...
- (void).cxx_destruct;	// IMP=0x0000000000180ae6
...
- (void)performWithTargetResponder:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000000017ff8a
- (id)initWithContextData:(id)arg1 appContext:(id)arg2 controllerClass:(Class)arg3;	// IMP=0x000000000017f88a
