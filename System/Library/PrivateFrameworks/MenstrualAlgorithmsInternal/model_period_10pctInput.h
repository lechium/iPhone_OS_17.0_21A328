...
@interface model_period_10pctInput : NSObject
{
...
- (void).cxx_destruct;	// IMP=0x0000000000055228
...
- (id)featureValueForName:(id)arg1;	// IMP=0x0000000000055082
@property(readonly, nonatomic) NSSet *featureNames;
- (id)initWithIn:(id)arg1 lstm_1_h_in:(id)arg2 lstm_1_c_in:(id)arg3;	// IMP=0x0000000000054faa
- (id)initWithIn:(id)arg1;	// IMP=0x0000000000054f93
