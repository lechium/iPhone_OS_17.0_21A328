...
@class CKGenericCondition, CKTripleCondition, MISSING_TYPE, NSArray, NSDictionary, NSString;
...
- (MISSING_TYPE *)removeValuesMatchingCondition:fromSynchedStoreWithIdentifier:completionHandler: /* Error: Ran out of types for this method. */;
