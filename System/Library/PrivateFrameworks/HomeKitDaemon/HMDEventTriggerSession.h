...
+ (_Bool)hasMessageReceiverChildren;	// IMP=0x00100000005ced51
+ (id)logCategory;	// IMP=0x00100000005ced21
- (void).cxx_destruct;	// IMP=0x00000000005cec9d
...
- (_Bool)sendMessage:(id)arg1 payload:(id)arg2 device:(id)arg3 target:(id)arg4 responseHandler:(CDUnknownBlockType)arg5;	// IMP=0x00000000005ce94d
- (_Bool)sendMessage:(id)arg1 payload:(id)arg2 device:(id)arg3 responseHandler:(CDUnknownBlockType)arg4;	// IMP=0x00000000005ce881
- (_Bool)sendResidentMessage:(id)arg1 payload:(id)arg2 responseHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000000005ce752
@property(readonly, nonatomic) NSObject<OS_dispatch_queue> *messageReceiveQueue;
@property(readonly, nonatomic) NSUUID *messageTargetUUID;
- (id)logIdentifier;	// IMP=0x00000000005ce71c
@property(readonly, copy) NSString *description;
- (id)dumpState;	// IMP=0x00000000005ce5a8
- (void)_registerForMessages;	// IMP=0x00000000005ce5a2
- (void)dealloc;	// IMP=0x00000000005ce409
- (id)initWithSessionID:(id)arg1 eventTrigger:(id)arg2 workQueue:(id)arg3 msgDispatcher:(id)arg4;	// IMP=0x00000000005ce1dd
