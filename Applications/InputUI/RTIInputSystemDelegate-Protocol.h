...
@class NSData, NSString, RTIDocumentTraits, RTIInputOperation, RTIInputSystemService, RTIInputSystemServiceSession, RTIInputSystemSession, RTISessionOptions, RTISupplementalLexicon, TISupplementalLexicon;
