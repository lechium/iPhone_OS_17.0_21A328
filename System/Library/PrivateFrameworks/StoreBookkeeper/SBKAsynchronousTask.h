...
- (void).cxx_destruct;	// IMP=0x000000000001e4f3
...
- (void)invokeTaskCompletionBlocksWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x000000000001e27a
- (void)addTaskCompletionBlock:(CDUnknownBlockType)arg1;	// IMP=0x000000000001e1b8
- (void)invalidate;	// IMP=0x000000000001e16a
- (void)_invalidateAssertion:(_Bool)arg1;	// IMP=0x000000000001e093
- (void)endTaskOperation;	// IMP=0x000000000001e061
- (void)finishTaskOperationWithResult:(id)arg1 error:(id)arg2;	// IMP=0x000000000001df61
- (void)beginTaskOperation;	// IMP=0x000000000001ddd8
...
- (void)_onQueueFireExpirationHandlerIfNecesary;	// IMP=0x000000000001d9b6
...
- (id)description;	// IMP=0x000000000001d67b
- (void)_invalidateTimer;	// IMP=0x000000000001d630
- (void)dealloc;	// IMP=0x000000000001d580
- (id)debugDescription;	// IMP=0x000000000001d572
- (id)initWithHandlerQueue:(id)arg1 timeout:(double)arg2 debugDescription:(id)arg3;	// IMP=0x000000000001d3cb
