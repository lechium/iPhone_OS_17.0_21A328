...
+ (id)sharedInstance;	// IMP=0x00100000005155d2
- (void).cxx_destruct;	// IMP=0x00000000005155bf
...
- (void)timerDidFire:(id)arg1;	// IMP=0x0000000000515481
- (struct HMDWatchConnectivityLogEventManagerSnapshot)currentWatchConnectivitySnapshot;	// IMP=0x00000000005153f7
- (void)completeCurrentReport;	// IMP=0x0000000000515273
- (void)incrementWatchRemovedNotificationCount;	// IMP=0x000000000051523e
- (void)incrementWatchAddedNotificationCount;	// IMP=0x0000000000515209
- (id)init;	// IMP=0x0000000000515164
