...
- (id)description;	// IMP=0x0010000000d4ce0d
- (id)jsonObject;	// IMP=0x0010000000d4cda9
@property(readonly) NSURLRequest *URLRequest;
- (id)initWithPayload:(id)arg1;	// IMP=0x0010000000d4cab3
- (id)initWithArchive:(id)arg1;	// IMP=0x0010000000d4ca63
- (id)initWithRequest:(id)arg1 endpoint:(id)arg2 headers:(id)arg3;	// IMP=0x0010000000d4c9c9
- (void)dealloc;	// IMP=0x0010000000d4c971
- (id)initWithPayload:(id)arg1 requestTypeCode:(unsigned int)arg2 endpoint:(id)arg3 headers:(id)arg4;	// IMP=0x0010000000d4c8ee
