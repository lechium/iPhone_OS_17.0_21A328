...
- (void).cxx_destruct;	// IMP=0x00000000005674f6
- (unsigned long long)hash;	// IMP=0x0000000000567261
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000566ea1
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000566592
- (void)writeTo:(id)arg1;	// IMP=0x0000000000565976
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000565967
- (id)jsonRepresentation;	// IMP=0x0000000000564ef6
- (id)dictionaryRepresentation;	// IMP=0x0000000000563ccb
- (id)description;	// IMP=0x0000000000563c1c
- (id)initWithData:(id)arg1;	// IMP=0x0000000000560cd5
- (id)init;	// IMP=0x0000000000560c79
