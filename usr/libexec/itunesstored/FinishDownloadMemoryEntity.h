...
+ (id)defaultProperties;	// IMP=0x0040000000086b72
+ (Class)databaseEntityClass;	// IMP=0x0010000000086b61
- (void).cxx_destruct;	// IMP=0x0020000000086ebf
...
- (id)secondaryAssetForType:(id)arg1;	// IMP=0x001000000008682f
@property(readonly, nonatomic) long long restoreState;
- (id)newITunesMetadataDictionary;	// IMP=0x0010000000086087
- (void)loadAssetsUsingSession:(id)arg1;	// IMP=0x0010000000085ba5
...
- (id)destinationDirectoryPathForAsset:(id)arg1;	// IMP=0x0010000000085619
