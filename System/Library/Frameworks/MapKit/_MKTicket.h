...
- (void).cxx_destruct;	// IMP=0x00000000000db968
...
- (void)applyToPlaceInfo:(id)arg1;	// IMP=0x00000000000db6c0
- (void)applyToCorrectedSearch:(id)arg1;	// IMP=0x00000000000db6aa
@property(readonly, nonatomic) GEOMapServiceTraits *traits;
- (void)cancel;	// IMP=0x00000000000db67e
- (void)submitWithHandler:(CDUnknownBlockType)arg1 timeout:(long long)arg2 queue:(id)arg3 networkActivity:(CDUnknownBlockType)arg4;	// IMP=0x00000000000db265
- (void)submitWithHandler:(CDUnknownBlockType)arg1 queue:(id)arg2 networkActivity:(CDUnknownBlockType)arg3;	// IMP=0x00000000000db24b
- (void)submitWithRefinedHandler:(CDUnknownBlockType)arg1 networkActivity:(CDUnknownBlockType)arg2;	// IMP=0x00000000000db234
- (void)submitWithHandler:(CDUnknownBlockType)arg1 networkActivity:(CDUnknownBlockType)arg2;	// IMP=0x00000000000db216
- (void)submitWithRefinedHandler:(CDUnknownBlockType)arg1 timeout:(long long)arg2 networkActivity:(CDUnknownBlockType)arg3;	// IMP=0x00000000000daa24
- (void)submitWithHandler:(CDUnknownBlockType)arg1 timeout:(long long)arg2 networkActivity:(CDUnknownBlockType)arg3;	// IMP=0x00000000000daa08
@property(readonly, copy) NSString *description;
- (id)initWithTicket:(id)arg1;	// IMP=0x00000000000da904
