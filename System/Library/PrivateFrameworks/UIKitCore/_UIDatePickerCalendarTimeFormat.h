...
+ (id)formatWithCalendar:(id)arg1 locale:(id)arg2 followsSystemHourCycle:(_Bool)arg3;	// IMP=0x00100000008cb6ed
+ (id)formatWithCalendar:(id)arg1 locale:(id)arg2;	// IMP=0x00100000008cb6d8
- (void).cxx_destruct;	// IMP=0x00000000008cddab
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000008cdaa4
- (id)withTimeZone:(id)arg1;	// IMP=0x00000000008cd9f8
- (id)withDisplaysTimeZone:(_Bool)arg1;	// IMP=0x00000000008cd9b1
- (id)withForceDoubleDigitHours:(_Bool)arg1;	// IMP=0x00000000008cd8a6
- (id)localizedTimeStringWithHours:(unsigned long long)arg1 minutes:(unsigned long long)arg2 isPM:(_Bool)arg3;	// IMP=0x00000000008cd891
- (id)localizedTimeStringWithHours:(unsigned long long)arg1 minutes:(unsigned long long)arg2 isPM:(_Bool)arg3 ranges:(CDStruct_a33ff3ce *)arg4;	// IMP=0x00000000008ccc45
- (id)initWithCalendar:(id)arg1 locale:(id)arg2 followsSystemHourCycle:(_Bool)arg3 forceDoubleDigitHours:(_Bool)arg4 displaysTimeZone:(_Bool)arg5;	// IMP=0x00000000008cb7a4
- (id)initWithCalendar:(id)arg1 locale:(id)arg2 forceDoubleDigitHours:(_Bool)arg3 displaysTimeZone:(_Bool)arg4;	// IMP=0x00000000008cb77c
