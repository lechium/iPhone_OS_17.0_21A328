...
- (void).cxx_destruct;	// IMP=0x00000000004df736
...
- (void)_applyAlphaToAllAttributesAlpha:(double)arg1;	// IMP=0x00000000004df4ac
- (void)_setContainerAttributes:(id)arg1 forLayoutMode:(unsigned long long)arg2;	// IMP=0x00000000004de1b8
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000004de069
