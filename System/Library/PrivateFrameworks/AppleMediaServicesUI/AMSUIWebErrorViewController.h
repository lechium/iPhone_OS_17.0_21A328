...
- (void).cxx_destruct;	// IMP=0x000000000009ca5b
...
- (void)_showCancelButtonIfNeeded;	// IMP=0x000000000009c5d8
- (void)_applyAppearance;	// IMP=0x000000000009c46d
- (void)willPresentPageModel:(id)arg1 appearance:(id)arg2;	// IMP=0x000000000009c25e
- (void)viewWillLayoutSubviews;	// IMP=0x000000000009c195
- (void)loadView;	// IMP=0x000000000009b48a
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x000000000009b290
- (id)initWithContext:(id)arg1;	// IMP=0x000000000009b233
