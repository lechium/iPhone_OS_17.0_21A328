...
+ (id)nameForState:(unsigned long long)arg1;	// IMP=0x00600000000fe09e
- (void).cxx_destruct;	// IMP=0x00000000000ffe0c
...
- (void)handleReplaceDeltasRequest:(id)arg1 result:(id)arg2;	// IMP=0x00000000000ffa4c
- (void)handleDeltaUploaded:(id)arg1 result:(id)arg2;	// IMP=0x00000000000ff6bf
- (void)_uploadAndReplaceDeltas:(CDUnknownBlockType)arg1;	// IMP=0x00000000000fe6cb
- (void)_uploadAndReplaceDeltas;	// IMP=0x00000000000fe536
- (void)_encryptMergeableDeltas;	// IMP=0x00000000000fe1a3
- (void)main;	// IMP=0x00000000000fe100
- (_Bool)makeStateTransition;	// IMP=0x00000000000fdfcd
- (id)activityCreate;	// IMP=0x00000000000fdfa4
- (int)operationType;	// IMP=0x00000000000fdf99
- (id)initWithOperationInfo:(id)arg1 container:(id)arg2;	// IMP=0x00000000000fde63
