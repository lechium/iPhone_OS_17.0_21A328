...
- (void).cxx_destruct;	// IMP=0x00000000007b771d
...
- (void)dealloc;	// IMP=0x00000000007b7691
- (id)initWithSnapshotFile:(id)arg1 videoResolution:(id)arg2;	// IMP=0x00000000007b75ad
- (id)initWithSnapshotData:(id)arg1 videoResolution:(id)arg2 snapshotDataTrasaction:(id)arg3;	// IMP=0x00000000007b74e3
