...
@interface MISystemAppMigrationState : NSObject
{
    ...
    MISSING_TYPE *_systemAppMigrationStateQueue;	// 24 = 0x18
}

+ (id)defaultManager;	// IMP=0x0040000000049a45
- (void).cxx_destruct;	// IMP=0x002000000004a04e
...
- (void)waitForSystemAppMigrationToComplete:(CDUnknownBlockType)arg1;	// IMP=0x0010000000049e01
@property(nonatomic) _Bool systemAppMigrationComplete; // @synthesize systemAppMigrationComplete=_systemAppMigrationComplete;
- (id)init;	// IMP=0x0010000000049907
