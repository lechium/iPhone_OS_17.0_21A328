...
- (void)appendBytes:(const void *)arg1 length:(unsigned long long)arg2;	// IMP=0x000000000002ce45
- (void)setTruncated;	// IMP=0x000000000002ce3d
- (void)setPublic;	// IMP=0x000000000002ce1c
- (void)_initBlob;	// IMP=0x000000000002cd6e
