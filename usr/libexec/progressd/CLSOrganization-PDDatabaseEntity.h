...
+ (id)searchColumnName;	// IMP=0x0020000000059a6d
+ (_Bool)migrateFromVersion:(unsigned long long)arg1 finalVersion:(out unsigned long long *)arg2 inDatabase:(id)arg3;	// IMP=0x00100000000599b0
+ (id)entityName;	// IMP=0x0010000000059437
- (id)tokensForSearchableColumn:(id)arg1 withValue:(id)arg2 tokenize:(_Bool)arg3;	// IMP=0x0020000000059b55
...
- (void)bindTo:(id)arg1;	// IMP=0x00100000000596ad
- (id)initWithDatabaseRow:(id)arg1;	// IMP=0x0010000000059444
