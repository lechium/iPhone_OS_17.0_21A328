...
- (void).cxx_destruct;	// IMP=0x0000000001187c61
@property(readonly, nonatomic) GEOTileLoader *tileLoader; // @synthesize tileLoader=_tileLoader;
- (void)cancel;	// IMP=0x0000000001187a29
- (void)addTileRequest:(id)arg1;	// IMP=0x0000000001187975
- (id)initWithTileLoader:(id)arg1;	// IMP=0x00000000011878c5
