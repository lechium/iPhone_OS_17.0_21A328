...
- (void)readStoreBagValues;	// IMP=0x00000000002952ba
- (unsigned int)bitrateForStoreBagKey:(id)arg1 connectionType:(int)arg2 currentBitrate:(unsigned int)arg3 isExpensive:(_Bool)arg4;	// IMP=0x00000000002950a5
- (void)readHardwareValues;	// IMP=0x000000000029507b
- (_Bool)rangeCheck:(unsigned int)arg1;	// IMP=0x0000000000295003
- (void)dealloc;	// IMP=0x0000000000294fa5
- (id)init;	// IMP=0x0000000000294f21
