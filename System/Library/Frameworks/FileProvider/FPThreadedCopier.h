...
+ (id)sharedCopier;	// IMP=0x0040000000079a14
- (void).cxx_destruct;	// IMP=0x000000000007a985
...
- (void)endOperation;	// IMP=0x000000000007a79c
- (void)beginOperation;	// IMP=0x000000000007a53d
- (_Bool)finishReading:(int)arg1 writing:(int)arg2 error:(id *)arg3;	// IMP=0x000000000007a3f0
- (int)beginWriting:(id)arg1 overwriteDestination:(_Bool)arg2 error:(id *)arg3;	// IMP=0x000000000007a34b
- (int)beginReading:(id)arg1 error:(id *)arg2;	// IMP=0x000000000007a2ba
- (_Bool)copy:(id)arg1 to:(id)arg2 overwriteDestination:(_Bool)arg3 progress:(id)arg4 error:(id *)arg5;	// IMP=0x0000000000079b00
- (id)init;	// IMP=0x0000000000079a69
