...
@class MISSING_TYPE, NSDate, NSString, SFBLEDevice;
...
- (void).cxx_destruct;	// IMP=0x00200000000cb4e0
...
- (void)sendProxyTrigger;	// IMP=0x00100000000cb02e
- (void)notifyDelegateWithError:(id)arg1;	// IMP=0x00100000000caf5a
- (void)handleFoundBLEDevice:(id)arg1;	// IMP=0x00100000000cacfd
- (void)deviceConnected:(id)arg1;	// IMP=0x00100000000cab8a
- (id)results;	// IMP=0x00100000000caa27
- (void)removeObservers;	// IMP=0x00100000000ca9d4
- (void)addObservers;	// IMP=0x00100000000ca96d
- (void)invalidate;	// IMP=0x00100000000ca891
- (void)_start;	// IMP=0x00100000000ca7df
- (void)start;	// IMP=0x00100000000ca758
- (id)initWithDevice:(id)arg1 sessionID:(id)arg2 bleDevice:(id)arg3;	// IMP=0x00100000000ca6c6
