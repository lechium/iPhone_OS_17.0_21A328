...
+ (id)_histogramViewWithElement:(id)arg1 existingView:(id)arg2;	// IMP=0x006000000003c6ff
+ (id)histogramViewWithElement:(id)arg1 existingView:(id)arg2;	// IMP=0x006000000003c3ed
- (void).cxx_destruct;	// IMP=0x000000000003dab7
...
- (void)drawRect:(struct CGRect)arg1;	// IMP=0x000000000003d066
- (_Bool)canBecomeFocused;	// IMP=0x000000000003d05e
