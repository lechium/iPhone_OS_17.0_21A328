...
- (void).cxx_destruct;	// IMP=0x0000000000013444
...
- (void)cancelSettleToPhoto;	// IMP=0x000000000001329b
- (void)_didReachTransitionToPhotoTime;	// IMP=0x0000000000013046
- (void)_didReachTransitionTime;	// IMP=0x0000000000012f2b
- (void)_startVideoPlayback;	// IMP=0x0000000000012dff
- (void)videoReadyForDisplayDidChange;	// IMP=0x0000000000012d96
- (void)playVitality;	// IMP=0x0000000000012d05
- (long long)behaviorType;	// IMP=0x0000000000012cfa
- (void)_handleDidFinishPreroll;	// IMP=0x0000000000012ca1
- (void)_handleDidSeekToStartTime;	// IMP=0x0000000000012b72
- (void)_stopObservingVideo;	// IMP=0x0000000000012ad5
- (void)_startObservingVideo;	// IMP=0x0000000000012674
- (void)prepareForVitality;	// IMP=0x000000000001236a
- (void)activeDidChange;	// IMP=0x00000000000122d0
- (id)initWithInitialLayoutInfo:(id)arg1 playbackEndTime:(CDStruct_1b6d18a9)arg2 playDuration:(CDStruct_1b6d18a9)arg3 playRate:(float)arg4 photoTransitionDuration:(double)arg5 pauseDuringTransition:(_Bool)arg6 assetOptions:(unsigned long long)arg7;	// IMP=0x0000000000012218
