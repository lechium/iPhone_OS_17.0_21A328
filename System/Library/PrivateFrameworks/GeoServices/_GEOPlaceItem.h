...
- (void).cxx_destruct;	// IMP=0x00000000008a2334
...
- (id)_placecardLayoutConfiguration;	// IMP=0x00000000008a230c
- (id)_relatedPlaceListForComponentIdentifier:(int)arg1;	// IMP=0x00000000008a2304
...
- (id)_businessClaim;	// IMP=0x00000000008a22bc
- (_Bool)_hasBusinessClaim;	// IMP=0x00000000008a22b4
- (id)_mapItemByStrippingOptionalData;	// IMP=0x00000000008a22ab
@property(readonly, nonatomic, getter=_photos) NSArray *photos;
@property(readonly, nonatomic, getter=_reviews) NSArray *reviews;
- (id)_asPlaceInfo;	// IMP=0x00000000008a2253
...
- (id)_yelpID;	// IMP=0x00000000008a1ff2
...
- (id)_urlForWritingAReview;	// IMP=0x00000000008a1fda
- (id)_urlForReview:(id)arg1;	// IMP=0x00000000008a1fd2
- (id)_urlForPhotoWithUID:(id)arg1;	// IMP=0x00000000008a1fca
...
- (_Bool)_hasLocalizedCategoryNamesForType:(unsigned int)arg1;	// IMP=0x00000000008a1f47
- (id)_localizedCategoryNamesForType:(unsigned int)arg1;	// IMP=0x00000000008a1f3f
...
- (id)_arrivalMapRegionForTransportType:(int)arg1;	// IMP=0x00000000008a1ba2
- (unsigned int)_travelDistanceForTransportType:(int)arg1;	// IMP=0x00000000008a1b60
- (unsigned int)_travelTimeForTransportType:(int)arg1;	// IMP=0x00000000008a1b1e
- (_Bool)_hasTravelTimeForTransportType:(int)arg1;	// IMP=0x00000000008a1b01
- (int)_recommendedTransportType;	// IMP=0x00000000008a1af6
- (id)_spokenAddressForLocale:(id)arg1;	// IMP=0x00000000008a1ad9
...
- (id)weatherDisplayName;	// IMP=0x00000000008a1a31
- (id)addressObject;	// IMP=0x00000000008a197e
...
- (id)spokenNameForLocale:(id)arg1;	// IMP=0x00000000008a13c2
@property(readonly, nonatomic) NSString *name;
@property(readonly, nonatomic) int referenceFrame;
@property(readonly, nonatomic, getter=isValid) _Bool valid;
- (_Bool)isEqualToMapItem:(id)arg1;	// IMP=0x00000000008a1307
@property(readonly) unsigned long long hash;
@property(readonly, copy) NSString *description;
- (id)initWithPlace:(id)arg1;	// IMP=0x00000000008a1125
- (id)initWithPlaceResult:(id)arg1;	// IMP=0x00000000008a104c
