...
+ (id)sharedFontManager;	// IMP=0x006000000000120c
- (void).cxx_destruct;	// IMP=0x000000000000140a
...
- (void)cacheFonts;	// IMP=0x0000000000001295
- (id)init;	// IMP=0x0000000000001249
