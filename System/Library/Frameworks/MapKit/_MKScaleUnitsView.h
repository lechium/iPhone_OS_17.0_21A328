...
- (void).cxx_destruct;	// IMP=0x00000000001b49e1
...
- (id)_legendStringForDistanceString:(id)arg1 appendUnits:(_Bool)arg2 index:(int)arg3;	// IMP=0x00000000001b47b0
@property(readonly, nonatomic) NSString *zeroUnitsString; // @synthesize zeroUnitsString=_zeroUnitsString;
- (id)_uncachedLegendStringsForDistanceString:(id)arg1;	// IMP=0x00000000001b44ea
...
- (_Bool)canDisplaySegment:(unsigned long long)arg1;	// IMP=0x00000000001b3ef9
- (void)_calculateLegend:(_Bool)arg1;	// IMP=0x00000000001b37ae
- (void)setUnits:(id)arg1;	// IMP=0x00000000001b3556
- (double)_widthForString:(id)arg1 attributes:(id)arg2;	// IMP=0x00000000001b344b
- (void)clearCaches:(id)arg1;	// IMP=0x00000000001b342e
- (id)init;	// IMP=0x00000000001b322b
