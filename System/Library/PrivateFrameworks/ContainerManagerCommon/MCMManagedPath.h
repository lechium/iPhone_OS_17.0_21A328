...
- (void).cxx_destruct;	// IMP=0x000000000006e4d4
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000006e15c
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000006e0cc
- (_Bool)isEqualToManagedPath:(id)arg1;	// IMP=0x000000000006e087
@property(readonly) unsigned long long hash;
- (id)managedPathByAppendingPathComponent:(id)arg1 flags:(unsigned long long)arg2 ACLConfig:(unsigned long long)arg3 mode:(unsigned short)arg4 dpClass:(int)arg5 owner:(id)arg6;	// IMP=0x000000000006df24
- (id)initWithURL:(id)arg1 flags:(unsigned long long)arg2 ACLConfig:(unsigned long long)arg3 mode:(unsigned short)arg4 dpClass:(int)arg5 owner:(id)arg6 parent:(id)arg7;	// IMP=0x000000000006de02
