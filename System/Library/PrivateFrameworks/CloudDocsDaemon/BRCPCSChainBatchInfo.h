...
- (void).cxx_destruct;	// IMP=0x00000000001edbeb
...
- (void)chainPreparedRecordBatch:(id)arg1;	// IMP=0x00000000001ed1ca
- (void)_chainPreppedRecordToParent:(id)arg1;	// IMP=0x00000000001eceda
- (void)addFullyChainedRecordInfo:(id)arg1;	// IMP=0x00000000001ec378
- (void)prepareFirstPhaseRecordBatch;	// IMP=0x00000000001ec1cb
- (_Bool)containsRecordInfo:(id)arg1;	// IMP=0x00000000001ec063
- (id)initWithAppLibrary:(id)arg1;	// IMP=0x00000000001ebf0e
