...
- (void).cxx_destruct;	// IMP=0x00000000003638ec
...
- (id)attributeDescriptions;	// IMP=0x000000000036366a
- (id)initWithLocation:(id)arg1 reachableIPAccessoryCount:(unsigned long long)arg2 reachableBTLEAccessoryCount:(unsigned long long)arg3 reachableMediaAccessoryCount:(unsigned long long)arg4;	// IMP=0x00000000003635b4
