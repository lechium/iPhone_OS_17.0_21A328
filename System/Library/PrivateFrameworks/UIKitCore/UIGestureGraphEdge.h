...
- (void).cxx_destruct;	// IMP=0x000000000094138b
...
- (id)description;	// IMP=0x000000000094123c
@property(readonly, nonatomic, getter=isLoop) _Bool loop;
- (id)commonNode:(id)arg1;	// IMP=0x00000000009410a5
- (id)oppositeNode:(id)arg1;	// IMP=0x0000000000941068
- (id)initWithLabel:(id)arg1 sourceNode:(id)arg2 targetNode:(id)arg3 directed:(_Bool)arg4;	// IMP=0x0000000000940ee8
