...
- (id)flatbuffData;	// IMP=0x000000000010bcd6
- (Offset_acd6b661)addObjectToBuffer:(void *)arg1;	// IMP=0x000000000010b1d9
...
- (void)context_info_enumerateObjectsUsingBlock:(CDUnknownBlockType)arg1;	// IMP=0x000000000010a88f
- (unsigned long long)context_info_count;	// IMP=0x000000000010a7f3
- (id)context_info_objectAtIndex:(unsigned long long)arg1;	// IMP=0x000000000010a6fa
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000010a270
- (id)initWithFlatbuffData:(id)arg1 root:(const struct StartTextToSpeechStreamingRequest *)arg2 verify:(_Bool)arg3;	// IMP=0x000000000010a0c5
- (id)initWithFlatbuffData:(id)arg1 root:(const struct StartTextToSpeechStreamingRequest *)arg2;	// IMP=0x000000000010a0b0
- (id)initAndVerifyWithFlatbuffData:(id)arg1;	// IMP=0x000000000010a096
- (id)initWithFlatbuffData:(id)arg1;	// IMP=0x000000000010a07f
