...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000002178e
- (void).cxx_destruct;	// IMP=0x0000000000021cb3
...
- (id)description;	// IMP=0x00000000000218cc
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000021874
- (unsigned long long)hash;	// IMP=0x000000000002183b
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000217eb
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000021796
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000002170e
- (id)init;	// IMP=0x000000000002167a
