...
+ (id)logCategory;	// IMP=0x0010000000ad78dc
- (void).cxx_destruct;	// IMP=0x0000000000ad7878
...
- (id)logIdentifier;	// IMP=0x0000000000ad7797
- (id)negotiatedParameters;	// IMP=0x0000000000ad7642
- (id)initWithSessionID:(id)arg1 streamingTierType:(unsigned long long)arg2 remoteCapabilities:(id)arg3 streamPreference:(id)arg4;	// IMP=0x0000000000ad72c2
