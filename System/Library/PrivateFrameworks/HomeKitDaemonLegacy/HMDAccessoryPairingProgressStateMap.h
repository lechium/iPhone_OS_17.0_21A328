...
- (void).cxx_destruct;	// IMP=0x000000000052f4e7
...
- (double)getTimeDurationForLongestProgressState;	// IMP=0x000000000052f3c4
- (void)updateWithProgressState:(id)arg1 date:(id)arg2;	// IMP=0x000000000052ed92
- (id)initWithDate:(id)arg1;	// IMP=0x000000000052ed0d
