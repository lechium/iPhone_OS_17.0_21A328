...
+ (id)logCategory;	// IMP=0x0010000000a0346c
- (void).cxx_destruct;	// IMP=0x0000000000a033fb
...
- (id)logIdentifier;	// IMP=0x0000000000a0334f
@property(readonly, nonatomic) NSUUID *messageTargetUUID;
- (void)__handleXPCMessage:(id)arg1;	// IMP=0x0000000000a03184
- (void)registerForMessage:(id)arg1 policies:(id)arg2;	// IMP=0x0000000000a0309e
- (id)shortDescription;	// IMP=0x0000000000a03023
- (void)dealloc;	// IMP=0x0000000000a02f66
- (id)initWithReceiver:(id)arg1 handler:(id)arg2;	// IMP=0x0000000000a02ecb
