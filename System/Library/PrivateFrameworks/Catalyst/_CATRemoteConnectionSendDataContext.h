...
- (void).cxx_destruct;	// IMP=0x000000000001c8e4
...
- (id)bufferedDataWithError:(id *)arg1;	// IMP=0x000000000001c84f
- (unsigned long long)headerLength;	// IMP=0x000000000001c7ed
@property(readonly, nonatomic) unsigned long long clientBytesWritten;
@property(readonly, nonatomic) _Bool hasBytesRemaining;
- (id)initWithData:(id)arg1 userInfo:(id)arg2;	// IMP=0x000000000001c5e8
