...
- (void)viewDidDisappear:(_Bool)arg1;	// IMP=0x0000000000050d9f
- (void)viewWillDisappear:(_Bool)arg1;	// IMP=0x0000000000050d66
- (void)viewDidAppear:(_Bool)arg1;	// IMP=0x0000000000050d2d
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x0000000000050cf4
- (void)viewDidLayoutSubviews;	// IMP=0x0000000000050b35
- (void)viewDidLoad;	// IMP=0x000000000004fa77
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x000000000004f873
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x000000000004f7aa
@property(readonly, nonatomic) struct CGSize preferredLogoSize;
- (void)_manualSignInButtonPressed:(id)arg1;	// IMP=0x000000000004f5f5
- (void)_stopObservingViewModel:(id)arg1;	// IMP=0x000000000004f5cc
- (void)_startObservingViewModel:(id)arg1;	// IMP=0x000000000004f59d
- (void)dealloc;	// IMP=0x000000000004f554
- (id)initWithNibName:(id)arg1 bundle:(id)arg2;	// IMP=0x000000000004f510
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000004f469
