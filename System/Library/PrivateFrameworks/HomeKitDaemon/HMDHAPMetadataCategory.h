...
- (void).cxx_destruct;	// IMP=0x0000000000241356
...
- (id)initWithIdentifier:(id)arg1 uuid:(id)arg2 name:(id)arg3 description:(id)arg4;	// IMP=0x000000000024108e
- (id)init;	// IMP=0x0000000000240fe6
