...
- (void).cxx_destruct;	// IMP=0x00000000000cb0ac
...
- (void)collectionView:(id)arg1 didSelectItemAtIndexPath:(id)arg2;	// IMP=0x00000000000cadf9
- (id)initWithTraitContainer:(id)arg1;	// IMP=0x00000000000cabec
