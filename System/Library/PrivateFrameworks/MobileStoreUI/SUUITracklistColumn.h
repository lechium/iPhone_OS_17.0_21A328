...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000f7f38
- (id)description;	// IMP=0x00000000000f7ead
- (void)setPreferredWidthForAttributedStrings:(id)arg1;	// IMP=0x00000000000f7cb0
