...
+ (int)payloadForVideoPayload:(int)arg1;	// IMP=0x00100000003b7336
+ (int)videoPayloadForPayload:(int)arg1;	// IMP=0x00100000003b7318
+ (_Bool)convertVideoFormat:(int)arg1 width:(int *)arg2 height:(int *)arg3;	// IMP=0x00100000003b7189
+ (int)videoFormatForWidth:(int)arg1 height:(int)arg2;	// IMP=0x00100000003b702d
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000000a98d
- (unsigned long long)hash;	// IMP=0x000000000000a83f
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000000a694
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000000a55c
- (void)copyTo:(id)arg1;	// IMP=0x000000000000a462
- (void)writeTo:(id)arg1;	// IMP=0x000000000000a2d1
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000000a2c4
- (id)dictionaryRepresentation;	// IMP=0x0000000000009814
- (id)description;	// IMP=0x000000000000977a
...
- (void)printWithLogFile:(void *)arg1;	// IMP=0x00000000003b6dc7
@property(readonly, nonatomic) _Bool isSubStream;
- (id)newMultiwayVideoStream;	// IMP=0x00000000003b6b4b
- (id)initWithStreamConfig:(id)arg1;	// IMP=0x00000000003b6949
