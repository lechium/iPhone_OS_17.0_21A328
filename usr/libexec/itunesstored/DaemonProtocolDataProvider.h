...
- (_Bool)processDictionary:(id)arg1 error:(id *)arg2;	// IMP=0x00100000001b31c2
- (void)_presentDialog:(id)arg1;	// IMP=0x00100000001b312e
- (void)dealloc;	// IMP=0x00100000001b30ec
