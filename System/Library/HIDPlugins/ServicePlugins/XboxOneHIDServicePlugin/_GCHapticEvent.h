...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000000020b9
...
- (id)description;	// IMP=0x0000000000001f7c
- (id)initWithSyntheticCommand:(id)arg1;	// IMP=0x0000000000001d8e
- (void)evaluateDeviceNoteParams:(id)arg1;	// IMP=0x0000000000001cf9
- (pair_218a80e9)valueForNoteParam:(unsigned int)arg1 inParameters:(id)arg2;	// IMP=0x0000000000001b10
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000021f7
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000020c1
