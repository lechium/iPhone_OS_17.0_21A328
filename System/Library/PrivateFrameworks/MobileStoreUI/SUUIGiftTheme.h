...
@interface SUUIGiftTheme : NSObject
{
...
- (void).cxx_destruct;	// IMP=0x000000000009ed4c
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000009ebb5
- (id)description;	// IMP=0x000000000009eb23
- (id)initWithThemeDictionary:(id)arg1;	// IMP=0x000000000009e855
