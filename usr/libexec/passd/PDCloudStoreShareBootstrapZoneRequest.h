...
- (void).cxx_destruct;	// IMP=0x00200000001b5431
...
- (id)description;	// IMP=0x00100000001b532a
- (_Bool)canCoalesceRequest:(id)arg1;	// IMP=0x00100000001b5172
- (id)initWithZoneName:(id)arg1 containerName:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x00100000001b50c5
