...
+ (id)customAttributes;	// IMP=0x00600000001b4872
...
- (id)outputImage;	// IMP=0x00000000001b4c2c
- (id)_negkernel;	// IMP=0x00000000001b4c0c
- (id)_poskernel;	// IMP=0x00000000001b4bec
- (_Bool)_isIdentity;	// IMP=0x00000000001b4bb7
