...
@class NSArray, NSDate, NSFileHandle, NSObject, NSSet, NSString, WBSHistoryServiceEvent, WBSHistoryVisitIdentifier, WBSSetInt64, WBSURLCompletionUserTypedString;
...
- (void)assignURLString:(NSString *)arg1 toTopicTagsWithIDs:(WBSSetInt64 *)arg2 completionHandler:(void (^)(_Bool, NSError *))arg3;
...
- (void)computeFrequentlyVisitedSites:(unsigned long long)arg1 minimalVisitCountScore:(unsigned long long)arg2 blockList:(NSSet *)arg3 allowList:(NSSet *)arg4 options:(unsigned long long)arg5 currentTime:(double)arg6 completionHandler:(void (^)(NSArray *, NSError *))arg7;
...
- (void)recordVisitWithIdentifier:(WBSHistoryVisitIdentifier *)arg1 sourceVisit:(WBSHistoryVisitIdentifier *)arg2 title:(NSString *)arg3 wasHTTPNonGet:(_Bool)arg4 loadSuccessful:(_Bool)arg5 origin:(long long)arg6 attributes:(unsigned long long)arg7 statusCode:(long long)arg8 completionHandler:(void (^)(NSError *))arg9;
