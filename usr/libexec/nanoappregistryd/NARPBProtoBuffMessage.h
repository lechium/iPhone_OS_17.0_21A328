...
- (void).cxx_destruct;	// IMP=0x0020000000004d33
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000004c5a
- (unsigned long long)hash;	// IMP=0x0010000000004c0d
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000004b55
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000004ab7
- (void)copyTo:(id)arg1;	// IMP=0x0010000000004a54
- (void)writeTo:(id)arg1;	// IMP=0x00100000000049f7
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000000049ea
- (id)dictionaryRepresentation;	// IMP=0x001000000000472a
- (id)description;	// IMP=0x001000000000467b
