...
- (void).cxx_destruct;	// IMP=0x00000000000a410d
...
- (_Bool)accessibilityIgnoresInvertColors;	// IMP=0x00000000000a3e05
- (id)accessibilityElements;	// IMP=0x00000000000a3df3
- (struct CGRect)rectFromApplyingOrientation:(long long)arg1 toContentsRect:(struct CGRect)arg2;	// IMP=0x00000000000a3d49
@property(readonly, nonatomic) UIBezierPath *outlinePath;
- (void)updateOutlineLayer;	// IMP=0x00000000000a3ab0
- (void)updateSelectedKnobContents;	// IMP=0x00000000000a352b
- (void)unselectAllKnobs;	// IMP=0x00000000000a2e2b
- (id)closestKnobToPoint:(struct CGPoint)arg1;	// IMP=0x00000000000a2c2b
- (void)didPan:(id)arg1;	// IMP=0x00000000000a22c3
- (void)touchesBeganOnQuadEditPanGestureRecognizerDelegate:(id)arg1;	// IMP=0x00000000000a22b1
- (void)updateKnobLocationsToRect:(id)arg1;	// IMP=0x00000000000a209c
...
- (void)setupLoupeLayerIfNeeded;	// IMP=0x00000000000a179f
- (void)setImage:(id)arg1 orientation:(long long)arg2;	// IMP=0x00000000000a172c
- (void)setTempOverlayMagnification:(double)arg1 animationDuration:(double)arg2;	// IMP=0x00000000000a0f75
- (void)updateOutlineAndKnobColorForIsValid:(_Bool)arg1;	// IMP=0x00000000000a0d0f
- (void)updateOutlineAndKnobColorForCurrentValidityIfNecessary;	// IMP=0x00000000000a0c97
- (void)setUpKnobs;	// IMP=0x00000000000a0760
- (void)layoutSubviews;	// IMP=0x00000000000a05f2
- (void)commonInit;	// IMP=0x00000000000a052e
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000000a04d1
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000a0485
