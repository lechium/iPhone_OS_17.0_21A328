...
- (id)createEndpoint;	// IMP=0x00200000000018a0
- (id)allClients;	// IMP=0x0010000000001862
- (void)start;	// IMP=0x0010000000001678
- (void)addInvalidationHandler:(CDUnknownBlockType)arg1;	// IMP=0x0010000000001600
- (void)invalidate;	// IMP=0x00100000000014af
- (id)__invalidate;	// IMP=0x001000000000146c
- (void)setPrivileged:(_Bool)arg1;	// IMP=0x0010000000001460
- (id)dispatchQueue;	// IMP=0x0010000000001456
...
- (void)dealloc;	// IMP=0x001000000000126f
- (id)initWithConfiguration:(struct distnoted_configuration *)arg1;	// IMP=0x00100000000011c0
