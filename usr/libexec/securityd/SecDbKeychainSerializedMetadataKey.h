...
- (void).cxx_destruct;	// IMP=0x00200000001a01fe
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000001a00af
- (unsigned long long)hash;	// IMP=0x001000000019fffc
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000019feba
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000019fdb2
- (void)copyTo:(id)arg1;	// IMP=0x001000000019fcf2
- (void)writeTo:(id)arg1;	// IMP=0x001000000019fc28
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000019f95f
- (id)dictionaryRepresentation;	// IMP=0x001000000019f7f1
- (id)description;	// IMP=0x001000000019f742
