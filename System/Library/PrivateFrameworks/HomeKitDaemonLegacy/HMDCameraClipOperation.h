...
+ (id)logCategory;	// IMP=0x00100000002dc753
+ (id)shortDescription;	// IMP=0x00100000002dc741
+ (unsigned long long)cameraClipOperationType;	// IMP=0x00100000002dc699
- (void).cxx_destruct;	// IMP=0x00000000002dc602
...
- (void)_markEndDateAndSubmitUploadOperationEvent;	// IMP=0x00000000002dc0c3
@property(readonly) double executionDuration;
- (id)updateClipModel:(id)arg1;	// IMP=0x00000000002dbd74
- (id)fetchClipModel;	// IMP=0x00000000002dbb26
- (void)cancelWithError:(id)arg1;	// IMP=0x00000000002dba0e
- (void)finish;	// IMP=0x00000000002db8f6
- (void)main;	// IMP=0x00000000002db872
@property(readonly) double queuedDuration;
- (id)initWithClipModelID:(id)arg1 localZone:(id)arg2 dataSource:(id)arg3;	// IMP=0x00000000002db4ef
- (id)initWithClipModelID:(id)arg1 localZone:(id)arg2;	// IMP=0x00000000002db469
