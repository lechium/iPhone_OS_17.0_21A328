...
- (void).cxx_destruct;	// IMP=0x0000000000032488
...
- (void)_initPathPropertiesWithDaemonUser:(id)arg1;	// IMP=0x0000000000031c5e
- (void)_addPaths:(id)arg1;	// IMP=0x0000000000031c05
- (id)managedPathForURL:(id)arg1;	// IMP=0x0000000000031a2f
- (id)orderedPathsFromPaths:(id)arg1;	// IMP=0x0000000000031695
- (id)initWithDaemonUser:(id)arg1 privileged:(_Bool)arg2;	// IMP=0x00000000000314fc
