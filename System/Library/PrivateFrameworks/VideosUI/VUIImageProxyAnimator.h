...
- (void).cxx_destruct;	// IMP=0x000000000009182a
...
- (void)_displayIntervalTimerFired:(id)arg1;	// IMP=0x0000000000091671
- (void)_fetchNext;	// IMP=0x00000000000912b8
- (void)_updateImageWithIndex:(unsigned long long)arg1;	// IMP=0x0000000000090db3
- (void)loadImageProxy:(id)arg1 withWeakObject:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000000090b6d
- (void)_setImage:(id)arg1 animated:(_Bool)arg2;	// IMP=0x00000000000909b5
- (void)stopAnimation;	// IMP=0x000000000009094c
- (void)startAnimation;	// IMP=0x000000000009088b
- (id)initWithImageView:(id)arg1 andProxies:(id)arg2;	// IMP=0x00000000000907a7
- (id)init;	// IMP=0x0000000000090765
