...
+ (id)logCategory;	// IMP=0x0010000000cb9cdc
- (void).cxx_destruct;	// IMP=0x0000000000cb5f4e
...
- (id)logIdentifier;	// IMP=0x0000000000cb5e3c
- (void)__handleDeviceRemovedFromAccount:(id)arg1;	// IMP=0x0000000000cb5da8
- (void)__handleAccountRemovedFromRegistry:(id)arg1;	// IMP=0x0000000000cb5d14
- (void)__handleRemovedIdentity:(id)arg1;	// IMP=0x0000000000cb5c80
- (void)handleSecureMessage:(id)arg1 fromDevice:(id)arg2 fromTransport:(id)arg3;	// IMP=0x0000000000cb5b8d
- (void)handleCompletedMessage:(id)arg1 options:(id)arg2 responsePayload:(id)arg3 error:(id)arg4 completionHandler:(CDUnknownBlockType)arg5;	// IMP=0x0000000000cb5a44
- (void)sendMessage:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000cb597a
- (void)stop;	// IMP=0x0000000000cb5928
- (void)_closeWithError:(id)arg1;	// IMP=0x0000000000cb5851
- (void)closedWithError:(id)arg1;	// IMP=0x0000000000cb57bd
- (void)_configureWithCompletionQueue:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000cb509a
- (void)startAndInvokeOnQueue:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000cb4fdc
@property(readonly, copy) NSDate *lastActivity; // @synthesize lastActivity=_lastActivity;
- (void)setIdle:(_Bool)arg1;	// IMP=0x0000000000cb4e73
@property(readonly, getter=isIdle) _Bool idle; // @synthesize idle=_idle;
- (void)setAuthenticated:(_Bool)arg1;	// IMP=0x0000000000cb4dfc
@property(readonly, getter=isAuthenticated) _Bool authenticated; // @synthesize authenticated=_authenticated;
- (void)setOpen:(_Bool)arg1;	// IMP=0x0000000000cb4d85
@property(readonly, getter=isOpen) _Bool open; // @synthesize open=_open;
- (void)setMaximumRemoteStreams:(id)arg1;	// IMP=0x0000000000cb4cfa
...
- (void)dealloc;	// IMP=0x0000000000cb482a
- (id)initWithCurrentDevice:(id)arg1 peerDevice:(id)arg2 clientMode:(_Bool)arg3 sessionID:(id)arg4 accountRegistry:(id)arg5;	// IMP=0x0000000000cb45a4
