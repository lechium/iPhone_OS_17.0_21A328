...
- (void).cxx_destruct;	// IMP=0x0000000000069419
...
- (void)useImmutableObjectsFromMap:(id)arg1 intermediateMutableObjectTransferBlock:(CDUnknownBlockType)arg2;	// IMP=0x00000000000690a6
@property(readonly, copy) NSString *description;
- (id)initWithRemovedObjects:(id)arg1 indexes:(id)arg2;	// IMP=0x0000000000068f0b
