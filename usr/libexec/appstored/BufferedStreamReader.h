...
- (void).cxx_destruct;	// IMP=0x0020000000077f26
- (void)close;	// IMP=0x0010000000077edc
- (long long)readBytes:(char *)arg1 length:(unsigned long long)arg2 error:(id *)arg3;	// IMP=0x0010000000077e38
@property(readonly) _Bool hasBytesAvailable;
- (void)dealloc;	// IMP=0x0010000000077cd9
