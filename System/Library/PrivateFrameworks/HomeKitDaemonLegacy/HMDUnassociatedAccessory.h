...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000778ac5
+ (id)logCategory;	// IMP=0x0010000000778a95
+ (id)shortDescription;	// IMP=0x0010000000778a83
+ (id)otherAccessoryCategory;	// IMP=0x0010000000778988
- (void).cxx_destruct;	// IMP=0x0000000000778759
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000778222
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000007780ad
@property(readonly, nonatomic) NSUUID *messageTargetUUID;
- (id)messageDestination;	// IMP=0x0000000000778032
- (id)logIdentifier;	// IMP=0x0000000000778020
- (void)associateWithAccessoryAdvertisement:(id)arg1;	// IMP=0x0000000000777f86
- (void)identifyWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000777e64
- (void)_handleIdentify:(id)arg1;	// IMP=0x0000000000777ce2
@property(readonly, getter=isReachable) _Bool reachable;
- (void)updateCategoryWithCategoryIdentifier:(id)arg1;	// IMP=0x0000000000777ba0
@property(retain) HMAccessoryCategory *category; // @synthesize category=_category;
@property(copy, nonatomic) NSString *name; // @synthesize name=_name;
- (void)_registerForMessages;	// IMP=0x00000000007776a2
- (id)dumpDescription;	// IMP=0x0000000000777571
@property(readonly, copy) NSString *description;
@property(readonly, copy) NSString *debugDescription;
- (id)descriptionWithPointer:(_Bool)arg1 additionalDescription:(id)arg2;	// IMP=0x0000000000777226
- (id)shortDescription;	// IMP=0x000000000077718b
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000007770b0
...
- (void)dealloc;	// IMP=0x0000000000776f46
- (id)initWithIdentifier:(id)arg1 name:(id)arg2 category:(id)arg3 messageDispatcher:(id)arg4;	// IMP=0x0000000000776dad
- (id)init;	// IMP=0x0000000000776d05
