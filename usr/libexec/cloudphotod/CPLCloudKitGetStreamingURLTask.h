...
- (void).cxx_destruct;	// IMP=0x002000000012700f
...
- (void)_fetchStreamingURL;	// IMP=0x0010000000126292
- (void)runOperations;	// IMP=0x0010000000126202
- (_Bool)shouldRequestEncryptedStream;	// IMP=0x00100000001261a9
- (id)_streamOperationForKey:(id)arg1 operationType:(long long)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00100000001257a6
- (id)initWithController:(id)arg1 resource:(id)arg2 hints:(id)arg3 timeRange:(CDStruct_e83c9415)arg4 target:(id)arg5 transportScopeMapping:(id)arg6 cache:(id)arg7 completionHandler:(CDUnknownBlockType)arg8;	// IMP=0x00100000001255c1
