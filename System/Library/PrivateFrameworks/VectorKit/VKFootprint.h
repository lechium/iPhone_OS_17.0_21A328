...
- (id).cxx_construct;	// IMP=0x000000000008f90e
...
- (CDUnknownBlockType)annotationCoordinateTest;	// IMP=0x000000000008f6b5
- (CDUnknownBlockType)annotationRectTest;	// IMP=0x000000000008f4fc
- (Box_3d7e3c2c)_expandedBoundingRect;	// IMP=0x000000000008f45c
- (_Bool)containsGroundPoint:(const void *)arg1;	// IMP=0x000000000008f338
- (_Bool)rejectsRect:(const void *)arg1;	// IMP=0x000000000008f101
- (void)computeFromCamera:(id)arg1;	// IMP=0x000000000008ea45
