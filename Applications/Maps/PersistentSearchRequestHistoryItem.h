...
- (void).cxx_destruct;	// IMP=0x0020000000b2d865
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000b2d587
- (unsigned long long)hash;	// IMP=0x0010000000b2cf02
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000b2cc92
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000b2caae
- (void)copyTo:(id)arg1;	// IMP=0x0010000000b2c921
- (void)writeTo:(id)arg1;	// IMP=0x0010000000b2c791
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000b2c784
- (id)dictionaryRepresentation;	// IMP=0x0010000000b2bf56
- (id)description;	// IMP=0x0010000000b2bea7
