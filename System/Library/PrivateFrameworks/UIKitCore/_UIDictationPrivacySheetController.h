...
- (void).cxx_destruct;	// IMP=0x0000000000c2453e
...
- (void)dismiss;	// IMP=0x0000000000c24438
- (id)initWithType:(long long)arg1;	// IMP=0x0000000000c2419f
- (_Bool)_canShowWhileLocked;	// IMP=0x0000000000c24197
