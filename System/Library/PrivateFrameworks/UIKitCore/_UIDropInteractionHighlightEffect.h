...
- (void).cxx_destruct;	// IMP=0x000000000070db98
...
- (void)dealloc;	// IMP=0x000000000070dae4
- (struct CGRect)highlightRectInView:(id)arg1 forDragInteraction:(id)arg2 withContext:(id)arg3;	// IMP=0x000000000070da29
- (struct CGRect)clippingRectInView:(id)arg1 forView:(id)arg2;	// IMP=0x000000000070d72a
- (void)interaction:(id)arg1 didChangeWithContext:(id)arg2;	// IMP=0x000000000070d508
- (void)removeShapeLayer;	// IMP=0x000000000070d4d6
- (id)updateShapeLayerForFrame:(struct CGRect)arg1 inView:(id)arg2;	// IMP=0x000000000070d154
- (id)init;	// IMP=0x000000000070d0d5
