...
- (void).cxx_destruct;	// IMP=0x0000000000078c0b
...
- (id)infoCardChildUnactionableUIElements;	// IMP=0x0000000000078abe
- (id)infoCardChildPossibleActions;	// IMP=0x00000000000788a7
- (void)placeCardActionSectionView:(id)arg1 buttonWithActionItemPressed:(id)arg2;	// IMP=0x00000000000787ad
- (void)sectionView:(id)arg1 didSelectRow:(id)arg2 atIndex:(unsigned long long)arg3;	// IMP=0x0000000000078556
- (void)_setUpSectionViews;	// IMP=0x0000000000077bb2
- (id)_makePlaceActionButton;	// IMP=0x0000000000077b7d
- (void)viewDidAppear:(_Bool)arg1;	// IMP=0x0000000000077b1f
- (void)viewDidLoad;	// IMP=0x0000000000077a3d
- (id)init;	// IMP=0x00000000000779fe
