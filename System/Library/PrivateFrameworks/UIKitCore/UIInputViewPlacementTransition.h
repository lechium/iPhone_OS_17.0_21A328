...
+ (id)transitionForExistingPlacement:(id)arg1 animationStyle:(id)arg2;	// IMP=0x0060000000cb107a
+ (id)transitionFromPlacement:(id)arg1 toPlacement:(id)arg2 withAnimationStyle:(id)arg3;	// IMP=0x0060000000cb0fc6
- (void).cxx_destruct;	// IMP=0x0000000000cb132b
...
- (void)dealloc;	// IMP=0x0000000000cb1204
- (_Bool)didAdvanceAnimationToState:(int)arg1;	// IMP=0x0000000000cb111a
