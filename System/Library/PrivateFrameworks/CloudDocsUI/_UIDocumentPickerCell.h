...
+ (struct CGSize)thumbnailSizeForTraits:(id)arg1 cellStyle:(long long)arg2;	// IMP=0x0060000000001784
+ (id)_subtitleFontForTable:(_Bool)arg1;	// IMP=0x00600000000016f8
+ (id)_titleFontForTable:(_Bool)arg1;	// IMP=0x006000000000166c
+ (struct CGSize)defaultSizeForCellStyle:(long long)arg1 traitCollection:(id)arg2;	// IMP=0x0060000000001448
...
- (void)_showPickableDiagnostic;	// IMP=0x0000000000007acc
- (_Bool)canBecomeFirstResponder;	// IMP=0x0000000000007ac4
- (id)targetForAction:(SEL)arg1 withSender:(id)arg2;	// IMP=0x00000000000079d1
- (_Bool)canPerformAction:(SEL)arg1 withSender:(id)arg2;	// IMP=0x00000000000079c1
- (void)_showActions:(id)arg1;	// IMP=0x000000000000784f
- (void)updateActionGestureRecognizer;	// IMP=0x0000000000007686
- (void)_moveAction:(id)arg1;	// IMP=0x00000000000075bd
- (void)_activityAction:(id)arg1;	// IMP=0x00000000000074f4
- (void)_renameAction:(id)arg1;	// IMP=0x000000000000742b
- (void)_moreAction:(id)arg1;	// IMP=0x0000000000007362
- (void)_infoAction:(id)arg1;	// IMP=0x0000000000007299
- (void)_deleteAction:(id)arg1;	// IMP=0x00000000000071d3
- (void)setHighlighted:(_Bool)arg1;	// IMP=0x0000000000006c61
- (void)setSelected:(_Bool)arg1;	// IMP=0x0000000000006c01
- (void)_udpateLabelAlpha;	// IMP=0x0000000000006967
- (void)applyLayoutAttributes:(id)arg1;	// IMP=0x0000000000006710
- (void)updateForEditingState:(_Bool)arg1;	// IMP=0x000000000000661e
- (void)_updateConstraintsForCellStyle;	// IMP=0x0000000000003867
- (void)setEditing:(_Bool)arg1;	// IMP=0x0000000000003804
- (void)_updateSeparatorInset;	// IMP=0x0000000000003788
- (void)_updateAccessoryType;	// IMP=0x00000000000035f8
- (void)_updateFonts;	// IMP=0x0000000000003470
- (void)_updateSelectionState:(_Bool)arg1;	// IMP=0x000000000000287f
- (void)_updateIconSize;	// IMP=0x000000000000279e
- (void)reloadItem:(_Bool)arg1;	// IMP=0x0000000000002798
- (void)dealloc;	// IMP=0x000000000000274f
- (void)didTransitionFromLayout:(id)arg1 toLayout:(id)arg2;	// IMP=0x000000000000270c
- (void)willTransitionFromLayout:(id)arg1 toLayout:(id)arg2;	// IMP=0x000000000000267e
- (void)prepareForReuse;	// IMP=0x00000000000024e4
- (void)_dynamicTypeSizeChanged:(id)arg1;	// IMP=0x00000000000023ad
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x000000000000236c
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000001837
