...
- (void).cxx_destruct;	// IMP=0x000000000016cd35
...
- (id)predictionFromFeatures:(id)arg1 options:(id)arg2 error:(id *)arg3;	// IMP=0x000000000016c57d
- (id)featureValueFromDetectionPrint:(id)arg1 featureName:(id)arg2;	// IMP=0x000000000016c347
- (id)initWithModelDescription:(id)arg1 parameterDictionary:(id)arg2 error:(id *)arg3;	// IMP=0x000000000016b522
