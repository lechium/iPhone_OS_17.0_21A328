...
- (void).cxx_destruct;	// IMP=0x00000000001ba5bd
...
- (id)_saturationBackgroundImageWithSize:(struct CGSize)arg1;	// IMP=0x00000000001ba459
- (id)imageForImage:(id)arg1;	// IMP=0x00000000001b9fd4
