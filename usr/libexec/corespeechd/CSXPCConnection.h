...
- (void).cxx_destruct;	// IMP=0x002000000012d419
...
- (void)_handlePingPongMessage:(id)arg1 client:(id)arg2;	// IMP=0x001000000012d201
- (void)_notifyXPCDisconnectionToProxy:(id)arg1;	// IMP=0x001000000012d1a6
- (void)_notifyXPCDisconnectionToProxies;	// IMP=0x001000000012d0fc
- (void)_handleClientError:(id)arg1 client:(id)arg2;	// IMP=0x001000000012cf01
- (void)_handleSetXPCClientTypeMessage:(id)arg1 messageBody:(id)arg2 client:(id)arg3;	// IMP=0x001000000012cda7
- (void)_handleAudioProvidingRequestTypeSwitchMessage:(id)arg1 messageBody:(id)arg2 client:(id)arg3;	// IMP=0x001000000012cc0a
- (void)_handleAudioProvidingMessage:(id)arg1 messageBody:(id)arg2 client:(id)arg3;	// IMP=0x001000000012ca28
- (void)_handleClientMessage:(id)arg1 client:(id)arg2;	// IMP=0x001000000012c705
- (void)_handleClientEvent:(id)arg1;	// IMP=0x001000000012c59f
- (void)sendMessageToClient:(id)arg1;	// IMP=0x001000000012c46a
- (void)activateConnection;	// IMP=0x001000000012c3bb
- (_Bool)_getAudioProvideWithContext:(id)arg1 streamClientType:(unsigned long long)arg2;	// IMP=0x001000000012c174
- (id);	// IMP=0x001000000012bf5f
