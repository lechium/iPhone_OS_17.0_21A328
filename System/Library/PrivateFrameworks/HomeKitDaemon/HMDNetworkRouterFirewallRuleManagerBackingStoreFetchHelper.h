...
+ (unsigned long long)maxOperationDurationSeconds;	// IMP=0x0010000000014192
+ (unsigned long long)maxRetryCount;	// IMP=0x0010000000014174
+ (unsigned long long)__integerForPreferenceKey:(id)arg1 defaultValue:(unsigned long long)arg2;	// IMP=0x0010000000014090
+ (id)logCategory;	// IMP=0x0010000000014060
- (void).cxx_destruct;	// IMP=0x0000000000013ffc
...
- (void)finishWithResult:(id)arg1 error:(id)arg2;	// IMP=0x0000000000013bdd
- (void)finishWithError:(id)arg1;	// IMP=0x0000000000013bc6
- (void)finishWithResult:(id)arg1;	// IMP=0x0000000000013bb2
@property(nonatomic) _Bool shouldRetry;
- (void)dealloc;	// IMP=0x00000000000136ae
- (id)initWithActivity:(id)arg1 options:(id)arg2 container:(id)arg3 useAnonymousRequests:(_Bool)arg4 promise:(id)arg5;	// IMP=0x00000000000134c7
