...
- (void).cxx_destruct;	// IMP=0x0000000000064e7e
...
- (id)applyUpdatesWithElement:(id)arg1;	// IMP=0x0000000000064d91
- (id)initWithDOMElement:(id)arg1 parent:(id)arg2 elementFactory:(id)arg3;	// IMP=0x00000000000649e1
