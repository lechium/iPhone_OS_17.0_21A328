...
- (void).cxx_destruct;	// IMP=0x0020000000ce66d3
@property(readonly, nonatomic) SearchResult *searchResult; // @synthesize searchResult=_searchResult;
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000ce65df
@property(readonly) unsigned long long hash;
- (id)initWithSearchResult:(id)arg1 backgroundModel:(id)arg2;	// IMP=0x0010000000ce6430
