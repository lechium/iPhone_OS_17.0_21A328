...
- (void).cxx_destruct;	// IMP=0x000000000005fecb
...
- (double)rate;	// IMP=0x000000000005fe40
- (long long)timeControlStatus;	// IMP=0x000000000005fe35
- (long long)status;	// IMP=0x000000000005fe2a
- (_Bool)isPlaying;	// IMP=0x000000000005fe22
