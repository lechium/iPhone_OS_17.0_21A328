...
+ (_Bool)supportsSecureCoding;	// IMP=0x0020000000005e6c
...
- (id)description;	// IMP=0x00100000000065f0
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000006139
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000006041
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000005f45
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000005e74
- (id)init;	// IMP=0x0010000000005dcb
