...
- (void).cxx_destruct;	// IMP=0x0000000000497936
...
- (void)rebaseDataSourceIndexPathsWithUpdateMap:(id)arg1;	// IMP=0x0000000000497411
@property(readonly, nonatomic) NSArray *draggingDataSourceIndexPaths;
- (_Bool)isDraggingFromDataSourceIndexPath:(id)arg1;	// IMP=0x0000000000497353
- (id)dataSourceIndexPathForDragItem:(id)arg1 forCollectionView:(id)arg2;	// IMP=0x0000000000497292
- (void)setDataSourceIndexPath:(id)arg1 forDragItem:(id)arg2 collectionView:(id)arg3;	// IMP=0x0000000000497188
- (void)addDraggingDataSourceIndexPath:(id)arg1;	// IMP=0x000000000049716b
@property(readonly, nonatomic) NSIndexPath *dragFromDataSourceIndexPath;
- (id)description;	// IMP=0x0000000000496ff2
- (id)init;	// IMP=0x0000000000496f6d
