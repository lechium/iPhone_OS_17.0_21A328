...
+ (id)descriptionWithTension:(double)arg1 friction:(double)arg2;	// IMP=0x00600000015b005a
+ (id)descriptionWithSpringAnimationParameters:(CDStruct_6c8af1d9)arg1;	// IMP=0x00600000015affde
