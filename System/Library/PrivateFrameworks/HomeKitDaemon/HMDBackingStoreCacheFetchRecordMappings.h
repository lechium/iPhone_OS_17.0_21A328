...
- (void).cxx_destruct;	// IMP=0x000000000022d520
...
- (id)mainReturningError;	// IMP=0x000000000022d253
- (id)initWithGroup:(id)arg1 fetchResult:(CDUnknownBlockType)arg2;	// IMP=0x000000000022d197
