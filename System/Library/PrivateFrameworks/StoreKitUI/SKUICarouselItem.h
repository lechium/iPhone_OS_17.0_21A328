...
- (void).cxx_destruct;	// IMP=0x00000000002b4aa8
...
- (id)description;	// IMP=0x00000000002b49e5
- (void)_setLinkItem:(id)arg1;	// IMP=0x00000000002b49cf
- (id)artworkForSize:(struct CGSize)arg1;	// IMP=0x00000000002b4929
- (id)initWithComponentContext:(id)arg1;	// IMP=0x00000000002b4605
