...
- (void).cxx_destruct;	// IMP=0x000000000055922c
...
- (void)setVelocity:(struct PUDisplayVelocity)arg1 forTileController:(id)arg2;	// IMP=0x000000000055911a
- (struct PUDisplayVelocity)velocityForTileController:(id)arg1;	// IMP=0x0000000000559065
