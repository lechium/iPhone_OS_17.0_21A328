...
- (void).cxx_destruct;	// IMP=0x0020000000032662
@property(readonly, nonatomic) BKMousePointerController *mousePointerController;
- (long long)processEvent:(inout struct __IOHIDEvent **)arg1 sender:(id)arg2 dispatcher:(id)arg3;	// IMP=0x0010000000032604
- (id)init;	// IMP=0x0010000000032520
