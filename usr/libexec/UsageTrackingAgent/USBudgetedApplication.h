...
- (_Bool)_validateBudget:(id)arg1 andEvent:(id)arg2 error:(out id *)arg3;	// IMP=0x0020000000002a34
- (_Bool)validateEvent:(inout id *)arg1 error:(out id *)arg2;	// IMP=0x00100000000029cf
- (_Bool)validateBudget:(inout id *)arg1 error:(out id *)arg2;	// IMP=0x001000000000296a
