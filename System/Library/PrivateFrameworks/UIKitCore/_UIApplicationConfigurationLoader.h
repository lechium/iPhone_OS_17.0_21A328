...
+ (id)sharedLoader;	// IMP=0x0040000000a5559e
- (void).cxx_destruct;	// IMP=0x0000000000a55c00
@property(readonly, nonatomic) UISApplicationInitializationContext *applicationInitializationContext;
- (void)startPreloadInitializationContext;	// IMP=0x0000000000a55a79
- (id)_loadInitializationContext;	// IMP=0x0000000000a5583e
- (id)_appInitializationContextFactoryClass;	// IMP=0x0000000000a5577d
@property(readonly, nonatomic) _Bool usesLocalInitializationContext;
@property(readonly, nonatomic) _Bool isFrontBoard;
- (void)dealloc;	// IMP=0x0000000000a55654
- (id)_init;	// IMP=0x0000000000a55625
