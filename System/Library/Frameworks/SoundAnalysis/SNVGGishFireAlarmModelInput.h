...
- (void).cxx_destruct;	// IMP=0x0000000000124f4f
...
- (id)featureValueForName:(id)arg1;	// IMP=0x0000000000124da6
@property(readonly, nonatomic) NSSet *featureNames;
- (id)initWithInput1:(id)arg1 stateIn:(id)arg2 detectedHistoryIn:(id)arg3;	// IMP=0x0000000000124cce
- (id)initWithInput1:(id)arg1;	// IMP=0x0000000000124cb7
