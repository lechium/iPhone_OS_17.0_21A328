...
+ (_Bool)migrateFromVersion:(unsigned long long)arg1 finalVersion:(out unsigned long long *)arg2 inDatabase:(id)arg3;	// IMP=0x0020000000109938
+ (id)identityColumnName;	// IMP=0x00100000001092d0
+ (id)entityName;	// IMP=0x00100000001092a4
- (void).cxx_destruct;	// IMP=0x002000000010a807
...
// Error: Property attributes should begin with the type ('T') attribute, property name: entityIdentity
...
- (void)bindTo:(id)arg1;	// IMP=0x001000000010975e
- (id)initWithDatabaseRow:(id)arg1;	// IMP=0x0010000000109566
- (id)initWithObject:(id)arg1 state:(long long)arg2;	// IMP=0x00100000001093f8
