...
- (void).cxx_destruct;	// IMP=0x0000000000185384
...
- (void)performBlockAfterFirstUnlock:(CDUnknownBlockType)arg1;	// IMP=0x00100000001850a5
- (void)_handleDeviceFirstUnlockNotification;	// IMP=0x0010000000184eda
- (void)_refreshHasBeenUnlocked;	// IMP=0x0010000000184d8e
- (id)initWithQueue:(id)arg1;	// IMP=0x0010000000184d77
- (id)initWithNotifyObserver:(id)arg1 queue:(id)arg2;	// IMP=0x0010000000184bc8
