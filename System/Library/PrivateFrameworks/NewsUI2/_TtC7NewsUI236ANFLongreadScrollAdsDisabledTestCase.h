...
@interface _TtC7NewsUI236ANFLongreadScrollAdsDisabledTestCase : NSObject
{
...
- (void).cxx_destruct;	// IMP=0x000000000058b690
- (id)init;	// IMP=0x000000000058b640
- (id)scrollViewWithContext:(id)arg1;	// IMP=0x000000000058b4e0
