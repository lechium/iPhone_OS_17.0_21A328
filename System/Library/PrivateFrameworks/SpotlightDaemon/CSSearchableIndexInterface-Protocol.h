...
@optional
- (void)fetchAttributes:(NSArray *)arg1 protectionClass:(NSString *)arg2 bundleID:(NSString *)arg3 identifiers:(NSObject *)arg4 includeParents:(_Bool)arg5 qos:(unsigned int)arg6 completionHandler:(void (^)(id, NSError *))arg7;
...
- (void)_issueDiagnose:(int)arg1 completionHandler:(void (^)(NSData *, NSError *))arg2;
