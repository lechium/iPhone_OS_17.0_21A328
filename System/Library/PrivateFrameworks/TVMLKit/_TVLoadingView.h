...
- (void).cxx_destruct;	// IMP=0x000000000001a235
...
- (void)_showSpinner;	// IMP=0x0000000000019fea
- (_Bool)canBecomeFocused;	// IMP=0x0000000000019fe2
- (void)layoutSubviews;	// IMP=0x0000000000019bac
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000019a67
