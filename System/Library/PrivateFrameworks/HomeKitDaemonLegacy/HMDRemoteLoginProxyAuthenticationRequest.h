...
+ (id)xpcMessageName;	// IMP=0x001000000037d463
+ (id)messageName;	// IMP=0x001000000037d456
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000037d44e
+ (id)objWithMessage:(id)arg1;	// IMP=0x001000000037d2b7
+ (id)objWithDict:(id)arg1;	// IMP=0x001000000037d13e
- (void).cxx_destruct;	// IMP=0x000000000037d0eb
...
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000037cef6
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000037cdbb
