...
- (id).cxx_construct;	// IMP=0x000000000008b164
- (void).cxx_destruct;	// IMP=0x000000000008b10e
...
- (void)updateCamera:(shared_ptr_46708168)arg1;	// IMP=0x000000000008adf7
- (CameraFrame_b765d6d7)cameraFrame:(_Bool)arg1;	// IMP=0x000000000008ac5e
- (View_a667aa2f)view:(struct ViewSize)arg1;	// IMP=0x000000000008abb4
...
- (void)adjustClipPlanes;	// IMP=0x000000000008a9e1
- (float)zoomAtCentrePoint;	// IMP=0x000000000008a9c4
- (float)zoomAtPoint:(struct CGPoint)arg1;	// IMP=0x000000000008a916
- (double)depthForViewWidth:(double)arg1;	// IMP=0x000000000008a8e5
- (double)widthOfViewAtDepth:(double)arg1;	// IMP=0x000000000008a8bc
- (struct CGPoint)screenPointFromGroundPoint:(const void *)arg1;	// IMP=0x000000000008a804
- (optional_67826ebe)groundPointFromScreenPoint:(struct CGPoint)arg1 atGroundLevel:(double)arg2;	// IMP=0x000000000008a621
- (optional_67826ebe)groundPointFromScreenPoint:(struct CGPoint)arg1;	// IMP=0x000000000008a5ff
- (void)updateIfNeeded;	// IMP=0x0000000000089b9a
- (void)setNeedsUpdate;	// IMP=0x0000000000089b6b
- (CDUnknownBlockType)annotationCoordinateTest;	// IMP=0x0000000000089b55
- (CDUnknownBlockType)annotationRectTest;	// IMP=0x0000000000089b3f
- (Matrix_6e1d3589)groundPlaneIntersectionPoint;	// IMP=0x00000000000899f5
@property(nonatomic) struct VKCameraState cameraState;
@property(readonly, nonatomic) double yaw;
@property(readonly, nonatomic) double pitch;
- (double)displayZoomLevel;	// IMP=0x0000000000089733
...
- (Mercator3_d8bb135c)mercatorPosition;	// IMP=0x0000000000089148
- (void)setMercatorPosition:(const void *)arg1;	// IMP=0x0000000000088fe4
- (void)_setPosition:(const void *)arg1;	// IMP=0x0000000000088fb9
- (id)descriptionDictionaryRepresentation;	// IMP=0x0000000000088c96
- (id)description;	// IMP=0x0000000000088ab6
- (id)detailedDescription;	// IMP=0x0000000000088aa4
- (id)initWithRunLoopController:(struct RunLoopController *)arg1;	// IMP=0x000000000008892c
