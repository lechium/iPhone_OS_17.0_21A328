...
+ (id)directionsWaypointWithNanoDirectionWaypoint:(id)arg1;	// IMP=0x0010000000356aa4
- (void).cxx_destruct;	// IMP=0x0010000000cb513b
...
- (id)description;	// IMP=0x0010000000cb4ccb
- (unsigned long long)hash;	// IMP=0x0010000000cb4c62
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000cb490d
...
- (_Bool)containsSearchResult:(id)arg1;	// IMP=0x0010000000cb46ce
@property(readonly, nonatomic) NSString *hawkQueryRepresentation;
@property(readonly, nonatomic) NSString *location;
@property(readonly, nonatomic, getter=isValid) _Bool valid;
- (void)updateFromGEOComposedWaypoint:(id)arg1;	// IMP=0x0010000000cb4038
- (id)nanoDirectionWaypoint;	// IMP=0x0010000000356d36
