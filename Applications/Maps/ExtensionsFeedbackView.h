...
- (void).cxx_destruct;	// IMP=0x0020000000793f19
...
- (void)configureTippingViewWithDelegate:(id)arg1;	// IMP=0x0010000000793d91
- (void)configureSubmitButtonTitle:(id)arg1;	// IMP=0x0010000000793c11
- (void)configureHeaderImage:(id)arg1;	// IMP=0x0010000000793bc4
- (void)_submitTapped:(id)arg1;	// IMP=0x0010000000793b8e
- (void)_updateSubmitButton;	// IMP=0x0010000000793b0d
- (void)_updateConstraints;	// IMP=0x00100000007936d2
- (void)updateTheme;	// IMP=0x0010000000793664
- (void)_commonInit;	// IMP=0x00100000007932e7
- (id)initWithSubmitHandler:(CDUnknownBlockType)arg1;	// IMP=0x0010000000793241
