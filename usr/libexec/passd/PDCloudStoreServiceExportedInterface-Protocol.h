...
@class MISSING_TYPE, NSArray, NSDate, NSSet, NSString, PKCloudStoreZoneQueryConfiguration, PKPaymentTransaction;

@protocol PDCloudStoreServiceExportedInterface <PDXPCServiceExportedInterface>
- (void)changeHistoryForContainerIdentifier:(NSString *)arg1 completion:(void (^)(NSArray *, NSError *))arg2;
...
- (MISSING_TYPE *)removeRecordWithRecordName:zoneName:containerName:completion: /* Error: Ran out of types for this method. */;
