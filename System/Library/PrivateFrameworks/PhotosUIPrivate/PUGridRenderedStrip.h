...
- (void).cxx_destruct;	// IMP=0x000000000025bbe9
...
- (_Bool)_disableRasterizeInAnimations;	// IMP=0x000000000025ba9c
- (void)applyLayoutAttributes:(id)arg1;	// IMP=0x000000000025b9d2
- (void)_updateExtendedContents;	// IMP=0x000000000025b8e8
- (void)_render;	// IMP=0x000000000025b099
@property(readonly, nonatomic) long long numberOfColumns;
- (void)setVisualSectionIndex:(long long)arg1 andVisualItemRange:(struct _NSRange)arg2;	// IMP=0x000000000025ae74
- (void)setNeedsRendering;	// IMP=0x000000000025ac8f
- (void)layoutSubviews;	// IMP=0x000000000025a7de
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000025a752
