...
- (void).cxx_destruct;	// IMP=0x002000000072ec97
...
- (void)showFlag:(_Bool)arg1;	// IMP=0x001000000072e9ef
- (void)viewTapped;	// IMP=0x001000000072e975
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x001000000072e44c
