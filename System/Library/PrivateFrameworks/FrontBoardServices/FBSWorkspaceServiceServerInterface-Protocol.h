...
- (oneway void)createSceneWithIdentity:(FBSSceneIdentity *)arg1 parameters:(FBSSceneParameters *)arg2 transitionContext:(FBSSceneTransitionContext *)arg3 completion:(void (^)(FBSWorkspaceSceneUpdateResponse *, NSError *))arg4;
@end
