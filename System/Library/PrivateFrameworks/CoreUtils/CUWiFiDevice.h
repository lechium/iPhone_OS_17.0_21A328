...
- (void).cxx_destruct;	// IMP=0x00000000000c11b4
...
- (unsigned int)_updateWithDeviceIE:(const char *)arg1 end:(const char *)arg2;	// IMP=0x00000000000c0691
- (id)description;	// IMP=0x00000000000c04ff
