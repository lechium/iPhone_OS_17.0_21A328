...
+ (id)mediaCatgeoryForType:(unsigned long long)arg1;	// IMP=0x00600000000d76ed
- (void).cxx_destruct;	// IMP=0x00000000000d7e9c
...
- (id)description;	// IMP=0x00000000000d7ab5
- (id)_initWithType:(unsigned long long)arg1;	// IMP=0x00000000000d7a2e
- (id)init;	// IMP=0x00000000000d79bf
