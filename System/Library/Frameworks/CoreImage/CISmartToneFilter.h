...
+ (id)customAttributes;	// IMP=0x006000000019c084
...
- (id)outputImage;	// IMP=0x000000000019cb3b
- (void)setValue:(id)arg1 forKey:(id)arg2;	// IMP=0x000000000019ca9a
- (id)_kernelRH;	// IMP=0x000000000019ca7a
- (id)_kernelH;	// IMP=0x000000000019ca5a
- (id)_kernelC;	// IMP=0x000000000019ca3a
- (id)_kernelBpos;	// IMP=0x000000000019ca1a
- (id)_kernelBneg;	// IMP=0x000000000019c9fa
- (void)dealloc;	// IMP=0x000000000019c97d
- (_Bool)_isIdentity;	// IMP=0x000000000019c847
