...
- (void).cxx_destruct;	// IMP=0x002000000008f478
- (void)appendDescriptionToFormatter:(id)arg1;	// IMP=0x001000000008f41f
@property(readonly, copy) NSString *description;
- (void)dealloc;	// IMP=0x001000000008f277
- (id)init;	// IMP=0x001000000008f227
