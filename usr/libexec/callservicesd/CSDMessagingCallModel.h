...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000051e2c
- (unsigned long long)hash;	// IMP=0x0010000000051d4d
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000051b7c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000051a74
- (void)copyTo:(id)arg1;	// IMP=0x001000000005198f
- (void)writeTo:(id)arg1;	// IMP=0x0010000000051875
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000051868
- (id)dictionaryRepresentation;	// IMP=0x00100000000510a8
- (id)description;	// IMP=0x0010000000050ff9
