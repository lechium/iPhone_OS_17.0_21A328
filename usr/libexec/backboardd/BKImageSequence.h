...
- (void).cxx_destruct;	// IMP=0x0020000000031305
...
- (void)_loadAllImages;	// IMP=0x0010000000031242
- (struct CGImage *)_imageAtIndex:(long long)arg1;	// IMP=0x0010000000030f97
- (id)_idiomSuffix;	// IMP=0x0010000000030f8a
- (struct CGImage *)_createImageForIndex:(unsigned long long)arg1 basename:(id)arg2 scale:(double)arg3 idiom:(id)arg4 bundle:(id)arg5;	// IMP=0x0010000000030c57
- (id)allImages;	// IMP=0x0010000000030c28
- (struct CGImage *)imageAtIndex:(long long)arg1;	// IMP=0x0010000000030c16
- (id)initWithBasename:(id)arg1 bundle:(id)arg2 imageCount:(long long)arg3 scale:(double)arg4;	// IMP=0x0010000000030add
