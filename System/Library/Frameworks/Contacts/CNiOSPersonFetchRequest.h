...
+ (id)effectivePredicate:(id)arg1;	// IMP=0x00600000000fd89a
+ (id)validatePredicate:(id)arg1 error:(id *)arg2;	// IMP=0x00600000000fd7f6
+ (id)fetchRequestFromCNFetchRequest:(id)arg1 managedConfiguration:(id)arg2 error:(id *)arg3;	// IMP=0x00600000000fd5df
+ (long long)resolvedSortOrderFromContactSortOrder:(long long)arg1;	// IMP=0x00600000000fd57b
- (void).cxx_destruct;	// IMP=0x00000000000fd548
...
- (id)initWithPredicate:(id)arg1 keysToFetch:(id)arg2 shouldSort:(_Bool)arg3 sortOrder:(unsigned int)arg4 unifiedFetch:(_Bool)arg5 batchSize:(unsigned long long)arg6 managedConfiguration:(id)arg7 options:(unsigned long long)arg8;	// IMP=0x00000000000fd3a8
