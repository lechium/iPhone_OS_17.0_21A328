...
- (void).cxx_destruct;	// IMP=0x00000000012c5072
@property(readonly, nonatomic) unsigned long long count;
- (_Bool)continueEnumeratingTileKeysWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x00000000012c4c93
- (id)initWithMapRegion:(id)arg1 tileSet:(id)arg2 zoomMode:(long long)arg3;	// IMP=0x00000000012c49f1
