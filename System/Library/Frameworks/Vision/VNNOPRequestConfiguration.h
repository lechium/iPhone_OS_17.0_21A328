...
- (void).cxx_destruct;	// IMP=0x0000000000127c4a
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000127b4d
- (id)initWithRequestClass:(Class)arg1;	// IMP=0x0000000000127a5a
