...
- (void).cxx_destruct;	// IMP=0x0020000000061049
...
- (void)cancel;	// IMP=0x0010000000060fb8
- (void)countDidChange:(long long)arg1 acknowledgementToken:(id)arg2;	// IMP=0x0010000000060ee8
- (id)initWithFavoriteItem:(id)arg1 messagePersistence:(id)arg2 hookRegistry:(id)arg3 countDidChange:(CDUnknownBlockType)arg4;	// IMP=0x00100000000609b4
