...
- (void).cxx_destruct;	// IMP=0x000000000002231f
...
- (id)specifiers;	// IMP=0x0000000000021f00
- (id)initWithListController:(id)arg1 groupSpecifier:(id)arg2;	// IMP=0x0000000000021eaa
- (id)initWithListController:(id)arg1 groupSpecifier:(id)arg2 parentSpecifier:(id)arg3;	// IMP=0x0000000000021e18
