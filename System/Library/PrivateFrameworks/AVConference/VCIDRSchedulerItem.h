...
- (id)description;	// IMP=0x000000000006f583
- (long long)compareBudget:(id)arg1;	// IMP=0x000000000006f52a
- (void)addStream:(id)arg1;	// IMP=0x000000000006f4c5
- (void)dealloc;	// IMP=0x000000000006f467
- (id)init;	// IMP=0x000000000006f3f1
