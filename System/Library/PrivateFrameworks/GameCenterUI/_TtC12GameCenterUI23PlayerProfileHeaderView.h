...
- (void).cxx_destruct;	// IMP=0x00000000004af3a2
...
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x00000000004ae32d
- (void)layoutSubviews;	// IMP=0x00000000004ae290
- (struct JUMeasurements)measurementsWithFitting:(struct CGSize)arg1 in:(id)arg2;	// IMP=0x00000000004adf42
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000004ad977
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000004ad92d
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000004ad68b
