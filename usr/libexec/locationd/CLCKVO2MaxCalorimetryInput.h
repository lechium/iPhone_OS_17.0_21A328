...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000008545bc
- (unsigned long long)hash;	// IMP=0x0010000000853d0c
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000853a06
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000085381d
- (void)copyTo:(id)arg1;	// IMP=0x0010000000853672
- (void)writeTo:(id)arg1;	// IMP=0x0010000000853459
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000085344c
- (id)dictionaryRepresentation;	// IMP=0x00100000008528d2
- (id)description;	// IMP=0x001000000085285b
