...
- (void)removeProfileWithIdentifier:(NSString *)arg1 completionHandler:(void (^)(NSError *))arg2;	// IMP=0x000000000002f413
- (void)installedProfilesWithCompletionHandler:(void (^)(NSDictionary *, NSError *))arg1;	// IMP=0x000000000002f240
- (void)installProfileWithData:(NSData *)arg1 completionHandler:(void (^)(NSString *, NSError *))arg2;	// IMP=0x000000000002ef38
