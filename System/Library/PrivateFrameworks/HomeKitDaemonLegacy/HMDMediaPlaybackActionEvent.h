...
- (void).cxx_destruct;	// IMP=0x00000000006a193b
...
- (id)initWithIsPlaybackArchivePresent:(_Bool)arg1 playbackStateNumber:(id)arg2 volumeNumber:(id)arg3 sourceNumber:(id)arg4 sourceClientName:(id)arg5 accessories:(id)arg6;	// IMP=0x00000000006a11eb
- (id)biomeEventsRepresentationForLogObserver:(id)arg1;	// IMP=0x000000000001cfdc
- (unsigned long long)microLocationScanTriggerTypeForLogEventObserver:(id)arg1;	// IMP=0x0000000000050502
- (_Bool)shouldTriggerMicroLocationRecordingScanForLogEventObserver:(id)arg1;	// IMP=0x0000000000050477
- (_Bool)shouldTriggerMicroLocationLocalizationScanForLogEventObserver:(id)arg1;	// IMP=0x00000000000503ec
- (id)microLocationMetadataForLogEventObserver:(id)arg1;	// IMP=0x0000000000050179
