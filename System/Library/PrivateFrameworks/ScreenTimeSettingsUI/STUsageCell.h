...
- (void).cxx_destruct;	// IMP=0x00000000000b2a30
...
- (void)_didFetchAppInfoOrIcon:(id)arg1;	// IMP=0x00000000000b298f
- (void)refreshCellContentsWithSpecifier:(id)arg1;	// IMP=0x00000000000b2858
- (void)setValue:(id)arg1;	// IMP=0x00000000000b2461
- (id)value;	// IMP=0x00000000000b2423
- (id)initWithStyle:(long long)arg1 reuseIdentifier:(id)arg2 specifier:(id)arg3;	// IMP=0x00000000000b15ec
