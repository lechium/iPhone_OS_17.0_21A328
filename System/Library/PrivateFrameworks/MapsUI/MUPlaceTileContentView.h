...
+ (struct CGSize)_preferredSizeForViewModel:(id)arg1 cellConfiguration:(id)arg2 maximumMeasurements:(id)arg3;	// IMP=0x00100000000d2a0a
+ (struct CGSize)preferredSizeForViewModels:(id)arg1 cellConfiguration:(id)arg2 usingMeasurements:(id)arg3;	// IMP=0x00100000000d281a
+ (double)preferredWidth;	// IMP=0x00100000000d280c
- (void).cxx_destruct;	// IMP=0x00000000000d2f43
@property(retain, nonatomic) id <MUPlaceTileViewModel> viewModel; // @synthesize viewModel=_viewModel;
- (struct CGSize)intrinsicContentSize;	// IMP=0x00000000000d27e7
@property(readonly, nonatomic) UIImageView *tileImageView;
- (void)_updateFonts;	// IMP=0x00000000000d25f0
- (void)_updateAppearance;	// IMP=0x00000000000d1fc6
- (void)_setupConstraints;	// IMP=0x00000000000d1b08
- (void)_setupSubviews;	// IMP=0x00000000000d170e
- (id)initWithCellConfiguration:(id)arg1;	// IMP=0x00000000000d1647
