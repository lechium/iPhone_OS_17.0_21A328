...
- (void).cxx_destruct;	// IMP=0x0020000000353796
...
- (void)purgeData;	// IMP=0x00100000003534a2
- (void)saveData:(id)arg1 allowBackup:(_Bool)arg2;	// IMP=0x0010000000352967
- (id)data;	// IMP=0x001000000035232a
@property(readonly, nonatomic) _Bool isAvailable;
- (id)initWithIdentifier:(id)arg1 dataProtectionClass:(long long)arg2 keychainWrapper:(id)arg3 systemMonitor:(id)arg4 fileDirectory:(id)arg5;	// IMP=0x00100000003521c7
- (id)initWithIdentifier:(id)arg1 dataProtectionClass:(long long)arg2 keychainWrapper:(id)arg3 systemMonitor:(id)arg4;	// IMP=0x00100000003521a1
