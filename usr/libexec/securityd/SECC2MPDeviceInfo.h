...
+ (Class)internalTestConfigType;	// IMP=0x002000000020930c
- (void).cxx_destruct;	// IMP=0x0020000000208eb5
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000208ae2
- (unsigned long long)hash;	// IMP=0x00100000002089af
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000208783
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000208459
- (void)copyTo:(id)arg1;	// IMP=0x0010000000208275
- (void)writeTo:(id)arg1;	// IMP=0x0010000000208031
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000208024
- (id)dictionaryRepresentation;	// IMP=0x0010000000207c64
- (id)description;	// IMP=0x0010000000207bb5
- (id)internalTestConfigAtIndex:(unsigned long long)arg1;	// IMP=0x0010000000207b98
- (unsigned long long)internalTestConfigsCount;	// IMP=0x0010000000207b7b
- (void)addInternalTestConfig:(id)arg1;	// IMP=0x0010000000207b11
- (void)clearInternalTestConfigs;	// IMP=0x0010000000207af4
