...
- (void).cxx_destruct;	// IMP=0x000000000008b478
...
- (id)_createLabelWithLines:(long long)arg1 title:(_Bool)arg2;	// IMP=0x000000000008b307
- (id)_createButtonWithTarget:(id)arg1 selector:(SEL)arg2;	// IMP=0x000000000008b14e
- (void)_bottomLinkSelected:(id)arg1;	// IMP=0x000000000008b109
- (void)layoutSubviews;	// IMP=0x000000000008abf6
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000008aa2b
