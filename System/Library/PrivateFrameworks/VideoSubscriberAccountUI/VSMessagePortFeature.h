...
+ (id)makeFeatureJSObjectForFeature:(id)arg1;	// IMP=0x0010000000015260
- (void).cxx_destruct;	// IMP=0x0000000000015522
...
- (void)messagePort:(id)arg1 didReceiveMessage:(id)arg2;	// IMP=0x0000000000015470
- (id)initWithDOMNode:(id)arg1 featureName:(id)arg2;	// IMP=0x00000000000153a2
