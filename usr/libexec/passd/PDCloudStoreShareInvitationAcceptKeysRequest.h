...
- (void).cxx_destruct;	// IMP=0x00200000001b3357
...
- (id)description;	// IMP=0x00100000001b3250
- (_Bool)canCoalesceRequest:(id)arg1;	// IMP=0x00100000001b2f63
- (id)initWithInvitation:(id)arg1 fromDestination:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x00100000001b2eb9
