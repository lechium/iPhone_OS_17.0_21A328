...
+ (id)logCategory;	// IMP=0x00100000004614df
- (void).cxx_destruct;	// IMP=0x00000000004613a2
...
- (void)_sendImageSendFailure:(id)arg1;	// IMP=0x0000000000460f5a
- (id)logIdentifier;	// IMP=0x0000000000460f0a
- (id)initWithSessionID:(id)arg1 workQueue:(id)arg2 device:(id)arg3 accessory:(id)arg4 delegateQueue:(id)arg5 uniqueIdentifier:(id)arg6;	// IMP=0x0000000000460d81
