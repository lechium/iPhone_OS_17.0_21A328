...
- (void).cxx_destruct;	// IMP=0x002000000036d6eb
...
- (void)setUint32Key:(unsigned int)arg1;	// IMP=0x001000000036d33e
- (unsigned int)uint32Key;	// IMP=0x001000000036d332
...
- (void)_createStallDetectorWithName:(id)arg1;	// IMP=0x001000000036cbdc
- (void)_triggerStallDetectionLogsForDetector:(id)arg1 withEvent:(id)arg2;	// IMP=0x001000000036c79f
- (void)reportToAWD:(unsigned long long)arg1 connectionType:(int)arg2 error:(int)arg3;	// IMP=0x001000000036c606
- (void)invalidate;	// IMP=0x001000000036c001
- (void)dealloc;	// IMP=0x001000000036bf78
- (void)_closeSockets;	// IMP=0x001000000036bb72
@property(nonatomic) NSObject<OS_dispatch_queue> *completionQueue;
- (id)initWithAddressPair:(id)arg1 protocol:(int)arg2;	// IMP=0x001000000036b8a1
- (id)flagsString;	// IMP=0x001000000036b7f1
- (CDStruct_eff2b79e *)encryptionState;	// IMP=0x001000000036b7e4
- (id)description;	// IMP=0x001000000036b3d4
- (id)initWithConnectionID:(id)arg1 protocol:(int)arg2 keyMaterialLength:(int)arg3 isCloudEnabled:(_Bool)arg4;	// IMP=0x001000000036b0a7
- (id)initWithConnectionID:(id)arg1 protocol:(int)arg2 isCloudEnabled:(_Bool)arg3;	// IMP=0x001000000036ad89
