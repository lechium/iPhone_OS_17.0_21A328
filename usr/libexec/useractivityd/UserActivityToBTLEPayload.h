...
- (void).cxx_destruct;	// IMP=0x0020000000058567
...
- (id)description;	// IMP=0x00100000000580bd
- (id)encodeAsData;	// IMP=0x001000000005781e
- (id)initWithData:(id)arg1;	// IMP=0x0010000000056e28
- (void)addAdditionalItem:(id)arg1 forKey:(id)arg2;	// IMP=0x0010000000056d1d
@property(readonly, copy) NSDictionary *additionalItems;
- (id)initWithNSError:(id)arg1;	// IMP=0x0010000000056c97
- (id)init:(id)arg1 title:(id)arg2 date:(id)arg3 userInfoPayload:(id)arg4 teamID:(id)arg5 activityType:(id)arg6;	// IMP=0x0010000000056ac0
