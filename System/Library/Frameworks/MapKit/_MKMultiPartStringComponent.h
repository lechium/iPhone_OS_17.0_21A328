...
- (void).cxx_destruct;	// IMP=0x000000000007f7a3
...
- (id)description;	// IMP=0x000000000007f6b8
- (id)initWithAttributedString:(id)arg1 range:(struct _NSRange)arg2;	// IMP=0x000000000007f61f
