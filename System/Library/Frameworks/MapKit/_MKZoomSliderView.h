...
- (void).cxx_destruct;	// IMP=0x00000000000b0bf1
@property(nonatomic, getter=isActive) _Bool active; // @synthesize active=_active;
@property(nonatomic) double zoomFraction; // @synthesize zoomFraction=_zoomFraction;
- (void)updateConstraints;	// IMP=0x00000000000afe5c
- (void)setBounds:(struct CGRect)arg1;	// IMP=0x00000000000afe0a
- (void)didMoveToWindow;	// IMP=0x00000000000afcc3
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000000aee75
