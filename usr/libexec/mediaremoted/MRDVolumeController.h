...
+ (id)allocWithZone:(struct _NSZone *)arg1;	// IMP=0x004000000001984e
- (void).cxx_destruct;	// IMP=0x0020000000019948
...
- (void)setIsMuted:(_Bool)arg1 error:(id *)arg2;	// IMP=0x001000000001991b
- (void)adjustVolume:(long long)arg1 error:(id *)arg2;	// IMP=0x0010000000019915
- (void)adjustVolumeWithStepAmount:(float)arg1 error:(id *)arg2;	// IMP=0x001000000001990f
- (void)setVolume:(float)arg1 error:(id *)arg2;	// IMP=0x0010000000019909
- (id)initWithRoutingDataSource:(id)arg1;	// IMP=0x001000000001989e
