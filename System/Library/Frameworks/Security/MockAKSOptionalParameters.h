...
- (void).cxx_destruct;	// IMP=0x000000000006ae53
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000006ad61
- (unsigned long long)hash;	// IMP=0x000000000006acf4
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000006ac14
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000006ab50
- (void)copyTo:(id)arg1;	// IMP=0x000000000006aacd
- (void)writeTo:(id)arg1;	// IMP=0x000000000006aa53
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000006a8c7
- (id)dictionaryRepresentation;	// IMP=0x000000000006a81d
- (id)description;	// IMP=0x000000000006a76e
