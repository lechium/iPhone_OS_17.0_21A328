...
+ (id)op:(unsigned long long)arg1 column:(unsigned long long)arg2;	// IMP=0x004000000003090a
...
- (id)initWithOperation:(unsigned long long)arg1 columnName:(unsigned long long)arg2;	// IMP=0x001000000003089a
