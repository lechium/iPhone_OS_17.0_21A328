...
- (_Bool)px_isTransientCollectionWithIdentifier:(id)arg1;	// IMP=0x0020000000a4f426
@property(readonly, nonatomic) NSURL *px_navigationURL;
- (id)px_navigationURLWithSelectedObject:(id)arg1;	// IMP=0x0020000000a4f26a
- (id)px_navigationURLComponents;	// IMP=0x0020000000a4f118
- (id)px_navigationURLQueryItemWithPrefix:(id)arg1;	// IMP=0x0020000000a4efdd
- (id)px_navigationWellKnownName;	// IMP=0x0020000000a4ef35
- (id)px_navigationURLHost;	// IMP=0x0020000000a4ee8d
@property(readonly, nonatomic) NSDictionary *px_debugDictionary;
- (_Bool)px_fetchIsEmptyWithOptions:(id)arg1;	// IMP=0x0020000000a4ed1d
- (_Bool)px_fetchIsEmpty;	// IMP=0x0020000000a4eca2
- (id)px_fetchContainedAssetCollections;	// IMP=0x0020000000a4ebe5
- (id)px_fetchAncestryIncludingRoot:(_Bool)arg1;	// IMP=0x0020000000a4ea3e
- (id)px_fetchContainerTitle;	// IMP=0x0020000000a4e8e7
