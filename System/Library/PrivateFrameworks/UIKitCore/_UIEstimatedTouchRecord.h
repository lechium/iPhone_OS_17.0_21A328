...
- (void).cxx_destruct;	// IMP=0x0000000001094eaa
...
- (void)dispatchUpdateWithPressure:(double)arg1 stillEstimated:(_Bool)arg2;	// IMP=0x0000000001094c45
- (void)removeTouchable:(id)arg1;	// IMP=0x0000000001094c2f
- (void)addTouchable:(id)arg1;	// IMP=0x0000000001094bd5
- (id)initWithLiveTouch:(id)arg1 freezeTouch:(id)arg2 contextID:(id)arg3;	// IMP=0x0000000001094b1d
