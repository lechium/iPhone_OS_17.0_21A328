...
- (unsigned long long)hash;	// IMP=0x000000000027eac5
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000027e9d9
- (id)initWithPersistentID:(unsigned long long)arg1 size:(struct CGSize)arg2;	// IMP=0x000000000027e97e
