...
- (void).cxx_destruct;	// IMP=0x0010000000010ef7
@property(readonly, getter=isManaging) _Bool managing; // @synthesize managing=_managing;
@property(readonly) NSData *state;
- (id)isApplicationIdentifierEligibleForManagedMode:(id)arg1 error:(id *)arg2;	// IMP=0x0010000000010b28
- (id)serviceSpecifiersForApplicationIdentifier:(id)arg1 error:(id *)arg2;	// IMP=0x0010000000010942
- (id)init;	// IMP=0x0010000000010881
- (void)_loadEnterpriseData;	// IMP=0x0010000000010f2a
