...
- (void).cxx_destruct;	// IMP=0x000000000051903e
...
- (_Bool)removeDisplayContext:(id)arg1;	// IMP=0x0000000000518ee2
- (_Bool)addDisplayContext:(id)arg1;	// IMP=0x0000000000518e35
- (id)init;	// IMP=0x0000000000518db5
