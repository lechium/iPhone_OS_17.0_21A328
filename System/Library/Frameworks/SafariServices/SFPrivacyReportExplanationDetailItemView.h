...
- (void).cxx_destruct;	// IMP=0x000000000014fd05
...
- (_Bool)textView:(id)arg1 shouldInteractWithURL:(id)arg2 inRange:(struct _NSRange)arg3 interaction:(long long)arg4;	// IMP=0x000000000014fc55
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x000000000014fb31
- (void)_updateTopSpacing;	// IMP=0x000000000014faa8
- (void)_updateTopConstraints;	// IMP=0x000000000014fa41
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000014ee66
