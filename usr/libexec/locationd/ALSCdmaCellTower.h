...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000009c4090
- (unsigned long long)hash;	// IMP=0x00100000009c3f54
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000009c3daa
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000009c3c50
- (void)copyTo:(id)arg1;	// IMP=0x00100000009c3b36
- (void)writeTo:(id)arg1;	// IMP=0x00100000009c39ed
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000009c39e0
- (id)dictionaryRepresentation;	// IMP=0x00100000009c313a
- (id)description;	// IMP=0x00100000009c30c3
...
- (void)dealloc;	// IMP=0x00100000009c2e20
