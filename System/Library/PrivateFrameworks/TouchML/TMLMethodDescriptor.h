...
+ (id)decode:(const struct ProtobufCMessage *)arg1;	// IMP=0x00100000000071cb
+ (id)methodSelectorForMethodName:(id)arg1 parameters:(id)arg2;	// IMP=0x0010000000007006
...
- (void)encode:(struct ProtobufCMessage *)arg1;	// IMP=0x0000000000007073
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000006dd5
- (id)initWithName:(id)arg1 returnType:(unsigned long long)arg2 parameters:(id)arg3 methodSelector:(id)arg4 attributes:(id)arg5;	// IMP=0x0000000000006cc7
