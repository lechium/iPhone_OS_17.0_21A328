...
- (void).cxx_destruct;	// IMP=0x0000000000378a8e
...
- (void)setStartErrorMessageFromException:(id)arg1;	// IMP=0x00000000003789f4
- (id)initWithCancelDelegate:(id)arg1;	// IMP=0x0000000000378960
- (_Bool)verifyFileFormat;	// IMP=0x0000000000378aed
- (id)read;	// IMP=0x0000000000378ae5
- (_Bool)start;	// IMP=0x0000000000378add
- (_Bool)isBinaryReader;	// IMP=0x0000000000378ad5
