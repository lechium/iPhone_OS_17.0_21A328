...
@class MISSING_TYPE, NSArray, NSString, RAPQuestion, UIImage;
...
- (void).cxx_destruct;	// IMP=0x002000000022cb69
...
- (_Bool)_hasSearchRelatedFollowupQuestion;	// IMP=0x001000000022cacf
- (void)_fillSubmissionParameters:(id)arg1;	// IMP=0x001000000022c545
- (MISSING_TYPE *)_alternateAuxiliaryControlsRecording;	// IMP=0x001000000022c4f5
- (_Bool)_isRecursivelyComplete;	// IMP=0x001000000022c4a1
- (_Bool)isComplete;	// IMP=0x001000000022c48c
