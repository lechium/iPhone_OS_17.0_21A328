...
+ (id)runLoopStateWithRunLoop:(struct __CFRunLoop *)arg1;	// IMP=0x00600000000f052d
...
- (void)dealloc;	// IMP=0x00000000000f05c9
- (id)initWithRunLoop:(struct __CFRunLoop *)arg1;	// IMP=0x00000000000f0564
