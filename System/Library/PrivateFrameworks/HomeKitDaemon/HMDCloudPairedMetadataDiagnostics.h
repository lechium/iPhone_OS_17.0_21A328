...
+ (id)logCategory;	// IMP=0x0060000000896f4d
- (void).cxx_destruct;	// IMP=0x0000000000896f0b
...
- (id)attributeDescriptions;	// IMP=0x0000000000896b01
- (id)initWithAccessoryIdentifier:(id)arg1 privacyPolicyURL:(id)arg2 uploadDestination:(id)arg3 consentVersion:(unsigned long long)arg4 uploadType:(unsigned long long)arg5;	// IMP=0x0000000000896a08
- (id)initWithAccessoryIdentifier:(id)arg1 jsonDictionary:(id)arg2;	// IMP=0x0000000000896617
