...
+ (id)availableSystemAppListForStorageBaseURL:(id)arg1;	// IMP=0x0040000000002447
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000000218c
- (void).cxx_destruct;	// IMP=0x002000000000599c
...
- (void)waitForInstallableSystemAppBundleIDs:(CDUnknownBlockType)arg1;	// IMP=0x0010000000005748
- (_Bool)needsSyncForCurrentOSBuildVersion:(id)arg1;	// IMP=0x00100000000055bc
@property(readonly, copy, nonatomic) NSDictionary *installableSystemAppToCompanionAppIdentifierMap;
- (void)setInstallableSystemAppBundleIDsExcludingCompanionState:(id)arg1;	// IMP=0x0010000000004e39
- (id)_onQueue_bundleIDsOfInstallableSystemAppsForLocallyAvailableApps:(id)arg1;	// IMP=0x0010000000004bee
...
- (void)setAvailableSystemApps:(id)arg1 bundleIDsOfInstallableSystemAppsIgnoringCounterpartAvailability:(id)arg2 forRemoteOSBuildVersion:(id)arg3;	// IMP=0x0010000000004197
- (void)_onQueue_callWaitersForInstallableSystemAppsWithLocallyAvailableApps:(id)arg1;	// IMP=0x0010000000003fb9
- (_Bool)systemAppIsInstallableWithBundleID:(id)arg1 error:(id *)arg2;	// IMP=0x0010000000003a33
- (id)installableSystemAppWithBundleID:(id)arg1 error:(id *)arg2;	// IMP=0x00100000000033d4
@property(readonly, copy, nonatomic) NSArray *installableSystemApps;
- (_Bool)_onQueue_appIsInstallable:(id)arg1 givenLocallyAvailableApps:(id)arg2;	// IMP=0x0010000000002f4c
@property(readonly, copy, nonatomic) NSArray *availableSystemApps; // @synthesize availableSystemApps=_availableSystemApps;
- (void)_onQueue_saveData;	// IMP=0x0010000000002aa3
@property(readonly, nonatomic) NSObject<OS_dispatch_queue> *queue;
- (id)initWithStorageBaseURL:(id)arg1;	// IMP=0x00100000000023c2
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000002341
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000002194
