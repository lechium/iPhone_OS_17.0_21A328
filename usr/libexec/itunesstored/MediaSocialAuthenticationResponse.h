...
- (void).cxx_destruct;	// IMP=0x00200000000e278b
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000e2697
- (void)addUploadIdentifier:(long long)arg1;	// IMP=0x00100000000e263d
- (void)addPostIdentifier:(long long)arg1;	// IMP=0x00100000000e25e3
- (id)init;	// IMP=0x00100000000e256e
