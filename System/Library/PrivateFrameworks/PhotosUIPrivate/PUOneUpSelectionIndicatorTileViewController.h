...
- (void).cxx_destruct;	// IMP=0x0000000000355bcf
...
- (void)viewModel:(id)arg1 didChange:(id)arg2;	// IMP=0x0000000000355a43
- (void)observable:(id)arg1 didChange:(unsigned long long)arg2 context:(void *)arg3;	// IMP=0x0000000000355846
- (void)_setButtonVisible:(_Bool)arg1 animated:(_Bool)arg2;	// IMP=0x0000000000355744
- (void)_updateButtonIfNeeded;	// IMP=0x0000000000355263
- (void)_invalidateButton;	// IMP=0x000000000035524c
- (_Bool)_needsUpdate;	// IMP=0x000000000035523a
- (void)_setNeedsUpdate;	// IMP=0x0000000000355234
- (void)_updateIfNeeded;	// IMP=0x000000000035517f
- (void)performChanges:(CDUnknownBlockType)arg1;	// IMP=0x00000000003550e1
- (void)_handleButton:(id)arg1;	// IMP=0x0000000000354f40
- (id)_selectionManager;	// IMP=0x0000000000354e9f
- (id)_reviewActionManager;	// IMP=0x0000000000354e48
- (void)becomeReusable;	// IMP=0x0000000000354a3a
- (void)viewDidLoad;	// IMP=0x00000000003549f9
