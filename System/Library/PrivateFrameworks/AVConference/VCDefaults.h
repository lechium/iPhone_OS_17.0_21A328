...
+ (id)copyStringValueForKey:(struct __CFString *)arg1;	// IMP=0x006000000046900d
+ (_Bool)booleanValueForKey:(struct __CFString *)arg1 defaultValue:(_Bool)arg2;	// IMP=0x0060000000468fad
+ (_Bool)booleanValueForKey:(struct __CFString *)arg1;	// IMP=0x0060000000468f92
+ (long long)integerValueForKey:(struct __CFString *)arg1 defaultValue:(long long)arg2;	// IMP=0x0060000000468e48
+ (long long)integerValueForKey:(struct __CFString *)arg1;	// IMP=0x0060000000468e2d
+ (double)getDoubleValueForKey:(struct __CFString *)arg1 defaultValue:(double)arg2;	// IMP=0x0060000000468cdc
+ (id)sharedInstance;	// IMP=0x0060000000468bfd
...
- (_Bool)forceEnableAudioMockInputPathForAppleTV;	// IMP=0x000000000046af81
- (_Bool)forceUseInternalRTPThreadingWithDefaultValue:(_Bool)arg1;	// IMP=0x000000000046af5f
...
- (_Bool)shouldOverrideEffectsFramerate:(unsigned int *)arg1;	// IMP=0x000000000046ab6f
...
- (_Bool)enableAudioDumpParticipantLocal:(_Bool)arg1;	// IMP=0x000000000046a83e
- (_Bool)enableAudioDumpParticipantRemote:(_Bool)arg1;	// IMP=0x000000000046a81c
...
- (_Bool)forceWifiAssistOutOfBudget;	// IMP=0x000000000046a57c
- (_Bool)forceWifiAssist;	// IMP=0x000000000046a55c
...
- (unsigned int)forceThermalLevelFramerate:(unsigned int)arg1;	// IMP=0x00000000004695dd
...
- (void)seperateString:(id)arg1;	// IMP=0x00000000004692d6
...
- (id)autorelease;	// IMP=0x00000000004690cf
- (oneway void)release;	// IMP=0x00000000004690c9
- (unsigned long long)retainCount;	// IMP=0x00000000004690bc
- (id)retain;	// IMP=0x00000000004690b3
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000004690aa
- (id)allocWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000046909d
- (id)init;	// IMP=0x000000000046904b
