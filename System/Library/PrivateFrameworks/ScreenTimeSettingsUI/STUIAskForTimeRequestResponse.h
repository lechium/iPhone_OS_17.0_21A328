...
- (void).cxx_destruct;	// IMP=0x00000000000a8537
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000a8446
- (id)initWithRequestResponse:(id)arg1;	// IMP=0x00000000000a82c0
- (id)init;	// IMP=0x00000000000a82ac
