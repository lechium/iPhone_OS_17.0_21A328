...
- (void).cxx_destruct;	// IMP=0x0000000000039978
@property(retain, nonatomic) id <SYShowBacklinkIndicatorCommandImpl> _impl; // @synthesize _impl=__impl;
- (void)invalidate;	// IMP=0x0000000000039920
- (void)runWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00000000000398b7
@property(readonly, nonatomic, getter=isActive) _Bool active;
- (id)initWithDomainIdentifiers:(id)arg1 linkIdentifiers:(id)arg2;	// IMP=0x00000000000397ba
