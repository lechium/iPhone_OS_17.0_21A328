...
- (void).cxx_destruct;	// IMP=0x000000000060e143
...
- (id)attributeDescriptions;	// IMP=0x000000000060de6d
...
- (id)initWithSessionID:(id)arg1 cameraID:(id)arg2 sequenceNumber:(unsigned long long)arg3;	// IMP=0x000000000060dc80
