...
- (void)executeEpilogue;	// IMP=0x00000000002f2e81
- (_Bool)executeRequestCore:(id *)arg1;	// IMP=0x00000000002f2db0
- (void)executePrologue;	// IMP=0x00000000002f2c34
- (void)visitPredicateExpression:(id)arg1;	// IMP=0x00000000002f2ac4
- (void)visitPredicate:(id)arg1;	// IMP=0x00000000002f2abe
- (id)_createStatement;	// IMP=0x00000000002f2970
@property(retain, nonatomic) NSSQLiteStatement *fetchStatement;
- (id)manyToManyPrefetchRequestsForRelationshipNamed:(id)arg1 onEntity:(id)arg2;	// IMP=0x00000000002f1af5
- (id)manyToOnePrefetchRequestForRelationshipNamed:(id)arg1 onEntity:(id)arg2;	// IMP=0x00000000002f1abc
- (id)inverseIsToOnePrefetchRequestForRelationshipNamed:(id)arg1 onEntity:(id)arg2;	// IMP=0x00000000002f1a83
@property(readonly, nonatomic) NSFetchRequest *request;
- (id)createChildContextForNestedFetchRequest:(id)arg1;	// IMP=0x00000000002f1989
- (void)dealloc;	// IMP=0x00000000002f182d
- (id)initWithRequest:(id)arg1 context:(id)arg2 sqlCore:(id)arg3;	// IMP=0x00000000002f0f6a
