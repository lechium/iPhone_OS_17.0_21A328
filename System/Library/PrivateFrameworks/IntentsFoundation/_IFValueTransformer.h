...
+ (_Bool)allowsReverseTransformation;	// IMP=0x0060000000001f75
- (void).cxx_destruct;	// IMP=0x0000000000001f44
...
- (id)reverseTransformedValue:(id)arg1;	// IMP=0x0000000000001eb0
- (id)transformedValue:(id)arg1;	// IMP=0x0000000000001e3e
- (id)initWithForwardTransformation:(CDUnknownBlockType)arg1 reverseTransformation:(CDUnknownBlockType)arg2;	// IMP=0x0000000000001d77
