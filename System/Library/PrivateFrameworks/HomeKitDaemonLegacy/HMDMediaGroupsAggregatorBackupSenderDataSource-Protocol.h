...
@class HMDMediaGroupsAggregatorBackupReceiver, HMDMediaGroupsAggregatorBackupSender, NSArray, NSUUID;
...
- (id <HMDMessageRouter>)routerForParticipantAccessoryUUID:(NSUUID *)arg1 mediaGroupsAggregatorBackupSender:(HMDMediaGroupsAggregatorBackupSender *)arg2;
