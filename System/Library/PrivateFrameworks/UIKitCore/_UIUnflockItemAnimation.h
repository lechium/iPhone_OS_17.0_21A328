...
+ (id)animationWithPlatterView:(id)arg1 destination:(id)arg2 positionReferenceView:(id)arg3 type:(long long)arg4;	// IMP=0x006000000136ca05
- (void).cxx_destruct;	// IMP=0x000000000136e2a8
...
- (void)complete;	// IMP=0x000000000136e171
- (void)play;	// IMP=0x000000000136cbab
