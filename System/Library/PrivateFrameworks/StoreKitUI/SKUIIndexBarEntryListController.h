...
+ (id)entryListControllerForEntryListViewElement:(id)arg1;	// IMP=0x006000000033981d
+ (id)entryListControllerForEntryViewElement:(id)arg1;	// IMP=0x0060000000339790
- (void).cxx_destruct;	// IMP=0x0000000000339a85
...
- (void)_didInvalidate;	// IMP=0x00000000003399c0
- (id)targetIndexBarEntryIDForEntryDescriptorAtIndex:(long long)arg1 returningRelativeSectionIndex:(out long long *)arg2;	// IMP=0x0000000000339975
- (void)reloadViewElementData;	// IMP=0x000000000033992c
- (id)entryDescriptorAtIndex:(long long)arg1;	// IMP=0x00000000003398e1
