...
- (void).cxx_destruct;	// IMP=0x0020000000073e2c
...
- (void)updateExpirationTime:(double)arg1;	// IMP=0x0010000000073db7
- (id)initWithIPAddress:(id)arg1 addressFamily:(unsigned long long)arg2 timeToLive:(double)arg3;	// IMP=0x0010000000073d26
