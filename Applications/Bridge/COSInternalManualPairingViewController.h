...
- (void).cxx_destruct;	// IMP=0x002000000002922e
...
- (void)pressedDone:(id)arg1;	// IMP=0x001000000002905e
- (void)pressedCancel:(id)arg1;	// IMP=0x0010000000029041
- (void)tappedManualMode:(id)arg1;	// IMP=0x0010000000029021
- (void)viewDidLoad;	// IMP=0x0010000000028f2d
- (id)init;	// IMP=0x0010000000028e8c
