...
+ (id)customAttributes;	// IMP=0x00600000001896cc
...
- (id)outputImage;	// IMP=0x000000000018a109
- (id)defuse:(id)arg1 seed:(int)arg2;	// IMP=0x0000000000189e8c
- (id)_kernelKmeans;	// IMP=0x0000000000189e6c
- (id)_combine:(id)arg1;	// IMP=0x00000000001899b0
