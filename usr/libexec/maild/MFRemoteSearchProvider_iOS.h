...
- (void).cxx_destruct;	// IMP=0x00200000000b5841
...
- (id)verifyResults:(id)arg1 query:(id)arg2;	// IMP=0x00100000000b56f8
- (id)fetchRemoteMessagesWithQuery:(id)arg1 delegate:(id)arg2;	// IMP=0x00100000000b5597
- (id)initWithMessagePersistence:(id)arg1;	// IMP=0x00100000000b54c9
