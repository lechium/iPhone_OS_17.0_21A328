...
- (void).cxx_destruct;	// IMP=0x000000000003d8ce
...
- (void)restoreVolumeIfNeeded;	// IMP=0x000000000003d7db
- (void)setProgressAwayFromZero:(double)arg1;	// IMP=0x000000000003d60c
- (void)setProgressTowardsZero:(double)arg1;	// IMP=0x000000000003d49c
- (_Bool)canAnimateVolumeAwayFromZero;	// IMP=0x000000000003d38d
- (_Bool)canAnimateVolumeTowardsZero;	// IMP=0x000000000003d27e
- (_Bool)currentRouteHasVolumeControl;	// IMP=0x000000000003d233
- (id)initWithPlayerController:(id)arg1;	// IMP=0x000000000003d1c8
