...
- (void).cxx_destruct;	// IMP=0x000000000022bbb5
...
- (id)mainReturningError;	// IMP=0x000000000022b537
- (id)initWithGroup:(id)arg1 records:(id)arg2 fetchResult:(CDUnknownBlockType)arg3;	// IMP=0x000000000022b457
- (id)initWithGroup:(id)arg1 parentUuids:(id)arg2 fetchResult:(CDUnknownBlockType)arg3;	// IMP=0x000000000022b377
- (id)initWithGroup:(id)arg1 uuids:(id)arg2 fetchResult:(CDUnknownBlockType)arg3;	// IMP=0x000000000022b297
