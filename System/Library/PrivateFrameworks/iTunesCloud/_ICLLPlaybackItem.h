...
- (void).cxx_destruct;	// IMP=0x00000000000b43fa
- (unsigned long long)hash;	// IMP=0x00000000000b42e9
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000b413f
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000b3ff4
- (void)writeTo:(id)arg1;	// IMP=0x00000000000b3eef
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000000b3ee2
- (id)dictionaryRepresentation;	// IMP=0x00000000000b3caf
- (id)description;	// IMP=0x00000000000b3c00
