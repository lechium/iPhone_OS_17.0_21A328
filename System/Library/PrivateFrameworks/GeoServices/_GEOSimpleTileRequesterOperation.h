...
- (void).cxx_destruct;	// IMP=0x0000000001234d21
...
- (void)dataURLSession:(id)arg1 didCompleteTask:(id)arg2;	// IMP=0x000000000123305d
- (void)dataURLSession:(id)arg1 shouldConvertDataTask:(id)arg2 toDownloadTaskForEstimatedResponseSize:(unsigned long long)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x0000000001232ed1
...
- (double)startTime;	// IMP=0x0000000001232d70
- (double)elapsed;	// IMP=0x0000000001232d20
- (void)clearAllRelatedOperations;	// IMP=0x0000000001232cee
- (void)cancel;	// IMP=0x0000000001232b4b
- (void)start;	// IMP=0x000000000123251c
@property(readonly, copy) NSString *description;
@property(readonly, nonatomic) unsigned long long contentLength;
@property(readonly, nonatomic) NSURL *URL;
@property unsigned int priority;
- (id)initWithRequest:(id)arg1 delegateQueue:(id)arg2 delegate:(id)arg3;	// IMP=0x0000000001231c2a
- (id)init;	// IMP=0x0000000001231c1c
