...
- (void).cxx_destruct;	// IMP=0x0020000000002a5d
...
- (id)deltaFromSnapshot:(id)arg1;	// IMP=0x0010000000002528
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000023c9
- (id)init;	// IMP=0x0010000000002363
