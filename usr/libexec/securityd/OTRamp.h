...
- (void).cxx_destruct;	// IMP=0x0020000000150990
...
- (_Bool)checkRampStateWithError:(id *)arg1;	// IMP=0x001000000014fb11
- (void)fetchRampRecordWithReply:(CDUnknownBlockType)arg1;	// IMP=0x001000000014f85a
- (id)initWithRecordName:(id)arg1 localSettingName:(id)arg2 container:(id)arg3 database:(id)arg4 zoneID:(id)arg5 accountTracker:(id)arg6 lockStateTracker:(id)arg7 reachabilityTracker:(id)arg8 fetchRecordRecordsOperationClass:(Class)arg9;	// IMP=0x001000000014f679
