...
@class DMFReportingRequirements, MISSING_TYPE, NSString, NSXPCListenerEndpoint;
...
@interface DMDConfigurationSourceRepresentation : NSObject
{
    ...
    MISSING_TYPE *_reportingRequirements;	// 48 = 0x30
}

- (void).cxx_destruct;	// IMP=0x002000000003c24e
...
- (id)initWithConfigurationSource:(id)arg1;	// IMP=0x001000000003bf1f
