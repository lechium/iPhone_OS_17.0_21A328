...
- (void).cxx_destruct;	// IMP=0x00000000001c54b6
...
- (void)_updateVignetteImage;	// IMP=0x00000000001c5375
- (void)installBannerOnView:(id)arg1 anchoredToScrollView:(id)arg2;	// IMP=0x00000000001c52fe
- (void)_doAllSetup;	// IMP=0x00000000001c4d20
- (void)_configureBanner;	// IMP=0x00000000001c4a9f
- (id)initWithBannerElement:(id)arg1;	// IMP=0x00000000001c49c5
