...
+ (id)displayTileTransformWithModelTileTransform:(id)arg1 initialScale:(double)arg2 initialSize:(struct CGSize)arg3 displaySize:(struct CGSize)arg4 secondaryDisplayTileTransform:(id)arg5;	// IMP=0x00100000001e3d7f
- (void).cxx_destruct;	// IMP=0x00000000001e390e
...
- (id)description;	// IMP=0x00000000001e3735
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001e372a
- (id)init;	// IMP=0x00000000001e36ca
- (id)newDisplayTileTransformWithUserAffineTransform:(struct CGAffineTransform)arg1 userInputOriginIdentifier:(id)arg2 isZoomedOut:(_Bool)arg3;	// IMP=0x00000000001e3c69
