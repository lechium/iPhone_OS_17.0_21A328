...
- (void).cxx_destruct;	// IMP=0x00000000000877a4
...
- (id)applyUpdatesWithElement:(id)arg1;	// IMP=0x0000000000087252
- (id)accessibilityText;	// IMP=0x00000000000871d6
@property(readonly, nonatomic) long long badgeType;
@property(readonly, nonatomic) NSAttributedString *attributedString;
- (id)initWithDOMElement:(id)arg1 parent:(id)arg2 elementFactory:(id)arg3;	// IMP=0x0000000000086c38
