...
- (void).cxx_destruct;	// IMP=0x00000000004bf6ba
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000004bf1db
- (unsigned long long)hash;	// IMP=0x00000000004bee8b
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000004be999
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000004be641
- (void)copyTo:(id)arg1;	// IMP=0x00000000004be318
- (void)writeTo:(id)arg1;	// IMP=0x00000000004bdf9c
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000004bd02a
- (id)dictionaryRepresentation;	// IMP=0x00000000004bc72c
- (id)description;	// IMP=0x00000000004bc67d
