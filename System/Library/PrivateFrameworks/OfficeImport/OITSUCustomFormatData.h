...
+ (id)customFormatData;	// IMP=0x00100000002b58d8
- (void).cxx_destruct;	// IMP=0x00000000002b633b
...
- (unsigned long long)hash;	// IMP=0x00000000002b617f
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000002b5ca4
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000002b5c99
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000002b5c46
- (void)p_copySelfTo:(id)arg1;	// IMP=0x00000000002b59ac
- (id)init;	// IMP=0x00000000002b5959
- (id)initWithCustomFormatData:(id)arg1;	// IMP=0x00000000002b58f1
