...
- (void).cxx_destruct;	// IMP=0x0000000000360382
...
- (void)updateBackgroundImage;	// IMP=0x000000000036029a
- (void)_setIsContainedInPopover:(_Bool)arg1;	// IMP=0x0000000000360294
- (void)_setFrame:(struct CGRect)arg1 forceUpdateBackgroundImage:(_Bool)arg2;	// IMP=0x0000000000360282
- (id)_currentCustomBackgroundRespectOversize_legacy:(_Bool *)arg1;	// IMP=0x000000000036027a
- (id)_currentCustomBackground;	// IMP=0x0000000000360272
- (void)layoutSubviews;	// IMP=0x0000000000360159
@property(copy, nonatomic) NSString *backdropGroupName;
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000035fe8f
