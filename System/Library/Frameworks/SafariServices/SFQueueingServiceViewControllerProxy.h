...
- (void).cxx_destruct;	// IMP=0x00000000000fd794
...
- (id)forwardingTargetForSelector:(SEL)arg1;	// IMP=0x00000000000fd741
- (void)forwardInvocation:(id)arg1;	// IMP=0x00000000000fd64e
- (id)methodSignatureForSelector:(SEL)arg1;	// IMP=0x00000000000fd5dd
- (id)initWithProtocol:(id)arg1;	// IMP=0x00000000000fd3cc
