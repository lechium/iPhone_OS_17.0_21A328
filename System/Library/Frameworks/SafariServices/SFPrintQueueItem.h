...
- (void).cxx_destruct;	// IMP=0x00000000000710d4
...
- (void)completeWithResult:(long long)arg1;	// IMP=0x0000000000071098
- (void)dealloc;	// IMP=0x0000000000071069
- (id)initWithFrameHandle:(id)arg1 initiatedByWebContent:(_Bool)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000000070fb9
