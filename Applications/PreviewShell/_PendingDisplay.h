...
- (void).cxx_destruct;	// IMP=0x00200000000053de
...
- (_Bool)matches:(id)arg1;	// IMP=0x0010000000005308
- (void)cancelTimeoutTimer;	// IMP=0x00100000000052d6
- (void)startTimeoutTimerWithHandler:(CDUnknownBlockType)arg1;	// IMP=0x00100000000051a6
- (id)initWithToken:(id)arg1 pixelSize:(struct CGSize)arg2 scale:(double)arg3 capabilitiesPath:(id)arg4 maskPath:(id)arg5 successHandler:(CDUnknownBlockType)arg6 failureHandler:(CDUnknownBlockType)arg7;	// IMP=0x001000000000502a
