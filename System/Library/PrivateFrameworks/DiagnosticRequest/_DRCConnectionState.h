...
+ (id)sharedConnectionState;	// IMP=0x006000000000bba2
- (void).cxx_destruct;	// IMP=0x000000000000c344
...
- (id)sendMessageWithReplySync:(id)arg1;	// IMP=0x000000000000c2be
- (_Bool)sendMessage:(id)arg1;	// IMP=0x000000000000c154
- (id)init;	// IMP=0x000000000000bc6f
- (void)cleanupState;	// IMP=0x000000000000bbf7
