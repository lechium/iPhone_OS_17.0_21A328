...
+ (id)settingsControllerModule;	// IMP=0x00100000014264cc
...
- (void)setDefaultValues;	// IMP=0x000000000142643f
- (void)settings:(id)arg1 changedValueForKey:(id)arg2;	// IMP=0x00000000014261b4
- (id)initWithDefaultValues;	// IMP=0x0000000001426165
