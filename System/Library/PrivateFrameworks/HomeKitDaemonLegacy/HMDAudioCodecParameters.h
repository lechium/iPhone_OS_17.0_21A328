...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000006fa69
- (void).cxx_destruct;	// IMP=0x000000000006f97c
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000006f820
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000006f518
- (void)description:(id)arg1 indent:(id)arg2;	// IMP=0x000000000006f339
@property(readonly, copy) NSData *tlvData;
- (_Bool)_parseFromTLVData;	// IMP=0x000000000006ef81
- (id)initWithChannelCount:(id)arg1 bitRateSetting:(id)arg2 audioSampleRate:(id)arg3 rtpPtime:(id)arg4;	// IMP=0x000000000006ee84
