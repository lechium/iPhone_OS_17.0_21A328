...
- (void).cxx_destruct;	// IMP=0x000000000043f805
...
- (void)_ensureNetworkInterfaceMonitorStopped;	// IMP=0x000000000043f74d
- (int)_ensureNetworkInterfaceMonitorStarted;	// IMP=0x000000000043f4ce
- (void)_update;	// IMP=0x000000000043f329
- (void)stop;	// IMP=0x000000000043f2d7
- (void)start;	// IMP=0x000000000043f285
- (void)dealloc;	// IMP=0x000000000043f201
- (id)init;	// IMP=0x000000000043f178
