...
+ (const char *)trackerStateTypeName;	// IMP=0x0060000000012e72
+ (unsigned long long)trackerStateSize;	// IMP=0x0060000000012e67
- (void *)identifier;	// IMP=0x0000000000012e7f
- (_Bool)dumpState:(void *)arg1 withSize:(unsigned long long)arg2 hints:(struct os_state_hints_s *)arg3;	// IMP=0x0000000000012cb4
- (void)updateState:(CDUnknownBlockType)arg1;	// IMP=0x0000000000012904
...
- (void)dealloc;	// IMP=0x0000000000010066
- (id)initWithQueue:(id)arg1 identifier:(void *)arg2 state:(CDUnknownBlockType)arg3;	// IMP=0x000000000000fbf3
- (id)initWithQueue:(id)arg1 identifier:(void *)arg2;	// IMP=0x000000000000fbde
- (id)initInSilo:(id)arg1 withIdentifier:(void *)arg2 state:(CDUnknownBlockType)arg3;	// IMP=0x000000000000fb7d
- (id)initInSilo:(id)arg1 withIdentifier:(void *)arg2;	// IMP=0x000000000000fb68
