...
- (void).cxx_destruct;	// IMP=0x0020000000173300
- (void)showWithFlags:(unsigned int)arg1 throttleSeconds:(int)arg2;	// IMP=0x00100000001730c5
- (void)_handlePINEntered:(id)arg1;	// IMP=0x0010000000172f77
- (void)_handleKeyboardWillShow:(id)arg1;	// IMP=0x0010000000172bf1
- (void)handleDismissButton:(id)arg1;	// IMP=0x0010000000172b42
- (_Bool)_canShowWhileLocked;	// IMP=0x0010000000172b3a
- (void)viewDidDisappear:(_Bool)arg1;	// IMP=0x0010000000172a69
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x00100000001727b6
