...
- (void).cxx_destruct;	// IMP=0x00000000000e1640
...
- (id)_sparseObjectFromObject:(id)arg1 usingPropertyPaths:(id)arg2;	// IMP=0x00000000000e0d03
- (void)updateUsageIndexesWithChangeSet:(id)arg1;	// IMP=0x00000000000e0bbd
- (void)removeUsageForIndex:(long long)arg1;	// IMP=0x00000000000e0ba7
- (void)addUsageForIndex:(long long)arg1;	// IMP=0x00000000000e0b4f
@property(readonly, copy, nonatomic) NSIndexSet *usageIndexes;
- (id)initWithPrototype:(id)arg1 dataItem:(id)arg2;	// IMP=0x00000000000e0970
- (void)dsepm_setViewElement:(id)arg1;	// IMP=0x0000000000002937
- (id)dsepm_viewElement;	// IMP=0x0000000000002926
