...
+ (Class)classIdsType;	// IMP=0x00200000001a15fd
+ (Class)optionItemsType;	// IMP=0x00100000001a10ea
- (void).cxx_destruct;	// IMP=0x00200000001a49e4
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000001a4281
- (unsigned long long)hash;	// IMP=0x00100000001a3d80
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000001a38b5
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000001a328b
- (void)copyTo:(id)arg1;	// IMP=0x00100000001a2e91
- (void)writeTo:(id)arg1;	// IMP=0x00100000001a29b9
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000001a29ac
- (id)dictionaryRepresentation;	// IMP=0x00100000001a16bd
- (id)description;	// IMP=0x00100000001a160e
- (id)classIdsAtIndex:(unsigned long long)arg1;	// IMP=0x00100000001a15e0
- (unsigned long long)classIdsCount;	// IMP=0x00100000001a15c3
- (void)addClassIds:(id)arg1;	// IMP=0x00100000001a1559
- (void)clearClassIds;	// IMP=0x00100000001a153c
...
- (int)StringAsOpenResponseType:(id)arg1;	// IMP=0x00100000001a13a8
- (id)openResponseTypeAsString:(int)arg1;	// IMP=0x00100000001a135f
...
- (int)StringAsSliderType:(id)arg1;	// IMP=0x00100000001a11bd
- (id)sliderTypeAsString:(int)arg1;	// IMP=0x00100000001a1168
@property(nonatomic) _Bool hasSliderType;
@property(nonatomic) int sliderType; // @synthesize sliderType=_sliderType;
- (id)optionItemsAtIndex:(unsigned long long)arg1;	// IMP=0x00100000001a10cd
- (unsigned long long)optionItemsCount;	// IMP=0x00100000001a10b0
- (void)addOptionItems:(id)arg1;	// IMP=0x00100000001a1046
- (void)clearOptionItems;	// IMP=0x00100000001a1029
- (int)StringAsMultipleChoiceType:(id)arg1;	// IMP=0x00100000001a0f57
- (id)multipleChoiceTypeAsString:(int)arg1;	// IMP=0x00100000001a0f0e
...
- (int)StringAsAnswerFormatType:(id)arg1;	// IMP=0x00100000001a0def
- (id)answerFormatTypeAsString:(int)arg1;	// IMP=0x00100000001a0da6
...
- (int)StringAsSurveyStepType:(id)arg1;	// IMP=0x00100000001a0c64
- (id)surveyStepTypeAsString:(int)arg1;	// IMP=0x00100000001a0c0f
@property(nonatomic) _Bool hasSurveyStepType;
- (void);	// IMP=0x00100000001a0bc0
