...
@class HKCharacteristicType, HKObjectType, HKQuantityType, HKQueryServerConfiguration, HKSampleType, HKTaskConfiguration, HKUnit, HKWorkout, HKWorkoutConfiguration, NSArray, NSData, NSDate, NSDictionary, NSError, NSNumber, NSSet, NSString, NSURL, NSUUID, _HKFilter;

@protocol HKHealthStoreServerInterface <NSObject>
- (void)remote_setMirroredWorkoutSessionObserverStateToEnabled:(_Bool)arg1 completion:(void (^)(_Bool, NSError *))arg2;
...
- (void)remote_startWatchAppWithWorkoutPlanData:(NSData *)arg1 processIdentifier:(int)arg2 completion:(void (^)(_Bool, NSError *))arg3;
...
- (void)remote_getAllHealthDataAccessForSiriWithCompletion:(void (^)(long long, NSError *))arg1;
- (void)remote_setAllHealthDataAccessForSiri:(long long)arg1 completion:(void (^)(_Bool, NSError *))arg2;
...
- (void)remote_createTaskServerEndpointForIdentifier:(NSString *)arg1 pluginURL:(NSURL *)arg2 taskUUID:(NSUUID *)arg3 instanceUUID:(NSUUID *)arg4 configuration:(HKTaskConfiguration *)arg5 completion:(void (^)(NSXPCListenerEndpoint *, NSError *))arg6;
@end
