...
+ (void)setupRelationsBetweenDisplayItemStates:(id)arg1 visualProvider:(id)arg2;	// IMP=0x00100000011a7397
+ (id)stateForDisplayItemWithIdentifier:(id)arg1 statusBar:(id)arg2;	// IMP=0x00100000011a6bdb
- (void).cxx_destruct;	// IMP=0x00000000011aaaba
...
- (id)description;	// IMP=0x00000000011aa626
@property(readonly, nonatomic) long long priority;
@property(readonly, copy, nonatomic) NSArray *potentialPlacementRegionIdentifiers;
- (_Bool)isCurrentPlacement:(id)arg1;	// IMP=0x00000000011aa28c
- (_Bool)prepareAnimation:(id)arg1;	// IMP=0x00000000011a9d4a
- (id)_animationWithUpdateAnimation:(id)arg1;	// IMP=0x00000000011a9ad3
- (void)_cancelObsoleteAnimations;	// IMP=0x00000000011a98dc
@property(readonly, nonatomic, getter=_animationType) long long animationType;
- (id)_effectiveStyleAttributesFromStyleAttributes:(id)arg1 data:(id)arg2 styleAttributesChanged:(_Bool *)arg3;	// IMP=0x00000000011a93b2
- (id)_updateForUpdatedData:(id)arg1 updatedStyleAttributes:(id)arg2 updatedEnability:(id)arg3;	// IMP=0x00000000011a9192
- (id)_updateForItem:(id)arg1 data:(id)arg2 styleAttributes:(id)arg3;	// IMP=0x00000000011a8ed4
- (id)updateWithData:(id)arg1 styleAttributes:(id)arg2;	// IMP=0x00000000011a87a8
- (_Bool)updatePlacement;	// IMP=0x00000000011a86cb
- (void)resetToPreferredPlacement;	// IMP=0x00000000011a86b5
- (_Bool)_updatePlacementWithRecursionBlock:(CDUnknownBlockType)arg1;	// IMP=0x00000000011a852a
- (_Bool)_resolveDependentItemStatesWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x00000000011a8288
- (void)_updateStatuses;	// IMP=0x00000000011a81a6
- (void)prepareForDataUpdate;	// IMP=0x00000000011a818f
- (void)prepareForOverflowDataUpdate;	// IMP=0x00000000011a8179
- (id)placementStateForPlacement:(id)arg1;	// IMP=0x00000000011a71d2
- (void)addPlacement:(id)arg1 inRegion:(id)arg2;	// IMP=0x00000000011a6fee
- (_Bool)_updateToNextPlacementStateIfNeeded;	// IMP=0x00000000011a6f61
- (void)updateToNextEnabledPlacement;	// IMP=0x00000000011a6f2a
@property(readonly, nonatomic) _UIStatusBarDisplayItemPlacementState *currentPlacementState;
- (_Bool)hasRunningAnimations;	// IMP=0x00000000011a6ea6
