...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000001f0fd5
+ (unsigned long long)currentVersion;	// IMP=0x00100000001f0fca
- (void).cxx_destruct;	// IMP=0x00000000001f0fa2
...
- (id)initWithRawColorGaborDescriptor:(id)arg1;	// IMP=0x00000000001f0c95
@property(readonly) NSData *rawColorGaborDescriptor;
- (float)computeFinalDescriptorBasedDistanceForColorDistance:(float)arg1 andSceneClassifierDistance:(float)arg2;	// IMP=0x00000000001f0c2b
- (float)distanceFromDescriptor:(id)arg1;	// IMP=0x00000000001f0ba8
- (_Bool)computeRegistrationFeaturesForImageData:(id)arg1 context:(id)arg2 error:(id *)arg3;	// IMP=0x00000000001f0ba0
- (_Bool)computeDescriptorForImageData:(id)arg1 context:(id)arg2 error:(id *)arg3;	// IMP=0x00000000001f08df
- (_Bool)computeConvnetDescriptorForImageData:(id)arg1 context:(id)arg2 error:(id *)arg3;	// IMP=0x00000000001f08d7
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001f0708
- (unsigned long long)hash;	// IMP=0x00000000001f05ef
- (void)dealloc;	// IMP=0x00000000001f05af
- (id)initWithState:(id)arg1 byteOffset:(unsigned long long *)arg2 error:(id *)arg3;	// IMP=0x00000000001f026f
- (unsigned long long)serializeStateIntoData:(id)arg1 startingAtByteOffset:(unsigned long long)arg2 error:(id *)arg3;	// IMP=0x00000000001efffd
@property(readonly, nonatomic) unsigned long long serializedLength;
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001efd3e
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001ef7b7
- (id)initWithImageData:(id)arg1 andCustomQualityScore:(float)arg2 context:(id)arg3 error:(id *)arg4;	// IMP=0x00000000001ef788
- (id)initWithImageData:(id)arg1 context:(id)arg2 error:(id *)arg3;	// IMP=0x00000000001ef550
