...
- (void).cxx_destruct;	// IMP=0x00200000001dbf60
...
- (unsigned long long)_durationInMillisecondsForDuration:(id)arg1;	// IMP=0x00100000001dc43b
- (id)metricValue;	// IMP=0x00100000001dc052
