...
- (void).cxx_destruct;	// IMP=0x0000000000071138
...
- (id)bundleAtURL:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000070c10
- (id)bundleURLFromAssetURL:(id)arg1;	// IMP=0x0000000000070944
- (void)completeWithBundle:(id)arg1 isFallback:(_Bool)arg2 isCached:(_Bool)arg3;	// IMP=0x0000000000070141
- (_Bool)completeIfPossible;	// IMP=0x000000000006fbba
- (void)cancelTimeout;	// IMP=0x000000000006fb70
- (_Bool)updateTaskWithBundle:(id)arg1 error:(id)arg2 isFallback:(_Bool)arg3 isImperfectMatch:(_Bool)arg4 isCached:(_Bool)arg5;	// IMP=0x000000000006f96c
- (_Bool)updateTaskWithAssetBundleURL:(id)arg1 error:(id)arg2 isFallback:(_Bool)arg3 isImperfectMatch:(_Bool)arg4 isCached:(_Bool)arg5;	// IMP=0x000000000006f8b6
- (_Bool)updateTaskWithAssetURL:(id)arg1 error:(id)arg2 isFallback:(_Bool)arg3 isImperfectMatch:(_Bool)arg4 isCached:(_Bool)arg5;	// IMP=0x000000000006f825
- (void)createQueryParameters;	// IMP=0x000000000006f4fc
- (id)initWithDeviceQuery:(id)arg1 requestConfiguration:(id)arg2 dispatchQueue:(id)arg3 useProcessLocalCache:(_Bool)arg4;	// IMP=0x000000000006f198
