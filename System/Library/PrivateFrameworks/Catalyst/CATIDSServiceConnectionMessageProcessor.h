...
- (void).cxx_destruct;	// IMP=0x0000000000023e77
@property(nonatomic) __weak id <CATIDSServiceConnectionMessageProcessorDelegate> delegate; // @synthesize delegate=_delegate;
- (void)receiveMessage:(id)arg1;	// IMP=0x00000000000236cd
- (id)initWithWorkQueue:(id)arg1 connectionIdentifier:(id)arg2;	// IMP=0x0000000000023634
