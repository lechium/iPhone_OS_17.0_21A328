...
+ (void)_setAnnotatesMigrationMetadata:(_Bool)arg1;	// IMP=0x0060000000231996
+ (_Bool)_annotatesMigrationMetadata;	// IMP=0x006000000023196c
...
- (void)dealloc;	// IMP=0x0000000000231cfc
