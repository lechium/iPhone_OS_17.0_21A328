...
+ (id)configurationForDisplayID:(unsigned int)arg1 error:(id *)arg2;	// IMP=0x0020000000044e6b
+ (id)sharedDisplayMonitor;	// IMP=0x0010000000044e16
- (void).cxx_destruct;	// IMP=0x00200000000456d5
...
- (id)initWithDisplayID:(unsigned int)arg1;	// IMP=0x0010000000044e98
