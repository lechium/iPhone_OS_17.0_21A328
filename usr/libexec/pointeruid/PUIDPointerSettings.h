...
@interface PUIDPointerSettings : PTSettings
{
    ...
    _Bool _shouldAutohideAfterHitTestContextLoss;	// 16 = 0x10
    _Bool _shouldHideWhileGesturing;	// 17 = 0x11
    _Bool _supportsTeleporting;	// 18 = 0x12
    _Bool _allowPositionToPositionAnimations;	// 19 = 0x13
    _Bool _showDebugColors;	// 20 = 0x14
    ...
    double _delayBeforeUnhidingAfterGesturing;	// 432 = 0x1b0
    SBFFluidBehaviorSettings *_visibleToHiddenTeleportingAnimationSettings;	// 440 = 0x1b8
    SBFFluidBehaviorSettings *_hiddenToVisibleTeleportingAnimationSettings;	// 448 = 0x1c0
    double _flexibleRectIntensityReductionRange;	// 456 = 0x1c8
    double _minFlexibleRectLightLuminanceIntensity;	// 464 = 0x1d0
    double _minFlexibleRectDarkLuminanceIntensity;	// 472 = 0x1d8
    double _positionToPositionAnimationThreshold;	// 480 = 0x1e0
    SBFFluidBehaviorSettings *_pointerAccessoryAnimationSettings;	// 488 = 0x1e8
}

+ (id)settingsControllerModule;	// IMP=0x004000000001887c
- (void).cxx_destruct;	// IMP=0x002000000001b83d
...
@property(retain, nonatomic) SBFFluidBehaviorSettings *hiddenToVisibleTeleportingAnimationSettings; // @synthesize hiddenToVisibleTeleportingAnimationSettings=_hiddenToVisibleTeleportingAnimationSettings;
@property(retain, nonatomic) SBFFluidBehaviorSettings *visibleToHiddenTeleportingAnimationSettings; // @synthesize visibleToHiddenTeleportingAnimationSettings=_visibleToHiddenTeleportingAnimationSettings;
@property(nonatomic) _Bool supportsTeleporting; // @synthesize supportsTeleporting=_supportsTeleporting;
@property(nonatomic) double delayBeforeUnhidingAfterGesturing; // @synthesize delayBeforeUnhidingAfterGesturing=_delayBeforeUnhidingAfterGesturing;
@property(nonatomic) _Bool shouldHideWhileGesturing; // @synthesize shouldHideWhileGesturing=_shouldHideWhileGesturing;
@property(nonatomic) _Bool shouldAutohideAfterHitTestContextLoss; // @synthesize shouldAutohideAfterHitTestContextLoss=_shouldAutohideAfterHitTestContextLoss;
...
- (void)setPressedScaleAnimationSettings:(id)arg1;	// IMP=0x001000000001b3fa
- (id)pressedScaleAnimationSettings;	// IMP=0x001000000001b3e9
...
- (void)setDefaultValues;	// IMP=0x00100000000176cf
