...
- (void)start;	// IMP=0x0000000000001ca7
- (void)finishExecuting;	// IMP=0x0000000000001ba4
- (void)cancel;	// IMP=0x0000000000001ae3
- (id)initWithContextProvider:(id)arg1;	// IMP=0x0000000000001a7c
