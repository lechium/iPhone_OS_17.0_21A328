...
- (void).cxx_destruct;	// IMP=0x0020000000003f7a
...
- (void)_provideItemAtURL:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0010000000003e2f
- (void)_provideItemAtURL:(id)arg1 toReaderWithID:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0010000000003c8a
- (void)unlockWithError:(id)arg1;	// IMP=0x0010000000003a12
- (id)initWithURL:(id)arg1;	// IMP=0x0010000000003943
