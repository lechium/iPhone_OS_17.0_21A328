...
+ (id)diskStores;	// IMP=0x0060000000018376
+ (id)diskStoreForURL:(id)arg1;	// IMP=0x0060000000018000
- (void).cxx_destruct;	// IMP=0x00000000000185a8
...
- (void)executeBlock:(CDUnknownBlockType)arg1 onQueue:(id)arg2;	// IMP=0x00000000000181e8
- (id)description;	// IMP=0x00000000000181a9
- (id)initWithURL:(id)arg1;	// IMP=0x0000000000017bc2
