...
- (void).cxx_destruct;	// IMP=0x0000000000224e10
...
- (void)_reloadView;	// IMP=0x0000000000224c30
- (void)_setTrendingResponse:(id)arg1 error:(id)arg2;	// IMP=0x0000000000224bda
- (void)_reloadData;	// IMP=0x0000000000224a03
- (void)layoutSubviews;	// IMP=0x0000000000224929
