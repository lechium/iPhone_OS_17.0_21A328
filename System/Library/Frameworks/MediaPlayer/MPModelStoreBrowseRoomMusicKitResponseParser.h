...
- (void).cxx_destruct;	// IMP=0x00000000001c178b
- (id)_parsedContentNode:(id)arg1 additionalAttributesFromParent:(id)arg2;	// IMP=0x00000000001c14cb
- (id)_parsedElements:(id)arg1;	// IMP=0x00000000001c12a2
- (id)_parsedSectionedCollection;	// IMP=0x00000000001c0b00
@property(readonly, nonatomic) MPSectionedCollection *results;
- (id)initWithRawResponseOutput:(id)arg1 sectionBuilder:(id)arg2 contentItemBuilder:(id)arg3 filteredFCKinds:(id)arg4 userIdentity:(id)arg5;	// IMP=0x00000000001c099a
