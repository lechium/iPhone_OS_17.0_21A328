...
- (void).cxx_destruct;	// IMP=0x00000000000586a0
...
- (void)playerDidPlayToEndTime:(id)arg1;	// IMP=0x0000000000058519
- (void)toggleIsPlaying;	// IMP=0x00000000000584db
- (void)resetVideo;	// IMP=0x000000000005839b
- (void)pauseVideo;	// IMP=0x00000000000582de
- (void)playVideo;	// IMP=0x00000000000581af
- (void)setImage:(id)arg1;	// IMP=0x0000000000058128
@property(nonatomic, getter=isMuted) _Bool muted;
- (struct CGSize)preferredVideoSize;	// IMP=0x0000000000058019
- (void)layoutSubviews;	// IMP=0x0000000000057dbd
- (void)dealloc;	// IMP=0x0000000000057d48
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000057d33
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000057d08
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000057cdd
- (id)initWithFrame:(struct CGRect)arg1 videoURL:(id)arg2 screenshotDisplayConfiguration:(id)arg3;	// IMP=0x0000000000057a17
