...
+ (id)customAttributes;	// IMP=0x00600000001368fa
...
- (id)outputImage;	// IMP=0x0000000000134e67
- (id)_CIPageCurlNoShadowTransition;	// IMP=0x0000000000134e47
- (id)_CIPageCurlWithShadowTransition;	// IMP=0x0000000000134e27
