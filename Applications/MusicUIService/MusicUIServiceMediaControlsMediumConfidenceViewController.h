...
+ (_Bool)_isSecureForRemoteViewService;	// IMP=0x00200000000038e4
- (void).cxx_destruct;	// IMP=0x00200000000040d0
...
- (void)routingControllerAvailableRoutesDidChange:(id)arg1;	// IMP=0x0010000000003d4b
- (void)handleButtonActions:(id)arg1;	// IMP=0x0010000000003c6a
- (void)configureWithContext:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00100000000038f4
- (_Bool)_shouldRemoveViewFromHierarchyOnDisappear;	// IMP=0x00100000000038ec
- (void)presentAlert;	// IMP=0x0010000000002c71
- (void)beginDiscoveryForCandidateRoute;	// IMP=0x0010000000002b54
- (_Bool)fetchCandidateOutputDevice;	// IMP=0x0010000000002973
- (void)configurePresentation;	// IMP=0x001000000000292c
- (id)connectionWithEndpoint:(id)arg1;	// IMP=0x0010000000002631
- (void)presentErrorAlert;	// IMP=0x0010000000002314
- (void)dismiss;	// IMP=0x0010000000002271
- (_Bool)prefersStatusBarHidden;	// IMP=0x0010000000002269
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x0010000000002228
