...
- (id)managedObjectContext;	// IMP=0x00000000002df657
- (void)dealloc;	// IMP=0x00000000002df5f6
- (id)initForStore:(id)arg1 request:(id)arg2 metadata:(id)arg3 forceInsertsToUpdates:(_Bool)arg4 context:(id)arg5;	// IMP=0x00000000002df508
