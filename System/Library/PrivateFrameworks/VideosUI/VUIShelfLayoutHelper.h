...
- (void)_freeBuffers;	// IMP=0x0000000000086953
- (void)_compute;	// IMP=0x0000000000085d5e
- (struct CGRect)frameForItemAtIndexPath:(id)arg1;	// IMP=0x0000000000085cc2
- (struct UIEdgeInsets)insetForSection:(long long)arg1;	// IMP=0x0000000000085c87
- (struct CGRect)frameForHeaderInSection:(long long)arg1;	// IMP=0x0000000000085c4c
- (void)dealloc;	// IMP=0x0000000000085c0e
- (id)initWithShelfViewLayout:(id)arg1;	// IMP=0x0000000000085b9a
