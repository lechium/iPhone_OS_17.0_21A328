...
+ (void)updateSharedInfoWithIdentifier:(id)arg1 productType:(id)arg2 buildVersion:(id)arg3;	// IMP=0x00200000002ed15e
+ (id)locallyPairedPeerInfo;	// IMP=0x00100000002ed06e
+ (id)_queue;	// IMP=0x00100000002ed03e
- (void).cxx_destruct;	// IMP=0x00200000002ecddc
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000002ecb18
- (unsigned long long)hash;	// IMP=0x00100000002ecb02
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000002ecaf7
- (id)afPeerInfo;	// IMP=0x00100000002eca9a
@property(readonly, copy, nonatomic) NSDictionary *dictionaryRepresentation;
- (id)description;	// IMP=0x00100000002ec983
- (id)initWithAFPeerInfo:(id)arg1;	// IMP=0x00100000002ec5cc
- (id)initWithUniqueIdentifer:(id)arg1;	// IMP=0x00100000002ec55f
- (id)initWithIDSIdentifer:(id)arg1;	// IMP=0x00100000002ec545
- (id)initWithIDSIdentifer:(id)arg1 productType:(id)arg2 buildVersion:(id)arg3 name:(id)arg4;	// IMP=0x00100000002ec42e
