...
+ (id)loadForZone:(id)arg1 contextID:(id)arg2;	// IMP=0x00400000000a7532
- (void).cxx_destruct;	// IMP=0x00200000000a74b2
...
- (id)asKeychainBackedSet:(id *)arg1;	// IMP=0x00100000000a7116
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000a6e27
- (id)description;	// IMP=0x00100000000a6b9e
- (id)initWithZoneID:(id)arg1 contextID:(id)arg2;	// IMP=0x00100000000a6b05
