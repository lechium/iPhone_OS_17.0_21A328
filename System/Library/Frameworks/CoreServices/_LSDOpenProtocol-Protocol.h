...
- (void)updateRestrictionKnowledgeWithCompletionHandler:(void (^)(_Bool, NSError *))arg1;
- (void)failedToOpenApplication:(NSString *)arg1 withURL:(NSURL *)arg2 completionHandler:(void (^)(_Bool, NSError *))arg3;
