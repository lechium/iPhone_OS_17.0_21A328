...
+ (id)cps_preIngestedURLWithBundleIdentifier:(id)arg1;	// IMP=0x002000000000cc81
+ (id)cps_resolvedURLWithStoreIconURLString:(id)arg1 iconSize:(unsigned long long)arg2;	// IMP=0x002000000000c9b7
