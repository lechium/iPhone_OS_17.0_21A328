...
- (void).cxx_destruct;	// IMP=0x00200000002e19fa
...
- (id)deltaFromSnapshot:(id)arg1;	// IMP=0x00100000002e14e3
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000002e1384
- (id)init;	// IMP=0x00100000002e131e
