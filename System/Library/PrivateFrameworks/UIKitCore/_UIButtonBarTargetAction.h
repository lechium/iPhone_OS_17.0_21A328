...
- (void).cxx_destruct;	// IMP=0x00000000001c81f6
...
- (void)_invoke:(id)arg1 forEvent:(id)arg2;	// IMP=0x00000000001c7fd0
@property(readonly, nonatomic) SEL proxyAction;
- (id)initWithBarButtonItem:(id)arg1;	// IMP=0x00000000001c7f58
- (id)init;	// IMP=0x00000000001c7eab
