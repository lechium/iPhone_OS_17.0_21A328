...
- (void).cxx_destruct;	// IMP=0x00000000000c5f5c
@property(nonatomic) struct CGSize imageSize; // @synthesize imageSize=_imageSize;
- (void)prepareForReuse;	// IMP=0x00000000000c5f25
- (void)layoutSubviews;	// IMP=0x00000000000c5c88
- (void)setHighlighted:(_Bool)arg1;	// IMP=0x00000000000c5b8b
@property(nonatomic, getter=isVideo) _Bool video;
@property(retain, nonatomic) UIImage *image;
@property(readonly, nonatomic) struct CGRect imageFrame;
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000000c581b
