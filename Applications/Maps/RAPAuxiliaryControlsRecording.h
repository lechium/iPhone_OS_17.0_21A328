...
- (void).cxx_destruct;	// IMP=0x002000000096a826
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000096a7fe
- (id)initWithControlsGeo:(id)arg1 originatingIndex:(unsigned long long)arg2;	// IMP=0x001000000096a76c
