...
+ (id)builderWithVisualIdentity:(id)arg1 avatarStore:(id)arg2 environment:(id)arg3 contactViewCache:(id)arg4 photoPickerConfiguration:(id)arg5;	// IMP=0x00600000002723ad
- (void).cxx_destruct;	// IMP=0x000000000027236f
...
- (id)build;	// IMP=0x000000000027205d
- (id)emojiContentGroup;	// IMP=0x0000000000271f2c
- (id)animojiContentGroup;	// IMP=0x0000000000271dd7
- (id)photoContentGroup;	// IMP=0x0000000000271b6a
- (id)injectedItemsGroup;	// IMP=0x0000000000271b07
- (id)addItemsContentGroup;	// IMP=0x000000000027199c
@property(readonly, nonatomic) _Bool includesAnyPhotoContent;
- (id)initWithVisualIdentity:(id)arg1 avatarStore:(id)arg2 environment:(id)arg3 contactViewCache:(id)arg4;	// IMP=0x0000000000271818
