...
- (void).cxx_destruct;	// IMP=0x002000000010e5e8
...
- (void)audioEngineAudioChunkForTvAvailable:(id)arg1 audioChunk:(id)arg2;	// IMP=0x001000000010e484
- (void)audioEngineBufferAvailable:(id)arg1 audioStreamHandleId:(unsigned long long)arg2 buffer:(id)arg3 remoteVAD:(id)arg4 atTime:(unsigned long long)arg5 isFileLoadedBuffer:(_Bool)arg6;	// IMP=0x001000000010e3cc
- (void)audioEngineDidStopRecord:(id)arg1 audioStreamHandleId:(unsigned long long)arg2 reason:(unsigned long long)arg3;	// IMP=0x001000000010e3c6
- (void)audioEngineDidStartRecord:(id)arg1 audioStreamHandleId:(unsigned long long)arg2 successfully:(_Bool)arg3 error:(id)arg4;	// IMP=0x001000000010e3c0
- (void)stopAudioStream;	// IMP=0x000000000010e36e
- (void)startAudioStreamWithOption:(id)arg1;	// IMP=0x001000000010e31c
- (_Bool)isRecording;	// IMP=0x001000000010e287
- (_Bool)injectAudio:(id)arg1 withScaleFactor:(float)arg2 playbackStarted:(CDUnknownBlockType)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x001000000010e258
- (_Bool)injectAudio:(id)arg1;	// IMP=0x001000000010e229
- (void)stop;	// IMP=0x001000000010e1d7
- (void)start;	// IMP=0x001000000010e185
- (void)dealloc;	// IMP=0x001000000010e0cb
- (void)attachDevice:(id)arg1;	// IMP=0x001000000010dfd9
- (_Bool)alwaysOnVoiceTriggerEnabled;	// IMP=0x001000000010df44
- (void)setAlwaysOnVoiceTriggerEnabled:(_Bool)arg1;	// IMP=0x001000000010deef
- (_Bool)isAlwaysOnVoiceTriggerAvailable;	// IMP=0x001000000010dee7
- (id)initWithStreamHandleId:(unsigned long long)arg1;	// IMP=0x001000000010dd7d
