...
@interface _TtC7NewsUI237ANFGraphicalScrollAdsDisabledTestCase : NSObject
{
...
- (void).cxx_destruct;	// IMP=0x0000000000e2d130
- (id)init;	// IMP=0x0000000000e2d0e0
- (id)scrollViewWithContext:(id)arg1;	// IMP=0x0000000000e2cf80
