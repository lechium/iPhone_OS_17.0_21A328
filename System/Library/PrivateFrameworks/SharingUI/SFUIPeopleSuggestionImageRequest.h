...
- (void).cxx_destruct;	// IMP=0x000000000003106d
...
- (id)initWithRequestID:(int)arg1 peopleSuggestion:(id)arg2 type:(long long)arg3 resultHandler:(CDUnknownBlockType)arg4;	// IMP=0x0000000000030f5e
