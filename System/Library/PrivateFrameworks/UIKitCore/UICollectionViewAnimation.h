...
- (void).cxx_destruct;	// IMP=0x0000000000476bfa
...
- (void)addStartupHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000476b5c
- (void)addCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000476b04
- (void)startWithAnimator:(id)arg1;	// IMP=0x0000000000475ae1
- (void)start;	// IMP=0x0000000000475acd
...
- (id)description;	// IMP=0x00000000004759e9
- (id)initWithView:(id)arg1 viewType:(long long)arg2 finalLayoutAttributes:(id)arg3 startFraction:(double)arg4 endFraction:(double)arg5 animateFromCurrentPostion:(_Bool)arg6 deleteAfterAnimation:(_Bool)arg7 customAnimations:(CDUnknownBlockType)arg8;	// IMP=0x0000000000475763
