...
- (void).cxx_destruct;	// IMP=0x0020000000159742
...
- (void)callsChangedForCallCenterObserver:(id)arg1;	// IMP=0x00100000001594e7
@property(nonatomic, getter=isOnEmergencyCall) _Bool onEmergencyCall; // @synthesize onEmergencyCall=_onEmergencyCall;
- (id)_callDirectoryPhoneNumberVariantsForSourceAddress:(id)arg1 countryCode:(id)arg2;	// IMP=0x00100000001591d0
- (_Bool)callDirectoryAllowsCallFromSourceAddress:(id)arg1 countryCode:(id)arg2;	// IMP=0x0010000000158f52
- (_Bool)callDirectoryAllowsCallFromSourceAddress:(id)arg1;	// IMP=0x0010000000158ebc
- (_Bool)_doNotDisturbAllowsCallFromSourceAddress:(id)arg1 providerIdentifier:(id)arg2;	// IMP=0x0010000000158bb3
- (id)_callFilterIdentifier;	// IMP=0x0010000000158b60
- (CDUnknownBlockType)_callFilterBlock;	// IMP=0x00100000001588a3
- (id)initWithDataSource:(id)arg1 deviceLockObserver:(id)arg2 callCenterObserver:(id)arg3 callDirectoryStoreBuilder:(CDUnknownBlockType)arg4 queue:(id)arg5;	// IMP=0x0010000000158509
- (id)init;	// IMP=0x0010000000158231
