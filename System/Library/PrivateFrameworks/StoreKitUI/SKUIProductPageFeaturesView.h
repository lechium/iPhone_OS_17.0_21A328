...
- (void).cxx_destruct;	// IMP=0x00000000001c8e28
...
- (id)_gameCenterStringWithFeatures:(unsigned long long)arg1;	// IMP=0x00000000001c86a9
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000001c8473
- (void)setBackgroundColor:(id)arg1;	// IMP=0x00000000001c82d5
- (void)layoutSubviews;	// IMP=0x00000000001c7e46
@property(copy, nonatomic) NSString *title;
- (void)setFeatures:(long long)arg1 gameCenterFeatures:(unsigned long long)arg2;	// IMP=0x00000000001c7415
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000001c7280
