...
@interface AVCaptureSessionInternal : NSObject
{
    ...
    int continuityCameraClientDeviceClass;	// 188 = 0xbc
    _Bool suppressVideoEffects;	// 192 = 0xc0
    struct OpaqueFigReentrantMutex *figCaptureSourceConfigChangeCacheMutex;	// 200 = 0xc8
    NSMutableArray *_devicesObservingVideoZoomFactor;	// 208 = 0xd0
    _Bool checkIfFileAlreadyExistForMFO;	// 216 = 0xd8
}
