...
@class MISSING_TYPE, NSArray, NSIndexPath, NSString, UIColor, UITableView, UITableViewCell, UIView, _UITableViewCellActionButton;
...
- (MISSING_TYPE *)tableView:swipeAccessoryButtonForRowAtIndexPath: /* Error: Ran out of types for this method. */;
