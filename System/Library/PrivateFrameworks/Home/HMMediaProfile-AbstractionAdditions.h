...
- (id)hf_associatedAccessories;	// IMP=0x002000000008bc65
- (id)hf_containedProfiles;	// IMP=0x002000000008bc53
- (id)hf_containedCharacteristics;	// IMP=0x002000000008bbe7
- (id)hf_containedServices;	// IMP=0x002000000008bb84
- (Class)hf_itemClass;	// IMP=0x002000000008bb73
- (id)hf_accessoryLikeObject;	// IMP=0x002000000008ba4f
- (id)hf_updateValue:(_Bool)arg1 forContextType:(unsigned long long)arg2;	// IMP=0x00200000001f5c2f
- (_Bool)hf_shouldHideForContextType:(unsigned long long)arg1;	// IMP=0x00200000001f5bbc
- (_Bool)hf_shouldBeOnForContextType:(unsigned long long)arg1;	// IMP=0x00200000001f5b26
- (_Bool)hf_hasSetForContextType:(unsigned long long)arg1;	// IMP=0x00200000001f5ad5
- (_Bool)hf_isOnForContextType:(unsigned long long)arg1;	// IMP=0x00200000001f5a84
- (id)hf_identify;	// IMP=0x00200000002700ba
- (unsigned long long)hf_preferredUserSelectionType;	// IMP=0x0020000000270076
- (id)hf_preferredMediaUser;	// IMP=0x0020000000270002
@property(readonly, nonatomic) _Bool hf_supportsPreferredMediaUser;
@property(readonly, nonatomic) _Bool hf_supportsHomeTheater;
- (id)hf_destination;	// IMP=0x002000000026fe38
- (id)hf_updateDateAdded:(id)arg1;	// IMP=0x002000000026fdc7
@property(readonly, copy, nonatomic) NSDate *hf_dateAdded;
@property(readonly, copy, nonatomic) NSString *hf_displayName;
- (id)hf_stateDumpBuilderWithContext:(id)arg1;	// IMP=0x002000000026fd23
- (id)hf_updateShowInHomeDashboard:(_Bool)arg1;	// IMP=0x002000000026fd0c
...
- (id)hf_updateIsFavorite:(_Bool)arg1;	// IMP=0x002000000026fcb0
...
- (id)hf_fetchLog:(id)arg1 timeout:(double)arg2;	// IMP=0x002000000026fbdd
- (id)hf_fetchLogListWithTimeout:(double)arg1;	// IMP=0x002000000026fb61
- (id)hf_idsDeviceIdentifierWithError:(id *)arg1;	// IMP=0x002000000026fabd
- (id)hf_siriLanguageOptionsManager;	// IMP=0x002000000026f860
- (id)hf_mediaAccessoryCommonSettingsManager;	// IMP=0x002000000026f5c2
@property(readonly, nonatomic) HFHomeKitSettingsValueManager *hf_settingsValueManager;
- (id)hf_isEitherHomePodMediaAccountOrHomeMediaAccountPresent;	// IMP=0x002000000026eccd
- (id)hf_homePodMediaAccountIsMismatchedWithHomeMediaAccount;	// IMP=0x002000000026e366
- (id)hf_homePodSupportsMultiUserLanguage;	// IMP=0x002000000026e35e
- (id)hf_appleMusicCurrentLoggedInAccountDSID;	// IMP=0x002000000026e356
- (id)hf_appleMusicCurrentLoggedInAccount;	// IMP=0x002000000026e34e
...
- (_Bool)hf_offersAutomation;	// IMP=0x002000000026d3cc
...
- (id)hf_rootAccessoryLikeHomeKitObject;	// IMP=0x00200000002ce615
