...
@interface SUUIDeveloperInfo : NSObject
{
...
- (void).cxx_destruct;	// IMP=0x000000000020ea35
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000020e7f3
- (id)formattedAddressString;	// IMP=0x000000000020e6a3
- (id)initWithDeveloperDictionary:(id)arg1;	// IMP=0x000000000020dec0
