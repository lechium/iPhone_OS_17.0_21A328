...
+ (void)updateMaxAllowedBitratePerConnection:(unsigned int *)arg1 connectionType:(int)arg2 negotiatedSettings:(id)arg3;	// IMP=0x006000000042fa2c
...
- (void)updateNegotiatedSettings:(id)arg1;	// IMP=0x000000000042fa57
- (unsigned int)maxAllowedBitrateForConnectionType:(int)arg1 operatingMode:(int)arg2;	// IMP=0x000000000042f9bc
- (unsigned int)maxAllowedBitrateForVCConnection:(id)arg1 forLocalInterface:(_Bool)arg2 operatingMode:(int)arg3 encodeRule:(id)arg4;	// IMP=0x000000000042f8d7
- (id)maxAllowedBitrateRuleForConnection:(int)arg1;	// IMP=0x000000000042f716
- (unsigned int)maxAllowedAudioOnlyBitrateForConnection:(int)arg1;	// IMP=0x000000000042f61b
- (unsigned int)maxAllowedScreenShareBitrateForConnection:(int)arg1;	// IMP=0x000000000042f520
- (unsigned int)maxAllowedBitrateForVCConnection:(id)arg1 forLocalInterface:(_Bool)arg2 encodeRule:(id)arg3;	// IMP=0x000000000042f2a1
- (unsigned int)maxAllowedBitrateForVCConnection:(id)arg1 forLocalInterface:(_Bool)arg2;	// IMP=0x000000000042f28c
- (unsigned int)maxAllowedBitrateForConnectionType:(int)arg1;	// IMP=0x000000000042f153
- (unsigned int)maxAllowedScreenShareCellularBitrate;	// IMP=0x000000000042f13a
- (unsigned int)maxAllowedCellularBitrate;	// IMP=0x000000000042f119
- (void)readCarrierBundleValues;	// IMP=0x000000000042f113
- (void)updateMaxAllowedBitrate:(unsigned int *)arg1 key:(struct __CFString *)arg2 type:(id)arg3 isAudio:(_Bool)arg4 carrierBundleBitrates:(struct __CFDictionary *)arg5;	// IMP=0x000000000042f10d
- (void)readStoreBagValues:(void *)arg1;	// IMP=0x000000000042efcb
- (int)storeBagBitrateForKey:(id)arg1;	// IMP=0x000000000042ef30
- (void)readHardwareValues;	// IMP=0x000000000042ef2a
- (void)addRuleForBitrate:(unsigned int)arg1 connectionType:(int)arg2 limitingRule:(id)arg3;	// IMP=0x000000000042eebb
- (void)createSupportedBitrateRuleSets;	// IMP=0x000000000042ee85
- (void)dealloc;	// IMP=0x000000000042ee27
- (id)initWithDeviceRole:(int)arg1 callLogFile:(void *)arg2;	// IMP=0x000000000042ec90
