...
+ (id)sendingRemoteMessage:(id)arg1 transportType:(int)arg2;	// IMP=0x00600000000a4cd5
+ (id)sendingRemoteMessage:(id)arg1 identifier:(id)arg2 transactionIdentifier:(id)arg3 messageType:(long long)arg4 peerInformation:(id)arg5 secure:(_Bool)arg6 transportType:(int)arg7 messageQoS:(long long)arg8;	// IMP=0x00600000000a4bf0
+ (id)receivedRemoteMessage:(id)arg1 transportType:(int)arg2;	// IMP=0x00600000000a4a79
+ (id)receivedRemoteMessage:(id)arg1 identifier:(id)arg2 transactionIdentifier:(id)arg3 messageType:(long long)arg4 peerInformation:(id)arg5 secure:(_Bool)arg6 transportType:(int)arg7 messageQoS:(long long)arg8;	// IMP=0x00600000000a4994
- (void).cxx_destruct;	// IMP=0x00000000000a4941
...
- (id)initWithRemoteMessage:(id)arg1 identifier:(id)arg2 transactionIdentifier:(id)arg3 messageType:(long long)arg4 peerInformation:(id)arg5 secure:(_Bool)arg6 transportType:(int)arg7 sending:(_Bool)arg8 messageQoS:(long long)arg9;	// IMP=0x00000000000a4736
