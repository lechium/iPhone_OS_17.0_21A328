...
- (void).cxx_destruct;	// IMP=0x0000000000735603
...
- (id)attributeDescriptions;	// IMP=0x000000000073526a
- (id)serializeFields;	// IMP=0x0000000000735071
- (id)initWithNeedsOnboardingField:(id)arg1 supportsOnboardingField:(id)arg2 siriEnableField:(id)arg3 siriListeningField:(id)arg4 siriTouchToUseField:(id)arg5 siriLightOnUseField:(id)arg6 siriSoundOnUseField:(id)arg7;	// IMP=0x0000000000734e5e
