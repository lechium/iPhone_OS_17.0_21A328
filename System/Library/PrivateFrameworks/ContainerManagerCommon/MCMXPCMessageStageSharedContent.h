...
- (void).cxx_destruct;	// IMP=0x0000000000048d49
...
- (unsigned int)disposition;	// IMP=0x0000000000048c48
- (id)initWithXPCObject:(id)arg1 context:(id)arg2 error:(unsigned long long *)arg3;	// IMP=0x0000000000048b46
