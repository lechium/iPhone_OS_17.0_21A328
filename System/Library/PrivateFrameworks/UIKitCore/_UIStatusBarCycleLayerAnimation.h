...
+ (id)cycleAnimationWithLayer:(id)arg1 animation:(id)arg2 key:(id)arg3;	// IMP=0x0060000001199d61
- (void).cxx_destruct;	// IMP=0x000000000119a07d
...
- (id)description;	// IMP=0x0000000001199f21
