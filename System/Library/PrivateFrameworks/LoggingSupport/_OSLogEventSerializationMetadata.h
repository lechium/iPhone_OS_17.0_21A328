...
- (void).cxx_destruct;	// IMP=0x000000000003f53f
...
- (id)stringForIndex:(id)arg1;	// IMP=0x000000000003f3ff
- (id)indexForString:(id)arg1;	// IMP=0x000000000003f2f3
- (id)dataRepresentation;	// IMP=0x000000000003eedb
- (id)initWithDataRepresentation:(id)arg1;	// IMP=0x000000000003ea51
- (id)init;	// IMP=0x000000000003e9eb
