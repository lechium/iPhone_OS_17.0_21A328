...
- (id)newAccessoryDisclosureIndicatorViewForVibrationPickerCell;	// IMP=0x00000000002d38a7
- (id)newBackgroundViewForSelectedVibrationPickerCell:(_Bool)arg1;	// IMP=0x00000000002d3895
...
- (id)newAccessoryDisclosureIndicatorViewForTonePickerCell;	// IMP=0x00000000002d3580
- (id)newBackgroundViewForSelectedTonePickerCell:(_Bool)arg1;	// IMP=0x00000000002d3472
