...
- (void).cxx_destruct;	// IMP=0x00000000007c4253
...
- (void)_performDelayedFocusingAnimationIfNecessary;	// IMP=0x00000000007c4166
- (void)_scheduleDelayedFocusingAnimationWithDelay:(double)arg1;	// IMP=0x00000000007c40a2
- (void)didUpdateFocusInContext:(id)arg1 fromItem:(id)arg2;	// IMP=0x00000000007c3b54
- (id)willUpdateFocusInContext:(id)arg1;	// IMP=0x00000000007c39b9
- (id)init;	// IMP=0x00000000007c394e
