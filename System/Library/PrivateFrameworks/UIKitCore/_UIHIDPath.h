...
- (void).cxx_destruct;	// IMP=0x0000000001095410
...
- (void)applyTransform:(struct CGAffineTransform)arg1;	// IMP=0x0000000001095326
- (void)updateWithHIDEvent:(struct __IOHIDEvent *)arg1;	// IMP=0x0000000001094f24
- (id)init;	// IMP=0x0000000001094ee8
