...
- (void).cxx_destruct;	// IMP=0x002000000002908c
...
- (oneway void)allCallHistoryDeleted;	// IMP=0x0010000000028f4d
- (oneway void)recentCallsDeleted:(id)arg1;	// IMP=0x0010000000028dc0
- (void)unregisterClient:(id)arg1;	// IMP=0x0010000000028cb7
- (void)registerClient:(id)arg1;	// IMP=0x0010000000028bae
- (void)notifyClientsToConnectIfNecessary;	// IMP=0x0010000000028b06
- (void)invalidate;	// IMP=0x00100000000289fd
- (void)dealloc;	// IMP=0x0010000000028971
- (id)initWithCallHistoryController:(id)arg1;	// IMP=0x0010000000028417
