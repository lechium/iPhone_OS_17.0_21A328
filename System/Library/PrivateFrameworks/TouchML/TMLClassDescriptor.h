...
+ (id)decode:(const struct ProtobufCMessage *)arg1;	// IMP=0x001000000005edc5
- (void).cxx_destruct;	// IMP=0x000000000005f15b
...
- (void)encode:(struct ProtobufCMessage *)arg1;	// IMP=0x000000000005e904
- (_Bool)mergeFromClassDescriptor:(id)arg1;	// IMP=0x000000000005e4ca
- (_Bool)canMergeFromClassDescriptor:(id)arg1;	// IMP=0x000000000005df9d
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000005dbd4
- (void)addChildClass:(id)arg1;	// IMP=0x000000000005db68
- (void)addMethod:(id)arg1;	// IMP=0x000000000005dafc
- (void)addSignal:(id)arg1;	// IMP=0x000000000005da90
- (id)propertyForName:(id)arg1;	// IMP=0x000000000005da05
- (void)addProperty:(id)arg1;	// IMP=0x000000000005d999
@property(readonly, nonatomic) Class objcClass; // @synthesize objcClass=_objcClass;
- (id)initWithName:(id)arg1 superClassName:(id)arg2 initializer:(id)arg3 optional:(_Bool)arg4;	// IMP=0x000000000005d7f7
