...
+ (double)maximumHeightWithVisibleFields:(unsigned long long)arg1;	// IMP=0x006000000005148c
- (void).cxx_destruct;	// IMP=0x0000000000053986
...
- (void)_reloadUserRatingViews;	// IMP=0x0000000000053542
- (id)_newDefaultLabel;	// IMP=0x0000000000053438
- (id)_decimalNumberFormatter;	// IMP=0x00000000000533ca
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000000530bf
- (void)setBackgroundColor:(id)arg1;	// IMP=0x0000000000052f74
- (void)drawRect:(struct CGRect)arg1;	// IMP=0x000000000005229b
...
- (void)setColoringWithColorScheme:(id)arg1;	// IMP=0x0000000000051a19
@property(copy, nonatomic) NSString *categoryString;
@property(copy, nonatomic) NSString *editorialBadgeString;
@property(copy, nonatomic) NSString *artistName;
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000000513de
