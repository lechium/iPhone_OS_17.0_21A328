...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000018f571
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000018f515
- (unsigned long long)hash;	// IMP=0x001000000018f50b
- (id)valueForSessionProperty:(id)arg1;	// IMP=0x001000000018f4e4
@property(copy, nonatomic) NSString *statusDescription;
- (void)setValue:(id)arg1 forSessionProperty:(id)arg2;	// IMP=0x001000000018f47f
@property(nonatomic) long long sessionState;
- (void)setSessionPropertyValues:(id)arg1;	// IMP=0x001000000018f3b5
...
- (void)dealloc;	// IMP=0x001000000018f153
- (id)initWithSessionProperties:(id)arg1;	// IMP=0x001000000018f118
- (id)init;	// IMP=0x001000000018f0a5
