...
- (id).cxx_construct;	// IMP=0x0000000000326884
- (void).cxx_destruct;	// IMP=0x0000000000326831
...
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x0000000000326549
- (void)resumeAnimation;	// IMP=0x000000000032644e
- (void)pauseAnimation;	// IMP=0x00000000003263ed
- (_Bool)isAnimating;	// IMP=0x0000000000326385
@property(readonly, nonatomic) _Bool shouldForceZoomToFit;
- (void)setGesturing:(_Bool)arg1;	// IMP=0x00000000003262ef
- (void)stopTrackingAnnotation;	// IMP=0x0000000000326187
- (void)startTrackingAnnotation:(id)arg1 trackHeading:(_Bool)arg2 animated:(_Bool)arg3 duration:(double)arg4 timingFunction:(CDUnknownBlockType)arg5;	// IMP=0x0000000000325de4
- (void)_rotateToHeadingAnimated:(_Bool)arg1 duration:(double)arg2;	// IMP=0x0000000000325dde
- (void)_goToAnnotationAnimated:(_Bool)arg1 duration:(double)arg2 timingFunction:(CDUnknownBlockType)arg3 isInitial:(_Bool)arg4;	// IMP=0x0000000000325dd8
- (void)updateFramerate;	// IMP=0x0000000000325cd6
@property(readonly, nonatomic, getter=isTrackingHeading) _Bool trackingHeading;
- (void)dealloc;	// IMP=0x0000000000325b7e
- (id)initWithMapDataAccess:(struct MapDataAccess *)arg1 animationRunner:(struct AnimationRunner *)arg2 runLoopController:(struct RunLoopController *)arg3 cameraDelegate:(id)arg4;	// IMP=0x0000000000325b21
