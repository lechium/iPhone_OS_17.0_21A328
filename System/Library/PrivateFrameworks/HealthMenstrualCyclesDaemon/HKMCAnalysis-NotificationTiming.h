...
- (_Bool)isEarliestNotificationScheduledAfterDate:(id)arg1 gregorianCalendar:(id)arg2;	// IMP=0x0030000000039583
- (id)hdmc_fertileWindowDidUpdateDueToSensorDataNotificationForNotificationFireDate:(id)arg1 lastFiredDate:(id)arg2 fertileWindowNotificationTimeOfDay:(id)arg3;	// IMP=0x0030000000039108
...
- (id)_hdmc_firstPeriodStartProjection;	// IMP=0x0030000000038bbb
@end
