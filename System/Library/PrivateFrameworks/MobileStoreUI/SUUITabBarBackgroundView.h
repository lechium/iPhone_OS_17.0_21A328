...
- (void).cxx_destruct;	// IMP=0x0000000000373c6a
...
- (void)updateBackgroundImage;	// IMP=0x0000000000373b82
- (void)_setIsContainedInPopover:(_Bool)arg1;	// IMP=0x0000000000373b7c
- (void)_setFrame:(struct CGRect)arg1 forceUpdateBackgroundImage:(_Bool)arg2;	// IMP=0x0000000000373b6a
- (id)_currentCustomBackgroundRespectOversize_legacy:(_Bool *)arg1;	// IMP=0x0000000000373b62
- (id)_currentCustomBackground;	// IMP=0x0000000000373b5a
- (void)layoutSubviews;	// IMP=0x0000000000373a41
@property(copy, nonatomic) NSString *backdropGroupName;
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000003737c6
