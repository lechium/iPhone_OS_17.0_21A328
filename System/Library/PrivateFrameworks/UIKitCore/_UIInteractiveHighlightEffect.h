...
- (void).cxx_destruct;	// IMP=0x0000000000f2e2e9
...
- (void)dealloc;	// IMP=0x0000000000f2e1c6
- (void)finalizeEffect;	// IMP=0x0000000000f2e1ad
- (void)applyBackgroundEffectWithMagnitude:(double)arg1 interactive:(_Bool)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x0000000000f2e130
