...
- (void).cxx_destruct;	// IMP=0x00000000007d3f0c
...
- (id)initWithStagedDestinationIdentifier:(id)arg1 isTriggeredOnControllerDevice:(id)arg2 userPrivilege:(id)arg3;	// IMP=0x00000000007d3ce7
