...
- (void).cxx_destruct;	// IMP=0x00000000001346ad
...
- (id)revealedAnalyticsModule;	// IMP=0x0000000000134652
- (_Bool)isImpressionable;	// IMP=0x000000000013464a
- (int)analyticsModuleType;	// IMP=0x000000000013462d
- (id)analyticsModule;	// IMP=0x0000000000134610
- (id)infoCardChildUnactionableUIElements;	// IMP=0x00000000001345f3
- (id)infoCardChildPossibleActions;	// IMP=0x00000000001345d6
@property(nonatomic) __weak id <MUInfoCardAnalyticsDelegate> analyticsDelegate;
- (void)headerButtonsSectionControllerWillPresentMenu:(id)arg1;	// IMP=0x000000000013457d
- (void)headerButtonsSectionController:(id)arg1 didSelectPrimaryType:(unsigned long long)arg2 withPresentationOptions:(id)arg3;	// IMP=0x0000000000134503
- (void)headerButtonsSectionControllerDidUpdateContent:(id)arg1;	// IMP=0x00000000001344b7
...
- (id)initWithPlaceItem:(id)arg1 configuration:(id)arg2;	// IMP=0x0000000000133ea3
