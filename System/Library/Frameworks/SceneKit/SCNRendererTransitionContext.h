...
- (void)dealloc;	// IMP=0x00000000001a9ead
- (id)prepareRendererAtIndex:(int)arg1 withScene:(id)arg2 renderSize:(struct CGSize)arg3 pointOfView:(id)arg4 parentRenderer:(id)arg5;	// IMP=0x00000000001a9d32
- (struct __C3DFXPass *)transitionPass;	// IMP=0x00000000001a9cde
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001a9c3c
