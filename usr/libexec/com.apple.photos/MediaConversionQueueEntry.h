...
- (void).cxx_destruct;	// IMP=0x002000000000aece
...
- (_Bool)allRequestsAreBackground;	// IMP=0x001000000000acef
- (_Bool)allRequestsAreOptional;	// IMP=0x001000000000ac50
- (_Bool)allRequestsHaveRequestPriority:(long long)arg1;	// IMP=0x001000000000abaa
- (long long)compareProcessingOrderToEntry:(id)arg1;	// IMP=0x001000000000a9a7
@property(readonly) NSArray *clientRequestsSnapshot;
- (void)videoConversionTask:(id)arg1 didUpdateFractionCompleted:(double)arg2;	// IMP=0x001000000000a7fe
- (id)requestIdentifiersForConnectionIdentifier:(id)arg1;	// IMP=0x001000000000a720
- (id)anyDestinationURLCollection;	// IMP=0x001000000000a64d
- (id)clientRequestForIdentifier:(id)arg1;	// IMP=0x001000000000a53a
- (id)removeAndReturnClientRequestWithIdentifier:(id)arg1 remainingRequestCount:(long long *)arg2;	// IMP=0x001000000000a2ff
- (_Bool)clientRequestIsDuplicate:(id)arg1 identicalDestination:(_Bool *)arg2;	// IMP=0x001000000000a211
- (void)didDequeueAndStartProcessingQueueEntry;	// IMP=0x001000000000a1f8
- (void)withLockEnumerateClientRequests:(CDUnknownBlockType)arg1;	// IMP=0x001000000000a146
- (void)addClientRequest:(id)arg1;	// IMP=0x001000000000a065
- (id)description;	// IMP=0x0010000000009f94
- (void)dealloc;	// IMP=0x0010000000009e67
- (id)initWithIdentifier:(id)arg1 initialConversionOptions:(id)arg2;	// IMP=0x0010000000009d32
