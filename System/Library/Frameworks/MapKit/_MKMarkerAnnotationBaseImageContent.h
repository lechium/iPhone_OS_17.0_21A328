...
- (void).cxx_destruct;	// IMP=0x000000000019799a
...
- (id)initWithFillColor:(id)arg1 strokeColor:(id)arg2 strokeWidth:(double)arg3 blendMode:(int)arg4 baseImageType:(long long)arg5;	// IMP=0x00000000001978aa
