...
- (unsigned long long)analyzedWithoutResourcesCounter:(unsigned long long)arg1;	// IMP=0x001000000004335a
- (void)addAnalyzedWithoutResourcesCounter:(unsigned long long)arg1;	// IMP=0x001000000004334c
- (unsigned long long)analyzedWithResourcesCounter:(unsigned long long)arg1;	// IMP=0x001000000004333e
- (void)addAnalyzedWithResourcesCounter:(unsigned long long)arg1;	// IMP=0x0010000000043330
- (unsigned long long);	// IMP=0x0010000000043325
- (void)addUnanalyzedWithoutResourcesCounter:(unsigned long long)arg1;	// IMP=0x001000000004331a
- (unsigned long long)unanalyzedWithResourcesCounter:(unsigned long long)arg1;	// IMP=0x001000000004330f
- (void)addUnanalyzedWithResourcesCounter:(unsigned long long)arg1;	// IMP=0x0010000000043304
- (id)init;	// IMP=0x00100000000432a3
