...
- (void).cxx_destruct;	// IMP=0x000000000000959c
...
- (void)_handleUpdatedUnderlyingActiveKeepLocalStatus:(struct MPLibraryActiveKeepLocalStatus)arg1;	// IMP=0x0000000000009500
- (struct MusicKit_SoftLinking_MPLibraryActiveKeepLocalStatus)_activeKeepLocalStatusFromUnderlyingStatus:(struct MPLibraryActiveKeepLocalStatus)arg1 underlyingDownloadPauseReasons:(unsigned long long)arg2;	// IMP=0x00000000000094d9
- (void)calculateDownloadProgressWithChildren:(id)arg1;	// IMP=0x000000000000927a
@property(readonly, nonatomic) struct MusicKit_SoftLinking_MPLibraryActiveKeepLocalStatus currentStatus;
- (id)initWithIdentifyingModelObject:(id)arg1;	// IMP=0x0000000000008d78
