...
@class CKAggregateAttachmentMessagePartChatItem, CKAttachmentMessagePartChatItem, CKBalloonView, CKBrowserItemPayload, CKChatItem, CKComposition, CKConversation, CKFullScreenEffect, CKInlineReplyTransitionProperties, CKMessageStatusChatItem, CKTranscriptStatusCell, CKViewController, IMSticker, NSArray, NSIndexPath, NSIndexSet, NSString, PXAssetReference, UIContextMenuConfiguration, UIContextMenuInteraction, UITargetedPreview, UITraitCollection, UIView, UIViewController, _UIContextMenuStyle;
...
- (_Bool)transcriptCollectionViewControllerShouldShouldScrollToTopForStatusBarTap:(CKViewController<CKCoreTranscriptControllerProtocol> *)arg1;
