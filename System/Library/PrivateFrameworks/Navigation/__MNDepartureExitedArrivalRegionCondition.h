...
- (void).cxx_destruct;	// IMP=0x00000000000e9b67
- (double)scoreForLocation:(id)arg1;	// IMP=0x00000000000e9601
- (id)initWithUpdater:(id)arg1 arrivalRegions:(id)arg2;	// IMP=0x00000000000e951c
