...
- (void).cxx_destruct;	// IMP=0x002000000006fb18
...
- (id)headlineNotification_dictionaryRepresentation;	// IMP=0x001000000006f934
- (id)initWithDictionary:(id)arg1;	// IMP=0x001000000006f79c
- (id)initWithHeadline:(id)arg1;	// IMP=0x001000000006f2d3
