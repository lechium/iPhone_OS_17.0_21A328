...
- (void).cxx_destruct;	// IMP=0x00000000004fdfe3
...
- (void)updateConfigWithAccessory:(id)arg1 reportNetworkProtectionMetrics:(_Bool)arg2 networkProtectionEnabled:(_Bool)arg3 hapServiceTypes:(id)arg4 primaryHAPServiceTypes:(id)arg5;	// IMP=0x00000000004f9e38
- (id)initWithDataSource:(id)arg1 home:(id)arg2;	// IMP=0x00000000004f8197
- (id)initWithHome:(id)arg1;	// IMP=0x00000000004f8182
- (long long)weeksSinceDate:(id)arg1 trimAtMaximumValue:(unsigned long long)arg2;	// IMP=0x00000000004f811c
- (long long)daysSinceDate:(id)arg1 trimAtMaximumValue:(unsigned long long)arg2;	// IMP=0x00000000004f8055
- (void)setHomeConfigurationBitMasks;	// IMP=0x00000000004f7f39
