...
- (void).cxx_destruct;	// IMP=0x0000000000015eb6
...
- (id)featureAvailabilityExtensionForFeatureIdentifier:(id)arg1;	// IMP=0x0000000000015ea4
- (id)initWithProfile:(id)arg1;	// IMP=0x0000000000015d29
