...
- (void).cxx_destruct;	// IMP=0x000000000081777a
...
- (id)mainReturningError;	// IMP=0x0000000000817262
- (id)initWithAtomicSaveEnabled:(_Bool)arg1 transaction:(id)arg2;	// IMP=0x00000000008171cf
- (id)initWithTransaction:(id)arg1;	// IMP=0x0000000000817188
