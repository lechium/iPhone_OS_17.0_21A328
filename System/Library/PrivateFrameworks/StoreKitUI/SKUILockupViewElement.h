...
- (long long)pageComponentType;	// IMP=0x0000000000146e96
- (_Bool)isEnabled;	// IMP=0x0000000000146e52
- (id)applyUpdatesWithElement:(id)arg1;	// IMP=0x0000000000146dac
...
- (id)initWithDOMElement:(id)arg1 parent:(id)arg2 elementFactory:(id)arg3;	// IMP=0x00000000001469dc
