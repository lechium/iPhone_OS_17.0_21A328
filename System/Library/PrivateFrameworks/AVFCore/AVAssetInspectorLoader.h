...
+ (void)initialize;	// IMP=0x00100000000f8cc8
- (id)_createAVErrorForError:(id)arg1 andFigErrorCode:(int)arg2;	// IMP=0x00000000000f8fc4
- (void)loadValuesAsynchronouslyForKeys:(id)arg1 keysForCollectionKeys:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000000000f8faf
- (void)_ensureAllDependenciesOfKeyAreLoaded:(id)arg1;	// IMP=0x00000000000f8fa9
- (void)_setIsAssociatedWithFragmentMinder:(_Bool)arg1;	// IMP=0x00000000000f8fa3
...
- (struct OpaqueFigFormatReader *)_copyFormatReader;	// IMP=0x00000000000f8e98
@property(readonly, nonatomic) NSURL *URL;
- (void)cancelLoading;	// IMP=0x00000000000f8e8a
- (id)assetInspector;	// IMP=0x00000000000f8e82
- (void)loadValuesAsynchronouslyForKeys:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000000000f8e57
- (long long)statusOfValueForKey:(id)arg1 error:(id *)arg2;	// IMP=0x00000000000f8e29
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000f8e1e
- (void)dealloc;	// IMP=0x00000000000f8de3
@property(readonly, nonatomic, getter=_weakReference) AVWeakReference *weakReference;
- (id)init;	// IMP=0x00000000000f8d7a
