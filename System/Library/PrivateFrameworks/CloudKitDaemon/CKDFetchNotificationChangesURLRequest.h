...
- (void).cxx_destruct;	// IMP=0x0000000000298b69
...
- (id)requestDidParseProtobufObject:(id)arg1;	// IMP=0x0000000000298630
- (id)generateRequestOperations;	// IMP=0x00000000002983cb
- (id)requestOperationClasses;	// IMP=0x000000000029835f
- (void)fillOutEquivalencyPropertiesBuilder:(id)arg1;	// IMP=0x00000000002982c4
- (id)initWithOperation:(id)arg1 serverChangeTokenData:(id)arg2;	// IMP=0x000000000029822b
