...
- (id).cxx_construct;	// IMP=0x00000000000256e8
- (void).cxx_destruct;	// IMP=0x0000000000025692
@property(readonly) NSUUID *peer; // @synthesize peer=_peer;
- (long long)deviceProximity;	// IMP=0x0000000000025674
- (_Bool)proxReady;	// IMP=0x0000000000025601
- (void)addSample:(struct BtProxData)arg1;	// IMP=0x000000000002557c
- (id)initWithPeer:(id)arg1 andPeerModel:(id)arg2 withError:(id *)arg3;	// IMP=0x0000000000025232
- (id)init;	// IMP=0x00000000000251f4
