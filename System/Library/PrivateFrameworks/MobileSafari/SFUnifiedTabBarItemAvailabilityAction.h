...
- (void).cxx_destruct;	// IMP=0x000000000004467a
...
- (void)performAction;	// IMP=0x0000000000044646
- (id)initWithTitle:(id)arg1 image:(id)arg2 buttonType:(long long)arg3 action:(CDUnknownBlockType)arg4;	// IMP=0x0000000000044550
