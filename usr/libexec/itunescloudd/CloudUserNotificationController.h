...
- (void).cxx_destruct;	// IMP=0x0020000000049af4
...
- (id)_createBag;	// IMP=0x0010000000049a97
- (void)userNotificationCenter:(id)arg1 didReceiveNotificationResponse:(id)arg2 withCompletionHandler:(CDUnknownBlockType)arg3;	// IMP=0x001000000004996a
- (void)userNotificationCenter:(id)arg1 didChangeSettings:(id)arg2;	// IMP=0x0010000000049790
- (id)init;	// IMP=0x0010000000049641
