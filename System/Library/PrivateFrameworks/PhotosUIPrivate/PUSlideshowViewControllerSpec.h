...
- (void)updateIfNeeded;	// IMP=0x000000000052801f
- (id)initWithMode:(unsigned long long)arg1;	// IMP=0x0000000000527fdb
- (id)init;	// IMP=0x0000000000527fc7
@property(readonly, nonatomic) PUSlideshowViewControllerSpecChange *currentChange;
- (id)newSpecChange;	// IMP=0x0000000000527f78
