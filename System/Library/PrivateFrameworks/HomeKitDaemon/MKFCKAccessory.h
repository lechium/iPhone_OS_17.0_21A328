...
+ (id)fetchRequest;	// IMP=0x0000000000d35352
- (_Bool)exportFromLocalModel:(id)arg1 updatedProperties:(id)arg2 context:(id)arg3;	// IMP=0x0000000000895d62
- (_Bool)importIntoLocalModel:(id)arg1 updatedProperties:(id)arg2 context:(id)arg3;	// IMP=0x00000000008954e3
- (_Bool)isReadyToImportIntoLocalModelWithContext:(id)arg1;	// IMP=0x00000000008953ac
