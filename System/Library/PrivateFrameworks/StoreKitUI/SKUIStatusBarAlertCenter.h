...
+ (id)sharedCenter;	// IMP=0x00100000002d0126
- (void).cxx_destruct;	// IMP=0x00000000002d0bd7
...
- (void)statusBarAlertViewControllerWasTapped:(id)arg1;	// IMP=0x00000000002d0b12
- (void)dismiss;	// IMP=0x00000000002d097b
- (void)scheduleDismiss;	// IMP=0x00000000002d0938
- (void)unscheduleDismiss;	// IMP=0x00000000002d0912
- (void)showMessage:(id)arg1 withStyle:(long long)arg2 forDuration:(double)arg3 actionBlock:(CDUnknownBlockType)arg4;	// IMP=0x00000000002d043b
@property(readonly, copy, nonatomic) NSString *message;
@property(nonatomic, getter=isVisible) _Bool visible;
- (id)init;	// IMP=0x00000000002d01be
