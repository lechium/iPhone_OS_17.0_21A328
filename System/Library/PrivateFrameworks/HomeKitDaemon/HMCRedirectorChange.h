...
- (void).cxx_destruct;	// IMP=0x0000000000c8c71f
...
- (void)dumpForLoggingWithPrefix:(id)arg1 logType:(unsigned char)arg2;	// IMP=0x0000000000c8c4d3
- (id)descriptionLines;	// IMP=0x0000000000c8c206
- (id)description;	// IMP=0x0000000000c8c109
