...
- (void)deregisterWithUUID:(id)arg1 service:(char *)arg2;	// IMP=0x000000000032f705
- (void)registerBlockWithUUID:(id)arg1 service:(char *)arg2 block:(CDUnknownBlockType)arg3;	// IMP=0x000000000032ede6
- (void)deregisterFromNotifications;	// IMP=0x000000000032ec97
- (void)dealloc;	// IMP=0x000000000032ec0f
- (id)init;	// IMP=0x000000000032eae3
