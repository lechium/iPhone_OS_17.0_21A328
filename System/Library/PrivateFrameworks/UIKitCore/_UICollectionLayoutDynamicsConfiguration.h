...
- (void).cxx_destruct;	// IMP=0x00000000003642b0
...
- (id)_dirtyItems;	// IMP=0x000000000036422b
- (void)_reset;	// IMP=0x00000000003641bb
- (void)_setBehaviors:(id)arg1 forItem:(id)arg2;	// IMP=0x00000000003640b3
@property(retain, nonatomic) NSArray *dynamicItems;
- (void)setBehaviors:(id)arg1 forItem:(id)arg2;	// IMP=0x0000000000363fcf
- (id)behaviorsForItem:(id)arg1;	// IMP=0x0000000000363eb1
- (id)init;	// IMP=0x0000000000363e3c
