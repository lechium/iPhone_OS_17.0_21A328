...
- (double)updatedOutput;	// IMP=0x0000000000046fb0
- (double)initialOutputForInput:(double)arg1;	// IMP=0x0000000000046fa7
- (id)initWithInput:(double)arg1;	// IMP=0x0000000000046f5d
