...
- (void).cxx_destruct;	// IMP=0x0020000000025f9a
...
- (void)updateWithRawAdvertisementData:(id)arg1 receivedViaScanning:(_Bool)arg2 isReplay:(_Bool)arg3 newAdvertisementHandler:(CDUnknownBlockType)arg4;	// IMP=0x0010000000024f39
- (void)updateWithRawAdvertisementData:(id)arg1 receivedViaScanning:(_Bool)arg2 newAdvertisementHandler:(CDUnknownBlockType)arg3;	// IMP=0x0010000000024f21
- (id)description;	// IMP=0x0010000000024e3c
- (id)initWithDevice:(id)arg1;	// IMP=0x0010000000024daa
