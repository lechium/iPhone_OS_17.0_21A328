...
+ (id)stringForLinkQuality:(int)arg1;	// IMP=0x0010000000013822
+ (_Bool)isBadLinkQuality:(int)arg1;	// IMP=0x0010000000012a30
+ (_Bool)isPoorLinkQuality:(int)arg1;	// IMP=0x00100000000129e0
- (void).cxx_destruct;	// IMP=0x000000000001421c
- (_Bool)_createLinkQualityMonitor:(_Bool)arg1;	// IMP=0x0000000000013e2a
- (void)_dynamicStoreCallbackForKeys:(id)arg1;	// IMP=0x0000000000013dc5
- (void)_dynamicStoreCallback:(id)arg1;	// IMP=0x0000000000013b2d
- (void)_processLinkQualityUpdateWithChangedKey:(id)arg1 updatedLinkQuality:(int)arg2;	// IMP=0x0000000000013864
- (void)_unscheduleLinkQualityMonitor;	// IMP=0x00000000000137db
- (void)_updatePathParameters;	// IMP=0x00000000000136ed
- (void)_pathUpdate:(id)arg1;	// IMP=0x0000000000013091
- (void)_createPathEvaluator;	// IMP=0x0000000000012edd
- (void)_unschedulePathEvaluator;	// IMP=0x0000000000012df8
- (void)_callDelegateWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000000012c71
...
- (_Bool)_isInterfaceHistoricallyUsable;	// IMP=0x000000000001290d
@property(readonly, nonatomic) _Bool isInterfaceUsable;
- (_Bool)_isInterfaceUsable;	// IMP=0x00000000000128ae
- (void)setTrackedTimeInterval:(double)arg1;	// IMP=0x000000000001284b
- (void)setThresholdOffTransitionCount:(unsigned long long)arg1;	// IMP=0x00000000000127f8
- (void)setTrackUsability:(_Bool)arg1;	// IMP=0x0000000000012772
- (void)_flushStaleTransitions;	// IMP=0x00000000000125f0
- (void)_updateOffTransitionsForLinkQualityChange;	// IMP=0x0000000000012531
- (id)currentInterfaceName;	// IMP=0x00000000000124be
- (void)dealloc;	// IMP=0x0000000000012429
- (id)initWithInterfaceIdentifier:(long long)arg1 delegateQueue:(id)arg2;	// IMP=0x000000000001231b
- (id)init;	// IMP=0x000000000001229d
