...
- (void)_invalidateTimer;	// IMP=0x0000000000012459
- (void)_updateHideControlsAfterDelayTimer;	// IMP=0x0000000000012283
- (_Bool)_controlsShouldAutoHide;	// IMP=0x00000000000121d2
- (id)_performVisibilityTransitionAnimated:(_Bool)arg1 existingAnimator:(id)arg2 animations:(CDUnknownBlockType)arg3 success:(CDUnknownBlockType)arg4;	// IMP=0x0000000000011e99
- (id)_updateVisibilityOfView:(id)arg1 hidden:(_Bool)arg2 animated:(_Bool)arg3 existingAnimator:(id)arg4;	// IMP=0x0000000000011ce3
- (void)_setControlsHidden:(_Bool)arg1 animated:(_Bool)arg2;	// IMP=0x0000000000011c35
- (void)_setPrefersControlsHidden:(_Bool)arg1 animated:(_Bool)arg2;	// IMP=0x00000000000119c2
- (id)_acquirePreventAutoHideOfControlsAssertionWithReason:(id)arg1;	// IMP=0x000000000001178c
- (id)PG_acquireAssertionToPreventAutoHideOfControlsWithReason:(id)arg1;	// IMP=0x000000000001177a
- (void)_handleHoverGestureRecognizer:(id)arg1;	// IMP=0x0000000000011670
- (void)_handleDoubleDoubleTapGestureRecognizer:(id)arg1;	// IMP=0x0000000000011644
- (void)_handleDoubleTapGestureRecognizer:(id)arg1;	// IMP=0x0000000000011627
- (void)_handleSingleTapGestureRecognizer:(id)arg1;	// IMP=0x00000000000115dc
- (_Bool)gestureRecognizer:(id)arg1 shouldRequireFailureOfGestureRecognizer:(id)arg2;	// IMP=0x0000000000011556
- (_Bool)gestureRecognizerShouldBegin:(id)arg1;	// IMP=0x00000000000113ce
- (void)controlsViewModel:(id)arg1 valuesChangedFromOldValue:(id)arg2;	// IMP=0x0000000000010f29
- (void)controlsViewModel:(id)arg1 didIssueCommand:(id)arg2;	// IMP=0x0000000000010e73
- (void)setHoverGestureDisbaled:(_Bool)arg1;	// IMP=0x0000000000010e50
- (id)viewModel;	// IMP=0x0000000000010e3b
- (void)setControlsContainerHidden:(_Bool)arg1 animated:(_Bool)arg2;	// IMP=0x0000000000010d68
- (void)_setContinuousCornerRadius:(double)arg1;	// IMP=0x0000000000010cf4
- (void)layoutSubviews;	// IMP=0x0000000000010c29
- (void)didMoveToWindow;	// IMP=0x0000000000010b33
- (id)initWithFrame:(struct CGRect)arg1 viewModel:(id)arg2;	// IMP=0x0000000000010811
