...
+ (unsigned long long)_kMaxLinesInSectionBeforePage;	// IMP=0x006000000006a3b6
+ (unsigned long long)_kNumLinesFallbackValue;	// IMP=0x006000000006a3a9
+ (id)defaultFilterForInactiveLines;	// IMP=0x006000000006a328
+ (id)defaultFilterForDepartures;	// IMP=0x006000000006a2a7
