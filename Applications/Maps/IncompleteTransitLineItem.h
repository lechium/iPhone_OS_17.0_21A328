...
- (void).cxx_destruct;	// IMP=0x00200000001cb1ed
...
- (id)initWithTransitLine:(id)arg1;	// IMP=0x00100000001cae0b
- (id)initWithIdentifier:(id)arg1 name:(id)arg2;	// IMP=0x00100000001cad60
- (id)initWithLabelMarker:(id)arg1 system:(id)arg2;	// IMP=0x00100000001cacc7
- (id)initWithLabelMarker:(id)arg1;	// IMP=0x00100000001cacb3
