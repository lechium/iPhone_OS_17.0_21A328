...
+ (id)customAttributes;	// IMP=0x0060000000049652
...
- (id)outputImage;	// IMP=0x00000000000499d5
- (_Bool)_isIdentity;	// IMP=0x00000000000499cd
- (id)_kernel;	// IMP=0x0000000000049632
