...
+ (id)logCategory;	// IMP=0x0010000000b282d8
- (void).cxx_destruct;	// IMP=0x0000000000b281f4
...
- (id)logIdentifier;	// IMP=0x0000000000b2812f
- (id)stateAsString;	// IMP=0x0000000000b28073
- (_Bool)containsState:(long long)arg1;	// IMP=0x0000000000b28050
- (void)updateState:(long long)arg1;	// IMP=0x0000000000b27ef5
- (void)dealloc;	// IMP=0x0000000000b27e10
- (id)initWithSessionID:(id)arg1 reachabilityPath:(unsigned long long)arg2 streamSender:(id)arg3 remoteCapabilities:(id)arg4 localNetworkConfig:(id)arg5 streamPreference:(id)arg6;	// IMP=0x0000000000b27cac
