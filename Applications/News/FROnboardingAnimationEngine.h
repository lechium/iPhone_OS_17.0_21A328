...
- (void).cxx_destruct;	// IMP=0x00200000000c0ab9
...
- (id)_animatorsRegisteredForItem:(id)arg1;	// IMP=0x00100000000c090b
- (void)_registerAnimator:(id)arg1 forItem:(id)arg2;	// IMP=0x00100000000c0893
- (void)tick:(id)arg1;	// IMP=0x00100000000c05fa
- (void)_stopSessionIfNoMoreAnimators;	// IMP=0x00100000000c04ba
- (void)_startSessionIfNotAlreadyRunning;	// IMP=0x00100000000c030b
- (void)_removeAnimator:(id)arg1;	// IMP=0x00100000000c01c9
- (id)animatorsTrackingItem:(id)arg1;	// IMP=0x00100000000c0181
- (void)cancelAllAnimations;	// IMP=0x00100000000c00f3
- (void)cancelAnimator:(id)arg1;	// IMP=0x00100000000bffb1
- (void)addAnimator:(id)arg1;	// IMP=0x00100000000bfe86
...
- (id)init;	// IMP=0x00100000000bfd23
- (void)dealloc;	// IMP=0x00100000000bfcb8
