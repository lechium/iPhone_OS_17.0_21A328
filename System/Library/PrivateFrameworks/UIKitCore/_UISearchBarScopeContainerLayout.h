...
- (void).cxx_destruct;	// IMP=0x00000000002ab65b
...
- (id)description;	// IMP=0x00000000002ab31e
- (void)applyLayout;	// IMP=0x00000000002ab26c
- (void)updateLayout;	// IMP=0x00000000002aaec8
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000002aae28
- (double)scopeControlHeight;	// IMP=0x00000000002aadc3
