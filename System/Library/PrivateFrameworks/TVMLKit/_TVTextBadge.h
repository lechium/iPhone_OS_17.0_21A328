...
+ (id)textBadgeViewWithElement:(id)arg1 existingView:(id)arg2;	// IMP=0x0060000000089d8d
- (void).cxx_destruct;	// IMP=0x000000000008a51d
...
- (void)drawRect:(struct CGRect)arg1;	// IMP=0x000000000008a251
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x000000000008a132
