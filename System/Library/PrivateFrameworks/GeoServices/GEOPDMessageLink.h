...
+ (id)messageLinkForPlaceData:(id)arg1;	// IMP=0x0010000000a9d068
- (void).cxx_destruct;	// IMP=0x0000000000ce81c7
- (unsigned long long)hash;	// IMP=0x0000000000ce809c
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000ce7ead
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000ce7ab4
- (void)writeTo:(id)arg1;	// IMP=0x0000000000ce773b
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000ce772c
- (id)jsonRepresentation;	// IMP=0x0000000000ce7554
- (id)dictionaryRepresentation;	// IMP=0x0000000000ce6f00
- (id)description;	// IMP=0x0000000000ce6e51
- (id)initWithData:(id)arg1;	// IMP=0x0000000000ce59f3
- (id)init;	// IMP=0x0000000000ce5997
