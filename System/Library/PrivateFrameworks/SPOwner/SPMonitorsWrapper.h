...
- (void).cxx_destruct;	// IMP=0x0000000000014111
...
- (void)resume;	// IMP=0x0000000000013fef
- (void)pause;	// IMP=0x0000000000013f77
- (void)stop;	// IMP=0x0000000000013f10
- (void)start;	// IMP=0x0000000000013d92
- (unsigned long long)powerState;	// IMP=0x0000000000013d8a
- (_Bool)isNetworkUp;	// IMP=0x0000000000013d46
- (id)initWithBeaconManager:(id)arg1 delegateQueue:(id)arg2;	// IMP=0x0000000000013c6b
