...
- (void).cxx_destruct;	// IMP=0x000000000010d7c9
...
- (id)_systemController;	// IMP=0x000000000010d72c
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000010d413
- (id)initWithSceneIdentifier:(id)arg1 clientIdentifier:(id)arg2;	// IMP=0x000000000010d375
