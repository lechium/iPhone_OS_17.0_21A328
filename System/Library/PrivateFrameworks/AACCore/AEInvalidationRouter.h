...
- (void).cxx_destruct;	// IMP=0x00000000000093f5
@property(readonly, nonatomic) CDUnknownBlockType invalidationHandler;
- (void)fetchCapturedErrorWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00000000000090c9
- (void)setRouterDelegate:(id)arg1;	// IMP=0x0000000000008f5c
- (void)setRouterMode:(long long)arg1;	// IMP=0x0000000000008dc9
- (id)initWithQueue:(id)arg1;	// IMP=0x0000000000008d56
