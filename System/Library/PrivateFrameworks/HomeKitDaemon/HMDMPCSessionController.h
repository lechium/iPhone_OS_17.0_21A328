...
- (void).cxx_destruct;	// IMP=0x0000000000d292fc
...
- (void)executeSessionWithSessionData:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000000d28253
- (id)initWithLogEventSubmitter:(id)arg1;	// IMP=0x0000000000d2815b
