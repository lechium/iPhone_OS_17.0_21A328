...
- (void).cxx_destruct;	// IMP=0x00200000000f6466
- (long long)readBytes:(char *)arg1 length:(unsigned long long)arg2 error:(id *)arg3;	// IMP=0x00100000000f60a1
- (void)stream:(id)arg1 handleEvent:(unsigned long long)arg2;	// IMP=0x00100000000f5dc3
- (void)open;	// IMP=0x00100000000f5d77
- (void)close;	// IMP=0x00100000000f5d15
@property(readonly) _Bool hasBytesAvailable;
- (void)dealloc;	// IMP=0x00100000000f5a5e
