...
- (void).cxx_destruct;	// IMP=0x000000000001417f
...
- (void)_applicationDidBecomeActive:(id)arg1;	// IMP=0x0000000000014043
- (void)_applicationWillEnterForeground:(id)arg1;	// IMP=0x000000000001402d
- (void)_applicationDidEnterBackground:(id)arg1;	// IMP=0x0000000000013f6c
- (void)_didDraw;	// IMP=0x0000000000013d90
- (void)_willDraw;	// IMP=0x0000000000013d8a
- (_Bool)_isForcingPause;	// IMP=0x0000000000013d82
- (void)_didInvalidate;	// IMP=0x0000000000013d7c
- (void)invalidate;	// IMP=0x0000000000013d13
- (_Bool)attachToScreen:(id)arg1;	// IMP=0x000000000001398b
- (void)dealloc;	// IMP=0x00000000000138b7
