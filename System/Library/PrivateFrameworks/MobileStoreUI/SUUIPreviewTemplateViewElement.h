...
- (void).cxx_destruct;	// IMP=0x000000000004ca4a
...
- (id)applyUpdatesWithElement:(id)arg1;	// IMP=0x000000000004c947
- (id)initWithDOMElement:(id)arg1 parent:(id)arg2 elementFactory:(id)arg3;	// IMP=0x000000000004c840
