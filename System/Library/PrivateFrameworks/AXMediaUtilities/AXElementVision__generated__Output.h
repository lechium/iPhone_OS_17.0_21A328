...
- (void).cxx_destruct;	// IMP=0x0000000000027ba2
...
- (id)featureValueForName:(id)arg1;	// IMP=0x0000000000027ad1
@property(readonly, nonatomic) NSSet *featureNames;
- (id)initWithConfidence:(id)arg1 coordinates:(id)arg2;	// IMP=0x0000000000027a3f
