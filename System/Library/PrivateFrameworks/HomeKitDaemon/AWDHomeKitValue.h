...
- (void).cxx_destruct;	// IMP=0x0000000000788a67
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000007888f9
- (unsigned long long)hash;	// IMP=0x0000000000788680
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000078851f
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000007883fb
- (void)copyTo:(id)arg1;	// IMP=0x000000000078831c
- (void)writeTo:(id)arg1;	// IMP=0x000000000078822a
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000078821d
- (id)dictionaryRepresentation;	// IMP=0x0000000000788025
- (id)description;	// IMP=0x0000000000787f76
