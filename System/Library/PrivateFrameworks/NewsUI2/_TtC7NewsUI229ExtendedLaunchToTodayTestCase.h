...
@interface _TtC7NewsUI229ExtendedLaunchToTodayTestCase : NSObject
{
    ...
    MISSING_TYPE *todayBlueprintPrewarmState;	// 40 = 0x28
}

- (void).cxx_destruct;	// IMP=0x0000000000a6b950
- (id)init;	// IMP=0x0000000000a6b8f0
- (void)runTestWithContext:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000000a6b860
