...
- (void).cxx_destruct;	// IMP=0x0000000000277bb8
...
- (void)cancel;	// IMP=0x0000000000277413
- (id)initWithPropertyItems:(id)arg1 service:(id)arg2 idsAvailabilityProvider:(id)arg3 schedulerProvider:(id)arg4;	// IMP=0x0000000000277099
- (id)initWithPropertyItems:(id)arg1 service:(id)arg2;	// IMP=0x0000000000276fa9
