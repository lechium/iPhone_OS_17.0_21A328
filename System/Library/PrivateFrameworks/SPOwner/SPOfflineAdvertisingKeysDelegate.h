...
- (void).cxx_destruct;	// IMP=0x0000000000035f82
...
- (void)peripheralManager:(id)arg1 offlineAdvPayloadRequestedWithReason:(long long)arg2;	// IMP=0x0000000000035d56
- (void)processKeyResponse:(id)arg1;	// IMP=0x000000000003588a
- (long long)transformReason:(long long)arg1;	// IMP=0x0000000000035839
- (void)enterLowPowerMode;	// IMP=0x0000000000035730
- (void)peripheralManagerDidUpdateState:(id)arg1;	// IMP=0x0000000000035544
- (id)userAgentSyncProxy;	// IMP=0x0000000000035532
- (id)syncProxy;	// IMP=0x00000000000352cf
- (id)userAgentProxy;	// IMP=0x00000000000352bd
- (id)proxy;	// IMP=0x00000000000350c3
- (id)remoteInterface;	// IMP=0x0000000000034fa7
- (id)initWithBeaconManager:(id)arg1;	// IMP=0x0000000000034d8a
