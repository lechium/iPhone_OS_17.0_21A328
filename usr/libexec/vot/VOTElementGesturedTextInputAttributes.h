...
- (void).cxx_destruct;	// IMP=0x0020000000066bc5
...
- (id)description;	// IMP=0x0010000000066906
- (id)_descriptionForBool:(_Bool)arg1;	// IMP=0x00100000000668e8
- (id)_descriptionForCharacterSets:(unsigned long long)arg1;	// IMP=0x0010000000066826
- (id)initWithAttributes:(id)arg1;	// IMP=0x00100000000664e5
