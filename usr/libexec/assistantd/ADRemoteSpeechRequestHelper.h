...
- (void).cxx_destruct;	// IMP=0x00200000001365c3
...
- (void)reset;	// IMP=0x0010000000136561
- (id)setSpeechRequestOptions:(id)arg1 withCompletion:(CDUnknownBlockType)arg2;	// IMP=0x00100000001364a4
