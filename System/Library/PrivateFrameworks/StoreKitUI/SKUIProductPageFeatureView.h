...
- (void).cxx_destruct;	// IMP=0x00000000001c9a90
@property(retain, nonatomic) SKUIColorScheme *colorScheme; // @synthesize colorScheme=_colorScheme;
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000001c997e
- (void)setBackgroundColor:(id)arg1;	// IMP=0x00000000001c98dc
- (void)layoutSubviews;	// IMP=0x00000000001c96af
