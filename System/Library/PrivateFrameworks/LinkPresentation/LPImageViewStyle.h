...
- (void).cxx_destruct;	// IMP=0x000000000008ac9d
...
- (id)emailCompatibleMargin;	// IMP=0x000000000008a9e5
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000008a7e6
- (id)init;	// IMP=0x000000000008a68f
