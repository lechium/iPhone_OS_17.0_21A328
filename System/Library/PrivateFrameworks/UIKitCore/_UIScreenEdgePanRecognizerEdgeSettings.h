...
+ (id)settingsControllerModule;	// IMP=0x00600000009889ab
+ (id)keyPathsForValuesAffectingEdgeAngleWindowDegreees;	// IMP=0x006000000098898b
...
- (void)setDefaultValues;	// IMP=0x00000000009887d6
