...
+ (Class)presenceEventsType;	// IMP=0x00100000008de19c
- (void).cxx_destruct;	// IMP=0x00000000008ddd79
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000008ddb30
- (unsigned long long)hash;	// IMP=0x00000000008dda8a
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000008dd935
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000008dd6e4
- (void)copyTo:(id)arg1;	// IMP=0x00000000008dd5b0
- (void)writeTo:(id)arg1;	// IMP=0x00000000008dd3e2
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000008dd3d5
- (id)dictionaryRepresentation;	// IMP=0x00000000008dd02b
- (id)description;	// IMP=0x00000000008dcf7c
...
- (id)presenceEventsAtIndex:(unsigned long long)arg1;	// IMP=0x00000000008dce3b
- (unsigned long long)presenceEventsCount;	// IMP=0x00000000008dce1e
- (void)addPresenceEvents:(id)arg1;	// IMP=0x00000000008dcdb4
- (void)clearPresenceEvents;	// IMP=0x00000000008dcd97
