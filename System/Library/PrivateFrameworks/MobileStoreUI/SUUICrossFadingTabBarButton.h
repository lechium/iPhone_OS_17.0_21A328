...
- (void)_positionBadge;	// IMP=0x000000000008842b
- (void)_setBadgeValue:(id)arg1;	// IMP=0x000000000008826e
- (void)tintColorDidChange;	// IMP=0x0000000000087e7e
- (void)layoutSubviews;	// IMP=0x0000000000087ad6
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000000877a7
