...
- (id).cxx_construct;	// IMP=0x0000000000372837
- (void).cxx_destruct;	// IMP=0x0000000000372811
...
- (id)findAccessPoints:(CDUnknownBlockType)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000000003727d2
- (double)distanceInMetersFrom:(CDStruct_c3b9c2ee)arg1;	// IMP=0x0000000000372797
- (id)findGeometryWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000000003724e1
@property(readonly, copy) NSString *description;
@property(readonly, nonatomic) NSString *internalName;
@property(readonly, nonatomic) unsigned long long transitID;
@property(readonly, nonatomic) CDStruct_c3b9c2ee coordinate;
- (void)dealloc;	// IMP=0x00000000003723b7
- (id)initWithMap:(id)arg1 node:(shared_ptr_52e51bdf)arg2;	// IMP=0x00000000003722c6
