...
+ (id)routePlanningTimingPickerConfiguration;	// IMP=0x0040000000a43510
+ (id)leadingInsetConfiguration;	// IMP=0x0010000000a434e8
+ (id)popoverCardHeaderConfiguration;	// IMP=0x0010000000a43203
+ (id)leadingNavigationModalCardHeaderCompactConfiguration;	// IMP=0x0010000000a430ff
+ (id)navigationModalCardHeaderCompactConfiguration;	// IMP=0x0010000000a42fc1
+ (id)navigationModalCardHeaderConfiguration;	// IMP=0x0010000000a42e83
+ (id)leadingAlignedTitleModalCardHeaderConfiguration;	// IMP=0x0010000000a42e65
+ (id)defaultModalCardHeaderConfiguration;	// IMP=0x0010000000a42b84
- (void).cxx_destruct;	// IMP=0x0020000000a435ff
