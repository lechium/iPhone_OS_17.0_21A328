...
- (id)ciImage;	// IMP=0x0000000000094173
- (id)textureForSliceIndex:(unsigned long long)arg1;	// IMP=0x0000000000093ff5
- (_Bool)matchesDescription:(CDStruct_ace98575 *)arg1 size:(unsigned long long)arg2 arrayLength: /* Error: Ran out of types for this method. */;	// IMP=0x0000000000093ef9
@property(readonly, nonatomic) unsigned char renderBufferFormat;
@property(readonly, nonatomic) _Bool viewportDependant;
- (id)description;	// IMP=0x0000000000093e46
- (void)dealloc;	// IMP=0x0000000000093dee
- (id)initWithDescription:(CDStruct_ace98575 *)arg1 size:(unsigned long long)arg2 arrayLength: /* Error: Ran out of types for this method. */;	// IMP=0x0000000000093d94
