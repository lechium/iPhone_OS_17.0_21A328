...
@class MISSING_TYPE, MRAVRoutingDiscoverySessionConfiguration, MRRequestDetails, NSArray, NSData, NSDictionary, NSError, NSString;
...
- (MISSING_TYPE *)setRegisteredCallbacks: /* Error: Ran out of types for this method. */;
@end
