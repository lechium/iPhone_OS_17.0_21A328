...
+ (id)sortDateComponentsOfDateComponents:(id)arg1 withDayOffset:(long long)arg2;	// IMP=0x006000000004a3ae
+ (id)sortDateComponentsOfDate:(id)arg1;	// IMP=0x006000000004a32b
- (void).cxx_destruct;	// IMP=0x000000000004a545
...
- (void)resetPagingContext;	// IMP=0x000000000004a2b1
- (_Bool)shouldQueryForNextBatch;	// IMP=0x000000000004a264
- (id)init;	// IMP=0x000000000004a218
