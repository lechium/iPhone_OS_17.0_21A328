...
- (void)cancelGestureDidChange:(id)arg1;	// IMP=0x000000000003f13b
- (void)invalidate;	// IMP=0x000000000003ee9a
- (void)installWithCancelBlock:(CDUnknownBlockType)arg1;	// IMP=0x000000000003e9b7
- (void)dealloc;	// IMP=0x000000000003e979
- (id)initWithView:(id)arg1;	// IMP=0x000000000003e8fb
