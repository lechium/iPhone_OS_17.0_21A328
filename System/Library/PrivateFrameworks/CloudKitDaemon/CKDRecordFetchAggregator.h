...
- (void).cxx_destruct;	// IMP=0x00000000002397af
...
- (_Bool)supportsClearAssetEncryption;	// IMP=0x0000000000239552
- (void)_finishOnCallbackQueueWithError:(id)arg1;	// IMP=0x0000000000239495
- (void)_finishRecordFetchAggregator;	// IMP=0x000000000023908d
- (void)finishIfAppropriate;	// IMP=0x0000000000238f4f
- (void)fetchRecords:(id)arg1 withPerRecordCompletion:(CDUnknownBlockType)arg2;	// IMP=0x0000000000238c31
- (id)_fetchRecord:(id)arg1 recordReadyHandle:(_Bool *)arg2 withRecordCompletion:(CDUnknownBlockType)arg3;	// IMP=0x000000000023806f
- (void)main;	// IMP=0x0000000000237dc8
- (void)_addRecordFetchInfos:(id)arg1;	// IMP=0x0000000000237973
- (void)_recordFetchesAvailable;	// IMP=0x00000000002378a9
- (void)_lockedSendFetchRequest;	// IMP=0x0000000000235c9a
- (void)_flushFetchedRecordsToConsumerLocked;	// IMP=0x0000000000235c2a
- (void)_flushFetchedRecordsToConsumerNoOrderingLocked;	// IMP=0x0000000000235a68
- (void)_flushFetchedRecordsToConsumerOrderedLocked;	// IMP=0x00000000002357f8
- (void)_performCallbackForFetchInfoLocked:(id)arg1;	// IMP=0x0000000000235587
- (int)operationType;	// IMP=0x000000000023557f
- (id)description;	// IMP=0x000000000023556d
- (id)CKPropertiesDescription;	// IMP=0x000000000023500a
- (void)dealloc;	// IMP=0x0000000000234faf
- (id)activityCreate;	// IMP=0x0000000000234f86
- (id)initWithOperationInfo:(id)arg1 container:(id)arg2;	// IMP=0x00000000002349a7
