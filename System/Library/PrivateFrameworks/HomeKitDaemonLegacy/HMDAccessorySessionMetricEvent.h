...
- (void).cxx_destruct;	// IMP=0x000000000049d54c
...
- (id)initWithAccessory:(id)arg1 expectedTransport:(id)arg2 homeUUID:(id)arg3 topErrorDomain:(id)arg4 topErrorCode:(long long)arg5 sessionFailureCount:(unsigned long long)arg6;	// IMP=0x000000000049ca0c
- (id)initWithAccessory:(id)arg1 sessionMetric:(id)arg2;	// IMP=0x000000000049c51f
