...
@interface _TtC7NewsUI226MagazineFeedScrollTestCase : NSObject
{
...
- (void).cxx_destruct;	// IMP=0x00000000002a2f20
- (id)init;	// IMP=0x00000000002a2ed0
- (id)scrollViewWithContext:(id)arg1;	// IMP=0x00000000002a2d70
