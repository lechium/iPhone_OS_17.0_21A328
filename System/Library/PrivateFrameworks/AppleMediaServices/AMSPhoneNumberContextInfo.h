...
- (void).cxx_destruct;	// IMP=0x000000000035a7ed
...
- (id)description;	// IMP=0x000000000035a640
- (id)initWithPhoneNumber:(id)arg1 simLabel:(id)arg2 uuid:(id)arg3 isVoicePreferred:(_Bool)arg4;	// IMP=0x000000000035a57d
