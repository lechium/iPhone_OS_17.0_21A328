...
@class NSError, NSString, PKAccountServicePaymentMethod, PKApplePayTrustSignature, PKAuthorizedPeerPaymentQuote, PKPaymentAuthorizationController, PKServiceProviderPurchase;
...
- (void)paymentAuthorizationController:(PKPaymentAuthorizationController *)arg1 didAuthorizeApplePayTrustSignature:(PKApplePayTrustSignature *)arg2 handler:(void (^)(PKPaymentAuthorizationResult *))arg3;
- (void)paymentAuthorizationController:(PKPaymentAuthorizationController *)arg1 didUpdateAccountServicePaymentMethod:(PKAccountServicePaymentMethod *)arg2 handler:(void (^)(PKPaymentRequestPaymentMethodUpdate *, PKApplePayTrustSignatureRequest *))arg3;
