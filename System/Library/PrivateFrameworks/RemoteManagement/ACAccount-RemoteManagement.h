...
+ (id)rm_createMAIDAccountWithStore:(id)arg1 username:(id)arg2 description:(id)arg3 dsid:(id)arg4 altDSID:(id)arg5 personaIdentifier:(id)arg6 enrollmentURL:(id)arg7;	// IMP=0x0020000000001bbf
+ (id)rm_createBearerAccountWithStore:(id)arg1 username:(id)arg2 description:(id)arg3 enrollmentURL:(id)arg4 authToken:(id)arg5;	// IMP=0x0020000000001a69
+ (id)rm_createTestAccountWithStore:(id)arg1 username:(id)arg2 description:(id)arg3 enrollmentURL:(id)arg4;	// IMP=0x0020000000001940
- (_Bool)rm_isAccountSchemeMAID;	// IMP=0x0010000000002044
- (_Bool)rm_isAccountSchemeBearer;	// IMP=0x0010000000001ff9
- (_Bool)rm_isAccountSchemeTest;	// IMP=0x0010000000001fae
