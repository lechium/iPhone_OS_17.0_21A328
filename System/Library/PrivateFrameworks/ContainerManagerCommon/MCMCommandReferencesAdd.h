...
+ (Class)incomingMessageClass;	// IMP=0x001000000000ca12
+ (unsigned long long)command;	// IMP=0x001000000000c9dc
- (void).cxx_destruct;	// IMP=0x000000000000c794
...
- (id)_resolveUserIdentity;	// IMP=0x000000000000c422
- (void)execute;	// IMP=0x000000000000b925
- (_Bool)preflightClientAllowed;	// IMP=0x000000000000b891
- (id)initWithMessage:(id)arg1 context:(id)arg2 reply:(id)arg3;	// IMP=0x000000000000b74b
