...
@class GEOApplicationAuditToken, GEOMapServiceTraits, NSData, NSDictionary, NSString, NSURL;
...
- (void)performServiceRequest:(NSData *)arg1 requestType:(long long)arg2 traits:(GEOMapServiceTraits *)arg3 auditToken:(GEOApplicationAuditToken *)arg4 withCallback:(void (^)(NSData *, NSError *))arg5;
...
- (void)sendEnqueuedTileFetchesForRequestIdentifier:(NSString *)arg1 auditToken:(GEOApplicationAuditToken *)arg2;
