...
@class ECAngleBracketIDHash, ECMessageFlags, ECSubject, NSArray, NSData, NSDate, NSDictionary, NSSet, NSString, NSUUID;
...
- (NSData *)bestAlternativePartAsData:(_Bool *)arg1 usingEncoding:(unsigned long long)arg2;
