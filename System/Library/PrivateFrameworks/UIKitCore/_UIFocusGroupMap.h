...
- (void).cxx_destruct;	// IMP=0x000000000144cf7b
@property(readonly, nonatomic) id <UICoordinateSpace> coordinateSpace; // @synthesize coordinateSpace=_coordinateSpace;
- (id)visualDescription;	// IMP=0x000000000144cd1b
- (id)description;	// IMP=0x000000000144cc79
- (id)focusGroupForItem:(id)arg1;	// IMP=0x000000000144cbad
...
- (id)_indexEnvironment:(id)arg1;	// IMP=0x000000000144c33d
- (void)_indexItems:(id)arg1;	// IMP=0x000000000144bfce
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000144bcd0
- (id)initWithItems:(id)arg1 standInItemsMap:(id)arg2 coordinateSpace:(id)arg3;	// IMP=0x000000000144ba73
- (id)initWithItems:(id)arg1 coordinateSpace:(id)arg2;	// IMP=0x000000000144ba5c
