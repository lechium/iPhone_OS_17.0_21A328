...
+ (id)fromProto:(id)arg1;	// IMP=0x00400000000035f6
+ (id)toProto:(id)arg1;	// IMP=0x00100000000033e2
- (void).cxx_destruct;	// IMP=0x00200000000038b1
...
- (id)initWithDictionary:(id)arg1;	// IMP=0x00100000000030da
- (id)init;	// IMP=0x00100000000030ab
