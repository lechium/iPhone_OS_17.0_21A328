...
- (void).cxx_destruct;	// IMP=0x00000000004edefe
...
- (double)_maximumDepthLevelInChain;	// IMP=0x00000000004ed9e0
...
- (id)_descendantDescription;	// IMP=0x00000000004ed706
@property(readonly, copy) NSString *description;
- (void)_layout;	// IMP=0x00000000004ec0e3
...
- (void)_invalidateCurrentOffset;	// IMP=0x00000000004e548e
- (void)_invalidateDetents;	// IMP=0x00000000004e4af7
- (void)_boundingPathMayHaveChangedForView:(id)arg1 relativeToBoundsOriginOnly:(_Bool)arg2;	// IMP=0x00000000004e411f
- (void)_invalidatePreferredSize;	// IMP=0x00000000004e40cc
- (id)initWithMetrics:(id)arg1;	// IMP=0x00000000004e3dbe
