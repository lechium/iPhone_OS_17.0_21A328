...
@interface _TtC7NewsUI222OpenWebArticleTestCase : NSObject
{
...
- (id)init;	// IMP=0x0000000000241c40
- (void)runTestWithContext:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000000241b00
