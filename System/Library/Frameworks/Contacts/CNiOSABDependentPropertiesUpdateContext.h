...
+ (_Bool)shouldSetWatchChanges;	// IMP=0x00600000000e5ba3
+ (id)os_log;	// IMP=0x00600000000e4c3e
- (void).cxx_destruct;	// IMP=0x00000000000e5db2
...
- (_Bool)setWatchChangesforThumbnailImageDataToPerson:(void *)arg1 error:(id *)arg2;	// IMP=0x00000000000e5bab
- (_Bool)flushPendingImageChangesToPerson:(void *)arg1 logger:(id)arg2 error:(id *)arg3;	// IMP=0x00000000000e4f05
- (_Bool)logIfConditionFailed:(_Bool)arg1 message:(id)arg2 error:(struct __CFError **)arg3;	// IMP=0x00000000000e4e7f
- (void)resetAllData;	// IMP=0x00000000000e4dd7
