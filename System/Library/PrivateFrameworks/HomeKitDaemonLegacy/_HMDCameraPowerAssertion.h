...
- (void).cxx_destruct;	// IMP=0x00000000007b85a4
...
- (void)dealloc;	// IMP=0x00000000007b84e6
- (id)initWithPowerAssertionHandler:(id)arg1 remoteRequestHandlerSessionID:(id)arg2;	// IMP=0x00000000007b844b
