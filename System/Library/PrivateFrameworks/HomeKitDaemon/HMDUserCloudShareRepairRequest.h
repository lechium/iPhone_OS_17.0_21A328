...
- (void).cxx_destruct;	// IMP=0x00000000006df746
@property(readonly) HMUserCloudShareRepairInfo *repairInfo; // @synthesize repairInfo=_repairInfo;
- (id)description;	// IMP=0x00000000006df673
- (id)initWithStartDate:(id)arg1 containerID:(id)arg2 home:(id)arg3 repairInfo:(id)arg4;	// IMP=0x00000000006df5e9
