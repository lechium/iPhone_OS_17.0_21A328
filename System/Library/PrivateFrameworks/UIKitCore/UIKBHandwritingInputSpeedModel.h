...
- (void).cxx_destruct;	// IMP=0x0000000000b61fa5
...
- (void)updatePreferences;	// IMP=0x0000000000b61d72
- (double)timeoutForNextPage;	// IMP=0x0000000000b61bb4
- (double)smoothValueFromArray:(id)arg1;	// IMP=0x0000000000b61a6a
- (double)speedForCurrentStroke;	// IMP=0x0000000000b6173a
- (void)endCharacter;	// IMP=0x0000000000b61620
- (void)endStroke;	// IMP=0x0000000000b615f7
- (void)addPoint:(struct CGPoint)arg1 timestamp:(double)arg2;	// IMP=0x0000000000b61563
- (void)beginStroke;	// IMP=0x0000000000b61461
- (id)init;	// IMP=0x0000000000b6139a
