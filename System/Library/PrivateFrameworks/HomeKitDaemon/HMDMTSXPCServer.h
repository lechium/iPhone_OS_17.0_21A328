...
- (void).cxx_destruct;	// IMP=0x0000000000099429
...
- (void)start;	// IMP=0x000000000009923b
- (id)initWithPairingServer:(id)arg1 deviceSetupServer:(id)arg2 authorizationServer:(id)arg3 xpcServer:(id)arg4;	// IMP=0x00000000000990e6
- (id)initWithPairingServer:(id)arg1 deviceSetupServer:(id)arg2 authorizationServer:(id)arg3;	// IMP=0x0000000000099019
