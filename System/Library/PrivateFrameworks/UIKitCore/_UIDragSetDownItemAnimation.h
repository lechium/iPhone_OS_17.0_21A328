...
@interface _UIDragSetDownItemAnimation : NSObject
{
    ...
    struct CAPoint3D _center;	// 216 = 0xd8
    struct CGRect _targetFrame;	// 240 = 0xf0
    CDUnion_b2735e62 _initialVelocity;	// 272 = 0x110
    CDUnion_b2735e62 _initialTargetVelocity;	// 304 = 0x130
}

- (void).cxx_destruct;	// IMP=0x00000000016d5464
...
- (void)_setCenterAndVelocityFromDroppedItem:(id)arg1;	// IMP=0x00000000016d4f36
- (void)updateDroppedItem:(id)arg1;	// IMP=0x00000000016d4d8e
- (void)updateTargetedDropPreview:(id)arg1;	// IMP=0x00000000016d4713
- (void)updateAnimationTargeting;	// IMP=0x00000000016d3ff3
@property(readonly, nonatomic) long long previewMode;
- (_Bool)needsReparenting;	// IMP=0x00000000016d3f58
- (CDUnknownBlockType)animationCompletionHandler;	// IMP=0x00000000016d3dd6
- (void)performSpringAnimations:(CDUnknownBlockType)arg1;	// IMP=0x00000000016d3bb2
- (void)previewContainerAnimationDidComplete;	// IMP=0x00000000016d3b78
- (void)performTrackingAnimations:(CDUnknownBlockType)arg1;	// IMP=0x00000000016d395c
- (double)estimatedFractionCompleteOfAnimation;	// IMP=0x00000000016d3866
- (void)updateCurrentTargetFrame;	// IMP=0x00000000016d36a3
- (void)reparentRetargetingContainerViewInTargetContainer;	// IMP=0x00000000016d2da7
- (void)configureCrossfadingAnimationToTargetedPreview;	// IMP=0x00000000016d13f3
- (void)configureSystemDefaultAnimation;	// IMP=0x00000000016d0ef7
- (void)configureAnimation;	// IMP=0x00000000016d0e9f
@property(readonly, nonatomic) UIWindow *targetContainerWindow;
- (void)animationCompleted;	// IMP=0x00000000016d0d7c
- (void)animationReachedTarget;	// IMP=0x00000000016d0d2c
- (void)beginAnimation;	// IMP=0x00000000016d0ce3
- (void)prepareToBeginAnimation;	// IMP=0x00000000016d0b93
- (void)prepareAnimationInWindow;	// IMP=0x00000000016d0850
- (id)initWithDragItem:(id)arg1 droppedItem:(id)arg2 window:(id)arg3 defaultAnimation:(_Bool)arg4 sourceAnimation:(_Bool)arg5 delegate:(id)arg6;	// IMP=0x00000000016d070c
