...
- (void)_fetchDemographicInformation;	// IMP=0x0000000000016dd7
- (id)initWithSample:(id)arg1 healthStore:(id)arg2 activeAlgorithmVersion:(long long)arg3;	// IMP=0x0000000000016d03
