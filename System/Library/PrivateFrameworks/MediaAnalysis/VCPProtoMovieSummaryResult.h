...
+ (id)resultFromLegacyDictionary:(id)arg1;	// IMP=0x00100000000e2e5d
- (void).cxx_destruct;	// IMP=0x00000000002de78b
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000002de5f3
- (unsigned long long)hash;	// IMP=0x00000000002de493
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000002de37d
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000002de297
- (void)copyTo:(id)arg1;	// IMP=0x00000000002de1f9
- (void)writeTo:(id)arg1;	// IMP=0x00000000002de151
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000002de144
- (id)dictionaryRepresentation;	// IMP=0x00000000002ddc55
- (id)description;	// IMP=0x00000000002ddba6
@property(readonly, nonatomic) _Bool hasPlaybackCrop;
@property(readonly, nonatomic) _Bool hasKeyFrame;
- (id)exportToLegacyDictionary;	// IMP=0x00000000000e32de
