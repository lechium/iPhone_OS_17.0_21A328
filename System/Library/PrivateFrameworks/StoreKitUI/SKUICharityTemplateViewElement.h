...
- (void).cxx_destruct;	// IMP=0x0000000000381afd
...
- (id)applyUpdatesWithElement:(id)arg1;	// IMP=0x00000000003819fa
- (id)initWithDOMElement:(id)arg1 parent:(id)arg2 elementFactory:(id)arg3;	// IMP=0x00000000003818ab
