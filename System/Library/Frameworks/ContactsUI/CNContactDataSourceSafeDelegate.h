...
- (void).cxx_destruct;	// IMP=0x0000000000305e26
@property(nonatomic) __weak id <CNContactDataSourceDelegate> delegate; // @synthesize delegate=_delegate;
- (void)contactDataSourceDidChange:(id)arg1;	// IMP=0x0000000000305d58
- (id)initWithDelegate:(id)arg1;	// IMP=0x0000000000305cdd
