...
+ (id)defaultProperties;	// IMP=0x0020000000187074
+ (Class)databaseEntityClass;	// IMP=0x0010000000187063
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x002000000018709b
@property(copy, nonatomic) NSData *policyData;
@property(readonly, nonatomic) SSDownloadPolicy *downloadPolicy;
- (void)dealloc;	// IMP=0x0010000000186dc8
