...
- (void).cxx_destruct;	// IMP=0x001000000007d067
...
- (id)initWithStatusKeyPaths:(id)arg1 statusByKeyPath:(id)arg2 errorByKeyPath:(id)arg3;	// IMP=0x001000000007c375
- (id)init;	// IMP=0x001000000007c311
- (id)protocolStatusReportWithFullReport:(_Bool)arg1;	// IMP=0x001000000007d43f
