...
- (void).cxx_destruct;	// IMP=0x0000000000021d11
...
- (void)updatePreferredContentSizeForCardWidth:(double)arg1;	// IMP=0x0000000000021c58
- (_Bool)_canShowWhileLocked;	// IMP=0x0000000000021c50
@property(nonatomic) _Bool locationConfirmationPermissionEnabled;
@property(nonatomic) _Bool notificationPermissionEnabled;
- (void)doneTapped;	// IMP=0x0000000000021b3f
- (void)viewDidLayoutSubviews;	// IMP=0x0000000000021874
- (void)setUpOptionsContainer;	// IMP=0x0000000000021384
- (void)viewDidLoad;	// IMP=0x000000000001fcb7
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x000000000001fb24
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000001fad7
- (id)initWithNibName:(id)arg1 bundle:(id)arg2;	// IMP=0x000000000001fa7a
- (id)init;	// IMP=0x000000000001fa36
- (id)initWithAppName:(id)arg1 backgroundImage:(id)arg2;	// IMP=0x000000000001f773
- (void)loadView;	// IMP=0x000000000001f73a
