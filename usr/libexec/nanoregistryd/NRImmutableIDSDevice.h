...
@interface NRImmutableIDSDevice : NSObject
{
    ...
    MISSING_TYPE *_mutableIDSDevice;	// 120 = 0x78
...
- (void).cxx_destruct;	// IMP=0x0020000000004cee
...
- (id)description;	// IMP=0x0010000000004a7a
- (id)initWithIDSDevice:(id)arg1;	// IMP=0x0010000000004696
