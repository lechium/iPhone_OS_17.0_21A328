...
+ (id)sharedController;	// IMP=0x00200000000013c0
- (void).cxx_destruct;	// IMP=0x00200000000017e5
@property(retain, nonatomic) NSXPCListener *listener; // @synthesize listener=_listener;
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x0010000000001692
- (void)start;	// IMP=0x0010000000001626
- (id)init;	// IMP=0x0010000000001415
