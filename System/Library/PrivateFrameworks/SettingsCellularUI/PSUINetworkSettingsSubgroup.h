...
- (void).cxx_destruct;	// IMP=0x0000000000053113
...
- (id)specifiers;	// IMP=0x0000000000052c3d
- (id)initWithListController:(id)arg1 groupSpecifier:(id)arg2;	// IMP=0x0000000000052be7
- (id)initWithListController:(id)arg1 groupSpecifier:(id)arg2 parentSpecifier:(id)arg3;	// IMP=0x0000000000052b55
