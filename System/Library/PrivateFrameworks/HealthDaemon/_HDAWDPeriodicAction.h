...
- (void).cxx_destruct;	// IMP=0x0000000000391b6d
- (void)performPeriodicActivity:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000000003918b4
- (void)periodicActivity:(id)arg1 configureXPCActivityCriteria:(id)arg2;	// IMP=0x0000000000391814
- (void)dealloc;	// IMP=0x0000000000390824
