...
- (void).cxx_destruct;	// IMP=0x0020000000a8552b
...
- (void)resignCurrent;	// IMP=0x0010000000a854bc
- (void)becomeCurrent;	// IMP=0x0010000000a8547f
...
- (void)setRouteIsNavigable:(_Bool)arg1;	// IMP=0x0010000000a851d1
- (void)viewDidLoad;	// IMP=0x0010000000a84d2c
- (id)init;	// IMP=0x0010000000a84ccf
