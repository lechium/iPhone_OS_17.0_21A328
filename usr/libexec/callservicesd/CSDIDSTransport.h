...
- (void).cxx_destruct;	// IMP=0x002000000021cb68
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000021c99c
- (unsigned long long)hash;	// IMP=0x001000000021c882
- (_Bool)isEqualToTransport:(id)arg1;	// IMP=0x001000000021c669
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000021c60c
- (id)description;	// IMP=0x001000000021c3da
- (id)initWithDestination:(id)arg1;	// IMP=0x001000000021c35f
- (id)initWithSocket:(int)arg1;	// IMP=0x001000000021c31d
