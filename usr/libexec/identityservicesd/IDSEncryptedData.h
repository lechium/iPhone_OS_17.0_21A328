...
- (void).cxx_destruct;	// IMP=0x00200000000e4bc8
...
- (id)description;	// IMP=0x00100000000e4b14
- (id)initWithData:(id)arg1 encryptionType:(long long)arg2 payloadMetadata:(id)arg3;	// IMP=0x00100000000e4a6f
