...
- (void).cxx_destruct;	// IMP=0x00000000001897ad
...
- (void)requestDidParseNodeFailure:(id)arg1;	// IMP=0x00000000001895a7
- (id)requestDidParseProtobufObject:(id)arg1;	// IMP=0x0000000000189462
- (id)generateRequestOperations;	// IMP=0x000000000018899f
- (id)requestOperationClasses;	// IMP=0x00000000001888b8
- (_Bool)requiresCKAnonymousUserIDs;	// IMP=0x00000000001888b0
- (void)fillOutRequestProperties:(id)arg1;	// IMP=0x000000000018862e
- (void)fillOutEquivalencyPropertiesBuilder:(id)arg1;	// IMP=0x00000000001884b6
- (id)initWithOperation:(id)arg1 subscriptionsToSave:(id)arg2 subscriptionIDsToDelete:(id)arg3;	// IMP=0x00000000001883ed
