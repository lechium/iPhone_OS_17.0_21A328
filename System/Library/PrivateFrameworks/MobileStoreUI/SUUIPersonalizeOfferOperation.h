...
- (void).cxx_destruct;	// IMP=0x000000000009b2f2
- (void)main;	// IMP=0x000000000009ad12
@property(copy) CDUnknownBlockType outputBlock;
- (id)initWithItemIdentifier:(long long)arg1 clientContext:(id)arg2;	// IMP=0x000000000009aa45
