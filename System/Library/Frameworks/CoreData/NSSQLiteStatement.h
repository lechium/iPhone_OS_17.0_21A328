...
- (id)bindIntarrays;	// IMP=0x0000000000211048
- (id)bindVariables;	// IMP=0x0000000000210f75
- (id)sqlString;	// IMP=0x0000000000210f31
- (id)entity;	// IMP=0x0000000000210f27
- (void)dealloc;	// IMP=0x0000000000210ea8
- (id)initWithEntity:(id)arg1;	// IMP=0x0000000000210e2c
- (id)description;	// IMP=0x0000000000210dba
- (id)initWithEntity:(id)arg1 sqlString:(id)arg2;	// IMP=0x0000000000210d58
