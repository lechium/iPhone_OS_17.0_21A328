...
- (void)printFlushAckToBasebandDump:(unsigned char)arg1 transactionID:(unsigned short)arg2 packetDropped:(unsigned short)arg3 sequenceNumberArray:(unsigned short *)arg4;	// IMP=0x00000000001c8c96
- (void)processBasebandAck:(CDStruct_b203c80d *)arg1;	// IMP=0x00000000001c8b4f
- (_Bool)isRadioAccessTechnologyOnCellular:(unsigned int)arg1;	// IMP=0x00000000001c8b40
- (void)enableBasebandLogDump:(void *)arg1;	// IMP=0x00000000001c8b26
- (_Bool)processBasebandNotification:(CDStruct_b203c80d *)arg1 arrivalTime:(double)arg2 error:(id *)arg3;	// IMP=0x00000000001c88f7
- (_Bool)processBasebandNotification:(id)arg1 metaData:(id)arg2 error:(id *)arg3;	// IMP=0x00000000001c8801
- (void)dealloc;	// IMP=0x00000000001c8665
- (id)init;	// IMP=0x00000000001c85f6
