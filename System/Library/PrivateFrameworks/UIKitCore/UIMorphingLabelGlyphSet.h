...
- (void).cxx_destruct;	// IMP=0x0000000000e9a81b
...
- (struct CGRect)boundingRectForGlyphsInRange:(struct _NSRange)arg1;	// IMP=0x0000000000e9a6fb
- (void)placeGlyphs;	// IMP=0x0000000000e9a52f
- (void)removeGlyphs;	// IMP=0x0000000000e9a3c5
- (void)buildGlyphViews;	// IMP=0x0000000000e9917c
- (void)dealloc;	// IMP=0x0000000000e99113
- (id)initWithLabel:(id)arg1 attributedString:(id)arg2;	// IMP=0x0000000000e98f13
