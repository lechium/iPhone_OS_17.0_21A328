...
- (void).cxx_destruct;	// IMP=0x0000000001274d7c
...
- (_Bool)deletePlaceholder;	// IMP=0x0000000001274be2
- (_Bool)commitInsertionWithDataSourceUpdates:(CDUnknownBlockType)arg1;	// IMP=0x0000000001274a80
- (void)addCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00000000012748cc
- (void)addAnimations:(CDUnknownBlockType)arg1;	// IMP=0x0000000001274718
- (id)initWithDelegate:(id)arg1 dragItem:(id)arg2 reuseIdentifier:(id)arg3 rowHeight:(double)arg4 cellUpdateHandler:(CDUnknownBlockType)arg5;	// IMP=0x0000000001274625
