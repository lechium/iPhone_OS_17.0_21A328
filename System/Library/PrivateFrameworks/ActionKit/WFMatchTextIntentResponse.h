...
+ (id)invalidRegularExpressionIntentResponseWithErrorDescription:(id)arg1;	// IMP=0x006000000033e543
@property(nonatomic) long long code; // @synthesize code=_code;
- (id)initWithCode:(long long)arg1 userActivity:(id)arg2;	// IMP=0x000000000033e4a7
