...
- (void).cxx_destruct;	// IMP=0x0020000000781a7e
@property(nonatomic) UIView *tableViewFooter; // @synthesize tableViewFooter=_tableViewFooter;
@property(retain, nonatomic) UITableView *tableView; // @synthesize tableView=_tableView;
- (void)viewDidLoad;	// IMP=0x0010000000781171
- (id)initWithStyle:(long long)arg1 withTableViewFooter:(id)arg2;	// IMP=0x0010000000781144
- (id)initWithStyle:(long long)arg1;	// IMP=0x001000000078102d
