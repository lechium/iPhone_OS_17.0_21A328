...
- (void).cxx_destruct;	// IMP=0x0000000000f07518
...
- (void)unregister;	// IMP=0x0000000000f07487
- (struct CGRect)preferredSourceViewRectInCoordinateSpace:(id)arg1;	// IMP=0x0000000000f0746f
@property(readonly, nonatomic) UIGestureRecognizer *previewingGestureRecognizerForFailureRelationship;
- (id)initWithSourceView:(id)arg1;	// IMP=0x0000000000f073b1
