...
- (void).cxx_destruct;	// IMP=0x00000000002c6740
- (void)applicationWillDeactivate:(id)arg1;	// IMP=0x00000000002c66db
- (void)applicationDidActivate:(id)arg1;	// IMP=0x00000000002c66ca
- (void)dealloc;	// IMP=0x00000000002c6649
- (id)init;	// IMP=0x00000000002c5ee7
