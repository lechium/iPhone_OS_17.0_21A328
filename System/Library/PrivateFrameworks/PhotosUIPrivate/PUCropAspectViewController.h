...
- (void).cxx_destruct;	// IMP=0x00000000001c5857
...
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x00000000001c5682
- (void)aspectButtonPressed:(id)arg1;	// IMP=0x00000000001c5467
- (void)updateAspectConstraints;	// IMP=0x00000000001c3e7e
- (void)updateAspectButtons;	// IMP=0x00000000001c3743
- (id)matchingCropAspectTo:(id)arg1;	// IMP=0x00000000001c33e5
- (void)updateAspectButtonSelection;	// IMP=0x00000000001c3240
- (void)viewDidLoad;	// IMP=0x00000000001c2d7f
- (id)initWithLayoutOrientation:(long long)arg1 originalSize:(struct CGSize)arg2 currentSize:(struct CGSize)arg3 currentCropAspect:(id)arg4 spec:(id)arg5;	// IMP=0x00000000001c2c6a
