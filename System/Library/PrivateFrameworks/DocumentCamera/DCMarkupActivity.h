...
- (void).cxx_destruct;	// IMP=0x000000000004d784
...
- (void)performActivity;	// IMP=0x000000000004d4fb
- (void)prepareWithActivityItems:(id)arg1;	// IMP=0x000000000004d34d
- (_Bool)canPerformWithActivityItems:(id)arg1;	// IMP=0x000000000004d21f
- (id)activityImage;	// IMP=0x000000000004d10c
- (id)activityTitle;	// IMP=0x000000000004d0e2
- (id)activityType;	// IMP=0x000000000004d0d5
- (id)initFromView:(id)arg1 presentingViewController:(id)arg2 frameBlock:(CDUnknownBlockType)arg3 completionBlock:(CDUnknownBlockType)arg4;	// IMP=0x000000000004cfe6
