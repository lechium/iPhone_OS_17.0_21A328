...
- (void).cxx_destruct;	// IMP=0x0020000000108dbe
...
- (void)proceedWithFilteredTLKShares:(id)arg1;	// IMP=0x0010000000108aaf
- (void)proceedWithRecoveryKeyID:(id)arg1;	// IMP=0x0010000000108942
- (void)groupStart;	// IMP=0x001000000010842f
- (id)initWithDependencies:(id)arg1 intendedState:(id)arg2 errorState:(id)arg3 custodianRecoveryKey:(id)arg4 saveVoucher:(_Bool)arg5;	// IMP=0x001000000010831f
