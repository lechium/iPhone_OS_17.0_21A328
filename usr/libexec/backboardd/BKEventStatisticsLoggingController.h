...
+ (id)workQueue;	// IMP=0x002000000006b49e
- (void).cxx_destruct;	// IMP=0x002000000006addb
@property(copy, nonatomic) NSArray *statistics; // @synthesize statistics=_statistics;
- (void)invalidate;	// IMP=0x001000000006ad77
- (void)updateStatistics:(CDUnknownBlockType)arg1;	// IMP=0x001000000006acea
- (id)beginTransactionForReason:(id)arg1;	// IMP=0x001000000006acd4
- (void)dealloc;	// IMP=0x001000000006ab4b
- (id)initWithLabel:(id)arg1 logCategory:(id)arg2;	// IMP=0x001000000006a985
