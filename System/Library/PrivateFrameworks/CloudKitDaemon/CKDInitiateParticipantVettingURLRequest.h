...
- (void).cxx_destruct;	// IMP=0x0000000000122dbb
...
- (void)requestDidParseNodeFailure:(id)arg1;	// IMP=0x0000000000122c63
- (id)requestDidParseProtobufObject:(id)arg1;	// IMP=0x0000000000122a3e
- (id)generateRequestOperations;	// IMP=0x00000000001227df
- (id)requestOperationClasses;	// IMP=0x0000000000122773
- (void)fillOutRequestProperties:(id)arg1;	// IMP=0x000000000012268d
- (void)fillOutEquivalencyPropertiesBuilder:(id)arg1;	// IMP=0x00000000001225b9
- (id)initWithOperation:(id)arg1 shareRecordID:(id)arg2 encryptedKey:(id)arg3 participantID:(id)arg4 baseToken:(id)arg5;	// IMP=0x00000000001224ba
