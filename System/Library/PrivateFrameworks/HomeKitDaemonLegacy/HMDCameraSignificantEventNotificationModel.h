...
+ (id)significantEventsBetweenDatesQueryWithIsAscending:(_Bool)arg1;	// IMP=0x00600000002aa180
+ (id)hmbQueries;	// IMP=0x00600000002aa0b5
+ (id)hmbExternalRecordType;	// IMP=0x00600000002aa0a8
+ (id)hmbProperties;	// IMP=0x00600000002aa078
- (id)createClipSignificantEventWithCameraProfileUUID:(id)arg1 faceClassification:(id)arg2;	// IMP=0x00000000002aa8b5
