...
- (void).cxx_destruct;	// IMP=0x002000000042fa15
...
- (_Bool)_missingDeviceIdentity:(_Bool *)arg1;	// IMP=0x001000000042f9c3
- (void)recertifyDeviceIfNeeded;	// IMP=0x001000000042f9bd
- (void)_repairTimerHit:(id)arg1;	// IMP=0x001000000042f9ab
- (id)init;	// IMP=0x001000000042f8a6
