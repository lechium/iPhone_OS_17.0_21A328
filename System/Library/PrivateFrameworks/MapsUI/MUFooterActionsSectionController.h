...
- (void).cxx_destruct;	// IMP=0x0000000000123d7d
...
- (id)revealedAnalyticsModule;	// IMP=0x0000000000123ceb
- (id)analyticsModule;	// IMP=0x0000000000123cb7
- (int)analyticsModuleType;	// IMP=0x0000000000123cac
- (id)infoCardChildUnactionableUIElements;	// IMP=0x0000000000123c9f
- (id)infoCardChildPossibleActions;	// IMP=0x0000000000123a93
@property(readonly, nonatomic) MUPlaceSectionFooterViewModel *sectionFooterViewModel;
- (id)draggableContent;	// IMP=0x0000000000123a83
- (void)reloadData;	// IMP=0x0000000000123616
@property(readonly, nonatomic) _Bool hasContent;
@property(readonly, nonatomic) NSArray *sectionViews;
@property(readonly, nonatomic) UIView *sectionView;
- (void)_setupFooterView;	// IMP=0x00000000001234d4
- (id)initWithActionManager:(id)arg1;	// IMP=0x0000000000123392
