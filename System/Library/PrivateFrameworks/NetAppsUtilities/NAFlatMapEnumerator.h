...
- (void).cxx_destruct;	// IMP=0x0000000000004315
...
- (id)allObjects;	// IMP=0x000000000000424c
- (id)nextObject;	// IMP=0x00000000000041a9
- (id)initWithEnumerator:(id)arg1 map:(CDUnknownBlockType)arg2;	// IMP=0x00000000000040f4
