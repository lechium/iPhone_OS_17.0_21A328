...
- (id)className;	// IMP=0x0000000000059f6c
- (void)calculateNOWRD:(double)arg1 time:(double)arg2;	// IMP=0x0000000000059b52
- (void)calculateOWRDWithTimestamp:(unsigned int)arg1 sampleRate:(unsigned int)arg2 time:(double)arg3;	// IMP=0x0000000000059647
- (void)resetLossEventBuffer;	// IMP=0x0000000000059636
- (int)lossEventCountThresholdForBitrate:(unsigned int)arg1;	// IMP=0x000000000005960e
- (int)lossEventCount;	// IMP=0x00000000000595f4
- (void)updatePacketLossRate:(double)arg1 time:(double)arg2;	// IMP=0x00000000000595a4
- (_Bool)shouldRampUp;	// IMP=0x00000000000594de
- (_Bool)shouldRampDown;	// IMP=0x000000000005942a
- (unsigned short)rampDownTier;	// IMP=0x0000000000059400
- (unsigned short)rampUpTier;	// IMP=0x00000000000593e1
- (void)stateEnter;	// IMP=0x00000000000593c2
- (void)stateExit;	// IMP=0x00000000000593bc
- (void)stateChange:(int)arg1;	// IMP=0x0000000000059263
- (void)printRateControlFullInfoWithLogDump:(void *)arg1 time:(double)arg2 videoStall:(_Bool)arg3 videoFrozenDuration:(double)arg4 averageTargetBitrate:(unsigned int)arg5;	// IMP=0x000000000005913e
- (void)updateRTPReceiveWithTimestamp:(unsigned int)arg1 sampleRate:(unsigned int)arg2 time:(double)arg3;	// IMP=0x000000000005912c
- (void)doRateControlWithTime:(double)arg1 roundTripTime:(double)arg2 packetLossRate:(double)arg3 operatingTierIndex:(unsigned short)arg4 averageReceivedBitrate:(unsigned int)arg5;	// IMP=0x0000000000058f2f
@property(readonly, copy) NSString *description;
- (void)setMaxTierIndex:(unsigned short)arg1 minTierIndex:(unsigned short)arg2;	// IMP=0x0000000000058e79
- (id)init;	// IMP=0x0000000000058c69
