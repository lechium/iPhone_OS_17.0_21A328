...
- (void).cxx_destruct;	// IMP=0x000000000003909e
...
- (id)description;	// IMP=0x0000000000038f9e
- (void)_addChildViewElement:(id)arg1;	// IMP=0x0000000000038f88
- (id)initWithColumnIdentifier:(long long)arg1;	// IMP=0x0000000000038f27
