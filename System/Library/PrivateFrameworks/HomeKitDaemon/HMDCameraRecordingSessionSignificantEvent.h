...
- (void).cxx_destruct;	// IMP=0x000000000003e6bf
...
- (id)attributeDescriptions;	// IMP=0x000000000003e081
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000003ded1
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000003dec6
- (unsigned long long)hash;	// IMP=0x000000000003de82
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000003dafb
- (id)initWithUUID:(id)arg1;	// IMP=0x000000000003d9d5
