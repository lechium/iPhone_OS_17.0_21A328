...
- (struct CGPoint)_visibleBannerCenterPosition:(struct CGSize)arg1;	// IMP=0x0000000000005079
- (struct CGPoint)_hiddenBannerPosition:(struct CGSize)arg1;	// IMP=0x0000000000004f94
- (void)addConstraintsForBannerView;	// IMP=0x0000000000004ade
- (double)bannerWidthForViewSize:(struct CGSize)arg1;	// IMP=0x0000000000004a4c
- (void)viewWillTransitionToSize:(struct CGSize)arg1 withTransitionCoordinator:(id)arg2;	// IMP=0x00000000000046f2
- (unsigned long long)supportedInterfaceOrientations;	// IMP=0x0000000000004568
- (void)hideBannerQuickly:(_Bool)arg1;	// IMP=0x00000000000041be
- (void)showCurrentBanner;	// IMP=0x0000000000003dec
- (void)addBannerView:(id)arg1;	// IMP=0x0000000000003cae
- (void)handleWindowPan:(id)arg1;	// IMP=0x0000000000003c0a
- (_Bool)windowPointInside:(struct CGPoint)arg1 withEvent:(id)arg2;	// IMP=0x00000000000039b9
