...
- (void).cxx_destruct;	// IMP=0x00200000003cb15f
...
- (void)updateWithRefinedWaypoints:(id)arg1;	// IMP=0x00100000003cafd7
- (id)makeRouteAttributesBuilderWithNavigationMode:(unsigned long long)arg1;	// IMP=0x00100000003caf6e
@property(readonly, nonatomic) WalkPreferences *walkPreferences;
- (id)initWithPreferences:(id)arg1 timing:(id)arg2;	// IMP=0x00100000003caec7
