...
- (void).cxx_destruct;	// IMP=0x00000000003369c2
...
- (_Bool)canPerformLocalActionWithItemState:(id)arg1;	// IMP=0x00000000003368a3
- (_Bool)canPersonalizeUsingItemState:(id)arg1;	// IMP=0x0000000000336768
