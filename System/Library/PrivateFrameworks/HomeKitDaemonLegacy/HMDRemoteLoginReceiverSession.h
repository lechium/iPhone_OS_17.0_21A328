...
- (void).cxx_destruct;	// IMP=0x00000000002401b4
...
- (id)description;	// IMP=0x0000000000240115
- (void)dealloc;	// IMP=0x0000000000240025
- (id)initWithSessionID:(id)arg1 remoteAuthentication:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x000000000023ff51
