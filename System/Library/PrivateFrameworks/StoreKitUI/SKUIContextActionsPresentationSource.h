...
- (void).cxx_destruct;	// IMP=0x000000000039c5e7
...
- (void)presentViewController:(id)arg1 permittedArrowDirections:(unsigned long long)arg2 animated:(_Bool)arg3;	// IMP=0x000000000039c18b
- (id)initWithViewController:(id)arg1;	// IMP=0x000000000039c0dd
