...
- (void).cxx_destruct;	// IMP=0x000000000002e643
...
- (void)didTapNextButton;	// IMP=0x000000000002e4ec
- (void)didTapCancelButton;	// IMP=0x000000000002e4af
- (void)didTapOpacityButton;	// IMP=0x000000000002e3ca
- (void)didTapRotationButton;	// IMP=0x000000000002e2e3
- (void)didTapResetButton;	// IMP=0x000000000002e2a6
