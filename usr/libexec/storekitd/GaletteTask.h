...
+ (id)_unavailableInStorefrontErrorWithUnderlyingError:(id)arg1;	// IMP=0x004000000003f46f
+ (id)taskWithClient:(id)arg1 bundleRecord:(id)arg2 mode:(long long)arg3 presentSheet:(_Bool)arg4;	// IMP=0x001000000003ef3e
- (void).cxx_destruct;	// IMP=0x00200000000400fb
...
- (id)_countryCodesWithError:(id *)arg1;	// IMP=0x001000000003fba6
- (id)_clientData;	// IMP=0x001000000003f91e
- (void)_presentSheetWithURL:(id)arg1;	// IMP=0x001000000003f492
- (void)main;	// IMP=0x001000000003f05b
