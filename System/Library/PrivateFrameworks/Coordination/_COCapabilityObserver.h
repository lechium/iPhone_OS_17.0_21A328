...
- (void).cxx_destruct;	// IMP=0x0000000000024db4
...
- (void)notify:(_Bool)arg1;	// IMP=0x0000000000024b52
- (id)description;	// IMP=0x0000000000024a64
- (id)initWithCapability:(id)arg1 cluster:(id)arg2 block:(CDUnknownBlockType)arg3;	// IMP=0x00000000000248c0
