...
- (void).cxx_destruct;	// IMP=0x00000000000d34c9
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000d337e
- (id)initWithRequestClass:(Class)arg1;	// IMP=0x00000000000d331b
