...
- (id)outputImage;	// IMP=0x00000000000824b9
- (id)skinProtectionMaskWithThreshold:(float)arg1;	// IMP=0x00000000000823b7
- (id)irisProtectionMaskWithThresholdIris:(float)arg1 thresholdSclera:(float)arg2 thresholdSkin:(float)arg3;	// IMP=0x000000000008224b
