...
- (void).cxx_destruct;	// IMP=0x0000000000e1368f
- (unsigned long long)hash;	// IMP=0x0000000000e1345b
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000e1310a
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000e12d97
- (void)writeTo:(id)arg1;	// IMP=0x0000000000e127d7
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000e127ca
- (id)jsonRepresentation;	// IMP=0x0000000000e1255e
- (id)dictionaryRepresentation;	// IMP=0x0000000000e11e12
- (id)description;	// IMP=0x0000000000e11d63
- (id)initWithData:(id)arg1;	// IMP=0x0000000000e109fa
- (id)init;	// IMP=0x0000000000e1099e
