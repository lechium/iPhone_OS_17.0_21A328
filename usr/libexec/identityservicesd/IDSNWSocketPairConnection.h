...
- (void).cxx_destruct;	// IMP=0x002000000042a601
...
- (void)_sendDataViaNWConnection:(id)arg1 isLargeTransfer:(_Bool)arg2;	// IMP=0x001000000042a299
@property(readonly, nonatomic) NSSet *inFlightMessages;
- (void)_dequeueNextMessageFromOutgoingQueue;	// IMP=0x0010000000429d59
- (double)lastSocketActivityTime;	// IMP=0x0010000000429d4e
- (_Bool)sendDataMessage:(id)arg1 canFragment:(_Bool)arg2;	// IMP=0x001000000042971a
- (_Bool)sendDataMessage:(id)arg1;	// IMP=0x0010000000429706
- (void)_processIncomingRawMessage:(id)arg1;	// IMP=0x0010000000428e74
- (void)processStoredIncomingMessage:(id)arg1;	// IMP=0x0010000000428e62
- (void)_receiveFromNWConnection:(id)arg1;	// IMP=0x00100000004288d7
- (void)setOTREncryptionBlock:(CDUnknownBlockType)arg1 decryptionBlock:(CDUnknownBlockType)arg2;	// IMP=0x001000000042885e
- (void)_notifyDelegateAboutClosedConnection;	// IMP=0x00100000004287c4
- (void)endSession;	// IMP=0x001000000042869d
- (void)dealloc;	// IMP=0x0010000000428614
- (void)start;	// IMP=0x0010000000428152
- (id)initWithSocket:(int)arg1 queue:(id)arg2 delegate:(id)arg3 priority:(long long)arg4 identifier:(id)arg5;	// IMP=0x0010000000427f82
