...
+ (_Bool)supportsSecureCoding;	// IMP=0x006000000018e353
+ (id)loadFromClientStateInSession:(id)arg1 options:(id)arg2;	// IMP=0x006000000018dfcb
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000018e263
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000018e16a
- (id)init;	// IMP=0x000000000018e110
- (id)description;	// IMP=0x000000000018e0c6
...
- (unsigned long long)allocatePackageItemRank;	// IMP=0x000000000018de52
@property(nonatomic) unsigned long long nextNotifRank;
- (unsigned long long)allocateNotifRank;	// IMP=0x000000000018dd55
- (unsigned long long)allocateItemRowID;	// IMP=0x000000000018dcfd
