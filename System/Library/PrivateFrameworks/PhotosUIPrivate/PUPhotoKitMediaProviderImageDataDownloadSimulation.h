...
- (void).cxx_destruct;	// IMP=0x0000000000428b77
...
- (void)endSimulationWithError:(id)arg1;	// IMP=0x00000000004288e0
- (void)updateSimulationWithProgress:(double)arg1;	// IMP=0x000000000042883c
- (void)_handleResultImageData:(id)arg1 dataUTI:(id)arg2 orientation:(long long)arg3 info:(id)arg4;	// IMP=0x0000000000428790
- (id)init;	// IMP=0x00000000004286df
