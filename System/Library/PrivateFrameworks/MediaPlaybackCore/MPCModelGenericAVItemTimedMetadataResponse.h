...
- (void).cxx_destruct;	// IMP=0x000000000014a758
...
- (void)_personalizationResponseDidInvalidateNotification:(id)arg1;	// IMP=0x000000000014a69d
- (void)dealloc;	// IMP=0x000000000014a608
- (id)initWithRequest:(id)arg1 personalizationResponse:(id)arg2 firstResponse:(_Bool)arg3 finalResponse:(_Bool)arg4;	// IMP=0x000000000014a4b4
