...
- (void).cxx_destruct;	// IMP=0x000000000022de09
...
- (id)mainReturningError;	// IMP=0x000000000022d7eb
- (id)initWithGroup:(id)arg1 update:(_Bool)arg2 migration:(_Bool)arg3 fetchResult:(CDUnknownBlockType)arg4;	// IMP=0x000000000022d710
