...
- (void).cxx_destruct;	// IMP=0x0000000000ba3c7a
...
- (void)timerDidFire:(id)arg1;	// IMP=0x0000000000ba3bcf
- (void)suspend;	// IMP=0x0000000000ba3b92
- (void)resume;	// IMP=0x0000000000ba3b55
- (id)initWithQueue:(id)arg1 interval:(double)arg2 timerFireHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000000ba3a64
