...
@interface VOTEvent : NSObject
{
    ...
    MISSING_TYPE *_bypassHelp;	// 88 = 0x58
...
+ (id)brailleEventWithCommand:(id)arg1 info:(id)arg2;	// IMP=0x0040000000016ef5
+ (id)appleTVRemoteEventWithCommand:(id)arg1 info:(id)arg2;	// IMP=0x0010000000016e57
+ (id)systemServerEventWithCommand:(id)arg1 info:(id)arg2;	// IMP=0x0010000000016db9
+ (id)internalEventWithCommand:(id)arg1 info:(id)arg2;	// IMP=0x0010000000016d1b
+ (id)touchEventWithCommand:(id)arg1 info:(id)arg2;	// IMP=0x0010000000016c7d
+ (id)keyEventWithCommand:(id)arg1 keyInfo:(id)arg2;	// IMP=0x0010000000016c61
+ (id)keyEventWithCommand:(id)arg1 keyInfo:(id)arg2 otherInfo:(id)arg3;	// IMP=0x0010000000016b93
+ (id)externalDeviceEventWithCommand:(id)arg1 info:(id)arg2;	// IMP=0x0010000000016af5
- (void).cxx_destruct;	// IMP=0x0020000000017300
...
- (id)description;	// IMP=0x001000000001710c
@property(nonatomic) _Bool bypassHelp; // @dynamic bypassHelp;
- (id)objectForIndex:(unsigned long long)arg1;	// IMP=0x00100000000170e4
- (void)setObject:(id)arg1 forIndex:(unsigned long long)arg2;	// IMP=0x001000000001706b
- (void)setInfo:(id)arg1;	// IMP=0x0010000000017020
@property(retain, nonatomic) VOTKeyInfo *keyInfo; // @dynamic keyInfo;
- (_Bool)isAppleTVRemoteEvent;	// IMP=0x0010000000016fe4
- (_Bool)isSystemServerEvent;	// IMP=0x0010000000016fd6
- (_Bool)isBrailleEvent;	// IMP=0x0010000000016fc8
- (_Bool)isExternalDeviceEvent;	// IMP=0x0010000000016fba
- (_Bool)isTouchEvent;	// IMP=0x0010000000016fac
- (_Bool)isKeyEvent;	// IMP=0x0010000000016f9e
- (double)time;	// IMP=0x0010000000016f93
- (id)initWithType:(long long)arg1;	// IMP=0x0010000000016aa3
