...
+ (_Bool)validateRequest:(id)arg1 error:(id *)arg2;	// IMP=0x006000000000192b
- (void).cxx_destruct;	// IMP=0x0000000000001abb
...
- (void)runWithRequest:(id)arg1;	// IMP=0x00000000000019d3
- (id)initWithRequest:(id)arg1 enrollmentStateProvider:(id)arg2;	// IMP=0x00000000000018b3
