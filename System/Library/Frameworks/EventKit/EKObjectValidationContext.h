...
- (void).cxx_destruct;	// IMP=0x00000000000c7bb2
...
- (void)faultIfNeededForObject:(id)arg1;	// IMP=0x00000000000c7af9
- (id)initWithRootObject:(id)arg1;	// IMP=0x00000000000c7a8e
