...
- (void).cxx_destruct;	// IMP=0x002000000000a0cc
...
- (struct CGSize)intrinsicContentSize;	// IMP=0x0010000000009fc9
...
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x0010000000009d5c
- (_Bool)canBecomeFocused;	// IMP=0x0010000000009d54
- (void)_tappyTap;	// IMP=0x0010000000009cd5
- (id)initWithModel:(id)arg1;	// IMP=0x001000000000915e
