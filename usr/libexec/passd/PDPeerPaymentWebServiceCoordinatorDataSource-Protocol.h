...
@class NSArray, NSDate, NSSet, NSString, PKPass, PKPeerPaymentAccount, PKPeerPaymentPreferences, PKPeerPaymentRecurringPayment;
...
- (void)deletePeerPaymentRecurringPaymentsForIdentifiers:(NSArray *)arg1;
- (void)updateAllPeerPaymentRecurringPayments:(NSArray *)arg1;
...
- (NSArray *)peerPaymentRecurringPayments;
- (void)deletePeerPaymentPendingRequestsForRequestTokens:(NSArray *)arg1;
- (void)insertOrUpdatePeerPaymentPendingRequests:(NSArray *)arg1;
- (NSArray *)peerPaymentPendingRequestsForRequestTokens:(NSArray *)arg1;
