...
- (void).cxx_destruct;	// IMP=0x000000000011fa27
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000011f91f
...
- (id)initWithVideoManagedObject:(id)arg1 imageType:(unsigned long long)arg2;	// IMP=0x000000000011f3bf
