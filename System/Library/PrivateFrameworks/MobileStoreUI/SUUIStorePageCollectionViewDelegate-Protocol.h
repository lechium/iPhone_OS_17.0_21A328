...
#import <MobileStoreUI/UICollectionViewDelegateFlowLayout-Protocol.h>

@class IKColor, NSArray, NSIndexPath, SUUICollectionViewLayoutAttributes, SUUIStorePageCollectionViewLayout, UICollectionView;
...
- (struct UIEdgeInsets)collectionView:(UICollectionView *)arg1 layout:(SUUIStorePageCollectionViewLayout *)arg2 pinningContentInsetForItemAtIndexPath:(NSIndexPath *)arg3;
