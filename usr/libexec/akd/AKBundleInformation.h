...
+ (_Bool)supportsSecureCoding;	// IMP=0x002000000006d041
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000006cf9e
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000006cdc6
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000006ccef
- (id)initWithBundleIdentifier:(id)arg1 bundleName:(id)arg2 bundleDescription:(id)arg3 bundleType:(unsigned long long)arg4 otherInfo:(id)arg5;	// IMP=0x001000000006cc06
