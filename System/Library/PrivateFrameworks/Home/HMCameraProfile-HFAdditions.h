...
+ (unsigned long long)hf_cameraAccessModeSelectedOptionForCameraProfiles:(id)arg1 presenceType:(unsigned long long)arg2;	// IMP=0x0010000000178abd
- (id)hf_faceCropImageForSignificantEvent:(id)arg1;	// IMP=0x00100000001791d3
- (id)hf_significantEventWithIdentifier:(id)arg1;	// IMP=0x0010000000178def
- (void)hf_updateDoorbellChime:(_Bool)arg1;	// IMP=0x0010000000178870
...
- (id)hf_updateUserNotificationSettings:(id)arg1;	// IMP=0x0010000000263ae7
@property(readonly, copy, nonatomic) HFUserNotificationServiceSettings *hf_userNotificationSettings;
- (id)hf_bulletinNotifications;	// IMP=0x00100000002639b0
- (id)_hf_smartDetectionBulletinNotification;	// IMP=0x0010000000263960
- (id)_hf_legacyMotionSensorBulletinNotification;	// IMP=0x00100000002638dc
- (id)_hf_doorbellBulletinNotification;	// IMP=0x0010000000263858
