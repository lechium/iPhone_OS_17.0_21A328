...
@class MISSING_TYPE, NSSet, NSString, NSUserActivity, UIScene, UISceneConnectionOptions, UISceneSession;

@protocol UISceneDelegate <NSObject>

@optional
- (void)scene:(UIScene *)arg1 didUpdateUserActivity:(NSUserActivity *)arg2;
- (MISSING_TYPE *)scene:didFailToContinueUserActivityWithType:error: /* Error: Ran out of types for this method. */;
