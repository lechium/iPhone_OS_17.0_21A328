...
- (void).cxx_destruct;	// IMP=0x0020000000112a45
@property(readonly, copy, nonatomic) CDUnknownBlockType completionHandler; // @synthesize completionHandler=_completionHandler;
@property(copy, nonatomic) NSArray *downloadTasks; // @synthesize downloadTasks=_downloadTasks;
- (void)runOperations;	// IMP=0x00100000001124d3
- (void)_downloadNextGroup;	// IMP=0x0010000000111f04
- (void)_downloadNextOperationType;	// IMP=0x0010000000111e02
- (void)_downloadCurrentGroup;	// IMP=0x0010000000110a12
- (id)_recordIDForResourcesWithItemScopedIdentifier:(id)arg1;	// IMP=0x00100000001107c5
- (id)_cloudKitScopeForTask:(id)arg1;	// IMP=0x00100000001104eb
- (id)_downloadOperationWithRecordIDsAndTasks:(id)arg1 keys:(id)arg2 perRecordProgressBlock:(CDUnknownBlockType)arg3 perRecordCompletionBlock:(CDUnknownBlockType)arg4 completionBlock:(CDUnknownBlockType)arg5;	// IMP=0x001000000010fe11
- (void)_finishRemainingTasksWithError:(id)arg1;	// IMP=0x001000000010fbd4
- (void)cancelDownloadTask:(id)arg1;	// IMP=0x001000000010f9be
- (id)initWithController:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x001000000010f353
