...
+ (_Bool)shouldPlayWhenDoneForActionRef:(id)arg1;	// IMP=0x006000000007dcb8
+ (long long)getPurchaseTypeFromActionRef:(id)arg1;	// IMP=0x006000000007db16
- (void).cxx_destruct;	// IMP=0x000000000007e083
...
- (void)_recordErrorLog:(id)arg1;	// IMP=0x000000000007dcc0
- (void)handleRequestCompletionWithResult:(id)arg1 andError:(id)arg2;	// IMP=0x000000000007d8ea
- (void)enqueueWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000000007d7b5
- (id)initWithBuyParams:(id)arg1 ofPurchaseType:(long long)arg2;	// IMP=0x000000000007d589
