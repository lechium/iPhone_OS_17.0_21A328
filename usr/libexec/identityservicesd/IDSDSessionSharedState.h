...
- (void).cxx_destruct;	// IMP=0x0020000000348380
...
- (id)publicIdentityFromData:(id)arg1;	// IMP=0x0010000000347a9f
- (_Bool)destinationIsDefaultPairedDevice:(id)arg1;	// IMP=0x00100000003479f4
- (_Bool)destinationIsGuestDevice:(id)arg1;	// IMP=0x00100000003479a6
- (id)getQuickRelayAllocateOptions:(id)arg1;	// IMP=0x00100000003476e8
- (_Bool)supportsReinitiate;	// IMP=0x001000000034764d
- (void)_endSessionTimedOut;	// IMP=0x0010000000347547
- (void)_endSessionTimerFiredOnMain;	// IMP=0x00100000003474c8
- (void)setEndSessionTimeoutTimer;	// IMP=0x0010000000347300
- (void)_clearEndSessionTimeoutTimer;	// IMP=0x00100000003471a1
- (void)_clearPacketLossTimer;	// IMP=0x00100000003470a3
- (void)_connectionTimedOut;	// IMP=0x0010000000346faa
- (void)_connectionTimerFiredOnMain;	// IMP=0x0010000000346f2b
- (void)setConnectionTimer;	// IMP=0x0010000000346c85
- (void)_clearConnectionTimer;	// IMP=0x0010000000346b26
- (void)_clearInvitationTimer;	// IMP=0x00100000003469c7
- (void)_inviteTimedOut;	// IMP=0x001000000034687c
- (void)_inviteTimerFiredOnMain;	// IMP=0x00100000003467fd
- (void)setInvitationTimer;	// IMP=0x0010000000346621
- (void)clearAllTimers;	// IMP=0x00100000003465d9
@property(readonly, nonatomic) CDStruct_eff2b79e *encryptionState;
- (id)initWithDictionary:(id)arg1 serviceName:(id)arg2 isInitiator:(_Bool)arg3 uniqueID:(id)arg4 accountID:(id)arg5 destinations:(id)arg6;	// IMP=0x0010000000344e9d
