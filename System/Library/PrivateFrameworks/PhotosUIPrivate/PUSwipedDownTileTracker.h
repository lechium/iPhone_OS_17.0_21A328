...
- (void).cxx_destruct;	// IMP=0x000000000053d72a
...
- (id)tileControllerToTrack;	// IMP=0x000000000053d4b6
- (void)completeTracking;	// IMP=0x000000000053d45c
- (void)updateTileControllerTracking;	// IMP=0x000000000053d00e
- (void)startTileControllerTracking;	// IMP=0x000000000053cc69
- (void)updateGestureRecognizerTracking;	// IMP=0x000000000053cb03
- (id)initWithPanGestureRecognizer:(id)arg1 tilingView:(id)arg2;	// IMP=0x000000000053c9fb
- (id)initWithTilingView:(id)arg1;	// IMP=0x000000000053c9e4
