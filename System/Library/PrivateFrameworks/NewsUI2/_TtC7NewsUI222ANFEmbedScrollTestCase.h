...
@interface _TtC7NewsUI222ANFEmbedScrollTestCase : NSObject
{
...
- (void).cxx_destruct;	// IMP=0x0000000000b15400
- (id)init;	// IMP=0x0000000000b153b0
- (id)scrollViewWithContext:(id)arg1;	// IMP=0x0000000000b15250
