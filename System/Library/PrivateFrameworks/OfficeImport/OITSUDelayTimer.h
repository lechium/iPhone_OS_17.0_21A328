...
- (void)cancel;	// IMP=0x000000000029bb08
- (void)_reallyCancel;	// IMP=0x000000000029bac6
- (void)afterDelay:(double)arg1 processBlock:(CDUnknownBlockType)arg2;	// IMP=0x000000000029b8d2
- (void)dealloc;	// IMP=0x000000000029b87d
- (id)initWithTargetSerialQueue:(id)arg1;	// IMP=0x000000000029b76b
- (id)init;	// IMP=0x000000000029b757
