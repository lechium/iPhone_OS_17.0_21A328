...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000000ce15
- (unsigned long long)hash;	// IMP=0x000000000000cdae
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000000ccb6
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000000cc1a
- (void)copyTo:(id)arg1;	// IMP=0x000000000000cba1
- (void)writeTo:(id)arg1;	// IMP=0x000000000000cb0b
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000000cafe
- (id)dictionaryRepresentation;	// IMP=0x000000000000c9ac
- (id)description;	// IMP=0x000000000000c8fd
