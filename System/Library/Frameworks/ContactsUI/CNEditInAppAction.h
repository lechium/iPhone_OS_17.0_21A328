...
- (void).cxx_destruct;	// IMP=0x000000000023571b
@property(readonly, nonatomic) CNUIUserActivityManager *activityManager; // @synthesize activityManager=_activityManager;
- (id)title;	// IMP=0x00000000002356ae
- (void)performActionWithSender:(id)arg1;	// IMP=0x000000000023563e
- (id)initWithContact:(id)arg1 activityManager:(id)arg2;	// IMP=0x00000000002355b3
