...
+ (_Bool)supportsSecureCoding;	// IMP=0x0020000000062e1a
- (void).cxx_destruct;	// IMP=0x00200000000634f4
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000063348
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000063169
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000062e22
