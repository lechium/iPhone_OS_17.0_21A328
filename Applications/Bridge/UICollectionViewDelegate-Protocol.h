...
@class MISSING_TYPE, NSArray, NSIndexPath, NSString, UICollectionReusableView, UICollectionView, UICollectionViewCell, UICollectionViewFocusUpdateContext, UICollectionViewLayout, UICollectionViewTransitionLayout, UIContextMenuConfiguration, UIFocusAnimationCoordinator, UITargetedPreview, UIWindowSceneActivationConfiguration;
...
- (MISSING_TYPE *)collectionView:didSelectItemAtIndexPath: /* Error: Ran out of types for this method. */;
