...
- (void).cxx_destruct;	// IMP=0x00000000002af643
...
- (void)defragmentData;	// IMP=0x00000000002af506
- (void)append:(id)arg1;	// IMP=0x00000000002af460
- (id)initWithData:(id)arg1;	// IMP=0x00000000002af3a0
- (id)init;	// IMP=0x00000000002af387
