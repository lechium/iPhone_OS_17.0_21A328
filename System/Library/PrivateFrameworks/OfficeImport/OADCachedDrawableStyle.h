...
- (unsigned long long)hash;	// IMP=0x00000000000b0b42
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001038da
- (id)initWithFillCategory:(int)arg1 mFillIndex:(unsigned long long)arg2 strokeIndex:(unsigned long long)arg3 shadowIndex:(unsigned long long)arg4 reflectionOpacity:(unsigned char)arg5 textStyleIndex:(unsigned long long)arg6;	// IMP=0x00000000000b0a4f
