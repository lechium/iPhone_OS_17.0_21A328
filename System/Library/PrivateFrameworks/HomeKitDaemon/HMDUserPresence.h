...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000089b143
- (void).cxx_destruct;	// IMP=0x000000000089b101
...
- (id)attributeDescriptions;	// IMP=0x000000000089ae03
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000089ad27
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000089ac0d
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000089aa16
@property(readonly, nonatomic, getter=isNotAtHome) _Bool notAtHome;
@property(readonly, nonatomic, getter=isAtHome) _Bool atHome;
- (id)initWithUser:(id)arg1 presenceRegionStatus:(id)arg2 timeStamp:(id)arg3;	// IMP=0x000000000089a710
- (id)initWithUser:(id)arg1 presenceRegionStatus:(id)arg2;	// IMP=0x000000000089a673
