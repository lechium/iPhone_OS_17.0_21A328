...
- (void).cxx_destruct;	// IMP=0x000000000028215c
...
- (void)_cancelNotificationTimerWithReason:(id)arg1;	// IMP=0x0000000000281f15
- (void)_startNotificationTimerWithEventHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000281ccc
- (void)ingestNotificationName:(id)arg1;	// IMP=0x00000000002818ed
- (id)initWithDelegate:(id)arg1;	// IMP=0x000000000028178d
