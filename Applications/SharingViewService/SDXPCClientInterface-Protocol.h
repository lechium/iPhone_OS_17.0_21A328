...
@class MISSING_TYPE, NSDictionary, NSString, NSURL, NSUUID, SFClientGetDeviceAssetsParams, SFClientSubCredentialParams, SFContactInfo, SFDevice, SFPeopleSuggesterParams;

@protocol SDXPCClientInterface
- (MISSING_TYPE *)startProxCardTransactionWithOptions:completion: /* Error: Ran out of types for this method. */;
