...
- (id).cxx_construct;	// IMP=0x000000000057934a
- (void).cxx_destruct;	// IMP=0x00000000005791cb
...
- (void *)debugConsoleForId:(int)arg1;	// IMP=0x000000000057906f
- (void)didDrawView;	// IMP=0x0000000000579065
- (void)willDrawView;	// IMP=0x0000000000579009
...
- (_Bool)hasRenderTarget;	// IMP=0x00000000005787a5
- (void)destroyRenderTarget;	// IMP=0x0000000000578629
- (void)createRenderTarget;	// IMP=0x0000000000577a04
- (struct __IOSurface *)flipImage;	// IMP=0x0000000000577840
...
- (shared_ptr_fa6aa836)bitmapData;	// IMP=0x0000000000577668
@property(readonly, nonatomic) void *imageTexture;
@property(readonly, nonatomic) _Bool shouldRasterize;
- (void)dealloc;	// IMP=0x00000000005775fe
- (id)initWithSize:(struct CGSize)arg1 scale:(double)arg2 useMultisampling:(_Bool)arg3 extraColorFormats:(const void *)arg4 taskContext:(const void *)arg5 device:(void *)arg6 services:(void *)arg7 signpostId:(unsigned long long)arg8;	// IMP=0x0000000000576fbb
- (void *)_internalRenderTarget;	// IMP=0x0000000000576fb1
@property(readonly, nonatomic) void *finalRenderTarget;
@property(readonly, nonatomic) struct CGSize sizeInPixels;
- (void)willDealloc;	// IMP=0x0000000000576c07
- (void *)finalSurface;	// IMP=0x0000000000576bfd
