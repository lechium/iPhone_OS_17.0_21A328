...
+ (id)logCategory;	// IMP=0x00100000004522f8
- (void).cxx_destruct;	// IMP=0x0000000000451eb1
...
- (void)timerDidFire:(id)arg1;	// IMP=0x0000000000451c27
- (id)logIdentifier;	// IMP=0x0000000000451c15
- (void)_callDelegate;	// IMP=0x0000000000451b54
- (void)_handleStatusUpdateMessageError:(id)arg1 responseTime:(double)arg2;	// IMP=0x0000000000451a3c
- (void)_send;	// IMP=0x0000000000450c7d
- (void)send;	// IMP=0x0000000000450c0c
- (id)attributeDescriptions;	// IMP=0x00000000004509dc
- (void)dealloc;	// IMP=0x0000000000450894
- (id)initWithDelegate:(id)arg1 workQueue:(id)arg2 targetUUID:(id)arg3 messageDispatcher:(id)arg4 user:(id)arg5 presenceAuthStatus:(id)arg6 presenceComputeStatus:(id)arg7 presenceRegionStatus:(id)arg8 reason:(id)arg9;	// IMP=0x0000000000450566
