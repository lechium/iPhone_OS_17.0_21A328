...
- (void).cxx_destruct;	// IMP=0x00000000001962af
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001960b4
- (id)initWithStyle:(long long)arg1;	// IMP=0x0000000000195fbe
