...
+ (id)uniqueToken;	// IMP=0x0060000001744524
- (void).cxx_destruct;	// IMP=0x00000000017446bf
@property(copy, nonatomic) NSString *sceneIdentityString; // @synthesize sceneIdentityString=_sceneIdentityString;
- (id)description;	// IMP=0x0000000001744601
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000017445b3
- (id)init;	// IMP=0x0000000001744536
