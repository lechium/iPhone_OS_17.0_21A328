...
+ (void)generateReportForSharedFolder:(id)arg1 qualityOfService:(long long)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0060000000064412
+ (void)_finishReport:(id)arg1 session:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0060000000063f27
- (void).cxx_destruct;	// IMP=0x0000000000065086
...
- (id)telemetryEvent;	// IMP=0x0000000000064f7a
- (void)incrementErrorRetryCountWithSession:(id)arg1;	// IMP=0x0000000000063c92
- (void)shareChangedDuringCheckWithSession:(id)arg1;	// IMP=0x0000000000063b8c
- (id)initWithURL:(id)arg1;	// IMP=0x0000000000063b21
