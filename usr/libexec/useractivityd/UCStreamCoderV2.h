...
- (void).cxx_destruct;	// IMP=0x002000000001aea5
...
- (id)fetchDataForType:(id)arg1;	// IMP=0x001000000001aa0d
- (id)unpackMessage:(id)arg1;	// IMP=0x001000000001a99d
- (id)packMessage:(id)arg1;	// IMP=0x001000000001a986
- (void)filePackagerError:(id)arg1;	// IMP=0x001000000001a8a2
- (void)packager:(id)arg1 gotData:(id)arg2 forPacket:(long long)arg3;	// IMP=0x001000000001a3f2
- (void)sendCompletedWithError:(id)arg1;	// IMP=0x001000000001a197
- (void)sendPasteboard:(id)arg1 withCompletion:(CDUnknownBlockType)arg2;	// IMP=0x0010000000018cc2
- (void)calculateTimeRemaining;	// IMP=0x0010000000018aa0
- (void)processPasteboardInfo:(id)arg1;	// IMP=0x00100000000183dd
- (void)removeReceivedItems:(id)arg1;	// IMP=0x00100000000180f2
- (void)completedReceivingPasteboardWithError:(id)arg1;	// IMP=0x0010000000017e46
- (void)receivedPasteboardInfo:(id)arg1 withError:(id)arg2;	// IMP=0x0010000000017ba4
- (void)cancelReceive;	// IMP=0x0010000000017ae9
- (void)receivePasteboardToFile:(id)arg1 withProgress:(id)arg2 infoReceivedHandler:(CDUnknownBlockType)arg3 completionHandler:(CDUnknownBlockType)arg4 returnInfoEarly:(_Bool)arg5;	// IMP=0x00100000000178fe
- (void)sendHeartbeat;	// IMP=0x00100000000177f9
- (void)sendTotalSendSize;	// IMP=0x00100000000176df
- (void)sendPasteboardDataResponse;	// IMP=0x001000000001752d
- (void)sendFileArchiveRequest;	// IMP=0x001000000001701e
- (void)sendPasteboardDataRequest;	// IMP=0x0010000000016f34
- (void)sendPasteboardInfoResponse;	// IMP=0x0010000000016d97
- (void)sendPasteboardInfoRequest;	// IMP=0x0010000000016d09
- (void)handleHeartbeat:(id)arg1;	// IMP=0x0010000000016c65
- (void)handlePasteboardAuxInfoReceived:(id)arg1;	// IMP=0x0010000000016b06
- (void)handlePasteboardFileResponse:(id)arg1;	// IMP=0x001000000001631f
- (void)handlePasteboardDataResponse:(id)arg1;	// IMP=0x0010000000015ed1
- (void)handlePasteboardInfoResponse:(id)arg1;	// IMP=0x0010000000015bb7
- (void)handlePasteboardFileRequest:(id)arg1;	// IMP=0x00100000000154a4
- (void)handlePasteboardDataRequest:(id)arg1;	// IMP=0x0010000000015420
- (void)handlePasteboardInfoRequest:(id)arg1;	// IMP=0x001000000001539c
- (void)recvStop:(id)arg1;	// IMP=0x001000000001520a
- (void)sendStopWithError:(long long)arg1;	// IMP=0x001000000001507d
- (void)streams:(id)arg1 didWriteMessageWithTag:(long long)arg2;	// IMP=0x0010000000014bb8
- (void)streams:(id)arg1 didReadMessage:(id)arg2 withTag:(long long)arg3;	// IMP=0x0010000000014a37
- (void)streamsDidClose:(id)arg1 withError:(id)arg2;	// IMP=0x0010000000014928
- (void)removeObject:(id)arg1;	// IMP=0x0010000000014876
- (void)storeObject:(id)arg1;	// IMP=0x00100000000147c4
- (void)dealloc;	// IMP=0x00100000000145b1
- (id)initWithInputStream:(id)arg1 outputStream:(id)arg2;	// IMP=0x001000000001414d
