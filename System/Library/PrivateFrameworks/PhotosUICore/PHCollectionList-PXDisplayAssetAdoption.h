...
+ (id)px_otherAlbumsCollectionListIncludeDeleted:(_Bool)arg1 includeHidden:(_Bool)arg2 includeDuplicates:(_Bool)arg3;	// IMP=0x0010000000a52167
+ (id)_otherAlbumAssetCollectionsIncludingRecentlyDeleted:(_Bool)arg1 includeHidden:(_Bool)arg2 includeDuplicates:(_Bool)arg3 includingSharedLibrary:(_Bool)arg4 includingDebugAlbums:(_Bool)arg5;	// IMP=0x0010000000a50f9b
+ (id)_isValidGazeRectPredicate;	// IMP=0x0010000000a50e92
+ (id)_otherAlbumsCollectionListWithDeletedCollection:(_Bool)arg1 withHiddenCollection:(_Bool)arg2 withDuplicatesCollection:(_Bool)arg3;	// IMP=0x0010000000a50dca
+ (id)px_transientIdentifierForWellKnownFolderName:(id)arg1;	// IMP=0x0010000000a50d5e
...
- (_Bool)px_isTransientCollectionWithIdentifier:(id)arg1;	// IMP=0x0010000000a4fa31
- (_Bool)px_isContainedInCollectionList:(id)arg1;	// IMP=0x0010000000a4f908
...
- (_Bool)px_fetchIsEmptyWithOptions:(id)arg1;	// IMP=0x0010000000a4f701
- (id)px_navigationWellKnownName;	// IMP=0x0010000000a4f68b
- (id)px_navigationURLHost;	// IMP=0x0010000000a4f67e
