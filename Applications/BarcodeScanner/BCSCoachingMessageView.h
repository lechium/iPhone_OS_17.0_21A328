...
- (void).cxx_destruct;	// IMP=0x002000000001c9f8
- (void)layoutSubviews;	// IMP=0x001000000001c73c
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x001000000001c5ef
@property(copy, nonatomic) NSString *message;
- (id)init;	// IMP=0x001000000001be0b
