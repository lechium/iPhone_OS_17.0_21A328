...
+ (long long)activityCategory;	// IMP=0x00400000000bf040
- (void).cxx_destruct;	// IMP=0x00000000000bf5a0
- (id)init;	// IMP=0x00000000000bf540
- (void)performActivity;	// IMP=0x00000000000bf510
- (void)prepareWithActivityItems:(id)arg1;	// IMP=0x00000000000bf360
- (_Bool)canPerformWithActivityItems:(id)arg1;	// IMP=0x00000000000bf1e0
