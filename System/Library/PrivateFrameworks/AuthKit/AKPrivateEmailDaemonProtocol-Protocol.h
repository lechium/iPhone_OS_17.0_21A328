...
- (void)fetchSignInWithApplePrivateEmailWithContext:(AKPrivateEmailContext *)arg1 completion:(void (^)(AKPrivateEmail *, NSError *))arg2;
...
- (void)registerPrivateEmailWithContext:(AKPrivateEmailContext *)arg1 completion:(void (^)(AKPrivateEmail *, NSError *))arg2;
