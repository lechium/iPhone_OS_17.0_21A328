...
- (void).cxx_destruct;	// IMP=0x00000000002f31cc
...
- (id)getCanonicalID;	// IMP=0x00000000002f30e5
@property(readonly, nonatomic) NSArray *videosPlayables;
- (id)notificationBody;	// IMP=0x00000000002f30ba
- (id)notificationTitle;	// IMP=0x00000000002f309d
@property(readonly, nonatomic) NSString *title;
@property(readonly, nonatomic) NSString *buyParams;
@property(readonly, nonatomic) _Bool playWhenDone;
- (id)initWithDictionary:(id)arg1;	// IMP=0x00000000002f2de6
