...
+ (id)reuseIdentifier;	// IMP=0x006000000036fd64
- (void).cxx_destruct;	// IMP=0x00000000003707fc
...
- (void)layoutSubviews;	// IMP=0x000000000037039f
- (id)formattedTitleFromPreviewTitle:(id)arg1;	// IMP=0x0000000000370282
- (double)cornerRadius;	// IMP=0x000000000036fe84
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000036fd71
