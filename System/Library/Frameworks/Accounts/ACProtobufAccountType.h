...
- (void).cxx_destruct;	// IMP=0x0000000000057d87
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000057af6
- (unsigned long long)hash;	// IMP=0x0000000000057993
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000005775f
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000575a4
- (void)copyTo:(id)arg1;	// IMP=0x0000000000057450
- (void)writeTo:(id)arg1;	// IMP=0x00000000000572f9
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000000572ec
- (id)dictionaryRepresentation;	// IMP=0x0000000000056b7f
- (id)description;	// IMP=0x0000000000056ad0
