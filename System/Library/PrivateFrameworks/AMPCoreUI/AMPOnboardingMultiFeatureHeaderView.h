...
- (void)updateContentSize;	// IMP=0x0000000000008a43
- (void)setFrame:(struct CGRect)arg1;	// IMP=0x00000000000089f1
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x00000000000087fa
- (void)adjustedContentInsetDidChange;	// IMP=0x00000000000087a4
- (void)layoutSubviews;	// IMP=0x000000000000802b
- (id)initWithFeatures:(id)arg1;	// IMP=0x0000000000007d4f
