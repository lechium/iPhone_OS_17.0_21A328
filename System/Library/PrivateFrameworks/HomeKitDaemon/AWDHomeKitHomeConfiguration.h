...
+ (Class)primaryHAPServicesListCertifiedType;	// IMP=0x00100000006f5f61
+ (Class)hapServicesListCertifiedType;	// IMP=0x00100000006f5f50
+ (Class)primaryHAPServicesListType;	// IMP=0x00100000006f5f3f
+ (Class)hapServicesListType;	// IMP=0x00100000006f5f2e
+ (Class)homeKitMultiUserSettingsType;	// IMP=0x00100000006f5f1d
+ (Class)eventTriggersType;	// IMP=0x00100000006f5f0c
- (void).cxx_destruct;	// IMP=0x00000000006f28a1
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000006f0dde
- (unsigned long long)hash;	// IMP=0x00000000006f000d
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000006eed83
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000006ed690
- (void)copyTo:(id)arg1;	// IMP=0x00000000006ec4b5
- (void)writeTo:(id)arg1;	// IMP=0x00000000006eaf0d
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000006eaf00
- (id)dictionaryRepresentation;	// IMP=0x00000000006e80d3
- (id)description;	// IMP=0x00000000006e8024
...
- (int)StringAsCurrentMediaAccessoryFallbackMediaUserType:(id)arg1;	// IMP=0x00000000006e7af7
- (id)currentMediaAccessoryFallbackMediaUserTypeAsString:(int)arg1;	// IMP=0x00000000006e7aac
...
- (id)primaryHAPServicesListCertifiedAtIndex:(unsigned long long)arg1;	// IMP=0x00000000006e716f
- (unsigned long long)primaryHAPServicesListCertifiedsCount;	// IMP=0x00000000006e7152
- (void)addPrimaryHAPServicesListCertified:(id)arg1;	// IMP=0x00000000006e70e8
- (void)clearPrimaryHAPServicesListCertifieds;	// IMP=0x00000000006e70cb
- (id)hapServicesListCertifiedAtIndex:(unsigned long long)arg1;	// IMP=0x00000000006e70ae
- (unsigned long long)hapServicesListCertifiedsCount;	// IMP=0x00000000006e7091
- (void)addHapServicesListCertified:(id)arg1;	// IMP=0x00000000006e7027
- (void)clearHapServicesListCertifieds;	// IMP=0x00000000006e700a
- (id)primaryHAPServicesListAtIndex:(unsigned long long)arg1;	// IMP=0x00000000006e6fed
- (unsigned long long)primaryHAPServicesListsCount;	// IMP=0x00000000006e6fd0
- (void)addPrimaryHAPServicesList:(id)arg1;	// IMP=0x00000000006e6f66
- (void)clearPrimaryHAPServicesLists;	// IMP=0x00000000006e6f49
- (id)hapServicesListAtIndex:(unsigned long long)arg1;	// IMP=0x00000000006e6f2c
- (unsigned long long)hapServicesListsCount;	// IMP=0x00000000006e6f0f
- (void)addHapServicesList:(id)arg1;	// IMP=0x00000000006e6ea5
- (void)clearHapServicesLists;	// IMP=0x00000000006e6e88
...
- (id)homeKitMultiUserSettingsAtIndex:(unsigned long long)arg1;	// IMP=0x00000000006e6c60
- (unsigned long long)homeKitMultiUserSettingsCount;	// IMP=0x00000000006e6c43
- (void)addHomeKitMultiUserSettings:(id)arg1;	// IMP=0x00000000006e6bd9
- (void)clearHomeKitMultiUserSettings;	// IMP=0x00000000006e6bbc
...
- (int)StringAsNetworkProtectionStatus:(id)arg1;	// IMP=0x00000000006e6862
- (id)networkProtectionStatusAsString:(int)arg1;	// IMP=0x00000000006e681a
...
- (id)eventTriggersAtIndex:(unsigned long long)arg1;	// IMP=0x00000000006e61b9
- (unsigned long long)eventTriggersCount;	// IMP=0x00000000006e619c
- (void)addEventTriggers:(id)arg1;	// IMP=0x00000000006e6132
- (void)clearEventTriggers;	// IMP=0x00000000006e6115
