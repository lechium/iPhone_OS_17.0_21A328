...
+ (id)extendedInfoWithRoute:(id)arg1;	// IMP=0x00400000000562d3
- (void).cxx_destruct;	// IMP=0x0020000000056498
...
- (id)_extendedInfo;	// IMP=0x001000000005644d
@property(readonly, nonatomic) NSString *deviceIdentifier;
@property(readonly, nonatomic) NSString *modelName;
@property(readonly, nonatomic) _Bool requiresPIN;
- (id)initWithRoute:(id)arg1;	// IMP=0x0010000000056324
