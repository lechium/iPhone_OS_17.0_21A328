...
#import <MobileSafariUI/WKUIDelegate-Protocol.h>
...
- (void)_webView:(WKWebView *)arg1 requestPermissionForXRSessionOrigin:(NSString *)arg2 mode:(long long)arg3 grantedFeatures:(unsigned long long)arg4 consentRequiredFeatures:(unsigned long long)arg5 consentOptionalFeatures:(unsigned long long)arg6 requiredFeaturesRequested:(unsigned long long)arg7 optionalFeaturesRequested:(unsigned long long)arg8 completionHandler:(void (^)(unsigned long long))arg9;
