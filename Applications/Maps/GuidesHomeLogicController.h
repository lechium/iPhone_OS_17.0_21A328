...
- (void).cxx_destruct;	// IMP=0x0020000000868755
...
- (void)scrollToSelectedFilter;	// IMP=0x001000000086856b
- (id)routeToSelectedGuidesHomeFilterAtIndexPath:(id)arg1;	// IMP=0x00100000008683d2
- (id)routeToSelectedAllCollectionsFilterAtIndexPath:(id)arg1;	// IMP=0x00100000008683ca
- (id)routeToSelectedFilterAtIndexPath:(id)arg1;	// IMP=0x00100000008683c2
- (id)selectedFilterIndexPath;	// IMP=0x0010000000868372
- (void)initializeSectionsUsingMaxWidth:(double)arg1 traitEnvironment:(id)arg2;	// IMP=0x0010000000866f4c
- (id)itemsForSectionAtIndex:(unsigned long long)arg1;	// IMP=0x0010000000866b12
- (id)filterValueAtIndex:(unsigned long long)arg1;	// IMP=0x0010000000866a5b
- (id)sectionAtIndex:(unsigned long long)arg1;	// IMP=0x00100000008669b1
- (id)allSections;	// IMP=0x0010000000866969
- (void)appendBatchOfCollections:(id)arg1;	// IMP=0x0010000000866872
- (void)updateFilteredCollectionsFromResults:(id)arg1 collectionIds:(id)arg2;	// IMP=0x0010000000866493
- (void)willDisplayCellAtIndexpath:(id)arg1;	// IMP=0x001000000086639a
- (void)initializeFonts;	// IMP=0x00100000008662ee
- (id)initWithGuidesHomeResult:(id)arg1 maxWidth:(double)arg2 traitEnvironment:(id)arg3 guideFetcher:(id)arg4 guideConsumer:(id)arg5 guideLocation:(id)arg6;	// IMP=0x00100000008661b8
