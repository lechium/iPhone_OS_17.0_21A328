...
- (void)dealloc;	// IMP=0x0000000000063072
@property struct tagCONNRESULT *result;
- (id)initWithCallID:(unsigned int)arg1;	// IMP=0x0000000000062fad
- (id)initWithResult:(struct tagCONNRESULT *)arg1;	// IMP=0x0000000000062f0f
