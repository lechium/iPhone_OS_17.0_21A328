...
@interface SUUIRedeem : NSObject
{
    ...
    id <SUUIArtworkProviding> _headerArtworkProvider;	// 96 = 0x60
...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000001b414e
- (void).cxx_destruct;	// IMP=0x00000000001b4795
...
@property(retain, nonatomic) id <SUUIArtworkProviding> headerArtworkProvider; // @synthesize headerArtworkProvider=_headerArtworkProvider;
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001b4481
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001b4156
- (id)init;	// IMP=0x00000000001b40fa
