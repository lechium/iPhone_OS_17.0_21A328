...
- (void).cxx_destruct;	// IMP=0x000000000092e459
...
- (id)mainReturningError;	// IMP=0x000000000092df41
- (id)initWithAtomicSaveEnabled:(_Bool)arg1 transaction:(id)arg2;	// IMP=0x000000000092deae
- (id)initWithTransaction:(id)arg1;	// IMP=0x000000000092de67
