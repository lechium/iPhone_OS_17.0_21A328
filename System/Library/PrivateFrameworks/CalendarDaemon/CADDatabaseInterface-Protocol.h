...
- (void)CADDatabaseCommitDeletes:(NSArray *)arg1 updatesAndInserts:(NSDictionary *)arg2 options:(long long)arg3 andFetchChangesSinceTimestamp:(CADInMemoryChangeTimestamp *)arg4 withReply:(void (^)(int, NSDictionary *, NSDictionary *, NSDictionary *, CADInMemoryChangeTimestamp *, _Bool))arg5;
