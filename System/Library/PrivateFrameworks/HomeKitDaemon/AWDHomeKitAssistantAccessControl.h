...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000ada57c
- (unsigned long long)hash;	// IMP=0x0000000000ada4de
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000ada3ad
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000ada2db
- (void)copyTo:(id)arg1;	// IMP=0x0000000000ada22c
- (void)writeTo:(id)arg1;	// IMP=0x0000000000ada158
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000ad9d58
- (id)dictionaryRepresentation;	// IMP=0x0000000000ad9b5c
- (id)description;	// IMP=0x0000000000ad9aad
