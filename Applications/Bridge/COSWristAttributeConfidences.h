...
- (id)description;	// IMP=0x00100000000a74ad
- (void)divideConfidencesBy:(long long)arg1;	// IMP=0x00100000000a7461
- (void)addConfidences:(id)arg1;	// IMP=0x00100000000a7366
- (id)initWithObservationTime:(double)arg1;	// IMP=0x00100000000a7323
- (id)initWithObservationTime:(double)arg1 none:(double)arg2 invalid:(double)arg3 lr:(double)arg4 ll:(double)arg5 rr:(double)arg6 rl:(double)arg7 palm:(double)arg8 dock:(double)arg9;	// IMP=0x00100000000a726d
