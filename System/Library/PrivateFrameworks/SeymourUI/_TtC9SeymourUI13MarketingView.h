...
- (void).cxx_destruct;	// IMP=0x000000000070fa20
- (void)dismissButtonTapped:(id)arg1;	// IMP=0x000000000070e430
- (void)actionItemButtonTapped:(id)arg1;	// IMP=0x000000000070e3e0
- (void)layoutSubviews;	// IMP=0x000000000070ce20
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000070c960
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000070c930
