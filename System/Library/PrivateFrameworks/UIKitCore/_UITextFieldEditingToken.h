...
- (void).cxx_destruct;	// IMP=0x00000000014036b4
...
- (_Bool)endEditing;	// IMP=0x0000000001403403
- (id)initWithTextStorage:(id)arg1 attributeNames:(id)arg2;	// IMP=0x000000000140335f
