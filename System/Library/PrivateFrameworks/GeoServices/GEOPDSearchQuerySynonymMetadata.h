...
- (void).cxx_destruct;	// IMP=0x0000000000b5a977
- (unsigned long long)hash;	// IMP=0x0000000000b5a690
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000b5a313
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000b59c63
- (void)writeTo:(id)arg1;	// IMP=0x0000000000b59695
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000b59686
- (id)jsonRepresentation;	// IMP=0x0000000000b587b6
- (id)dictionaryRepresentation;	// IMP=0x0000000000b57c38
- (id)description;	// IMP=0x0000000000b57b89
- (id)initWithData:(id)arg1;	// IMP=0x0000000000b566f9
- (id)init;	// IMP=0x0000000000b5669d
