...
- (id)description;	// IMP=0x000000000008b46e
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000008b1d0
- (unsigned long long)hash;	// IMP=0x000000000008b1c6
- (void)dealloc;	// IMP=0x000000000008b175
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000008b16a
