...
+ (id)sharedManager;	// IMP=0x00400000000c6535
- (void).cxx_destruct;	// IMP=0x00200000000c6a4c
...
- (_Bool)isRecordEqualToMostRecentInviteShare:(id)arg1;	// IMP=0x00100000000c6787
- (id)init;	// IMP=0x00100000000c66d3
