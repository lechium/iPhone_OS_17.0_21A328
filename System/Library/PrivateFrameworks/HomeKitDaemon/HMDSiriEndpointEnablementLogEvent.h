...
+ (id)logCategory;	// IMP=0x0010000000d31af8
...
- (id)submitEventWithHistogrammedHomeDataCommonDimensionsForSpecifiedHome;	// IMP=0x0000000000d31ac4
@property(readonly, nonatomic) unsigned long long coreAnalyticsEventOptions;
@property(readonly, copy, nonatomic) NSDictionary *coreAnalyticsEventDictionary;
@property(readonly, copy, nonatomic) NSString *coreAnalyticsEventName;
- (id)serializedMetric;	// IMP=0x0000000000d31854
- (id)initWithDictionary:(id)arg1;	// IMP=0x0000000000d31665
- (id)initWithHomeUUID:(id)arg1 numCapableSiriEndpoints:(unsigned long long)arg2 numEnabledSiriEndpoints:(unsigned long long)arg3;	// IMP=0x0000000000d3160f
- (id)initWithConfigurationDataSource:(id)arg1;	// IMP=0x0000000000d312bd
