...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000000b41a
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000000b7d8
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000000b422
- (void)dealloc;	// IMP=0x000000000000b3b6
- (id)initForRequest:(id)arg1;	// IMP=0x000000000000b307
