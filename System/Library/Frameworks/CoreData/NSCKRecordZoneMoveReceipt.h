...
+ (id)countMoveReceiptsInStore:(id)arg1 matchingPredicate:(id)arg2 withManagedObjectContext:(id)arg3 error:(id *)arg4;	// IMP=0x004000000014d47b
+ (id)moveReceiptsMatchingRecordIDs:(id)arg1 inManagedObjectContext:(id)arg2 persistentStore:(id)arg3 error:(id *)arg4;	// IMP=0x004000000014cd39
+ (id)entityPath;	// IMP=0x004000000014cc28
- (id)createRecordIDForMovedRecord;	// IMP=0x000000000014cc91
