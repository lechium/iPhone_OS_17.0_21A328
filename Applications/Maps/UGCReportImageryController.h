...
- (void).cxx_destruct;	// IMP=0x0020000000787114
- (void)cancelPresentation;	// IMP=0x00100000007870bb
- (void)fetchLayoutAndPresentWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0010000000786bfc
- (id)initWithMapItem:(id)arg1 reportedPhoto:(id)arg2 presentingViewController:(id)arg3;	// IMP=0x0010000000786a88
