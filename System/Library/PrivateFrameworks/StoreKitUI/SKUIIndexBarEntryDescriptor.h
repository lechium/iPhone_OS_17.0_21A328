...
+ (id)placeholderEntryDescriptorWithSize:(struct CGSize)arg1;	// IMP=0x0060000000074652
+ (id)entryDescriptorWithImage:(id)arg1;	// IMP=0x00600000000745a6
+ (id)entryDescriptorWithAttributedString:(id)arg1;	// IMP=0x00600000000744fa
+ (id)entryDescriptorWithArtwork:(id)arg1;	// IMP=0x006000000007444e
- (void).cxx_destruct;	// IMP=0x00000000000749bf
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000007431d
- (unsigned long long)hash;	// IMP=0x0000000000074216
