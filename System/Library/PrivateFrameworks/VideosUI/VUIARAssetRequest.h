...
- (void).cxx_destruct;	// IMP=0x00000000001656cc
...
- (id)_prefixForString:(id)arg1;	// IMP=0x0000000000165551
- (void)recordLog:(id)arg1;	// IMP=0x00000000001653c4
- (id)cacheDownloadedFileFromLocation:(id)arg1;	// IMP=0x00000000001651e2
- (id)cachePath;	// IMP=0x0000000000165171
- (void)cancelDownload;	// IMP=0x0000000000165122
- (void)startDownloadWithSession:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000000016507a
- (id)initWithRemoteURL:(id)arg1 shareURL:(id)arg2 fileName:(id)arg3;	// IMP=0x0000000000164f0b
