...
- (void).cxx_destruct;	// IMP=0x0000000000083902
...
- (void)computeOnCPUWithInputTensors:(id)arg1 outputTensors:(id)arg2;	// IMP=0x0000000000082f67
- (_Bool)hasGPUSupport;	// IMP=0x0000000000082f5f
- (id)initWithParameters:(id)arg1;	// IMP=0x0000000000082d16
- (id)setupForInputShapes:(id)arg1 withParameters:(id)arg2;	// IMP=0x0000000000082a13
