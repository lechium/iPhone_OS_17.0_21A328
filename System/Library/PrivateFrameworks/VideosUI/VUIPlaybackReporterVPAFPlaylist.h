...
- (void).cxx_destruct;	// IMP=0x000000000024dd27
...
- (id)itemsBetweenStartOverallPosition:(unsigned long long)arg1 endOverallPosition:(unsigned long long)arg2;	// IMP=0x000000000024dabd
- (id)itemAtOverallPosition:(unsigned long long)arg1 rangeOptions:(long long)arg2;	// IMP=0x000000000024d8ea
- (id)initWithPlayer:(id)arg1;	// IMP=0x000000000024c902
