...
+ (id)notificationFromRemoteNotificationDictionary:(id)arg1;	// IMP=0x00600000000c2511
+ (Class)__class;	// IMP=0x00600000000c24c1
- (void).cxx_destruct;	// IMP=0x00000000000c257e
