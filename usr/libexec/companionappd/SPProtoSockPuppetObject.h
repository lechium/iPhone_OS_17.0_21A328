...
- (void).cxx_destruct;	// IMP=0x002000000000657b
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000006289
- (unsigned long long)hash;	// IMP=0x0010000000005f36
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000005cab
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000005ab2
- (void)copyTo:(id)arg1;	// IMP=0x0010000000005910
- (void)writeTo:(id)arg1;	// IMP=0x001000000000574d
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000005740
- (id)dictionaryRepresentation;	// IMP=0x0010000000004c7b
- (id)description;	// IMP=0x0010000000004bcc
