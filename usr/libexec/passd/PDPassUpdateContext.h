...
+ (_Bool)supportsSecureCoding;	// IMP=0x0020000000295f61
- (void).cxx_destruct;	// IMP=0x00200000002964cc
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000296127
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000295f69
