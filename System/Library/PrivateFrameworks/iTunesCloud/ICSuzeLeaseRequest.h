...
- (void)performWithResponseHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000000012f7b6
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000012f6ec
- (id)initWithRequestContext:(id)arg1 requestType:(long long)arg2 leaseID:(id)arg3 mediaType:(long long)arg4 clientData:(id)arg5;	// IMP=0x000000000012f5df
