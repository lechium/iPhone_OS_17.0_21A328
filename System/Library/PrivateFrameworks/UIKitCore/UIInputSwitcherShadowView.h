...
- (void).cxx_destruct;	// IMP=0x0000000000af36a4
...
- (void)drawRect:(struct CGRect)arg1;	// IMP=0x0000000000af2915
- (void)layoutSubviews;	// IMP=0x0000000000af2788
- (void)setFrame:(struct CGRect)arg1;	// IMP=0x0000000000af268f
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000af23c1
