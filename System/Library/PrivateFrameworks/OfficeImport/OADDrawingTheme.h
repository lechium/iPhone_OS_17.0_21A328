...
- (void).cxx_destruct;	// IMP=0x00000000003464f5
...
- (id)description;	// IMP=0x000000000034637f
...
- (unsigned long long)hash;	// IMP=0x00000000003462ce
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000346213
- (void)applyThemeOverrides:(id)arg1 colorMapOverride:(id)arg2;	// IMP=0x00000000003460ee
- (id)initWithTheme:(id)arg1 colorMap:(id)arg2 colorPalette:(id)arg3;	// IMP=0x0000000000345ee3
- (id)initWithStyleMatrix:(id)arg1 fontScheme:(id)arg2 colorScheme:(id)arg3 colorMap:(id)arg4 colorPalette:(id)arg5;	// IMP=0x0000000000345d8f
