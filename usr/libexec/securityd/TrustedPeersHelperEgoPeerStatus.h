...
+ (_Bool)supportsSecureCoding;	// IMP=0x00200000002035ff
- (void).cxx_destruct;	// IMP=0x00200000002035c1
// Error: Property attributes should begin with the type ('T') attribute, property name: isLocked
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000203362
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000202f7b
- (id)description;	// IMP=0x0010000000202ee8
- (id)initWithEgoPeerID:(id)arg1 egoPeerMachineID:(id)arg2 status:(unsigned long long)arg3 viablePeerCountsByModelID:(id)arg4 peerCountsByMachineID:(id)arg5 isExcluded:(_Bool)arg6 isLocked:(_Bool)arg7;	// IMP=0x0010000000202c82
