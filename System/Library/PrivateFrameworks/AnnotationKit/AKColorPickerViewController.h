...
- (void).cxx_destruct;	// IMP=0x00000000000052bc
...
- (void)syncTextAttributesToUI:(id)arg1;	// IMP=0x000000000000520c
- (id)convertTextAttributes:(id)arg1;	// IMP=0x00000000000050cb
- (void)valueChanged:(id)arg1;	// IMP=0x0000000000004f37
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x0000000000004ea4
- (void)viewDidLoad;	// IMP=0x0000000000004c1d
- (id)initWithController:(id)arg1;	// IMP=0x0000000000004b8c
