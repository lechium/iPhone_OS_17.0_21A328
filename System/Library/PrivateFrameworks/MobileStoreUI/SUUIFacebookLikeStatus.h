...
- (void).cxx_destruct;	// IMP=0x00000000000791d4
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000790f8
- (id)initWithURL:(id)arg1 likeStatusDictionary:(id)arg2;	// IMP=0x0000000000078de5
