...
+ (_Bool)shouldAssertWiFi;	// IMP=0x0020000000001f0b
- (void).cxx_destruct;	// IMP=0x0020000000002584
...
- (void)cancel;	// IMP=0x0010000000002372
- (void)load;	// IMP=0x0010000000002140
- (void)dealloc;	// IMP=0x0010000000002111
- (id)initWithURLRequest:(id)arg1 completionBlock:(CDUnknownBlockType)arg2;	// IMP=0x0010000000001f13
