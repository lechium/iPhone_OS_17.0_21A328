...
- (void).cxx_destruct;	// IMP=0x0000000000196ee3
...
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x0000000000196a97
- (void)layoutSubviews;	// IMP=0x00000000001966f9
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000001965fb
