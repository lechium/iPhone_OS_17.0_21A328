...
- (void).cxx_destruct;	// IMP=0x000000000017b56a
...
- (void)verifyFutureProgressIsNotFinished;	// IMP=0x000000000017b452
- (void)copyProgressInfoToProgress:(id)arg1 options:(BOOL)arg2;	// IMP=0x000000000017b372
- (void)updateLocalizedDescriptionWithOptions:(BOOL)arg1;	// IMP=0x000000000030d1ef
- (void)updateUnitCount;	// IMP=0x000000000017ad7e
- (id)description;	// IMP=0x000000000017aa27
- (id)init;	// IMP=0x000000000017a90c
