...
- (void).cxx_destruct;	// IMP=0x0000000000cc5450
- (unsigned long long)hash;	// IMP=0x0000000000cc5362
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000cc51bb
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000cc4f41
- (void)writeTo:(id)arg1;	// IMP=0x0000000000cc4c96
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000cc4c87
- (id)jsonRepresentation;	// IMP=0x0000000000cc3fcc
- (id)dictionaryRepresentation;	// IMP=0x0000000000cc3b1b
- (id)description;	// IMP=0x0000000000cc3a6c
- (void)dealloc;	// IMP=0x0000000000cc26cb
- (id)initWithData:(id)arg1;	// IMP=0x0000000000cc266f
- (id)init;	// IMP=0x0000000000cc2613
