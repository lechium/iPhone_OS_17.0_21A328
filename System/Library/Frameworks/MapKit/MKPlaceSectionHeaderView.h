...
- (void)setTarget:(id)arg1 action:(SEL)arg2;	// IMP=0x0000000000006357
@property(retain, nonatomic) UIImage *icon;
@property(retain, nonatomic) NSString *seeMoreButtonText; // @synthesize seeMoreButtonText=_seeMoreButtonText;
- (void)updateConstraints;	// IMP=0x0000000000005e27
- (void)updateContent;	// IMP=0x0000000000005d87
- (void)createConstraints;	// IMP=0x0000000000004e9a
- (_Bool)shouldStack;	// IMP=0x0000000000004b16
- (void)_updateConstraints;	// IMP=0x0000000000004760
- (void)contentSizeDidChange;	// IMP=0x000000000000474f
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000004484
