...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000004a9456
- (void).cxx_destruct;	// IMP=0x00000000004a93d0
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000004a91b5
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000004a9057
