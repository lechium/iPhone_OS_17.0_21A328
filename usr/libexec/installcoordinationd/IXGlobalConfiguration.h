...
+ (id)sharedInstance;	// IMP=0x0040000000007cac
- (void).cxx_destruct;	// IMP=0x0020000000008dbf
...
- (id)extractedInstallableStagingDirectory:(id *)arg1;	// IMP=0x0010000000008b76
- (id)remoteInstallationStagingDirectory:(id *)arg1;	// IMP=0x0010000000008b11
- (id)removabilityDirectoryAbortingOnError;	// IMP=0x0010000000008a6b
- (id)removabilityDirectoryWithError:(id *)arg1;	// IMP=0x0010000000008a06
- (id)promiseStagingRootDirectoryAbortingOnError;	// IMP=0x0010000000008960
- (id)promiseStagingRootDirectoryWithError:(id *)arg1;	// IMP=0x00100000000088fb
- (id)dataDirectoryAbortingOnError;	// IMP=0x0010000000008855
- (id)dataDirectoryWithError:(id *)arg1;	// IMP=0x00100000000087f0
- (id)_dataStorageHomeURLWithError:(id *)arg1;	// IMP=0x0010000000008687
- (void)createDirectories;	// IMP=0x0010000000007e29
- (id)init;	// IMP=0x0010000000007d39
