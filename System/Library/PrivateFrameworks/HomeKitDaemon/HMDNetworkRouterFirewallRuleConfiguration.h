...
+ (id)__decodeRulesFromNetworkDeclarations:(id)arg1 key:(id)arg2 class:(Class)arg3 required:(_Bool)arg4;	// IMP=0x0010000000c9127a
+ (_Bool)__decodeFullAccessFromNetworkDeclarations:(id)arg1 key:(id)arg2 fullAccess:(_Bool *)arg3;	// IMP=0x0010000000c910e1
+ (_Bool)__decodeNetworkDeclarationsFromJSONDictionary:(id)arg1 networkDeclarations:(id *)arg2;	// IMP=0x0010000000c90ee1
+ (id)logCategory;	// IMP=0x0010000000c90eb1
- (void).cxx_destruct;	// IMP=0x0000000000c90e34
...
- (id)attributeDescriptions;	// IMP=0x0000000000c904f8
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000c90121
- (id)initWithAccessoryIdentifier:(id)arg1 jsonDictionary:(id)arg2;	// IMP=0x0000000000c8fdb1
- (id)initWithAccessoryIdentifier:(id)arg1 lastModifiedTime:(id)arg2 fullAccessLAN:(_Bool)arg3 lanRules:(id)arg4 fullAccessWAN:(_Bool)arg5 wanRules:(id)arg6;	// IMP=0x0000000000c8fc8c
