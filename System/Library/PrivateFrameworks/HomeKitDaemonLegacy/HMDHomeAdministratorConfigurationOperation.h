...
+ (id)logCategory;	// IMP=0x0010000000741785
+ (double)timeout;	// IMP=0x00100000007416a7
- (void).cxx_destruct;	// IMP=0x0000000000741246
...
- (id)logIdentifier;	// IMP=0x0000000000741117
- (void)main;	// IMP=0x0000000000740cb4
- (id)initWithMessage:(id)arg1 home:(id)arg2 dispatcher:(id)arg3;	// IMP=0x0000000000740b70
