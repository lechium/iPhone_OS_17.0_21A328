...
- (void).cxx_destruct;	// IMP=0x000000000002d241
...
- (void)rotateByAngle:(float)arg1;	// IMP=0x000000000002cf35
- (double)normalizeAngle:(double)arg1;	// IMP=0x000000000002ced6
- (id)initWithNode:(id)arg1;	// IMP=0x000000000002cdfd
