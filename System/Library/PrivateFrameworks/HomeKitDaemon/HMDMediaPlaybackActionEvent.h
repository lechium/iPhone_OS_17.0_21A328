...
- (void).cxx_destruct;	// IMP=0x00000000007864e9
...
- (id)initWithIsPlaybackArchivePresent:(_Bool)arg1 playbackStateNumber:(id)arg2 volumeNumber:(id)arg3 sourceNumber:(id)arg4 sourceClientName:(id)arg5 accessories:(id)arg6;	// IMP=0x0000000000785d99
- (id)biomeEventsRepresentationForLogObserver:(id)arg1;	// IMP=0x0000000000021957
- (unsigned long long)microLocationScanTriggerTypeForLogEventObserver:(id)arg1;	// IMP=0x0000000000055232
- (_Bool)shouldTriggerMicroLocationRecordingScanForLogEventObserver:(id)arg1;	// IMP=0x00000000000551a7
- (_Bool)shouldTriggerMicroLocationLocalizationScanForLogEventObserver:(id)arg1;	// IMP=0x000000000005511c
- (id)microLocationMetadataForLogEventObserver:(id)arg1;	// IMP=0x0000000000054ea9
