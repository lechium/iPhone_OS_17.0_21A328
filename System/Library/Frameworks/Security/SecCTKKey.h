...
+ (id)fromKeyRef:(struct __SecKey *)arg1;	// IMP=0x00100000000a8599
- (void).cxx_destruct;	// IMP=0x00000000000a840e
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000a808e
- (id)performOperation:(long long)arg1 data:(id)arg2 algorithms:(id)arg3 parameters:(id)arg4 error:(id *)arg5;	// IMP=0x00000000000a7ed1
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000a7ea3
- (id)initFromKey:(id)arg1;	// IMP=0x00000000000a7dd8
- (id)initWithAttributes:(id)arg1 error:(id *)arg2;	// IMP=0x00000000000a7576
