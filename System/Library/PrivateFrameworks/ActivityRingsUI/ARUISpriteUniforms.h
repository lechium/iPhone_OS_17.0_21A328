...
- (void)_updateUniformsWithSprite:(id)arg1;	// IMP=0x000000000000f452
- (void)_updateVertexAttributesWithSprite:(id)arg1 inContet:(id)arg2;	// IMP=0x000000000000f163
- (void *)uniformsBytes;	// IMP=0x000000000000f159
- (void *)vertexAttributesBytes;	// IMP=0x000000000000f14f
- (id)initWithSprite:(id)arg1 inContext:(id)arg2;	// IMP=0x000000000000f0ae
