...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000009fb365
- (unsigned long long)hash;	// IMP=0x00100000009fb265
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000009fb102
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000009fafde
- (void)copyTo:(id)arg1;	// IMP=0x00100000009faefa
- (void)writeTo:(id)arg1;	// IMP=0x00100000009fadf1
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000009fade4
- (id)dictionaryRepresentation;	// IMP=0x00100000009fa6e2
- (id)description;	// IMP=0x00100000009fa66b
...
- (void)dealloc;	// IMP=0x00100000009fa45c
