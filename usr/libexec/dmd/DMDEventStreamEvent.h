...
- (void).cxx_destruct;	// IMP=0x0020000000051f8e
...
- (id)eventStatusMessageWithPayloadIdentifier:(id)arg1;	// IMP=0x0010000000051e46
- (id)description;	// IMP=0x0010000000051da9
- (id)initWithEventType:(id)arg1 details:(id)arg2;	// IMP=0x0010000000051cd9
