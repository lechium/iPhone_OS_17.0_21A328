...
+ (id)reuseIdentifier;	// IMP=0x0060000000ae8b8b
...
- (void)_updateRoundedCorners;	// IMP=0x0000000000ae8ee6
- (void)updateSelectionWithPoint:(struct CGPoint)arg1;	// IMP=0x0000000000ae8ee0
- (void)setSelected:(_Bool)arg1 animated:(_Bool)arg2;	// IMP=0x0000000000ae8e36
- (void)layoutSubviews;	// IMP=0x0000000000ae8c1c
- (id)initWithStyle:(long long)arg1 reuseIdentifier:(id)arg2;	// IMP=0x0000000000ae8b95
