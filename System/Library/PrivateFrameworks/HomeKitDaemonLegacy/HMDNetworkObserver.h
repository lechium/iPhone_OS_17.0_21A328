...
+ (id)supportedEventClasses;	// IMP=0x0010000000bb7fbe
- (void).cxx_destruct;	// IMP=0x0000000000bb7bd0
...
- (void)timerDidFire:(id)arg1;	// IMP=0x0000000000bb79fd
- (void)checkNetworkChange;	// IMP=0x0000000000bb7532
- (void)deleteCountersAfterDate:(id)arg1;	// IMP=0x0000000000bb7477
- (void)deleteCountersBeforeDate:(id)arg1;	// IMP=0x0000000000bb73bc
- (id)logEventForHomeWithUUID:(id)arg1 associatedWithDate:(id)arg2;	// IMP=0x0000000000bb6e70
- (void)runDailyTask;	// IMP=0x0000000000bb6960
- (void)didReceiveEventFromDispatcher:(id)arg1;	// IMP=0x0000000000bb6897
- (void)_handleAccessorySessionEvent:(id)arg1;	// IMP=0x0000000000bb6698
- (void)_handleReadWriteLogEvent:(id)arg1;	// IMP=0x0000000000bb641c
- (void)_clearNonPersistentCounters;	// IMP=0x0000000000bb6359
- (id)_keyOfLargestCountInHistogram:(id)arg1;	// IMP=0x0000000000bb6223
- (void)_incrementError:(id)arg1 forHistogram:(id)arg2 byValue:(unsigned long long)arg3;	// IMP=0x0000000000bb6143
- (void)_handleCurrentNetworkChangedNotification:(id)arg1;	// IMP=0x0000000000bb5f8e
- (id)counterGroupForName:(id)arg1 homeUUID:(id)arg2 date:(id)arg3;	// IMP=0x0000000000bb5ea7
- (void)stop;	// IMP=0x0000000000bb5d28
- (void)start;	// IMP=0x0000000000bb5afc
- (id)initWithLogEventDispatcher:(id)arg1 countersManager:(id)arg2 dailyScheduler:(id)arg3 currentHomeDataSource:(id)arg4 dateProvider:(id)arg5 wifiManager:(id)arg6 notificationCenter:(id)arg7 changeDebounceTimer:(id)arg8 tickBlock:(CDUnknownBlockType)arg9;	// IMP=0x0000000000bb5904
- (id)initWithLogEventDispatcher:(id)arg1 countersManager:(id)arg2 dailyScheduler:(id)arg3 currentHomeDataSource:(id)arg4 dateProvider:(id)arg5;	// IMP=0x0000000000bb579c
