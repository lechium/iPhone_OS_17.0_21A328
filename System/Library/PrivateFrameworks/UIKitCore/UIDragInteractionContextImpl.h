...
- (void).cxx_destruct;	// IMP=0x00000000006f26eb
...
- (void)addCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00000000006f250f
- (void)_api_addCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00000000006f24fd
- (void)addAnimations:(CDUnknownBlockType)arg1;	// IMP=0x00000000006f240c
