...
- (void).cxx_destruct;	// IMP=0x0000000000476ff1
...
- (_Bool)isNOOP;	// IMP=0x0000000000476f47
- (id)description;	// IMP=0x0000000000476e17
- (void)commitTargetIndexPath;	// IMP=0x0000000000476de0
- (id)expectedCellIndexPath;	// IMP=0x0000000000476cd9
- (id)initWithCell:(id)arg1 indexPath:(id)arg2;	// IMP=0x0000000000476c43
