...
- (void).cxx_destruct;	// IMP=0x000000000070f8a1
...
- (void)_tick:(id)arg1;	// IMP=0x000000000070f758
- (void)setupDisplayLink;	// IMP=0x000000000070f5f8
- (void)interactionDidFinish:(id)arg1;	// IMP=0x000000000070f5bb
- (_Bool)shouldAllowInteraction:(id)arg1 withContext:(id)arg2;	// IMP=0x000000000070f556
