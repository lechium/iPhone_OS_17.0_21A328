...
- (void).cxx_destruct;	// IMP=0x002000000003c8d6
...
- (void)setOTREncryptionBlock:(CDUnknownBlockType)arg1 decryptionBlock:(CDUnknownBlockType)arg2;	// IMP=0x001000000003c613
- (void)setNotifyWhenConnectionReceivesBytes:(_Bool)arg1;	// IMP=0x001000000003c5df
- (void)_endSession;	// IMP=0x001000000003c3b9
- (_Bool)sendDataMessage:(id)arg1 canFragment:(_Bool)arg2;	// IMP=0x001000000003c086
- (_Bool)sendDataMessage:(id)arg1;	// IMP=0x001000000003c072
- (void)_sendToConnectedSocket;	// IMP=0x001000000003b829
- (_Bool)_queueNextOutgoingData;	// IMP=0x001000000003ac4c
- (void)_processBytesAvailable;	// IMP=0x001000000003a0c1
- (_Bool)_processIncomingMessage:(id)arg1;	// IMP=0x00100000000397d6
- (void)processStoredIncomingMessage:(id)arg1;	// IMP=0x0010000000039576
- (void)removePendingMessagesForProtectionClass:(unsigned int)arg1;	// IMP=0x0010000000039077
- (long long)_read:(char *)arg1 maxLength:(unsigned long long)arg2;	// IMP=0x0010000000038df9
- (void)_callDelegateWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x0010000000038d09
...
- (void)endSession;	// IMP=0x00100000000386cd
- (void)dealloc;	// IMP=0x0010000000038644
- (void)start;	// IMP=0x001000000003850a
- (id)initWithSocket:(int)arg1 queue:(id)arg2 delegate:(id)arg3 priority:(long long)arg4 connectionID:(id)arg5 linkType:(unsigned long long)arg6;	// IMP=0x001000000003819e
