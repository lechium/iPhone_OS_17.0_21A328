...
- (id)makeChildRules;	// IMP=0x00000000000035c8
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000003540
@property(readonly) unsigned long long hash;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000034ef
- (void)dealloc;	// IMP=0x00000000000034a5
