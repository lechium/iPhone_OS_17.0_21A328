...
- (void).cxx_destruct;	// IMP=0x0020000000bdac76
...
- (CDStruct_0af47fae)cornerMaskForCarCardLayout:(CDStruct_de0926f2)arg1;	// IMP=0x0010000000bdaa81
- (id)backgroundViewForCarCardLayout:(CDStruct_de0926f2)arg1 scale:(double)arg2 userInterfaceStyle:(long long)arg3;	// IMP=0x0010000000bdaa79
- (void)locationManagerApprovalDidChange:(id)arg1;	// IMP=0x0010000000bda9d1
- (void)_buttonTapped:(id)arg1;	// IMP=0x0010000000bda985
- (void)viewDidLoad;	// IMP=0x0010000000bda54e
- (id)initWithDelegate:(id)arg1;	// IMP=0x0010000000bda3f7
