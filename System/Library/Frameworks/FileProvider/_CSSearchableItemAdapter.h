...
+ (id)fp_queryFetchAttributes;	// IMP=0x00100000000bd91f
- (void).cxx_destruct;	// IMP=0x00000000000bf89a
...
- (id)fp_appContainerBundleIdentifier;	// IMP=0x00000000000bf6f8
- (id)sharingCurrentUserPermissions;	// IMP=0x00000000000bf6a1
@property(readonly, nonatomic, getter=isMostRecentVersionDownloaded) _Bool mostRecentVersionDownloaded;
- (_Bool)isRecursivelyDownloaded;	// IMP=0x00000000000bf5b7
...
- (id)formerIdentifier;	// IMP=0x00000000000bf1f2
@property(readonly, copy) NSString *fp_parentDomainIdentifier;
- (_Bool)isInPinnedFolder;	// IMP=0x00000000000bf126
- (_Bool)isPinned;	// IMP=0x00000000000bf0b1
- (id)collaborationIdentifier;	// IMP=0x00000000000bf05a
...
- (id)tags;	// IMP=0x00000000000be403
...
- (id)containerSubitemCount;	// IMP=0x00000000000be001
- (id)sharingCurrentUserRole;	// IMP=0x00000000000bdfb1
...
- (id)initWithSearchableItem:(id)arg1;	// IMP=0x00000000000bd89e
