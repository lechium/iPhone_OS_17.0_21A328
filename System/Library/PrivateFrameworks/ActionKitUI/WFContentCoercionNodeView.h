...
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x0000000000060b76
- (void)updateColors;	// IMP=0x0000000000060ae8
- (void)layoutSubviews;	// IMP=0x000000000006087a
- (id)initWithFrame:(struct CGRect)arg1 isRootNode:(_Bool)arg2;	// IMP=0x00000000000604f9
