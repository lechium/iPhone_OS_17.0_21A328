...
- (void).cxx_destruct;	// IMP=0x00000000000de526
...
- (_Bool)contactViewController:(id)arg1 shouldPerformDefaultActionForContact:(id)arg2 propertyKey:(id)arg3 labeledValue:(id)arg4;	// IMP=0x00000000000de48a
- (void)contactPicker:(id)arg1 didSelectContact:(id)arg2;	// IMP=0x00000000000de2ad
- (void)contactPickerDidCancel:(id)arg1;	// IMP=0x00000000000de202
- (void)peoplePickerLinkButtonTapped;	// IMP=0x00000000000de129
- (void)performActionWithSender:(id)arg1;	// IMP=0x00000000000ddd58
