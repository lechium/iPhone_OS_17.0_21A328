...
- (id)makeChildRules;	// IMP=0x0000000000003978
@property(readonly, copy) NSString *identifier;
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000038e8
@property(readonly) unsigned long long hash;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000003897
- (void)dealloc;	// IMP=0x000000000000384d
