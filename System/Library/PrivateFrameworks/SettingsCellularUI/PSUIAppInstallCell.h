...
@interface PSUIAppInstallCell : PSTableCell
{
    ...
    UIButton *_installButton;	// 200 = 0xc8
...
+ (id)specifierForAppWithDescription:(id)arg1 target:(id)arg2 action:(SEL)arg3;	// IMP=0x0060000000019310
- (void).cxx_destruct;	// IMP=0x000000000001ae8b
...
- (id)getLogger;	// IMP=0x000000000001ac7a
- (void)_updateCellWithInstallState;	// IMP=0x000000000001aa94
- (void)layoutSubviews;	// IMP=0x000000000001a8d3
- (void)updateConstraints;	// IMP=0x000000000001a724
- (id)initWithStyle:(long long)arg1 reuseIdentifier:(id)arg2 specifier:(id)arg3;	// IMP=0x0000000000019535
