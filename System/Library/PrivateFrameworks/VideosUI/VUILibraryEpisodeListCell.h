...
+ (id)_metadataLabelWithString:(id)arg1 existingLabel:(id)arg2;	// IMP=0x006000000006684d
+ (void)configureVUILibraryEpisodeListCell:(id)arg1 withMedia:(id)arg2 andAssetController:(id)arg3;	// IMP=0x0060000000064027
- (void).cxx_destruct;	// IMP=0x0000000000066abd
...
- (_Bool)_contentSizeCategoryIsAccessibility;	// IMP=0x0000000000066809
- (double)_metadataHeightToBaselineNonAXContentSizeCategory;	// IMP=0x00000000000667cf
- (double)_metadataScaledTopMarginForNonAXContentSizeCategory;	// IMP=0x000000000006674d
- (void)_configureDotSeparator;	// IMP=0x00000000000665e8
- (void)_addDownloadButtonIfRequired:(id)arg1;	// IMP=0x00000000000664ad
- (void)layoutSubviews;	// IMP=0x000000000006501e
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x0000000000064609
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000000643bf
