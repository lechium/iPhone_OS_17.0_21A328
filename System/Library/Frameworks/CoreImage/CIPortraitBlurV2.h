...
+ (id)customAttributes;	// IMP=0x006000000015bd28
...
- (id)outputImage;	// IMP=0x000000000015c235
- (double)effectiveScale;	// IMP=0x000000000015c1a0
- (id)sensorSize;	// IMP=0x000000000015c07a
