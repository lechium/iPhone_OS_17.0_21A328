...
- (void).cxx_destruct;	// IMP=0x00000000000063c2
- (id)featureAvailabilityExtensionForFeatureIdentifier:(id)arg1;	// IMP=0x0000000000006337
- (id)initWithProfile:(id)arg1;	// IMP=0x0000000000005d9a
