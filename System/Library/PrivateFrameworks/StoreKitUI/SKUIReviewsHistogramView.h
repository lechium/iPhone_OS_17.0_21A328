...
- (void).cxx_destruct;	// IMP=0x0000000000217cd2
...
- (id)_countLabelString;	// IMP=0x000000000021798c
- (id)_histogramImageForValues:(id)arg1;	// IMP=0x0000000000216fb1
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x0000000000216e50
- (void)setBackgroundColor:(id)arg1;	// IMP=0x0000000000216d9a
- (void)layoutSubviews;	// IMP=0x00000000002163b8
...
- (id)initWithClientContext:(id)arg1;	// IMP=0x0000000000214c8a
