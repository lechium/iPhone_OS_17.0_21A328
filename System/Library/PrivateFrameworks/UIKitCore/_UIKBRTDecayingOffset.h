...
- (void)updateOffsetTo:(struct CGPoint)arg1;	// IMP=0x0000000000e05fbd
- (void)reset;	// IMP=0x0000000000e05f77
- (id)initWithTimeoutDuration:(double)arg1 limitMovement:(_Bool)arg2;	// IMP=0x0000000000e05f35
