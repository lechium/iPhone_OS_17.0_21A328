...
- (void).cxx_destruct;	// IMP=0x0000000000340231
- (unsigned long long)hash;	// IMP=0x000000000033fdb6
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000033fae7
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000033f693
- (void)writeTo:(id)arg1;	// IMP=0x000000000033f1b6
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000033f1a7
- (id)jsonRepresentation;	// IMP=0x000000000033ef29
- (id)dictionaryRepresentation;	// IMP=0x000000000033e5f4
- (id)description;	// IMP=0x000000000033e545
- (void)dealloc;	// IMP=0x000000000033d148
- (id)initWithData:(id)arg1;	// IMP=0x000000000033d0ec
- (id)init;	// IMP=0x000000000033d090
