...
+ (struct _NSRange)highlightedLaneRangeForLanes:(id)arg1;	// IMP=0x0040000000012f80
+ (id)_createFakeLanes;	// IMP=0x00100000000125fb
+ (id)fakeInfoForManeuver:(_Bool)arg1;	// IMP=0x00100000000124c9
- (void).cxx_destruct;	// IMP=0x00200000000132c8
...
- (id)highlightedLanes;	// IMP=0x0010000000013262
@property(readonly, nonatomic) struct _NSRange highlightedLaneRange;
@property(readonly, nonatomic) _Bool isForMidStep;
- (id)description;	// IMP=0x0010000000012dd1
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000012d03
- (id)initWithLaneInfoId:(id)arg1 lanes:(id)arg2 forManeuver:(_Bool)arg3 midStepTitles:(id)arg4 details:(id)arg5;	// IMP=0x0010000000012bed
- (id)initWithLaneInfoId:(id)arg1 lanes:(id)arg2;	// IMP=0x0010000000012bc1
- (id)initWithGuidanceLaneInfo:(id)arg1;	// IMP=0x0010000000012712
