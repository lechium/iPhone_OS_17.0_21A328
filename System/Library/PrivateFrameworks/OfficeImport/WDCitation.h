...
+ (id)stringValuesForNodesAtPath:(id)arg1 nodePtr:(struct _xmlNode *)arg2 trimStyle:(_Bool)arg3;	// IMP=0x0060000000416879
+ (id)stringValueForNodeAtPath:(id)arg1 nodePtr:(struct _xmlNode *)arg2 trimStyle:(_Bool)arg3;	// IMP=0x00600000004167bc
+ (id)subStringOf:(struct _xmlNode *)arg1 forPath:(id)arg2;	// IMP=0x00600000004166ff
+ (struct _xmlNode *)trimStyle:(struct _xmlNode *)arg1;	// IMP=0x00600000004166cd
+ (struct _xmlNode *)nodeAtPath:(id)arg1 nodePtr:(struct _xmlNode *)arg2;	// IMP=0x0060000000416534
+ (id)wordStringForRefType:(int)arg1;	// IMP=0x00600000004162f2
+ (int)refTypeForWordString:(id)arg1;	// IMP=0x0060000000416266
+ (id)endNoteStringForRefType:(int)arg1;	// IMP=0x00600000004161f3
+ (id)refTypeEnumMap;	// IMP=0x0060000000416049
+ (id)wordRefTypeEnumMap;	// IMP=0x0060000000415f95
- (void).cxx_destruct;	// IMP=0x0000000000416beb
...
- (id)description;	// IMP=0x0000000000416a6e
- (id)initWithDocument:(id)arg1;	// IMP=0x00000000004160fd
