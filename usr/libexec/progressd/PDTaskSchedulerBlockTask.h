...
- (void).cxx_destruct;	// IMP=0x002000000006b95e
...
- (void)run;	// IMP=0x001000000006b5c5
- (void)clampToPredefinedTimePeriod:(unsigned long long)arg1;	// IMP=0x001000000006b4a1
- (id)initWithIdentifier:(id)arg1 queue:(id)arg2 block:(CDUnknownBlockType)arg3;	// IMP=0x001000000006b383
