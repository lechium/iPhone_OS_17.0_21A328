...
- (void).cxx_destruct;	// IMP=0x0000000000299874
...
- (id)_dataSourceForShelves;	// IMP=0x0000000000299591
- (void)dataSourceDidFinishFetching:(id)arg1;	// IMP=0x00000000002993c3
- (void)startFetch;	// IMP=0x0000000000299351
- (void)dealloc;	// IMP=0x0000000000299308
- (id)initWithValidShelfTypes:(id)arg1 withFamilyMember:(id)arg2;	// IMP=0x0000000000299290
