...
+ (unsigned long long)aspectRatioOfResolution:(id)arg1;	// IMP=0x00100000004c4b40
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000004c4b38
+ (void)translateCapabilities:(id)arg1;	// IMP=0x00100000004c4421
- (void).cxx_destruct;	// IMP=0x00000000004c41b5
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000004c3fc0
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000004c3cb6
- (void)updateWithRemoteSettings:(id)arg1;	// IMP=0x00000000004c39a2
- (void)_updateWithStreamPreference:(id)arg1;	// IMP=0x00000000004c325c
- (id)_supportedResolutionsWithOverrides;	// IMP=0x00000000004c2d8f
- (id)initWithStreamPreference:(id)arg1;	// IMP=0x00000000004c2ac3
- (id)description;	// IMP=0x00000000004c2995
