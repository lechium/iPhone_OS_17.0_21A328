...
@protocol SRCompactViewControllerDelegate <NSObject>
...
- (void)endSiriSessionForViewController:(SRCompactViewController *)arg1 withDismissalReason:(long long)arg2;
- (void)viewController:(SRCompactViewController *)arg1 reduceOrbOpacity:(_Bool)arg2;
