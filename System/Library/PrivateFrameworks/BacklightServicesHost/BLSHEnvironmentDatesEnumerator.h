...
+ (id)createWithInitialSpecifier:(id)arg1 enumerator:(id)arg2 dateInterval:(id)arg3 environment:(id)arg4 sourceModel:(id)arg5;	// IMP=0x006000000002444f
- (void).cxx_destruct;	// IMP=0x00000000000247db
...
- (id)description;	// IMP=0x00000000000246c4
