...
- (id)outputImage;	// IMP=0x00000000001595c2
- (id)outputImage:(id)arg1 horizontal:(_Bool)arg2;	// IMP=0x0000000000158c22
- (id)noiseColorKernel;	// IMP=0x0000000000158c02
- (id)_noiseGeneratorKernel;	// IMP=0x0000000000158b95
- (id)_kernel:(_Bool)arg1 withAddedNoise:(_Bool)arg2;	// IMP=0x0000000000158a91
