...
- (void).cxx_destruct;	// IMP=0x00000000000874ff
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000008749e
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000087414
- (id)stateForCluster:(id)arg1;	// IMP=0x00000000000873fe
- (id)initWithSuite:(id)arg1 clusters:(id)arg2;	// IMP=0x0000000000087330
