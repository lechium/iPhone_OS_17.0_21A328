...
@class NSData, NSDictionary, NSString, WBSCloudHistoryConfiguration;

@protocol WBSCloudHistoryDataStore
@property(readonly, nonatomic) _Bool useManateeContainer;
- (void)fetchRecordsForProfileServerIdentifier:(NSString *)arg1 completion:(void (^)(WBSCloudHistoryFetchResult *, NSError *))arg2;
...
- (void)saveCloudHistoryVisits:(NSDictionary *)arg1 tombstones:(NSDictionary *)arg2 longLivedOperationPersistenceCompletion:(void (^)(NSString *))arg3 completion:(void (^)(NSError *))arg4;
