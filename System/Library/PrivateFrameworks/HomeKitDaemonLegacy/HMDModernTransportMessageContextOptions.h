...
+ (id)newWithBuilder:(CDUnknownBlockType)arg1;	// IMP=0x00600000009e991a
- (void).cxx_destruct;	// IMP=0x00000000009e98e7
...
- (id)initWithBuilder:(id)arg1;	// IMP=0x00000000009e9768
