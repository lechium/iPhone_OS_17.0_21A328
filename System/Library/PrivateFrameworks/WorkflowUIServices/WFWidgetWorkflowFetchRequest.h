...
- (void).cxx_destruct;	// IMP=0x0000000000043164
...
- (id)description;	// IMP=0x000000000004302f
- (id)initWithFetchType:(unsigned long long)arg1 identifier:(id)arg2 limit:(unsigned long long)arg3 retryCount:(unsigned long long)arg4 completionHandler:(CDUnknownBlockType)arg5;	// IMP=0x0000000000042f47
