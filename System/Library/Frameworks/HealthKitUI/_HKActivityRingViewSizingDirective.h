...
+ (id)sortedRingRatioDirectives;	// IMP=0x0060000000003025
+ (id)activityRingSizingDirectiveWithIdentifier:(id)arg1 width:(double)arg2 outerRingOffset:(double)arg3 ringThickness:(double)arg4 ringInterspacing:(double)arg5;	// IMP=0x0060000000003455
- (void).cxx_destruct;	// IMP=0x0000000000003ae5
...
- (id)description;	// IMP=0x00000000000039f8
