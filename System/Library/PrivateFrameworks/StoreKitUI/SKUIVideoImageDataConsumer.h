...
- (void).cxx_destruct;	// IMP=0x000000000000c16f
...
- (id)imageForImage:(id)arg1;	// IMP=0x000000000000bdd8
- (id)imageForColor:(id)arg1 orientation:(unsigned long long)arg2;	// IMP=0x000000000000bbce
