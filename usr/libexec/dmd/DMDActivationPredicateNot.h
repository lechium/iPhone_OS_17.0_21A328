...
- (void).cxx_destruct;	// IMP=0x002000000000fffe
...
- (id)metadata;	// IMP=0x001000000000fecb
- (id)evaluatePredicateWithError:(id *)arg1;	// IMP=0x001000000000fcf2
- (id)initWithDelegate:(id)arg1 uniqueIdentifier:(id)arg2 subPredicateObserver:(id)arg3 predicate:(id)arg4;	// IMP=0x001000000000fc68
