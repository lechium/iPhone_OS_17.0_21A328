...
- (void).cxx_destruct;	// IMP=0x00000000002290a1
...
- (id)dumpDebug;	// IMP=0x0000000000228e10
- (id)initWithGroupID:(long long)arg1 zone:(id)arg2 rootRecord:(id)arg3 serverChangeToken:(id)arg4 subscriptionName:(id)arg5 owner:(id)arg6 subscription:(id)arg7;	// IMP=0x0000000000228cae
