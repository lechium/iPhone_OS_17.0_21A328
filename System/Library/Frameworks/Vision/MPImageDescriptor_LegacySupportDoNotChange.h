...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000001bc2f6
- (void).cxx_destruct;	// IMP=0x00000000001bc2c3
...
- (void)dealloc;	// IMP=0x00000000001bc162
- (unsigned long long)serializeStateIntoData:(id)arg1 startingAtByteOffset:(unsigned long long)arg2 error:(id *)arg3;	// IMP=0x00000000001bbe81
- (unsigned long long)serializedLength;	// IMP=0x00000000001bbe61
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001bbe3f
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001bb96a
