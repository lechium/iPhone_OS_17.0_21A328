...
- (void).cxx_destruct;	// IMP=0x000000000052342c
...
- (unsigned long long)hash;	// IMP=0x000000000052331b
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000523278
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000005230b3
@property(readonly, nonatomic) NSDictionary *propertyDictionary;
- (id)initWithPropertyDictionary:(id)arg1;	// IMP=0x00000000005225b0
- (void)unregisterChangeObserver:(id)arg1;	// IMP=0x0000000000522581
- (void)registerChangeObserver:(id)arg1;	// IMP=0x0000000000522552
- (id)currentChange;	// IMP=0x0000000000522514
- (id)newViewModelChange;	// IMP=0x0000000000522503
