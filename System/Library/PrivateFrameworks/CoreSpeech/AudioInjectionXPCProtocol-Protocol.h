...
- (void)injectAudio:(NSURL *)arg1 toDeviceWithUUID:(NSUUID *)arg2 withScaleFactor:(float)arg3 withNumChannels:(int)arg4 withUserIntentOptions:(NSDictionary *)arg5 completion:(void (^)(_Bool, NSError *, unsigned long long, unsigned long long))arg6;
