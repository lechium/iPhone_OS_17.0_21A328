...
- (void).cxx_destruct;	// IMP=0x0020000000068b59
...
- (void)process;	// IMP=0x0010000000068ae9
- (_Bool)isProcessing;	// IMP=0x0010000000068ade
- (void)invalidate;	// IMP=0x0010000000068ad3
- (_Bool)isInvalidated;	// IMP=0x0010000000068ac8
- (id)initWithNotificationMessage:(id)arg1 identifier:(id)arg2 submissionDate:(double)arg3 context:(id)arg4;	// IMP=0x00100000000689a2
