...
- (void).cxx_destruct;	// IMP=0x002000000000ce17
...
- (_Bool)commitWithError:(id *)arg1;	// IMP=0x001000000000ccaa
- (id)description;	// IMP=0x001000000000cc2c
- (id)initWithPluginID:(id)arg1;	// IMP=0x001000000000cac5
