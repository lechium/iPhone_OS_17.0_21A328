...
- (void).cxx_destruct;	// IMP=0x0000000000c3c013
...
- (unsigned long long)hash;	// IMP=0x0000000000c3bd33
- (long long)compare:(id)arg1;	// IMP=0x0000000000c3bc3d
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000c3b868
- (id)attributeDescriptions;	// IMP=0x0000000000c3b569
- (id)initWithManufacturer:(id)arg1 model:(id)arg2 appBundleID:(id)arg3 appStoreID:(id)arg4 firmwareVersion:(id)arg5 productData:(id)arg6 productDataAlternates:(id)arg7;	// IMP=0x0000000000c3b369
