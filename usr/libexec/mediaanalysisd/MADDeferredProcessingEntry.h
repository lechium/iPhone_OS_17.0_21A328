...
+ (id)entryWithLocalIdentifier:(id)arg1 requestDate:(id)arg2;	// IMP=0x0040000000045010
- (void).cxx_destruct;	// IMP=0x00200000000450bc
...
- (id)initWithLocalIdentifier:(id)arg1 requestDate:(id)arg2;	// IMP=0x0010000000044f77
