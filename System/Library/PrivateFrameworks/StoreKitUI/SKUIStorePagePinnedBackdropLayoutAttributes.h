...
- (void).cxx_destruct;	// IMP=0x00000000002231ea
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000222fbf
- (unsigned long long)hash;	// IMP=0x0000000000222eb9
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000222daa
