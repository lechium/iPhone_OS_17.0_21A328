...
+ (id)sharedInstance;	// IMP=0x004000000041e616
- (void).cxx_destruct;	// IMP=0x002000000041eba5
...
- (void)_timerFiredOnMain;	// IMP=0x001000000041ead7
- (void)_timerFired;	// IMP=0x001000000041e92b
- (void)removeTarget:(id)arg1;	// IMP=0x001000000041e8ae
- (void)addTarget:(id)arg1 actionBlock:(CDUnknownBlockType)arg2;	// IMP=0x001000000041e7cc
- (_Bool)hasActionForTarget:(id)arg1;	// IMP=0x001000000041e795
- (id)initWithTimerBlock:(CDUnknownBlockType)arg1;	// IMP=0x001000000041e6f7
