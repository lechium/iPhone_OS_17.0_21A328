...
- (_Bool)_ntsLoadFromPropertyList:(id)arg1;	// IMP=0x0020000000047752
- (id)_dsidFromDictionary:(id)arg1;	// IMP=0x00100000000476ad
- (id)_copyPaymentsFromDictionary:(id)arg1;	// IMP=0x001000000004743d
- (id)_copyAppReceiptFromDictionary:(id)arg1;	// IMP=0x00100000000473eb
@property(copy) NSNumber *userIdentifier;
@property _Bool shouldTriggerQueueCheck;
- (void)setRangesToLoad:(id)arg1;	// IMP=0x0010000000047268
...
- (_Bool)loadFromPropertyList:(id)arg1;	// IMP=0x0010000000046fff
- (void)appendResponse:(id)arg1;	// IMP=0x0010000000046ce9
- (void)dealloc;	// IMP=0x0010000000046c8a
- (id)initWithRequestType:(long long)arg1;	// IMP=0x0010000000046c4d
