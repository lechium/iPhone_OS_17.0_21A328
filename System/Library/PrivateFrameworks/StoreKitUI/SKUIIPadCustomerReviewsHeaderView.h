...
- (void).cxx_destruct;	// IMP=0x0000000000262609
...
- (void)_reloadSortButton;	// IMP=0x00000000002620f1
- (void)_destroySortPopoverController;	// IMP=0x0000000000262070
- (void)_sortButtonAction:(id)arg1;	// IMP=0x0000000000261ec1
- (void)popoverControllerDidDismissPopover:(id)arg1;	// IMP=0x0000000000261eaf
- (void)menuViewController:(id)arg1 didSelectItemAtIndex:(long long)arg2;	// IMP=0x0000000000261e3a
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x0000000000261d6c
- (void)setBackgroundColor:(id)arg1;	// IMP=0x0000000000261ca2
- (void)layoutSubviews;	// IMP=0x000000000026185f
- (id)hitTest:(struct CGPoint)arg1 withEvent:(id)arg2;	// IMP=0x000000000026175d
- (void)dealloc;	// IMP=0x000000000026132a
- (id)initWithClientContext:(id)arg1;	// IMP=0x0000000000260d38
