...
- (void).cxx_destruct;	// IMP=0x0000000000026a32
...
- (void)setUpSectionHeightConstraints;	// IMP=0x000000000002645a
- (void)setUpSections;	// IMP=0x0000000000025b72
@property(getter=isDarkened) _Bool darkened;
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x0000000000025525
- (id)initWithDataPoint:(id)arg1 useVibrancy:(_Bool)arg2;	// IMP=0x000000000002529f
