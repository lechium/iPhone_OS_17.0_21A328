...
- (void).cxx_destruct;	// IMP=0x002000000000b3fb
...
- (void)presentableDidAppearAsBanner:(id)arg1;	// IMP=0x001000000000b37c
...
- (_Bool)_canShowWhileLocked;	// IMP=0x001000000000b2ef
...
- (id)postOptions;	// IMP=0x001000000000b187
- (void)viewDidLoad;	// IMP=0x001000000000b158
- (id)initWithAction:(id)arg1;	// IMP=0x001000000000b058
