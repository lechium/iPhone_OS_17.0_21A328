...
- (void).cxx_destruct;	// IMP=0x000000000023c936
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000023c789
- (id)initWithRequestClass:(Class)arg1;	// IMP=0x000000000023c695
