...
+ (id)customAttributes;	// IMP=0x00600000001aeb3b
...
- (id)outputImage;	// IMP=0x00000000001aeea2
- (id)_geomKernel;	// IMP=0x00000000001aee82
- (id)_colorKernel;	// IMP=0x00000000001aee62
