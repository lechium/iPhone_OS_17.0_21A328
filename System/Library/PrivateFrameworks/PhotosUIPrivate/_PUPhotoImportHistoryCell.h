...
- (void).cxx_destruct;	// IMP=0x00000000002b7f61
...
- (void)_updateBorderColor;	// IMP=0x00000000002b7db6
- (void)prepareForReuse;	// IMP=0x00000000002b7b0b
- (void)layoutSubviews;	// IMP=0x00000000002b7a75
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000002b7985
