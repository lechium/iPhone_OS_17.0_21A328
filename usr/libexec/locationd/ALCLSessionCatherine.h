...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000041d78e
- (unsigned long long)hash;	// IMP=0x001000000041ca0a
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000041c585
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000041c2bb
- (void)copyTo:(id)arg1;	// IMP=0x001000000041c02f
- (void)writeTo:(id)arg1;	// IMP=0x001000000041bd09
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000041bcfc
- (id)dictionaryRepresentation;	// IMP=0x001000000041a780
- (id)description;	// IMP=0x001000000041a709
...
- (int)StringAsOnsetReason:(id)arg1;	// IMP=0x001000000041a571
- (id)onsetReasonAsString:(int)arg1;	// IMP=0x001000000041a536
...
- (int)StringAsActivityType:(id)arg1;	// IMP=0x0010000000419a2c
- (id)activityTypeAsString:(int)arg1;	// IMP=0x0010000000419664
