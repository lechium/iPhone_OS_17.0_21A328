...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000000cd303
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000cd188
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000ccfd9
- (void)lock:(CDUnknownBlockType)arg1;	// IMP=0x00000000000ccf6f
- (id)initWithIdentityStoreStyle:(long long)arg1;	// IMP=0x00000000000ccf1e
- (id)_initCommon;	// IMP=0x00000000000ccee3
