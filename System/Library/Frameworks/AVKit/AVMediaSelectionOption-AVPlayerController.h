...
+ (id)avkit_autoOption;	// IMP=0x0020000000158660
+ (id)avkit_offOption;	// IMP=0x0020000000158630
- (long long)languageCompare:(id)arg1 currentLanguageCode:(id)arg2 currentLanguageIdentifier:(id)arg3;	// IMP=0x0010000000038e73
...
- (id)avkit_title;	// IMP=0x0010000000158550
