...
- (void).cxx_destruct;	// IMP=0x00000000001f094a
...
- (id)_blurredMaterialImageWithSourceBackgroundImage:(id)arg1 forRect:(struct CGRect)arg2 croppedRect:(struct CGRect)arg3;	// IMP=0x00000000001f0642
- (void)main;	// IMP=0x00000000001f01bd
- (id)init;	// IMP=0x00000000001f014e
- (id)initWithSourceBackgroundImage:(id)arg1;	// IMP=0x00000000001f00e0
