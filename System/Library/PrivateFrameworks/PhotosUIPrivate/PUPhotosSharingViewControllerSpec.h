...
- (_Bool)embedsActivityViewForBounds:(struct CGRect)arg1 horizontalSizeClass:(long long)arg2 verticalSizeClass:(long long)arg3;	// IMP=0x0000000000491e00
...
- (double)interItemSpacingForWidth:(double)arg1;	// IMP=0x0000000000491d4c
@property(readonly, nonatomic) double interItemSpacing;
- (_Bool)maximizeImageHeightForBounds:(struct CGRect)arg1;	// IMP=0x0000000000491cf3
