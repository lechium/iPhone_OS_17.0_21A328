...
+ (id)stateWithGeometry:(struct UIPeripheralAnimationGeometry)arg1 inPositionIsDestination:(_Bool)arg2;	// IMP=0x0060000000d8c923
- (void).cxx_destruct;	// IMP=0x0000000000d8cac7
...
- (void)dealloc;	// IMP=0x0000000000d8c9c0
