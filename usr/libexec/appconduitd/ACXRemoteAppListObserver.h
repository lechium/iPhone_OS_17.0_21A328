...
- (void).cxx_destruct;	// IMP=0x0020000000045614
...
- (unsigned long long)hash;	// IMP=0x00100000000455d8
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000454c9
- (id)initWithObserver:(id)arg1 queue:(id)arg2;	// IMP=0x00100000000453e2
