...
- (void).cxx_destruct;	// IMP=0x00200000002381f8
...
- (void)requestSyncWithPeers:(id)arg1;	// IMP=0x0010000000238005
- (void)requestSyncWith:(id)arg1;	// IMP=0x0010000000237f32
- (void)finish;	// IMP=0x0010000000236597
- (void)restart;	// IMP=0x0010000000236569
- (void)start;	// IMP=0x001000000023613d
- (id)initWithAccount:(id)arg1 quiet:(_Bool)arg2;	// IMP=0x00100000002360b5
@property(readonly) NSString *description;
- (void)updateSOSCircleCachedStatus;	// IMP=0x0010000000235e43
- (unsigned long long)currentTrustBitmask;	// IMP=0x0010000000235d31
