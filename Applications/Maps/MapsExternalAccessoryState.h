...
+ (id)allKeys;	// IMP=0x00400000007ab599
- (void).cxx_destruct;	// IMP=0x00200000007ac559
...
- (_Bool)isEqualToState:(id)arg1;	// IMP=0x00100000007ac376
@property(readonly, nonatomic) CDStruct_8024420c engineTypes;
- (void)updateWithInfo:(id)arg1;	// IMP=0x00100000007abcd1
- (id)_augmentVehicleInfo:(id)arg1;	// IMP=0x00100000007abb5f
- (void)_augmentMutableVehicleInfo:(id)arg1;	// IMP=0x00100000007ab8dd
- (id)initWithAccessory:(id)arg1;	// IMP=0x00100000007ab714
- (id)descriptionForKey:(id)arg1;	// IMP=0x00100000007ab5e9
