...
- (void).cxx_destruct;	// IMP=0x0000000000071300
...
- (_Bool)_subviewIsCustomMenuItemView:(id)arg1;	// IMP=0x0000000000070eb4
...
- (void)_updateCustomContentTransitioningInfoPanelLayout;	// IMP=0x0000000000070612
- (void)_updateVolumeControllerLayout;	// IMP=0x000000000007060c
- (id)_scrubInstructionsAttributedText;	// IMP=0x000000000007038d
- (void)_updateScrubInstructionsFrame;	// IMP=0x000000000006ff06
- (void)_updateScrubInstructionsLabelsText;	// IMP=0x000000000006fd31
- (void)_showScrubInstructions;	// IMP=0x000000000006fb0d
- (void)_updateFontSizes;	// IMP=0x000000000006f8ce
- (unsigned long long)_layoutItemDisplayPriorityForSubview:(id)arg1;	// IMP=0x000000000006f5a9
- (double)_rowSpacingForDoubleRowLayoutAfterRow:(unsigned long long)arg1;	// IMP=0x000000000006f41e
- (void)_layoutSingleRowViews;	// IMP=0x000000000006ecbc
- (void)_layoutDoubleRowViews;	// IMP=0x000000000006dd90
- (double)_doubleRowLayoutSpacingAfterSubview:(id)arg1;	// IMP=0x000000000006d893
- (double)_singeRowLayoutSpacingAfterSubview:(id)arg1;	// IMP=0x000000000006d4ac
- (void)endScrubbing:(id)arg1;	// IMP=0x000000000006d347
- (void)scrubberValueChanged:(id)arg1;	// IMP=0x000000000006d2c2
- (void)beginScrubbing:(id)arg1;	// IMP=0x000000000006d1ee
@property(readonly, nonatomic, getter=isCollapsedOrExcluded) _Bool collapsedOrExcluded;
- (void)scrubberSlowKnobMovementDetected:(id)arg1;	// IMP=0x000000000006cf33
- (void)avkit_reevaluateHiddenStateOfItem:(id)arg1;	// IMP=0x000000000006ce16
- (void)layoutSubviews;	// IMP=0x000000000006c45c
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x000000000006c41b
- (struct CGSize)intrinsicContentSize;	// IMP=0x000000000006c0bf
- (double)layoutHeightThatFitsRowsStartingWithRow:(unsigned long long)arg1;	// IMP=0x000000000006c068
- (void)reevaluateHiddenStateOfAllItems;	// IMP=0x000000000006c02b
- (float)volumeControlsControllerTransportBarHeight:(id)arg1;	// IMP=0x000000000006bb6f
- (id)initWithFrame:(struct CGRect)arg1 styleSheet:(id)arg2;	// IMP=0x000000000006b036
