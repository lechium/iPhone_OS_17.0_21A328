...
- (void).cxx_destruct;	// IMP=0x0000000000037f4d
...
- (void)_updateDeviceVisual:(id)arg1;	// IMP=0x0000000000037b11
- (void)_updateForDeviceInfo;	// IMP=0x0000000000037892
- (void)sessionProgressEvent:(int)arg1 info:(id)arg2;	// IMP=0x000000000003777e
- (void)eventCancel:(id)arg1;	// IMP=0x00000000000376fb
- (void)viewDidDisappear:(_Bool)arg1;	// IMP=0x00000000000376b2
- (void)viewWillDisappear:(_Bool)arg1;	// IMP=0x0000000000037614
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x00000000000374d5
