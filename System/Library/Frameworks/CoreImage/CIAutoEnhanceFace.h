...
- (struct CGRect)faceRect;	// IMP=0x00000000001d7de5
- (id)description;	// IMP=0x00000000001d7da7
- (id)initWithBounds:(struct CGRect)arg1 andImage:(id)arg2 usingContext:(id)arg3;	// IMP=0x00000000001d7a02
