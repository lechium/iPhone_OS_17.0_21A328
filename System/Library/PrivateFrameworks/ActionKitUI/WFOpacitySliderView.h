...
- (void).cxx_destruct;	// IMP=0x000000000002cdcd
...
- (void)reset;	// IMP=0x000000000002cd0f
@property(readonly, nonatomic) double opacity;
- (void)didChangeOpacityValue:(id)arg1;	// IMP=0x000000000002cbf3
- (void)layoutSubviews;	// IMP=0x000000000002c751
- (id)init;	// IMP=0x000000000002c0cd
