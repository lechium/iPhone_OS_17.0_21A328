...
- (void).cxx_destruct;	// IMP=0x00200000001b484f
@property(readonly, copy, nonatomic) NSError *error; // @synthesize error=_error;
@property(nonatomic) long long countOfBytesSent; // @synthesize countOfBytesSent=_countOfBytesSent;
// Error: Property attributes should begin with the type ('T') attribute, property name: assetTokenType
// Property attributes: (null)

@property(readonly, copy, nonatomic) NSString *assetToken; // @synthesize assetToken=_assetToken;
- (id)initWithURLResponse:(id)arg1 data:(id)arg2;	// IMP=0x00100000001b4343
