...
- (void).cxx_destruct;	// IMP=0x000000000009ab39
...
- (struct CGAffineTransform)transformFromCurrentVideoOrientationToOrientation:(long long)arg1;	// IMP=0x000000000009a7bf
- (double)angleOffsetFromPortraitOrientationToOrientation:(long long)arg1;	// IMP=0x000000000009a79f
- (void)removeFile:(id)arg1;	// IMP=0x000000000009a689
- (void)video:(id)arg1 didFinishSavingWithError:(id)arg2 contextInfo:(void *)arg3;	// IMP=0x000000000009a54a
- (void)saveMovieToCameraRoll;	// IMP=0x000000000009a43f
- (void)resumeCaptureSessionForMovieRecording;	// IMP=0x000000000009a402
- (void)pauseCaptureSessionForMovieRecording;	// IMP=0x000000000009a3c5
- (_Bool)inputsReadyToRecord;	// IMP=0x000000000009a38c
- (void)stopRecording;	// IMP=0x000000000009a0f9
- (void)startRecording;	// IMP=0x0000000000099ee8
- (_Bool)setupAssetWriterMetadataInputAndMetadataAdaptor;	// IMP=0x0000000000099aed
- (_Bool)setupAssetWriterVideoInput:(struct opaqueCMFormatDescription *)arg1;	// IMP=0x00000000000995af
- (_Bool)writeMetaDataAtFrame:(long long)arg1 intrinsicMatrix:(CDStruct_d80e62f2)arg2;	// IMP=0x000000000009913d
- (void)writeSampleBuffer:(struct opaqueCMSampleBuffer *)arg1 ofType:(id)arg2 atFrame:(long long)arg3;	// IMP=0x0000000000098e3f
- (void)recordingDidStop;	// IMP=0x0000000000098c8e
- (void)recordingWillStop;	// IMP=0x0000000000098b77
- (void)recordingDidStart;	// IMP=0x0000000000098a9f
- (void)recordingWillStart;	// IMP=0x00000000000988b9
- (void)recordFrame:(struct opaqueCMSampleBuffer *)arg1 fromConnection:(id)arg2;	// IMP=0x0000000000098569
- (id)initWithDelegate:(id)arg1 videoConnection:(id)arg2 referenceOrientation:(long long)arg3;	// IMP=0x00000000000983f4
