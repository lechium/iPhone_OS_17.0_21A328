...
- (void).cxx_destruct;	// IMP=0x000000000011d830
@property(nonatomic) __weak NSError *expectedError; // @synthesize expectedError=_expectedError;
- (_Bool)attemptRecoveryFromError:(id)arg1 optionIndex:(unsigned long long)arg2;	// IMP=0x000000000011d2ec
- (id)initWithBlock:(CDUnknownBlockType)arg1 operationService:(id)arg2;	// IMP=0x000000000011d24e
