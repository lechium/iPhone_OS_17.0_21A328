...
@interface SUUIReportAConcernTemplateViewElement : SUUIViewElement
{
...
- (void).cxx_destruct;	// IMP=0x000000000021920b
...
- (id)initWithDOMElement:(id)arg1 parent:(id)arg2 elementFactory:(id)arg3;	// IMP=0x0000000000218f82
