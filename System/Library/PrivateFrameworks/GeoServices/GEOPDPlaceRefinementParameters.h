...
- (void).cxx_destruct;	// IMP=0x00000000005f1744
- (unsigned long long)hash;	// IMP=0x00000000005f12bc
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000005f1054
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000005f0c08
- (void)writeTo:(id)arg1;	// IMP=0x00000000005f07ab
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000005f079c
- (id)jsonRepresentation;	// IMP=0x00000000005ef43c
- (id)dictionaryRepresentation;	// IMP=0x00000000005eeb8e
- (id)description;	// IMP=0x00000000005eeadf
- (id)initWithData:(id)arg1;	// IMP=0x00000000005ed4af
- (id)init;	// IMP=0x00000000005ed453
- (_Bool)_routeHypothesisPlaceRefinementParametersIsEqual:(id)arg1;	// IMP=0x00000000011d9921
- (unsigned long long)_routeHypothesisPlaceRefinementParametersHash;	// IMP=0x00000000011d98b5
- (_Bool)_hasRequiredFields;	// IMP=0x00000000011d9889
- (id)initWithSearchURLQuery:(id)arg1 identifier:(id)arg2;	// IMP=0x0000000001423ca7
- (id)initWithMapItemToRefine:(id)arg1 coordinate:(CDStruct_c3b9c2ee)arg2;	// IMP=0x0000000001423a0a
- (id)initWithIdentifier:(id)arg1 placeNameHint:(id)arg2 locationHint:(CDStruct_c3b9c2ee)arg3;	// IMP=0x00000000014237e4
