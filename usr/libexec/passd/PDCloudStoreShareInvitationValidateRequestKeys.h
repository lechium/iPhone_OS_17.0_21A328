...
- (void).cxx_destruct;	// IMP=0x00200000001b3805
...
- (id)description;	// IMP=0x00100000001b36fe
- (_Bool)canCoalesceRequest:(id)arg1;	// IMP=0x00100000001b3435
- (id)initWithInvitation:(id)arg1 recipientHandle:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x00100000001b3388
