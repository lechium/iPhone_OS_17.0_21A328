...
- (void).cxx_destruct;	// IMP=0x0000000000133b40
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000133a1e
- (unsigned long long)hash;	// IMP=0x0000000000133980
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000133868
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000013378c
- (void)copyTo:(id)arg1;	// IMP=0x00000000001336eb
- (void)writeTo:(id)arg1;	// IMP=0x000000000013363d
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000133630
- (id)dictionaryRepresentation;	// IMP=0x00000000001331b8
- (id)description;	// IMP=0x0000000000133109
