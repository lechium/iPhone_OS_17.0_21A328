...
- (void)fulfilledWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0000000000003857
- (void)fulfill:(id)arg1;	// IMP=0x000000000000379d
- (id)initWithFulfillmentQueue:(id)arg1;	// IMP=0x0000000000003677
