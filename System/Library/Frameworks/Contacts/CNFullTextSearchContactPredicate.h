...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000000324eb
- (void).cxx_destruct;	// IMP=0x0000000000032942
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000003270a
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000324f3
- (id)initWithSearchString:(id)arg1 containerIdentifiers:(id)arg2 groupIdentifiers:(id)arg3;	// IMP=0x00000000000323eb
- (id)sgContactMatchesWithSortOrder:(long long)arg1 mutableObjects:(_Bool)arg2 service:(id)arg3 error:(id *)arg4;	// IMP=0x00000000000cdc74
