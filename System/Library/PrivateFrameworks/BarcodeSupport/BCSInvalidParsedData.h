...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000000121d4
- (void).cxx_destruct;	// IMP=0x0000000000012218
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000001214c
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000012016
@property(readonly, copy, nonatomic) NSString *extraPreviewText;
@property(readonly, nonatomic) long long type;
- (id)initWithInvalidDataType:(long long)arg1 invalidContents:(id)arg2;	// IMP=0x0000000000011f75
