...
+ (void)initializeJSContext:(id)arg1;	// IMP=0x001000000002a6c8
...
- (id)CATransform3DValue;	// IMP=0x000000000002a656
- (id)initWithTransform3D:(struct CATransform3D)arg1;	// IMP=0x000000000002a5df
