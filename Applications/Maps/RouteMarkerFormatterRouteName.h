...
@interface RouteMarkerFormatterRouteName : NSObject
{
    NSArray *_routes;	// 8 = 0x8
    unsigned long long _selectedRouteIndex;	// 16 = 0x10
}

- (void).cxx_destruct;	// IMP=0x0020000000a7bd50
...
- (id)markerInfoForRoute:(id)arg1;	// IMP=0x0010000000a7bbf1
- (id)initWithRoutes:(id)arg1 selectedRouteIndex:(unsigned long long)arg2;	// IMP=0x0010000000a7bb73
