...
- (void).cxx_destruct;	// IMP=0x0000000000281778
...
- (void)_reloadFonts;	// IMP=0x000000000028165c
- (id)_newLinkButtonWithTitle:(id)arg1;	// IMP=0x00000000002815b6
- (void)_layoutTwoRows;	// IMP=0x00000000002810a9
- (void)_layoutOneRow;	// IMP=0x00000000002809f9
- (void)tintColorDidChange;	// IMP=0x0000000000280964
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000002807da
- (void)layoutSubviews;	// IMP=0x0000000000280781
...
- (_Bool)isRedeemHidden;	// IMP=0x000000000028049a
- (_Bool)isEcommerceHidden;	// IMP=0x0000000000280421
@property(copy, nonatomic) NSString *ECommerceLinkTitle;
- (void)dealloc;	// IMP=0x00000000002802b5
- (id)initWithClientContext:(id)arg1;	// IMP=0x000000000027ff1c
