...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000c5d5b7
- (void).cxx_destruct;	// IMP=0x0000000000c5d92e
...
- (id)description;	// IMP=0x0000000000c5d85b
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000c5d780
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000c5d66d
- (id)initWithInterpretations:(id)arg1 isLowConfidence:(_Bool)arg2;	// IMP=0x0000000000c5d649
- (id)initWithInterpretations:(id)arg1;	// IMP=0x0000000000c5d5bf
