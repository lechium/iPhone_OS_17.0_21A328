...
- (void).cxx_destruct;	// IMP=0x0000000000081871
...
- (void)_setNoUsageDataViewVisibility;	// IMP=0x000000000008172c
- (void)setValue:(id)arg1;	// IMP=0x0000000000081440
- (id)value;	// IMP=0x0000000000081402
- (void)_hasMulitlineLayoutDidChangeFrom:(_Bool)arg1 to:(_Bool)arg2;	// IMP=0x000000000008138f
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x00000000000811e6
- (void)dealloc;	// IMP=0x000000000008118c
- (id)initWithStyle:(long long)arg1 reuseIdentifier:(id)arg2 specifier:(id)arg3;	// IMP=0x00000000000808f7
