...
- (void).cxx_destruct;	// IMP=0x00000000006cdce1
- (void)refreshControl:(id)arg1 didChangeToState:(long long)arg2 fromState:(long long)arg3;	// IMP=0x00000000006cdbe1
- (void)incrementInsetHeight:(double)arg1;	// IMP=0x00000000006cdba6
- (void)decrementInsetHeight:(double)arg1;	// IMP=0x00000000006cdb6b
...
- (id)initWithScrollView:(id)arg1;	// IMP=0x00000000006cdae9
