...
@interface _TtC8StocksUI33ForYouFeedScrollLandscapeTestCase : NSObject
{
...
- (void).cxx_destruct;	// IMP=0x0000000000206930
- (id)init;	// IMP=0x00000000002068e0
- (id)scrollViewWithContext:(id)arg1;	// IMP=0x0000000000206780
