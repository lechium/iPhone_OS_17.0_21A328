...
+ (id)selectButtonConfiguration:(id)arg1 supportsSiri:(_Bool)arg2;	// IMP=0x006000000083f17f
- (void).cxx_destruct;	// IMP=0x000000000083f157
...
- (_Bool)dispatchButtonEvent:(id)arg1;	// IMP=0x000000000083f093
- (void)updateSelectedButtons:(id)arg1;	// IMP=0x000000000083f081
- (id)initWithName:(id)arg1 identifier:(unsigned int)arg2 ticksPerSecond:(unsigned long long)arg3 supportedButtons:(id)arg4 supportsSiri:(_Bool)arg5;	// IMP=0x000000000083ef96
