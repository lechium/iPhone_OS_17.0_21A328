...
- (void).cxx_destruct;	// IMP=0x00000000002256fb
...
- (id)description;	// IMP=0x00000000002255b9
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000002254de
- (void)sizeSplitsToFitWidth:(double)arg1 usingBlock:(CDUnknownBlockType)arg2;	// IMP=0x00000000002251f3
@property(readonly, nonatomic) long long numberOfSplits;
@property(readonly, nonatomic) SKUIStorePageSplit *firstSplit;
- (void)enumerateSplitsUsingBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000000224e61
