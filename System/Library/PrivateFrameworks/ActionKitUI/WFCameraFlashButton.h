...
- (void).cxx_destruct;	// IMP=0x0000000000033c59
...
- (struct CGSize)intrinsicContentSize;	// IMP=0x0000000000033911
- (_Bool)beginTrackingWithTouch:(id)arg1 withEvent:(id)arg2;	// IMP=0x0000000000033620
- (id)hitTest:(struct CGPoint)arg1 withEvent:(id)arg2;	// IMP=0x00000000000335b0
- (void)didMoveToWindow;	// IMP=0x000000000003353d
- (void)layoutSubviews;	// IMP=0x00000000000334ae
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000032ffb
