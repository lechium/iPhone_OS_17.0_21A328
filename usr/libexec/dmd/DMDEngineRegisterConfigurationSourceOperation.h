...
- (void).cxx_destruct;	// IMP=0x002000000004e46c
...
- (void)delegateUpdatedDeclarationSourceAndEndOperation:(id)arg1;	// IMP=0x001000000004e2c7
- (void)main;	// IMP=0x001000000004da47
