...
- (void).cxx_destruct;	// IMP=0x0000000000034740
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000000346e0
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x0000000000034660
- (void)didTapRightButton;	// IMP=0x0000000000034630
- (void)didTapLeftButton;	// IMP=0x0000000000034570
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000034460
