...
+ (_Bool)supportsSecureCoding;	// IMP=0x0060000000009241
- (void).cxx_destruct;	// IMP=0x0000000000017c07
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000f7921
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000002e23
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000f7832
