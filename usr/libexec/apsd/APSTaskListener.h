...
- (void).cxx_destruct;	// IMP=0x002000000007c459
...
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x001000000007bf91
- (void)_cleanupConnection:(id)arg1;	// IMP=0x001000000007bdf2
- (void)dealloc;	// IMP=0x001000000007bd60
- (id)initWithQueue:(id)arg1 apsDaemon:(id)arg2;	// IMP=0x001000000007bbb6
