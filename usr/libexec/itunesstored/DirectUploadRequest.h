...
- (void).cxx_destruct;	// IMP=0x00200000001a0f96
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000001a0e30
- (id)initWithEntity:(id)arg1 accountIdentifier:(id)arg2;	// IMP=0x00100000001a0b4d
