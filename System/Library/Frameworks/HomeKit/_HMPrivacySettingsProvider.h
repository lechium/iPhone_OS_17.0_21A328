...
- (void)requestAccessWithQueue:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000000027a76
- (unsigned long long)queryAuthorizationStatus;	// IMP=0x0000000000027a4e
