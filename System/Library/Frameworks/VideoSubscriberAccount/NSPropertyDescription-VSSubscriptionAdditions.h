...
- (id)vs_JSONValueTransformer;	// IMP=0x003000000002a02f
...
- (id)vs_propertyListValueTransformer;	// IMP=0x003000000002998c
...
- (_Bool)vs_isSuitableForPurpose:(long long)arg1;	// IMP=0x003000000002981f
...
- (void)vs_setUserInfoValue:(id)arg1 forKey:(id)arg2;	// IMP=0x0030000000029595
@end
