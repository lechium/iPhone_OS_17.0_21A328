...
- (void).cxx_destruct;	// IMP=0x0000000000b60bfd
- (unsigned long long)hash;	// IMP=0x0000000000b60afc
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000b6092d
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000b6080a
- (void)writeTo:(id)arg1;	// IMP=0x0000000000b606f6
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000b606e9
- (id)jsonRepresentation;	// IMP=0x0000000000b606da
- (id)dictionaryRepresentation;	// IMP=0x0000000000b603a2
- (id)description;	// IMP=0x0000000000b602f3
