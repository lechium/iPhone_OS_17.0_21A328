...
- (void).cxx_destruct;	// IMP=0x00200000000b04e7
...
- (id)description;	// IMP=0x00100000000b0350
@property(readonly, nonatomic) NSDictionary *dictionary;
- (void)insertValue:(double)arg1;	// IMP=0x00100000000afe07
- (id)initWithCapacity:(unsigned long long)arg1 dictionary:(id)arg2;	// IMP=0x00100000000afa29
- (id)initWithCapacity:(unsigned long long)arg1;	// IMP=0x00100000000af9b2
