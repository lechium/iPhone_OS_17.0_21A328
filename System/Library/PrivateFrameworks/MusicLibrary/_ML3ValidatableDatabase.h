...
- (void).cxx_destruct;	// IMP=0x00000000001ea234
...
- (_Bool)currentQueueIsValidationQueue;	// IMP=0x00000000001ea1c9
- (id)init;	// IMP=0x00000000001ea187
- (id)initWithDatabasePath:(id)arg1;	// IMP=0x00000000001ea035
