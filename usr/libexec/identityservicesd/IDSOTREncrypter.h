...
- (void).cxx_destruct;	// IMP=0x00200000002cd4d2
...
- (id)decryptData:(id)arg1 onQueue:(id)arg2 error:(long long *)arg3;	// IMP=0x00100000002ccd08
- (id)encryptData:(id)arg1 onQueue:(id)arg2 error:(long long *)arg3;	// IMP=0x00100000002cc52d
- (id)initWithOTRController:(id)arg1 OTRToken:(id)arg2;	// IMP=0x00100000002cc494
