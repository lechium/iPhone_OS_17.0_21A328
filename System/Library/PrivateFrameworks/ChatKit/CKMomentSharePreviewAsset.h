...
- (void).cxx_destruct;	// IMP=0x0000000000314f5d
...
- (struct CGRect)bestCropRectForAspectRatio:(double)arg1 verticalContentMode:(long long)arg2 cropMode:(long long)arg3;	// IMP=0x0000000000314cc5
@property(readonly, nonatomic) double aspectRatio;
- (struct CGSize)size;	// IMP=0x0000000000314c37
- (struct CGRect)bestCropRectForAspectRatio:(double)arg1;	// IMP=0x0000000000314c10
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000003149ad
@property(readonly, nonatomic) _Bool isInSharedLibrary;
- (long long)isContentEqualTo:(id)arg1;	// IMP=0x000000000031490a
...
- (id)initWithMomentShare:(id)arg1;	// IMP=0x0000000000314735
- (id)init;	// IMP=0x000000000031472c
