...
- (void).cxx_destruct;	// IMP=0x0000000000095460
...
- (unsigned long long)preferedMonogramType;	// IMP=0x000000000009502e
- (unsigned long long)hash;	// IMP=0x0000000000094e6a
- (struct CGPoint)specialOffsetForString:(id)arg1;	// IMP=0x0000000000094d66
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000093faa
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000093c0c
- (id)copyWithType:(unsigned long long)arg1;	// IMP=0x0000000000093b5f
- (id)init;	// IMP=0x0000000000093b43
- (id)initWithFirstName:(id)arg1 lastName:(id)arg2 imageURL:(id)arg3 font:(id)arg4;	// IMP=0x00000000000939c2
