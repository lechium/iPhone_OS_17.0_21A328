...
#import <PhotosIntelligence/CLSSimilarlyStackableItem-Protocol.h>
#import <PhotosIntelligence/NSObject-Protocol.h>
#import <PhotosIntelligence/PLRegionsClusteringItem-Protocol.h>

@class CLLocation, CLSAssetScoringContext, CLSCurationModel, NSArray, NSDate, NSSet, NSString, VNSceneprint;
