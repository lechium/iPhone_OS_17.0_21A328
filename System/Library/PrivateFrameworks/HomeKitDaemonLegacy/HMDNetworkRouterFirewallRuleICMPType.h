...
+ (id)createListWithJSONDictionary:(id)arg1 key:(id)arg2;	// IMP=0x00600000008152cd
+ (id)createWithJSONDictionary:(id)arg1;	// IMP=0x00600000008150cd
- (void).cxx_destruct;	// IMP=0x00000000008150a5
...
- (id)description;	// IMP=0x0000000000814f2f
@property(readonly, nonatomic) NSDictionary *prettyJSONDictionary;
- (unsigned long long)hash;	// IMP=0x0000000000814d45
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000814bdb
- (id)initWithJSONDictionary:(id)arg1 protocol:(unsigned char)arg2 typeValue:(id)arg3;	// IMP=0x0000000000814b38
