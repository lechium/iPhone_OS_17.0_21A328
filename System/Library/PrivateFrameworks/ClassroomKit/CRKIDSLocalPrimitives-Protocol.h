...
@class CRKIDSMessageOptions, NSArray, NSDictionary, NSError, NSString;
...
- (void)forceRefreshIDStatusForDestinations:(NSArray *)arg1 completion:(void (^)(NSDictionary *))arg2;
- (_Bool)isRemoteUserNotRegisteredError:(NSError *)arg1;
