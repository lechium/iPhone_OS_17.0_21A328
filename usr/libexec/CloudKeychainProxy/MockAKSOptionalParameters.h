...
- (void).cxx_destruct;	// IMP=0x002000000000eb5c
...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000000ea6a
- (unsigned long long)hash;	// IMP=0x001000000000e9fd
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000000e91d
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000000e859
- (void)copyTo:(id)arg1;	// IMP=0x001000000000e7d6
- (void)writeTo:(id)arg1;	// IMP=0x001000000000e75c
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000000e5d0
- (id)dictionaryRepresentation;	// IMP=0x001000000000e526
- (id)description;	// IMP=0x001000000000e477
