...
- (void).cxx_destruct;	// IMP=0x00000000000a6c02
...
- (id)description;	// IMP=0x00000000000a6ad5
- (id)initWithServiceType:(id)arg1 serviceInstanceID:(id)arg2 serviceProperties:(unsigned long long)arg3 linkedServices:(id)arg4 authenticated:(_Bool)arg5;	// IMP=0x00000000000a681c
