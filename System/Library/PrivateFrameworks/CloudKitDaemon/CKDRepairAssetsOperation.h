...
+ (id)nameForState:(unsigned long long)arg1;	// IMP=0x006000000036b684
- (void).cxx_destruct;	// IMP=0x000000000036fe90
...
- (void)_finishOnCallbackQueueWithError:(id)arg1;	// IMP=0x000000000036fc96
- (void)main;	// IMP=0x000000000036fb9a
- (id)assetOrPackageForMetadata:(id)arg1 inRecord:(id)arg2;	// IMP=0x000000000036f993
- (id)repairContainer;	// IMP=0x000000000036f5d9
- (void)_updateMissingAssetServerStatus;	// IMP=0x000000000036e069
- (void)_uploadAssetsModify;	// IMP=0x000000000036c4af
- (void)_fetchAssetMetadata;	// IMP=0x000000000036b6da
- (_Bool)makeStateTransition;	// IMP=0x000000000036b579
- (id)activityCreate;	// IMP=0x000000000036b550
- (id)initWithOperationInfo:(id)arg1 container:(id)arg2;	// IMP=0x000000000036aecc
