...
@interface _ICNANoteReportToAccount : NSObject
{
    ...
    unsigned long long _countOfNotesWithPaperDocument;	// 528 = 0x210
    unsigned long long _countOfNotesWithPDF;	// 536 = 0x218
    unsigned long long _countOfNotesWithNoteLink;	// 544 = 0x220
    unsigned long long _countOfNotesWithFolderLink;	// 552 = 0x228
    unsigned long long _countOfNotesWithTags;	// 560 = 0x230
    unsigned long long _countOfNotesWithMentions;	// 568 = 0x238
    unsigned long long _scrapPaperCount;	// 576 = 0x240
    unsigned long long _countOfScrapPapersWithTags;	// 584 = 0x248
    unsigned long long _countOfScrapPapersWithMentions;	// 592 = 0x250
    unsigned long long _countOfPinnedScrapPapers;	// 600 = 0x258
    unsigned long long _countOfLockedScrapPapers;	// 608 = 0x260
    unsigned long long _countOfCollaboratedScrapPapers;	// 616 = 0x268
    unsigned long long _countOfScrapPapersWithDocScan;	// 624 = 0x270
    unsigned long long _countOfScrapPapersWithInlineDrawingV1;	// 632 = 0x278
    unsigned long long _countOfScrapPapersWithInlineDrawingV2;	// 640 = 0x280
    unsigned long long _countOfScrapPapersWithFullscreenDrawing;	// 648 = 0x288
    unsigned long long _countOfScrapPapersWithTables;	// 656 = 0x290
    unsigned long long _countOfScrapPapersWithRichUrl;	// 664 = 0x298
    unsigned long long _countOfScrapPapersWithMapLink;	// 672 = 0x2a0
    unsigned long long _countOfScrapPapersWithOtherAttachments;	// 680 = 0x2a8
    unsigned long long _countOfScrapPapersWithPaperKit;	// 688 = 0x2b0
    unsigned long long _countOfScrapPapersWithDeepLink;	// 696 = 0x2b8
    unsigned long long _countOfNotes;	// 704 = 0x2c0
    unsigned long long _countOfChecklists;	// 712 = 0x2c8
    unsigned long long _countOfNotesWithChecklists;	// 720 = 0x2d0
    unsigned long long _countOfPinnedNotes;	// 728 = 0x2d8
    unsigned long long _countOfLockedNotes;	// 736 = 0x2e0
    unsigned long long _countOfV1LockedNotes;	// 744 = 0x2e8
    unsigned long long _countOfV2LockedNotes;	// 752 = 0x2f0
    unsigned long long _countOfLockedNotesWithDivergedMode;	// 760 = 0x2f8
    unsigned long long _countOfLockedNotesWithDivergedPassword;	// 768 = 0x300
}
...
@property(nonatomic) unsigned long long countOfNotesWithPDF; // @synthesize countOfNotesWithPDF=_countOfNotesWithPDF;
@property(nonatomic) unsigned long long countOfNotesWithPaperDocument; // @synthesize countOfNotesWithPaperDocument=_countOfNotesWithPaperDocument;
...
- (unsigned long long)countOfNotesWithCollaborationStatus:(long long)arg1 collaborationType:(long long)arg2;	// IMP=0x000000000000b6d8
- (unsigned long long)countOfNotesWithFactor:(long long)arg1 andFactor:(long long)arg2;	// IMP=0x000000000000b68e
- (void)completeTwoFactorMatrixReportingForCurrentNote;	// IMP=0x000000000000b63c
- (void)updateNoteCollaborationMatrixWithCollaborationStatus:(id)arg1 collaborationType:(id)arg2;	// IMP=0x000000000000b589
- (void)updateNoteTwoFactorMatrixWithIndex:(long long)arg1;	// IMP=0x000000000000b50f
- (id)init;	// IMP=0x000000000000b4c0
