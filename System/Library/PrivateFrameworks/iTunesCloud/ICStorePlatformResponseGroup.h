...
- (void).cxx_destruct;	// IMP=0x00000000001635ae
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001635a3
...
- (id)itemForIdentifier:(id)arg1;	// IMP=0x0000000000163050
@property(readonly, copy, nonatomic) NSDate *expirationDate;
- (void)enumerateItemsUsingBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000000162e02
...
- (id)initWithResponses:(id)arg1;	// IMP=0x0000000000162a7e
