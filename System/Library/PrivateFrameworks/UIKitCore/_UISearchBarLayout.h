...
- (void).cxx_destruct;	// IMP=0x00000000002aa716
...
- (void)setLayoutCustomizationDelegateSearchFieldContainerWillLayoutSubviewsCallback:(CDUnknownBlockType)arg1;	// IMP=0x00000000002aa3c7
- (void)setDelegateSearchFieldFrameManipulationBlock:(CDUnknownBlockType)arg1;	// IMP=0x00000000002aa36d
@property(readonly, copy) NSString *description;
- (void)cleanUpLayout;	// IMP=0x00000000002a955f
- (void)applyScopeContainerSublayout;	// IMP=0x00000000002a94fd
- (void)applyLayout;	// IMP=0x00000000002a8bd1
- (void)ensureCorrectContainerViewOrdering;	// IMP=0x00000000002a8b32
- (double)minimumLayoutWidth;	// IMP=0x00000000002a8af0
- (void)updateLayout;	// IMP=0x00000000002a86d7
- (double)layout:(id)arg1 fontScaledValueForValue:(double)arg2;	// IMP=0x00000000002a8624
- (void)containerLayoutWillUpdateLayout:(id)arg1;	// IMP=0x00000000002a85bb
- (void)prepareSublayouts;	// IMP=0x00000000002a858d
- (void)prepareScopeContainerLayout;	// IMP=0x00000000002a8458
- (void)prepareSearchContainerLayout;	// IMP=0x00000000002a8157
- (void)prepareBaseConfigurationForSublayout:(id)arg1;	// IMP=0x00000000002a80cb
- (void)setUpSearchContainerLayout;	// IMP=0x00000000002a7fa6
- (void)setUpScopeContainerLayout;	// IMP=0x00000000002a7f27
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000002a7078
