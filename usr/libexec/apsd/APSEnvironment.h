...
@interface APSEnvironment : NSObject
{
    ...
    MISSING_TYPE *_configurationURL;	// 16 = 0x10
...
+ (void)_saveCachedProperties;	// IMP=0x00200000000775f2
+ (void)_loadCachedProperties;	// IMP=0x00100000000770cb
+ (id)environmentForName:(id)arg1;	// IMP=0x00100000000770b2
+ (void)initialize;	// IMP=0x0010000000076afe
- (void).cxx_destruct;	// IMP=0x0020000000077ab8
...
- (id)description;	// IMP=0x0010000000077999
@property(readonly, nonatomic) unsigned long long priority;
- (unsigned long long)hash;	// IMP=0x0010000000077943
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000077938
