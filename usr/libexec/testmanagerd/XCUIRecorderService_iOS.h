...
+ (void)provideCapabilitiesToBuilder:(id)arg1;	// IMP=0x0020000000026c76
- (void).cxx_destruct;	// IMP=0x0020000000026ee6
...
- (id)_snapshotForTargetApplicationWithError:(id *)arg1;	// IMP=0x0010000000026b2d
- (id)_snapshotForApplicationContainingElement:(id)arg1 error:(id *)arg2;	// IMP=0x00100000000268da
- (void)_processKeyboardEvent:(id)arg1;	// IMP=0x001000000002682b
- (void)_processDeviceOrientationEvent:(id)arg1;	// IMP=0x0010000000026713
- (void)_recognizedGestures:(id)arg1;	// IMP=0x0010000000026086
- (void)_recognizedEventTypeName:(id)arg1 atAbsoluteTime:(double)arg2 withStartSnapshot:(id)arg3 endSnapshot:(id)arg4;	// IMP=0x0010000000025e45
- (id)_recordedEventNames:(id)arg1 timestamp:(double)arg2 duration:(double)arg3 startLocation:(id)arg4 startElementSnapshot:(id)arg5 startApplicationSnapshot:(id)arg6 endLocation:(id)arg7 endElementSnapshot:(id)arg8 endApplicationSnapshot:(id)arg9;	// IMP=0x0010000000025cae
- (void)_reportDeferredActionForEventCount:(id)arg1;	// IMP=0x0010000000025bec
- (_Bool)_reportCurrentActionWaitForTimeInterval:(double *)arg1;	// IMP=0x00100000000259fc
- (void)_processHandEvent:(id)arg1;	// IMP=0x0010000000025415
- (void)_processButtonUpEventType:(unsigned int)arg1 withHIDTime:(long long)arg2;	// IMP=0x0010000000025296
- (void)_processButtonDownEventType:(unsigned int)arg1 withHIDTime:(long long)arg2;	// IMP=0x0010000000024faf
- (void)_processButtonUpEvent:(id)arg1;	// IMP=0x0010000000024f35
- (void)_processButtonDownEvent:(id)arg1;	// IMP=0x0010000000024ebb
- (void)_releasePendingEvents:(double)arg1;	// IMP=0x0010000000024d3a
- (id)stringForHandEventType:(unsigned int)arg1;	// IMP=0x0010000000024b51
- (id)_elementSnapshotForLocation:(struct CGPoint)arg1 rootElementSnapshot:(id *)arg2;	// IMP=0x0010000000024760
- (void)_handleHIDEventReceived:(id)arg1;	// IMP=0x0010000000024361
- (void)stopRecording;	// IMP=0x0010000000023f8c
- (void)_registerForKeyEventNotification;	// IMP=0x0010000000023afe
- (void)startRecordingProcessPID:(int)arg1 applicationSnapshotAttributes:(id)arg2 applicationSnapshotParameters:(id)arg3 elementSnapshotAttributes:(id)arg4 elementSnapshotParameters:(id)arg5 simpleTargetGestureNames:(id)arg6;	// IMP=0x00100000000231ff
- (void)dealloc;	// IMP=0x0010000000023137
- (id)initWithAXManager:(id)arg1;	// IMP=0x00100000000230d9
- (id)initWithError:(id *)arg1;	// IMP=0x001000000002301b
