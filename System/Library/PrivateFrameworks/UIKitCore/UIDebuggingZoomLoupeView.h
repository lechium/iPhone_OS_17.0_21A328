...
- (void).cxx_destruct;	// IMP=0x00000000014ce393
...
- (void)drawRect:(struct CGRect)arg1;	// IMP=0x00000000014cdd69
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000014cdcd8
