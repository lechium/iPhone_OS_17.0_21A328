...
+ (id)ruleWithLHS:(id)arg1 RHS:(id)arg2 nodeEvaluator:(CDUnknownBlockType)arg3;	// IMP=0x00600000000b3f75
- (void).cxx_destruct;	// IMP=0x00000000000b45c3
...
- (id)description;	// IMP=0x00000000000b45a6
