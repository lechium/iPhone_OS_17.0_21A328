...
- (void).cxx_destruct;	// IMP=0x00200000000f6e52
...
- (id)generateLinkReport:(double)arg1 isCurrentLink:(_Bool)arg2;	// IMP=0x00100000000f6b17
- (void)_didReceiveData:(id)arg1;	// IMP=0x00100000000f6410
- (void)didReceiveData:(id)arg1;	// IMP=0x00100000000f6371
- (void)setHasSpaceAvailable:(_Bool)arg1;	// IMP=0x00100000000f6128
- (unsigned long long)sendPacketBufferArray:(struct **)arg1 arraySize:(int)arg2 toDeviceUniqueID:(id)arg3 cbuuid:(id)arg4;	// IMP=0x00100000000f611d
- (unsigned long long)sendPacketBuffer:(CDStruct_a8d8a807 *)arg1 toDeviceUniqueID:(id)arg2 cbuuid:(id)arg3;	// IMP=0x00100000000f5ed0
- (id)copyLinkStatsDict;	// IMP=0x00100000000f5db5
@property(readonly, getter=linkTypeString) NSString *linkTypeString;
@property(readonly) unsigned long long headerOverhead;
- (void)start;	// IMP=0x00100000000f5d43
- (void)triggerBTCorruptionRecovery;	// IMP=0x00100000000f5d31
- (void)_localDetectedCorruption;	// IMP=0x00100000000f5d2b
- (void)dealloc;	// IMP=0x00100000000f5ce0
- (id)initWithWPLinkManager:(id)arg1 withIdentifier:(id)arg2;	// IMP=0x00100000000f5b9e
