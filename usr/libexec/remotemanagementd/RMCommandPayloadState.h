...
- (void)markPending;	// IMP=0x0020000000024e6a
- (void)markFailedWithError:(id)arg1 reasons:(id)arg2;	// IMP=0x0010000000024b21
- (void)markExecutedWithResult:(id)arg1 reasons:(id)arg2 unknownPayloadKeys:(id)arg3;	// IMP=0x00100000000247b3
- (void)markQueued;	// IMP=0x0010000000024750
