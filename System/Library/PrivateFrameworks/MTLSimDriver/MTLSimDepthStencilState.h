...
- (unsigned int)depthStencilRef;	// IMP=0x0000000000013070
- (void)dealloc;	// IMP=0x0000000000012fa6
- (id)initWithDescriptor:(id)arg1 reference:(unsigned int)arg2 device:(id)arg3;	// IMP=0x0000000000012f5e
