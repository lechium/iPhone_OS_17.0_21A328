...
- (void).cxx_destruct;	// IMP=0x0020000000129fab
...
- (id)classIDFromHandout:(id)arg1;	// IMP=0x0010000000129dfc
- (_Bool)isIncompleteHandout:(id)arg1;	// IMP=0x0010000000129c50
- (void)fireTriggerWithNotificationData:(id)arg1;	// IMP=0x0010000000129bbc
- (id)initWithDatabase:(id)arg1;	// IMP=0x0010000000129b51
