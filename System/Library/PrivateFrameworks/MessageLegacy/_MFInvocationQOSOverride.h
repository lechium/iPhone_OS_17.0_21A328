...
- (_Bool)removeOverride;	// IMP=0x0000000000018625
- (void)applyOverrideWhileForeground:(_Bool)arg1;	// IMP=0x0000000000018578
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000001850d
- (unsigned long long)hash;	// IMP=0x00000000000184fb
- (void)dealloc;	// IMP=0x00000000000184bd
- (id)initWithPthread:(struct _opaque_pthread_t *)arg1 desiredQoS:(unsigned int)arg2 lowPriority:(_Bool)arg3;	// IMP=0x000000000001846b
