...
- (void)clearCache;	// IMP=0x00100000000035ec
- (void)scheduleCacheOperation:(unsigned long long)arg1;	// IMP=0x00100000000034cc
- (void)start;	// IMP=0x00100000000033b8
- (id)initWithServiceName:(id)arg1;	// IMP=0x00100000000030ae
- (id)generateStoreUnitWithRequest:(id)arg1 validationToken:(id *)arg2;	// IMP=0x001000000000433d
- (void)clearCachedItemsForBundeID:(id)arg1 reply:(CDUnknownBlockType)arg2;	// IMP=0x00100000000042e3
- (void)generateImageWithRequest:(id)arg1 reply:(CDUnknownBlockType)arg2;	// IMP=0x0010000000003b60
- (void)fetchCacheConfigurationWithReply:(CDUnknownBlockType)arg1;	// IMP=0x0010000000003941
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x0010000000003782
