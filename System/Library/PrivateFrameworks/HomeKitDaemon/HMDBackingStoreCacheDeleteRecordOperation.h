...
- (void).cxx_destruct;	// IMP=0x000000000022aade
...
- (id)mainReturningError;	// IMP=0x000000000022a662
- (id)initWithGroup:(id)arg1 recordNames:(id)arg2 resultBlock:(CDUnknownBlockType)arg3;	// IMP=0x000000000022a5ac
