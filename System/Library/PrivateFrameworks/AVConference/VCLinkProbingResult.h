...
- (id)description;	// IMP=0x00000000003f8cba
- (unsigned char)getPLRTierFromPLREnvelope:(double)arg1;	// IMP=0x00000000003f8c11
- (void)updateLinkStatsWithArrivingNewValueMeanRTT:(double)arg1 arrivingNewValuePLR:(double)arg2;	// IMP=0x00000000003f8a67
- (void)updateProbingResult:(id)arg1 initialResult:(_Bool)arg2;	// IMP=0x00000000003f85da
- (void)mergeProbingResults:(id)arg1;	// IMP=0x00000000003f85c6
- (void)dealloc;	// IMP=0x00000000003f854b
- (id)initWithProbingResults:(id)arg1 linkProbingResultConfig:(CDStruct_7421bd8e)arg2;	// IMP=0x00000000003f843d
