...
+ (_Bool)supportsSecureCoding;	// IMP=0x0020000000037271
- (void).cxx_destruct;	// IMP=0x0020000000037635
...
- (void)dealloc;	// IMP=0x00100000000374c2
- (id)description;	// IMP=0x001000000003747a
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000003730e
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000037279
