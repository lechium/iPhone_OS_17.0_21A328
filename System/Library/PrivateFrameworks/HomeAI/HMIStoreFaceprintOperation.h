...
+ (id)logCategory;	// IMP=0x006000000000fd14
- (void).cxx_destruct;	// IMP=0x000000000000fd4a
...
- (void)main;	// IMP=0x000000000000f9d2
- (id)initWithDataSource:(id)arg1 faceprint:(id)arg2;	// IMP=0x000000000000f928
