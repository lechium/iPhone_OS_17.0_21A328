...
+ (id)toVSSubscriptions:(id)arg1;	// IMP=0x001000000003f88d
- (void).cxx_destruct;	// IMP=0x000000000003fbe7
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000003fa58
- (id)toVSSubscription;	// IMP=0x000000000003f724
- (id)init;	// IMP=0x000000000003f646
