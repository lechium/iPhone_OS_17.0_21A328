...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000093f37
- (unsigned long long)hash;	// IMP=0x0000000000093f29
- (unsigned long long)intersectsTexture:(id)arg1;	// IMP=0x0000000000093da7
- (id)initWithDesc:(const struct MTLRenderPassAttachmentDescriptorPrivate *)arg1 renderTargetArrayLength:(unsigned long long)arg2;	// IMP=0x0000000000093c18
