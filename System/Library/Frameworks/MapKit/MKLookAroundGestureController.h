...
- (void).cxx_destruct;	// IMP=0x00000000001c2b50
...
- (_Bool)gestureRecognizer:(id)arg1 shouldRecognizeSimultaneouslyWithGestureRecognizer:(id)arg2;	// IMP=0x00000000001c2a7f
- (_Bool)gestureRecognizer:(id)arg1 shouldReceiveTouch:(id)arg2;	// IMP=0x00000000001c2a10
- (void)_handleZoom:(id)arg1;	// IMP=0x00000000001c235f
- (void)_handlePan:(id)arg1;	// IMP=0x00000000001c1745
- (void)_handleSingleNavigate:(id)arg1;	// IMP=0x00000000001c1101
- (void)_moveBackToReplayTap;	// IMP=0x00000000001c0cf2
- (id)initWithLookAroundView:(id)arg1;	// IMP=0x00000000001c0ab8
