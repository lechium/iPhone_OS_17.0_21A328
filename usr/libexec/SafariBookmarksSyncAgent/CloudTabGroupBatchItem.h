...
- (void).cxx_destruct;	// IMP=0x0020000000026a1a
...
- (id)initWithChange:(id)arg1 deletedRecordZoneIDs:(id)arg2 updatedRecords:(id)arg3 deletedRecordIDs:(id)arg4;	// IMP=0x001000000002688c
- (id)initWithChange:(id)arg1 deletedRecordZoneIDs:(id)arg2 deletedRecordIDs:(id)arg3;	// IMP=0x00100000000267dc
- (id)initWithChange:(id)arg1 deletedRecordZoneIDs:(id)arg2;	// IMP=0x001000000002671c
- (id)initWithChange:(id)arg1 updatedRecords:(id)arg2 deletedRecordIDs:(id)arg3;	// IMP=0x001000000002666c
- (id)initWithChange:(id)arg1 updatedRecords:(id)arg2;	// IMP=0x00100000000265d5
