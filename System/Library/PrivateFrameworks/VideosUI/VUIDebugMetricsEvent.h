...
- (void).cxx_destruct;	// IMP=0x0000000000252cd4
...
- (id)objectForKeyedSubscript:(id)arg1;	// IMP=0x0000000000252a8f
...
- (id)_sortKeys:(id)arg1;	// IMP=0x00000000002527dc
- (id)initWithEventDictionary:(id)arg1 termCollater:(id)arg2;	// IMP=0x0000000000251b3e
