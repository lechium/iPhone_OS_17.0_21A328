...
- (void).cxx_destruct;	// IMP=0x00000000001f91f2
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001f910e
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001f8f62
- (id)initWithObservationsRecipient:(id)arg1;	// IMP=0x00000000001f8f19
