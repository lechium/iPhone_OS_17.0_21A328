...
- (void).cxx_destruct;	// IMP=0x0000000000e75312
- (unsigned long long)hash;	// IMP=0x0000000000e74a04
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000e7487c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000e74615
- (void)writeTo:(id)arg1;	// IMP=0x0000000000e74183
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000e74174
- (id)jsonRepresentation;	// IMP=0x0000000000e6f019
- (id)dictionaryRepresentation;	// IMP=0x0000000000e6eb0c
- (id)description;	// IMP=0x0000000000e6ea5d
- (id)initWithData:(id)arg1;	// IMP=0x0000000000e6daa6
- (id)init;	// IMP=0x0000000000e6da4a
