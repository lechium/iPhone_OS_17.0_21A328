...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000003857
- (unsigned long long)hash;	// IMP=0x0010000000003736
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000003546
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000033b1
- (void)copyTo:(id)arg1;	// IMP=0x0010000000003276
- (void)writeTo:(id)arg1;	// IMP=0x0010000000003135
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000003128
- (id)dictionaryRepresentation;	// IMP=0x0010000000002b3e
- (id)description;	// IMP=0x0010000000002a8f
