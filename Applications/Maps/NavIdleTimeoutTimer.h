...
- (void).cxx_destruct;	// IMP=0x0020000000d0995c
...
- (void)_handleTimer;	// IMP=0x0010000000d097e7
- (void)_invalidateTimer;	// IMP=0x0010000000d0975f
- (void)_scheduleTimer;	// IMP=0x0010000000d09481
- (void)_handleGesture:(id)arg1;	// IMP=0x0010000000d09432
- (void)_handleEvent:(id)arg1;	// IMP=0x0010000000d0919d
- (void)_setupEventTap;	// IMP=0x0010000000d08f14
- (void)dealloc;	// IMP=0x0010000000d08e94
- (id)initWithView:(id)arg1 idleTimeout:(double)arg2;	// IMP=0x0010000000d08dfb
- (id)initWithView:(id)arg1;	// IMP=0x0010000000d08de1
- (id)initWithWindow:(id)arg1 idleTimeout:(double)arg2;	// IMP=0x0010000000d08d48
- (id)initWithWindow:(id)arg1;	// IMP=0x0010000000d08d2e
