...
- (void)_invalidate;	// IMP=0x0000000000010dc1
- (void)invalidate;	// IMP=0x0000000000010cd8
- (id)remoteObjectProxy;	// IMP=0x0000000000010c88
- (void)addFailureBlock:(CDUnknownBlockType)arg1;	// IMP=0x00000000000109fb
- (id)initWithFMNSXPCConnection:(id)arg1;	// IMP=0x000000000001095d
