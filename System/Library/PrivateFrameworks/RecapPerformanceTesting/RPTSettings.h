...
+ (id)processEnvironment;	// IMP=0x0040000000005653
- (void).cxx_destruct;	// IMP=0x0000000000005872
...
- (id)initFromDictionary:(id)arg1;	// IMP=0x000000000000576a
- (id)init;	// IMP=0x0000000000005714
