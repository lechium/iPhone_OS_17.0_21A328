...
+ (_Bool)needsDisplayForKey:(id)arg1;	// IMP=0x006000000000ad86
- (void).cxx_destruct;	// IMP=0x000000000000b179
...
- (void)drawInContext:(struct CGContext *)arg1;	// IMP=0x000000000000ae47
- (id)initWithLayer:(id)arg1;	// IMP=0x000000000000ab99
- (id)init;	// IMP=0x000000000000aa27
