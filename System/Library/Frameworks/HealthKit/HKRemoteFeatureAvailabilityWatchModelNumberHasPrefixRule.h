...
+ (id)ruleIdentifier;	// IMP=0x001000000014f127
- (void).cxx_destruct;	// IMP=0x000000000014f279
@property(retain, nonatomic) NSString *modelNumberPrefix; // @synthesize modelNumberPrefix=_modelNumberPrefix;
- (_Bool)evaluate;	// IMP=0x000000000014f18d
- (void)processUserInfo:(id)arg1;	// IMP=0x000000000014f134
