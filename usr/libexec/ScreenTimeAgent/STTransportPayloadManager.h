...
- (void).cxx_destruct;	// IMP=0x00200000000abbf8
...
- (void)localTransport:(id)arg1 didReceivePayload:(id)arg2;	// IMP=0x00100000000abafc
- (void)transport:(id)arg1 didReceiveUpdatedState:(unsigned long long)arg2 forPayloadUUID:(id)arg3 context:(id)arg4 error:(id)arg5;	// IMP=0x00100000000aba57
- (void)transport:(id)arg1 didReceiveData:(id)arg2 altURI:(id)arg3 appleID:(id)arg4 serverReceivedTime:(id)arg5;	// IMP=0x00100000000ab3f6
- (void)_forwardPayloadToLocalTransport:(id)arg1;	// IMP=0x00100000000aaeb0
- (void)_updatePayloadUUID:(id)arg1 toState:(unsigned long long)arg2 context:(id)arg3;	// IMP=0x00100000000aadb7
- (void)_sendPayload:(id)arg1;	// IMP=0x00100000000aa97d
- (void)_operation:(id)arg1 finishedDidChange:(_Bool)arg2;	// IMP=0x00100000000aa899
- (void)_operation:(id)arg1 executingDidChange:(_Bool)arg2;	// IMP=0x00100000000aa818
- (void)_operation:(id)arg1 cancelledDidChange:(_Bool)arg2;	// IMP=0x00100000000aa797
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x00100000000aa4f7
- (void)_processEnqueuedPayloads;	// IMP=0x00100000000a9f90
- (void)enqueuePayload:(id)arg1;	// IMP=0x00100000000a9ddc
- (void)invalidate;	// IMP=0x00100000000a9c0d
- (void)resume;	// IMP=0x00100000000a9a72
- (id)initWithTransport:(id)arg1 localTransport:(id)arg2 persistenceController:(id)arg3;	// IMP=0x00100000000a9643
