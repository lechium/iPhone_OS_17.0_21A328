...
+ (id)statusWithApplication:(id)arg1 rideOptions:(id)arg2 expirationDate:(id)arg3 userActivity:(id)arg4 rideOptionStatusError:(unsigned long long)arg5;	// IMP=0x0040000000ce9fb3
+ (id)statusWithApplication:(id)arg1 error:(unsigned long long)arg2;	// IMP=0x0010000000ce9f61
+ (id)statusWithApplication:(id)arg1 loadingRideOptions:(_Bool)arg2;	// IMP=0x0010000000ce9f11
+ (id)statusWithApplication:(id)arg1;	// IMP=0x0010000000ce9eaa
- (void).cxx_destruct;	// IMP=0x0010000000cea197
...
- (id)description;	// IMP=0x0010000000cea08f
- (id)_init;	// IMP=0x0010000000ce9e51
