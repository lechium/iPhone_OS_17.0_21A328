...
{
    id <TabCollectionView> _sourceTabView;	// 8 = 0x8
    TabDocument *_tabDocument;	// 16 = 0x10
}

- (void).cxx_destruct;	// IMP=0x0000000000115895
...
- (id)initWithTabDocument:(id)arg1 sourceTabView:(id)arg2;	// IMP=0x00000000001157cc
