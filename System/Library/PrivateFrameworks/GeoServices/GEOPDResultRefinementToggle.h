...
- (void).cxx_destruct;	// IMP=0x0000000000e97539
- (unsigned long long)hash;	// IMP=0x0000000000e9740f
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000e97222
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000e96fb0
- (void)writeTo:(id)arg1;	// IMP=0x0000000000e96d39
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000e96d2a
- (id)jsonRepresentation;	// IMP=0x0000000000e96c1a
- (id)dictionaryRepresentation;	// IMP=0x0000000000e9671e
- (id)description;	// IMP=0x0000000000e9666f
- (id)initWithData:(id)arg1;	// IMP=0x0000000000e95855
- (id)init;	// IMP=0x0000000000e957f9
