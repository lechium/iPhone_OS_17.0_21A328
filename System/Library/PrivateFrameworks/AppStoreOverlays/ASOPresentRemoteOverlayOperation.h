...
- (void)start;	// IMP=0x0000000000006081
- (void)finishExecuting;	// IMP=0x0000000000005f7e
- (void)cancel;	// IMP=0x0000000000005ebd
- (id)initWithRemoteOverlay:(id)arg1;	// IMP=0x0000000000005e4f
