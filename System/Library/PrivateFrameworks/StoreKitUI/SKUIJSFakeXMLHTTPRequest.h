...
- (void).cxx_destruct;	// IMP=0x00000000003abc6e
...
- (id)getResponseHeader:(id)arg1;	// IMP=0x00000000003ab9ec
- (id)getAllResponseHeaders;	// IMP=0x00000000003ab8fd
- (id)initWithAppContext:(id)arg1 data:(id)arg2 URLResponse:(id)arg3 performanceMetrics:(id)arg4;	// IMP=0x00000000003ab7c8
