...
+ (id)entityName;	// IMP=0x0020000000137f24
- (id)internalRepresentation;	// IMP=0x0020000000137a50
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x0010000000137189
