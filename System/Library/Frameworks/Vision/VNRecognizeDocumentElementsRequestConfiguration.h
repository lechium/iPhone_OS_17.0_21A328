...
- (void).cxx_destruct;	// IMP=0x00000000002225d5
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000222499
- (id)initWithRequestClass:(Class)arg1;	// IMP=0x00000000002223ac
