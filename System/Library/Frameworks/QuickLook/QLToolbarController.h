...
- (void).cxx_destruct;	// IMP=0x000000000001c1f5
...
- (void)setAccessoryView:(id)arg1 animated:(_Bool)arg2;	// IMP=0x000000000001bb91
...
- (void)setPreferredSuperview:(id)arg1 preferredParentViewForSafeAreaInset:(id)arg2;	// IMP=0x000000000001b98c
- (void)updateLayout;	// IMP=0x000000000001b69d
- (void)restoreOriginalConfiguration;	// IMP=0x000000000001b666
- (void)restoreOriginalToolbar;	// IMP=0x000000000001b5ec
- (void)_embedAccessoryView;	// IMP=0x000000000001b4c2
- (double)_toolbarExtensionHeight;	// IMP=0x000000000001b466
- (double)_totalHeight;	// IMP=0x000000000001b3c8
- (void)_layoutAccessoryView:(id)arg1;	// IMP=0x000000000001b255
- (double)_originalToolbarHeightIncludingSafeAreaBottomInset:(_Bool)arg1;	// IMP=0x000000000001b1b6
- (double)_computeClippingExtensionContainerHeightForCurrentHiddenProgress;	// IMP=0x000000000001b15a
- (double)_computeClippingExtensionContainerBottomConstraint;	// IMP=0x000000000001b0e3
- (double)_toolbarSafeAreaInsetBottom;	// IMP=0x000000000001afe8
- (_Bool)_tryToSetUp:(_Bool)arg1;	// IMP=0x000000000001a82f
- (id)init;	// IMP=0x000000000001a7e6
