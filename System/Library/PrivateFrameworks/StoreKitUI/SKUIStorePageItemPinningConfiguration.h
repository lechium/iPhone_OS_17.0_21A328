...
- (void)invalidatePinningTransitionStyle;	// IMP=0x00000000002cf42e
- (void)invalidatePinningGroup;	// IMP=0x00000000002cf3cf
- (void)invalidatePinningStyle;	// IMP=0x00000000002cf370
- (void)invalidatePinningContentInset;	// IMP=0x00000000002cf303
