...
- (void).cxx_destruct;	// IMP=0x0000000000010904
...
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x000000000000fdb1
- (void)_fontSizeDidChange:(id)arg1;	// IMP=0x000000000000fd9d
- (id)_buttonBackgroundImageForState:(unsigned long long)arg1 traits:(id)arg2;	// IMP=0x000000000000fbae
- (void)_buttonPressed:(id)arg1;	// IMP=0x000000000000fb35
- (void)dealloc;	// IMP=0x000000000000fab3
- (id)initWithNibName:(id)arg1 bundle:(id)arg2;	// IMP=0x000000000000e25e
