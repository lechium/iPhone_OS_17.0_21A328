...
- (void).cxx_destruct;	// IMP=0x00200000001e95bb
- (long long)readBytes:(char *)arg1 length:(unsigned long long)arg2 error:(id *)arg3;	// IMP=0x00100000001e94f2
- (void)close;	// IMP=0x00100000001e94a8
