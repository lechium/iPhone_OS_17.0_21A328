...
+ (id)moveStepFaultInjectionWithMoveStep:(long long)arg1 workItemDelay:(double)arg2;	// IMP=0x00400000000be1c2
...
- (id)initWithMoveStep:(long long)arg1 workItemDelay:(double)arg2;	// IMP=0x00100000000be1fb
