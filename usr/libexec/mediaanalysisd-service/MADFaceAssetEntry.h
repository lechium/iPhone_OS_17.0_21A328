...
+ (id)entryWithAsset:(id)arg1 previousStatus:(unsigned long long)arg2 previousAttempts:(unsigned long long)arg3 andLastAttemptDate:(id)arg4;	// IMP=0x004000000007d60c
- (void).cxx_destruct;	// IMP=0x002000000007d74c
@property(retain, nonatomic) NSURL *downloadURL; // @synthesize downloadURL=_downloadURL;
- (void)setDownloadResource:(id)arg1;	// IMP=0x001000000007d720
- (id)downloadResource;	// IMP=0x001000000007d716
...
- (id)initWithAsset:(id)arg1 previousStatus:(unsigned long long)arg2 previousAttempts:(unsigned long long)arg3 andLastAttemptDate:(id)arg4;	// IMP=0x001000000007d500
