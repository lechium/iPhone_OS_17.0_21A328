...
- (unsigned long long)hash;	// IMP=0x000000000029fe8d
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000029fdf8
- (id)description;	// IMP=0x000000000029fda3
- (void)dealloc;	// IMP=0x000000000029fd3f
- (id)initWithStreamToken:(long long)arg1 format:(struct AudioStreamBasicDescription)arg2 bufferLength:(double)arg3;	// IMP=0x000000000029fb16
