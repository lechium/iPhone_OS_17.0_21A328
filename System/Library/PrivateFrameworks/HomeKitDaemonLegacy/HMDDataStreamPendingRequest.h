...
- (void).cxx_destruct;	// IMP=0x000000000031649b
...
- (unsigned long long)hash;	// IMP=0x0000000000316425
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000316350
- (id)initWithIdentifier:(id)arg1 protocol:(id)arg2 topic:(id)arg3 payload:(id)arg4 callback:(CDUnknownBlockType)arg5;	// IMP=0x000000000031624b
