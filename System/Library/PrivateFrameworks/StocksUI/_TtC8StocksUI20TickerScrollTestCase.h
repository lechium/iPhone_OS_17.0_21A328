...
@interface _TtC8StocksUI20TickerScrollTestCase : NSObject
{
...
- (void).cxx_destruct;	// IMP=0x000000000036f0c0
- (id)init;	// IMP=0x000000000036f070
- (id)scrollViewWithContext:(id)arg1;	// IMP=0x000000000036ef20
