...
- (void).cxx_destruct;	// IMP=0x000000000194df63
- (id)init;	// IMP=0x000000000194df14
- (void)scene:(id)arg1 willConnectToSession:(id)arg2 options:(id)arg3;	// IMP=0x000000000194de5d
