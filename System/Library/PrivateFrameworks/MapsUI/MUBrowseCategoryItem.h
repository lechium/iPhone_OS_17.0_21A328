...
- (void).cxx_destruct;	// IMP=0x00000000000f8eb7
...
- (id)imageWithSearchCategory:(id)arg1 nightMode:(_Bool)arg2;	// IMP=0x00000000000f8dd9
- (id)initWithCategory:(id)arg1 nightMode:(_Bool)arg2;	// IMP=0x00000000000f8cf6
