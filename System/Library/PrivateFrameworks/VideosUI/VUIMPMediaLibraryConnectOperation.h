...
- (void).cxx_destruct;	// IMP=0x00000000002b6789
...
- (void)_notifyClientOfProgress:(float)arg1;	// IMP=0x00000000002b6586
- (void)_stopProgressTimer;	// IMP=0x00000000002b6533
- (void)_startProgressTimer;	// IMP=0x00000000002b63e3
- (void)executionDidBegin;	// IMP=0x00000000002b60aa
- (id)initWithMediaLibrary:(id)arg1;	// IMP=0x00000000002b6009
- (id)init;	// IMP=0x00000000002b5f9a
