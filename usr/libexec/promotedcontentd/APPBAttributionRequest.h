...
+ (id)options;	// IMP=0x0020000000062f70
- (void).cxx_destruct;	// IMP=0x00200000000652b4
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000064f49
- (unsigned long long)hash;	// IMP=0x00100000000648f4
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000645c2
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000064353
- (void)copyTo:(id)arg1;	// IMP=0x0010000000064155
- (void)writeTo:(id)arg1;	// IMP=0x0010000000063f4d
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000063f40
- (id)dictionaryRepresentation;	// IMP=0x0010000000063558
- (id)description;	// IMP=0x00100000000634a9
- (int)StringAsDownloadType:(id)arg1;	// IMP=0x0010000000063412
- (id)downloadTypeAsString:(int)arg1;	// IMP=0x00100000000633c9
...
- (int)StringAsRunState:(id)arg1;	// IMP=0x00100000000631f5
- (id)runStateAsString:(int)arg1;	// IMP=0x00100000000631ac
