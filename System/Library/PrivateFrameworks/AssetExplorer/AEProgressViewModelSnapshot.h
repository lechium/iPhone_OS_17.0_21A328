...
- (void).cxx_destruct;	// IMP=0x000000000002112f
...
- (id)progressForIndexPath:(struct PXSimpleIndexPath)arg1;	// IMP=0x0000000000021083
- (_Bool)hasProgressForIndexPath:(struct PXSimpleIndexPath)arg1;	// IMP=0x0000000000021026
- (id)initWithProgressByIndexPath:(id)arg1 dataSourceIdenfitier:(long long)arg2;	// IMP=0x0000000000020e03
