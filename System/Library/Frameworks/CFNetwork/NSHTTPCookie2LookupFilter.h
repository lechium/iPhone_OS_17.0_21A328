...
- (void).cxx_destruct;	// IMP=0x0000000000131a64
...
- (_Bool)matchCookie:(id)arg1;	// IMP=0x0000000000131091
- (long long)_flags;	// IMP=0x0000000000130b6c
- (id)initWithCookie:(id)arg1;	// IMP=0x00000000001309d8
