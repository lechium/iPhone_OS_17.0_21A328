...
- (void).cxx_destruct;	// IMP=0x00000000001cf44e
...
- (void)_setDocument:(id)arg1;	// IMP=0x00000000001cf18d
- (id)initWithDocument:(id)arg1 presentationOptions:(id)arg2;	// IMP=0x00000000001cf0ac
- (id)init;	// IMP=0x00000000001cf096
