...
- (void).cxx_destruct;	// IMP=0x0000000000153fa6
- (unsigned long long)hash;	// IMP=0x0000000000153e97
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000153cd0
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000153b6d
- (void)writeTo:(id)arg1;	// IMP=0x0000000000153a44
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000153a37
- (id)dictionaryRepresentation;	// IMP=0x00000000001537c8
- (id)description;	// IMP=0x0000000000153719
