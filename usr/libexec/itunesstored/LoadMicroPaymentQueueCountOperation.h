...
- (_Bool)_setCountWithResponse:(id)arg1 error:(id *)arg2;	// IMP=0x001000000008e747
- (_Bool)_loadCountReturningError:(id *)arg1;	// IMP=0x001000000008e465
- (void)run;	// IMP=0x001000000008e1aa
- (void)dealloc;	// IMP=0x001000000008e144
