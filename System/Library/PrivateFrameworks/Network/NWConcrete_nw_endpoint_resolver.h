...
- (void).cxx_destruct;	// IMP=0x00000000003a7860
- (_Bool)applyWithHandler:(id)arg1 toChildren:(CDUnknownBlockType)arg2;	// IMP=0x00000000003a7080
- (void)updatePathWithHandler:(id)arg1;	// IMP=0x00000000003a6af0
- (void)cancelWithHandler:(id)arg1 forced:(_Bool)arg2;	// IMP=0x00000000003a6480
- (void)startWithHandler:(id)arg1;	// IMP=0x00000000003a5420
- (void)dealloc;	// IMP=0x00000000003a53f0
- (id)init;	// IMP=0x00000000003a51c0
