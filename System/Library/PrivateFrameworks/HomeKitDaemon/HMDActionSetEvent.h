...
- (void).cxx_destruct;	// IMP=0x000000000068d78a
...
- (id)initWithActionSet:(id)arg1 source:(unsigned long long)arg2 numAccessories:(unsigned int)arg3 bundleId:(id)arg4 transactionId:(id)arg5;	// IMP=0x000000000068d1f9
- (id)biomeEventsRepresentationForLogObserver:(id)arg1;	// IMP=0x0000000000024a13
- (unsigned long long)microLocationScanTriggerTypeForLogEventObserver:(id)arg1;	// IMP=0x00000000000562e8
- (_Bool)shouldTriggerMicroLocationRecordingScanForLogEventObserver:(id)arg1;	// IMP=0x000000000005627a
- (_Bool)shouldTriggerMicroLocationLocalizationScanForLogEventObserver:(id)arg1;	// IMP=0x000000000005620c
- (id)microLocationMetadataForLogEventObserver:(id)arg1;	// IMP=0x0000000000056093
