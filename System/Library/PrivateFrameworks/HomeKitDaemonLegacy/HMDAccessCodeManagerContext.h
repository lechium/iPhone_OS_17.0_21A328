...
+ (id)logCategory;	// IMP=0x0010000000040c49
- (void).cxx_destruct;	// IMP=0x0000000000040a0d
...
- (id)generateAccessCodeValueFromConstraints:(id)arg1 accessoryAccessCodes:(id)arg2 homeAccessCodes:(id)arg3;	// IMP=0x000000000004097a
- (id)hapAccessoryWithUUID:(id)arg1;	// IMP=0x000000000004088f
...
- (id)userWithUUID:(id)arg1;	// IMP=0x000000000004059d
- (id)userForMessage:(id)arg1;	// IMP=0x0000000000040523
- (void)redispatchToResidentMessage:(id)arg1;	// IMP=0x000000000004046f
- (id)_performMockedReadRequests:(id)arg1;	// IMP=0x00000000000402a7
- (id)performReadRequests:(id)arg1 withRetries:(long long)arg2 timeInterval:(double)arg3 loggingObject:(id)arg4;	// IMP=0x0000000000040104
- (id)performWriteRequests:(id)arg1 withRetries:(long long)arg2 timeInterval:(double)arg3 loggingObject:(id)arg4;	// IMP=0x000000000003ff61
- (id)_performMockedWriteRequests:(id)arg1;	// IMP=0x000000000003fd99
...
- (void)configureWithMessageDispatcher:(id)arg1;	// IMP=0x000000000003f457
- (id)initWithHome:(id)arg1 workQueue:(id)arg2 UUID:(id)arg3;	// IMP=0x000000000003f2e6
- (id)initWithHome:(id)arg1 workQueue:(id)arg2;	// IMP=0x000000000003f225
