...
+ (_Bool)_navigation_isLocation:(id)arg1 equalTo:(id)arg2;	// IMP=0x002000000008f688
+ (id)_navigation_stringWithType:(int)arg1;	// IMP=0x002000000008f027
- (CDStruct_071ac149)_navigation_geoCoordinate3D;	// IMP=0x001000000008f9b6
- (CDStruct_c3b9c2ee)_navigation_geoCoordinate;	// IMP=0x001000000008f977
- (id)_navigation_geoLocation;	// IMP=0x001000000008f90b
...
- (double)_navigation_speedAccuracy;	// IMP=0x001000000008f79f
- (_Bool)_navigation_isEqualToLocationCoordinate:(struct CLLocationCoordinate2D)arg1;	// IMP=0x001000000008f712
...
- (id)initWithGeoLocation:(id)arg1;	// IMP=0x001000000008f1bf
- (id)initWithCoordinate:(struct CLLocationCoordinate2D)arg1 rawCoordinate:(struct CLLocationCoordinate2D)arg2 course:(double)arg3 rawCourse:(double)arg4 courseAccuracy:(double)arg5 speed:(double)arg6 speedAccuracy:(double)arg7 altitude:(double)arg8 timestamp:(double)arg9 horizontalAccuracy:(double)arg10 verticalAccuracy:(double)arg11 type:(int)arg12 referenceFrame:(int)arg13 serializedCoarseMetaData:(id)arg14;	// IMP=0x001000000008f062
- (id)initWithCoordinate:(struct CLLocationCoordinate2D)arg1 rawCoordinate:(struct CLLocationCoordinate2D)arg2 course:(double)arg3 rawCourse:(double)arg4 courseAccuracy:(double)arg5 speed:(double)arg6 speedAccuracy:(double)arg7 altitude:(double)arg8 timestamp:(double)arg9 horizontalAccuracy:(double)arg10 verticalAccuracy:(double)arg11 type:(int)arg12 referenceFrame:(int)arg13;	// IMP=0x001000000008f04a
@end
