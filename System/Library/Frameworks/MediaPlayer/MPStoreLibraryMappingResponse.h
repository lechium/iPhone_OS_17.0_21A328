...
- (void).cxx_destruct;	// IMP=0x000000000017987f
@property(nonatomic) long long libraryAddedStatus; // @synthesize libraryAddedStatus=_libraryAddedStatus;
- (void)setLibraryIdentifierSet:(id)arg1 forIdentifierSet:(id)arg2;	// IMP=0x00000000001797ce
- (id)libraryIdentifierSetForIdentifierSet:(id)arg1;	// IMP=0x00000000001797b8
