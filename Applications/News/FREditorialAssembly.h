...
- (void).cxx_destruct;	// IMP=0x00200000000bb288
...
- (void)loadInRegistry:(id)arg1;	// IMP=0x00100000000ba428
- (id)initWithFeldsparContext:(id)arg1 dataProviderFactory:(id)arg2;	// IMP=0x00100000000ba38f
