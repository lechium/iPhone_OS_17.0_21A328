...
+ (unsigned long long)getSSVDeviceType;	// IMP=0x002000000004913b
+ (unsigned int)SSVDefaultDistanceChannelCount;	// IMP=0x00100000000490c9
+ (unsigned int)SSVDefaultLKFSChannelCount;	// IMP=0x001000000004905c
+ (unsigned int)SSVDefaultNoiseChannelCount;	// IMP=0x0010000000048fea
- (unsigned long long)_mapInputOriginFromAssetToCSAudioRecordType:(id)arg1;	// IMP=0x0020000000042722
...
- (id)_getNumberFromASVDictionaryForKey:(id)arg1 category:(id)arg2 default:(id)arg3;	// IMP=0x00100000000484fd
...
- (unsigned long long);	// IMP=0x0010000000047644
...
- (id)_adaptiveSiriVolumeDictionary;	// IMP=0x001000000004507d
- (id)_userSelectedPhraseTypeToRTModelPhraseType:(id)arg1;	// IMP=0x0010000000068d7c
- (_Bool)_allowMultiPhrase:(id)arg1 forceSkipEngineVersionCheck:(_Bool)arg2;	// IMP=0x0010000000068bbf
- (id)_rtModelWithRequestOptions:(id)arg1 accessoryBlobs:(id)arg2;	// IMP=0x00100000000688d3
- (id)_getFilteredAccessoryRTBlobListForRequestOptions:(id)arg1 accessoryBlobs:(id)arg2 forceSkipEngineVersionCheck:(_Bool)arg3;	// IMP=0x00100000000686d6
- (id)_splitBlobsByPhraseType:(id)arg1;	// IMP=0x00100000000682d7
- (id)_buildRTModelWithBlobConfig:(id)arg1 requestOptions:(id)arg2;	// IMP=0x0010000000067caf
- (id)_sha256:(id)arg1;	// IMP=0x0010000000067bf7
- (id)_sha1:(id)arg1;	// IMP=0x0010000000067b0c
- (id)localeMapWithName:(id)arg1;	// IMP=0x001000000006790b
- (id)rtModelLocaleMapWithModelType:(long long)arg1;	// IMP=0x00100000000678d7
- (id)remoraRTModelLocaleMap;	// IMP=0x00100000000678be
- (id)jarvisRTModelLocaleMap;	// IMP=0x00100000000678a5
- (id)hearstRTModelLocaleMap;	// IMP=0x001000000006788c
- (id)hearstRTModelWithRequestOptions:(id)arg1;	// IMP=0x001000000006787a
- (id)rtModelWithRequestOptions:(id)arg1;	// IMP=0x0010000000067685
- (id)latestHearstRTModelWithRequestOptions:(id)arg1;	// IMP=0x00100000000671ae
- (id)RTModelWithFallbackLanguage:(id)arg1;	// IMP=0x0010000000067148
- (id)createRTModelWithLocale:(id)arg1;	// IMP=0x00100000000670bf
...
- (long long)multiUserDeltaScoreThresholdForPhId:(unsigned long long)arg1;	// IMP=0x00100000000b3df4
@property(readonly, nonatomic) long long multiUserConfidentScoreThreshold;
- (long long)multiUserConfidentScoreThresholdForPhId:(unsigned long long)arg1;	// IMP=0x00100000000b3cb8
@property(readonly, nonatomic) long long multiUserHighScoreThreshold;
- (long long)multiUserHighScoreThresholdForPhId:(unsigned long long)arg1;	// IMP=0x00100000000b3b7c
@property(readonly, nonatomic) long long multiUserLowScoreThreshold;
- (long long)multiUserLowScoreThresholdForPhId:(unsigned long long)arg1;	// IMP=0x00100000000b3a40
@property(readonly, nonatomic) float satScoreThreshold;
- (float)satScoreThresholdForPhId:(unsigned long long)arg1;	// IMP=0x00100000000b390a
- (id)getPhraseConfig:(unsigned long long)arg1;	// IMP=0x00100000000b37fa
...
- (_Bool)isHSVoiceTrigger:(id)arg1;	// IMP=0x0010000000110c9f
- (_Bool)isJSVoiceTrigger:(id)arg1;	// IMP=0x0010000000110bf4
- (id)getCategoryKeyWithRecordCtx:(id)arg1;	// IMP=0x0010000000110b3b
- (_Bool)shouldRunSpkrIdForCategory:(id)arg1;	// IMP=0x0010000000110b19
- (id)nldaConfigFileForCategory:(id)arg1;	// IMP=0x0010000000110a67
- (id)mitigationConfigFileForCategory:(id)arg1;	// IMP=0x00100000001109b5
...
- (id)nldaConfigFile;	// IMP=0x0010000000110816
...
- (id)mitigatonConfigFile;	// IMP=0x00100000001106b7
