...
+ (id)temporaryFileURLWithNameComponent:(id)arg1 pathExtension:(id)arg2;	// IMP=0x0020000000019328
+ (_Bool)supportsDeduplication;	// IMP=0x0010000000019320
- (void).cxx_destruct;	// IMP=0x0020000000019270
...
- (_Bool)requiresPhotosAdjustmentRendering;	// IMP=0x0010000000018fcb
- (_Bool)isMetadataTrackExtractionConversion;	// IMP=0x0010000000018f56
- (_Bool)isPassthroughConversion;	// IMP=0x0010000000018ee1
- (void)startProgressUpdateTimerAndMarkStartTime;	// IMP=0x0010000000018edb
- (void)cancel;	// IMP=0x0010000000018ed5
- (void)performConversion;	// IMP=0x0010000000018e57
- (void)didEnqueue;	// IMP=0x0010000000018df5
- (_Bool)wantsResultAsData;	// IMP=0x0010000000018d80
- (void)updateResultTracker;	// IMP=0x0010000000018c2c
- (void)callCompletionHandler;	// IMP=0x0010000000018927
- (void)loadAsset;	// IMP=0x001000000001879a
@property(readonly) NSURL *outputMainResourceURL;
@property(readonly) NSURL *sourceMainResourceURL;
- (void)resolveSourceBookmarkDictionary:(id)arg1;	// IMP=0x00100000000184a1
- (id)initWithSourceBookmarkDictionary:(id)arg1 outputURLCollection:(id)arg2 options:(id)arg3 requestTracker:(id)arg4;	// IMP=0x0010000000018351
