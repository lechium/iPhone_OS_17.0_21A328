...
- (void).cxx_destruct;	// IMP=0x00200000001c5634
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000001c5405
- (unsigned long long)hash;	// IMP=0x00100000001c52aa
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000001c5090
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000001c4ee8
- (void)copyTo:(id)arg1;	// IMP=0x00100000001c4d98
- (void)writeTo:(id)arg1;	// IMP=0x00100000001c4c2d
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000001c4c20
- (id)dictionaryRepresentation;	// IMP=0x00100000001c4373
- (id)description;	// IMP=0x00100000001c42c4
