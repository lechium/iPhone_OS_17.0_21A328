...
- (void).cxx_destruct;	// IMP=0x0020000000003492
...
- (void)_sendNextMessage;	// IMP=0x00100000000032a0
- (void)_enqueueBarrierMessage:(CDUnknownBlockType)arg1;	// IMP=0x001000000000306c
- (void)_enqueueMessage:(CDUnknownBlockType)arg1;	// IMP=0x0010000000002f35
- (void)downloadFinishedForRequest:(id)arg1 error:(id)arg2;	// IMP=0x0010000000002e29
- (void)downloadProgressedForRequest:(id)arg1 contentArchive:(id)arg2;	// IMP=0x0010000000002cc5
- (void)downloadProgressedForRequest:(id)arg1 progress:(double)arg2;	// IMP=0x0010000000002bcd
- (id)init;	// IMP=0x0010000000002a88
- (id)initWithConsumer:(id)arg1 connection:(id)arg2;	// IMP=0x00100000000029c5
