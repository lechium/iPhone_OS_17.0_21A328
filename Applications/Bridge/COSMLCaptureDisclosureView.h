...
- (void).cxx_destruct;	// IMP=0x00200000000a6875
...
- (void)tappedLearnMore:(id)arg1;	// IMP=0x00100000000a6589
- (void)layoutSubviews;	// IMP=0x00100000000a6384
- (void)userToggledSwitch:(id)arg1;	// IMP=0x00100000000a634f
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00100000000a5e95
