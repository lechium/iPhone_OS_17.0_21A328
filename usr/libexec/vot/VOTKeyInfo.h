...
- (void).cxx_destruct;	// IMP=0x0010000000118ea8
...
- (id)description;	// IMP=0x0010000000118c3b
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000001186b4
- (id)initWithEventRepresentation:(id)arg1;	// IMP=0x0010000000118551
- (void)_setCommandKeyPressed:(_Bool)arg1;	// IMP=0x0010000000118edb
