...
@class IDSConnection, IDSDeviceIdentity, IDSMessageContext, IDSProtobuf, IDSURI, NSArray, NSData, NSDictionary, NSError, NSString;
...
- (void)connection:(IDSConnection *)arg1 didCancelMessageWithSuccess:(_Bool)arg2 error:(NSError *)arg3 identifier:(NSString *)arg4;
