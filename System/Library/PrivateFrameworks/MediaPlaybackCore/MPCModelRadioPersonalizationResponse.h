...
- (void).cxx_destruct;	// IMP=0x00000000001f7e71
@property(copy, nonatomic) MPSectionedCollection *radioStationTracks; // @synthesize radioStationTracks=_radioStationTracks;
- (void)dealloc;	// IMP=0x00000000001f7dba
- (id)initWithRequest:(id)arg1 personalizationResponse:(id)arg2;	// IMP=0x00000000001f7c5d
