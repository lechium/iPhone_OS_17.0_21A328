...
- (void).cxx_destruct;	// IMP=0x0000000000214c09
...
- (id)description;	// IMP=0x0000000000214a0f
- (id)initWithName:(id)arg1 readHAPCharacteristic:(id)arg2 writeHAPCharacteristic:(id)arg3 format:(id)arg4;	// IMP=0x0000000000214871
- (id)init;	// IMP=0x00000000002147c9
