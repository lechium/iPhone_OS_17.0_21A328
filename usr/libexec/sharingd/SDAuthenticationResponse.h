...
- (void).cxx_destruct;	// IMP=0x002000000001de25
...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000001dccf
- (unsigned long long)hash;	// IMP=0x001000000001dc12
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000001dad2
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000001d9c4
- (void)copyTo:(id)arg1;	// IMP=0x001000000001d8fd
- (void)writeTo:(id)arg1;	// IMP=0x001000000001d835
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000001d828
- (id)dictionaryRepresentation;	// IMP=0x001000000001d3f8
- (id)description;	// IMP=0x001000000001d349
