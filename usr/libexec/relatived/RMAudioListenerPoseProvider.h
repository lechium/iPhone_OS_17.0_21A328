...
- (void).cxx_destruct;	// IMP=0x0020000000002bbb
...
- (void)stopProducingData;	// IMP=0x0010000000002ae5
- (id)startProducingDataWithCallback:(CDUnknownBlockType)arg1;	// IMP=0x0010000000002a27
- (id)initWithConfiguration:(id)arg1 receiverQueue:(id)arg2;	// IMP=0x0010000000002983
