...
- (_Bool)CAMLWriter:(id)arg1 shouldEncodeObject:(id)arg2;	// IMP=0x0000000000026528
- (id)CAMLWriter:(id)arg1 URLForResource:(id)arg2;	// IMP=0x00000000000261f3
- (id)CAMLWriter:(id)arg1 typeForObject:(id)arg2;	// IMP=0x0000000000026106
- (id)initWithResourceDir:(id)arg1;	// IMP=0x00000000000260a4
- (void)dealloc;	// IMP=0x0000000000026037
