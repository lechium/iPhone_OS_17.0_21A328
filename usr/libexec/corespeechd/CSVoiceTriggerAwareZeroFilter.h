...
- (void).cxx_destruct;	// IMP=0x002000000010007c
...
- (id)metrics;	// IMP=0x00100000000fffe6
- (void)flush;	// IMP=0x00100000000fff5d
- (void)processBuffer:(id)arg1 atTime:(unsigned long long)arg2;	// IMP=0x00100000000ffc6a
- (void)resetWithSampleRate:(float)arg1 containsVoiceTrigger:(_Bool)arg2 voiceTriggerInfo:(id)arg3;	// IMP=0x00100000000ff9bb
- (id)init;	// IMP=0x00100000000ff98c
