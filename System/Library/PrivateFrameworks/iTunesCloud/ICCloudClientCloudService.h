...
- (void).cxx_destruct;	// IMP=0x0000000000018c80
...
- (id)_xpcConnectionWithListenerEndpoint:(id)arg1;	// IMP=0x00000000000189aa
@property(readonly, nonatomic) NSXPCConnection *xpcConnection; // @synthesize xpcConnection=_xpcConnection;
- (id)initWithListenerEndpointProvider:(id)arg1;	// IMP=0x000000000001882f
