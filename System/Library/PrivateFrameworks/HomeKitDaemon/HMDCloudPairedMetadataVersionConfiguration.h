...
+ (id)logCategory;	// IMP=0x0010000000966578
- (void).cxx_destruct;	// IMP=0x0000000000966547
...
- (id)attributeDescriptions;	// IMP=0x0000000000966340
- (id)initWithAccessoryIdentifier:(id)arg1 jsonDictionary:(id)arg2;	// IMP=0x0000000000965f1d
- (id)initWithAccessoryIdentifier:(id)arg1 diagnostics:(id)arg2;	// IMP=0x0000000000965e6c
