...
- (void).cxx_destruct;	// IMP=0x0000000000b2bdb0
...
- (id)attributeDescriptions;	// IMP=0x0000000000b2bbb8
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000b2bbad
- (id)initWithNaturalLightingEnabled:(_Bool)arg1 completion:(CDUnknownBlockType)arg2 retryCount:(unsigned long long)arg3;	// IMP=0x0000000000b2bb17
