...
- (void).cxx_destruct;	// IMP=0x0020000000bf2ac3
...
- (void)_pop;	// IMP=0x0010000000bf2908
- (void)_setTopIdentifier:(id)arg1;	// IMP=0x0010000000bf28c2
- (void)_pushItem:(id)arg1 index:(long long)arg2;	// IMP=0x0010000000bf2826
- (id)initWithSectionIdentifier:(id)arg1 sectionIndex:(long long)arg2;	// IMP=0x0010000000bf261f
