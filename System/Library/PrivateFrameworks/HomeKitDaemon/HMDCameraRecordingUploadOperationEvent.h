...
- (void).cxx_destruct;	// IMP=0x0000000000a8db53
...
- (id)attributeDescriptions;	// IMP=0x0000000000a8d71c
- (id)initWithClipModelID:(id)arg1 operation:(id)arg2;	// IMP=0x0000000000a8d669
