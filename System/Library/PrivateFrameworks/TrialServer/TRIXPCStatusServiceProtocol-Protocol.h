...
- (void)experimentHistoryRecordsWithLimit:(unsigned long long)arg1 newerThanDate:(NSDate *)arg2 privacyFilterPolicy:(unsigned char)arg3 deploymentEnvironment:(int)arg4 completion:(void (^)(NSNumber *, NSArray *, NSDate *, NSError *))arg5;
@end
