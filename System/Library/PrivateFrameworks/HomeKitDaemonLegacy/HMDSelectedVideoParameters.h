...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000076ed5
- (void).cxx_destruct;	// IMP=0x0000000000076e82
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000076d26
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000076a44
- (void)description:(id)arg1 indent:(id)arg2;	// IMP=0x000000000007681f
- (_Bool)_parseFromTLVData;	// IMP=0x0000000000076534
@property(readonly, copy) NSData *tlvData;
- (id)initWithCodec:(id)arg1 codecParameter:(id)arg2 attribute:(id)arg3 rtpParameter:(id)arg4;	// IMP=0x0000000000076254
