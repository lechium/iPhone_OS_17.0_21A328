...
+ (_Bool)supportsSecureCoding;	// IMP=0x00200000002e81e9
...
- (id)description;	// IMP=0x00100000002e8713
- (id)jsonObject;	// IMP=0x00100000002e8526
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00100000002e8445
- (id)initWithCoder:(id)arg1;	// IMP=0x00100000002e832d
- (void)dealloc;	// IMP=0x00100000002e82f2
- (id)initWithAccessPoint:(struct AccessPoint)arg1;	// IMP=0x00100000002e81f1
