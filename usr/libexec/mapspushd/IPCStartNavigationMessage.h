...
+ (id)startNavigationMessageWithLoadDirectionsMessage:(id)arg1;	// IMP=0x004000000001ecd4
- (void).cxx_destruct;	// IMP=0x002000000001f310
...
- (_Bool)matchesLoadDirectionsMessage:(id)arg1;	// IMP=0x001000000001f188
- (id)description;	// IMP=0x001000000001f0d9
- (id)dictionaryValue;	// IMP=0x001000000001ef09
- (id)initWithDictionary:(id)arg1;	// IMP=0x001000000001ed26
