...
- (void).cxx_destruct;	// IMP=0x002000000003328b
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000330f1
@property(readonly, nonatomic) RestoreDownloadItem *restoreDownloadItem;
@property(readonly, copy, nonatomic) NSDictionary *dictionaryRepresentation;
- (id)initWithDictionaryRepresentation:(id)arg1;	// IMP=0x0010000000032b74
- (id)initWithApplication:(id)arg1;	// IMP=0x00100000000329e3
