...
+ (id)parsedFromData:(id)arg1 error:(id *)arg2;	// IMP=0x00100000004d6bbe
+ (id)ruleFromFirewallRuleLAN:(id)arg1;	// IMP=0x001000000045f61f
- (void).cxx_destruct;	// IMP=0x00000000004d40fc
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000004d3bd6
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000004d3af7
- (id)serializeWithError:(id *)arg1;	// IMP=0x00000000004d3658
- (_Bool)parseFromData:(id)arg1 error:(id *)arg2;	// IMP=0x00000000004d31a5
- (id)initWithDirection:(id)arg1 lanIdentifierList:(id)arg2 destinationIPAddress:(id)arg3 icmpTypeList:(id)arg4;	// IMP=0x00000000004d30bd
- (id)init;	// IMP=0x00000000004d308e
- (void)addTo:(id)arg1;	// IMP=0x000000000045dd1a
