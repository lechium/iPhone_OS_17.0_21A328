...
- (void)remNotifications:(id)arg1;	// IMP=0x0000000000017681
- (void)addNotifications:(id)arg1;	// IMP=0x000000000001763f
- (_Bool)interestedInNotification:(id)arg1;	// IMP=0x00000000000175f8
- (void)dealloc;	// IMP=0x0000000000017588
@property(readonly) int pid; // @dynamic pid;
- (id)initWithConnection:(id)arg1;	// IMP=0x00000000000174d3
