...
+ (id)tupleWithAccessoryUUID:(id)arg1 reachable:(_Bool)arg2;	// IMP=0x00600000000c2073
- (void).cxx_destruct;	// IMP=0x00000000000c2060
...
- (id)description;	// IMP=0x00000000000c1e60
- (unsigned long long)hash;	// IMP=0x00000000000c1e1c
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000c1d8b
