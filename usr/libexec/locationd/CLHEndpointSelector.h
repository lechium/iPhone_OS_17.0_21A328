...
- (id)description;	// IMP=0x0010000000df8be2
- (id)jsonObject;	// IMP=0x0010000000df8a68
- (void)updateEndpoint:(id *)arg1 withKey:(id)arg2;	// IMP=0x0010000000df88f7
- (void)refresh;	// IMP=0x0010000000df880b
- (void)dealloc;	// IMP=0x0010000000df8789
- (id)init;	// IMP=0x0010000000df85e6
