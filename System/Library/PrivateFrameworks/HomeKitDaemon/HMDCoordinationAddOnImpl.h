...
- (void).cxx_destruct;	// IMP=0x0000000000aecdee
@property(nonatomic) __weak id <HMDCoordinationAddOnImplDelegate> delegate; // @synthesize delegate=_delegate;
- (void)didChangeNodesForMeshController:(id)arg1;	// IMP=0x0000000000aecd65
- (void)meshController:(id)arg1 didTransitionToState:(unsigned long long)arg2;	// IMP=0x0000000000aeccea
