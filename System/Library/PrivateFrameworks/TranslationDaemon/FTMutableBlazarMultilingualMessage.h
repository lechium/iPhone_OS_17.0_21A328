...
+ (long long)session_message_typeForObject:(id)arg1;	// IMP=0x006000000009d34e
+ (long long)session_message_typeForMutableObject:(id)arg1;	// IMP=0x006000000009d0d4
+ (Class)session_message_mutableClassForType:(long long)arg1;	// IMP=0x006000000009d09a
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000009c079
- (id)init;	// IMP=0x000000000009bfeb
