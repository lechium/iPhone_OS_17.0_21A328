...
- (void).cxx_destruct;	// IMP=0x002000000017dd19
...
- (void)insertText:(id)arg1;	// IMP=0x001000000017db30
- (void)deleteBackward;	// IMP=0x001000000017daaa
- (_Bool)canBecomeFirstResponder;	// IMP=0x001000000017daa2
@property(nonatomic) long long autocorrectionType;
@property(nonatomic) long long autocapitalizationType;
- (void)_updateLabels;	// IMP=0x001000000017d60d
- (void)touchesBegan:(id)arg1 withEvent:(id)arg2;	// IMP=0x001000000017d5bf
