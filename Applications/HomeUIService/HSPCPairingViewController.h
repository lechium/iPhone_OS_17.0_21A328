...
- (void).cxx_destruct;	// IMP=0x0020000000040f37
...
- (void)updatePairingStatus:(id)arg1;	// IMP=0x0010000000040dd9
- (id)commitConfiguration;	// IMP=0x0010000000040db9
- (id)iconDescriptor;	// IMP=0x0010000000040c75
- (id)initWithCoordinator:(id)arg1 config:(id)arg2;	// IMP=0x0010000000040af0
