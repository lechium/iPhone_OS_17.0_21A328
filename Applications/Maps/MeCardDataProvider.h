...
- (void).cxx_destruct;	// IMP=0x00200000007b178c
...
- (void)shortcutManagerMeCardDidChange:(id)arg1;	// IMP=0x00100000007b1759
- (void)_updateMeCardAndNotifyObservers:(_Bool)arg1;	// IMP=0x00100000007b1518
@property(readonly, nonatomic) GEOObserverHashTable *observers;
- (id)init;	// IMP=0x00100000007b1402
