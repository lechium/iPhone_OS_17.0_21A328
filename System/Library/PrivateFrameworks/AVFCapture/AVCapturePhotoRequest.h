...
+ (id)requestWithDelegate:(id)arg1 settings:(id)arg2 lensStabilizationSupported:(_Bool)arg3;	// IMP=0x0060000000046294
+ (void)initialize;	// IMP=0x0060000000046283
...
- (void)_resolveExpectedPhotoManifest;	// IMP=0x0000000000046512
...
- (void)dealloc;	// IMP=0x00000000000463f4
- (id)initWithDelegate:(id)arg1 settings:(id)arg2 lensStabilizationSupported:(_Bool)arg3;	// IMP=0x00000000000462df
