...
+ (id)_classNameFromPropertyType:(unsigned long long)arg1;	// IMP=0x0010000000236abe
- (void).cxx_destruct;	// IMP=0x0000000000236cc0
...
- (void)_updateSourceSupportsFiltering;	// IMP=0x0000000000236b80
- (id)description;	// IMP=0x0000000000236506
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000236417
- (id)init;	// IMP=0x00000000002360d4
