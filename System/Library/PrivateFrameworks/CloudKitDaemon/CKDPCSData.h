...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000034fc38
- (void).cxx_destruct;	// IMP=0x000000000034feda
...
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000034fd6b
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000034fc40
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000034fae3
- (id)description;	// IMP=0x000000000034fad1
- (id)CKPropertiesDescription;	// IMP=0x000000000034f98a
...
- (_Bool)shouldEncodePCSData;	// IMP=0x000000000034f886
- (void)dealloc;	// IMP=0x000000000034f83f
- (id)initWithPCSData:(id)arg1;	// IMP=0x000000000034f7cc
