...
- (void).cxx_destruct;	// IMP=0x0020000000189dbc
- (void)showWithFlags:(unsigned int)arg1 throttleSeconds:(int)arg2;	// IMP=0x0010000000189bdb
- (void)_handlePINEntered:(id)arg1;	// IMP=0x0010000000189a8c
- (void)_handleKeyboardWillShow:(id)arg1;	// IMP=0x00100000001896c8
- (void)handleDismissButton:(id)arg1;	// IMP=0x0010000000189614
- (void)viewDidDisappear:(_Bool)arg1;	// IMP=0x0010000000189543
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x00100000001892d5
