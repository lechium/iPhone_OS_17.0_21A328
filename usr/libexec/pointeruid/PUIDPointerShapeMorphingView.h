...
- (void).cxx_destruct;	// IMP=0x0020000000023d7a
@property(readonly, copy, nonatomic) UIBezierPath *path; // @synthesize path=_path;
- (void)_resetToStableStateWithPath:(id)arg1;	// IMP=0x00100000000239e5
- (void)setPath:(id)arg1 animated:(_Bool)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x001000000001f385
- (void)dealloc;	// IMP=0x001000000001f33c
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x001000000001ed0e
