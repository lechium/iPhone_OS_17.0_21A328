...
+ (id)settingsControllerModule;	// IMP=0x006000000012e749
+ (id)sharedInstance;	// IMP=0x006000000012e719
...
- (id)debugDescription;	// IMP=0x000000000012e3ee
- (void)setDefaultValues;	// IMP=0x000000000012e311
- (id)parentSettings;	// IMP=0x000000000012e2f8
