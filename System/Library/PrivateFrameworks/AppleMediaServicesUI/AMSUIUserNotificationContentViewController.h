...
- (void).cxx_destruct;	// IMP=0x000000000007b184
...
- (void)viewTapped:(id)arg1;	// IMP=0x000000000007b01c
- (_Bool)gestureRecognizer:(id)arg1 shouldReceiveTouch:(id)arg2;	// IMP=0x000000000007afa0
- (void)mediaPause;	// IMP=0x000000000007aec7
@property(readonly, nonatomic) struct CGSize expectedContentSize;
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x000000000007a28b
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x000000000007a19b
- (void)viewWillLayoutSubviews;	// IMP=0x0000000000079838
- (void)setPreferredContentSize:(struct CGSize)arg1;	// IMP=0x00000000000797b3
- (void)loadView;	// IMP=0x000000000007938e
- (void)dealloc;	// IMP=0x00000000000792cc
- (id)initWithNotification:(id)arg1 delegate:(id)arg2;	// IMP=0x00000000000784a0
