...
+ (id)frameWorkFetchResultsWithOperationResults:(id)arg1;	// IMP=0x00600000002eb4e3
- (void).cxx_destruct;	// IMP=0x00000000002eb490
...
- (id)attributeDescriptions;	// IMP=0x00000000002eb266
- (id)initWithKeyPath:(id)arg1 setting:(id)arg2 metadata:(id)arg3 error:(id)arg4;	// IMP=0x00000000002eb178
