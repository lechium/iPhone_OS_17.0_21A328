...
@class MISSING_TYPE, NSHTTPURLResponse, NSURLAuthenticationChallenge, NSURLRequest, NSURLSession, NSURLSessionTask, NSURLSessionTaskMetrics;

@protocol NSURLSessionTaskDelegate <NSURLSessionDelegate>

@optional
- (MISSING_TYPE *)URLSession:task:didCompleteWithError: /* Error: Ran out of types for this method. */;
