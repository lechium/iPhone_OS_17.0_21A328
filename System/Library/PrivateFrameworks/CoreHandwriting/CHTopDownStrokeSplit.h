...
+ (id)writingDirectionOrderedStrokes:(id)arg1 substrokesByStrokeIdentifier:(id)arg2 writingOrientation:(long long)arg3;	// IMP=0x0060000000124320
- (void).cxx_destruct;	// IMP=0x00000000001247d0
...
- (id)initWithStrokes:(id)arg1 substrokesByStrokeIdentifier:(id)arg2 splitIndex:(long long)arg3 writingOrientation:(long long)arg4;	// IMP=0x0000000000123b80
