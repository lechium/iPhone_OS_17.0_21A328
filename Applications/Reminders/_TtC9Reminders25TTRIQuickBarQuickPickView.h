...
- (void).cxx_destruct;	// IMP=0x004000000067b040
@property(nonatomic, copy) NSArray *accessibilityElements;
@property(nonatomic) _Bool isAccessibilityElement;
- (void)itemAction:(id)arg1;	// IMP=0x001000000067ae20
- (void)_dynamicUserInterfaceTraitDidChange;	// IMP=0x001000000067a4a0
- (void)layoutSubviews;	// IMP=0x001000000067a470
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000679db0
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0010000000679d80
