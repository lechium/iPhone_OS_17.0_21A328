...
- (void).cxx_destruct;	// IMP=0x002000000006cd48
...
- (void)activityPayloadFromDevice:(id)arg1 forAdvertisementPayload:(id)arg2 command:(id)arg3 timeout:(long long)arg4 withCompletionHandler:(CDUnknownBlockType)arg5;	// IMP=0x001000000006cba8
- (id)initWithController:(id)arg1;	// IMP=0x001000000006cb3d
