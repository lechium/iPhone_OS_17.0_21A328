...
+ (id)requestWithRootView:(id)arg1 focusSystem:(id)arg2;	// IMP=0x0010000000812a78
- (void).cxx_destruct;	// IMP=0x0000000000813873
...
- (id)takeSnapshot;	// IMP=0x0000000000812ce8
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000812bc5
- (id)initWithRootView:(id)arg1 focusSystem:(id)arg2;	// IMP=0x0000000000812ae6
