...
- (void).cxx_destruct;	// IMP=0x000000000003e6b0
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x000000000003e640
- (void)didTapUnitTime:(id)arg1;	// IMP=0x000000000003de60
- (void)didTapRecord:(id)arg1;	// IMP=0x000000000003ddd0
- (void)didTapSkip:(id)arg1;	// IMP=0x000000000003dce0
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000003dbe0
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000003dbc0
