...
- (void).cxx_destruct;	// IMP=0x0020000000c5c753
- (void)proceedToSearchResultIncorrectQuestion:(id)arg1;	// IMP=0x0010000000c5c68a
- (void)proceedToPlaceClosureQuestion:(id)arg1;	// IMP=0x0010000000c5c5c1
- (void)proceedToProblemNotListedQuestion:(id)arg1;	// IMP=0x0010000000c5c4f8
- (void)proceedToNextQuestion:(id)arg1;	// IMP=0x0010000000c5c3f5
- (void)_instrumentSelectedSearch;	// IMP=0x0010000000c5c352
- (id)tableParts;	// IMP=0x0010000000c5be38
@property(readonly, nonatomic) int analyticTarget;
- (id)initWithReport:(id)arg1 question:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x0010000000c5bcc7
