...
+ (_Bool)supportsSecureCoding;	// IMP=0x004000000007906a
- (void).cxx_destruct;	// IMP=0x00200000000792d5
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00100000000791bd
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000079072
