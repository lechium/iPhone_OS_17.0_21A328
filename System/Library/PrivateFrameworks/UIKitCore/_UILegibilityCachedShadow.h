...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000a0d7b6
- (_Bool)matchesSettings:(id)arg1 strength:(double)arg2;	// IMP=0x0000000000a0d73c
- (void)dealloc;	// IMP=0x0000000000a0d6e3
