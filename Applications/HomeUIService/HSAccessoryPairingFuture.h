...
- (void).cxx_destruct;	// IMP=0x002000000005f0b6
...
- (void)updateSetupPayload:(id)arg1;	// IMP=0x001000000005ef93
@property(readonly, nonatomic) NSString *pairingStatusDescription;
@property(readonly, nonatomic) NSString *pairingStatusTitle;
- (void)pairingController:(id)arg1 didTransitionToPhase:(unsigned long long)arg2 statusTitle:(id)arg3 statusDescription:(id)arg4;	// IMP=0x001000000005eb90
- (id)cancelPairingWithError:(id)arg1;	// IMP=0x001000000005e8f3
- (id)cancelPairing;	// IMP=0x001000000005e7e9
- (id)startPairingWithHome:(id)arg1;	// IMP=0x001000000005e529
- (id)initWithPairingContext:(id)arg1 discoveredAccessory:(id)arg2 accessoryAlreadyStaged:(_Bool)arg3;	// IMP=0x001000000005e12f
- (id)initWithPairingContext:(id)arg1 accessoryAlreadyStaged:(_Bool)arg2;	// IMP=0x001000000005e115
- (id)initWithPairingContext:(id)arg1 discoveredAccessory:(id)arg2;	// IMP=0x001000000005e100
- (void)dealloc;	// IMP=0x001000000005e092
