...
+ (id)stateWithRegionContainer:(id)arg1 focusSystem:(id)arg2 clippingRect:(struct CGRect)arg3;	// IMP=0x0060000000829e31
- (void).cxx_destruct;	// IMP=0x0000000000829ee4
...
- (id)initWithRegionContainer:(id)arg1 focusSystem:(id)arg2 clippingRect:(struct CGRect)arg3;	// IMP=0x0000000000829d83
