...
- (void).cxx_destruct;	// IMP=0x0000000000a069dc
...
- (id)imageWithConfiguration:(id)arg1;	// IMP=0x0000000000a067cf
- (id)initWithData:(id)arg1;	// IMP=0x0000000000a067c6
- (id)initWithContentsOfFile:(id)arg1;	// IMP=0x0000000000a066a5
