...
+ (Class)internalTestConfigType;	// IMP=0x001000000003615a
- (void).cxx_destruct;	// IMP=0x0000000000037815
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000037442
- (unsigned long long)hash;	// IMP=0x000000000003730f
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000370e3
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000036db9
- (void)copyTo:(id)arg1;	// IMP=0x0000000000036bd5
- (void)writeTo:(id)arg1;	// IMP=0x0000000000036991
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000036984
- (id)dictionaryRepresentation;	// IMP=0x000000000003621a
- (id)description;	// IMP=0x000000000003616b
- (id)internalTestConfigAtIndex:(unsigned long long)arg1;	// IMP=0x000000000003613d
- (unsigned long long)internalTestConfigsCount;	// IMP=0x0000000000036120
- (void)addInternalTestConfig:(id)arg1;	// IMP=0x00000000000360b6
- (void)clearInternalTestConfigs;	// IMP=0x0000000000036099
