...
+ (Class)dataSourceClass;	// IMP=0x0020000000401b41
- (void).cxx_destruct;	// IMP=0x0020000000401c99
...
- (_Bool)RAPDirectionsStepsList:(id)arg1 shouldShowFlagForStep:(id)arg2 listItem:(id)arg3;	// IMP=0x0010000000401bd9
- (long long)tableViewStyle;	// IMP=0x0010000000401bce
- (id)init;	// IMP=0x0010000000401b52
