...
- (void).cxx_destruct;	// IMP=0x0020000000340537
...
- (void)setActivityProviderDelegate:(id)arg1;	// IMP=0x00100000003404cc
...
- (id)initWithPublisher:(id)arg1;	// IMP=0x0010000000340248
- (id)initWithPlaceCollection:(id)arg1 refinedMapItems:(id)arg2;	// IMP=0x001000000034010e
