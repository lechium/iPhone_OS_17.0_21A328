...
- (id)decompressedDataForData:(id)arg1 error:(id *)arg2;	// IMP=0x000000000000581e
- (void)dealloc;	// IMP=0x00000000000057e4
- (id)initWithOptions:(long long)arg1;	// IMP=0x0000000000005759
- (id)init;	// IMP=0x0000000000005742
