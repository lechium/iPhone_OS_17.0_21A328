...
- (void).cxx_destruct;	// IMP=0x00000000000673d3
...
- (void)syncTextAttributesToUI:(id)arg1;	// IMP=0x000000000006728f
- (id)convertTextAttributes:(id)arg1;	// IMP=0x000000000006714e
- (void)viewDidLayoutSubviews;	// IMP=0x0000000000066fce
- (void)setRightButtonItems:(id)arg1 animated:(_Bool)arg2;	// IMP=0x0000000000066e9d
- (void)valueChanged:(id)arg1;	// IMP=0x0000000000066cae
- (void)viewDidLoad;	// IMP=0x0000000000066687
- (id)initWithController:(id)arg1;	// IMP=0x000000000006661b
