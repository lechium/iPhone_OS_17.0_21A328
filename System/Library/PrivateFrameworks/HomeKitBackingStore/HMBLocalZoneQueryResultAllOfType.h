...
- (_Bool)bindPropertiesToStatement:(struct sqlite3_stmt *)arg1 error:(id *)arg2;	// IMP=0x000000000005487e
- (id)initWithLocalZone:(id)arg1 modelClassName:(id)arg2;	// IMP=0x00000000000546fb
