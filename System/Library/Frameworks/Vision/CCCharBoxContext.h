...
- (void)releaseAllocations;	// IMP=0x000000000022723e
- (_Bool)makeAllocationsForWidth:(unsigned long long)arg1;	// IMP=0x0000000000227130
- (void)dealloc;	// IMP=0x00000000002270bd
- (void)resetBoxBounds;	// IMP=0x00000000002270ac
- (void)copyFlagValue:(unsigned long long)arg1 toTarget:(unsigned long long)arg2 atIndex:(unsigned int)arg3;	// IMP=0x000000000022707b
- (unsigned int)checkFlag:(unsigned long long)arg1 atIndex:(unsigned int)arg2;	// IMP=0x0000000000227066
- (void)clearFlag:(unsigned long long)arg1 atIndex:(unsigned int)arg2;	// IMP=0x0000000000227053
- (void)setFlag:(unsigned long long)arg1 atIndex:(unsigned int)arg2;	// IMP=0x0000000000227043
