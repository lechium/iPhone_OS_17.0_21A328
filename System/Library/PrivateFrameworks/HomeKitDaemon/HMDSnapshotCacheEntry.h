...
- (void).cxx_destruct;	// IMP=0x0000000000ad92b2
...
- (id)description;	// IMP=0x0000000000ad91ca
- (id)initWithSnapshotCharacteristicEventUUID:(id)arg1 snapshotFile:(id)arg2 timer:(id)arg3;	// IMP=0x0000000000ad9100
