...
- (void).cxx_destruct;	// IMP=0x0020000000109918
...
- (void)_calculateNumberOfVoicingFrames;	// IMP=0x0010000000109608
- (void)_calculateSpeechVoicingLevel;	// IMP=0x001000000010936e
- (double)_calculateRMSWithFrameData:(short [80])arg1;	// IMP=0x0010000000109329
- (void)calculateShadowMicScore;	// IMP=0x0010000000108f0a
- (void)addDataToBuffer:(id)arg1;	// IMP=0x0010000000108ef4
- (id)init;	// IMP=0x0010000000108e6d
