...
- (void).cxx_destruct;	// IMP=0x002000000011eb74
...
- (id)mappedContactIdentifierForContactIdentifier:(id)arg1;	// IMP=0x001000000011eaf1
- (id)setMappedContactIdentifier:(id)arg1 relatedContactIdentifiers:(id)arg2;	// IMP=0x001000000011e7b1
- (id)coalescedNodesForNewAvailableNodes:(id)arg1;	// IMP=0x001000000011d753
- (id)init;	// IMP=0x001000000011d6de
