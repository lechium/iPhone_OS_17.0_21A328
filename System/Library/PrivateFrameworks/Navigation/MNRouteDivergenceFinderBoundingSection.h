...
- (id).cxx_construct;	// IMP=0x00000000000a0b6a
- (void).cxx_destruct;	// IMP=0x00000000000a0b42
...
- (void)_appendDescription:(id)arg1 indent:(unsigned long long)arg2;	// IMP=0x00000000000a09cd
- (id)description;	// IMP=0x00000000000a0879
- (id)boundsDescription;	// IMP=0x00000000000a0778
- (id)treeDescription;	// IMP=0x00000000000a0710
- (_Bool)containsCoordinate:(CDStruct_071ac149)arg1;	// IMP=0x00000000000a06d8
- (void)traverseWithHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000000000a0655
- (id)leafSectionsIntersectingSection:(id)arg1 paddingMapPoints:(double)arg2;	// IMP=0x00000000000a0380
