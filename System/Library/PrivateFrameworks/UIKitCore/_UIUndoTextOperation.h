...
- (void).cxx_destruct;	// IMP=0x0000000001427f7e
...
- (_Bool)supportsCoalescing;	// IMP=0x0000000001427f33
- (void)undoRedo;	// IMP=0x0000000001427f2d
- (id)initWithAffectedRange:(struct _NSRange)arg1 inputController:(id)arg2;	// IMP=0x0000000001427ea0
