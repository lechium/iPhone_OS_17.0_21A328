...
- (void).cxx_destruct;	// IMP=0x002000000004c29d
...
- (id)ts_fetchArticlesWithURL:(id)arg1;	// IMP=0x001000000004bf93
- (id)initWithFeldsparContext:(id)arg1 assetManager:(id)arg2;	// IMP=0x001000000004beb1
