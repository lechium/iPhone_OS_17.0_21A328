...
- (void).cxx_destruct;	// IMP=0x000000000001985c
- (id)nextObject;	// IMP=0x00000000000196a3
- (id)initWithAppEnumerationOptions:(unsigned long long)arg1;	// IMP=0x000000000001939b
