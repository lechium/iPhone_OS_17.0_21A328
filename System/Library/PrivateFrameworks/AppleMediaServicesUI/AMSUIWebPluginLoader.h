...
- (void).cxx_destruct;	// IMP=0x00000000000c4394
...
- (id)_loadInstalledPlugins;	// IMP=0x00000000000c3fff
- (id)pluginForBundleIdentifier:(id)arg1;	// IMP=0x00000000000c36cd
@property(readonly, nonatomic) NSArray *loadedPlugins;
- (id)initWithContext:(id)arg1;	// IMP=0x00000000000c35d4
