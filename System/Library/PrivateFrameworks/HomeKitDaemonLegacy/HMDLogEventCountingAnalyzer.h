...
- (void).cxx_destruct;	// IMP=0x000000000032c8c0
...
- (void)deleteCountersAfterDate:(id)arg1;	// IMP=0x000000000032c742
- (void)deleteCountersBeforeDate:(id)arg1;	// IMP=0x000000000032c687
- (void)runDailyTask;	// IMP=0x000000000032c616
- (void)incrementDailyCountersForEventName:(id)arg1;	// IMP=0x000000000032c4ca
- (void)incrementPeriodicCountersForEventName:(id)arg1;	// IMP=0x000000000032c37d
- (id)periodicSnapshotAtCurrentTickSeconds:(unsigned long long)arg1;	// IMP=0x000000000032c2cf
- (void)didReceiveEventFromDispatcher:(id)arg1 withCurrentTickSeconds:(unsigned long long)arg2;	// IMP=0x000000000032c1a1
- (void)didReceiveEventFromDispatcher:(id)arg1;	// IMP=0x000000000032c10d
- (id)initWithEventCountersManager:(id)arg1 dailyScheduler:(id)arg2 dateProvider:(id)arg3 systemInfo:(id)arg4 queue:(id)arg5 loggingPeriodicitySeconds:(unsigned long long)arg6 tickSecondsProviderBlock:(CDUnknownBlockType)arg7 periodicCountersLoggingBlock:(CDUnknownBlockType)arg8;	// IMP=0x000000000032bef6
- (id)initWithEventCountersManager:(id)arg1 dailyScheduler:(id)arg2 dateProvider:(id)arg3 systemInfo:(id)arg4 queue:(id)arg5;	// IMP=0x000000000032be4f
