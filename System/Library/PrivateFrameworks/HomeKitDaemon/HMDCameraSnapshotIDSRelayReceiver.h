...
+ (id)logCategory;	// IMP=0x0010000000c1f4e6
- (void).cxx_destruct;	// IMP=0x0000000000c1f1e6
...
- (void)sessionEnded:(id)arg1 withReason:(unsigned int)arg2 error:(id)arg3;	// IMP=0x0000000000c1ef61
- (void)sessionStarted:(id)arg1;	// IMP=0x0000000000c1ede7
- (void)service:(id)arg1 account:(id)arg2 inviteReceivedForSession:(id)arg3 fromID:(id)arg4 withContext:(id)arg5;	// IMP=0x0000000000c1e47b
- (void)_didReceiveData:(id)arg1 error:(id)arg2;	// IMP=0x0000000000c1e332
- (void)dealloc;	// IMP=0x0000000000c1e1c9
- (void)_handleDataFromSocket:(id)arg1;	// IMP=0x0000000000c1da90
- (void)_startDataReceive;	// IMP=0x0000000000c1d8f1
- (id)logIdentifier;	// IMP=0x0000000000c1d8a1
- (id)initWithSessionID:(id)arg1 logIdentifier:(id)arg2 machOUUID:(id)arg3 workQueue:(id)arg4 sessionInviterDeviceVerifier:(id)arg5 delegate:(id)arg6;	// IMP=0x0000000000c1d693
