...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000847ce6
- (void).cxx_destruct;	// IMP=0x0000000000847c57
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000847b41
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000847985
- (void)description:(id)arg1 indent:(id)arg2;	// IMP=0x0000000000847789
@property(readonly, copy) NSData *tlvData;
- (_Bool)_parseFromTLVData;	// IMP=0x00000000008473a7
- (id)initWithCodec:(id)arg1 codecParameters:(id)arg2 videoAttributes:(id)arg3;	// IMP=0x00000000008472dd
