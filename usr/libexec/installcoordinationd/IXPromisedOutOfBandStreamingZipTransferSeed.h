...
+ (_Bool)supportsSecureCoding;	// IMP=0x002000000003ef93
- (void).cxx_destruct;	// IMP=0x002000000003f111
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000003ef9b
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000003ee24
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000003ecab
