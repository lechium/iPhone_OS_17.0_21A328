...
- (void).cxx_destruct;	// IMP=0x00000000002da6ae
...
- (unsigned long long)hash;	// IMP=0x00000000002da5bf
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000002da497
- (id)initWithArtworkCatalog:(id)arg1 representativeSize:(struct CGSize)arg2;	// IMP=0x00000000002da3fc
