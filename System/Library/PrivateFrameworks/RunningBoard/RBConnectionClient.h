...
- (void).cxx_destruct;	// IMP=0x000000000003ed92
- (id)captureState;	// IMP=0x000000000003ed56
@property(readonly, copy, nonatomic) NSString *stateCaptureTitle;
- (void)inheritanceManager:(id)arg1 didChangeInheritances:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x000000000003dc34
@property(readonly, copy) NSString *description;
- (_Bool)hasEntitlementDomain:(unsigned long long)arg1;	// IMP=0x000000000003a8eb
- (_Bool)hasEntitlement:(id)arg1;	// IMP=0x000000000003a8d2
- (id)init;	// IMP=0x0000000000031827
