...
- (void).cxx_destruct;	// IMP=0x00200000001025ee
- (id)_scopeChangeFromShareMetadata:(id)arg1 currentUserID:(id)arg2 error:(id *)arg3;	// IMP=0x001000000010201a
- (void)_fetchSharedScopeWithCurrentUserID:(id)arg1;	// IMP=0x001000000010156c
- (void)runOperations;	// IMP=0x00100000001014eb
- (id)initWithController:(id)arg1 shareURL:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0010000000101432
