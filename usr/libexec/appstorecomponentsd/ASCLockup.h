...
+ (_Bool)supportsSecureCoding;	// IMP=0x002000000000ca38
- (void).cxx_destruct;	// IMP=0x001000000000e1a5
...
- (id)lockupWithOffer:(id)arg1;	// IMP=0x001000000000df88
- (id)lockupByAddingFeature:(id)arg1;	// IMP=0x001000000000dcd2
- (id)featureWithClass:(Class)arg1;	// IMP=0x001000000000db88
@property(readonly, copy) NSString *description;
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000000d1a5
@property(readonly) unsigned long long hash;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000000cf6d
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000000cd1d
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000000ca40
- (id)initWithID:(id)arg1 kind:(id)arg2 metrics:(id)arg3 icon:(id)arg4 heading:(id)arg5 title:(id)arg6 subtitle:(id)arg7 ageRating:(id)arg8 offer:(id)arg9;	// IMP=0x001000000000c9f7
- (id)initWithID:(id)arg1 kind:(id)arg2 metrics:(id)arg3 icon:(id)arg4 heading:(id)arg5 title:(id)arg6 subtitle:(id)arg7 ageRating:(id)arg8 offer:(id)arg9 features:(id)arg10;	// IMP=0x001000000000c7f4
- (id)initWithID:(id)arg1 kind:(id)arg2 icon:(id)arg3 heading:(id)arg4 title:(id)arg5 subtitle:(id)arg6 ageRating:(id)arg7 offer:(id)arg8;	// IMP=0x001000000000e225
...
- (id)lockupWithSignpostTags:(id)arg1;	// IMP=0x0010000000010960
