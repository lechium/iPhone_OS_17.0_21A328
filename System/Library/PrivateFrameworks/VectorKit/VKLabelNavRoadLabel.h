...
- (id).cxx_construct;	// IMP=0x00000000007b58d3
- (void).cxx_destruct;	// IMP=0x00000000007b58a4
...
- (id)description;	// IMP=0x00000000007b5767
- (id)displayGroup;	// IMP=0x00000000007b55b5
- (void)layoutForStagingWithNavContext:(struct NavContext *)arg1;	// IMP=0x00000000007b55a4
- (void)layoutWithNavContext:(struct NavContext *)arg1;	// IMP=0x00000000007b5572
...
- (id)initWithNavFeature:(id)arg1 label:(const void *)arg2 navLabelType:(int)arg3;	// IMP=0x00000000007b5431
