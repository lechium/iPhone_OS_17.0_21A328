...
typedef struct {
    ...
    double fortyFiveDegreeSouthAngleCornerRadiusSpecial;
    ...
    double laneDirectionStraightDefaultHeight;
    double laneDirectionSlightTurnDefaultHeight;
    double laneDirectionUTurnDefaultHeight;
    double laneDirectionTurnDefaultHeight;
    double laneTurnRadius;
    double laneSlightTurnStemBeforeArc;
    double laneSlightTurnStemBeforeArcShort;
    double laneSlightTurnStemBeforeArcSpecial;
    double laneSlightTurnStemAfterArc;
    double laneSharpTurnStemBeforeArc;
    double laneSharpTurnStemAfterArc;
    double laneSharpTurnSpecialStemBeforeArc;
    double laneSharpTurnSpecialStemAfterArc;
    double laneTurnStemBeforeArc;
    double laneTurnStemAfterArc;
    double laneUTurnStemBeforeArc;
    double laneUTurnArrowHeadStemAdjustment;
    double laneUTurnSpecialStemBeforeArc;
    double laneUTurnSpecialStemAfterArc;
} CDStruct_a1deb1f2;
