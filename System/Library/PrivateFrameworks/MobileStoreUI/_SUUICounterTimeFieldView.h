...
- (void).cxx_destruct;	// IMP=0x00000000002751e2
...
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000002750c9
- (void)setBackgroundColor:(id)arg1;	// IMP=0x000000000027503b
- (void)layoutSubviews;	// IMP=0x0000000000274de9
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000274c66
