...
+ (long long)session_message_typeForObject:(id)arg1;	// IMP=0x006000000009f20b
+ (long long)session_message_typeForMutableObject:(id)arg1;	// IMP=0x006000000009ee9b
+ (Class)session_message_mutableClassForType:(long long)arg1;	// IMP=0x006000000009ee61
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000009d846
- (id)init;	// IMP=0x000000000009d7b8
