...
- (void).cxx_destruct;	// IMP=0x0020000000097eb2
...
- (_Bool)stateIsNearby;	// IMP=0x0010000000097acc
- (_Bool)stateIsMedium;	// IMP=0x0010000000097a9b
- (_Bool)stateIsClose;	// IMP=0x0010000000097a89
- (void)resetTicks;	// IMP=0x00100000000978f2
@property(readonly, copy, nonatomic) NSString *name;
@property(readonly, copy, nonatomic) NSString *effectiveID;
@property(readonly, nonatomic) _Bool isReady;
- (_Bool)_canTransition:(int)arg1;	// IMP=0x0010000000097100
- (_Bool)canTransition:(int)arg1;	// IMP=0x001000000009700b
- (id)description;	// IMP=0x0010000000096cf0
