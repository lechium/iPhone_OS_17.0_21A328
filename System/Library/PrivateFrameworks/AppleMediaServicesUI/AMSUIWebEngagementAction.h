...
- (void).cxx_destruct;	// IMP=0x000000000009a250
...
- (id)_resultFromMessageResponse:(id)arg1;	// IMP=0x0000000000099f56
- (id)runAction;	// IMP=0x00000000000995d7
- (id)initWithJSObject:(id)arg1 context:(id)arg2;	// IMP=0x00000000000993af
