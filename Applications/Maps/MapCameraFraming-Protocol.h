...
@class GEOComposedRoute, GEOMapRegion, HistoryEntryRecentsItem, MKMapCamera, MKMapItem, MKMapView, MNLocation, NSArray, NSNumber, Route, SearchResult, VKLabelMarker;
@protocol POIShape;

@protocol MapCameraFraming <NSObject>
@property(readonly, nonatomic) __weak MKMapView *mapView;
- (CDStruct_02837cd9)mapRectForTripFromLocation:(MNLocation *)arg1 alongRoute:(Route *)arg2;
...
- (void)frameRoutes:(NSArray *)arg1 waypoints:(_Bool)arg2 animated:(_Bool)arg3 completion:(void (^)(_Bool))arg4;
- (void)frameRoutes:(NSArray *)arg1 animated:(_Bool)arg2 completion:(void (^)(_Bool))arg3;
@end
