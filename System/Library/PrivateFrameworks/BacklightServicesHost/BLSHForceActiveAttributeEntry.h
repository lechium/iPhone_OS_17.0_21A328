...
+ (id)activateForAttribute:(id)arg1 fromAssertion:(id)arg2 forService:(id)arg3 attributeHandler:(id)arg4;	// IMP=0x0010000000053869
- (void).cxx_destruct;	// IMP=0x0000000000053b3d
...
- (void)invalidate;	// IMP=0x0000000000053af5
- (_Bool)reactivateIfPossible;	// IMP=0x0000000000053aed
- (id)initForAttribute:(id)arg1 fromAssertion:(id)arg2 forService:(id)arg3;	// IMP=0x0000000000053a37
