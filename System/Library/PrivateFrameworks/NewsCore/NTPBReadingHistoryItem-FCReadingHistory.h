...
+ (id)readValueFromKeyValuePair:(id)arg1;	// IMP=0x00100000000181d3
+ (int)keyValuePairType;	// IMP=0x00100000000181c8
- (void)writeToKeyValuePair:(id)arg1;	// IMP=0x00100000000181e8
...
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000001726c
