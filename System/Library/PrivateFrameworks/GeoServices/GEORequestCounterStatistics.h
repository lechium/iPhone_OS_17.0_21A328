...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000326de7
- (void).cxx_destruct;	// IMP=0x00000000003273f3
...
- (id)description;	// IMP=0x0000000000327324
- (unsigned long long)countForResult:(unsigned char)arg1;	// IMP=0x00000000003272a8
- (void)addUsedInterfaces:(unsigned long long)arg1;	// IMP=0x000000000032729e
- (void)incrementCountForResult:(unsigned char)arg1;	// IMP=0x000000000032716a
- (void)incrementDuration:(double)arg1;	// IMP=0x0000000000327136
- (void)incrementBytesReceived:(unsigned long long)arg1;	// IMP=0x000000000032712c
- (void)incrementBytesTransmitted:(unsigned long long)arg1;	// IMP=0x0000000000327122
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000327049
- (unsigned long long)hash;	// IMP=0x0000000000327013
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000326f4a
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000326def
