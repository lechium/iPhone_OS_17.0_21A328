...
- (void).cxx_destruct;	// IMP=0x002000000006a969
...
- (id)groupUUID;	// IMP=0x001000000006a3ba
- (id)UUID;	// IMP=0x001000000006a3a8
@property(readonly, nonatomic) long long state;
- (id)description;	// IMP=0x001000000006a139
- (id)initWithConversationLink:(id)arg1 localMember:(id)arg2 queue:(id)arg3;	// IMP=0x001000000006a005
