...
+ (id)assetTrackInspectorWithAsset:(id)arg1 trackID:(int)arg2 trackIndex:(long long)arg3;	// IMP=0x001000000010032f
@property(readonly, nonatomic, getter=_isDefunct) _Bool defunct;
- (struct OpaqueFigSampleCursorService *)_getFigSampleCursorServiceReportingTimeAccuracy:(_Bool *)arg1;	// IMP=0x0000000000101232
- (id)makeSampleCursorAtLastSampleInDecodeOrder;	// IMP=0x00000000001011ab
- (id)makeSampleCursorAtFirstSampleInDecodeOrder;	// IMP=0x0000000000101124
- (id)makeSampleCursorWithPresentationTimeStamp:(CDStruct_1b6d18a9)arg1;	// IMP=0x0000000000101011
...
- (id)metadataForFormat:(id)arg1;	// IMP=0x0000000000100f22
...
- (CDStruct_1b6d18a9)samplePresentationTimeForTrackTime:(CDStruct_1b6d18a9)arg1;	// IMP=0x0000000000100cb4
- (id)segmentForTrackTime:(CDStruct_1b6d18a9)arg1;	// IMP=0x0000000000100995
...
- (id)_segmentsForSegmentData:(id)arg1;	// IMP=0x00000000001007c2
...
- (void)loadValuesAsynchronouslyForKeys:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000000001004e8
- (long long)statusOfValueForKey:(id)arg1 error:(id *)arg2;	// IMP=0x00000000001004d1
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001004c6
- (void)dealloc;	// IMP=0x0000000000100460
- (id)_weakReference;	// IMP=0x000000000010044f
- (id)init;	// IMP=0x0000000000100432
- (id)_initWithAsset:(id)arg1 trackIndex:(long long)arg2;	// IMP=0x000000000010041b
- (id)_initWithAsset:(id)arg1 trackID:(int)arg2;	// IMP=0x0000000000100402
- (id)_initWithAsset:(id)arg1 trackID:(int)arg2 trackIndex:(long long)arg3;	// IMP=0x0000000000100385
