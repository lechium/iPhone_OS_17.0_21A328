...
- (void)acoustic_profile_blob:(CDUnknownBlockType)arg1;	// IMP=0x0000000000144b2d
@property(copy, nonatomic) NSData *acoustic_profile_blob;
@property(copy, nonatomic) NSString *acoustic_profile_version;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000144982
- (id)init;	// IMP=0x00000000001448f4
