...
+ (id)productInfoViewWithElement:(id)arg1 existingView:(id)arg2;	// IMP=0x00100000000cf8f9
- (void).cxx_destruct;	// IMP=0x00000000000d1cfe
...
- (id)impressionableElementsContainedInDocument:(id)arg1;	// IMP=0x00000000000d17f5
- (void)layoutSubviews;	// IMP=0x00000000000d0c25
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000000d045b
- (id)preferredFocusEnvironments;	// IMP=0x00000000000d035f
- (_Bool)canBecomeFocused;	// IMP=0x00000000000d02b2
