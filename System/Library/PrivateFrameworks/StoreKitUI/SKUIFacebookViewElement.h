...
- (void).cxx_destruct;	// IMP=0x0000000000148d83
...
- (long long)pageComponentType;	// IMP=0x0000000000148d56
- (id)applyUpdatesWithElement:(id)arg1;	// IMP=0x0000000000148c8c
- (id)initWithDOMElement:(id)arg1 parent:(id)arg2 elementFactory:(id)arg3;	// IMP=0x0000000000148aa2
