...
- (void)sendMessage:(id)arg1 userInfo:(id)arg2;	// IMP=0x0000000000003eac
- (void)_handleEvent:(id)arg1;	// IMP=0x0000000000003be8
- (id)_deserializeMessage:(id)arg1;	// IMP=0x0000000000003ab0
- (void)dealloc;	// IMP=0x0000000000003a72
- (void)close;	// IMP=0x0000000000003a3c
- (id)initWithConnection:(id)arg1;	// IMP=0x0000000000003908
