...
- (void)executeEpilogue;	// IMP=0x000000000006505f
- (_Bool)executeRequestUsingConnection:(id)arg1;	// IMP=0x0000000000064bbf
- (_Bool)executeRequestCore:(id *)arg1;	// IMP=0x0000000000064b91
- (void)executePrologue;	// IMP=0x0000000000064b8b
@property(readonly, nonatomic) _Bool isWritingRequest;
@property(readonly, nonatomic) NSSQLRowCache *rowCache;
- (void)dealloc;	// IMP=0x00000000000649e2
- (id)initWithRequest:(id)arg1 context:(id)arg2 sqlCore:(id)arg3;	// IMP=0x0000000000064874
