...
- (void)removeWatchers;	// IMP=0x000000000000d770
- (void)installWatchers;	// IMP=0x000000000000d4a0
- (void)cancel;	// IMP=0x000000000000d200
- (void)_performWithPreviousResults:(id)arg1 forceNotify:(_Bool)arg2 uninstalledProxies:(id)arg3;	// IMP=0x000000000000cc60
- (void)performWithPreviousResults:(id)arg1 forceNotify:(_Bool)arg2;	// IMP=0x000000000000c510
- (void)dealloc;	// IMP=0x000000000000c3c0
- (id)initWithAttributes:(id)arg1 flags:(unsigned long long)arg2 host:(id)arg3 report:(CDUnknownBlockType)arg4;	// IMP=0x000000000000bf20
