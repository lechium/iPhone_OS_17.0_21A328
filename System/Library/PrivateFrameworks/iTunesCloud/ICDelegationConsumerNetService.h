...
- (void).cxx_destruct;	// IMP=0x000000000003ed3d
...
- (void)_updateNetServiceStatus;	// IMP=0x000000000003e830
- (void)stop;	// IMP=0x000000000003e7e5
- (void)publish;	// IMP=0x000000000003e79a
@property(readonly, nonatomic) ICDelegationServiceSecuritySettings *securitySettings;
- (void)netService:(id)arg1 didNotPublish:(id)arg2;	// IMP=0x000000000003e46f
- (void)netServiceDidPublish:(id)arg1;	// IMP=0x000000000003e3b6
- (void)netService:(id)arg1 didAcceptConnectionWithInputStream:(id)arg2 outputStream:(id)arg3;	// IMP=0x000000000003e22a
- (void)dealloc;	// IMP=0x000000000003e169
- (id)initWithUserIdentityDelegationAccountUUIDs:(id)arg1;	// IMP=0x000000000003e09e
