...
- (void).cxx_destruct;	// IMP=0x0020000000130d2e
...
- (void)deliveryController:(id)arg1 uniqueID:(id)arg2 isConnected:(_Bool)arg3;	// IMP=0x0010000000130bf3
- (void)sendMonitorMessage;	// IMP=0x0010000000130523
- (void)checkConnectivityState:(id)arg1;	// IMP=0x0010000000130285
- (id)init;	// IMP=0x0010000000130256
