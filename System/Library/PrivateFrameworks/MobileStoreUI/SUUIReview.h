...
- (void).cxx_destruct;	// IMP=0x000000000013c164
...
- (id)initWithCacheRepresentation:(id)arg1;	// IMP=0x000000000013bdca
- (id)formattedBylineWithClientContext:(id)arg1;	// IMP=0x000000000013ba95
- (id)initWithReviewDictionary:(id)arg1;	// IMP=0x000000000013b83c
