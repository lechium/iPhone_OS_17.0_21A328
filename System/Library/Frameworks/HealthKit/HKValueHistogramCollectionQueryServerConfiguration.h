...
+ (_Bool)supportsSecureCoding;	// IMP=0x0060000000220529
- (void).cxx_destruct;	// IMP=0x00000000002207a5
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000220685
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000220531
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000002204b5
