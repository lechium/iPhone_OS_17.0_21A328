...
- (void).cxx_destruct;	// IMP=0x0000000000bc81e6
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000bc8075
- (unsigned long long)hash;	// IMP=0x0000000000bc7f8f
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000bc7e27
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000bc7d0c
- (void)copyTo:(id)arg1;	// IMP=0x0000000000bc7c29
- (void)writeTo:(id)arg1;	// IMP=0x0000000000bc7b3c
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000bc7779
- (id)dictionaryRepresentation;	// IMP=0x0000000000bc7586
- (id)description;	// IMP=0x0000000000bc74d7
