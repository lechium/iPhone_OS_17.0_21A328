...
- (void).cxx_destruct;	// IMP=0x002000000007db0c
...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000007d8d0
- (unsigned long long)hash;	// IMP=0x001000000007d7cb
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000007d605
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000007d478
- (void)copyTo:(id)arg1;	// IMP=0x001000000007d355
- (void)writeTo:(id)arg1;	// IMP=0x001000000007d241
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000007d234
- (id)dictionaryRepresentation;	// IMP=0x001000000007cd25
- (id)description;	// IMP=0x001000000007cc76
...
- (int)StringAsType:(id)arg1;	// IMP=0x001000000007cac9
- (id)typeAsString:(int)arg1;	// IMP=0x001000000007ca80
