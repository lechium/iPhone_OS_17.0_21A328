...
- (void).cxx_destruct;	// IMP=0x0000000000012a33
...
- (void)cancel;	// IMP=0x00000000000127c5
- (void)executionDidBegin;	// IMP=0x00000000000127b3
- (void)_promptForPrivacyWithDisplayNameIfRequired:(id)arg1 providerID:(id)arg2 providerIsSupported:(_Bool)arg3 allowUI:(_Bool)arg4;	// IMP=0x000000000001243f
- (void)_determineProviderDisplayNameWithUI:(_Bool)arg1;	// IMP=0x0000000000011e64
- (void)_checkSupportedProviders;	// IMP=0x0000000000011790
- (void)_finishWithSupportedProviders:(id)arg1;	// IMP=0x0000000000010f0b
- (void)_checkAvailability;	// IMP=0x0000000000010d88
- (void)_continueCheckPrivacyWithAccessStatus:(unsigned long long)arg1;	// IMP=0x0000000000010be7
- (void)_checkPrivacy;	// IMP=0x0000000000010404
- (void)_checkEntitlement;	// IMP=0x00000000000102ba
- (void)_finishWithError:(id)arg1;	// IMP=0x00000000000101a1
- (id)_privacyServiceWithErrorHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000010127
- (void)dealloc;	// IMP=0x00000000000100de
- (id)init;	// IMP=0x000000000000fe8b
