...
- (void).cxx_destruct;	// IMP=0x00000000009b3631
@property(nonatomic, readonly) double accessibilityProgress;
- (struct CGSize)vui_layoutSubviews:(struct CGSize)arg1 computationOnly:(_Bool)arg2;	// IMP=0x00000000009b2912
- (void)vui_setSelected:(_Bool)arg1 animated:(_Bool)arg2 withAnimationCoordinator:(id)arg3;	// IMP=0x00000000009b274c
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000009b269d
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000009b25bb
