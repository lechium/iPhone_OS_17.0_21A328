...
- (void).cxx_destruct;	// IMP=0x00000000000fb6de
...
- (void)removeObserver:(id)arg1;	// IMP=0x00000000000fb6aa
- (void)addObserver:(id)arg1;	// IMP=0x00000000000fb6a4
- (id)initWithHFPEnabled:(_Bool)arg1;	// IMP=0x00000000000fb656
