...
- (void).cxx_destruct;	// IMP=0x000000000035a995
...
- (id)CKPropertiesDescription;	// IMP=0x000000000035a8a9
@property(readonly) double relativeStart;
@property(readonly) double absoluteStop;
- (long long)compareStopTime:(id)arg1;	// IMP=0x000000000035a798
- (long long)compareStartTime:(id)arg1;	// IMP=0x000000000035a718
@property(readonly) double executing;
@property(readonly) double queueing;
@property(readonly) double absoluteStart;
- (id)initWithOperationState:(unsigned long long)arg1 startDate:(id)arg2 duration:(double)arg3;	// IMP=0x000000000035a616
