...
+ (id)op:(unsigned long long)arg1 value:(id)arg2;	// IMP=0x004000000003083e
- (void).cxx_destruct;	// IMP=0x002000000003082e
@property(retain) NSString *value; // @synthesize value=_value;
@property unsigned long long sqlOp; // @synthesize sqlOp=_sqlOp;
- (id)initWithOperation:(unsigned long long)arg1 value:(id)arg2;	// IMP=0x0010000000030780
