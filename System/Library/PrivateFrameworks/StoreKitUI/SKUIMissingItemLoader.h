...
- (void).cxx_destruct;	// IMP=0x00000000002c7926
...
- (void)_requestItems:(id)arg1 withReason:(long long)arg2;	// IMP=0x00000000002c77ae
- (id)_existingRequestIDForItemID:(id)arg1;	// IMP=0x00000000002c7600
- (void)itemRequest:(id)arg1 didFinishWithItems:(id)arg2 invalidItemIdentifiers:(id)arg3;	// IMP=0x00000000002c7512
- (void)loadItemsWithIdentifiers:(id)arg1 reason:(long long)arg2;	// IMP=0x00000000002c720c
- (void)loadItemsForPageComponent:(id)arg1 startIndex:(long long)arg2 reason:(long long)arg3;	// IMP=0x00000000002c70d9
- (id)initWithResourceLoader:(id)arg1;	// IMP=0x00000000002c6fef
- (id)init;	// IMP=0x00000000002c6fdb
