...
+ (id)allowedClasses;	// IMP=0x00600000002ba9b8
+ (_Bool)isSupported;	// IMP=0x00600000002ba910
+ (long long)role;	// IMP=0x00600000002ba868
- (void).cxx_destruct;	// IMP=0x00000000002bac42
...
- (_Bool)processSessionData:(id)arg1 fromBundle:(id)arg2 outAccessoryUUID:(id *)arg3 outAccessoryIDSIdentifier:(id *)arg4 error:(id *)arg5;	// IMP=0x00000000002baaf9
- (id)initWithHomeManager:(id)arg1;	// IMP=0x00000000002baa83
