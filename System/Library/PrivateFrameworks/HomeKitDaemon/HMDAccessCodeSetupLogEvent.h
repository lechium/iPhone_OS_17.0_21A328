...
- (void)submitSuccess;	// IMP=0x00000000000a4546
- (void)submitFailureWithReason:(unsigned long long)arg1 error:(id)arg2;	// IMP=0x00000000000a44b5
- (id)init;	// IMP=0x00000000000a4486
