...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000350ad8
+ (id)dataWithRecord:(id)arg1;	// IMP=0x00100000003505fb
- (void).cxx_destruct;	// IMP=0x000000000035175c
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000035116e
- (void)dealloc;	// IMP=0x000000000035111c
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000350de1
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000350ae0
- (id)CKPropertiesDescription;	// IMP=0x0000000000350998
- (void)setPcs:(struct _OpaquePCSShareProtection *)arg1;	// IMP=0x0000000000350691
- (_Bool)shouldEncodePCSData;	// IMP=0x000000000035065e
- (id)itemID;	// IMP=0x000000000035064c
- (id)initWithRecord:(id)arg1;	// IMP=0x00000000003502ec
- (id)initWithPCSData:(id)arg1 recordID:(id)arg2;	// IMP=0x0000000000350274
