...
+ (id)instanceWithDictionary:(id)arg1;	// IMP=0x00100000000029bf
- (void).cxx_destruct;	// IMP=0x0000000000002b73
...
- (id)initWithMessageType:(long long)arg1;	// IMP=0x00000000000027db
- (id)initWithMessageIdentifier:(id)arg1 messageType:(long long)arg2 messagingVersion:(long long)arg3;	// IMP=0x000000000000275a
