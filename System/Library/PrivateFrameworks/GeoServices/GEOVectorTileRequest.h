...
+ (_Bool)isValid:(id)arg1;	// IMP=0x0010000000f14a00
- (void).cxx_destruct;	// IMP=0x0000000000f1627e
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000f16062
- (unsigned long long)hash;	// IMP=0x0000000000f15c55
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000f158b9
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000f15564
- (void)copyTo:(id)arg1;	// IMP=0x0000000000f152fa
- (void)writeTo:(id)arg1;	// IMP=0x0000000000f14f8d
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000f14f80
- (void)readAll:(_Bool)arg1;	// IMP=0x0000000000f147b9
- (id)initWithJSON:(id)arg1;	// IMP=0x0000000000f147a7
- (id)initWithDictionary:(id)arg1;	// IMP=0x0000000000f14033
- (id)jsonRepresentation;	// IMP=0x0000000000f14024
- (id)dictionaryRepresentation;	// IMP=0x0000000000f13a15
- (id)description;	// IMP=0x0000000000f13966
...
- (id)initWithData:(id)arg1;	// IMP=0x0000000000f122a8
- (id)init;	// IMP=0x0000000000f1224c
