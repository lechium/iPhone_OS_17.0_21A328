...
- (void).cxx_destruct;	// IMP=0x00000000000371e8
...
- (void)dequeueObject:(id)arg1 buffer:(id)arg2;	// IMP=0x00000000000371bf
- (void)enqueueObject:(id)arg1 replaceIfExists:(_Bool)arg2 buffer:(id)arg3;	// IMP=0x00000000000370b7
@property(readonly, nonatomic) NSString *descriptionType;
- (id)initWithCapacity:(unsigned long long)arg1 batchHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000037020
