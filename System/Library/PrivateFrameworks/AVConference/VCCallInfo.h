...
+ (unsigned char)getVCCurrentVersion;	// IMP=0x006000000040afcf
...
- (_Bool)supportSDPCompression;	// IMP=0x000000000040afc2
- (void)setUserAgent:(id)arg1;	// IMP=0x000000000040ae80
- (struct VoiceIOFarEndVersionInfo)audioVersionInfo:(_Bool)arg1;	// IMP=0x000000000040ae1f
@property(readonly) _Bool supportsDynamicContentsRectWithAspectPreservation;
- (_Bool)updateWithLastDecodedFrameTime:(double)arg1 time:(double)arg2;	// IMP=0x000000000040ab82
@property(readonly, nonatomic) _Bool requiresImplicitFeatureString;
- (void)dealloc;	// IMP=0x000000000040aac3
- (id)init;	// IMP=0x000000000040a8f9
