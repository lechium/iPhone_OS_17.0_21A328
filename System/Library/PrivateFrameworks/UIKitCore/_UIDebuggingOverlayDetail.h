...
+ (id)detailWithTitle:(id)arg1 detail:(id)arg2;	// IMP=0x00600000014bc563
- (void).cxx_destruct;	// IMP=0x00000000014bc64f
...
- (void)_updateForInspectedView:(id)arg1;	// IMP=0x00000000014bc5ff
