...
+ (id)customAttributes;	// IMP=0x0060000000102c5c
...
- (id)outputImage;	// IMP=0x000000000010247e
- (struct CGRect)_outputExtent;	// IMP=0x0000000000101d98
- (id)_kernel;	// IMP=0x0000000000101d78
