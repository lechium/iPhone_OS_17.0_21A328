...
+ (id)descriptionStringForTracksOfPlayerItem:(id)arg1;	// IMP=0x00600000000584a3
+ (id)descriptionStringForVideoRangeOfFormatDescription:(struct opaqueCMFormatDescription *)arg1;	// IMP=0x0060000000058478
+ (id)descriptionStringForBitRate:(double)arg1;	// IMP=0x006000000005840d
+ (id)descriptionStringForFormatOfTrack:(id)arg1;	// IMP=0x006000000005810c
- (void).cxx_destruct;	// IMP=0x000000000005a1e7
...
- (void)update;	// IMP=0x00000000000599ae
- (void)updateFromPlayerItem;	// IMP=0x0000000000058cc3
- (void)updateFromPlayer;	// IMP=0x00000000000587aa
- (void)dealloc;	// IMP=0x0000000000057fd8
