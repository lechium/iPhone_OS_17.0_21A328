...
+ (id)cachesWithRoute:(id)arg1 context:(id)arg2;	// IMP=0x004000000069f99b
- (void).cxx_destruct;	// IMP=0x00200000006a11bc
...
- (void)_roadForCoordinate:(CDStruct_c3b9c2ee)arg1 course:(double)arg2 handler:(CDUnknownBlockType)arg3;	// IMP=0x00100000006a0e04
- (void)_calculateRoadTileGroupedManeuversWithUpdateHandler:(CDUnknownBlockType)arg1;	// IMP=0x00100000006a07ec
- (void)_calculateRouteGroupedManeuvers;	// IMP=0x00100000006a00f4
- (void)_updateGroupedManeuverCounts;	// IMP=0x001000000069fbe6
- (void)recalculateGroupedManeuversCaches;	// IMP=0x001000000069fb5d
- (id)init;	// IMP=0x001000000069f901
