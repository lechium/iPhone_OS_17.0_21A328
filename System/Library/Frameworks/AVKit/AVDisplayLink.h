...
- (void).cxx_destruct;	// IMP=0x000000000014bf9e
...
- (void)linkFired:(id)arg1;	// IMP=0x000000000014be11
- (void)invalidate;	// IMP=0x000000000014bda8
- (void)startDisplayLinkUpdatesForObserver:(id)arg1 framesPerSecond:(long long)arg2 usingBlock:(CDUnknownBlockType)arg3;	// IMP=0x000000000014bc3b
