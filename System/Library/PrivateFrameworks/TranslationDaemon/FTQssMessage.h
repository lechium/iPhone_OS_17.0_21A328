...
+ (long long)container_message_typeForImmutableObject:(id)arg1;	// IMP=0x0010000000085101
+ (Class)container_message_immutableClassForType:(long long)arg1;	// IMP=0x00100000000850c7
- (void).cxx_destruct;	// IMP=0x00000000000863ba
- (id)flatbuffData;	// IMP=0x0000000000086233
- (Offset_eabeea59)addObjectToBuffer:(void *)arg1;	// IMP=0x0000000000085567
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000836b8
- (id)initWithFlatbuffData:(id)arg1 root:(const struct QssMessage *)arg2 verify:(_Bool)arg3;	// IMP=0x00000000000834d5
- (id)initWithFlatbuffData:(id)arg1 root:(const struct QssMessage *)arg2;	// IMP=0x00000000000834c0
- (id)initAndVerifyWithFlatbuffData:(id)arg1;	// IMP=0x00000000000834a6
- (id)initWithFlatbuffData:(id)arg1;	// IMP=0x000000000008348f
