...
- (void).cxx_destruct;	// IMP=0x00000000009dad3d
...
- (id)description;	// IMP=0x00000000009dac1a
- (id)initWithUUID:(id)arg1 accessoryName:(id)arg2 manufacturerName:(id)arg3 category:(id)arg4 certificationStatus:(unsigned long long)arg5 productData:(id)arg6;	// IMP=0x00000000009daaec
