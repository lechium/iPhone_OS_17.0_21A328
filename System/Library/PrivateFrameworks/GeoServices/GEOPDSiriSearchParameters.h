...
- (void).cxx_destruct;	// IMP=0x000000000067923c
- (unsigned long long)hash;	// IMP=0x00000000006790be
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000678e35
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000006788fc
- (void)writeTo:(id)arg1;	// IMP=0x0000000000678467
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000678458
- (id)jsonRepresentation;	// IMP=0x0000000000678348
- (id)dictionaryRepresentation;	// IMP=0x0000000000677865
- (id)description;	// IMP=0x00000000006777b6
- (id)initWithData:(id)arg1;	// IMP=0x0000000000676183
- (id)init;	// IMP=0x0000000000676127
