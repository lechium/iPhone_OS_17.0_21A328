...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000000801bc
- (void).cxx_destruct;	// IMP=0x000000000008018b
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000800bb
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000007fefb
- (void)description:(id)arg1 indent:(id)arg2;	// IMP=0x000000000007fdd6
- (_Bool)_parseFromTLVData;	// IMP=0x000000000007fbcc
@property(readonly, copy) NSData *tlvData;
- (id)initWithSessionControl:(id)arg1;	// IMP=0x000000000007fa3d
- (id)initWithSessionControl:(id)arg1 videoParameters:(id)arg2;	// IMP=0x000000000007f99b
