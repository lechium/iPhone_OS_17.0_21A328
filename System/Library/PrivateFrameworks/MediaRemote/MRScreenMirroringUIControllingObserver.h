...
- (void).cxx_destruct;	// IMP=0x00000000000278d8
...
- (void)_mirrorStateChanged:(_Bool)arg1 screenType:(unsigned int)arg2;	// IMP=0x00000000000276fc
- (void)dealloc;	// IMP=0x000000000002764b
- (id)init;	// IMP=0x00000000000273d5
