...
- (void).cxx_destruct;	// IMP=0x000000000002f388
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000002f23f
- (unsigned long long)hash;	// IMP=0x000000000002f235
- (void)notify:(id)arg1;	// IMP=0x000000000002f1db
- (id)initWithObserver:(id)arg1 keyPath:(id)arg2 callback:(CDUnknownBlockType)arg3;	// IMP=0x000000000002f0fe
