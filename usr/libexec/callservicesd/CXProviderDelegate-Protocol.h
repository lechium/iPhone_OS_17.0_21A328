...
@class AVAudioSession, CXAction, CXAnswerCallAction, CXEndCallAction, CXPlayDTMFCallAction, CXProvider, CXSetHeldCallAction, CXSetMutedCallAction, CXStartCallAction, CXTransaction;
