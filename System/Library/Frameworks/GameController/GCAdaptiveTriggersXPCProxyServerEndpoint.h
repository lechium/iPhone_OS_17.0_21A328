...
- (void).cxx_destruct;	// IMP=0x00000000000af0cc
...
- (void)fetchObjectIdentifierWithReply:(CDUnknownBlockType)arg1;	// IMP=0x00000000000aefd6
- (void)invalidateConnection;	// IMP=0x00000000000aef23
- (void)newAdaptiveTriggerPayload:(id)arg1 index:(int)arg2;	// IMP=0x00000000000aee25
- (void)fetchStatusesWithReply:(CDUnknownBlockType)arg1;	// IMP=0x00000000000aed7b
- (_Bool)acceptClient:(id)arg1 onConnection:(id)arg2 error:(id *)arg3;	// IMP=0x00000000000ae961
- (void)invalidateClient;	// IMP=0x00000000000ae8a0
@property(readonly, nonatomic) id <_GCControllerComponentDescription> receiverDescription;
- (id)initWithInitialStatuses:(id)arg1;	// IMP=0x00000000000ae7e4
- (id)initWithIdentifier:(id)arg1 initialStatuses:(id)arg2;	// IMP=0x00000000000ae6d5
