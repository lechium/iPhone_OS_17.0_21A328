...
- (void).cxx_destruct;	// IMP=0x000000000008c113
...
- (id)loadPage;	// IMP=0x000000000008ba8c
@property(readonly, nonatomic) _Bool disableReappearPlaceholder;
- (id)createViewControllerForContainer:(id)arg1;	// IMP=0x000000000008ba1b
- (id)initWithJSObject:(id)arg1 context:(id)arg2;	// IMP=0x000000000008b4cb
