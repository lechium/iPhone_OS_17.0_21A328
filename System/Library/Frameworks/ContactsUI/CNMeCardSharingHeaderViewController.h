...
- (void).cxx_destruct;	// IMP=0x00000000000a1804
...
- (double)desiredHeight;	// IMP=0x00000000000a1740
- (void)viewWillLayoutSubviews;	// IMP=0x00000000000a14c6
- (void)viewDidLoad;	// IMP=0x00000000000a1311
- (id)initWithAvatarViewController:(id)arg1 name:(id)arg2 layoutAttributes:(id)arg3;	// IMP=0x00000000000a1234
