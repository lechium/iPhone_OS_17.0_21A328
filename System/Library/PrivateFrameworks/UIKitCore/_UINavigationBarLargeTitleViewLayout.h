...
- (void).cxx_destruct;	// IMP=0x00000000002604b8
...
- (void)updateLayoutData:(id)arg1 layoutWidth:(double)arg2;	// IMP=0x0000000000260385
- (void)removeContent;	// IMP=0x000000000026033d
- (struct CGSize)sizeFittingSize:(struct CGSize)arg1 titleType:(long long)arg2;	// IMP=0x0000000000260315
- (struct CGSize)_cachedTitleHeightSizeAndUpdateRestingSizeForWidth:(double)arg1;	// IMP=0x000000000025fd7e
- (struct CGSize)_cachedTitleHeightSizeAndUpdateRestingSizeForWidthSupportingMultiLineShrinkToFit:(double)arg1;	// IMP=0x000000000025f5ae
- (void)_invalidateTitleHeightCache;	// IMP=0x000000000025f575
- (double)_textHeightForSize:(struct CGSize)arg1 titleType:(long long)arg2;	// IMP=0x000000000025f4ef
- (void)setContentHidden:(_Bool)arg1;	// IMP=0x000000000025f4ce
- (void)setContentAlpha:(double)arg1;	// IMP=0x000000000025f489
- (void)cleanupAfterLayoutTransitionCompleted;	// IMP=0x000000000025f477
- (void)layoutViewsWithOffset:(struct UIOffset)arg1 useRestingTitleHeight:(_Bool)arg2;	// IMP=0x000000000025eaec
- (void)layoutViewsWithOffsetSupportingMultiLineShrinkToFit:(struct UIOffset)arg1 useRestingTitleHeight:(_Bool)arg2;	// IMP=0x000000000025df34
- (void)layoutViews;	// IMP=0x000000000025df1a
- (void)_enforceLayoutOrdering;	// IMP=0x000000000025debd
- (void)updateRestingTitleHeight;	// IMP=0x000000000025dd9e
- (double)restingTitleHeightForSize:(struct CGSize)arg1 type:(long long)arg2;	// IMP=0x000000000025dd4b
- (struct CGRect)_contentLayoutBounds;	// IMP=0x000000000025dd2a
- (struct CGRect)_contentLayoutBoundsUsingRestingTitleHeight:(_Bool)arg1;	// IMP=0x000000000025dc5a
- (id)initWithContentView:(id)arg1;	// IMP=0x000000000025daeb
- (id)description;	// IMP=0x000000000025d94f
