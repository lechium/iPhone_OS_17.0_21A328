...
- (void)pictureInPictureRemoteObject:(PGPictureInPictureRemoteObject *)arg1 requestActivationOfSceneWithPersistenceIdentier:(NSString *)arg2 completion:(void (^)(_Bool))arg3;
