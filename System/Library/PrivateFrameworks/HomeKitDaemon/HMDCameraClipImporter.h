...
+ (id)logCategory;	// IMP=0x0010000000a75e6c
- (void).cxx_destruct;	// IMP=0x0000000000a750f3
...
- (id)importClipsWithImportData:(id)arg1;	// IMP=0x0000000000a744d1
- (id)initWithLocalZone:(id)arg1 cameraProfileUUID:(id)arg2;	// IMP=0x0000000000a74358
