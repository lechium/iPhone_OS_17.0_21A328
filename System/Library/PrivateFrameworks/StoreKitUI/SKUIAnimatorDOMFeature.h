...
+ (id)featureName;	// IMP=0x00100000001640a2
+ (id)makeFeatureJSObjectForFeature:(id)arg1;	// IMP=0x0010000000163fe1
- (void).cxx_destruct;	// IMP=0x0000000000164139
...
- (id)initWithDOMNode:(id)arg1 featureName:(id)arg2;	// IMP=0x0000000000163ec7
