...
- (void).cxx_destruct;	// IMP=0x000000000005f194
...
- (void)_reloadItemState;	// IMP=0x000000000005ec84
- (id)_newDefaultLabel;	// IMP=0x000000000005ebb3
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x000000000005eb44
- (void)layoutSubviews;	// IMP=0x000000000005d6d8
- (id)hitTest:(struct CGPoint)arg1 withEvent:(id)arg2;	// IMP=0x000000000005d5b6
...
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000005c63d
