...
- (void)_showVideoWithPlaybackID:(long long)arg1;	// IMP=0x000000000000d14a
- (void)_transitionToVideoWithPlaybackID:(long long)arg1;	// IMP=0x000000000000d0c5
- (void)_startPlaybackWithPlaybackID:(long long)arg1;	// IMP=0x000000000000d066
- (void)_didFinishPreparing;	// IMP=0x000000000000d014
- (void)_handleDidFinishPreroll;	// IMP=0x000000000000d002
- (void)_prerollWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000000000cf21
- (void)_handleDidSeekToBeginning;	// IMP=0x000000000000ce7d
- (void)_prepareVideoForPlaybackIfNeeded;	// IMP=0x000000000000cc36
- (void)startPlayback;	// IMP=0x000000000000cbab
- (void)activeDidChange;	// IMP=0x000000000000cb2b
- (void)videoDidPlayToEnd;	// IMP=0x000000000000cae7
- (void)_handleDidFinish;	// IMP=0x000000000000ca78
- (void)videoWillPlayToEnd;	// IMP=0x000000000000c8f7
- (long long)behaviorType;	// IMP=0x000000000000c8ec
@property(nonatomic) __weak id <ISLivePhotoPlaybackBehaviorDelegate> delegate; // @dynamic delegate;
- (id)initWithInitialLayoutInfo:(id)arg1 keyTime:(CDStruct_1b6d18a9)arg2 playbackTimeRange:(CDStruct_e83c9415)arg3 photoTransitionDuration:(double)arg4 immediatelyShowsPhotoWhenPlaybackEnds:(_Bool)arg5 hasBlurryTransition:(_Bool)arg6;	// IMP=0x000000000000c7b0
