...
- (id)description;	// IMP=0x0020000000027dab
...
- (id)resetDisavowedSessionProperties;	// IMP=0x0010000000027930
@property(readonly) NSSet *disavowedSessionProperties;
- (void)addDisavowedSessionProperties:(id)arg1;	// IMP=0x0010000000027524
- (void)dealloc;	// IMP=0x00100000000274cc
- (id)initWithInputConnection:(id)arg1;	// IMP=0x0010000000027482
