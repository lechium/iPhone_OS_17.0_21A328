...
- (void)analyzeAudioData:(void *)arg1 numberFrames:(unsigned int)arg2 observers:(id)arg3;	// IMP=0x00000000000df38f
- (void)analyzeFrequencies:(struct AudioBufferList *)arg1 numberFrames:(unsigned long long)arg2 observers:(id)arg3;	// IMP=0x00000000000df2b8
- (void)_freeBuffers;	// IMP=0x00000000000df27c
- (void)_destroyFFTSetup;	// IMP=0x00000000000df256
- (void)_prepareBuffers;	// IMP=0x00000000000df1ef
- (void)dealloc;	// IMP=0x00000000000df19c
- (id)initWithMaximumNumberOfFrames:(long long)arg1 sampleRate:(float)arg2;	// IMP=0x00000000000df0fd
