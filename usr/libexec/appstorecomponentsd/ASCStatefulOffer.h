...
+ (_Bool)supportsSecureCoding;	// IMP=0x002000000001ad50
- (void).cxx_destruct;	// IMP=0x002000000001be7a
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000001b5ec
@property(readonly) unsigned long long hash;
- (id)offerWithMetrics:(id)arg1;	// IMP=0x001000000001b272
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000001b267
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000001b05b
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000001ad58
- (id)initWithID:(id)arg1 titles:(id)arg2 subtitles:(id)arg3 flags:(long long)arg4 ageRating:(id)arg5 metrics:(id)arg6 defaultOffer:(id)arg7 buyOffer:(id)arg8 openOffer:(id)arg9;	// IMP=0x001000000001ab9e
