...
- (void).cxx_destruct;	// IMP=0x002000000011a7a7
...
- (void)dispatchStateChangedFrom:(unsigned long long)arg1 to:(unsigned long long)arg2;	// IMP=0x001000000011a315
- (void)notifyObserver:(id)arg1 didChangeStateFrom:(unsigned long long)arg2 to:(unsigned long long)arg3;	// IMP=0x001000000011a235
- (void)notifyObserver:(id)arg1 didReceiveNotificationWithToken:(int)arg2;	// IMP=0x001000000011a133
- (id)initWithDelegate:(id)arg1;	// IMP=0x0010000000119fbf
