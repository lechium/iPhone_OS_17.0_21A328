...
- (void).cxx_destruct;	// IMP=0x000000000009fb5b
...
- (id)initWithAbsoluteResumeTime:(id)arg1 absoluteTimestamp:(id)arg2 relativeResumeTime:(id)arg3 relativeBookmarkTimestamp:(id)arg4;	// IMP=0x000000000009f9b1
