...
- (void).cxx_destruct;	// IMP=0x0000000000f4421e
...
- (void)_advanceFromDisplayLink:(id)arg1;	// IMP=0x0000000000f4406d
- (void)stopAnimation;	// IMP=0x0000000000f44004
- (id)initWithDuration:(double)arg1 advanceBlock:(CDUnknownBlockType)arg2;	// IMP=0x0000000000f43e8b
- (id)init;	// IMP=0x0000000000f43e7d
