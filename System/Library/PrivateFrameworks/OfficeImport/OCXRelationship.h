...
- (void).cxx_destruct;	// IMP=0x0000000000379a00
...
- (void)writeToStreamWriter:(id)arg1;	// IMP=0x000000000037990e
- (id)initWithId:(unsigned long long)arg1 type:(id)arg2 target:(id)arg3 external:(_Bool)arg4;	// IMP=0x0000000000379779
