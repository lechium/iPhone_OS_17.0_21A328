...
+ (id)logCategory;	// IMP=0x001000000050a90d
+ (long long)colorTemperatureMiredsFromKelvins:(long long)arg1;	// IMP=0x001000000050a8ea
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000050a8e2
- (void).cxx_destruct;	// IMP=0x000000000050a7a0
...
- (id)transitionPointsWithmillisecondsElapsedSinceStartOfDay:(unsigned long long)arg1;	// IMP=0x0000000000509bd9
- (id)colorTemperatureForBrightness:(long long)arg1 millisecondsElapsedSinceStartOfDay:(unsigned long long)arg2;	// IMP=0x0000000000509a11
@property(readonly) unsigned long long checksum;
- (id)attributeDescriptions;	// IMP=0x0000000000509112
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000508fe3
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000508fd8
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000508c95
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000050885b
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000507e86
- (id)initWithCurve:(id)arg1 minimumColorTemperature:(long long)arg2 maximumColorTemperature:(long long)arg3;	// IMP=0x0000000000507915
- (id)initWithVersion:(unsigned long long)arg1 transitionPoints:(id)arg2 minimumBrightness:(long long)arg3 maximumBrightness:(long long)arg4 minimumColorTemperature:(long long)arg5 maximumColorTemperature:(long long)arg6;	// IMP=0x0000000000507847
