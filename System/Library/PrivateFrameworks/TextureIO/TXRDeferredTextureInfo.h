...
- (void).cxx_destruct;	// IMP=0x0000000000004c0c
...
- (id)initWithMipmapLevelCount:(unsigned long long)arg1 arrayLength:(unsigned long long)arg2 cubemap:(_Bool)arg3;	// IMP=0x0000000000004ae4
