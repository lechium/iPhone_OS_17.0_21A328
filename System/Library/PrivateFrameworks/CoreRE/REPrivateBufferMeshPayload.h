...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000003076d5
- (void).cxx_destruct;	// IMP=0x00000000003081ff
...
- (id)redactedDescription;	// IMP=0x0000000000308126
- (id)description;	// IMP=0x0000000000308114
@property(readonly, nonatomic, getter=isShareable) _Bool shareable;
@property(readonly, nonatomic) unsigned long long bufferSize;
- (id)bufferWithDevice:(id)arg1;	// IMP=0x0000000000307e7d
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000307c7a
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000307927
- (id)initWithBuffer:(id)arg1 parts:(id)arg2 models:(id)arg3 instances:(id)arg4;	// IMP=0x00000000003076dd
