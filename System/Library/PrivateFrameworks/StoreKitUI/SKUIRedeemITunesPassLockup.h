...
- (void).cxx_destruct;	// IMP=0x00000000001d29ca
- (id)_attributedDescriptionString;	// IMP=0x00000000001d264f
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000001d25aa
- (void)setHighlighted:(_Bool)arg1;	// IMP=0x00000000001d252e
- (void)layoutSubviews;	// IMP=0x00000000001d21af
- (id)initWithITunesPassConfiguration:(id)arg1 clientContext:(id)arg2;	// IMP=0x00000000001d1e2e
