...
- (void).cxx_destruct;	// IMP=0x00000000005d9ce1
...
- (void)setValueUpdatedTime:(id)arg1 stateNumber:(id)arg2;	// IMP=0x00000000005d9bc4
- (id)initWithError:(id)arg1;	// IMP=0x00000000005d9b56
- (id)initWithValue:(id)arg1 updateIdentifier:(id)arg2 remoteDevice:(id)arg3;	// IMP=0x00000000005d9a8c
