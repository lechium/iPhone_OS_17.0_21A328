...
- (void).cxx_destruct;	// IMP=0x000000000035bda0
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000035bca8
- (id)HTTPBodyDictionary;	// IMP=0x000000000035bb89
- (id)initWithAmountDictionary:(id)arg1;	// IMP=0x000000000035b99a
