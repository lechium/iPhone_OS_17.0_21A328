...
- (void).cxx_destruct;	// IMP=0x002000000035216e
...
- (void)purgeData;	// IMP=0x0010000000352011
- (void)saveData:(id)arg1 allowBackup:(_Bool)arg2;	// IMP=0x0010000000351dd8
- (id)data;	// IMP=0x0010000000351bda
@property(readonly, nonatomic) _Bool isAvailable;
- (id)initWithIdentifier:(id)arg1 keychainWrapper:(id)arg2 systemMonitor:(id)arg3;	// IMP=0x0010000000351ada
