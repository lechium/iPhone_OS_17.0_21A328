...
- (double)_currentTouchForceMultiplier;	// IMP=0x0000000000f37616
- (double)_normalizedTouchForceValue:(double)arg1;	// IMP=0x0000000000f375e9
- (double)_denormalizedTouchForceValue:(double)arg1;	// IMP=0x0000000000f375b8
- (double)_thresholdForForceLevel:(long long)arg1;	// IMP=0x0000000000f3754f
- (void)_accessibilityForceSensitivityChanged:(id)arg1;	// IMP=0x0000000000f3753d
- (void)reset;	// IMP=0x0000000000f37345
- (void)evaluateWithTouchForce:(double)arg1 atTimestamp:(double)arg2 withCentroidAtLocation:(struct CGPoint)arg3;	// IMP=0x0000000000f36f82
@property(readonly, nonatomic) double velocity; // @dynamic velocity;
- (double)currentProgressToState:(long long)arg1;	// IMP=0x0000000000f36e53
- (id)description;	// IMP=0x0000000000f36d80
- (void)dealloc;	// IMP=0x0000000000f36cfe
- (id)init;	// IMP=0x0000000000f36bec
