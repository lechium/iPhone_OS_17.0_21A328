...
- (void).cxx_destruct;	// IMP=0x0000000000329d37
...
- (void)_positionBadge;	// IMP=0x0000000000329ae7
- (void)_setBadgeValue:(id)arg1;	// IMP=0x000000000032992a
- (void)tintColorDidChange;	// IMP=0x000000000032953a
- (void)layoutSubviews;	// IMP=0x0000000000329192
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000328e14
