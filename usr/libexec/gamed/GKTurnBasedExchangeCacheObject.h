...
+ (id)entityName;	// IMP=0x004000000013e267
- (id)internalRepresentation;	// IMP=0x002000000013ec12
- (void)updateWithServerRepresentation:(id)arg1 participants:(id)arg2;	// IMP=0x001000000013e274
