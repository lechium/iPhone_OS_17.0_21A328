...
- (void).cxx_destruct;	// IMP=0x000000000131bfd4
...
- (void)removeOldData:(id)arg1;	// IMP=0x000000000131b759
- (void)_completeWithError:(id)arg1;	// IMP=0x000000000131b61c
- (void)populateTileGroup:(id)arg1;	// IMP=0x000000000131b616
- (void)cancel;	// IMP=0x000000000131b588
- (void)_handleResponse:(id)arg1 withData:(id)arg2 error:(id)arg3;	// IMP=0x000000000131b066
- (void)startWithCompletionHandler:(CDUnknownBlockType)arg1 callbackQueue:(id)arg2;	// IMP=0x000000000131a838
@property(readonly) NSProgress *progress;
@property(readonly, nonatomic) long long estimatedWeight;
- (void)dealloc;	// IMP=0x000000000131a7d5
- (id)initWithMigrator:(id)arg1 newSearchAttributionManifestURL:(id)arg2 oldTileGroup:(id)arg3;	// IMP=0x000000000131a5cc
- (id)init;	// IMP=0x000000000131a5a2
