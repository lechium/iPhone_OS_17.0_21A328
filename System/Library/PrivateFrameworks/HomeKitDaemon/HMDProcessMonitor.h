...
+ (id)logCategory;	// IMP=0x001000000080f23f
- (void).cxx_destruct;	// IMP=0x000000000080e079
...
- (void)timerDidFire:(id)arg1;	// IMP=0x000000000080df44
- (void)_processAppStateChange:(id)arg1;	// IMP=0x000000000080de31
- (void)removeFromPendingTerminated:(id)arg1;	// IMP=0x000000000080d9ff
- (void)_removeProcess:(id)arg1;	// IMP=0x000000000080d94e
- (void)removeProcess:(id)arg1;	// IMP=0x000000000080d72d
- (void)addProcess:(id)arg1;	// IMP=0x000000000080d5ed
- (id)processInfoForConnection:(id)arg1;	// IMP=0x000000000080d3aa
- (id)processInfoForPID:(int)arg1;	// IMP=0x000000000080d343
@property(readonly, copy) NSArray *foregroundProcesses;
@property(readonly, copy) NSArray *processes;
- (void)updateApplicationMonitor;	// IMP=0x000000000080d00c
- (void)dealloc;	// IMP=0x000000000080cfc3
- (id)initWithXpcListenerQueue:(id)arg1;	// IMP=0x000000000080ceea
- (id)init;	// IMP=0x000000000080ce45
