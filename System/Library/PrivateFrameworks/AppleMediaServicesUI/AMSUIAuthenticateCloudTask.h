...
- (void).cxx_destruct;	// IMP=0x0000000000011504
...
- (id)_serviceContextWithResults:(id)arg1 parentViewController:(id)arg2;	// IMP=0x00000000000110fc
- (id)performAuthenticate;	// IMP=0x0000000000010942
- (id)initWithAuthRequest:(id)arg1 presentingViewController:(id)arg2;	// IMP=0x00000000000108a0
