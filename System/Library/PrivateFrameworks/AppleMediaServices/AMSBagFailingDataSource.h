...
- (void).cxx_destruct;	// IMP=0x000000000032f1a7
...
- (void)setDefaultValue:(id)arg1 forKey:(id)arg2;	// IMP=0x000000000032f12a
- (id)defaultValueForKey:(id)arg1;	// IMP=0x000000000032f122
- (void)valueForURLVariable:(id)arg1 account:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x000000000032f112
- (id)valueForURLVariable:(id)arg1 account:(id)arg2;	// IMP=0x000000000032f10a
- (void)loadWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000000032ef13
@property(readonly, copy, nonatomic) NSString *bagLoadingPartialIdentifier;
@property(readonly, nonatomic, getter=isLoaded) _Bool loaded;
- (id)initWithProfile:(id)arg1 profileVersion:(id)arg2 error:(id)arg3 delay:(double)arg4;	// IMP=0x000000000032ee01
