...
- (void).cxx_destruct;	// IMP=0x00000000006cc930
- (id)initWithNibName:(id)arg1 bundle:(id)arg2;	// IMP=0x00100000006cc8d0
- (void)didTapCommit:(id)arg1;	// IMP=0x00100000006caaa0
- (void)didTapCancel:(id)arg1;	// IMP=0x00100000006caa10
...
- (void)viewWillLayoutSubviews;	// IMP=0x00100000006ca920
- (void)viewWillDisappear:(_Bool)arg1;	// IMP=0x00100000006ca6f0
- (void)viewDidAppear:(_Bool)arg1;	// IMP=0x00100000006ca6c0
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x00100000006ca680
- (void)viewDidLoad;	// IMP=0x00100000006ca300
@property(nonatomic, readonly) _Bool canBecomeFirstResponder;
@property(nonatomic, readonly) NSUndoManager *undoManager;
- (id)initWithCoder:(id)arg1;	// IMP=0x00100000006c97d0
