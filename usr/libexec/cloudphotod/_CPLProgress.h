...
- (void).cxx_destruct;	// IMP=0x0020000000037ae6
...
- (void)unpublish;	// IMP=0x0010000000037a6a
- (void)publish;	// IMP=0x0010000000037a43
- (void)_publishRealProgressIfNecessary;	// IMP=0x001000000003791e
- (void)setUserInfoObject:(id)arg1 forKey:(id)arg2;	// IMP=0x001000000003788d
- (id)initWithIdentifier:(id)arg1 firstSyncOfMainLibrary:(_Bool)arg2;	// IMP=0x00100000000376cc
