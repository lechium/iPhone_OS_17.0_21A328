...
- (void).cxx_destruct;	// IMP=0x00000000001e2e24
...
- (id)_layoutInfoWithDefaultDisappearance:(id)arg1;	// IMP=0x00000000001e26e0
- (id)optionsForAnimatingTileController:(id)arg1 toLayoutInfo:(id)arg2 withAnimationType:(long long)arg3;	// IMP=0x00000000001e25ad
