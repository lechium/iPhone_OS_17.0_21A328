...
- (void).cxx_destruct;	// IMP=0x00200000000450b8
...
- (id)configurationsByRecordZoneIDUsingCache:(id)arg1;	// IMP=0x0010000000044cc4
- (id)recordIDsFromCloudBackedZones:(id)arg1;	// IMP=0x0010000000044a98
- (id)cloudBackedZoneChangesOperationFromFetchTask:(id)arg1 forChangedZones:(id)arg2 container:(id)arg3;	// IMP=0x001000000004390f
- (id)cloudBackedDatabaseChangesOperationFromFetchTask:(id)arg1 container:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x00100000000428ab
- (id)initWithConfiguration:(id)arg1;	// IMP=0x00100000000427d7
