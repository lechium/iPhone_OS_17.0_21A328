...
- (void).cxx_destruct;	// IMP=0x000000000123c745
...
- (_Bool)handledUpdateOfActionable:(id)arg1 highlighted:(_Bool)arg2 initialPress:(_Bool)arg3;	// IMP=0x000000000123c615
- (void)updateRegion:(id)arg1 highlighted:(_Bool)arg2 initialPress:(_Bool)arg3 cornerRadius:(double)arg4;	// IMP=0x000000000123c428
- (id)animationForBackgroundActivityPillWithDuration:(double)arg1 scale:(double)arg2;	// IMP=0x000000000123c1f4
- (id)animationForBackgroundActivityPill;	// IMP=0x000000000123c1d7
- (id)animationForBackgroundActivityIcon;	// IMP=0x000000000123c054
- (void)_hideActivityDetailAndUpdate:(_Bool)arg1;	// IMP=0x000000000123bf7e
- (void)updatePill;	// IMP=0x000000000123bf62
- (void)_updateBackgroundActivityWithEntry:(id)arg1 timeEntry:(id)arg2 needsUpdate:(_Bool)arg3;	// IMP=0x000000000123bb5c
- (void)updateDataForBackgroundActivity:(id)arg1;	// IMP=0x000000000123b7c1
