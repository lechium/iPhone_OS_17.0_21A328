...
- (void).cxx_destruct;	// IMP=0x0000000000054be2
...
- (_Bool)bindPropertiesToStatement:(struct sqlite3_stmt *)arg1 error:(id *)arg2;	// IMP=0x0000000000054afb
- (id)initWithLocalZone:(id)arg1 parentModelID:(id)arg2;	// IMP=0x0000000000054978
