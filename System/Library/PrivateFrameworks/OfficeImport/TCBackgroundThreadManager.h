...
- (void).cxx_destruct;	// IMP=0x00000000002e62a6
...
- (void)waitUntilComplete;	// IMP=0x00000000002e61ec
- (void)addASyncBlock:(CDUnknownBlockType)arg1;	// IMP=0x00000000002e6012
- (void)dealloc;	// IMP=0x00000000002e5f9c
- (id)initWithCancelDelegate:(id)arg1;	// IMP=0x00000000002e5dd2
