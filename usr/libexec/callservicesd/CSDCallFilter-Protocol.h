...
@class CXCallUpdate, NSArray, NSString, TUCallProvider, TUHandle;
...
- (_Bool)shouldFilterIncomingCall:(CXCallUpdate *)arg1 from:(TUCallProvider *)arg2;
- (_Bool)isUnknownAddress:(NSString *)arg1 normalizedAddress:(NSString *)arg2 forBundleIdentifier:(NSString *)arg3;
- (_Bool)isUnknownCaller:(CXCallUpdate *)arg1;
