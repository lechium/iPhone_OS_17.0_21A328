...
+ (id)sharedConnectionState;	// IMP=0x006000000000165f
- (void).cxx_destruct;	// IMP=0x0000000000001fa0
...
- (id)sendMessageWithReplySync:(id)arg1;	// IMP=0x0000000000001d74
- (_Bool)sendMessage:(id)arg1;	// IMP=0x0000000000001b93
- (id)init;	// IMP=0x000000000000172c
- (void)cleanupState;	// IMP=0x00000000000016b4
