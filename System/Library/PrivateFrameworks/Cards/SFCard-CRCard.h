...
+ (id)_interactionsByIntentDataHashes;	// IMP=0x001000000000a6a3
- (id)_interactionDataKey;	// IMP=0x001000000000ad5a
- (id)underlyingInteraction;	// IMP=0x001000000000ad0a
@property(readonly, nonatomic) unsigned long long cardFormat;
@property(readonly, copy, nonatomic) NSString *cardIdentifier;
- (id)interaction;	// IMP=0x001000000000a8ad
@property(readonly, nonatomic) NSSet *interactions;
@property(readonly, nonatomic) SFCard *backingCard;
- (void)loadCardWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x001000000000a732
