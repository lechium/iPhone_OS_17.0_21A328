...
+ (id)sharedController;	// IMP=0x00400000000274c5
- (void).cxx_destruct;	// IMP=0x0020000000027b1a
...
- (id)popToViewController:(id)arg1 animated:(_Bool)arg2;	// IMP=0x0010000000027962
- (void)pushViewController:(id)arg1 animated:(_Bool)arg2;	// IMP=0x0010000000027898
- (id)topViewController;	// IMP=0x0010000000027848
- (id)viewControllers;	// IMP=0x0010000000027836
- (void)removeAllContainerViewControllers;	// IMP=0x00100000000277f9
- (void)synchonrizeContinainerViewControllers;	// IMP=0x0010000000027613
- (void)setupWithContainerViewController:(id)arg1;	// IMP=0x001000000002759d
- (id)init;	// IMP=0x001000000002751a
