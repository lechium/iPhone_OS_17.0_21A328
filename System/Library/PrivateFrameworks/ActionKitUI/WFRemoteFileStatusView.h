...
- (void).cxx_destruct;	// IMP=0x0000000000052535
...
- (void)setError:(id)arg1;	// IMP=0x00000000000522d9
- (void)setLoading;	// IMP=0x0000000000052164
- (void)setEmptyWithLabel:(_Bool)arg1;	// IMP=0x0000000000051fa3
- (void)recoveryButtonTapped;	// IMP=0x0000000000051f57
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000051822
