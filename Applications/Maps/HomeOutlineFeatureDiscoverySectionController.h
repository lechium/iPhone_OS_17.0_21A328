...
- (void).cxx_destruct;	// IMP=0x00200000009d4703
...
- (void)collectionView:(id)arg1 willDisplayCell:(id)arg2 forItemAtIndexPath:(id)arg3;	// IMP=0x00100000009d45f4
@property(readonly, nonatomic) _Bool persistsExpansions;
- (id)contextMenuForSnapshot:(id)arg1;	// IMP=0x00100000009d45e4
...
- (id)initWithConfiguration:(id)arg1 suggestionsDataProvider:(id)arg2;	// IMP=0x00100000009d42db
