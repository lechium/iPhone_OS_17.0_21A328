...
- (void).cxx_destruct;	// IMP=0x0020000000138320
...
// Error: Property attributes should begin with the type ('T') attribute, property name: conditionChecksInFlight
...
- (id)doWatchedStateMachineRPC:(id)arg1 sourceStates:(id)arg2 path:(id)arg3 transitionOp:(id)arg4 reply:(CDUnknownBlockType)arg5;	// IMP=0x0010000000137bbd
- (id)doWatchedStateMachineRPC:(id)arg1 sourceStates:(id)arg2 path:(id)arg3 reply:(CDUnknownBlockType)arg4;	// IMP=0x0010000000137a6e
- (void)setWatcherTimeout:(unsigned long long)arg1;	// IMP=0x0010000000137a5c
- (void)doSimpleStateMachineRPC:(id)arg1 op:(id)arg2 sourceStates:(id)arg3 reply:(CDUnknownBlockType)arg4;	// IMP=0x00100000001376b7
- (void)_onqueueRegisterMultiStateArrivalWatcher:(id)arg1;	// IMP=0x0010000000137586
- (void)registerMultiStateArrivalWatcher:(id)arg1;	// IMP=0x00100000001374cd
- (void)registerStateTransitionWatcher:(id)arg1;	// IMP=0x0010000000137414
- (void)handleExternalRequest:(id)arg1;	// IMP=0x001000000013735b
- (void)haltOperation;	// IMP=0x00100000001372af
- (void)startOperation;	// IMP=0x001000000013723e
- (_Bool)isPaused;	// IMP=0x0010000000137173
- (void)testReleaseStateMachinePause:(id)arg1;	// IMP=0x00100000001370ba
- (void)testPauseStateMachineAfterEntering:(id)arg1;	// IMP=0x0010000000137001
- (void)_onqueueSendAnyPendingFlags;	// IMP=0x00100000001366e8
- (void)_onqueueRecheckConditions;	// IMP=0x0010000000135dba
- (id)possiblePendingFlags;	// IMP=0x0010000000135d6a
- (id)dumpPendingFlags;	// IMP=0x0010000000135c3f
- (void)disablePendingFlags;	// IMP=0x0010000000135bce
- (void)_onqueueHandlePendingFlag:(id)arg1;	// IMP=0x001000000013599c
- (void)_onqueueHandlePendingFlagLater:(id)arg1;	// IMP=0x00100000001358bb
- (void)handlePendingFlag:(id)arg1;	// IMP=0x0010000000135802
- (void)_onqueueHandleFlag:(id)arg1;	// IMP=0x001000000013575d
- (void)handleFlag:(id)arg1;	// IMP=0x00100000001356a4
- (void)_onqueuePokeStateMachine;	// IMP=0x001000000013564f
- (void)pokeStateMachine;	// IMP=0x00100000001355de
- (id)createOperationToFinishAttempt:(id)arg1;	// IMP=0x0010000000135475
- (void)_onqueueStartNextStateMachineOperation:(_Bool)arg1;	// IMP=0x0010000000134f7e
- (id)_onqueueNextStateMachineTransition;	// IMP=0x0010000000134b1c
- (id)waitForState:(id)arg1 wait:(unsigned long long)arg2;	// IMP=0x0010000000134a60
@property(retain) NSString<OctagonStateString> *currentState;
@property(readonly) id <OctagonFlagContainer> flags;
- (id)description;	// IMP=0x0010000000134725
- (id)pendingFlagsString;	// IMP=0x00100000001346a4
@property(readonly) NSDictionary *stateConditions;
- (id)initWithName:(id)arg1 states:(id)arg2 flags:(id)arg3 initialState:(id)arg4 queue:(id)arg5 stateEngine:(id)arg6 lockStateTracker:(id)arg7 reachabilityTracker:(id)arg8;	// IMP=0x0010000000134027
