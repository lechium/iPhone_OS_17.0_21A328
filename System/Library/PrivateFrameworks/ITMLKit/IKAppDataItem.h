...
- (void).cxx_destruct;	// IMP=0x00000000000e1b17
...
- (id)valueForPropertyPath:(id)arg1;	// IMP=0x00000000000e1a4e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000e1a43
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000e17c1
- (unsigned long long)hash;	// IMP=0x00000000000e177d
- (id)initWithType:(id)arg1 identifier:(id)arg2 prototypeIdentifier:(id)arg3 dataDictionary:(id)arg4;	// IMP=0x00000000000e167c
