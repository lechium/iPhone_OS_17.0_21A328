...
- (void).cxx_destruct;	// IMP=0x00000000001ae628
...
- (void)_fetchEligibleAccountModificationActionsForSavedAccount:(id)arg1;	// IMP=0x00000000001ae059
@property(readonly, nonatomic) NSArray *items;
- (id)cellForTableView:(id)arg1 forCellType:(id)arg2;	// IMP=0x00000000001ad3cf
- (id)initWithAccountCellData:(id)arg1 warning:(id)arg2 delegate:(id)arg3;	// IMP=0x00000000001ad2d0
