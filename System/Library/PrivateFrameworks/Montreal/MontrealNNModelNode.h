...
- (id)createDataContainer;	// IMP=0x00000000001798b0
- (void)generateJSONAtPath:(id)arg1;	// IMP=0x0000000000179740
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000179620
- (id)jsonDescription;	// IMP=0x00000000001793d0
- (void)description:(id)arg1 indent:(id)arg2;	// IMP=0x0000000000179030
- (CDStruct_96916c69)parameters:(void *)arg1;	// IMP=0x0000000000178f90
- (void)keepTensors:(id)arg1;	// IMP=0x0000000000178ca0
- (id)auditAndUpdateTensors:(id)arg1 dimensionTensors:(id)arg2;	// IMP=0x0000000000178890
- (id)initWithDictionary:(id)arg1 tensors:(id)arg2 quantization:(id)arg3 jsonDir:(id)arg4;	// IMP=0x0000000000177eb0
- (id)initWithName:(id)arg1 nodeStr:(id)arg2 activations:(id)arg3 properties:(id)arg4 weights:(id)arg5;	// IMP=0x0000000000177ce0
- (id)checkForValidity;	// IMP=0x0000000000177aa0
