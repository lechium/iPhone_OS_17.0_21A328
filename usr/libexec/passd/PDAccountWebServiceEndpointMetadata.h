...
@interface PDAccountWebServiceEndpointMetadata : NSObject
{
    ...
    NSDate *_localLastUpdated;	// 40 = 0x28
}

- (void).cxx_destruct;	// IMP=0x00200000002aaec8
@property(nonatomic) _Bool isDirty; // @synthesize isDirty=_isDirty;
@property(copy, nonatomic) NSDate *localLastUpdated; // @synthesize localLastUpdated=_localLastUpdated;
...
- (id)initWithAccountIdentifier:(id)arg1 endpoint:(unsigned long long)arg2;	// IMP=0x00100000002aade0
