...
+ (id)serviceName;	// IMP=0x0060000000032ca1
+ (id)sharedInstance;	// IMP=0x0060000000032c3c
...
- (void)removeObserver:(id)arg1;	// IMP=0x0000000000033348
- (void)addObserver:(id)arg1;	// IMP=0x00000000000332f4
- (id)findOrRegisterIcon:(id)arg1;	// IMP=0x000000000003311b
- (void)dealloc;	// IMP=0x00000000000330ec
- (id)_init;	// IMP=0x0000000000032cf8
