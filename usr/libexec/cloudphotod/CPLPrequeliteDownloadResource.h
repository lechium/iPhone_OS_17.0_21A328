...
- (void).cxx_destruct;	// IMP=0x0020000000056303
...
- (id)resourceWithDownloadQueue:(id)arg1;	// IMP=0x001000000005612f
- (id)initWithResource:(id)arg1;	// IMP=0x0010000000055f38
- (id)initFromPQLResultSet:(id)arg1 error:(id *)arg2;	// IMP=0x0010000000055db0
