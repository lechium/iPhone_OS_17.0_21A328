...
+ (id)dbValue:(id)arg1 type:(id)arg2 value:(id)arg3;	// IMP=0x006000000029e749
- (void).cxx_destruct;	// IMP=0x000000000029e839
...
- (id)initWithParent:(id)arg1 type:(id)arg2 value:(id)arg3;	// IMP=0x000000000029e693
