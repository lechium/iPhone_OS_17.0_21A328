...
- (void).cxx_destruct;	// IMP=0x000000000006f188
...
- (unsigned long long)hash;	// IMP=0x000000000006f0b9
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000006ef01
- (id)description;	// IMP=0x000000000006edd1
- (id)maAssetQueryDescription;	// IMP=0x000000000006ec2d
- (id)initWithDeviceAssetQuery:(id)arg1 installedOnly:(_Bool)arg2 imperfectMatch:(_Bool)arg3 fallback:(_Bool)arg4;	// IMP=0x000000000006eaea
