...
+ (id)eventWithData:(id)arg1 dataVersion:(unsigned int)arg2;	// IMP=0x0010000000467bb5
- (void).cxx_destruct;	// IMP=0x0000000000467b62
...
- (id)proto;	// IMP=0x0000000000467a89
- (id)initWithProtoData:(id)arg1;	// IMP=0x00000000004679ec
- (id)initWithProto:(id)arg1;	// IMP=0x000000000046789f
- (id)encodeAsProto;	// IMP=0x000000000046784f
- (id)serialize;	// IMP=0x000000000046783d
@property(readonly, nonatomic) unsigned int dataVersion;
- (id)initWithHomeUUID:(id)arg1 accessoryUUID:(id)arg2 characteristicUUID:(id)arg3 brightness:(id)arg4;	// IMP=0x0000000000467735
