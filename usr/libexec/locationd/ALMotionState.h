...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000001af313
- (unsigned long long)hash;	// IMP=0x00100000001af1ae
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000001af0d7
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000001af000
- (void)copyTo:(id)arg1;	// IMP=0x00100000001aef82
- (void)writeTo:(id)arg1;	// IMP=0x00100000001aeeed
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000001aeee0
- (id)dictionaryRepresentation;	// IMP=0x00100000001aeab6
- (id)description;	// IMP=0x00100000001aea3f
@property(readonly, nonatomic) _Bool hasNatalieFeatures;
@property(nonatomic) _Bool hasTimestamp;
- (void)dealloc;	// IMP=0x00100000001ae98c
