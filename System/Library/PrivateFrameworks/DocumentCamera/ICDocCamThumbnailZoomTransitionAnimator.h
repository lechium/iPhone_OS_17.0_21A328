...
- (void).cxx_destruct;	// IMP=0x00000000000a6f0d
...
- (_Bool)_shouldCrossFadeNavigationBar;	// IMP=0x00000000000a6e8e
- (void)animateTransition:(id)arg1;	// IMP=0x00000000000a5328
- (double)transitionDuration:(id)arg1;	// IMP=0x00000000000a5316
- (id)initWithImage:(id)arg1 indexPath:(id)arg2 duration:(double)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x00000000000a5244
