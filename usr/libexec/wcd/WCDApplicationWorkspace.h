...
- (void).cxx_destruct;	// IMP=0x002000000000f154
@property(nonatomic) __weak id <WCDApplicationWorkspaceDelegate> delegate; // @synthesize delegate=_delegate;
@property(readonly, copy) NSString *debugDescription;
@property(readonly, copy) NSString *description;
- (id)debugDescriptionWithMultilinePrefix:(id)arg1;	// IMP=0x001000000000f0a5
- (id)descriptionWithMultilinePrefix:(id)arg1;	// IMP=0x001000000000f055
- (id)descriptionBuilderWithMultilinePrefix:(id)arg1;	// IMP=0x001000000000ef46
- (id)succinctDescription;	// IMP=0x001000000000eef6
- (id)succinctDescriptionBuilder;	// IMP=0x001000000000ee64
...
- (id)_lock_applicationInfoForBundleIdentifier:(id)arg1 type:(unsigned long long)arg2;	// IMP=0x001000000000e24d
- (id)applicationInfoForBundleIdentifier:(id)arg1 type:(unsigned long long)arg2 allowPlaceholder:(_Bool)arg3;	// IMP=0x001000000000e0d3
- (id)applicationInfoForBundleIdentifier:(id)arg1 type:(unsigned long long)arg2;	// IMP=0x001000000000e0be
- (id)init;	// IMP=0x001000000000dfe9
