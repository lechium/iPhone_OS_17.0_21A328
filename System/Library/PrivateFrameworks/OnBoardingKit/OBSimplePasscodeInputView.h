...
- (void)passcodeField:(id)arg1 enteredPasscode:(id)arg2;	// IMP=0x000000000000626d
- (id)passcode;	// IMP=0x000000000000621d
- (void)setPasscode:(id)arg1;	// IMP=0x00000000000061b4
- (id)passcodeDisplayView;	// IMP=0x000000000000619f
- (id)initWithFrame:(struct CGRect)arg1 numberOfEntryFields:(unsigned long long)arg2;	// IMP=0x0000000000005e8a
