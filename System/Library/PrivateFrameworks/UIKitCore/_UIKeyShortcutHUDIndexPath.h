...
+ (id)hudIndexPathWithClient:(id)arg1 indexPath:(id)arg2;	// IMP=0x006000000055e0ed
- (void).cxx_destruct;	// IMP=0x000000000055e372
...
- (unsigned long long)hash;	// IMP=0x000000000055e2ce
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000055e175
