...
- (void).cxx_destruct;	// IMP=0x00200000000065aa
...
- (void)assetResolutionFailedWithError:(id)arg1;	// IMP=0x0010000000006516
- (void)assetResolutionDidSucceedWithAssetURL:(id)arg1;	// IMP=0x001000000000620d
...
- (void)main;	// IMP=0x001000000000604c
- (_Bool)isAsynchronous;	// IMP=0x0010000000006044
- (id)initWithImageDeclaration:(id)arg1 resolver:(id)arg2;	// IMP=0x0010000000005fa2
