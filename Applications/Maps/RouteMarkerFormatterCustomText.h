...
- (void).cxx_destruct;	// IMP=0x002000000044a254
...
- (id)markerInfoForRoute:(id)arg1;	// IMP=0x001000000044a144
- (id)initWithRoutes:(id)arg1 selectedRouteIndex:(unsigned long long)arg2 customSelectedRouteText:(id)arg3;	// IMP=0x001000000044a080
