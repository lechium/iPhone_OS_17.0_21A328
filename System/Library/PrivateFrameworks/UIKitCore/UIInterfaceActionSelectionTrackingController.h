...
- (void).cxx_destruct;	// IMP=0x00000000000ecb43
...
- (id)_allGestureRecognizers;	// IMP=0x00000000000ec95d
- (id)_allActionViewsIncludingCooperatingActionViews;	// IMP=0x00000000000ec8a4
- (void)_performRecursivelyWithVisitedCooperatingControllers:(id)arg1 block:(CDUnknownBlockType)arg2;	// IMP=0x00000000000ec59e
- (_Bool)_shouldDisableSelectionTrackingIfScrollingScrollView:(id)arg1;	// IMP=0x00000000000ec521
- (void)_noteScrollView:(id)arg1 isUserScrolling:(_Bool)arg2;	// IMP=0x00000000000ec48c
- (void)_unregisterForScrollViewNotifications;	// IMP=0x00000000000ec41c
- (void)_registerForScrollViewNotifications;	// IMP=0x00000000000ebfc6
- (void)_initializeSelectionGestureRecognizer;	// IMP=0x00000000000ebe09
- (id)_actionViewAtCurrentLocationForGestureRecognizer:(id)arg1;	// IMP=0x00000000000ebaf2
- (id)_actionViewIncludingCooperatingActionViewsAtCurrentLocationForGestureRecognizer:(id)arg1;	// IMP=0x00000000000eb967
- (_Bool)_allowSelectionForCurrentGestureLocationWithGestureRecognizer:(id)arg1;	// IMP=0x00000000000eb89d
- (void)_invokeHandlerForInterfaceAction:(id)arg1;	// IMP=0x00000000000eb87b
- (_Bool)_isPresentedAndVisible;	// IMP=0x00000000000eb825
- (void)_handleActionSelectionGestureRecognizer:(id)arg1;	// IMP=0x00000000000eb11d
- (void)_rolloverActionChanged:(id)arg1;	// IMP=0x00000000000eafab
- (void)_handleSystemProvidedGestureRecognizer:(id)arg1;	// IMP=0x00000000000eaf99
- (void)deselectAllActions;	// IMP=0x00000000000eaf3e
- (_Bool)gestureRecognizer:(id)arg1 shouldRequireFailureOfGestureRecognizer:(id)arg2;	// IMP=0x00000000000eadd5
- (_Bool)_gestureRecognizer:(id)arg1 shouldRecognizeSimultaneouslyWithGestureRecognizer:(id)arg2;	// IMP=0x00000000000eacf1
- (_Bool)_gestureRecognizer:(id)arg1 shouldReceiveTouch:(id)arg2;	// IMP=0x00000000000eac39
- (void)_clearSystemProvidedGestureRecognizer;	// IMP=0x00000000000eac25
- (void)_setSystemProvidedGestureRecognizer:(id)arg1;	// IMP=0x00000000000eaa72
- (void)beginTrackingSessionByTakingOverForSystemProvidedGestureRecognizer:(id)arg1;	// IMP=0x00000000000eaa1d
- (void)handlePressedFocusedInterfaceAction:(id)arg1;	// IMP=0x00000000000eaa0b
- (id)_interfaceActionOfFocusedRepresentationView;	// IMP=0x00000000000ea8a9
- (id)focusedInterfaceAction;	// IMP=0x00000000000ea897
- (void)setCooperatingSelectionTrackingControllers:(id)arg1;	// IMP=0x00000000000ea34f
- (void)dealloc;	// IMP=0x00000000000ea311
- (id)initWithTrackableContainerView:(id)arg1 actionsScrollView:(id)arg2;	// IMP=0x00000000000ea232
