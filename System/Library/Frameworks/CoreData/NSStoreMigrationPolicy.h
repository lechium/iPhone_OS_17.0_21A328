...
+ (id)migrationStoreOptionsFromStoreOptions:(id)arg1;	// IMP=0x006000000021c4ef
+ (id)destinationURLForMigrationSourceURL:(id)arg1 createDocumentReplacementDirectory:(_Bool)arg2 error:(id *)arg3;	// IMP=0x006000000021d955
+ (void)setMigrationDebugLevel:(int)arg1;	// IMP=0x006000000021d832
+ (int)migrationDebugLevel;	// IMP=0x006000000021d819
- (id)migrateStoreAtURL:(id)arg1 withManager:(id)arg2 metadata:(id)arg3 options:(id)arg4 error:(id *)arg5;	// IMP=0x000000000021d6c9
- (id)createMigrationManagerForSourceModel:(id)arg1 destinationModel:(id)arg2 error:(id *)arg3;	// IMP=0x000000000021d547
- (id)sourceModelForStoreAtURL:(id)arg1 metadata:(id)arg2 error:(id *)arg3;	// IMP=0x000000000021ccf2
- (void)dealloc;	// IMP=0x000000000021c6ca
