...
- (void).cxx_destruct;	// IMP=0x0000000000ae291d
...
- (void)timerDidFire:(id)arg1;	// IMP=0x0000000000ae2542
- (void)stop;	// IMP=0x0000000000ae2498
- (void)start;	// IMP=0x0000000000ae231f
- (void)addCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0000000000ae2251
- (id)initWithHome:(id)arg1 accessory:(id)arg2 linkType:(long long)arg3;	// IMP=0x0000000000ae2130
