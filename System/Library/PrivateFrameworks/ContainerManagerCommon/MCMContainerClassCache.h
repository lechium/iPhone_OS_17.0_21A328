...
- (void).cxx_destruct;	// IMP=0x000000000003b0fb
...
- (void)_handleUnrecoverableCorruptContainerPath:(id)arg1;	// IMP=0x000000000003abf4
- (id)_setEntry:(id)arg1 forIdentifier:(id)arg2 writeThrough:(_Bool)arg3;	// IMP=0x000000000003a9bd
- (id)_concurrent_generateCacheEntryWithURL:(id)arg1 identifier:(id)arg2 containerPath:(id)arg3 schemaVersion:(id)arg4 uuid:(id)arg5 metadata:(id)arg6;	// IMP=0x000000000003a889
- (id)_concurrent_slowGenerateCacheEntryWithFileHandle:(id)arg1 URL:(id)arg2 identifier:(id)arg3 uuid:(id)arg4 schemaVersion:(id)arg5 containerPath:(id)arg6;	// IMP=0x000000000003a490
- (void)_concurrent_processCorruptEntry:(id)arg1 handler:(CDUnknownBlockType)arg2;	// IMP=0x000000000003a161
- (void)_concurrent_processURL:(id)arg1 handler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000039d5a
- (void)_processCorruptEntries:(id)arg1 handler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000039c97
- (void)_processURLs:(id)arg1 handler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000039bd4
- (void)_queue_syncWithDisk;	// IMP=0x0000000000038f45
- (_Bool)_checkExistanceOfCacheEntry:(id)arg1 libraryRepair:(id)arg2;	// IMP=0x0000000000038dd0
- (void)forceWriteThrough;	// IMP=0x0000000000038c91
- (void)asyncStartSynchronization;	// IMP=0x0000000000038bb2
- (void)flush;	// IMP=0x0000000000038aee
- (void)waitForSynchronizationToComplete;	// IMP=0x0000000000038a9f
- (_Bool)enumerateCacheEntriesWithEnumerator:(CDUnknownBlockType)arg1;	// IMP=0x0000000000038826
- (id)setCacheEntry:(id)arg1 forIdentifier:(id)arg2 writeThrough:(_Bool)arg3;	// IMP=0x0000000000038770
- (id)setCacheEntry:(id)arg1 forIdentifier:(id)arg2;	// IMP=0x000000000003872d
- (id)cacheEntryForIdentifier:(id)arg1;	// IMP=0x00000000000385b6
- (id)initWithContainerClassPath:(id)arg1 cacheEntryClass:(Class)arg2 targetQueue:(id)arg3 userIdentityCache:(id)arg4;	// IMP=0x0000000000038325
