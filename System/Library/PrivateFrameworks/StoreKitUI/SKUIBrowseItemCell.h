...
- (void)_reloadHighlightState;	// IMP=0x000000000002ae62
- (void)layoutSubviews;	// IMP=0x000000000002a8be
- (void)setSelected:(_Bool)arg1;	// IMP=0x000000000002a87d
- (void)setHighlighted:(_Bool)arg1;	// IMP=0x000000000002a83c
@property(retain, nonatomic) NSString *subtitle;
@property(retain, nonatomic) NSString *title;
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000002a224
