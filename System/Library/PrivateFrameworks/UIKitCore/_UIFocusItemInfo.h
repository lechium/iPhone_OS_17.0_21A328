...
+ (id)infoWithView:(id)arg1;	// IMP=0x00100000007e95a7
+ (id)infoWithItem:(id)arg1 useFallbackAncestorScroller:(_Bool)arg2;	// IMP=0x00100000007e954e
+ (id)infoWithItem:(id)arg1;	// IMP=0x00100000007e9500
- (void).cxx_destruct;	// IMP=0x00000000007eaa71
...
- (id)shortDescription;	// IMP=0x00000000007ea8a8
- (id)description;	// IMP=0x00000000007ea829
- (void)invalidateFocusedRegion;	// IMP=0x00000000007ea803
- (struct CGRect)focusedRectInCoordinateSpace:(id)arg1;	// IMP=0x00000000007ea747
- (id)_createFocusedRegion;	// IMP=0x00000000007e9a90
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000007e96de
- (id)_initWithItem:(id)arg1 containingView:(id)arg2 useFallbackAncestorScroller:(_Bool)arg3;	// IMP=0x00000000007e95f6
