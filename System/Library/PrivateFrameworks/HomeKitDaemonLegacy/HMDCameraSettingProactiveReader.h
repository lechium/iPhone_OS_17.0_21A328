...
+ (id)logCategory;	// IMP=0x00100000005f4857
+ (id)_streamingStatusForResponse:(id)arg1;	// IMP=0x00100000005f44e6
- (void).cxx_destruct;	// IMP=0x00000000005f3fb1
...
- (void)_callDidCompleteReadDelegateCallback;	// IMP=0x00000000005f3e38
- (id)_inUseStreamControlMessageHandlersForReadResponses:(id)arg1;	// IMP=0x00000000005f3c7d
- (id)_availableStreamControlMessageHandlersForReadResponses:(id)arg1;	// IMP=0x00000000005f3ac2
- (void)_handleStreamStatusMultireadResponse:(id)arg1;	// IMP=0x00000000005f3551
- (void)readSetting;	// IMP=0x00000000005f3000
- (void)handleMessage:(id)arg1;	// IMP=0x00000000005f2bed
- (_Bool)hasPendingNegotiateMessageForSessionWithIdentifier:(id)arg1;	// IMP=0x00000000005f2b17
- (id)initWithWorkQueue:(id)arg1 sessionID:(id)arg2 accessory:(id)arg3 message:(id)arg4 streamControlMessageHandlers:(id)arg5 streamPreferences:(id)arg6 logIdentifier:(id)arg7;	// IMP=0x00000000005f28e4
