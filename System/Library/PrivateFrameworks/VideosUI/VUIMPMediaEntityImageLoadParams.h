...
- (void).cxx_destruct;	// IMP=0x0000000000136206
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000135ea7
@property(readonly) unsigned long long hash;
@property(readonly, copy, nonatomic) NSString *imageIdentifier; // @synthesize imageIdentifier=_imageIdentifier;
- (id)init;	// IMP=0x0000000000135ce9
- (id)initWithMediaItem:(id)arg1 andImageType:(unsigned long long)arg2;	// IMP=0x0000000000135c3f
