...
- (void).cxx_destruct;	// IMP=0x000000000001d5f6
- (id)pipelineForConfiguration:(id)arg1;	// IMP=0x000000000001d4ad
- (id)initWithDeviceSPI:(id)arg1 librarySPI:(id)arg2;	// IMP=0x000000000001d382
- (id)initWithDevice:(id)arg1 library:(id)arg2;	// IMP=0x000000000001d230
