...
- (void).cxx_destruct;	// IMP=0x00200000000f1d5d
...
- (void)main;	// IMP=0x00100000000f1cc0
- (int)mainInternal;	// IMP=0x00100000000f1cb5
- (_Bool)isCancelled;	// IMP=0x00100000000f1c65
- (id)initWithPhotoLibrary:(id)arg1;	// IMP=0x00100000000f1bb0
- (id)init;	// IMP=0x00100000000f1ba2
