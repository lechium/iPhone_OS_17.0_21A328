...
+ (double)_interspaceForIconSize:(long long)arg1;	// IMP=0x00100000011417e1
- (void).cxx_destruct;	// IMP=0x0000000001142379
...
- (struct CGSize)intrinsicContentSize;	// IMP=0x0000000001141ea2
- (void)applyStyleAttributes:(id)arg1;	// IMP=0x0000000001141d60
- (id)viewForLastBaselineLayout;	// IMP=0x0000000001141d35
- (void)_iconSizeDidChange;	// IMP=0x0000000001141be9
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000001141ba2
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000001141b4a
- (void)_commonInit;	// IMP=0x0000000001141801
