...
- (void).cxx_destruct;	// IMP=0x000000000001b816
@property(nonatomic) __weak id <SLRemoteComposeViewControllerDelegateProtocol> delegate; // @synthesize delegate=_delegate;
- (_Bool)_canShowWhileLocked;	// IMP=0x000000000001b7e1
- (void)viewServiceDidTerminateWithError:(id)arg1;	// IMP=0x000000000001b736
