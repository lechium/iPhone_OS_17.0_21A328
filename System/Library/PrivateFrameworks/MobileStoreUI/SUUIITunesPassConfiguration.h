...
- (void).cxx_destruct;	// IMP=0x0000000000337890
...
- (id)learnMoreAlertView;	// IMP=0x00000000003377f3
- (id)initWithITunesPassDictionary:(id)arg1 clientContext:(id)arg2;	// IMP=0x0000000000336cd5
