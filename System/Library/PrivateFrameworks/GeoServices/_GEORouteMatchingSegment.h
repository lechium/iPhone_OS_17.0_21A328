...
- (void).cxx_destruct;	// IMP=0x000000000126df02
...
- (id)description;	// IMP=0x000000000126dda3
- (double)distanceFromCoordinate:(CDStruct_c3b9c2ee)arg1 outCoordinateOnSegment:(CDStruct_c3b9c2ee *)arg2 outRouteCoordinate:(struct PolylineCoordinate *)arg3;	// IMP=0x000000000126dc2d
