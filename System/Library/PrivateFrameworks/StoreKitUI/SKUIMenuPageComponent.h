...
- (void).cxx_destruct;	// IMP=0x000000000037182c
...
- (id)_componentWithContext:(id)arg1;	// IMP=0x00000000003716ee
- (void)_setChildComponents:(id)arg1 forIndex:(long long)arg2;	// IMP=0x00000000003716c8
- (long long)componentType;	// IMP=0x00000000003716bd
- (id)titleForIndex:(long long)arg1;	// IMP=0x00000000003716a0
- (id)sortURLForIndex:(long long)arg1;	// IMP=0x0000000000371637
@property(readonly, nonatomic) long long numberOfItems;
- (id)childComponentsForIndex:(long long)arg1;	// IMP=0x00000000003715bd
@property(readonly, nonatomic) NSArray *allTitles;
- (id)initWithViewElement:(id)arg1;	// IMP=0x000000000037148b
- (id)initWithRoomSortData:(id)arg1;	// IMP=0x0000000000371003
- (id)initWithCustomPageContext:(id)arg1;	// IMP=0x000000000037074f
