...
+ (id)_defaultQueryParameters;	// IMP=0x002000000002ff89
+ (id)_defaultQueryType;	// IMP=0x001000000002ff7c
+ (id)allExisitngInfos;	// IMP=0x001000000002fd4a
- (_Bool)isEqual:(id)arg1;	// IMP=0x0020000000030065
@property(readonly) unsigned long long hash;
- (_Bool)shouldPrefetchResource:(id)arg1;	// IMP=0x0010000000030053
...
- (id)init;	// IMP=0x001000000002fca2
