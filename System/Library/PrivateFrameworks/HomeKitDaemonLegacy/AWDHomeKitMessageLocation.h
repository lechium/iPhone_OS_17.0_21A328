...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000085713
- (unsigned long long)hash;	// IMP=0x00000000000853c2
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000008525f
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000085170
- (void)copyTo:(id)arg1;	// IMP=0x00000000000850a4
- (void)writeTo:(id)arg1;	// IMP=0x0000000000084fab
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000084f9e
- (id)dictionaryRepresentation;	// IMP=0x0000000000084d47
- (id)description;	// IMP=0x0000000000084c98
