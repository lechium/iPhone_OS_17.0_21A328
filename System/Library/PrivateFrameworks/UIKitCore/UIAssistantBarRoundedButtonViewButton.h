...
- (void).cxx_destruct;	// IMP=0x0000000000da4884
...
- (void)_updateBackgroundAndTitleColor;	// IMP=0x0000000000da4666
- (id)_titleColorForState:(unsigned long long)arg1;	// IMP=0x0000000000da4654
- (id)_currentTitleColor;	// IMP=0x0000000000da4608
- (void)setHighlighted:(_Bool)arg1;	// IMP=0x0000000000da45c7
