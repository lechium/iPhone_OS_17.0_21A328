...
- (void).cxx_destruct;	// IMP=0x002000000003aaeb
...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000003a9a8
- (unsigned long long)hash;	// IMP=0x001000000003a80d
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000003a6bb
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000003a5bf
- (void)copyTo:(id)arg1;	// IMP=0x001000000003a4f8
- (void)writeTo:(id)arg1;	// IMP=0x001000000003a429
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000003a41c
- (id)dictionaryRepresentation;	// IMP=0x0010000000039f54
- (id)description;	// IMP=0x0010000000039ea5
