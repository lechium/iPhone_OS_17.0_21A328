...
+ (id)_remoteViewControllerInterface;	// IMP=0x006000000017981f
- (void).cxx_destruct;	// IMP=0x00000000001799cd
@property(readonly, nonatomic) NSString *applicationIdentifier; // @synthesize applicationIdentifier=_applicationIdentifier;
- (void)_willAppearInRemoteViewController;	// IMP=0x000000000017983f
