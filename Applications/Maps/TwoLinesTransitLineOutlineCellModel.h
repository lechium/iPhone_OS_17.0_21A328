...
- (void).cxx_destruct;	// IMP=0x0010000000ce7390
@property(readonly, nonatomic) id <GEOTransitLine> transitLine; // @synthesize transitLine=_transitLine;
- (id)accessoryModels;	// IMP=0x0010000000ce736a
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000ce723f
@property(readonly) unsigned long long hash;
- (id)initWithTransitLine:(id)arg1 accessoryModels:(id)arg2 backgroundModel:(id)arg3;	// IMP=0x0010000000ce703f
