...
+ (id)sampleFromHIDEvent:(struct __IOHIDEvent *)arg1;	// IMP=0x006000000109b5f3
- (void).cxx_destruct;	// IMP=0x000000000109be6c
...
- (id)description;	// IMP=0x000000000109bd83
- (id)hitTestWithEvent:(id)arg1;	// IMP=0x000000000109bc82
