...
+ (id)new;	// IMP=0x006000000005b41e
- (void).cxx_destruct;	// IMP=0x000000000005b2c8
...
- (id)debugDescription;	// IMP=0x000000000005b1ef
- (id)description;	// IMP=0x000000000005b16c
@property(readonly, nonatomic, getter=isForWriting) _Bool forWriting;
- (id)initForWritingWithEndpoint:(id)arg1 data:(id)arg2 encrypted:(_Bool)arg3 mimeType:(id)arg4;	// IMP=0x000000000005b13e
- (id)initForReadingWithEndpoint:(id)arg1 data:(id)arg2 encrypted:(_Bool)arg3 mimeType:(id)arg4;	// IMP=0x000000000005b122
- (id)init;	// IMP=0x000000000005b07a
