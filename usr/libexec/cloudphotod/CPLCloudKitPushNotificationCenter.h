...
- (void).cxx_destruct;	// IMP=0x002000000000479f
...
- (void)getStatusDictionaryWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x001000000000415e
- (void)getStatusWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x00100000000039f0
- (void)_setPushRegistrationStatus:(id)arg1 error:(id)arg2;	// IMP=0x0010000000003977
- (void)connection:(id)arg1 didReceiveToken:(id)arg2 forTopic:(id)arg3 identifier:(id)arg4;	// IMP=0x001000000000383f
- (void)connection:(id)arg1 didReceiveIncomingMessage:(id)arg2;	// IMP=0x00100000000032d2
- (void)connection:(id)arg1 didReceivePublicToken:(id)arg2;	// IMP=0x00100000000031ea
- (void)unregisterFromPushNotifications;	// IMP=0x0010000000003153
- (void)stopWaitingForPushNotifications;	// IMP=0x001000000000306d
- (void)startWaitingForPushNotificationsForContainer:(id)arg1;	// IMP=0x00100000000029c8
