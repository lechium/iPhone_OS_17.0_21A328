...
- (void).cxx_destruct;	// IMP=0x0000000000063ac2
...
- (void)syncErrors:(CDUnknownBlockType)arg1;	// IMP=0x0000000000061615
- (void)generateReportWithSession:(id)arg1;	// IMP=0x000000000005eb6f
- (id)_injectionForAnalyticsServiceCode:(int)arg1;	// IMP=0x000000000005ea6c
- (void)_fillTransferFailure:(id)arg1 withRowID:(unsigned long long)arg2 atDate:(id)arg3 session:(id)arg4;	// IMP=0x000000000005e738
- (id)getRampNumberForSession:(id)arg1;	// IMP=0x000000000005e6f6
- (id)init;	// IMP=0x000000000005e63c
