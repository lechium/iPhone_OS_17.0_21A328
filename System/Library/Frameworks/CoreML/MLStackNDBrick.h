...
- (void).cxx_destruct;	// IMP=0x0000000000030300
...
- (void)computeOnCPUWithInputTensors:(id)arg1 outputTensors:(id)arg2;	// IMP=0x000000000002fcb2
- (_Bool)hasGPUSupport;	// IMP=0x000000000002fcaa
- (id)initWithParameters:(id)arg1;	// IMP=0x000000000002fa35
- (id)setupForInputShapes:(id)arg1 withParameters:(id)arg2;	// IMP=0x000000000002f67b
