...
- (void).cxx_destruct;	// IMP=0x00200000002cbaf3
...
- (void)headerViewButtonTapped:(id)arg1;	// IMP=0x00100000002cb8e1
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x00100000002cb825
- (void)setupConstraints;	// IMP=0x00100000002cafe3
- (void)setupHeaderContainerView;	// IMP=0x00100000002caca0
- (void)updateImage;	// IMP=0x00100000002cab67
- (void)setupStackView;	// IMP=0x00100000002ca907
- (void)setupSubviews;	// IMP=0x00100000002ca866
- (double)minimumRequiredHeight;	// IMP=0x00100000002ca83d
- (double)maximumRequiredHeight;	// IMP=0x00100000002ca814
- (void)adjustLogoImageViewTopConstraint:(double)arg1;	// IMP=0x00100000002ca783
- (void)headerHeightChangedWithNewYOffset:(double)arg1;	// IMP=0x00100000002ca5f6
- (void)resetLogoHeight;	// IMP=0x00100000002ca51f
- (id)initWithDelegate:(id)arg1 usingPublisherAttribution:(id)arg2 usingAnalyticsManager:(id)arg3;	// IMP=0x00100000002ca403
