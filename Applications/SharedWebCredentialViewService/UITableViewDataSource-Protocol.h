...
@class MISSING_TYPE, NSArray, NSIndexPath, NSString, UITableView, UITableViewCell;
...
- (MISSING_TYPE *)tableView:sectionForSectionIndexTitle:atIndex: /* Error: Ran out of types for this method. */;
