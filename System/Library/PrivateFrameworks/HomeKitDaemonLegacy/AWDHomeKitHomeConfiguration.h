...
+ (Class)primaryHAPServicesListCertifiedType;	// IMP=0x0010000000626cc9
+ (Class)hapServicesListCertifiedType;	// IMP=0x0010000000626cb8
+ (Class)primaryHAPServicesListType;	// IMP=0x0010000000626ca7
+ (Class)hapServicesListType;	// IMP=0x0010000000626c96
+ (Class)homeKitMultiUserSettingsType;	// IMP=0x0010000000626c85
+ (Class)eventTriggersType;	// IMP=0x0010000000626c74
- (void).cxx_destruct;	// IMP=0x0000000000623609
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000621b46
- (unsigned long long)hash;	// IMP=0x0000000000620d75
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000061faeb
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000061e3f8
- (void)copyTo:(id)arg1;	// IMP=0x000000000061d21d
- (void)writeTo:(id)arg1;	// IMP=0x000000000061bc75
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000061bc68
- (id)dictionaryRepresentation;	// IMP=0x0000000000618e3b
- (id)description;	// IMP=0x0000000000618d8c
...
- (int)StringAsCurrentMediaAccessoryFallbackMediaUserType:(id)arg1;	// IMP=0x000000000061885f
- (id)currentMediaAccessoryFallbackMediaUserTypeAsString:(int)arg1;	// IMP=0x0000000000618814
...
- (id)primaryHAPServicesListCertifiedAtIndex:(unsigned long long)arg1;	// IMP=0x0000000000617ed7
- (unsigned long long)primaryHAPServicesListCertifiedsCount;	// IMP=0x0000000000617eba
- (void)addPrimaryHAPServicesListCertified:(id)arg1;	// IMP=0x0000000000617e50
- (void)clearPrimaryHAPServicesListCertifieds;	// IMP=0x0000000000617e33
- (id)hapServicesListCertifiedAtIndex:(unsigned long long)arg1;	// IMP=0x0000000000617e16
- (unsigned long long)hapServicesListCertifiedsCount;	// IMP=0x0000000000617df9
- (void)addHapServicesListCertified:(id)arg1;	// IMP=0x0000000000617d8f
- (void)clearHapServicesListCertifieds;	// IMP=0x0000000000617d72
- (id)primaryHAPServicesListAtIndex:(unsigned long long)arg1;	// IMP=0x0000000000617d55
- (unsigned long long)primaryHAPServicesListsCount;	// IMP=0x0000000000617d38
- (void)addPrimaryHAPServicesList:(id)arg1;	// IMP=0x0000000000617cce
- (void)clearPrimaryHAPServicesLists;	// IMP=0x0000000000617cb1
- (id)hapServicesListAtIndex:(unsigned long long)arg1;	// IMP=0x0000000000617c94
- (unsigned long long)hapServicesListsCount;	// IMP=0x0000000000617c77
- (void)addHapServicesList:(id)arg1;	// IMP=0x0000000000617c0d
- (void)clearHapServicesLists;	// IMP=0x0000000000617bf0
...
- (id)homeKitMultiUserSettingsAtIndex:(unsigned long long)arg1;	// IMP=0x00000000006179c8
- (unsigned long long)homeKitMultiUserSettingsCount;	// IMP=0x00000000006179ab
- (void)addHomeKitMultiUserSettings:(id)arg1;	// IMP=0x0000000000617941
- (void)clearHomeKitMultiUserSettings;	// IMP=0x0000000000617924
...
- (int)StringAsNetworkProtectionStatus:(id)arg1;	// IMP=0x00000000006175ca
- (id)networkProtectionStatusAsString:(int)arg1;	// IMP=0x0000000000617582
...
- (id)eventTriggersAtIndex:(unsigned long long)arg1;	// IMP=0x0000000000616f21
- (unsigned long long)eventTriggersCount;	// IMP=0x0000000000616f04
- (void)addEventTriggers:(id)arg1;	// IMP=0x0000000000616e9a
- (void)clearEventTriggers;	// IMP=0x0000000000616e7d
