...
+ (id)logCategory;	// IMP=0x001000000078bc6d
- (void).cxx_destruct;	// IMP=0x000000000078badc
...
- (void)sendRemoteMessageWithName:(id)arg1 payload:(id)arg2 responseHandler:(CDUnknownBlockType)arg3;	// IMP=0x000000000078b682
- (id)logIdentifier;	// IMP=0x000000000078b632
- (id)initWithTarget:(id)arg1 accessory:(id)arg2 device:(id)arg3 workQueue:(id)arg4 messageDispatcher:(id)arg5;	// IMP=0x000000000078b512
