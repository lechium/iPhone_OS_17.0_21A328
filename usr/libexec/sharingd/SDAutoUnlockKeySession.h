...
- (void).cxx_destruct;	// IMP=0x002000000001cb32
...
- (void)logAutoUnlockEnd;	// IMP=0x001000000001c670
- (void)logAutoUnlockStart;	// IMP=0x001000000001c66a
- (void)invalidateAssertionTimer;	// IMP=0x001000000001c594
- (void)restartAssertionTimer;	// IMP=0x001000000001c383
- (void)releaseIdleSleepAssertion;	// IMP=0x001000000001c2e4
- (void)declareSystemActivityAssertion;	// IMP=0x001000000001c050
- (void)sendConfirmationACK;	// IMP=0x001000000001be39
- (void)sendSessionAuthToken:(id)arg1 error:(id)arg2;	// IMP=0x001000000001b9c8
- (void)sendKeyExchangeRequestWithData:(id)arg1 error:(id)arg2;	// IMP=0x001000000001b6da
- (void)sendAuthPromptResponseWithData:(id)arg1 error:(id)arg2;	// IMP=0x001000000001b3ee
- (void)sendAWDLInfoWithKeyData:(id)arg1 error:(id)arg2;	// IMP=0x001000000001ade0
- (void)handleCleanUpAWDL;	// IMP=0x001000000001ad52
- (void)handleUnlockConfirmation:(id)arg1;	// IMP=0x001000000001a908
- (void)createAuthTokenIfReady;	// IMP=0x001000000001a095
- (void)handleSessionKeyExchangeResponse:(id)arg1;	// IMP=0x0010000000019e77
- (void)handleAuthPromptImageData:(id)arg1;	// IMP=0x0010000000019bb2
- (void)handleAuthPromptRequest:(id)arg1;	// IMP=0x00100000000196bb
- (_Bool)handleAWDLInfo:(id)arg1;	// IMP=0x00100000000190d4
- (void)handleMessageWithWrapper:(id)arg1;	// IMP=0x0010000000018950
- (void)nq_handleWiFiRequestInvalidated;	// IMP=0x00100000000188b1
- (void)nq_handleWiFiRequestStartedWithStartAWDLHandler:(CDUnknownBlockType)arg1;	// IMP=0x00100000000187f9
- (void)nq_awdlNetworkStarted;	// IMP=0x0010000000018619
- (void)createWiFiRequest;	// IMP=0x0010000000017e01
- (void)alertOfUnlock;	// IMP=0x0010000000017ce5
- (void)promptForApproval;	// IMP=0x0010000000017cdf
- (void)systemIsActive:(id)arg1;	// IMP=0x0010000000017b2b
- (void)deviceDisconnected:(id)arg1;	// IMP=0x00100000000178e1
- (void)removeObservers;	// IMP=0x001000000001788e
- (void)addObservers;	// IMP=0x0010000000017790
- (void)postBeganUnlockingNotification;	// IMP=0x00100000000176fd
- (void)beginAKSSession;	// IMP=0x00100000000176f7
- (void)notifyDelegateWithError:(id)arg1;	// IMP=0x0010000000017531
- (void)keyCanUnlock:(CDUnknownBlockType)arg1;	// IMP=0x001000000001752b
- (_Bool)keyInState;	// IMP=0x0010000000017395
- (void)_invalidate;	// IMP=0x0010000000017101
- (void)invalidateOnQueue;	// IMP=0x00100000000170c2
- (void)invalidate;	// IMP=0x0010000000017041
- (id)initWithBLEDevice:(id)arg1 sessionID:(id)arg2;	// IMP=0x0010000000016d94
