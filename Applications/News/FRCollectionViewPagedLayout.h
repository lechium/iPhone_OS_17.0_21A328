...
- (id)adjustLayoutAttributeForPageOffset:(id)arg1;	// IMP=0x0010000000038b0f
- (struct CGSize)collectionViewContentSize;	// IMP=0x00100000000388ca
- (id)layoutAttributesForItemAtIndexPath:(id)arg1;	// IMP=0x0010000000038832
- (id)layoutAttributesForElementsInRect:(struct CGRect)arg1;	// IMP=0x001000000003862b
