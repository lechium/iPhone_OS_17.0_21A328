...
- (void).cxx_destruct;	// IMP=0x000000000026d01a
...
- (void)_handleRenderCompletedWithJpegData:(id)arg1 baseSize:(struct CGSize)arg2 editedSize:(struct CGSize)arg3;	// IMP=0x000000000026cf17
- (void)run;	// IMP=0x000000000026ccf6
- (id)_editSource;	// IMP=0x000000000026ca67
- (_Bool)_isInputValid;	// IMP=0x000000000026c92b
- (id)initWithImageInfoNode:(id)arg1 videoURLNode:(id)arg2 compositionController:(id)arg3 livePhotoPairingIdentifier:(id)arg4 jpegCompression:(double)arg5;	// IMP=0x000000000026c61d
