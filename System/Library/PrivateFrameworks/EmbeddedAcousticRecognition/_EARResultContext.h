...
- (id).cxx_construct;	// IMP=0x00000000000afccf
- (void).cxx_destruct;	// IMP=0x00000000000afc5a
...
- (void)updateLoggableResultWithCurrentResult:(const void *)arg1 currentCosts:(const void *)arg2 startMilliseconds:(unsigned int)arg3;	// IMP=0x00000000000af905
- (id)description;	// IMP=0x00000000000af825
- (void)resetPartialResultContext;	// IMP=0x00000000000af7d2
- (void)addPartialResultToContext:(const void *)arg1;	// IMP=0x00000000000af6ef
- (void)incrementCountOfIsFinalFalseAlreadyWritten;	// IMP=0x00000000000af6e5
