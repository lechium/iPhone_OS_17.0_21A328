...
- (void).cxx_destruct;	// IMP=0x002000000002f155
- (void)_startListeningToMemoryPressureEvents;	// IMP=0x001000000002ede7
- (void)dealloc;	// IMP=0x001000000002ed92
- (void)start;	// IMP=0x001000000002ed64
- (void)protectedDataDidBecomeAvailable:(id)arg1;	// IMP=0x001000000002ed5e
- (void)_migrate;	// IMP=0x001000000002eb6a
- (void)_clearNavTracesDirectory;	// IMP=0x001000000002e980
- (void)_stopMonitoringSignificantLocationChanges;	// IMP=0x001000000002e8d5
- (void)_turnOffCoreRoutineMonitoringOn3DTouchDevices;	// IMP=0x001000000002e834
- (void)_main;	// IMP=0x001000000002e6c2
