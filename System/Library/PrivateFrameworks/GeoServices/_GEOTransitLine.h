...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000001208998
- (void).cxx_destruct;	// IMP=0x0000000001208b64
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000001208ac4
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000012089a0
...
- (id)initWithLine:(id)arg1 system:(id)arg2 locationHint:(CDStruct_c3b9c2ee)arg3;	// IMP=0x00000000012084b6
