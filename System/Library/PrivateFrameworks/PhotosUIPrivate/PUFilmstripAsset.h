...
@interface PUFilmstripAsset : NSObject
{
    unsigned long long _pixelWidth;	// 8 = 0x8
    unsigned long long _pixelHeight;	// 16 = 0x10
    _Bool __isSourceTimeAccurate;	// 24 = 0x18
    double _sourceTime;	// 32 = 0x20
    AVAsset *__asset;	// 40 = 0x28
    double __normalizedTime;	// 48 = 0x30
}
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000002436b3
- (long long)compare:(id)arg1;	// IMP=0x0000000000243672
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000002435f5
...
- (unsigned long long)isContentEqualTo:(id)arg1;	// IMP=0x000000000024353d
...
- (void)loadSourceTimeWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000243347
- (id)initWithNormalizedTime:(double)arg1 asset:(id)arg2;	// IMP=0x000000000024321f
- (id)init;	// IMP=0x0000000000243208
