...
+ (id)errorEventWithErrorType:(unsigned long long)arg1 accessory:(id)arg2;	// IMP=0x0060000000c62bc0
- (void).cxx_destruct;	// IMP=0x0000000000c62baf
...
- (id)initWithErrorType:(unsigned long long)arg1 accessory:(id)arg2;	// IMP=0x0000000000c62b0c
