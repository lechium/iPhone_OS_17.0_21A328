...
+ (void)px_generateResourceFilesForAssets:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0010000000552fe8
+ (id)addressWithoutUnitedStatesZipCode:(id)arg1;	// IMP=0x0010000000552e77
+ (id)px_orderedAssetsFromAssets:(id)arg1 sortDescriptors:(id)arg2;	// IMP=0x0010000000552c42
+ (id)px_fetchPlacesAssetsInAssetCollection:(id)arg1 options:(id)arg2;	// IMP=0x0010000000552952
+ (id)px_fetchAssetsInArray:(id)arg1 photoLibrary:(id)arg2;	// IMP=0x00100000005528a0
@property(readonly, nonatomic) struct CGPoint positionOffset;
@property(readonly, nonatomic) struct CGAffineTransform transform;
- (float)px_playbackScore;	// IMP=0x001000000029aed8
- (double)weightUsingWeightingScheme:(long long)arg1;	// IMP=0x001000000029ac4d
- (double)weightUsingCriterion:(long long)arg1;	// IMP=0x001000000029abf6
@property(readonly, nonatomic) double weight;
@property(readonly, nonatomic) struct CGSize size;
- (_Bool)px_isRecommendationSeenForVariationType:(long long)arg1;	// IMP=0x0010000000488da0
- (_Bool)px_isVariationTypeRecommended:(long long)arg1;	// IMP=0x0010000000488c7e
- (id)px_coreDataBrowserURL;	// IMP=0x0010000000551edc
- (id)px_navigationURLWithContainerCollection:(id)arg1;	// IMP=0x0010000000551dab
- (id)px_navigationURLQueryItemWithPrefix:(id)arg1;	// IMP=0x0010000000551cfc
- (id)_userFeedbackScoreInfo;	// IMP=0x00100000005518e4
- (id)_imageProcessingFlags;	// IMP=0x00100000005516a4
@property(readonly, nonatomic) _Bool px_shotWithNightMode;
- (id)_videoDeferredProcessingNeededString:(unsigned short)arg1;	// IMP=0x00100000005515d5
- (id)_deferredProcessingStringWithEnum:(unsigned short)arg1;	// IMP=0x00100000005515b1
- (id)_junkClassificationStringWithClassifications:(id)arg1;	// IMP=0x0010000000550fc2
- (id)_sdClassificationStringWithClassifications:(id)arg1;	// IMP=0x0010000000550d30
- (id)_sceneClassificationStringWithClassifications:(id)arg1;	// IMP=0x00100000005507c0
- (id)_ocrStrings;	// IMP=0x00100000005507b3
- (id)stringMinutesTimeRangeFromTimeRange:(CDStruct_3c1748cc)arg1;	// IMP=0x00100000005506c4
@property(readonly, nonatomic) PXDebugValueList *px_curationDebugValues;
- (id)px_detailedDebugDescriptionInLibrary:(id)arg1;	// IMP=0x001000000054d43f
...
- (id)px_slHighlightWithError:(id *)arg1;	// IMP=0x001000000054c861
...
- (id)px_singleLineMailingAddress;	// IMP=0x001000000054c2d9
...
- (struct CGRect)bestCropRectForAspectRatioV2:(double)arg1 verticalContentMode:(long long)arg2 cropMode:(long long)arg3;	// IMP=0x00100000007ed46c
- (void)enumerateCropVariantsForTargetSize:(struct CGSize)arg1 preferFaceCrops:(_Bool)arg2 usingBlock:(CDUnknownBlockType)arg3;	// IMP=0x00100000007ed186
- (struct CGRect)bestCropRectForAspectRatio:(double)arg1 verticalContentMode:(long long)arg2 cropMode:(long long)arg3;	// IMP=0x00100000007ecec6
- (struct CGRect)bestCropRectForAspectRatio:(double)arg1;	// IMP=0x00100000007ece9f
@property(readonly, nonatomic) unsigned long long thumbnailVersion;
- (long long)isContentEqualTo:(id)arg1;	// IMP=0x00100000007ecdb5
@property(readonly, nonatomic) Class defaultImageProviderClass;
- (id)localizedDetailedGeoDescriptionForRTL:(_Bool)arg1;	// IMP=0x00100000007ecbc7
...
- (id)_faceNamesStringForAsset;	// IMP=0x00100000008cf50d
- (id)px_accessibilityLabelForStyles:(unsigned long long)arg1;	// IMP=0x00100000008cf08e
@property(readonly, nonatomic) _Bool requiresConfidentiality;
- (_Bool)px_isSupportedApp:(id)arg1;	// IMP=0x0010000000a53e72
...
- (id)_px_currentRAWResource;	// IMP=0x0010000000a6a026
