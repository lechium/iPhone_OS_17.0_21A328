...
- (void).cxx_destruct;	// IMP=0x0020000000006243
- (void)_updateStatisticsFromSnapshots;	// IMP=0x0010000000006049
- (void)setCurrentValue:(unsigned long long)arg1;	// IMP=0x0010000000005e61
@property(readonly, nonatomic) double estimatedTimeRemaining;
- (id)initWithMaxValue:(unsigned long long)arg1;	// IMP=0x0010000000005cf6
