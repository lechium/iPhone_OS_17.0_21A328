...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000003c8ee2
- (unsigned long long)hash;	// IMP=0x00000000003c8dee
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000003c8c56
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000003c8b44
- (void)copyTo:(id)arg1;	// IMP=0x00000000003c8a55
- (void)writeTo:(id)arg1;	// IMP=0x00000000003c8922
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000003c8915
- (id)dictionaryRepresentation;	// IMP=0x00000000003c8618
- (id)description;	// IMP=0x00000000003c8569
