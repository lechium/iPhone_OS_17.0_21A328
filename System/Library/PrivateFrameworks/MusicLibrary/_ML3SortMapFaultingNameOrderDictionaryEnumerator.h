...
- (void).cxx_destruct;	// IMP=0x00000000000b2805
- (id)nextObject;	// IMP=0x00000000000b2606
- (id)initWithDirtyInsertsEnumerator:(id)arg1 connection:(id)arg2;	// IMP=0x00000000000b2564
