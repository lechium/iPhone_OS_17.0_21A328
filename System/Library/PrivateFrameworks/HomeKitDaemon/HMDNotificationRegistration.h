...
+ (id)logCategory;	// IMP=0x0010000000c279df
- (void).cxx_destruct;	// IMP=0x0000000000c279b0
...
- (void)addObserver:(SEL)arg1 name:(id)arg2 object:(id)arg3;	// IMP=0x0000000000c276e5
- (id)logIdentifier;	// IMP=0x0000000000c27610
- (id)initWithRegisterer:(id)arg1;	// IMP=0x0000000000c27578
