...
- (void).cxx_destruct;	// IMP=0x00200000000172fa
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000001719a
- (unsigned long long)hash;	// IMP=0x0010000000017154
- (id)initWithContextRelativePointerPosition:(id)arg1 displayUUID:(id)arg2 restrictingToPID:(int)arg3;	// IMP=0x001000000001709f
