...
+ (id)broadcastKeyGenerationEventForAccessory:(id)arg1 reason:(int)arg2;	// IMP=0x00600000007c350e
- (void).cxx_destruct;	// IMP=0x00000000007c34fb
...
- (id)initBroadcastKeyGenerationEventForAccessory:(id)arg1 reason:(int)arg2;	// IMP=0x00000000007c345b
