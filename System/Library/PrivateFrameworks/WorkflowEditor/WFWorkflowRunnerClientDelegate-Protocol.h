...
@class NSDictionary, NSError, NSProgress, WFContentCollection, WFWorkflowRunnerClient;
...
- (void)workflowRunnerClient:(WFWorkflowRunnerClient *)arg1 didFinishRunningWorkflowWithAllResults:(NSDictionary *)arg2 error:(NSError *)arg3 cancelled:(_Bool)arg4;
