...
- (void).cxx_destruct;	// IMP=0x00000000000248b2
@property(readonly, nonatomic) __weak COCapabilityManager *manager; // @synthesize manager=_manager;
- (void)availabilityChanged:(_Bool)arg1 ofCapability:(id)arg2 inCluster:(id)arg3;	// IMP=0x0000000000024815
- (id)initWithCapabilityManager:(id)arg1;	// IMP=0x00000000000247b1
