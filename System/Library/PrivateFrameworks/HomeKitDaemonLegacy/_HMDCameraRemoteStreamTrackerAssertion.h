...
- (void).cxx_destruct;	// IMP=0x00000000006a79be
...
- (void)dealloc;	// IMP=0x00000000006a7910
- (id)initWithStreamTracker:(id)arg1 streamIdentifier:(id)arg2;	// IMP=0x00000000006a7875
