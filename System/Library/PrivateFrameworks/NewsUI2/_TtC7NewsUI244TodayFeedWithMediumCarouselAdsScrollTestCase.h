...
@interface _TtC7NewsUI244TodayFeedWithMediumCarouselAdsScrollTestCase : NSObject
{
...
- (void).cxx_destruct;	// IMP=0x00000000000e1a30
- (id)init;	// IMP=0x00000000000e1a10
- (id)scrollViewWithContext:(id)arg1;	// IMP=0x00000000000e1dd0
