...
- (void).cxx_destruct;	// IMP=0x0020000000a8a3ad
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000a8a299
- (id)initWithDisplayName:(id)arg1 isSelected:(_Bool)arg2 data:(id)arg3 refinementKey:(id)arg4;	// IMP=0x0010000000a8a1b4
