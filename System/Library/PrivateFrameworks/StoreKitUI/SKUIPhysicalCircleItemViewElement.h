...
- (void).cxx_destruct;	// IMP=0x0000000000361317
...
- (id)applyUpdatesWithElement:(id)arg1;	// IMP=0x000000000036123b
...
- (id)initWithDOMElement:(id)arg1 parent:(id)arg2 elementFactory:(id)arg3;	// IMP=0x00000000003610a2
