...
@class NIAlgorithmConvergenceState, NINearbyObject, NIRegionPredicate, NISession, NSError;

@protocol NIInternalSessionDelegate <NISessionDelegate>

@optional
- (void)session:(NISession *)arg1 didUpdateHomeDeviceUWBRangingAvailability:(_Bool)arg2;
...
- (void)session:(NISession *)arg1 didReceiveRangingAuthRecommendation:(_Bool)arg2 forObject:(NINearbyObject *)arg3;
...
- (void)session:(NISession *)arg1 suspensionReasonEnded:(long long)arg2 isNoLongerSuspended:(_Bool)arg3;
