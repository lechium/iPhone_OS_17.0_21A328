...
- (id)socketPairMessage;	// IMP=0x00100000001b6411
- (void)processAckForSocketPairMessage:(id)arg1;	// IMP=0x00100000001b63f9
- (void)kickProgressBlock;	// IMP=0x00100000001b62a6
- (id)init;	// IMP=0x00100000001b6154
