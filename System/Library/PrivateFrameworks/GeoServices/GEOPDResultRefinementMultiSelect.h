...
- (void).cxx_destruct;	// IMP=0x0000000000e83ef2
- (unsigned long long)hash;	// IMP=0x0000000000e83df1
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000e83c39
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000e8387b
- (void)writeTo:(id)arg1;	// IMP=0x0000000000e83521
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000e83512
- (id)jsonRepresentation;	// IMP=0x0000000000e83193
- (id)dictionaryRepresentation;	// IMP=0x0000000000e82b87
- (id)description;	// IMP=0x0000000000e82ad8
- (id)initWithData:(id)arg1;	// IMP=0x0000000000e818ee
- (id)init;	// IMP=0x0000000000e81892
