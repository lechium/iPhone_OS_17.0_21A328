...
- (void).cxx_destruct;	// IMP=0x000000000031353c
...
- (void)_setLogoImage:(id)arg1 forCharity:(id)arg2;	// IMP=0x000000000031327b
- (void)_setHeaderImage:(id)arg1 forTheme:(id)arg2;	// IMP=0x0000000000313075
- (void)_loadThemeImages;	// IMP=0x0000000000312c26
- (void)_finishLoadAccountInfoWithResponse:(id)arg1 error:(id)arg2 block:(CDUnknownBlockType)arg3;	// IMP=0x0000000000312a6e
- (void)_finishLoadWithResponse:(id)arg1 error:(id)arg2 block:(CDUnknownBlockType)arg3;	// IMP=0x0000000000311967
- (void)removeObserver:(id)arg1;	// IMP=0x0000000000311930
- (id)logoImageForCharity:(id)arg1;	// IMP=0x00000000003118cd
- (void)loadLogoForCharity:(id)arg1;	// IMP=0x00000000003115b9
- (void)loadConfigurationWithCompletionBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000000311184
- (_Bool)loadCachedConfiguration;	// IMP=0x000000000031117c
- (id)charityForIdentifier:(id)arg1;	// IMP=0x0000000000310fb7
- (void)addObserver:(id)arg1;	// IMP=0x0000000000310f11
- (id)initWithOperationQueue:(id)arg1 clientContext:(id)arg2;	// IMP=0x0000000000310e35
