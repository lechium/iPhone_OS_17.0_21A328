...
+ (id)sharedSystem;	// IMP=0x002000000001e0ea
- (void).cxx_destruct;	// IMP=0x002000000001f962
...
- (id)_queue_createAccessibilitySessionToken;	// IMP=0x001000000001f78b
- (void)invalidateToken:(id)arg1;	// IMP=0x001000000001f57b
- (void)_queue_setAccelerometerEnabled:(_Bool)arg1;	// IMP=0x001000000001f3fc
- (void)_queue_setPassiveListeningModeEnabled:(_Bool)arg1;	// IMP=0x001000000001f173
- (void)_queue_unloadAccessibility;	// IMP=0x001000000001ef4a
- (_Bool)_queue_setDisableOnTerminationWithError:(id *)arg1;	// IMP=0x001000000001ed53
- (_Bool)_queue_loadAccessibilityIfNeeded:(_Bool)arg1 andWaitForNotificationWithTimeout:(double)arg2 error:(id *)arg3;	// IMP=0x001000000001e991
- (id)_queue_loadAccessibilityWithTimeout:(double)arg1 error:(id *)arg2;	// IMP=0x001000000001e621
- (id)loadAccessibilityWithTimeout:(double)arg1 error:(id *)arg2;	// IMP=0x001000000001e37a
- (void)dealloc;	// IMP=0x001000000001e279
- (id)initWithAccessibilityFunctions:(CDStruct_f25c63ae)arg1;	// IMP=0x001000000001e192
