...
- (void)ubiquityIdentityChanged:(id)arg1;	// IMP=0x000000000034fcbe
- (void)_applicationResumed:(id)arg1;	// IMP=0x000000000034fbe9
- (void)containerDeleteDetected:(id)arg1;	// IMP=0x000000000034fac8
- (id)description;	// IMP=0x000000000034f396
- (void)dealloc;	// IMP=0x000000000034f313
- (id)initWithProcessingQueue:(id)arg1 localPeerID:(id)arg2 storeName:(id)arg3 andUbiquityRootLocation:(id)arg4;	// IMP=0x000000000034f275
- (id)init;	// IMP=0x000000000034f226
