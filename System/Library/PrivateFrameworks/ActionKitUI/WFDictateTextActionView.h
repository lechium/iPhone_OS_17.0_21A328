...
- (void).cxx_destruct;	// IMP=0x0000000000036c02
...
- (void)updateWithTranscription:(id)arg1;	// IMP=0x0000000000036aca
- (void)stopButtonTapped;	// IMP=0x00000000000369f7
- (void)dealloc;	// IMP=0x0000000000036975
- (id)initWithFrame:(struct CGRect)arg1 padded:(_Bool)arg2;	// IMP=0x00000000000364b6
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000000364a2
