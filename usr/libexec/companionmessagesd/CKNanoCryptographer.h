...
+ (id)sharedCryptographer;	// IMP=0x0040000000006528
...
- (id)stringDigestForName:(id)arg1;	// IMP=0x001000000000692d
@property(readonly, nonatomic) NSData *deviceSalt;
- (void)prewarmDeviceSalt;	// IMP=0x00100000000065d5
- (id)init;	// IMP=0x001000000000657d
