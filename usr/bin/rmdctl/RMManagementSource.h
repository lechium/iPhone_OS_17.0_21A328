...
+ (id)fetchRequestWithAccountIdentifier:(id)arg1;	// IMP=0x00200000000109e0
+ (id)fetchRequestWithIdentifier:(id)arg1;	// IMP=0x0010000000010939
+ (id)fetchRequestWithEnrollmentType:(long long)arg1;	// IMP=0x00100000000108b6
+ (id)fetchRequestWithDeviceChannel;	// IMP=0x0010000000010833
+ (id)fetchRequestWithBootstrapURI:(id)arg1 enrollmentType:(long long)arg2;	// IMP=0x001000000001077e
+ (id)fetchRequestWithBootstrapURI:(id)arg1;	// IMP=0x00100000000106d7
- (id)reportDetails;	// IMP=0x0010000000010a87
- (void)awakeFromInsert;	// IMP=0x0010000000010644
