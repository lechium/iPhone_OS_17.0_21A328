...
+ (id)switcherItemWithIdentifier:(id)arg1;	// IMP=0x0060000000aeaf50
- (void).cxx_destruct;	// IMP=0x0000000000aeb23b
...
- (id)initWithIdentifier:(id)arg1;	// IMP=0x0000000000aeafff
- (void)dealloc;	// IMP=0x0000000000aeaf99
