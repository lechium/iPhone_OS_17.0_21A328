...
@interface _SSSPDFPageMiniMapView : UIView
{
    ...
    _SSSScrollViewLayoutRects *;	// 72 = 0x48
...
+ (struct CGAffineTransform)_transformToConvertToRect:(struct CGRect)arg1 fromRect:(struct CGRect)arg2;	// IMP=0x0040000000034512
+ (struct CGPoint)adjustedTranslationForProposedRect:(struct CGRect)arg1 originalRect:(struct CGRect)arg2 scaledContentViewBounds:(struct CGRect)arg3;	// IMP=0x0010000000033ab8
...
- (struct CGRect)convertRectToPageViewSpace:(struct CGRect)arg1 fromView:(id)arg2;	// IMP=0x0010000000034371
- (struct CGRect)convertRectFromPageViewSpace:(struct CGRect)arg1 toView:(id)arg2;	// IMP=0x00100000000341d7
- (struct CGRect)visibleRectInPageViewSpace;	// IMP=0x001000000003404d
- (void)userDidPanSelectionRect:(id)arg1;	// IMP=0x0010000000033c8d
- (_Bool)isDraggingVisibleRect;	// IMP=0x0010000000033a68
- (void)updatePDFViewFromVisibleRegionView;	// IMP=0x0010000000033844
- (void)updateVisibleRegionViewFromPDFView;	// IMP=0x0010000000033374
- (void)annotationsDidChange;	// IMP=0x00100000000330c4
- (void)visibleRegionRectDidChange;	// IMP=0x001000000003308d
- (id)pageImageForSize:(struct CGSize)arg1;	// IMP=0x0010000000032e4e
- (id)pageView;	// IMP=0x0010000000032de7
- (id)pdfPage;	// IMP=0x0010000000032d75
- (void)setNeedsPageImageUpdate;	// IMP=0x0010000000032d3d
- (void)_removePDFNotifications;	// IMP=0x0010000000032b97
- (void)_setupPDFNotificationsIfPossible;	// IMP=0x0010000000032a1f
- (void)layoutSubviews;	// IMP=0x0010000000032779
- (void)dealloc;	// IMP=0x001000000003270d
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00100000000325af
