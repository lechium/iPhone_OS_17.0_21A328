...
+ (id)instanceWithDictionary:(id)arg1;	// IMP=0x001000000000e55d
- (void).cxx_destruct;	// IMP=0x000000000000e7c8
...
- (id)initWithConnectionIdentifier:(id)arg1 receivedSequenceNumber:(id)arg2 content:(id)arg3;	// IMP=0x000000000000e2d3
