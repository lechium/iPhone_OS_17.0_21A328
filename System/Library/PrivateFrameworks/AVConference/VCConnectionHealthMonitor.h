...
- (void)resetHistory:(struct ConnectionStatsHistory *)arg1;	// IMP=0x000000000031abc0
- (void)resetConnectionStats:(_Bool)arg1;	// IMP=0x000000000031ab66
- (void)processPeerStatsBlob:(unsigned int)arg1;	// IMP=0x000000000031a660
- (unsigned int)generateStatsBlob;	// IMP=0x000000000031a5ae
@property id <VCConnectionHealthMonitorDelegate> delegate; // @synthesize delegate=_delegate;
- (void)dealloc;	// IMP=0x000000000031a1eb
- (id)init;	// IMP=0x000000000031a05d
