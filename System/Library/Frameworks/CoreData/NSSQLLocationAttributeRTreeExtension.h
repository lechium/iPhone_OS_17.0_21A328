...
- (_Bool)validate:(id *)arg1;	// IMP=0x00000000002717f0
- (_Bool)isEqualToExtension:(id)arg1;	// IMP=0x00000000002715fd
...
- (void)dealloc;	// IMP=0x0000000000271523
- (id)initWithObjectFromUserInfo:(id)arg1 onAttributeNamed:(id)arg2 onEntity:(id)arg3;	// IMP=0x00000000002712b3
