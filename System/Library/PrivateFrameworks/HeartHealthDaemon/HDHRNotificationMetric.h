...
+ (id)eventName;	// IMP=0x004000000001447e
- (void).cxx_destruct;	// IMP=0x0000000000014668
...
- (void)submit;	// IMP=0x0000000000014575
- (id)eventPayload;	// IMP=0x000000000001448b
- (id)initWithNotificationType:(id)arg1;	// IMP=0x00000000000143c8
