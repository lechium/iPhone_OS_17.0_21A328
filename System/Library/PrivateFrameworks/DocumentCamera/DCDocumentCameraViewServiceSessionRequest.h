...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000038691
- (void).cxx_destruct;	// IMP=0x0000000000038835
...
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000038699
- (id)init;	// IMP=0x0000000000038582
