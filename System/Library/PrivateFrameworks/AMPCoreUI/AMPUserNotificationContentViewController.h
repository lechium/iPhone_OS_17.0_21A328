...
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x0000000000005645
- (void)mediaPause;	// IMP=0x00000000000054b8
- (void)imageViewTapped:(id)arg1;	// IMP=0x000000000000547b
- (void)viewWillLayoutSubviews;	// IMP=0x0000000000004c39
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x0000000000004b49
@property(readonly, nonatomic) struct CGSize expectedContentSize;
- (void)setPreferredContentSize:(struct CGSize)arg1;	// IMP=0x000000000000478a
- (void)loadView;	// IMP=0x00000000000043a7
- (id)initWithNotification:(id)arg1 delegate:(id)arg2;	// IMP=0x00000000000035a1
