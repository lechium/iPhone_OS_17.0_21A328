...
+ (_Bool)sourceTypeIsFoundOnServers:(unsigned long long)arg1;	// IMP=0x00600000000ddad4
+ (_Bool)sourceTypeIsFoundInMail:(unsigned long long)arg1;	// IMP=0x00600000000ddac5
- (void).cxx_destruct;	// IMP=0x00000000000ddb59
...
- (void)addResult:(id)arg1;	// IMP=0x00000000000dd9c4
- (id)init;	// IMP=0x00000000000dd926
- (id)searchResults;	// IMP=0x00000000000ddb95
