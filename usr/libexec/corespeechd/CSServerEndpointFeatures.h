...
+ (id)initialResultCandidateFeatures;	// IMP=0x004000000000c2c8
+ (id)initialServerEndpointFeatures;	// IMP=0x001000000000c274
- (void).cxx_destruct;	// IMP=0x002000000000c24c
...
- (id)dictionary;	// IMP=0x001000000000bfd2
- (id)description;	// IMP=0x001000000000bf21
- (id)initWithWordCount:(long long)arg1 trailingSilenceFrames:(long long)arg2 endOfSilenceLikelihood:(double)arg3 pauseCounts:(id)arg4 silencePosterior:(double)arg5 taskName:(id)arg6;	// IMP=0x001000000000befe
- (id)initWithWordCount:(long long)arg1 trailingSilenceDuration:(long long)arg2 eosLikelihood:(double)arg3 pauseCounts:(id)arg4 silencePosterior:(double)arg5 taskName:(id)arg6 processedAudioDurationInMilliseconds:(long long)arg7;	// IMP=0x001000000000be2a
