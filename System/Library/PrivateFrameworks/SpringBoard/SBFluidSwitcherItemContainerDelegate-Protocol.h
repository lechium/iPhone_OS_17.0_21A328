...
- (_Bool)hitTestedToFloatingElement:(struct CGPoint)arg1 window:(UIWindow *)arg2 ofItemContainer:(SBFluidSwitcherItemContainer *)arg3;
...
- (void)containerSelectionStateChanged:(SBFluidSwitcherItemContainer *)arg1 toState:(long long)arg2 hover:(_Bool)arg3 pencilHover:(_Bool)arg4;
