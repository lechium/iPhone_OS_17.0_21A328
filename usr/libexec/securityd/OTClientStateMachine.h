...
- (void).cxx_destruct;	// IMP=0x002000000020521e
...
- (void)rpcVoucher:(id)arg1 peerID:(id)arg2 permanentInfo:(id)arg3 permanentInfoSig:(id)arg4 stableInfo:(id)arg5 stableInfoSig:(id)arg6 reply:(CDUnknownBlockType)arg7;	// IMP=0x0010000000204d50
- (void)rpcEpoch:(id)arg1 reply:(CDUnknownBlockType)arg2;	// IMP=0x0010000000204a53
- (id)_onqueueNextClientStateMachineTransition:(id)arg1;	// IMP=0x001000000020456f
- (_Bool)isAcceptorWaitingForFirstMessage;	// IMP=0x00100000002044d5
- (void)handleExternalClientStateMachineRequest:(id)arg1 client:(id)arg2;	// IMP=0x00100000002043f6
- (void)_onqueueStartNextClientStateMachineOperation:(id)arg1;	// IMP=0x00100000002041df
- (void)_onqueuePokeClientStateMachine:(id)arg1;	// IMP=0x0010000000204141
- (id)createOperationToFinishAttemptForClient:(id)arg1 clientName:(id)arg2;	// IMP=0x0010000000203fbe
- (void)startOctagonStateMachine;	// IMP=0x0010000000203f4d
@property(retain) NSString<OctagonStateString> *currentState;
- (void)dealloc;	// IMP=0x0010000000203de4
- (id)initWithContainerName:(id)arg1 contextID:(id)arg2 clientName:(id)arg3 cuttlefish:(id)arg4;	// IMP=0x0010000000203acc
