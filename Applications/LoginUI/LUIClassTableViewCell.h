...
- (void).cxx_destruct;	// IMP=0x002000000000f095
...
- (void)_removeImageDataObserversFromContacts:(id)arg1;	// IMP=0x001000000000eceb
- (void)_addImageDataObserversToContacts:(id)arg1;	// IMP=0x001000000000eb8d
- (id)_contactsForInstructors:(id)arg1;	// IMP=0x001000000000e7d7
- (id)_instructorsInClass:(id)arg1;	// IMP=0x001000000000e5e9
- (void)disableCellForUserInteraction;	// IMP=0x001000000000e424
- (void)enableCellForUserInteraction;	// IMP=0x001000000000e381
- (void)updateImage;	// IMP=0x001000000000e0f2
- (void)updateName;	// IMP=0x001000000000df31
- (id)_userForObject:(id)arg1;	// IMP=0x001000000000ddcf
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x001000000000dd6a
- (void)layoutSubviews;	// IMP=0x001000000000d6ce
- (id)initWithStyle:(long long)arg1 reuseIdentifier:(id)arg2;	// IMP=0x001000000000d3ae
- (void)dealloc;	// IMP=0x001000000000d2e0
