...
+ (id)requestWithFaceClusterIds:(id)arg1 clusterFlags:(id)arg2 updateHandler:(CDUnknownBlockType)arg3;	// IMP=0x006000000002d1f9
- (void).cxx_destruct;	// IMP=0x000000000002d33a
...
- (id)initWithFaceClusterIds:(id)arg1 clusterFlags:(id)arg2 updateHandler:(CDUnknownBlockType)arg3;	// IMP=0x000000000002ceb5
