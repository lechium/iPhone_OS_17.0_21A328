...
+ (long long)session_message_typeForImmutableObject:(id)arg1;	// IMP=0x00100000000785ea
+ (Class)session_message_immutableClassForType:(long long)arg1;	// IMP=0x00100000000785b0
- (void).cxx_destruct;	// IMP=0x000000000007909e
- (id)flatbuffData;	// IMP=0x0000000000078f17
- (Offset_a99fc554)addObjectToBuffer:(void *)arg1;	// IMP=0x0000000000078864
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000007784b
- (id)initWithFlatbuffData:(id)arg1 root:(const struct BlazarMultilingualMessage *)arg2 verify:(_Bool)arg3;	// IMP=0x0000000000077668
- (id)initWithFlatbuffData:(id)arg1 root:(const struct BlazarMultilingualMessage *)arg2;	// IMP=0x0000000000077653
- (id)initAndVerifyWithFlatbuffData:(id)arg1;	// IMP=0x0000000000077639
- (id)initWithFlatbuffData:(id)arg1;	// IMP=0x0000000000077622
