...
- (void).cxx_destruct;	// IMP=0x0020000000140f11
...
- (id)initWithAdditionalEncryptionResult:(id)arg1;	// IMP=0x0010000000140e92
- (id)initWithMPIdentityIdentifier:(id)arg1;	// IMP=0x0010000000140e31
- (id)initWithEncryptionType:(long long)arg1;	// IMP=0x0010000000140df4
- (id)init;	// IMP=0x0010000000140ddb
