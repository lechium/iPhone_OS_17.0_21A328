...
- (void).cxx_destruct;	// IMP=0x000000000020b9e7
...
- (_Bool)addFragmentChunk:(id)arg1 error:(id *)arg2;	// IMP=0x000000000020b393
- (id)attributeDescriptions;	// IMP=0x000000000020b11e
- (id)initWithSequenceNumber:(id)arg1 type:(id)arg2;	// IMP=0x000000000020af20
