...
+ (id)logCategory;	// IMP=0x0010000000ba39fd
- (void).cxx_destruct;	// IMP=0x0000000000ba344c
...
- (_Bool)supportsDeviceWithCapabilities:(id)arg1;	// IMP=0x0000000000ba3319
- (void)timerDidFire:(id)arg1;	// IMP=0x0000000000ba2fe3
@property(readonly, nonatomic) NSObject<OS_dispatch_queue> *messageReceiveQueue;
@property(readonly, nonatomic) NSUUID *messageTargetUUID;
- (void)writeForNaturalLightingEnabledWithReason:(id)arg1;	// IMP=0x0000000000ba2ede
- (void)synchronizeCurveWithActiveTransitionContext:(id)arg1;	// IMP=0x0000000000ba2a94
- (void)writeWithNaturalLightingEnabled:(_Bool)arg1 reason:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x0000000000ba288c
- (void)handleCurrentDevicePrimaryResidentChangedWithReason:(id)arg1;	// IMP=0x0000000000ba26bf
- (void)handlePrimaryResidentUpdateNotification:(id)arg1;	// IMP=0x0000000000ba2607
- (void)handleActiveTransitionContextUpdated:(id)arg1;	// IMP=0x0000000000ba1de5
- (void)configureWithLightProfile:(id)arg1;	// IMP=0x0000000000ba1b1a
- (id)initWithUUID:(id)arg1 workQueue:(id)arg2 logIdentifier:(id)arg3 dataSource:(id)arg4 notificationCenter:(id)arg5 timerFactory:(CDUnknownBlockType)arg6;	// IMP=0x0000000000ba19cf
- (id)initWithUUID:(id)arg1 workQueue:(id)arg2 logIdentifier:(id)arg3;	// IMP=0x0000000000ba18ed
