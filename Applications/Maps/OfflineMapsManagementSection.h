...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000836974
- (unsigned long long)hash;	// IMP=0x0010000000836962
- (id)initWithSectionType:(unsigned long long)arg1;	// IMP=0x0010000000836925
