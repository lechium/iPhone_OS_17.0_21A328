...
@interface _TtC8StocksUI23StockFeedMemoryTestCase : NSObject
{
...
- (id)init;	// IMP=0x0000000000178610
- (void)runTestWithContext:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000000178300
