...
- (id)hu_preloadContent;	// IMP=0x00100000000040c6
- (id)commitConfiguration;	// IMP=0x00100000000040a6
- (void)viewDidLoad;	// IMP=0x0010000000003aeb
- (id)initWithCoordinator:(id)arg1 config:(id)arg2;	// IMP=0x00100000000038f9
