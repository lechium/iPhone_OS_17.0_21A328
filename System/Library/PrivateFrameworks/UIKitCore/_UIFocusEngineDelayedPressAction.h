...
+ (void)sendDelayedPressWithType:(long long)arg1 timestamp:(double)arg2 sender:(id)arg3;	// IMP=0x00600000008030a9
- (void).cxx_destruct;	// IMP=0x00000000008034e3
...
- (void)_sendPressEvent;	// IMP=0x000000000080319b
- (id)_initWithPressType:(long long)arg1 timestamp:(double)arg2 sender:(id)arg3;	// IMP=0x0000000000802faf
