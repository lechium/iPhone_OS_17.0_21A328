...
- (void).cxx_destruct;	// IMP=0x0020000000037927
...
- (id)protoBuffer;	// IMP=0x0010000000037678
- (Class)responseClass;	// IMP=0x0010000000037667
- (id)initWithBundleID:(id)arg1 identifier:(id)arg2 segmentIdentifiers:(id)arg3 replaceExisting:(_Bool)arg4 privateSegment:(_Bool)arg5;	// IMP=0x0010000000037568
