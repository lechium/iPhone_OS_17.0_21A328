...
- (void).cxx_destruct;	// IMP=0x00000000003067de
...
- (void)dealloc;	// IMP=0x0000000000306327
- (id)initWithAppContext:(id)arg1 navigationController:(id)arg2 tabBarItem:(id)arg3 owner:(id)arg4;	// IMP=0x00000000003060c0
