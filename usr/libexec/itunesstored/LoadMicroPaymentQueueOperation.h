...
- (_Bool)_loadPaymentsWithExpectedCount:(long long)arg1 error:(id *)arg2;	// IMP=0x001000000009189e
- (_Bool)_getQueueCount:(long long *)arg1 error:(id *)arg2;	// IMP=0x00100000000917ad
- (void)run;	// IMP=0x00100000000916c9
- (void)dealloc;	// IMP=0x0010000000091647
