...
@class MISSING_TYPE, NSDictionary, NSIndexPath, NSString, NSURL, RUIElement, RUIObjectModel, RUIPage, RUITableView, RUITableViewRow, RUITableViewSection, UINavigationController, UIView, UIViewController;
...
- (MISSING_TYPE *)objectModel:tableHeaderViewForAttributes:page: /* Error: Ran out of types for this method. */;
