...
- (void).cxx_destruct;	// IMP=0x0020000000021b9c
...
- (id)initWithGuid:(id)arg1 connectionType:(unsigned int)arg2 linkQuality:(id)arg3 reason:(unsigned int)arg4;	// IMP=0x001000000002192b
