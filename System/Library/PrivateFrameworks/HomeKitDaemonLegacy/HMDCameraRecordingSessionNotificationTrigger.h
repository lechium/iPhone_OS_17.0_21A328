...
+ (id)logCategory;	// IMP=0x00100000009f878b
- (void).cxx_destruct;	// IMP=0x00000000009f8629
...
- (void)listener:(id)arg1 didUpdateAvailableCharacteristics:(id)arg2;	// IMP=0x00000000009f8359
- (void)handleCharacteristicsValueUpdated:(id)arg1;	// IMP=0x00000000009f82a1
- (void)handleAccessoryConfigured:(id)arg1;	// IMP=0x00000000009f8230
- (void)_handleObservedCharacteristicsValueUpdate:(id)arg1;	// IMP=0x00000000009f76a2
- (void)start;	// IMP=0x00000000009f7551
- (void)dealloc;	// IMP=0x00000000009f73db
- (id)initWithCamera:(id)arg1 workQueue:(id)arg2 availabilityListener:(id)arg3 notificationCenter:(id)arg4;	// IMP=0x00000000009f71be
- (id)initWithCamera:(id)arg1 workQueue:(id)arg2;	// IMP=0x00000000009f6fda
