...
@interface _GEOPlaceSearchCompletionItem : NSObject
{
    ...
    _Bool _supportsOfflineDownload;	// 88 = 0x58
}

- (void).cxx_destruct;	// IMP=0x00000000007b904c
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000007b8c35
@property(readonly, nonatomic) NSData *metadata;
@property(readonly, nonatomic) NSData *entryMetadata;
- (void)sendFeedback;	// IMP=0x00000000007b8c1f
- (_Bool)getCoordinate:(CDStruct_c3b9c2ee *)arg1;	// IMP=0x00000000007b8ab3
...
- (id)calloutTitle;	// IMP=0x00000000007b871c
- (id)queryLine;	// IMP=0x00000000007b85fe
- (id)highlightsForLine:(unsigned long long)arg1;	// IMP=0x00000000007b85af
- (id)initWithEntry:(id)arg1 traits:(id)arg2 entryListIndex:(int)arg3 entryIndex:(int)arg4 mapItems:(id)arg5 collections:(id)arg6 publishers:(id)arg7;	// IMP=0x00000000007b6c08
