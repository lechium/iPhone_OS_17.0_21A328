...
@interface AVCaptureConnectionInternal : NSObject
{
    ...
    _Bool videoZoomSmoothingSupported;	// 296 = 0x128
    _Bool videoZoomSmoothingEnabled;	// 297 = 0x129
    _Bool videoGreenGhostMitigationSupported;	// 298 = 0x12a
    _Bool videoGreenGhostMitigationEnabled;	// 299 = 0x12b
    _Bool videoDeviceOrientationCorrectionSupported;	// 300 = 0x12c
    _Bool videoDeviceOrientationCorrectionEnabled;	// 301 = 0x12d
}
