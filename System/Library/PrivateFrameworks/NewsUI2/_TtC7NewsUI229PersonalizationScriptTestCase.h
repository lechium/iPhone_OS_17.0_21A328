...
@interface _TtC7NewsUI229PersonalizationScriptTestCase : NSObject
{
    ...
    MISSING_TYPE *aggregateStoreProvider;	// 24 = 0x18
...
- (void).cxx_destruct;	// IMP=0x0000000000af0710
- (id)init;	// IMP=0x0000000000af06b0
- (void)runTestWithContext:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000000af0620
