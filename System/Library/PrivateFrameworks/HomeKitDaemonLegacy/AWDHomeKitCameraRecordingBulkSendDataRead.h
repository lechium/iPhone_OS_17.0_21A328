...
- (void).cxx_destruct;	// IMP=0x0000000000915ede
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000915c52
- (unsigned long long)hash;	// IMP=0x0000000000915ac2
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000091585a
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000091568f
- (void)copyTo:(id)arg1;	// IMP=0x00000000009154f6
- (void)writeTo:(id)arg1;	// IMP=0x000000000091533c
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000914c27
- (id)dictionaryRepresentation;	// IMP=0x0000000000914823
- (id)description;	// IMP=0x0000000000914774
