...
- (void).cxx_destruct;	// IMP=0x0000000000087bf4
...
- (void)computeOnCPUWithInputTensors:(id)arg1 outputTensors:(id)arg2;	// IMP=0x00000000000879f3
- (_Bool)hasGPUSupport;	// IMP=0x00000000000879eb
- (id)initWithParameters:(id)arg1;	// IMP=0x00000000000878b2
- (id)setupForInputShapes:(id)arg1 withParameters:(id)arg2;	// IMP=0x000000000008789c
