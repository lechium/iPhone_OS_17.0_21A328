...
+ (id)_observationKeys;	// IMP=0x00100000014f86c3
- (void).cxx_destruct;	// IMP=0x00000000014fa0fa
...
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x00000000014f9f00
- (void)_updateOutputs;	// IMP=0x00000000014f90f6
- (struct CGRect)_effectiveViewSourceRect;	// IMP=0x00000000014f90d8
- (struct CGSize)_popoverViewSizeForContentSize:(struct CGSize)arg1 arrowDirection:(unsigned long long)arg2;	// IMP=0x00000000014f8f40
- (id)candidates;	// IMP=0x00000000014f8f2f
- (void)updateProperties:(CDUnknownBlockType)arg1;	// IMP=0x00000000014f8ec7
- (id)description;	// IMP=0x00000000014f8be6
- (void)dealloc;	// IMP=0x00000000014f8a83
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000014f88f1
- (id)init;	// IMP=0x00000000014f8748
