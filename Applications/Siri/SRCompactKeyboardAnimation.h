...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000003fbe2
- (id)initWithKeyboardNotification:(id)arg1;	// IMP=0x001000000003f951
- (id)initWithDuration:(double)arg1 curve:(long long)arg2 beginningFrame:(struct CGRect)arg3 endingFrame:(struct CGRect)arg4;	// IMP=0x001000000003f8c4
