...
@optional
- (void)contactlessInterfaceSessionDidResume:(PKContactlessInterfaceSession *)arg1;
- (void)contactlessInterfaceSession:(PKContactlessInterfaceSession *)arg1 didSuspendWithToken:(NSData *)arg2;
...
- (void)contactlessInterfaceSessionDidReceiveUntrustedTerminal:(PKContactlessInterfaceSession *)arg1;
...
- (void)contactlessInterfaceSessionDidTerminate:(PKContactlessInterfaceSession *)arg1 withErrorCode:(unsigned long long)arg2;
