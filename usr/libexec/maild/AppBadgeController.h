...
@class EDMessageCountQueryHandler, EDMessagePersistence, EDPersistenceHookRegistry, EMFocus, EMFocusController, EMObjectID, EMQuery, MFMailboxProvider, NSDictionary, NSString, UNUserNotificationCenter;
...
+ (id)log;	// IMP=0x0020000000003477
- (void).cxx_destruct;	// IMP=0x00200000000054c4
...
- (void)currentFocusChanged:(id)arg1;	// IMP=0x0010000000005259
- (void)mailboxListChanged:(id)arg1;	// IMP=0x00100000000051b1
- (void)countDidChange:(long long)arg1 acknowledgementToken:(id)arg2;	// IMP=0x001000000000514b
- (void)userNotificationCenterSettingsDidChange:(id)arg1;	// IMP=0x0010000000004fcb
- (void)_startObservingCountPredicate:(id)arg1 serverCountMailboxScope:(id)arg2;	// IMP=0x0010000000004d92
- (id)_excludedAccountIdentifiersByCurrentFocus;	// IMP=0x0010000000004adc
- (void)_createCountQueryPredicateFromNotificationTopics;	// IMP=0x001000000000403d
- (void)setBadgeCount:(long long)arg1;	// IMP=0x0010000000003ea5
- (id)_enabledAndExcludedMailboxesExcludingAccountIDs:(id)arg1;	// IMP=0x0010000000003b6a
- (void)_nts_getAccountsExcludedFromUnreadCount:(out id *)arg1 includeUnreadVIPs:(out _Bool *)arg2 includeUnreadNotifiedThreads:(out _Bool *)arg3;	// IMP=0x00100000000038b3
- (void)dealloc;	// IMP=0x00100000000037f4
- (id)initWithMessagePersistence:(id)arg1 hookRegistry:(id)arg2 mailboxProvider:(id)arg3 focusController:(id)arg4;	// IMP=0x0010000000003554
