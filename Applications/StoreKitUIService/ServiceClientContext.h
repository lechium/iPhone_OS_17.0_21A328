...
- (void)getDefaultMetricsControllerWithCompletionBlock:(CDUnknownBlockType)arg1;	// IMP=0x001000000000ec1c
- (id)initWithConfigurationDictionary:(id)arg1;	// IMP=0x001000000000eb62
