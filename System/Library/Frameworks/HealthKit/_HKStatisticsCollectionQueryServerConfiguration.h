...
+ (_Bool)supportsSecureCoding;	// IMP=0x00600000001fe662
- (void).cxx_destruct;	// IMP=0x00000000001fe9eb
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001fe809
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001fe66a
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001fe58c
