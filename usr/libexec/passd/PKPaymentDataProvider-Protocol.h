...
@class MISSING_TYPE, NSArray, NSCalendar, NSData, NSDate, NSSet, NSString, PKExpressPassInformation, PKMerchant, PKOSVersionRequirement, PKPass, PKPassUpgradeRequest, PKPaymentApplication, PKPaymentBalance, PKPaymentBalanceReminder, PKPaymentCommutePlanReminder, PKPaymentPass, PKPaymentTransactionRequest, PKPaymentWebService, PKTransitCommutePlan;
...
- (MISSING_TYPE *)installmentPlansWithTransactionReferenceIdentifier:completion: /* Error: Ran out of types for this method. */;
...
- (void)cancelAutoTopUpForPassWithUniqueIdentifier:(NSString *)arg1 balanceIdentifiers:(NSSet *)arg2 completion:(void (^)(_Bool))arg3;
...
- (void)transactionCountByPeriodForRequest:(PKPaymentTransactionRequest *)arg1 calendar:(NSCalendar *)arg2 calendarUnit:(unsigned long long)arg3 includePurchaseTotal:(_Bool)arg4 completion:(void (^)(NSArray *))arg5;
...
- (void)removeExpressPassesWithUniqueIdentifiers:(NSArray *)arg1 visibleViewController:(id)arg2 completion:(void (^)(_Bool, NSSet *))arg3;
