...
- (void).cxx_destruct;	// IMP=0x000000000017c6ca
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000017c54d
- (unsigned long long)hash;	// IMP=0x000000000017c4eb
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000017c32c
- (id)description;	// IMP=0x000000000017c274
- (id)initWithAlbumArtistPersistentID:(long long)arg1 groupingKey:(id)arg2 feedURL:(id)arg3 seasonNumber:(long long)arg4 compilation:(_Bool)arg5;	// IMP=0x000000000017c1a2
