...
- (void).cxx_destruct;	// IMP=0x0000000000032b57
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000000327dc
- (unsigned long long)hash;	// IMP=0x0000000000032629
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000032369
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000032133
- (void)copyTo:(id)arg1;	// IMP=0x0000000000031f7c
- (void)writeTo:(id)arg1;	// IMP=0x0000000000031dbd
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000031db0
- (id)dictionaryRepresentation;	// IMP=0x0000000000031278
- (id)description;	// IMP=0x00000000000311c9
...
- (int)StringAsMetricType:(id)arg1;	// IMP=0x0000000000030f26
- (id)metricTypeAsString:(int)arg1;	// IMP=0x0000000000030eba
