...
+ (_Bool)supportsSecureCoding;	// IMP=0x0020000000046c19
- (void).cxx_destruct;	// IMP=0x0020000000046e47
...
- (id)description;	// IMP=0x0010000000046da8
- (id);	// IMP=0x0010000000046cb0
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000046c21
