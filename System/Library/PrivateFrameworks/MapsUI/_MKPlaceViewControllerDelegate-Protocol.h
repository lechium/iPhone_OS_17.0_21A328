...
@class CNContactViewController, CNLabeledValue, GEOAttribution, GEOGuideLocation, GEOMapServiceTraits, GEOPlaceCollection, GEOSearchCategory, MKLookAroundView, MKMapItem, NSArray, NSDictionary, NSNumber, NSString, UINavigationController, UIView, UIViewController, _MKPlaceViewController;
@protocol GEOTransitConnectionInfo, GEOTransitDepartureSequence, MKCuratedCollectionsSyncCoordinator, MKTransitLineMarker, _MKInfoCardAnalyticsDelegate, _MKPlaceItem;
