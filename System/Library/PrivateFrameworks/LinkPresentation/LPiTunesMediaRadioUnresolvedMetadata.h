...
@interface LPiTunesMediaRadioUnresolvedMetadata : NSObject
{
...
- (void).cxx_destruct;	// IMP=0x0000000000060fd5
...
- (id)assetsToFetch;	// IMP=0x0000000000060ee4
- (id)resolve;	// IMP=0x0000000000060e0c
