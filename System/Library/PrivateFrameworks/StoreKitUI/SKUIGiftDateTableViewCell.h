...
- (void).cxx_destruct;	// IMP=0x00000000000993c8
...
- (id)_newLabel;	// IMP=0x000000000009926c
- (id)_labelForDate:(id)arg1;	// IMP=0x0000000000099117
- (id)_labelColor;	// IMP=0x00000000000990d8
- (void)_datePickerEditingDidBegin;	// IMP=0x000000000009903c
- (void)_datePickerDateDidChange;	// IMP=0x0000000000098f8b
- (void)layoutSubviews;	// IMP=0x0000000000098916
@property(copy, nonatomic) NSString *placeholder;
@property(copy, nonatomic) NSString *label;
@property(retain, nonatomic) NSDate *date;
- (id)initWithStyle:(long long)arg1 reuseIdentifier:(id)arg2;	// IMP=0x0000000000097ed9
