...
+ (id)changesetWithDownloadID:(id)arg1 state:(long long)arg2;	// IMP=0x00100000000068c3
- (void).cxx_destruct;	// IMP=0x0000000000006df7
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000006c2b
- (id)copyXPCEncoding;	// IMP=0x0000000000006b6e
- (id)initWithXPCEncoding:(id)arg1;	// IMP=0x0000000000006961
