...
+ (id)decode:(const struct ProtobufCMessage *)arg1;	// IMP=0x0060000000039055
- (void).cxx_destruct;	// IMP=0x0000000000039278
...
- (void)encode:(struct ProtobufCMessage *)arg1;	// IMP=0x0000000000038e12
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000038c56
@property(readonly, nonatomic) Protocol *objcProtocol; // @synthesize objcProtocol=_objcProtocol;
- (void)addSignal:(id)arg1;	// IMP=0x0000000000038b8b
- (id)initWithName:(id)arg1 implementsProtocols:(id)arg2;	// IMP=0x0000000000038abb
