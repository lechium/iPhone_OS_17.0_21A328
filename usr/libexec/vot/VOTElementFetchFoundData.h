...
+ (id)fetchFoundData:(id)arg1 forceUpdate:(_Bool)arg2 direction:(long long)arg3 generation:(unsigned long long)arg4 range:(struct _NSRange)arg5 searchType:(long long)arg6;	// IMP=0x004000000011c562
- (void).cxx_destruct;	// IMP=0x002000000011c7c1
...
- (id)description;	// IMP=0x001000000011c630
