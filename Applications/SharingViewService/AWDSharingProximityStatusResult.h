...
- (void).cxx_destruct;	// IMP=0x002000000018bdff
...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000018bcaf
- (unsigned long long)hash;	// IMP=0x001000000018bbe7
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000018ba92
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000018b989
- (void)copyTo:(id)arg1;	// IMP=0x001000000018b8af
- (void)writeTo:(id)arg1;	// IMP=0x001000000018b7c0
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000018b38a
- (id)dictionaryRepresentation;	// IMP=0x001000000018b169
- (id)description;	// IMP=0x001000000018b0ba
