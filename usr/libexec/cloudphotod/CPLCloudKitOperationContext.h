...
- (void).cxx_destruct;	// IMP=0x00200000000c0115
...
- (id)startDateDescriptionWithNow:(id)arg1;	// IMP=0x00100000000bfd74
- (id)operationDescription;	// IMP=0x00100000000bfd6c
- (id)extendedStatusDescriptionStrings;	// IMP=0x00100000000bfd64
