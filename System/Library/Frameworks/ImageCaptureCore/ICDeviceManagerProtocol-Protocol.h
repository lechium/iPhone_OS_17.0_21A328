...
- (long long)refreshObjectHandleInfo:(ICCameraFile *)arg1 fromDevice:(ICCameraDevice *)arg2 completion:(void (^)(id, NSMutableDictionary *))arg3;
...
- (long long)enumerateContent:(ICCameraDevice *)arg1 withOptions:(NSDictionary *)arg2 completion:(void (^)(id, NSMutableDictionary *))arg3;
