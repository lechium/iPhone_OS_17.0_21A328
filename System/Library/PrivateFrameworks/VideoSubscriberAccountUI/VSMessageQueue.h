...
- (void).cxx_destruct;	// IMP=0x000000000000a2ad
...
- (id)removeAllMessages;	// IMP=0x000000000000a21e
- (void)addMessage:(id)arg1;	// IMP=0x000000000000a100
- (id)init;	// IMP=0x000000000000a004
