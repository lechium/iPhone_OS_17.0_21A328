...
- (void).cxx_destruct;	// IMP=0x0000000000200c98
...
- (_Bool)matchesElement:(id)arg1;	// IMP=0x000000000020097b
- (id)initWithElementName:(id)arg1 attributes:(id)arg2;	// IMP=0x00000000002008c2
- (id)initWithTagSpecification:(id)arg1;	// IMP=0x0000000000200573
