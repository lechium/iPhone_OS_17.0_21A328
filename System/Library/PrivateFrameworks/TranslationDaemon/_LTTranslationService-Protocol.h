...
#import <TranslationDaemon/_LTTextTranslationService-Protocol.h>

@class NSArray, NSData, NSLocale, NSString, _LTInstallRequest, _LTLanguageAssetRequest, _LTLocalePair, _LTSELFLoggingEventData, _LTTaskContext, _LTTranslationContext, _LTTranslationFeedback, _LTTranslationParagraph;
...
- (void)textStreamingConfigurationWithCompletion:(void (^)(_LTTextStreamingConfiguration *))arg1;
