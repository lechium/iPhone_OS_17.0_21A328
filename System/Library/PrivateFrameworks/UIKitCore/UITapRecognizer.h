...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000098e40a
- (void).cxx_destruct;	// IMP=0x000000000098fda6
...
- (void)_updateDigitizerLocationForEvent:(id)arg1;	// IMP=0x000000000098fc8c
- (struct CGPoint)_digitizerLocation;	// IMP=0x000000000098fc7c
@property(readonly, nonatomic) NSSet *activeTouches;
- (struct CGPoint)locationInView:(id)arg1 focusSystem:(id)arg2;	// IMP=0x000000000098fb6a
- (struct CGPoint)locationInView:(id)arg1;	// IMP=0x000000000098fad1
- (struct CGPoint)_locationInSceneReferenceSpace;	// IMP=0x000000000098fabe
...
- (void)pressesCancelled:(id)arg1 withEvent:(id)arg2;	// IMP=0x000000000098fa0f
- (void)pressesEnded:(id)arg1 withEvent:(id)arg2;	// IMP=0x000000000098f9a8
- (void)pressesChanged:(id)arg1 withEvent:(id)arg2;	// IMP=0x000000000098f918
- (void)pressesBegan:(id)arg1 withEvent:(id)arg2;	// IMP=0x000000000098f8b3
- (void)touchesCancelled:(id)arg1 withEvent:(id)arg2;	// IMP=0x000000000098f846
- (void)_interactionEndedTouch:(_Bool)arg1;	// IMP=0x000000000098f72c
- (void)_beginInteraction;	// IMP=0x000000000098f687
- (void)touchesEnded:(id)arg1 withEvent:(id)arg2;	// IMP=0x000000000098f5a1
- (void)touchesMoved:(id)arg1 withEvent:(id)arg2;	// IMP=0x000000000098f30a
- (void)touchesBegan:(id)arg1 withEvent:(id)arg2;	// IMP=0x000000000098ebe7
- (_Bool)activeTouchesExceedAllowableSeparation;	// IMP=0x000000000098eb47
- (double)_effectiveAllowableMovement;	// IMP=0x000000000098eae8
- (void)multitouchExpired:(id)arg1;	// IMP=0x000000000098ea64
- (void)startMultitouchTimer:(double)arg1;	// IMP=0x000000000098ea14
- (void)clearMultitouchTimer;	// IMP=0x000000000098e9cb
- (void)tooSlow:(id)arg1;	// IMP=0x000000000098e96e
- (void)startTapTimer:(double)arg1;	// IMP=0x000000000098e91e
- (void)clearTapTimer;	// IMP=0x000000000098e8d5
- (void)_reset;	// IMP=0x000000000098e848
- (void)dealloc;	// IMP=0x000000000098e7f5
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000098e69f
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000098e412
- (id)init;	// IMP=0x000000000098e352
