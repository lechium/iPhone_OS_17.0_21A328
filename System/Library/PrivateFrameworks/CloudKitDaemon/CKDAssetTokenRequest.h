...
- (void).cxx_destruct;	// IMP=0x000000000008382d
...
- (id)description;	// IMP=0x00000000000837ca
- (id)CKPropertiesDescription;	// IMP=0x000000000008362a
- (_Bool)isEmpty;	// IMP=0x000000000008360d
- (id)successfulBatches;	// IMP=0x00000000000835ba
- (_Bool)hasSuccessfulBatches;	// IMP=0x00000000000834c3
- (void)addFailedBatch:(id)arg1;	// IMP=0x00000000000834a4
- (void)addAssetBatch:(id)arg1;	// IMP=0x00000000000833f4
- (id)init;	// IMP=0x000000000008337f
