...
- (void).cxx_destruct;	// IMP=0x0020000000b9b9a2
...
- (id)accessibilityIdentifier;	// IMP=0x0010000000b9b8e9
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x0010000000b9b6c9
- (void)layoutSubviews;	// IMP=0x0010000000b9b2b6
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0010000000b9a71e
