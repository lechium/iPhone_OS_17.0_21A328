...
+ (id)shortDescription;	// IMP=0x001000000079f803
- (void).cxx_destruct;	// IMP=0x000000000079f7b0
...
- (void)replayChange:(id)arg1 stagedChange:(id)arg2;	// IMP=0x000000000079efaa
- (void)resetRecord;	// IMP=0x000000000079ef6b
- (void)updateChangeWithRecord:(id)arg1;	// IMP=0x000000000079ef02
@property(readonly, nonatomic) CKRecordID *recordID;
@property(readonly, nonatomic) NSString *type;
@property(readonly, nonatomic) NSString *recordName;
@property(readonly, nonatomic) CKRecord *record;
- (void)updateWithObjectChange:(id)arg1;	// IMP=0x000000000079e562
- (void)updateDeletedCloudRecord:(id)arg1;	// IMP=0x000000000079e45d
- (void)updateCloudRecord:(id)arg1;	// IMP=0x000000000079df5e
- (void)forceChangeToInvalid;	// IMP=0x000000000079df4a
- (void)forceChangeToDelete;	// IMP=0x000000000079de5a
...
- (id)shortDescription;	// IMP=0x000000000079da60
- (id)initWithCloudObjectRecord:(id)arg1;	// IMP=0x000000000079da49
- (id)initWithObjectChange:(id)arg1;	// IMP=0x000000000079da35
- (id)_initWithObjectChange:(id)arg1 cloudObjectRecord:(id)arg2;	// IMP=0x000000000079d707
- (id)init;	// IMP=0x000000000079d65f
