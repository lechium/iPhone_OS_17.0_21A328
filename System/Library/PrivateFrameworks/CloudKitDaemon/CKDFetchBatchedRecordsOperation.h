...
- (void).cxx_destruct;	// IMP=0x00000000002aa181
...
- (_Bool)supportsClearAssetEncryption;	// IMP=0x00000000002a9ff7
- (void)_noteOperationFinishedBlockEnd;	// IMP=0x00000000002a9f7d
- (void)_noteOperationEnding;	// IMP=0x00000000002a9f03
- (void)_noteOperationBeginning;	// IMP=0x00000000002a9e89
- (void)_noteCompletedURLRequest:(id)arg1 withSchedulerInfo:(id)arg2;	// IMP=0x00000000002a9e0f
- (id)_optionsForZonesWithPendingChangesAfterRequest:(id)arg1;	// IMP=0x00000000002a9d92
- (id)_createAndConfigureURLRequestForZoneIDs:(id)arg1 optionsByZoneID:(id)arg2;	// IMP=0x00000000002a9d15
- (void)_noteDeletedRecordWithID:(id)arg1 recordType:(id)arg2;	// IMP=0x00000000002a9c9b
- (void)_noteChangedRecordWithID:(id)arg1 record:(id)arg2 error:(id)arg3;	// IMP=0x00000000002a9c21
- (id)activityCreate;	// IMP=0x00000000002a9ba4
@property(readonly, nonatomic) NSString *pipeliningDescription;
- (int)operationType;	// IMP=0x00000000002a9b1f
- (void)_finishOnCallbackQueueWithError:(id)arg1;	// IMP=0x00000000002a99d4
- (void)main;	// IMP=0x00000000002a8e54
- (id)_possiblyWrapError:(id)arg1 forRecordWithID:(id)arg2 withCode:(long long)arg3 format:(id)arg4;	// IMP=0x00000000002a8c32
- (void)_sendFetchChangesRequestForZoneIDs:(id)arg1 withOptions:(id)arg2 previousRequestSchedulerInfo:(id)arg3;	// IMP=0x00000000002a7ced
- (void)_handleRecordDelete:(id)arg1 recordType:(id)arg2 perRequestSchedulerInfo:(id)arg3;	// IMP=0x00000000002a7a4c
- (void)_handleChangedRecords:(id)arg1 perRequestSchedulerInfo:(id)arg2;	// IMP=0x00000000002a6b35
- (void)_handleFetchChangesRequestFinishedWithSchedulerInfo:(id)arg1;	// IMP=0x00000000002a6abb
- (id)relevantZoneIDs;	// IMP=0x00000000002a6aa6
- (id)initWithOperationInfo:(id)arg1 container:(id)arg2;	// IMP=0x00000000002a6933
