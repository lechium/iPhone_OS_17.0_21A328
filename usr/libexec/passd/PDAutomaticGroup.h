...
+ (id)createAutomaticGroupForPass:(id)arg1 withGroupingProfile:(id)arg2;	// IMP=0x004000000041e9f8
- (void).cxx_destruct;	// IMP=0x002000000041f7ff
...
- (_Bool)updateOrderWithCatalogGroup:(id)arg1;	// IMP=0x001000000041f36d
- (_Bool)removePass:(id)arg1;	// IMP=0x001000000041f1cc
- (_Bool)addPass:(id)arg1 withGroupingProfile:(id)arg2;	// IMP=0x001000000041ecb5
