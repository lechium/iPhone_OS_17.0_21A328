...
- (void).cxx_destruct;	// IMP=0x002000000005adef
- (void);	// IMP=0x001000000005ade6
...
- (id)initWithUsingWWAN:(_Bool)arg1 keepAliveInterval:(int)arg2 delayedResponseInterval:(int)arg3 usingServerStats:(_Bool)arg4 keepAliveState:(id)arg5 hwVersion:(id)arg6 swVersion:(id)arg7 swBuild:(id)arg8;	// IMP=0x001000000005ac3a
- (id)initWithUsingWWAN:(_Bool)arg1 keepAliveInterval:(int)arg2 delayedResponseInterval:(int)arg3 usingServerStats:(_Bool)arg4 keepAliveState:(id)arg5;	// IMP=0x001000000005ac06
- (id)initWithUsingWWAN:(_Bool)arg1 keepAliveInterval:(int)arg2 keepAliveState:(id)arg3;	// IMP=0x001000000005abe1
