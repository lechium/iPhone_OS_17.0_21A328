...
- (id)description;	// IMP=0x000000000006c008
- (id)formattedDescription:(unsigned long long)arg1;	// IMP=0x000000000006be9b
- (id)describe;	// IMP=0x000000000006be0e
- (void)dealloc;	// IMP=0x000000000006bdc7
- (id)initWithValue:(const void *)arg1 type:(unsigned long long)arg2 index:(unsigned long long)arg3;	// IMP=0x000000000006bd3f
