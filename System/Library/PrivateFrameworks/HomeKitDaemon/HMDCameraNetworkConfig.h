...
+ (id)localIPAddress;	// IMP=0x00100000006b4fc9
- (void).cxx_destruct;	// IMP=0x00000000006b4f98
...
- (id)description;	// IMP=0x00000000006b4e42
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000006b4d5f
- (id)initWithAddress:(id)arg1 ipv6:(_Bool)arg2 rtpPort:(id)arg3;	// IMP=0x00000000006b4cbc
- (id)init;	// IMP=0x00000000006b4c7d
