...
- (void).cxx_destruct;	// IMP=0x00000000001fc24f
...
- (id)mainReturningError;	// IMP=0x00000000001fb79d
- (id)initWithZone:(id)arg1 resultBlock:(CDUnknownBlockType)arg2;	// IMP=0x00000000001fb712
