...
+ (id)descriptionForPasswordWithUser:(id)arg1 creationDate:(id)arg2;	// IMP=0x0060000000108716
- (void).cxx_destruct;	// IMP=0x00000000001089a7
...
- (id)initWithMatch:(id)arg1 detail:(id)arg2 creationDate:(id)arg3;	// IMP=0x00000000001088b0
