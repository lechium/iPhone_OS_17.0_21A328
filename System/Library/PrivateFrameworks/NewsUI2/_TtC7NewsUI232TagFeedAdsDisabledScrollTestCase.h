...
@interface _TtC7NewsUI232TagFeedAdsDisabledScrollTestCase : NSObject
{
...
- (void).cxx_destruct;	// IMP=0x0000000000d63e20
- (id)init;	// IMP=0x0000000000d63dd0
- (id)scrollViewWithContext:(id)arg1;	// IMP=0x0000000000d63c70
