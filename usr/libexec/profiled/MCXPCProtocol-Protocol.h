...
@class MISSING_TYPE, NSArray, NSData, NSDate, NSDictionary, NSNumber, NSSet, NSString, NSUUID;
...
- (MISSING_TYPE *)setKeyboardShortcutsAllowed:completion: /* Error: Ran out of types for this method. */;
