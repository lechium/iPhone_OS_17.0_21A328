...
- (void).cxx_destruct;	// IMP=0x0000000000139612
...
- (void)cancel;	// IMP=0x0000000000139528
- (id)initWithMediaLibrary:(id)arg1;	// IMP=0x0000000000139487
- (id)init;	// IMP=0x0000000000139418
