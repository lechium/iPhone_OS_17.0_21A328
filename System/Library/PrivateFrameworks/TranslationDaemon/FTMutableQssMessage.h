...
+ (long long)container_message_typeForObject:(id)arg1;	// IMP=0x00600000000a7eab
+ (long long)container_message_typeForMutableObject:(id)arg1;	// IMP=0x00600000000a7a45
+ (Class)container_message_mutableClassForType:(long long)arg1;	// IMP=0x00600000000a7a0b
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000a5cce
- (id)init;	// IMP=0x00000000000a5c40
