...
- (void).cxx_destruct;	// IMP=0x00200000001914bc
- (unsigned long long)hash;	// IMP=0x001000000019108f
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000190a48
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000019040d
- (void)writeTo:(id)arg1;	// IMP=0x001000000018ff25
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000018ff18
- (id)dictionaryRepresentation;	// IMP=0x001000000018ed4b
- (id)description;	// IMP=0x001000000018ec9c
