...
- (id).cxx_construct;	// IMP=0x0000000000185c2c
- (void).cxx_destruct;	// IMP=0x0000000000185bca
...
- (void)requestMutation:(id)arg1;	// IMP=0x00000000001856eb
- (void)notifyClientsOfCustomPropertyChange:(struct AudioObjectPropertyAddress)arg1;	// IMP=0x00000000001855cb
