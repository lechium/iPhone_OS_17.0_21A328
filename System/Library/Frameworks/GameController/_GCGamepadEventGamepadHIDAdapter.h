...
- (void).cxx_destruct;	// IMP=0x0000000000085bd2
...
- (id)observeGamepadEvents:(CDUnknownBlockType)arg1;	// IMP=0x0000000000085823
- (void)dealloc;	// IMP=0x00000000000857ca
- (id)init;	// IMP=0x000000000008579f
- (id)initWithSource:(id)arg1 service:(id)arg2;	// IMP=0x00000000000854bf
