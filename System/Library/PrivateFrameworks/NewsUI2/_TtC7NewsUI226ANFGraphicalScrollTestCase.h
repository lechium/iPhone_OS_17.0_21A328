...
@interface _TtC7NewsUI226ANFGraphicalScrollTestCase : NSObject
{
...
- (void).cxx_destruct;	// IMP=0x00000000004d90a0
- (id)init;	// IMP=0x00000000004d9050
- (id)scrollViewWithContext:(id)arg1;	// IMP=0x00000000004d8ef0
