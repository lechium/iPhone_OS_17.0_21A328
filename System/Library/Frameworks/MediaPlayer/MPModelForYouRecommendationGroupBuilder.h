...
+ (id)allSupportedItemProperties;	// IMP=0x006000000026062f
+ (id)allSupportedGroupProperties;	// IMP=0x0060000000260555
- (void).cxx_destruct;	// IMP=0x000000000025fb24
...
- (id)modelObjectForRecommendationDictionary:(id)arg1 userIdentity:(id)arg2;	// IMP=0x000000000025f650
- (id)initWithRequestedGroupPropertySet:(id)arg1 requestedItemPropertySet:(id)arg2 storeItemMetadataResults:(id)arg3 flatSectionedItems:(id)arg4;	// IMP=0x000000000025f542
