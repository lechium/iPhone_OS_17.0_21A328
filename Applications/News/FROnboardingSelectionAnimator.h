...
- (void).cxx_destruct;	// IMP=0x00200000000661a0
...
- (void)updateTickWithAnimationEngine:(id)arg1 sessionTimeAtLastTick:(double)arg2 currentSessionTime:(double)arg3;	// IMP=0x001000000006600c
- (void)updateCellWithCurrentStateOfItem:(id)arg1;	// IMP=0x0010000000065cfa
- (void)addedToAnimationEngine:(id)arg1;	// IMP=0x0010000000065cdf
- (void)restartDimple;	// IMP=0x0010000000065cc8
- (id)init;	// IMP=0x001000000006565c
