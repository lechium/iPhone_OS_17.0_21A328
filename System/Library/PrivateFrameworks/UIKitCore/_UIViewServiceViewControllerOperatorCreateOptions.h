...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000153b3bd
- (void).cxx_destruct;	// IMP=0x000000000153b49b
...
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000153afb7
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000153acd4
