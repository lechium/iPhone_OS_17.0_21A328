...
- (_Bool)getControllerPublicKey:(id *)arg1 secretKey:(id *)arg2 keyPair:(id *)arg3 username:(id *)arg4 allowCreation:(_Bool)arg5 forAccessory:(NSString *)arg6 error:(id *)arg7;
...
- (_Bool)getControllerPublicKey:(id *)arg1 secretKey:(id *)arg2 username:(id *)arg3 allowCreation:(_Bool)arg4 forAccessory:(NSString *)arg5 error:(id *)arg6;
...
@optional
- (_Bool)savePairingIdentityToBackUpTable:(HAPPairingIdentity *)arg1;
- (HMFPairingIdentity *)pairingIdentityForAppleMediaAccessorySensorWithUUID:(NSUUID *)arg1;
- (_Bool)saveAppleMediaAccessorySensorPairingIdentity:(HMFPairingIdentity *)arg1;
