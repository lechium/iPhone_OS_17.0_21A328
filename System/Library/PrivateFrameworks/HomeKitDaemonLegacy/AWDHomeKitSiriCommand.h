...
- (void).cxx_destruct;	// IMP=0x00000000005d9835
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000005d9628
- (unsigned long long)hash;	// IMP=0x00000000005d94d7
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000005d92a2
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000005d90f9
- (void)copyTo:(id)arg1;	// IMP=0x00000000005d8f92
- (void)writeTo:(id)arg1;	// IMP=0x00000000005d8df4
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000005d86f4
- (id)dictionaryRepresentation;	// IMP=0x00000000005d82e0
- (id)description;	// IMP=0x00000000005d8231
...
- (int)StringAsOutcome:(id)arg1;	// IMP=0x00000000005d7e94
- (id)outcomeAsString:(int)arg1;	// IMP=0x00000000005d7e4c
@property(nonatomic) _Bool hasOutcome;
@property(nonatomic) int outcome; // @synthesize outcome=_outcome;
@property(nonatomic) _Bool hasDuration;
- (int)StringAsActionType:(id)arg1;	// IMP=0x00000000005d7c5a
- (id)actionTypeAsString:(int)arg1;	// IMP=0x00000000005d7c12
