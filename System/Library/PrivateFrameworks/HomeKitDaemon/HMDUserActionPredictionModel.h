...
+ (_Bool)hmbExcludeFromCloudStorage;	// IMP=0x00600000003f6b3b
+ (id)hmbProperties;	// IMP=0x00600000003f6b0b
- (id)userActionPrediction;	// IMP=0x00000000003f76be
- (id)initWithUserActionPrediction:(id)arg1;	// IMP=0x00000000003f70b9
