...
- (void).cxx_destruct;	// IMP=0x002000000041324c
...
- (void)handleResponseDictionary:(id)arg1;	// IMP=0x001000000041300a
- (id)bagKey;	// IMP=0x0010000000412ffd
- (id)requiredKeys;	// IMP=0x0010000000412fe4
- (id)messageBody;	// IMP=0x0010000000412d47
- (id)additionalMessageHeaders;	// IMP=0x0010000000412b46
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000412953
