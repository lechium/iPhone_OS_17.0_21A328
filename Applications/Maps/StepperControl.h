...
- (void).cxx_destruct;	// IMP=0x0020000000ba828a
...
- (void)plusButtonTapped:(id)arg1;	// IMP=0x0010000000ba7fba
- (void)minusButtonTapped:(id)arg1;	// IMP=0x0010000000ba7f88
- (void)updateLabel;	// IMP=0x0010000000ba7e7d
- (void)setupConstraints;	// IMP=0x0010000000ba7837
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0010000000ba74b6
