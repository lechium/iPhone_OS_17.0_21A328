...
- (void).cxx_destruct;	// IMP=0x0000000000064dbf
...
- (void)buttonShapesEnabledDidChange;	// IMP=0x0000000000064817
- (void)dealloc;	// IMP=0x0000000000064795
- (id)initWithFrame:(struct CGRect)arg1 expanded:(_Bool)arg2 modally:(_Bool)arg3;	// IMP=0x0000000000063b62
- (void)toggleExpanded;	// IMP=0x0000000000063ac2
- (void)updateExpanded;	// IMP=0x0000000000063999
