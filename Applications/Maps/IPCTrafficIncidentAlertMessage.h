...
- (void).cxx_destruct;	// IMP=0x0020000000ce268d
...
- (id)description;	// IMP=0x0010000000ce247a
- (id)dictionaryValue;	// IMP=0x0010000000ce224a
- (id)initWithDictionary:(id)arg1;	// IMP=0x0010000000ce20bb
