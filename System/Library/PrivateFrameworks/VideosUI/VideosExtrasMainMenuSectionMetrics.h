...
- (void).cxx_destruct;	// IMP=0x00000000001ca62b
...
- (struct CGSize)_horizontalFittingSizeForFontDescriptor:(id)arg1 gutterSize:(double)arg2 itemCount:(long long)arg3 itemSizes:(out struct CGSize *)arg4;	// IMP=0x00000000001ca47d
- (void)_updateAllMetrics;	// IMP=0x00000000001ca341
- (void)updateSizes;	// IMP=0x00000000001ca313
- (struct CGSize)sizeForCellAtIndex:(long long)arg1;	// IMP=0x00000000001ca2c1
- (void)setFittingWidth:(double)arg1;	// IMP=0x00000000001ca289
- (void)_setNeedsUpdate;	// IMP=0x00000000001ca10a
- (void)_recalculateSizes;	// IMP=0x00000000001ca07f
