...
- (id).cxx_construct;	// IMP=0x00000000005d5fa3
- (void).cxx_destruct;	// IMP=0x00000000005d5eb8
...
- (double)boundsUnitsPerMeter;	// IMP=0x00000000005d5d2a
- (Matrix_08d701e4)maneuverTransform;	// IMP=0x00000000005d5c98
- (Matrix_08d701e4)inverseManeuverTransform;	// IMP=0x00000000005d5c44
- (vector_9022e479)maneuverPoints;	// IMP=0x00000000005d5936
- (void)_updateBounds:(id)arg1 boundsInflation:(float)arg2;	// IMP=0x00000000005d4f78
- (void)forEachSection:(CDUnknownBlockType)arg1;	// IMP=0x00000000005d4eb3
- (void)splitRouteLineAtAnnotation:(id)arg1;	// IMP=0x00000000005d4651
- (optional_db527fce)snapRouteMatch:(id)arg1;	// IMP=0x00000000005d3a65
- (_Bool)needsUpdateForViewingScale:(double)arg1;	// IMP=0x00000000005d3942
- (_Bool)isTrafficUptoDate:(double)arg1;	// IMP=0x00000000005d3913
- (_Bool)isTrafficUpToDate;	// IMP=0x00000000005d38dc
- (void)createMeshIfNecessary:(long long)arg1;	// IMP=0x00000000005d3804
- (void)generateArrowsForManeuverDisplayMode:(int)arg1 routeLineWidth:(double)arg2;	// IMP=0x00000000005d31af
- (_Bool)buildRouteLine:(id)arg1 matchToRoads:(_Bool)arg2 shouldGenerateSnapPath:(_Bool)arg3 viewUnitsPerPoint:(double)arg4 force:(_Bool)arg5 boundsInflation:(float)arg6 isGradientTraffic:(_Bool)arg7 currentLegIndex:(unsigned int)arg8;	// IMP=0x00000000005d0982
- (void)_updateTilesCovered:(id)arg1;	// IMP=0x00000000005d075e
@property(readonly, nonatomic) NSArray *matchedSegments; // @synthesize matchedSegments=_matchedSegments;
- (void)_clearMatchedSegments;	// IMP=0x00000000005d066a
- (void)_addMatchedSegments:(id)arg1;	// IMP=0x00000000005d05ef
@property(readonly, nonatomic) GEOComposedRoute *composedRoute;
- (void)dealloc;	// IMP=0x00000000005d0523
- (id)initWithPolylineOverlay:(id)arg1;	// IMP=0x00000000005d03cc
