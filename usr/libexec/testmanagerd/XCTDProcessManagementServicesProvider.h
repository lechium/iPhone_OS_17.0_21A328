...
- (void).cxx_destruct;	// IMP=0x002000000001e0b9
...
- (void)applicationDidUpdateState:(id)arg1;	// IMP=0x001000000001dfed
- (id)init;	// IMP=0x001000000001df75
- (id)initWithProcessMonitor:(id)arg1 processAssertionManager:(id)arg2;	// IMP=0x001000000001dede
- (void)invalidate;	// IMP=0x001000000001dd9b
- (void)dealloc;	// IMP=0x001000000001dce9
