...
- (void).cxx_destruct;	// IMP=0x0000000000181c7c
...
- (id)initWithImageProvider:(CDUnknownBlockType)arg1 originalImageProvider:(CDUnknownBlockType)arg2 type:(long long)arg3;	// IMP=0x0000000000181b4c
- (id)initWithImageProvider:(CDUnknownBlockType)arg1 type:(long long)arg2;	// IMP=0x0000000000181b34
