...
@interface HMDMetricsManager : NSObject
{
    ...
    HMDWidgetTimelineRefresherEventsAnalyzer *_widgetTimelineRefresherEventsAnalyzer;	// 352 = 0x160
...
+ (id)namespaceUUID;	// IMP=0x001000000058d2b3
- (void).cxx_destruct;	// IMP=0x000000000058cd98
...
- (id)messageDestination;	// IMP=0x000000000058c643
@property(readonly, nonatomic) NSUUID *messageTargetUUID;
- (void)saveCounters;	// IMP=0x000000000058c5ec
- (void)waitToCompleteCurrentlyQueuedTasks;	// IMP=0x000000000058c580
- (void)_handleLogEventDailySchedulerSubmitRequest:(id)arg1;	// IMP=0x000000000058c50d
- (void)_handleLogEventDailySchedulerStatusRequest:(id)arg1;	// IMP=0x000000000058c486
- (void)_handleResetEventCounters:(id)arg1;	// IMP=0x000000000058c413
- (void)_handleFetchEventCounters:(id)arg1;	// IMP=0x000000000058c28f
- (void)addRateTrigger:(id)arg1 forEventName:(id)arg2 requestGroup:(id)arg3 atThreshold:(unsigned long long)arg4 windowSize:(unsigned long long)arg5;	// IMP=0x000000000058c183
- (void)addThresholdTrigger:(id)arg1 forEventName:(id)arg2 requestGroup:(id)arg3 atThreshold:(unsigned long long)arg4 uploadImmediately:(_Bool)arg5;	// IMP=0x000000000058c078
- (void)addThresholdTrigger:(id)arg1 forEventName:(id)arg2 requestGroup:(id)arg3 atThreshold:(unsigned long long)arg4;	// IMP=0x000000000058bf76
- (void)registerEWSTriggers;	// IMP=0x000000000058bb77
- (void)startAnalyzers;	// IMP=0x000000000058b21d
- (void)registerTaggedLoggingProcessors;	// IMP=0x000000000058b151
@property(readonly) _Bool isSubmissionEnabled;
@property(readonly, nonatomic) _Bool isDemoModeConfigured;
@property(readonly, nonatomic) id <HMMLogEventSubmitting> logEventSubmitter;
- (void)updateWidgetStatusInCachedConfiguration;	// IMP=0x000000000058af25
- (id)accessoryForIdentifier:(id)arg1;	// IMP=0x000000000058abeb
@property(readonly, nonatomic) id <HMDMetricsDeviceStateProvider> deviceStateProvider;
- (id)cachedHomeConfigurationForHomeUUID:(id)arg1;	// IMP=0x000000000058a9e0
...
- (void)homeKitConfigurationChanged;	// IMP=0x000000000058a6d4
@property(readonly, copy, nonatomic) NSArray *configurationObservers;
- (void)addConfigurationChangedObserver:(CDUnknownBlockType)arg1;	// IMP=0x000000000058a5ff
- (id)logHomeKitErrorAggregationSummary;	// IMP=0x000000000058a5af
- (id)logHomeKitAggregationAnalysisSummary;	// IMP=0x000000000058a55f
- (void)resetHomeKitAggregationAnalysisContext;	// IMP=0x000000000058a430
- (id)homeKitAggregationAnalysisLogEvent;	// IMP=0x000000000058a2d5
- (void)submitDailyAggregationAnalysisEvents;	// IMP=0x000000000058a23a
- (void)submitCurrentUserSettings;	// IMP=0x000000000058a016
- (void)runDailyTask;	// IMP=0x0000000000589a65
- (void)startMetricsCollection;	// IMP=0x000000000058979b
- (void)configureHAPMetricsDispatcher:(id)arg1;	// IMP=0x0000000000589732
- (void)_registerForMessages;	// IMP=0x0000000000589432
- (void)_configureManagers;	// IMP=0x00000000005892a6
- (void)addAnalyzer:(id)arg1 toListOfAggregationAnalysisEventContributing:(id)arg2;	// IMP=0x0000000000589233
- (void)_configureObservers;	// IMP=0x0000000000588bb6
...
- (id)initWithMessageDispatcher:(id)arg1 accountManager:(id)arg2 notificationSettingsProvider:(id)arg3;	// IMP=0x000000000058843e
