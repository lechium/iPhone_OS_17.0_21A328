...
@class CATTransport, CRKSession, NSArray, NSString;
@protocol CRKIdentity;

@protocol CRKSessionDelegate <NSObject>
- (void)session:(CRKSession *)arg1 encounteredUntrustedConnectionForASMInstructorIdentifier:(NSString *)arg2 decisionHandler:(void (^)(unsigned long long))arg3;
