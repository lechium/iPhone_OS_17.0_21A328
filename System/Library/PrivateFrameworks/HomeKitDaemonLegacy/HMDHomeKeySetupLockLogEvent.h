...
- (void).cxx_destruct;	// IMP=0x00000000006b13c1
...
- (void)timerDidFire:(id)arg1;	// IMP=0x00000000006b12ae
@property(readonly, nonatomic) unsigned long long coreAnalyticsEventOptions;
@property(readonly, copy, nonatomic) NSDictionary *coreAnalyticsEventDictionary;
@property(readonly, copy, nonatomic) NSString *coreAnalyticsEventName;
- (void)timeout;	// IMP=0x00000000006b106b
- (void)submitSuccess;	// IMP=0x00000000006b0fef
- (_Bool)incrementCompleted;	// IMP=0x00000000006b0f7b
- (id)initWithAccessoryUUID:(id)arg1 withKeyType:(unsigned long long)arg2 expectedCount:(long long)arg3 queue:(id)arg4;	// IMP=0x00000000006b0e4a
