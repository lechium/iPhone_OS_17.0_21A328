...
@interface _TtC11FMFindingUI25FMPFSKPatternFragmentNode
{
...
- (void).cxx_destruct;	// IMP=0x0000000000024b00
- (id)init;	// IMP=0x0000000000024a00
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000023470
