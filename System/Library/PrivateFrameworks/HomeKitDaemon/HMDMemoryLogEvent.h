...
- (id)initWithReason:(long long)arg1 currentMemoryUsage:(unsigned long long)arg2 intervalMaxMemoryUsage:(unsigned long long)arg3;	// IMP=0x0000000000b76c68
- (id)init;	// IMP=0x0000000000b76bc0
- (void)updateDiagnosticReportSignature:(id)arg1;	// IMP=0x0000000000d10332
