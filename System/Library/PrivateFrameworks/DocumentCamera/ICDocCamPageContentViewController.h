...
+ (double)leadingTrailingOffset:(long long)arg1;	// IMP=0x00600000000280c2
- (void).cxx_destruct;	// IMP=0x0000000000028303
...
- (_Bool)_canShowWhileLocked;	// IMP=0x000000000002825a
- (void)didReceiveMemoryWarning;	// IMP=0x000000000002822b
- (void)handleSingleTap:(id)arg1;	// IMP=0x00000000000281d2
- (void)viewDidLoad;	// IMP=0x00000000000280cb
