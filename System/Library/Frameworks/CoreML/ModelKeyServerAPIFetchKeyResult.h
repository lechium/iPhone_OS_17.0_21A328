...
- (void).cxx_destruct;	// IMP=0x0000000000027ca3
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000027b03
- (unsigned long long)hash;	// IMP=0x0000000000027a36
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000278c8
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000027794
- (void)copyTo:(id)arg1;	// IMP=0x00000000000276b1
- (void)writeTo:(id)arg1;	// IMP=0x00000000000275fd
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000000275f0
- (id)dictionaryRepresentation;	// IMP=0x000000000002742f
- (id)description;	// IMP=0x0000000000027380
- (void)clearOneofValuesForKey;	// IMP=0x0000000000027320
- (int)StringAsKey:(id)arg1;	// IMP=0x0000000000027289
- (id)keyAsString:(int)arg1;	// IMP=0x0000000000027241
