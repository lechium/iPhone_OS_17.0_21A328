...
- (void).cxx_destruct;	// IMP=0x0000000000043ea9
...
- (id)headerString;	// IMP=0x0000000000043dee
- (id)initWithBeaconIdentifier:(id)arg1 keySequence:(unsigned char)arg2 mapHandle:(CDStruct_e66c82b6 *)arg3;	// IMP=0x0000000000043d6d
- (void)dealloc;	// IMP=0x0000000000043d33
- (id)init;	// IMP=0x0000000000043d08
