...
- (void).cxx_destruct;	// IMP=0x00000000000716d6
...
- (id)indexPathForContainerInstance:(id)arg1;	// IMP=0x0000000000071607
- (id)indexPathForGroupInstance:(id)arg1;	// IMP=0x00000000000715f1
- (id)indexPathForContactInstance:(id)arg1;	// IMP=0x00000000000715db
- (void)_populateSaveRequestIndexTables;	// IMP=0x0000000000071172
- (void)dealloc;	// IMP=0x0000000000071133
@property(readonly, nonatomic) void *addressBook;
- (id)initWithSaveRequest:(id)arg1 response:(id)arg2 addressBook:(void *)arg3;	// IMP=0x0000000000070f4a
