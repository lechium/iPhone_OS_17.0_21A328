...
+ (id)logCategory;	// IMP=0x0010000000428f0d
+ (id)sharedPSKForNetworkWithSSID:(id)arg1;	// IMP=0x0010000000428c9a
- (void).cxx_destruct;	// IMP=0x0000000000426ce6
...
- (id)logIdentifier;	// IMP=0x0000000000426b7f
- (void)_performWiFiConfigurationControlRequest:(id)arg1 withDescription:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x00000000004264c8
- (void)_reconfigurationCompletedWithSuccess:(_Bool)arg1 error:(id)arg2;	// IMP=0x000000000042629b
- (void)_commitConfigurationUpdate;	// IMP=0x0000000000426162
- (void)timerDidFire:(id)arg1;	// IMP=0x0000000000425fc1
- (void)_accessoryDidBecomeReachable:(id)arg1;	// IMP=0x0000000000425f50
- (void)safelyReconfigureWithSSID:(id)arg1 PSK:(id)arg2 verificationCallback:(CDUnknownBlockType)arg3 logEvent:(id)arg4 completion:(CDUnknownBlockType)arg5;	// IMP=0x0000000000425de4
- (void)reconfigureWithSSID:(id)arg1 PSK:(id)arg2 logEvent:(id)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x0000000000425ca6
@property(readonly) NSNotificationCenter *notificationCenter;
@property(readonly) _Bool supportsStationConfiguration;
@property(readonly) long long capabilities;
- (id)initWithAccessory:(id)arg1 wiFiTransportService:(id)arg2 workQueue:(id)arg3;	// IMP=0x0000000000425b41
