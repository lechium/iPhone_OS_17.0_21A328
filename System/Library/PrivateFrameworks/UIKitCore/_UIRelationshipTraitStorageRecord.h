...
- (void).cxx_destruct;	// IMP=0x0000000000a7d211
...
- (id)description;	// IMP=0x0000000000a7d173
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000a7d0f2
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000a7d013
- (id)initWithTraitCollection:(id)arg1 addedObjects:(id)arg2 removedObjects:(id)arg3;	// IMP=0x0000000000a7cf27
