...
+ (id)_readAndValidateReplaceFileAtUrl:(id)arg1 error:(id *)arg2;	// IMP=0x00100000000bd5a8
+ (_Bool)recoverFromReplaceOperationsWithError:(id *)arg1;	// IMP=0x00100000000bc996
+ (Class)incomingMessageClass;	// IMP=0x00100000000bc95a
+ (unsigned long long)command;	// IMP=0x00100000000bc924
- (void).cxx_destruct;	// IMP=0x00000000000bc8d0
...
- (_Bool)_writeToDiskReplaceAt:(id)arg1 old:(id)arg2 withNew:(id)arg3 usingStaging:(id)arg4 toDestination:(id)arg5 error:(id *)arg6;	// IMP=0x00000000000bc27c
- (void)execute;	// IMP=0x00000000000b93a0
- (_Bool)preflightClientAllowed;	// IMP=0x00000000000b930c
- (id)initWithMessage:(id)arg1 context:(id)arg2 reply:(id)arg3;	// IMP=0x00000000000b91f9
- (id)initWithConcreteContainerIdentityOld:(id)arg1 concreteContainerIdentityNew:(id)arg2 preserveOldPathIdentifier:(_Bool)arg3 preserveOldInternalUUID:(_Bool)arg4 asyncReclaim:(_Bool)arg5 context:(id)arg6 resultPromise:(id)arg7;	// IMP=0x00000000000b90fd
