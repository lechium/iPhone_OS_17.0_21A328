...
- (void).cxx_destruct;	// IMP=0x00000000000bf019
...
- (id)loadPage;	// IMP=0x00000000000bec76
@property(readonly, nonatomic) _Bool disableReappearPlaceholder;
- (id)createViewControllerForContainer:(id)arg1;	// IMP=0x00000000000bec1e
- (id)initWithJSObject:(id)arg1 context:(id)arg2;	// IMP=0x00000000000be907
