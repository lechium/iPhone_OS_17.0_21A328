...
- (void).cxx_destruct;	// IMP=0x0000000000a554eb
...
- (_Bool)passthroughScrollInteractionDidRecognize:(id)arg1;	// IMP=0x0000000000a55486
- (_Bool)passthroughScrollInteraction:(id)arg1 shouldInteractAtLocation:(struct CGPoint)arg2 withEvent:(id)arg3;	// IMP=0x0000000000a5546a
- (void)textFieldDidEndEditing:(id)arg1;	// IMP=0x0000000000a552f4
- (_Bool)textFieldShouldEndEditing:(id)arg1;	// IMP=0x0000000000a551aa
- (_Bool)textFieldShouldReturn:(id)arg1;	// IMP=0x0000000000a55192
- (void)textFieldDidBeginEditing:(id)arg1;	// IMP=0x0000000000a550b8
- (_Bool)textFieldShouldBeginEditing:(id)arg1;	// IMP=0x0000000000a55071
- (_Bool)textField:(id)arg1 shouldChangeCharactersInRange:(struct _NSRange)arg2 replacementString:(id)arg3;	// IMP=0x0000000000a54ed0
@property(readonly, nonatomic, getter=isDisplayingEditedText) _Bool displayingEditedText;
- (_Bool)makeTextInputFirstResponderWithInitialLayoutBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000000a54d7d
- (void)longPressRecognizerChanged:(id)arg1;	// IMP=0x0000000000a54ccc
- (void)dealloc;	// IMP=0x0000000000a54c96
- (void)updateLabelConfiguration:(id)arg1 editingConfiguration:(id)arg2;	// IMP=0x0000000000a54746
@property(readonly, copy) NSString *description;
- (id)initWithContentView:(id)arg1 editableLabel:(id)arg2;	// IMP=0x0000000000a54537
