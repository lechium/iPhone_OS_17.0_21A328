...
- (void).cxx_destruct;	// IMP=0x00000000000933e5
...
- (id)CKPropertiesDescription;	// IMP=0x000000000009333d
- (id)description;	// IMP=0x000000000009332b
- (void)invokeWaitCompletedHandler:(_Bool)arg1;	// IMP=0x0000000000093218
- (id)initWithWaiter:(id)arg1 zoneIDs:(id)arg2 waitCompletedHandler:(CDUnknownBlockType)arg3 activity:(id)arg4;	// IMP=0x0000000000093122
