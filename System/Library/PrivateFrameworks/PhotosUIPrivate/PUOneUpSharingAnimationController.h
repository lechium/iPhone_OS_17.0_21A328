...
+ (id)new;	// IMP=0x00100000002b790b
- (void).cxx_destruct;	// IMP=0x00000000002b5651
...
- (void)_configurePhotoView:(id)arg1 withContentHelper:(id)arg2;	// IMP=0x00000000002b5263
- (void)_installTransitioningBadgeViewsForAssetTransitionInfo:(id)arg1 inTransitioningView:(id)arg2;	// IMP=0x00000000002b4ce7
- (id)interruptibleAnimatorForTransition:(id)arg1;	// IMP=0x00000000002b430f
- (double)transitionDuration:(id)arg1;	// IMP=0x00000000002b4278
- (id)initWithTransitionContext:(id)arg1 presentingViewController:(id)arg2;	// IMP=0x00000000002b41d6
- (id)init;	// IMP=0x00000000002b415c
