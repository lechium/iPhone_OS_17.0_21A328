...
- (void).cxx_destruct;	// IMP=0x00200000000acc77
...
- (void)cancel;	// IMP=0x00100000000aca3d
- (void)_onqueueTrigger:(unsigned long long)arg1 maximumDelay:(unsigned long long)arg2;	// IMP=0x00100000000ac488
- (void)trigger;	// IMP=0x00100000000ac3c3
- (void)_onqueueTimerTick;	// IMP=0x00100000000ac07c
- (void)triggerAt:(unsigned long long)arg1;	// IMP=0x00100000000abfac
- (void)waitUntil:(unsigned long long)arg1;	// IMP=0x00100000000abf30
@property(readonly) NSDate *nextFireTime;
- (id)description;	// IMP=0x00100000000abd5f
- (id)makeOperationDependency;	// IMP=0x00100000000abc90
- (void)changeDelays:(unsigned long long)arg1 continuingDelay:(unsigned long long)arg2;	// IMP=0x00100000000abc09
- (id)initWithName:(id)arg1 initialDelay:(unsigned long long)arg2 exponentialBackoff:(double)arg3 maximumDelay:(unsigned long long)arg4 keepProcessAlive:(_Bool)arg5 dependencyDescriptionCode:(long long)arg6 qosClass:(unsigned int)arg7 block:(CDUnknownBlockType)arg8;	// IMP=0x00100000000aba1f
- (id)initWithName:(id)arg1 initialDelay:(unsigned long long)arg2 exponentialBackoff:(double)arg3 maximumDelay:(unsigned long long)arg4 keepProcessAlive:(_Bool)arg5 dependencyDescriptionCode:(long long)arg6 block:(CDUnknownBlockType)arg7;	// IMP=0x00100000000ab9fc
- (id)initWithName:(id)arg1 initialDelay:(unsigned long long)arg2 continuingDelay:(unsigned long long)arg3 keepProcessAlive:(_Bool)arg4 dependencyDescriptionCode:(long long)arg5 block:(CDUnknownBlockType)arg6;	// IMP=0x00100000000ab9a1
- (id)initWithName:(id)arg1 delay:(unsigned long long)arg2 keepProcessAlive:(_Bool)arg3 dependencyDescriptionCode:(long long)arg4 block:(CDUnknownBlockType)arg5;	// IMP=0x00100000000ab97d
