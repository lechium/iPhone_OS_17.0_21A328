...
- (unsigned long long)analyzedWithoutResourcesCounter:(unsigned long long)arg1;	// IMP=0x001000000004237a
- (void)addAnalyzedWithoutResourcesCounter:(unsigned long long)arg1;	// IMP=0x001000000004236c
- (unsigned long long)analyzedWithResourcesCounter:(unsigned long long)arg1;	// IMP=0x001000000004235e
- (void)addAnalyzedWithResourcesCounter:(unsigned long long)arg1;	// IMP=0x0010000000042350
- (unsigned long long);	// IMP=0x0010000000042345
- (void)addUnanalyzedWithoutResourcesCounter:(unsigned long long)arg1;	// IMP=0x001000000004233a
- (unsigned long long)unanalyzedWithResourcesCounter:(unsigned long long)arg1;	// IMP=0x001000000004232f
- (void)addUnanalyzedWithResourcesCounter:(unsigned long long)arg1;	// IMP=0x0010000000042324
- (id)init;	// IMP=0x00100000000422c3
