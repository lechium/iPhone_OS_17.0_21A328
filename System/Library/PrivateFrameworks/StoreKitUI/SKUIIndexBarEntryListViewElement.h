...
- (void).cxx_destruct;	// IMP=0x00000000000bd8de
...
- (id)applyUpdatesWithElement:(id)arg1;	// IMP=0x00000000000bd60c
- (id)initWithDOMElement:(id)arg1 parent:(id)arg2 elementFactory:(id)arg3;	// IMP=0x00000000000bd3da
