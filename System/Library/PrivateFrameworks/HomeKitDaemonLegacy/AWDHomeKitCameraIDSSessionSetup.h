...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000032ac7d
- (unsigned long long)hash;	// IMP=0x000000000032abfc
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000032ab07
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000032aa58
- (void)copyTo:(id)arg1;	// IMP=0x000000000032a9cc
- (void)writeTo:(id)arg1;	// IMP=0x000000000032a919
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000032a90c
- (id)dictionaryRepresentation;	// IMP=0x000000000032a767
- (id)description;	// IMP=0x000000000032a6b8
