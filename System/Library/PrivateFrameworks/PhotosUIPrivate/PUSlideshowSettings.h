...
+ (id)settingsControllerModule;	// IMP=0x006000000051f65d
+ (id)sharedInstance;	// IMP=0x006000000051f62d
- (void).cxx_destruct;	// IMP=0x000000000051f411
...
- (void)setDefaultValues;	// IMP=0x000000000051f192
- (void)setDefaultPresetTransitionValues;	// IMP=0x000000000051ea76
- (void)saveInteractiveSlideshowSettingsInUserDefaults;	// IMP=0x000000000051e769
- (_Bool)transitionSettingsAreDefaults;	// IMP=0x000000000051e369
- (void)restoreCurrentInteractiveTransitionValuesFromUserDefaults;	// IMP=0x000000000051e149
- (void)removeTransitionTimingCustomizationsFromUserDefaults;	// IMP=0x000000000051e089
@property(retain, nonatomic) OKProducerPreset *currentPreset; // @synthesize currentPreset=_currentPreset;
- (id)archiveValueForKey:(id)arg1;	// IMP=0x000000000051dcb2
- (void)applyArchiveValue:(id)arg1 forKey:(id)arg2;	// IMP=0x000000000051dc25
- (void)performPostSaveActions;	// IMP=0x000000000051dbe4
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000051db83
- (id)parentSettings;	// IMP=0x000000000051db6a
