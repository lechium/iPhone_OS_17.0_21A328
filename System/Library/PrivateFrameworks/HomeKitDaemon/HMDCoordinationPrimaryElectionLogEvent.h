...
+ (_Bool)submitEventWithHistogrammedAggregateHomeDataCommonDimensions;	// IMP=0x0010000000009239
...
- (id)initWithIsPrimary:(_Bool)arg1 didChangePrimary:(_Bool)arg2;	// IMP=0x00000000000090de
