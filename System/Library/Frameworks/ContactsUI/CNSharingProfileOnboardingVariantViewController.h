...
- (void).cxx_destruct;	// IMP=0x00000000001791a7
...
- (void)photoPickerVariantListControllerDidCancel:(id)arg1;	// IMP=0x0000000000178fe2
- (void)photoPickerVariantListController:(id)arg1 didSelectProviderItem:(id)arg2;	// IMP=0x0000000000178f67
- (void)didTapBack:(id)arg1;	// IMP=0x0000000000178f1b
- (void)didTapPose:(id)arg1;	// IMP=0x0000000000178ecf
- (void)didTapContinue:(id)arg1;	// IMP=0x0000000000178e92
- (void)didTapSetupLater:(id)arg1;	// IMP=0x0000000000178e46
- (void)updateOriginalItem:(id)arg1;	// IMP=0x0000000000178ddd
- (void)viewDidLayoutSubviews;	// IMP=0x0000000000178d13
- (void)viewDidLoad;	// IMP=0x0000000000178413
- (id)initWithVariantsManager:(id)arg1 originalItem:(id)arg2 selectedVariantIdentifier:(id)arg3;	// IMP=0x000000000017830a
