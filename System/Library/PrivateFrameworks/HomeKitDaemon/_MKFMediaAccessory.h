...
+ (id)backingModelProtocol;	// IMP=0x001000000078761f
+ (id)modelIDForParentRelationshipTo:(id)arg1;	// IMP=0x0010000000787606
+ (Class)cd_modelClass;	// IMP=0x001000000080b208
+ (id)fetchRequest;	// IMP=0x0010000000d35972
- (id)castIfMediaAccessory;	// IMP=0x0000000000787666
