...
- (void).cxx_destruct;	// IMP=0x00000000000519d3
...
- (void)_layoutDidChangeFrom:(_Bool)arg1 to:(_Bool)arg2;	// IMP=0x0000000000051912
- (void)_numberOfLinesDidChangeFrom:(unsigned long long)arg1 to:(unsigned long long)arg2;	// IMP=0x00000000000518a8
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x00000000000515a7
- (void)dealloc;	// IMP=0x0000000000051519
- (id)initWithUsageReport:(id)arg1;	// IMP=0x0000000000050d5e
