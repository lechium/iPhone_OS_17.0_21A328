...
+ (id)allSupportedItemProperties;	// IMP=0x0060000000208126
+ (id)allSupportedGroupProperties;	// IMP=0x006000000020802b
- (void).cxx_destruct;	// IMP=0x000000000020664c
...
- (id)modelObjectForRecommendationDictionary:(id)arg1 userIdentity:(id)arg2;	// IMP=0x00000000002062a3
- (id)modelObjectForItemsArray:(id)arg1 userIdentity:(id)arg2;	// IMP=0x0000000000206176
- (id)modelObjectForRecentlyPlayedArray:(id)arg1 userIdentity:(id)arg2;	// IMP=0x0000000000206049
- (void)initializeRequestedGroupProperties;	// IMP=0x0000000000205d42
- (id)initWithRequestedGroupPropertySet:(id)arg1 requestedItemPropertySet:(id)arg2 storeItemMetadataResults:(id)arg3 flatSectionedItems:(id)arg4 storeURLBag:(id)arg5 isListenNow:(_Bool)arg6;	// IMP=0x0000000000205c0a
