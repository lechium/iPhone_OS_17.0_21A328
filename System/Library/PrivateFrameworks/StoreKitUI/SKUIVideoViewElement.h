...
- (void).cxx_destruct;	// IMP=0x0000000000249e3a
...
- (_Bool)isEnabled;	// IMP=0x0000000000249dc3
- (id)applyUpdatesWithElement:(id)arg1;	// IMP=0x0000000000249ce7
@property(readonly, nonatomic) SKUIImageViewElement *thumbnailImage; // @synthesize thumbnailImage=_thumbnailImage;
@property(readonly, nonatomic) NSArray *assets;
- (id)initWithDOMElement:(id)arg1 parent:(id)arg2 elementFactory:(id)arg3;	// IMP=0x00000000002496e7
