...
- (void).cxx_destruct;	// IMP=0x00000000002f250d
...
- (void)_checkForCover:(id)arg1;	// IMP=0x00000000002f2306
- (void)recordTouchAtPoint:(struct CGPoint)arg1;	// IMP=0x00000000002f1fe3
- (void)reset;	// IMP=0x00000000002f1eb7
- (void)dealloc;	// IMP=0x00000000002f1d23
- (id)initWithSize:(struct CGSize)arg1 touchLifetime:(double)arg2;	// IMP=0x00000000002f1cb4
