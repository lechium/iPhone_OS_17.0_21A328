...
+ (void)loadEnableAirPlay2Accessories;	// IMP=0x001000000026b2d0
- (void).cxx_destruct;	// IMP=0x000000000026b29f
...
- (id)stringValue;	// IMP=0x000000000026b223
- (id)numberValue;	// IMP=0x000000000026b124
- (_Bool)boolValue;	// IMP=0x000000000026b0e0
@property(readonly, copy) NSString *propertyDescription;
- (id)initWithKey:(id)arg1 options:(unsigned long long)arg2 defaultValue:(id)arg3;	// IMP=0x000000000026aef2
