...
- (void).cxx_destruct;	// IMP=0x00000000001130a3
...
- (void)reset;	// IMP=0x0000000000113047
- (void)evaluateForState:(long long)arg1;	// IMP=0x0000000000112d70
- (id)initWithScrollView:(id)arg1 axis:(long long)arg2;	// IMP=0x0000000000112c1a
- (id)init;	// IMP=0x0000000000112c0c
