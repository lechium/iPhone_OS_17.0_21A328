...
- (void)_requestMediaDataIfReady;	// IMP=0x00000000000cf018
- (void)invalidate;	// IMP=0x00000000000cef70
- (_Bool)_isInvalidatePending;	// IMP=0x00000000000cef48
- (void)_setInvalidatePending;	// IMP=0x00000000000cef23
- (void)startRequestingMediaData;	// IMP=0x00000000000ceec2
- (void)dealloc;	// IMP=0x00000000000cee6d
- (id)init;	// IMP=0x00000000000cee54
- (id)initWithMediaDataConsumer:(id)arg1 requestQueue:(id)arg2 requestBlock:(CDUnknownBlockType)arg3;	// IMP=0x00000000000cecb7
