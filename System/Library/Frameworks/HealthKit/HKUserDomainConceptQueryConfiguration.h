...
+ (_Bool)supportsSecureCoding;	// IMP=0x00600000000d7ead
- (void).cxx_destruct;	// IMP=0x00000000000d8110
@property(nonatomic) unsigned long long limit; // @synthesize limit=_limit;
@property(copy, nonatomic) HKQueryAnchor *anchor; // @synthesize anchor=_anchor;
@property(copy, nonatomic) NSArray *sortDescriptors; // @synthesize sortDescriptors=_sortDescriptors;
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000d7fec
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000d7eb5
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000d7de1
