...
- (void).cxx_destruct;	// IMP=0x00200000007408ce
...
- (void)layoutSubviews;	// IMP=0x00100000007405cc
@property(readonly, nonatomic) UIImageView *shieldImageView;
@property(readonly, nonatomic) GuidanceManeuverView *maneuverView;
- (void)updateStyleForTheme;	// IMP=0x001000000073ff1c
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x001000000073fd6d
