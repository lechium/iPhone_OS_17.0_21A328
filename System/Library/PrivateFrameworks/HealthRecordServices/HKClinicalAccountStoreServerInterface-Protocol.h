...
- (void)remote_simulateAccountDownloadOverdueWithIdentifier:(NSUUID *)arg1 stage:(long long)arg2 completion:(void (^)(_Bool, NSError *))arg3;
...
- (void)remote_deleteAccountWithIdentifier:(NSUUID *)arg1 deletionReason:(long long)arg2 completion:(void (^)(_Bool, NSError *))arg3;
...
- (void)remote_endLoginSessionWithState:(NSUUID *)arg1 code:(NSString *)arg2 completion:(void (^)(HKClinicalAccountLoginCompletionState *))arg3;
- (void)remote_beginReloginSessionForAccountWithIdentifier:(NSUUID *)arg1 completion:(void (^)(NSURL *, NSUUID *, NSError *))arg2;
- (void)remote_beginInitialLoginSessionForGatewayWithExternalID:(NSString *)arg1 completion:(void (^)(NSURL *, NSUUID *, NSError *))arg2;
@end
