...
- (id)submitEventWithHistogrammedHomeDataCommonDimensionsForSpecifiedHome;	// IMP=0x000000000081ed5c
@property(readonly, copy, nonatomic) NSDictionary *coreAnalyticsEventDictionary;
@property(readonly, copy, nonatomic) NSString *coreAnalyticsEventName;
- (id)initWithUser:(id)arg1 userDataController:(id)arg2 homeUUID:(id)arg3;	// IMP=0x000000000081e9a0
- (id)initWithUser:(id)arg1;	// IMP=0x000000000081e8e3
