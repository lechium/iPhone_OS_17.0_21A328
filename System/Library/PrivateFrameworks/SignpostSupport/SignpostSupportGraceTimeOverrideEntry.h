...
- (id)debugDescriptionWithWhitespacePrefix:(id)arg1;	// IMP=0x0000000000003747
- (id)debugDescription;	// IMP=0x000000000000372e
- (id)initWithEntryLevel:(unsigned long long)arg1;	// IMP=0x00000000000036cd
