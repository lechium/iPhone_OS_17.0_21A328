...
- (void).cxx_destruct;	// IMP=0x00000000005baf0e
...
- (id)initWithActionSet:(id)arg1 source:(unsigned long long)arg2 numAccessories:(unsigned int)arg3 bundleId:(id)arg4 transactionId:(id)arg5;	// IMP=0x00000000005ba97d
- (id)biomeEventsRepresentationForLogObserver:(id)arg1;	// IMP=0x0000000000020098
- (unsigned long long)microLocationScanTriggerTypeForLogEventObserver:(id)arg1;	// IMP=0x00000000000515b8
- (_Bool)shouldTriggerMicroLocationRecordingScanForLogEventObserver:(id)arg1;	// IMP=0x000000000005154a
- (_Bool)shouldTriggerMicroLocationLocalizationScanForLogEventObserver:(id)arg1;	// IMP=0x00000000000514dc
- (id)microLocationMetadataForLogEventObserver:(id)arg1;	// IMP=0x0000000000051363
