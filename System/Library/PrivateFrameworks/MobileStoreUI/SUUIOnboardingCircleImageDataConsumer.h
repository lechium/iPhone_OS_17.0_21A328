...
- (void).cxx_destruct;	// IMP=0x0000000000376f72
...
- (id)_saturationBackgroundImageWithSize:(struct CGSize)arg1;	// IMP=0x0000000000376e0e
- (id)imageForImage:(id)arg1;	// IMP=0x00000000003769c1
