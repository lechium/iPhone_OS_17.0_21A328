...
#import <SmartReplies/_SGSuggestionsServiceBaseProtocol-Protocol.h>
#import <SmartReplies/_SGSuggestionsServiceEventsConfirmRejectProtocol-Protocol.h>
#import <SmartReplies/_SGSuggestionsServiceEventsObserverProtocol-Protocol.h>
...
- (void)isEventCandidateForURL:(NSURL *)arg1 andTitle:(NSString *)arg2 containsSchemaOrg:(_Bool)arg3 withCompletion:(void (^)(_Bool))arg4;
