...
@interface WebViewPrivate : NSObject
{
    ...
    struct unique_ptr<WebViewRenderingUpdateScheduler, std::default_delete<WebViewRenderingUpdateScheduler>> renderingUpdateScheduler;	// 1008 = 0x3f0
...
+ (void)initialize;	// IMP=0x0060000000134be0
- (id).cxx_construct;	// IMP=0x00000000001351b0
- (void).cxx_destruct;	// IMP=0x0000000000134cf0
- (void)dealloc;	// IMP=0x0000000000134cc0
- (id)init;	// IMP=0x0000000000134bf0
