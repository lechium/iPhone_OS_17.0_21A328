...
- (void).cxx_destruct;	// IMP=0x000000000025deed
...
- (id)compositeImageWithSize:(struct CGSize)arg1;	// IMP=0x000000000025de34
- (id)originalImageWithSize:(struct CGSize)arg1;	// IMP=0x000000000025dd98
