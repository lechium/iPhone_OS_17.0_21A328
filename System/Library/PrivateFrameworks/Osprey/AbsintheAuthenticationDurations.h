...
- (id)calculateDuration:(id)arg1 and:(id)arg2;	// IMP=0x0000000000006031
- (void)setAbsintheConnectionMethodWith:(id)arg1;	// IMP=0x0000000000005fea
- (void)setAbsintheAuthenticationTimestampForKey:(id)arg1;	// IMP=0x0000000000005edb
- (void)reportAbsintheAuthenticationDurations;	// IMP=0x0000000000005b45
- (id)init;	// IMP=0x0000000000005ad0
