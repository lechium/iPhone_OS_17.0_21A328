...
- (void).cxx_destruct;	// IMP=0x00000000005b4d02
...
- (void)_handleExportCompletedWithSuccess:(_Bool)arg1 editedSize:(struct CGSize)arg2 error:(id)arg3;	// IMP=0x00000000005b4c24
- (void)didCancel;	// IMP=0x00000000005b4be7
@property(readonly, nonatomic) double progress;
- (void)run;	// IMP=0x00000000005b493d
- (id)_editSource;	// IMP=0x00000000005b47d9
- (id)_newOutputURL;	// IMP=0x00000000005b46f0
- (id)_exportPresetName;	// IMP=0x00000000005b46b8
- (id)initWithVideoURLNode:(id)arg1 imageURLNode:(id)arg2 quality:(unsigned long long)arg3 livePhotoPairingIdentifier:(id)arg4 compositionController:(id)arg5;	// IMP=0x00000000005b449f
