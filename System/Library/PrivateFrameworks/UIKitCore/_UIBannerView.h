...
- (void).cxx_destruct;	// IMP=0x00000000010c5353
...
- (void)setHighlighted:(_Bool)arg1 initialPress:(_Bool)arg2;	// IMP=0x00000000010c5144
- (void)layoutSubviews;	// IMP=0x00000000010c4e6a
- (void)updateConstraints;	// IMP=0x00000000010c4898
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000010c43a8
