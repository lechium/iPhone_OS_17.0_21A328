...
- (id)hk_localizedWeekdaysListWithGregorianCalendar:(id)arg1 standaloneFormatter:(id)arg2 listItemFormatter:(id)arg3;	// IMP=0x003000000018ee85
@property(readonly, nonatomic) NSString *hk_localizedWeekdaysList;
- (void)addDetailValuesToSection:(id)arg1;	// IMP=0x0030000000303e65
@end
