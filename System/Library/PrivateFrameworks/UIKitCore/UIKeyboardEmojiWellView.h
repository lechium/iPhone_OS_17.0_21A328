...
- (void).cxx_destruct;	// IMP=0x0000000000cae68e
...
- (void)dragWillBegin:(id)arg1;	// IMP=0x0000000000cae542
- (void)layoutSubviews;	// IMP=0x0000000000cae080
- (id)fontUsingSilhouette:(unsigned long long)arg1 size:(double)arg2;	// IMP=0x0000000000cad4e7
- (void)setStringRepresentation:(id)arg1 silhouette:(unsigned long long)arg2;	// IMP=0x0000000000cad396
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000cacea0
