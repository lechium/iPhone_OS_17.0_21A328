...
+ (_Bool)submitEventWithHistogrammedAggregateHomeDataCommonDimensions;	// IMP=0x0010000000535032
+ (id)removingAccessory:(id)arg1 hapAccessory:(id)arg2;	// IMP=0x0010000000534f86
+ (id)pairingAccessory:(id)arg1 home:(id)arg2;	// IMP=0x0010000000534f00
+ (id)pairingAccessoryWithDescription:(id)arg1 home:(id)arg2;	// IMP=0x0010000000534e8e
- (void).cxx_destruct;	// IMP=0x0000000000534d3c
...
- (id)residentConfirmationToString:(long long)arg1;	// IMP=0x0000000000534688
- (void)updateResidentConfirmationDurationWithConfirmation:(long long)arg1;	// IMP=0x00000000005345fe
@property(readonly, nonatomic) unsigned long long coreAnalyticsEventOptions;
@property(readonly, copy, nonatomic) NSDictionary *coreAnalyticsEventDictionary;
- (id)getLowestError:(id)arg1;	// IMP=0x00000000005334ab
@property(readonly, copy, nonatomic) NSString *coreAnalyticsEventName;
- (void)submitAtDate:(id)arg1;	// IMP=0x0000000000532990
- (_Bool)_isMatterAccessory;	// IMP=0x000000000053297b
- (void)_updateThreadPropertiesWithPairedAccessory:(id)arg1;	// IMP=0x00000000005328d5
- (void)updateEventPropertiesWithHAPAccessory:(id)arg1;	// IMP=0x0000000000532485
- (void)updateEventPropertiesWithPairedAccessory:(id)arg1;	// IMP=0x00000000005322f1
- (void)pairedToServer:(id)arg1 certificationStatus:(long long)arg2 addedViaWAC:(_Bool)arg3 legacyWAC:(_Bool)arg4;	// IMP=0x0000000000532081
- (void)setAuthenticationMethod:(unsigned long long)arg1;	// IMP=0x000000000053206f
- (void)setAddedViaWAC:(_Bool)arg1;	// IMP=0x000000000053205d
- (id)initWithAccessoryDescription:(id)arg1 home:(id)arg2;	// IMP=0x00000000005317ef
- (id)initWithUnpairedAccessory:(id)arg1 pairedAccessory:(id)arg2 hapAccessory:(id)arg3 home:(id)arg4 isAddOperation:(_Bool)arg5;	// IMP=0x0000000000530957
