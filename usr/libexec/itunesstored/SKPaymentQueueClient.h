...
- (void).cxx_destruct;	// IMP=0x00200000000a9339
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000a9142
- (id)copyXPCEncoding;	// IMP=0x00100000000a9051
- (id)initWithXPCEncoding:(id)arg1;	// IMP=0x00100000000a8e75
