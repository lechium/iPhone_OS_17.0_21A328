...
- (void).cxx_destruct;	// IMP=0x000000000018c990
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000018c930
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000018c910
- (void)didMoveToSuperview;	// IMP=0x000000000018c8e0
- (void)layoutSubviews;	// IMP=0x000000000018c6a0
