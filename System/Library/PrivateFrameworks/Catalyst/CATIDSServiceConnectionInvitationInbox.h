...
+ (id)acknowledgeTimerIdentifier;	// IMP=0x0060000000009bac
...
- (void)acknowledgeTimerFiredWithInvitationIdentifier:(id)arg1;	// IMP=0x0000000000009a34
- (void)receiveAcknowledgeForInvitationIdentifier:(id)arg1 connectionIdentifier:(id)arg2;	// IMP=0x00000000000096ee
- (void)receiveInvitationWithIdentifier:(id)arg1 senderAppleID:(id)arg2 senderAddress:(id)arg3 messagingVersion:(unsigned long long)arg4 userInfo:(id)arg5;	// IMP=0x00000000000090f1
- (id)initWithTimerSource:(id)arg1 assertionProvider:(id)arg2 workQueue:(id)arg3 acknowledgeTimeout:(double)arg4;	// IMP=0x0000000000008fef
- (void)dealloc;	// IMP=0x0000000000008e8f
