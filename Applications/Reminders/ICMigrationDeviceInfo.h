...
+ (void)logDeviceList:(id)arg1;	// IMP=0x00200000000073dc
- (void).cxx_destruct;	// IMP=0x00200000000075f5
...
- (id)loggableDescription;	// IMP=0x00100000000073ca
- (_Bool)shouldBeHidden;	// IMP=0x00100000000073c2
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000073b7
- (id)initWithName:(id)arg1;	// IMP=0x001000000000739d
- (id)initWithName:(id)arg1 upgradable:(_Bool)arg2 upgraded:(_Bool)arg3;	// IMP=0x001000000000731c
