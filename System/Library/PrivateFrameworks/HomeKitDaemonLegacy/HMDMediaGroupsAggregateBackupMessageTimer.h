...
+ (id)logCategory;	// IMP=0x00100000006fbdb2
- (void).cxx_destruct;	// IMP=0x00000000006fbd6d
...
- (id)logIdentifier;	// IMP=0x00000000006fbc61
- (void)timerDidFire:(id)arg1;	// IMP=0x00000000006fbb0c
- (id)timerWithTimeInterval:(double)arg1 options:(unsigned long long)arg2;	// IMP=0x00000000006fbacc
- (double)nextTimeInterval;	// IMP=0x00000000006fba48
- (void)startRetryTimer;	// IMP=0x00000000006fb70d
- (void)markAttemptWithMessageIdentifier:(id)arg1;	// IMP=0x00000000006fb6ce
- (id)initWithParticipantAccessoryUUID:(id)arg1 timerProvider:(id)arg2;	// IMP=0x00000000006fb603
- (id)initWithParticipantAccessoryUUID:(id)arg1;	// IMP=0x00000000006fb5ee
