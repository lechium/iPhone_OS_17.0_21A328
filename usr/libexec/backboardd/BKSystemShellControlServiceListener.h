...
- (void).cxx_destruct;	// IMP=0x002000000009ddca
- (void)listener:(id)arg1 didReceiveConnection:(id)arg2 withContext:(id)arg3;	// IMP=0x001000000009db7c
- (void)activate;	// IMP=0x001000000009db66
- (id)initWithSentinel:(id)arg1;	// IMP=0x001000000009da05
