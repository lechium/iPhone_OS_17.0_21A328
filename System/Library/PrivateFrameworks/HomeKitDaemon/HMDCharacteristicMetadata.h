...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000005bec27
+ (id)characteristicMetadataWithDictionary:(id)arg1;	// IMP=0x00100000005bea20
- (void).cxx_destruct;	// IMP=0x00000000005be989
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000005be719
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000005be502
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000005be4f7
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000005be24b
@property(readonly) unsigned long long hash;
- (id)dictionaryRepresentation;	// IMP=0x00000000005bdf49
- (id)_descriptionDetails;	// IMP=0x00000000005bd8d8
- (id)dumpState;	// IMP=0x00000000005bd86b
@property(readonly, copy) NSString *description;
- (id)initWithMinimumValue:(id)arg1 maximumValue:(id)arg2 stepValue:(id)arg3 maxLength:(id)arg4 validValues:(id)arg5 format:(id)arg6 units:(id)arg7 manufacturerDescription:(id)arg8;	// IMP=0x00000000005bd5de
- (id)init;	// IMP=0x00000000005bd536
