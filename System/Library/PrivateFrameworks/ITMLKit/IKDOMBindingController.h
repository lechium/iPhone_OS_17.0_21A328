...
+ (id)_prototypeGroupsByTypeForDOMElement:(id)arg1;	// IMP=0x00100000000939d2
+ (id)_parsedMutationRulesForDOMElement:(id)arg1;	// IMP=0x001000000009351b
+ (id)instantiateDOMElementForItem:(id)arg1 withPrototype:(id)arg2 parentDOMElement:(id)arg3 existingDOMElement:(id)arg4;	// IMP=0x00100000000923b8
+ (id)domBindingControllerForDOMElement:(id)arg1;	// IMP=0x0010000000090b8f
+ (void)prepareForDOMElement:(id)arg1;	// IMP=0x0010000000090ad4
+ (id)parsedBindingForDOMElement:(id)arg1;	// IMP=0x00100000000902a0
- (void).cxx_destruct;	// IMP=0x00000000000959ed
...
- (void)_evaluateMutationRules;	// IMP=0x0000000000095706
- (void)_resolveBinding;	// IMP=0x0000000000094403
- (_Bool)_canBeReused;	// IMP=0x0000000000094181
- (void)dataObservable:(id)arg1 didChangePropertyPathWithString:(id)arg2 extraInfo:(id)arg3;	// IMP=0x0000000000092bc7
- (id)findPrototypeForDataItem:(id)arg1;	// IMP=0x00000000000927c8
- (void)scheduleUpdateUsingPreUpdate:(CDUnknownBlockType)arg1 update:(CDUnknownBlockType)arg2;	// IMP=0x0000000000091cb1
- (void)dealloc;	// IMP=0x0000000000091c00
- (id)initWithDOMElement:(id)arg1;	// IMP=0x0000000000090ba4
