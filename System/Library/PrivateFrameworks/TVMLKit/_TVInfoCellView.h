...
+ (id)infoCellViewWithElement:(id)arg1 existingView:(id)arg2;	// IMP=0x00100000000afe4e
- (void).cxx_destruct;	// IMP=0x00000000000b1eb2
...
- (id)impressionableElementsContainedInDocument:(id)arg1;	// IMP=0x00000000000b1a95
- (void)layoutSubviews;	// IMP=0x00000000000b1339
- (struct CGSize)sizeThatFits:(struct CGSize)arg1 withHeaderWidth:(double)arg2;	// IMP=0x00000000000b0d82
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000000b0d35
- (double)minimumHeaderWidth;	// IMP=0x00000000000b09ea
