...
- (void).cxx_destruct;	// IMP=0x0000000000205eb7
...
- (id)initWithEncryptedData:(id)arg1 changeType:(int)arg2 deleteType:(int)arg3;	// IMP=0x0000000000205e0e
- (id)initWithEncryptedData:(id)arg1;	// IMP=0x0000000000205d9b
