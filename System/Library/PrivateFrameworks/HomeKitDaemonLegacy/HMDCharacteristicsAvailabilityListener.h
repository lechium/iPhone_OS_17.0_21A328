...
+ (id)logCategory;	// IMP=0x0010000000bc6e5e
- (void).cxx_destruct;	// IMP=0x0000000000bc6c16
...
- (void)handleServicesUpdated:(id)arg1;	// IMP=0x0000000000bc6ae0
- (void)handleCharacteristicsUpdated:(id)arg1;	// IMP=0x0000000000bc6a6f
- (void)_notifyDelegate;	// IMP=0x0000000000bc6893
- (id)_accessoryCharacteristicsToObserve;	// IMP=0x0000000000bc64ce
- (void)_registerForNotifications;	// IMP=0x0000000000bc63e6
- (void)start;	// IMP=0x0000000000bc6386
- (id)initWithAccessory:(id)arg1 workQueue:(id)arg2 interestedCharacteristicTypesByServiceType:(id)arg3;	// IMP=0x0000000000bc61a4
