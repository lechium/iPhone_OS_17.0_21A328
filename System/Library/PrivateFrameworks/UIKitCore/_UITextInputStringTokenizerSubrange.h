...
+ (id)subrangeWithSubstring:(id)arg1 basePosition:(id)arg2;	// IMP=0x0060000000e86fbb
- (void).cxx_destruct;	// IMP=0x0000000000e870d3
...
- (id)description;	// IMP=0x0000000000e8704e
