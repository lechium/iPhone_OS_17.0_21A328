...
+ (void)performOnCollectionView:(id)arg1 withUpdate:(CDUnknownBlockType)arg2 animated:(_Bool)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x0040000000064627
- (void).cxx_destruct;	// IMP=0x0020000000064cd0
...
- (void)setInsertedIndexPaths:(id)arg1;	// IMP=0x0010000000064c2b
- (id)insertedIndexPaths;	// IMP=0x0010000000064c21
