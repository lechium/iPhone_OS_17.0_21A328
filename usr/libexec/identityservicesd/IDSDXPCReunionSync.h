...
- (void).cxx_destruct;	// IMP=0x00200000001314d9
...
- (_Bool)_isEntitledForPreferInfraWiFiForServices:(id)arg1 error:(id *)arg2;	// IMP=0x0010000000131331
- (void)_defaultPeerSetPreferInfraWiFi:(_Bool)arg1 services:(id)arg2;	// IMP=0x00100000001312b2
- (void)reunionSyncCompletedForServices:(id)arg1 withCompletion:(CDUnknownBlockType)arg2;	// IMP=0x0010000000131089
- (void)reunionSyncStartedForServices:(id)arg1 withCompletion:(CDUnknownBlockType)arg2;	// IMP=0x0010000000130e5a
- (id)initWithConnection:(id)arg1 clientProcessName:(id)arg2 UTunDeliveryController:(id)arg3 duetInterface:(id)arg4;	// IMP=0x0010000000130d77
