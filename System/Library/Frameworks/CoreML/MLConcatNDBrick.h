...
- (void).cxx_destruct;	// IMP=0x000000000018dbeb
...
- (void)computeOnCPUWithInputTensors:(id)arg1 outputTensors:(id)arg2;	// IMP=0x000000000018d4e6
- (_Bool)hasGPUSupport;	// IMP=0x000000000018d4de
- (id)initWithParameters:(id)arg1;	// IMP=0x000000000018d269
- (id)setupForInputShapes:(id)arg1 withParameters:(id)arg2;	// IMP=0x000000000018cea4
