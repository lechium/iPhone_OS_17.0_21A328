...
- (void).cxx_destruct;	// IMP=0x0000000000025fb4
@property(readonly) NSString *configurationType; // @synthesize configurationType=_configurationType;
- (void)_assetDidChange:(id)arg1;	// IMP=0x0000000000025f8d
- (void)_filesystemDidChange:(id)arg1;	// IMP=0x0000000000025cd6
- (id)fetchBundles;	// IMP=0x000000000002576a
- (void)dealloc;	// IMP=0x00000000000256af
- (id)init;	// IMP=0x0000000000025684
- (id)initWithConfigurationType:(id)arg1 provider:(id)arg2;	// IMP=0x00000000000249a9
