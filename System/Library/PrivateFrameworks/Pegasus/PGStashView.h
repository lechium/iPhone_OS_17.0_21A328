...
- (void)resetChevronState;	// IMP=0x0000000000042b85
- (void)setChevronHidden:(_Bool)arg1 left:(_Bool)arg2;	// IMP=0x0000000000042b4f
- (void)_setContinuousCornerRadius:(double)arg1;	// IMP=0x00000000000428f4
- (void)layoutStashChevrons;	// IMP=0x0000000000042555
- (void)layoutSubviews;	// IMP=0x000000000004235b
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000041d30
