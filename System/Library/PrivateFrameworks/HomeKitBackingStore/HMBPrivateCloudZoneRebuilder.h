...
+ (id)logCategory;	// IMP=0x001000000003d2e2
- (void).cxx_destruct;	// IMP=0x00000000000364cb
...
- (id)logIdentifier;	// IMP=0x0000000000036369
- (void)timerDidFire:(id)arg1;	// IMP=0x00000000000360dd
- (void)handleZoneChanged;	// IMP=0x0000000000035e45
@property(readonly, nonatomic, getter=isZoneRebuildInProgress) _Bool zoneRebuildInProgress;
- (void)rebuild;	// IMP=0x0000000000035c59
- (void)handleIdentityLost;	// IMP=0x0000000000035ab5
- (id)zoneStartUp;	// IMP=0x0000000000035956
- (id)initWithCloudZone:(id)arg1;	// IMP=0x000000000003588f
