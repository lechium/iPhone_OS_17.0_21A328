...
- (void).cxx_destruct;	// IMP=0x0020000000239d5f
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000239c3d
- (unsigned long long)hash;	// IMP=0x0010000000239ba7
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000239a91
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000002399a8
- (void)copyTo:(id)arg1;	// IMP=0x0010000000239905
- (void)writeTo:(id)arg1;	// IMP=0x0010000000239865
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000239858
- (id)dictionaryRepresentation;	// IMP=0x001000000023950b
- (id)description;	// IMP=0x001000000023945c
