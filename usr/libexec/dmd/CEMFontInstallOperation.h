...
- (void).cxx_destruct;	// IMP=0x0020000000005aa9
...
- (void)assetResolutionFailedWithError:(id)arg1;	// IMP=0x0010000000005a15
- (void)assetResolutionDidSucceedWithAssetURL:(id)arg1;	// IMP=0x001000000000570c
...
- (_Bool)isAsynchronous;	// IMP=0x0010000000005543
- (id)initWithFontDeclaration:(id)arg1 resolver:(id)arg2;	// IMP=0x00100000000054a1
