...
+ (void)generateReportForSharedFolder:(id)arg1 qualityOfService:(long long)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0060000000054fae
+ (void)_finishReport:(id)arg1 session:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0060000000054ac3
- (void).cxx_destruct;	// IMP=0x00000000000561e1
...
- (id)telemetryEvent;	// IMP=0x00000000000560d5
- (void)incrementErrorRetryCountWithSession:(id)arg1;	// IMP=0x000000000005482e
- (void)shareChangedDuringCheckWithSession:(id)arg1;	// IMP=0x0000000000054728
- (id)initWithURL:(id)arg1;	// IMP=0x00000000000546bd
