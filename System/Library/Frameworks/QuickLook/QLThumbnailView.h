...
- (void).cxx_destruct;	// IMP=0x00000000000862eb
...
- (void)setFrame:(struct CGRect)arg1;	// IMP=0x00000000000861ad
- (void)drawRect:(struct CGRect)arg1;	// IMP=0x0000000000085f1e
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000085e8d
