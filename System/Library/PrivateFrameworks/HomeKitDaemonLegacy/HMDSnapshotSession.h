...
+ (id)logCategory;	// IMP=0x001000000076799e
- (void).cxx_destruct;	// IMP=0x000000000076793a
...
- (void)respond:(id)arg1 payload:(id)arg2;	// IMP=0x0000000000767467
- (void)dealloc;	// IMP=0x00000000007673eb
- (id)logIdentifier;	// IMP=0x000000000076739b
- (id)initWithSessionID:(id)arg1 accessory:(id)arg2 snapshotGetter:(id)arg3 message:(id)arg4 waitPeriod:(double)arg5 streamingTierType:(unsigned long long)arg6 cameraLocallyReachable:(_Bool)arg7 snapshotForNotification:(_Bool)arg8;	// IMP=0x00000000007671c4
