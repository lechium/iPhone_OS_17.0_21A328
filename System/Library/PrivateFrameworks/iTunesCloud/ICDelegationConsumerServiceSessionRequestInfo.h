...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000a84ae
- (unsigned long long)hash;	// IMP=0x00000000000a84a0
- (id)initWithAccountID:(unsigned long long)arg1 fairPlaySessionID:(unsigned long long)arg2;	// IMP=0x00000000000a8458
