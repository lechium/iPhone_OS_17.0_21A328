...
- (void).cxx_destruct;	// IMP=0x00000000000ee33a
...
- (void)fetchObjectIdentifierWithReply:(CDUnknownBlockType)arg1;	// IMP=0x00000000000ee27a
- (void)invalidateConnection;	// IMP=0x00000000000ee1c7
- (void)fetchPlayerIndexWithReply:(CDUnknownBlockType)arg1;	// IMP=0x00000000000ee11d
- (void)newPlayerIndex:(long long)arg1;	// IMP=0x00000000000ee06f
- (_Bool)acceptClient:(id)arg1 onConnection:(id)arg2 error:(id *)arg3;	// IMP=0x00000000000edc8b
- (void)invalidateClient;	// IMP=0x00000000000edbca
@property(readonly, nonatomic) id <_GCControllerComponentDescription> receiverDescription;
- (id)initWithInitialValue:(long long)arg1;	// IMP=0x00000000000edb30
- (id)initWithIdentifier:(id)arg1 initialValue:(long long)arg2;	// IMP=0x00000000000edab0
