...
- (void).cxx_destruct;	// IMP=0x0020000000005cec
...
- (void)main;	// IMP=0x0010000000005b7c
- (id)initWithFontDeclaration:(id)arg1 installMetadata:(id)arg2;	// IMP=0x0010000000005ada
