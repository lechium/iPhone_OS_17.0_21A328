...
- (void).cxx_destruct;	// IMP=0x00000000001aa7ba
...
- (id)description;	// IMP=0x00000000001aa5c1
- (id)describeMergeTable;	// IMP=0x00000000001aa4a1
- (id)mergeSource:(id)arg1 andDestination:(id)arg2;	// IMP=0x00000000001aa3ea
@property(readonly, copy, nonatomic) NSArray *merged;
- (void)_calculate;	// IMP=0x00000000001aa263
- (void)_calculateMerge;	// IMP=0x00000000001a9a52
- (void)_calculateLCSSTable;	// IMP=0x00000000001a9823
- (void)_calculatePrefixAndSuffix;	// IMP=0x00000000001a965e
- (void)_reset;	// IMP=0x00000000001a9631
- (void)dealloc;	// IMP=0x00000000001a95f7
