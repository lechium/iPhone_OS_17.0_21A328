...
- (void).cxx_destruct;	// IMP=0x000000000004b6be
...
- (id)timeRefForTTLClass:(unsigned char)arg1;	// IMP=0x000000000004b68a
- (id)initWithCollection:(id)arg1 localStorePlist:(id)arg2 liveDataDescriptor:(int)arg3;	// IMP=0x000000000004b3c7
- (id)initWithDictionary:(id)arg1;	// IMP=0x000000000004ae4b
