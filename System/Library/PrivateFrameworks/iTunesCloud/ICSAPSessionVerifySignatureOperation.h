...
- (void).cxx_destruct;	// IMP=0x00000000001ac655
@property(copy, nonatomic) CDUnknownBlockType responseHandler; // @synthesize responseHandler=_responseHandler;
@property(retain, nonatomic) NSMutableData *data; // @synthesize data=_data;
@property(copy, nonatomic) NSData *signatureData; // @synthesize signatureData=_signatureData;
- (void)finishWithSAPContextPreparationError:(id)arg1;	// IMP=0x00000000001ac59e
- (void)executeWithSAPContext:(id)arg1;	// IMP=0x00000000001ac4cd
