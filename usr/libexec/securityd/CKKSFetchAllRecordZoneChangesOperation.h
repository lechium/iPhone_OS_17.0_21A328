...
- (void).cxx_destruct;	// IMP=0x00200000000c6ed1
...
- (void)cancel;	// IMP=0x00100000000c6b97
- (void)sendChangesToClient:(id)arg1 moreComing:(_Bool)arg2;	// IMP=0x00100000000c677e
- (void)performFetch;	// IMP=0x00100000000c5a70
- (void)groupStart;	// IMP=0x00100000000c5866
- (void)queryClientsForChangeTokens;	// IMP=0x00100000000c52f2
- (id)initWithContainer:(id)arg1 fetchClass:(Class)arg2 clientMap:(id)arg3 fetchReasons:(id)arg4 apnsPushes:(id)arg5 forceResync:(_Bool)arg6 ckoperationGroup:(id)arg7;	// IMP=0x00100000000c5097
- (id)init;	// IMP=0x00100000000c5089
