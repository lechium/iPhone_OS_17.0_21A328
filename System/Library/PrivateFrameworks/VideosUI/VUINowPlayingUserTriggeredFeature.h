...
- (void).cxx_destruct;	// IMP=0x000000000002ff4f
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000002fe78
@property(readonly) unsigned long long hash;
@property(readonly, copy) NSString *description;
- (id)initWithType:(unsigned long long)arg1;	// IMP=0x000000000002fd15
- (id)init;	// IMP=0x000000000002fcfc
