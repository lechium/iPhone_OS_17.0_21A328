...
- (void).cxx_destruct;	// IMP=0x002000000001b9d2
...
- (id)description;	// IMP=0x001000000001b885
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000001b6e2
- (unsigned long long)hash;	// IMP=0x001000000001b66d
- (id)plistRepresentation;	// IMP=0x001000000001b4d8
- (id)initWithPlistRepresentation:(id)arg1;	// IMP=0x001000000001b39f
- (id)initWithActivityLabel:(id)arg1 globalProgress:(long long)arg2 syncProgressState:(unsigned long long)arg3;	// IMP=0x001000000001b316
