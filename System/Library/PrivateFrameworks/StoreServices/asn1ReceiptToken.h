...
+ (id)readFromBuffer:(const char *)arg1;	// IMP=0x006000000017055f
...
- (id)description;	// IMP=0x0000000000170733
- (void)dealloc;	// IMP=0x0000000000170524
- (id)_initWithType:(unsigned long long)arg1 typeVersion:(unsigned long long)arg2 contentToken:(id)arg3;	// IMP=0x00000000001704bb
