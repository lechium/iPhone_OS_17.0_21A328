...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000afed5e
+ (_Bool)supportsPingRequest:(unsigned long long)arg1;	// IMP=0x0010000000afed53
+ (unsigned long long)setSupportsPingRequest:(_Bool)arg1 capabilities:(unsigned long long)arg2;	// IMP=0x0010000000afed48
+ (id)fromMessagePayload:(id)arg1;	// IMP=0x0010000000afeaba
- (void).cxx_destruct;	// IMP=0x0000000000afe9c5
...
- (long long)compare:(id)arg1 currentPrimary:(id)arg2 outCriteria:(unsigned long long *)arg3;	// IMP=0x0000000000afe400
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000afe2f6
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000afe0b5
- (id)redactedDescription;	// IMP=0x0000000000afe0a3
- (id)description;	// IMP=0x0000000000afdf07
- (id)toMessagePayload;	// IMP=0x0000000000afde73
- (_Bool)supportsPingRequest;	// IMP=0x0000000000afde3e
- (id)initWithVersion:(id)arg1 deviceIdentifier:(id)arg2 name:(id)arg3 currentPrimaryIdentifier:(id)arg4 enabledAsResident:(_Bool)arg5 supportsPingRequest:(_Bool)arg6 connectionType:(unsigned long long)arg7 pcsEnabled:(_Bool)arg8 swVersion:(id)arg9;	// IMP=0x0000000000afdceb
