...
+ (struct _NSRange)highlightedLaneRangeForLanes:(id)arg1;	// IMP=0x0040000000c4caef
+ (id)_createFakeLanes;	// IMP=0x0010000000c4c16a
+ (id)fakeInfoForManeuver:(_Bool)arg1;	// IMP=0x0010000000c4c038
- (void).cxx_destruct;	// IMP=0x0020000000c4ce37
...
- (id)highlightedLanes;	// IMP=0x0010000000c4cdd1
@property(readonly, nonatomic) struct _NSRange highlightedLaneRange;
@property(readonly, nonatomic) _Bool isForMidStep;
- (id)description;	// IMP=0x0010000000c4c940
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000c4c872
- (id)initWithLaneInfoId:(id)arg1 lanes:(id)arg2 forManeuver:(_Bool)arg3 midStepTitles:(id)arg4 details:(id)arg5;	// IMP=0x0010000000c4c75c
- (id)initWithLaneInfoId:(id)arg1 lanes:(id)arg2;	// IMP=0x0010000000c4c730
- (id)initWithGuidanceLaneInfo:(id)arg1;	// IMP=0x0010000000c4c281
