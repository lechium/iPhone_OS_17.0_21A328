...
- (void).cxx_destruct;	// IMP=0x00200000004c6e47
...
- (void)cancel;	// IMP=0x00100000004c6d50
- (void)_reallyCancel;	// IMP=0x00100000004c6d02
- (void)afterDelay:(double)arg1 processBlock:(CDUnknownBlockType)arg2;	// IMP=0x00100000004c6a72
- (void)dealloc;	// IMP=0x00100000004c6a1d
- (id)initWithTargetSerialQueue:(id)arg1;	// IMP=0x00100000004c68a9
- (id)init;	// IMP=0x00100000004c6895
