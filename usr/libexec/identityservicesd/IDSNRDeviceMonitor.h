...
- (void).cxx_destruct;	// IMP=0x00200000000051f1
...
- (id)init;	// IMP=0x00100000000051a3
- (id)initWithDeviceIdentifier:(id)arg1 delegate:(id)arg2 queue:(id)arg3;	// IMP=0x0010000000005195
