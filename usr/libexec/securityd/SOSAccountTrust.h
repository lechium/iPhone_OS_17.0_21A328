...
+ (id)trust;	// IMP=0x004000000025875c
- (void).cxx_destruct;	// IMP=0x0020000000258729
...
- (void)dealloc;	// IMP=0x0010000000258502
- (id)initWithRetirees:(id)arg1 fpi:(struct __OpaqueSOSFullPeerInfo *)arg2 circle:(struct __OpaqueSOSCircle *)arg3 departureCode:(int)arg4 peerExpansion:(id)arg5;	// IMP=0x0010000000258423
- (id)init;	// IMP=0x0010000000258338
