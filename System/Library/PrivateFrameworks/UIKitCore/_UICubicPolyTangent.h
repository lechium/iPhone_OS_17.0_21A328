...
+ (id)keyboardTrackpadCurve;	// IMP=0x00100000014f24d7
...
- (void)settings:(id)arg1 changedValueForKey:(id)arg2;	// IMP=0x00000000014f23f3
- (double)piecewiseCubicAcceleratedSpeed:(double)arg1;	// IMP=0x00000000014f2363
- (double)quarticTangentFunction:(double)arg1 powerOfEarliestTangent:(int)arg2;	// IMP=0x00000000014f219a
- (double)quarticFunction:(double)arg1;	// IMP=0x00000000014f214e
- (double)quarticDerivative:(double)arg1;	// IMP=0x00000000014f20ec
- (int)RootPowerOfEarliestTangent:(int)arg1;	// IMP=0x00000000014f206d
- (double)gainForPower:(int)arg1;	// IMP=0x00000000014f2043
- (double)tangentSpeedForPower:(int)arg1;	// IMP=0x00000000014f2019
- (void)clipGainsForIOFixedMathWithTangency;	// IMP=0x00000000014f1e80
- (double)clipForIOFixedMath:(double)arg1 polynomialPower:(int)arg2 tangencyStartingAt:(double)arg3;	// IMP=0x00000000014f1e29
@property(readonly, nonatomic) _Bool isEmpty;
- (id)init;	// IMP=0x00000000014f1d94
