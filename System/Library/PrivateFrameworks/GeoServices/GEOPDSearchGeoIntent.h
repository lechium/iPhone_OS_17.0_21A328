...
- (void).cxx_destruct;	// IMP=0x0000000000b0c45d
- (unsigned long long)hash;	// IMP=0x0000000000b0c2f1
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000b0c08a
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000b0bd60
- (void)writeTo:(id)arg1;	// IMP=0x0000000000b0ba54
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000b0ba45
- (id)jsonRepresentation;	// IMP=0x0000000000b0b7c7
- (id)dictionaryRepresentation;	// IMP=0x0000000000b0af12
- (id)description;	// IMP=0x0000000000b0ae63
- (id)initWithData:(id)arg1;	// IMP=0x0000000000b09f91
- (id)init;	// IMP=0x0000000000b09f35
