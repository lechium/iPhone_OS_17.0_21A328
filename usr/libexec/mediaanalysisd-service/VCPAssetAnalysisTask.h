...
+ (id)taskWithAnalysisTypes:(unsigned long long)arg1 forAsset:(id)arg2 withExistingAnalysis:(id)arg3;	// IMP=0x004000000006f4d5
- (void).cxx_destruct;	// IMP=0x002000000007149d
...
- (int)mainInternal;	// IMP=0x00100000000700a4
- (void)_reportCoreAnalyticsWithAsset:(id)arg1 analysis:(id)arg2 analysisStatus:(long long)arg3 processingInterval:(double)arg4 extendedAnalysisStatus:(id)arg5;	// IMP=0x001000000006fa3f
- (void)publishLivePhotoEffectsAnalysis:(id)arg1 toAsset:(id)arg2;	// IMP=0x001000000006f60d
@property(readonly, nonatomic) double cost;
- (id)initWithAnalysisTypes:(unsigned long long)arg1 forAsset:(id)arg2 withExistingAnalysis:(id)arg3;	// IMP=0x001000000006f398
