...
- (void).cxx_destruct;	// IMP=0x0020000000c15434
...
- (void)addUserPathItem:(int)arg1;	// IMP=0x0010000000c151ef
- (_Bool)isComplete;	// IMP=0x0010000000c151dd
- (void)submitRAPWithWillSubmitBlock:(CDUnknownBlockType)arg1 didSubmitBlock:(CDUnknownBlockType)arg2;	// IMP=0x0010000000c14f69
- (void)rapCompleted:(_Bool)arg1 privacyShown:(_Bool)arg2 analyticsEvent:(id)arg3;	// IMP=0x0010000000c14f43
- (_Bool)isAdjustedCoordinateBeyondThreshold;	// IMP=0x0010000000c14e2b
- (id)_geoCoordinateFromUserCorrections;	// IMP=0x0010000000c14d28
- (void)_fillSubmissionParameters:(id)arg1;	// IMP=0x0010000000c144fa
@property(readonly, nonatomic) struct CLLocationCoordinate2D currentCoordinate;
- (id)initWithReport:(id)arg1 parentQuestion:(id)arg2 shortcut:(id)arg3;	// IMP=0x0010000000c1421d
