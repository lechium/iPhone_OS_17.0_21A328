...
- (void).cxx_destruct;	// IMP=0x00000000001b3801
@property(nonatomic) _Bool checked; // @synthesize checked=_checked;
@property(nonatomic) _Bool usesDetailAppearance; // @synthesize usesDetailAppearance=_usesDetailAppearance;
- (void)checkmarkButtonTapped:(id)arg1;	// IMP=0x00000000001b34c0
- (void)setValue:(id)arg1 property:(id)arg2;	// IMP=0x00000000001b32ac
- (id)initWithStyle:(long long)arg1 reuseIdentifier:(id)arg2;	// IMP=0x00000000001b28b3
