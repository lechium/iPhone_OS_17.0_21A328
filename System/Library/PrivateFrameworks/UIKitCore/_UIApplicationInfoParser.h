...
@interface _UIApplicationInfoParser : NSObject
{
    ...
    _Bool _hasSupportsIndirectInputEventsKey;	// 21 = 0x15
    _Bool _supportsIndirectInputEvents;	// 22 = 0x16
    _Bool _requiresGameControllerBasedFocus;	// 23 = 0x17
    _Bool _focusEnabledInLimitedControls;	// 24 = 0x18
    _Bool _forcesDefaultFocusAppearance;	// 25 = 0x19
    _Bool _focusSystemEnabled;	// 26 = 0x1a
    _Bool _supportsPrintCommand;	// 27 = 0x1b
    _Bool _supportsAlwaysOnDisplay;	// 28 = 0x1c
    _Bool _supportsBacklightEnvironment;	// 29 = 0x1d
...
+ (id)mainBundleInfoParser;	// IMP=0x00600000008b2595
- (void).cxx_destruct;	// IMP=0x00000000008b3c25
...
- (_Bool)_isLinkedOnOrAfterYukon;	// IMP=0x00000000008b3ab3
- (void)_computeSupportedUserInterfaceStyleFromInfo:(id)arg1;	// IMP=0x00000000008b39dc
- (void)_computeSupportedInterfaceOrientationsWithInfo:(id)arg1;	// IMP=0x00000000008b360a
- (id)_initWithApplicationPlistData:(id)arg1;	// IMP=0x00000000008b2934
- (id)initWithApplicationProxy:(id)arg1;	// IMP=0x00000000008b2690
- (id)_initWithBundle:(id)arg1;	// IMP=0x00000000008b263a
