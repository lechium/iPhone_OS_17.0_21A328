...
- (void).cxx_destruct;	// IMP=0x002000000019ed17
...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000019ebc0
- (unsigned long long)hash;	// IMP=0x001000000019eb0e
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000019e9cc
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000019e8bd
- (void)copyTo:(id)arg1;	// IMP=0x001000000019e7fa
- (void)writeTo:(id)arg1;	// IMP=0x001000000019e73d
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000019e730
- (id)dictionaryRepresentation;	// IMP=0x001000000019e383
- (id)description;	// IMP=0x001000000019e2d4
...
- (int)StringAsAttachmentType:(id)arg1;	// IMP=0x001000000019e145
- (id)attachmentTypeAsString:(int)arg1;	// IMP=0x001000000019e0fc
