...
+ (id)batchContextWithPhotoLibrary:(id)arg1 clusterer:(id)arg2 andContext:(id)arg3;	// IMP=0x004000000008feff
- (void).cxx_destruct;	// IMP=0x0020000000090742
...
- (_Bool)downloadTimedout;	// IMP=0x00100000000904d7
- (void)updateLastestDownloadTimestamp;	// IMP=0x00100000000903a3
- (void)storeResource:(id)arg1 resourceURL:(id)arg2 isBestResource:(_Bool)arg3 requestDownload:(_Bool)arg4 downloadStatus:(int)arg5 forLocalIdentifier:(id)arg6;	// IMP=0x0010000000090120
- (id)resourceForLocalIdentifier:(id)arg1;	// IMP=0x001000000008ffb0
- (id)initWithPhotoLibrary:(id)arg1 clusterer:(id)arg2 andContext:(id)arg3;	// IMP=0x001000000008fce0
