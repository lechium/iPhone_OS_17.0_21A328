...
@class FSMimic, LSDocumentProxy, NSArray, NSSet, NSString, _LSDiskUsage;

@protocol _LSDReadProtocol
- (void)getApplicationCategoryIdentifiersSetWithCompletionHandler:(void (^)(NSSet *, NSError *))arg1;
