...
+ (void)initialize;	// IMP=0x00600000011a3636
- (void).cxx_destruct;	// IMP=0x00000000011a4cf1
...
- (void)endCoalescingUpdatesForEntryKeys:(id)arg1;	// IMP=0x00000000011a4b23
- (void)beginCoalescingUpdatesForEntryKeys:(id)arg1 delay:(double)arg2;	// IMP=0x00000000011a4946
- (void)_coalescedUpdateForEntryKeys:(id)arg1;	// IMP=0x00000000011a4734
- (void)_updateForCoalescedKeysWithData:(id)arg1;	// IMP=0x00000000011a43b8
@property(readonly, copy, nonatomic) NSSet *delayedEntryKeys;
- (void)endDelayingUpdatesForEntryKeys:(id)arg1;	// IMP=0x00000000011a40be
- (void)beginDelayingUpdatesForEntryKeys:(id)arg1;	// IMP=0x00000000011a3f65
- (void)_updateForDelayedKeysWithData:(id)arg1;	// IMP=0x00000000011a3ebe
- (void)_updateForOverlayWithData:(id)arg1;	// IMP=0x00000000011a3e68
- (void)_updateFromPendingUpdatesForKeys:(id)arg1 block:(CDUnknownBlockType)arg2;	// IMP=0x00000000011a3af2
- (id)_updatedDataFromData:(id)arg1 delayedKeys:(id)arg2;	// IMP=0x00000000011a37e6
- (void)updateWithData:(id)arg1;	// IMP=0x00000000011a378b
- (id)initWithUpdateBlock:(CDUnknownBlockType)arg1;	// IMP=0x00000000011a367d
