...
@interface _TtC7NewsUI223TodayFeedScrollTestCase : NSObject
{
...
- (void).cxx_destruct;	// IMP=0x0000000000cec750
- (id)init;	// IMP=0x0000000000cec700
- (id)scrollViewWithContext:(id)arg1;	// IMP=0x0000000000cec5a0
