...
- (void).cxx_destruct;	// IMP=0x00000000009975ea
...
- (id)description;	// IMP=0x0000000000997502
- (id)initWithSnapshotCharacteristicEventUUID:(id)arg1 snapshotFile:(id)arg2 timer:(id)arg3;	// IMP=0x0000000000997438
