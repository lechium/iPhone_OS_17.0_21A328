...
+ (long long)activityCategory;	// IMP=0x0040000000660200
- (void).cxx_destruct;	// IMP=0x0000000000660a90
- (id)init;	// IMP=0x0000000000660a30
- (void)performActivity;	// IMP=0x0000000000660a00
- (void)prepareWithActivityItems:(id)arg1;	// IMP=0x0000000000660560
- (_Bool)canPerformWithActivityItems:(id)arg1;	// IMP=0x00000000006603f0
