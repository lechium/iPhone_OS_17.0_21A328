...
+ (id)searchCriterionForSenderAddresses:(id)arg1;	// IMP=0x002000000000a44b
- (void).cxx_destruct;	// IMP=0x002000000000afe9
...
- (void)search:(id)arg1 didFinishWithError:(id)arg2;	// IMP=0x001000000000ae24
- (_Bool)search:(id)arg1 didFindResults:(id)arg2;	// IMP=0x001000000000aace
- (id)nextOutgoingMessageBatch;	// IMP=0x001000000000a977
- (void)searchMailWithSenderAddresses:(id)arg1;	// IMP=0x001000000000a7c7
- (void)searchAccounts:(id)arg1;	// IMP=0x001000000000a24a
- (void)initializeSearchIfNecessary;	// IMP=0x0010000000009f6d
- (id)init;	// IMP=0x0010000000009f13
- (void)dealloc;	// IMP=0x0010000000009eb9
