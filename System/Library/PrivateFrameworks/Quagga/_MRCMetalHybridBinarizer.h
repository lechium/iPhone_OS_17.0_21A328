...
- (void).cxx_destruct;	// IMP=0x000000000005ad32
- (id)newTextureByBinarizingPixelBuffer:(struct __CVBuffer *)arg1 error:(id *)arg2;	// IMP=0x000000000005a4f8
- (id)initWithMetalContext:(id)arg1 error:(id *)arg2;	// IMP=0x000000000005a383
- (id)init;	// IMP=0x000000000005a36d
