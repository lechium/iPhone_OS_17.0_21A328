...
+ (id)decodedNamedLayerImageFromNamedLayerImage:(id)arg1;	// IMP=0x00100000000071de
+ (id)namedLayerImageFromNamedLayerImage:(id)arg1;	// IMP=0x001000000000716a
- (void).cxx_destruct;	// IMP=0x0000000000007604
...
- (id)imageObj;	// IMP=0x00000000000075b3
@property(nonatomic) _Bool fixedFrame;
@property(readonly, nonatomic) double opacity;
@property(readonly, nonatomic) struct CGRect frame;
@property(readonly, nonatomic) NSString *name;
- (id)_init;	// IMP=0x000000000000712f
- (id)init;	// IMP=0x0000000000007121
