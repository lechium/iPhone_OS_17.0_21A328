...
+ (id)memberWithTUConversationMember:(id)arg1;	// IMP=0x001000000007e258
- (void).cxx_destruct;	// IMP=0x00100000000fc23a
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000000fc03f
- (unsigned long long)hash;	// IMP=0x00100000000fbf42
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000fbdb0
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000fbc5f
- (void)copyTo:(id)arg1;	// IMP=0x00100000000fbb5b
- (void)writeTo:(id)arg1;	// IMP=0x00100000000fba55
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000000fba48
- (id)dictionaryRepresentation;	// IMP=0x00100000000fb3c0
- (id)description;	// IMP=0x00100000000fb311
@property(readonly, nonatomic) _Bool hasAssociationVoucher;
- (int)StringAsValidationSource:(id)arg1;	// IMP=0x00100000000fb265
- (id)validationSourceAsString:(int)arg1;	// IMP=0x00100000000fb21c
...
- (id)description;	// IMP=0x001000000007e7a3
