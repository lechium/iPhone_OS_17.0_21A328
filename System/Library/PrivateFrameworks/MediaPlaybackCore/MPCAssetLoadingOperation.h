...
- (void).cxx_destruct;	// IMP=0x00000000001acb55
...
- (_Bool)_configureItem:(id)arg1 error:(id *)arg2;	// IMP=0x00000000001ac5ed
- (void)main;	// IMP=0x00000000001abda2
- (_Bool)isFinished;	// IMP=0x00000000001abd92
- (_Bool)isExecuting;	// IMP=0x00000000001abd82
- (void)start;	// IMP=0x00000000001abb74
- (id)initWithPlayerItem:(id)arg1 configurator:(id)arg2 delegate:(id)arg3 token:(long long)arg4 callbackQueue:(id)arg5 completion:(CDUnknownBlockType)arg6;	// IMP=0x00000000001ab9ba
