...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000153b904
- (void).cxx_destruct;	// IMP=0x000000000153b981
...
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000153b69b
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000153b4ef
