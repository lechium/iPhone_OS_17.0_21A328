...
- (void).cxx_destruct;	// IMP=0x00000000001c04fc
@property(nonatomic) __weak MKMapView *mapView; // @synthesize mapView=_mapView;
- (_Bool)updateCalloutViewIfNeededAnimated:(_Bool)arg1;	// IMP=0x00000000001bfc6f
- (long long)_baseImageType;	// IMP=0x00000000001bfbad
- (void)_addAnchorDotView;	// IMP=0x00000000001bfa1a
...
- (_Bool)_isMetroArea;	// IMP=0x00000000001bf990
- (void)traitEnvironment:(id)arg1 didChangeTraitCollection:(id)arg2;	// IMP=0x00000000001bf87a
- (void)_resolveBalloonAttributes;	// IMP=0x00000000001bf465
- (void)_updateAnchorOffset;	// IMP=0x00000000001bf3b3
- (void)_updateFromMap;	// IMP=0x00000000001bf309
- (void)setAnnotation:(id)arg1;	// IMP=0x00000000001bf2cd
- (_Bool)shouldShowCallout;	// IMP=0x00000000001bf285
- (id)initWithAnnotation:(id)arg1 reuseIdentifier:(id)arg2;	// IMP=0x00000000001bf198
