...
- (void).cxx_destruct;	// IMP=0x00000000003529e0
...
- (void)_applyNewContentInset:(struct UIEdgeInsets)arg1 withOldContentInset:(struct UIEdgeInsets)arg2 toContentScrollView:(id)arg3;	// IMP=0x00000000003527a1
- (void)updateAppliedContentInsetsAdjustment;	// IMP=0x0000000000352655
- (void)applyNewContentInset:(struct UIEdgeInsets)arg1;	// IMP=0x0000000000352605
- (id)initWithViewController:(id)arg1;	// IMP=0x0000000000352544
- (id)init;	// IMP=0x0000000000352530
