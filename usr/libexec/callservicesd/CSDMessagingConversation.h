...
+ (Class)activeLightweightParticipantsType;	// IMP=0x00200000000fc8a7
+ (Class)lightweightMembersType;	// IMP=0x00100000000fc7d5
+ (Class)otherInvitedHandlesType;	// IMP=0x00100000000fc703
+ (Class)activitySessionsType;	// IMP=0x00100000000fc5f2
+ (Class)activeRemoteParticipantsType;	// IMP=0x00100000000fc520
+ (Class)remoteMembersType;	// IMP=0x00100000000fc44e
- (void).cxx_destruct;	// IMP=0x00100000001006c3
...
// Error: Property attributes should begin with the type ('T') attribute, property name: highlightIdentifier
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000000ffc29
- (unsigned long long)hash;	// IMP=0x00100000000ff9d8
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000ff620
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000fec2e
- (void)copyTo:(id)arg1;	// IMP=0x00100000000fe70f
- (void)writeTo:(id)arg1;	// IMP=0x00100000000fdffd
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000000fdff0
- (id)dictionaryRepresentation;	// IMP=0x00100000000fcad5
- (id)description;	// IMP=0x00100000000fca26
- (int)StringAsAvMode:(id)arg1;	// IMP=0x00100000000fc98f
- (id)avModeAsString:(int)arg1;	// IMP=0x00100000000fc946
...
- (id)activeLightweightParticipantsAtIndex:(unsigned long long)arg1;	// IMP=0x00100000000fc88a
- (unsigned long long)activeLightweightParticipantsCount;	// IMP=0x00100000000fc86d
- (void)addActiveLightweightParticipants:(id)arg1;	// IMP=0x00100000000fc803
- (void)clearActiveLightweightParticipants;	// IMP=0x00100000000fc7e6
- (id)lightweightMembersAtIndex:(unsigned long long)arg1;	// IMP=0x00100000000fc7b8
- (unsigned long long)lightweightMembersCount;	// IMP=0x00100000000fc79b
- (void)addLightweightMembers:(id)arg1;	// IMP=0x00100000000fc731
- (void)clearLightweightMembers;	// IMP=0x00100000000fc714
- (id)otherInvitedHandlesAtIndex:(unsigned long long)arg1;	// IMP=0x00100000000fc6e6
- (unsigned long long)otherInvitedHandlesCount;	// IMP=0x00100000000fc6c9
- (void)addOtherInvitedHandles:(id)arg1;	// IMP=0x00100000000fc65f
- (void)clearOtherInvitedHandles;	// IMP=0x00100000000fc642
...
- (id)activitySessionsAtIndex:(unsigned long long)arg1;	// IMP=0x00100000000fc5d5
- (unsigned long long)activitySessionsCount;	// IMP=0x00100000000fc5b8
- (void)addActivitySessions:(id)arg1;	// IMP=0x00100000000fc54e
- (void)clearActivitySessions;	// IMP=0x00100000000fc531
- (id)activeRemoteParticipantsAtIndex:(unsigned long long)arg1;	// IMP=0x00100000000fc503
- (unsigned long long)activeRemoteParticipantsCount;	// IMP=0x00100000000fc4e6
- (void)addActiveRemoteParticipants:(id)arg1;	// IMP=0x00100000000fc47c
- (void)clearActiveRemoteParticipants;	// IMP=0x00100000000fc45f
- (id)remoteMembersAtIndex:(unsigned long long)arg1;	// IMP=0x00100000000fc431
- (unsigned long long)remoteMembersCount;	// IMP=0x00100000000fc414
- (void)addRemoteMembers:(id)arg1;	// IMP=0x00100000000fc3aa
- (void)clearRemoteMembers;	// IMP=0x00100000000fc38d
