...
- (void).cxx_destruct;	// IMP=0x00000000000dcd74
- (void)submitWithHandler:(CDUnknownBlockType)arg1 queue:(id)arg2;	// IMP=0x00000000000dca5f
- (void)cancel;	// IMP=0x00000000000dca49
@property(readonly, nonatomic) GEOMapRegion *boundingRegion;
- (id)traits;	// IMP=0x00000000000dca25
- (id)initWithTicket:(id)arg1;	// IMP=0x00000000000dc9ba
