...
+ (_Bool)fakeResponseForHandle:(id)arg1;	// IMP=0x001000000019d90b
+ (id)sharedWorkQueue;	// IMP=0x001000000019d8db
- (void).cxx_destruct;	// IMP=0x000000000019cd15
...
- (void)_requestStatusOnMainQueue:(_Bool)arg1;	// IMP=0x000000000019c758
- (void)idStatusUpdatedForDestinations:(id)arg1 service:(id)arg2;	// IMP=0x000000000019c68e
@property(readonly, nonatomic) _Bool cancelled;
- (void)cancel;	// IMP=0x000000000019c5bc
- (void)cleanupDelegate;	// IMP=0x000000000019c517
- (id)initWithPropertyItems:(id)arg1 service:(id)arg2 postToMainQueue:(_Bool)arg3 resultBlock:(CDUnknownBlockType)arg4;	// IMP=0x000000000019c386
