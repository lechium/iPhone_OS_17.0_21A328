...
- (void).cxx_destruct;	// IMP=0x002000000012f401
...
- (void)_emitMHEndpointLatencyInfo:(id)arg1 withRequestMHUUID:(id)arg2;	// IMP=0x001000000012f358
- (void)report;	// IMP=0x001000000012f0c0
- (void)addPktInfoWithTimestamp:(unsigned long long)arg1 arrivalTimestamp:(unsigned long long)arg2 currentMachTime:(unsigned long long)arg3;	// IMP=0x001000000012ee12
- (id)initWithRequestMHUUID:(id)arg1;	// IMP=0x001000000012ed26
