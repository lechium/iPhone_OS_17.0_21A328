...
+ (id)fetchRequest;	// IMP=0x0040000000042220
- (id)getBookWidgetInfoObject;	// IMP=0x0020000000042240
- (id)initIntoManagedObjectContext:(id)arg1;	// IMP=0x0010000000042189
...
// Error: Property attributes should begin with the type ('T') attribute, property name: isExplicit
