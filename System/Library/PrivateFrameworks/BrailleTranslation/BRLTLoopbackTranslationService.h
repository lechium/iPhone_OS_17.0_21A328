...
- (void).cxx_destruct;	// IMP=0x000000000000690f
@property(retain, nonatomic) BRLTSLoopbackTranslationService *loopbackService; // @synthesize loopbackService=_loopbackService;
- (_Bool)isLoopback;	// IMP=0x00000000000068e2
- (id)initWithServiceIdentifier:(id)arg1 connection:(id)arg2 loopbackService:(id)arg3;	// IMP=0x0000000000006860
