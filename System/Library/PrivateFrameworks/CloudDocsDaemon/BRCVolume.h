...
- (_Bool)setUpForRelPath:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000008381
@property(readonly, nonatomic) NSNumber *totalSize;
@property(readonly, nonatomic) NSNumber *freeSize;
- (id)description;	// IMP=0x0000000000008146
@property(readonly, nonatomic) NSString *fsTypeName;
- (int)_setUpForStatfs:(struct statfs)arg1;	// IMP=0x0000000000008019
