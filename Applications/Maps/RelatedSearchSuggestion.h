...
- (void).cxx_destruct;	// IMP=0x0020000000a517ad
...
- (void)_parseComponents;	// IMP=0x0010000000a51191
@property(readonly, nonatomic) NSString *displayString;
- (void)_parseSubtitutes;	// IMP=0x0010000000a50d7a
- (id)initWithResultDisplayHeader:(id)arg1 substitutes:(id)arg2 visibleTime:(double)arg3 showCloseButton:(_Bool)arg4;	// IMP=0x0010000000a50c91
