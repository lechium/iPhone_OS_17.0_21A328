...
- (void).cxx_destruct;	// IMP=0x0000000000dbe996
@property(nonatomic) __weak id <_GEONetworkDefaultsServerProxyDelegate> delegate; // @synthesize delegate=_delegate;
- (void)updateNetworkDefaultsWithReason:(unsigned long long)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000dbe337
- (void)updateNetworkDefaults:(CDUnknownBlockType)arg1;	// IMP=0x0000000000dbe31d
- (void)_networkDefaultsDidChange;	// IMP=0x0000000000dbe243
- (void)dealloc;	// IMP=0x0000000000dbe20a
- (id)init;	// IMP=0x0000000000dbe0c8
