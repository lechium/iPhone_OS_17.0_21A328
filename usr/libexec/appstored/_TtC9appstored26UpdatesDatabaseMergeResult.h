...
- (void).cxx_destruct;	// IMP=0x004000000000ec00
- (id)init;	// IMP=0x001000000000eba0
- (id)initWithAvailableUpdateCount:(long long)arg1 shouldNotifyOfChanges:(_Bool)arg2 bundleIDs:(id)arg3 result:(_Bool)arg4;	// IMP=0x001000000000eb20
