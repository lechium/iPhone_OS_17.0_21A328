...
- (void).cxx_destruct;	// IMP=0x0000000000148a1c
...
- (void)_removeOverlay;	// IMP=0x000000000014894b
- (void)_reloadHighlight;	// IMP=0x00000000001486bf
- (void)layoutSubviews;	// IMP=0x0000000000148512
- (void)setBackgroundColor:(id)arg1;	// IMP=0x0000000000148448
@property(copy, nonatomic) NSString *title;
@property(retain, nonatomic) UIImage *itemImage;
- (void)setSelected:(_Bool)arg1;	// IMP=0x0000000000147dbf
- (void)setHighlighted:(_Bool)arg1;	// IMP=0x0000000000147d30
@property(retain, nonatomic) SKUICountdown *countdown;
- (void)setColoringWithColorScheme:(id)arg1;	// IMP=0x0000000000147ab9
