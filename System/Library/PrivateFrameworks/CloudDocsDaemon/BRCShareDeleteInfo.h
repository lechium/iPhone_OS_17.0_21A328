...
- (void).cxx_destruct;	// IMP=0x00000000002857f7
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000285755
- (unsigned long long)hash;	// IMP=0x000000000028573f
- (id)initWithShareID:(id)arg1 emptyRecord:(id)arg2;	// IMP=0x00000000002856a6
