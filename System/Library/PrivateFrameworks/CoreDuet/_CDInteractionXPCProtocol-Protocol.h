...
- (void)autocompleteSearchResultsWithPredictionContext:(_PSPredictionContext *)arg1 reply:(void (^)(NSArray *))arg2;
...
- (void)photosContactInferencesSuggestionsWithPredictionContext:(_PSPredictionContext *)arg1 reply:(void (^)(NSArray *))arg2;
- (void)photosRelationshipSuggestionsWithPredictionContext:(_PSPredictionContext *)arg1 reply:(void (^)(NSArray *))arg2;
- (void)familyRecommendedSuggestionsWithPredictionContext:(_PSPredictionContext *)arg1 reply:(void (^)(NSArray *))arg2;
