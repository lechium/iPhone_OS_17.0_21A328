...
- (void).cxx_destruct;	// IMP=0x00000000014d4a71
...
- (struct CGImage *)newCaptureSnapshotAtRect:(struct CGRect)arg1 window:(id)arg2;	// IMP=0x00000000014d423e
- (void)dealloc;	// IMP=0x00000000014d41f8
- (id)drawViewLinesAtPoint:(struct CGPoint)arg1 forView:(id)arg2;	// IMP=0x00000000014d3e9a
- (id)drawLinesAtPoint:(struct CGPoint)arg1;	// IMP=0x00000000014d34f5
- (void)toggleMeasuring:(id)arg1;	// IMP=0x00000000014d342c
- (void)updateGesture:(id)arg1;	// IMP=0x00000000014d2e5b
- (void)viewWillDisappear:(_Bool)arg1;	// IMP=0x00000000014d2db3
- (void)viewDidAppear:(_Bool)arg1;	// IMP=0x00000000014d2b00
- (void)toggleDirection:(id)arg1;	// IMP=0x00000000014d2984
- (void)toggleMode:(id)arg1;	// IMP=0x00000000014d2891
- (void)viewDidLoad;	// IMP=0x00000000014d1d85
- (id)initWithNibName:(id)arg1 bundle:(id)arg2;	// IMP=0x00000000014d1ccd
