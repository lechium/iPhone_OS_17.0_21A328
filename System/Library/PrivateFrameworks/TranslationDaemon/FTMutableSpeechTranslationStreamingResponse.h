...
+ (long long)content_typeForObject:(id)arg1;	// IMP=0x0060000000196034
+ (long long)content_typeForMutableObject:(id)arg1;	// IMP=0x0060000000195e0c
+ (Class)content_mutableClassForType:(long long)arg1;	// IMP=0x0060000000195dd2
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000194faf
- (id)init;	// IMP=0x0000000000194f21
