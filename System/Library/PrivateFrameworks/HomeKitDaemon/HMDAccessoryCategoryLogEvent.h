...
+ (id)denominatorSpecifyingEvent;	// IMP=0x00100000003fe420
- (void).cxx_destruct;	// IMP=0x00000000003fe40d
...
- (id)submitEventWithHistogrammedHomeDataCommonDimensionsForSpecifiedHome;	// IMP=0x00000000003fe3c7
...
- (id)initWithAccessoryDetailsType:(unsigned long long)arg1 accessoryCategoryIdentifier:(id)arg2 homeUUID:(id)arg3;	// IMP=0x00000000003fe108
