...
- (void).cxx_destruct;	// IMP=0x0000000000201081
...
- (_Bool)matchesElementStack:(id)arg1;	// IMP=0x0000000000200f44
- (id)initWithSpecificationString:(id)arg1;	// IMP=0x0000000000200cc0
