...
@interface _TtC7NewsUI225HistoryFeedScrollTestCase : NSObject
{
...
- (void).cxx_destruct;	// IMP=0x0000000000b89970
- (id)init;	// IMP=0x0000000000b89920
- (id)scrollViewWithContext:(id)arg1;	// IMP=0x0000000000b897c0
