...
- (void).cxx_destruct;	// IMP=0x000000000012deae
@property(copy, nonatomic) CDUnknownBlockType actionHandler; // @synthesize actionHandler=_actionHandler;
@property(readonly, nonatomic) MUHoursSummaryViewModel *viewModel; // @synthesize viewModel=_viewModel;
- (void)_contentSizeDidChange;	// IMP=0x000000000012de69
- (void)_updateAppearance;	// IMP=0x000000000012dcc0
- (void)_handleServiceHoursAnimation;	// IMP=0x000000000012dbe5
- (void)_handleNormalHoursAnimation;	// IMP=0x000000000012db4e
- (void)handleAnimation;	// IMP=0x000000000012db05
- (void)_handleAnimationStartForNormalHours;	// IMP=0x000000000012dad8
- (void)handleAnimationStart;	// IMP=0x000000000012da96
- (void)_updateExpandButton;	// IMP=0x000000000012d986
- (void)expandButtonTapped;	// IMP=0x000000000012d8f9
- (void)_updateForPlatterAvailability;	// IMP=0x000000000012d8f3
- (void)_setupConstraints;	// IMP=0x000000000012ce6d
- (void)_setupSubviews;	// IMP=0x000000000012c8d0
- (id)initWithViewModel:(id)arg1;	// IMP=0x000000000012c7fd
