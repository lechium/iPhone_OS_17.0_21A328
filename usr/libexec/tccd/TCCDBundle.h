...
+ (id)bundleWithIdentifier:(id)arg1;	// IMP=0x00400000000376ed
+ (id)bundleWithURL:(id)arg1;	// IMP=0x00100000000376a0
- (_Bool)isPathContainedWithin:(id)arg1;	// IMP=0x0020000000037f0f
- (_Bool)isPathTheMainExecutable:(id)arg1;	// IMP=0x0010000000037e13
...
- (id)localizedUsageDescriptionForKey:(id)arg1;	// IMP=0x0010000000037c2b
...
- (id)description;	// IMP=0x00100000000377ae
@property(readonly) NSURL *bundleURL;
@property(readonly) NSString *bundlePath;
@property(readonly) NSString *bundleIdentifier;
- (void)dealloc;	// IMP=0x0010000000037661
- (id)initWithIdentifier:(id)arg1;	// IMP=0x0010000000037547
- (id)initWithURL:(id)arg1;	// IMP=0x001000000003747d
