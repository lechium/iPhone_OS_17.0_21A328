...
- (void)invalidate;	// IMP=0x0000000000287fe6
- (id)value;	// IMP=0x0000000000287e3a
- (void)p_setValue:(id)arg1;	// IMP=0x0000000000287d6b
- (void)dealloc;	// IMP=0x0000000000287d0c
- (id)initForReentrant:(_Bool)arg1 withGenerator:(CDUnknownBlockType)arg2;	// IMP=0x0000000000287c8c
