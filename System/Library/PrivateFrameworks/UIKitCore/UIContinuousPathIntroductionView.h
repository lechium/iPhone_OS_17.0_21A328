...
- (void).cxx_destruct;	// IMP=0x00000000000b129c
...
- (void)extraButtonTapAction;	// IMP=0x00000000000b1075
- (void)removeFromSuperview;	// IMP=0x00000000000b100f
- (long long)textBodyMaxLines;	// IMP=0x00000000000b1004
- (double)mediaLayoutWidthAdjustment;	// IMP=0x00000000000b0f49
- (id)textBodyDescriptions;	// IMP=0x00000000000b0e5d
- (id)textTitleDescriptions;	// IMP=0x00000000000b0e50
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x00000000000b0a40
- (void)updateVideoLayerWithNewVideo:(_Bool)arg1;	// IMP=0x00000000000b0421
- (id)mediaContents;	// IMP=0x00000000000aec56
- (id)_introductionMovieAssetURL;	// IMP=0x00000000000aeb9a
- (void)setupConstraintData;	// IMP=0x00000000000ae898
- (id)initWithKeyboardAppearance:(long long)arg1;	// IMP=0x00000000000ae751
