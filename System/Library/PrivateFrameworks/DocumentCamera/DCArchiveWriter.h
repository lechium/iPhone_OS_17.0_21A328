...
- (void).cxx_destruct;	// IMP=0x000000000004a2dc
...
- (_Bool)writeURL:(id)arg1 isDirectory:(_Bool)arg2 error:(id *)arg3;	// IMP=0x0000000000049b20
- (_Bool)open:(id *)arg1;	// IMP=0x00000000000498e8
- (_Bool)finish:(id *)arg1;	// IMP=0x000000000004977b
- (_Bool)writeURLs:(id)arg1 error:(id *)arg2;	// IMP=0x000000000004932a
- (void)dealloc;	// IMP=0x00000000000492e0
- (id)initWithDestinationURL:(id)arg1 baseURL:(id)arg2;	// IMP=0x0000000000049207
