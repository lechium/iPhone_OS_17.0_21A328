...
- (void).cxx_destruct;	// IMP=0x0020000000635435
...
- (long long);	// IMP=0x00100000006353d3
...
- (struct CGSize)intrinsicContentSize;	// IMP=0x0010000000634e38
- (void)disallowMutation;	// IMP=0x0010000000634cf8
@property(readonly, nonatomic) int displayManeuver;
- (id)_imageWithManeuverType:(int)arg1 inRect:(struct CGRect)arg2;	// IMP=0x00100000006349c3
- (void)_invalidateDrawingPaths;	// IMP=0x0010000000634995
- (void)_drawProceedToRoute;	// IMP=0x001000000063446b
- (void)_drawArrival;	// IMP=0x0010000000633f41
- (void)_drawDefaultPaths;	// IMP=0x0010000000633e87
- (void)_drawManeuverImage;	// IMP=0x0010000000633e10
- (void)drawRect:(struct CGRect)arg1;	// IMP=0x0010000000633d46
- (void)_updateDrawingPathsFromJunction;	// IMP=0x0010000000633b0d
- (void)_updateDrawingPathsForProceedToRoute;	// IMP=0x0010000000633849
- (void)_updateDrawingPathsForArrival;	// IMP=0x00100000006334d6
- (_Bool)_maneuverTypeRequiresDrawingPaths:(int)arg1;	// IMP=0x00100000006334b4
- (void)_updateDrawingPaths;	// IMP=0x0010000000632cb6
- (void)_updateManeuverArtworkImageIfNeeded;	// IMP=0x0010000000632751
- (void)_updateManeuverImage;	// IMP=0x001000000063263a
- (void)drawArrow:(id)arg1 stroke:(id)arg2 withVisibleWidth:(double)arg3 intersectionFillPath:(id)arg4 intersectionStrokePath:(id)arg5 referenceSize:(struct CGSize)arg6;	// IMP=0x001000000063208b
- (struct CGAffineTransform)transformForDrawingPathsWithFrame:(struct CGRect)arg1 relativeToReferenceSize:(struct CGSize)arg2;	// IMP=0x0010000000631e8b
- (void)drawArrow:(id)arg1 stroke:(id)arg2;	// IMP=0x0010000000631d76
- (void)drawIntersectionStroke:(id)arg1 forFill:(id)arg2;	// IMP=0x0010000000631c79
- (void)drawIntersectionFill:(id)arg1;	// IMP=0x0010000000631bfc
@property(readonly, nonatomic) _Bool _maneuverIsDrawnByDrawRect;
- (id)accessibilityIdentifier;	// IMP=0x00100000006319ed
- (id)initWithFrame:(struct CGRect)arg1 textureProvider:(id)arg2;	// IMP=0x00100000006317f2
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00100000006317de
