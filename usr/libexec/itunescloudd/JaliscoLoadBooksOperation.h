...
- (void).cxx_destruct;	// IMP=0x00200000000cef10
...
- (id)metadataFilter;	// IMP=0x00100000000cee86
- (id)queryFilter;	// IMP=0x00100000000cee19
- (id)_queryFilterEncodedStringForDAAPNameString:(id)arg1;	// IMP=0x00100000000cedf6
- (void)main;	// IMP=0x00100000000ce73a
