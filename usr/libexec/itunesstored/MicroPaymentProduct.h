...
+ (id)periodFromISO8601String:(id)arg1;	// IMP=0x004000000006424b
...
- (id)copyProduct;	// IMP=0x0010000000063e53
- (void)dealloc;	// IMP=0x0010000000063dd1
- (id)initWithDictionary:(id)arg1;	// IMP=0x00100000000636e9
