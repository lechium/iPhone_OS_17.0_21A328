...
- (void).cxx_destruct;	// IMP=0x002000000006a910
...
- (void)shutdownStream;	// IMP=0x001000000006a652
- (void)shutdownTimerFired:(id)arg1;	// IMP=0x001000000006a58e
- (void)stream:(id)arg1 handleEvent:(unsigned long long)arg2;	// IMP=0x0010000000069de9
- (id)headerForData:(id)arg1;	// IMP=0x0010000000069d21
- (void)sendTypes:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0010000000069973
- (id)initWithOutputStream:(id)arg1 inputStream:(id)arg2 pasteboard:(id)arg3;	// IMP=0x00100000000697d9
