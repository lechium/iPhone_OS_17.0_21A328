...
- (void).cxx_destruct;	// IMP=0x00000000003dd731
...
- (void)run;	// IMP=0x00000000003dd34a
- (id)initWithAdjustmentNode:(id)arg1 baseMediaNode:(id)arg2 currentImageNode:(id)arg3 currentVideoNode:(id)arg4 completionHandler:(CDUnknownBlockType)arg5;	// IMP=0x00000000003dd1a6
