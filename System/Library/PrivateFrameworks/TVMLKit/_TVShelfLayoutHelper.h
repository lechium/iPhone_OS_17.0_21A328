...
- (void).cxx_destruct;	// IMP=0x00000000000625d9
...
- (void)_freeBuffers;	// IMP=0x0000000000062525
- (void)_compute;	// IMP=0x000000000006181c
- (struct CGRect)frameForItemAtIndexPath:(id)arg1;	// IMP=0x0000000000061780
- (struct UIEdgeInsets)insetForSection:(long long)arg1;	// IMP=0x0000000000061745
- (struct CGRect)frameForHeaderInSection:(long long)arg1;	// IMP=0x000000000006170a
- (void)dealloc;	// IMP=0x00000000000616cc
- (id)initWithShelfViewLayout:(id)arg1;	// IMP=0x0000000000061658
