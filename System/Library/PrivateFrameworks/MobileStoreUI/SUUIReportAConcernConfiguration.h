...
@interface SUUIReportAConcernConfiguration : NSObject
{
...
+ (id)configurationWithTemplateElement:(id)arg1;	// IMP=0x0010000000018314
- (void).cxx_destruct;	// IMP=0x00000000000189d5
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000187b9
