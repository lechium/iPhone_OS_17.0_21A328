...
- (void).cxx_destruct;	// IMP=0x000000000022b19e
...
- (id)mainReturningError;	// IMP=0x000000000022af40
- (id)initWithGroup:(id)arg1 fetchResult:(CDUnknownBlockType)arg2;	// IMP=0x000000000022ae84
