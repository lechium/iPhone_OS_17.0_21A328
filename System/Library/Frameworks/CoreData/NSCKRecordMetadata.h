...
+ (id)recordFromEncodedData:(id)arg1 error:(id *)arg2;	// IMP=0x004000000004e283
+ (id)encodeRecord:(id)arg1 error:(id *)arg2;	// IMP=0x004000000004e0f3
+ (id)insertMetadataForObject:(id)arg1 setRecordName:(_Bool)arg2 inZoneWithID:(id)arg3 recordNamePrefix:(id)arg4 error:(id *)arg5;	// IMP=0x004000000004bac0
+ (id)entityPath;	// IMP=0x0040000000048802
- (_Bool)mergeMoveReceiptsWithData:(id)arg1 error:(id *)arg2;	// IMP=0x000000000004da77
- (id)createEncodedMoveReceiptData:(id *)arg1;	// IMP=0x000000000004d8b7
- (id)createRecordFromSystemFields;	// IMP=0x00000000000489dd
