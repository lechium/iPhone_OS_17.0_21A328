...
- (void).cxx_destruct;	// IMP=0x000000000070ffd1
- (unsigned long long)hash;	// IMP=0x000000000070fefb
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000070fd7b
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000070f5ac
- (void)writeTo:(id)arg1;	// IMP=0x000000000070ed64
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000070ed57
- (id)jsonRepresentation;	// IMP=0x000000000070eaeb
- (id)dictionaryRepresentation;	// IMP=0x000000000070e1ab
- (id)description;	// IMP=0x000000000070e0fc
- (id)initWithData:(id)arg1;	// IMP=0x000000000070cc50
- (id)init;	// IMP=0x000000000070cbf4
