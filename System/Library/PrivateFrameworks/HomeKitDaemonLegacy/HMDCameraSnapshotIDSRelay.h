...
+ (id)logCategory;	// IMP=0x001000000073b0ff
- (void).cxx_destruct;	// IMP=0x000000000073b09b
...
- (void)dealloc;	// IMP=0x000000000073af0f
- (id)initWithSessionID:(id)arg1 logIdentifier:(id)arg2 workQueue:(id)arg3;	// IMP=0x000000000073ad7e
