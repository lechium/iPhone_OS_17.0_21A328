...
- (void).cxx_destruct;	// IMP=0x002000000002b3fa
...
- (id)recoverTaskFromLimitExceededError;	// IMP=0x001000000002b31c
- (id)recoverTaskFromPartialError;	// IMP=0x001000000002af1e
@property(readonly, nonatomic) NSArray *recoverableTasks;
- (id)initWithOriginalTask:(id)arg1 savedGroups:(id)arg2 savedTracks:(id)arg3 deletedIDs:(id)arg4 error:(id)arg5;	// IMP=0x001000000002ac6a
