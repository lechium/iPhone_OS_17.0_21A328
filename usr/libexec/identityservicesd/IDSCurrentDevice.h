...
+ (id)sharedInstance;	// IMP=0x004000000030133c
- (void).cxx_destruct;	// IMP=0x00200000003016f5
- (void)regenerateDeviceIdentifier;	// IMP=0x00100000003015d4
@property(readonly, retain, nonatomic) NSString *deviceIdentifier;
- (id)_deviceIdentifierKeychainID;	// IMP=0x0010000000301405
...
- (id)init;	// IMP=0x0010000000301391
