...
- (void).cxx_destruct;	// IMP=0x00200000003406a0
...
- (id)description;	// IMP=0x001000000033fb99
- (unsigned long long)requestLength;	// IMP=0x001000000033f8b0
- (unsigned long long)_recipientDataSize;	// IMP=0x001000000033efa9
- (void)handleResponseDictionary:(id)arg1;	// IMP=0x001000000033efa3
- (_Bool)wantsAPSRetries;	// IMP=0x001000000033ef9b
- (id)messageBody;	// IMP=0x001000000033e668
- (id)requiredKeys;	// IMP=0x001000000033e5bd
- (long long)responseCommand;	// IMP=0x001000000033e5b2
- (long long)command;	// IMP=0x001000000033e5a7
- (_Bool)wantsIntegerUniqueIDs;	// IMP=0x001000000033e59f
- (_Bool)wantsBinaryPush;	// IMP=0x001000000033e597
- (_Bool)wantsCompressedBody;	// IMP=0x001000000033e58f
- (_Bool)wantsHTTPHeaders;	// IMP=0x001000000033e587
- (_Bool)wantsBagKey;	// IMP=0x001000000033e57f
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000033dd14
- (id)initWithDictionary:(id)arg1;	// IMP=0x001000000033638c
- (id)init:(id)arg1;	// IMP=0x001000000033620e
