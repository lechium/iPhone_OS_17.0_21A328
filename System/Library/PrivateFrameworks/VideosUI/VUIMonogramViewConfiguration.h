...
- (void).cxx_destruct;	// IMP=0x0000000000195f6a
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000195c9b
- (id)focusedShadowImage;	// IMP=0x0000000000195bef
- (id)unfocusedShadowImage;	// IMP=0x0000000000195b43
- (id)initWithShadowImages:(_Bool)arg1;	// IMP=0x0000000000195ae6
- (id)initWithStyle:(long long)arg1;	// IMP=0x0000000000195848
