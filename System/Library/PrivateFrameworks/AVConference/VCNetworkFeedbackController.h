...
- (void)cleanupWRMClient;	// IMP=0x00000000001b1522
- (void)setupWRMClientWithMetricsConfig:(CDStruct_21a0265e)arg1;	// IMP=0x00000000001b13cb
- (void)cleanupWCMClient;	// IMP=0x00000000001b13c5
- (void)setupWCMClient;	// IMP=0x00000000001b13bf
- (void)wcmGetCallConfig:(unsigned int *)arg1 targetBitrate:(unsigned int *)arg2;	// IMP=0x00000000001b12a6
- (void)wcmSetCallConfig:(unsigned int)arg1 interferenceLevel:(unsigned int)arg2;	// IMP=0x00000000001b115e
- (void)setPreWarmState:(_Bool)arg1;	// IMP=0x00000000001b111f
- (void)setWRMCoexMetrics:(id)arg1;	// IMP=0x00000000001b100e
- (void)setWRMNotification:(CDStruct_cd8cfafa *)arg1;	// IMP=0x00000000001b0ed6
- (void)setWRMMetricConfig:(CDStruct_69d7cc99 *)arg1;	// IMP=0x00000000001b0e70
- (void)reportWRMMetrics:(const CDStruct_dea828ac *)arg1;	// IMP=0x00000000001b0e4f
- (void)reportImmediateWRMMetric:(int)arg1 value:(unsigned long long)arg2;	// IMP=0x00000000001b0e2e
- (void)requestWRMNotification;	// IMP=0x00000000001b0d5b
- (void)sendStatusUpdate:(const CDStruct_8aeecdac *)arg1;	// IMP=0x00000000001b0d45
- (void)sendFeedbackControllerReport:(CDStruct_4b4d87a1)arg1;	// IMP=0x00000000001b0c54
- (void)cleanupWRMData;	// IMP=0x00000000001b0c18
- (void)setRSSIThresholdEnabled:(_Bool)arg1;	// IMP=0x00000000001b0c02
- (void)updateMetricsConfig:(CDStruct_21a0265e)arg1;	// IMP=0x00000000001b0bec
@property(readonly) unsigned int recommendedTargetBitrateCap;
- (id)strongDelegate;	// IMP=0x00000000001b0b98
- (void)stop;	// IMP=0x00000000001b0a7c
- (void)startWithMetricsConfig:(CDStruct_21a0265e)arg1;	// IMP=0x00000000001b0966
- (void)initializeWRMInfo;	// IMP=0x00000000001b082f
- (void)dealloc;	// IMP=0x00000000001b0799
- (id)initWithDelegate:(id)arg1 connectionManager:(id)arg2;	// IMP=0x00000000001b0700
