...
@class HSProxCardCoordinator, HSSetupStateMachineConfiguration, NSString, UIView, UIViewController;
...
- (void).cxx_destruct;	// IMP=0x00200000000021e8
...
- (id)commitConfiguration;	// IMP=0x0010000000002155
@property(readonly, nonatomic) id <HFIconDescriptor> iconDescriptor;
- (void)viewDidLoad;	// IMP=0x0010000000001ffa
- (id)initWithCoordinator:(id)arg1 config:(id)arg2 iconView:(id)arg3;	// IMP=0x0010000000001f30
- (id)initWithCoordinator:(id)arg1 config:(id)arg2;	// IMP=0x0010000000001e68
