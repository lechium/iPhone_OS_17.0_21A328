...
- (unsigned long long)constantOffsetAtIndex:(unsigned long long)arg1;	// IMP=0x0000000000001176
- (unsigned long long)alignment;	// IMP=0x0000000000001165
- (unsigned long long)encodedLength;	// IMP=0x0000000000001154
- (_Bool)bufferLayoutMatchesFrontEndLayout;	// IMP=0x0000000000001144
- (void)dealloc;	// IMP=0x000000000000106f
- (id)initWithDevice:(id)arg1 reference:(unsigned int)arg2 data:(CDStruct_146dae35 *)arg3;	// IMP=0x0000000000000fd0
