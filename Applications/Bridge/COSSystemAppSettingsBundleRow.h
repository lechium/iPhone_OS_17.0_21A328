...
- (void).cxx_destruct;	// IMP=0x002000000013085e
...
- (id)description;	// IMP=0x00100000001306a5
- (_Bool)_requiredAppsInstalled:(id)arg1;	// IMP=0x0010000000130388
- (_Bool)_removeRowForSpecialCriteriaOverride:(id)arg1;	// IMP=0x00100000001302d8
- (void)setAreRequiredWatchAppsInstalled:(id)arg1;	// IMP=0x00100000001301e5
- (id)settingsBundleDict;	// IMP=0x001000000012feea
- (void)_setRequiredInstalledWatchAppsForLegacy:(id)arg1;	// IMP=0x001000000012fe5f
- (id)initWithBundle:(id)arg1 name:(id)arg2;	// IMP=0x001000000012fb04
