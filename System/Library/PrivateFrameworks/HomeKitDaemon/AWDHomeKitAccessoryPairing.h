...
- (void).cxx_destruct;	// IMP=0x00000000008e9877
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000008e936c
- (unsigned long long)hash;	// IMP=0x00000000008e8ff5
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000008e8a54
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000008e86c1
- (void)copyTo:(id)arg1;	// IMP=0x00000000008e8391
- (void)writeTo:(id)arg1;	// IMP=0x00000000008e8014
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000008e7155
- (id)dictionaryRepresentation;	// IMP=0x00000000008e6867
- (id)description;	// IMP=0x00000000008e67b8
...
- (int)StringAsCredentialType:(id)arg1;	// IMP=0x00000000008e6343
- (id)credentialTypeAsString:(int)arg1;	// IMP=0x00000000008e62fb
...
- (int)StringAsCertified:(id)arg1;	// IMP=0x00000000008e615f
- (id)certifiedAsString:(int)arg1;	// IMP=0x00000000008e6117
...
- (int)StringAsTransportType:(id)arg1;	// IMP=0x00000000008e5f60
- (id)transportTypeAsString:(int)arg1;	// IMP=0x00000000008e5f18
