...
- (void).cxx_destruct;	// IMP=0x00000000000e093d
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000e068d
- (unsigned long long)hash;	// IMP=0x00000000000e0649
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000e063e
- (id)initWithIdentifier:(id)arg1 selector:(id)arg2 groupingValues:(id)arg3;	// IMP=0x00000000000e0552
