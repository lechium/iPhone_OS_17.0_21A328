...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000001b3866
- (unsigned long long)hash;	// IMP=0x00100000001b30b1
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000001b2ee2
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000001b2da0
- (void)copyTo:(id)arg1;	// IMP=0x00100000001b2c9c
- (void)writeTo:(id)arg1;	// IMP=0x00100000001b2b09
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000001b2afc
- (id)dictionaryRepresentation;	// IMP=0x00100000001b21bd
- (id)description;	// IMP=0x00100000001b2146
