...
- (void).cxx_destruct;	// IMP=0x00000000000539d7
...
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x000000000005392d
- (void)_updateVolumeCapabilities;	// IMP=0x0000000000053841
- (void)_updateVolumeStyle;	// IMP=0x0000000000053759
- (_Bool)gestureRecognizer:(id)arg1 shouldReceiveTouch:(id)arg2;	// IMP=0x00000000000535d0
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x0000000000053449
- (void)didMoveToWindow;	// IMP=0x000000000005330e
- (void)didMoveToSuperview;	// IMP=0x00000000000532cd
- (void)layoutSubviews;	// IMP=0x0000000000052ec9
- (void)dealloc;	// IMP=0x0000000000052e47
- (id)initWithFrame:(struct CGRect)arg1 slider:(id)arg2;	// IMP=0x0000000000052cda
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000052c5b
