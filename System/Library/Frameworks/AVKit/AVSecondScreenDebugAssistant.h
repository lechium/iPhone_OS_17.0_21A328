...
- (void).cxx_destruct;	// IMP=0x000000000009b130
...
- (void)_actuallyUpdateDebugLabelTextWithCurrentResolution:(id)arg1 currentVideoDynamicRange:(id)arg2;	// IMP=0x000000000009a7f2
- (void)_updateDebugLabelText;	// IMP=0x000000000009a5e0
- (id)_currentVideoDynamicRange;	// IMP=0x000000000009a3c9
- (id)_currentDisplay;	// IMP=0x000000000009a137
- (id)_currentEnabledVideoTrack;	// IMP=0x0000000000099ece
- (void)dealloc;	// IMP=0x0000000000099cac
- (id)init;	// IMP=0x0000000000099afb
