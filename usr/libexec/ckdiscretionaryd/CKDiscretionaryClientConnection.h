...
- (void).cxx_destruct;	// IMP=0x0020000000006a02
...
- (void)cleanup;	// IMP=0x00100000000064fe
- (void)finishOperationID:(id)arg1;	// IMP=0x0010000000006153
- (void)queueOperationID:(id)arg1 options:(id)arg2 clientOperationCallbackProxy:(id)arg3 withBlock:(CDUnknownBlockType)arg4;	// IMP=0x0010000000005432
- (id)initWithDaemon:(id)arg1 connection:(id)arg2;	// IMP=0x0010000000004ee0
- (id)initWithDaemon:(id)arg1 group:(id)arg2 bundleID:(id)arg3 isSpringBoardApp:(_Bool)arg4 requiresPastBuddy:(_Bool)arg5 scheduleSendBarrierBlock:(CDUnknownBlockType)arg6;	// IMP=0x0010000000004d47
