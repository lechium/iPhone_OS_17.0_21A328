...
- (void).cxx_destruct;	// IMP=0x002000000003c058
...
- (CDUnknownBlockType)actionForButtonAtIndex:(unsigned long long)arg1;	// IMP=0x001000000003bc87
- (void)addButtonDefinition:(id)arg1 forAction:(CDUnknownBlockType)arg2;	// IMP=0x001000000003bbac
- (id)initWithTitle:(id)arg1 message:(id)arg2;	// IMP=0x001000000003bab5
