...
+ (id)responseWithResponse:(id)arg1;	// IMP=0x00400000000a65a2
+ (id)responseWithCode:(unsigned long long)arg1 headerFields:(id)arg2 data:(id)arg3 MIMEType:(id)arg4 error:(id)arg5;	// IMP=0x00100000000a64e4
- (void).cxx_destruct;	// IMP=0x00200000000a649b
...
- (id)description;	// IMP=0x00100000000a63ac
- (id)initWithCode:(unsigned long long)arg1 headerFields:(id)arg2 data:(id)arg3 MIMEType:(id)arg4 error:(id)arg5;	// IMP=0x00100000000a628d
