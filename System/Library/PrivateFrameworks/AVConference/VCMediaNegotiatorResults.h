...
- (unsigned int)maxBandwidthWithOperatingMode:(int)arg1 connectionType:(int)arg2;	// IMP=0x0000000000338ebd
- (void)addBandwidthConfigurations:(id)arg1;	// IMP=0x0000000000338e88
- (void)dealloc;	// IMP=0x0000000000338e14
- (id)init;	// IMP=0x0000000000338d94
