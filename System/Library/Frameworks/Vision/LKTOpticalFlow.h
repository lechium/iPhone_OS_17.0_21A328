...
- (_Bool)_validateOutputImage:(struct __CVBuffer *)arg1 error:(id *)arg2;	// IMP=0x0000000000299bf3
- (_Bool)_validateInputImage:(struct __CVBuffer *)arg1 error:(id *)arg2;	// IMP=0x0000000000299b38
- (_Bool)estimateFlowStream:(struct __CVBuffer *)arg1 error:(id *)arg2;	// IMP=0x0000000000299af3
- (_Bool)estimateFlowFromReference:(struct __CVBuffer *)arg1 target:(struct __CVBuffer *)arg2 error:(id *)arg3;	// IMP=0x0000000000299aae
- (_Bool)setOutputUV:(struct __CVBuffer *)arg1 error:(id *)arg2;	// IMP=0x0000000000299a69
- (void)waitUntilCompleted;	// IMP=0x0000000000299a63
- (id)initWithWidth:(int)arg1 height:(int)arg2 numScales:(int)arg3;	// IMP=0x0000000000299a0a
