...
- (void).cxx_destruct;	// IMP=0x000000000010bd9f
...
- (void)dealloc;	// IMP=0x000000000010bcd9
- (id)initWithDocument:(id)arg1 stageID:(id)arg2 transferSize:(unsigned long long)arg3;	// IMP=0x000000000010bb4a
- (id)description;	// IMP=0x000000000010bb1d
