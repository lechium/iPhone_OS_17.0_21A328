...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000005640bb
- (void).cxx_destruct;	// IMP=0x0000000000564035
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000563e1a
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000563cbc
