...
+ (id)allHandles;	// IMP=0x00600000001c7d22
- (void).cxx_destruct;	// IMP=0x00000000001c7ce0
...
- (id)_createCornerOverlayView;	// IMP=0x00000000001c7a73
- (id)_createLineView;	// IMP=0x00000000001c79c1
- (id)initForHandle:(unsigned long long)arg1;	// IMP=0x00000000001c6a82
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000001c6a6b
