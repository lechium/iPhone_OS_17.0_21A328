...
+ (id)sharedQueryQueue;	// IMP=0x0040000000068e89
- (void).cxx_destruct;	// IMP=0x002000000006a831
...
- (void)_queryForTransactionsWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0010000000069715
- (void)_delayedQuery;	// IMP=0x00100000000693da
- (void)_scheduleQueryForTransactions;	// IMP=0x00100000000692b5
- (void)_managedObjectContextDidSave:(id)arg1;	// IMP=0x00100000000691d1
- (void)start;	// IMP=0x0010000000068f30
- (void)dealloc;	// IMP=0x0010000000068de1
- (id)initWithContext:(id)arg1;	// IMP=0x0010000000068d3f
- (id)initWithPersistentHistoryToken:(id)arg1 context:(id)arg2;	// IMP=0x0010000000068c9c
