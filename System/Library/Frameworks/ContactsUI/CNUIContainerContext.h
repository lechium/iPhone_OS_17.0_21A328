...
- (void).cxx_destruct;	// IMP=0x000000000020021e
...
- (void)resetToInitialState;	// IMP=0x000000000020015a
@property(readonly, nonatomic) NSDictionary *removedContainers;
@property(readonly, nonatomic) NSArray *addedContainers;
- (id)persistedContainers;	// IMP=0x0000000000200028
- (void)removeContainer:(id)arg1;	// IMP=0x00000000001fff34
- (void)addContainer:(id)arg1;	// IMP=0x00000000001ffdd9
- (id)initWithContainers:(id)arg1;	// IMP=0x00000000001ffd35
