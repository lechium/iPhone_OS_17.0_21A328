...
- (void).cxx_destruct;	// IMP=0x0000000000283523
...
- (void)performWithDelegate:(CDUnknownBlockType)arg1;	// IMP=0x00000000002833f2
- (id)initWithDelegate:(id)arg1;	// IMP=0x0000000000283383
