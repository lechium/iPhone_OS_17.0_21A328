...
@class MISSING_TYPE, NSError, NSSet, NSString, NSUserActivity, UIScene, UISceneConnectionOptions, UISceneSession;
...
- (MISSING_TYPE *)stateRestorationActivityForScene: /* Error: Ran out of types for this method. */;
