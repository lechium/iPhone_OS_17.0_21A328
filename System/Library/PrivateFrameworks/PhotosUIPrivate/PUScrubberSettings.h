...
+ (id)settingsControllerModule;	// IMP=0x00600000004f4c71
+ (id)sharedInstance;	// IMP=0x00600000004f4c41
...
- (void)setDefaultValues;	// IMP=0x00000000004f46ca
- (id)parentSettings;	// IMP=0x00000000004f46b1
