...
- (void).cxx_destruct;	// IMP=0x000000000012d085
...
- (id)featureValueForName:(id)arg1;	// IMP=0x000000000012cedc
@property(readonly, nonatomic) NSSet *featureNames;
- (id)initWithInput1:(id)arg1 stateIn:(id)arg2 detectedHistoryIn:(id)arg3;	// IMP=0x000000000012ce04
- (id)initWithInput1:(id)arg1;	// IMP=0x000000000012cded
