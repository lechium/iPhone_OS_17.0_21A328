...
- (void).cxx_destruct;	// IMP=0x000000000009f1cd
...
- (void)finishWithError:(id)arg1;	// IMP=0x000000000009f05b
- (void)start;	// IMP=0x000000000009ef95
- (id)initWithConnectionInterface:(id)arg1 entityMangledTypeName:(id)arg2 queue:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x000000000009eccf
