...
- (void).cxx_destruct;	// IMP=0x002000000031bac5
@property(readonly, nonatomic) id <RAPPlace> reportedPlace; // @synthesize reportedPlace=_reportedPlace;
- (id)followUpQuestionForCategory:(long long)arg1;	// IMP=0x001000000031ba30
@property(readonly, nonatomic) MKMapItem *snippetMapItem;
@property(readonly, nonatomic) long long snippetStyle;
- (void)_fillSubmissionParameters:(id)arg1;	// IMP=0x001000000031b8c7
@property(readonly, nonatomic) _Bool shouldLoadClaimThisBusiness;
- (id)_alternateMapViewContext;	// IMP=0x001000000031b86f
- (id)mainMenuItems;	// IMP=0x001000000031b809
@property(readonly, nonatomic) int analyticTarget;
- (id)initWithReport:(id)arg1 parentQuestion:(id)arg2 reportedPlace:(id)arg3;	// IMP=0x001000000031b77c
- (id)initWithReport:(id)arg1 reportedPlace:(id)arg2;	// IMP=0x001000000031b765
