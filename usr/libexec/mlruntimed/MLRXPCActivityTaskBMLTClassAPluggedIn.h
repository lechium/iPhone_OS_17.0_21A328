...
@interface MLRXPCActivityTaskBMLTClassAPluggedIn : NSObject
{
...
- (void).cxx_destruct;	// IMP=0x002000000001f396
...
- (void)stop;	// IMP=0x001000000001f28b
- (void)startTaskWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x001000000001f144
- (id)createTaskScheduler;	// IMP=0x001000000001f114
- (id)criteria;	// IMP=0x001000000001f000
