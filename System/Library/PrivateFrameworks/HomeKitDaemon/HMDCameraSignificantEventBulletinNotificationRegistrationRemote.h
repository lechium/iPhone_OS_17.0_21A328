...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000083d32f
- (void).cxx_destruct;	// IMP=0x000000000083d2fe
...
- (id)attributeDescriptions;	// IMP=0x000000000083d1b4
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000083cf63
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000083ceb5
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000083ceaa
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000083cd5f
- (id)initWithCameraCameraSignificantEventBulletinNotificationRegistration:(id)arg1 source:(id)arg2;	// IMP=0x000000000083cc9b
