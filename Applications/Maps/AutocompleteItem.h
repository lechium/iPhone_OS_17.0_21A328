...
+ (id)keysForServerCompletion:(id)arg1;	// IMP=0x00200000002a8d93
- (void).cxx_destruct;	// IMP=0x00200000002a95dd
...
- (id)leafPersonalizedAutocompleteItems;	// IMP=0x00100000002a94ed
...
- (id)_searchItemForString:(id)arg1;	// IMP=0x00100000002a92c5
- (id)initWithPersonalizedItem:(id)arg1 matchInfo:(id)arg2;	// IMP=0x00100000002a8b32
- (id)initWithLocalCompletion:(id)arg1 sourceType:(long long)arg2 sourceSubtype:(long long)arg3 matchInfo:(id)arg4;	// IMP=0x00100000002a8b12
- (id)initWithLocalCompletion:(id)arg1 sourceType:(long long)arg2 sourceSubtype:(long long)arg3 hasPriorityOverride:(_Bool)arg4 priorityOverride:(long long)arg5 matchInfo:(id)arg6;	// IMP=0x00100000002a7f07
- (id)initWithServerCompletion:(id)arg1 hasPriorityOverride:(_Bool)arg2 priorityOverride:(long long)arg3 serverResultScoreMetadata:(id)arg4;	// IMP=0x00100000002a7d60
- (id)init;	// IMP=0x00100000002a7d52
