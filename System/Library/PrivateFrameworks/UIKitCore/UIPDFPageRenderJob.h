...
- (void)sendImageTo:(id)arg1 callback:(SEL)arg2 userData:(id)arg3;	// IMP=0x000000000110c825
- (void)sendImage;	// IMP=0x000000000110c6e9
- (void)renderImage;	// IMP=0x000000000110c073
@property(readonly, retain) UIImage *image; // @dynamic image;
- (void)releaseOperation;	// IMP=0x000000000110c015
@property UIPDFPageRenderOperation *operation; // @dynamic operation;
- (void)setTarget:(id)arg1 callback:(SEL)arg2 userData:(id)arg3;	// IMP=0x000000000110be5b
- (void)cancelOperationForTarget:(id)arg1;	// IMP=0x000000000110bcd3
- (void)cancelOperation;	// IMP=0x000000000110bb6b
- (void)cancel;	// IMP=0x000000000110b9e9
- (void)dealloc;	// IMP=0x000000000110b991
- (id)initWithPage:(id)arg1 maxSize:(struct CGSize)arg2 queuePriority:(long long)arg3;	// IMP=0x000000000110b8af
- (_Bool)hasPage;	// IMP=0x000000000110b882
