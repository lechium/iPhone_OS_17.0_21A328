...
+ (id)cellNibForContacts;	// IMP=0x0060000000160f80
+ (id)cellNibForActions;	// IMP=0x0060000000160f1d
- (void).cxx_destruct;	// IMP=0x0000000000160ca9
...
- (void)trackHighlight:(id)arg1;	// IMP=0x000000000016081a
- (void)stopTrackingWithGestureRecognizer:(id)arg1;	// IMP=0x00000000001607f8
- (void)startTrackingWithGestureRecognizer:(id)arg1;	// IMP=0x0000000000160785
- (void)reloadData;	// IMP=0x000000000015fdaa
- (void)_updateHighlightAnimated:(_Bool)arg1;	// IMP=0x000000000015fc33
- (void)prepareForReuse;	// IMP=0x000000000015fbbd
- (void)setHighlighted:(_Bool)arg1 animated:(_Bool)arg2;	// IMP=0x000000000015fb74
- (void)setHighlighted:(_Bool)arg1;	// IMP=0x000000000015fb5d
- (void)awakeFromNib;	// IMP=0x000000000015f9ac
- (void)_updateFonts;	// IMP=0x000000000015f85c
