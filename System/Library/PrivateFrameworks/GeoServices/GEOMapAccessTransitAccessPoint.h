...
- (id).cxx_construct;	// IMP=0x0000000000373a0a
- (void).cxx_destruct;	// IMP=0x00000000003739d9
- (id)findAccessPoints:(CDUnknownBlockType)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000373957
- (id)findStation:(CDUnknownBlockType)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000000037376b
- (id)findStops:(CDUnknownBlockType)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000373763
- (id)findGeometryWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000000037371f
...
- (double)distanceInMetersFrom:(CDStruct_c3b9c2ee)arg1;	// IMP=0x000000000037369c
...
- (id)initWithMap:(id)arg1 accessPoint:(shared_ptr_4792c490)arg2;	// IMP=0x0000000000373519
