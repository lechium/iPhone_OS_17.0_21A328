...
- (id).cxx_construct;	// IMP=0x0000000000509b9f
- (void).cxx_destruct;	// IMP=0x0000000000509b85
- (void)routeContextStateDidChange:(id)arg1;	// IMP=0x0000000000509ac8
- (void)dealloc;	// IMP=0x0000000000509a4c
- (id)initWithRouteContext:(id)arg1 transitSupport:(void *)arg2;	// IMP=0x0000000000509995
