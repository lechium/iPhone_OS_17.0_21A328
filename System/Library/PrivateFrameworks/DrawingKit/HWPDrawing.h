...
- (void).cxx_destruct;	// IMP=0x0000000000016b01
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000016944
- (unsigned long long)hash;	// IMP=0x0000000000016824
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000016672
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000164fa
- (void)copyTo:(id)arg1;	// IMP=0x00000000000163e1
- (void)writeTo:(id)arg1;	// IMP=0x000000000001629d
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000016290
- (id)dictionaryRepresentation;	// IMP=0x0000000000015aca
- (id)description;	// IMP=0x0000000000015a1b
...
- (int)StringAsCompressionAlgorithm:(id)arg1;	// IMP=0x0000000000015836
- (id)compressionAlgorithmAsString:(int)arg1;	// IMP=0x00000000000157ed
