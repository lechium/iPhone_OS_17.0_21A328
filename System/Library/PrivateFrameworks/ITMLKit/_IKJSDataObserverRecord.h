...
+ (id)hashForObserver:(id)arg1;	// IMP=0x0060000000024db0
- (void).cxx_destruct;	// IMP=0x000000000002504d
...
- (_Bool)isAffectedByPropertyPathWithString:(id)arg1 subpathString:(id *)arg2;	// IMP=0x0000000000024edf
- (id)initWithObserver:(id)arg1 pathString:(id)arg2;	// IMP=0x0000000000024dd5
