...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000015db1
- (void).cxx_destruct;	// IMP=0x0000000000015fdb
...
- (id)description;	// IMP=0x0000000000015f42
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000015e26
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000015db9
