...
- (id)newSubBufferWithBytes:(const void *)arg1 length:(unsigned long long)arg2 renderContext:(id)arg3;	// IMP=0x00000000000e9c21
- (id)_newSubBuffer;	// IMP=0x00000000000e99f9
- (void)dealloc;	// IMP=0x00000000000e99af
- (id)initWithDevice:(id)arg1 fixedSizeElement:(unsigned long long)arg2 buffersize:(unsigned long long)arg3 name:(id)arg4;	// IMP=0x00000000000e98e9
