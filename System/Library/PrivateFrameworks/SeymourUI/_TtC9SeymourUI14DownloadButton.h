...
- (void).cxx_destruct;	// IMP=0x000000000098de30
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x000000000098cc20
- (void)tintColorDidChange;	// IMP=0x000000000098c8f0
- (void)layoutSubviews;	// IMP=0x000000000098c6e0
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000098c400
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000098c3d0
@property(nonatomic) _Bool highlighted;
- (_Bool)isHighlighted;	// IMP=0x000000000098ba20
