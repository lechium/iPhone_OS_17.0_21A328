...
- (void).cxx_destruct;	// IMP=0x000000000026a96c
...
- (_Bool)hasReferenceIndexPath;	// IMP=0x000000000026a903
- (void)invalidate;	// IMP=0x000000000026a87e
- (id)init;	// IMP=0x000000000026a7dc
