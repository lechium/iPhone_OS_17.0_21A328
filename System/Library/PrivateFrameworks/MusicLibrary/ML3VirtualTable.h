...
- (id).cxx_construct;	// IMP=0x0000000000178cf5
- (void).cxx_destruct;	// IMP=0x0000000000178ca5
...
- (_Bool)unregister;	// IMP=0x0000000000178a45
- (_Bool)registerWithConnection:(id)arg1;	// IMP=0x0000000000178772
@property(readonly, nonatomic) NSString *name;
- (void)dealloc;	// IMP=0x00000000001786f1
- (id)initWithDatabaseTable:(id)arg1;	// IMP=0x000000000017856d
