...
- (void).cxx_destruct;	// IMP=0x00000000000f4a0e
...
- (id)initWithTitle:(id)arg1;	// IMP=0x00000000000f493b
- (id)initWithImageInsetPercentage:(double)arg1 imageProvider:(CDUnknownBlockType)arg2;	// IMP=0x00000000000f48a1
