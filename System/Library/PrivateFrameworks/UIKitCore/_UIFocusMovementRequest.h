...
- (void).cxx_destruct;	// IMP=0x000000000083e289
...
- (id)_requestByRedirectingRequestToFocusSystem:(id)arg1;	// IMP=0x000000000083df57
- (id)initWithFocusSystem:(id)arg1 window:(id)arg2;	// IMP=0x000000000083de4e
- (id)init;	// IMP=0x000000000083ddc7
