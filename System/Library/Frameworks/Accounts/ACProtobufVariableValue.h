...
- (void).cxx_destruct;	// IMP=0x0000000000006132
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000005dd1
- (unsigned long long)hash;	// IMP=0x0000000000005b92
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000000593e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000000574b
- (void)copyTo:(id)arg1;	// IMP=0x00000000000055ca
- (void)writeTo:(id)arg1;	// IMP=0x000000000000544d
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000005440
- (id)dictionaryRepresentation;	// IMP=0x0000000000004be0
- (id)description;	// IMP=0x0000000000004b31
...
- (_Bool)_setObject:(id)arg1;	// IMP=0x0000000000053602
- (id)initWithObjectValue:(id)arg1;	// IMP=0x0000000000053589
