...
- (void)clearFieldsAfterUsername;	// IMP=0x0000000000046d93
- (void)pickerDidSelectRow:(unsigned long long)arg1;	// IMP=0x0000000000046d42
- (void)buttonTappedAtIndex:(unsigned long long)arg1;	// IMP=0x0000000000046cf1
- (void)validateCredentialEntryFields;	// IMP=0x0000000000046aff
- (void)configureWithRequest:(id)arg1;	// IMP=0x000000000004676e
- (void)_bindField:(id)arg1;	// IMP=0x000000000004656d
- (void)_unbindField:(id)arg1;	// IMP=0x0000000000046516
