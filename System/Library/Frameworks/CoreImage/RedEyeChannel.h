...
- (id)parameterNamesForChannel:(int)arg1;	// IMP=0x00000000001eba81
- (id)filterNameForChannel:(int)arg1;	// IMP=0x00000000001eba5e
- (id)outputImage;	// IMP=0x00000000001eb71b
