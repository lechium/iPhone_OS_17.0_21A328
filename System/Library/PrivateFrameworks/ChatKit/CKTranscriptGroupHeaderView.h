...
- (void).cxx_destruct;	// IMP=0x00000000004b7dfc
...
- (void)layoutSubviews;	// IMP=0x00000000004b7b83
- (id)initWithFrame:(struct CGRect)arg1 conversation:(id)arg2;	// IMP=0x00000000004b77c0
- (void)dealloc;	// IMP=0x00000000004b75ef
