...
- (void).cxx_destruct;	// IMP=0x000000000009f447
...
- (id)relevantZoneIDs;	// IMP=0x000000000009f1d2
- (void)_finishOnCallbackQueueWithError:(id)arg1;	// IMP=0x000000000009f16c
- (void)main;	// IMP=0x000000000009e799
- (void)_sendQueryRequestWithCursor:(id)arg1 previousRequestSchedulerInfo:(id)arg2;	// IMP=0x000000000009d4c4
- (void)_handleRecordResponses:(id)arg1 perRequestSchedulerInfo:(id)arg2;	// IMP=0x000000000009c7c0
- (id)_wrapError:(id)arg1 format:(id)arg2;	// IMP=0x000000000009c5a6
- (void)_handleQueryRequestFinishedWithSchedulerInfo:(id)arg1;	// IMP=0x000000000009becf
- (id)activityCreate;	// IMP=0x000000000009bea6
@property(readonly, nonatomic) NSString *pipeliningDescription;
- (int)operationType;	// IMP=0x000000000009be8e
- (id)initWithOperationInfo:(id)arg1 container:(id)arg2;	// IMP=0x000000000009bb37
