...
- (void)finalizeAtTime:(CDStruct_1b6d18a9)arg1;	// IMP=0x00000000000adabe
- (void)mergeSegment:(id)arg1;	// IMP=0x00000000000ad9b9
- (void)resetSegment:(CDStruct_1b6d18a9)arg1;	// IMP=0x00000000000ad935
- (void)updateSegment:(CDStruct_1b6d18a9)arg1;	// IMP=0x00000000000ad8cb
- (id)init;	// IMP=0x00000000000ad857
