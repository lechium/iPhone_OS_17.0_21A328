...
+ (id)featureName;	// IMP=0x00100000000d6668
+ (id)makeFeatureJSObjectForFeature:(id)arg1;	// IMP=0x00100000000d65d1
- (void).cxx_destruct;	// IMP=0x00000000000d67f3
...
- (void)setEditing:(_Bool)arg1 options:(id)arg2;	// IMP=0x00000000000d6675
- (id)initWithDOMNode:(id)arg1 featureName:(id)arg2;	// IMP=0x00000000000d64b7
