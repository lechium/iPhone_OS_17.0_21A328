...
- (void).cxx_destruct;	// IMP=0x00000000000920ee
...
- (id)preferredFocusEnvironments;	// IMP=0x0000000000091f30
- (void)configureSupplementaryCellLayoutAttributesWithAutomaticInsets:(struct UIEdgeInsets)arg1 sectionIndex:(long long)arg2;	// IMP=0x0000000000091649
- (void)layoutSubviews;	// IMP=0x0000000000090de2
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000090b5f
