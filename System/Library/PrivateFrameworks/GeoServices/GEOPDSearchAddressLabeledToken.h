...
- (void).cxx_destruct;	// IMP=0x0000000000af1ead
- (unsigned long long)hash;	// IMP=0x0000000000af1dca
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000af1c38
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000af17ac
- (void)writeTo:(id)arg1;	// IMP=0x0000000000af136f
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000af1360
- (id)jsonRepresentation;	// IMP=0x0000000000aefb0f
- (id)dictionaryRepresentation;	// IMP=0x0000000000aef38f
- (id)description;	// IMP=0x0000000000aef2e0
- (id)initWithData:(id)arg1;	// IMP=0x0000000000aee5c6
- (id)init;	// IMP=0x0000000000aee56a
