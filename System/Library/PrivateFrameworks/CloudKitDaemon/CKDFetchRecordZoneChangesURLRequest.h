...
- (void).cxx_destruct;	// IMP=0x00000000002fdc38
...
- (void)requestDidComplete;	// IMP=0x00000000002fd9e9
- (void)requestDidParseNodeFailure:(id)arg1;	// IMP=0x00000000002fd4d8
- (id)requestDidParseProtobufObject:(id)arg1;	// IMP=0x00000000002fcc96
- (id)_handleRecordChanges:(id)arg1 deltaChanges:(id)arg2 forZoneID:(id)arg3;	// IMP=0x00000000002faf0d
- (id)generateRequestOperations;	// IMP=0x00000000002f9c9e
- (_Bool)handlesAnonymousCKUserIDPropagation;	// IMP=0x00000000002f9c96
- (_Bool)requestGETPreAuth;	// IMP=0x00000000002f9c29
- (id)requestOperationClasses;	// IMP=0x00000000002f9bbd
- (id)zoneIDsToLock;	// IMP=0x00000000002f9bab
- (_Bool)allowsAnonymousAccount;	// IMP=0x00000000002f9b91
- (void)fillOutRequestProperties:(id)arg1;	// IMP=0x00000000002f9b00
- (void)fillOutEquivalencyPropertiesBuilder:(id)arg1;	// IMP=0x00000000002f97d7
...
- (id)initWithOperation:(id)arg1 recordZoneIDs:(id)arg2 configurationsByRecordZoneID:(id)arg3;	// IMP=0x00000000002f95f0
