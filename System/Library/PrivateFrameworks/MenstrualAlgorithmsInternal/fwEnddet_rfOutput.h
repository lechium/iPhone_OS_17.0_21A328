...
- (void).cxx_destruct;	// IMP=0x0000000000056791
...
- (id)featureValueForName:(id)arg1;	// IMP=0x0000000000056668
@property(readonly, nonatomic) NSSet *featureNames;
- (id)initWithClassLabel:(long long)arg1 classProbability:(id)arg2;	// IMP=0x00000000000565d1
