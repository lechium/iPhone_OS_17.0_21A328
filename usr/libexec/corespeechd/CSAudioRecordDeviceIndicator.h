...
- (void).cxx_destruct;	// IMP=0x002000000014836b
...
- (void)updateDeviceId:(id)arg1;	// IMP=0x0010000000148333
- (void)updateWithLatestRecordContext:(id)arg1;	// IMP=0x0010000000148193
- (id)initWithRecordContext:(id)arg1 deviceId:(id)arg2 shouldUseRemoteRecorder:(_Bool)arg3 streamHandleId:(unsigned long long)arg4;	// IMP=0x00100000001480cf
