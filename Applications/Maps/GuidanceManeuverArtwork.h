...
+ (id)artworkWithManeuver:(int)arg1;	// IMP=0x0040000000772834
- (void).cxx_destruct;	// IMP=0x0020000000772b7c
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000772a09
- (unsigned long long)hash;	// IMP=0x00100000007729a1
...
- (id)initWithManeuver:(int)arg1 junction:(id)arg2 drivingSide:(int)arg3 artworkDataSource:(id)arg4;	// IMP=0x0010000000772869
- (_Bool)isValue:(id)arg1 equalTo:(id)arg2;	// IMP=0x001000000077279a
