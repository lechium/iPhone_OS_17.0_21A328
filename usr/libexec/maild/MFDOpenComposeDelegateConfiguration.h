...
- (void).cxx_destruct;	// IMP=0x002000000007986d
...
- (id)description;	// IMP=0x0010000000079749
- (id)initWithIdentifier:(id)arg1 delegateEndpoint:(id)arg2 isEntitledDelegate:(_Bool)arg3;	// IMP=0x0010000000079687
