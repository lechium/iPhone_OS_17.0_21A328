...
+ (id)overlayViewFromMediaItem:(id)arg1 overlayType:(long long)arg2 existingView:(id)arg3;	// IMP=0x0060000000032dd6
...
- (struct UIEdgeInsets)_overlayPadding;	// IMP=0x000000000003488c
- (struct CGSize)vui_layoutSubviews:(struct CGSize)arg1 computationOnly:(_Bool)arg2;	// IMP=0x00000000000338a7
