...
- (void).cxx_destruct;	// IMP=0x0000000000073306
...
- (id)description;	// IMP=0x0000000000072b9b
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000728ae
- (unsigned long long)hash;	// IMP=0x000000000007274e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000726cd
@property(readonly, nonatomic, getter=isDownloadInProgress) _Bool downloadInProgress;
- (id)init;	// IMP=0x0000000000072666
