...
+ (_Bool)handleConnection:(id)arg1 server:(id)arg2;	// IMP=0x002000000000c474
- (void).cxx_destruct;	// IMP=0x002000000000ca42
...
- (void)addSlotWithEndpoint:(id)arg1 name:(id)arg2 type:(id)arg3 reply:(CDUnknownBlockType)arg4;	// IMP=0x001000000000c53d
- (id)initWithConnection:(id)arg1 server:(id)arg2;	// IMP=0x001000000000c3e1
