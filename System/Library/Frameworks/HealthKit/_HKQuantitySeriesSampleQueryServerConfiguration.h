...
+ (_Bool)supportsSecureCoding;	// IMP=0x00600000000ecc50
- (void).cxx_destruct;	// IMP=0x00000000000ed120
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000eceef
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000ecc58
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000ecafe
