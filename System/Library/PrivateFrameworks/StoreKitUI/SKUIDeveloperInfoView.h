...
- (void).cxx_destruct;	// IMP=0x000000000006497d
...
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000000647cd
- (void)setBackgroundColor:(id)arg1;	// IMP=0x0000000000064638
- (void)layoutSubviews;	// IMP=0x00000000000642bd
- (id)initWithDeveloperInfo:(id)arg1 clientContext:(id)arg2;	// IMP=0x000000000006381d
