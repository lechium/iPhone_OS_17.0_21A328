...
+ (id)todoVariableWithName:(id)arg1 defaultExpirationInterval:(double)arg2;	// IMP=0x004000000007aac6
+ (id)todoVariableWithName:(id)arg1;	// IMP=0x001000000007aab1
- (void).cxx_destruct;	// IMP=0x002000000007b682
...
- (id)setHasCompletedGeneration:(long long)arg1 now:(id)arg2;	// IMP=0x001000000007b575
- (id)hasSomethingTodoNow:(id)arg1;	// IMP=0x001000000007b4e1
- (id)setHasCompletedGeneration:(long long)arg1;	// IMP=0x001000000007b476
@property(readonly, nonatomic) id <PQLInjecting> hasSomethingTodo;
- (id)initWithName:(id)arg1 defaultExpirationInterval:(double)arg2;	// IMP=0x001000000007ab21
