...
- (void).cxx_destruct;	// IMP=0x00000000000ffb8c
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000ffa46
- (id)initWithRequestClass:(Class)arg1;	// IMP=0x00000000000ff9b4
- (void)setDefaultSymbologiesForRevision:(unsigned long long)arg1;	// IMP=0x00000000000ff842
