...
+ (long long)session_message_typeForObject:(id)arg1;	// IMP=0x00600000000a4496
+ (long long)session_message_typeForMutableObject:(id)arg1;	// IMP=0x00600000000a4394
+ (Class)session_message_mutableClassForType:(long long)arg1;	// IMP=0x00600000000a435a
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000a3c30
- (id)init;	// IMP=0x00000000000a3ba2
