...
- (void).cxx_destruct;	// IMP=0x000000000047f14a
...
- (void)setFloatingOffset:(struct UIOffset)arg1;	// IMP=0x000000000047efc4
- (void)prepareSublayout;	// IMP=0x000000000047e9be
@property(nonatomic) struct CGSize optionBadgeSize;
@property(nonatomic) struct CGSize selectionBadgeSize;
- (id)initWithIndexPath:(id)arg1 itemFrame:(struct CGRect)arg2;	// IMP=0x000000000047e84a
