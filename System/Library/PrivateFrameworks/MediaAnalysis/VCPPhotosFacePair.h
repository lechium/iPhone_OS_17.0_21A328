...
+ (id)pairWithFace:(id)arg1 andFace:(id)arg2 distance:(double)arg3;	// IMP=0x00600000002c8ab6
- (void).cxx_destruct;	// IMP=0x00000000002c8b5d
...
- (id)initWithFace:(id)arg1 andFace:(id)arg2 distance:(double)arg3;	// IMP=0x00000000002c8a0d
