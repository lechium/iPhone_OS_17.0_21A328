...
- (void).cxx_destruct;	// IMP=0x002000000007827e
- (void)expectedContentLength:(unsigned long long)arg1;	// IMP=0x0010000000078222
- (long long)writeBytes:(const char *)arg1 length:(unsigned long long)arg2 error:(id *)arg3;	// IMP=0x0010000000078176
- (void)close;	// IMP=0x0010000000078098
@property(readonly) _Bool hasSpaceAvailable;
- (void)dealloc;	// IMP=0x0010000000077f39
