...
+ (id)contextWithBundleID:(id)arg1 transactionID:(unsigned long long)arg2;	// IMP=0x0040000000074488
+ (id)contextWithBundleID:(id)arg1;	// IMP=0x0010000000074424
- (void).cxx_destruct;	// IMP=0x00200000000744d8
...
- (id)init;	// IMP=0x0010000000074382
