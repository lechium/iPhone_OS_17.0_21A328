...
- (void).cxx_destruct;	// IMP=0x0000000000045043
@property(retain, nonatomic) MKMapItemView *mapItemView; // @synthesize mapItemView=_mapItemView;
- (struct CGSize)intrinsicContentSize;	// IMP=0x0000000000044fe6
- (double)mapViewHeight;	// IMP=0x0000000000044fd8
@property(retain, nonatomic) UIImage *map;
- (void)infoCardThemeChanged;	// IMP=0x0000000000044dea
@property(nonatomic, getter=isBottomHairlineHidden) _Bool bottomHairlineHidden;
- (void)_contentSizeDidChange;	// IMP=0x0000000000044cd7
- (double)titleHeight;	// IMP=0x0000000000044c85
- (id)initWithFrame:(struct CGRect)arg1 hideLookAroundView:(_Bool)arg2;	// IMP=0x0000000000043faf
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000043f9b
- (_Bool)useImageView;	// IMP=0x0000000000043f93
- (_Bool)hasTitle;	// IMP=0x0000000000043f8b
