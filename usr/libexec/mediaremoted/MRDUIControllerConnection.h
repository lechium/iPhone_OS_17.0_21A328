...
+ (id)serviceInterface;	// IMP=0x0020000000064dec
- (void).cxx_destruct;	// IMP=0x0020000000064f2c
...
- (void)dealloc;	// IMP=0x0010000000064598
- (id)initWithClientObject:(id)arg1 invalidationHandler:(CDUnknownBlockType)arg2;	// IMP=0x001000000006446b
