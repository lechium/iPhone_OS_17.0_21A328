...
+ (_Bool)supportsSecureCoding;	// IMP=0x0020000000085993
+ (id)archiveBasePath;	// IMP=0x00100000000857cd
+ (void)deleteArchives;	// IMP=0x0010000000085754
+ (id)archivePathForQuery:(id)arg1;	// IMP=0x0010000000085654
- (void).cxx_destruct;	// IMP=0x0020000000085f00
...
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000085b55
- (struct _MDPlistContainer *)decodeMDPlistContainerWithCoder:(id)arg1 forKey:(id)arg2;	// IMP=0x0010000000085ab1
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000008599b
- (id)initWithQuery:(id)arg1 withResults:(id)arg2 withSuggestions:(id)arg3 withCorrections:(id)arg4 suggestionsAreBlended:(_Bool)arg5 withStore:(id)arg6;	// IMP=0x001000000008581b
