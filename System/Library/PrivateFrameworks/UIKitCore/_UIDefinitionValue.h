...
- (void).cxx_destruct;	// IMP=0x000000000057b950
...
- (id)description;	// IMP=0x000000000057b865
- (id)initWithLocalizedDictionaryName:(id)arg1 term:(id)arg2 definition:(id)arg3 longDefinition:(id)arg4;	// IMP=0x000000000057b754
