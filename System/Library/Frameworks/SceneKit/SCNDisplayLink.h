...
- (_Bool)_isInvalidated;	// IMP=0x000000000022851f
- (void)setNeedsDisplay;	// IMP=0x000000000022850b
- (void)invalidate;	// IMP=0x00000000002284a9
- (void)_caDisplayLinkCallback;	// IMP=0x0000000000228477
- (void)_callbackWithTime:(double)arg1;	// IMP=0x00000000002282d9
- (int)queuedFrameCount;	// IMP=0x00000000002282d0
@property(nonatomic) float preferredFrameRate;
@property(copy, nonatomic) CDUnknownBlockType adaptativeFrameRate;
- (_Bool)setPaused:(_Bool)arg1 nextFrameTimeHint:(double)arg2 lastUpdate:(double)arg3;	// IMP=0x000000000022810b
@property(nonatomic, getter=isPaused) _Bool paused;
- (void)dealloc;	// IMP=0x0000000000227fba
- (id)initWithQueue:(id)arg1 screen:(id)arg2 policy:(unsigned long long)arg3 block:(CDUnknownBlockType)arg4;	// IMP=0x0000000000227d42
- (id)init;	// IMP=0x0000000000227d34
