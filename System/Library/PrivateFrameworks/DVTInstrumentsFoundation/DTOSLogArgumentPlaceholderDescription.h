...
- (void).cxx_destruct;	// IMP=0x000000000001a8ec
...
- (unsigned long long)hash;	// IMP=0x000000000001a8ae
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000001a8a3
- (id)initWithPlaceholderToken:(id)arg1;	// IMP=0x000000000001a3d0
