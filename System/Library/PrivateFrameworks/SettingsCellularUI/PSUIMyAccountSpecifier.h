...
- (void).cxx_destruct;	// IMP=0x000000000006283b
...
- (id)getLogger;	// IMP=0x000000000006275a
- (void)launchMyAccountInSafari:(id)arg1;	// IMP=0x0000000000062626
- (void)launchMyAccountInWebView:(id)arg1;	// IMP=0x000000000006249c
- (id)initWithContext:(id)arg1 cbCache:(id)arg2;	// IMP=0x00000000000622a3
