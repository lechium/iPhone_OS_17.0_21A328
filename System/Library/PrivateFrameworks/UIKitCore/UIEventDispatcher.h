...
- (void).cxx_destruct;	// IMP=0x00000000010a19ae
- (void)dealloc;	// IMP=0x00000000010a1962
- (void)eventFetcherDidReceiveEvents:(id)arg1;	// IMP=0x00000000010a1941
- (id)initWithApplication:(id)arg1;	// IMP=0x00000000010a1531
