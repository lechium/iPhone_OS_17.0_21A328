...
+ (id)tupleWithFragmentationStreamForObject:(id)arg1 delegate:(id)arg2;	// IMP=0x0060000000ae910c
- (void).cxx_destruct;	// IMP=0x0000000000ae90b9
...
- (void)close;	// IMP=0x0000000000ae9038
@property(readonly, nonatomic, getter=isExpired) _Bool expired;
- (id)initWithFragmentationStreamForObject:(id)arg1 delegate:(id)arg2;	// IMP=0x0000000000ae8e66
