...
- (void).cxx_destruct;	// IMP=0x00000000007f06ce
...
- (id)stringFromReport:(id)arg1;	// IMP=0x00000000007f05f8
- (id)_componentsFromReport:(id)arg1;	// IMP=0x00000000007f00cb
- (id)init;	// IMP=0x00000000007f0009
