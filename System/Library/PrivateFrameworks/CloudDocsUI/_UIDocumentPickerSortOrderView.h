...
- (void).cxx_destruct;	// IMP=0x000000000000a30e
...
- (void)_toggleListMode:(id)arg1;	// IMP=0x000000000000a1da
- (void)valueChanged:(id)arg1;	// IMP=0x000000000000a149
@property(nonatomic) int value;
- (void)updateForListMode;	// IMP=0x000000000000a061
- (void)layoutSubviews;	// IMP=0x00000000000095d9
- (void)setNeedsLayout;	// IMP=0x00000000000095aa
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000000090c4
