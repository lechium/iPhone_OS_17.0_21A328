...
+ (_Bool)handleConnection:(id)arg1 server:(id)arg2;	// IMP=0x002000000000ca94
- (void).cxx_destruct;	// IMP=0x002000000000cd5d
@property(readonly, nonatomic) NSString *slotType; // @synthesize slotType=_slotType;
- (void)dealloc;	// IMP=0x001000000000ccf9
@property(readonly, nonatomic) id <TKProtocolSlotClientNotification> notification;
- (void)reportChangesForSlotType:(id)arg1 reply:(CDUnknownBlockType)arg2;	// IMP=0x001000000000cb6f
