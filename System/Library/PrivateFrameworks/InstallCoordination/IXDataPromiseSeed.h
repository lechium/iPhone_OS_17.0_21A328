...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000004920d
- (void).cxx_destruct;	// IMP=0x0000000000049371
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000049215
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000490c7
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000048f64
