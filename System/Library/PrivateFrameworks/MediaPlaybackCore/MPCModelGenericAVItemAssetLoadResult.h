...
+ (id)assetLoadResultWithStoreAssetPlaybackResponse:(id)arg1 assetLoadProperties:(id)arg2 source:(long long)arg3 error:(id *)arg4;	// IMP=0x006000000015e9aa
- (void).cxx_destruct;	// IMP=0x000000000016077a
...
- (id)descriptionDictionary;	// IMP=0x000000000015fca9
- (id)description;	// IMP=0x000000000015fc21
