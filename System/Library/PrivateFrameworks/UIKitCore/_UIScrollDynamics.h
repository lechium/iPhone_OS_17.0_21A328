...
- (void)recalculateForDecelerationTarget:(struct CGPoint)arg1;	// IMP=0x000000000162f124
- (void)calculateToReachDecelerationTarget;	// IMP=0x000000000162f11e
- (void)calculateDecelerationTarget;	// IMP=0x000000000162f118
- (_Bool)isRubberBandingAfterDuration:(double)arg1;	// IMP=0x000000000162f110
- (struct CGPoint)positionAfterDuration:(double)arg1;	// IMP=0x000000000162f0fa
- (struct CGVector)velocityAfterDuration:(double)arg1;	// IMP=0x000000000162f0ee
- (double)speedAfterDuration:(double)arg1;	// IMP=0x000000000162f0e5
@property(readonly, nonatomic) double durationUntilStop;
- (id)initWithInitialContentOffset:(struct CGPoint)arg1 velocity:(struct CGVector)arg2 contentFrame:(struct CGRect)arg3 viewSize:(struct CGSize)arg4 screenScale:(double)arg5;	// IMP=0x000000000162efd0
- (id)init;	// IMP=0x000000000162ef65
