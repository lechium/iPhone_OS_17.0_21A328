...
- (void).cxx_destruct;	// IMP=0x002000000050940a
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000005092aa
- (id)initWithTitle:(id)arg1 categoryType:(unsigned long long)arg2;	// IMP=0x0010000000509233
