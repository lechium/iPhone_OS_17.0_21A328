...
+ (id)sharedManager;	// IMP=0x006000000095e12b
- (void).cxx_destruct;	// IMP=0x000000000095dd01
...
- (void)dealloc;	// IMP=0x000000000095dadf
- (id)initWithNotificationCenter:(id)arg1 followUpManager:(id)arg2 darwinNotificationProvider:(id)arg3;	// IMP=0x000000000095d7d6
