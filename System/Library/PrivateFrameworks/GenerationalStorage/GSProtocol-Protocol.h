...
- (void)readImportCookieDataForVolumeAtURL:(NSURL *)arg1 reply:(void (^)(NSData *, NSDate *, NSError *))arg2;
- (void)storeImportCookieData:(NSData *)arg1 forVolumeURL:(NSURL *)arg2 reply:(void (^)(NSError *))arg3;
...
- (void)checkItemAtURLValidInsidePermanentStorage:(NSURL *)arg1 reply:(void (^)(_Bool, NSError *))arg2;
...
- (void)removeAdditionsUnderPath:(NSString *)arg1 additionsList:(NSArray *)arg2 completionHandler:(void (^)(NSDictionary *, NSError *))arg3;
- (void)listAdditionsUnderPath:(NSString *)arg1 withNameSpace:(NSString *)arg2 withOptions:(unsigned long long)arg3 withoutOptions:(unsigned long long)arg4 andEnumerationState:(id)arg5 completionHandler:(void (^)(NSArray *, id, NSError *))arg6;
