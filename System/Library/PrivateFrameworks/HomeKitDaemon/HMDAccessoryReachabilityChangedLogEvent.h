...
+ (_Bool)submitEventWithHistogrammedAggregateHomeDataCommonDimensions;	// IMP=0x00100000003d0724
+ (id)eventWithReachable:(_Bool)arg1 changed:(_Bool)arg2 duration:(double)arg3 accessory:(id)arg4 transportReport:(id)arg5;	// IMP=0x00100000003d0694
- (void).cxx_destruct;	// IMP=0x00000000003d061f
...
- (id)__initWithReachable:(_Bool)arg1 changed:(_Bool)arg2 duration:(double)arg3 accessory:(id)arg4 transportReport:(id)arg5;	// IMP=0x00000000003cfdff
- (id)init;	// IMP=0x00000000003cfd57
