...
+ (id)volumeController;	// IMP=0x00100000000b8514
- (void).cxx_destruct;	// IMP=0x00000000000b8478
...
- (void)endChangingVolume;	// IMP=0x00000000000b840a
- (void)beginChangingVolume;	// IMP=0x00000000000b83f3
- (void)setClientWithIdentifier:(id)arg1 forWindowSceneSessionWithIdentifier:(id)arg2;	// IMP=0x00000000000b83ed
@property(readonly, nonatomic) _Bool currentRouteHasVolumeControl;
- (void)setTargetVolume:(float)arg1;	// IMP=0x00000000000b8345
@property(readonly, nonatomic) float volume;
- (void)dealloc;	// IMP=0x00000000000b82af
- (id)init;	// IMP=0x00000000000b8214
