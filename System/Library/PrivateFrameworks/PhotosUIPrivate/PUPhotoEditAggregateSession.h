...
- (void).cxx_destruct;	// IMP=0x000000000027c942
...
- (void)finishSessionWithEnd:(long long)arg1;	// IMP=0x000000000027c861
- (id)finishSessionWithEnd:(long long)arg1 newCompositionController:(id)arg2 oldCompositionController:(id)arg3;	// IMP=0x000000000027c46e
- (void)_recordKeys:(id)arg1;	// IMP=0x000000000027c33d
- (id)_sessionKeysWithEnd:(long long)arg1;	// IMP=0x000000000027c1d8
@property(readonly, nonatomic) __weak NSArray *_autoCropKeys;
- (void)notifyDidAdjustCrop;	// IMP=0x000000000027c09d
- (void)notifyDidResetCrop;	// IMP=0x000000000027c04f
- (void)notifyDidApplyPerspectiveAutoCrop;	// IMP=0x000000000027c038
- (void)notifyDidApplyAutoCrop;	// IMP=0x000000000027bff4
- (struct __CFString *)_keyForSessionEnd:(long long)arg1;	// IMP=0x000000000027bf76
