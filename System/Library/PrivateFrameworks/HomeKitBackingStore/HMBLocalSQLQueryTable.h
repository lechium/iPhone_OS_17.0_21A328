...
- (void).cxx_destruct;	// IMP=0x000000000001f04e
...
- (void)finalize;	// IMP=0x000000000001ec1d
- (void)dealloc;	// IMP=0x000000000001eab4
- (unsigned long long)_updateQueryForZoneRow:(unsigned long long)arg1 recordRow:(unsigned long long)arg2 encodedColumns:(id)arg3 error:(id *)arg4;	// IMP=0x000000000001e989
- (id)buildQueriableFieldsForModel:(id)arg1;	// IMP=0x000000000001e841
- (unsigned long long)_deleteAllQueriesForZoneRow:(unsigned long long)arg1 error:(id *)arg2;	// IMP=0x000000000001e78f
- (unsigned long long)_deleteQueryForRecordRow:(unsigned long long)arg1 error:(id *)arg2;	// IMP=0x000000000001e6b7
- (id)performQueryOn:(id)arg1 properties:(id)arg2 filter:(CDUnknownBlockType)arg3;	// IMP=0x000000000001e515
- (id)initWithContext:(id)arg1 queryModel:(Class)arg2 prepareOnly:(_Bool)arg3;	// IMP=0x000000000001c93f
