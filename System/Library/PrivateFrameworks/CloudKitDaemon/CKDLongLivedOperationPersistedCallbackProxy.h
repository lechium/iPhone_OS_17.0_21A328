...
- (void).cxx_destruct;	// IMP=0x000000000025886b
...
- (void)forwardInvocation:(id)arg1;	// IMP=0x00000000002586b6
- (id)methodSignatureForSelector:(SEL)arg1;	// IMP=0x00000000002584fc
- (id)initWithOperationID:(id)arg1 callbackProtocol:(id)arg2 completionSelector:(SEL)arg3 operationInfoCache:(id)arg4;	// IMP=0x0000000000258461
