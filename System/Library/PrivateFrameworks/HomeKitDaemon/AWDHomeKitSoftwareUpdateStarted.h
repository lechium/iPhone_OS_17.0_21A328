...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000b11b90
- (unsigned long long)hash;	// IMP=0x0000000000b11b0d
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000b11a0b
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000b11958
- (void)copyTo:(id)arg1;	// IMP=0x0000000000b118c8
- (void)writeTo:(id)arg1;	// IMP=0x0000000000b11814
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000b1149e
- (id)dictionaryRepresentation;	// IMP=0x0000000000b112f8
- (id)description;	// IMP=0x0000000000b11249
