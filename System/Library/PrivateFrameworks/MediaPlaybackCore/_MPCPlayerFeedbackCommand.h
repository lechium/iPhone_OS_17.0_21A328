...
- (void).cxx_destruct;	// IMP=0x00000000002555af
...
- (id)changeValue:(_Bool)arg1;	// IMP=0x000000000025520c
- (id)initWithResponse:(id)arg1 mediaRemoteCommand:(unsigned int)arg2;	// IMP=0x00000000002551ca
