...
- (void).cxx_destruct;	// IMP=0x002000000000d42a
...
- (void)resetForCancel;	// IMP=0x001000000000d328
- (id)description;	// IMP=0x001000000000d1ae
- (id)initWithService:(id)arg1;	// IMP=0x001000000000cfeb
