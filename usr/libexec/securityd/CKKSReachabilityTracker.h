...
+ (_Bool)isNetworkFailureError:(id)arg1;	// IMP=0x004000000012d1e0
+ (_Bool)isNetworkError:(id)arg1;	// IMP=0x001000000012d0ad
- (void).cxx_destruct;	// IMP=0x002000000012ccb8
...
- (_Bool)isNetworkError:(id)arg1;	// IMP=0x001000000012cbdc
- (void)setNetworkReachability:(_Bool)arg1;	// IMP=0x001000000012cb62
- (void)_onqueueSetNetworkReachability:(_Bool)arg1;	// IMP=0x001000000012caa8
- (void)_onQueueResetReachabilityDependency;	// IMP=0x001000000012c77e
- (void)_onQueueRunReachabilityDependency;	// IMP=0x001000000012c640
@property(readonly) _Bool currentReachability;
- (id)description;	// IMP=0x001000000012c525
- (id)init;	// IMP=0x001000000012c2fc
