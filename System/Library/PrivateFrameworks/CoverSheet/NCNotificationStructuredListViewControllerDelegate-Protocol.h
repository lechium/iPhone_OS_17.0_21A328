...
- (struct UIEdgeInsets)notificationStructuredListViewControllerRequestsEdgeInsetsForOverlayFooterView:(NCNotificationStructuredListViewController *)arg1 forOrientation:(long long)arg2;
