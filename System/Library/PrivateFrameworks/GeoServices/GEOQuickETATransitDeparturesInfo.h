...
- (void).cxx_destruct;	// IMP=0x00000000013658b2
...
- (id)_chooseMostImportantTransitLegInRoute:(id)arg1;	// IMP=0x0000000001365728
- (id)description;	// IMP=0x000000000136566e
- (id)initWithComposedRoute:(id)arg1;	// IMP=0x00000000013655c8
