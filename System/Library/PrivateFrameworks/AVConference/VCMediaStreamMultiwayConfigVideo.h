...
- (id)streamIds;	// IMP=0x000000000032ad7a
- (void)addSubStreamConfig:(id)arg1;	// IMP=0x000000000032ad5d
- (void)addPayload:(int)arg1;	// IMP=0x000000000032ad1d
- (void)dealloc;	// IMP=0x000000000032aca2
- (id)init;	// IMP=0x000000000032ac15
