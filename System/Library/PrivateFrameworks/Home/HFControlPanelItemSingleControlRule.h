...
- (void).cxx_destruct;	// IMP=0x00000000002479e5
...
- (id)controlPanelItemForControlItems:(id)arg1;	// IMP=0x000000000024789f
- (id)initWithFilter:(CDUnknownBlockType)arg1 displayResultsGenerator:(CDUnknownBlockType)arg2;	// IMP=0x00000000002477e6
