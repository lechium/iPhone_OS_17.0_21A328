...
- (void).cxx_destruct;	// IMP=0x000000000006fe81
...
- (id)_startEntryProxy;	// IMP=0x000000000006fd69
- (id)nextObject;	// IMP=0x000000000006fc84
- (id)nextObjectWithExclusiveAccessToken:(id)arg1;	// IMP=0x000000000006f2b4
- (id)initWithSectionedIdentifierList:(id)arg1 options:(unsigned long long)arg2 startEntry:(id)arg3 endEntry:(id)arg4 withExclusiveAccessToken:(id)arg5;	// IMP=0x000000000006eeec
