...
+ (id)nonSPIEntitledMessageWithName:(id)arg1 messagePayload:(id)arg2;	// IMP=0x0020000000308f81
+ (id)entitledMessageWithName:(id)arg1 identifier:(id)arg2 messagePayload:(id)arg3;	// IMP=0x0020000000308f0a
+ (id)entitledMessageWithName:(id)arg1 messagePayload:(id)arg2;	// IMP=0x0020000000308ddf
+ (id)internalMessageWithName:(id)arg1 destination:(id)arg2 messagePayload:(id)arg3;	// IMP=0x002000000057d3a3
+ (id)internalMessageWithName:(id)arg1 messagePayload:(id)arg2 responseHandler:(CDUnknownBlockType)arg3;	// IMP=0x002000000057d354
+ (id)internalMessageWithName:(id)arg1 messagePayload:(id)arg2;	// IMP=0x002000000057d305
+ (id)homeLocationAuthorizedAndEntitledMessageWithName:(id)arg1 target:(id)arg2 messagePayload:(id)arg3;	// IMP=0x002000000079530c
+ (id)locationAuthorizedMessageWithName:(id)arg1 messagePayload:(id)arg2;	// IMP=0x00200000007952a2
- (unsigned long long)homeManagerOptions;	// IMP=0x0010000000308d8e
...
- (id)userForHome:(id)arg1;	// IMP=0x00100000009c231f
- (id)matchingRemoteIdentityUserForHome:(id)arg1;	// IMP=0x00100000009c1f69
- (_Bool)isSingleReadWriteRequest;	// IMP=0x0010000000b933fa
