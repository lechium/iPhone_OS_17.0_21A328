...
- (id).cxx_construct;	// IMP=0x000000000287e3c0
- (void).cxx_destruct;	// IMP=0x000000000287e380
@property(readonly, copy) NSString *description;
- (void)registerItemProvider:(id)arg1;	// IMP=0x000000000287e1c0
...
- (id)initWithData:(id)arg1 type:(id)arg2;	// IMP=0x000000000287e0d0
