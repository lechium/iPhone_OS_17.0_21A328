...
- (void).cxx_destruct;	// IMP=0x0000000000355e40
@property(nonatomic) struct UIEdgeInsets contentInsets; // @synthesize contentInsets=_contentInsets;
@property(copy, nonatomic) NSString *accessibilityLabel; // @synthesize accessibilityLabel=_accessibilityLabel;
- (void)setBackgroundColor:(id)arg1;	// IMP=0x0000000000355d2e
- (void)layoutSubviews;	// IMP=0x0000000000355afe
- (void)setColoringWithColorScheme:(id)arg1;	// IMP=0x00000000003559c9
@property(retain, nonatomic) UIImage *brickImage;
- (void)applyEditorialLayout:(id)arg1 orientation:(long long)arg2;	// IMP=0x00000000003554c9
