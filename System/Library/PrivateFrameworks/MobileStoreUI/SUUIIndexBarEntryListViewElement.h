...
- (void).cxx_destruct;	// IMP=0x000000000010f0ba
...
- (id)applyUpdatesWithElement:(id)arg1;	// IMP=0x000000000010ede8
- (id)initWithDOMElement:(id)arg1 parent:(id)arg2 elementFactory:(id)arg3;	// IMP=0x000000000010ec33
