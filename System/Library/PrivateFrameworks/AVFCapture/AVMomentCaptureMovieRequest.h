...
+ (id)requestWithDelegate:(id)arg1 movieRecordingSettings:(id)arg2 momentSettings:(id)arg3;	// IMP=0x006000000005d5de
...
- (void)dealloc;	// IMP=0x000000000005d6e2
- (id)_initWithDelegate:(id)arg1 movieRecordingSettings:(id)arg2 momentSettings:(id)arg3;	// IMP=0x000000000005d629
