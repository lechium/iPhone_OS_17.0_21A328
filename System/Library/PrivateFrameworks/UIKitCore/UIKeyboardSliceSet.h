...
+ (id)sliceSetWithDictionaryRepresenation:(id)arg1;	// IMP=0x0060000000e47baf
- (void).cxx_destruct;	// IMP=0x0000000000e482f3
...
- (id)description;	// IMP=0x0000000000e48013
- (void)addSlice:(id)arg1;	// IMP=0x0000000000e47ffd
- (id)initWithSliceID:(id)arg1;	// IMP=0x0000000000e47a08
