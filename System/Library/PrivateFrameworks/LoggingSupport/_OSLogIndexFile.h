...
- (void).cxx_destruct;	// IMP=0x000000000001782d
...
- (id)copyMappedChunkStore:(id *)arg1;	// IMP=0x00000000000177e1
- (_Bool)_determineTimespan;	// IMP=0x0000000000017626
- (_Bool)_loadCatalogMetadataForTimespan;	// IMP=0x0000000000017401
- (_Bool)_loadHeaderMetadata:(id)arg1;	// IMP=0x000000000001733d
- (void)dealloc;	// IMP=0x0000000000017303
- (id)initWithChunkStore:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000017243
- (id)initWithTraceFile:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000017111
