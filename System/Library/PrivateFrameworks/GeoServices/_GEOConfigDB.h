...
- (void).cxx_destruct;	// IMP=0x00000000002a5260
...
- (long long)nextId;	// IMP=0x00000000002a51f3
- (id)init:(id)arg1 cache:(id)arg2 operationQueue:(id)arg3 clearFunction:(CDUnknownFunctionPointerType)arg4 setFunction:(CDUnknownFunctionPointerType)arg5 addFunction:(CDUnknownFunctionPointerType)arg6 tableName:(id)arg7;	// IMP=0x00000000002a4fec
