...
- (void).cxx_destruct;	// IMP=0x00000000004d3445
...
- (void)viewModel:(id)arg1 didChange:(id)arg2;	// IMP=0x00000000004d335b
- (void)observable:(id)arg1 didChange:(unsigned long long)arg2 context:(void *)arg3;	// IMP=0x00000000004d3319
- (void)_updateVisibilityAnimated:(_Bool)arg1;	// IMP=0x00000000004d319c
- (void)_updateBarLayout;	// IMP=0x00000000004d30d6
- (void)_updateControls;	// IMP=0x00000000004d2ff3
- (void)_handleRetakeButtonTapped:(id)arg1;	// IMP=0x00000000004d2e86
- (void)_handleDoneButtonTapped:(id)arg1;	// IMP=0x00000000004d2e44
- (void)becomeReusable;	// IMP=0x00000000004d2dea
- (id)loadView;	// IMP=0x00000000004d2d11
