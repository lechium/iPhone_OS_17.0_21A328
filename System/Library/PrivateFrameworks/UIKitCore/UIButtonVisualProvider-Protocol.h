...
@class NSAttributedString, NSString, UIButton, UIContextMenuConfiguration, UIContextMenuInteraction, UIFocusAnimationCoordinator, UIFocusUpdateContext, UIImage, UIImageSymbolConfiguration, UIImageView, UILabel, UIMenu, UIPointerEffect, UIPointerShape, UIPreviewParameters, UIScreen, UIShape, UITargetedPreview, UITraitCollection, UIView, UIVisualEffectView, UIWindow, _UIContextMenuStyle, _UIFocusAnimationConfiguration;
@protocol UIButtonVisualProvider, UIHoverEffect, UIPointerInteractionAnimating;
...
- (id <UIHoverEffect>)preferredHoverEffect;
