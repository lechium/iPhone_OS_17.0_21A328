...
@interface _TtC7NewsUI243TodayFeedWithLargeCarouselAdsScrollTestCase : NSObject
{
...
- (void).cxx_destruct;	// IMP=0x00000000000e1840
- (id)init;	// IMP=0x00000000000e1810
- (id)scrollViewWithContext:(id)arg1;	// IMP=0x00000000000e16a0
