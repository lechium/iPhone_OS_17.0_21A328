...
- (void)dealloc;	// IMP=0x00000000001454bc
- (id)init;	// IMP=0x00000000001454a3
- (id)initWithExternalDevice:(id)arg1 client:(id)arg2 reason:(id)arg3;	// IMP=0x00000000001453c3
