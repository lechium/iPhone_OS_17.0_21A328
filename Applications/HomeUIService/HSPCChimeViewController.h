...
+ (_Bool)shouldSkipForAccessory:(id)arg1 inHome:(id)arg2;	// IMP=0x00200000000303d7
+ (_Bool)_shouldShowTraditionalChimeFeatureForAccessory:(id)arg1;	// IMP=0x001000000003038c
+ (id)_muteCharacteristicForAccessory:(id)arg1;	// IMP=0x001000000003030f
+ (_Bool)_shouldShowHomePodChimeFeatureForHome:(id)arg1;	// IMP=0x0010000000030223
- (void).cxx_destruct;	// IMP=0x00200000000304f4
...
- (_Bool)isHomePodChimeEnabled;	// IMP=0x001000000003018a
- (_Bool)isTraditionalChimeEnabled;	// IMP=0x001000000003008a
- (id)setHomePodChime:(_Bool)arg1;	// IMP=0x001000000002fe94
- (void)setTraditionalDoorbellChime:(_Bool)arg1;	// IMP=0x001000000002fe1e
- (void)viewDidLoad;	// IMP=0x001000000002fcf6
- (id)commitConfiguration;	// IMP=0x001000000002fb4f
- (id)initWithCoordinator:(id)arg1 config:(id)arg2;	// IMP=0x001000000002f733
