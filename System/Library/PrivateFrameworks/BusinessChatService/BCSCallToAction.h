...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000003234
- (unsigned long long)hash;	// IMP=0x0000000000003186
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000003044
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000002f32
- (void)copyTo:(id)arg1;	// IMP=0x0000000000002e6f
- (void)writeTo:(id)arg1;	// IMP=0x0000000000002db1
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000002da4
- (id)dictionaryRepresentation;	// IMP=0x0000000000002a14
- (id)description;	// IMP=0x0000000000002965
