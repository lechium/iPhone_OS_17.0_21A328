...
- (void).cxx_destruct;	// IMP=0x00000000002e7460
...
- (_Bool)setUp;	// IMP=0x00000000002e73b2
- (id)initWithEntryName:(id)arg1 outputStream:(id)arg2 isCompressed:(_Bool)arg3;	// IMP=0x00000000002e72cf
