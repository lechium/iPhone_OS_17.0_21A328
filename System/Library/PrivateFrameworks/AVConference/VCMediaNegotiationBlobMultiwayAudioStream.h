...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000000424b5
- (unsigned long long)hash;	// IMP=0x00000000000422c4
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000042164
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000042058
- (void)copyTo:(id)arg1;	// IMP=0x0000000000041f8a
- (void)writeTo:(id)arg1;	// IMP=0x0000000000041e55
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000041e48
- (id)dictionaryRepresentation;	// IMP=0x000000000004164e
- (id)description;	// IMP=0x00000000000415b4
...
- (void)printWithLogFile:(void *)arg1;	// IMP=0x00000000003b6748
- (id)newMultiwayAudioStream;	// IMP=0x00000000003b65a3
- (void)setPayloadFlagsWithPayloads:(id)arg1;	// IMP=0x00000000003b642e
- (id)initWithStreamConfig:(id)arg1;	// IMP=0x00000000003b6283
