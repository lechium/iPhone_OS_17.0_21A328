...
- (void).cxx_destruct;	// IMP=0x0000000000819480
...
- (id)mainReturningError;	// IMP=0x0000000000818e6c
- (id)initWithUUID:(id)arg1 pushingTo:(unsigned long long)arg2 resultBlock:(CDUnknownBlockType)arg3;	// IMP=0x0000000000818dc4
