...
- (void).cxx_destruct;	// IMP=0x00000000005a39d1
...
- (void)computeNextRetryInterval;	// IMP=0x00000000005a38fa
@property double retryInterval; // @synthesize retryInterval=_retryInterval;
- (id)initWithWorkQueue:(id)arg1 homePresenceByPairingIdentity:(id)arg2 preferences:(id)arg3;	// IMP=0x00000000005a3627
- (id)initWithWorkQueue:(id)arg1 homePresenceByPairingIdentity:(id)arg2;	// IMP=0x00000000005a3590
