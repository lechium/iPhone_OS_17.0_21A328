...
- (void).cxx_destruct;	// IMP=0x0000000000a2f25b
...
- (id)description;	// IMP=0x0000000000a2f0e1
- (id)initWithServer:(id)arg1 primaryAccessoryUUID:(id)arg2 certificationStatus:(long long)arg3 configurationAppIdentifier:(id)arg4 hostAccessory:(id)arg5 networkCredential:(id)arg6 pairingEvent:(id)arg7;	// IMP=0x0000000000a2efb1
