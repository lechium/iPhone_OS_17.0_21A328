...
- (void).cxx_destruct;	// IMP=0x000000000003c0ef
...
- (void)_handleSingleTap:(id)arg1;	// IMP=0x000000000003be27
- (void)_handlePinch:(id)arg1;	// IMP=0x000000000003bcef
- (void)_handleDoubleTap:(id)arg1;	// IMP=0x000000000003bc16
...
- (void)finalizeZoomingImageTransitionWithContext:(id)arg1 transitionFinished:(_Bool)arg2;	// IMP=0x000000000003b588
- (void)performZoomingImageTransitionWithContext:(id)arg1;	// IMP=0x000000000003b51f
- (void)prepareZoomingImageTransitionWithContext:(id)arg1;	// IMP=0x000000000003b478
- (void)viewDidAppear:(_Bool)arg1;	// IMP=0x000000000003b3e5
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x000000000003b39f
- (void)updateViewConstraints;	// IMP=0x000000000003a9bd
- (void)viewDidLoad;	// IMP=0x000000000003a009
- (_Bool)prefersStatusBarHidden;	// IMP=0x0000000000039fc5
- (void)dealloc;	// IMP=0x0000000000039e6b
