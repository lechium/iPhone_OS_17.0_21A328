...
- (void).cxx_destruct;	// IMP=0x00200000000c1422
...
- (void)downloadEditorialItemWithIDs:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00100000000c0d41
- (id)initWithTagController:(id)arg1 editorialItemEntryManager:(id)arg2;	// IMP=0x00100000000c0c5f
