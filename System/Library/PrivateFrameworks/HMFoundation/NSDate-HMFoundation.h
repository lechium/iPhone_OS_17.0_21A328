...
+ (id)shortDescription;	// IMP=0x0010000000048b73
+ (id)timeIntervalDescription:(double)arg1;	// IMP=0x0010000000048d33
- (id)hmf_dateComponentsUsingTimeZone:(id)arg1;	// IMP=0x0010000000048c94
