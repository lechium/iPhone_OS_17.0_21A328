...
@interface _TtC8StocksUI24ForYouFeedMemoryTestCase : NSObject
{
...
- (void).cxx_destruct;	// IMP=0x00000000000e1080
- (id)init;	// IMP=0x00000000000e0fc0
- (void)runTestWithContext:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000000000e0f30
