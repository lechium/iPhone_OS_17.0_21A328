...
- (void).cxx_destruct;	// IMP=0x00200000003ceb70
...
- (void)updateWithRefinedWaypoints:(id)arg1;	// IMP=0x00100000003ce95b
- (id)makeRouteAttributesBuilderWithNavigationMode:(unsigned long long)arg1;	// IMP=0x00100000003ce8f2
@property(readonly, nonatomic) CyclePreferences *cyclePreferences;
- (id)initWithPreferences:(id)arg1 timing:(id)arg2;	// IMP=0x00100000003ce84b
