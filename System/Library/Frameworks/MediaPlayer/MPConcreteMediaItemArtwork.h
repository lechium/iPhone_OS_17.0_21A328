...
- (void).cxx_destruct;	// IMP=0x000000000013e3a7
@property(readonly, nonatomic) MPArtworkCatalog *artworkCatalog;
- (struct CGRect)bounds;	// IMP=0x000000000013e242
- (id)initWithArtworkCatalog:(id)arg1;	// IMP=0x000000000013e22e
- (id)initWithArtworkCatalog:(id)arg1 allowsNetworking:(_Bool)arg2;	// IMP=0x000000000013e15a
