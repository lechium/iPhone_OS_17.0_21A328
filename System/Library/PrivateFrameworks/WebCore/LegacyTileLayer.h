...
- (id)actionForKey:(id)arg1;	// IMP=0x0000000000e465f0
- (void)drawInContext:(struct CGContext *)arg1;	// IMP=0x0000000000e46580
- (void)renderInContext:(struct CGContext *)arg1;	// IMP=0x0000000000e46520
- (void)layoutSublayers;	// IMP=0x0000000000e464e0
- (void)setNeedsDisplayInRect:(struct CGRect)arg1;	// IMP=0x0000000000e46490
