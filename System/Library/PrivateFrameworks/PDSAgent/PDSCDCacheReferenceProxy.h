...
- (void).cxx_destruct;	// IMP=0x000000000001460e
...
- (id)forwardingTargetForSelector:(SEL)arg1;	// IMP=0x00000000000145b2
- (_Bool)conformsToProtocol:(id)arg1;	// IMP=0x0000000000014544
- (id)initWithCacheContainer:(id)arg1 persistentContainer:(id)arg2;	// IMP=0x00000000000144c6
