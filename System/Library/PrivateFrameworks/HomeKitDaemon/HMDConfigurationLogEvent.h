...
- (void).cxx_destruct;	// IMP=0x00000000002a9ad3
...
- (_Bool)isSubmitted;	// IMP=0x00000000002a980a
...
- (id)initWithHomeConfigurations:(id)arg1 isFMFDevice:(_Bool)arg2;	// IMP=0x00000000002a8d8b
- (id)initWithHomeManager:(id)arg1 metadataVersion:(unsigned int)arg2;	// IMP=0x00000000002a8af8
