...
- (void).cxx_destruct;	// IMP=0x000000000001f5f9
...
- (id)_textScaleUpSpringAnimation;	// IMP=0x000000000001f514
- (id)_backdropEffectRemovalAnimationForKeyPath:(id)arg1;	// IMP=0x000000000001f4c6
- (id)_basicAnimationToDecreaseOpacity;	// IMP=0x000000000001f489
- (id)_springAnimationToDecreaseOpacity;	// IMP=0x000000000001f434
- (id)_animationForTranslationY:(double)arg1;	// IMP=0x000000000001f396
- (void)_reloadTapped:(id)arg1;	// IMP=0x000000000001f37c
- (void)_showCompletionAnimation:(CDUnknownBlockType)arg1;	// IMP=0x000000000001f15c
- (void)_updateConicGradientRotation;	// IMP=0x000000000001f007
- (void)_revealBackgroundAndLabels;	// IMP=0x000000000001edd3
- (void)_startAnimationIfNeeded;	// IMP=0x000000000001ecac
- (void)_updateLoadingProgress;	// IMP=0x000000000001ebd6
- (_Bool)_loadingIsComplete;	// IMP=0x000000000001ebba
- (void)finishLoadingWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000000001e646
- (void)setLoadingProgress:(float)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000000001e40c
- (void)setBackgroundImage:(id)arg1 animated:(_Bool)arg2;	// IMP=0x000000000001e1e8
@property(readonly, nonatomic) UIImage *backgroundImage;
- (void)setLoadingHasFailed:(_Bool)arg1 animated:(_Bool)arg2 reason:(id)arg3 reloadHandler:(CDUnknownBlockType)arg4;	// IMP=0x000000000001ded2
- (void)layoutSubviews;	// IMP=0x000000000001d4db
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000001d48e
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000001c816
