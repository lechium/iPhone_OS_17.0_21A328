...
+ (id)options;	// IMP=0x002000000004921c
- (void).cxx_destruct;	// IMP=0x002000000004a0a7
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000049ece
- (unsigned long long)hash;	// IMP=0x0010000000049ddc
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000049c36
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000049adf
- (void)copyTo:(id)arg1;	// IMP=0x00100000000499df
- (void)writeTo:(id)arg1;	// IMP=0x00100000000498d9
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000000498cc
- (id)dictionaryRepresentation;	// IMP=0x0010000000049412
- (id)description;	// IMP=0x0010000000049363
