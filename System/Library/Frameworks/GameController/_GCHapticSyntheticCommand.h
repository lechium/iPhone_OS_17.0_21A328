...
- (void).cxx_destruct;	// IMP=0x00000000000f0f0f
...
- (id)description;	// IMP=0x00000000000f0e9c
...
- (void)cancel;	// IMP=0x00000000000f0e49
- (void)preprocessCommand:(const void *)arg1;	// IMP=0x00000000000f0dbc
- (id)initWithHapticCommand:(const void *)arg1;	// IMP=0x00000000000f0ccb
