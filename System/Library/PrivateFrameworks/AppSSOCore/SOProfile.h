...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000000085b0
+ (id)stringWithAuthenticationMethod:(long long)arg1;	// IMP=0x001000000000834d
+ (id)stringWithScreenLockedBehavior:(long long)arg1;	// IMP=0x0010000000008305
+ (id)stringWithProfileType:(long long)arg1;	// IMP=0x00100000000082bd
- (void).cxx_destruct;	// IMP=0x0000000000008dc2
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000008c37
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000089bd
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000085b8
- (id)description;	// IMP=0x000000000000839a
