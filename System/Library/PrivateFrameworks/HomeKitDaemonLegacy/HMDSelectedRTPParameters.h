...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000007624c
- (void).cxx_destruct;	// IMP=0x00000000000761c6
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000075f76
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000075ae1
- (void)description:(id)arg1 indent:(id)arg2;	// IMP=0x000000000007589f
- (_Bool)_parseFromTLVData;	// IMP=0x0000000000075521
@property(readonly, copy) NSData *tlvData;
- (id)initWithPayloadType:(id)arg1 maximumBitrate:(id)arg2 minimumBitrate:(id)arg3 rtcpInterval:(id)arg4 comfortNoisePayloadType:(id)arg5;	// IMP=0x00000000000751e9
