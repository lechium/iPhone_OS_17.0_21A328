...
- (void).cxx_destruct;	// IMP=0x00000000000e8730
- (id)init;	// IMP=0x00000000000e86e0
- (id)initWithTitle:(id)arg1 image:(id)arg2 actionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000000000e8630
