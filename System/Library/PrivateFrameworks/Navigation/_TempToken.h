...
- (void).cxx_destruct;	// IMP=0x00000000000171d2
...
- (id)initWithToken:(id)arg1;	// IMP=0x0000000000016df6
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000016c44
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000001683a
