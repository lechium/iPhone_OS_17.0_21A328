...
- (void).cxx_destruct;	// IMP=0x0000000000200c29
...
- (id)mainReturningError;	// IMP=0x000000000020095c
- (id)initWithGroup:(id)arg1 fetchResult:(CDUnknownBlockType)arg2;	// IMP=0x00000000002008a0
