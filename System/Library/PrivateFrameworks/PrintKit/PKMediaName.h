...
+ (id)pkMediaNameWithString:(id)arg1;	// IMP=0x0060000000024150
...
- (void)parseMediaName:(id)arg1;	// IMP=0x000000000002431b
- (void)dealloc;	// IMP=0x0000000000024258
- (id)initWithString:(id)arg1;	// IMP=0x00000000000241ae
