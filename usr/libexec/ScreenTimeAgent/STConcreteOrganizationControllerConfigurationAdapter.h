...
- (void).cxx_destruct;	// IMP=0x002000000001d2b2
...
- (id)_handleConfigurationAsSettings:(id)arg1;	// IMP=0x001000000001ccf7
- (id)_handleConfigurationAsBlueprint:(id)arg1 timeout:(unsigned long long)arg2;	// IMP=0x001000000001c52e
- (id)handleConfigurationChange:(id)arg1;	// IMP=0x001000000001bf92
- (id)initWithFamilySettingsManager:(id)arg1 requestManager:(id)arg2 persistentContainer:(id)arg3;	// IMP=0x001000000001becc
