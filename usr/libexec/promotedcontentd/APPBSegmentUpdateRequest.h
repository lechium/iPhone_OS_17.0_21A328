...
+ (id)options;	// IMP=0x002000000008d142
- (void).cxx_destruct;	// IMP=0x002000000008fa78
...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000008f6c4
- (unsigned long long)hash;	// IMP=0x001000000008f2a5
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000008efd9
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000008edbe
- (void)copyTo:(id)arg1;	// IMP=0x001000000008ead9
- (void)writeTo:(id)arg1;	// IMP=0x001000000008e8c5
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000008e8b8
- (id)dictionaryRepresentation;	// IMP=0x001000000008db02
- (id)description;	// IMP=0x001000000008da53
- (int)StringAsAccountStates:(id)arg1;	// IMP=0x001000000008d9bc
- (id)accountStatesAsString:(int)arg1;	// IMP=0x001000000008d973
- (void)setAccountStates:(int *)arg1 count:(unsigned long long)arg2;	// IMP=0x001000000008d95c
- (int)accountStateAtIndex:(unsigned long long)arg1;	// IMP=0x001000000008d88c
- (void)addAccountState:(int)arg1;	// IMP=0x001000000008d879
- (void)clearAccountStates;	// IMP=0x001000000008d868
@property(readonly, nonatomic) int *accountStates;
@property(readonly, nonatomic) unsigned long long accountStatesCount;
- (int)StringAsAccountTypes:(id)arg1;	// IMP=0x001000000008d70a
- (id)accountTypesAsString:(int)arg1;	// IMP=0x001000000008d6c1
- (void)setAccountTypes:(int *)arg1 count:(unsigned long long)arg2;	// IMP=0x001000000008d6aa
- (int)accountTypeAtIndex:(unsigned long long)arg1;	// IMP=0x001000000008d5da
- (void)addAccountType:(int)arg1;	// IMP=0x001000000008d5c7
- (void)clearAccountTypes;	// IMP=0x001000000008d5b6
@property(readonly, nonatomic) int *accountTypes;
@property(readonly, nonatomic) unsigned long long accountTypesCount;
- (int)StringAsDeviceModes:(id)arg1;	// IMP=0x001000000008d4fc
- (id)deviceModesAsString:(int)arg1;	// IMP=0x001000000008d4b3
- (void)setDeviceModes:(int *)arg1 count:(unsigned long long)arg2;	// IMP=0x001000000008d49c
- (int)deviceModeAtIndex:(unsigned long long)arg1;	// IMP=0x001000000008d3cc
- (void)addDeviceMode:(int)arg1;	// IMP=0x001000000008d3b9
- (void)clearDeviceModes;	// IMP=0x001000000008d3a8
...
- (void)dealloc;	// IMP=0x001000000008d0e4
