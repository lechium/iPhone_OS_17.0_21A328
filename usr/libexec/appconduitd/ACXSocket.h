...
- (void).cxx_destruct;	// IMP=0x002000000003526b
...
- (id)readDataOrDictionaryWithError:(id *)arg1;	// IMP=0x001000000003494a
- (id)readDictionaryWithError:(id *)arg1;	// IMP=0x0010000000034806
- (id)readDataWithError:(id *)arg1;	// IMP=0x00100000000346c2
- (_Bool)writeShutdownMessageWithError:(id *)arg1;	// IMP=0x0010000000034651
- (_Bool)writePingWithError:(id *)arg1;	// IMP=0x00100000000345e0
- (_Bool)writeDictionary:(id)arg1 error:(id *)arg2;	// IMP=0x00100000000343e1
- (_Bool)writeData:(id)arg1 error:(id *)arg2;	// IMP=0x0010000000034360
- (_Bool)writeBytes:(const void *)arg1 length:(unsigned long long)arg2 error:(id *)arg3;	// IMP=0x0010000000034129
- (void)_setUpSocketReadSource;	// IMP=0x0010000000033e8f
- (void)invalidate;	// IMP=0x0010000000033d64
- (void)noteWifiAsserted:(_Bool)arg1;	// IMP=0x0010000000033d5b
- (void)suspendReadSource;	// IMP=0x0010000000033cf3
- (void)resumeReadSource;	// IMP=0x0010000000033c88
- (id)initWithIDSDeviceConnection:(id)arg1 boostingMessageContext:(id)arg2 streamName:(id)arg3 creationTime:(id)arg4 readEventHandler:(CDUnknownBlockType)arg5;	// IMP=0x0010000000033b57
- (id)initWithSocket:(int)arg1 streamName:(id)arg2 creationTime:(id)arg3 readEventHandler:(CDUnknownBlockType)arg4;	// IMP=0x0010000000033a79
