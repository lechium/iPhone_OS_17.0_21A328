...
+ (long long)content_typeForImmutableObject:(id)arg1;	// IMP=0x001000000017f733
+ (Class)content_immutableClassForType:(long long)arg1;	// IMP=0x001000000017f6f9
- (void).cxx_destruct;	// IMP=0x000000000017fe45
- (id)flatbuffData;	// IMP=0x000000000017fcbe
- (Offset_c5a53c72)addObjectToBuffer:(void *)arg1;	// IMP=0x000000000017f8b1
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000017ef16
- (id)initWithFlatbuffData:(id)arg1 root:(const struct SpeechTranslationStreamingRequest *)arg2 verify:(_Bool)arg3;	// IMP=0x000000000017ed33
- (id)initWithFlatbuffData:(id)arg1 root:(const struct SpeechTranslationStreamingRequest *)arg2;	// IMP=0x000000000017ed1e
- (id)initAndVerifyWithFlatbuffData:(id)arg1;	// IMP=0x000000000017ed04
- (id)initWithFlatbuffData:(id)arg1;	// IMP=0x000000000017eced
