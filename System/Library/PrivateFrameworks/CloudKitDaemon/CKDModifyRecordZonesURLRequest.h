...
- (void).cxx_destruct;	// IMP=0x000000000037d41d
...
- (void)requestDidParseNodeFailure:(id)arg1;	// IMP=0x000000000037d1ec
- (id)requestDidParseProtobufObject:(id)arg1;	// IMP=0x000000000037cf2c
- (id)generateRequestOperations;	// IMP=0x000000000037c616
- (id)requestOperationClasses;	// IMP=0x000000000037c52f
- (id)zoneIDsToLock;	// IMP=0x000000000037c275
- (_Bool)requiresCKAnonymousUserIDs;	// IMP=0x000000000037c26d
- (void)fillOutRequestProperties:(id)arg1;	// IMP=0x000000000037c167
- (void)fillOutEquivalencyPropertiesBuilder:(id)arg1;	// IMP=0x000000000037bff8
- (id)initWithOperation:(id)arg1 recordZonesToSave:(id)arg2 recordZoneIDsToDelete:(id)arg3;	// IMP=0x000000000037bf2f
