...
- (void).cxx_destruct;	// IMP=0x000000000014dbf6
...
- (void)_updateCountViews;	// IMP=0x000000000014d968
- (id)initWithDetailLabel:(_Bool)arg1 reuseIdentifier:(id)arg2;	// IMP=0x000000000014ca0b
