...
- (_Bool)iconManager:(SBHIconManager *)arg1 isTimedOutForDataSourceContainerBundleIdentifier:(NSString *)arg2;
- (_Bool)iconManager:(SBHIconManager *)arg1 allowsRemovalOfIconDataSourceWithinStack:(id <SBLeafIconDataSource>)arg2;
...
- (_Bool)iconManager:(SBHIconManager *)arg1 dragsSupportSystemDragsForIconView:(SBIconView *)arg2;
