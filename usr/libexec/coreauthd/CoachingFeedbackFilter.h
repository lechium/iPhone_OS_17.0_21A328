...
- (void).cxx_destruct;	// IMP=0x00200000000026e7
...
- (void)_dispatchPendingBlocks;	// IMP=0x00100000000024d7
- (void)dispatchNowOrWhenFeedbackDurationAchieved:(_Bool)arg1 finish:(_Bool)arg2 block:(CDUnknownBlockType)arg3;	// IMP=0x00100000000022a9
- (void)_doneWaiting;	// IMP=0x00100000000021ea
- (void)_sendFeedback:(long long)arg1;	// IMP=0x0010000000001f28
- (double)_timeoutForFeedback:(long long)arg1;	// IMP=0x0010000000001f02
- (void)scheduleFeedback:(long long)arg1;	// IMP=0x0010000000001cc7
- (id)initWithDelegate:(id)arg1 feedbackSet:(id)arg2 feedbackDuration:(double)arg3 iconDuration:(double)arg4;	// IMP=0x0010000000001bfb
