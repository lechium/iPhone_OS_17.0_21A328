...
- (void).cxx_destruct;	// IMP=0x000000000006d4f6
...
- (id)initWithXPCObject:(id)arg1 context:(id)arg2 error:(unsigned long long *)arg3;	// IMP=0x000000000006d227
- (id)initWithConcreteContainer:(id)arg1 context:(id)arg2;	// IMP=0x000000000006d18c
