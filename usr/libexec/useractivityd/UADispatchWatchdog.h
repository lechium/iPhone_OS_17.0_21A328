...
- (void).cxx_destruct;	// IMP=0x002000000001b7f6
...
- (void)_triggerWatchdog;	// IMP=0x001000000001b5be
- (void)cancel;	// IMP=0x001000000001b4ca
- (void)poke;	// IMP=0x001000000001b43d
- (void)start;	// IMP=0x001000000001b227
- (void)dealloc;	// IMP=0x001000000001b1c4
- (id)initWithName:(id)arg1 timeout:(double)arg2 block:(CDUnknownBlockType)arg3;	// IMP=0x001000000001b100
