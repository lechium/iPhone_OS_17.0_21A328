...
+ (id)reuseIdentifier;	// IMP=0x00100000002af507
...
- (id)hitTest:(struct CGPoint)arg1 withEvent:(id)arg2;	// IMP=0x00000000002af52f
- (void)forceUnreadIndicatorVisibility:(_Bool)arg1 forConversation:(id)arg2 animated:(_Bool)arg3;	// IMP=0x00000000002af529
- (id)avatarView;	// IMP=0x00000000002af521
- (_Bool)avatarView:(id)arg1 shouldShowContact:(id)arg2;	// IMP=0x00000000002af519
