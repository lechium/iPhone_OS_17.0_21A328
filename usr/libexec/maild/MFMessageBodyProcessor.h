...
+ (id)powernapProcessor;	// IMP=0x002000000008c823
+ (void)initialize;	// IMP=0x001000000008c7dc
- (void).cxx_destruct;	// IMP=0x002000000008df1b
...
- (id)_mailboxesToDownload;	// IMP=0x001000000008d7a3
- (_Bool)_shouldContinueProcessing;	// IMP=0x001000000008d5ba
- (void)_runSynchronously;	// IMP=0x001000000008d191
@property(readonly, nonatomic) MailPersistentStorage *persistentStorage;
- (_Bool)mailboxMessageBodyProcessorShouldContinueProcessing:(id)arg1;	// IMP=0x001000000008d166
- (void)runWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x001000000008d10f
- (_Bool)runSynchronouslyWithDuration:(long long)arg1;	// IMP=0x001000000008cbc7
- (_Bool)runSynchronously;	// IMP=0x001000000008cbae
- (id)initWithName:(id)arg1 accountsProvider:(id)arg2 deviceStorage:(id)arg3 condition:(id)arg4;	// IMP=0x001000000008ca31
