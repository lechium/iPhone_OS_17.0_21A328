...
- (void).cxx_destruct;	// IMP=0x002000000000534d
...
- (void)stopProducingData;	// IMP=0x0010000000005269
- (id)startProducingDataWithCallback:(CDUnknownBlockType)arg1;	// IMP=0x0010000000004f89
- (id)initWithConfiguration:(id)arg1 receiverQueue:(id)arg2;	// IMP=0x0010000000004e8b
