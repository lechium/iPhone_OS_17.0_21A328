...
- (void).cxx_destruct;	// IMP=0x000000000003141b
...
- (id)description;	// IMP=0x00000000000311f4
- (void)retryGroup:(id)arg1;	// IMP=0x00000000000310d5
- (void)daemonDidRebootstrap:(id)arg1;	// IMP=0x0000000000031077
- (void)endViewRender;	// IMP=0x0000000000030c2a
- (void)beginViewRender;	// IMP=0x00000000000309af
- (void)iconArtwork:(id)arg1 didFailFetchWithError:(id)arg2;	// IMP=0x00000000000307c5
- (void)iconArtwork:(id)arg1 didFetchImage:(id)arg2;	// IMP=0x00000000000304e0
- (void)request:(id)arg1 didFailWithError:(id)arg2;	// IMP=0x000000000002ffe0
- (void)request:(id)arg1 didCompleteWithLockup:(id)arg2;	// IMP=0x000000000002fcc1
- (void)requestWillFetchLockup:(id)arg1;	// IMP=0x000000000002fbde
- (void)performFollowUpWork:(CDUnknownBlockType)arg1;	// IMP=0x000000000002fb80
- (void)performIconFetch;	// IMP=0x000000000002f725
- (void)performLockupFetch;	// IMP=0x000000000002f275
- (_Bool)retryRequestIfNeeded;	// IMP=0x000000000002f08c
- (void)reloadDefaultContent;	// IMP=0x000000000002efdf
- (void)clearContent;	// IMP=0x000000000002ee7b
- (void)showPlaceholderContent;	// IMP=0x000000000002ec92
@property(readonly, nonatomic) _Bool prefersRightToLeftViewLayout;
- (void)dealloc;	// IMP=0x000000000002e67a
- (id)initWithView:(id)arg1 offerPresenter:(id)arg2 metricsPresenter:(id)arg3;	// IMP=0x000000000002e5ca
- (id)initWithView:(id)arg1 offerPresenter:(id)arg2 metricsPresenter:(id)arg3 context:(id)arg4;	// IMP=0x000000000002e47f
