...
- (void).cxx_destruct;	// IMP=0x0020000000020d97
...
- (void)_updateColors;	// IMP=0x0010000000020b3a
- (struct CGSize)systemLayoutSizeFittingSize:(struct CGSize)arg1;	// IMP=0x0010000000020ae0
- (struct CGSize)intrinsicContentSize;	// IMP=0x0010000000020a86
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x0010000000020a74
- (_Bool)canBecomeFocused;	// IMP=0x0010000000020a6c
- (void)action;	// IMP=0x00100000000209d1
- (id)initWithConfig:(id)arg1 color:(id)arg2;	// IMP=0x0010000000020385
