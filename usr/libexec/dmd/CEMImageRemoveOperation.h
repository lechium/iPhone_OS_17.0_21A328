...
- (void).cxx_destruct;	// IMP=0x00200000000067ed
...
- (void)main;	// IMP=0x001000000000667d
- (id)initWithImageDeclaration:(id)arg1 installMetadata:(id)arg2;	// IMP=0x00100000000065db
