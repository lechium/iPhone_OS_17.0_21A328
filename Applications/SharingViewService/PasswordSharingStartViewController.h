...
- (void).cxx_destruct;	// IMP=0x002000000017c265
...
- (void)handleTapOutsideView:(id)arg1;	// IMP=0x001000000017c151
- (void)handleDismissButtonPressed:(id)arg1;	// IMP=0x001000000017c0c9
- (void)handleAllowButtonPressed:(id)arg1;	// IMP=0x001000000017be45
- (_Bool)gestureRecognizer:(id)arg1 shouldReceiveTouch:(id)arg2;	// IMP=0x001000000017bdc9
- (void)configureUIElementsForHotspot;	// IMP=0x001000000017bb69
- (void)configureUIElementsDefault;	// IMP=0x001000000017b689
- (void)viewDidDisappear:(_Bool)arg1;	// IMP=0x001000000017b5d3
- (void)viewDidAppear:(_Bool)arg1;	// IMP=0x001000000017b52c
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x001000000017b3bc
