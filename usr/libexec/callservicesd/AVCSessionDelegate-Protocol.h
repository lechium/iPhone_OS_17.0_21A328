...
@class AVCSession, AVCSessionConfiguration, AVCSessionParticipant, NSData, NSDictionary, NSError, NSString;
...
@optional
- (void)sessionDidStopReacting:(AVCSession *)arg1;
- (void)session:(AVCSession *)arg1 didReact:(NSString *)arg2;
...
- (void)session:(AVCSession *)arg1 mixingDidStopForMediaType:(unsigned int)arg2;
- (void)session:(AVCSession *)arg1 mixingDidStartForMediaType:(unsigned int)arg2 mixingMediaType:(unsigned int)arg3;
