...
- (void).cxx_destruct;	// IMP=0x0000000000836e29
...
- (void)performHapticFeedbackForFocusUpdateInContext:(id)arg1;	// IMP=0x0000000000836c18
- (id)initWithScreen:(id)arg1;	// IMP=0x0000000000836b9d
