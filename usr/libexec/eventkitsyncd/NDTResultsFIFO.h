...
- (void).cxx_destruct;	// IMP=0x0020000000040959
...
- (void)terminateIfNotFinished;	// IMP=0x00100000000406b8
- (void)terminate;	// IMP=0x00100000000405ec
- (id)pop;	// IMP=0x00100000000404db
- (void)conditionalPop:(CDUnknownBlockType)arg1;	// IMP=0x001000000004023b
- (void)finish;	// IMP=0x0010000000040181
- (_Bool);	// IMP=0x001000000003ff45
- (id)initWithFIFOLength:(long long)arg1 name:(id)arg2;	// IMP=0x001000000003fe71
- (id)init;	// IMP=0x001000000003fe58
