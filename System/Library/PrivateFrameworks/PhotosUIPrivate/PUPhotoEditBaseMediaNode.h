...
- (void).cxx_destruct;	// IMP=0x00000000003dd131
...
- (void)runNode:(id)arg1 didCompleteWithError:(id)arg2;	// IMP=0x00000000003dd02f
- (void)run;	// IMP=0x00000000003dcdb8
- (id)initWithAdjustmentNode:(id)arg1;	// IMP=0x00000000003dccec
