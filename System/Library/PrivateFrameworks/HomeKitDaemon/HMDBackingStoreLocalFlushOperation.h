...
- (void).cxx_destruct;	// IMP=0x000000000086749a
...
- (void)main;	// IMP=0x0000000000866e73
- (id)initWithStore:(id)arg1 clearCloud:(_Bool)arg2 resultHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000000866da6
