...
- (void).cxx_destruct;	// IMP=0x000000000002c629
...
- (long long)pageComponentType;	// IMP=0x000000000002c5c9
- (unsigned long long)elementType;	// IMP=0x000000000002c5be
- (id)applyUpdatesWithElement:(id)arg1;	// IMP=0x000000000002c464
- (id)initWithDOMElement:(id)arg1 parent:(id)arg2 elementFactory:(id)arg3;	// IMP=0x000000000002c282
