...
- (void).cxx_destruct;	// IMP=0x0000000000055662
...
- (id)nextObject;	// IMP=0x0000000000055385
- (_Bool)bindPropertiesToStatement:(struct sqlite3_stmt *)arg1 error:(id *)arg2;	// IMP=0x00000000000552bf
- (id)initWithLocalZone:(id)arg1 modelID:(id)arg2;	// IMP=0x0000000000054fd1
