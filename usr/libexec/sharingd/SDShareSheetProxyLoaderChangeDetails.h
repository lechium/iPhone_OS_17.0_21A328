...
- (void).cxx_destruct;	// IMP=0x0020000000181068
...
- (id)failedIndexesForProxySection:(id)arg1;	// IMP=0x0010000000180f49
- (id)loadedIndexesForProxySection:(id)arg1;	// IMP=0x0010000000180e60
- (void)addResult:(id)arg1 forProxySection:(id)arg2;	// IMP=0x0010000000180c76
@property(readonly, nonatomic) NSArray *changedProxySections;
- (id)init;	// IMP=0x0010000000180b94
