...
@class FPItem, FPItemID, MISSING_TYPE, NSArray, NSDictionary, NSError, NSProgress, NSSet, NSString;
...
- (MISSING_TYPE *)deleteItemsWithIDs:baseVersions:options:reply: /* Error: Ran out of types for this method. */;
