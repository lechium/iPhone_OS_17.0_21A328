...
- (void).cxx_destruct;	// IMP=0x00000000000eb1c3
...
- (struct CGRect)faceBoundsWithTransform:(unsigned long long)arg1 height:(unsigned long long)arg2 transform:(struct CGAffineTransform)arg3;	// IMP=0x00000000000eb012
- (struct CGRect)faceBounds:(unsigned long long)arg1 height:(unsigned long long)arg2;	// IMP=0x00000000000eafb3
- (unsigned long long)flagsForOrientation:(_Bool)arg1 width:(unsigned long long)arg2 height:(unsigned long long)arg3;	// IMP=0x00000000000eaf49
- (id)init;	// IMP=0x00000000000eaee6
