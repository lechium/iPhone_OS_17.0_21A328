...
- (void).cxx_destruct;	// IMP=0x000000000015fc1a
- (id)finish:(int)arg1;	// IMP=0x000000000015fa4c
- (_Bool)parse:(const char *)arg1 len:(long long)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x000000000015f10d
