...
- (void).cxx_destruct;	// IMP=0x0000000000349f25
...
- (_Bool)gestureRecognizer:(id)arg1 shouldRecognizeSimultaneouslyWithGestureRecognizer:(id)arg2;	// IMP=0x0000000000349c73
- (_Bool)gestureRecognizer:(id)arg1 shouldBeRequiredToFailByGestureRecognizer:(id)arg2;	// IMP=0x00000000003499fc
- (_Bool)gestureRecognizer:(id)arg1 shouldRequireFailureOfGestureRecognizer:(id)arg2;	// IMP=0x00000000003498b3
- (_Bool)gestureRecognizerShouldBegin:(id)arg1;	// IMP=0x00000000003496e7
- (void)_updateGestureRecognizersIfNeeded;	// IMP=0x0000000000349542
- (void)invalidateViewHostingGestureRecognizers;	// IMP=0x0000000000349514
- (void)_invalidateGestureRecognizers;	// IMP=0x00000000003494fd
- (id)longPressGestureRecognizer;	// IMP=0x00000000003494d8
@property(readonly, nonatomic) PUTouchingGestureRecognizer *touchingGestureRecognizer;
- (void)addIrisGestureRecognizer:(id)arg1;	// IMP=0x0000000000349378
