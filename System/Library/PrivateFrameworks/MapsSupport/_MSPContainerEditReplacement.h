...
- (void).cxx_destruct;	// IMP=0x0000000000069cab
...
- (void)useImmutableObjectsFromMap:(id)arg1 intermediateMutableObjectTransferBlock:(CDUnknownBlockType)arg2;	// IMP=0x0000000000069658
@property(readonly, copy) NSString *description;
- (id)initWithOriginalObjects:(id)arg1 replacementObjects:(id)arg2 indexes:(id)arg3;	// IMP=0x000000000006945b
