...
+ (id)logCategory;	// IMP=0x00600000000991c9
- (void).cxx_destruct;	// IMP=0x00000000000990cc
...
- (void)_generateAllCombinations:(id)arg1;	// IMP=0x0000000000098a03
- (id)createSelectedAudioParameters;	// IMP=0x0000000000098621
- (id)createSRTPParamters;	// IMP=0x0000000000098596
- (_Bool)_selectParametersFromCodec:(id)arg1 bitRateSettings:(id)arg2 sampleRates:(id)arg3 audioChannelCount:(id)arg4;	// IMP=0x0000000000097fe7
- (_Bool)selectAudioParameters;	// IMP=0x00000000000977d7
- (id)logIdentifier;	// IMP=0x0000000000097787
- (id)initWithSessionID:(id)arg1 supportedAudioConfiguration:(id)arg2 supportedRTPConfiguration:(id)arg3 streamingCapabilities:(id)arg4;	// IMP=0x00000000000975fa
