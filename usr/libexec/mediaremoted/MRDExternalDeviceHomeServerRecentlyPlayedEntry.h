...
- (void).cxx_destruct;	// IMP=0x002000000005c400
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000005bc63
- (id)description;	// IMP=0x001000000005bb4e
- (id)initWithDictionaryRepresentation:(id)arg1;	// IMP=0x001000000005b961
