...
+ (id)logCategory;	// IMP=0x0010000000850144
- (void).cxx_destruct;	// IMP=0x00000000008500e0
...
- (void)respond:(id)arg1 payload:(id)arg2;	// IMP=0x000000000084fc0d
- (void)dealloc;	// IMP=0x000000000084fb91
- (id)logIdentifier;	// IMP=0x000000000084fb41
- (id)initWithSessionID:(id)arg1 accessory:(id)arg2 snapshotGetter:(id)arg3 message:(id)arg4 waitPeriod:(double)arg5 streamingTierType:(unsigned long long)arg6 cameraLocallyReachable:(_Bool)arg7 snapshotForNotification:(_Bool)arg8;	// IMP=0x000000000084f96a
