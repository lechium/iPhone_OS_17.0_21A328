...
- (void).cxx_destruct;	// IMP=0x000000000034fee2
@property(readonly, copy, nonatomic) CDUnknownBlockType actionBlock; // @synthesize actionBlock=_actionBlock;
- (void)performAction;	// IMP=0x000000000034fe67
- (id)initWithActionBlock:(CDUnknownBlockType)arg1;	// IMP=0x000000000034fdf4
