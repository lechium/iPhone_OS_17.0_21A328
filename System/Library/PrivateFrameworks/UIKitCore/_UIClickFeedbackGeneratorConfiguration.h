...
+ (id)defaultConfiguration;	// IMP=0x0060000000777586
- (void).cxx_destruct;	// IMP=0x0000000000777b60
...
- (void)setclickDownFeedback:(id)arg1;	// IMP=0x00000000007779a0
- (id)feedbackKeyPaths;	// IMP=0x0000000000777889
...
- (long long)requiredSupportLevel;	// IMP=0x0000000000777355
