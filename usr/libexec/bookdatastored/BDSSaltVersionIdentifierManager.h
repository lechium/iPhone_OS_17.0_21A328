...
- (void).cxx_destruct;	// IMP=0x00200000000851fb
...
- (void)handleSaltVersionIdentifierChange:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x001000000008445e
- (void)databaseController:(id)arg1 saltVersionIdentifierChanged:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x0010000000084446
- (id)initWithZoneDataManager:(id)arg1 tokenController:(id)arg2 databaseController:(id)arg3;	// IMP=0x0010000000084256
