...
+ (id)deviceControlRequestWithCompletionBlock:(CDUnknownBlockType)arg1;	// IMP=0x00600000000a5c06
...
- (void)dealloc;	// IMP=0x00000000000a5ca6
- (id)_initWithCompletionBlock:(CDUnknownBlockType)arg1;	// IMP=0x00000000000a5c3d
