...
+ (id)logCategory;	// IMP=0x001000000082589b
- (void).cxx_destruct;	// IMP=0x00000000008252c3
...
- (void)_drainVariantFragmentQueue;	// IMP=0x0000000000824d0d
- (void)handleVariantFragment:(id)arg1;	// IMP=0x00000000008249da
- (void)handleFullFragment:(id)arg1;	// IMP=0x00000000008248e6
@property(readonly) _Bool expectsVariantFragment;
- (id)initWithLogIdentifier:(id)arg1;	// IMP=0x00000000008247c5
