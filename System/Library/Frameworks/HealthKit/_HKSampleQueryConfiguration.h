...
+ (_Bool)supportsSecureCoding;	// IMP=0x0060000000017d04
- (void).cxx_destruct;	// IMP=0x000000000001151e
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000097475
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000002134
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000973b7
