...
- (void).cxx_destruct;	// IMP=0x00000000002417e9
...
- (id)description;	// IMP=0x00000000002415ef
- (id)initWithName:(id)arg1 readHAPCharacteristic:(id)arg2 writeHAPCharacteristic:(id)arg3 format:(id)arg4;	// IMP=0x0000000000241451
- (id)init;	// IMP=0x00000000002413a9
