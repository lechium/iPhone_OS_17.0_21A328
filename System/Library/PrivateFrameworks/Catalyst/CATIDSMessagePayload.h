...
+ (id)instanceWithDictionary:(id)arg1;	// IMP=0x001000000000d9af
...
- (id)messageContent;	// IMP=0x000000000000db7a
@property(readonly, copy, nonatomic) NSDictionary *dictionaryValue;
- (id)initWithMetadata:(id)arg1 message:(id)arg2;	// IMP=0x000000000000d812
- (id)initWithMessage:(id)arg1;	// IMP=0x000000000000d78a
