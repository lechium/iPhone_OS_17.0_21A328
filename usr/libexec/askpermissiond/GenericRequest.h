...
- (void).cxx_destruct;	// IMP=0x002000000002acb1
...
- (id)compile;	// IMP=0x001000000002aa14
- (id)initWithDictionary:(id)arg1;	// IMP=0x001000000002a601
- (id)initWithDate:(id)arg1 requestIdentifier:(id)arg2 uniqueIdentifier:(id)arg3 itemIdentifier:(id)arg4 localizations:(id)arg5 offerName:(id)arg6 status:(long long)arg7;	// IMP=0x001000000002a4d2
