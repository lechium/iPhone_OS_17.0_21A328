...
+ (int)awdUserPrivilegeFromHMUserPrivilege:(long long)arg1;	// IMP=0x006000000098abe3
+ (id)eventWithP2PEnabled:(_Bool)arg1 privilegeLevel:(long long)arg2 passwordSet:(_Bool)arg3;	// IMP=0x006000000098ab5e
