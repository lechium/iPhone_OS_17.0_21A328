...
- (void).cxx_destruct;	// IMP=0x00000000000391fc
...
- (id)initWithIdentifier:(id)arg1 startTime:(unsigned long long)arg2 endTime:(unsigned long long)arg3 role:(long long)arg4 accessoryUUID:(id)arg5 accessoryIDSIdentifier:(id)arg6 setupClientBundleID:(id)arg7;	// IMP=0x0000000000039002
