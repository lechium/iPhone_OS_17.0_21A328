...
- (void).cxx_destruct;	// IMP=0x00000000000dc6c4
...
- (void)_updateInputLabelSpacing:(id)arg1;	// IMP=0x00000000000dc31a
- (void)_updateInputLabelStyle:(id)arg1;	// IMP=0x00000000000dc27f
- (void)setModifiersWidth:(double)arg1 inputWidth:(double)arg2;	// IMP=0x00000000000dc0c8
...
- (void)dealloc;	// IMP=0x00000000000dbdc1
- (void)_commonInit;	// IMP=0x00000000000db430
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000db3e4
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000000db387
