...
+ (id)logCategory;	// IMP=0x0060000000a91140
+ (id)shortDescription;	// IMP=0x0060000000a9112e
- (void).cxx_destruct;	// IMP=0x0000000000a910bb
...
- (void)clearData;	// IMP=0x0000000000a90efd
...
- (_Bool)encodeObjectChange:(id)arg1;	// IMP=0x0000000000a90458
- (id)extractObjectChange;	// IMP=0x0000000000a8f96f
- (id)description;	// IMP=0x0000000000a8f903
- (id)shortDescription;	// IMP=0x0000000000a8f817
- (id)initWithObjectID:(id)arg1 recordName:(id)arg2 cloudZone:(id)arg3;	// IMP=0x0000000000a8f6bf
- (id)init;	// IMP=0x0000000000a8f617
