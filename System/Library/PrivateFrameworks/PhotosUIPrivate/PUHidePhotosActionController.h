...
- (void).cxx_destruct;	// IMP=0x0000000000177aba
...
- (void)performActionWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000000001779df
- (id)alertControllerForTogglingAssetsVisibilityWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000177680
- (id)initWithAssets:(id)arg1 undoManager:(id)arg2;	// IMP=0x0000000000177592
