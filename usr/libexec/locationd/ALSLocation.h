...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000009f0bf0
- (unsigned long long)hash;	// IMP=0x00100000009f0ad2
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000009f0949
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000009f0824
- (void)copyTo:(id)arg1;	// IMP=0x00100000009f073d
- (void)writeTo:(id)arg1;	// IMP=0x00100000009f05e9
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000009f05dc
- (id)dictionaryRepresentation;	// IMP=0x00100000009efcf4
- (id)description;	// IMP=0x00100000009efc7d
