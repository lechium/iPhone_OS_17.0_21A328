...
- (void).cxx_destruct;	// IMP=0x00400000000aee2a
- (id)initWithURL:(id)arg1 append:(_Bool)arg2;	// IMP=0x00100000000aedc7
- (id)initToBuffer:(char *)arg1 capacity:(long long)arg2;	// IMP=0x00100000000aed9c
- (id)initToMemory;	// IMP=0x00100000000aed71
- (void)close;	// IMP=0x00100000000aed2a
- (void)open;	// IMP=0x00100000000aea19
...
- (long long)write:(const char *)arg1 maxLength:(long long)arg2;	// IMP=0x00100000000ae8c2
@property(nonatomic, readonly) NSString *dataDigestForStream;
- (id)initWithOutputStream:(id)arg1;	// IMP=0x00100000000ae44f
- (id)init;	// IMP=0x00100000000ae1d6
