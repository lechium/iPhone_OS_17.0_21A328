...
@interface MLRXPCActivityTaskWithClassAPluggedIn : NSObject
{
...
- (void).cxx_destruct;	// IMP=0x002000000001cb69
...
- (void)stop;	// IMP=0x001000000001caff
- (void)startTaskWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x001000000001c9c9
- (id)createTaskScheduler;	// IMP=0x001000000001c999
- (id)criteria;	// IMP=0x001000000001c8a7
