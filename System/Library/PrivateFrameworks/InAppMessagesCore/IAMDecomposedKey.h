...
- (void)constructCompoundPredicateIfNeeded;	// IMP=0x0000000000002ac7
- (_Bool)predicatesMatchFigaroEventProperties:(id)arg1;	// IMP=0x0000000000002a54
- (_Bool)hasPredicates;	// IMP=0x0000000000002a37
- (void)addPredicateCondition:(id)arg1;	// IMP=0x00000000000029e8
- (id)init;	// IMP=0x000000000000295a
