...
+ (_Bool)sqliteDatabaseExistsAtURL:(id)arg1;	// IMP=0x006000000000ade8
- (void).cxx_destruct;	// IMP=0x000000000000b5c8
...
- (_Bool)isDataLoaded;	// IMP=0x000000000000b168
- (_Bool)hasNotPassedExpiryDate:(id)arg1 isForCountryCode:(id)arg2;	// IMP=0x000000000000afb7
- (_Bool)isDataValid;	// IMP=0x000000000000af10
- (id)initWithClusterType:(long long)arg1 databaseMaxAge:(double)arg2 forStorefront:(id)arg3 databaseFilePathURL:(id)arg4;	// IMP=0x000000000000ae60
