...
+ (id)taskWithPhotoLibrary:(id)arg1;	// IMP=0x004000000007bf79
- (void).cxx_destruct;	// IMP=0x002000000007ce90
...
- (int)mainInternal;	// IMP=0x001000000007c678
- (_Bool)containsAsset:(id)arg1;	// IMP=0x001000000007c402
- (void)addAnalysis:(unsigned long long)arg1 withExistingAnalysis:(id)arg2 forAsset:(id)arg3;	// IMP=0x001000000007c364
- (void)addAnalysis:(unsigned long long)arg1 withExistingAnalysis:(id)arg2 forAsset:(id)arg3 allowStreaming:(_Bool)arg4;	// IMP=0x001000000007bfde
- (id)initWithPhotoLibrary:(id)arg1;	// IMP=0x001000000007bea9
