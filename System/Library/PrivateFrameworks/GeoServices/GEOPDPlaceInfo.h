...
+ (id)placeInfoForPlaceData:(id)arg1;	// IMP=0x0010000000a96bd6
- (void).cxx_destruct;	// IMP=0x0000000000d26d2f
- (unsigned long long)hash;	// IMP=0x0000000000d26b47
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000d26944
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000d26695
- (void)writeTo:(id)arg1;	// IMP=0x0000000000d26423
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000d26414
- (id)jsonRepresentation;	// IMP=0x0000000000d25b29
- (id)dictionaryRepresentation;	// IMP=0x0000000000d25547
- (id)description;	// IMP=0x0000000000d25498
- (id)initWithData:(id)arg1;	// IMP=0x0000000000d2445b
- (id)init;	// IMP=0x0000000000d243ff
