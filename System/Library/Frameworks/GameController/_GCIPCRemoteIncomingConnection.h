...
- (void).cxx_destruct;	// IMP=0x000000000006019e
@property(readonly, nonatomic) __weak id <_GCIPCProcess> process; // @synthesize process=_process;
- (id)initWithConnection:(id)arg1;	// IMP=0x000000000006015a
- (id)initWithConnection:(id)arg1 fromProcess:(id)arg2;	// IMP=0x000000000005fff0
