...
+ (_Bool)revision:(unsigned long long)arg1 supportsConstellation:(unsigned long long)arg2;	// IMP=0x0060000000129824
- (void).cxx_destruct;	// IMP=0x0000000000129811
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000012964c
- (id)initWithRequestClass:(Class)arg1;	// IMP=0x0000000000129592
