...
+ (id)customAttributes;	// IMP=0x00600000001bc39d
...
- (id)outputImage;	// IMP=0x00000000001bc81d
- (id)alphaImageForMainImage:(id)arg1 disparity:(id)arg2;	// IMP=0x00000000001bc50e
