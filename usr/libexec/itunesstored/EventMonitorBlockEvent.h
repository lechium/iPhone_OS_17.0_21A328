...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000013749e
- (void)performAction;	// IMP=0x0010000000137484
- (_Bool)hasOccurred;	// IMP=0x0010000000137468
- (void)dealloc;	// IMP=0x0010000000137410
