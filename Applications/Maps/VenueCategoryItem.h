...
- (void).cxx_destruct;	// IMP=0x0020000000706a6f
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000070685e
- (id)initWithSearchCategory:(id)arg1 venueIdentifier:(id)arg2 displayMode:(int)arg3 isAutoCompleteCategory:(_Bool)arg4 shouldFrameMapViewport:(_Bool)arg5;	// IMP=0x00100000007067aa
