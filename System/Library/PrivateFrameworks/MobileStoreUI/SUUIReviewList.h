...
- (void).cxx_destruct;	// IMP=0x000000000018faeb
@property(readonly, nonatomic) NSArray *reviews; // @synthesize reviews=_reviews;
@property(readonly, nonatomic) NSMutableDictionary *cacheRepresentation;
- (id)initWithCacheRepresentation:(id)arg1;	// IMP=0x000000000018f63c
...
- (void)addReviews:(id)arg1;	// IMP=0x000000000018f23b
- (id)initWithReviewListDictionary:(id)arg1;	// IMP=0x000000000018ef87
