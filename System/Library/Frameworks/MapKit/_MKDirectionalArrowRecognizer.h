...
- (void).cxx_destruct;	// IMP=0x00000000000be3e6
...
- (void)keyUp:(id)arg1;	// IMP=0x00000000000be2e8
- (void)keyDown:(id)arg1;	// IMP=0x00000000000be1e9
- (void)handleArrowMask:(long long)arg1;	// IMP=0x00000000000be12c
- (id)initWithTarget:(id)arg1 action:(SEL)arg2;	// IMP=0x00000000000be044
