...
- (void).cxx_destruct;	// IMP=0x0000000000e7b48b
- (unsigned long long)hash;	// IMP=0x0000000000e7b397
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000e7b1e2
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000e7af56
- (void)writeTo:(id)arg1;	// IMP=0x0000000000e7acc9
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000e7acba
- (id)jsonRepresentation;	// IMP=0x0000000000e7a6bc
- (id)dictionaryRepresentation;	// IMP=0x0000000000e7a01e
- (id)description;	// IMP=0x0000000000e79f6f
- (id)initWithData:(id)arg1;	// IMP=0x0000000000e78f61
- (id)init;	// IMP=0x0000000000e78f05
