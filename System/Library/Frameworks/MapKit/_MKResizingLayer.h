...
- (void).cxx_destruct;	// IMP=0x0000000000079262
@property(nonatomic) _Bool needsLayoutOnBoundsChange; // @synthesize needsLayoutOnBoundsChange=_needsLayoutOnBoundsChange;
- (void)setContentsScale:(double)arg1;	// IMP=0x00000000000790b1
- (void)setMask:(id)arg1;	// IMP=0x0000000000078f8f
- (void)setBounds:(struct CGRect)arg1;	// IMP=0x0000000000078cd8
- (void)sizeSublayerToBounds:(id)arg1;	// IMP=0x0000000000078c7f
