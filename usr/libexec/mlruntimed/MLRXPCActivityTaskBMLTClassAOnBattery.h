...
@interface MLRXPCActivityTaskBMLTClassAOnBattery : NSObject
{
...
- (void).cxx_destruct;	// IMP=0x0020000000006bb5
...
- (void)stop;	// IMP=0x0010000000006aaa
- (void)startTaskWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0010000000006963
- (id)createTaskScheduler;	// IMP=0x0010000000006933
- (id)criteria;	// IMP=0x001000000000681c
