...
- (void).cxx_destruct;	// IMP=0x0020000000009dcf
...
- (void)_launchTargetAppIfNecessary;	// IMP=0x00100000000095bb
- (void)_launchTargetApp;	// IMP=0x0010000000009543
- (void)_switchToNowPlaying;	// IMP=0x0010000000009496
- (void)scene:(id)arg1 openURLContexts:(id)arg2;	// IMP=0x00100000000093a9
- (void)sceneDidEnterBackground:(id)arg1;	// IMP=0x0010000000009340
- (void)sceneWillEnterForeground:(id)arg1;	// IMP=0x001000000000930d
- (void)sceneWillResignActive:(id)arg1;	// IMP=0x00100000000092ce
- (void)sceneDidBecomeActive:(id)arg1;	// IMP=0x001000000000921a
- (void)sceneDidDisconnect:(id)arg1;	// IMP=0x0010000000009180
- (void)scene:(id)arg1 willConnectToSession:(id)arg2 options:(id)arg3;	// IMP=0x0010000000009085
- (void)dealloc;	// IMP=0x001000000000901a
- (void)setScene:(id)arg1;	// IMP=0x0010000000008e83
