...
+ (id)customAttributes;	// IMP=0x006000000003c943
...
- (id)outputImage;	// IMP=0x000000000003c110
- (id)_CICMYK_black;	// IMP=0x000000000003c0f0
- (id)_CICMYK_yellow;	// IMP=0x000000000003c0d0
- (id)_CICMYK_magenta;	// IMP=0x000000000003c0b0
- (id)_CICMYK_cyan;	// IMP=0x000000000003c090
- (id)_CICMYK_convert;	// IMP=0x000000000003c070
- (id)_CIWhite;	// IMP=0x000000000003c050
