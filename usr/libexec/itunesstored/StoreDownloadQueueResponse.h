...
- (void).cxx_destruct;	// IMP=0x00100000000123a1
...
- (id)_errorWithFailureType:(id)arg1 customerMessage:(id)arg2;	// IMP=0x001000000001229c
...
- (id)errorForItemIdentifier:(id)arg1;	// IMP=0x0010000000011fa5
@property(readonly) NSOrderedSet *downloads;
- (id)initWithError:(id)arg1 userIdentifier:(id)arg2;	// IMP=0x0010000000011df1
- (id)initWithDictionary:(id)arg1 userIdentifier:(id)arg2 preferredAssetFlavor:(id)arg3;	// IMP=0x0010000000010eae
- (id)initWithDictionary:(id)arg1 userIdentifier:(id)arg2;	// IMP=0x0010000000010e99
- (id)init;	// IMP=0x0010000000010e87
- (id)_initStoreDownloadQueueResponse;	// IMP=0x0010000000010e2f
- (id)_newManifestWithStoreDownloadQueueResponse:(id)arg1 accountID:(id)arg2 accountName:(id)arg3;	// IMP=0x0010000000171a44
- (void)enumerateActivitiesWithAccountID:(id)arg1 accountName:(id)arg2 usingBlock:(CDUnknownBlockType)arg3;	// IMP=0x001000000017113c
- (id)copyJobManifestWithAccountID:(id)arg1 accountName:(id)arg2;	// IMP=0x00100000001710d3
