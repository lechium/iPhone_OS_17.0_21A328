...
+ (id)customAttributes;	// IMP=0x00600000001c4dc5
...
- (id)outputImage;	// IMP=0x00000000001c56f4
- (id)unifiedRenderingOutputImage:(struct CGImageMetadata *)arg1;	// IMP=0x00000000001c53ba
- (id)alterBlurmap;	// IMP=0x00000000001c5295
