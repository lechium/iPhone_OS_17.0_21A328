...
- (void).cxx_destruct;	// IMP=0x002000000002a5a5
...
- (void)_haltAnimations;	// IMP=0x001000000002a358
- (void)animateToMonthWithCompletion:(CDUnknownBlockType)arg1 inContext:(id)arg2;	// IMP=0x0010000000029e43
- (void)animateToListWithCompletion:(CDUnknownBlockType)arg1 inContext:(id)arg2;	// IMP=0x001000000002989e
- (void)_terminateAnimationsAfterDelay;	// IMP=0x0010000000029829
- (void)animateTransition:(id)arg1;	// IMP=0x00100000000291c3
- (double)transitionDuration:(id)arg1;	// IMP=0x00100000000291b5
- (id)initWithModel:(id)arg1 paletteView:(id)arg2 reverse:(_Bool)arg3;	// IMP=0x00100000000290e3
