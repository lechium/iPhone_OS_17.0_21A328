...
- (void).cxx_destruct;	// IMP=0x000000000024735c
...
- (_Bool)isLoaded;	// IMP=0x00000000002471d3
- (void)updateWithDictionary:(id)arg1;	// IMP=0x0000000000246fa3
- (id)initWithCountdownDictionary:(id)arg1;	// IMP=0x0000000000246632
