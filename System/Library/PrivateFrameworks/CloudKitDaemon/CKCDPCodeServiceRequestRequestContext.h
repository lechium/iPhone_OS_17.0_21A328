...
- (void).cxx_destruct;	// IMP=0x000000000037915e
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000378e75
- (unsigned long long)hash;	// IMP=0x0000000000378cfe
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000378aae
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000003788b7
- (void)copyTo:(id)arg1;	// IMP=0x0000000000378733
- (void)writeTo:(id)arg1;	// IMP=0x00000000003785b9
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000003785ac
- (id)dictionaryRepresentation;	// IMP=0x0000000000377e10
- (id)description;	// IMP=0x0000000000377d61
...
- (int)StringAsDatabaseType:(id)arg1;	// IMP=0x0000000000377bab
- (id)databaseTypeAsString:(int)arg1;	// IMP=0x0000000000377b62
@property(nonatomic) _Bool hasDatabaseType;
@property(nonatomic) int databaseType; // @synthesize databaseType=_databaseType;
- (int)StringAsDatabaseEnvironment:(id)arg1;	// IMP=0x0000000000377a93
- (id)databaseEnvironmentAsString:(int)arg1;	// IMP=0x0000000000377a3e
