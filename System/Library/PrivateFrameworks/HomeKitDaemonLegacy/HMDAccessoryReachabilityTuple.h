...
+ (id)tupleWithAccessoryUUID:(id)arg1 reachable:(_Bool)arg2;	// IMP=0x00600000000af572
- (void).cxx_destruct;	// IMP=0x00000000000af55f
...
- (id)description;	// IMP=0x00000000000af35f
- (unsigned long long)hash;	// IMP=0x00000000000af31b
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000af28a
