...
- (id)description;	// IMP=0x001000000002dfe0
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000002dfb0
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000002df79
