...
@interface _TtC7NewsUI229ArticleToArticleSwipeTestCase : NSObject
{
...
- (void).cxx_destruct;	// IMP=0x0000000000d864b0
- (id)init;	// IMP=0x0000000000d863b0
- (void)runTestWithContext:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000000d86320
