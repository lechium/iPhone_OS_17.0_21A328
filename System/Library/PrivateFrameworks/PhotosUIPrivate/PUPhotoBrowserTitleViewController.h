...
- (void).cxx_destruct;	// IMP=0x00000000003bc243
...
- (void)_handleTapGestureRecognizer:(id)arg1;	// IMP=0x00000000003bc08b
- (void)_updateGestureRecognizersIfNeeded;	// IMP=0x00000000003bbf9a
- (void)_invalidateGestureRecognizers;	// IMP=0x00000000003bbf67
- (void)_updateLabelsIfNeeded;	// IMP=0x00000000003bbb7e
- (void)_invalidateLabels;	// IMP=0x00000000003bbb4b
- (void)_updatePlayClockDescriptionIfNeeded;	// IMP=0x00000000003bb97f
- (void)_invalidatePlayClockDescription;	// IMP=0x00000000003bb94c
- (void)_updateDayAndTimeDescriptionsIfNeeded;	// IMP=0x00000000003bb808
- (void)_invalidateDayAndTimeDescriptions;	// IMP=0x00000000003bb7d5
- (void)_setNeedsUpdate;	// IMP=0x00000000003bb729
- (_Bool)_needsUpdate;	// IMP=0x00000000003bb6c8
- (void)_updateIfNeeded;	// IMP=0x00000000003bb5c0
- (void)performChanges:(CDUnknownBlockType)arg1;	// IMP=0x00000000003bb4c4
- (void)_assertInsideUpdate;	// IMP=0x00000000003bb42c
- (void)_assertInsideChangeBlock;	// IMP=0x00000000003bb394
- (void)_dateFormatterChanged:(id)arg1;	// IMP=0x00000000003bb348
@property(retain, nonatomic) UIColor *subtitleTextColor;
@property(retain, nonatomic) UIColor *titleTextColor;
@property(readonly, copy, nonatomic) NSString *subtitle;
@property(readonly, copy, nonatomic) NSString *title;
- (id)init;	// IMP=0x00000000003bacee
