...
+ (id)replacementWithRange:(id)arg1 original:(id)arg2 replacement:(id)arg3 menuTitle:(id)arg4;	// IMP=0x00600000013c5616
- (void).cxx_destruct;	// IMP=0x00000000013c595e
...
- (_Bool)_isNoReplacementsFoundItem;	// IMP=0x00000000013c58c1
- (void)didReplaceTextWithTarget:(id)arg1;	// IMP=0x00000000013c56de
