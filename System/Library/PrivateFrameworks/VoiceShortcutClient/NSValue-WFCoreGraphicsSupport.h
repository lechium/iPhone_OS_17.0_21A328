...
+ (id)wf_valueWithCGAffineTransform:(struct CGAffineTransform)arg1;	// IMP=0x0020000000083fc5
+ (id)wf_valueWithCGRect:(struct CGRect)arg1;	// IMP=0x0020000000083fb3
+ (id)wf_valueWithCGSize:(struct CGSize)arg1;	// IMP=0x0020000000083fa1
+ (id)wf_valueWithCGVector:(struct CGVector)arg1;	// IMP=0x0020000000083f8f
+ (id)wf_valueWithCGPoint:(struct CGPoint)arg1;	// IMP=0x0020000000083f7d
