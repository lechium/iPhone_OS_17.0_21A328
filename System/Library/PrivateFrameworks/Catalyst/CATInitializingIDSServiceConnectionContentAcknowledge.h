...
+ (id)instanceWithDictionary:(id)arg1;	// IMP=0x00100000000429ef
- (void).cxx_destruct;	// IMP=0x0000000000042a65
...
- (id)initWithConnectionIdentifier:(id)arg1;	// IMP=0x00000000000428b2
