...
- (void).cxx_destruct;	// IMP=0x0020000000037ec7
...
- (void)enumerateChangesWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x0010000000037d36
@property(readonly, nonatomic) _Bool hasChanges;
- (id)initWithStore:(id)arg1 table:(id)arg2;	// IMP=0x0010000000037bf6
