...
- (void).cxx_destruct;	// IMP=0x0000000000913511
...
- (void)configPageView;	// IMP=0x0000000000912292
- (void)layoutSubviews;	// IMP=0x0000000000912280
- (id)initWithImageView:(id)arg1;	// IMP=0x0000000000912148
