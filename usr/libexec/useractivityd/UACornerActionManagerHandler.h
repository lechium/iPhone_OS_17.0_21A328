...
- (void).cxx_destruct;	// IMP=0x0020000000013e70
...
- (id)statusString;	// IMP=0x0010000000013d18
- (_Bool)terminate;	// IMP=0x0010000000013bb3
- (_Bool)resume;	// IMP=0x0010000000013a94
- (_Bool)suspend;	// IMP=0x001000000001396e
@property _Bool suspended;
@property(readonly) _Bool active;
- (id)initWithManager:(id)arg1 name:(id)arg2;	// IMP=0x00100000000136e4
