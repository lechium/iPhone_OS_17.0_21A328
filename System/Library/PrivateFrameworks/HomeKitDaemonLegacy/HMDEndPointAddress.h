...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000000729f5
- (void).cxx_destruct;	// IMP=0x00000000000729b3
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000072868
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000725d8
- (void)description:(id)arg1 indent:(id)arg2;	// IMP=0x0000000000072445
- (_Bool)_parseFromTLVData;	// IMP=0x0000000000072208
@property(readonly, copy) NSData *tlvData;
- (_Bool)compatibleWithRemoteEndPoint:(id)arg1;	// IMP=0x0000000000071fdd
- (id)initWithIPAddress:(id)arg1 isIPv6Address:(_Bool)arg2 videoRTPPort:(id)arg3 audioRTPPort:(id)arg4;	// IMP=0x0000000000071f04
