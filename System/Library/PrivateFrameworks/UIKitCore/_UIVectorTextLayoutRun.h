...
- (void).cxx_destruct;	// IMP=0x00000000015e6511
...
- (void)_enumerateGlyphsUsingBlock:(CDUnknownBlockType)arg1;	// IMP=0x00000000015e60cc
- (void)enumerateGlyphsUsingBlock:(CDUnknownBlockType)arg1;	// IMP=0x00000000015e5d2c
- (void)renderInContext:(struct CGContext *)arg1;	// IMP=0x00000000015e5ac2
- (_Bool)shouldRender;	// IMP=0x00000000015e5a9e
- (id)font;	// IMP=0x00000000015e5a90
- (id)string;	// IMP=0x00000000015e5987
- (struct _NSRange)stringRange;	// IMP=0x00000000015e5966
- (long long)glyphCount;	// IMP=0x00000000015e595c
- (void)dealloc;	// IMP=0x00000000015e591d
- (id)initWithCTRun:(struct __CTRun *)arg1 lineIndex:(unsigned long long)arg2 layoutInfo:(id)arg3;	// IMP=0x00000000015e588d
