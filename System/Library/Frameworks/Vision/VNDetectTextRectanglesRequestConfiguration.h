...
- (void).cxx_destruct;	// IMP=0x00000000000ca991
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000ca791
- (id)initWithRequestClass:(Class)arg1;	// IMP=0x00000000000ca6fa
