...
- (void)fireAlarm:(id)arg1 error:(int)arg2;	// IMP=0x0010000000534393
- (void)onNotification:(int)arg1 withData:(id)arg2;	// IMP=0x001000000053438d
- (id)initWithMotionAlarmSubscription:(void *)arg1;	// IMP=0x0010000000534350
