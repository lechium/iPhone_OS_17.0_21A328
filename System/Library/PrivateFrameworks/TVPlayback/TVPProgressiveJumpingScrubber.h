...
- (void).cxx_destruct;	// IMP=0x0000000000004047
...
- (void)_skipTimerFired:(id)arg1;	// IMP=0x0000000000003e3d
- (double)_nextTimeToAdvanceFromTime:(double)arg1;	// IMP=0x0000000000003d6b
- (void)cancelScrub;	// IMP=0x0000000000003d39
- (void)startScrubWithRate:(double)arg1;	// IMP=0x0000000000003c5a
