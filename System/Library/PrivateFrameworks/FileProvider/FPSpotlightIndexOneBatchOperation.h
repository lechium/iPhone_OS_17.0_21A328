...
- (void).cxx_destruct;	// IMP=0x00000000000c7eb8
...
- (void)finishWithResult:(id)arg1 error:(id)arg2;	// IMP=0x00000000000c7d53
- (void)main;	// IMP=0x00000000000c665e
- (id)initWithIndexer:(id)arg1 isInitialIndexing:(_Bool)arg2 isOutOfBandIndexing:(_Bool)arg3 queue:(id)arg4;	// IMP=0x00000000000c639c
