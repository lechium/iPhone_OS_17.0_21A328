...
- (id)debugDescription;	// IMP=0x00100000000830e5
- (id)description;	// IMP=0x0010000000082ff9
- (const char *)objCType;	// IMP=0x0010000000082fec
- (void)getValue:(void *)arg1;	// IMP=0x0010000000082fcf
...
- (id)initWithAuditToken:(CDStruct_4c969caf)arg1;	// IMP=0x0010000000082c74
