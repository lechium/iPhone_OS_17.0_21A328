...
- (id)correctedString;	// IMP=0x000000000002df41
- (id)correctionResult;	// IMP=0x000000000002df37
- (id)description;	// IMP=0x000000000002ded0
- (void)dealloc;	// IMP=0x000000000002de86
- (id)initWithCorrectionResult:(id)arg1 correctedString:(id)arg2;	// IMP=0x000000000002de07
