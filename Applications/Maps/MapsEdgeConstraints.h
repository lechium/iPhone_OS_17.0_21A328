...
@class MISSING_TYPE, NSArray, NSLayoutConstraint;
...
+ (id)edgeConstraintsWithTop:(id)arg1 left:(id)arg2 bottom:(id)arg3 right:(id)arg4;	// IMP=0x004000000022154a
+ (id)edgeConstraintsWithTop:(id)arg1 leading:(id)arg2 bottom:(id)arg3 trailing:(id)arg4;	// IMP=0x001000000022146d
- (MISSING_TYPE *).cxx_destruct;	// IMP=0x00200000002218ed
