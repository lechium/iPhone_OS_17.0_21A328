...
+ (double)processStartTime;	// IMP=0x00100000002d1a6c
+ (id)consumePendingLaunchEvent;	// IMP=0x00100000002d1a29
+ (void)withPendingLaunchEvent:(CDUnknownBlockType)arg1;	// IMP=0x00100000002d1a0d
+ (void)createPendingLaunchEvent;	// IMP=0x00100000002d19d3
+ (void)resetPendingLaunchEventForTesting;	// IMP=0x00100000002d19af
- (void).cxx_destruct;	// IMP=0x00000000002d3443
@property(readonly, copy, nonatomic) NSDictionary *templateMetrics; // @synthesize templateMetrics=_templateMetrics;
- (void)populateObjectInspector:(id)arg1;	// IMP=0x00000000002d2c08
@property(readonly, copy) NSString *description;
- (void)appendPropertiesToBody:(id)arg1;	// IMP=0x00000000002d2572
...
- (void)addTemplateLoadTimingMetric:(id)arg1 forURL:(id)arg2;	// IMP=0x00000000002d1d77
...
- (id)init;	// IMP=0x00000000002d1871
