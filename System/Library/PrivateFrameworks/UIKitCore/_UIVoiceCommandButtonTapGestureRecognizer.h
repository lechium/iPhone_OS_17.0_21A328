...
- (id)voiceCommandButtonTapDuration;	// IMP=0x0000000000c23a0e
- (void)pressesEnded:(id)arg1 withEvent:(id)arg2;	// IMP=0x0000000000c23983
- (void)pressesBegan:(id)arg1 withEvent:(id)arg2;	// IMP=0x0000000000c238f8
- (void)reset;	// IMP=0x0000000000c238af
