...
+ (long long)typicalBarPosition;	// IMP=0x006000000020555c
- (void).cxx_destruct;	// IMP=0x0000000000205a06
...
- (id)representativeImageForIdiom:(long long)arg1;	// IMP=0x0000000000205812
...
- (double)titleVerticalAdjustmentForBarMetrics:(long long)arg1;	// IMP=0x00000000002056d7
- (void)setTitleVerticalAdjustment:(double)arg1 forBarMetrics:(long long)arg2;	// IMP=0x00000000002055c8
