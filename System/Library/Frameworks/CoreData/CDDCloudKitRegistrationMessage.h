...
+ (_Bool)supportsSecureCoding;	// IMP=0x00600000001add98
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001adc74
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001adabc
- (void)dealloc;	// IMP=0x00000000001ada1e
