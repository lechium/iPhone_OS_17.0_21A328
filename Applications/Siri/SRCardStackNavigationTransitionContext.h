...
- (void).cxx_destruct;	// IMP=0x002000000006d7c7
...
// Error: Property attributes should begin with the type ('T') attribute, property name: toPlatteredCardView
...
- (void)completeTransition:(_Bool)arg1;	// IMP=0x001000000006d57a
@property(readonly, nonatomic) long long semanticContentAttribute;
- (id)init;	// IMP=0x001000000006d4df
- (id)initWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x001000000006d46c
