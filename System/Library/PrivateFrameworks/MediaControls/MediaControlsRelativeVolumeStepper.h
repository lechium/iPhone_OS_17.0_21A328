...
- (void).cxx_destruct;	// IMP=0x000000000006474a
...
- (void)increaseButtonHoldReleased:(id)arg1;	// IMP=0x000000000006448d
- (void)increaseButtonHoldBegan:(id)arg1;	// IMP=0x0000000000064440
- (void)increaseTouchUpInside:(id)arg1;	// IMP=0x0000000000064423
- (void)decreaseButtonHoldReleased:(id)arg1;	// IMP=0x00000000000643ba
- (void)decreaseButtonHoldBegan:(id)arg1;	// IMP=0x000000000006436d
- (void)decreaseTouchUpInside:(id)arg1;	// IMP=0x0000000000064350
- (void)layoutSubviews;	// IMP=0x0000000000064193
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000063a2b
