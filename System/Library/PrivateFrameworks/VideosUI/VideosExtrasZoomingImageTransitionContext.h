...
- (void).cxx_destruct;	// IMP=0x0000000000040e99
...
- (id)initWithZoomingImageView:(id)arg1 itemIndex:(unsigned long long)arg2 appearState:(unsigned long long)arg3 isInteractive:(_Bool)arg4;	// IMP=0x0000000000040d8e
