...
- (void).cxx_destruct;	// IMP=0x000000000022d133
...
- (id)initWithGroup:(id)arg1 recordName:(id)arg2 uuid:(id)arg3 parentUuid:(id)arg4 type:(id)arg5;	// IMP=0x000000000022cddf
