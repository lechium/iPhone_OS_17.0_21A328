...
- (void)postNotificationsForType:(unsigned long long)arg1 forStart:(_Bool)arg2;	// IMP=0x000000000125caa5
- (void)postNotificationsForType:(unsigned long long)arg1 from:(struct CGRect)arg2 to:(struct CGRect)arg3 forStart:(_Bool)arg4;	// IMP=0x000000000125c8e9
