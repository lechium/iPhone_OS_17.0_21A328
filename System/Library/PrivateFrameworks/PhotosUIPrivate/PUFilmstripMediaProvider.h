...
- (void).cxx_destruct;	// IMP=0x0000000000246940
...
- (void)_deliverPlaceholderImage;	// IMP=0x000000000024677d
- (void)_deliverResult:(id)arg1;	// IMP=0x0000000000246573
- (void)_deliverPendingResults;	// IMP=0x0000000000246156
- (void)_didGenerateImage:(id)arg1 error:(id)arg2 requestedTime:(CDStruct_1b6d18a9)arg3 actualTime:(CDStruct_1b6d18a9)arg4 generatorResult:(long long)arg5 forResult:(id)arg6;	// IMP=0x0000000000245ef1
- (void)_generateImageForResult:(id)arg1;	// IMP=0x0000000000245ca4
- (void)dealloc;	// IMP=0x0000000000245c5b
- (void)cancelAllRequests;	// IMP=0x0000000000245bea
- (void)cancelImageRequest:(int)arg1;	// IMP=0x0000000000245abb
- (void)_handleSourceTimeLoadedForAsset:(id)arg1 time:(double)arg2 targetSize:(struct CGSize)arg3 contentMode:(long long)arg4 requestNumber:(long long)arg5;	// IMP=0x0000000000245974
- (int)requestImageForAsset:(id)arg1 targetSize:(struct CGSize)arg2 contentMode:(long long)arg3 options:(id)arg4 resultHandler:(CDUnknownBlockType)arg5;	// IMP=0x0000000000245640
- (void)_performIvarWrite:(CDUnknownBlockType)arg1;	// IMP=0x00000000002454f9
- (void)_performIvarRead:(CDUnknownBlockType)arg1;	// IMP=0x00000000002454e1
- (id)init;	// IMP=0x00000000002454cb
- (id)initWithAVAsset:(id)arg1 videoComposition:(id)arg2;	// IMP=0x00000000002451b5
