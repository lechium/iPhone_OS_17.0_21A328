...
+ (id)animationWithDuration:(double)arg1 startValue:(id)arg2 endValue:(CDUnknownBlockType)arg3 timingFunction:applier: /* Error: Ran out of types for this method. */;	// IMP=0x001000000000f4fd
- (void).cxx_destruct;	// IMP=0x000000000000f88d
...
- (void)completeAnimation;	// IMP=0x000000000000f7ba
- (_Bool)isAnimating;	// IMP=0x000000000000f7a3
- (void)update:(double)arg1;	// IMP=0x000000000000f6e1
- (void)dealloc;	// IMP=0x000000000000f683
- (id)initWithDuration:(double)arg1 startValue:(id)arg2 endValue:(CDUnknownBlockType)arg3 timingFunction:applier: /* Error: Ran out of types for this method. */;	// IMP=0x000000000000f595
