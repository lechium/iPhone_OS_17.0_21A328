...
- (void).cxx_destruct;	// IMP=0x00200000000743ec
...
- (id)debugDescription;	// IMP=0x0010000000074201
- (_Bool)isValid;	// IMP=0x00100000000741f8
- (id)initWithSong:(id)arg1;	// IMP=0x0010000000073e56
