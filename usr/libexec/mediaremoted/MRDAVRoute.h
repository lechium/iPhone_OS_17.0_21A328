...
@interface MRDAVRoute : NSObject
{
    ...
    NSDictionary *;	// 64 = 0x40
}

+ (id)allocWithZone:(struct _NSZone *)arg1;	// IMP=0x0040000000135aa1
- (void).cxx_destruct;	// IMP=0x0020000000135c63
...
- (unsigned long long)sampleRate;	// IMP=0x0010000000135bf1
- (_Bool)matchesUniqueIdentifier:(id)arg1;	// IMP=0x0010000000135b83
- (id)initWithDictionary:(id)arg1;	// IMP=0x0010000000135af1
