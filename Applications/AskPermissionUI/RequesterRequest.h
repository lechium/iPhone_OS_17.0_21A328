...
- (void).cxx_destruct;	// IMP=0x002000000000baad
...
- (id)requestIdentifier;	// IMP=0x001000000000ba71
@property(readonly, nonatomic) NSDate *date; // @synthesize date=_date;
@property(readonly, copy) NSString *description;
- (id)compile;	// IMP=0x001000000000b810
- (id)initWithDictionary:(id)arg1;	// IMP=0x001000000000b3d9
- (id)initWithDate:(id)arg1 requestIdentifier:(id)arg2 uniqueIdentifier:(id)arg3 itemIdentifier:(id)arg4 localizations:(id)arg5 offerName:(id)arg6 status:(long long)arg7;	// IMP=0x001000000000b2aa
