...
+ (id)sharedManager;	// IMP=0x006000000045babb
...
- (void)effectsRegistered:(_Bool)arg1;	// IMP=0x000000000045c4de
- (void)encodeProcessedPixelBuffer:(struct __CVBuffer *)arg1 time:(CDStruct_1b6d18a9)arg2 imageData:(id)arg3 processTime:(id)arg4;	// IMP=0x000000000045c3f8
- (void)resetEffectsLogging;	// IMP=0x000000000045c39a
- (void)flushRemoteQueue;	// IMP=0x000000000045c079
- (void)tearDownRemoteQueues;	// IMP=0x000000000045c073
- (void)updateThermalLevel:(int)arg1;	// IMP=0x000000000045bca7
- (_Bool)isFaceMeshTrackingEnabled;	// IMP=0x000000000045bac9
- (void)registerBlocksForService;	// IMP=0x000000000045bac3
@property(nonatomic) id <VCEffectsManagerDelegate> delegate; // @synthesize delegate=_delegate;
- (void)releaseAllocators;	// IMP=0x000000000045ba96
- (_Bool)createAllocators;	// IMP=0x000000000045ba8e
- (_Bool)initializeReceiveQueue:(id)arg1 error:(id *)arg2;	// IMP=0x000000000045ba86
- (void)dealloc;	// IMP=0x000000000045b9e4
- (id)init;	// IMP=0x000000000045b8db
