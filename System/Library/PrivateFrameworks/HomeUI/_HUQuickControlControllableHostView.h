...
- (void).cxx_destruct;	// IMP=0x000000000032a8d8
...
- (void)beginUserInteractionWithFirstTouchGestureRecognizer:(id)arg1;	// IMP=0x000000000032a83d
- (id)intrinsicSizeDescriptorForControlSize:(unsigned long long)arg1;	// IMP=0x000000000032a824
- (id)initWithProfile:(id)arg1;	// IMP=0x000000000032a708
