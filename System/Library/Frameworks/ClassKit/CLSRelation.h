...
- (void).cxx_destruct;	// IMP=0x000000000008f195
...
- (id)description;	// IMP=0x000000000008f004
- (_Bool)isEquivalentToRelation:(id)arg1;	// IMP=0x000000000008ece7
- (_Bool)isInverseOfRelation:(id)arg1;	// IMP=0x000000000008e97b
- (id)initWithFromEntity:(Class)arg1 toEntity:(Class)arg2 onFromKey:(id)arg3 toKey:(id)arg4 faultable:(_Bool)arg5;	// IMP=0x000000000008e8bb
