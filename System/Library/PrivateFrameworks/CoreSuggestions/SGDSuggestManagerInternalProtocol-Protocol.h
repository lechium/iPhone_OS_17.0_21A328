...
@class CSSearchableItem, NSArray, NSData, NSDate, NSString, NSURL, SGRecordId, SGSimpleMailMessage;
...
- (void)dissectAttachmentsFromSearchableItem:(CSSearchableItem *)arg1 options:(unsigned long long)arg2 withCompletion:(void (^)(SGXPCResponse1 *))arg3;
