...
- (void).cxx_destruct;	// IMP=0x0000000000020094
@property(readonly, nonatomic) __weak EKReminderStore *reminderStore; // @synthesize reminderStore=_reminderStore;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000020073
- (void)cancel;	// IMP=0x000000000002001a
- (id)initWithReminderStore:(id)arg1;	// IMP=0x000000000001ffb6
