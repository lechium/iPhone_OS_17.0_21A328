...
+ (_Bool)supportsInteractiveCounterRotationDismissals;	// IMP=0x004000000004958a
- (void).cxx_destruct;	// IMP=0x0000000000049512
...
- (id)toView;	// IMP=0x00000000000493aa
...
- (id)presentingView;	// IMP=0x000000000004902f
...
- (id)fromView;	// IMP=0x0000000000048d31
...
- (id)initWithPresentationController:(id)arg1 configuration:(id)arg2;	// IMP=0x0000000000048965
