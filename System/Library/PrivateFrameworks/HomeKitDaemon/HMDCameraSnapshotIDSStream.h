...
+ (id)logCategory;	// IMP=0x00100000006bf440
- (void).cxx_destruct;	// IMP=0x00000000006bf3ed
...
- (id)logIdentifier;	// IMP=0x00000000006bf345
- (void)dealloc;	// IMP=0x00000000006bf227
- (id)initWithSessionID:(id)arg1 workQueue:(id)arg2 proxyService:(id)arg3;	// IMP=0x00000000006bf05b
