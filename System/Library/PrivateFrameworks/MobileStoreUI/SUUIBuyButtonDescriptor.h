...
@class NSString, SUUIStoreIdentifier;
...
@property(retain, nonatomic) SUUIStoreIdentifier *storeIdentifier; // @synthesize storeIdentifier=_storeIdentifier;
...
- (_Bool)canPerformLocalActionWithItemState:(id)arg1;	// IMP=0x000000000019986f
- (_Bool)canPersonalizeUsingItemState:(id)arg1;	// IMP=0x0000000000199734
