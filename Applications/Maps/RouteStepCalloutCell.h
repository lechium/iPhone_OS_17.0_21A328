...
+ (id)cellWithRoute:(id)arg1 stepIndex:(unsigned long long)arg2 type:(unsigned int)arg3;	// IMP=0x004000000041bda0
- (void).cxx_destruct;	// IMP=0x002000000041c574
...
- (void)drawInRect:(struct CGRect)arg1;	// IMP=0x001000000041c348
- (_Bool)rotate;	// IMP=0x001000000041c2cf
- (_Bool)shouldRotateWithCallout:(id)arg1;	// IMP=0x001000000041c26c
- (struct CGRect)_frameForType:(unsigned int)arg1;	// IMP=0x001000000041bfc2
...
- (id)initWithRoute:(id)arg1 stepIndex:(unsigned long long)arg2 type:(unsigned int)arg3;	// IMP=0x001000000041bdfd
