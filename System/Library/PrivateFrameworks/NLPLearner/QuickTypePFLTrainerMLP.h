...
+ (id)reportingStringForModelUpdates:(float *)arg1 count:(unsigned long long)arg2;	// IMP=0x006000000000be55
+ (struct __CFData *)copyToFlatBuffer:(void *)arg1;	// IMP=0x006000000000bd56
+ (void)initialize;	// IMP=0x006000000000bd08
- (id).cxx_construct;	// IMP=0x000000000000d9b3
- (void).cxx_destruct;	// IMP=0x000000000000d93e
...
- (void)writeModelToURL:(id)arg1;	// IMP=0x000000000000d762
- (id)getWeightUpdatesAddNoise:(_Bool)arg1 encryptionKey:(id)arg2 recipe:(id)arg3;	// IMP=0x000000000000cbd8
- (_Bool)trainOn:(id)arg1 forNEpochs:(unsigned long long)arg2;	// IMP=0x000000000000c2f0
- (id)initWithSeedModelPath:(id)arg1 andPrivacyIdentifier:(id)arg2;	// IMP=0x000000000000c170
