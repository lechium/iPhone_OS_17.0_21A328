...
@interface LPiTunesMediaPodcastUnresolvedMetadata : NSObject
{
...
- (void).cxx_destruct;	// IMP=0x00000000000622ef
...
- (id)assetsToFetch;	// IMP=0x00000000000621f1
- (id)resolve;	// IMP=0x0000000000061f3e
