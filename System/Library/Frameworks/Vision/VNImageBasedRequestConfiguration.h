...
- (void).cxx_destruct;	// IMP=0x0000000000161a03
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001618cc
- (id)initWithRequestClass:(Class)arg1;	// IMP=0x000000000016187a
