...
- (void).cxx_destruct;	// IMP=0x00200000001e7a53
- (void)_handleRepairBundleIDNotification:(id)arg1;	// IMP=0x00100000001e5b89
- (void)_handleNetworkStateDidChangeNotification:(id)arg1;	// IMP=0x00100000001e53a4
- (void)decorateMetricsEvent:(id)arg1 context:(id)arg2;	// IMP=0x00100000001e4058
- (id)createMetricsEventsForEventType:(unsigned char)arg1 context:(id)arg2;	// IMP=0x00100000001e3cf2
- (id)init;	// IMP=0x00100000001dcad3
