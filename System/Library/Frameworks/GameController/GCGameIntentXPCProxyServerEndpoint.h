...
- (void).cxx_destruct;	// IMP=0x000000000003a3af
...
- (void)fetchObjectIdentifierWithReply:(CDUnknownBlockType)arg1;	// IMP=0x000000000003a2f9
- (void)invalidateConnection;	// IMP=0x000000000003a246
- (_Bool)acceptClient:(id)arg1 onConnection:(id)arg2 error:(id *)arg3;	// IMP=0x0000000000039fdb
- (void)invalidateClient;	// IMP=0x0000000000039f1a
- (void)triggerGameIntentWithEvent:(long long)arg1;	// IMP=0x0000000000039ec9
@property(readonly, nonatomic) id <_GCControllerComponentDescription> receiverDescription;
- (id)init;	// IMP=0x0000000000039e38
- (id)initWithIdentifier:(id)arg1;	// IMP=0x0000000000039dc3
