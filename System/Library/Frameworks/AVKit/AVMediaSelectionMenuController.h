...
- (void).cxx_destruct;	// IMP=0x000000000003ce6b
...
- (void)_updateSelectionStateForMenu:(id)arg1 selectedIndex:(unsigned long long)arg2;	// IMP=0x000000000003cbe6
- (id)_menuForOptions:(id)arg1 withIdentifier:(id)arg2;	// IMP=0x000000000003c71f
- (id)_displayNameForMediaSelectionOption:(id)arg1;	// IMP=0x000000000003c642
@property(readonly, nonatomic) UIMenu *legibleOptionsMenu;
@property(readonly, nonatomic) UIMenu *audibleOptionsMenu;
- (id)initWithAudibleOptions:(id)arg1 legibleOptions:(id)arg2;	// IMP=0x000000000003c36b
