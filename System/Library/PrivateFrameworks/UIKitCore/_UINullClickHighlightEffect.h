...
+ (id)effectWithPreview:(id)arg1 continuingFromPreview:(id)arg2;	// IMP=0x00100000002e4e52
- (void).cxx_destruct;	// IMP=0x00000000002e4f3e
...
- (void)interaction:(id)arg1 didChangeWithContext:(id)arg2;	// IMP=0x00000000002e4e9f
