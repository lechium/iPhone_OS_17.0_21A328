...
+ (id)_derivedExtensionAuxiliaryHostProtocolWithContextClass:(Class)arg1;	// IMP=0x001000000000f8d5
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000000f8cd
+ (id)_extensionContextForIdentifier:(id)arg1;	// IMP=0x001000000000f84f
+ (id)_extensionContextVendorProtocolWithAllowedErrorClasses:(id)arg1;	// IMP=0x001000000000f6ff
+ (id)_defaultExtensionContextVendorProtocol;	// IMP=0x001000000000f656
+ (id)_extensionContextHostProtocolWithAllowedErrorClasses:(id)arg1;	// IMP=0x001000000000f340
+ (id)_extensionContextHostProtocolAllowedClassesForItems;	// IMP=0x001000000000f2e9
- (void).cxx_destruct;	// IMP=0x0000000000012878
...
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x0000000000012454
- (void)___nsx_pingHost:(CDUnknownBlockType)arg1;	// IMP=0x0000000000012449
- (void)_willPerformHostCallback:(CDUnknownBlockType)arg1;	// IMP=0x0000000000012220
@property(readonly, copy) NSString *description;
- (void)_openURL:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000000011fa4
- (void)_loadPreviewImageForPayload:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000011dcf
- (void)_loadItemForPayload:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000011a12
- (void)openURL:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000011798
- (void)cancelRequestWithError:(id)arg1;	// IMP=0x00000000000114c8
- (void)completeRequestReturningItems:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000010b03
- (void)_completeRequestReturningItemsSecondHalf:(CDUnknownBlockType)arg1;	// IMP=0x0000000000010af8
- (_Bool)_isHost;	// IMP=0x0000000000010ac5
- (void)dealloc;	// IMP=0x0000000000010a70
- (void)invalidate;	// IMP=0x000000000001095c
- (void)_initializeAuxillaryConnectionWithListenerEndpoint:(id)arg1;	// IMP=0x0000000000010447
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000103ce
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000103c3
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000001026f
- (id)initWithInputItems:(id)arg1 listenerEndpoint:(id)arg2 contextUUID:(id)arg3 extensionContext:(id)arg4;	// IMP=0x000000000000fb9d
