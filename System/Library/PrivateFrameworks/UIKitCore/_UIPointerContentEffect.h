...
- (void).cxx_destruct;	// IMP=0x00000000012df951
...
- (void)addCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00000000012df6eb
- (id)previewForContinuingToEffectWithPreview:(id)arg1;	// IMP=0x00000000012df522
- (void)setDescriptor:(id)arg1 andKey:(id)arg2;	// IMP=0x00000000012df3b6
@property(readonly, nonatomic) id <_UIContentEffectDescriptor> descriptor;
- (void)_monitoredView:(id)arg1 didMoveFromSuperview:(id)arg2 toSuperview:(id)arg3;	// IMP=0x00000000012df39e
- (void)_monitoredView:(id)arg1 willMoveFromSuperview:(id)arg2 toSuperview:(id)arg3;	// IMP=0x00000000012df1ef
- (_Bool)_monitorsView:(id)arg1;	// IMP=0x00000000012df13c
- (void)_ensureRelativeEffectViewOrderInContainer;	// IMP=0x00000000012ded07
- (void)_modifyEffectContainerViewHierarchy:(CDUnknownBlockType)arg1 waitForCACommit:(_Bool)arg2;	// IMP=0x00000000012dec24
- (void)_cleanUpObservation;	// IMP=0x00000000012deac6
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x00000000012de747
- (void)_anchorPlatterView:(id)arg1 toPreview:(id)arg2 updateBounds:(_Bool)arg3;	// IMP=0x00000000012ddd78
- (id)_positionReferenceViewForPreview:(id)arg1;	// IMP=0x00000000012ddb15
- (void)_tearDownPlatterView;	// IMP=0x00000000012ddaae
- (void)_createAndInstallPlatterView;	// IMP=0x00000000012dd304
- (void)_commitPointerStyleToArbiterWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00000000012dce07
- (void)_updateFromState:(long long)arg1 toState:(long long)arg2;	// IMP=0x00000000012dbee0
- (void)setPressed:(_Bool)arg1 animated:(_Bool)arg2;	// IMP=0x00000000012dbd4e
- (void)end:(_Bool)arg1;	// IMP=0x00000000012dbce6
- (void)begin;	// IMP=0x00000000012dbc89
- (void)_updatePlatterView:(id)arg1 forStyle:(id)arg2;	// IMP=0x00000000012db84b
- (void)_setStyle:(id)arg1 andRegion:(id)arg2;	// IMP=0x00000000012db728
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000012db634
- (void)dealloc;	// IMP=0x00000000012db5f6
- (id)initWithStyle:(id)arg1 region:(id)arg2;	// IMP=0x00000000012db498
