...
- (void).cxx_destruct;	// IMP=0x0000000000823c01
...
- (void)addDestinationRegion:(id)arg1;	// IMP=0x0000000000823af0
- (void)addSnapshot:(id)arg1;	// IMP=0x0000000000823a66
@property(readonly, copy, nonatomic) NSArray *destinationRegions;
@property(readonly, copy, nonatomic) NSArray *snapshots;
- (id)init;	// IMP=0x000000000082395d
