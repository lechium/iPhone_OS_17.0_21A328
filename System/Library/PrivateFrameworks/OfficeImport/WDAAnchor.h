...
+ (id)stringForTextWrappingModeType:(int)arg1;	// IMP=0x00600000003e4386
- (void).cxx_destruct;	// IMP=0x00000000003e4450
...
- (id)description;	// IMP=0x00000000003e43a7
- (id)init;	// IMP=0x000000000015a318
