...
- (void)_queue_terminateBubbleForID:(int)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x001000000001f110
- (void);	// IMP=0x001000000001f0fe
- (void)scheduleSyncBubbleTerminationForUser:(id)arg1;	// IMP=0x001000000001f0f8
- (id)init;	// IMP=0x001000000001f0a0
