...
- (void).cxx_destruct;	// IMP=0x000000000050f902
...
- (void)_momentShareCacheDidChange:(id)arg1;	// IMP=0x000000000050f7d1
- (void)_handleFetchedMomentShare:(id)arg1 error:(id)arg2;	// IMP=0x000000000050f5ee
- (void)_fetchMomentShare;	// IMP=0x000000000050f494
- (id)createInitialDataSource;	// IMP=0x000000000050f23a
- (id)initWithMomentShareURL:(id)arg1;	// IMP=0x000000000050f126
- (id)init;	// IMP=0x000000000050f112
