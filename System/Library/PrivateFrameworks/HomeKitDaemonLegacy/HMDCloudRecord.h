...
+ (id)logCategory;	// IMP=0x006000000094a9b1
+ (id)shortDescription;	// IMP=0x006000000094a99f
- (void).cxx_destruct;	// IMP=0x000000000094a92c
...
- (void)clearData;	// IMP=0x000000000094a76e
...
- (_Bool)encodeObjectChange:(id)arg1;	// IMP=0x0000000000949cc9
- (id)extractObjectChange;	// IMP=0x00000000009491e0
- (id)description;	// IMP=0x0000000000949174
- (id)shortDescription;	// IMP=0x0000000000949088
- (id)initWithObjectID:(id)arg1 recordName:(id)arg2 cloudZone:(id)arg3;	// IMP=0x0000000000948f30
- (id)init;	// IMP=0x0000000000948e88
