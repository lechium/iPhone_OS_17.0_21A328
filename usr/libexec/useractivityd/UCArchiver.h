...
- (void).cxx_destruct;	// IMP=0x002000000007c913
@property(retain) NSUUID *uuid; // @synthesize uuid=_uuid;
@property(retain) NSString *leaf; // @synthesize leaf=_leaf;
@property(retain) NSURL *baseURL; // @synthesize baseURL=_baseURL;
- (void)archiveURLWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x001000000007c89a
- (id)initWithURL:(id)arg1 typeUUID:(id)arg2;	// IMP=0x001000000007c77a
