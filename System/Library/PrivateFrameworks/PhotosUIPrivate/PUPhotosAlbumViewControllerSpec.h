...
+ (id)padSpec;	// IMP=0x0060000000450b48
+ (id)phoneSpec;	// IMP=0x0060000000450b2f
...
- (void)configureCollectionViewGridLayout:(id)arg1;	// IMP=0x0000000000450a1b
@property(readonly, nonatomic) double contentCornerRadius;
- (long long)cellFillMode;	// IMP=0x0000000000450a07
- (id)gridSpec;	// IMP=0x00000000004509ff
