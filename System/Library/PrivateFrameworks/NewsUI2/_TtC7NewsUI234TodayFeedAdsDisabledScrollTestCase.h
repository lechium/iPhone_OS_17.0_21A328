...
@interface _TtC7NewsUI234TodayFeedAdsDisabledScrollTestCase : NSObject
{
...
- (void).cxx_destruct;	// IMP=0x00000000001bbf30
- (id)init;	// IMP=0x00000000001bbee0
- (id)scrollViewWithContext:(id)arg1;	// IMP=0x00000000001bbd80
