...
- (void).cxx_destruct;	// IMP=0x00000000006b1aae
...
- (void)setValueUpdatedTime:(id)arg1 stateNumber:(id)arg2;	// IMP=0x00000000006b1991
- (id)initWithError:(id)arg1;	// IMP=0x00000000006b1923
- (id)initWithValue:(id)arg1 updateIdentifier:(id)arg2 remoteDevice:(id)arg3;	// IMP=0x00000000006b1859
