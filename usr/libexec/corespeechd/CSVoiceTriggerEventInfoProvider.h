...
+ (_Bool)isVoiceTriggerInfoAvailableLocally:(id)arg1;	// IMP=0x00400000000bb07f
+ (id)sharedInstance;	// IMP=0x00100000000bb04f
- (void).cxx_destruct;	// IMP=0x00200000000badb9
...
- (_Bool)_isBuiltInDeviceFromDeviceId:(id)arg1;	// IMP=0x00100000000bad64
- (void)fetchVoiceTriggerInfoWithAudioContext:(id)arg1 resultVoiceTriggerInfo:(id *)arg2 resultRTSTriggerInfo:(id *)arg3;	// IMP=0x00100000000baad1
- (void)setVoiceTriggerInfo:(id)arg1 deviceId:(id)arg2;	// IMP=0x00100000000baa1a
- (id)init;	// IMP=0x00100000000ba993
