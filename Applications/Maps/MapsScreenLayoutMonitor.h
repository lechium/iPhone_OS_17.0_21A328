...
+ (id)sharedMonitor;	// IMP=0x0020000000671387
- (void).cxx_destruct;	// IMP=0x002000000067220e
...
- (void)_layoutMonitor:(id)arg1 didUpdateDisplayLayout:(id)arg2 withContext:(id)arg3;	// IMP=0x0010000000671dbe
- (unsigned long long)_changeReasonWithNewLayout:(id)arg1 context:(id)arg2;	// IMP=0x0010000000671bcb
- (_Bool)_isMapsActiveInLayout:(id)arg1;	// IMP=0x0010000000671a21
- (void)_notifyObservers;	// IMP=0x001000000067195a
- (void)_prepareLayoutMonitor;	// IMP=0x001000000067193f
- (void)stopMonitoringWithObserver:(id)arg1;	// IMP=0x001000000067181d
- (void)startMonitoringWithObserver:(id)arg1;	// IMP=0x00100000006716a5
@property(retain, nonatomic) FBSDisplayLayoutMonitor *layoutMonitor; // @synthesize layoutMonitor=_layoutMonitor;
- (void)dealloc;	// IMP=0x0010000000671450
- (id)init;	// IMP=0x00100000006713dc
