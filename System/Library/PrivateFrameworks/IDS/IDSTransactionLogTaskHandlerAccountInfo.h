...
- (void).cxx_destruct;	// IMP=0x000000000012540b
...
- (id)accountForAlias:(id)arg1;	// IMP=0x000000000012536a
- (id)initWithAccountIdentity:(id)arg1 aliasToAccountsMap:(id)arg2 serviceName:(id)arg3;	// IMP=0x00000000001252b2
