...
- (void).cxx_destruct;	// IMP=0x000000000020b46f
...
- (void)_finishOnCallbackQueueWithError:(id)arg1;	// IMP=0x000000000020b33b
- (void)main;	// IMP=0x000000000020afdf
- (int)operationType;	// IMP=0x000000000020afd4
- (void)_handleFetchChangesRequestFinished:(id)arg1;	// IMP=0x000000000020ac96
- (id)activityCreate;	// IMP=0x000000000020ac6d
- (id)initWithOperationInfo:(id)arg1 container:(id)arg2;	// IMP=0x000000000020abaa
