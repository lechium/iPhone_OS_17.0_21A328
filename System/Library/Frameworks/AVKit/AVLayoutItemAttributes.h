...
- (void).cxx_destruct;	// IMP=0x000000000014b300
...
- (id)debugDescription;	// IMP=0x000000000014b062
- (unsigned long long)hash;	// IMP=0x000000000014b01e
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000014af48
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000014ad11
@property(readonly, nonatomic, getter=isCollapsedOrExcluded) _Bool collapsedOrExcluded;
- (id)init;	// IMP=0x000000000014ac05
