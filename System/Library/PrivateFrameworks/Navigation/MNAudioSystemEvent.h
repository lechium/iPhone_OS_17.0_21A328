...
- (void).cxx_destruct;	// IMP=0x0000000000009e6e
...
- (id)description;	// IMP=0x0000000000009c76
- (_Bool)isEqualToEvent:(id)arg1;	// IMP=0x0000000000009b21
@property(readonly, nonatomic) _Bool hasSoundEffect;
- (id)initWithUtterance:(id)arg1 andShortPrompt:(unsigned long long)arg2 andVoiceGuidanceLevel:(unsigned long long)arg3 andCompletion:(CDUnknownBlockType)arg4;	// IMP=0x00000000000099f6
