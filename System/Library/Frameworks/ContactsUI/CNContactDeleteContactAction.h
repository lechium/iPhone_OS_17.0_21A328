...
- (void).cxx_destruct;	// IMP=0x00000000000f478d
...
- (void)showDeleteFailureAlert;	// IMP=0x00000000000f456c
- (_Bool)deleteContact;	// IMP=0x00000000000f4345
- (void)performActionWithSender:(id)arg1;	// IMP=0x00000000000f3f90
- (id)initWithContact:(id)arg1 recentsManager:(id)arg2 componentsFactory:(id)arg3;	// IMP=0x00000000000f3eda
