...
- (void).cxx_destruct;	// IMP=0x00000000000884e5
...
- (id)adjustedForString:(id)arg1;	// IMP=0x00000000000883d1
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000008832c
- (id)initWithPlatform:(long long)arg1 sizeClass:(unsigned long long)arg2 fontScalingFactor:(double)arg3;	// IMP=0x0000000000087a6f
