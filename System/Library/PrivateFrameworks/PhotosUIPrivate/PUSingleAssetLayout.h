...
- (void).cxx_destruct;	// IMP=0x0000000000518ba7
...
- (struct CGRect)visibleRectForScrollingToItemAtIndexPath:(id)arg1 scrollPosition:(long long)arg2;	// IMP=0x0000000000518ac5
- (id)layoutInfoForTileWithIndexPath:(id)arg1 kind:(id)arg2;	// IMP=0x0000000000518799
- (id)layoutInfosForTilesInRect:(struct CGRect)arg1;	// IMP=0x0000000000518667
- (struct CGRect)contentBounds;	// IMP=0x000000000051861d
- (void)_invalidateSingleAssetLayout;	// IMP=0x0000000000518326
