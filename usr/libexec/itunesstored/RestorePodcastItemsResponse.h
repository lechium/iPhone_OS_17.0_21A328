...
- (void)setError:(id)arg1 forItemIdentifier:(id)arg2;	// IMP=0x00100000001a111b
- (id)errorForItemIdentifier:(id)arg1;	// IMP=0x00100000001a10f4
- (void)dealloc;	// IMP=0x00100000001a109c
