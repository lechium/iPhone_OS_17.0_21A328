...
- (void).cxx_destruct;	// IMP=0x00200000002c08b5
...
- (void)sendEvent:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00100000002c03c0
- (void)sendEvent:(id)arg1;	// IMP=0x00100000002c03ac
- (void)handleEventWithAction:(unsigned int)arg1 token:(unsigned long long)arg2 descriptor:(id)arg3;	// IMP=0x00100000002bff30
- (id)initWithStreamName:(id)arg1;	// IMP=0x00100000002bfc15
