...
- (void).cxx_destruct;	// IMP=0x0020000000d33a33
- (id)tableParts;	// IMP=0x0010000000d338a7
...
- (void)viewDidAppear:(_Bool)arg1;	// IMP=0x0010000000d336b4
- (id)initWithReport:(id)arg1 question:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x0010000000d335d5
