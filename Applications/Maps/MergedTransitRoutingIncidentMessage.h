...
- (void).cxx_destruct;	// IMP=0x00200000003eb08f
...
- (id)initWithGEOComposedRouteAdvisory:(id)arg1 transitIncidents:(id)arg2;	// IMP=0x00100000003eae73
- (id)initWithTransitIncidents:(id)arg1;	// IMP=0x00100000003eae5c
