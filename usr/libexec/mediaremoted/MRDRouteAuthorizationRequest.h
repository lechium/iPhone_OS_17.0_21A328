...
- (void).cxx_destruct;	// IMP=0x002000000012de7f
...
- (void)cancel;	// IMP=0x001000000012de5f
- (void)respondWithAuthorizationToken:(id)arg1;	// IMP=0x001000000012de4d
- (id)initWithRoute:(id)arg1 inputType:(long long)arg2 responseCallback:(CDUnknownBlockType)arg3 cancelCallback:(CDUnknownBlockType)arg4;	// IMP=0x001000000012dd62
