...
- (void).cxx_destruct;	// IMP=0x0020000000186998
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000001867ae
- (unsigned long long)hash;	// IMP=0x001000000018670f
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000001865d7
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000001864bf
- (void)copyTo:(id)arg1;	// IMP=0x00100000001863fc
- (void)writeTo:(id)arg1;	// IMP=0x0010000000186348
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000186051
- (id)dictionaryRepresentation;	// IMP=0x0010000000185e98
- (id)description;	// IMP=0x0010000000185de9
