...
+ (double)heightForButtonsViewWithButtonCount:(long long)arg1;	// IMP=0x001000000035414c
+ (double)buttonHeight;	// IMP=0x00100000003540c0
...
- (struct CGRect)actionButtonsViewFrameForButtonCount:(long long)arg1;	// IMP=0x0000000000353e1d
- (id)initWithContainerSize:(struct CGSize)arg1 insets:(struct UIEdgeInsets)arg2 buttonCount:(long long)arg3;	// IMP=0x0000000000353d8f
