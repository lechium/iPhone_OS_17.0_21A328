...
+ (id)logCategory;	// IMP=0x00100000006a651c
- (void).cxx_destruct;	// IMP=0x00000000006a638b
...
- (void)sendRemoteMessageWithName:(id)arg1 payload:(id)arg2 responseHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000000006a5f31
- (id)logIdentifier;	// IMP=0x00000000006a5ee1
- (id)initWithTarget:(id)arg1 accessory:(id)arg2 device:(id)arg3 workQueue:(id)arg4 messageDispatcher:(id)arg5;	// IMP=0x00000000006a5dc1
