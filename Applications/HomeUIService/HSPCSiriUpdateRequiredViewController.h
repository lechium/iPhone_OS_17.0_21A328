...
- (void).cxx_destruct;	// IMP=0x00200000000038c8
...
- (id)commitConfiguration;	// IMP=0x001000000000385a
- (id)initWithCoordinator:(id)arg1 config:(id)arg2;	// IMP=0x00100000000036a7
