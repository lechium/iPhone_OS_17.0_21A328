...
- (void).cxx_destruct;	// IMP=0x00200000000a573a
@property(nonatomic) __weak id <ADDisplayScaleContextCollectorDelegate> delegate; // @synthesize delegate=_delegate;
- (double)displayScale;	// IMP=0x00100000000a571a
- (void)dealloc;	// IMP=0x00100000000a5697
- (id)initWithDelegate:(id)arg1;	// IMP=0x00100000000a562f
