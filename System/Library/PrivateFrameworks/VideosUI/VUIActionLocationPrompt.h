...
- (void)_locationAuthorizationStatusDidChange:(id)arg1;	// IMP=0x000000000016c7dc
- (void)performWithTargetResponder:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000000016c55f
- (id)initWithContextData:(id)arg1;	// IMP=0x000000000016c37c
