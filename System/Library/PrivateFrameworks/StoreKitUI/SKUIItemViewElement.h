...
- (void).cxx_destruct;	// IMP=0x00000000002d7836
...
- (id)applyUpdatesWithElement:(id)arg1;	// IMP=0x00000000002d774c
- (id)initWithDOMElement:(id)arg1 parent:(id)arg2 elementFactory:(id)arg3;	// IMP=0x00000000002d7477
