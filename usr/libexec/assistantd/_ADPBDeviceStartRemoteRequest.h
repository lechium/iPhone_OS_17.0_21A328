...
+ (unsigned short)_ADPBDeviceRequestType;	// IMP=0x00200000000adb55
- (void).cxx_destruct;	// IMP=0x00200000001dd0a2
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000001dcef6
- (unsigned long long)hash;	// IMP=0x00100000001dce24
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000001dccae
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000001dcb72
- (void)copyTo:(id)arg1;	// IMP=0x00100000001dca8f
- (void)writeTo:(id)arg1;	// IMP=0x00100000001dc9b4
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000001dc732
- (id)dictionaryRepresentation;	// IMP=0x00100000001dc5d5
- (id)description;	// IMP=0x00100000001dc526
...
- (void)_ad_performWithSharedDataRemote:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00100000000cd650
- (void)_ad_performWithCloudService:(id)arg1 fromPeer:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x001000000014c733
