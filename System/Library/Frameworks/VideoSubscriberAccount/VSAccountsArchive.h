...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000044a59
- (void).cxx_destruct;	// IMP=0x0000000000044e42
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000044d13
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000044ab2
- (id)init;	// IMP=0x0000000000044a61
