...
+ (struct CGSize)bufferingIndicatorTileSize;	// IMP=0x00100000001acf36
+ (_Bool)canShowBufferingIndicatorTileForAsset:(id)arg1;	// IMP=0x00100000001acec3
- (void).cxx_destruct;	// IMP=0x00000000001acd55
...
- (void)observable:(id)arg1 didChange:(unsigned long long)arg2 context:(void *)arg3;	// IMP=0x00000000001acb85
- (void)viewModel:(id)arg1 didChange:(id)arg2;	// IMP=0x00000000001aca70
- (void)_updateIndicator;	// IMP=0x00000000001ac7f9
- (void)_handleErrorButton:(id)arg1;	// IMP=0x00000000001ac64c
- (void)_setIndicatorStyle:(long long)arg1 animated:(_Bool)arg2;	// IMP=0x00000000001ac026
- (void)becomeReusable;	// IMP=0x00000000001abd75
