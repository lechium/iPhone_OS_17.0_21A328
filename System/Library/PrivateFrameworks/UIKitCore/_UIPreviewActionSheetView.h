...
- (void).cxx_destruct;	// IMP=0x0000000000f1fe2a
...
- (void)_performActionForPreviewAction:(id)arg1 interfaceAction:(id)arg2;	// IMP=0x0000000000f1fc5e
- (void)_setupViewHierarchy;	// IMP=0x0000000000f1f192
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000f1f163
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000f1f11b
- (id)initWithFrame:(struct CGRect)arg1 title:(id)arg2 items:(id)arg3 contentInsets:(struct UIEdgeInsets)arg4;	// IMP=0x0000000000f1f03b
