...
- (void).cxx_destruct;	// IMP=0x000000000060f4e0
- (void)doneButtonTapped;	// IMP=0x000000000060f430
- (void)startButtonTapped;	// IMP=0x000000000060f410
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000060f2d0
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000060f2a0
