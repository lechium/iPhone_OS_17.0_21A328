...
- (void)addCustomFeatureListString:(id)arg1 payload:(int)arg2;	// IMP=0x00000000002c37dd
- (void)dealloc;	// IMP=0x00000000002c3736
- (id)description;	// IMP=0x00000000002c35f9
- (id)init;	// IMP=0x00000000002c3516
