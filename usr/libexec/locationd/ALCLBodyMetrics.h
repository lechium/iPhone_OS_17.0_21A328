...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000001c3974
- (unsigned long long)hash;	// IMP=0x00100000001c3284
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000001c317d
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000001c30a4
- (void)copyTo:(id)arg1;	// IMP=0x00100000001c3009
- (void)writeTo:(id)arg1;	// IMP=0x00100000001c2f11
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000001c2f04
- (id)dictionaryRepresentation;	// IMP=0x00100000001c28d5
- (id)description;	// IMP=0x00100000001c285e
- (int)StringAsGender:(id)arg1;	// IMP=0x00100000001c2817
- (id)genderAsString:(int)arg1;	// IMP=0x00100000001c27d8
