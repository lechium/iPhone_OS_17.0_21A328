...
- (void).cxx_destruct;	// IMP=0x0000000000ec0c0d
...
- (struct CGPoint)locationInCoordinateSpace:(id)arg1;	// IMP=0x0000000000ec09a7
@property(readonly, nonatomic) NSString *eventName;
- (_Bool)_affectedByGesture:(id)arg1;	// IMP=0x0000000000ec0992
- (void)reset;	// IMP=0x0000000000ec092f
- (void)touchesCancelled:(id)arg1 withEvent:(id)arg2;	// IMP=0x0000000000ec0893
- (void)touchesEnded:(id)arg1 withEvent:(id)arg2;	// IMP=0x0000000000ec07f7
- (void)touchesMoved:(id)arg1 withEvent:(id)arg2;	// IMP=0x0000000000ec07f1
- (void)touchesBegan:(id)arg1 withEvent:(id)arg2;	// IMP=0x0000000000ec06e8
- (struct CGPoint)locationInView:(id)arg1;	// IMP=0x0000000000ec0664
- (id)initWithTarget:(id)arg1 action:(SEL)arg2;	// IMP=0x0000000000ec05cc
