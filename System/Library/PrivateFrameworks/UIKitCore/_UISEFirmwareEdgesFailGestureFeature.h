...
- (void).cxx_destruct;	// IMP=0x00000000009268a5
@property(readonly, nonatomic) unsigned long long touchedEdges; // @synthesize touchedEdges=_touchedEdges;
- (void)_incorporateSample:(const struct _UISEGestureFeatureSample *)arg1;	// IMP=0x00000000009267f2
- (id)debugDictionary;	// IMP=0x0000000000926743
- (id)initWithSettings:(id)arg1;	// IMP=0x00000000009266d3
