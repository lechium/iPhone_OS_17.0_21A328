...
+ (_Bool)migrateFromVersion:(unsigned long long)arg1 finalVersion:(out unsigned long long *)arg2 inDatabase:(id)arg3;	// IMP=0x002000000009d1d8
+ (id)searchColumnName;	// IMP=0x001000000009ce47
+ (id)entityName;	// IMP=0x001000000009ce3a
- (void)bindTo:(id)arg1;	// IMP=0x002000000009d080
- (id)initWithDatabaseRow:(id)arg1;	// IMP=0x001000000009cf34
