...
- (void).cxx_destruct;	// IMP=0x000000000004bbf4
...
- (id)_newClippedPath;	// IMP=0x000000000004b92e
- (void)p_computeAngle:(double *)arg1 point:(struct CGPoint *)arg2 cutSegment:(long long *)arg3 cutT:(double *)arg4 forLineEndAtHead:(_Bool)arg5;	// IMP=0x000000000004b50c
- (void)p_validateTailLineEnd;	// IMP=0x000000000004b4c8
- (void)p_validateHeadLineEnd;	// IMP=0x000000000004b473
- (void)p_validateHeadAndTail;	// IMP=0x000000000004b403
- (void)p_invalidateClippedPath;	// IMP=0x000000000004b3df
- (void)p_invalidateTail;	// IMP=0x000000000004b3c7
- (void)p_invalidateHead;	// IMP=0x000000000004b3b1
- (id)clippedPathForLineEnds;	// IMP=0x000000000004b368
- (double)tailLineEndAngle;	// IMP=0x000000000004b346
- (double)headLineEndAngle;	// IMP=0x000000000004b324
- (struct CGPoint)tailLineEndPoint;	// IMP=0x000000000004b2fd
- (struct CGPoint)headLineEndPoint;	// IMP=0x000000000004b2d6
- (double)lineEndScale;	// IMP=0x000000000004b24e
- (id)strokeTailLineEnd;	// IMP=0x000000000004b198
- (id)strokeHeadLineEnd;	// IMP=0x000000000004b0e2
- (void)p_drawLineEndForHead:(_Bool)arg1 withDelta:(struct CGPoint)arg2 inContext:(struct CGContext *)arg3 useFastDrawing:(_Bool)arg4;	// IMP=0x000000000004af85
- (void)drawInContext:(struct CGContext *)arg1;	// IMP=0x000000000004aea5
- (id)init;	// IMP=0x000000000004ae6b
