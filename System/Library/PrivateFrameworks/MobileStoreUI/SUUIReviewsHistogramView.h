...
@class NSArray, NSMutableDictionary, NSString, SUUIClientContext, SUUIColorScheme, SUUIStarRatingControl, UIButton, UIControl, UIImageView, UILabel, UISegmentedControl;
...
@interface SUUIReviewsHistogramView : UIView
{
    ...
    SUUIStarRatingControl *_starRatingControl;	// 64 = 0x40
...
- (void).cxx_destruct;	// IMP=0x00000000002a3691
...
- (id)_countLabelString;	// IMP=0x00000000002a334b
- (id)_histogramImageForValues:(id)arg1;	// IMP=0x00000000002a2970
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000002a280f
- (void)setBackgroundColor:(id)arg1;	// IMP=0x00000000002a2759
- (void)layoutSubviews;	// IMP=0x00000000002a1d77
...
- (id)initWithClientContext:(id)arg1;	// IMP=0x00000000002a06dd
