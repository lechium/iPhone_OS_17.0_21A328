...
+ (id)changeSetForReminder;	// IMP=0x004000000004b84d
+ (id)changeSetForEvent;	// IMP=0x001000000004b834
- (void).cxx_destruct;	// IMP=0x002000000004bae9
...
- (void)enumerateForChangeType:(int)arg1 forEntitiesOfClass:(Class)arg2 withBlock:(CDUnknownBlockType)arg3;	// IMP=0x001000000004ba23
- (id)description;	// IMP=0x001000000004b925
