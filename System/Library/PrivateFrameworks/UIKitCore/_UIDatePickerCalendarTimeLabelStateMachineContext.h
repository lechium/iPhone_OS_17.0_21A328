...
- (void).cxx_destruct;	// IMP=0x00000000004b855c
...
- (_Bool)currentSateCanTransitionWithEvents:(id)arg1;	// IMP=0x00000000004b841e
@property(readonly, nonatomic) unsigned long long *currentStateRef;
- (void)_updateFromState:(unsigned long long)arg1;	// IMP=0x00000000004b83ee
- (id)initWithUpdateHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000000004b82fe
