...
- (void).cxx_destruct;	// IMP=0x000000000006dd9d
- (id)init;	// IMP=0x000000000006dcd9
- (_Bool)encodeResultOntoReply:(id)arg1;	// IMP=0x000000000006d976
- (void)addOwner:(id)arg1 group:(id)arg2;	// IMP=0x000000000006d7f5
