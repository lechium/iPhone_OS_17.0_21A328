...
- (void).cxx_destruct;	// IMP=0x00000000000adb3f
...
- (void)_reloadWithMenuBarStyle:(long long)arg1 menuItemViewElements:(id)arg2 scrollEnabled:(_Bool)arg3;	// IMP=0x00000000000ada9e
- (void)_ensureDataLoaded;	// IMP=0x00000000000ada38
- (void)contentWillAppearForMenuItemAtIndex:(unsigned long long)arg1 withEntityValueProvider:(id)arg2 clientContext:(id)arg3;	// IMP=0x00000000000ad827
- (unsigned long long)indexOfMenuItemViewElement:(id)arg1;	// IMP=0x00000000000ad7bc
- (id)documentOptionsForMenuItemAtIndex:(unsigned long long)arg1;	// IMP=0x00000000000ad748
- (id)documentOptionsForEntityUniqueIdentifier:(id)arg1;	// IMP=0x00000000000ad6e2
- (id)documentForMenuItemAtIndex:(unsigned long long)arg1;	// IMP=0x00000000000ad66e
- (id)documentForEntityUniqueIdentifier:(id)arg1;	// IMP=0x00000000000ad608
...
- (void)menuBarDocument:(id)arg1 didSelectMenuItem:(id)arg2 animated:(_Bool)arg3;	// IMP=0x00000000000ad494
- (void)menuBarDocument:(id)arg1 didReplaceDocumentForMenuItem:(id)arg2;	// IMP=0x00000000000ad3da
- (void)menuBarDocument:(id)arg1 didReplaceDocumentForEntityWithUniqueIdentifier:(id)arg2;	// IMP=0x00000000000ad34f
- (id)_initWithMenuBarDocument:(id)arg1;	// IMP=0x00000000000ad259
