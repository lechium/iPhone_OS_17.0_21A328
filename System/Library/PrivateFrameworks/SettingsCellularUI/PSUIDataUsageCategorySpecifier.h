...
- (void).cxx_destruct;	// IMP=0x000000000003b125
...
- (id)getLogger;	// IMP=0x000000000003b06c
- (id)dataUsageString;	// IMP=0x000000000003aff0
- (unsigned long long)dataUsage;	// IMP=0x000000000003abbc
- (id)initWithType:(unsigned long long)arg1 subSpecifiers:(id)arg2;	// IMP=0x000000000003a6f8
