...
@class MISSING_TYPE, NSArray, NSDictionary, NSSet, NSString, PRSQueryTask, PRSRankingConfiguration, SDSearchQuery, SPParsecDatastore;
...
@interface SPParsecQueryTask : NSObject
{
    ...
    MISSING_TYPE *_webSearchLoaded;	// 124 = 0x7c
...
- (void).cxx_destruct;	// IMP=0x002000000008cc6a
...
- (id)rerankMapsResultsWithLocalSignals:(id)arg1 forQueryId:(long long)arg2;	// IMP=0x001000000008c8e7
- (void)query:(id)arg1 didFinishWithResults:(id)arg2 withSuggestions:(id)arg3 withCorrections:(id)arg4 withAlternativeResults:(id)arg5 suggestionsAreBlended:(_Bool)arg6;	// IMP=0x001000000008b00f
- (id)findLocalCopies:(id)arg1 alternativeResults:(id)arg2 withQueryString:(id)arg3;	// IMP=0x0010000000087ace
- (void)archiveWithQuery:(id)arg1 didFinishWithResults:(id)arg2 withSuggestions:(id)arg3 withCorrections:(id)arg4 suggestionsAreBlended:(_Bool)arg5;	// IMP=0x001000000008786b
- (void)geoUserSessionEntityString:(id)arg1;	// IMP=0x0010000000087802
- (void)_setScore:forResult: /* Error: Ran out of types for this method. */;	// IMP=0x00100000000877ed
- (void)queryDidFinishLoading:(id)arg1;	// IMP=0x001000000008750e
- (void)cancel;	// IMP=0x001000000008715d
- (void)finished;	// IMP=0x0010000000086379
- (id)initWithStore:(id)arg1 resultPipe:(id)arg2 queue:(id)arg3 visibleApps:(id)arg4 hiddenApps:(id)arg5;	// IMP=0x00100000000861f6
- (void)dealloc;	// IMP=0x00100000000861bc
- (void)resumeWithArchive:(id)arg1;	// IMP=0x00100000000860bc
- (id)unarchiveWithQuery:(id)arg1;	// IMP=0x0010000000085fa6
- (void)resumeWithTimeout:(double)arg1;	// IMP=0x0010000000085f54
