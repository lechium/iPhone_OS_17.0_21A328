...
- (void).cxx_destruct;	// IMP=0x0000000000002c46
...
- (void)_stopObservingPlayer;	// IMP=0x0000000000002b91
- (void)dealloc;	// IMP=0x0000000000002b53
- (void)cancel;	// IMP=0x0000000000002b3d
- (void)_didReachTargetTime;	// IMP=0x00000000000029a8
- (void)_stepDownRate;	// IMP=0x00000000000026e4
- (void)start;	// IMP=0x00000000000023f3
- (id)initWithTargetTime:(CDStruct_1b6d18a9)arg1 duration:(double)arg2 initialRate:(float)arg3 avPlayer:(id)arg4 progressHandler:(CDUnknownBlockType)arg5;	// IMP=0x000000000000231b
