...
+ (id)differentialStyle;	// IMP=0x001000000014f1b6
- (void).cxx_destruct;	// IMP=0x00000000003a1346
...
- (id)description;	// IMP=0x00000000003a12c8
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000003a11c5
