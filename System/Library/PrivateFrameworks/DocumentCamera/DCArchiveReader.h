...
- (void).cxx_destruct;	// IMP=0x000000000001cd56
...
- (id)incrementalPathInDirectory:(id)arg1 withFilename:(id)arg2 andExtension:(id)arg3;	// IMP=0x000000000001cb0d
- (_Bool)moveContentsOfDirectory:(id)arg1 toDirectory:(id)arg2 resultURLs:(id *)arg3 error:(id *)arg4;	// IMP=0x000000000001c54e
- (_Bool)unarchiveSourcePath:(id)arg1 toDestinationPath:(id)arg2 error:(id *)arg3;	// IMP=0x000000000001bc8b
- (id)temporaryDirectory;	// IMP=0x000000000001bb68
- (_Bool)unarchiveResultURLs:(id *)arg1 error:(id *)arg2;	// IMP=0x000000000001b9c2
- (id)initWithSourceURL:(id)arg1 destinationURL:(id)arg2;	// IMP=0x000000000001b8f4
