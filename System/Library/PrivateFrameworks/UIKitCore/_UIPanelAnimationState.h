...
+ (double)defaultDuration;	// IMP=0x0060000000592b76
+ (id)timingCurveProviderWithVelocity:(double)arg1;	// IMP=0x0060000000592b38
+ (id)timingCurveProvider;	// IMP=0x0060000000592b1f
- (void).cxx_destruct;	// IMP=0x0000000000592c73
...
- (id)description;	// IMP=0x0000000000592a85
