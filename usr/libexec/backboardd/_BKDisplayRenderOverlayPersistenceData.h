...
+ (_Bool)supportsSecureCoding;	// IMP=0x002000000002fcf7
+ (id)classesRequiredToDecode;	// IMP=0x001000000002fc71
- (void).cxx_destruct;	// IMP=0x002000000002fc49
...
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000002faa7
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000002f93f
- (void)dealloc;	// IMP=0x001000000002f8b5
- (id)_initWithDescriptor:(id)arg1 overlayType:(long long)arg2 imageData:(id)arg3 level:(float)arg4 frozen:(_Bool)arg5;	// IMP=0x001000000002f7c2
