...
- (void).cxx_destruct;	// IMP=0x0000000000087e2e
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000087b5e
- (unsigned long long)hash;	// IMP=0x0000000000087ab4
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000087aa9
- (void)_assetControllerStateDidChange:(id)arg1;	// IMP=0x0000000000087984
- (void)_removeDeletedMediaItemInShowPageIfNeeded;	// IMP=0x0000000000087694
- (void)_configureWithMediaEntities:(id)arg1;	// IMP=0x00000000000870fa
- (void)dealloc;	// IMP=0x0000000000086b5b
- (id)initWithMediaEntities:(id)arg1 withDownloadType:(long long)arg2;	// IMP=0x0000000000086ace
- (id)initWithMediaEntity:(id)arg1 withDownloadType:(long long)arg2;	// IMP=0x0000000000086a18
