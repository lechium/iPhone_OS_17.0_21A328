...
- (void)enableBasebandLogDump:(void *)arg1;	// IMP=0x00000000001c85ac
- (void)addBDCDListWithNotificationArrivalTime:(double)arg1 bdcd:(double)arg2 queuingDelay:(double)arg3;	// IMP=0x00000000001c84a0
- (void)resetBBNoteHistoryList;	// IMP=0x00000000001c8485
- (void)resetBDCDList;	// IMP=0x00000000001c846a
- (void)normalizeBDCD:(double)arg1;	// IMP=0x00000000001c822e
- (double)updateTotalQueueDepth:(unsigned int)arg1;	// IMP=0x00000000001c81bf
- (void)calculateBitratesAndDelaysWithTotalQueueDepth:(unsigned int)arg1;	// IMP=0x00000000001c7f13
- (void)addInfoListWithNotification:(CDStruct_b203c80d *)arg1;	// IMP=0x00000000001c7e50
- (struct tagVCStatisticsMessage)getBasebandMetricsWithNotification:(CDStruct_b203c80d *)arg1;	// IMP=0x00000000001c7bdc
- (void)dealloc;	// IMP=0x00000000001c7b7e
- (id)init;	// IMP=0x00000000001c7ad7
