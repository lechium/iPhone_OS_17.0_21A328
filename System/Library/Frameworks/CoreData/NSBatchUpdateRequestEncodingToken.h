...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000000beba
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000000c0f7
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000000bec2
- (void)dealloc;	// IMP=0x000000000000be56
- (id)initForRequest:(id)arg1;	// IMP=0x000000000000bb72
