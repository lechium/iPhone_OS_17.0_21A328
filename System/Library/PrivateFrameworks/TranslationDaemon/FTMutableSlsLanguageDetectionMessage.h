...
+ (long long)session_message_typeForObject:(id)arg1;	// IMP=0x00600000000a5ad4
+ (long long)session_message_typeForMutableObject:(id)arg1;	// IMP=0x00600000000a59fa
+ (Class)session_message_mutableClassForType:(long long)arg1;	// IMP=0x00600000000a59c0
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000a5395
- (id)init;	// IMP=0x00000000000a5307
