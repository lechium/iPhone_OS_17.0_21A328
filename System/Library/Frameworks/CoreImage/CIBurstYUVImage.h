...
- (struct __CVBuffer *)pixelBuffer;	// IMP=0x000000000003bfe8
- (void)dealloc;	// IMP=0x000000000003bf78
- (id)initWithIOSurface:(struct __IOSurface *)arg1 maxDimension:(int)arg2;	// IMP=0x000000000003bcca
- (id)initWithCGImage:(struct CGImage *)arg1 maxDimension:(int)arg2;	// IMP=0x000000000003baf8
- (void)convertRGBAToYUV420:(char *)arg1 rgbaBytesPerRow:(int)arg2;	// IMP=0x000000000003b609
