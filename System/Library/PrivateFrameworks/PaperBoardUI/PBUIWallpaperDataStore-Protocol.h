...
@class NSData, NSDictionary, NSString, NSURL, PBUIWallpaperGradient, PBUIWallpaperImage, PBUIWallpaperOptions, UIColor, UIImage;

@protocol PBUIWallpaperDataStore <NSObject>
- (void)removeWallpaperGradientForVariants:(long long)arg1;
- (_Bool)setWallpaperGradient:(PBUIWallpaperGradient *)arg1 forVariants:(long long)arg2;
...
- (_Bool)setWallpaperOptions:(PBUIWallpaperOptions *)arg1 forVariants:(long long)arg2 wallpaperMode:(long long)arg3;
