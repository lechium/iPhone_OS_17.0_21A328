...
+ (void)_setSelectedDeviceIdentifier:(id)arg1 coordinator:(id)arg2;	// IMP=0x00000000000b8b8b
+ (id)_getUIActionForDevice:(id)arg1 deviceIndentifier:(id)arg2 coordinator:(id)arg3 weakSelf:(id)arg4;	// IMP=0x00000000000b8990
+ (id)_getDevicesDropDownMenuWithCoordinator:(id)arg1 viewController:(id)arg2;	// IMP=0x00000000000b8473
+ (void)_setSelectedUsageReportType:(unsigned long long)arg1 user:(id)arg2;	// IMP=0x00000000000b8382
+ (void)selectedUsageReportDidChangeFrom:(id)arg1 to:(id)arg2 datePickerBar:(id)arg3 coordinator:(id)arg4;	// IMP=0x00000000000b798e
- (void).cxx_destruct;	// IMP=0x00000000000b9487
...
- (void)_reportCoreAnalyticsEventWithUser:(id)arg1 currentDate:(id)arg2 calendar:(id)arg3;	// IMP=0x00000000000b90fa
@property(getter=isDatePickerHidden) _Bool datePickerHidden;
- (void)scrollViewDidScroll:(id)arg1;	// IMP=0x00000000000b8cb4
- (void)_devicesDidChangeFrom:(id)arg1 to:(id)arg2;	// IMP=0x00000000000b78d3
- (void)_hasUsageDataDidChange:(_Bool)arg1;	// IMP=0x00000000000b737d
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x00000000000b6ea6
- (void)setCoordinator:(id)arg1;	// IMP=0x00000000000b6c00
- (void)viewDidLayoutSubviews;	// IMP=0x00000000000b6a41
- (void)viewWillDisappear:(_Bool)arg1;	// IMP=0x00000000000b6969
- (void)viewDidAppear:(_Bool)arg1;	// IMP=0x00000000000b6824
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x00000000000b6676
- (void)viewDidLoad;	// IMP=0x00000000000b6041
- (void)dealloc;	// IMP=0x00000000000b5f75
