...
- (void).cxx_destruct;	// IMP=0x00000000002f19cd
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000002f18cd
- (unsigned long long)hash;	// IMP=0x00000000002f182d
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000002f1713
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000002f1640
- (void)copyTo:(id)arg1;	// IMP=0x00000000002f159c
- (void)writeTo:(id)arg1;	// IMP=0x00000000002f14ec
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000002f117a
- (id)dictionaryRepresentation;	// IMP=0x00000000002f0fc4
- (id)description;	// IMP=0x00000000002f0f15
- (int)StringAsCertified:(id)arg1;	// IMP=0x00000000002f0e7e
- (id)certifiedAsString:(int)arg1;	// IMP=0x00000000002f0e36
