...
+ (id)startNavigationMessageWithLoadDirectionsMessage:(id)arg1;	// IMP=0x004000000003e794
- (void).cxx_destruct;	// IMP=0x002000000003edd0
...
- (_Bool)matchesLoadDirectionsMessage:(id)arg1;	// IMP=0x001000000003ec48
- (id)description;	// IMP=0x001000000003eb99
- (id)dictionaryValue;	// IMP=0x001000000003e9c9
- (id)initWithDictionary:(id)arg1;	// IMP=0x001000000003e7e6
