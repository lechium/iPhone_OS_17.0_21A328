...
+ (_Bool)supportsSecureCoding;	// IMP=0x002000000000bb30
...
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000000bbd0
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000000bb40
@property(retain, nonatomic) NSString *deviceIdentifier;
@property(retain, nonatomic) NSString *bundleIdentifier;
@property(retain, nonatomic) NSString *sensor;
- (void)dealloc;	// IMP=0x001000000000ba20
- (id)init;	// IMP=0x001000000000b9d0
