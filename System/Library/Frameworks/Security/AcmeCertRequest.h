...
- (void).cxx_destruct;	// IMP=0x000000000010c3b1
...
- (struct __SecIdentity *)identityWithError:(id *)arg1;	// IMP=0x000000000010bc76
- (id)executeRequest;	// IMP=0x000000000010b86b
- (_Bool)valueForBooleanDefault:(id)arg1;	// IMP=0x000000000010b7f4
- (id)processReply:(id)arg1;	// IMP=0x000000000010a810
- (id)acmeRequest;	// IMP=0x000000000010a189
- (id)pollForStatus:(id)arg1 until:(id)arg2;	// IMP=0x000000000010a14b
- (id)sendRequestToXPCService:(id)arg1 response:(id *)arg2;	// IMP=0x0000000000109ab6
- (int)errorStatusWithHTTPErrorCode:(int)arg1;	// IMP=0x0000000000109a4e
- (id)attestationChainPEMRepresentation;	// IMP=0x000000000010997f
- (id)createCertificate;	// IMP=0x000000000010985b
- (id)createAttestation;	// IMP=0x000000000010950c
- (id)attestationObjectWithCertificates:(id)arg1;	// IMP=0x000000000010914e
- (id)requestAttestationChainWithError:(id *)arg1;	// IMP=0x00000000001090e4
- (_Bool)deviceAttestationSupported;	// IMP=0x00000000001090dc
- (id)createCSR;	// IMP=0x0000000000108fe1
- (id)createKeyPair;	// IMP=0x0000000000108f14
- (id)sanitizeParameters;	// IMP=0x0000000000108de3
- (id)sanitizeSubject;	// IMP=0x0000000000108ce8
- (id)serialNumber;	// IMP=0x0000000000108c0a
- (void)dealloc;	// IMP=0x0000000000108b69
- (id)initWithSubject:(id)arg1 parameters:(id)arg2;	// IMP=0x0000000000108a9d
