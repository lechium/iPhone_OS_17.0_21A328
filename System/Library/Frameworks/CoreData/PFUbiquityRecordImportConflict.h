...
+ (void)initialize;	// IMP=0x006000000029819d
- (id)description;	// IMP=0x000000000029b849
- (id)createSetOfManagedObjectIDsForGlobalIDsInRelationship:(id)arg1 withValue:(id)arg2 withGlobalIDToLocalIDURIMap:(id)arg3 andTransactionLog:(id)arg4;	// IMP=0x000000000029b478
- (void)dealloc;	// IMP=0x000000000029825d
- (id)init;	// IMP=0x00000000002981f2
