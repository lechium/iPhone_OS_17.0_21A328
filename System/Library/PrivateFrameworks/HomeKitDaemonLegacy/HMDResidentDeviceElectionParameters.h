...
- (void).cxx_destruct;	// IMP=0x0000000000ac1608
...
- (id)attributeDescriptions;	// IMP=0x0000000000ac1305
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000ac1280
- (unsigned long long)hash;	// IMP=0x0000000000ac123c
- (long long)compare:(id)arg1 outCriteria:(unsigned long long *)arg2;	// IMP=0x0000000000ac0bcf
- (long long)compare:(id)arg1;	// IMP=0x0000000000ac0bbb
@property(readonly, copy) NSDictionary *dictionaryRepresentation;
- (id)initWithResident:(id)arg1 enabled:(id)arg2 location:(long long)arg3 accessories:(id)arg4;	// IMP=0x0000000000ac0715
- (id)initWithResident:(id)arg1 dictionaryRepresentation:(id)arg2;	// IMP=0x0000000000ac051f
