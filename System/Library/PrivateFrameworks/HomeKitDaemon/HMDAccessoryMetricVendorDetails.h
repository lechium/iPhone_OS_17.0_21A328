...
+ (unsigned long long)maximumDifferentiationNumber;	// IMP=0x00400000005acf0f
- (void).cxx_destruct;	// IMP=0x00000000005acd8d
...
- (id)attributeDescriptions;	// IMP=0x00000000005acaf7
- (id)initWithProductData:(id)arg1 manufacturer:(id)arg2 model:(id)arg3 firmwareVersion:(id)arg4 category:(id)arg5 differentiationNumber:(id)arg6;	// IMP=0x00000000005ac9b1
- (id)initWithAccessory:(id)arg1;	// IMP=0x00000000005ac26c
