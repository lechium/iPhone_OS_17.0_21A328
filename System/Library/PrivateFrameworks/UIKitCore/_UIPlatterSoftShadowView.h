...
- (void).cxx_destruct;	// IMP=0x00000000000bc434
...
- (void)_updateForShadowPath;	// IMP=0x00000000000bc1c3
- (id)initWithFrame:(struct CGRect)arg1 shadowPath:(id)arg2;	// IMP=0x00000000000bc052
