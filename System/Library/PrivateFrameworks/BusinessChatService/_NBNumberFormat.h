...
- (void).cxx_destruct;	// IMP=0x0000000000067365
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000671b2
- (id)description;	// IMP=0x000000000006707b
- (id)initWithEntry:(id)arg1;	// IMP=0x0000000000066f17
- (id)initWithPattern:(id)arg1 withFormat:(id)arg2 withLeadingDigitsPatterns:(id)arg3 withNationalPrefixFormattingRule:(id)arg4 whenFormatting:(_Bool)arg5 withDomesticCarrierCodeFormattingRule:(id)arg6;	// IMP=0x0000000000066e0b
