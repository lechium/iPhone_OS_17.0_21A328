...
- (void).cxx_destruct;	// IMP=0x00000000000bf8af
...
- (id)_resultWithResponses:(id)arg1;	// IMP=0x00000000000bf749
- (void)_startChangesOperationWithMediaEntityFetchResponses:(id)arg1 currentFetchResponses:(id)arg2;	// IMP=0x00000000000bf4c7
- (void)_handleCompletdFetchWithResponses:(id)arg1 error:(id)arg2;	// IMP=0x00000000000bf30f
- (void)_startMediaLibraryFetchOperation;	// IMP=0x00000000000bf0bc
- (void)cancel;	// IMP=0x00000000000bf03e
- (void)executionDidBegin;	// IMP=0x00000000000bf02c
- (id)initWithMediaLibrary:(id)arg1 fetchReason:(long long)arg2 requests:(id)arg3;	// IMP=0x00000000000bef63
