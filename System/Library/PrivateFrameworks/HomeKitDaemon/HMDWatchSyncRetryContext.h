...
+ (id)createWithWatchIdentifier:(id)arg1 watchSync:(id)arg2 retryAttempt:(long long)arg3;	// IMP=0x0010000000221d65
- (void).cxx_destruct;	// IMP=0x0000000000221d34
...
- (id)attributeDescriptions;	// IMP=0x0000000000221b41
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000221b36
@property(readonly) double retryInterval;
- (id)initWithWatchIdentifier:(id)arg1 watchSync:(id)arg2 retryAttempt:(long long)arg3 initialRetryInterval:(double)arg4 maximumRetryAttempts:(long long)arg5;	// IMP=0x00000000002219f8
