...
- (void).cxx_destruct;	// IMP=0x000000000019258e
...
- (void)_centersButtonsIfNeeded:(id)arg1 identifiers:(id)arg2;	// IMP=0x00000000001922e6
- (id)_arrangedBarButtonItems:(id)arg1 identifiers:(id)arg2;	// IMP=0x0000000000192081
- (id)_newEntryForIdentifiers:(id)arg1;	// IMP=0x0000000000191f6e
- (id)orderedBarButtonsItemsForIdentifiers:(id)arg1;	// IMP=0x0000000000191d30
- (long long)identifierForCustomButton:(id)arg1;	// IMP=0x0000000000191c24
- (long long)identifierForBarButtonItem:(id)arg1;	// IMP=0x0000000000191b18
- (id)barButtonItemForIdentifier:(long long)arg1;	// IMP=0x00000000001919d2
@property(readonly, nonatomic) NSDictionary *barButtonItems;
- (void)_resetSet;	// IMP=0x00000000001918f3
- (id)initWithOptions:(unsigned long long)arg1;	// IMP=0x00000000001917e6
- (id)init;	// IMP=0x00000000001917d2
