...
+ (_Bool)supportsSecureCoding;	// IMP=0x0020000000001e03
- (void).cxx_destruct;	// IMP=0x002000000000207b
...
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000001ea4
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000001e0b
