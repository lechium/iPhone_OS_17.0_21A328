...
+ (id)createAnimationInfoDataForCacheItem:(id)arg1 order:(unsigned int)arg2;	// IMP=0x006000000044c5c6
+ (void)loadAnimationCache:(id)arg1 pdAnimation:(id)arg2 state:(id)arg3;	// IMP=0x006000000044c286
+ (void)mapAnimationInfo:(id)arg1 cacheData:(id)arg2 state:(id)arg3;	// IMP=0x006000000044ce28
+ (void)mapCommonData:(id)arg1 cacheData:(id)arg2 state:(id)arg3;	// IMP=0x006000000044c9a6
- (void).cxx_destruct;	// IMP=0x000000000044c965
...
- (id)initWithAnimationInfo:(id)arg1;	// IMP=0x000000000044bf0b
