...
+ (id)logCategory;	// IMP=0x00600000006a0dd6
- (void).cxx_destruct;	// IMP=0x00000000006a0c22
...
- (void)_generateAllCombinations;	// IMP=0x000000000069efaf
- (id)createReselectedVideoParameters:(id)arg1;	// IMP=0x000000000069ee44
- (id)createSelectedVideoParameters;	// IMP=0x000000000069ea5a
- (id)createSRTPParamters;	// IMP=0x000000000069e9cf
- (_Bool)_selectParametersFromCodec:(id)arg1 profiles:(id)arg2 levels:(id)arg3 packetizationModes:(id)arg4 videoAttributes:(id)arg5;	// IMP=0x000000000069e0d7
- (_Bool)selectVideoParameters;	// IMP=0x000000000069d101
- (id)logIdentifier;	// IMP=0x000000000069d0b1
- (void)_setVideoResolutionPreference;	// IMP=0x000000000069cce8
- (id)initWithSessionID:(id)arg1 videoTierParameters:(id)arg2 supportedVideoConfiguration:(id)arg3 supportedRTPConfiguration:(id)arg4 streamingCapabilities:(id)arg5;	// IMP=0x000000000069cafa
