...
- (void).cxx_destruct;	// IMP=0x00000000000321bf
...
- (id)shortDescription;	// IMP=0x0000000000031ea9
- (_Bool)isExpiredAtTimeStamp:(CDStruct_1b6d18a9)arg1;	// IMP=0x0000000000031e33
- (float)similarityToPersonBlob:(id)arg1;	// IMP=0x000000000003165c
- (void)trackPersonBlob:(id)arg1;	// IMP=0x000000000003160d
- (id)initWithNewPersonEvent:(id)arg1 timeStamp:(CDStruct_1b6d18a9)arg2;	// IMP=0x00000000000313d8
