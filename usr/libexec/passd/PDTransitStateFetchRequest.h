...
- (void).cxx_destruct;	// IMP=0x00200000000dc7c1
...
- (unsigned long long)hash;	// IMP=0x00100000000dc6c6
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000dc615
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000dc542
