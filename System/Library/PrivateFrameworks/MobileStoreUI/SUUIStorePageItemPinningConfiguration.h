...
- (void)invalidatePinningTransitionStyle;	// IMP=0x000000000008773b
- (void)invalidatePinningGroup;	// IMP=0x0000000000087729
- (void)invalidatePinningStyle;	// IMP=0x0000000000087717
- (void)invalidatePinningContentInset;	// IMP=0x00000000000876f7
