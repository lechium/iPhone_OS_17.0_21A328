...
- (void).cxx_destruct;	// IMP=0x0020000000191be8
...
- (void)addCompletionBlock:(CDUnknownBlockType)arg1 forSession:(id)arg2;	// IMP=0x0010000000191a54
- (void)addSession:(id)arg1;	// IMP=0x0010000000191a08
- (void)addServiceType:(id)arg1;	// IMP=0x00100000001919f2
- (void)addAlias:(id)arg1;	// IMP=0x00100000001919d5
- (id)init;	// IMP=0x0010000000191932
