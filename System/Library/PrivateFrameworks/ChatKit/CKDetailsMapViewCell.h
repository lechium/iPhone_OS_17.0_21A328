...
+ (_Bool)shouldHighlight;	// IMP=0x00100000001bab6b
+ (id)reuseIdentifier;	// IMP=0x00100000001bab5e
- (void).cxx_destruct;	// IMP=0x00000000001bb0c0
...
- (void)layoutSubviews;	// IMP=0x00000000001baccb
- (id)initWithStyle:(long long)arg1 reuseIdentifier:(id)arg2;	// IMP=0x00000000001bab10
