...
+ (id)configurationWithTemplateElement:(id)arg1;	// IMP=0x00100000002e7095
- (void).cxx_destruct;	// IMP=0x00000000002e7810
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000002e75a7
