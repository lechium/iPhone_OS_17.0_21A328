...
+ (id)infoWithTargetableAccessory:(id)arg1;	// IMP=0x00600000001c8baa
- (void).cxx_destruct;	// IMP=0x00000000001c8b9c
...
- (_Bool)isActiveAndSupportsDragonSiri;	// IMP=0x00000000001c8b13
