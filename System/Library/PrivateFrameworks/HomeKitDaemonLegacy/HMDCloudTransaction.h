...
+ (id)shortDescription;	// IMP=0x0060000000ad01b3
- (void).cxx_destruct;	// IMP=0x0000000000ad011e
...
- (id)replayTransaction:(id)arg1 stagedTransaction:(id)arg2;	// IMP=0x0000000000acfbab
- (void)loadObjectChanges;	// IMP=0x0000000000acfb88
- (id)changeWithRecordName:(id)arg1;	// IMP=0x0000000000acfb0e
- (id)changeWithObjectID:(id)arg1;	// IMP=0x0000000000acfa94
...
- (void)updateCloudCache;	// IMP=0x0000000000acf874
- (void)setDeleteAsProcessedWithRecordID:(id)arg1;	// IMP=0x0000000000acf80b
- (void)resetRecordWithRecordID:(id)arg1;	// IMP=0x0000000000acf7a2
- (void)setSaveAsProcessedWithRecord:(id)arg1;	// IMP=0x0000000000acf739
- (void)fetchBatchToUpload:(CDUnknownBlockType)arg1;	// IMP=0x0000000000acf6d0
- (_Bool)moreChangesToProcess;	// IMP=0x0000000000acf68c
- (void)setAllChangedAsProcessed;	// IMP=0x0000000000acf64f
- (void)loadCloudRecordsAndDetermineDeletesFromCache:(CDUnknownBlockType)arg1;	// IMP=0x0000000000acf4ba
- (void)cachedCloudRecordWithObjectID:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000acf42f
- (id)cachedCloudRecordWithObjectID:(id)arg1;	// IMP=0x0000000000acf3b5
@property(readonly) _Bool doRecordsExistInCache;
- (_Bool)doesRecordExistInCacheWithObjectID:(id)arg1;	// IMP=0x0000000000acf303
- (_Bool)doesRecordExistWithObjectID:(id)arg1;	// IMP=0x0000000000acf295
@property(readonly, nonatomic) _Bool hasValidChanges;
- (void)removeChangeWithObjectID:(id)arg1;	// IMP=0x0000000000acf1e8
- (void)addChangeWithDeletedRecordID:(id)arg1;	// IMP=0x0000000000acf17f
- (void)addChangeWithRecord:(id)arg1;	// IMP=0x0000000000acf116
- (void)addChangeWithObjectChange:(id)arg1;	// IMP=0x0000000000acf0ad
...
- (id)description;	// IMP=0x0000000000acedd0
- (id)shortDescription;	// IMP=0x0000000000acecdf
- (void)updateCloudZone:(id)arg1;	// IMP=0x0000000000acec58
- (id)initWithType:(unsigned long long)arg1 temporaryCache:(_Bool)arg2 noLocalData:(_Bool)arg3;	// IMP=0x0000000000acebb5
- (id)initWithType:(unsigned long long)arg1 temporaryCache:(_Bool)arg2;	// IMP=0x0000000000aceba0
- (id)init;	// IMP=0x0000000000aceaf8
