...
+ (_Bool)supportsSecureCoding;	// IMP=0x0020000000043ea5
- (void).cxx_destruct;	// IMP=0x00200000000441dc
...
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000043fe5
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000043ead
- (id)description;	// IMP=0x0010000000043dac
- (id)initWithCloudSyncVersions:(id)arg1;	// IMP=0x0010000000043c89
