...
- (void).cxx_destruct;	// IMP=0x000000000003dfcc
- (void)waitForReady;	// IMP=0x000000000003dfb7
- (void)setListener:(id)arg1;	// IMP=0x000000000003dad9
- (void)stopListening;	// IMP=0x000000000003da46
- (id)initWithLayer:(void *)arg1;	// IMP=0x000000000003d9e2
