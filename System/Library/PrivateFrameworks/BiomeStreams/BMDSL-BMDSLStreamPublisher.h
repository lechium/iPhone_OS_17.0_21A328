...
- (id)asTableWithTransform:(id)arg1 schema:(id)arg2;	// IMP=0x0030000000057231
- (id)trackDerivatesInDBAtURL:(id)arg1 derivedTableName:(id)arg2;	// IMP=0x0030000000095f8a
@end
