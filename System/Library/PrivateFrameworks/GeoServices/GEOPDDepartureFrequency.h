...
+ (_Bool)isValid:(id)arg1;	// IMP=0x0010000000c7af4c
- (void).cxx_destruct;	// IMP=0x0000000000c7b936
- (void)clearUnknownFields:(_Bool)arg1;	// IMP=0x0000000000c7b8f0
@property(readonly, nonatomic) PBUnknownFields *unknownFields;
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000c7b7fd
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000c7b5b3
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000c7b4aa
- (void)copyTo:(id)arg1;	// IMP=0x0000000000c7b3cc
- (void)writeTo:(id)arg1;	// IMP=0x0000000000c7b2bd
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000c7b2b0
- (void)readAll:(_Bool)arg1;	// IMP=0x0000000000c7a9a4
- (id)initWithJSON:(id)arg1;	// IMP=0x0000000000c7a992
- (id)initWithDictionary:(id)arg1;	// IMP=0x0000000000c7a641
- (id)jsonRepresentation;	// IMP=0x0000000000c7a531
- (id)dictionaryRepresentation;	// IMP=0x0000000000c7a166
...
- (_Bool)isValidAtDate:(id)arg1;	// IMP=0x000000000120a4fe
