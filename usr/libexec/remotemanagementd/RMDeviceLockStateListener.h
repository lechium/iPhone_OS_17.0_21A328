...
+ (id)newListenerWithDelegate:(id)arg1;	// IMP=0x0020000000032315
- (void).cxx_destruct;	// IMP=0x0020000000032909
...
- (void)triggerAggregatingTimerAction;	// IMP=0x001000000003272c
- (void)didReceiveNotificationForStream:(id)arg1 notificationName:(id)arg2;	// IMP=0x001000000003267a
- (void)stopListening;	// IMP=0x00100000000325ee
- (void)startListening;	// IMP=0x001000000003246d
- (id)initWithDelegate:(id)arg1;	// IMP=0x001000000003235e
