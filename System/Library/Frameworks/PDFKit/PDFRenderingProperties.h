...
- (void).cxx_destruct;	// IMP=0x0000000000005f54
- (void)_notifyPropertyChanged:(long long)arg1;	// IMP=0x0000000000005e62
...
- (void)dealloc;	// IMP=0x0000000000005af3
- (id)init;	// IMP=0x00000000000059b2
