...
- (struct CGRect)lastItemFrame;	// IMP=0x0000000000082d22
- (struct CGRect)firstItemFrame;	// IMP=0x0000000000082cf7
- (void)setItemFrame:(struct CGRect)arg1 atIndex:(long long)arg2;	// IMP=0x0000000000082cd8
- (struct CGRect)itemFrameAtIndex:(long long)arg1;	// IMP=0x0000000000082cb7
- (void)dealloc;	// IMP=0x0000000000082c20
