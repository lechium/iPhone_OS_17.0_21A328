...
- (void).cxx_destruct;	// IMP=0x000000000012f725
...
- (id)featureValueForName:(id)arg1;	// IMP=0x000000000012f57c
@property(readonly, nonatomic) NSSet *featureNames;
- (id)initWithInput1:(id)arg1 stateIn:(id)arg2 detectedHistoryIn:(id)arg3;	// IMP=0x000000000012f4a4
- (id)initWithInput1:(id)arg1;	// IMP=0x000000000012f48d
