...
- (void).cxx_destruct;	// IMP=0x002000000003000e
...
- (void)loadInRegistry:(id)arg1;	// IMP=0x001000000002dfeb
- (id)initWithCloudContext:(id)arg1 configurationManager:(id)arg2 appActivityMonitor:(id)arg3;	// IMP=0x001000000002df33
