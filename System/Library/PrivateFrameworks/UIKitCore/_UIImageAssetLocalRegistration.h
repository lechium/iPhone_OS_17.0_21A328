...
+ (id)registrationWithImage:(id)arg1 configuration:(id)arg2;	// IMP=0x0060000000a02064
- (void).cxx_destruct;	// IMP=0x0000000000a0237a
@property(retain, nonatomic) UIImageConfiguration *configuration; // @synthesize configuration=_configuration;
@property(retain, nonatomic) UIImage *image; // @synthesize image=_image;
- (_Bool)matchesConfiguration:(id)arg1;	// IMP=0x0000000000a021bd
