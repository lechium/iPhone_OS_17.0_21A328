...
- (void).cxx_destruct;	// IMP=0x00000000000a1415
...
- (id)observeMotionEvents:(CDUnknownBlockType)arg1;	// IMP=0x00000000000a1066
- (void)dealloc;	// IMP=0x00000000000a100d
- (id)init;	// IMP=0x00000000000a0fe2
- (id)initWithSource:(id)arg1 service:(id)arg2;	// IMP=0x00000000000a09c3
