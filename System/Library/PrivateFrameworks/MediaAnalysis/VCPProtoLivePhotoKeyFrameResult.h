...
+ (Class)faceResultsType;	// IMP=0x00100000000272f5
+ (id)resultFromLegacyDictionary:(id)arg1;	// IMP=0x0010000000021b1f
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000002918f
- (unsigned long long)hash;	// IMP=0x00000000000287d5
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000285e8
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000002833c
- (void)copyTo:(id)arg1;	// IMP=0x000000000002819d
- (void)writeTo:(id)arg1;	// IMP=0x0000000000027f25
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000027f18
- (id)dictionaryRepresentation;	// IMP=0x0000000000027447
- (id)description;	// IMP=0x0000000000027398
@property(nonatomic) _Bool hasContentScore;
@property(nonatomic) _Bool hasGlobalQualityScore;
- (id)faceResultsAtIndex:(unsigned long long)arg1;	// IMP=0x00000000000272d8
- (unsigned long long)faceResultsCount;	// IMP=0x00000000000272bb
- (void)addFaceResults:(id)arg1;	// IMP=0x0000000000027251
- (void)clearFaceResults;	// IMP=0x0000000000027234
- (id)exportToLegacyDictionary;	// IMP=0x0000000000022294
