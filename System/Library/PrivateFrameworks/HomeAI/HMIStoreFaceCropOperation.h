...
+ (id)logCategory;	// IMP=0x006000000000f8c1
- (void).cxx_destruct;	// IMP=0x000000000000f8f7
...
- (void)main;	// IMP=0x000000000000f57f
- (id)initWithDataSource:(id)arg1 faceCrop:(id)arg2;	// IMP=0x000000000000f4d5
