...
@interface SNSoundPrintALaughterModelInput : NSObject
{
...
- (void).cxx_destruct;	// IMP=0x0000000000131dc5
...
- (id)featureValueForName:(id)arg1;	// IMP=0x0000000000131c1c
@property(readonly, nonatomic) NSSet *featureNames;
- (id)initWithInput1:(id)arg1 stateIn:(id)arg2 detectedHistoryIn:(id)arg3;	// IMP=0x0000000000131b44
- (id)initWithInput1:(id)arg1;	// IMP=0x0000000000131b2d
