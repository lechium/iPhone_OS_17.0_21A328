...
- (void).cxx_destruct;	// IMP=0x002000000001d567
...
- (id)description;	// IMP=0x001000000001d354
- (id)dictionaryValue;	// IMP=0x001000000001d124
- (id)initWithDictionary:(id)arg1;	// IMP=0x001000000001cf95
