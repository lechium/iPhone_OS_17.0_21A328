...
- (void).cxx_destruct;	// IMP=0x000000000006eac4
...
- (id)nextObject;	// IMP=0x000000000006e93d
- (id)nextObjectWithExclusiveAccessToken:(id)arg1;	// IMP=0x000000000006e33d
- (id)initWithSectionedIdentifierList:(id)arg1 options:(unsigned long long)arg2 startEntry:(id)arg3 endEntry:(id)arg4 withExclusiveAccessToken:(id)arg5;	// IMP=0x000000000006d97f
