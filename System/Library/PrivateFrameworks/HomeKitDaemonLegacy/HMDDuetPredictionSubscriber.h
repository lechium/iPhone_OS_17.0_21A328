...
- (void).cxx_destruct;	// IMP=0x000000000063add4
...
- (void)dealloc;	// IMP=0x000000000063ad1d
- (void)_unregisterForNotifications;	// IMP=0x000000000063acd8
- (void)_registerForNotifications;	// IMP=0x000000000063ab25
- (id)initWithWorkQueue:(id)arg1 messageDispatcher:(id)arg2 dataSource:(id)arg3;	// IMP=0x000000000063aa3e
