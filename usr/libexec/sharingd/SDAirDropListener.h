...
- (void).cxx_destruct;	// IMP=0x00200000000afcfb
...
- (void)dealloc;	// IMP=0x00100000000afc0e
- (void)stop;	// IMP=0x00100000000afbbf
- (void)start;	// IMP=0x00100000000afb4c
- (void)networkOperation:(id)arg1 event:(long long)arg2 withResults:(id)arg3;	// IMP=0x00100000000af82f
- (id)init;	// IMP=0x00100000000af7e1
