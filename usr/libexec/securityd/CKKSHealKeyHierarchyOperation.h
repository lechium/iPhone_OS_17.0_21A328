...
- (void).cxx_destruct;	// IMP=0x0020000000092cfa
...
- (_Bool)ensureKeyPresent:(id)arg1 viewState:(id)arg2;	// IMP=0x00100000000926c9
- (void)attemptToHealView:(id)arg1 currentTrustStates:(id)arg2;	// IMP=0x0010000000092563
- (void)groupStart;	// IMP=0x00100000000920e5
- (id)initWithDependencies:(id)arg1 allowFullRefetchResult:(_Bool)arg2 intending:(id)arg3 errorState:(id)arg4;	// IMP=0x0010000000091fcc
- (id)init;	// IMP=0x0010000000091fbe
