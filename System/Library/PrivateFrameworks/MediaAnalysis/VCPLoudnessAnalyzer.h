...
- (id).cxx_construct;	// IMP=0x00000000001439f0
- (void).cxx_destruct;	// IMP=0x0000000000143992
- (id)results;	// IMP=0x000000000014391c
- (int)finalizeAnalysisAtTime:(const CDStruct_1b6d18a9 *)arg1;	// IMP=0x00000000001431fb
- (int)processAudioSamples:(struct AudioBufferList *)arg1 timestamp:(struct AudioTimeStamp)arg2;	// IMP=0x0000000000142a9b
- (void)dealloc;	// IMP=0x0000000000142a23
- (int)setupWithSample:(struct opaqueCMSampleBuffer *)arg1 andSampleBatchSize:(int)arg2;	// IMP=0x000000000014289b
- (id)init;	// IMP=0x00000000001427f6
