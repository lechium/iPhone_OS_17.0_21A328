...
- (struct CGSize)intrinsicSizeForContentSize:(struct CGSize)arg1;	// IMP=0x00000000007496b2
- (struct CGRect)contentFrameForBounds:(struct CGRect)arg1;	// IMP=0x0000000000749605
- (id)initWithPerEdgePadding:(struct UIEdgeInsets)arg1;	// IMP=0x00000000007495be
- (id)initWithSymmetricalPadding:(struct CGSize)arg1;	// IMP=0x0000000000749562
- (id)init;	// IMP=0x0000000000749523
