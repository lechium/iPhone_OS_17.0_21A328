...
+ (id)logCategory;	// IMP=0x0010000000821729
- (void).cxx_destruct;	// IMP=0x00000000008216c5
...
- (void)dealloc;	// IMP=0x0000000000821539
- (id)initWithSessionID:(id)arg1 logIdentifier:(id)arg2 workQueue:(id)arg3;	// IMP=0x00000000008213a8
