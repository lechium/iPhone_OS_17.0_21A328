...
+ (_Bool)supportsSecureCoding;	// IMP=0x002000000008c0cd
- (void).cxx_destruct;	// IMP=0x002000000008c44a
...
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000008c212
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000008c0d5
- (id)configuredRecordFromAttributes;	// IMP=0x001000000008bea5
- (id)zoneName;	// IMP=0x001000000008be91
- (id)identifier;	// IMP=0x001000000008be7f
- (id)recordType;	// IMP=0x001000000008be72
@property(readonly, copy) NSString *description;
- (id)initWithRecord:(id)arg1;	// IMP=0x001000000008bb63
- (id)initWithCloudData:(id)arg1;	// IMP=0x001000000008b926
- (id)initWithCollectionID:(id)arg1;	// IMP=0x001000000008b862
