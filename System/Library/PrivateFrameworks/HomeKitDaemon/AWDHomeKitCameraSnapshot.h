...
- (void).cxx_destruct;	// IMP=0x000000000058b2d1
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000058ae4e
- (unsigned long long)hash;	// IMP=0x000000000058abf2
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000058a87e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000058a5bc
- (void)copyTo:(id)arg1;	// IMP=0x000000000058a391
- (void)writeTo:(id)arg1;	// IMP=0x000000000058a158
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000058996a
- (id)dictionaryRepresentation;	// IMP=0x00000000005893ef
- (id)description;	// IMP=0x0000000000589340
...
- (int)StringAsCertified:(id)arg1;	// IMP=0x0000000000588ffb
- (id)certifiedAsString:(int)arg1;	// IMP=0x0000000000588fb3
