...
- (void).cxx_destruct;	// IMP=0x00000000000878bb
...
- (unsigned int)disposition;	// IMP=0x0000000000087379
- (id)initWithXPCObject:(id)arg1 context:(id)arg2 error:(unsigned long long *)arg3;	// IMP=0x0000000000086973
