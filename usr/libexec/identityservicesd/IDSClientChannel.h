...
- (void).cxx_destruct;	// IMP=0x00200000000380fe
...
- (void)setReadHandler:(CDUnknownBlockType)arg1;	// IMP=0x0010000000038018
- (CDUnknownBlockType)readHandler;	// IMP=0x001000000003800e
@property(copy, nonatomic, setter=setUUID:) NSUUID *uuid; // @synthesize uuid=_uuid;
- (void)osChannelInfoLog;	// IMP=0x0010000000037fef
- (void)invalidate;	// IMP=0x0010000000037fe9
- (_Bool)writeBuffer:(char *)arg1 bufferSize:(unsigned int)arg2 metaData:(const void *)arg3 metadataSize:(unsigned int)arg4 moreComing:(_Bool)arg5;	// IMP=0x0010000000037fe1
- (_Bool)writePacketBuffer:(CDStruct_a8d8a807 *)arg1 metaData:(const void *)arg2 metadataSize:(unsigned int)arg3 moreComing:(_Bool)arg4;	// IMP=0x0010000000037fd9
- (_Bool)writeDatagram:(const void *)arg1 datagramSize:(unsigned int)arg2 metaData:(const void *)arg3 metadataSize:(unsigned int)arg4;	// IMP=0x0010000000037fd1
- (void)connectWithProtocoHandler;	// IMP=0x0010000000037fcb
- (_Bool)connectWithTransportThread;	// IMP=0x0010000000037fc3
- (id)initWithDestination:(id)arg1;	// IMP=0x0010000000037f50
