...
- (void).cxx_destruct;	// IMP=0x0000000000c754e6
- (unsigned long long)hash;	// IMP=0x0000000000c74fa7
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000c74e1f
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000c74bb8
- (void)writeTo:(id)arg1;	// IMP=0x0000000000c748cf
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000c748c0
- (id)jsonRepresentation;	// IMP=0x0000000000c725d9
- (id)dictionaryRepresentation;	// IMP=0x0000000000c7216c
- (id)description;	// IMP=0x0000000000c720bd
- (id)initWithData:(id)arg1;	// IMP=0x0000000000c7112d
- (id)init;	// IMP=0x0000000000c710d1
- (id)locationName;	// IMP=0x0000000000a9defe
- (id)categoryName;	// IMP=0x0000000000a9de83
