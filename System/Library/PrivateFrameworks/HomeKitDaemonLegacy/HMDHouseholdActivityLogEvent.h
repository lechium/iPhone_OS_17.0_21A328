...
+ (id)logCategory;	// IMP=0x0010000000479684
+ (id)coalescedEventFromHouseholdActivityLogEvents:(id)arg1 homeUUID:(id)arg2 contributors:(id)arg3;	// IMP=0x00100000004790b3
- (void).cxx_destruct;	// IMP=0x00000000004790a0
...
- (id)submitEventWithHistogrammedHomeDataCommonDimensionsForSpecifiedHome;	// IMP=0x0000000000478d91
@property(readonly, nonatomic) unsigned long long coreAnalyticsEventOptions;
@property(readonly, copy, nonatomic) NSDictionary *coreAnalyticsEventDictionary;
@property(readonly, copy, nonatomic) NSString *coreAnalyticsEventName;
- (id)serializedMetric;	// IMP=0x0000000000478a0f
- (id)initWithDictionary:(id)arg1 contributors:(id)arg2;	// IMP=0x0000000000478735
- (id)initPopulatedFromDate:(id)arg1 homeUUID:(id)arg2 contributors:(id)arg3;	// IMP=0x0000000000478571
- (id)initWithHomeUUID:(id)arg1 contributors:(id)arg2;	// IMP=0x00000000004784ed
