...
- (void).cxx_destruct;	// IMP=0x000000000082b3a7
...
- (id)captureSnapshot;	// IMP=0x000000000082b195
- (id)_searchAreaForContainerSearchRect:(struct CGRect)arg1;	// IMP=0x000000000082a8a7
- (id)initWithFocusSystem:(id)arg1 rootContainer:(id)arg2 coordinateSpace:(id)arg3 searchInfo:(id)arg4 ignoresRootContainerClippingRect:(_Bool)arg5;	// IMP=0x000000000082a59b
- (id)init;	// IMP=0x000000000082a514
