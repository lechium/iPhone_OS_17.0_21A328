...
- (void)update;	// IMP=0x000000000004ac66
...
- (void)trackRotation:(double)arg1;	// IMP=0x000000000004ac04
- (void)trackScale:(double)arg1;	// IMP=0x000000000004abe3
- (void)trackGestureLocation:(struct CGPoint)arg1;	// IMP=0x000000000004aba9
- (void)startTrackingCenter:(struct CGPoint)arg1 bounds:(struct CGRect)arg2 transform:(struct CGAffineTransform)arg3 withInitialGestureLocation:(struct CGPoint)arg4;	// IMP=0x000000000004aa71
- (id)init;	// IMP=0x000000000004aa1e
