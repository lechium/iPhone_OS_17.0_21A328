...
- (void).cxx_destruct;	// IMP=0x000000000005465e
...
- (void)syncErrors:(CDUnknownBlockType)arg1;	// IMP=0x00000000000521b1
- (void)generateReportWithSession:(id)arg1;	// IMP=0x0000000000050264
- (id)_injectionForAnalyticsServiceCode:(int)arg1;	// IMP=0x000000000005017c
- (void)_fillTransferFailure:(id)arg1 withRowID:(unsigned long long)arg2 atDate:(id)arg3 session:(id)arg4;	// IMP=0x000000000004fe48
- (id)getRampNumberForSession:(id)arg1;	// IMP=0x000000000004fe06
- (id)init;	// IMP=0x000000000004fd4c
