...
- (void).cxx_destruct;	// IMP=0x002000000023b05d
...
- (void)cancel;	// IMP=0x001000000023af08
- (void)resolve;	// IMP=0x001000000023aa79
- (void)parseResults:(const char *)arg1 port:(unsigned short)arg2 txtLen:(unsigned short)arg3 txtRecord:(const char *)arg4 interface:(unsigned int)arg5;	// IMP=0x001000000023a6d8
- (void)notifyClient:(int)arg1;	// IMP=0x001000000023a685
- (void)dealloc;	// IMP=0x001000000023a647
- (id)initWithName:(id)arg1 type:(id)arg2 domain:(id)arg3 path:(id)arg4 timeout:(_Bool)arg5;	// IMP=0x001000000023a510
