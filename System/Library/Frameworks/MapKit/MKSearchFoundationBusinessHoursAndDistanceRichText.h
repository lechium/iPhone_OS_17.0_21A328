...
- (void).cxx_destruct;	// IMP=0x00000000001a9b45
...
- (_Bool)isRichTextResolved;	// IMP=0x00000000001a9a7a
- (void)resolveDistanceNotFound;	// IMP=0x00000000001a9a2e
- (void)resolveDistanceString:(id)arg1 lines:(id)arg2;	// IMP=0x00000000001a9973
- (void)updateFormattedTextForLines:(id)arg1;	// IMP=0x00000000001a95d7
- (void)resolveBusinessHoursByMapItem:(id)arg1 lines:(id)arg2;	// IMP=0x00000000001a91e1
