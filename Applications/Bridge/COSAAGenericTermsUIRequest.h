...
+ (id)deviceModelHeaderName;	// IMP=0x00400000000faa53
+ (id)pairedClientInfoHeaderName;	// IMP=0x00100000000faa46
+ (id)clientInfoHeaderForDevice:(id)arg1;	// IMP=0x00100000000fa730
- (void).cxx_destruct;	// IMP=0x00200000000fae5c
...
- (id)initWithGizmoDevice:(id)arg1 showWarranty:(_Bool)arg2;	// IMP=0x00100000000faa60
