...
- (void).cxx_destruct;	// IMP=0x00000000000512ed
...
- (id)eventsFromResult:(id)arg1;	// IMP=0x000000000005036f
- (id)initWithContactStore:(id)arg1 additionalContactKeyDescriptors:(id)arg2;	// IMP=0x00000000000502a1
