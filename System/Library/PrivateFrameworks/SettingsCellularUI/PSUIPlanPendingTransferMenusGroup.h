...
- (void).cxx_destruct;	// IMP=0x00000000000094ac
...
- (id)getLogger;	// IMP=0x00000000000093d2
- (void)addSpecifierForHeaderString:(id)arg1;	// IMP=0x0000000000009295
- (id)cancelConsentRequestSpecifier;	// IMP=0x000000000000916d
- (id)activatePlanSpecifier;	// IMP=0x00000000000090da
- (id)planActivationInfo;	// IMP=0x0000000000008f17
- (id)planPendingTransferNumber:(id)arg1;	// IMP=0x0000000000008eb0
- (id)planPendingTransferLabel:(id)arg1;	// IMP=0x0000000000008e5c
- (void)removePlanPendingTransfer:(id)arg1;	// IMP=0x0000000000008be5
- (id)initWithListController:(id)arg1 groupSpecifier:(id)arg2;	// IMP=0x0000000000008b8f
- (id)specifiers;	// IMP=0x0000000000008458
- (id)initWithHostController:(id)arg1 parentSpecifier:(id)arg2;	// IMP=0x0000000000008313
