...
+ (id)gameCenterConfiguration;	// IMP=0x004000000035517e
+ (id)contactsConfiguration;	// IMP=0x004000000035512a
+ (id)defaultConfiguration;	// IMP=0x0040000000355118
