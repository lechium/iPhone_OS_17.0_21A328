...
- (void).cxx_destruct;	// IMP=0x000000000002787a
...
- (id)observeKeyboardEvents:(CDUnknownBlockType)arg1;	// IMP=0x00000000000274cb
- (void)dealloc;	// IMP=0x0000000000027472
- (id)init;	// IMP=0x0000000000027447
- (id)initWithSource:(id)arg1 service:(id)arg2;	// IMP=0x00000000000270f0
