...
- (void)setupEVSModesWithClientModeMask:(unsigned int)arg1;	// IMP=0x000000000004f5b6
- (void)setupAMRWBModesWithClientModeMask:(unsigned int)arg1;	// IMP=0x000000000004f3a3
- (void)setupAMRModesWithClientModeMask:(unsigned int)arg1;	// IMP=0x000000000004f1c6
- (void)setPreferredModeWithClientMode:(int)arg1;	// IMP=0x000000000004f1bd
- (void)setupCodecBandwidthsWithClientBandwidthMask:(unsigned int)arg1;	// IMP=0x000000000004f056
- (void)setupModesWithClientModeMask:(unsigned int)arg1;	// IMP=0x000000000004f007
@property(readonly, nonatomic) _Bool isComfortNoise;
- (void)dealloc;	// IMP=0x000000000004ef60
- (id)initWithCodecType:(long long)arg1;	// IMP=0x000000000004eec7
