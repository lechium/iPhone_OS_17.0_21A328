...
+ (id)playerItemForMediaItem:(id)arg1;	// IMP=0x00600000000090b2
- (void).cxx_destruct;	// IMP=0x000000000000b323
...
- (id)description;	// IMP=0x000000000000af2b
- (void)_initializeAdditionalAttributesWithMediaItem:(id)arg1;	// IMP=0x000000000000971b
- (void)_initializeArtworkCatalogWithMediaItem:(id)arg1;	// IMP=0x0000000000009334
- (void)_initializeBasicPropertiesWithMediaItem:(id)arg1;	// IMP=0x0000000000009194
- (id)_initWithMediaItem:(id)arg1;	// IMP=0x0000000000009104
