...
- (void).cxx_destruct;	// IMP=0x0000000000020d05
...
- (id)sectionedDataSourceManagerInterestingObjectReferences:(id)arg1;	// IMP=0x0000000000020cdb
- (void)observable:(id)arg1 didChange:(unsigned long long)arg2 context:(void *)arg3;	// IMP=0x0000000000020901
- (id)mutableChangeObject;	// IMP=0x00000000000208f8
- (void)cancelProgressForAssetUUIDs:(id)arg1;	// IMP=0x000000000002061b
- (void)setProgress:(id)arg1 forAssetReference:(id)arg2;	// IMP=0x00000000000204de
- (id)_createSnapshot;	// IMP=0x0000000000020118
@property(readonly, nonatomic) AEProgressViewModelSnapshot *progressSnapshot;
- (id)initWithDataSourceManager:(id)arg1;	// IMP=0x000000000001ffbf
