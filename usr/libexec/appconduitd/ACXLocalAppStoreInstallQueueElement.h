...
- (void).cxx_destruct;	// IMP=0x0020000000033a46
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000338e9
- (unsigned long long)hash;	// IMP=0x001000000003387b
- (id)initWithApp:(id)arg1 isUserInitiated:(_Bool)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x00100000000337c8
