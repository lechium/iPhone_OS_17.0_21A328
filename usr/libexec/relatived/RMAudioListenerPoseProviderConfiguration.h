...
- (void).cxx_destruct;	// IMP=0x002000000000295b
...
- (id)initWithUniqueIdentifier:(id)arg1 tempestOptions:(id)arg2 forceSessionRestart:(_Bool)arg3;	// IMP=0x001000000000285d
