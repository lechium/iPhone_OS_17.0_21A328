...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000a16396
- (unsigned long long)hash;	// IMP=0x0000000000a160f9
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000a15f74
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000a15e6e
- (void)copyTo:(id)arg1;	// IMP=0x0000000000a15d8b
- (void)writeTo:(id)arg1;	// IMP=0x0000000000a15c74
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000a157bc
- (id)dictionaryRepresentation;	// IMP=0x0000000000a154f6
- (id)description;	// IMP=0x0000000000a15447
@property(nonatomic) _Bool hasHeight;
@property(nonatomic) _Bool hasWidth;
- (int)StringAsType:(id)arg1;	// IMP=0x0000000000a1531a
- (id)typeAsString:(int)arg1;	// IMP=0x0000000000a152d2
