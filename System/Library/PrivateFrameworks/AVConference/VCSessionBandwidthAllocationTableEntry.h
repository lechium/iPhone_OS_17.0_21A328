...
+ (long long)compareAudioEntry:(id)arg1 videoEntry:(id)arg2;	// IMP=0x00600000001ca66c
+ (long long)compareVideoEntry:(id)arg1 videoEntry:(id)arg2;	// IMP=0x00600000001ca1e0
+ (long long)compareAudioEntry:(id)arg1 audioEntry:(id)arg2;	// IMP=0x00600000001c9fb1
+ (unsigned char)entryTypeForMediaType:(unsigned int)arg1;	// IMP=0x00600000001c9d6a
...
- (long long)compare:(id)arg1;	// IMP=0x00000000001c9df6
- (id)description;	// IMP=0x00000000001c9c45
- (void)dealloc;	// IMP=0x00000000001c9be7
- (id)initWithClient:(id)arg1 type:(unsigned char)arg2 streamToken:(long long)arg3 streamID:(unsigned int)arg4 streamGroupID:(unsigned int)arg5;	// IMP=0x00000000001c9b36
...
- (id)initWithClient:(id)arg1 type:(unsigned char)arg2 streamToken:(long long)arg3 networkBitrate:(unsigned int)arg4 mediaBitrate:(unsigned int)arg5 qualityIndex:(unsigned int)arg6 streamID:(unsigned int)arg7 streamGroupID:(unsigned int)arg8;	// IMP=0x00000000001c99fd
