...
+ (id)logCategory;	// IMP=0x0060000000797831
- (void).cxx_destruct;	// IMP=0x00000000007977ef
...
- (id)attributeDescriptions;	// IMP=0x00000000007973e5
- (id)initWithAccessoryIdentifier:(id)arg1 privacyPolicyURL:(id)arg2 uploadDestination:(id)arg3 consentVersion:(unsigned long long)arg4 uploadType:(unsigned long long)arg5;	// IMP=0x00000000007972ec
- (id)initWithAccessoryIdentifier:(id)arg1 jsonDictionary:(id)arg2;	// IMP=0x0000000000796efb
