...
- (void).cxx_destruct;	// IMP=0x0000000000ab4ad1
...
- (id)traitCollection;	// IMP=0x0000000000ab481d
- (_Bool)pointInside:(struct CGPoint)arg1 withEvent:(id)arg2;	// IMP=0x0000000000ab45f2
- (void)layoutSubviews;	// IMP=0x0000000000ab4444
- (void)setInlineText:(id)arg1 inlineRect:(struct CGRect)arg2 maxX:(double)arg3 layout:(_Bool)arg4;	// IMP=0x0000000000ab3c35
- (_Bool)shouldExtendUpwards;	// IMP=0x0000000000ab39ec
- (void)adjustFrameForInlineText:(id)arg1 inlineRect:(struct CGRect)arg2 maxX:(double)arg3;	// IMP=0x0000000000ab3363
- (struct CGRect)adjustedFrameFromDesiredFrame:(struct CGRect)arg1 textWidth:(double)arg2;	// IMP=0x0000000000ab3080
- (struct CGRect)adjustedFrameFromDesiredFrame:(struct CGRect)arg1 textHeight:(double)arg2;	// IMP=0x0000000000ab2bfc
- (_Bool)isAcceptableFrame:(struct CGRect)arg1 afterScrollBy:(double)arg2;	// IMP=0x0000000000ab2330
- (struct CGRect)adjustedInlineRectFromInlineText:(id)arg1 inlineRect:(struct CGRect)arg2;	// IMP=0x0000000000ab22af
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000ab21ef
