...
+ (id)parsedFromData:(id)arg1 error:(id *)arg2;	// IMP=0x001000000059e3b3
- (void).cxx_destruct;	// IMP=0x0000000000595edc
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000005959b6
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000005958d7
- (id)serializeWithError:(id *)arg1;	// IMP=0x0000000000595000
- (_Bool)parseFromData:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000594a35
- (id)initWithMulticastBridgingRules:(id)arg1 staticPortRules:(id)arg2 dynamicPortRules:(id)arg3 staticICMPRules:(id)arg4;	// IMP=0x000000000059494d
- (id)init;	// IMP=0x000000000059491e
