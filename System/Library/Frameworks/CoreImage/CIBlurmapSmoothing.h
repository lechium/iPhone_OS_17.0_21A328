...
+ (id)customAttributes;	// IMP=0x0060000000152ba4
...
- (id)outputImage;	// IMP=0x00000000001531d3
- (id)performPass:(id)arg1 reference:(id)arg2 values:(id)arg3 rect:(struct CGRect)arg4;	// IMP=0x0000000000152d8a
- (id)_kernelV;	// IMP=0x0000000000152d6a
- (id)_kernelH;	// IMP=0x0000000000152d4a
