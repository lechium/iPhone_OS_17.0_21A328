...
- (void).cxx_destruct;	// IMP=0x00000000001d9f41
...
- (_Bool)removePlaybackQueueDataSourceCallback:(id)arg1;	// IMP=0x00000000001d9ca3
- (void)registerNowPlayingInfoArtworkAssetCallback:(id)arg1;	// IMP=0x00000000001d98b1
- (void)registerNowPlayingInfoAssetCallbacks:(id)arg1;	// IMP=0x00000000001d9508
- (void)registerNowPlayingInfoCallbacks:(id)arg1;	// IMP=0x00000000001d9069
- (void)registerNowPlayingInfoBackedPlaybackQueueDataSourceCallbacks;	// IMP=0x00000000001d9001
@property(readonly, copy, nonatomic) NSArray *commandHandlerBlocks;
- (void)removeCommandHandlerBlockForKey:(id)arg1;	// IMP=0x00000000001d8e08
- (void)addCommandHandlerBlock:(CDUnknownBlockType)arg1 forKey:(id)arg2;	// IMP=0x00000000001d8cfa
- (unsigned long long)_onQueue_capabilities;	// IMP=0x00000000001d8c27
...
- (id)initWithPlayerPath:(id)arg1 queue:(id)arg2;	// IMP=0x00000000001d7793
