...
- (void).cxx_destruct;	// IMP=0x00000000000990bd
...
- (id)loadPage;	// IMP=0x0000000000098c1c
@property(readonly, nonatomic) _Bool disableReappearPlaceholder;
- (id)createViewControllerForContainer:(id)arg1;	// IMP=0x0000000000098a87
- (id)initWithJSObject:(id)arg1 context:(id)arg2;	// IMP=0x00000000000986e1
