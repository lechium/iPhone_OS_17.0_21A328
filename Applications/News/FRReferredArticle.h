...
- (void).cxx_destruct;	// IMP=0x00200000000af953
...
- (id)headlineWithContentContext:(id)arg1;	// IMP=0x00100000000af5bf
- (id)initWithArticleID:(id)arg1 sourceChannelID:(id)arg2 sectionData:(id)arg3 flintDocumentAssetHandle:(id)arg4 articleRecordData:(id)arg5 sourceChannelRecordData:(id)arg6 parentIssueRecordData:(id)arg7;	// IMP=0x00100000000af369
