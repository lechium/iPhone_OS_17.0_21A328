...
+ (id)configurationPromiseWithBag:(id)arg1;	// IMP=0x0060000000314df4
- (void).cxx_destruct;	// IMP=0x0000000000315771
...
- (id)_generateModifiersIfNeeded;	// IMP=0x000000000031536d
@property(readonly, nonatomic) NSArray *overrides; // @synthesize overrides=_overrides;
- (id)modifierForEvent:(id)arg1;	// IMP=0x0000000000315045
- (void)prepareForFlush;	// IMP=0x0000000000314f3a
- (id)initWithMetricsDictionary:(id)arg1;	// IMP=0x0000000000314d3d
