...
- (void).cxx_destruct;	// IMP=0x002000000000c12d
- (id)_loadStatusOnce:(id *)arg1;	// IMP=0x001000000000bd72
- (id)_getInitialStatus:(id *)arg1;	// IMP=0x001000000000ba44
- (_Bool)_carrierBundleStatusIsValidForCachedStatus:(id)arg1;	// IMP=0x001000000000b8ac
- (void)_cacheAccountEligibilityWithStatus:(id)arg1;	// IMP=0x001000000000b5b9
- (void)run;	// IMP=0x001000000000aa77
