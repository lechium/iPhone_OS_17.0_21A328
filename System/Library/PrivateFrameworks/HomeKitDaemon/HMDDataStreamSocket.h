...
+ (id)logCategory;	// IMP=0x0010000000581705
- (void).cxx_destruct;	// IMP=0x0000000000581453
...
- (void)closeInitiated;	// IMP=0x00000000005813be
- (void)handleIncomingData:(id)arg1;	// IMP=0x00000000005812f3
- (void)closeWithError:(id)arg1;	// IMP=0x000000000058120a
- (id)readData;	// IMP=0x00000000005811af
- (void)_writeData:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000000005810d1
- (void)writeData:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000000581027
- (_Bool)writeData:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000580f92
- (void)close;	// IMP=0x0000000000580f7e
...
- (id)initWithStreamProtocol:(id)arg1 applicationProtocolName:(id)arg2 workQueue:(id)arg3;	// IMP=0x0000000000580cfd
