...
@interface LSBundleRecordBuilder
{
    ...
    struct LSBundleBaseFlags _baseFlags;	// 87 = 0x57
    ...
    NSArray *_parentApplicationIdentifiers;	// 472 = 0x1d8
    NSString *_watchKitVersion;	// 480 = 0x1e0
    NSString *_complicationPrincipalClass;	// 488 = 0x1e8
    NSArray *_supportedComplicationFamilies;	// 496 = 0x1f0
    NSString *_ratingLabel;	// 504 = 0x1f8
    NSNumber *_ratingRank;	// 512 = 0x200
    NSString *_genre;	// 520 = 0x208
    NSNumber *_genreID;	// 528 = 0x210
    NSString *_primaryIconName;	// 536 = 0x218
    NSString *_alternatePrimaryIconName;	// 544 = 0x220
    NSDictionary *_iconsDict;	// 552 = 0x228
    NSArray *_iconFileNames;	// 560 = 0x230
    NSNumber *_purchaserDSID;	// 568 = 0x238
    NSNumber *_downloaderDSID;	// 576 = 0x240
    NSNumber *_familyID;	// 584 = 0x248
    NSNumber *_staticDiskUsage;	// 592 = 0x250
    NSString *_libraryPath;	// 600 = 0x258
    NSArray *_libraryItems;	// 608 = 0x260
    NSArray *_documentClaims;	// 616 = 0x268
    NSArray *_URLClaims;	// 624 = 0x270
    NSArray *_importedTypes;	// 632 = 0x278
    NSArray *_exportedTypes;	// 640 = 0x280
    NSArray *_queriableSchemes;	// 648 = 0x288
    NSDictionary *_pluginPlists;	// 656 = 0x290
    NSDictionary *_pluginMIDicts;	// 664 = 0x298
    NSArray *_driverExtensionPaths;	// 672 = 0x2a0
    NSDictionary *_groupContainers;	// 680 = 0x2a8
    NSDictionary *_entitlements;	// 688 = 0x2b0
    NSDictionary *_sandboxEnvironmentVariables;	// 696 = 0x2b8
    NSDictionary *_extensionSDK;	// 704 = 0x2c0
    NSDictionary *_intentDefinitionURLs;	// 712 = 0x2c8
    NSArray *_bgPermittedIdentifiers;	// 720 = 0x2d0
    NSArray *_carPlayInstrumentClusterURLSchemes;	// 728 = 0x2d8
    NSDictionary *_localizedNames;	// 736 = 0x2e0
    NSDictionary *_localizedShortNames;	// 744 = 0x2e8
    NSString *_microphoneUsageDescription;	// 752 = 0x2f0
    NSDictionary *_localizedMicrophoneUsageDescription;	// 760 = 0x2f8
    NSString *_identityUsageDescription;	// 768 = 0x300
    NSDictionary *_localizedIdentityUsageDescription;	// 776 = 0x308
    NSDictionary *_localizedStrings;	// 784 = 0x310
    NSDictionary *_unlocalizedNamesWithContext;	// 792 = 0x318
    NSNumber *_directoryClass;	// 800 = 0x320
    NSDictionary *_mobileInstallIDs;	// 808 = 0x328
    NSArray *_slices;	// 816 = 0x330
    NSNumber *_signatureVersion;	// 824 = 0x338
    NSDictionary *_stashedAppInfo;	// 832 = 0x340
    NSString *_applicationManagementDomain;	// 840 = 0x348
    NSString *_linkedParentBundleID;	// 848 = 0x350
}

- (void).cxx_destruct;	// IMP=0x0000000000083b01
...
- (unsigned int)registerBundleRecord:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000082a55
- (int)activateBindings:(id)arg1 unitID:(unsigned int)arg2 bundleData:(const struct LSBundleData *)arg3;	// IMP=0x000000000008297c
- (struct LSBundleData)buildBundleData:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000080239
- (void)parseNSExtensionSDKDefinitionsFromDictionary:(id)arg1;	// IMP=0x000000000007fd52
- (void)parseActivityTypesFromDictionary:(id)arg1;	// IMP=0x000000000007faef
- (_Bool)parseInstallationInfo:(id)arg1;	// IMP=0x000000000007e7fc
- (_Bool)parseInfoPlist:(id)arg1;	// IMP=0x000000000007c58e
- (void)parseURLClaimsFromDict:(id)arg1;	// IMP=0x000000000007c31f
- (void)parseDocumentClaimsFromDict:(id)arg1;	// IMP=0x000000000007c03a
- (void)parseDeviceFamilyFromDict:(id)arg1;	// IMP=0x000000000007bed1
- (void)parseIconFilenamesFromDict:(id)arg1 forPlatform:(unsigned int)arg2;	// IMP=0x000000000007bde9
- (id)iconsDictionaryFromDict:(id)arg1;	// IMP=0x000000000007b7cd
- (void)parseArchitecturesFromDict:(id)arg1;	// IMP=0x000000000007b75f
- (void)setCommonInfoPlistKeysFromDictionary:(id)arg1;	// IMP=0x000000000007b629
- (void)setRaritiesFromDictionary:(id)arg1;	// IMP=0x000000000007b39d
- (void)setFlagsFromDictionary:(id)arg1;	// IMP=0x000000000007b019
- (id)_LSKeyTypeMap;	// IMP=0x000000000007ae23
- (id)_LSPlistRaritiesMap;	// IMP=0x000000000007ac13
- (id)_LSBundleFlagMap;	// IMP=0x000000000007a6d1
- (id)truncate:(_Bool *)arg1 queriableSchemesIfNeeded:(id)arg2;	// IMP=0x000000000007a483
- (int)registerQueriableSchemes:(id)arg1 bundleData:(struct LSBundleData *)arg2;	// IMP=0x000000000007a09e
- (void)addItemInfoFlag:(unsigned int)arg1;	// IMP=0x000000000007a08e
- (void)addIconFlag:(unsigned char)arg1;	// IMP=0x000000000007a07e
- (void)addPlistFlag:(unsigned int)arg1;	// IMP=0x000000000007a06e
- (void)addBundleFlag:(unsigned long long)arg1;	// IMP=0x000000000007a05d
- (void)setRegistrationInfo:(id)arg1 alias:(id)arg2;	// IMP=0x0000000000079f4b
