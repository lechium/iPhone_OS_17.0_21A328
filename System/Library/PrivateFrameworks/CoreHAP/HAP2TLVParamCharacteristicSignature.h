...
+ (id)parsedFromData:(id)arg1 error:(id *)arg2;	// IMP=0x001000000006316c
- (void).cxx_destruct;	// IMP=0x00000000000630f7
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000625c9
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000006243d
- (id)serializeWithError:(id *)arg1;	// IMP=0x00000000000618f8
- (_Bool)parseFromData:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000060f8a
- (id)initWithInstanceID:(id)arg1 characteristicType:(id)arg2 characteristicProperties:(id)arg3 userDescription:(id)arg4 bluetoothFormat:(id)arg5 validRange:(id)arg6 stepValue:(id)arg7 validValues:(id)arg8 validValuesRange:(id)arg9;	// IMP=0x0000000000060e05
- (id)init;	// IMP=0x0000000000060dd6
