...
+ (struct CGSize)preferredSize;	// IMP=0x0040000000a1473c
- (void).cxx_destruct;	// IMP=0x0020000000a14772
...
- (void)dismissWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x0010000000a1453f
- (void)present;	// IMP=0x0010000000a143e5
- (id)initWithTrackingStateReason:(unsigned long long)arg1;	// IMP=0x0010000000a138cd
