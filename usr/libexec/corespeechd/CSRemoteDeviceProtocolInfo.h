...
+ (id)localDeviceProtocolInfo;	// IMP=0x004000000008a443
+ (id)defaultProtocolInfo;	// IMP=0x001000000008a3f8
- (void).cxx_destruct;	// IMP=0x002000000008a3c5
...
- (id)description;	// IMP=0x001000000008a351
@property(readonly, nonatomic) NSObject<OS_xpc_object> *xpcObject;
- (id)initWithXPCObject:(id)arg1;	// IMP=0x001000000008a078
- (id)initWithProtocolVersion:(unsigned long long)arg1 buildVersion:(id)arg2 deviceProductVersion:(id)arg3 deviceProductType:(id)arg4 deviceCategory:(unsigned long long)arg5;	// IMP=0x0010000000089fac
