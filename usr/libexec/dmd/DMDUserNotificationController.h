...
+ (id)sharedController;	// IMP=0x0020000000086026
- (void).cxx_destruct;	// IMP=0x002000000008706f
...
- (void)_notificationRef:(struct __CFUserNotification *)arg1 wasDismissedWithFlags:(unsigned long long)arg2;	// IMP=0x0010000000086d6c
- (void)_completeNotification:(id)arg1 response:(unsigned long long)arg2;	// IMP=0x0010000000086bca
- (void)_showNextNotification;	// IMP=0x00100000000867ed
- (id)_dictFromNotification:(id)arg1;	// IMP=0x00100000000865ef
- (void)showNotification:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0010000000086175
- (id)initPrivate;	// IMP=0x00100000000860bb
