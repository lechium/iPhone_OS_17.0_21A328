...
- (void).cxx_destruct;	// IMP=0x0020000000a89c53
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000a89b48
- (id)initWithSections:(id)arg1 displayName:(id)arg2 viewTakesFullHeight:(_Bool)arg3;	// IMP=0x0010000000a89aa5
