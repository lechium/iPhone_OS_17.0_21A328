...
+ (id)logCategory;	// IMP=0x00100000006c735f
+ (id)_streamingStatusForResponse:(id)arg1;	// IMP=0x00100000006c6fee
- (void).cxx_destruct;	// IMP=0x00000000006c6ab9
...
- (void)_callDidCompleteReadDelegateCallback;	// IMP=0x00000000006c6940
- (id)_inUseStreamControlMessageHandlersForReadResponses:(id)arg1;	// IMP=0x00000000006c6785
- (id)_availableStreamControlMessageHandlersForReadResponses:(id)arg1;	// IMP=0x00000000006c65ca
- (void)_handleStreamStatusMultireadResponse:(id)arg1;	// IMP=0x00000000006c6059
- (void)readSetting;	// IMP=0x00000000006c5b08
- (void)handleMessage:(id)arg1;	// IMP=0x00000000006c56f5
- (_Bool)hasPendingNegotiateMessageForSessionWithIdentifier:(id)arg1;	// IMP=0x00000000006c561f
- (id)initWithWorkQueue:(id)arg1 sessionID:(id)arg2 accessory:(id)arg3 message:(id)arg4 streamControlMessageHandlers:(id)arg5 streamPreferences:(id)arg6 logIdentifier:(id)arg7;	// IMP=0x00000000006c53ec
