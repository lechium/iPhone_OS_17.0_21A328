...
- (void).cxx_destruct;	// IMP=0x0000000000054055
...
- (id)description;	// IMP=0x0000000000053f74
- (id)initWithName:(id)arg1 offset:(int)arg2 modelField:(id)arg3;	// IMP=0x0000000000053ec1
