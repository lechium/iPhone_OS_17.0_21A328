...
- (void).cxx_destruct;	// IMP=0x0020000000094985
...
- (id)_coealesceItems:(id)arg1;	// IMP=0x00100000000945a1
@property(readonly, nonatomic) MRNowPlayingState *state;
- (id)description;	// IMP=0x0010000000092d14
- (id)initWithPlayerPath:(id)arg1;	// IMP=0x0010000000092ca9
