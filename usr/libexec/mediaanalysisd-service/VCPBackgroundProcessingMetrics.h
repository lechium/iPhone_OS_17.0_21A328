...
+ (id)sharedMetricsWithPhotoLibrary:(id)arg1;	// IMP=0x00400000000745bb
- (void).cxx_destruct;	// IMP=0x00200000000751ea
- (int)persist;	// IMP=0x0010000000074a93
- (int)reportAnalyzedAsset:(id)arg1 withAnalysis:(id)arg2 andProcessingTime:(double)arg3;	// IMP=0x00100000000747c4
- (void)dealloc;	// IMP=0x0010000000074538
- (id)initWithPhotoLibrary:(id)arg1;	// IMP=0x0010000000073b90
