...
- (void).cxx_destruct;	// IMP=0x000000000007121a
...
- (void)dealloc;	// IMP=0x00000000000711c1
- (void)invalidate;	// IMP=0x0000000000070fb0
- (void)done;	// IMP=0x0000000000070d84
- (CDUnknownBlockType)_popGatherReply;	// IMP=0x0000000000070d17
- (void)gatherWithBatchSize:(long long)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000000006f586
- (id)initWithNotificationPipe:(id)arg1 appLibraries:(id)arg2 startingRank:(unsigned long long)arg3 maxRank:(unsigned long long)arg4 withDeadItems:(_Bool)arg5 gatherReply:(CDUnknownBlockType)arg6;	// IMP=0x000000000006f1c7
