...
- (void)_handleFailedNotificationWithError:(id)arg1;	// IMP=0x000000000009c922
- (void)_handleCompletedWritingNotification;	// IMP=0x000000000009c8ed
- (void)_teardownNotificationHandlers;	// IMP=0x000000000009c83c
- (void)_callDelegateIfNotCalledWithSuccess:(_Bool)arg1 error:(id)arg2;	// IMP=0x000000000009c7d9
- (void)dealloc;	// IMP=0x000000000009c774
- (id)initWithFigAssetWriter:(struct OpaqueFigAssetWriter *)arg1;	// IMP=0x000000000009c54f
