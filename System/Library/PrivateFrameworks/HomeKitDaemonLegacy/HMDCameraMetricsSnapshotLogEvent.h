...
- (void).cxx_destruct;	// IMP=0x000000000073fa6c
...
- (id)initWithSessionID:(id)arg1 cameraAccessory:(id)arg2 isLocal:(_Bool)arg3 snapshotForNotification:(_Bool)arg4;	// IMP=0x000000000073f9f4
