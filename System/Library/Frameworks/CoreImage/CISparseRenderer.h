...
+ (id)customAttributes;	// IMP=0x006000000015a10b
...
- (id)outputImage;	// IMP=0x000000000015b18a
- (id)_kernel:(_Bool)arg1 alpha:(_Bool)arg2;	// IMP=0x000000000015b054
- (id)_lutKernel:(_Bool)arg1 alpha:(_Bool)arg2;	// IMP=0x000000000015af1e
- (id)baseVecsLUT:(unsigned int)arg1;	// IMP=0x000000000015ae35
- (id)stepsLUT:(unsigned int)arg1;	// IMP=0x000000000015ad18
- (id)baseVecsLUTGenerator;	// IMP=0x000000000015acab
- (id)stepsLUTGenerator;	// IMP=0x000000000015ac3e
- (_Bool)_useD2XRenderer;	// IMP=0x000000000015ab1d
- (id)_packageParams:(_Bool)arg1 extent:(struct CGRect)arg2 image:(id)arg3 haveAlpha:(_Bool)arg4;	// IMP=0x000000000015a27e
