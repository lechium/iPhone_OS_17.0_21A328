...
- (void).cxx_destruct;	// IMP=0x0000000000aeabfe
...
- (void)touchesMoved:(id)arg1 withEvent:(id)arg2;	// IMP=0x0000000000aeaacb
- (void)touchesBegan:(id)arg1 withEvent:(id)arg2;	// IMP=0x0000000000aeaa10
- (_Bool)shouldTrack;	// IMP=0x0000000000aeaa08
@property(readonly, nonatomic) unsigned long long numberOfSegments;
- (void)updateSelectionWithPoint:(struct CGPoint)arg1;	// IMP=0x0000000000aea8ed
- (void)_populateSegmentViewsWithCount:(unsigned long long)arg1;	// IMP=0x0000000000aea342
- (void)_removeAllSegmentViews;	// IMP=0x0000000000aea17a
- (void)layoutSubviews;	// IMP=0x0000000000aea105
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000ae9e58
