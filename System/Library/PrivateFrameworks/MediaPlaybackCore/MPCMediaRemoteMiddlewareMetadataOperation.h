...
- (void).cxx_destruct;	// IMP=0x00000000000f79fa
...
- (id)_itemGenericObjectPropertySetForContentItem:(id)arg1 propertySet:(id)arg2;	// IMP=0x00000000000f7397
- (id)_genericObjectPropertySetForContentItem:(id)arg1 preferredRelationships:(id)arg2 propertySet:(id)arg3;	// IMP=0x00000000000f6e9a
- (struct _MSVSignedRange)rangeFromTracklistRange:(CDStruct_912cb5d2)arg1;	// IMP=0x00000000000f6e76
@property(readonly, nonatomic) NSArray *outputProtocols;
@property(readonly, nonatomic) NSArray *inputProtocols;
- (id)timeoutDescription;	// IMP=0x00000000000f6cd0
- (void)execute;	// IMP=0x00000000000f6c09
- (void)_loadPlayingIdentifierWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00000000000f69e3
- (void)_loadItemsWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00000000000f6451
- (id)initWithMiddleware:(id)arg1 request:(id)arg2;	// IMP=0x00000000000f63af
