...
- (void).cxx_destruct;	// IMP=0x0000000000773a02
...
- (void)main;	// IMP=0x00000000007733db
- (id)initWithStore:(id)arg1 clearCloud:(_Bool)arg2 resultHandler:(CDUnknownBlockType)arg3;	// IMP=0x000000000077330e
