...
- (void).cxx_destruct;	// IMP=0x00000000001f77de
- (struct __CTServerConnection *)_telephonyServer;	// IMP=0x00000000001f75be
- (void)sendSMSWithBodyText:(id)arg1:(id)arg2:(id)arg3;	// IMP=0x00000000001f74b2
...
- (id)formattedPhoneNumber:(id)arg1;	// IMP=0x00000000001f723c
@property(readonly, nonatomic) NSString *countryCode;
- (void)beginObserving;	// IMP=0x00000000001f715b
- (void)dealloc;	// IMP=0x00000000001f7080
- (id)initWithAppContext:(id)arg1;	// IMP=0x00000000001f7021
