...
- (void)replicateStateFromImageView:(id)arg1;	// IMP=0x000000000000da75
@property(nonatomic) double borderWidth;
@property(copy, nonatomic) UIColor *borderColor;
- (_Bool)_shouldAnimatePropertyWithKey:(id)arg1;	// IMP=0x000000000000d84a
- (void)setTransform:(struct CGAffineTransform)arg1;	// IMP=0x000000000000d7d5
