...
- (void).cxx_destruct;	// IMP=0x000000000004ea68
...
- (void)dealloc;	// IMP=0x000000000004e984
- (_Bool)hasValidURL;	// IMP=0x000000000004e940
- (void)refillReadBuffer;	// IMP=0x000000000004e7dc
- (id)readLine;	// IMP=0x000000000004e264
- (id)initWithFileURL:(id)arg1 bufferSize:(unsigned long long)arg2 maxLineSize:(unsigned long long)arg3;	// IMP=0x000000000004e155
- (id)initWithFileURL:(id)arg1;	// IMP=0x000000000004e138
