...
+ (id)sharedSettings;	// IMP=0x00100000000b7571
- (void).cxx_destruct;	// IMP=0x00000000000b8a2e
...
- (void)environmentMonitorDidChangeNetworkType:(id)arg1;	// IMP=0x00000000000b88ce
- (id)_descriptionForExternalScreenType:(unsigned int)arg1;	// IMP=0x00000000000b88ad
- (long long)_downloadQualityForString:(id)arg1;	// IMP=0x00000000000b884d
- (long long)_playbackQualityForString:(id)arg1 forCellular:(_Bool)arg2;	// IMP=0x00000000000b87e0
- (void)_updatePropertiesFromUserPrefs;	// IMP=0x00000000000b84a5
- (void)_registerObserverForUserPrefsChange;	// IMP=0x00000000000b833a
- (void)_sceneWillConnect:(id)arg1;	// IMP=0x00000000000b8276
- (void)_externalScreenTypeDidChange:(id)arg1;	// IMP=0x00000000000b8129
- (void)_applicationWillEnterForeground:(id)arg1;	// IMP=0x00000000000b8117
- (void)_updateNetworkStatus;	// IMP=0x00000000000b7ee2
- (void)updateSupplementaryAvailableAudioLanguageCodes:(id)arg1;	// IMP=0x00000000000b7c3a
...
- (void)dealloc;	// IMP=0x00000000000b79bc
- (id)init;	// IMP=0x00000000000b75c6
