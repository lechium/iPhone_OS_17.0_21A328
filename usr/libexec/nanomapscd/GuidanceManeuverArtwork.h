...
+ (id)artworkWithManeuver:(int)arg1;	// IMP=0x0040000000016e5c
- (void).cxx_destruct;	// IMP=0x00200000000171a4
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000017031
- (unsigned long long)hash;	// IMP=0x0010000000016fc9
...
- (id)initWithManeuver:(int)arg1 junction:(id)arg2 drivingSide:(int)arg3 artworkDataSource:(id)arg4;	// IMP=0x0010000000016e91
- (_Bool)isValue:(id)arg1 equalTo:(id)arg2;	// IMP=0x0010000000016dc2
