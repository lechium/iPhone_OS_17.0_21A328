...
- (void).cxx_destruct;	// IMP=0x0000000000ea04e4
...
- (void)createDynamicColors;	// IMP=0x0000000000e9f9b2
- (id)vibrancyEffectForBlur:(id)arg1;	// IMP=0x0000000000e9f994
- (id)initWithKeyboardAppearance:(long long)arg1 isRTL:(_Bool)arg2;	// IMP=0x0000000000e9f8c0
