...
+ (id)statusWithApplication:(id)arg1 rideOption:(id)arg2 startingWaypointCoordinate:(struct CLLocationCoordinate2D)arg3 origin:(id)arg4 destination:(id)arg5 loadingRequestRideStatus:(_Bool)arg6 etaMinutesAtStartWaypoint:(id)arg7;	// IMP=0x00400000008c57d4
+ (id)statusWithApplication:(id)arg1 error:(unsigned long long)arg2;	// IMP=0x00100000008c5768
- (void).cxx_destruct;	// IMP=0x00100000008c5baf
...
- (id)description;	// IMP=0x00100000008c5a3a
