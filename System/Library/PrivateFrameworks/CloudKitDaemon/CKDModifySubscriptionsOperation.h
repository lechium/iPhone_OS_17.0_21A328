...
+ (long long)isPredominatelyDownload;	// IMP=0x00600000001739e0
- (void).cxx_destruct;	// IMP=0x0000000000174a79
...
- (_Bool)isOperationType:(int)arg1;	// IMP=0x0000000000174993
- (int)operationType;	// IMP=0x0000000000174967
- (void)_finishOnCallbackQueueWithError:(id)arg1;	// IMP=0x0000000000174656
- (void)main;	// IMP=0x00000000001739e8
- (void)_handleSubscriptionDeleted:(id)arg1 responseCode:(id)arg2;	// IMP=0x000000000017363f
- (void)_handleSubscriptionSaved:(id)arg1 error:(id)arg2;	// IMP=0x00000000001733e0
- (void)_handleSubscriptionSaved:(id)arg1 responseCode:(id)arg2;	// IMP=0x0000000000173261
- (id)activityCreate;	// IMP=0x0000000000173238
- (id)initWithOperationInfo:(id)arg1 container:(id)arg2;	// IMP=0x0000000000172f70
