...
+ (void)loadAllSearchesFromStorage:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00200000009c0a14
- (void).cxx_destruct;	// IMP=0x00200000009c11e5
...
- (id)geoMapItemForSearchResultAtIndex:(unsigned long long)arg1;	// IMP=0x00100000009c10fa
@property(readonly, nonatomic) unsigned long long searchResultsCount;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000009c10a2
@property(readonly, nonatomic) id <RAPAuxiliaryControlsRecording> auxiliaryControlsRecording;
- (void)applyToCorrectedSearch:(id)arg1;	// IMP=0x00100000009c1083
- (id)initWithHistoryItem:(id)arg1 correctedSearchTemplate:(id)arg2 auxiliaryControls:(id)arg3 originatingIndex:(unsigned long long)arg4;	// IMP=0x00100000009c0ecc
