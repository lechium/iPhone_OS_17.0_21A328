...
+ (id)logCategory;	// IMP=0x0010000000c2610a
- (void).cxx_destruct;	// IMP=0x0000000000c260a6
...
- (id)logIdentifier;	// IMP=0x0000000000c25fc5
- (id)negotiatedParameters;	// IMP=0x0000000000c25e70
- (id)initWithSessionID:(id)arg1 streamingTierType:(unsigned long long)arg2 remoteCapabilities:(id)arg3 streamPreference:(id)arg4;	// IMP=0x0000000000c25af0
