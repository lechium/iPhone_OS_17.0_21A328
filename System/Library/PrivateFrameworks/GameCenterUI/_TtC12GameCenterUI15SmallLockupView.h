...
- (void).cxx_destruct;	// IMP=0x000000000020e7ab
...
- (void)layoutSubviews;	// IMP=0x000000000020d967
- (struct JUMeasurements)measurementsWithFitting:(struct CGSize)arg1 in:(id)arg2;	// IMP=0x000000000020d73b
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x000000000020d575
@property(nonatomic) struct UIEdgeInsets layoutMargins;
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000020d2db
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000020cff0
