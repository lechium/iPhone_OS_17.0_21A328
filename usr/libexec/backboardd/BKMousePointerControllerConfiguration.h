...
@interface BKMousePointerControllerConfiguration : NSObject
{
    ...
    id <BKCADisplayProvider> _displayProvider;	// 16 = 0x10
    ...
    id <BKHIDEventHitTestDispatcher> _eventDispatcher;	// 120 = 0x78
    Class _displayLinkClass;	// 128 = 0x80
}

- (void).cxx_destruct;	// IMP=0x002000000004fe81
...
@property(retain, nonatomic) id <BKHIDEventHitTestDispatcher> eventDispatcher; // @synthesize eventDispatcher=_eventDispatcher;
...
@property(retain, nonatomic) id <BKCADisplayProvider> displayProvider; // @synthesize displayProvider=_displayProvider;
