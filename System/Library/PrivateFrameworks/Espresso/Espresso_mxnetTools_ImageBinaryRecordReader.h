...
- (void).cxx_destruct;	// IMP=0x000000000086ab2c
...
- (struct _mxnetTools_imageID_t_)imageID;	// IMP=0x000000000086a9db
- (id)labels;	// IMP=0x000000000086a8e0
- (id)imageData;	// IMP=0x000000000086a775
- (_Bool)nextRecordAndError:(id *)arg1;	// IMP=0x000000000086a284
- (_Bool)seekRecordWithID:(struct _mxnetTools_imageID_t_ *)arg1 error:(id *)arg2;	// IMP=0x000000000086a187
- (id)initWithRecFile:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000869eb9
