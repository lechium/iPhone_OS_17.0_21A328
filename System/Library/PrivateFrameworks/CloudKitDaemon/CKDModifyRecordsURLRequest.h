...
- (void).cxx_destruct;	// IMP=0x00000000003629c7
...
- (void)requestDidComplete;	// IMP=0x0000000000362210
- (void)requestDidParseNodeFailure:(id)arg1;	// IMP=0x0000000000361c42
- (id)requestDidParseProtobufObject:(id)arg1;	// IMP=0x0000000000360e5c
- (id)returnVerificationKeyAndSignatureForRequestOperation:(id)arg1 dataToBeSigned:(id)arg2 error:(id *)arg3;	// IMP=0x0000000000360735
- (id)generateMergeableDeltaSaveOperationsForRecord:(id)arg1 error:(id *)arg2;	// IMP=0x000000000035f59f
- (id)generateRequestOperations;	// IMP=0x000000000035ce0c
- (_Bool)requiresCKAnonymousSignature;	// IMP=0x000000000035cdfa
- (_Bool)handlesAnonymousCKUserIDPropagation;	// IMP=0x000000000035cdf2
- (int)isolationLevel;	// IMP=0x000000000035cdd5
- (id)requestOperationClasses;	// IMP=0x000000000035ccbb
- (id)zoneIDsToLock;	// IMP=0x000000000035c97f
- (_Bool)allowsAnonymousAccount;	// IMP=0x000000000035c965
- (void)fillOutRequestProperties:(id)arg1;	// IMP=0x000000000035c85f
- (void)fillOutEquivalencyPropertiesBuilder:(id)arg1;	// IMP=0x000000000035c6f0
- (id)initWithOperation:(id)arg1 recordsToSave:(id)arg2 recordIDsToDelete:(id)arg3 recordIDsToDeleteToSigningPCSIdentity:(id)arg4 oplock:(_Bool)arg5 sendAllFields:(_Bool)arg6 clientChangeTokenData:(id)arg7 requestedFieldsByRecordId:(id)arg8;	// IMP=0x000000000035c4c3
