...
- (void).cxx_destruct;	// IMP=0x002000000000f3f0
...
- (void)startSearchQueryWithOptions:(id)arg1;	// IMP=0x001000000000f05b
- (_Bool)prepareForTestWithOptions:(id)arg1;	// IMP=0x001000000000eeca
