...
+ (id)xpcMessageName;	// IMP=0x0010000000411072
+ (id)messageName;	// IMP=0x0010000000411065
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000041105d
+ (id)objWithMessage:(id)arg1;	// IMP=0x0010000000410ec6
+ (id)objWithDict:(id)arg1;	// IMP=0x0010000000410d4d
- (void).cxx_destruct;	// IMP=0x0000000000410cfa
...
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000410b05
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000004109ca
