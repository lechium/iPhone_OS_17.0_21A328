...
- (id).cxx_construct;	// IMP=0x0000000000090b0f
- (void).cxx_destruct;	// IMP=0x0000000000090ad3
@property(readonly, retain, nonatomic) NSArray *results;
- (int)finalizeAnalysis;	// IMP=0x0000000000090671
- (void)mergeSimilarSegments;	// IMP=0x00000000000904fc
- (int)processFrameMetadata:(id)arg1;	// IMP=0x0000000000090262
- (_Bool)decideSegmentPointBasedOn:(float)arg1;	// IMP=0x00000000000901cb
- (id)init;	// IMP=0x0000000000090094
