...
- (void).cxx_destruct;	// IMP=0x000000000010c3b9
...
- (void)requestDidComplete;	// IMP=0x000000000010c1a9
- (void)requestDidParseNodeFailure:(id)arg1;	// IMP=0x000000000010bece
- (id)requestDidParseProtobufObject:(id)arg1;	// IMP=0x000000000010b6ce
- (id)generateRequestOperations;	// IMP=0x000000000010aac4
- (_Bool)requiresCKAnonymousUserIDs;	// IMP=0x000000000010aa62
- (_Bool)handlesAnonymousCKUserIDPropagation;	// IMP=0x000000000010aa5a
- (id)zoneIDsToLock;	// IMP=0x000000000010a99c
- (_Bool)requestGETPreAuth;	// IMP=0x000000000010a92f
- (_Bool)allowsAnonymousAccount;	// IMP=0x000000000010a915
- (id)requestOperationClasses;	// IMP=0x000000000010a8a9
- (void)fillOutRequestProperties:(id)arg1;	// IMP=0x000000000010a7bb
- (void)fillOutEquivalencyPropertiesBuilder:(id)arg1;	// IMP=0x000000000010a6b2
- (id)initWithOperation:(id)arg1 query:(id)arg2 cursor:(id)arg3 limit:(unsigned long long)arg4 requestedFields:(id)arg5 zoneID:(id)arg6;	// IMP=0x000000000010a52c
