...
- (void).cxx_destruct;	// IMP=0x0020000000864199
...
- (id)_geoBusinessHours;	// IMP=0x00100000008640fa
- (void)_setupSubmissionParameters:(id)arg1;	// IMP=0x0010000000863fb3
- (void)_fillSubmissionParameters:(id)arg1;	// IMP=0x0010000000863dfd
- (_Bool)isComplete;	// IMP=0x0010000000863dca
@property(readonly, nonatomic) RAPCommentQuestion *commentQuestion; // @synthesize commentQuestion=_commentQuestion;
- (int)closureTypeAction;	// IMP=0x0010000000863c3a
- (void)_captureAnalytics;	// IMP=0x0010000000863bc6
