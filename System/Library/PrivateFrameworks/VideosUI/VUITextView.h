...
- (id)_defaultParagraphStyle;	// IMP=0x0000000000226d41
- (void)setVuiBackgroundColor:(id)arg1;	// IMP=0x0000000000226d2f
- (struct CGSize)vui_sizeThatFits:(struct CGSize)arg1;	// IMP=0x0000000000226d00
