...
- (void).cxx_destruct;	// IMP=0x0020000000a77805
...
- (void)_updateViews;	// IMP=0x0010000000a774a2
- (void)setHighlighted:(_Bool)arg1;	// IMP=0x0010000000a77400
- (void)setSelected:(_Bool)arg1;	// IMP=0x0010000000a77379
- (void)didMoveToWindow;	// IMP=0x0010000000a7730b
- (void)_setupConstraints;	// IMP=0x0010000000a76e82
- (id)initWithTransportType:(long long)arg1;	// IMP=0x0010000000a76618
