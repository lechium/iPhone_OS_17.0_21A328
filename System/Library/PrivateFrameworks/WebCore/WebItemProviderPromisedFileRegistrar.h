...
- (id).cxx_construct;	// IMP=0x000000000287e7c0
- (void).cxx_destruct;	// IMP=0x000000000287e780
@property(readonly, copy) NSString *description;
@property(readonly, nonatomic) NSString *typeIdentifier;
- (void)registerItemProvider:(id)arg1;	// IMP=0x000000000287e5c0
- (id)initWithType:(id)arg1 callback:(CDUnknownBlockType)arg2;	// IMP=0x000000000287e520
