...
- (void).cxx_destruct;	// IMP=0x00000000013f4ae3
...
- (void)animationCompleted;	// IMP=0x00000000013f49a7
- (void)animationStarted;	// IMP=0x00000000013f496e
- (id)positionedPasteResult;	// IMP=0x00000000013f487c
