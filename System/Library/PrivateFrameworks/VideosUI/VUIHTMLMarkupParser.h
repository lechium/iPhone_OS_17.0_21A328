...
+ (void)initialize;	// IMP=0x0060000000199187
- (void).cxx_destruct;	// IMP=0x00000000001999a9
...
- (void)parse;	// IMP=0x000000000019942f
- (void)reportParseError:(struct _xmlError *)arg1;	// IMP=0x00000000001992f1
- (void)reportErrorWithCode:(unsigned long long)arg1 userInfo:(id)arg2;	// IMP=0x000000000019926c
- (id)init;	// IMP=0x0000000000199241
- (id)initWithString:(id)arg1;	// IMP=0x00000000001991ce
