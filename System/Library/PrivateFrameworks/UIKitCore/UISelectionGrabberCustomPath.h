...
- (id)bezierPathForHostView:(id)arg1 targetView:(id)arg2;	// IMP=0x00000000013abfd3
- (id)description;	// IMP=0x00000000013abf28
- (id)summaryDescription;	// IMP=0x00000000013abe7a
