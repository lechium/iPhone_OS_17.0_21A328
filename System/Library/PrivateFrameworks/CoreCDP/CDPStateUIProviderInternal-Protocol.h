...
@protocol CDPRecoveryKeyValidatorInternal, CDPRemoteDeviceSecretValidatorProtocol, CDPRemoteDeviceSecretValidatorProtocolInternal;
...
- (void)cdpContext:(CDPContext *)arg1 presentRemoteApprovalWithCompletion:(void (^)(_Bool, NSError *))arg2;
