...
- (void)computeOnCPUWithInputTensors:(id)arg1 outputTensors:(id)arg2;	// IMP=0x00000000000ecd3a
- (id)computeDynamicOutputShape:(id)arg1;	// IMP=0x00000000000eca59
- (_Bool)hasDynamicOutputShape:(unsigned long long)arg1;	// IMP=0x00000000000eca4c
- (_Bool)hasGPUSupport;	// IMP=0x00000000000eca44
- (id)initWithParameters:(id)arg1;	// IMP=0x00000000000ec7b6
- (id)setupForInputShapes:(id)arg1 withParameters:(id)arg2;	// IMP=0x00000000000ec67f
