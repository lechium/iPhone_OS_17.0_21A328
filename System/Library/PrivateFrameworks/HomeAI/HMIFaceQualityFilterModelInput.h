...
- (void).cxx_destruct;	// IMP=0x000000000001bc3b
...
- (id)featureValueForName:(id)arg1;	// IMP=0x000000000001bb40
@property(readonly, nonatomic) NSSet *featureNames;
- (id)initWithInput:(id)arg1 inputName:(id)arg2;	// IMP=0x000000000001b9e8
