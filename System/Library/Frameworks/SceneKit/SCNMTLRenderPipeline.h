...
- (void)_computeUsageForArguments:(id)arg1 function:(id)arg2;	// IMP=0x000000000011f565
- (_Bool)matchesRenderPassDescriptor:(id)arg1;	// IMP=0x000000000011f402
- (id)description;	// IMP=0x000000000011ed14
- (void)dealloc;	// IMP=0x000000000011ec7e
- (id)init;	// IMP=0x000000000011ec44
