...
- (void).cxx_destruct;	// IMP=0x00000000015bc8d9
...
- (void)performWithoutLock:(CDUnknownBlockType)arg1;	// IMP=0x00000000015bc873
- (void)performWithLock:(CDUnknownBlockType)arg1;	// IMP=0x00000000015bc7ce
- (void)setCompletionCallback:(CDUnknownBlockType)arg1;	// IMP=0x00000000015bc7a9
- (void)performCompletionCallbackFinished:(_Bool)arg1;	// IMP=0x00000000015bc759
@property(nonatomic) _Bool invalidated;
- (id)initWithAnimation:(id)arg1 completion:(CDUnknownBlockType)arg2 composer:(id)arg3;	// IMP=0x00000000015bc662
