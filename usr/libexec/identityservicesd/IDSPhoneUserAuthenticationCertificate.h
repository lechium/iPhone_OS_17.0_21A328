...
- (void).cxx_destruct;	// IMP=0x0020000000422949
...
- (id)description;	// IMP=0x001000000042287f
- (id)initWithPhoneUser:(id)arg1 authenticationCertificate:(id)arg2;	// IMP=0x00100000004227e6
