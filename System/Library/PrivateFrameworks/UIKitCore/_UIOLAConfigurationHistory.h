...
- (void).cxx_destruct;	// IMP=0x000000000156765d
...
- (double)customSpacingAfterItem:(id)arg1;	// IMP=0x00000000015674e0
- (void)setCustomSpacing:(double)arg1 afterItem:(id)arg2;	// IMP=0x0000000001567419
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000015672e3
