...
+ (id)options;	// IMP=0x002000000009ec58
- (void).cxx_destruct;	// IMP=0x002000000009fc1c
...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000009fa77
- (unsigned long long)hash;	// IMP=0x001000000009f98a
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000009f7fb
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000009f6b9
- (void)copyTo:(id)arg1;	// IMP=0x001000000009f5c3
- (void)writeTo:(id)arg1;	// IMP=0x001000000009f4b9
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000009f4ac
- (id)dictionaryRepresentation;	// IMP=0x001000000009eeba
- (id)description;	// IMP=0x001000000009ee0b
