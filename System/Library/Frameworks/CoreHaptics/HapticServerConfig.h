...
- (id).cxx_construct;	// IMP=0x00000000000081a2
- (void).cxx_destruct;	// IMP=0x000000000000814f
...
- (id)initWithHapticPlayer:(id)arg1 withOptions:(id)arg2 error:(id *)arg3;	// IMP=0x0000000000005e7c
