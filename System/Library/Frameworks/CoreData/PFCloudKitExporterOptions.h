...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000027cb47
- (id)copy;	// IMP=0x000000000027cafe
- (void)dealloc;	// IMP=0x000000000027caa5
- (id)initWithDatabase:(id)arg1 options:(id)arg2;	// IMP=0x000000000027ca2c
