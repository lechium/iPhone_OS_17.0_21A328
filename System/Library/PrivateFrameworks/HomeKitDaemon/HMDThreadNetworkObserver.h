...
+ (id)supportedEventClasses;	// IMP=0x00100000009d97d5
- (void).cxx_destruct;	// IMP=0x00000000009d942c
...
- (void)_injectThreadNetworkStateForTestingWithNumAdvertisedBRs:(unsigned long long)arg1 numAppleBRs:(unsigned long long)arg2 numThirdPartyBRs:(unsigned long long)arg3 numThreadNetworks:(unsigned long long)arg4 maxSimuIPPrefixesDetected:(unsigned long long)arg5 txTotal:(unsigned long long)arg6 txSuccess:(unsigned long long)arg7 txDelayAvg:(unsigned long long)arg8 rxTotal:(unsigned long long)arg9 rxSuccess:(unsigned long long)arg10 reportDuration:(unsigned long long)arg11 reportDate:(id)arg12 reportDailySummary:(_Bool)arg13;	// IMP=0x00000000009d9075
- (void)requestThreadNetworkStateCaptureForAccessory:(id)arg1 failingScenario:(int)arg2;	// IMP=0x00000000009d906f
- (void)generateLogForPeriodicReport:(id)arg1;	// IMP=0x00000000009d9069
- (void)deleteCountersAfterDate:(id)arg1;	// IMP=0x00000000009d8fae
- (void)deleteCountersBeforeDate:(id)arg1;	// IMP=0x00000000009d8ef3
- (id)_keyOfLargestCountInHistogram:(id)arg1;	// IMP=0x00000000009d8dbd
- (void)_incrementError:(id)arg1 forHistogram:(id)arg2 byValue:(unsigned long long)arg3;	// IMP=0x00000000009d8cdd
- (void)_updateDailyCountersAndResetCurrentReportStatsForHomeWithUUID:(id)arg1 associatedWithDate:(id)arg2;	// IMP=0x00000000009d830d
- (id)logEventForHomeWithUUID:(id)arg1 associatedWithDate:(id)arg2 isDailySummary:(_Bool)arg3;	// IMP=0x00000000009d7b62
- (void)_runLoggingForDate:(id)arg1 isDailySummary:(_Bool)arg2;	// IMP=0x00000000009d7991
- (void)runDailyTask;	// IMP=0x00000000009d790d
- (void)didReceiveEventFromDispatcher:(id)arg1;	// IMP=0x00000000009d7844
- (void)_handleAccessorySessionEvent:(id)arg1;	// IMP=0x00000000009d76be
- (void)_handleReadWriteLogEvent:(id)arg1;	// IMP=0x00000000009d751b
- (id)counterGroupForName:(id)arg1 homeUUID:(id)arg2 date:(id)arg3;	// IMP=0x00000000009d7434
- (void)stop;	// IMP=0x00000000009d7358
- (void)start;	// IMP=0x00000000009d7201
- (void)_setDailyScheduler:(id)arg1;	// IMP=0x00000000009d71da
- (id)initWithLogEventDispatcher:(id)arg1 countersManager:(id)arg2 dailyScheduler:(id)arg3 currentHomeDataSource:(id)arg4 dateProvider:(id)arg5 notificationCenter:(id)arg6;	// IMP=0x00000000009d7035
- (id)initWithLogEventDispatcher:(id)arg1 countersManager:(id)arg2 dailyScheduler:(id)arg3 currentHomeDataSource:(id)arg4 dateProvider:(id)arg5;	// IMP=0x00000000009d6f3f
