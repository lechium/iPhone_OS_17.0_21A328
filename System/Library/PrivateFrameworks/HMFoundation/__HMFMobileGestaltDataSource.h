...
- (_Bool)shouldFetchProtectedKey:(id)arg1;	// IMP=0x000000000002f0d8
- (_Bool)shouldFetchUserAssignedDeviceName;	// IMP=0x000000000002f030
- (void)dealloc;	// IMP=0x000000000002efe9
