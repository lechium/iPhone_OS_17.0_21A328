...
- (void)getCPLConfigrationValueForKey:(NSString *)arg1 reply:(void (^)(NSDictionary *))arg2;
...
- (void)refreshLibraryScopeWithIdentifier:(NSString *)arg1 reply:(void (^)(CPLScopeChange *, NSError *))arg2;
...
- (void)isReadyForAnalysisQuickCheckWithReply:(void (^)(_Bool))arg1;
