...
+ (id)translatorForKeyPaths:(id)arg1 valueTransformFunction:(CDUnknownFunctionPointerType)arg2;	// IMP=0x00100000001aba3c
+ (id)translatorForKeyPaths:(id)arg1 valueTransformBlock:(CDUnknownBlockType)arg2;	// IMP=0x00100000001ab9aa
- (void).cxx_destruct;	// IMP=0x00000000001ab982
...
- (id)valueFromSource:(id)arg1 context:(id)arg2;	// IMP=0x00000000001ab930
