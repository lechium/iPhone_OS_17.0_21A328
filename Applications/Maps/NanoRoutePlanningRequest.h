...
+ (_Bool)supportsSecureCoding;	// IMP=0x002000000069d81b
+ (id)requestForPlaceholderDirections;	// IMP=0x001000000069d403
+ (id)requestForDirectionsWithCompanionRouteDetails:(id)arg1 companionRouteContext:(id)arg2;	// IMP=0x001000000069d288
+ (id)requestWithWaypoints:(id)arg1 viaTransportType:(unsigned long long)arg2 traits:(id)arg3 companionRouteContext:(id)arg4;	// IMP=0x001000000069d0fe
- (void).cxx_destruct;	// IMP=0x002000000069e5ea
...
- (id)debugDescription;	// IMP=0x001000000069df2e
- (id)description;	// IMP=0x001000000069ddfe
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000069dc05
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000069d823
- (void)_populateCopy:(id)arg1;	// IMP=0x001000000069d755
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000069d721
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000069d6ed
- (id)snapshot;	// IMP=0x001000000069d66b
...
- (id)requestedCompanionRouteDetails;	// IMP=0x001000000069d454
- (id)init;	// IMP=0x001000000069cff5
