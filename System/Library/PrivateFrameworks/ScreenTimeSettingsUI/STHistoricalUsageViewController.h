...
+ (id)historicalUsageViewControllerOfType:(unsigned long long)arg1 graphHeight:(double)arg2;	// IMP=0x0010000000065184
...
- (id)_dataSetFromUsageReport:(id)arg1;	// IMP=0x0000000000067436
- (id)_dayGraphViewControllerForDay:(unsigned long long)arg1 week:(unsigned long long)arg2 usageReport:(id)arg3;	// IMP=0x0000000000067220
- (id)_weekGraphViewControllerForWeek:(unsigned long long)arg1 usageReport:(id)arg2;	// IMP=0x0000000000066fbc
- (void)pageViewController:(id)arg1 didFinishAnimating:(_Bool)arg2 previousViewControllers:(id)arg3 transitionCompleted:(_Bool)arg4;	// IMP=0x0000000000066ca2
- (void)pageViewController:(id)arg1 willTransitionToViewControllers:(id)arg2;	// IMP=0x0000000000066ad4
- (id)_nextGraphViewControllerForPageViewController:(id)arg1 currentGraphViewController:(id)arg2 direction:(long long)arg3;	// IMP=0x0000000000066613
- (id)pageViewController:(id)arg1 viewControllerAfterViewController:(id)arg2;	// IMP=0x0000000000066510
- (id)pageViewController:(id)arg1 viewControllerBeforeViewController:(id)arg2;	// IMP=0x000000000006640a
- (void)_selectedBarViewDidChangeFrom:(id)arg1 to:(id)arg2;	// IMP=0x0000000000066261
- (void)_selectedDayUsageReportDidChangeFrom:(id)arg1 to:(id)arg2;	// IMP=0x0000000000065e8a
- (void)_selectedWeekUsageReportDidChange:(id)arg1;	// IMP=0x0000000000065ba5
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x000000000006583a
- (void)prepareForSegue:(id)arg1 sender:(id)arg2;	// IMP=0x000000000006545a
- (void)viewDidLoad;	// IMP=0x00000000000652ed
- (void)dealloc;	// IMP=0x0000000000065244
