...
- (void).cxx_destruct;	// IMP=0x00200000000052df
...
- (void)reloadAccountState:(_Bool)arg1;	// IMP=0x00100000000041da
- (void)debouncer:(id)arg1 didDebounce:(id)arg2;	// IMP=0x00100000000041c6
- (id)initWithDelegate:(id)arg1;	// IMP=0x0010000000003a13
- (void)dealloc;	// IMP=0x0010000000003995
