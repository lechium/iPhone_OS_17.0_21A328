...
+ (id)logCategory;	// IMP=0x00100000005a259a
- (void).cxx_destruct;	// IMP=0x00000000005a2547
...
- (void)authenticate;	// IMP=0x00000000005a245b
- (id)logIdentifier;	// IMP=0x00000000005a2449
- (id)initWithSessionID:(id)arg1 remoteDevice:(id)arg2 workQueue:(id)arg3 remoteMessageSender:(id)arg4;	// IMP=0x00000000005a234c
