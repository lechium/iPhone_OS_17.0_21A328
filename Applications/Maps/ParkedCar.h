...
+ (id)title;	// IMP=0x00400000001f0e69
+ (id)personalizedItemKey;	// IMP=0x00100000001f0877
- (void).cxx_destruct;	// IMP=0x00200000001f118f
...
- (void)updateFromVehicleEvent:(id)arg1 geoMapItem:(id)arg2;	// IMP=0x00100000001f09fa
- (id)initWithCoordinate:(struct CLLocationCoordinate2D)arg1;	// IMP=0x00100000001f0945
- (id)initWithVehicleEvent:(id)arg1 geoMapItem:(id)arg2;	// IMP=0x00100000001f0892
- (id)init;	// IMP=0x00100000001f0884
