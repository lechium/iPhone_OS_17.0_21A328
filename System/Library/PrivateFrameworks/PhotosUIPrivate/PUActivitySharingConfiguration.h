...
@interface PUActivitySharingConfiguration : NSObject
{
    ...
    PHFetchResult *_initialAssetsFetchResult;	// 104 = 0x68
}

- (void).cxx_destruct;	// IMP=0x000000000011380f
...
- (id)initWithCollectionsFetchResult:(id)arg1 selectionManager:(id)arg2;	// IMP=0x000000000011351d
