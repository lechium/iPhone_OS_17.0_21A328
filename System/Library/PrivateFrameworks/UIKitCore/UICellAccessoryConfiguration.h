...
- (void).cxx_destruct;	// IMP=0x0000000001247c38
...
- (_Bool)alwaysNeedsLayout;	// IMP=0x0000000001247c0f
- (id)description;	// IMP=0x00000000012478f6
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000012476ff
- (id)init;	// IMP=0x000000000124769c
