...
+ (_Bool)_hasRequiredTelephonyEntitlement;	// IMP=0x00100000000b15bf
+ (_Bool)_hasCellularTelephonyCapability;	// IMP=0x00100000000b15ae
- (void).cxx_destruct;	// IMP=0x00000000000b24b2
...
- (void)phoneNumberChanged:(id)arg1;	// IMP=0x00000000000b23dc
- (void)phoneNumberAvailable:(id)arg1;	// IMP=0x00000000000b2390
- (void)operatorNameChanged:(id)arg1 name:(id)arg2;	// IMP=0x00000000000b2344
- (id)formattedPhoneNumber:(id)arg1;	// IMP=0x00000000000b232f
...
- (void)invalidate;	// IMP=0x00000000000b159a
- (void)dealloc;	// IMP=0x00000000000b1556
- (id)initWithDelegate:(id)arg1;	// IMP=0x00000000000b1009
- (id)init;	// IMP=0x00000000000b0ff5
