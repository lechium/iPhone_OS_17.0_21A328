...
- (void).cxx_destruct;	// IMP=0x00000000000b4f6e
- (id)_termsButton;	// IMP=0x00000000000b4cc7
- (id)_newLightLabelWithSize:(double)arg1 alpha:(double)arg2;	// IMP=0x00000000000b4bad
- (id)_newBoldLabelWithSize:(double)arg1;	// IMP=0x00000000000b4abf
- (void)layoutSubviews;	// IMP=0x00000000000b3240
@property(readonly, nonatomic) UIButton *termsButton;
- (id)initWithGift:(id)arg1 configuration:(id)arg2;	// IMP=0x00000000000b1e71
