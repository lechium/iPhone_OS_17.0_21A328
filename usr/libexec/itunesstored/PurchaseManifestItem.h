...
- (void)_setValue:(id)arg1 forKey:(id)arg2;	// IMP=0x001000000000fa4a
...
- (void)dealloc;	// IMP=0x001000000000f901
- (id)initWithManifestItemDictionary:(id)arg1;	// IMP=0x001000000000f8aa
