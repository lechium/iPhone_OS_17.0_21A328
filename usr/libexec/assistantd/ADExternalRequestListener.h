...
- (void).cxx_destruct;	// IMP=0x002000000010f0a6
- (void)listen;	// IMP=0x001000000010f019
- (id)initWithInstanceContext:(id)arg1;	// IMP=0x001000000010ef8a
- (id)init;	// IMP=0x001000000010ef30
