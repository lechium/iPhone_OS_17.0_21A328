...
- (void).cxx_destruct;	// IMP=0x00200000001e641d
...
- (id)timeout:(unsigned long long)arg1;	// IMP=0x00100000001e62c3
- (id)_onqueueStart;	// IMP=0x00100000001e623e
- (id)description;	// IMP=0x00100000001e6174
- (id)init:(id)arg1 sourceStates:(id)arg2 serialQueue:(id)arg3 timeout:(unsigned long long)arg4 transitionOp:(id)arg5;	// IMP=0x00100000001e6071
