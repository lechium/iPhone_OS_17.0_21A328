...
+ (id)sharedServer;	// IMP=0x002000000007b7cf
- (void).cxx_destruct;	// IMP=0x002000000007ba60
...
- (void)invalidate;	// IMP=0x001000000007b937
- (void)run;	// IMP=0x001000000007b824
- (id)init;	// IMP=0x001000000007b4c9
