...
@interface _TtC7NewsUI233ANFEmbedScrollAdsDisabledTestCase : NSObject
{
...
- (id)init;	// IMP=0x0000000000282780
- (id)scrollViewWithContext:(id)arg1;	// IMP=0x0000000000282620
