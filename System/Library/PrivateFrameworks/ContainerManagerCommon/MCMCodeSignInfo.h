...
- (void).cxx_destruct;	// IMP=0x0000000000012d97
...
- (id)initWithAuditToken:(CDStruct_4c969caf)arg1;	// IMP=0x00000000000129f2
- (id)initWithURL:(id)arg1 error:(unsigned long long *)arg2;	// IMP=0x0000000000012984
