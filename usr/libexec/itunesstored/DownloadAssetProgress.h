...
- (void).cxx_destruct;	// IMP=0x00200000001e1abd
...
- (id)_newProgressForMediaSelection:(id)arg1;	// IMP=0x00100000001e1953
- (void)setMediaSelectionDidComplete:(id)arg1;	// IMP=0x00100000001e1949
- (void)setProgress:(double)arg1 forMediaSelection:(id)arg2;	// IMP=0x00100000001e17bc
@property(readonly, nonatomic) double progress;
- (id)init;	// IMP=0x00100000001e1740
