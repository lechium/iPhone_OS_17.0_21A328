...
- (void).cxx_destruct;	// IMP=0x00000000000f9366
...
- (_Bool)_isFixedWidth;	// IMP=0x00000000000f9324
- (void)_updateConstantSizedConstraints;	// IMP=0x00000000000f9275
- (void)separatorViewDidUpdateConstraints;	// IMP=0x00000000000f9263
@property(nonatomic) double constantAxisDimension; // @synthesize constantAxisDimension=_constantAxisDimension;
- (id)initWithSeparatorView:(id)arg1;	// IMP=0x00000000000f8f52
