...
+ (id)readOpaqueTokenFromBuffer:(const char *)arg1;	// IMP=0x00600000000f7d0e
+ (id)readTokenFromBuffer:(const char *)arg1;	// IMP=0x00600000000f7cf3
+ (id)readTokenFromBuffer:(const char *)arg1 opaque:(_Bool)arg2;	// IMP=0x00600000000f7bb5
...
- (id)description;	// IMP=0x00000000000f7d2c
- (id)_initWithID:(unsigned long long)arg1 class:(unsigned char)arg2 length:(unsigned long long)arg3 content:(const char *)arg4 opaque:(_Bool)arg5;	// IMP=0x00000000000f7b57
