...
- (void).cxx_destruct;	// IMP=0x00000000001b304b
...
- (void)computeOnCPUWithInputTensors:(id)arg1 outputTensors:(id)arg2;	// IMP=0x00000000001b2e59
- (_Bool)hasGPUSupport;	// IMP=0x00000000001b2e51
- (id)initWithParameters:(id)arg1;	// IMP=0x00000000001b2d18
- (id)setupForInputShapes:(id)arg1 withParameters:(id)arg2;	// IMP=0x00000000001b2c6f
