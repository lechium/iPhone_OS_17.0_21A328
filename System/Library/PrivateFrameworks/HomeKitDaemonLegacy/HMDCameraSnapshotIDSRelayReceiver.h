...
+ (id)logCategory;	// IMP=0x0010000000acea91
- (void).cxx_destruct;	// IMP=0x0000000000ace791
...
- (void)sessionEnded:(id)arg1 withReason:(unsigned int)arg2 error:(id)arg3;	// IMP=0x0000000000ace50c
- (void)sessionStarted:(id)arg1;	// IMP=0x0000000000ace392
- (void)service:(id)arg1 account:(id)arg2 inviteReceivedForSession:(id)arg3 fromID:(id)arg4 withContext:(id)arg5;	// IMP=0x0000000000acda26
- (void)_didReceiveData:(id)arg1 error:(id)arg2;	// IMP=0x0000000000acd8dd
- (void)dealloc;	// IMP=0x0000000000acd774
- (void)_handleDataFromSocket:(id)arg1;	// IMP=0x0000000000acd03b
- (void)_startDataReceive;	// IMP=0x0000000000acce9c
- (id)logIdentifier;	// IMP=0x0000000000acce4c
- (id)initWithSessionID:(id)arg1 logIdentifier:(id)arg2 machOUUID:(id)arg3 workQueue:(id)arg4 sessionInviterDeviceVerifier:(id)arg5 delegate:(id)arg6;	// IMP=0x0000000000accc3e
