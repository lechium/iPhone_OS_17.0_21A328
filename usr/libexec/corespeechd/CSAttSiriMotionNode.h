...
- (void).cxx_destruct;	// IMP=0x00200000000e0bf2
...
- (void);	// IMP=0x00100000000e0b73
- (void)addReceiver:(id)arg1;	// IMP=0x00100000000e0b6d
- (void)stop;	// IMP=0x00100000000e0b67
- (void)pause;	// IMP=0x00100000000e0b61
- (void)start;	// IMP=0x00100000000e0b5b
- (id)initWithAttSiriController:(id)arg1;	// IMP=0x00100000000e0b4d
