...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000009eed50
- (unsigned long long)hash;	// IMP=0x00100000009eec82
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000009eeb89
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000009eea9c
- (void)copyTo:(id)arg1;	// IMP=0x00100000009ee9f9
- (void)writeTo:(id)arg1;	// IMP=0x00100000009ee911
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000009ee904
- (id)dictionaryRepresentation;	// IMP=0x00100000009ee27a
- (id)description;	// IMP=0x00100000009ee203
@property(nonatomic) _Bool hasPsc;
@property(nonatomic) _Bool hasArfcn;
@property(readonly, nonatomic) _Bool hasLocation;
- (void)dealloc;	// IMP=0x00100000009ee120
