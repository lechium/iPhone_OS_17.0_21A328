...
- (void).cxx_destruct;	// IMP=0x0000000000080654
...
- (void)drawRect:(struct CGRect)arg1;	// IMP=0x00000000000803f5
- (id)initWithFrame:(struct CGRect)arg1 shadowImage:(id)arg2;	// IMP=0x0000000000080365
