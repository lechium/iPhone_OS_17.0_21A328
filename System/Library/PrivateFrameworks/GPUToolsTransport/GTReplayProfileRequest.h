...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000006821
- (void).cxx_destruct;	// IMP=0x0000000000006a67
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000006924
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000006829
