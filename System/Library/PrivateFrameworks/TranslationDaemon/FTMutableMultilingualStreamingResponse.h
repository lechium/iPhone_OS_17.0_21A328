...
+ (long long)content_typeForObject:(id)arg1;	// IMP=0x0060000000193e0e
+ (long long)content_typeForMutableObject:(id)arg1;	// IMP=0x0060000000193cdc
+ (Class)content_mutableClassForType:(long long)arg1;	// IMP=0x0060000000193ca2
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000193479
- (id)init;	// IMP=0x00000000001933eb
