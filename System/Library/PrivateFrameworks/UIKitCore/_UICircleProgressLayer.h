...
+ (_Bool)needsDisplayForKey:(id)arg1;	// IMP=0x0060000000658693
- (void).cxx_destruct;	// IMP=0x0000000000658a0c
...
- (void)drawInContext:(struct CGContext *)arg1;	// IMP=0x0000000000658708
- (id)initWithLayer:(id)arg1;	// IMP=0x00000000006584c3
- (id)init;	// IMP=0x0000000000658389
