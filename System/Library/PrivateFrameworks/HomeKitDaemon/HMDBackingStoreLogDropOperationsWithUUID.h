...
- (void).cxx_destruct;	// IMP=0x000000000093015f
...
- (id)mainReturningError;	// IMP=0x000000000092fb4b
- (id)initWithUUID:(id)arg1 pushingTo:(unsigned long long)arg2 resultBlock:(CDUnknownBlockType)arg3;	// IMP=0x000000000092faa3
