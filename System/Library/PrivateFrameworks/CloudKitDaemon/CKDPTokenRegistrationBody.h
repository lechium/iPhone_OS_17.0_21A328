...
- (void).cxx_destruct;	// IMP=0x000000000018e099
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000018df9f
- (unsigned long long)hash;	// IMP=0x000000000018df01
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000018ddea
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000018dd0f
- (void)copyTo:(id)arg1;	// IMP=0x000000000018dc6f
- (void)writeTo:(id)arg1;	// IMP=0x000000000018dbc1
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000018dbb4
- (id)dictionaryRepresentation;	// IMP=0x000000000018d7ac
- (id)description;	// IMP=0x000000000018d6fd
@property(nonatomic) _Bool hasSkipBundleIDCheck;
- (int)StringAsApnsEnv:(id)arg1;	// IMP=0x000000000018d64f
- (id)apnsEnvAsString:(int)arg1;	// IMP=0x000000000018d5fa
