...
- (void).cxx_destruct;	// IMP=0x000000000001070b
...
- (long long)_libraryAddStatusFromUnderlyingStatus:(long long)arg1;	// IMP=0x00000000000106d4
- (void)_handleUpdatedUnderlyingLibraryAddStatus:(long long)arg1;	// IMP=0x000000000001069f
@property(readonly, nonatomic) long long currentStatus;
- (id)initWithIdentifyingModelObject:(id)arg1;	// IMP=0x0000000000010284
