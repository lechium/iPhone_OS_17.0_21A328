...
- (void).cxx_destruct;	// IMP=0x0020000000095d40
...
- (void)animateTransition:(id)arg1;	// IMP=0x001000000009518a
- (double)transitionDuration:(id)arg1;	// IMP=0x001000000009513a
- (id)initWithModel:(id)arg1 paletteView:(id)arg2 reverse:(_Bool)arg3;	// IMP=0x0010000000095055
