...
- (void).cxx_destruct;	// IMP=0x0000000000110334
...
- (struct CGSize)_calculateMetricsOfScorecard;	// IMP=0x000000000010fa2c
- (void)drawRect:(struct CGRect)arg1;	// IMP=0x000000000010f213
- (void)_calculateColumnSpacing;	// IMP=0x000000000010ef67
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x000000000010ef28
- (void)invalidateData;	// IMP=0x000000000010eec0
