...
- (void).cxx_destruct;	// IMP=0x0000000000035cb0
...
- (void)_didDetermineFileSize:(id)arg1 fileTypeString:(id)arg2;	// IMP=0x0000000000035b32
- (void)_didGenerateThumbnail:(id)arg1;	// IMP=0x0000000000035a74
- (void)_finishIfNeeded;	// IMP=0x0000000000035a46
- (void)main;	// IMP=0x0000000000035809
- (id)initWithListCell:(id)arg1 index:(unsigned long long)arg2 item:(id)arg3 delegate:(id)arg4;	// IMP=0x0000000000035724
