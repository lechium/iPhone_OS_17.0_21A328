...
+ (id)sentinelParentUUID;	// IMP=0x00400000007a5ed0
+ (id)hmbProperties;	// IMP=0x00400000007a5ea0
- (id)createPerson;	// IMP=0x00000000007a6530
- (id)initWithPerson:(id)arg1;	// IMP=0x00000000007a641b
