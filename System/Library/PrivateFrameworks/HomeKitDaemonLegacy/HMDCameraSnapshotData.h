...
- (void).cxx_destruct;	// IMP=0x00000000006c9495
...
- (void)dealloc;	// IMP=0x00000000006c9409
- (id)initWithSnapshotFile:(id)arg1 videoResolution:(id)arg2;	// IMP=0x00000000006c9325
- (id)initWithSnapshotData:(id)arg1 videoResolution:(id)arg2 snapshotDataTrasaction:(id)arg3;	// IMP=0x00000000006c925b
