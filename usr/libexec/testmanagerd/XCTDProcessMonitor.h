...
+ (id)processStateDescriptor;	// IMP=0x0020000000021c13
+ (id)predicatesForBundleIDs:(id)arg1;	// IMP=0x0010000000021a46
+ (id)stateSnapshotFromRBSState:(id)arg1 forRBSBundle:(id)arg2 pid:(int)arg3;	// IMP=0x0010000000021775
- (void).cxx_destruct;	// IMP=0x0020000000022e77
...
- (id)bundleIDForPID:(int)arg1 error:(id *)arg2;	// IMP=0x0010000000022d5f
- (id)processSpecifierForPID:(int)arg1 error:(id *)arg2;	// IMP=0x0010000000022d13
- (void)startMonitoringApplicationWithBundleID:(id)arg1 path:(id)arg2;	// IMP=0x0010000000021cb1
- (void)guardIsValid:(CDUnknownBlockType)arg1;	// IMP=0x0010000000021700
- (void)invalidate;	// IMP=0x0010000000021611
- (id)initWithDelegate:(id)arg1;	// IMP=0x001000000002159e
- (id)initWithDelegate:(id)arg1 processMonitor:(id)arg2 processHandleClass:(Class)arg3;	// IMP=0x0010000000021498
