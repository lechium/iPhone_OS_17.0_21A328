...
- (void).cxx_destruct;	// IMP=0x00000000000bfe0a
...
- (id)_parseCDADate:(id)arg1;	// IMP=0x00000000000bfc31
- (id)_personNameFrom:(id)arg1 familyTagRule:(id)arg2 givenTagRule:(id)arg3 nilOnFail:(_Bool)arg4;	// IMP=0x00000000000bfa2f
- (id)_firstFrom:(id)arg1 tagRule:(id)arg2 nilOnFail:(_Bool)arg3;	// IMP=0x00000000000bf98f
- (void)extractHeaderFieldsFromDocumentData:(id)arg1;	// IMP=0x00000000000bf6cd
- (id)initWithDocumentData:(id)arg1;	// IMP=0x00000000000bf665
