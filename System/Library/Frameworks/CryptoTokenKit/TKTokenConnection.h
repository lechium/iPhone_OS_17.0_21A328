...
- (void).cxx_destruct;	// IMP=0x000000000002dd99
...
- (void)dealloc;	// IMP=0x000000000002dce4
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x000000000002dc21
- (void)invalidate;	// IMP=0x000000000002dc0b
- (id)initWithToken:(id)arg1;	// IMP=0x000000000002dac0
