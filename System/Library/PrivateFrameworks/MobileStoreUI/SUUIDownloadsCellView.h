...
@interface SUUIDownloadsCellView : UIView
{
...
- (void).cxx_destruct;	// IMP=0x0000000000254da5
...
- (void)layoutSubviews;	// IMP=0x0000000000254793
- (void)setBackgroundColor:(id)arg1;	// IMP=0x00000000002546df
@property(nonatomic) double progress;
@property(retain, nonatomic) UIImage *image;
- (id)init;	// IMP=0x0000000000253e90
