...
+ (id)logCategory;	// IMP=0x0010000000285a9a
+ (_Bool)isRoleSupported:(long long)arg1;	// IMP=0x0010000000285a66
- (void).cxx_destruct;	// IMP=0x0000000000284bec
...
- (id)setupTrackingInfo;	// IMP=0x00000000002848de
@property(readonly, nonatomic) NSObject<OS_dispatch_queue> *messageReceiveQueue;
@property(readonly, nonatomic) NSUUID *messageTargetUUID;
- (id)logIdentifier;	// IMP=0x000000000028486a
- (void)_sendRequestData:(id)arg1;	// IMP=0x0000000000284646
- (void)_handleReceiveData:(id)arg1;	// IMP=0x00000000002845a9
- (void)close:(id)arg1;	// IMP=0x0000000000284446
- (void)_handleClose:(id)arg1;	// IMP=0x000000000028428f
- (void)_closeWithError:(id)arg1;	// IMP=0x0000000000283c50
- (void)open;	// IMP=0x0000000000283b7f
- (void)__registerForMessages;	// IMP=0x0000000000283a30
- (id)messageDispatcher;	// IMP=0x00000000002839e0
- (id)messageDestination;	// IMP=0x0000000000283977
@property(readonly) long long role;
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000283850
@property(readonly) unsigned long long hash;
- (id)initWithIdentifier:(id)arg1 role:(long long)arg2 homeManager:(id)arg3 upSecondsFactory:(CDUnknownBlockType)arg4;	// IMP=0x000000000028342f
- (id)initWithIdentifier:(id)arg1 role:(long long)arg2 homeManager:(id)arg3;	// IMP=0x0000000000283416
- (id)init;	// IMP=0x000000000028336e
