...
- (void).cxx_destruct;	// IMP=0x0000000000f35989
...
- (double)_touchForceFromTouches:(id)arg1;	// IMP=0x0000000000f35782
@property(readonly, nonatomic, getter=isDeepPressLikely) _Bool deepPressLikely;
- (void)analyzeTouchForce:(double)arg1 centroidAtLocation:(struct CGPoint)arg2;	// IMP=0x0000000000f355fc
- (void)analyzeTouches:(id)arg1;	// IMP=0x0000000000f35578
- (id)init;	// IMP=0x0000000000f354c6
