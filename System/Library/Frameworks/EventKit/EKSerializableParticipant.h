...
+ (id)classesForKey;	// IMP=0x0060000000011969
- (void).cxx_destruct;	// IMP=0x000000000001219d
...
- (id)createAttendee:(id *)arg1;	// IMP=0x0000000000011dcd
- (id)initWithParticipant:(id)arg1;	// IMP=0x0000000000011c4b
