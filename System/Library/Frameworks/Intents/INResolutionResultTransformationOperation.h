...
- (void).cxx_destruct;	// IMP=0x00000000001c850f
...
- (_Bool)isExecuting;	// IMP=0x00000000001c8499
- (_Bool)isFinished;	// IMP=0x00000000001c8489
- (void)start;	// IMP=0x00000000001c8395
- (id)initWithResult:(id)arg1 intent:(id)arg2 intentSlotDescription:(id)arg3 optionsProvider:(id)arg4;	// IMP=0x00000000001c8298
