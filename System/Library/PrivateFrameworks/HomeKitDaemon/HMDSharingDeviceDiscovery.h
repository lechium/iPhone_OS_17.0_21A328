...
- (void).cxx_destruct;	// IMP=0x000000000060eb15
@property(retain, nonatomic) SFDeviceDiscovery *deviceDiscovery; // @synthesize deviceDiscovery=_deviceDiscovery;
- (void)repairDevice:(id)arg1 flags:(unsigned int)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x000000000060ea35
- (void)stop;	// IMP=0x000000000060e9db
- (void)start;	// IMP=0x000000000060e997
...
- (void)dealloc;	// IMP=0x000000000060e4f0
