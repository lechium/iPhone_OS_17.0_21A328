...
- (void).cxx_destruct;	// IMP=0x00000000007c5995
- (id)firstFactoidForSemantic:(int)arg1;	// IMP=0x00000000007c5837
- (id)factoidAtIndex:(int)arg1;	// IMP=0x00000000007c5790
...
- (id)initWithPlaceData:(id)arg1 attributionMap:(id)arg2;	// IMP=0x00000000007c5200
