...
- (void).cxx_destruct;	// IMP=0x00000000004a79bd
...
- (void)_handleVideoPlayer:(id)arg1 didChange:(id)arg2;	// IMP=0x00000000004a7838
- (void)_handleViewModel:(id)arg1 didChange:(id)arg2;	// IMP=0x00000000004a77d0
- (void)viewModel:(id)arg1 didChange:(id)arg2;	// IMP=0x00000000004a7715
- (void)_updateCurrentPlaybackTimeAndDurationIfNeeded;	// IMP=0x00000000004a75ef
- (void)_invalidateCurrentPlaybackTimeAndDuration;	// IMP=0x00000000004a75bc
- (void)_updateAVPlayerIfNeeded;	// IMP=0x00000000004a7512
- (void)_invalidateAVPlayer;	// IMP=0x00000000004a74df
- (void)_updatePlayPauseStateIfNeeded;	// IMP=0x00000000004a7402
- (void)_invalidatePlayPauseState;	// IMP=0x00000000004a73cf
- (void)_updateVideoPlayerIfNeeded;	// IMP=0x00000000004a72e3
- (void)_invalidateVideoPlayer;	// IMP=0x00000000004a72b0
- (void)_setNeedsUpdate;	// IMP=0x00000000004a7204
- (_Bool)_needsUpdate;	// IMP=0x00000000004a71a3
- (void)_updateIfNeeded;	// IMP=0x00000000004a709b
- (void)_performChanges:(CDUnknownBlockType)arg1;	// IMP=0x00000000004a6fee
- (void)_assertInsideUpdate;	// IMP=0x00000000004a6f56
- (void)_assertInsideChangeBlock;	// IMP=0x00000000004a6ebe
- (void)_publishChanges;	// IMP=0x00000000004a6c4e
@property(readonly, nonatomic) PUPlayPauseBarItemsControllerChange *_currentChange; // @synthesize _currentChange=__currentChange;
- (void)_stopObservingAVPlayer;	// IMP=0x00000000004a69a1
- (void)_startObservingAVPlayer;	// IMP=0x00000000004a6795
- (void)unregisterChangeObserver:(id)arg1;	// IMP=0x00000000004a6497
- (void)registerChangeObserver:(id)arg1;	// IMP=0x00000000004a63de
- (id)init;	// IMP=0x00000000004a6357
