...
- (void).cxx_destruct;	// IMP=0x000000000024af67
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000024aec5
- (unsigned long long)hash;	// IMP=0x000000000024aeaf
- (id)initWithShareID:(id)arg1 emptyRecord:(id)arg2;	// IMP=0x000000000024ae16
