...
- (void).cxx_destruct;	// IMP=0x0000000000063cd6
...
- (void)_notifyWithFunctionName:(id)arg1 eventName:(id)arg2 info:(id)arg3;	// IMP=0x00000000000636b3
- (void)_cancelCurrentRequestAndNotify:(_Bool)arg1;	// IMP=0x0000000000063510
- (void)setRequestHeader:(id)arg1:(id)arg2;	// IMP=0x00000000000632fb
- (id)getResponseHeader:(id)arg1;	// IMP=0x0000000000063213
- (id)getAllResponseHeaders;	// IMP=0x000000000006300c
- (void)abort;	// IMP=0x0000000000062ff8
- (void)send:(id)arg1;	// IMP=0x0000000000062907
- (void)open:(id)arg1:(id)arg2:(id)arg3:(id)arg4:(id)arg5;	// IMP=0x0000000000062759
- (id)initWithContext:(id)arg1;	// IMP=0x0000000000062715
- (id)init;	// IMP=0x0000000000062642
