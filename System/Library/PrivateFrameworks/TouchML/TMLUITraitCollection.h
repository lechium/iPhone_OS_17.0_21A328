...
+ (id)currentTraitCollection:(id)arg1;	// IMP=0x006000000002a2ca
+ (id)traitEnvironment:(id)arg1 willTransitionToTraitCollection:(id)arg2 fromPreviousTraitCollection:(id)arg3;	// IMP=0x0060000000029d2a
+ (id)defaultCollection;	// IMP=0x0060000000029672
- (void).cxx_destruct;	// IMP=0x000000000002a3ca
...
- (void)applyToTraitEnvironment:(id)arg1;	// IMP=0x0000000000029b7f
@property(readonly, nonatomic) UITraitCollection *traitCollection;
- (void)setTMLValue:(id)arg1 forKeyPath:(id)arg2;	// IMP=0x0000000000029735
- (void)tmlDispose;	// IMP=0x0000000000029603
- (id)init;	// IMP=0x0000000000029598
