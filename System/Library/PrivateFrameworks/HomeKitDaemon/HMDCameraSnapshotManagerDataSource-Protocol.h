...
@class HMDAccessory, HMDCameraResidentMessageHandler, HMDCameraSnapshotLocal, HMDCameraSnapshotRemoteRelayReceiver, HMDCameraSnapshotSessionID, HMDDevice, HMDSnapshotLocalSession, HMDSnapshotRequestHandler, HMFMessage, NSObject, NSUUID;
