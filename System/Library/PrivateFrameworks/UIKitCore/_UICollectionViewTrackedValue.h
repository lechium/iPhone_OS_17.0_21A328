...
- (void).cxx_destruct;	// IMP=0x0000000000475753
...
- (double)speed;	// IMP=0x0000000000475615
- (void)addValue:(double)arg1;	// IMP=0x0000000000475550
- (id)init;	// IMP=0x00000000004753ee
