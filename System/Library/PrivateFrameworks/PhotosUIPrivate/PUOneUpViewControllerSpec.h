...
- (void).cxx_destruct;	// IMP=0x000000000039248c
...
- (void)_setHideBadgesWhenShowingAccessoryView:(_Bool)arg1;	// IMP=0x00000000003920f3
- (void)_setHideStatusBarWhenShowingAccessoryView:(_Bool)arg1;	// IMP=0x0000000000392085
- (void)_setPrefersSquareImageInDetails:(_Bool)arg1;	// IMP=0x0000000000392017
- (void)_setHideScrubberWhenShowingAccessoryView:(_Bool)arg1;	// IMP=0x0000000000391fa9
- (void)_setHideNavigationBarWhenShowingAccessoryView:(_Bool)arg1;	// IMP=0x0000000000391f3b
- (void)_setShouldDisplaySyndicationAttribution:(_Bool)arg1;	// IMP=0x0000000000391ecd
- (void)_setRenderIndicatorSize:(struct CGSize)arg1;	// IMP=0x0000000000391aeb
- (void)_setShouldDisplayPeopleRow:(_Bool)arg1;	// IMP=0x000000000039169d
@property(readonly, nonatomic) struct CGSize playButtonSize;
- (void)updateIfNeeded;	// IMP=0x0000000000390a6c
...
- (id)spotlightBackgroundColor;	// IMP=0x00000000003907f1
@property(readonly, nonatomic) _Bool shouldUseSpotlightStyling;
- (_Bool)_shouldForceBlackBackground;	// IMP=0x00000000003907bf
...
- (_Bool)_isAssetExplorerReviewScreen;	// IMP=0x00000000003906f7
@property(readonly, nonatomic) PUOneUpViewControllerSpecChange *currentChange;
- (id)newSpecChange;	// IMP=0x00000000003906a8
- (id)initWithOptions:(unsigned long long)arg1;	// IMP=0x0000000000390648
