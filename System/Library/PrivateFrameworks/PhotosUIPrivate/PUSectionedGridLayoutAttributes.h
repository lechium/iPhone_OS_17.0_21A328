...
- (id)description;	// IMP=0x00000000005143ab
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000514297
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000005141f0
- (id)init;	// IMP=0x00000000005141ac
