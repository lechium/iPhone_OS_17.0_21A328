...
- (void).cxx_destruct;	// IMP=0x00000000006b14d1
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000006b12c4
- (unsigned long long)hash;	// IMP=0x00000000006b1173
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000006b0f3e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000006b0d95
- (void)copyTo:(id)arg1;	// IMP=0x00000000006b0c2e
- (void)writeTo:(id)arg1;	// IMP=0x00000000006b0a90
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000006b0390
- (id)dictionaryRepresentation;	// IMP=0x00000000006aff7c
- (id)description;	// IMP=0x00000000006afecd
...
- (int)StringAsOutcome:(id)arg1;	// IMP=0x00000000006afb30
- (id)outcomeAsString:(int)arg1;	// IMP=0x00000000006afae8
@property(nonatomic) _Bool hasOutcome;
@property(nonatomic) int outcome; // @synthesize outcome=_outcome;
@property(nonatomic) _Bool hasDuration;
- (int)StringAsActionType:(id)arg1;	// IMP=0x00000000006af8f6
- (id)actionTypeAsString:(int)arg1;	// IMP=0x00000000006af8ae
