...
- (void)_clearBuffers;	// IMP=0x0010000000b4cabf
- (unsigned long long)_removeAdditionalInconsistentSpeedPedometerEntries;	// IMP=0x0010000000b4c86f
- (void)_closeCurrentTrack;	// IMP=0x0010000000b4bbe7
- (void)_closeTrackCheckPedometer;	// IMP=0x0010000000b4aff0
- (void)_closeTrackCheckGpsOdometer;	// IMP=0x0010000000b4a623
- (void)_closeTrackCheckGpsLocationFiltered;	// IMP=0x0010000000b4a0e9
- (void)_closeTrackCheckGpsLocation;	// IMP=0x0010000000b49e4e
- (void)_calculateTimeStartEndDistanceGpsPed;	// IMP=0x0010000000b49349
- (double)_extremaRemovedMean:(double [5])arg1;	// IMP=0x0010000000b492e5
- (id)_filterGpsLocationBuffer;	// IMP=0x0010000000b48c7a
- (void)updatePedometerBuffer:(struct CLExtendedStepCountEntry)arg1;	// IMP=0x0010000000b48b2c
- (void)updateGpsOdometerBuffer:(struct CLOdometerEntry)arg1;	// IMP=0x0010000000b48811
- (void)_updateGpsLocationBufferFiltered:(id)arg1;	// IMP=0x0010000000b4872f
- (void)updateGpsLocationBuffer:(id)arg1 gpsSource:(int)arg2;	// IMP=0x0010000000b47f1a
- (void)stop;	// IMP=0x0010000000b47d76
- (void)dealloc;	// IMP=0x0010000000b47cfb
- (id)init;	// IMP=0x0010000000b47a90
