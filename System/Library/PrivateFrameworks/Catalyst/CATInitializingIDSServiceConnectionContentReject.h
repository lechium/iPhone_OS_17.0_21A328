...
+ (id)instanceWithDictionary:(id)arg1;	// IMP=0x001000000004275a
- (void).cxx_destruct;	// IMP=0x000000000004288a
...
- (id)initWithConnectionIdentifier:(id)arg1 error:(id)arg2;	// IMP=0x00000000000425a9
