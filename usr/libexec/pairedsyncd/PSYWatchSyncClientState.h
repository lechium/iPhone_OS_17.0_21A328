...
- (void).cxx_destruct;	// IMP=0x002000000000e75d
...
- (id)description;	// IMP=0x001000000000e5ba
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000000e3da
- (unsigned long long)hash;	// IMP=0x001000000000e312
- (id)plistRepresentation;	// IMP=0x001000000000e0b1
...
- (id)initWithPlistRepresentation:(id)arg1;	// IMP=0x001000000000de66
- (id)initWithSyncSessionState:(unsigned long long)arg1 syncSessionType:(unsigned long long)arg2 migrationSync:(_Bool)arg3 activities:(id)arg4 completedActivities:(id)arg5;	// IMP=0x001000000000dda5
