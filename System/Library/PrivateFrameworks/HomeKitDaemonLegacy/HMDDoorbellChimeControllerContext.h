...
- (void).cxx_destruct;	// IMP=0x000000000068f13f
...
- (_Bool)accessorySupportsCoordinationDoorbellChime:(id)arg1;	// IMP=0x000000000068f0c5
@property(readonly, copy) NSUUID *currentAccessoryUUID;
- (id)fetchDoorbellDelay;	// IMP=0x000000000068efe1
- (id)clearCoordinationStateForKeyPaths:(id)arg1;	// IMP=0x000000000068efc8
- (id)keyPathFromComponents:(id)arg1;	// IMP=0x000000000068efc0
- (id)postCoordinationState:(id)arg1;	// IMP=0x000000000068efa7
...
- (id)postCULiveAction:(id)arg1;	// IMP=0x000000000068ed5d
...
- (id)initWithWorkQueue:(id)arg1 accessory:(id)arg2;	// IMP=0x000000000068eaee
