...
- (void)_reloadTransportControlStateForItemWithIdentifier:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000000000973c9
- (void)_broadcastTransportControlStateDictionary:(id)arg1 forItemWithIdentifier:(id)arg2;	// IMP=0x0000000000097270
- (void)_broadcastLocalParticipantStateDictionary:(id)arg1;	// IMP=0x00000000000971a0
- (void)clearCoordinationMediumDelegate;	// IMP=0x0000000000097090
- (void)synchronizePlaybackStateForReason:(id)arg1;	// IMP=0x0000000000096fb8
- (void)handleNewTransportControlStateDictionary:(id)arg1;	// IMP=0x0000000000096ea8
- (void)handleNewParticipantStateDictionary:(id)arg1;	// IMP=0x0000000000096d98
- (void)removeParticipant:(id)arg1;	// IMP=0x0000000000096c88
- (void)handlePlaybackSyncPayload:(id)arg1;	// IMP=0x0000000000096a70
- (_Bool)isCoordinatorSuspended;	// IMP=0x0000000000096a68
- (id)initWithLiveLink:(id)arg1;	// IMP=0x00000000000968c3
