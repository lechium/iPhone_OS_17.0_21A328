...
+ (unsigned long long)setup:(id)arg1 interval:(double)arg2;	// IMP=0x004000000000437e
+ (id)idleTracker:(id)arg1 queue:(id)arg2 interval:(double)arg3 block:(CDUnknownBlockType)arg4;	// IMP=0x0010000000003fad
- (void).cxx_destruct;	// IMP=0x0020000000004cb8
...
- (void)invalidate;	// IMP=0x00100000000048e3
- (void)dealloc;	// IMP=0x0010000000004292
- (id)init:(id)arg1 queue:(id)arg2 interval:(double)arg3 block:(CDUnknownBlockType)arg4;	// IMP=0x0010000000004047
