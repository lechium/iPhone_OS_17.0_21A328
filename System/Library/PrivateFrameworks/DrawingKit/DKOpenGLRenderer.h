...
- (id).cxx_construct;	// IMP=0x0000000000012441
- (void).cxx_destruct;	// IMP=0x00000000000123c3
...
- (id)snapshotImage;	// IMP=0x0000000000012238
- (void)updateVertexControllerWithData:(vector_f3c59865)arg1 range:(struct _NSRange)arg2 allowWet:(_Bool)arg3;	// IMP=0x00000000000120e0
- (void)updateVertexControllerWithDataRange:(struct _NSRange)arg1 allowWet:(_Bool)arg2;	// IMP=0x0000000000011f8b
- (void)didBeginNewStroke;	// IMP=0x0000000000011f4b
- (void)didCompleteStroke;	// IMP=0x0000000000011f39
- (void)clearComposite;	// IMP=0x0000000000011e75
- (void)clearDryPaintBuffer;	// IMP=0x0000000000011db4
- (void)clearWetPaintBuffer;	// IMP=0x0000000000011d4d
- (void)clear;	// IMP=0x0000000000011d12
- (void)resetRendererState;	// IMP=0x0000000000011c69
- (_Bool)canvasIsEmpty;	// IMP=0x0000000000011c58
- (void)drawContiguousVertexStorageImmediatelyWithLayeredBlending:(_Bool)arg1;	// IMP=0x0000000000011869
- (void)redrawEntireDrawingImmediatelyWithLayeredBlending:(_Bool)arg1;	// IMP=0x0000000000011857
- (void)undo;	// IMP=0x0000000000011809
- (void)drawComposite;	// IMP=0x000000000001154d
- (void)draw;	// IMP=0x00000000000114b9
- (void)updateDryForcefully;	// IMP=0x00000000000113a3
- (void)renderToComposite:(_Bool)arg1;	// IMP=0x000000000001113c
- (void)renderToDryPaintBuffer;	// IMP=0x0000000000010f1e
- (void)renderToWetPaintBufferWithRange:(struct _NSRange)arg1;	// IMP=0x0000000000010def
- (void)updateDryCycleIncludingComposite:(_Bool)arg1;	// IMP=0x0000000000010db2
- (void)updateWet;	// IMP=0x0000000000010d98
- (struct CGRect)getVertexBounds;	// IMP=0x0000000000010d1b
- (struct CGRect)regionWithVertices:(vector_f3c59865)arg1 withInflationAmount:(float)arg2;	// IMP=0x0000000000010a96
- (void)update;	// IMP=0x000000000001086b
- (_Bool)detectCollision:: /* Error: Ran out of types for this method. */;	// IMP=0x0000000000010669
- (void)addPoints:(id)arg1 withSegmentLength:(unsigned long long)arg2;	// IMP=0x000000000000fde6
- (void)removeVertexHistoryElement;	// IMP=0x000000000000fd75
- (void)appendVertexHistoryElement;	// IMP=0x000000000000fb92
- (void)initializeFrameBuffers;	// IMP=0x000000000000f8b2
- (void)destroyFrameBuffers;	// IMP=0x000000000000f821
- (void)didResize;	// IMP=0x000000000000f723
- (_Bool)initGL;	// IMP=0x000000000000ecaa
- (void)teardown;	// IMP=0x000000000000ec3b
- (void)dealloc;	// IMP=0x000000000000eb7d
- (id)init;	// IMP=0x000000000000ead5
- (id)initWithBounds:(struct CGRect)arg1 scale:(double)arg2;	// IMP=0x000000000000eabc
- (id)initWithBounds:(struct CGRect)arg1 scale:(double)arg2 bufferSize:(int)arg3 sharedContext:(_Bool)arg4;	// IMP=0x000000000000e9e0
