...
- (void).cxx_destruct;	// IMP=0x0020000000058979
...
- (void)viewDidLoad;	// IMP=0x001000000005814f
- (id)initWithCenterContentView:(id)arg1 size:(struct CGSize)arg2 pinSides:(_Bool)arg3;	// IMP=0x00100000000580a8
- (id)initWithCenterContentView:(id)arg1 size:(struct CGSize)arg2;	// IMP=0x0010000000058094
- (id)initWithCenterContentView:(id)arg1;	// IMP=0x0010000000058077
