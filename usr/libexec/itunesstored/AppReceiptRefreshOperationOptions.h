...
- (void).cxx_destruct;	// IMP=0x00200000001ab061
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000001aaf35
@property(readonly, nonatomic) NSString *URLBagKey;
- (id)initWithReceiptFlags:(unsigned long long)arg1;	// IMP=0x00100000001aaecd
