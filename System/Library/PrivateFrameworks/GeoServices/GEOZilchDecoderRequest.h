...
- (id).cxx_construct;	// IMP=0x00000000010a47e6
- (void).cxx_destruct;	// IMP=0x00000000010a4750
...
- (void)cancel;	// IMP=0x00000000010a4657
- (void)decodeWithPathHandler:(CDUnknownBlockType)arg1 errorHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000000010a391b
- (void)_finishedDecodingWithPath:(Path_3f73a495)arg1;	// IMP=0x00000000010a3787
- (id)initWithDecoder:(id)arg1 message:(shared_ptr_27244a92)arg2;	// IMP=0x00000000010a3590
