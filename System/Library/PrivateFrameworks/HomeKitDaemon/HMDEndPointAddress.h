...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000078d42
- (void).cxx_destruct;	// IMP=0x0000000000078d00
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000078bb5
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000078925
- (void)description:(id)arg1 indent:(id)arg2;	// IMP=0x0000000000078792
- (_Bool)_parseFromTLVData;	// IMP=0x0000000000078555
@property(readonly, copy) NSData *tlvData;
- (_Bool)compatibleWithRemoteEndPoint:(id)arg1;	// IMP=0x000000000007832a
- (id)initWithIPAddress:(id)arg1 isIPv6Address:(_Bool)arg2 videoRTPPort:(id)arg3 audioRTPPort:(id)arg4;	// IMP=0x0000000000078251
