...
- (void).cxx_destruct;	// IMP=0x0000000000072621
...
- (double)standardPaddingInline;	// IMP=0x00000000000723f3
- (double)standardPaddingFullScreen;	// IMP=0x00000000000723e1
- (struct UIEdgeInsets)embeddedInlineInsets;	// IMP=0x00000000000723c1
- (struct UIEdgeInsets)portraitFullscreenInsets;	// IMP=0x00000000000723a1
- (struct UIEdgeInsets)landscapeFullscreenInsets;	// IMP=0x0000000000072381
...
- (id)initWithTraitCollection:(id)arg1 shouldUseCompactFullScreenSize:(_Bool)arg2;	// IMP=0x0000000000071ce9
