...
@interface _TtC7NewsUI240TodayFeedWithProductionAdsScrollTestCase : NSObject
{
...
- (void).cxx_destruct;	// IMP=0x000000000092ac30
- (id)init;	// IMP=0x000000000092abe0
- (id)scrollViewWithContext:(id)arg1;	// IMP=0x000000000092aa80
