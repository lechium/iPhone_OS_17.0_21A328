...
- (void)doneWithInstallFonts:(_Bool)arg1;	// IMP=0x0010000000007d29
- (void)prepareForActivationWithContext:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0010000000007b57
- (void)configureWithContext:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00100000000079de
- (void)connectToEndpoint:(id)arg1;	// IMP=0x0010000000007808
- (void)viewDidDisappear:(_Bool)arg1;	// IMP=0x00100000000077a0
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x001000000000771c
- (void)viewDidAppear:(_Bool)arg1;	// IMP=0x00100000000070f0
