...
- (void).cxx_destruct;	// IMP=0x00000000006d903a
...
- (void)_requestStatus;	// IMP=0x00000000006d8c3f
- (id)initWithResidentDevice:(id)arg1 owner:(id)arg2;	// IMP=0x00000000006d8af0
