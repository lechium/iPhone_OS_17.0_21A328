...
@class CPApplicationPolicyManager, CSDAudioController, CSDCallDirectoryManager, CSDCallStateController, CSDCallStateMonitor, CSDConversationProviderManager, CSDConversationProviderManagerXPCServer, CSDDeviceLockStateObserver, CSDDualSIMRingtoneHelper, CSDHandoffAudioController, CSDMomentsController, CSDOrientationMonitor, CSDPowerAssertionManager, CSDProximityController, CSDProximitySensorObserver, CSDRaiseToAnswerController, CSDRelayClientController, CSDRelayCommonController, CSDRelayHostController, CSDRelayMessagingController, CSDStatusBarManager, CSDUserNotificationController, CSDVoIPApplicationController, CSDVoiceOverObserver, NSMutableArray, NSString, TUUserConfiguration;
...
@interface CSDDaemon : NSObject
{
    ...
    CSDDualSIMRingtoneHelper *_dualSIMRingtoneHelper;	// 224 = 0xe0
}

- (void).cxx_destruct;	// IMP=0x00200000000a42db
...
- (void)propertiesDidChangeForConfiguration:(id)arg1;	// IMP=0x00100000000a3f35
- (void)_setUpSandbox;	// IMP=0x00100000000a3f1a
- (id)_setUpTemporaryDirectory;	// IMP=0x00100000000a3dae
- (void)_setUpLanguageChangeListener;	// IMP=0x00100000000a3ce4
@property(readonly, copy) NSString *debugDescription;
- (void)_observeSignal:(int)arg1 usingHandler:(CDUnknownBlockType)arg2;	// IMP=0x00100000000a3a21
- (void)dealloc;	// IMP=0x00100000000a389f
- (id)init;	// IMP=0x00100000000a1eb1
