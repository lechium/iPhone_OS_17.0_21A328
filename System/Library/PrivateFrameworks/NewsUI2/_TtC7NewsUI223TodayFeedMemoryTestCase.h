...
@interface _TtC7NewsUI223TodayFeedMemoryTestCase : NSObject
{
...
- (void).cxx_destruct;	// IMP=0x0000000000ce7710
- (id)init;	// IMP=0x0000000000ce7610
- (void)runTestWithContext:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000000ce7580
