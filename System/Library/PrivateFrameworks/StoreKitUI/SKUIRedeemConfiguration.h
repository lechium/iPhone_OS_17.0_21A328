...
- (void).cxx_destruct;	// IMP=0x000000000031f41a
...
- (void)_setSuccessImage:(id)arg1;	// IMP=0x000000000031f351
- (void)_setLandingImage:(id)arg1;	// IMP=0x000000000031f2ce
- (void)_setInputImage:(id)arg1;	// IMP=0x000000000031f24b
- (id)_redeemPreflightRequestBodyData;	// IMP=0x000000000031f088
- (void)_loadDefaultImages;	// IMP=0x000000000031efa0
- (void)_loadConfigurationWithURLBagDictionary:(id)arg1 completionBlock:(CDUnknownBlockType)arg2;	// IMP=0x000000000031eb3f
- (void)_didLoadWithResponseDictionary:(id)arg1;	// IMP=0x000000000031e223
- (void)loadConfigurationWithCompletionBlock:(CDUnknownBlockType)arg1;	// IMP=0x000000000031e017
- (id)initWithOperationQueue:(id)arg1 category:(long long)arg2 clientContext:(id)arg3;	// IMP=0x000000000031df2f
