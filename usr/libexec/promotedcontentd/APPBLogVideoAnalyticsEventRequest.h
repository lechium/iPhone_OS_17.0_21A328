...
+ (id)options;	// IMP=0x002000000005f6cc
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000061064
- (unsigned long long)hash;	// IMP=0x0010000000060b04
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000006090d
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000060797
- (void)copyTo:(id)arg1;	// IMP=0x001000000006065c
- (void)writeTo:(id)arg1;	// IMP=0x0010000000060505
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000000604f8
- (id)dictionaryRepresentation;	// IMP=0x001000000005fcca
- (id)description;	// IMP=0x001000000005fc1b
...
- (int)StringAsVideoState:(id)arg1;	// IMP=0x001000000005f7f9
- (id)videoStateAsString:(int)arg1;	// IMP=0x001000000005f7b0
