...
+ (_Bool)supportsSecureCoding;	// IMP=0x00200000000216ad
- (void).cxx_destruct;	// IMP=0x00200000000218f8
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000021859
- (id)initWithCoder:(id)arg1;	// IMP=0x00100000000216b5
- (id)initResponseForHostname:(id)arg1 ipv4Address:(id)arg2 ipv6Address:(id)arg3;	// IMP=0x001000000002159a
