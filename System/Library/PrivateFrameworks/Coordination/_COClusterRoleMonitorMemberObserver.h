...
- (void).cxx_destruct;	// IMP=0x0000000000030ea7
...
- (void)notify:(id)arg1;	// IMP=0x0000000000030c52
- (id)description;	// IMP=0x0000000000030b86
- (id)initWithMember:(id)arg1 inCluster:(id)arg2 queue:(id)arg3 block:(CDUnknownBlockType)arg4;	// IMP=0x0000000000030a6a
