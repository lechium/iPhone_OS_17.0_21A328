...
- (void).cxx_destruct;	// IMP=0x00000000005a9764
...
- (void)_notNowButtonPressed;	// IMP=0x00000000005a9609
- (void)_acceptButtonPressed;	// IMP=0x00000000005a94b7
- (void)_messageButtonPressed;	// IMP=0x00000000005a93ed
- (void)addButtonsToTray;	// IMP=0x00000000005a902b
- (void)configureSecondReceiveScreen;	// IMP=0x00000000005a8d8b
- (void)configureSecondSendScreen;	// IMP=0x00000000005a8aeb
- (id)initSecondReceivingEDUScreenWithItemIndexPath:(id)arg1;	// IMP=0x00000000005a89ae
- (id)initSecondSendingEDUScreenWithComposition:(id)arg1 withSensitiveMediaObjects:(id)arg2 withIdentifiersOfShelvedImages:(id)arg3;	// IMP=0x00000000005a87ec
