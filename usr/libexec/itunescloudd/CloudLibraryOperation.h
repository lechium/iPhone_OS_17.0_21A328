...
+ (_Bool)supportsSecureCoding;	// IMP=0x002000000008a4b4
- (void).cxx_destruct;	// IMP=0x002000000008a41d
...
- (id)description;	// IMP=0x001000000008a2f1
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000008a259
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000008a17d
- (id)initWithConfiguration:(id)arg1 clientIdentity:(id)arg2;	// IMP=0x001000000008a023
- (id)initWithConfiguration:(id)arg1;	// IMP=0x0010000000089fc1
- (id)init;	// IMP=0x0010000000089f81
