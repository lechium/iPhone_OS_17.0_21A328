...
- (void).cxx_destruct;	// IMP=0x00000000001f2a7f
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001f27d7
- (id)initWithRequestClass:(Class)arg1;	// IMP=0x00000000001f26d7
