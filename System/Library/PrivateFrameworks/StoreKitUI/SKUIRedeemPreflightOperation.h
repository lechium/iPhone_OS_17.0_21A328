...
- (void).cxx_destruct;	// IMP=0x00000000001ffa6c
...
- (id)_redeemCodeMetadataWithClientContext:(id)arg1;	// IMP=0x00000000001ff5aa
- (id)_authenticationContext;	// IMP=0x00000000001ff4df
- (void)main;	// IMP=0x00000000001fee21
@property(retain) SKUIRedeemConfiguration *redeemConfiguration;
@property(copy) CDUnknownBlockType outputBlock;
@property _Bool loadsRedeemCodeMetadata;
- (id)initWithClientContext:(id)arg1 redeemCode:(id)arg2 forcesAuthentication:(_Bool)arg3;	// IMP=0x00000000001fe88e
- (id)init;	// IMP=0x00000000001fe87c
- (id)_initSKUIRedeemPreflightOperation;	// IMP=0x00000000001fe78f
