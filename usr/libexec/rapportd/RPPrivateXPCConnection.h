...
- (void).cxx_destruct;	// IMP=0x002000000007d0a4
...
- (void)xpcPrivateDiscoveryUpdate:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x001000000007cf1e
- (void)xpcPrivateDiscoveryActivate:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x001000000007ce0e
- (void)xpcPrivateAdvertiserUpdate:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x001000000007cd11
- (void)xpcPrivateAdvertiserActivate:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x001000000007cc01
- (void)xpcConnectionInvalidated;	// IMP=0x001000000007ca7e
- (_Bool)_entitledAndReturnError:(id *)arg1;	// IMP=0x001000000007c958
