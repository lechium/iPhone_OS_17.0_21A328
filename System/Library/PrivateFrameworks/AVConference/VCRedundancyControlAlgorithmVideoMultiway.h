...
- (void)updateRedundancyPercentage;	// IMP=0x0000000000247701
- (void)updateRedundancyStrategyWithNetworkStatistics:(struct tagVCStatisticsMessage)arg1;	// IMP=0x0000000000247680
- (id)init;	// IMP=0x0000000000247614
