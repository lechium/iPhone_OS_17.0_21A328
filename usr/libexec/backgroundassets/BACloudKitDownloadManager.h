...
- (void).cxx_destruct;	// IMP=0x0020000000031661
...
- (id)_newOperationQuery;	// IMP=0x001000000003122b
- (void)_downloadActualAsset;	// IMP=0x00100000000308c5
- (_Bool)_consumeAvailableDownloadSize;	// IMP=0x0010000000030648
- (void)_downloadSucceededWithURL:(id)arg1;	// IMP=0x00100000000304bc
- (void)_downloadFailedWithError:(id)arg1;	// IMP=0x0010000000030331
- (void)cancelDownload;	// IMP=0x00100000000302f4
- (void)pauseDownload;	// IMP=0x00100000000301cc
- (_Bool)startDownloadWithError:(id *)arg1;	// IMP=0x001000000002f5ab
- (id)initWithDownload:(id)arg1 withDelegate:(id)arg2;	// IMP=0x001000000002f47e
