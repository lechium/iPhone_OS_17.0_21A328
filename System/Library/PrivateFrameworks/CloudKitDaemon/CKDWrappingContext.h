...
- (void).cxx_destruct;	// IMP=0x00000000000c85eb
...
- (id)encryptedDataContextString;	// IMP=0x00000000000c8440
- (id)assetContextString;	// IMP=0x00000000000c8025
- (id)initWithRecordID:(id)arg1 fieldName:(id)arg2 mergeableDeltaID:(id)arg3 fileSignature:(id)arg4 referenceSignature:(id)arg5;	// IMP=0x00000000000c7e0c
