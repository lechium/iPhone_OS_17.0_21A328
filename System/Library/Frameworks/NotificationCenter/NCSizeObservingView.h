...
- (void).cxx_destruct;	// IMP=0x00000000000016f9
@property(nonatomic) __weak id <NCSizeObservingViewDelegate> delegate; // @synthesize delegate=_delegate;
- (void)setFrame:(struct CGRect)arg1;	// IMP=0x00000000000015eb
- (void)setBounds:(struct CGRect)arg1;	// IMP=0x00000000000014f6
