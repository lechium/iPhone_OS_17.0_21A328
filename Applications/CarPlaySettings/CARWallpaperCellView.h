...
- (void).cxx_destruct;	// IMP=0x0020000000012cf8
...
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x0010000000012a2d
- (_Bool)canBecomeFocused;	// IMP=0x0010000000012a25
- (struct CGSize)systemLayoutSizeFittingSize:(struct CGSize)arg1;	// IMP=0x001000000001287d
- (id)initWithWallpaper:(id)arg1 wallpaperPreferences:(id)arg2;	// IMP=0x0010000000011723
