...
+ (id)actionMenuGestureRecognizerButtonWithButton:(id)arg1;	// IMP=0x0060000000028ca4
- (void).cxx_destruct;	// IMP=0x00000000000291f7
...
- (void)gestureRecognized:(id)arg1;	// IMP=0x0000000000028f63
- (void)touchUpOutsideButton:(id)arg1;	// IMP=0x0000000000028f00
- (void)touchUpInsideButton:(id)arg1;	// IMP=0x0000000000028e94
- (void)touchDownButton:(id)arg1;	// IMP=0x0000000000028e48
- (id)initWithGestureRecognizer:(id)arg1 button:(id)arg2;	// IMP=0x0000000000028d29
