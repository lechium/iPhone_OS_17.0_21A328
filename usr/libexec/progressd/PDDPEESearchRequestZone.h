...
- (void).cxx_destruct;	// IMP=0x0020000000077201
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000000770c3
- (unsigned long long)hash;	// IMP=0x001000000007702a
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000076f1c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000076e38
- (void)copyTo:(id)arg1;	// IMP=0x0010000000076d95
- (void)writeTo:(id)arg1;	// IMP=0x0010000000076cf5
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000076ce8
- (id)dictionaryRepresentation;	// IMP=0x001000000007681c
- (id)description;	// IMP=0x001000000007676d
- (int)StringAsCompareOptions:(id)arg1;	// IMP=0x0010000000076638
- (id)compareOptionsAsString:(int)arg1;	// IMP=0x0010000000076567
