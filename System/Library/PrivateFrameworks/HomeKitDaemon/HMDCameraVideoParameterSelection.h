...
+ (id)logCategory;	// IMP=0x0060000000783eca
- (void).cxx_destruct;	// IMP=0x0000000000783d16
...
- (void)_generateAllCombinations;	// IMP=0x00000000007820a3
- (id)createReselectedVideoParameters:(id)arg1;	// IMP=0x0000000000781f38
- (id)createSelectedVideoParameters;	// IMP=0x0000000000781b4e
- (id)createSRTPParamters;	// IMP=0x0000000000781ac3
- (_Bool)_selectParametersFromCodec:(id)arg1 profiles:(id)arg2 levels:(id)arg3 packetizationModes:(id)arg4 videoAttributes:(id)arg5;	// IMP=0x00000000007811cb
- (_Bool)selectVideoParameters;	// IMP=0x00000000007801f5
- (id)logIdentifier;	// IMP=0x00000000007801a5
- (void)_setVideoResolutionPreference;	// IMP=0x000000000077fddc
- (id)initWithSessionID:(id)arg1 videoTierParameters:(id)arg2 supportedVideoConfiguration:(id)arg3 supportedRTPConfiguration:(id)arg4 streamingCapabilities:(id)arg5;	// IMP=0x000000000077fbee
