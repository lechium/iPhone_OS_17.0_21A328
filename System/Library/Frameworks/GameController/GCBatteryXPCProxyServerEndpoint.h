...
- (void).cxx_destruct;	// IMP=0x000000000000b48e
...
- (void)fetchObjectIdentifierWithReply:(CDUnknownBlockType)arg1;	// IMP=0x000000000000b3ce
- (void)invalidateConnection;	// IMP=0x000000000000b31b
- (void)fetchBatteryWithReply:(CDUnknownBlockType)arg1;	// IMP=0x000000000000b271
- (_Bool)acceptClient:(id)arg1 onConnection:(id)arg2 error:(id *)arg3;	// IMP=0x000000000000ae69
- (void)invalidateClient;	// IMP=0x000000000000ada8
@property(readonly, nonatomic) id <_GCControllerComponentDescription> receiverDescription;
- (id)initWithInitialValue:(id)arg1;	// IMP=0x000000000000acec
- (id)initWithIdentifier:(id)arg1 initialValue:(id)arg2;	// IMP=0x000000000000ac44
