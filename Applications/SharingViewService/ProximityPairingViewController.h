...
- (void).cxx_destruct;	// IMP=0x0020000000199aba
@property(copy, nonatomic) NSDictionary *userInfo; // @synthesize userInfo=_userInfo;
- (void)_updateBatteryUIForDevice:(id)arg1;	// IMP=0x00100000001996b5
- (void)_transitionToStatusFadeInSplit;	// IMP=0x0010000000199409
- (void)_transitionToStatusFadeInCombined;	// IMP=0x0010000000198ff1
- (void)_transitionToStatusStart;	// IMP=0x0010000000198e78
- (void)_transitionToTraining;	// IMP=0x0010000000198ded
- (void)transitionToPostPair;	// IMP=0x0010000000198c4a
- (void)_transitionToControlCenterTraining;	// IMP=0x00100000001982a4
- (void)handleFeatureShowcaseCompleted;	// IMP=0x00100000001981d2
- (void)_transitionToFeatureShowcase;	// IMP=0x0010000000197ac9
- (void)_testHandler:(id)arg1;	// IMP=0x001000000019799b
- (MISSING_TYPE *)_showFailed;	// IMP=0x001000000019791d
- (void)_showStart:(_Bool)arg1;	// IMP=0x0010000000195b33
- (void)_showCarPlayAlert;	// IMP=0x00100000001959fb
- (void)_pairingComplete:(id)arg1;	// IMP=0x0010000000195603
- (void)_movieStart;	// IMP=0x0010000000194dd0
- (void)_movieCleanup;	// IMP=0x0010000000194da8
- (void)_deviceLost:(id)arg1;	// IMP=0x0010000000194c11
- (void)_deviceFound:(id)arg1;	// IMP=0x001000000019472e
- (void)handleSkipTutorialButtonTapped:(id)arg1;	// IMP=0x0010000000194568
- (void)handleTapOutsideView:(id)arg1;	// IMP=0x0010000000194478
- (void)handleReportBugButton:(id)arg1;	// IMP=0x001000000019400f
- (void)handleDismissButton:(id)arg1;	// IMP=0x0010000000193f1f
- (void)handleDisconnectButton:(id)arg1;	// IMP=0x0010000000193dee
- (void)_handleConnectButton:(id)arg1;	// IMP=0x0010000000193aab
- (void)handleGuestConnectButton:(id)arg1;	// IMP=0x0010000000193a1e
- (void)handleConnectButton:(id)arg1;	// IMP=0x00100000001939b6
- (_Bool)gestureRecognizer:(id)arg1 shouldReceiveTouch:(id)arg2;	// IMP=0x0010000000193922
- (_Bool)_canShowWhileLocked;	// IMP=0x001000000019391a
- (void)viewDidDisappear:(_Bool)arg1;	// IMP=0x00100000001937a4
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x00100000001928ea
