...
- (void).cxx_destruct;	// IMP=0x00000000000d6695
...
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x00000000000d6628
- (void)_updateStyle;	// IMP=0x00000000000d651a
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000000d62dc
- (void)layoutSubviews;	// IMP=0x00000000000d5fa7
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000000d5d92
