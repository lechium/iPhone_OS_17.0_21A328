...
- (void).cxx_destruct;	// IMP=0x002000000001d2b7
...
- (id)description;	// IMP=0x001000000001d21a
- (id)initWithAudioURL:(id)arg1 withScaleFactor:(float)arg2 outASBD:(struct AudioStreamBasicDescription)arg3;	// IMP=0x001000000001d179
