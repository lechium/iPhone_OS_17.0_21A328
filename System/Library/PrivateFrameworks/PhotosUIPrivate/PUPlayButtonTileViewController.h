...
+ (struct CGSize)playButtonTileSize;	// IMP=0x00100000004a5502
- (void).cxx_destruct;	// IMP=0x00000000004a5439
...
- (void)viewModel:(id)arg1 didChange:(id)arg2;	// IMP=0x00000000004a51cb
- (void)_setShouldShowPlayButton:(_Bool)arg1 animated:(_Bool)arg2;	// IMP=0x00000000004a5073
- (void)_updateButtonAnimated:(_Bool)arg1;	// IMP=0x00000000004a4d2a
- (void)_playButtonTapped:(id)arg1;	// IMP=0x00000000004a4ca3
@property(readonly, nonatomic) _Bool showPlayButtonWhileActivated;
@property(readonly, nonatomic) _Bool canShowPauseButton;
- (void)becomeReusable;	// IMP=0x00000000004a4900
- (void)dealloc;	// IMP=0x00000000004a4891
- (id)loadView;	// IMP=0x00000000004a4746
