...
- (void).cxx_destruct;	// IMP=0x002000000004214d
...
- (void)transactionCompleted:(id)arg1;	// IMP=0x0010000000041d05
- (void)signalFetchChangesTransaction:(id)arg1;	// IMP=0x0010000000041ab1
- (void)signalSyncToCKTransactionForEntityName:(id)arg1 syncManager:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x00100000000416c9
- (void)signalSyncToCKTransactionForEntityName:(id)arg1 syncManager:(id)arg2;	// IMP=0x00100000000416b4
- (void)signalDataChangeTransactionForEntityName:(id)arg1 notificationName:(id)arg2;	// IMP=0x00100000000414b0
- (id)initWithCloudKitController:(id)arg1;	// IMP=0x00100000000413b0
