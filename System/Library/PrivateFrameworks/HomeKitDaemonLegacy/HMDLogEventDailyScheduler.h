...
+ (id)logCategory;	// IMP=0x0010000000233f17
+ (id)createSchedulerWithLogEventSubmitter:(id)arg1;	// IMP=0x0010000000233e0a
...
- (id)statusSummary;	// IMP=0x0000000000233933
- (void)runHomeutilTasks;	// IMP=0x000000000023365a
- (void)runDailyTasks;	// IMP=0x0000000000233437
- (id)taskRunners;	// IMP=0x00000000002333cf
- (void)registerDailyTaskRunner:(id)arg1;	// IMP=0x0000000000233359
- (void)_runActivity:(id)arg1;	// IMP=0x0000000000232f58
- (void)_handleCheckInForActivity:(id)arg1;	// IMP=0x0000000000232cca
- (void)_registerActivity;	// IMP=0x0000000000232aed
- (id)_criteriaForActivity;	// IMP=0x0000000000232a4e
- (id)initWithIdentifier:(id)arg1 preferencesKey:(id)arg2 logEventSubmitter:(id)arg3 xpcActivityInterface:(id)arg4 dateFactory:(CDUnknownBlockType)arg5;	// IMP=0x0000000000232862
