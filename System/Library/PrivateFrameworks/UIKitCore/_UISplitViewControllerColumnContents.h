...
- (void).cxx_destruct;	// IMP=0x00000000005ce10d
...
- (id)description;	// IMP=0x00000000005ce00d
@property(readonly, nonatomic) UIViewController *viewController; // @synthesize viewController=_viewController;
- (id)initWithViewController:(id)arg1 navigationController:(id)arg2 navigationControllerWrapper:(id)arg3;	// IMP=0x00000000005cde7e
