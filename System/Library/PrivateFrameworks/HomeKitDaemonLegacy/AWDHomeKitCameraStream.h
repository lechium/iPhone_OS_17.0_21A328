...
+ (Class)resolutionCountType;	// IMP=0x0010000000443c25
+ (Class)reconfigurationsType;	// IMP=0x0010000000443c14
- (void).cxx_destruct;	// IMP=0x0000000000443b39
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000443310
- (unsigned long long)hash;	// IMP=0x0000000000443035
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000442be6
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000004425df
- (void)copyTo:(id)arg1;	// IMP=0x000000000044221e
- (void)writeTo:(id)arg1;	// IMP=0x0000000000441d84
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000441390
- (id)dictionaryRepresentation;	// IMP=0x0000000000440940
- (id)description;	// IMP=0x0000000000440891
- (id)resolutionCountAtIndex:(unsigned long long)arg1;	// IMP=0x0000000000440874
- (unsigned long long)resolutionCountsCount;	// IMP=0x0000000000440857
- (void)addResolutionCount:(id)arg1;	// IMP=0x00000000004407ed
- (void)clearResolutionCounts;	// IMP=0x00000000004407d0
- (int)StringAsResolutionOnClose:(id)arg1;	// IMP=0x000000000044062c
- (id)resolutionOnCloseAsString:(int)arg1;	// IMP=0x00000000004405e1
...
- (id)reconfigurationsAtIndex:(unsigned long long)arg1;	// IMP=0x0000000000440392
- (unsigned long long)reconfigurationsCount;	// IMP=0x0000000000440375
- (void)addReconfigurations:(id)arg1;	// IMP=0x000000000044030b
- (void)clearReconfigurations;	// IMP=0x00000000004402ee
...
- (int)StringAsCertified:(id)arg1;	// IMP=0x0000000000440102
- (id)certifiedAsString:(int)arg1;	// IMP=0x00000000004400ba
