...
- (void).cxx_destruct;	// IMP=0x000000000027cbfd
...
- (void)channelsDidChangeForGeminiManager:(id)arg1;	// IMP=0x000000000027cac0
@property(readonly, nonatomic) NSString *channelIdentifier;
- (void)applicationWillEnterForeground:(id)arg1;	// IMP=0x000000000027c97d
- (void)resetDataSource;	// IMP=0x000000000027c800
- (id)initWithGeminiManager:(id)arg1;	// IMP=0x000000000027c71c
