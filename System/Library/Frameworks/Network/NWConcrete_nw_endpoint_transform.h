...
- (void).cxx_destruct;	// IMP=0x00000000007d2fc0
- (_Bool)applyWithHandler:(id)arg1 toChildren:(CDUnknownBlockType)arg2;	// IMP=0x00000000007d27e0
- (void)updatePathWithHandler:(id)arg1;	// IMP=0x00000000007d2250
- (void)cancelWithHandler:(id)arg1 forced:(_Bool)arg2;	// IMP=0x00000000007d1c10
- (void)startWithHandler:(id)arg1;	// IMP=0x00000000007d12f0
- (void)dealloc;	// IMP=0x00000000007d12c0
- (id)init;	// IMP=0x00000000007d1090
