...
- (void).cxx_destruct;	// IMP=0x000000000001b2e7
...
- (double)pruneIntervalInSeconds;	// IMP=0x000000000001b06c
- (double)cacheExpiryInSeconds;	// IMP=0x000000000001af78
- (id)noLocationKeyForWidth:(double)arg1 andHeight:(double)arg2;	// IMP=0x000000000001ae81
- (id)gridKeyForWidth:(double)arg1 andHeight:(double)arg2;	// IMP=0x000000000001ad8a
- (void)pruneCacheIfNeeded;	// IMP=0x000000000001a723
- (void)flushCache;	// IMP=0x000000000001a4ca
- (void)saveMetaData;	// IMP=0x0000000000019eb2
- (void)readMetaData;	// IMP=0x000000000001995e
- (_Bool)pendingMapImageForLocation:(id)arg1 altitude:(double)arg2 pitch:(double)arg3 width:(double)arg4 andHeight:(double)arg5;	// IMP=0x00000000000198b2
- (_Bool)pendingMapImageForRequest:(id)arg1;	// IMP=0x0000000000019574
- (void)cacheMapImage:(id)arg1 forLocation:(id)arg2 altitude:(double)arg3 pitch:(double)arg4 width:(double)arg5 andHeight:(double)arg6;	// IMP=0x00000000000194b3
- (void)cacheMapImage:(id)arg1 forRequest:(id)arg2;	// IMP=0x0000000000018e3d
- (id)cachedMapImageForLocation:(id)arg1 altitude:(double)arg2 pitch:(double)arg3 width:(double)arg4 andHeight:(double)arg5;	// IMP=0x0000000000018d83
- (id)cachedMapImageForRequest:(id)arg1;	// IMP=0x0000000000018c0c
- (void)cacheNoLocationImage:(id)arg1 forWidth:(double)arg2 andHeight:(double)arg3;	// IMP=0x000000000001879f
- (id)cachedNoLocationImageForWidth:(double)arg1 andHeight:(double)arg2;	// IMP=0x0000000000018642
- (void)cacheGridImage:(id)arg1 forWidth:(double)arg2 andHeight:(double)arg3;	// IMP=0x00000000000181d5
- (id)cachedGridImageForWidth:(double)arg1 andHeight:(double)arg2;	// IMP=0x0000000000018078
- (id)init;	// IMP=0x0000000000017b65
