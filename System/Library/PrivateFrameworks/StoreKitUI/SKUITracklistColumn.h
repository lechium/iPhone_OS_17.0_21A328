...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000b6e12
- (id)description;	// IMP=0x00000000000b6d41
- (void)setPreferredWidthForAttributedStrings:(id)arg1;	// IMP=0x00000000000b6ada
