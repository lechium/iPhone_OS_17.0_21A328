...
+ (_Bool)supportsSecureCoding;	// IMP=0x00600000000ca59f
- (void).cxx_destruct;	// IMP=0x00000000000ca7b3
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000ca68f
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000ca5a7
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000ca511
