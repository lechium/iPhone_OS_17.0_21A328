...
+ (_Bool)allowsReverseTransformation;	// IMP=0x0060000000265946
+ (Class)transformedValueClass;	// IMP=0x0060000000265935
- (void).cxx_destruct;	// IMP=0x0000000000266191
...
- (id)transformedValue:(id)arg1;	// IMP=0x000000000026594e
- (id)initWithIdentifierKeyPath:(id)arg1;	// IMP=0x0000000000265888
- (id)init;	// IMP=0x0000000000265819
