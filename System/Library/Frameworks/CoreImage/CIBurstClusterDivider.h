...
- (long long)compareActionAmounts:(id)arg1;	// IMP=0x0000000000020660
- (long long)compareIndices:(id)arg1;	// IMP=0x00000000000205ed
- (long long)compareDividers:(id)arg1;	// IMP=0x0000000000020574
