...
- (void).cxx_destruct;	// IMP=0x000000000003a0c2
...
- (_Bool)_canShowWhileLocked;	// IMP=0x000000000003a050
- (id)activityTypesThatInhibitPDFGeneration;	// IMP=0x0000000000039fe6
- (_Bool)writeGalleryPDFDataToPasteboardIfNecessaryForActivity:(id)arg1 documentInfoCollection:(id)arg2;	// IMP=0x0000000000039e7f
- (_Bool)inhibitPDFGenerationForActivityType:(id)arg1;	// IMP=0x0000000000039ddf
- (void)_performActivity:(id)arg1;	// IMP=0x0000000000039b82
