...
- (unsigned long long)hash;	// IMP=0x0000000000273942
...
- (id)description;	// IMP=0x00000000002738ae
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000273807
- (id)initWithPayload:(int)arg1 isSecondary:(_Bool)arg2 sbr:(_Bool)arg3 samplesPerBlock:(unsigned int)arg4;	// IMP=0x0000000000273768
- (id)init;	// IMP=0x000000000027375a
