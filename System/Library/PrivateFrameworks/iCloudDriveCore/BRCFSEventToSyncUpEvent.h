...
- (void).cxx_destruct;	// IMP=0x000000000004ee0e
...
- (id)associatedAppTelemetryEvent;	// IMP=0x000000000004ece9
- (id)subDescription;	// IMP=0x000000000004ec30
- (id)additionalPayload;	// IMP=0x000000000004eaed
