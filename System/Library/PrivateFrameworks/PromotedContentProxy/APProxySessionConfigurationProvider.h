...
- (id)_createConnectProxyConfig;	// IMP=0x00000000000024ac
- (id)connectProxyConfig;	// IMP=0x0000000000002418
- (void)addProtocolClasses:(id)arg1;	// IMP=0x0000000000002294
- (id)initWithDefaultProxyURL:(id)arg1;	// IMP=0x00000000000021f6
