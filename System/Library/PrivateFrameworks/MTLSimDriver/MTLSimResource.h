...
- (void)setHeapOffset:(unsigned long long)arg1;	// IMP=0x0000000000013862
- (void)waitUntilComplete;	// IMP=0x000000000001385c
- (_Bool)isPurgeable;	// IMP=0x0000000000013854
- (_Bool)isComplete;	// IMP=0x000000000001384c
- (_Bool)doesAliasResource:(id)arg1;	// IMP=0x000000000001381c
- (_Bool)doesAliasAnyResources:(const id *)arg1 count:(unsigned long long)arg2;	// IMP=0x0000000000013807
- (_Bool)doesAliasAllResources:(const id *)arg1 count:(unsigned long long)arg2;	// IMP=0x00000000000137ef
- (_Bool)doesAliasResources:(const id *)arg1 count:(unsigned long long)arg2 all:(_Bool)arg3;	// IMP=0x000000000001369e
...
- (unsigned long long)setPurgeableState:(unsigned long long)arg1;	// IMP=0x0000000000013604
- (void)makeAliasable;	// IMP=0x0000000000013566
- (_Bool)isAliasable;	// IMP=0x000000000001355d
@property(readonly) id <MTLHeap> heap; // @dynamic heap;
@property(copy) NSString *label; // @dynamic label;
- (id)retainedLabel;	// IMP=0x0000000000013506
@property(readonly) id <MTLDevice> device; // @dynamic device;
- (void)dealloc;	// IMP=0x000000000001343b
- (id)initWithResourceRef:(unsigned int)arg1 options:(unsigned long long)arg2 device:(id)arg3 heap:(id)arg4;	// IMP=0x000000000001339f
