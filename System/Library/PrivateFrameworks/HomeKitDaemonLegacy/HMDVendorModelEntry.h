...
- (void).cxx_destruct;	// IMP=0x0000000000af03f6
...
- (unsigned long long)hash;	// IMP=0x0000000000af0116
- (long long)compare:(id)arg1;	// IMP=0x0000000000af0020
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000aefc4b
- (id)attributeDescriptions;	// IMP=0x0000000000aef94c
- (id)initWithManufacturer:(id)arg1 model:(id)arg2 appBundleID:(id)arg3 appStoreID:(id)arg4 firmwareVersion:(id)arg5 productData:(id)arg6 productDataAlternates:(id)arg7;	// IMP=0x0000000000aef74c
