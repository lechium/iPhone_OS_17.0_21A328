...
- (void).cxx_destruct;	// IMP=0x000000000002ba06
...
- (id)getLogger;	// IMP=0x000000000002b7c1
- (id)networkSlicingDetailText:(id)arg1;	// IMP=0x000000000002b6c1
- (_Bool)planManagerCacheHasMoreThanOnePlanItem;	// IMP=0x000000000002b5f7
- (id)specifiers;	// IMP=0x000000000002a68b
- (void)viewWillAppear;	// IMP=0x000000000002a675
- (id)initWithListController:(id)arg1 groupSpecifier:(id)arg2;	// IMP=0x000000000002a61f
- (id)initWithFactory:(id)arg1;	// IMP=0x000000000002a2c8
