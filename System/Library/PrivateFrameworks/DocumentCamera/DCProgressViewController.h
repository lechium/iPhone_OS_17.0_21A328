...
- (void).cxx_destruct;	// IMP=0x00000000000ad746
...
- (_Bool)_canShowWhileLocked;	// IMP=0x00000000000ad671
- (void)viewWillDisappear:(_Bool)arg1;	// IMP=0x00000000000ad498
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x00000000000ad42e
- (void)viewDidLoad;	// IMP=0x00000000000ad32d
- (id)initWithDelegate:(id)arg1;	// IMP=0x00000000000ad27d
