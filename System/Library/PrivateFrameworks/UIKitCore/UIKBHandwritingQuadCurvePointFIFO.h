...
- (void).cxx_destruct;	// IMP=0x0000000000b569fb
...
- (void)clear;	// IMP=0x0000000000b568e2
- (void)flush;	// IMP=0x0000000000b565bd
- (void)addPoint:(struct)arg1;	// IMP=0x0000000000b55feb
- (id)initWithFIFO:(id)arg1 scale:(double)arg2;	// IMP=0x0000000000b55f55
