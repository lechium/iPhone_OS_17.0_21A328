...
+ (id)sharedNotifier;	// IMP=0x0040000000001d9f
...
- (id)_newRemoteConnection;	// IMP=0x0000000000001f3c
- (id)_remoteConnection;	// IMP=0x0000000000001df4
@property(readonly, nonatomic) id <ConnectionProtocol> remoteObjectProxy;
- (id)init;	// IMP=0x0000000000001af5
