...
+ (id)keyPathsForValuesAffectingManagementSourceIdentifier;	// IMP=0x0020000000023dc8
- (id)reportDetails;	// IMP=0x002000000002461f
- (_Bool)validateForUpdate:(id *)arg1;	// IMP=0x00100000000240a4
- (_Bool)validateForInsert:(id *)arg1;	// IMP=0x0010000000023e38
