...
- (void).cxx_destruct;	// IMP=0x00200000006bd7ba
...
- (void)_maps_buildDescriptionWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x00100000006bd49e
@property(readonly, copy) NSString *debugDescription;
@property(readonly, copy) NSString *description;
- (void)_copyPropertiesTo:(id)arg1;	// IMP=0x00100000006bce6d
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000006bcde4
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000006bcdd9
@property(readonly, nonatomic) Route *focusedRoute;
@property(readonly, nonatomic) Route *selectedRoute;
- (void)_setRoutes:(id)arg1 selectedRouteIndex:(unsigned long long)arg2;	// IMP=0x00100000006bcc91
- (id)initWithRoutes:(id)arg1 selectedRouteIndex:(unsigned long long)arg2;	// IMP=0x00100000006bcb73
- (id)initWithRoute:(id)arg1;	// IMP=0x00100000006bcab8
- (id)init;	// IMP=0x00100000006bcaa4
