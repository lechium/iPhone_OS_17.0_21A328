...
+ (id)selfCrashResetReason;	// IMP=0x00200000000ac204
- (void).cxx_destruct;	// IMP=0x00200000000ac2d0
- (void)commitChangeBatch:(id)arg1 withCompletionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00100000000aaccf
- (void)finalizeWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x00100000000aa3d9
- (void)beginSessionWithKnownLibraryVersion:(id)arg1 context:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00100000000a9c46
- (id)clientWorkDescription;	// IMP=0x00100000000a9c39
