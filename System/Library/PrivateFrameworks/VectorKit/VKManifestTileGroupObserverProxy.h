...
- (id).cxx_construct;	// IMP=0x00000000008855b0
- (void).cxx_destruct;	// IMP=0x0000000000885524
...
- (void)experimentConfigurationDidChange:(id)arg1;	// IMP=0x0000000000884f55
- (void)resourceManifestManager:(id)arg1 didChangeActiveTileGroup:(id)arg2 fromOldTileGroup:(id)arg3;	// IMP=0x0000000000884d9e
- (void)resourceManifestManagerWillChangeActiveTileGroup:(id)arg1;	// IMP=0x0000000000884c6d
- (void)dealloc;	// IMP=0x0000000000884b27
- (id)initWithQueue:(id)arg1;	// IMP=0x0000000000884a0c
