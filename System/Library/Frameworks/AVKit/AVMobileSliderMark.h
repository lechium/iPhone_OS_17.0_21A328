...
+ (id)liveEdgeMarkAtValue:(float)arg1;	// IMP=0x0060000000064702
+ (id)interstitialMarkAtValue:(float)arg1;	// IMP=0x0060000000064658
- (void).cxx_destruct;	// IMP=0x0000000000064630
...
- (id)initWithStartValue:(float)arg1 endValue:(float)arg2 filledColor:(id)arg3 unfilledColor:(id)arg4 markWithType:(unsigned long long)arg5;	// IMP=0x0000000000064539
