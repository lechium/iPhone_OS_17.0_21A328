...
+ (_Bool)canHandleURLComponents:(id)arg1;	// IMP=0x006000000004fc34
+ (id)plugInClasses;	// IMP=0x006000000004fbc8
- (void).cxx_destruct;	// IMP=0x000000000004fed5
...
- (id)appLinksWithContext:(struct LSContext *)arg1 error:(id *)arg2;	// IMP=0x000000000004fe2c
