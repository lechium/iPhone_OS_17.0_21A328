...
- (void).cxx_destruct;	// IMP=0x000000000001d377
...
- (void)_processNextKey;	// IMP=0x000000000001d1bd
- (void)_processDeletedKey:(id)arg1 isDirty:(_Bool *)arg2;	// IMP=0x000000000001d141
- (void)_processUpdatedKey:(id)arg1 isConflict:(_Bool)arg2 isDirty:(_Bool *)arg3;	// IMP=0x000000000001d088
- (void)enumerateKeysInResponseForTransaction:(id)arg1 completionBlock:(CDUnknownBlockType)arg2;	// IMP=0x000000000001cf41
- (id)initWithResponseData:(id)arg1;	// IMP=0x000000000001ced6
