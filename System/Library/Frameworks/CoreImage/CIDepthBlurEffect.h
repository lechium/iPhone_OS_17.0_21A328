...
+ (id)customAttributes;	// IMP=0x00600000001c7a64
+ (int)getDraftMode:(id)arg1;	// IMP=0x00600000001cc181
+ (struct CGImageMetadata *)augmentMetadataWithRenderingPropertiesForImage:(id)arg1;	// IMP=0x00600000001cc0aa
+ (struct CGImageMetadata *)metadataFromDictionary:(id)arg1 metadata:(struct CGImageMetadata *)arg2;	// IMP=0x00600000001cbfe2
+ (id)tuningParametersFromMetadata:(struct CGImageMetadata *)arg1;	// IMP=0x00600000001cbfd5
+ (struct CGImageMetadata *)replaceRenderingParameters:(struct CGImageMetadata *)arg1 tuningParameters:(id)arg2;	// IMP=0x00600000001cbfcd
...
- (id)outputImage;	// IMP=0x00000000001c85b9
- (id)_getFocusRect:(id)arg1 focusRect:(id)arg2;	// IMP=0x00000000001c82bc
- (void)setValue:(id)arg1 forUndefinedKey:(id)arg2;	// IMP=0x00000000001c80d4
- (void)prewarm:(id)arg1;	// IMP=0x00000000001c73ae
