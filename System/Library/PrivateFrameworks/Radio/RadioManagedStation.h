...
+ (id)defaultPropertiesToFetch;	// IMP=0x0060000000001ec7
@property(readonly, nonatomic) NSDictionary *dictionaryRepresentation;
@property(nonatomic) _Bool virtualPlayEnabled;
@property(nonatomic) int subscriberCount;
- (id)streamKeyURL;	// IMP=0x0000000000005222
- (id)streamCertificateURL;	// IMP=0x0000000000005185
...
- (void)setStreamKeyURL:(id)arg1;	// IMP=0x000000000000487e
- (void)setStreamCertificateURL:(id)arg1;	// IMP=0x000000000000478f
...
- (id)feedbackDictionaryRepresentation;	// IMP=0x00000000000023a6
- (id)additionalReferencedTrackDescriptors;	// IMP=0x0000000000001fba
