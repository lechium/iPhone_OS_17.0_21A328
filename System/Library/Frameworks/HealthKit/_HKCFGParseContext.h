...
- (void).cxx_destruct;	// IMP=0x0000000000019c19
...
- (void)increaseLengthAllowance:(unsigned long long)arg1;	// IMP=0x000000000001964a
- (void)decreaseLengthAllowance:(unsigned long long)arg1;	// IMP=0x000000000001924f
- (void)decrementRecursiveDepth;	// IMP=0x0000000000019654
- (void)incrementRecursiveDepth;	// IMP=0x0000000000019259
- (id)initWithScanner:(id)arg1 lengthAllowance:(unsigned long long)arg2;	// IMP=0x00000000000187a2
