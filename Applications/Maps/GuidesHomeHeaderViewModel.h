...
- (void).cxx_destruct;	// IMP=0x0010000000cb03ac
...
- (void)publisherLogoImageWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0010000000cb0257
- (id)initWithGuideLocation:(id)arg1 featuredGuide:(id)arg2 sectionTitle:(id)arg3;	// IMP=0x0010000000cafd26
- (void)collectionImageForSize:(struct CGSize)arg1 onCompletion:(CDUnknownBlockType)arg2;	// IMP=0x0010000000cb042c
