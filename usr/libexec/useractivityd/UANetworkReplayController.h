...
+ (_Bool)createConnection:(id)arg1 host:(id)arg2 port:(long long)arg3;	// IMP=0x002000000007b6cc
- (void).cxx_destruct;	// IMP=0x002000000007b90b
...
- (_Bool)terminate;	// IMP=0x001000000007b4cb
- (id)statusString;	// IMP=0x001000000007b378
- (_Bool)sendResponse:(id)arg1;	// IMP=0x001000000007b091
- (_Bool)processCommand:(id)arg1;	// IMP=0x001000000007a463
- (void)stream:(id)arg1 handleEvent:(unsigned long long)arg2;	// IMP=0x0010000000079151
- (id)initWithManager:(id)arg1 service:(id)arg2;	// IMP=0x0010000000078eca
- (id)initWithManager:(id)arg1 inputStream:(id)arg2 outputStream:(id)arg3 name:(id)arg4;	// IMP=0x0010000000078c64
