...
- (void).cxx_destruct;	// IMP=0x00200000000f381e
...
- (void)_reportStatisticsForDuration:(double)arg1 storageInfo:(id)arg2 cancelled:(_Bool)arg3;	// IMP=0x00100000000f33af
- (void)_removeItemInBlockForKey:(id)arg1;	// IMP=0x00100000000f30fd
- (void)_removeItem:(id)arg1;	// IMP=0x00100000000f2fca
- (void)_handleAncientItem:(id)arg1;	// IMP=0x00100000000f2ef7
- (void)stop;	// IMP=0x00100000000f2eba
- (void)collect;	// IMP=0x00100000000f28d1
- (id)initWithCacheStore:(id)arg1 expirationDate:(id)arg2 timeSincePrevLaunch:(double)arg3;	// IMP=0x00100000000f27c1
