...
- (void).cxx_destruct;	// IMP=0x00000000005e894e
...
- (double)getTimeDurationForLongestProgressState;	// IMP=0x00000000005e882b
- (void)updateWithProgressState:(id)arg1 date:(id)arg2;	// IMP=0x00000000005e81f9
- (id)initWithDate:(id)arg1;	// IMP=0x00000000005e8174
