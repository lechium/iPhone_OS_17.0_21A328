...
+ (id)sizesResolvingFirstPrioritizedSize:(id)arg1 secondPrioritizedSize:(id)arg2 inAvailableWidth:(double)arg3;	// IMP=0x00600000000edb98
- (void).cxx_destruct;	// IMP=0x00000000000edb4f
...
- (id)removeLastSizeOfPriority:(unsigned long long)arg1;	// IMP=0x00000000000ed95c
- (void)addSize:(struct CGSize)arg1 withPriority:(unsigned long long)arg2;	// IMP=0x00000000000ed869
- (id)init;	// IMP=0x00000000000ed79d
