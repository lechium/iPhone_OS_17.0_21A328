...
- (void).cxx_destruct;	// IMP=0x000000000001b4cb
...
- (void)prepareForReuse;	// IMP=0x000000000001b210
- (void)layoutSubviews;	// IMP=0x000000000001aac0
@property(copy, nonatomic) UIImage *tabImage;
- (void)setSubhead3LabelColor:(id)arg1;	// IMP=0x000000000001aa01
- (void)setSubhead2LabelColor:(id)arg1;	// IMP=0x000000000001a9e4
- (void)setSubhead1LabelColor:(id)arg1;	// IMP=0x000000000001a9c7
- (id)initWithStyle:(long long)arg1 reuseIdentifier:(id)arg2;	// IMP=0x000000000001a0d9
