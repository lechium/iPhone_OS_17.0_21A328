...
- (void).cxx_destruct;	// IMP=0x00000000002af869
...
- (void)setDetectorConfigurationOption:(id)arg1 value:(id)arg2;	// IMP=0x00000000002af6fd
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000002af61e
- (id)initWithRequestClass:(Class)arg1;	// IMP=0x00000000002af557
