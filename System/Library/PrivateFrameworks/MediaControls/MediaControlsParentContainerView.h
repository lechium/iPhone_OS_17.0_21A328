...
- (void).cxx_destruct;	// IMP=0x000000000005b039
...
- (void)handleHoverGestureRecognizer:(id)arg1;	// IMP=0x000000000005af10
@property(retain, nonatomic) UIView *routingView;
- (void)_setInitialFrameForRoutingView:(id)arg1;	// IMP=0x000000000005ad2a
- (void)_toggleRoutingPickerAnimated:(_Bool)arg1;	// IMP=0x000000000005a995
- (void)_updateTimeControlVisibility:(id)arg1;	// IMP=0x000000000005a772
- (void)_updateRoutingPickerVisibilityAnimated:(_Bool)arg1;	// IMP=0x000000000005a6a8
...
- (void)setSelectedMode:(long long)arg1 animated:(_Bool)arg2;	// IMP=0x000000000005a5d5
- (void)didMoveToWindow;	// IMP=0x000000000005a4cd
- (void)layoutSubviews;	// IMP=0x0000000000059ff8
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000059d54
