...
- (void).cxx_destruct;	// IMP=0x002000000011b86e
...
- (void)notifyDelegateOfWake;	// IMP=0x001000000011b7a7
- (void)notifyDelegateOfSleepWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x001000000011b70c
- (id)init;	// IMP=0x001000000011b447
