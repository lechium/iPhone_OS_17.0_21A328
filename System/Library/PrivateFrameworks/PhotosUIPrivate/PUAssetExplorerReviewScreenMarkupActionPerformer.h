...
+ (_Bool)shouldEnableOnAsset:(id)arg1 inAssetCollection:(id)arg2;	// IMP=0x00600000001704fd
+ (_Bool)canPerformOnAsset:(id)arg1 inAssetCollection:(id)arg2;	// IMP=0x00600000001704dd
- (void).cxx_destruct;	// IMP=0x0000000000170835
...
- (void)_presentMarkupViewControllerForReviewAsset:(id)arg1;	// IMP=0x00000000001706f8
- (void)performUserInteractionTask;	// IMP=0x00000000001705ae
