...
+ (Class)resolutionCountType;	// IMP=0x00100000004eb4c5
+ (Class)reconfigurationsType;	// IMP=0x00100000004eb4b4
- (void).cxx_destruct;	// IMP=0x00000000004eb3d9
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000004eabb0
- (unsigned long long)hash;	// IMP=0x00000000004ea8d5
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000004ea486
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000004e9e7f
- (void)copyTo:(id)arg1;	// IMP=0x00000000004e9abe
- (void)writeTo:(id)arg1;	// IMP=0x00000000004e9624
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000004e8c30
- (id)dictionaryRepresentation;	// IMP=0x00000000004e81e0
- (id)description;	// IMP=0x00000000004e8131
- (id)resolutionCountAtIndex:(unsigned long long)arg1;	// IMP=0x00000000004e8114
- (unsigned long long)resolutionCountsCount;	// IMP=0x00000000004e80f7
- (void)addResolutionCount:(id)arg1;	// IMP=0x00000000004e808d
- (void)clearResolutionCounts;	// IMP=0x00000000004e8070
- (int)StringAsResolutionOnClose:(id)arg1;	// IMP=0x00000000004e7ecc
- (id)resolutionOnCloseAsString:(int)arg1;	// IMP=0x00000000004e7e81
...
- (id)reconfigurationsAtIndex:(unsigned long long)arg1;	// IMP=0x00000000004e7c32
- (unsigned long long)reconfigurationsCount;	// IMP=0x00000000004e7c15
- (void)addReconfigurations:(id)arg1;	// IMP=0x00000000004e7bab
- (void)clearReconfigurations;	// IMP=0x00000000004e7b8e
...
- (int)StringAsCertified:(id)arg1;	// IMP=0x00000000004e79a2
- (id)certifiedAsString:(int)arg1;	// IMP=0x00000000004e795a
