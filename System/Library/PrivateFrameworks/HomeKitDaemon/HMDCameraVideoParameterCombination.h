...
- (void).cxx_destruct;	// IMP=0x00000000004e0e78
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000004e0c8a
- (id)description;	// IMP=0x00000000004e0bcd
- (id)initWithProfile:(id)arg1 level:(id)arg2 videoTier:(id)arg3;	// IMP=0x00000000004e0b03
