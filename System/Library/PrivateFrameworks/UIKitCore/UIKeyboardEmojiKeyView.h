...
- (void).cxx_destruct;	// IMP=0x0000000000c936fe
...
- (long long)updateToCategoryWithOffsetPercentage:(double)arg1;	// IMP=0x0000000000c936c9
- (void)updateToCategory:(long long)arg1;	// IMP=0x0000000000c936c3
