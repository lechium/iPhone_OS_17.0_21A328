...
+ (id)productLockupViewWithMedia:(id)arg1;	// IMP=0x0010000000227639
- (void).cxx_destruct;	// IMP=0x000000000022c0f5
...
- (id)_contentDescriptionFont;	// IMP=0x000000000022bd96
- (struct CGSize)_layoutForStacked:(struct CGSize)arg1 metricsOnly:(_Bool)arg2;	// IMP=0x000000000022aff8
- (struct CGSize)_layoutForCompact:(struct CGSize)arg1 metricsOnly:(_Bool)arg2;	// IMP=0x000000000022a390
- (struct CGSize)_layoutForCategoryAccessibility:(struct CGSize)arg1 metricsOnly:(_Bool)arg2;	// IMP=0x0000000000229d79
- (struct CGSize)_layoutWithSize:(struct CGSize)arg1 metricsOnly:(_Bool)arg2;	// IMP=0x0000000000229b64
- (double)_descriptionBottomMarginWithBaselineMargin:(double)arg1;	// IMP=0x0000000000229ae1
- (double)_descriptionTopMarginWithBaselineMargin:(double)arg1 otherFont:(id)arg2;	// IMP=0x0000000000229a1d
- (struct CGSize)_sizeOfDescriptionLabel:(double)arg1;	// IMP=0x0000000000229883
- (id)_contentDescriptionAttributedString;	// IMP=0x00000000002295ad
- (void)_updateSubtitleLabelForWindowWidth:(double)arg1;	// IMP=0x0000000000229500
- (void)rentalExpirationLabelNeedsRelayout:(id)arg1;	// IMP=0x00000000002294cf
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000002294b8
- (void)layoutSubviews;	// IMP=0x0000000000229425
- (void)setCoverArtImageProxy:(id)arg1 placeholderImage:(id)arg2;	// IMP=0x0000000000228b73
- (void)updateWithMediaEntity:(id)arg1;	// IMP=0x0000000000227ab1
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000002276ba
