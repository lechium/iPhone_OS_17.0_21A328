...
- (void)requestMediaDataIfNecessary;	// IMP=0x00000000000b8a4c
@property __weak id <AVAssetWriterInputMediaDataRequesterDelegate> delegate;
- (void)dealloc;	// IMP=0x00000000000b883b
- (void)_collectUncollectables_invokedFromDeallocAndFinalize;	// IMP=0x00000000000b880d
- (id)init;	// IMP=0x00000000000b87f7
- (id)initWithRequestQueue:(id)arg1 requestBlock:(CDUnknownBlockType)arg2;	// IMP=0x00000000000b86d3
