...
- (void).cxx_destruct;	// IMP=0x000000000005787c
...
- (id)featureValueForName:(id)arg1;	// IMP=0x00000000000576d6
@property(readonly, nonatomic) NSSet *featureNames;
- (id)initWithIn:(id)arg1 lstm_1_h_in:(id)arg2 lstm_1_c_in:(id)arg3;	// IMP=0x00000000000575fe
- (id)initWithIn:(id)arg1;	// IMP=0x00000000000575e7
