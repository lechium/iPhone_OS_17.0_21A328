...
- (void).cxx_destruct;	// IMP=0x0020000000014c91
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000001484b
- (unsigned long long)hash;	// IMP=0x00100000000147d0
- (id)copy;	// IMP=0x0010000000014771
- (id)initWithType:(int)arg1 usageString:(id)arg2 usageBool:(id)arg3 appId:(id)arg4 createTime:(id)arg5;	// IMP=0x001000000001466c
