...
- (void).cxx_destruct;	// IMP=0x00000000008d907d
...
- (void)assertionActivationStateChangedToState:(_Bool)arg1 forType:(unsigned long long)arg2;	// IMP=0x00000000008d8e69
- (_Bool)assertionActivationStateForType:(unsigned long long)arg1;	// IMP=0x00000000008d8e54
- (void)backgroundLumaView:(id)arg1 didTransitionToLevel:(unsigned long long)arg2;	// IMP=0x00000000008d8c07
- (void)_getPointerRegion:(inout id *)arg1 andStyle:(inout id *)arg2 atLocation:(struct CGPoint)arg3 inWindow:(id)arg4;	// IMP=0x00000000008d87e5
- (id)_psPointerShapeFromUIPointerShape:(id)arg1 atScale:(double)arg2;	// IMP=0x00000000008d85c3
- (id)_pointerShapeForStyle:(id)arg1 region:(id)arg2;	// IMP=0x00000000008d843c
- (id)_hoverRegionWithStyle:(id)arg1 forRegion:(id)arg2;	// IMP=0x00000000008d750c
- (id)_coordinateSpaceSourceViewForRegion:(id)arg1 withStyle:(id)arg2;	// IMP=0x00000000008d73cb
- (void)_preparePointerPortalSourceCollectionWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00000000008d6b52
- (void)_prepareContentMatchMoveSourceForPointerRegion:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000000008d65c6
- (void)_performTransactionUsingBlock:(CDUnknownBlockType)arg1;	// IMP=0x00000000008d64c0
- (void)_performNextTransaction;	// IMP=0x00000000008d632e
- (void)pointerClientControllerClientInteractionStateDidChange:(id)arg1;	// IMP=0x00000000008d61e7
- (void)pointerClientControllerWillDecelerate:(id)arg1 targetPointerPosition:(inout struct CGPoint *)arg2 velocity:(struct CGPoint)arg3 inContextID:(unsigned int)arg4 cursorRegionLookupRadius:(double)arg5 cursorRegionLookupResolution:(double)arg6 lookupConeAngle:(double)arg7;	// IMP=0x00000000008d596b
- (void)pointerClientController:(id)arg1 didInvalidatePortalSourceCollections:(id)arg2 matchMoveSources:(id)arg3;	// IMP=0x00000000008d57d8
- (id)obtainPointerUpdatePauseAssertion;	// IMP=0x00000000008d577b
- (void)endScrollingWithRegion:(id)arg1;	// IMP=0x00000000008d540d
- (void)beginScrollingWithRegion:(id)arg1;	// IMP=0x00000000008d5174
- (void)_notifyPointerStateDidChange;	// IMP=0x00000000008d50f3
@property(readonly, nonatomic) long long pointerState;
- (void)_clearMatchMoveSourceForRegion:(id)arg1 immediately:(_Bool)arg2;	// IMP=0x00000000008d4e23
- (void)_setActiveHoverRegion:(id)arg1 style:(id)arg2 forPointerRegion:(id)arg3 transactionID:(unsigned long long)arg4 completion:(CDUnknownBlockType)arg5;	// IMP=0x00000000008d4a98
- (void)exitRegion:(id)arg1 removeStyle:(_Bool)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x00000000008d4878
- (void)applyStyle:(id)arg1 forRegion:(id)arg2 effectSourceHandler:(CDUnknownBlockType)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x00000000008d3e6f
- (id)init;	// IMP=0x00000000008d3dfd
