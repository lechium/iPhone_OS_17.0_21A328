...
+ (id)logCategory;	// IMP=0x0010000000b142f8
- (void).cxx_destruct;	// IMP=0x0000000000b13f1c
...
- (id)attributeDescriptions;	// IMP=0x0000000000b13c0e
- (_Bool)_isCancelledError:(id)arg1;	// IMP=0x0000000000b13b84
- (void)_handleFatalOperationFailure;	// IMP=0x0000000000b139a9
- (void)_startNextOperation;	// IMP=0x0000000000b13870
- (void)_operationCompleted:(id)arg1 finalizeOnError:(_Bool)arg2 future:(id)arg3;	// IMP=0x0000000000b135e5
- (id)_addOperation:(id)arg1 finalizeClipOnError:(_Bool)arg2;	// IMP=0x0000000000b13349
- (id)_createClipWithSignificantEvent:(id)arg1 homePresenceByPairingIdentity:(id)arg2;	// IMP=0x0000000000b1317c
- (id)_createClip;	// IMP=0x0000000000b12ff5
- (_Bool)hasAddedCreateClipOperation;	// IMP=0x0000000000b12fc2
- (id)finish;	// IMP=0x0000000000b12ec6
- (id)addVideoSegmentData:(id)arg1 duration:(double)arg2 timeOffsetWithinClip:(double)arg3 clipFinalizedBecauseMaxDurationExceeded:(_Bool)arg4;	// IMP=0x0000000000b12bbe
- (id)addVideoInitData:(id)arg1;	// IMP=0x0000000000b12924
- (id)addNotificationForSignificantEvent:(id)arg1 homePresenceByPairingIdentity:(id)arg2;	// IMP=0x0000000000b125da
- (id)createClip;	// IMP=0x0000000000b123eb
- (id)initWithClipUUID:(id)arg1 startDate:(id)arg2 targetFragmentDuration:(double)arg3 quality:(long long)arg4 localZone:(id)arg5 workQueue:(id)arg6 logIdentifier:(id)arg7 encryptionManager:(id)arg8 factory:(id)arg9;	// IMP=0x0000000000b1212b
- (id)initWithClipUUID:(id)arg1 startDate:(id)arg2 targetFragmentDuration:(double)arg3 quality:(long long)arg4 localZone:(id)arg5 workQueue:(id)arg6 logIdentifier:(id)arg7;	// IMP=0x0000000000b12014
