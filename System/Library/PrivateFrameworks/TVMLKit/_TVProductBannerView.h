...
+ (id)productBannerViewWithElement:(id)arg1 existingView:(id)arg2;	// IMP=0x00100000000be113
- (void).cxx_destruct;	// IMP=0x00000000000bf3a2
...
- (id)impressionableElementsContainedInDocument:(id)arg1;	// IMP=0x00000000000bf1a1
- (void)layoutSubviews;	// IMP=0x00000000000bebd7
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000000bebc5
- (id)preferredFocusEnvironments;	// IMP=0x00000000000be8f4
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000000be89a
