...
- (void).cxx_destruct;	// IMP=0x000000000042864e
...
- (void)endSimulationWithError:(id)arg1;	// IMP=0x000000000042843d
- (void)updateSimulationWithProgress:(double)arg1;	// IMP=0x0000000000428399
- (void)_handleResultImage:(id)arg1 info:(id)arg2;	// IMP=0x0000000000428224
- (id)init;	// IMP=0x0000000000428173
