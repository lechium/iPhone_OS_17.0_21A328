...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001133cd
- (id)description;	// IMP=0x00000000001133b9
- (id)formattedDescription:(unsigned long long)arg1;	// IMP=0x00000000001131cd
- (void)dealloc;	// IMP=0x0000000000113183
- (id)initWithAirMDType:(id)arg1 dataType:(unsigned long long)arg2 pixelFormat:(unsigned long long)arg3 aluType:(unsigned long long)arg4 name:(id)arg5 offset:(unsigned long long)arg6;	// IMP=0x00000000001130fd
