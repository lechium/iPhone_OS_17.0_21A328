...
- (void)createConnection;	// IMP=0x0000000000038896
- (void)didSmoothLocations:(id)arg1 ofType:(id)arg2;	// IMP=0x00000000000387d0
- (void)dealloc;	// IMP=0x0000000000038741
- (id)initWithCLLocationSmoother:(id)arg1;	// IMP=0x0000000000038638
