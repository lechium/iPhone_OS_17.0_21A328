...
+ (id)logCategory;	// IMP=0x001000000094722d
- (void).cxx_destruct;	// IMP=0x00000000009464b4
...
- (id)importClipsWithImportData:(id)arg1;	// IMP=0x0000000000945892
- (id)initWithLocalZone:(id)arg1 cameraProfileUUID:(id)arg2;	// IMP=0x0000000000945719
