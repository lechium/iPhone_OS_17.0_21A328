...
- (void).cxx_destruct;	// IMP=0x000000000032420c
...
- (id)initWithMessageName:(id)arg1 qualityOfService:(long long)arg2 responseHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000000003240cb
