...
- (id)intervalForValue:(unsigned long long)arg1;	// IMP=0x00000000000029c2
- (id)intervalIndexForValue:(unsigned long long)arg1;	// IMP=0x0000000000002840
- (id)initWithBins:(id)arg1 intervalCreationBlock:(CDUnknownBlockType)arg2 valueComparisonBlock:(CDUnknownBlockType)arg3;	// IMP=0x0000000000002576
