...
- (void).cxx_destruct;	// IMP=0x00000000000c65b1
...
- (id)loadPage;	// IMP=0x00000000000c6468
@property(readonly, nonatomic) _Bool disableReappearPlaceholder;
- (id)createViewControllerForContainer:(id)arg1;	// IMP=0x00000000000c62aa
@property(readonly, copy) NSString *description;
- (id)initWithJSObject:(id)arg1 context:(id)arg2;	// IMP=0x00000000000c5965
