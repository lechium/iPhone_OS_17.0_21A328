...
- (void).cxx_destruct;	// IMP=0x0000000000286f32
...
- (void)removeServiceType:(id)arg1;	// IMP=0x0000000000286e78
- (void)addServiceType:(id)arg1;	// IMP=0x0000000000286e0f
- (void)removePlacement:(id)arg1;	// IMP=0x0000000000286da6
- (void)addPlacements:(id)arg1;	// IMP=0x0000000000286d3d
@property(readonly, nonatomic) NSSet *serviceTypes;
@property(readonly, nonatomic) NSSet *placements;
- (id)initWithQueue:(id)arg1;	// IMP=0x0000000000286ba0
