...
- (void).cxx_destruct;	// IMP=0x0000000000272231
...
- (void)setBackgroundColor:(id)arg1;	// IMP=0x00000000002720ae
- (void)drawRect:(struct CGRect)arg1;	// IMP=0x0000000000271ea7
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000271e04
