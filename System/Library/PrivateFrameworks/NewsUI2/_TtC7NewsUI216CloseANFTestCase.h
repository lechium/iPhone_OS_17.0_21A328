...
- (void).cxx_destruct;	// IMP=0x000000000070ca10
- (id)init;	// IMP=0x000000000070c910
- (void)runTestWithContext:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000000070c880
