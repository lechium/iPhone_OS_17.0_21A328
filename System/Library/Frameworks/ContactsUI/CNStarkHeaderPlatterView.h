...
- (void).cxx_destruct;	// IMP=0x000000000028bcd7
...
- (void)_updateForFocusedState:(_Bool)arg1;	// IMP=0x000000000028ba94
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x000000000028b994
- (_Bool)canBecomeFocused;	// IMP=0x000000000028b98c
- (id)initWithLabelText:(id)arg1 accessoryImage:(id)arg2;	// IMP=0x000000000028b309
