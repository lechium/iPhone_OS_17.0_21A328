...
+ (id)logCategory;	// IMP=0x001000000032a24a
+ (unsigned long long)entitlementsForConnection:(id)arg1;	// IMP=0x0010000000329eb8
- (void).cxx_destruct;	// IMP=0x0000000000328ec2
...
- (void)sendMessage:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000328c5a
- (void)updateUserInfo:(id)arg1;	// IMP=0x0000000000328990
- (void)handleMessage:(id)arg1 responseHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000000032897e
- (void)handleMessage:(id)arg1;	// IMP=0x000000000032896a
- (void)initiateRefresh;	// IMP=0x00000000003288ca
- (void)deactivate;	// IMP=0x0000000000328878
- (void)activateWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000000032865a
- (void)_handleMessage:(id)arg1 responseHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000327cef
- (_Bool)canSendMessage:(id)arg1;	// IMP=0x000000000032706d
- (_Bool)shouldSendResponseForMessageIdentifier:(id)arg1;	// IMP=0x0000000000326feb
@property(readonly, nonatomic) NSSet *activeRequests;
- (void)updateSendPolicyParameters:(id)arg1;	// IMP=0x0000000000326e9f
...
- (void)__handleApplicationStateChange:(id)arg1;	// IMP=0x0000000000326bdb
...
- (id)_displayName;	// IMP=0x0000000000326816
...
- (id)counterIdentifierForMessage:(id)arg1;	// IMP=0x0000000000326379
...
- (id)attributeDescriptions;	// IMP=0x0000000000326085
- (id)shortDescription;	// IMP=0x0000000000325f9c
- (void)dealloc;	// IMP=0x0000000000325e49
- (id)initWithConnection:(id)arg1 counterTracker:(id)arg2;	// IMP=0x0000000000325bd4
