...
- (void).cxx_destruct;	// IMP=0x00000000002e95ec
...
- (id)relevantZoneIDs;	// IMP=0x00000000002e931d
- (void)_finishOnCallbackQueueWithError:(id)arg1;	// IMP=0x00000000002e8f7b
- (void)main;	// IMP=0x00000000002e8acc
- (int)operationType;	// IMP=0x00000000002e8ac1
- (void)_handleRecordVersionsFetchedForID:(id)arg1 isDeleted:(_Bool)arg2 versions:(id)arg3 responseCode:(id)arg4;	// IMP=0x00000000002e7d90
- (_Bool)hasDecryptOperation;	// IMP=0x00000000002e7d4f
@property(readonly, nonatomic) CKDDecryptRecordsOperation *recordDecryptOperation;
- (id)activityCreate;	// IMP=0x00000000002e7ad9
- (id)initWithOperationInfo:(id)arg1 container:(id)arg2;	// IMP=0x00000000002e78df
