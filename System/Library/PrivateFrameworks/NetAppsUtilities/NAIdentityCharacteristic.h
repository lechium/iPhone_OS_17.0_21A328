...
- (void).cxx_destruct;	// IMP=0x000000000001ef70
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000001ec3f
@property(readonly) unsigned long long hash;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000001eafb
- (id)init;	// IMP=0x000000000001ea7a
