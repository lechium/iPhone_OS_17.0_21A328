...
+ (id)logCategory;	// IMP=0x001000000029432e
+ (void)_clearAllPendingRequests:(id)arg1 error:(id)arg2;	// IMP=0x001000000029420c
+ (void)_clearAllGeneratedRequests:(id)arg1 error:(id)arg2;	// IMP=0x0010000000293fb0
+ (id)createResponseSubset:(id)arg1 overallError:(id)arg2 readRequest:(id)arg3 error:(id *)arg4;	// IMP=0x00100000002936b5
+ (void)_processResponseForMultireadRequest:(id)arg1 overallError:(id)arg2 response:(id)arg3;	// IMP=0x0010000000293179
- (void).cxx_destruct;	// IMP=0x00000000002926c0
...
- (id)logIdentifier;	// IMP=0x0000000000292599
- (void)_processResponse:(id)arg1 overallError:(id)arg2 messageIdentifier:(id)arg3;	// IMP=0x00000000002920b2
- (void)_sendMultipleCharacteristicRead;	// IMP=0x000000000029121f
- (void)timerDidFire:(id)arg1;	// IMP=0x0000000000291167
- (void)redispatchMessage:(id)arg1 target:(id)arg2 responseQueue:(id)arg3;	// IMP=0x0000000000291057
- (long long)preferredDeviceType;	// IMP=0x0000000000290f5d
@property(readonly, nonatomic) HMDDevice *preferredDevice;
- (id)deviceForType:(long long)arg1;	// IMP=0x0000000000290ea5
- (_Bool)containsDevice:(id)arg1;	// IMP=0x0000000000290cb4
- (void)removeDeviceForType:(long long)arg1;	// IMP=0x0000000000290ad7
- (void)setDevice:(id)arg1 forType:(long long)arg2;	// IMP=0x00000000002909e4
@property(readonly, copy) NSString *description;
- (void)dealloc;	// IMP=0x000000000029079a
- (id)initWithHome:(id)arg1 remoteDispatcher:(id)arg2;	// IMP=0x0000000000290605
