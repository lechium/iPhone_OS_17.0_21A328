...
- (void).cxx_destruct;	// IMP=0x00200000000534ca
...
- (id)commitConfiguration;	// IMP=0x001000000005345c
- (id)initWithCoordinator:(id)arg1 config:(id)arg2;	// IMP=0x00100000000531d2
