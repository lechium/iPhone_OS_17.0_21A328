...
+ (id)customAttributes;	// IMP=0x0060000000149743
- (id).cxx_construct;	// IMP=0x0000000000149fde
...
- (id)outputImage;	// IMP=0x0000000000149e70
@property(readonly, nonatomic) CIFilter *outputRotationFilter;
@property(readonly, nonatomic) CDStruct_d80e62f2 outputTransform;
- (void)computeRotation;	// IMP=0x0000000000149b3d
- (void)computeCameraIntrinsics;	// IMP=0x00000000001499c6
