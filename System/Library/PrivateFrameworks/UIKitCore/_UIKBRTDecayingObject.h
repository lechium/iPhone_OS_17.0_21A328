...
- (void).cxx_destruct;	// IMP=0x0000000000e05f25
...
- (void)onResetDo:(CDUnknownBlockType)arg1;	// IMP=0x0000000000e05e23
- (void)resetActiveDecayTo:(double)arg1;	// IMP=0x0000000000e05e03
- (void)startOrUpdateDecay;	// IMP=0x0000000000e05dd7
- (void)updateDecay;	// IMP=0x0000000000e05d92
- (void)reset;	// IMP=0x0000000000e05d5c
- (void)resetDecayTo:(double)arg1;	// IMP=0x0000000000e05d05
@property(readonly, nonatomic) _Bool isActive;
- (void)startDecaying;	// IMP=0x0000000000e05cc2
- (id)initWithTimeoutDuration:(double)arg1;	// IMP=0x0000000000e05c7f
