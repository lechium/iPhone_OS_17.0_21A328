...
- (void).cxx_destruct;	// IMP=0x0000000000d38af0
- (unsigned long long)hash;	// IMP=0x0000000000d389e4
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000d3882e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000d38385
- (void)writeTo:(id)arg1;	// IMP=0x0000000000d37f76
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000d37f67
- (id)jsonRepresentation;	// IMP=0x0000000000d37700
- (id)dictionaryRepresentation;	// IMP=0x0000000000d36dab
- (id)description;	// IMP=0x0000000000d36cfc
- (id)initWithData:(id)arg1;	// IMP=0x0000000000d3595c
- (id)init;	// IMP=0x0000000000d35900
- (id)publisherDescription;	// IMP=0x0000000000a9d9a5
