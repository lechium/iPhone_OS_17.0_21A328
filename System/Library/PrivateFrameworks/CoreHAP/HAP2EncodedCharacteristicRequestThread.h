...
- (void).cxx_destruct;	// IMP=0x00000000000678af
- (id)serialize;	// IMP=0x00000000000677c9
...
- (id)initWithBTLERequests:(id)arg1 requestType:(unsigned long long)arg2 enforcePDUBodyLength:(_Bool)arg3;	// IMP=0x0000000000067563
