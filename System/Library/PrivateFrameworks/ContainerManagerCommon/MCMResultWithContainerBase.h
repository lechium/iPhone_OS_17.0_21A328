...
- (void).cxx_destruct;	// IMP=0x000000000008dd12
...
- (id)initWithMetadata:(id)arg1 sandboxToken:(const char *)arg2 includePath:(_Bool)arg3 includeInfo:(_Bool)arg4 includeUserManagedAssetsRelPath:(_Bool)arg5;	// IMP=0x000000000008d6aa
- (id)initWithContainerPath:(id)arg1 containerIdentity:(id)arg2 uuid:(id)arg3 sandboxToken:(const char *)arg4 includePath:(_Bool)arg5;	// IMP=0x000000000008d4a0
- (id)initWithUUID:(id)arg1 containerPathIdentifier:(id)arg2 identifier:(id)arg3 containerClass:(unsigned long long)arg4 POSIXUser:(id)arg5 personaUniqueString:(id)arg6 sandboxToken:(const char *)arg7 existed:(_Bool)arg8 url:(id)arg9 info:(id)arg10 transient:(_Bool)arg11 userManagedAssetsRelPath:(id)arg12;	// IMP=0x000000000008d271
- (_Bool)encodeResultOntoReply:(id)arg1;	// IMP=0x000000000008ce87
