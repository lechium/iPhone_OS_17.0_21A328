...
- (void).cxx_destruct;	// IMP=0x0000000000e554e5
...
- (id)meshTransformForKeyplane:(id)arg1 toKeyplane:(id)arg2;	// IMP=0x0000000000e53589
- (id)symmetricMeshTransformForKeyplane:(id)arg1;	// IMP=0x0000000000e519fd
- (_Bool)_allowFacesToAdjoinToAdjacentFaces;	// IMP=0x0000000000e51995
- (id)geometriesForKeyplane:(id)arg1;	// IMP=0x0000000000e51961
- (id)sortedCommonVisibleKeys;	// IMP=0x0000000000e517eb
- (void)updateOpacityAnimation:(id)arg1;	// IMP=0x0000000000e5160b
- (void)updateWithProgress:(double)arg1;	// IMP=0x0000000000e513fc
- (void)removeAllAnimations;	// IMP=0x0000000000e512d1
- (void)_updateTransition;	// IMP=0x0000000000e5110a
- (id)_animationsForEnd;	// IMP=0x0000000000e50b47
- (id)_animationsForStart;	// IMP=0x0000000000e50575
- (void)commitTransitionRebuild;	// IMP=0x0000000000e504b5
- (void)rebuildWithStartKeyplane:(id)arg1 startView:(id)arg2 endKeyplane:(id)arg3 endView:(id)arg4;	// IMP=0x0000000000e50052
- (void)dealloc;	// IMP=0x0000000000e50009
