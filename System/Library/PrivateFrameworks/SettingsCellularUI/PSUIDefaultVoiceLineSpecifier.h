...
- (void).cxx_destruct;	// IMP=0x000000000000ac19
...
- (id)getLogger;	// IMP=0x000000000000ab40
- (id)subscriptionContextForListItem:(id)arg1;	// IMP=0x000000000000aace
- (id)planItemForListItem:(id)arg1;	// IMP=0x000000000000a962
- (void)setDefaultVoiceLine:(id)arg1 specifier:(id)arg2;	// IMP=0x000000000000a650
- (id)defaultVoiceLine:(id)arg1;	// IMP=0x000000000000a4a6
@property(readonly, nonatomic) _Bool isSubcontrollerNeeded;
- (void)updateCachedState;	// IMP=0x000000000000a186
- (id)initWithPlanManagerCache:(id)arg1 planManager:(id)arg2 simStatusCache:(id)arg3;	// IMP=0x000000000000a00b
- (id)initSpecifier;	// IMP=0x0000000000009f5c
