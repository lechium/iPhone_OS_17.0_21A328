...
- (void).cxx_destruct;	// IMP=0x00200000005e6931
...
- (void)resolveAddressString:(id)arg1;	// IMP=0x00100000005e63c7
- (void)resolveAddress:(id)arg1;	// IMP=0x00100000005e62da
- (void)resolveNearestTransitStationForLabelMarker:(id)arg1;	// IMP=0x00100000005e5b4c
- (void);	// IMP=0x00100000005e53bd
- (void)resolveLabelMarker:(id)arg1;	// IMP=0x00100000005e4f38
- (void)_addCancelationHandler:(CDUnknownBlockType)arg1;	// IMP=0x00100000005e4e6e
- (void)cancel;	// IMP=0x00100000005e4cec
- (void)startWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00100000005e4c1d
- (id)traits;	// IMP=0x00100000005e4b78
- (id)initWithMapItem:(id)arg1;	// IMP=0x00100000005e4ab2
- (id)initWithAddressString:(id)arg1;	// IMP=0x00100000005e49ec
- (id)initWithAddress:(id)arg1;	// IMP=0x00100000005e4926
- (id)initWithLabelMarker:(id)arg1;	// IMP=0x00100000005e4860
- (id)init;	// IMP=0x00100000005e4811
