...
@interface _TtC8MapsSync29MapsSyncHistoryDirectionsItem (HistoryEntryRecentsItem)
- (void)ifSearch:(CDUnknownBlockType)arg1 ifRoute:(CDUnknownBlockType)arg2 ifPlaceDisplay:(CDUnknownBlockType)arg3 ifTransitLineItem:(CDUnknownBlockType)arg4;	// IMP=0x00200000007b1bd8
@property(readonly, nonatomic) NSData *archivedSharedTripData;
@property(readonly, nonatomic) _Bool navigationWasInterrupted;
- (id)routeInformationSource;	// IMP=0x00100000007b1b7e
