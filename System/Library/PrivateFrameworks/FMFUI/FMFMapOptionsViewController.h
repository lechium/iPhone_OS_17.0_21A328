...
- (void)segmentedControlChanged:(id)arg1;	// IMP=0x0000000000018e51
- (void)attributionButtonPressed:(id)arg1;	// IMP=0x0000000000018d63
- (void)openInMaps:(id)arg1;	// IMP=0x0000000000018b30
- (void)viewDidLoad;	// IMP=0x0000000000018924
- (struct CGSize)paneSize;	// IMP=0x00000000000188ba
- (void)_dismiss:(id)arg1;	// IMP=0x000000000001886e
- (void)awakeFromNib;	// IMP=0x000000000001883f
- (id)init;	// IMP=0x00000000000187c7
