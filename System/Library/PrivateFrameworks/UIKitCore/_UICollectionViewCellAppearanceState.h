...
- (id)description;	// IMP=0x000000000048d401
- (void)didEnd;	// IMP=0x000000000048d3ea
@property(readonly, nonatomic) _Bool hasBeganDroppingInto;
@property(readonly, nonatomic) _Bool enrouteToOrReachedTerminalState;
- (void)didCompleteDropping;	// IMP=0x000000000048d344
- (void)didCompleteCancelling;	// IMP=0x000000000048d32d
- (void)didBeginCancelling;	// IMP=0x000000000048d316
- (void)willBeginCancelling;	// IMP=0x000000000048d2ff
- (void)didBeginDroppingInto;	// IMP=0x000000000048d2e8
- (void)didBeginDropping;	// IMP=0x000000000048d2d1
- (void)didMove;	// IMP=0x000000000048d2ba
- (void)didCompleteLift;	// IMP=0x000000000048d282
- (void)didBeginLift;	// IMP=0x000000000048d26b
@property(readonly, nonatomic) long long appearance;
- (id)init;	// IMP=0x000000000048d20f
