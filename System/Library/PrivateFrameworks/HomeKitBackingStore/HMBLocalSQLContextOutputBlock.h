...
+ (id)logCategory;	// IMP=0x001000000007297a
- (void).cxx_destruct;	// IMP=0x0000000000072712
...
- (id)logIdentifier;	// IMP=0x0000000000072651
- (id)abort;	// IMP=0x00000000000721b5
- (id)commit:(id)arg1;	// IMP=0x0000000000071c87
- (id)updateModelID:(id)arg1 modelEncoding:(unsigned long long)arg2 modelData:(id)arg3;	// IMP=0x0000000000071934
- (id)initWithOwner:(id)arg1 identifier:(id)arg2 zoneRow:(unsigned long long)arg3 blockRow:(unsigned long long)arg4;	// IMP=0x00000000000716a9
