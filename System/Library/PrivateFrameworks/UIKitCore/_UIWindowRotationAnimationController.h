...
- (void).cxx_destruct;	// IMP=0x00000000006645ac
...
- (void)animateTransition:(id)arg1;	// IMP=0x0000000000663c7f
- (double)transitionDuration:(id)arg1;	// IMP=0x0000000000663c6d
- (void)dealloc;	// IMP=0x0000000000663c2d
