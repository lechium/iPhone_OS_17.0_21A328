...
- (void).cxx_destruct;	// IMP=0x00000000000725c6
...
- (void)vui_prepareForReuse;	// IMP=0x0000000000072453
- (struct CGSize)vui_layoutSubviews:(struct CGSize)arg1 computationOnly:(_Bool)arg2;	// IMP=0x00000000000710a9
- (void)vui_setHighlighted:(_Bool)arg1;	// IMP=0x000000000007104a
- (void)setHighlighted:(_Bool)arg1;	// IMP=0x0000000000071001
- (void)setSemanticContentAttribute:(long long)arg1;	// IMP=0x0000000000070f7b
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000070bf4
