...
- (void)sendMessages;	// IMP=0x0000000000022ea5
- (void)main;	// IMP=0x0000000000022e93
- (_Bool)isAsynchronous;	// IMP=0x0000000000022e8b
- (id)initWithIDSPrimitives:(id)arg1 workQueue:(id)arg2 messages:(id)arg3 destinationAddress:(id)arg4 sourceAppleID:(id)arg5 options:(id)arg6;	// IMP=0x0000000000022cfb
