...
+ (id)logCategory;	// IMP=0x0010000000b2f68d
+ (id)processInfoWithConnection:(id)arg1;	// IMP=0x0010000000b2f594
+ (id)privateClientIdentifierSalt;	// IMP=0x0010000000b2f564
+ (_Bool)automaticallyNotifiesObserversForKey:(id)arg1;	// IMP=0x0010000000b2f4fa
- (void).cxx_destruct;	// IMP=0x0000000000b2f13b
...
- (id)logIdentifier;	// IMP=0x0000000000b2f058
- (id)clientIdentifierSalt:(id *)arg1;	// IMP=0x0000000000b2ef26
- (void)removeConnection:(id)arg1;	// IMP=0x0000000000b2eea8
- (void)addConnection:(id)arg1;	// IMP=0x0000000000b2ec51
...
- (void)_updateProcessState:(id)arg1;	// IMP=0x0000000000b2e1ca
@property(readonly) _Bool shouldMonitor;
- (id)attributeDescriptions;	// IMP=0x0000000000b2df25
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000b2ddfc
- (id)initWithIdentifier:(int)arg1;	// IMP=0x0000000000b2dbc6
- (id)initWithAuditToken:(CDStruct_6ad76789)arg1;	// IMP=0x0000000000b2d7a1
- (id)init;	// IMP=0x0000000000b2d6f9
