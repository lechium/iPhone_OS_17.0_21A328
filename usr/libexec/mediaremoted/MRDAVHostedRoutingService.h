...
- (void).cxx_destruct;	// IMP=0x00200000000506b8
...
- (void)collectDiagnostic:(id)arg1;	// IMP=0x0010000000050508
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x0010000000050341
- (void)hostedDiscoverySessionDidInvalidate:(id)arg1;	// IMP=0x0010000000050295
- (id)endpointForDeviceUID:(id)arg1;	// IMP=0x0010000000050010
- (id)endpointForOrigin:(id)arg1;	// IMP=0x001000000004fbca
@property(readonly, nonatomic) NSXPCListenerEndpoint *xpcEndpoint;
- (id)init;	// IMP=0x001000000004faa7
