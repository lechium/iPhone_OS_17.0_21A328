...
- (void).cxx_destruct;	// IMP=0x0000000000201208
@property(readonly, nonatomic) CNUICoreContactEditingSession *editingSession; // @synthesize editingSession=_editingSession;
- (id)executeSaveWithConfiguration:(id)arg1 saveDelegate:(id)arg2;	// IMP=0x000000000020106d
- (id)initWithEditingSession:(id)arg1;	// IMP=0x0000000000200fef
- (id)init;	// IMP=0x0000000000200faf
