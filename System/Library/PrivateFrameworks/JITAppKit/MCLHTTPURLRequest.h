...
- (void)handleCompletion:(id)arg1;	// IMP=0x000000000001ba40
- (void)loadRequest:(id)arg1;	// IMP=0x000000000001b820
- (void)cancel;	// IMP=0x000000000001b7a0
- (void)sendText:(id)arg1;	// IMP=0x000000000001b710
- (void)sendData:(id)arg1;	// IMP=0x000000000001b580
- (void)send;	// IMP=0x000000000001b550
- (id)init;	// IMP=0x000000000001b4c0
