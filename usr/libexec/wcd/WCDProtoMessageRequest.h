...
- (void).cxx_destruct;	// IMP=0x002000000002793f
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000000277d7
- (unsigned long long)hash;	// IMP=0x00100000000276f7
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000027578
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000002745e
- (void)copyTo:(id)arg1;	// IMP=0x0010000000027380
- (void)writeTo:(id)arg1;	// IMP=0x0010000000027291
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000027284
- (id)dictionaryRepresentation;	// IMP=0x0010000000026cb9
- (id)description;	// IMP=0x0010000000026c0a
