...
+ (long long)content_typeForObject:(id)arg1;	// IMP=0x006000000019807f
+ (long long)content_typeForMutableObject:(id)arg1;	// IMP=0x0060000000197fcb
+ (Class)content_mutableClassForType:(long long)arg1;	// IMP=0x0060000000197f91
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000197a65
- (id)init;	// IMP=0x00000000001979d7
