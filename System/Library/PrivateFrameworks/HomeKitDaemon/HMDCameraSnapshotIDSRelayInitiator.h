...
+ (id)logCategory;	// IMP=0x0010000000b75265
- (void).cxx_destruct;	// IMP=0x0000000000b74d62
...
- (void)_callFileTransferFailed:(id)arg1;	// IMP=0x0000000000b74b77
- (void)sessionEnded:(id)arg1 withReason:(unsigned int)arg2 error:(id)arg3;	// IMP=0x0000000000b749c9
- (void)sessionStarted:(id)arg1;	// IMP=0x0000000000b7483d
- (void)session:(id)arg1 receivedInvitationCancelFromID:(id)arg2;	// IMP=0x0000000000b746c1
- (void)session:(id)arg1 receivedInvitationDeclineFromID:(id)arg2;	// IMP=0x0000000000b74545
- (void)session:(id)arg1 receivedInvitationAcceptFromID:(id)arg2;	// IMP=0x0000000000b74409
- (void)dealloc;	// IMP=0x0000000000b742a0
- (void)_startDataTransfer;	// IMP=0x0000000000b73fe4
- (void)sendIDSInvitation;	// IMP=0x0000000000b73b13
- (void)_sendData;	// IMP=0x0000000000b73a7a
- (void)sendData:(id)arg1;	// IMP=0x0000000000b73891
- (id)initWithSessionID:(id)arg1 logIdentifier:(id)arg2 workQueue:(id)arg3 device:(id)arg4 delegate:(id)arg5;	// IMP=0x0000000000b736f7
