...
- (void).cxx_destruct;	// IMP=0x000000000005ecc1
...
- (void)_openCommunicationSafetyLearnMoreLink;	// IMP=0x000000000005ec14
- (void)_turnOnCommunicationSafety:(id)arg1;	// IMP=0x000000000005eb9b
- (void)loadView;	// IMP=0x000000000005e9c2
- (id)initWithIntroductionModel:(id)arg1 childName:(id)arg2 continueHandler:(CDUnknownBlockType)arg3;	// IMP=0x000000000005e7d6
