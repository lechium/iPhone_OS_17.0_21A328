...
+ (id)statusString;	// IMP=0x00400000000694df
+ (id)cornerActionBTLEItemWithPayload:(id)arg1 device:(id)arg2 options:(id)arg3 optionBits:(unsigned int)arg4 scanner:(id)arg5 receiver:(id)arg6;	// IMP=0x0010000000063b9d
+ (id)cornerActionBTLEItemWithSFAdvertisement:(id)arg1 optionBits:(unsigned int)arg2 scanner:(id)arg3 receiver:(id)arg4;	// IMP=0x0010000000063a70
- (void).cxx_destruct;	// IMP=0x00200000000696d5
...
- (id)description;	// IMP=0x001000000006939d
- (void)setWhen:(id)arg1;	// IMP=0x0010000000069297
- (id)when;	// IMP=0x00100000000691c0
- (id)statusString;	// IMP=0x0010000000068c24
- (void)clearPayload;	// IMP=0x0010000000068a00
- (void)resignCurrent;	// IMP=0x0010000000068990
- (_Bool)requestPayloadWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x0010000000066766
- (_Bool)updateFromSFAdvertisement:(id)arg1;	// IMP=0x0010000000066200
- (id)initWithPayload:(id)arg1 device:(id)arg2 options:(id)arg3 optionBits:(unsigned int)arg4 type:(unsigned long long)arg5 activityType:(id)arg6 bundleIdentifier:(id)arg7 teamIDs:(id)arg8 advertisingOptions:(id)arg9 scanner:(id)arg10 receiver:(id)arg11;	// IMP=0x00100000000655c9
- (id)initWithPayload:(id)arg1 device:(id)arg2 options:(id)arg3 optionBits:(unsigned int)arg4 type:(unsigned long long)arg5 activityType:(id)arg6 bundleIdentifier:(id)arg7 teamIDs:(id)arg8 advertisingOptions:(id)arg9 scanner:(id)arg10 receiver:(id)arg11 dynamicIdentifier:(id)arg12;	// IMP=0x0010000000065525
