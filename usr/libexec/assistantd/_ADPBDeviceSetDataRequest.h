...
+ (Class)notificationPreviewRestrictedAppsType;	// IMP=0x002000000010b922
+ (unsigned short)_ADPBDeviceRequestType;	// IMP=0x00100000000adb60
- (void).cxx_destruct;	// IMP=0x002000000010b7bf
...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000010af22
- (unsigned long long)hash;	// IMP=0x001000000010aba6
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000010a627
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000010a055
- (void)copyTo:(id)arg1;	// IMP=0x0010000000109c63
- (void)writeTo:(id)arg1;	// IMP=0x0010000000109808
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000108f9d
- (id)dictionaryRepresentation;	// IMP=0x0010000000108977
- (id)description;	// IMP=0x00100000001088c8
...
- (id)notificationPreviewRestrictedAppsAtIndex:(unsigned long long)arg1;	// IMP=0x001000000010878e
- (unsigned long long)notificationPreviewRestrictedAppsCount;	// IMP=0x0010000000108771
- (void)addNotificationPreviewRestrictedApps:(id)arg1;	// IMP=0x0010000000108707
- (void)clearNotificationPreviewRestrictedApps;	// IMP=0x00100000001086ea
...
- (void)_ad_performWithSharedDataRemote:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00100000000cd729
- (void)_ad_performWithCloudService:(id)arg1 fromPeer:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x001000000014c847
