...
- (void).cxx_destruct;	// IMP=0x0000000000863e23
...
- (void)_setupAlternateTitlesFromBarButtonItem:(id)arg1;	// IMP=0x0000000000863618
- (id)_titleAlternativeForTitle:(id)arg1;	// IMP=0x00000000008634ef
- (_Bool)supportsBackButtons;	// IMP=0x00000000008634e7
- (void)updateButton:(id)arg1 forHighlightedState:(_Bool)arg2;	// IMP=0x00000000008634bc
- (void)updateButton:(id)arg1 forFocusedState:(_Bool)arg2;	// IMP=0x000000000086322f
- (void)buttonLayoutSubviews:(id)arg1 baseImplementation:(CDUnknownBlockType)arg2;	// IMP=0x0000000000862f11
- (void)configureButton:(id)arg1 fromBarButtonItem:(id)arg2;	// IMP=0x000000000086187b
- (void)_selectGestureChanged:(id)arg1;	// IMP=0x0000000000861815
- (void)configureButton:(id)arg1 withAppearanceDelegate:(id)arg2 fromBarItem:(id)arg3;	// IMP=0x000000000086177e
- (id)contentView;	// IMP=0x00000000008616ea
- (id)backIndicatorView;	// IMP=0x00000000008616d8
