...
- (void).cxx_destruct;	// IMP=0x002000000001a13f
...
- (void)clearRoutedCommands;	// IMP=0x001000000001a0c6
- (void)addRoutedCommand:(id)arg1;	// IMP=0x0010000000019ed2
@property(readonly, nonatomic) NSArray *routedCommands;
- (id)initWithContextID:(id)arg1 originatingAppDisplayID:(id)arg2;	// IMP=0x0010000000019cac
