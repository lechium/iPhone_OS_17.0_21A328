...
+ (id)sharedInstance;	// IMP=0x0060000000005ad1
...
- (void)_loadFMIPState;	// IMP=0x0000000000005e44
- (void)_loadLowBatteryState;	// IMP=0x0000000000005ce3
@property(readonly, nonatomic) _Bool fmipStateChangeInProgress;
@property(readonly, nonatomic) _Bool fmipEnabled;
- (id)init;	// IMP=0x0000000000005b26
