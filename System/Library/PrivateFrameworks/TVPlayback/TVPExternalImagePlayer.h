...
- (void).cxx_destruct;	// IMP=0x000000000001560d
...
- (double)_timeAfterRemovingInterstitials:(double)arg1;	// IMP=0x00000000000153f1
- (void)_updateImageIntervalWithRate:(double)arg1;	// IMP=0x000000000001531d
- (void)_cancelStaleImageLoadsForTime:(double)arg1;	// IMP=0x00000000000150e8
- (void)_cancelAllImageLoads;	// IMP=0x0000000000015054
- (void)_loadImagesIfNecessary;	// IMP=0x00000000000145d5
- (void)_displayLinkTimerFired:(id)arg1;	// IMP=0x000000000001419c
- (void)invalidate;	// IMP=0x0000000000014187
- (id)initWithMediaItem:(id)arg1 referenceTime:(CDStruct_1b6d18a9)arg2 forDate:(id)arg3;	// IMP=0x0000000000013d95
