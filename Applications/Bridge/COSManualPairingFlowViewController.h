...
- (void).cxx_destruct;	// IMP=0x002000000003fdf9
...
- (Class)pairingControllerClass;	// IMP=0x001000000003fd1a
- (void)controllerCancelled:(id)arg1;	// IMP=0x001000000003fce6
- (id)init;	// IMP=0x001000000003fbd3
