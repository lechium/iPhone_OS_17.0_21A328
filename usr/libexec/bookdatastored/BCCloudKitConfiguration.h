...
+ (id)configuration;	// IMP=0x00200000000164f7
...
- (_Bool)shouldPerformDatabaseSubscriptionForServiceMode:(_Bool)arg1;	// IMP=0x0010000000016780
- (_Bool)shouldArchiveData:(id)arg1;	// IMP=0x0010000000016778
