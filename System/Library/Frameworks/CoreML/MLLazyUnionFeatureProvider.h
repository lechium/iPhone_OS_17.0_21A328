...
- (void).cxx_destruct;	// IMP=0x00000000000bceba
...
- (id)unionFeatureProvider;	// IMP=0x00000000000bcba3
- (id)featureValueForName:(id)arg1;	// IMP=0x00000000000bcb03
@property(readonly, nonatomic) NSSet *featureNames;
- (id)initWithFeaturesFrom:(id)arg1 addedToFeaturesFrom:(id)arg2;	// IMP=0x00000000000bc9a3
