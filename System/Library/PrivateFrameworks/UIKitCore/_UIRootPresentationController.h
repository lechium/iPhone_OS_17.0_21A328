...
+ (_Bool)_allowsDeferredTransitions;	// IMP=0x00100000004e2a8c
- (void).cxx_destruct;	// IMP=0x00000000004e2aeb
...
- (id)_createVisualStyleForProvider:(id)arg1;	// IMP=0x00000000004e2a9c
- (_Bool)_mayChildGrabPresentedViewControllerView;	// IMP=0x00000000004e2a94
- (_Bool)_isRootPresentation;	// IMP=0x00000000004e2a84
- (void)willTransitionToTraitCollection:(id)arg1 withTransitionCoordinator:(id)arg2;	// IMP=0x00000000004e2999
...
- (id)_fullscreenPresentationSuperview;	// IMP=0x00000000004e2971
- (id)_parentTraitEnvironment;	// IMP=0x00000000004e295f
- (id)initWithPresentedViewController:(id)arg1 presentingWindow:(id)arg2;	// IMP=0x00000000004e28ec
