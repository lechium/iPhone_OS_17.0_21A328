...
+ (Class)payloadsType;	// IMP=0x00100000002fb886
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000002fccc7
- (unsigned long long)hash;	// IMP=0x00000000002fcbc9
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000002fca42
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000002fc7b7
- (void)copyTo:(id)arg1;	// IMP=0x00000000002fc661
- (void)writeTo:(id)arg1;	// IMP=0x00000000002fc46d
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000002fc460
- (id)dictionaryRepresentation;	// IMP=0x00000000002fbaeb
- (id)description;	// IMP=0x00000000002fba51
...
- (id)payloadsAtIndex:(unsigned long long)arg1;	// IMP=0x00000000002fb869
- (unsigned long long)payloadsCount;	// IMP=0x00000000002fb84c
- (void)addPayloads:(id)arg1;	// IMP=0x00000000002fb7ff
- (void)clearPayloads;	// IMP=0x00000000002fb7e2
@property(nonatomic) _Bool hasRtpSSRC;
- (void)dealloc;	// IMP=0x00000000002fb734
- (_Bool)setupVideoRuleCollection:(id)arg1 featureListStrings:(id)arg2;	// IMP=0x0000000000348903
- (id)rulesForEncodeType:(unsigned char)arg1 paylaod:(int)arg2 videoRuleCollection:(id)arg3;	// IMP=0x000000000034886e
- (void)printWithLogFile:(void *)arg1 prefix:(id)arg2 screenSize:(struct CGSize)arg3;	// IMP=0x0000000000348552
@property(readonly, nonatomic) VCVideoRuleCollections *videoRuleCollections;
- (_Bool)addVideoRules:(id)arg1 encodingType:(unsigned char)arg2 payload:(int)arg3 videoRuleCollections:(id)arg4;	// IMP=0x00000000003480b7
@property(readonly, nonatomic) struct CGSize orientationMismatchDisplayRatio;
- (void)aspectRatioPortrait:(struct CGSize *)arg1 aspectRatioLandscape:(struct CGSize *)arg2 orientationMismatchAspectRatioLandscape:(struct CGSize *)arg3 orientationMismatchAspectRatioPortrait:(struct CGSize *)arg4 screenSize:(struct CGSize)arg5;	// IMP=0x0000000000347e3c
- (id)initWithSSRC:(unsigned int)arg1 videoRuleCollections:(id)arg2 screenSize:(struct CGSize)arg3 aspectRatioPortrait:(struct CGSize)arg4 aspectRatioLandscape:(struct CGSize)arg5 orientationMismatchAspectRatioLandscape:(struct CGSize)arg6 featureListStrings:(id)arg7;	// IMP=0x0000000000347c26
