...
- (void).cxx_destruct;	// IMP=0x00200000000ccdf2
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000000ccb94
- (unsigned long long)hash;	// IMP=0x00100000000cc92f
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000cc699
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000cc4d9
- (void)copyTo:(id)arg1;	// IMP=0x00100000000cc36c
- (void)writeTo:(id)arg1;	// IMP=0x00100000000cc1dd
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000000cc1d0
- (id)dictionaryRepresentation;	// IMP=0x00100000000cb862
- (id)description;	// IMP=0x00100000000cb7b3
