...
+ (id)logCategory;	// IMP=0x0010000000bac345
+ (_Bool)isSupportedEvent:(id)arg1;	// IMP=0x0010000000bac2c3
+ (id)supportedEventClasses;	// IMP=0x0010000000bac293
- (void).cxx_destruct;	// IMP=0x0000000000bac247
...
- (void)didReceiveEventFromDispatcher:(id)arg1;	// IMP=0x0000000000bac13a
- (void)stop;	// IMP=0x0000000000bac03a
- (void)start;	// IMP=0x0000000000babf0d
- (id)initWithLogEventDispatcher:(id)arg1;	// IMP=0x0000000000babd91
- (_Bool)shouldSubmitEvent:(id)arg1;	// IMP=0x0000000000babd43
