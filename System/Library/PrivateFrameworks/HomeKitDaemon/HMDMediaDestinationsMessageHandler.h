...
- (void).cxx_destruct;	// IMP=0x0000000000a2073e
...
- (void)handleUpdatedDestination:(id)arg1;	// IMP=0x0000000000a2064d
- (void)handleMediaDestinationUpdatedNotification:(id)arg1;	// IMP=0x0000000000a2024e
- (id)initWithDestination:(id)arg1 messageDispatcher:(id)arg2 notificationCenter:(id)arg3 dataSource:(id)arg4 delegate:(id)arg5;	// IMP=0x0000000000a200da
