...
- (void).cxx_destruct;	// IMP=0x000000000020d5f1
...
- (id)initWithCacheRepresentation:(id)arg1;	// IMP=0x000000000020d257
- (id)formattedBylineWithClientContext:(id)arg1;	// IMP=0x000000000020cf22
- (id)initWithReviewDictionary:(id)arg1;	// IMP=0x000000000020cc7f
