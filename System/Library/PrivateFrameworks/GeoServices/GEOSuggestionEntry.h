...
- (void).cxx_destruct;	// IMP=0x0000000001074be1
- (unsigned long long)hash;	// IMP=0x0000000001074ad5
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000010748fb
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000001074426
- (void)writeTo:(id)arg1;	// IMP=0x0000000001073f56
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000001073f47
- (id)jsonRepresentation;	// IMP=0x0000000001073bc8
- (id)dictionaryRepresentation;	// IMP=0x0000000001073151
- (id)description;	// IMP=0x00000000010730a2
- (void)dealloc;	// IMP=0x0000000001071e9d
- (id)initWithData:(id)arg1;	// IMP=0x0000000001071e41
- (id)init;	// IMP=0x0000000001071de5
