...
- (id)_buildSectionsWithDisplayedItems:(id)arg1;	// IMP=0x0010000000018515
- (id)_buildItemModulesForHome:(id)arg1;	// IMP=0x00100000000183d6
- (id)_itemsToHideInSet:(id)arg1;	// IMP=0x0010000000018120
- (id)_buildItemProvidersForHome:(id)arg1;	// IMP=0x0010000000018038
- (id)initWithDelegate:(id)arg1 serviceLikeItems:(id)arg2;	// IMP=0x0010000000017dc9
