...
- (void).cxx_destruct;	// IMP=0x00000000000dc63f
...
- (void)execute;	// IMP=0x00000000000dc4d9
- (id)initWithDatabasePath:(id)arg1 accountChangeObserver:(id)arg2;	// IMP=0x00000000000dc42b
