...
+ (id)_sharedMPMediaLibraries;	// IMP=0x00100000001ea302
- (void).cxx_destruct;	// IMP=0x00000000001ea9bd
...
- (void)_notifyDelegateHomeShareMediaLibrariesDidUpdate:(id)arg1 withChangeSet:(id)arg2;	// IMP=0x00000000001ea8ab
- (void)_updateMediaLibrariesWithSharedMPMediaLibraries:(id)arg1;	// IMP=0x00000000001ea602
- (id)_homeShareMediaLibraries;	// IMP=0x00000000001ea3f3
- (void)_handleAvailableMediaLibrariesDidChange:(id)arg1;	// IMP=0x00000000001ea1be
- (void)endDiscoveringMediaLibraries;	// IMP=0x00000000001ea1a5
- (void)beginDiscoveringMediaLibraries;	// IMP=0x00000000001ea18c
@property(readonly, copy, nonatomic) NSArray *homeShareMediaLibraries;
- (void)dealloc;	// IMP=0x00000000001e9f92
- (id)initWithManager:(id)arg1;	// IMP=0x00000000001e9e7b
