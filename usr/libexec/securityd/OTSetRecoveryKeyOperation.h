...
- (void).cxx_destruct;	// IMP=0x00200000000afab1
...
- (void)proceedWithKeys:(id)arg1 salt:(id)arg2;	// IMP=0x00100000000af819
- (void)groupStart;	// IMP=0x00100000000af44a
- (id)initWithDependencies:(id)arg1 recoveryKey:(id)arg2;	// IMP=0x00100000000af3a8
