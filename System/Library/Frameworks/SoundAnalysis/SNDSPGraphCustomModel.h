...
- (id).cxx_construct;	// IMP=0x00000000001078a5
- (void).cxx_destruct;	// IMP=0x0000000000107833
- (id)predictionFromFeatures:(id)arg1 options:(id)arg2 error:(id *)arg3;	// IMP=0x0000000000106ef7
