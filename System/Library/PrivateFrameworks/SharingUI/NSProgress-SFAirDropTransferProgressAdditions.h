...
+ (id)sf_transferStateAsString:(long long)arg1;	// IMP=0x0020000000030d4b
+ (id)sf_publishingKeyForApp:(id)arg1 sessionID:(id)arg2;	// IMP=0x0020000000030831
@property(readonly, nonatomic) NSString *sf_error;
- (void)sf_failedWithError:(id)arg1;	// IMP=0x0010000000030ecd
@property(nonatomic) long long sf_transferState;
@property(nonatomic) unsigned int sf_initiator;
- (id)sf_initWithFileURL:(id)arg1;	// IMP=0x0010000000030bf5
...
- (id)sf_initWithAppBundle:(id)arg1 sessionID:(id)arg2 andPersonRealName:(id)arg3;	// IMP=0x0010000000030859
@end
