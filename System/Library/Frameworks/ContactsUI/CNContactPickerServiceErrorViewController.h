...
- (void).cxx_destruct;	// IMP=0x0000000000220576
...
- (void)invalidate;	// IMP=0x0000000000220521
- (void)invalidateSelectionAnimated:(_Bool)arg1;	// IMP=0x000000000022051b
- (void)setupWithOptions:(id)arg1 readyBlock:(CDUnknownBlockType)arg2;	// IMP=0x000000000022050b
