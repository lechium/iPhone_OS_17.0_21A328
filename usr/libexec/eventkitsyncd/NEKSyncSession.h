...
- (void).cxx_destruct;	// IMP=0x002000000005675c
...
- (void)syncSession:(id)arg1 didEndWithError:(id)arg2;	// IMP=0x0010000000056517
- (_Bool)syncSession:(id)arg1 resetDataStoreWithError:(id *)arg2;	// IMP=0x001000000005642a
- (void)syncSession:(id)arg1 applyChanges:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x0010000000055782
- (unsigned int)syncSession:(id)arg1 enqueueChanges:(CDUnknownBlockType)arg2 error:(id *)arg3;	// IMP=0x0010000000055159
- (void)dealloc;	// IMP=0x001000000005511f
- (id)init;	// IMP=0x001000000005502d
