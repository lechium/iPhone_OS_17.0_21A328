...
- (id).cxx_construct;	// IMP=0x000000000002a4b7
- (void).cxx_destruct;	// IMP=0x000000000002a432
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000002a209
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000029d50
@property(readonly, nonatomic) void *irProgram;
- (_Bool)writeToURL:(id)arg1 error:(id *)arg2;	// IMP=0x000000000002970b
- (id)initWithMessageStream:(struct CodedInputStream *)arg1 parserContext:(id)arg2 error:(id *)arg3;	// IMP=0x00000000000292e8
- (id)initWithSpecificationData:(id)arg1 parserContext:(id)arg2 error:(id *)arg3;	// IMP=0x00000000000291a0
