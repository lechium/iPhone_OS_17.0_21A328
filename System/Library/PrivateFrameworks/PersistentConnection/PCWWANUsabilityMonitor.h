...
- (void).cxx_destruct;	// IMP=0x000000000001642f
- (void)interfaceReachabilityChanged:(id)arg1;	// IMP=0x00000000000162f6
- (void)interfaceLinkQualityChanged:(id)arg1 previousLinkQuality:(int)arg2;	// IMP=0x000000000001619e
- (void)_callDelegateOnIvarQueueWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x000000000001607c
...
- (void)setTrackedTimeInterval:(double)arg1;	// IMP=0x000000000001596f
- (void)setThresholdOffTransitionCount:(unsigned long long)arg1;	// IMP=0x00000000000158f6
- (void)setTrackUsability:(_Bool)arg1;	// IMP=0x0000000000015842
- (void)_forwardConfigurationOnIvarQueue;	// IMP=0x00000000000157f4
@property(readonly, nonatomic) struct __CFString *wwanInterfaceName;
@property(readonly, nonatomic) int currentRAT; // @synthesize currentRAT=_currentRAT;
- (id)_currentDataSimContext;	// IMP=0x000000000001552e
...
- (_Bool)_isCurrentDataSimContextOnIvarQueue:(id)arg1;	// IMP=0x00000000000154b1
- (void)_adjustInterfaceNameForWWANContextID:(int)arg1 interfaceName:(id)arg2 forContext:(id)arg3;	// IMP=0x0000000000015264
- (void)_setupWWANMonitor;	// IMP=0x000000000001518e
- (void)dealloc;	// IMP=0x0000000000015130
- (id)initWithDelegateQueue:(id)arg1;	// IMP=0x0000000000014fa6
