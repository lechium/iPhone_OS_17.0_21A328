...
- (void).cxx_destruct;	// IMP=0x0000000000326340
...
- (void)enumerateObserversWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000000326209
- (void)unregisterObserver:(id)arg1;	// IMP=0x0000000000326173
- (void)registerObserver:(id)arg1;	// IMP=0x00000000003260dd
- (id)init;	// IMP=0x0000000000326056
