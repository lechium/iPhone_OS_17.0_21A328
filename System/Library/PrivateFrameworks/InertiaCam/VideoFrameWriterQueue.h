...
- (void).cxx_destruct;	// IMP=0x0000000000023efd
...
- (void)DrainIfAbove:(unsigned int)arg1 downTo:(unsigned int)arg2;	// IMP=0x0000000000023baa
- (void)StartWatchingForFrames;	// IMP=0x0000000000023ae7
- (void)FrameRequestCallback;	// IMP=0x000000000002365b
- (id)FindFrameWithIndex:(long long)arg1;	// IMP=0x0000000000023586
- (_Bool)WaitForFinish;	// IMP=0x0000000000023335
- (unsigned long long)FramesInQueue;	// IMP=0x00000000000232e6
- (void)AddAFrame:(id)arg1;	// IMP=0x000000000002325d
- (void)dealloc;	// IMP=0x000000000002322e
- (id)initWithOutputURL:(id)arg1 forMovieDimensions:(struct CGSize)arg2 outputTransform:(struct CGAffineTransform)arg3 startTime:(CDStruct_1b6d18a9)arg4 endTime:(CDStruct_1b6d18a9)arg5;	// IMP=0x0000000000022e15
