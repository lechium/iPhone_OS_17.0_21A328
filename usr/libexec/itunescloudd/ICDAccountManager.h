...
- (void).cxx_destruct;	// IMP=0x0020000000118b09
...
- (void)_updateStateWithChange:(id)arg1;	// IMP=0x0010000000118a14
- (id)_buildStateChange;	// IMP=0x001000000011880d
...
- (void)changeLibraryManagementPolicy:(long long)arg1;	// IMP=0x0010000000118237
- (void)updateState;	// IMP=0x001000000011802b
- (id)initWithLibraryManagementPolicy:(long long)arg1;	// IMP=0x0010000000117de1
