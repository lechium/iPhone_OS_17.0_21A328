...
- (void).cxx_destruct;	// IMP=0x00200000006551fd
...
- (void)updateWithRefinedWaypoints:(id)arg1;	// IMP=0x0010000000654fe8
- (id)makeRouteAttributesBuilderWithNavigationMode:(unsigned long long)arg1;	// IMP=0x0010000000654f7c
@property(readonly, nonatomic) DrivePreferences *drivePreferences;
- (id)initWithPreferences:(id)arg1 timing:(id)arg2;	// IMP=0x0010000000654ed5
