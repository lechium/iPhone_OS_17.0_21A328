...
- (void).cxx_destruct;	// IMP=0x0000000000020c7a
@property(nonatomic) __weak id <MNArrivalRegionTimerDelegate> delegate; // @synthesize delegate=_delegate;
- (void)updateForLocation:(id)arg1;	// IMP=0x00000000000208ff
- (void)dealloc;	// IMP=0x00000000000208bd
- (id)initWithArrivalRegion:(id)arg1;	// IMP=0x0000000000020804
- (id)init;	// IMP=0x00000000000207da
