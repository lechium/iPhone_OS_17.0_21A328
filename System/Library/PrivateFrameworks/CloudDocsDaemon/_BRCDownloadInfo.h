...
- (void).cxx_destruct;	// IMP=0x00000000001843cc
...
- (void)copyProgressInfoToProgress:(id)arg1 options:(BOOL)arg2;	// IMP=0x00000000001842a7
- (void)updateLocalizedDescriptionWithOptions:(BOOL)arg1;	// IMP=0x0000000000183fe6
- (id)init;	// IMP=0x0000000000183f37
