...
- (void).cxx_destruct;	// IMP=0x002000000012ad95
...
- (id)_newIOKitDeviceProperties;	// IMP=0x001000000012abdb
- (_Bool)handleTouchEvent:(struct _MRHIDTouchEvent)arg1;	// IMP=0x001000000012a85a
- (_Bool)handleHIDReport:(id)arg1;	// IMP=0x001000000012a749
- (id)deviceProperties;	// IMP=0x001000000012a70a
- (void)dealloc;	// IMP=0x001000000012a6cb
- (id)initWithDeviceDescriptor:(id)arg1;	// IMP=0x001000000012a584
