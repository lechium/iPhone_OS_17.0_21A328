...
- (void)_manageSharingOfTouchesBetweenClientAndHostContext;	// IMP=0x000000000000d043
- (void)didMoveToWindow;	// IMP=0x000000000000d031
@property(retain, nonatomic) PGHostedWindowHostingHandle *hostedWindowHostingHandle;
- (void)dealloc;	// IMP=0x000000000000cefa
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000000ce68
