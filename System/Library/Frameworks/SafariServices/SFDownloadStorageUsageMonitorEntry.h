...
- (void).cxx_destruct;	// IMP=0x000000000004025b
...
- (void)updateWithDictionaryRepresentation:(id)arg1;	// IMP=0x000000000003ff5a
- (void)_updateProgressSubscriptionWithData:(id)arg1;	// IMP=0x000000000003fcc1
- (void)_didLoseProgress:(id)arg1;	// IMP=0x000000000003faf0
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x000000000003fa66
- (void)_didGainProgress:(id)arg1;	// IMP=0x000000000003f9b5
- (id)initWithIdentifier:(id)arg1;	// IMP=0x000000000003f948
