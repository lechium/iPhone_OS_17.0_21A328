...
- (void).cxx_destruct;	// IMP=0x0000000000276e4b
...
- (id)description;	// IMP=0x0000000000276d3d
- (void)loadImage:(CDUnknownBlockType)arg1;	// IMP=0x0000000000276b56
@property(readonly, nonatomic) NSString *subHeader;
@property(readonly, nonatomic) NSString *title;
- (id)initWithElement:(id)arg1 prev:(id)arg2;	// IMP=0x0000000000276935
