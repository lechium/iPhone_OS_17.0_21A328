...
+ (_Bool)supportsSecureCoding;	// IMP=0x002000000001c7fc
- (void).cxx_destruct;	// IMP=0x002000000001d6aa
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000001cfc4
@property(readonly) unsigned long long hash;
- (id)offerWithMetrics:(id)arg1;	// IMP=0x001000000001cccc
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000001ccc1
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000001caf9
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000001c804
- (id)initWithID:(id)arg1 titles:(id)arg2 subtitles:(id)arg3 flags:(long long)arg4 ageRating:(id)arg5 metrics:(id)arg6 url:(id)arg7 isSensitive:(_Bool)arg8;	// IMP=0x001000000001c68e
