...
- (void).cxx_destruct;	// IMP=0x00000000000102e1
...
- (id)valueForUndefinedKey:(id)arg1;	// IMP=0x000000000000f434
- (void)setValue:(id)arg1 forUndefinedKey:(id)arg2;	// IMP=0x000000000000f419
- (void)setAXAttribute:(id)arg1 value:(id)arg2;	// IMP=0x000000000000f3fa
- (void)setAttribute:(id)arg1 value:(id)arg2;	// IMP=0x000000000000f349
- (void)tmlObjectCompleted;	// IMP=0x000000000000f2f0
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000000f2a7
- (id)initWithDictionary:(id)arg1;	// IMP=0x000000000000f20c
- (id)init;	// IMP=0x000000000000f1f8
