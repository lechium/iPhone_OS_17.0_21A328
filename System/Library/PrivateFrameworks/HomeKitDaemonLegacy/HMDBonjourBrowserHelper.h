...
- (void).cxx_destruct;	// IMP=0x0000000000796ba9
...
- (void)netServiceBrowser:(id)arg1 didStopBrowsingWithError:(id)arg2;	// IMP=0x000000000079689a
- (void)netServiceBrowser:(id)arg1 didRemoveService:(id)arg2;	// IMP=0x0000000000796698
- (void)netServiceBrowser:(id)arg1 didAddService:(id)arg2;	// IMP=0x0000000000796496
- (void)timerDidFire:(id)arg1;	// IMP=0x00000000007963c7
- (void)_updateTimerWithTimeout:(double)arg1;	// IMP=0x0000000000796264
- (void)_removeBrowser:(id)arg1;	// IMP=0x00000000007961ee
- (void)_addBrowser:(id)arg1;	// IMP=0x0000000000796178
@property(nonatomic) unsigned long long state; // @synthesize state=_state;
@property(readonly, nonatomic, getter=isStarted) _Bool started;
- (unsigned long long)discoveredServicesCountForServiceType:(id)arg1;	// IMP=0x0000000000795fc3
- (void)_stopBrowsers;	// IMP=0x0000000000795b3e
- (void)stop;	// IMP=0x0000000000795acd
- (_Bool)_startBrowsers;	// IMP=0x000000000079572f
- (void)startWithBrowsingCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0000000000795677
- (id)initWithServicesOfTypes:(id)arg1 browsingTimeInterval:(double)arg2 browsingPeriodicity:(double)arg3 workQueue:(id)arg4;	// IMP=0x00000000007953fa
