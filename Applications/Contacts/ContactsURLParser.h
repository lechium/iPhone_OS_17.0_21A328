...
+ (id)log;	// IMP=0x002000000000174e
- (void).cxx_destruct;	// IMP=0x0020000000001da3
...
- (id)legacyIdentifierFound;	// IMP=0x0010000000001d3b
- (id)identifierFound;	// IMP=0x0010000000001d29
- (id)identifierFromShowCommandURL:(id)arg1;	// IMP=0x0010000000001a18
- (void)readURL:(id)arg1;	// IMP=0x0010000000001865
- (id)initWithURL:(id)arg1 dataSource:(id)arg2;	// IMP=0x00100000000017aa
