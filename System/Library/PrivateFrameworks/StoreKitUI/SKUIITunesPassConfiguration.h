...
- (void).cxx_destruct;	// IMP=0x00000000001d91e0
...
- (id)learnMoreAlertView;	// IMP=0x00000000001d9143
- (id)initWithITunesPassDictionary:(id)arg1 clientContext:(id)arg2;	// IMP=0x00000000001d833a
