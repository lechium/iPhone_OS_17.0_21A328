...
+ (void)initialize;	// IMP=0x001000000009185b
- (void).cxx_destruct;	// IMP=0x00000000000938e9
...
- (void)_registerStateMachineHandlers;	// IMP=0x0000000000092289
- (void)downloadManagerDownloadsDidChange:(id)arg1;	// IMP=0x0000000000091e5d
- (void)downloadManager:(id)arg1 downloadStatesDidChange:(id)arg2;	// IMP=0x0000000000091b5d
- (void)waitForDownloadToBecomePlayableWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0000000000091a6c
- (void)dealloc;	// IMP=0x0000000000091a27
- (id)initWithDownload:(id)arg1 downloadManager:(id)arg2;	// IMP=0x00000000000918ab
