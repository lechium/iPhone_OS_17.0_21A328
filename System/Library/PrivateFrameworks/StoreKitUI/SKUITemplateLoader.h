...
- (void).cxx_destruct;	// IMP=0x0000000000222593
...
- (void)load;	// IMP=0x00000000002222db
- (void)_operationDidFinish:(id)arg1;	// IMP=0x00000000002220b5
- (void)_operation:(id)arg1 didFailWithError:(id)arg2;	// IMP=0x000000000022201a
- (void)_operation:(id)arg1 didCompleteWithOutput:(id)arg2;	// IMP=0x0000000000221df5
- (id)_operationWithURL:(id)arg1;	// IMP=0x0000000000221aba
- (id)initWithURLs:(id)arg1 completionBlock:(CDUnknownBlockType)arg2;	// IMP=0x0000000000221924
