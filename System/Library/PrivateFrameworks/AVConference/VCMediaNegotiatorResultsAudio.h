...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001b9383
- (void)dealloc;	// IMP=0x00000000001b9325
- (void)addSecondaryPayload:(int)arg1;	// IMP=0x00000000001b92ec
@property(readonly, nonatomic) NSArray *secondaryPayloads;
- (id)init;	// IMP=0x00000000001b9252
