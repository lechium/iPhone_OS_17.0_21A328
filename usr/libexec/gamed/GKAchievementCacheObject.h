...
+ (id)entityName;	// IMP=0x004000000012b4bc
- (id)internalRepresentation;	// IMP=0x002000000012b4b4
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x001000000012b1d8
