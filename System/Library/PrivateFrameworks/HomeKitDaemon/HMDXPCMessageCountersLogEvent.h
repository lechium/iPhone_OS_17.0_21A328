...
+ (id)XPCMessageCountersLogEventWithType:(id)arg1 peerInformation:(id)arg2 messageName:(id)arg3 count:(id)arg4;	// IMP=0x0060000000372265
- (void).cxx_destruct;	// IMP=0x0000000000372212
...
- (_Bool)shouldSubmit;	// IMP=0x000000000037217f
- (id)__initWithType:(id)arg1 peerInformation:(id)arg2 messageName:(id)arg3 count:(id)arg4;	// IMP=0x000000000037204f
