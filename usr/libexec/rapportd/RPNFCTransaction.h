...
+ (_Bool)supportsSecureCoding;	// IMP=0x0020000000001564
- (void).cxx_destruct;	// IMP=0x0020000000002448
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000001fb8
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000001e3a
- (void)setState:(long long)arg1;	// IMP=0x0010000000001c32
- (void)setError:(id)arg1;	// IMP=0x0010000000001619
- (id)initWithRole:(long long)arg1;	// IMP=0x001000000000156c
