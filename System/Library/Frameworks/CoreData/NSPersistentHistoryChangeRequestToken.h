...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000000cf32
...
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000000cf3a
- (void)dealloc;	// IMP=0x000000000000cece
- (id)initForRequest:(id)arg1;	// IMP=0x000000000000cda1
