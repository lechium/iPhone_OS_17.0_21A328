...
- (void).cxx_destruct;	// IMP=0x0020000000125459
...
- (void)groupStart;	// IMP=0x00100000001250d1
- (id)initWithDependencies:(id)arg1 intendedState:(id)arg2 errorState:(id)arg3;	// IMP=0x0010000000125007
