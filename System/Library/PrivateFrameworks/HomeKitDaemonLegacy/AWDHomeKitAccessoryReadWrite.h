...
+ (Class)characteristicsType;	// IMP=0x001000000020fb80
- (void).cxx_destruct;	// IMP=0x000000000020fae9
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000020f3e9
- (unsigned long long)hash;	// IMP=0x000000000020f06b
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000020ead9
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000020e572
- (void)copyTo:(id)arg1;	// IMP=0x000000000020e1bf
- (void)writeTo:(id)arg1;	// IMP=0x000000000020dd4c
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000020d033
- (id)dictionaryRepresentation;	// IMP=0x000000000020c603
- (id)description;	// IMP=0x000000000020c554
...
- (int)StringAsCertified:(id)arg1;	// IMP=0x000000000020c1b2
- (id)certifiedAsString:(int)arg1;	// IMP=0x000000000020c16a
@property(nonatomic) _Bool hasCertified;
@property(nonatomic) int certified; // @synthesize certified=_certified;
- (int)StringAsSource:(id)arg1;	// IMP=0x000000000020bfad
- (id)sourceAsString:(int)arg1;	// IMP=0x000000000020bf65
...
- (int)StringAsTransportType:(id)arg1;	// IMP=0x000000000020bd35
- (id)transportTypeAsString:(int)arg1;	// IMP=0x000000000020bced
@property(nonatomic) _Bool hasTransportType;
@property(nonatomic) int transportType; // @synthesize transportType=_transportType;
- (id)characteristicsAtIndex:(unsigned long long)arg1;	// IMP=0x000000000020bc66
- (unsigned long long)characteristicsCount;	// IMP=0x000000000020bc49
- (void)addCharacteristics:(id)arg1;	// IMP=0x000000000020bbdf
- (void)clearCharacteristics;	// IMP=0x000000000020bbc2
