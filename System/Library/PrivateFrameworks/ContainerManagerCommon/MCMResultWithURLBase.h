...
- (void).cxx_destruct;	// IMP=0x00000000000b0ec0
...
- (void)dealloc;	// IMP=0x00000000000b0d4d
- (id)initWithPath:(id)arg1 existed:(_Bool)arg2 sandboxToken:(const char *)arg3;	// IMP=0x00000000000b0c83
- (id)initWithURL:(id)arg1 existed:(_Bool)arg2 sandboxToken:(const char *)arg3;	// IMP=0x00000000000b0bc0
- (_Bool)encodeResultOntoReply:(id)arg1;	// IMP=0x00000000000b0a1c
