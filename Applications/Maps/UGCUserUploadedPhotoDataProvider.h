...
- (void).cxx_destruct;	// IMP=0x0020000000befe5e
@property(nonatomic) unsigned long long indexOfTappedPhoto; // @synthesize indexOfTappedPhoto=_indexOfTappedPhoto;
// Error: Property attributes should begin with the type ('T') attribute, property name: totalNumberOfPhotos
...
- (void)_setupPhotos;	// IMP=0x0010000000befa11
- (void)fetchNextBatchRequestIfNeeded;	// IMP=0x0010000000bef958
@property(readonly, nonatomic) _Bool hasReachedTotalCount;
@property(readonly, nonatomic) _Bool hasDataToShow;
- (id)initWithLookupResult:(id)arg1 delegate:(id)arg2;	// IMP=0x0010000000bef854
