...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000001bae89
- (void).cxx_destruct;	// IMP=0x00000000001bae56
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001bada7
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001bab4d
