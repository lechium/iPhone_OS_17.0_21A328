...
- (void).cxx_destruct;	// IMP=0x002000000007ebdd
...
- (id)_newSelectSQLWithProperties:(id)arg1 columns:(id)arg2;	// IMP=0x001000000007e497
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000007e3a5
- (id)initWithEntityClass:(Class)arg1 memoryEntityClass:(Class)arg2;	// IMP=0x001000000007e35d
- (id)initWithEntityClass:(Class)arg1;	// IMP=0x001000000007e349
