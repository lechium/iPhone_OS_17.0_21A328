...
- (void).cxx_destruct;	// IMP=0x000000000001f19d
...
- (void)updateMaskWithBounds:(struct CGRect)arg1 maskRect:(struct CGRect)arg2;	// IMP=0x000000000001ee1e
- (void)animateSheetMaskFromOldSheetFrame:(struct CGRect)arg1 toSheetFrame:(struct CGRect)arg2 duration:(double)arg3;	// IMP=0x000000000001e054
- (void)restoreSheetCutout;	// IMP=0x000000000001dfbc
- (void)removeSheetCutout;	// IMP=0x000000000001df25
- (void)removeAllAnimations;	// IMP=0x000000000001de8d
- (id)initWithBackgroundColor:(id)arg1 cornerRadius:(double)arg2;	// IMP=0x000000000001d9b6
