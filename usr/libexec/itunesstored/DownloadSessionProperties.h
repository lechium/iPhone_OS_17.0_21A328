...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000284f3
- (unsigned long long)hash;	// IMP=0x00100000000284e9
- (id)description;	// IMP=0x0010000000028483
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000283c3
- (void)dealloc;	// IMP=0x001000000002836b
- (id)initWithClientIdentifier:(id)arg1 handlerIdentifier:(long long)arg2;	// IMP=0x0010000000028309
