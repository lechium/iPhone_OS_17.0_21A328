...
- (unsigned long long)hash;	// IMP=0x000000000026cab7
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000026ca0c
- (void)dealloc;	// IMP=0x000000000026c9d1
- (id)initWithObserver:(id)arg1 target:(id)arg2 keyPath:(id)arg3 context:(void *)arg4;	// IMP=0x000000000026c955
- (id)init;	// IMP=0x000000000026c87b
