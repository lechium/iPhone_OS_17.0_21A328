...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000eb39a4
- (unsigned long long)hash;	// IMP=0x0010000000eb3225
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000eb3059
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000eb2f1a
- (void)copyTo:(id)arg1;	// IMP=0x0010000000eb2e19
- (void)writeTo:(id)arg1;	// IMP=0x0010000000eb2cc5
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000eb2cb8
- (id)dictionaryRepresentation;	// IMP=0x0010000000eb2565
- (id)description;	// IMP=0x0010000000eb24ee
- (int)StringAsQuality:(id)arg1;	// IMP=0x0010000000eb2468
- (id)qualityAsString:(int)arg1;	// IMP=0x0010000000eb242f
...
// Error: Property attributes should begin with the type ('T') attribute, property name: hasAccuracy
