...
- (void).cxx_destruct;	// IMP=0x00200000001038e6
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000103640
- (unsigned long long)hash;	// IMP=0x00100000001034c0
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000010325b
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000010306d
- (void)copyTo:(id)arg1;	// IMP=0x0010000000102ef5
- (void)writeTo:(id)arg1;	// IMP=0x0010000000102d75
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000102d68
- (id)dictionaryRepresentation;	// IMP=0x00100000001025bc
- (id)description;	// IMP=0x001000000010250d
