...
- (void).cxx_destruct;	// IMP=0x00000000004758df
@property(nonatomic, readonly) VUILabel *accessibilityTitleLabel;
- (struct CGSize)vui_layoutSubviews:(struct CGSize)arg1 computationOnly:(_Bool)arg2;	// IMP=0x0000000000475805
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000047454b
@property(nonatomic, readonly) _Bool vuiDebugUI;
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000474432
