...
- (void)computeOnCPUWithInputTensors:(id)arg1 outputTensors:(id)arg2;	// IMP=0x000000000002cf38
- (_Bool)hasGPUSupport;	// IMP=0x000000000002cf30
- (id)initWithParameters:(id)arg1;	// IMP=0x000000000002ccbb
- (id)setupForInputShapes:(id)arg1 withParameters:(id)arg2;	// IMP=0x000000000002ca1e
