...
@class BSAction, NSDictionary, NSNumberFormatter, NSProgress, NSSet, NSString, NSTimer, NSURL, UIColor, UILabel, UIView, WFDialogAttribution, WFIcon, WFIconStackAccessoryView, WFProgressAccessoryView, WFWorkflowRunningContext;
...
@interface WFApertureStatusViewController : UIViewController
{
    ...
    WFIcon *_pendingDelayedIcon;	// 136 = 0x88
}

+ (id)requestIdentifierForContext:(id)arg1;	// IMP=0x0020000000008b5b
- (void).cxx_destruct;	// IMP=0x00200000000087ee
...
- (void)presentableDidAppearAsBanner:(id)arg1;	// IMP=0x00100000000085fd
@property(readonly, nonatomic) UIViewController *viewController;
@property(readonly, nonatomic) _Bool providesHostedContent;
- (void)systemDismissedBanner;	// IMP=0x00100000000085e6
...
- (id)systemApertureElementProvider;	// IMP=0x0010000000008075
@property(readonly, copy, nonatomic) NSString *elementIdentifier;
- (long long)preferredLayoutModeForRunningContext:(id)arg1;	// IMP=0x0010000000007fa3
- (void)setIcon:(id)arg1;	// IMP=0x0010000000007e0f
- (void)startCollapseTimerIfNecessary;	// IMP=0x0010000000007d57
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x0010000000007d03
@property(readonly, nonatomic) NSNumberFormatter *percentageFormatter; // @synthesize percentageFormatter=_percentageFormatter;
- (void)updatePercentageSubtitleWithValue:(double)arg1;	// IMP=0x0010000000007998
- (struct CGSize)sensorIntersectionSizeForLabelAtCenter:(struct CGPoint)arg1 size:(struct CGSize)arg2 visibleGlyphFrame:(struct CGRect)arg3;	// IMP=0x001000000000772d
- (void)viewWillLayoutSubviews;	// IMP=0x001000000000681b
...
- (id)subtitleFont;	// IMP=0x00100000000065d4
- (id)titleFont;	// IMP=0x00100000000065b9
- (void)setCompletingSuccessfully:(_Bool)arg1;	// IMP=0x001000000000654c
- (_Bool)_canShowWhileLocked;	// IMP=0x0010000000006544
- (void)dealloc;	// IMP=0x00100000000064ea
- (id)initWithRunningContext:(id)arg1 attribution:(id)arg2 progress:(id)arg3;	// IMP=0x0000000000006037
- (id)initWithRunningContext:(id)arg1 attribution:(id)arg2;	// IMP=0x0010000000006022
