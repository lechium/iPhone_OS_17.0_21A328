...
- (void).cxx_destruct;	// IMP=0x00000000007efe5d
...
- (id)description;	// IMP=0x00000000007efcf1
- (id)initWithResolution:(long long)arg1 bitRateByFrameRate:(id)arg2 keyFrameInterval:(id)arg3 h264Level:(long long)arg4;	// IMP=0x00000000007efc43
