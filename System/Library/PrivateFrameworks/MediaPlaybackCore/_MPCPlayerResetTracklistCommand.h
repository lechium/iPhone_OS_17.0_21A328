...
- (void).cxx_destruct;	// IMP=0x0000000000239d46
...
- (id)replaceWithPlaybackIntent:(id)arg1 replaceIntent:(long long)arg2;	// IMP=0x00000000002397b5
- (id)replaceWithPlaybackIntent:(id)arg1;	// IMP=0x000000000023979e
- (id)clearUpNextItems;	// IMP=0x0000000000239647
- (id)clear;	// IMP=0x000000000023946d
