...
+ (id)logCategory;	// IMP=0x0010000000ad9d5d
- (void).cxx_destruct;	// IMP=0x0000000000ad9d2e
...
- (void)addObserver:(SEL)arg1 name:(id)arg2 object:(id)arg3;	// IMP=0x0000000000ad9a63
- (id)logIdentifier;	// IMP=0x0000000000ad998e
- (id)initWithRegisterer:(id)arg1;	// IMP=0x0000000000ad98f6
