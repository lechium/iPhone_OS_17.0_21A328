...
- (void).cxx_destruct;	// IMP=0x0020000000008365
...
- (void)fireTimer;	// IMP=0x0010000000008268
- (void)scheduleTimer;	// IMP=0x0010000000008139
@property(readonly, nonatomic, getter=isWaking) _Bool waking;
- (void)invalidate;	// IMP=0x00100000000080c3
- (void)dealloc;	// IMP=0x001000000000807c
- (id)initWithIdentifier:(id)arg1 delay:(double)arg2 gracePeriod:(double)arg3 handlerQueue:(id)arg4 handlerBlock:(CDUnknownBlockType)arg5;	// IMP=0x0010000000007f85
