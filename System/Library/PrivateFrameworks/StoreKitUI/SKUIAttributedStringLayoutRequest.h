...
- (void).cxx_destruct;	// IMP=0x00000000002f87b1
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000002f86f8
- (id)initWithAttributedString:(id)arg1;	// IMP=0x00000000002f8642
