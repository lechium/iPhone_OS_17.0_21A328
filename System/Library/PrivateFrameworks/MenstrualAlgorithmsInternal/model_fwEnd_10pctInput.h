...
- (void).cxx_destruct;	// IMP=0x0000000000058d7a
...
- (id)featureValueForName:(id)arg1;	// IMP=0x0000000000058bd4
@property(readonly, nonatomic) NSSet *featureNames;
- (id)initWithIn:(id)arg1 lstm_1_h_in:(id)arg2 lstm_1_c_in:(id)arg3;	// IMP=0x0000000000058afc
- (id)initWithIn:(id)arg1;	// IMP=0x0000000000058ae5
