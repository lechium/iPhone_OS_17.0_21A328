...
- (void).cxx_destruct;	// IMP=0x00000000001c63be
...
- (void)aspectRatioButtonPressed:(id)arg1;	// IMP=0x00000000001c6265
- (id)initWithLayoutOrientation:(long long)arg1;	// IMP=0x00000000001c590e
