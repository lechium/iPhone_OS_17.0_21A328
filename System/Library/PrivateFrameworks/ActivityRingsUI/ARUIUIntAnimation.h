...
+ (id)animationWithDuration:(double)arg1 startValue:(unsigned long long)arg2 endValue:(unsigned long long)arg3 timingFunction:(id)arg4 applier:(CDUnknownBlockType)arg5;	// IMP=0x001000000001c8e3
- (void).cxx_destruct;	// IMP=0x000000000001cc97
...
- (void)completeAnimation;	// IMP=0x000000000001cbc8
- (_Bool)isAnimating;	// IMP=0x000000000001cbb7
- (void)update:(double)arg1;	// IMP=0x000000000001cab4
- (void)dealloc;	// IMP=0x000000000001ca56
- (id)initWithDuration:(double)arg1 startValue:(unsigned long long)arg2 endValue:(unsigned long long)arg3 timingFunction:(id)arg4 applier:(CDUnknownBlockType)arg5;	// IMP=0x000000000001c979
