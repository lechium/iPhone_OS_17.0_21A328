...
- (void)fetchMessageRecordsFilteredUsingPredicate:(NSPredicate *)arg1 sortedUsingDescriptors:(NSArray *)arg2 limit:(unsigned long long)arg3 completionHandler:(void (^)(NSArray *))arg4;
