...
@class IDSDestination, MISSING_TYPE, NSArray, NSData, NSDate, NSDictionary, NSMutableArray, NSNumber, NSString;

@interface IDSDOutgoingMessage : NSObject
{
    MISSING_TYPE *_message;	// 8 = 0x8
...
- (void).cxx_destruct;	// IMP=0x00200000003293ad
