...
- (void).cxx_destruct;	// IMP=0x002000000028f9e7
...
- (void)_fillSubmissionParameters:(id)arg1;	// IMP=0x001000000028f457
- (id)_alternateMapViewContext;	// IMP=0x001000000028f445
- (_Bool)isComplete;	// IMP=0x001000000028f196
...
- (void)setCorrectedName:(id)arg1;	// IMP=0x001000000028eecd
