...
- (void).cxx_destruct;	// IMP=0x000000000009a036
- (_Bool)isImpressionable;	// IMP=0x000000000009a02e
@property(readonly, nonatomic) UIView *sectionView;
@property(readonly, nonatomic) UIViewController *sectionViewController;
- (id)initWithMapItem:(id)arg1 viewController:(id)arg2;	// IMP=0x0000000000099f0c
