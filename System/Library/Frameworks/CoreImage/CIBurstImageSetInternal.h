...
+ (id)defaultVersionString;	// IMP=0x006000000002b673
...
- (_Bool)isAction;	// IMP=0x0000000000036a06
- (_Bool)isPortrait;	// IMP=0x00000000000369d1
- (_Bool)isFaceDetectionForced;	// IMP=0x00000000000369b2
- (id)imageClusterForIdentifier:(id)arg1;	// IMP=0x00000000000365c4
- (id)bestImageIdentifiers;	// IMP=0x0000000000032575
- (void)selectCoverPhotoFromMultiple:(id)arg1 burstSize:(int)arg2;	// IMP=0x0000000000032072
- (id)findBestImage:(id)arg1 useActionScores:(_Bool)arg2;	// IMP=0x0000000000031842
- (void)computeAllImageScores;	// IMP=0x0000000000030083
- (float)computeBeginningVsEndAEMatrixDiffVsAverageAdjacent;	// IMP=0x000000000002fd14
- (float)computeCameraTravelDistance;	// IMP=0x000000000002f820
- (void)performEmotionalRejectionOnCluster:(id)arg1;	// IMP=0x000000000002f185
- (int)computeEmotion:(id)arg1;	// IMP=0x000000000002f025
- (void)addImageFromIOSurface:(struct __IOSurface *)arg1 properties:(id)arg2 identifier:(id)arg3 completionBlock:(CDUnknownBlockType)arg4;	// IMP=0x000000000002eeb2
- (void)addYUVImage:(id)arg1 properties:(id)arg2 identifier:(id)arg3 imageProps:(id)arg4 completionBlock:(CDUnknownBlockType)arg5;	// IMP=0x000000000002e9bd
- (void)processClusters:(_Bool)arg1;	// IMP=0x000000000002c49d
- (float)computeActionSelectionThreshold;	// IMP=0x000000000002c0ce
- (void)dealloc;	// IMP=0x000000000002be6d
- (id)initWithOptions:(id)arg1;	// IMP=0x000000000002b78c
- (id)burstDocumentDirectory;	// IMP=0x000000000002b6f2
