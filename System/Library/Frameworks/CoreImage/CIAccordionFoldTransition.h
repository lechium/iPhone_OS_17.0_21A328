...
+ (id)customAttributes;	// IMP=0x006000000000a777
...
- (id)outputImage;	// IMP=0x000000000000ab86
- (id)_kernel;	// IMP=0x000000000000ab66
- (id)_kernelMix;	// IMP=0x000000000000ab46
- (id)_kernelWarpT;	// IMP=0x000000000000ab26
- (id)_kernelWarpS;	// IMP=0x000000000000ab06
