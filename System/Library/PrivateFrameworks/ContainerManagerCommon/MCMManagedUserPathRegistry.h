...
- (void).cxx_destruct;	// IMP=0x0000000000032bbc
...
- (void)_initPathPropertiesWithUserIdentity:(id)arg1;	// IMP=0x000000000003270e
- (id)initWithUserIdentity:(id)arg1 daemonUser:(id)arg2;	// IMP=0x0000000000032565
