...
- (void).cxx_destruct;	// IMP=0x0000000000035a74
...
- (void)computeOnCPUWithInputTensors:(id)arg1 outputTensors:(id)arg2;	// IMP=0x000000000003546b
- (_Bool)hasGPUSupport;	// IMP=0x0000000000035463
- (id)initWithParameters:(id)arg1;	// IMP=0x00000000000351ee
- (id)setupForInputShapes:(id)arg1 withParameters:(id)arg2;	// IMP=0x00000000000351d8
