...
- (void).cxx_destruct;	// IMP=0x0020000000040d1a
...
- (_Bool)matchesPeer:(id)arg1;	// IMP=0x0010000000040c1d
...
- (id)initWithPeerID:(id)arg1 signingIdentity:(id)arg2 encryptionIdentity:(id)arg3;	// IMP=0x00100000000409b9
