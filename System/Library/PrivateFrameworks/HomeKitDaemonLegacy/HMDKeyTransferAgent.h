...
+ (id)logCategory;	// IMP=0x001000000068409e
- (void).cxx_destruct;	// IMP=0x000000000068404d
...
- (void)resetConfig;	// IMP=0x0000000000683e4c
- (void)beginPairingWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000683d2b
- (id)initWithHomeManager:(id)arg1;	// IMP=0x0000000000683bba
