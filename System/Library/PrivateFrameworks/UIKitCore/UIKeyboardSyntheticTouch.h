...
+ (id)syntheticTouchWithPoint:(struct CGPoint)arg1 timestamp:(double)arg2 window:(id)arg3;	// IMP=0x0060000000bd4808
- (void).cxx_destruct;	// IMP=0x0000000000bd4b03
...
- (void)_setLocationInWindow:(struct CGPoint)arg1 resetPrevious:(_Bool)arg2;	// IMP=0x0000000000bd4a5e
- (struct CGPoint)getLocationInWindow;	// IMP=0x0000000000bd4a3e
- (struct CGPoint)previousLocationInView:(id)arg1;	// IMP=0x0000000000bd49b2
- (struct CGPoint)locationInView:(id)arg1;	// IMP=0x0000000000bd4926
- (id)initWithPoint:(struct CGPoint)arg1 timestamp:(double)arg2 window:(id)arg3;	// IMP=0x0000000000bd487b
