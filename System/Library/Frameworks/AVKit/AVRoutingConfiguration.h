...
+ (id)configurationWithOutputContextID:(id)arg1 sharingPolicy:(unsigned long long)arg2;	// IMP=0x00600000000d8c2c
+ (id)defaultConfiguration;	// IMP=0x00600000000d8c0f
- (void).cxx_destruct;	// IMP=0x00000000000d8bff
...
- (_Bool)isDefault;	// IMP=0x00000000000d8be2
