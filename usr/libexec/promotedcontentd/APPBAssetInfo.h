...
- (void).cxx_destruct;	// IMP=0x002000000009cb17
...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000009c9a1
- (unsigned long long)hash;	// IMP=0x001000000009c705
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000009c55f
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000009c433
- (void)copyTo:(id)arg1;	// IMP=0x001000000009c336
- (void)writeTo:(id)arg1;	// IMP=0x001000000009c221
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000009c214
- (id)dictionaryRepresentation;	// IMP=0x001000000009bb0b
- (id)description;	// IMP=0x001000000009ba5c
...
- (int)StringAsContentType:(id)arg1;	// IMP=0x001000000009b831
- (id)contentTypeAsString:(int)arg1;	// IMP=0x001000000009b7e3
