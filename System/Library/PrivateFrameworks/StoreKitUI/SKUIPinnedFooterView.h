...
- (void).cxx_destruct;	// IMP=0x000000000002c251
...
- (void)_initializeTextView;	// IMP=0x000000000002c053
- (void)_configureTextViewTextStyling;	// IMP=0x000000000002bf4b
- (void)layoutSubviews;	// IMP=0x000000000002bd61
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000002bcb8
