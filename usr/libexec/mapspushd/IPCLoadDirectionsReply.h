...
- (void).cxx_destruct;	// IMP=0x002000000000f73e
...
- (id)description;	// IMP=0x001000000000f629
- (id)dictionaryValue;	// IMP=0x001000000000f489
- (id)initWithDictionary:(id)arg1;	// IMP=0x001000000000f304
