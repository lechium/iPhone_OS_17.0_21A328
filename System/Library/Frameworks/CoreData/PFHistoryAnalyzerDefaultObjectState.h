...
- (id)description;	// IMP=0x0000000000146c4f
- (void)updateWithChange:(id)arg1;	// IMP=0x0000000000146b7b
- (void)dealloc;	// IMP=0x0000000000146b09
- (id)initWithOriginalChange:(id)arg1;	// IMP=0x00000000001469fb
