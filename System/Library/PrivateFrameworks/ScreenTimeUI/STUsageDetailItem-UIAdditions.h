...
+ (void)iconImageForBundleIdentifier:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x002000000001d405
- (void)_didFindIconImage:(id)arg1;	// IMP=0x001000000001d30b
- (id)_monogramUsingDarkColors:(_Bool)arg1;	// IMP=0x001000000001d037
