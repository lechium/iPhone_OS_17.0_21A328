...
+ (id)_familyMembersFromDictionaryRepresentation:(id)arg1;	// IMP=0x00400000000a6a57
- (void).cxx_destruct;	// IMP=0x00200000000a7218
...
- (id)description;	// IMP=0x00100000000a69d5
@property(readonly, nonatomic) NSDictionary *dictionaryRepresentation;
- (id)initWithDictionaryRepresentation:(id)arg1 cached:(_Bool)arg2;	// IMP=0x00100000000a66f9
