...
- (void).cxx_destruct;	// IMP=0x0020000000114d6d
...
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x0010000000114924
- (void)listen;	// IMP=0x00100000001147ba
- (id)init;	// IMP=0x0010000000114748
