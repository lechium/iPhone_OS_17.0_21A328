...
- (void).cxx_destruct;	// IMP=0x00000000000c0288
...
- (void)_parsePauseDigitsFromDestinationID:(id)arg1;	// IMP=0x00100000000bfe77
- (id)dequeueAllPauseDigits;	// IMP=0x00100000000bfd79
- (id)dequeueNextPauseDigits;	// IMP=0x00100000000bfccc
@property(readonly, nonatomic) _Bool hasQueuedHardPauseDigits;
@property(readonly, nonatomic) CSDPauseDigits *nextPauseDigits;
- (id)description;	// IMP=0x00100000000bf9db
- (id)initWithDestinationID:(id)arg1;	// IMP=0x00100000000bf944
- (id)init;	// IMP=0x00100000000bf8ba
