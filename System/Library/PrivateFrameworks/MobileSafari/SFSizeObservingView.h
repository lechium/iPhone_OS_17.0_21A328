...
- (void).cxx_destruct;	// IMP=0x00000000000cf5ee
...
- (void)layoutSubviews;	// IMP=0x00000000000cf515
- (id)hitTest:(struct CGPoint)arg1 withEvent:(id)arg2;	// IMP=0x00000000000cf3fc
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000000cf206
