...
- (void).cxx_destruct;	// IMP=0x000000000093c50b
...
- (void)forceRefresh;	// IMP=0x000000000093c447
- (void)markDeleted;	// IMP=0x000000000093c436
- (void)markChanged;	// IMP=0x000000000093c425
- (id)initWithZoneID:(id)arg1;	// IMP=0x000000000093c36e
