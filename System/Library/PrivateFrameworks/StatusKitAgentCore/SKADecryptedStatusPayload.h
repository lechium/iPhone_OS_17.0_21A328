...
- (void).cxx_destruct;	// IMP=0x000000000005ae24
...
- (id)description;	// IMP=0x000000000005ad5a
- (id)initWithStatusPayload:(id)arg1 invitation:(id)arg2;	// IMP=0x000000000005acc1
