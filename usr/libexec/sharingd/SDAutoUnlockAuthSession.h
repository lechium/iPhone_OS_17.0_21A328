...
- (void).cxx_destruct;	// IMP=0x00200000001c3e5a
// Error: Property attributes should begin with the type ('T') attribute, property name: isAuthenticatingForSiri
...
- (id)peerListFromAWDLInfo:(id)arg1;	// IMP=0x00100000001c3636
- (void)sendData:(id)arg1 bleDevice:(id)arg2 direct:(_Bool)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x00100000001c307e
- (void)sendData:(id)arg1 bleDevice:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00100000001c3066
- (void)sendAWDLInfo:(_Bool)arg1;	// IMP=0x00100000001c292f
- (void)sendAWDLInfo;	// IMP=0x00100000001c291b
- (void)sendData:(id)arg1 type:(unsigned short)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00100000001c287e
- (void)sendData:(id)arg1 type:(unsigned short)arg2 errorHandler:(CDUnknownBlockType)arg3;	// IMP=0x00100000001c278d
- (void)sendAWDLInfoData:(id)arg1 type:(unsigned short)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00100000001c277b
- (void)_start;	// IMP=0x00100000001c2769
- (void)start;	// IMP=0x00100000001c26e2
- (id)getAppName;	// IMP=0x00100000001c26da
- (void)handleMessageWithWrapper:(id)arg1;	// IMP=0x00100000001c26d4
- (void)connectionActivated;	// IMP=0x00100000001c26ce
- (void)invalidate;	// IMP=0x00100000001c25d5
- (id)initWithDevice:(id)arg1 sessionID:(id)arg2 bleDevice:(id)arg3;	// IMP=0x00100000001c2538
