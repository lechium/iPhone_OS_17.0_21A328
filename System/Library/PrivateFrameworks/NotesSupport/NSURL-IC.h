...
@interface NSURL (IC)
+ (id)ic_urlFromWeblocFileAtURL:(id)arg1;	// IMP=0x00200000000255c0
...
- (_Bool)ic_isSafeFileURLForAttachment;	// IMP=0x00100000000251d0
...
- (void)ic_updateFlagToExcludeFromBackup:(_Bool)arg1;	// IMP=0x00100000000249c5
- (id)ic_dedupedURLWithProhibitedNames:(id)arg1;	// IMP=0x0010000000024720
- (void)ic_updateFlagToExcludeFromBackupNow:(_Bool)arg1;	// IMP=0x00100000000255c8
@end
