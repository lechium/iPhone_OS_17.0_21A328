...
+ (void)_addAnimations:(id)arg1 toDispatchGroup:(id)arg2;	// IMP=0x0010000001197a58
+ (void)_addAnimations:(id)arg1 toPreparingAnimations:(id)arg2 exclusiveAnimations:(id)arg3 visitedDisplayItemIdentifiers:(id)arg4;	// IMP=0x0010000001196f72
+ (void)prepareAnimations:(id)arg1 forStatusBar:(id)arg2;	// IMP=0x0010000001196d55
+ (id)animationWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x0010000001196a18
+ (void)initialize;	// IMP=0x00100000011969c1
- (void).cxx_destruct;	// IMP=0x0000000001199195
...
- (id)description;	// IMP=0x0000000001198e4e
- (id)_dependentItemIdentifiersEnabledOnly:(_Bool)arg1;	// IMP=0x0000000001198c0e
@property(readonly, nonatomic) NSSet *effectiveDelayedItemIdentifiers;
- (void)addSubAnimation:(id)arg1 forDisplayItemWithIdentifier:(id)arg2;	// IMP=0x000000000119868f
- (void)cancel;	// IMP=0x000000000119847f
- (void)addTimeout:(double)arg1 withHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000001198455
- (void)performForStatusBar:(id)arg1;	// IMP=0x0000000001197ca7
- (void)_prepareForStatusBar:(id)arg1 preparingAnimations:(id)arg2 exclusiveAnimations:(id)arg3;	// IMP=0x000000000119748a
- (void)addTotalCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000001196c87
- (void)addCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000001196bfa
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000001196add
