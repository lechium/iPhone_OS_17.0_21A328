...
+ (Class)invitedHandlesType;	// IMP=0x002000000000720c
+ (id)linkWithTUConversationLink:(id)arg1 includeGroupUUID:(_Bool)arg2;	// IMP=0x0010000000006c5b
- (void).cxx_destruct;	// IMP=0x0010000000009190
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000008d53
- (unsigned long long)hash;	// IMP=0x0010000000008a09
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000008774
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000083da
- (void)copyTo:(id)arg1;	// IMP=0x00100000000081c0
- (void)writeTo:(id)arg1;	// IMP=0x0010000000007f29
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000007f1c
- (id)dictionaryRepresentation;	// IMP=0x0010000000007521
- (id)description;	// IMP=0x0010000000007472
- (int)StringAsLinkLifetimeScope:(id)arg1;	// IMP=0x001000000000740d
- (id)linkLifetimeScopeAsString:(int)arg1;	// IMP=0x00100000000073b8
...
- (id)invitedHandlesAtIndex:(unsigned long long)arg1;	// IMP=0x00100000000071ef
- (unsigned long long)invitedHandlesCount;	// IMP=0x00100000000071d2
- (void)addInvitedHandles:(id)arg1;	// IMP=0x0010000000007168
- (void)clearInvitedHandles;	// IMP=0x001000000000714b
...
- (id)description;	// IMP=0x001000000000703e
