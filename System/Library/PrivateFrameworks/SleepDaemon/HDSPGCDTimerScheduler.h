...
- (void).cxx_destruct;	// IMP=0x000000000005fce1
...
- (void)unschedule;	// IMP=0x000000000005fcaa
- (void)scheduleEventForDate:(id)arg1 options:(unsigned long long)arg2;	// IMP=0x000000000005fba1
- (id)initWithCurrentDateProvider:(CDUnknownBlockType)arg1;	// IMP=0x000000000005fb17
