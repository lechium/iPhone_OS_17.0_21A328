...
+ (id)updateMultipleCharacteristicReadWriteResponsePayload:(id)arg1 withUnhandledRequests:(id)arg2;	// IMP=0x0060000000c96603
+ (id)notificationUpdateMessagePayloadForHome:(id)arg1 notificationEnabled:(_Bool)arg2 characteristics:(id)arg3 characteristicsErrorsMap:(id)arg4;	// IMP=0x0060000000c95dfd
+ (id)responsePayloadForHome:(id)arg1 changedAccessories:(id)arg2 moreMessagesInMultipart:(id)arg3;	// IMP=0x0060000000c95caf
- (void).cxx_destruct;	// IMP=0x0000000000c95c5c
...
- (id)attributeDescriptions;	// IMP=0x0000000000c95a17
- (id)notificationWithHome:(id)arg1;	// IMP=0x0000000000c958a7
- (id)initWithRequestIdentifier:(id)arg1 responses:(id)arg2 pendingMultiPartResponses:(_Bool)arg3;	// IMP=0x0000000000c948e4
