...
- (void).cxx_destruct;	// IMP=0x000000000011fe19
...
- (void)toggleDefaultBoolValue;	// IMP=0x000000000011fd3a
- (id)initWithTitle:(id)arg1 subtitle:(id)arg2 domain:(id)arg3 defaultName:(id)arg4 boolType:(_Bool)arg5;	// IMP=0x000000000011fc25
