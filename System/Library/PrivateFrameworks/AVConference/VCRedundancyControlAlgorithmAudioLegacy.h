...
- (void)computeRedundancyInfo;	// IMP=0x0000000000406ca8
- (void)updateRedundancyStrategyWithNetworkStatistics:(struct tagVCStatisticsMessage)arg1;	// IMP=0x0000000000406c2a
