...
- (void).cxx_destruct;	// IMP=0x0020000000002c12
...
- (unsigned long long)deltaDeliveryRequirements;	// IMP=0x0010000000002bba
- (id)mergeableDeltasForMetadata:(id)arg1 error:(id *)arg2;	// IMP=0x00100000000021e0
- (_Bool)mergeDeltas:(id)arg1 error:(id *)arg2;	// IMP=0x0010000000001d83
- (id)stateVector;	// IMP=0x0010000000001cc4
- (id)initWithStreamCRDT:(id)arg1 locationRow:(id)arg2 database:(id)arg3 queue:(id)arg4 maxDeltaSize:(long long)arg5 sessionContext:(id)arg6;	// IMP=0x0010000000001bb8
