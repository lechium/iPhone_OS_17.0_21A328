...
- (void).cxx_destruct;	// IMP=0x00000000002b2dc9
...
- (void)clearCache;	// IMP=0x00000000002b2d55
- (void)trendingSearchPageWithURL:(id)arg1 completionBlock:(CDUnknownBlockType)arg2;	// IMP=0x00000000002b2c04
- (void)requestTrendingSearchPageWithURL:(id)arg1;	// IMP=0x00000000002b2872
@property(readonly, nonatomic) NSOperationQueue *callbackQueue;
- (id)requestOperationWithPageURL:(id)arg1 completionBlock:(CDUnknownBlockType)arg2;	// IMP=0x00000000002b27b3
- (void)dealloc;	// IMP=0x00000000002b273e
- (id)initWithClientContext:(id)arg1;	// IMP=0x00000000002b2568
