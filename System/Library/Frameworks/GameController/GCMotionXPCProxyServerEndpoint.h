...
- (void).cxx_destruct;	// IMP=0x0000000000029fa8
...
- (void)fetchObjectIdentifierWithReply:(CDUnknownBlockType)arg1;	// IMP=0x0000000000029ee9
- (void)invalidateConnection;	// IMP=0x0000000000029e36
- (void)fetchSensorsActiveWithReply:(CDUnknownBlockType)arg1;	// IMP=0x0000000000029d8c
- (void)newSensorsActive:(_Bool)arg1;	// IMP=0x0000000000029ce2
- (_Bool)acceptClient:(id)arg1 onConnection:(id)arg2 error:(id *)arg3;	// IMP=0x00000000000298ff
- (void)invalidateClient;	// IMP=0x000000000002983e
@property(readonly, nonatomic) id <_GCControllerComponentDescription> receiverDescription;
- (id)initWithInitialValue:(_Bool)arg1;	// IMP=0x00000000000297a6
- (id)initWithIdentifier:(id)arg1 initialValue:(_Bool)arg2;	// IMP=0x0000000000029727
