...
- (void).cxx_destruct;	// IMP=0x00000000002fe489
...
- (id)requestDidParseProtobufObject:(id)arg1;	// IMP=0x00000000002fe2d8
- (id)generateRequestOperations;	// IMP=0x00000000002fdee6
- (id)requestOperationClasses;	// IMP=0x00000000002fde7a
- (void)fillOutEquivalencyPropertiesBuilder:(id)arg1;	// IMP=0x00000000002fdd92
- (id)initWithOperation:(id)arg1 encryptedAnonymousSharesToAdd:(id)arg2;	// IMP=0x00000000002fdcf9
- (_Bool)requiresCKAnonymousUserIDs;	// IMP=0x00000000002fdcf1
