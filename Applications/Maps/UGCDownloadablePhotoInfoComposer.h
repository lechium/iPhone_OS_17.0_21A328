...
+ (id)downloadablePhotoForUGCPhoto:(id)arg1;	// IMP=0x00200000002a3d86
+ (id)downloadablePhotoForGeoMapItemPhotoInfo:(id)arg1;	// IMP=0x00100000002a3cf4
- (void).cxx_destruct;	// IMP=0x00200000002a3e5b
...
- (id)initWithIdentifier:(id)arg1 url:(id)arg2 timeoutInterval:(double)arg3;	// IMP=0x00100000002a3c4b
