...
- (void).cxx_destruct;	// IMP=0x0000000000b3a305
- (unsigned long long)hash;	// IMP=0x0000000000b3a242
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000b3a0c4
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000b39a85
- (void)writeTo:(id)arg1;	// IMP=0x0000000000b38433
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000b38424
- (id)jsonRepresentation;	// IMP=0x0000000000b321de
- (id)dictionaryRepresentation;	// IMP=0x0000000000b317b2
- (id)description;	// IMP=0x0000000000b31703
- (id)initWithData:(id)arg1;	// IMP=0x0000000000b3035d
- (id)init;	// IMP=0x0000000000b30301
