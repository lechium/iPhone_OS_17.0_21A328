...
+ (id)defaultConfiguration;	// IMP=0x006000000001ced0
- (void).cxx_destruct;	// IMP=0x000000000001d283
...
- (id)initWithSubsystem:(id)arg1 category:(id)arg2;	// IMP=0x000000000001ce03
