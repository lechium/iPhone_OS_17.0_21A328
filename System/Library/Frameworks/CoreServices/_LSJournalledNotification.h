...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000175400
- (void).cxx_destruct;	// IMP=0x00000000001756d1
...
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000175553
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001754b2
- (id)initWithNotification:(int)arg1 bundleIDs:(id)arg2 plugins:(_Bool)arg3 options:(id)arg4;	// IMP=0x0000000000175408
