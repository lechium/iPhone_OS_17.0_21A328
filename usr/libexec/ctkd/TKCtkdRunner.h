...
- (void).cxx_destruct;	// IMP=0x0020000000003038
...
- (void)run;	// IMP=0x00100000000029b4
- (void)ensureSlotWatcherIsRunning;	// IMP=0x001000000000292e
- (id)initWithArgc:(int)arg1 argv:(const char **)arg2;	// IMP=0x0010000000002735
...
- (void)initializeSandBox;	// IMP=0x001000000000261b
