...
+ (id)makeFeatureJSObjectForFeature:(id)arg1;	// IMP=0x001000000000b392
+ (void)registerFeature;	// IMP=0x001000000000b360
- (void).cxx_destruct;	// IMP=0x000000000000b78f
...
- (id)initWithDOMNode:(id)arg1 featureName:(id)arg2;	// IMP=0x000000000000b429
