...
- (id).cxx_construct;	// IMP=0x0000000000657e7f
- (void).cxx_destruct;	// IMP=0x0000000000657e57
...
- (id)initWithName:(id)arg1 shieldGroup:(id)arg2 offset:(struct PolylineCoordinate)arg3;	// IMP=0x0000000000657d6a
