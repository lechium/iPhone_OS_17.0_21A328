...
- (void).cxx_destruct;	// IMP=0x000000000003ab30
...
- (void)hide;	// IMP=0x000000000003a6f9
- (void)show;	// IMP=0x000000000003a330
- (id)initWithView:(id)arg1 minimumDuration:(double)arg2;	// IMP=0x000000000003a0f3
