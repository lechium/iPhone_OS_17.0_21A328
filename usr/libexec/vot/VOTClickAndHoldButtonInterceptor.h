...
- (void).cxx_destruct;	// IMP=0x002000000013ae78
...
- (void)_drainQueueAndSendEventsToSystem:(_Bool)arg1;	// IMP=0x001000000013ac22
- (void)_releaseTimerFired;	// IMP=0x001000000013abb3
- (void)_holdTimerFired;	// IMP=0x001000000013ab44
- (void)_resetStateAndSendPendingEventsToSystem:(_Bool)arg1;	// IMP=0x001000000013aadc
- (void)_processStateChangeWithEvent:(long long)arg1 axEvent:(id)arg2;	// IMP=0x001000000013a6ef
- (void)buttonUpOccurred:(id)arg1;	// IMP=0x001000000013a60a
- (void)buttonDownOccurred:(id)arg1;	// IMP=0x001000000013a528
- (void)dealloc;	// IMP=0x001000000013a495
- (id)initWithThreadKey:(id)arg1;	// IMP=0x001000000013a30f
