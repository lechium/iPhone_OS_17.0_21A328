...
- (void).cxx_destruct;	// IMP=0x000000000124db79
- (unsigned long long)hash;	// IMP=0x000000000124d663
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000124d41e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000124d183
- (void)writeTo:(id)arg1;	// IMP=0x000000000124ce7b
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000124ce6c
- (id)jsonRepresentation;	// IMP=0x000000000124bbf7
- (id)dictionaryRepresentation;	// IMP=0x000000000124b60f
- (id)description;	// IMP=0x000000000124b560
- (void)dealloc;	// IMP=0x000000000124a338
- (id)initWithData:(id)arg1;	// IMP=0x000000000124a2dc
- (id)init;	// IMP=0x000000000124a280
- (id)initWithIdentifier:(id)arg1;	// IMP=0x0000000000a9f078
- (id)initWithVenueID:(unsigned long long)arg1 featureID:(unsigned long long)arg2 businessID:(unsigned long long)arg3 componentIdentifier:(id)arg4;	// IMP=0x0000000000a9ec44
- (id)initWithVenueID:(unsigned long long)arg1 featureID:(unsigned long long)arg2 businessID:(unsigned long long)arg3;	// IMP=0x0000000000a9eb42
