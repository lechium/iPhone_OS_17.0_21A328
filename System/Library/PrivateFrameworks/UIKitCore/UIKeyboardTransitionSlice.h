...
+ (id)sliceWithStart:(struct CGRect)arg1 end:(struct CGRect)arg2;	// IMP=0x0060000000e483c5
- (void).cxx_destruct;	// IMP=0x0000000000e48694
...
- (id)description;	// IMP=0x0000000000e484e8
@property(readonly) _Bool hasGeometry;
- (void)addStartRect:(struct CGRect)arg1 end:(struct CGRect)arg2;	// IMP=0x0000000000e4842b
- (id)init;	// IMP=0x0000000000e48326
