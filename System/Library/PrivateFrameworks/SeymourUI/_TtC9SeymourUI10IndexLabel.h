...
- (void).cxx_destruct;	// IMP=0x0000000000376350
- (void)textSizeUpdated:(id)arg1;	// IMP=0x0000000000375f80
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000375e00
- (void)layoutSubviews;	// IMP=0x0000000000375dd0
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000375bd0
