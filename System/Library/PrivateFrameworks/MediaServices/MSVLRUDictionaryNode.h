...
- (void).cxx_destruct;	// IMP=0x00000000000529fe
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000052958
- (id)initWithKey:(id)arg1 object:(id)arg2;	// IMP=0x00000000000528bf
