...
- (void).cxx_destruct;	// IMP=0x0000000000580cea
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000058080b
- (unsigned long long)hash;	// IMP=0x00000000005804bb
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000057ffc9
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000057fc71
- (void)copyTo:(id)arg1;	// IMP=0x000000000057f948
- (void)writeTo:(id)arg1;	// IMP=0x000000000057f5cc
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000057e65a
- (id)dictionaryRepresentation;	// IMP=0x000000000057dd5c
- (id)description;	// IMP=0x000000000057dcad
