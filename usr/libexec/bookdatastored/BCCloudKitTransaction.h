...
+ (id)transactionNameForEntityName:(id)arg1;	// IMP=0x0040000000039461
- (void).cxx_destruct;	// IMP=0x0020000000039fdc
...
- (void)laq_scheduleTransactionLifetime;	// IMP=0x0010000000039a8f
- (void)signal;	// IMP=0x001000000003963a
- (void)clientConnected;	// IMP=0x001000000003952b
- (double)transactionLifetimeTimout;	// IMP=0x001000000003951d
- (double)coalescingDelay;	// IMP=0x001000000003950f
- (void)performWorkWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00100000000394e4
- (id)transactionName;	// IMP=0x001000000003947a
- (id)initWithEntityName:(id)arg1 delegate:(id)arg2;	// IMP=0x0010000000039044
