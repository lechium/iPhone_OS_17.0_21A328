...
+ (_Bool)supportsSecureCoding;	// IMP=0x00200000000148f8
- (void).cxx_destruct;	// IMP=0x00200000000153b6
...
- (id)initWithCoder:(id)arg1;	// IMP=0x00100000000149a6
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000014900
