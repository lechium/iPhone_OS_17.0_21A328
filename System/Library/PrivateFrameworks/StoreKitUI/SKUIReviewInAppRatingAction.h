...
+ (id)actionWithCustomContentViewController:(id)arg1;	// IMP=0x00600000002f7f02
- (void).cxx_destruct;	// IMP=0x00000000002f80d7
...
- (void)setCustomEnabledState:(_Bool)arg1;	// IMP=0x00000000002f7fb6
- (void)setEnabled:(_Bool)arg1;	// IMP=0x00000000002f7f6d
