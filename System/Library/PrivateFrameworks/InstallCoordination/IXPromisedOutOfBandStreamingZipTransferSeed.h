...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000004436c
...
- (Class)clientPromiseClass;	// IMP=0x000000000004445f
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000044374
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000441fd
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000044084
