...
- (void).cxx_destruct;	// IMP=0x000000000006adcf
...
- (id)detectionWindowForType:(unsigned long long)arg1;	// IMP=0x000000000006ad1b
...
- (void)postWakeDetectionNotification:(unsigned long long)arg1;	// IMP=0x000000000006aa10
- (void)stopWakeDetection;	// IMP=0x000000000006a9e2
- (void)startWakeDetection:(unsigned long long)arg1;	// IMP=0x000000000006a977
- (void)earlyWakeUpWasNotifiedRemotely;	// IMP=0x000000000006a93a
- (void)wakeupEventDetected:(unsigned long long)arg1 date:(id)arg2;	// IMP=0x000000000006a8c3
- (unsigned long long)loggingCategory;	// IMP=0x000000000006a8b8
- (id)allStates;	// IMP=0x000000000006a811
- (id)initWithIdentifier:(id)arg1 persistence:(id)arg2 delegate:(id)arg3 infoProvider:(id)arg4 currentDateProvider:(CDUnknownBlockType)arg5;	// IMP=0x000000000006a513
