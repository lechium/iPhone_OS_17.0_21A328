...
- (_Bool)isBurstAction;	// IMP=0x0000000000020344
- (float)predictResult;	// IMP=0x0000000000020270
- (double)computeKernelValueWithSupportVector:(const struct CIBurstSupportVector *)arg1;	// IMP=0x00000000000201f6
- (void)scaleVector;	// IMP=0x00000000000200b6
- (id)initWithVersion:(int)arg1;	// IMP=0x000000000002004d
- (id)init;	// IMP=0x000000000001fffe
