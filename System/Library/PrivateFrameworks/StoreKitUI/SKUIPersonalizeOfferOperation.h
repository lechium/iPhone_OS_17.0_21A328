...
- (void).cxx_destruct;	// IMP=0x000000000027549b
- (void)main;	// IMP=0x0000000000274ebb
@property(copy) CDUnknownBlockType outputBlock;
- (id)initWithItemIdentifier:(long long)arg1 clientContext:(id)arg2;	// IMP=0x0000000000274ba4
