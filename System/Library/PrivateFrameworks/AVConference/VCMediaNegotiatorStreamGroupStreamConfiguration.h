...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000f8c4e
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000f86ad
- (_Bool)isEqualPayloads:(id)arg1;	// IMP=0x00000000000f856c
- (_Bool)applyCipherSuiteOnMediaStreamConfig:(id)arg1 codecConfigs:(id)arg2;	// IMP=0x00000000000f831b
- (_Bool)areCodecsEqualTo:(id)arg1;	// IMP=0x00000000000f82be
- (void)resetCodecs;	// IMP=0x00000000000f82a8
- (void)removeCodec:(unsigned int)arg1;	// IMP=0x00000000000f826f
- (void)addCodec:(unsigned int)arg1;	// IMP=0x00000000000f8236
- (void)resetPayloads;	// IMP=0x00000000000f8220
- (void)addPayload:(int)arg1;	// IMP=0x00000000000f81e7
- (void)dealloc;	// IMP=0x00000000000f817a
- (id)init;	// IMP=0x00000000000f80f4
