...
- (void).cxx_destruct;	// IMP=0x002000000003a19c
...
- (id)localPBStatus;	// IMP=0x001000000003973b
- (id);	// IMP=0x001000000003972e
- (void)hideProgressUI:(_Bool)arg1;	// IMP=0x001000000003929a
- (void)showProgressUI:(id)arg1;	// IMP=0x0010000000038720
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x0010000000037a62
- (void)advertiser:(id)arg1 didReceiveInputStream:(id)arg2 outputStream:(id)arg3;	// IMP=0x0010000000036e6b
- (void)startServiceForPasteVersion:(long long)arg1 handler:(CDUnknownBlockType)arg2;	// IMP=0x001000000003509a
- (void)getLocalPasteboardInfoData:(CDUnknownBlockType)arg1;	// IMP=0x0010000000034f43
- (void)setLocalPasteboardReflection:(_Bool)arg1;	// IMP=0x0010000000034f31
- (void)receivePasteboardStreamData:(id)arg1 version:(long long)arg2 withCompletion:(CDUnknownBlockType)arg3;	// IMP=0x0010000000032525
- (void)fetchRemotePasteboardForProcess:(int)arg1 withCompletion:(CDUnknownBlockType)arg2;	// IMP=0x001000000003040c
- (void)fetchRemotePasteboardTypesForProcess:(int)arg1 withCompletion:(CDUnknownBlockType)arg2;	// IMP=0x001000000003010a
- (void)removeLocalPasteboardFromAdvertisers:(id)arg1;	// IMP=0x0010000000030016
- (void)clearLocalPasteboardTypes:(id)arg1;	// IMP=0x001000000002fda4
- (void)clearLocalPasteboardInformation;	// IMP=0x001000000002fcde
- (void)localPasteboardTypesDidChange:(id)arg1 forGeneration:(unsigned long long)arg2;	// IMP=0x001000000002f62f
- (void)fetchRemoteDeviceName:(CDUnknownBlockType)arg1;	// IMP=0x001000000002f55d
- (void)fetchRemotePasteboardStatus:(CDUnknownBlockType)arg1;	// IMP=0x001000000002f4f7
- (void)setReturnPasteboardDataEarlyWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x001000000002f3e2
- (void)setRemotePasteboardAvalibility:(_Bool)arg1 withDataRequester:(id)arg2;	// IMP=0x001000000002f04d
- (id)currentPasteboardActivityInfo;	// IMP=0x001000000002ed37
- (id)eligibleAdvertiseableItemsInOrder;	// IMP=0x001000000002ebf7
- (id)items;	// IMP=0x001000000002ebe5
- (void)startConnection:(int)arg1;	// IMP=0x001000000002eb50
...
- (id)uuid;	// IMP=0x001000000002e8d7
- (void)dealloc;	// IMP=0x001000000002e80f
- (id)initWithManager:(id)arg1 name:(id)arg2;	// IMP=0x001000000002e165
