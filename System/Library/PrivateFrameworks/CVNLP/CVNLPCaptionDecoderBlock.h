...
- (id).cxx_construct;	// IMP=0x0000000000077380
- (void).cxx_destruct;	// IMP=0x0000000000077290
...
- (void)_runBlockWithCopyOutputBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000000076840
- (void)runBlockWithCopyInput:(float *)arg1 copyOutputBlock:(CDUnknownBlockType)arg2;	// IMP=0x00000000000766a0
- (void)runBlockWithCopyInputBlock:(CDUnknownBlockType)arg1 copyOutputBlock:(CDUnknownBlockType)arg2;	// IMP=0x0000000000076480
- (void)copyOutputState:(id)arg1;	// IMP=0x00000000000756c0
- (void)copyInputState:(id)arg1;	// IMP=0x0000000000074b80
- (void)buildNetworkForSequenceLength:(unsigned long long)arg1 imageFeatures:(id)arg2;	// IMP=0x0000000000070b00
- (_Bool)_loadNetwork:(id)arg1 modelIndex:(unsigned long long)arg2;	// IMP=0x000000000006f820
- (void)dealloc;	// IMP=0x000000000006f700
- (id)initWithOptions:(id)arg1 modelIndex:(unsigned long long)arg2 runTimeParams:(id)arg3;	// IMP=0x000000000006f4e0
