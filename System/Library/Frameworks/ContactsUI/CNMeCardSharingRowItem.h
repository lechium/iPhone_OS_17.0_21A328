...
- (void).cxx_destruct;	// IMP=0x000000000025a868
...
- (id)initWithLabel:(id)arg1 accessoryView:(id)arg2 confirmationHandler:(CDUnknownBlockType)arg3;	// IMP=0x000000000025a760
- (id)initWithLabel:(id)arg1 accessoryView:(id)arg2;	// IMP=0x000000000025a74b
