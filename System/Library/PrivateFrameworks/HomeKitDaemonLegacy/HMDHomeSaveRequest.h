...
- (void).cxx_destruct;	// IMP=0x0000000000900585
...
- (void)_updateSaveOptions:(_Bool)arg1 reason:(id)arg2;	// IMP=0x00000000009004dc
- (id)initWithReason:(id)arg1 information:(id)arg2 saveOptions:(unsigned long long)arg3;	// IMP=0x00000000009004b4
- (id)initWithReason:(id)arg1 information:(id)arg2 postSyncNotification:(_Bool)arg3;	// IMP=0x0000000000900487
- (id)initWithHome:(id)arg1 reason:(id)arg2 information:(id)arg3 postSyncNotification:(_Bool)arg4 objectChange:(_Bool)arg5;	// IMP=0x0000000000900400
- (id)_initWithHome:(id)arg1 reason:(id)arg2 information:(id)arg3 postSyncNotification:(_Bool)arg4 objectChange:(_Bool)arg5 saveOptions:(unsigned long long)arg6;	// IMP=0x00000000009002f6
