...
+ (id)sharedHandle;	// IMP=0x00600000001849ef
...
- (id)predictVectorForString:(void *)arg1 inputString:(id)arg2 error:(id *)arg3;	// IMP=0x00000000001847aa
- (id)predictLabelForWordString:(void *)arg1 inputString:(id)arg2 error:(id *)arg3;	// IMP=0x0000000000184651
- (id)predictLabelsForSentenceString:(void *)arg1 inputString:(id)arg2 error:(id *)arg3;	// IMP=0x00000000001844fb
- (id)predictTokensLabelsLocationsLengthsForString:(void *)arg1 inputString:(id)arg2 error:(id *)arg3;	// IMP=0x00000000001843a5
- (void *)initializeEmbeddingModelWithData:(id)arg1 error:(id *)arg2;	// IMP=0x000000000018435d
- (void *)initializeGazetteerModelWithData:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000184318
- (void *)initializeSentenceClassifierModelWithData:(id)arg1 error:(id *)arg2;	// IMP=0x00000000001842d3
- (void *)initializeWordTaggingModelWithData:(id)arg1 error:(id *)arg2;	// IMP=0x000000000018428e
- (id)init;	// IMP=0x0000000000183fde
