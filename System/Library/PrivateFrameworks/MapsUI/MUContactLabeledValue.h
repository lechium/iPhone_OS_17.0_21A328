...
- (void).cxx_destruct;	// IMP=0x00000000000f3801
...
- (id)initWithContactLabeledValue:(id)arg1 type:(long long)arg2;	// IMP=0x00000000000f368c
- (id)glyphName;	// IMP=0x00000000000f3663
