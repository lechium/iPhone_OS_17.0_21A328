...
+ (id)storeAccountWithDSID:(id)arg1 altDSID:(id)arg2 username:(id)arg3;	// IMP=0x0040000000138fce
+ (id)satelliteStoreAccountForFamilyMember:(id)arg1;	// IMP=0x0010000000138ea9
- (void).cxx_destruct;	// IMP=0x00200000001397e6
...
- (void)authenticateWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00100000001391d4
- (id)initWithContext:(id)arg1;	// IMP=0x0010000000138dde
