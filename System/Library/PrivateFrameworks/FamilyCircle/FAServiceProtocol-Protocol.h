...
- (void)enableSettingsForMemberDSID:(NSNumber *)arg1 screentimeModelCache:(FAScreentimeSettingsObjectCache *)arg2 options:(NSDictionary *)arg3 replyBlock:(void (^)(NSNumber *, NSError *))arg4;
