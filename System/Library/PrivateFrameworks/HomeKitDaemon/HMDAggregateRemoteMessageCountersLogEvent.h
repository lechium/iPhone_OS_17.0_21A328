...
+ (_Bool)submitEventWithHistogrammedAggregateHomeDataCommonDimensions;	// IMP=0x001000000060d918
+ (id)aggregateRemoteCountersLogEventWithMessageName:(id)arg1 deviceType:(id)arg2 transportType:(id)arg3 direction:(id)arg4 isPrimaryResident:(_Bool)arg5 count:(id)arg6;	// IMP=0x001000000060d840
- (void).cxx_destruct;	// IMP=0x000000000060d7dc
...
- (id)__initWithMessageName:(id)arg1 deviceType:(id)arg2 transportType:(id)arg3 direction:(id)arg4 isPrimaryResident:(_Bool)arg5 count:(id)arg6;	// IMP=0x000000000060d466
- (id)init;	// IMP=0x000000000060d3be
