...
- (void).cxx_destruct;	// IMP=0x0000000000078438
...
- (void)setupStatement:(id)arg1;	// IMP=0x000000000007828a
- (void)orderDescendingByProperty:(id)arg1;	// IMP=0x0000000000078210
- (void)orderAscendingByProperty:(id)arg1;	// IMP=0x0000000000078196
