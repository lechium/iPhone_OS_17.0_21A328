...
- (void).cxx_destruct;	// IMP=0x000000000010f7d4
...
- (id)initWithVideo:(id)arg1;	// IMP=0x000000000010f6e2
- (id)initWithVideoViewElement:(id)arg1 assetViewElement:(id)arg2;	// IMP=0x000000000010f562
- (id)initWithContentURL:(id)arg1;	// IMP=0x000000000010f508
- (id)init;	// IMP=0x000000000010f4c2
