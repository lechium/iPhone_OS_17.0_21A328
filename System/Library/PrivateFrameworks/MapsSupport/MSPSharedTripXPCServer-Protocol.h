...
- (void)stopSharingTripWithCompletion:(void (^)(NSError *))arg1;
- (void)stopSharingTripWithMessagesGroup:(NSString *)arg1 completion:(void (^)(NSError *))arg2;
- (void)stopSharingTripWithContacts:(NSArray *)arg1 completion:(void (^)(NSError *))arg2;
