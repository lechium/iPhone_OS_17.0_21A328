...
- (void).cxx_destruct;	// IMP=0x0000000000317fa5
...
- (void)recordDictationTipReplacementText:(id)arg1;	// IMP=0x0000000000317f07
- (void)startRecodingReplacementText:(id)arg1;	// IMP=0x0000000000317ef5
- (void)finalizeRecordedText;	// IMP=0x0000000000317d6f
- (void)recordDictationTipText:(id)arg1;	// IMP=0x0000000000317cc9
- (void)startRecodingText:(id)arg1;	// IMP=0x0000000000317c0e
- (void)resetHandler;	// IMP=0x0000000000317bb6
- (id)initWithDelegate:(id)arg1;	// IMP=0x0000000000317afd
