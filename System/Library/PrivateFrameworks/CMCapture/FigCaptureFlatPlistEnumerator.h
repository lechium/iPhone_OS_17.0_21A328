...
- (id)nextObject;	// IMP=0x0000000000005c87
- (id)allObjects;	// IMP=0x0000000000005b92
- (id)initWithFlatPlist:(id)arg1 offset:(unsigned long long)arg2 count:(unsigned long long)arg3;	// IMP=0x0000000000005aed
