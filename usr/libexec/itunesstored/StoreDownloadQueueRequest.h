...
+ (void)initialize;	// IMP=0x00200000000c0167
- (void);	// IMP=0x00200000000c02b5
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000c00cb
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000bffa1
- (unsigned long long)hash;	// IMP=0x00100000000bff8b
- (id)description;	// IMP=0x00100000000bff2b
@property(readonly, nonatomic) NSString *queueCountURLBagKey;
@property(readonly, nonatomic) NSString *queueContentsURLBagKey;
- (void)dealloc;	// IMP=0x00100000000bfe78
