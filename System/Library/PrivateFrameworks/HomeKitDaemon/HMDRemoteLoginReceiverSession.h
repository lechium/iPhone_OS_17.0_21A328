...
- (void).cxx_destruct;	// IMP=0x0000000000273758
...
- (id)description;	// IMP=0x00000000002736b9
- (void)dealloc;	// IMP=0x00000000002735c9
- (id)initWithSessionID:(id)arg1 remoteAuthentication:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x00000000002734f5
