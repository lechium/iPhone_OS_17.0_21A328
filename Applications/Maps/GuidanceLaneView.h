...
- (void).cxx_destruct;	// IMP=0x00200000008ad04d
...
- (void)drawRect:(struct CGRect)arg1;	// IMP=0x00100000008ac990
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x00100000008ac8c1
- (id)_defaultInvalidArrowColor;	// IMP=0x00100000008ac87e
- (id)_validArrowColor;	// IMP=0x00100000008ac869
- (id)_preferredArrowColor;	// IMP=0x00100000008ac80a
- (_Bool)_markFirstDirectionAsValid;	// IMP=0x00100000008ac802
- (_Bool)_highlightFirstDirection;	// IMP=0x00100000008ac71f
- (struct CGSize)intrinsicContentSize;	// IMP=0x00100000008ac707
- (void)_updateLanePaths;	// IMP=0x00100000008ac532
- (id)accessibilityIdentifier;	// IMP=0x00100000008ac445
- (id)initWithLaneInfo:(id)arg1 maneuverHasPreferredLane:(_Bool)arg2 drawingBiasDirection:(unsigned long long)arg3 laneStyle:(unsigned long long)arg4;	// IMP=0x00100000008ac268
