...
+ (id)logCategory;	// IMP=0x001000000030e787
- (void).cxx_destruct;	// IMP=0x000000000030d9f1
...
- (void)removeResponses:(id)arg1;	// IMP=0x000000000030d7ad
- (void)addActionSetRequest:(id)arg1 actionSet:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x000000000030d2a1
- (void)addWriteRequests:(id)arg1 home:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x000000000030ceb6
- (void)addReadRequests:(id)arg1 home:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x000000000030cacb
- (void)addMediaWriteRequests:(id)arg1 withRequestProperty:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x000000000030c3a1
- (void)handleAccessoryCharacteristicsChangedNotification:(id)arg1;	// IMP=0x000000000030c2e9
- (void)__handleAccessoryCharacteristicsChanged:(id)arg1;	// IMP=0x000000000030b33c
- (void)_reportOperationStartedForAccessory:(id)arg1;	// IMP=0x000000000030aafb
- (void)reportOperationStartedForAccessory:(id)arg1;	// IMP=0x000000000030aa43
- (void)_reportResponses;	// IMP=0x0000000000309d82
- (void)_reportResponsesForMediaRequests;	// IMP=0x000000000030965f
- (void)timeoutAndReportResults;	// IMP=0x00000000003095ee
- (void)_register;	// IMP=0x000000000030958a
@property(readonly, nonatomic) NSObject<OS_dispatch_queue> *messageReceiveQueue;
@property(readonly, nonatomic) NSUUID *messageTargetUUID;
- (void)dealloc;	// IMP=0x00000000003094be
- (id)initWithQueue:(id)arg1 msgDispatcher:(id)arg2;	// IMP=0x0000000000309367
