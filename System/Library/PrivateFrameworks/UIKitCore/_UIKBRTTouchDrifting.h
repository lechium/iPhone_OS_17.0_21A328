...
+ (_Bool)isEnabled;	// IMP=0x0060000000e00678
- (void).cxx_destruct;	// IMP=0x0000000000e05b1e
...
- (void)_updateDriftViewTimer:(id)arg1;	// IMP=0x0000000000e0541e
- (void)_updateDriftView;	// IMP=0x0000000000e03bbb
- (struct CGPoint)_pinOffset:(struct CGPoint)arg1;	// IMP=0x0000000000e03ad8
- (struct CGPoint)_pointFromPoint:(struct CGPoint)arg1 plusOffset:(struct CGPoint)arg2;	// IMP=0x0000000000e03aca
- (struct CGPoint)_offsetForPoint:(struct CGPoint)arg1 fromPoint:(struct CGPoint)arg2;	// IMP=0x0000000000e03abc
- (void)_updateDriftForFingers:(id)arg1 leftHand:(_Bool)arg2 newestTouch:(id)arg3;	// IMP=0x0000000000e03052
- (void)_updateDriftWithTouchInfo:(id)arg1;	// IMP=0x0000000000e0265a
- (id)_touchDictWithFingerIds:(id)arg1;	// IMP=0x0000000000e0221d
- (void)_updateHistory;	// IMP=0x0000000000e021d4
- (void)removeTouchWithIdentifier:(id)arg1 touchCancelled:(_Bool)arg2;	// IMP=0x0000000000e01e2d
- (void)moveTouchWithIdentifier:(id)arg1 toLocation:(struct CGPoint)arg2 withRadius:(double)arg3 atTouchTime:(double)arg4;	// IMP=0x0000000000e01b46
- (void)ignoreTouchWithIdentifier:(id)arg1 withTouchTime:(double)arg2;	// IMP=0x0000000000e0174e
- (void)updateTouchWithIdentifier:(id)arg1 withTouchTime:(double)arg2 resultingError:(struct CGPoint)arg3 rowOffsetFromHomeRow:(long long)arg4;	// IMP=0x0000000000e014aa
- (void)addTouchLocation:(struct CGPoint)arg1 withRadius:(double)arg2 withTouchTime:(double)arg3 withIdentifier:(id)arg4;	// IMP=0x0000000000e01247
...
- (void)updateWithFCenter:(struct CGPoint)arg1 jCenter:(struct CGPoint)arg2 keySize:(struct CGSize)arg3 rowOffsets:(id)arg4 homeRowOffsetIndex:(int)arg5;	// IMP=0x0000000000e00f2a
- (void)reset;	// IMP=0x0000000000e00cd7
- (void)_resetFeedback;	// IMP=0x0000000000e00c0e
- (void)dealloc;	// IMP=0x0000000000e00bd0
- (id)initWithParentView:(id)arg1;	// IMP=0x0000000000e00b7f
- (id)init;	// IMP=0x0000000000e006a3
