...
- (void).cxx_destruct;	// IMP=0x0000000000437cb2
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000437ac4
- (id)description;	// IMP=0x0000000000437a07
- (id)initWithProfile:(id)arg1 level:(id)arg2 videoTier:(id)arg3;	// IMP=0x000000000043793d
