...
- (void).cxx_destruct;	// IMP=0x0000000000315ef9
...
- (void)_setupDecryptCallbackForQueue:(id)arg1;	// IMP=0x0000000000315b9a
- (id)initWithRecord:(id)arg1 callbackQueue:(id)arg2;	// IMP=0x0000000000315a24
- (id)init;	// IMP=0x00000000003159a8
