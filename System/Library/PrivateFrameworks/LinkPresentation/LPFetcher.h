...
- (void).cxx_destruct;	// IMP=0x0000000000035e6b
...
- (void)cancel;	// IMP=0x0000000000035e26
- (void)fetchWithConfiguration:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000035e16
- (id)init;	// IMP=0x0000000000035db7
