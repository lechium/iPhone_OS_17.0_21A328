...
- (void).cxx_destruct;	// IMP=0x0020000000d2d495
...
- (void)cancel;	// IMP=0x0010000000d2d327
- (void)startWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x0010000000d2ca67
@property(readonly, nonatomic) Result *result;
@property(readonly, nonatomic) _Bool inProgress;
- (id)initWithTracePath:(id)arg1;	// IMP=0x0010000000d2c653
