...
- (void).cxx_destruct;	// IMP=0x000000000028e80f
...
- (struct CGSize)sizeForImportItemViewModel:(id)arg1;	// IMP=0x000000000028e67e
- (void)updatePreferredContentSize;	// IMP=0x000000000028e580
- (void)viewDidLoad;	// IMP=0x000000000028e420
- (id)initWithImportItemViewModel:(id)arg1 startingImage:(id)arg2 mediaProvider:(id)arg3;	// IMP=0x000000000028e326
