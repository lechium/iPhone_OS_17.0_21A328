...
- (void).cxx_destruct;	// IMP=0x00200000000891ff
- (void)setCommandPullSnapshotResponse:(id)arg1;	// IMP=0x00100000000891dd
- (id)getCommandPullSnapshotResponse;	// IMP=0x00100000000891a5
- (void)setCommandPullSnapshotRequest:(id)arg1;	// IMP=0x0010000000089183
- (id)getCommandPullSnapshotRequest;	// IMP=0x001000000008914b
- (void)setCommandPullDeltaResponse:(id)arg1;	// IMP=0x0010000000089129
- (id)getCommandPullDeltaResponse;	// IMP=0x00100000000890f1
- (void)setCommandPullDeltaRequest:(id)arg1;	// IMP=0x00100000000890d1
- (id)getCommandPullDeltaRequest;	// IMP=0x0010000000089099
- (void)setCommandPullGenerationsResponse:(id)arg1;	// IMP=0x0010000000089079
- (id)getCommandPullGenerationsResponse;	// IMP=0x0010000000089041
- (void)setCommandPullGenerationsRequest:(id)arg1;	// IMP=0x0010000000089021
- (id)getCommandPullGenerationsRequest;	// IMP=0x0010000000088fe9
- (void)setCommandPushGenerationsResponse:(id)arg1;	// IMP=0x0010000000088fc9
- (id)getCommandPushGenerationsResponse;	// IMP=0x0010000000088f91
- (void)setCommandPushGenerationsRequest:(id)arg1;	// IMP=0x0010000000088f71
- (id)getCommandPushGenerationsRequest;	// IMP=0x0010000000088f39
- (void)setType:(long long)arg1;	// IMP=0x0010000000088f2b
- (long long)getType;	// IMP=0x0010000000088f09
- (void)setSequence:(unsigned long long)arg1;	// IMP=0x0010000000088efb
- (unsigned long long)getSequence;	// IMP=0x0010000000088ed9
- (_Bool)isDirty;	// IMP=0x0010000000088ece
- (id)initWithBase:(id)arg1;	// IMP=0x0010000000088e63
