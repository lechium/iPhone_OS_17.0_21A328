...
- (void).cxx_destruct;	// IMP=0x0000000000ed9327
...
- (void)performReset;	// IMP=0x0000000000ed9018
- (_Bool)isViewAnimating;	// IMP=0x0000000000ed8f7f
- (void)reset;	// IMP=0x0000000000ed8f48
- (void)animateAutocorrectionAccepted;	// IMP=0x0000000000ed8c25
- (void)dismissAutocorrectBubble;	// IMP=0x0000000000ed8bc6
- (void)didTapAutocorrectionBubble;	// IMP=0x0000000000ed8bb4
- (id)createTypedTextViewWithTypedText:(id)arg1;	// IMP=0x0000000000ed87ca
- (void)updateSelfWithRect:(struct CGRect)arg1;	// IMP=0x0000000000ed819a
- (void)updateBubbleWithAutocorrectionText:(id)arg1 referenceRect:(struct CGRect)arg2;	// IMP=0x0000000000ed7db1
- (void)updateFakeTextSelectionHighlightForRect:(struct CGRect)arg1;	// IMP=0x0000000000ed77f0
- (void)updateWithAutocorrectionText:(id)arg1 typedText:(id)arg2 referenceTextView:(id)arg3 referenceRect:(struct CGRect)arg4;	// IMP=0x0000000000ed7730
- (id)init;	// IMP=0x0000000000ed76b6
