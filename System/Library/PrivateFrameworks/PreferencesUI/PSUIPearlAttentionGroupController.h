...
- (void).cxx_destruct;	// IMP=0x000000000000363f
...
- (_Bool)isPeriocularEnabled;	// IMP=0x00000000000035ce
- (_Bool)useAlternateFooterTextForAttention;	// IMP=0x00000000000035c6
- (id)specifiers;	// IMP=0x0000000000003588
- (id)initWithListController:(id)arg1 groupSpecifier:(id)arg2;	// IMP=0x00000000000034f6
