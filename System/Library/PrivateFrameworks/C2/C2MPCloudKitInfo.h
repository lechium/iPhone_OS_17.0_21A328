...
+ (Class)clientOperationType;	// IMP=0x001000000001697f
+ (Class)operationGroupType;	// IMP=0x0010000000016815
- (void).cxx_destruct;	// IMP=0x0000000000018f93
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000000189a2
- (unsigned long long)hash;	// IMP=0x000000000001879f
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000018469
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000017f69
- (void)copyTo:(id)arg1;	// IMP=0x0000000000017c57
- (void)writeTo:(id)arg1;	// IMP=0x0000000000017881
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000017874
- (id)dictionaryRepresentation;	// IMP=0x0000000000016acf
- (id)description;	// IMP=0x0000000000016a20
@property(nonatomic) _Bool hasReportClientOperationFrequencyBase;
@property(nonatomic) _Bool hasReportClientOperationFrequency;
- (id)clientOperationAtIndex:(unsigned long long)arg1;	// IMP=0x0000000000016962
- (unsigned long long)clientOperationsCount;	// IMP=0x0000000000016945
- (void)addClientOperation:(id)arg1;	// IMP=0x00000000000168db
- (void)clearClientOperations;	// IMP=0x00000000000168be
@property(nonatomic) _Bool hasReportOperationGroupFrequencyBase;
@property(nonatomic) _Bool hasReportOperationGroupFrequency;
- (id)operationGroupAtIndex:(unsigned long long)arg1;	// IMP=0x00000000000167f8
- (unsigned long long)operationGroupsCount;	// IMP=0x00000000000167db
- (void)addOperationGroup:(id)arg1;	// IMP=0x0000000000016771
- (void)clearOperationGroups;	// IMP=0x0000000000016754
