...
+ (_Bool)supportsSecureCoding;	// IMP=0x0060000000195dbe
+ (id)loadFromClientStateInSession:(id)arg1 options:(id)arg2;	// IMP=0x0060000000195a36
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000195cce
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000195bd5
- (id)init;	// IMP=0x0000000000195b7b
- (id)description;	// IMP=0x0000000000195b31
...
- (unsigned long long)allocatePackageItemRank;	// IMP=0x00000000001958bd
@property(nonatomic) unsigned long long nextNotifRank;
- (unsigned long long)allocateNotifRank;	// IMP=0x00000000001957c0
- (unsigned long long)allocateItemRowID;	// IMP=0x0000000000195768
