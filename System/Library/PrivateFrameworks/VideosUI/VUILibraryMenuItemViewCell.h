...
- (void).cxx_destruct;	// IMP=0x00000000001df007
...
- (void)layoutSubviews;	// IMP=0x00000000001de89f
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000001de735
- (_Bool)hasImage;	// IMP=0x00000000001de68f
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000001de135
