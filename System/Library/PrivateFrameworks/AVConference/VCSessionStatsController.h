...
- (void)flushRealTimeReportingStats;	// IMP=0x000000000037dd99
- (void)deregisterPeriodicTask;	// IMP=0x000000000037dd7a
- (void)periodicTask:(void *)arg1;	// IMP=0x000000000037db44
- (void)registerPeriodicTask;	// IMP=0x000000000037daf4
@property(readonly) id reportingAgent;
- (unsigned short)translateTimestampFromMicro:(double)arg1;	// IMP=0x000000000037dacd
- (void)stopLocalSessionStatsUpdate;	// IMP=0x000000000037d076
- (void)startLocalSessionStatsSend;	// IMP=0x000000000037cbf0
- (void)startLocalSessionStatsReceive;	// IMP=0x000000000037c873
- (void)startLocalSessionStatsUpdate;	// IMP=0x000000000037c845
- (void)sendLocalStats;	// IMP=0x000000000037c7a8
- (void)reset;	// IMP=0x000000000037c6cd
- (void)dealloc;	// IMP=0x000000000037c542
- (id)initWithDelegate:(id)arg1 connectionManager:(id)arg2 uplinkStatsCollector:(id)arg3 downlinkStatsCollector:(id)arg4 reportingAgent:(struct opaqueRTCReporting *)arg5 transportSessionID:(unsigned int)arg6 streamID:(unsigned short)arg7 mediaQueue:(struct tagVCMediaQueue *)arg8;	// IMP=0x000000000037c2c7
