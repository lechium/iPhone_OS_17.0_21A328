...
+ (id)missingContentTimerIdentifier;	// IMP=0x001000000000c7a9
...
- (id)description;	// IMP=0x000000000000c803
- (void)dataAggregationCompleted:(id)arg1;	// IMP=0x000000000000c617
- (void)missingContentTimerDidFire:(id)arg1 fireCount:(unsigned long long)arg2;	// IMP=0x000000000000c557
- (void)updateMissingContentTrackingForDataContent:(id)arg1;	// IMP=0x000000000000c1f2
- (void)updateExistingDataWindowWithContent:(id)arg1;	// IMP=0x000000000000c0c3
- (void)processNewDataWindowWithContent:(id)arg1;	// IMP=0x000000000000bfd4
- (void)receiveExpectedSequenceNumber:(unsigned long long)arg1;	// IMP=0x000000000000bee8
- (void)receiveDataContent:(id)arg1;	// IMP=0x000000000000bdc2
@property(readonly, nonatomic) unsigned long long receivedSequenceNumber;
- (id)missingSequenceNumbers;	// IMP=0x000000000000bd19
- (id)initWithWorkQueue:(id)arg1 timerSource:(id)arg2 missingItemInterval:(double)arg3 supportsSequenceCorrection:(_Bool)arg4;	// IMP=0x000000000000bc36
