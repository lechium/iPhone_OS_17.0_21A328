...
- (void).cxx_destruct;	// IMP=0x0000000000504cb4
...
- (void)animateTransition:(id)arg1;	// IMP=0x0000000000503ef6
- (double)transitionDuration:(id)arg1;	// IMP=0x0000000000503e95
- (void)finishTransition;	// IMP=0x0000000000503be9
- (void)interruptTabBarControllerTransition;	// IMP=0x0000000000503bd7
- (id)init;	// IMP=0x0000000000503b9b
