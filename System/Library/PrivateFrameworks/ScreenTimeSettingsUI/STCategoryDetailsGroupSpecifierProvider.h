...
- (void).cxx_destruct;	// IMP=0x0000000000028fcc
...
- (void)showMostUsedDetailListController:(id)arg1;	// IMP=0x0000000000028e65
- (id)totalUsageDescription:(id)arg1;	// IMP=0x0000000000028d64
- (id)initWithCategoryUsageItem:(id)arg1 coordinator:(id)arg2;	// IMP=0x00000000000285cb
