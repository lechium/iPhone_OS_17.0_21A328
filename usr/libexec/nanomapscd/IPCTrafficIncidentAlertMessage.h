...
- (void).cxx_destruct;	// IMP=0x00200000000187d6
...
- (id)description;	// IMP=0x00100000000185c3
- (id)dictionaryValue;	// IMP=0x0010000000018393
- (id)initWithDictionary:(id)arg1;	// IMP=0x0010000000018204
