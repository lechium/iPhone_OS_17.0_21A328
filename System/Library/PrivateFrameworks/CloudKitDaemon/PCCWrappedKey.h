...
- (void).cxx_destruct;	// IMP=0x0000000000392ecb
...
- (void)dealloc;	// IMP=0x0000000000392e4d
- (void)clear;	// IMP=0x0000000000392e47
- (id)data;	// IMP=0x0000000000392e1d
- (id)initWithKey:(id)arg1 permittedRemoteMeasurement:(id)arg2 attestation:(id)arg3;	// IMP=0x000000000039261f
