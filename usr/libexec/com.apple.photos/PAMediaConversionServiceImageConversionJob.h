...
- (void).cxx_destruct;	// IMP=0x0020000000010948
...
- (void)dealloc;	// IMP=0x001000000001057f
...
- (long long)requestedOrCalculatedMaximumLongSideLength;	// IMP=0x001000000000f8dc
- (_Bool)_validateOutputSize;	// IMP=0x001000000000f775
- (_Bool)_validateOrientation;	// IMP=0x001000000000f64c
- (_Bool)_validateMetadata;	// IMP=0x001000000000f4c8
- (_Bool)_validateSource;	// IMP=0x001000000000f299
- (void)_validate;	// IMP=0x001000000000f131
- (_Bool)validateSourceAndOptions;	// IMP=0x001000000000f0f8
- (id)initWithRequestIdentifier:(id)arg1 sourceResourceURLCollection:(id)arg2 outputFileType:(id)arg3;	// IMP=0x001000000000efa1
