...
- (void).cxx_destruct;	// IMP=0x000000000002d1c6
...
- (id)featureValueForName:(id)arg1;	// IMP=0x000000000002d0f5
@property(readonly, nonatomic) NSSet *featureNames;
- (id)initWithF_score_act_sigmoid_output:(id)arg1 geometry_output:(id)arg2;	// IMP=0x000000000002d063
