...
- (void).cxx_destruct;	// IMP=0x00000000007630f7
...
- (id)description;	// IMP=0x0000000000762eed
- (id)initWithOperationType:(unsigned long long)arg1 zoneName:(id)arg2 delayRespected:(_Bool)arg3;	// IMP=0x0000000000762ed5
- (id)initWithOperationType:(unsigned long long)arg1 zoneName:(id)arg2 cloudConflict:(_Bool)arg3 delayRespected:(_Bool)arg4;	// IMP=0x0000000000762e20
