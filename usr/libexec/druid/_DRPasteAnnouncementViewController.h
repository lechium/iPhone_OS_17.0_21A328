...
+ (_Bool)shouldCoalesce:(id)arg1;	// IMP=0x002000000000b282
- (void).cxx_destruct;	// IMP=0x002000000000b73b
...
- (void)presentableWillNotAppearAsBanner:(id)arg1 withReason:(id)arg2;	// IMP=0x001000000000b5d8
- (void)presentableWillDisappearAsBanner:(id)arg1 withReason:(id)arg2;	// IMP=0x001000000000b50a
- (void)presentableDidAppearAsBanner:(id)arg1;	// IMP=0x001000000000b339
- (struct UIEdgeInsets)bannerContentOutsets;	// IMP=0x001000000000b244
- (struct CGSize)preferredContentSizeWithPresentationSize:(struct CGSize)arg1 containerSize:(struct CGSize)arg2;	// IMP=0x001000000000b1da
@property(readonly, nonatomic) UIViewController *viewController;
@property(readonly, copy, nonatomic) NSString *requestIdentifier;
@property(readonly, copy, nonatomic) NSString *requesterIdentifier;
- (_Bool)_canShowWhileLocked;	// IMP=0x001000000000b1a7
- (void)viewDidLoad;	// IMP=0x001000000000b0c5
- (id)authorizationDecisionView;	// IMP=0x001000000000a7f7
- (void)dismissBanner;	// IMP=0x001000000000a7a3
- (void)denyPaste:(id)arg1;	// IMP=0x001000000000a741
- (void)allowPaste:(id)arg1;	// IMP=0x001000000000a6dc
- (id)initForDeniedPasteWithBannerSource:(id)arg1;	// IMP=0x001000000000a56c
- (id);	// IMP=0x001000000000a112
