...
- (void).cxx_destruct;	// IMP=0x0000000000022d69
...
- (id)source;	// IMP=0x0000000000022d2b
...
- (void)removeAllSamples;	// IMP=0x0000000000022937
- (void)removeSample:(id)arg1;	// IMP=0x0000000000022921
- (void)addSample:(id)arg1;	// IMP=0x0000000000022878
- (id)initWithSleepStage:(long long)arg1 timePeriod:(id)arg2 sourceRevision:(id)arg3 device:(id)arg4;	// IMP=0x0000000000022740
