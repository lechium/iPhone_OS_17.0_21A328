...
- (void).cxx_destruct;	// IMP=0x00200000002d594e
...
- (void)setPeerPaymentAccount:(id)arg1;	// IMP=0x00100000002d589b
- (id)peerPaymentAccount;	// IMP=0x00100000002d5891
...
- (id)description;	// IMP=0x00100000002d560f
- (_Bool)shouldReceiveNotificationsForPeerPaymentNotificationType:(unsigned long long)arg1;	// IMP=0x00100000002d5579
- (id)passUniqueIdentifier;	// IMP=0x00100000002d5563
