...
+ (id)namedDataWithData:(id)arg1 named:(id)arg2;	// IMP=0x00600000002df06c
- (void).cxx_destruct;	// IMP=0x00000000002df1c4
...
- (id)initWithData:(id)arg1 named:(id)arg2;	// IMP=0x00000000002df0f9
