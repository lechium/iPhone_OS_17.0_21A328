...
@interface SUUIChartColumnsView : UIView
{
    ...
    SUUIFlexibleSegmentedControl *_segmentedControl;	// 128 = 0x80
}

- (void).cxx_destruct;	// IMP=0x0000000000083f42
...
- (void)_reloadColumnViews;	// IMP=0x0000000000083417
- (id)_headerViewWithViewControllers:(id)arg1;	// IMP=0x00000000000831c9
- (void)segmentedControl:(id)arg1 didSelectSegmentIndex:(long long)arg2;	// IMP=0x0000000000083172
- (void)_headerViewAction:(id)arg1;	// IMP=0x00000000000830cc
- (void)layoutSubviews;	// IMP=0x0000000000082971
- (void)endColumnChangeAnimation;	// IMP=0x0000000000082815
- (void)beginColumnChangeAnimationToNumberOfVisibleColumns:(long long)arg1;	// IMP=0x000000000008279f
- (void)dealloc;	// IMP=0x0000000000082754
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000000824ba
