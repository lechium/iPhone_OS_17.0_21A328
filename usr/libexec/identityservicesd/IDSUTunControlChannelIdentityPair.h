...
- (void).cxx_destruct;	// IMP=0x0020000000136ede
...
- (id)description;	// IMP=0x0010000000136dfe
- (id)initWithLocalFullIdentity:(id)arg1 remotePublicIdentity:(id)arg2;	// IMP=0x0010000000136d65
