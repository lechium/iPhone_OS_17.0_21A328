...
- (void).cxx_destruct;	// IMP=0x000000000055a6ad
...
- (id)attributeDescriptions;	// IMP=0x000000000055a3d7
...
- (id)initWithSessionID:(id)arg1 cameraID:(id)arg2 sequenceNumber:(unsigned long long)arg3;	// IMP=0x000000000055a1ea
