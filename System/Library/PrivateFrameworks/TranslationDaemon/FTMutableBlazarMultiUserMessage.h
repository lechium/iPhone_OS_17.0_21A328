...
+ (long long)session_message_typeForObject:(id)arg1;	// IMP=0x006000000009ba05
+ (long long)session_message_typeForMutableObject:(id)arg1;	// IMP=0x006000000009b6be
+ (Class)session_message_mutableClassForType:(long long)arg1;	// IMP=0x006000000009b684
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000009a168
- (id)init;	// IMP=0x000000000009a0da
