...
+ (_Bool)supportsSecureCoding;	// IMP=0x002000000001dd36
- (void).cxx_destruct;	// IMP=0x002000000001dec5
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000001ddcb
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000001dd3e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000001dd17
- (id)description;	// IMP=0x001000000001dbff
- (unsigned long long)hash;	// IMP=0x001000000001dbbb
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000001db0b
- (void)handleInvalidationWithError:(id)arg1;	// IMP=0x001000000001d819
- (void)invalidateClientWithError:(id)arg1;	// IMP=0x001000000001d765
...
- (id)initWithRPCompanionLinkDevice:(id)arg1;	// IMP=0x001000000001d530
