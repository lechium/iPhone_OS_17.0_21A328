...
- (void).cxx_destruct;	// IMP=0x0000000000165915
...
- (id)applyUpdatesWithElement:(id)arg1;	// IMP=0x0000000000165713
- (long long)currentNumberValue;	// IMP=0x00000000001655fa
@property(readonly, nonatomic) SKUIImageViewElement *backgroundImageElement;
- (id)initWithDOMElement:(id)arg1 parent:(id)arg2 elementFactory:(id)arg3;	// IMP=0x0000000000165231
