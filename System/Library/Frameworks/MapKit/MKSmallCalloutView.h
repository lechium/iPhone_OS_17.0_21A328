...
- (void).cxx_destruct;	// IMP=0x0000000000258569
...
- (_Bool)canDisplayCompleteTitleWhenExpanded;	// IMP=0x0000000000258530
- (void)setDetailView:(id)arg1 animated:(_Bool)arg2;	// IMP=0x0000000000257b55
@property(retain, nonatomic) UIView *detailView;
- (void)setRightView:(id)arg1 animated:(_Bool)arg2;	// IMP=0x0000000000256e42
- (void)setLeftView:(id)arg1 animated:(_Bool)arg2;	// IMP=0x0000000000255feb
@property(retain, nonatomic) UIView *rightView;
@property(retain, nonatomic) UIView *leftView;
@property(copy, nonatomic) NSString *calloutSubtitle;
- (void)setCalloutSubtitle:(id)arg1 animated:(_Bool)arg2;	// IMP=0x0000000000255cb0
@property(copy, nonatomic) NSString *calloutTitle;
- (id)_maskedContainerView;	// IMP=0x0000000000255aad
@property(readonly, nonatomic) struct CGSize preferredContentSize; // @synthesize preferredContentSize=_preferredContentSize;
- (void)_updatePreferredContentSize;	// IMP=0x0000000000255a0e
- (void)_updatePreferredContentSizeIfNeeded;	// IMP=0x00000000002559ed
- (void)_setNeedsUpdatePreferredContentSize;	// IMP=0x00000000002559dc
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000002559ad
- (void)beginMapsTransitionMovingSideways;	// IMP=0x0000000000255918
- (void)reset;	// IMP=0x00000000002558b4
- (void)dealloc;	// IMP=0x000000000025583f
@property(nonatomic) double maximumWidth;
@property(nonatomic) double minimumWidth;
- (void)_contentSizeCategoryDidChange:(id)arg1;	// IMP=0x0000000000255598
- (id)initWithFrame:(struct CGRect)arg1 metrics:(CDStruct_f381021a)arg2;	// IMP=0x0000000000254251
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000002541af
