...
+ (_Bool)resolveInstanceMethod:(SEL)arg1;	// IMP=0x0010000000aa05ce
- (void).cxx_destruct;	// IMP=0x0000000000aa07f2
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000aa0421
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000aa0342
