...
- (void).cxx_destruct;	// IMP=0x000000000033d5a0
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000033d4f0
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000033d460
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x000000000033c6e0
