...
+ (id)_darkStyleGlyphColor;	// IMP=0x0060000000ceeb99
+ (id)_standardGlyphColor;	// IMP=0x0060000000ceeb60
- (void).cxx_destruct;	// IMP=0x0000000000cef3be
...
- (id)imageWithRenderConfig:(id)arg1;	// IMP=0x0000000000cef05c
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000ceec88
- (id)initWithImageName:(id)arg1 identifier:(id)arg2;	// IMP=0x0000000000ceebb2
