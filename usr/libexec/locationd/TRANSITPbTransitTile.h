...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000023b800
- (unsigned long long)hash;	// IMP=0x001000000023b5f3
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000023b419
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000023b2a2
- (void)copyTo:(id)arg1;	// IMP=0x001000000023b174
- (void)writeTo:(id)arg1;	// IMP=0x001000000023b02d
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000023b020
- (id)dictionaryRepresentation;	// IMP=0x001000000023a7e0
- (id)description;	// IMP=0x001000000023a769
...
- (void)dealloc;	// IMP=0x001000000023a498
