...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000192ba9
- (void).cxx_destruct;	// IMP=0x0000000000192b81
...
- (void)dealloc;	// IMP=0x0000000000192a92
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001927a7
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000192671
