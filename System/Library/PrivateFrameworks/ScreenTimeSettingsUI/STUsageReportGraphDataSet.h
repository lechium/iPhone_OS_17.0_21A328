...
- (void).cxx_destruct;	// IMP=0x00000000000d58ad
...
- (id)initEmptyDataSetWithTimePeriod:(unsigned long long)arg1 referenceDate:(id)arg2;	// IMP=0x00000000000d5343
- (id)initWithTimePeriod:(unsigned long long)arg1 itemType:(unsigned long long)arg2 total:(id)arg3 max:(id)arg4 average:(id)arg5 averageAsPercentageOfMax:(double)arg6 dataPoints:(id)arg7;	// IMP=0x00000000000d520d
