...
- (void).cxx_destruct;	// IMP=0x0020000000008ae0
...
- (void)updateForCurrentTraitCollection;	// IMP=0x00100000000081c0
- (void)viewWillTransitionToSize:(struct CGSize)arg1 withTransitionCoordinator:(id)arg2;	// IMP=0x0010000000008040
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x0010000000007fe0
- (id)initWithNibName:(id)arg1 bundle:(id)arg2 bag:(id)arg3 sceneAwareVariant:(_Bool)arg4;	// IMP=0x0010000000007940
