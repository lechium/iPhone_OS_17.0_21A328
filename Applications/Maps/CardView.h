...
- (void).cxx_destruct;	// IMP=0x0020000000b47fc7
...
- (struct CGSize)intrinsicContentSize;	// IMP=0x0010000000b47deb
- (void)_showGrabberFooter:(_Bool)arg1;	// IMP=0x0010000000b47870
- (void)showShadow:(_Bool)arg1 animated:(_Bool)arg2;	// IMP=0x0010000000b4771e
- (void)setLayoutStyle:(unsigned long long)arg1;	// IMP=0x0010000000b47424
- (void)_setCornerRadiusWithMaskedCorners:(unsigned long long)arg1 cornerRadius:(double)arg2;	// IMP=0x0010000000b47286
- (void)updateTheme;	// IMP=0x0010000000b4713c
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x0010000000b47019
- (void)setCaptureView:(id)arg1;	// IMP=0x0010000000b46f6d
- (void)layoutSubviews;	// IMP=0x0010000000b46d07
- (void)insertSubview:(id)arg1 atIndex:(long long)arg2;	// IMP=0x0010000000b46d01
- (void)didAddSubview:(id)arg1;	// IMP=0x0010000000b46c9d
- (void)_commonInitWithBlurType:(long long)arg1;	// IMP=0x0010000000b462d4
- (id)initWithThickBlur;	// IMP=0x0010000000b46176
- (id)initAllowingBlurredForButton:(_Bool)arg1;	// IMP=0x0010000000b460b3
- (id)initAllowingBlurred:(_Bool)arg1;	// IMP=0x0010000000b45ef5
