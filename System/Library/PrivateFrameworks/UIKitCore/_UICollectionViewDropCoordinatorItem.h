...
- (void).cxx_destruct;	// IMP=0x000000000048dbe2
...
- (void)addCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000000048dac6
- (void)addAnimations:(CDUnknownBlockType)arg1;	// IMP=0x000000000048da5d
@property(readonly, copy) NSString *description;
- (id)initWithDestinationIndexPath:(id)arg1 dragItem:(id)arg2 placeholderConfiguration:(id)arg3;	// IMP=0x000000000048d779
- (id)initWithDragItem:(id)arg1 target:(id)arg2;	// IMP=0x000000000048d636
- (id)initWithDestinationIndexPath:(id)arg1 dragItem:(id)arg2;	// IMP=0x000000000048d504
