...
- (void).cxx_destruct;	// IMP=0x00200000000282d6
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000028184
- (unsigned long long)hash;	// IMP=0x001000000002816e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000280aa
