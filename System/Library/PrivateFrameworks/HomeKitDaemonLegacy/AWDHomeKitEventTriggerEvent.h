...
- (void).cxx_destruct;	// IMP=0x00000000007bb1b4
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000007bae89
- (unsigned long long)hash;	// IMP=0x00000000007bad6a
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000007bab6a
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000007ba9b4
- (void)copyTo:(id)arg1;	// IMP=0x00000000007ba871
- (void)writeTo:(id)arg1;	// IMP=0x00000000007ba73f
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000007ba732
- (id)dictionaryRepresentation;	// IMP=0x00000000007ba438
- (id)description;	// IMP=0x00000000007ba389
