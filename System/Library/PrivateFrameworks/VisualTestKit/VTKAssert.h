...
- (void).cxx_destruct;	// IMP=0x0000000000006d5f
...
- (void)assertView:(id)arg1 identifier:(id)arg2 filePath:(id)arg3 lineNumber:(unsigned long long)arg4;	// IMP=0x00000000000064a6
@property(readonly, nonatomic) NSArray *drawItems;
@property(readonly, nonatomic) NSString *referenceImagesDirectory;
- (id)initWithTestCase:(id)arg1 configuration:(id)arg2;	// IMP=0x0000000000006362
- (id)initWithTestCase:(id)arg1;	// IMP=0x00000000000062fe
