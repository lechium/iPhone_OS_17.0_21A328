...
- (void).cxx_destruct;	// IMP=0x00000000002f8360
...
- (double)_calculateThrottleInterval;	// IMP=0x00000000002f8279
- (void)throttle;	// IMP=0x00000000002f81f2
- (_Bool)shouldThrottle;	// IMP=0x00000000002f81a5
- (void)reset;	// IMP=0x00000000002f8173
- (id)initWithBaseSleepInterval:(double)arg1 maxSleepInterval:(double)arg2;	// IMP=0x00000000002f8109
