...
- (void)remote_hkqa_statisticsWithCompletion:(void (^)(HKQAStatistics *, NSError *))arg1;
- (void)remote_hkqa_generateDemoDataWithDurationInDays:(long long)arg1 completion:(void (^)(_Bool, NSError *))arg2;
