...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000028654
- (id)description;	// IMP=0x000000000002853c
- (id)initWithUser:(id)arg1 presenceAuthStatus:(id)arg2 presenceComputeStatus:(id)arg3 presenceRegion:(id)arg4 reason:(id)arg5;	// IMP=0x0000000000028426
