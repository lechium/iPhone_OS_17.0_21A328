...
+ (id)schedulerStreamWithKeyFrameInterval:(unsigned int)arg1 framerate:(unsigned int)arg2 weightFactor:(unsigned int)arg3;	// IMP=0x00600000002f6652
...
- (id)description;	// IMP=0x00000000002f676a
- (long long)compareWeightFactor:(id)arg1;	// IMP=0x00000000002f6711
- (id)initWithKeyFrameInterval:(unsigned int)arg1 framerate:(unsigned int)arg2 weightFactor:(unsigned int)arg3;	// IMP=0x00000000002f669c
