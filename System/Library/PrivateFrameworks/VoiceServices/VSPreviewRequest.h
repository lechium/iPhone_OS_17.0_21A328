...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000000184bb
- (void).cxx_destruct;	// IMP=0x0000000000018493
...
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000001832b
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000001828e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000181b8
