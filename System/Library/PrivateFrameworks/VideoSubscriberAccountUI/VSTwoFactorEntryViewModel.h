...
- (void).cxx_destruct;	// IMP=0x0000000000033597
...
- (void)buttonAtIndexWasPressed:(unsigned long long)arg1;	// IMP=0x000000000003347d
- (void)configureWithRequest:(id)arg1;	// IMP=0x00000000000332b2
- (id)init;	// IMP=0x0000000000032f37
