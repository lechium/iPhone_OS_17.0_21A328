...
- (void).cxx_destruct;	// IMP=0x000000000008adba
...
- (void)dealloc;	// IMP=0x000000000008ad61
- (void)invalidate;	// IMP=0x000000000008ab50
- (void)done;	// IMP=0x000000000008a924
- (CDUnknownBlockType)_popGatherReply;	// IMP=0x000000000008a8b7
- (void)gatherWithBatchSize:(long long)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000000089063
- (id)initWithNotificationPipe:(id)arg1 appLibraries:(id)arg2 startingRank:(unsigned long long)arg3 maxRank:(unsigned long long)arg4 withDeadItems:(_Bool)arg5 gatherReply:(CDUnknownBlockType)arg6;	// IMP=0x0000000000088ca4
