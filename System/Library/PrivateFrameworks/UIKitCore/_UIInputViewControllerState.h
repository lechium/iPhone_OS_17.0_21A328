...
+ (id)stateForKeyboardState:(id)arg1;	// IMP=0x0010000000b074d6
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000b074ce
- (void).cxx_destruct;	// IMP=0x0000000000b07ea9
...
- (id)description;	// IMP=0x0000000000b07c9a
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000b07a5a
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000b07994
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000b0783a
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000b07793
- (void)createDocumentStateIfNecessary;	// IMP=0x0000000000b076c8
