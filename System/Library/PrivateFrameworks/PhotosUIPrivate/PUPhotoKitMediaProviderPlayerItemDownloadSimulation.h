...
- (void).cxx_destruct;	// IMP=0x0000000000429066
...
- (void)endSimulationWithError:(id)arg1;	// IMP=0x0000000000428e55
- (void)updateSimulationWithProgress:(double)arg1;	// IMP=0x0000000000428db1
- (void)_handleResultPlayerItem:(id)arg1 info:(id)arg2;	// IMP=0x0000000000428cfe
- (id)init;	// IMP=0x0000000000428c1f
