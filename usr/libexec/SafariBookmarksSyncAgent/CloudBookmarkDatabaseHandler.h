...
- (void).cxx_destruct;	// IMP=0x0020000000033f37
...
- (void)readingListBookmarkDidUpdate;	// IMP=0x0010000000033f09
- (void)saveAssetAtURL:(id)arg1 toURL:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0010000000033b11
- (_Bool)shouldApplyReference:(id)arg1 withGeneration:(id)arg2 toAttribute:(id)arg3 inRecordWithName:(id)arg4;	// IMP=0x0010000000033b09
@property(readonly, copy, nonatomic) NSArray *itemConfigurations;
- (id)positionForCloudBookmarkWithRecordName:(id)arg1;	// IMP=0x0010000000033aeb
- (id)generateIdentityHashWithComponents:(id)arg1;	// IMP=0x0010000000033ae3
@property(readonly, nonatomic) CKRecordZoneID *bookmarksRecordZoneID;
@property(readonly, nonatomic) NSString *deviceIdentifier;
- (void)dealloc;	// IMP=0x0010000000033a78
- (id)initWithBookmarkStore:(id)arg1 database:(void *)arg2 databaseAccessor:(id)arg3 accountPropertiesStore:(id)arg4;	// IMP=0x0010000000033900
- (id)init;	// IMP=0x00100000000338f2
