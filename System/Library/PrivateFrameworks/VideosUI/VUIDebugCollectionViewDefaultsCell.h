...
- (void).cxx_destruct;	// IMP=0x0000000000028020
...
- (_Bool)textFieldShouldReturn:(id)arg1;	// IMP=0x0000000000027ee0
- (void)textFieldDidEndEditing:(id)arg1;	// IMP=0x0000000000027e68
- (void)_defaultsSwitchPressed:(id)arg1;	// IMP=0x0000000000027e4b
- (void)layoutSubviews;	// IMP=0x0000000000027868
- (void)configureCellWithDefaults:(id)arg1;	// IMP=0x00000000000275bb
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000002708f
