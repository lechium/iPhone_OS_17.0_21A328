...
- (void).cxx_destruct;	// IMP=0x0020000000036d16
...
- (void)stopAnimatingSpinner;	// IMP=0x0010000000036c71
- (void)startAnimatingSpinner;	// IMP=0x0010000000036c54
- (void)setAlpha:(double)arg1;	// IMP=0x0010000000036c37
- (id)backdropColorWithAlpha;	// IMP=0x0010000000036c22
- (double)backdropAlpha;	// IMP=0x0010000000036c10
- (_Bool)resignFirstResponder;	// IMP=0x0010000000036bc4
- (_Bool)becomeFirstResponder;	// IMP=0x0010000000036ba7
- (void)setHintLabelText:(id)arg1;	// IMP=0x00100000000369d5
- (void)didMoveToWindow;	// IMP=0x0010000000036982
- (void)layoutSubviews;	// IMP=0x0010000000036638
@property(readonly, nonatomic) UIView<SBUIPasscodeLockView> *passcodeView;
- (id)initWithFrame:(struct CGRect)arg1 withPasscodeLockViewForStyle:(int)arg2;	// IMP=0x00100000000362d7
