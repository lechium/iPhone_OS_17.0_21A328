...
- (void).cxx_destruct;	// IMP=0x0020000000003930
...
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x00100000000034ab
- (_Bool)terminate;	// IMP=0x00100000000033c0
- (_Bool)resume;	// IMP=0x00100000000032e7
- (_Bool)suspend;	// IMP=0x001000000000320e
- (id)initWithManager:(id)arg1 name:(id)arg2;	// IMP=0x00100000000030ff
