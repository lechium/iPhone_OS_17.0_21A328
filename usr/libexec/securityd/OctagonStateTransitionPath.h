...
+ (id)pathFromDictionary:(id)arg1;	// IMP=0x00400000000c9681
- (void).cxx_destruct;	// IMP=0x00200000000c9659
...
- (id)asPathStep;	// IMP=0x00100000000c9520
- (id)initWithState:(id)arg1 pathStep:(id)arg2;	// IMP=0x00100000000c9487
