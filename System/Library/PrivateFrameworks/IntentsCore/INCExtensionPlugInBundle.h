...
- (void).cxx_destruct;	// IMP=0x00000000000027d6
...
- (id)initWithPrincipalClass:(Class)arg1 intentsSupported:(id)arg2 intentsRestrictedWhileLocked:(id)arg3;	// IMP=0x00000000000026ed
