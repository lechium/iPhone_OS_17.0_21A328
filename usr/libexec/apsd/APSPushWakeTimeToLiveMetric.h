...
- (void).cxx_destruct;	// IMP=0x0020000000008b65
...
- (id)initWithGuid:(id)arg1 connectedOnWake:(_Bool)arg2 everConnected:(_Bool)arg3 timeToFullyConnect:(id)arg4 timeToLastFromStorage:(id)arg5;	// IMP=0x0010000000008865
