...
+ (id)customAttributes;	// IMP=0x00600000000cf3ea
...
- (id)outputImage;	// IMP=0x00000000000cf9fb
- (id)_geomKernel;	// IMP=0x00000000000cf9db
- (id)_colorKernel;	// IMP=0x00000000000cf9bb
