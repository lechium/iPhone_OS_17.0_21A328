...
- (void).cxx_destruct;	// IMP=0x0020000000013c09
...
- (void)sharingSetupDidSucceed;	// IMP=0x0010000000013b61
- (void)sharingSetupDidFailWithError:(id)arg1;	// IMP=0x001000000001390e
...
- (id)init;	// IMP=0x0010000000013804
