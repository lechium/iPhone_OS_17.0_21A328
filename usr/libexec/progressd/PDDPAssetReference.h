...
+ (Class)classIdsType;	// IMP=0x002000000013ef47
- (void).cxx_destruct;	// IMP=0x0020000000141e4f
...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000014161c
- (unsigned long long)hash;	// IMP=0x00100000001411e7
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000140cdf
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000001406d7
- (void)copyTo:(id)arg1;	// IMP=0x0010000000140304
- (void)writeTo:(id)arg1;	// IMP=0x001000000013fed5
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000013fec8
- (id)dictionaryRepresentation;	// IMP=0x001000000013f137
- (id)description;	// IMP=0x001000000013f088
...
- (_Bool);	// IMP=0x001000000013ef58
- (id)classIdsAtIndex:(unsigned long long)arg1;	// IMP=0x001000000013ef2a
- (unsigned long long)classIdsCount;	// IMP=0x001000000013ef0d
- (void)addClassIds:(id)arg1;	// IMP=0x001000000013eea3
- (void)clearClassIds;	// IMP=0x001000000013ee86
...
- (int)StringAsParentEntityType:(id)arg1;	// IMP=0x001000000013eca3
- (id)parentEntityTypeAsString:(int)arg1;	// IMP=0x001000000013ec5a
...
- (int)StringAsType:(id)arg1;	// IMP=0x001000000013ea7f
- (id)typeAsString:(int)arg1;	// IMP=0x001000000013ea36
