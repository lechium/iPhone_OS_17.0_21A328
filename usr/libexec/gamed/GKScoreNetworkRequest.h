...
+ (long long)coalescingDelay;	// IMP=0x00200000000f75eb
+ (id)bagKey;	// IMP=0x00100000000f6a7a
- (void).cxx_destruct;	// IMP=0x00200000000f77f0
...
- (void)updateWithTaskInfo:(id)arg1;	// IMP=0x00100000000f740a
- (void)handleNetworkRequest:(id)arg1 session:(id)arg2 clientProxy:(id)arg3 previousKnownPendingAmount:(long long)arg4;	// IMP=0x00100000000f73f7
- (void)addInRequestData:(id *)arg1 additional:(id)arg2;	// IMP=0x00100000000f72ce
- (id)requestIdentifier;	// IMP=0x00100000000f72c4
- (id)taskInfo;	// IMP=0x00100000000f70e9
- (void)removeFromStore:(id)arg1;	// IMP=0x00100000000f7006
- (id)postBody;	// IMP=0x00100000000f6f0d
@property(readonly) long long numberOfRequests; // @dynamic numberOfRequests;
- (id)initWithScores:(id)arg1 bundleID:(id)arg2 eligibleChallenges:(id)arg3;	// IMP=0x00100000000f6b48
- (id)initWithTask:(id)arg1;	// IMP=0x00100000000f6a9c
- (void)handleNetworkRequest:(id)arg1 session:(id)arg2 clientProxy:(id)arg3;	// IMP=0x00100000000f6a87
