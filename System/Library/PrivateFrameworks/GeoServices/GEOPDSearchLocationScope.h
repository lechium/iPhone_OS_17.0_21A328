...
- (void).cxx_destruct;	// IMP=0x0000000000438772
- (unsigned long long)hash;	// IMP=0x0000000000437dc1
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000004379f3
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000437652
- (void)writeTo:(id)arg1;	// IMP=0x00000000004372bd
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000004372b0
- (id)jsonRepresentation;	// IMP=0x0000000000436e5e
- (id)dictionaryRepresentation;	// IMP=0x00000000004363db
- (id)description;	// IMP=0x000000000043632c
- (id)initWithData:(id)arg1;	// IMP=0x0000000000435420
- (id)init;	// IMP=0x00000000004353c4
