...
- (void).cxx_destruct;	// IMP=0x000000000000f2af
...
- (void)invalidate;	// IMP=0x000000000000f1e1
- (void)performObserverBlock;	// IMP=0x000000000000f188
- (id)initWithWeakObserver:(id)arg1 notificationName:(id)arg2 observerQueue:(id)arg3 observerBlock:(CDUnknownBlockType)arg4;	// IMP=0x000000000000ef39
