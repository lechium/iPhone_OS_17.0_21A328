...
- (void).cxx_destruct;	// IMP=0x00000000003e4690
...
- (void)_prepareAnimationViews;	// IMP=0x00000000003e3c8c
- (void)_prepareSnapshots;	// IMP=0x00000000003e3925
- (void)animateWithAlongsideActions:(CDUnknownBlockType)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000000003e2bd9
- (id)initWithSource:(id)arg1 container:(id)arg2;	// IMP=0x00000000003e2ac6
