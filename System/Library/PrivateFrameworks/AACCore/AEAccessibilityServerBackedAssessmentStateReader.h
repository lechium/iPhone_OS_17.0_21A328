...
- (void).cxx_destruct;	// IMP=0x0000000000005074
@property(nonatomic, getter=isActive) _Bool active; // @synthesize active=_active;
- (id)initWithAccessibilityServerPrimitives:(id)arg1 queue:(id)arg2;	// IMP=0x0000000000004e1d
- (void)dealloc;	// IMP=0x0000000000004da9
