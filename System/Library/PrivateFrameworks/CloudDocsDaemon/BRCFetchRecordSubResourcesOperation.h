...
- (void).cxx_destruct;	// IMP=0x000000000032c53b
...
- (_Bool)saveRecordsWithQueryCursor:(id)arg1;	// IMP=0x000000000032b9ae
- (_Bool)saveRecordsWithServerChangeToken:(id)arg1 clientChangeToken:(long long)arg2 syncStatus:(long long)arg3;	// IMP=0x000000000032b08c
- (_Bool)_hasRecordsPendingSubResources;	// IMP=0x000000000032b03f
- (void)_saveRecordsToPendingChangesWithServerChangeToken:(id)arg1 clientChangeToken:(long long)arg2;	// IMP=0x000000000032af54
- (void)_cleanUpAfterSavingRecords;	// IMP=0x000000000032ae99
- (void)_fetchRecordsBlockingSaveIfNecessary;	// IMP=0x000000000032a71b
- (void)_prepareToSaveRecords;	// IMP=0x0000000000328ed3
- (void)_createSubResourceGroupsFromPendingChangesStreamIfNecessary;	// IMP=0x0000000000328e0a
- (void)_scheduleXattrFetch;	// IMP=0x00000000003274cd
- (void)_dump;	// IMP=0x0000000000326ff3
- (_Bool)_markSubResourceRecordAsFetchedIfNecessary:(id)arg1;	// IMP=0x0000000000326d98
- (void)_scheduleDeserialize;	// IMP=0x0000000000325928
- (_Bool)_willFetchRecordForDeserialize:(id)arg1;	// IMP=0x00000000003257b8
- (void)finishWithResult:(id)arg1 error:(id)arg2;	// IMP=0x0000000000325474
- (void)main;	// IMP=0x000000000032537e
- (void)stop;	// IMP=0x0000000000324e82
- (void)cancel;	// IMP=0x0000000000324d2f
- (void)stopWithError:(id)arg1;	// IMP=0x0000000000324b03
- (void)_startWithParentOperation:(id)arg1;	// IMP=0x0000000000324a3a
- (void)notifyWhenRecordsAreFetchedAndFinish:(CDUnknownBlockType)arg1;	// IMP=0x0000000000324a20
- (void)notifyWhenCaughtUp:(_Bool)arg1 whenRecordsAreFetchedAndFinish:(CDUnknownBlockType)arg2;	// IMP=0x00000000003246fa
- (void)_notifyWhenRecordsAreFetched:(CDUnknownBlockType)arg1;	// IMP=0x0000000000324497
- (void)shareIDWasDeleted:(id)arg1;	// IMP=0x00000000003241cd
- (void)recordIDWasDeleted:(id)arg1;	// IMP=0x0000000000323adf
- (void)addRecordIDToDeserialize:(id)arg1 recordType:(long long)arg2;	// IMP=0x00000000003234d1
- (void)addRecordIDToDeserialize:(id)arg1;	// IMP=0x00000000003234bd
- (void)addRecord:(id)arg1;	// IMP=0x00000000003215d2
- (_Bool)shouldRetryForError:(id)arg1;	// IMP=0x0000000000321561
- (id)createActivity;	// IMP=0x0000000000321538
- (id)initAndScheduleWithServerZone:(id)arg1 parentOperation:(id)arg2 pendingChangesStream:(id)arg3 contentRecordsFetchedInline:(_Bool)arg4;	// IMP=0x0000000000320aa8
- (id)movedZoneNames;	// IMP=0x0000000000320a93
- (id)records;	// IMP=0x00000000003209c6
