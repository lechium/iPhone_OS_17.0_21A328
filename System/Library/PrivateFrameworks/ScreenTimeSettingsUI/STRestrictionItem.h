...
- (void).cxx_destruct;	// IMP=0x0000000000042c86
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000042bf8
- (id)description;	// IMP=0x0000000000042b42
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000042a00
- (unsigned long long)hash;	// IMP=0x0000000000042974
- (id)initWithConfiguration:(id)arg1 restrictionKey:(id)arg2 labelName:(id)arg3 type:(unsigned long long)arg4 restrictionValue:(id)arg5;	// IMP=0x00000000000426ec
