...
+ (void)initialize;	// IMP=0x00600000001e7c08
- (void).cxx_destruct;	// IMP=0x00000000001e94ee
...
- (_Bool)_supportsBookmarks;	// IMP=0x00000000001e93f2
- (void)_schedulePlaybackPositionInfoPersistence;	// IMP=0x00000000001e92c2
- (id)_localPlaybackFilePathURL;	// IMP=0x00000000001e906f
- (void)cleanUpMediaItem;	// IMP=0x00000000001e905b
- (void)updatePlayCountForElapsedTime:(double)arg1 duration:(double)arg2;	// IMP=0x00000000001e8ee2
- (void)updateBookmarkWithSuggestedTime:(double)arg1 forElapsedTime:(double)arg2 duration:(double)arg3 playbackOfMediaItemIsEnding:(_Bool)arg4;	// IMP=0x00000000001e8dbe
- (void)prepareForLoadingWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00000000001e8b82
- (id)mediaItemMetadataForProperty:(id)arg1;	// IMP=0x00000000001e81b2
- (_Bool)hasTrait:(id)arg1;	// IMP=0x00000000001e7fd5
- (id)mediaItemURL;	// IMP=0x00000000001e7f52
- (_Bool)isEqualToMediaItem:(id)arg1;	// IMP=0x00000000001e7e04
@property(readonly, nonatomic) id <TVImageLoader> imageLoader;
- (id)initWithMPMediaItem:(id)arg1;	// IMP=0x00000000001e7c58
