...
- (void).cxx_destruct;	// IMP=0x0020000000083e86
@property(readonly, nonatomic) CATTaskServer *taskServer; // @synthesize taskServer=_taskServer;
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x0010000000083d80
- (id)initWithTaskServer:(id)arg1;	// IMP=0x0010000000083d15
