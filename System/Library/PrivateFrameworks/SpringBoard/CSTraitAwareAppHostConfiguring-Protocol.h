...
@class CSCoverSheetViewControllerBase, UIViewController, UIWindow;
@protocol CSTraitAwareAppHostContextProviding, CSTraitsAwareOrientedAppHosting, SBApplicationHosting;
