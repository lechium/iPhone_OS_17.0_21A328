...
- (void).cxx_destruct;	// IMP=0x00000000010c5c46
...
- (void)addTapHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000000010c5ad1
- (void)addDismissalCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000000010c5a54
- (void)addDismissalAnimations:(CDUnknownBlockType)arg1;	// IMP=0x00000000010c59d7
- (void)dismiss;	// IMP=0x00000000010c57e8
- (void)handleLongPressGesture:(id)arg1;	// IMP=0x00000000010c5563
- (void)present;	// IMP=0x00000000010c53c8
