...
- (void).cxx_destruct;	// IMP=0x000000000000791d
...
- (void)registerResultBlock:(CDUnknownBlockType)arg1;	// IMP=0x00000000000077c1
- (void)_fulfillWithResult:(id)arg1;	// IMP=0x00000000000075a2
- (id)init;	// IMP=0x0000000000007514
