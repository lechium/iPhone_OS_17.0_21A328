...
- (void).cxx_destruct;	// IMP=0x00000000005fe0a0
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000005fdfb0
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000005fdf90
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000005fdf60
