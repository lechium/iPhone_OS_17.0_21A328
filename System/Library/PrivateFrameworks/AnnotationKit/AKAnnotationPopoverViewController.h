...
- (void).cxx_destruct;	// IMP=0x00000000000d04ed
...
- (void)hide;	// IMP=0x00000000000d01f5
- (void)didHide;	// IMP=0x00000000000d0140
- (void)willHide;	// IMP=0x00000000000d001a
- (void)didShow;	// IMP=0x00000000000cfda3
- (void)willShow;	// IMP=0x00000000000cfd46
- (_Bool)gestureRecognizerShouldBegin:(id)arg1;	// IMP=0x00000000000cfc5c
- (void)presentFromRect:(struct CGRect)arg1 view:(id)arg2;	// IMP=0x00000000000cf577
- (int)willPresentInPosition:(struct CGRect)arg1 view:(id)arg2;	// IMP=0x00000000000cf3fb
- (struct CGRect)p_containerFrameForView:(id)arg1;	// IMP=0x00000000000cf2c5
- (_Bool)canPresentInPosition:(int)arg1;	// IMP=0x00000000000cf2ba
- (void)didReceiveMemoryWarning;	// IMP=0x00000000000cf27c
- (void)viewDidLoad;	// IMP=0x00000000000cf20d
- (void)dealloc;	// IMP=0x00000000000cf1cf
- (void)releaseOutlets;	// IMP=0x00000000000cf1c9
- (id)init;	// IMP=0x00000000000cf177
