...
+ (id)shortDescription;	// IMP=0x00100000008a20a7
- (void).cxx_destruct;	// IMP=0x00000000008a2054
...
- (void)replayChange:(id)arg1 stagedChange:(id)arg2;	// IMP=0x00000000008a184e
- (void)resetRecord;	// IMP=0x00000000008a180f
- (void)updateChangeWithRecord:(id)arg1;	// IMP=0x00000000008a17a6
@property(readonly, nonatomic) CKRecordID *recordID;
@property(readonly, nonatomic) NSString *type;
@property(readonly, nonatomic) NSString *recordName;
@property(readonly, nonatomic) CKRecord *record;
- (void)updateWithObjectChange:(id)arg1;	// IMP=0x00000000008a0e07
- (void)updateDeletedCloudRecord:(id)arg1;	// IMP=0x00000000008a0d02
- (void)updateCloudRecord:(id)arg1;	// IMP=0x00000000008a0803
- (void)forceChangeToInvalid;	// IMP=0x00000000008a07ef
- (void)forceChangeToDelete;	// IMP=0x00000000008a06ff
...
- (id)shortDescription;	// IMP=0x00000000008a0305
- (id)initWithCloudObjectRecord:(id)arg1;	// IMP=0x00000000008a02ee
- (id)initWithObjectChange:(id)arg1;	// IMP=0x00000000008a02da
- (id)_initWithObjectChange:(id)arg1 cloudObjectRecord:(id)arg2;	// IMP=0x000000000089ffac
- (id)init;	// IMP=0x000000000089ff04
