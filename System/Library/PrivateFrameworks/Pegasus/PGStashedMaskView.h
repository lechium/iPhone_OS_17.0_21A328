...
- (void).cxx_destruct;	// IMP=0x0000000000031dbb
...
- (void)layoutSubviews;	// IMP=0x0000000000031877
- (_Bool)pointInside:(struct CGPoint)arg1 withEvent:(id)arg2;	// IMP=0x00000000000317af
- (void)_setContinuousCornerRadius:(double)arg1;	// IMP=0x0000000000031792
- (double)_continuousCornerRadius;	// IMP=0x0000000000031775
- (struct CGRect)_mainBodyBounds;	// IMP=0x00000000000316f8
@property(readonly, nonatomic) struct CGRect tabViewBounds;
- (void)setTabHidden:(_Bool)arg1 left:(_Bool)arg2;	// IMP=0x000000000003115c
- (id)initWithFrame:(struct CGRect)arg1 minimumStashTabSize:(struct CGSize)arg2;	// IMP=0x0000000000030a23
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000030a01
