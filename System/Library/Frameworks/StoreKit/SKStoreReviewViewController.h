...
- (void).cxx_destruct;	// IMP=0x000000000001b8e9
...
- (void)_addRemoteView;	// IMP=0x000000000001b6ee
- (void)_requestRemoteViewController;	// IMP=0x000000000001b2c9
- (void)remoteReviewViewControllerTerminatedWithError:(id)arg1;	// IMP=0x000000000001b2b3
- (void)_didFinishWithResult:(unsigned long long)arg1 error:(id)arg2;	// IMP=0x000000000001b1b1
- (void)viewWillDisappear:(_Bool)arg1;	// IMP=0x000000000001b116
- (void)viewDidLoad;	// IMP=0x000000000001b06a
- (void)dealloc;	// IMP=0x000000000001afcf
- (id)initWithReviewRequestToken:(id)arg1;	// IMP=0x000000000001aee7
