...
+ (void)configureEpisodeDetailView:(id)arg1 withMedia:(id)arg2 viewSize:(struct CGSize)arg3;	// IMP=0x001000000025a4ea
+ (struct CGSize)_episodeFrameImageSizeForDetailView:(id)arg1 withViewSize:(struct CGSize)arg2;	// IMP=0x001000000025a489
- (void).cxx_destruct;	// IMP=0x000000000025cc74
...
- (double)_seasonMargin;	// IMP=0x000000000025caee
- (void)_configureViewElementsForAX;	// IMP=0x000000000025ca65
- (void)didTapButtonForEpisodeFrameView:(id)arg1;	// IMP=0x000000000025ca31
- (double)_descriptionBottomMarginWithBaselineMargin:(double)arg1;	// IMP=0x000000000025c9ae
- (double)_descriptionTopMarginWithBaselineMargin:(double)arg1 otherFont:(id)arg2;	// IMP=0x000000000025c8ea
- (void)_configureDotSeparator;	// IMP=0x000000000025c79c
- (void)updateProgress;	// IMP=0x000000000025c72c
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x000000000025c411
- (void)layoutSubviews;	// IMP=0x000000000025b5a5
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000025afa0
