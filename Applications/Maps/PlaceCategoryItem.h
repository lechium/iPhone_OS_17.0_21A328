...
- (void).cxx_destruct;	// IMP=0x00200000009f8b6f
...
- (id)initWithSearchCategory:(id)arg1 parentMuid:(unsigned long long)arg2 displayMode:(int)arg3;	// IMP=0x00100000009f8ad1
