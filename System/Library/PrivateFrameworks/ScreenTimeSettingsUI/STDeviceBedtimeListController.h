...
- (void).cxx_destruct;	// IMP=0x0000000000058156
...
- (id)datePickerForSpecifier:(id)arg1;	// IMP=0x0000000000057b83
- (void)datePickerChanged:(id)arg1;	// IMP=0x0000000000057801
- (void)tableView:(id)arg1 willDisplayCell:(id)arg2 forRowAtIndexPath:(id)arg3;	// IMP=0x000000000005761c
- (void)tableView:(id)arg1 didSelectRowAtIndexPath:(id)arg2;	// IMP=0x0000000000057097
- (id)atDowntimeFooterText;	// IMP=0x0000000000056e3c
- (id)askForMoreTime:(id)arg1;	// IMP=0x0000000000056dcc
- (void)setAskForMoreTime:(id)arg1 specifier:(id)arg2;	// IMP=0x0000000000056c2a
- (id)timeFooterText;	// IMP=0x0000000000056a42
- (void)_showCustomizeDailyScheduleListController:(id)arg1;	// IMP=0x00000000000566c5
- (id)_customScheduleTime:(id)arg1;	// IMP=0x000000000005648c
- (id)_simpleEndTime:(id)arg1;	// IMP=0x0000000000056347
- (id)_simpleStartTime:(id)arg1;	// IMP=0x0000000000056202
- (void)_showOrHidePickerSpecifierForSpecifier:(id)arg1;	// IMP=0x0000000000055d1f
- (void)_actuallyToggleDowntimeEnabled;	// IMP=0x0000000000055be4
- (void)_toggleDowntimeEnabled;	// IMP=0x0000000000055940
- (id)_createDefaultCustomScheduleFromSimpleSchedule:(id)arg1;	// IMP=0x0000000000055688
- (id)deviceBedtimeEnabled:(id)arg1;	// IMP=0x0000000000055618
- (void)setDeviceBedtimeEnabled:(id)arg1 specifier:(id)arg2;	// IMP=0x00000000000553e6
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x0000000000055118
- (void)dealloc;	// IMP=0x0000000000054fc2
- (void)_didEndEditingDailySchedule:(id)arg1;	// IMP=0x00000000000549d3
- (void)_renderDeviceBedtimeSpecifierWithBedtime:(id)arg1;	// IMP=0x00000000000546b2
- (id)_deviceBedtimeSpecifierWithBedtime:(id)arg1 downtimeGroupSpecifier:(id)arg2;	// IMP=0x0000000000054278
- (id)specifiers;	// IMP=0x0000000000052fe5
- (void)_didFinishEditingBedtime;	// IMP=0x0000000000052ed7
- (void)willResignActive;	// IMP=0x0000000000052e3e
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x0000000000052da5
- (void)viewWillDisappear:(_Bool)arg1;	// IMP=0x0000000000052d20
- (_Bool)canBeShownFromSuspendedState;	// IMP=0x0000000000052d18
- (void)scheduleDowntimeRefreshIfNeeded;	// IMP=0x0000000000052b32
- (void)scheduleDowntimeRefreshAndReloadSpecifiers;	// IMP=0x0000000000052b04
- (id)init;	// IMP=0x0000000000052769
