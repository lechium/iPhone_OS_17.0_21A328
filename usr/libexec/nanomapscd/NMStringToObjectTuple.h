...
- (void).cxx_destruct;	// IMP=0x0020000000060b79
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000000609f7
- (unsigned long long)hash;	// IMP=0x0010000000060847
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000606db
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000605ba
- (void)copyTo:(id)arg1;	// IMP=0x00100000000604da
- (void)writeTo:(id)arg1;	// IMP=0x00100000000603ed
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000000603e0
- (id)dictionaryRepresentation;	// IMP=0x001000000005fef2
- (id)description;	// IMP=0x001000000005fe43
