...
+ (id)withEvent:(long long)arg1 andPredicate:(id)arg2;	// IMP=0x0020000000668a8d
...
- (void)dealloc;	// IMP=0x0010000000668b50
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000006689f3
- (unsigned long long)hash;	// IMP=0x0010000000668988
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000006688d0
