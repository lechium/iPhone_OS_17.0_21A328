...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000000043e3
- (unsigned long long)hash;	// IMP=0x001000000000437c
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000004284
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000041e8
- (void)copyTo:(id)arg1;	// IMP=0x001000000000416f
- (void)writeTo:(id)arg1;	// IMP=0x00100000000040d9
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000000040cc
- (id)dictionaryRepresentation;	// IMP=0x0010000000003c9d
- (id)description;	// IMP=0x0010000000003bee
