...
+ (struct CGSize)playbackTimeIndicatorTileSize;	// IMP=0x00100000004a8b8f
- (void).cxx_destruct;	// IMP=0x00000000004a8a91
...
- (void)_cancelFlashTimeIndicator;	// IMP=0x00000000004a89ff
- (void)_flashTimeIndicator;	// IMP=0x00000000004a89a4
- (void)_handleViewModel:(id)arg1 change:(id)arg2;	// IMP=0x00000000004a884a
- (void)_handleVideoPlayer:(id)arg1 change:(id)arg2;	// IMP=0x00000000004a87ef
- (void)viewModel:(id)arg1 didChange:(id)arg2;	// IMP=0x00000000004a8734
- (void)videoPlayer:(id)arg1 desiredSeekTimeDidChange:(CDStruct_1b6d18a9)arg2;	// IMP=0x00000000004a8722
- (void)videoPlayer:(id)arg1 currentTimeDidChange:(CDStruct_1b6d18a9)arg2;	// IMP=0x00000000004a8710
- (void)_updateIndicatorDisplayStyle;	// IMP=0x00000000004a8576
- (void)_updateIndicatorValueWithTime:(CDStruct_1b6d18a9)arg1;	// IMP=0x00000000004a849e
- (void)_setIndicatorVisible:(_Bool)arg1 animated:(_Bool)arg2;	// IMP=0x00000000004a820f
- (void)_setIndicatorFormat:(long long)arg1 animated:(_Bool)arg2;	// IMP=0x00000000004a815d
- (void)becomeReusable;	// IMP=0x00000000004a7ee1
- (void)viewDidLoad;	// IMP=0x00000000004a7d64
