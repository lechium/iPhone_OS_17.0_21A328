...
- (void).cxx_destruct;	// IMP=0x00000000000eb384
...
- (void)_buttonAction:(id)arg1;	// IMP=0x00000000000eb240
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000000eb213
- (void)setBackgroundColor:(id)arg1;	// IMP=0x00000000000eb1a1
@property(nonatomic) struct UIEdgeInsets contentInset;
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000000ead7f
