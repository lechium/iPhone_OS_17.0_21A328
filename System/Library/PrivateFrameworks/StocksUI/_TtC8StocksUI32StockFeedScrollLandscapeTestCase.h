...
@interface _TtC8StocksUI32StockFeedScrollLandscapeTestCase : NSObject
{
...
- (void).cxx_destruct;	// IMP=0x000000000006db40
- (id)init;	// IMP=0x000000000006daf0
- (id)scrollViewWithContext:(id)arg1;	// IMP=0x000000000006d990
