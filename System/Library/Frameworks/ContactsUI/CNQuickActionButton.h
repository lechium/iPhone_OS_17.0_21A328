...
- (void).cxx_destruct;	// IMP=0x000000000026c053
...
- (void)onLongPress:(id)arg1;	// IMP=0x000000000026bcca
- (void)performAction;	// IMP=0x000000000026bbeb
- (void)updateConstraints;	// IMP=0x000000000026b7c5
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000026b21b
