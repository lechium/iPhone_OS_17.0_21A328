...
- (void).cxx_destruct;	// IMP=0x0020000000299a52
...
// Error: Property attributes should begin with the type ('T') attribute, property name: publicLegacyIdentityData
// Property attributes: (null)

- (id)initWithPublicLegacyIdentityData:(id)arg1 publicNGMIdentityData:(id)arg2 publicNGMPrekeyData:(id)arg3 NGMVersion:(id)arg4;	// IMP=0x0010000000299942
