...
- (void).cxx_destruct;	// IMP=0x0020000000077eea
...
- (id)debugDescription;	// IMP=0x0010000000077c9d
- (float)legacyScore;	// IMP=0x0010000000077b87
...
- (id)initWithContentItemSnapshot:(id)arg1;	// IMP=0x0010000000077888
