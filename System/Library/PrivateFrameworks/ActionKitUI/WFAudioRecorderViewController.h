...
- (void)audioRecorder:(id)arg1 didFinishWithDestinationURL:(id)arg2 error:(id)arg3;	// IMP=0x000000000002b426
- (void)audioRecorder:(id)arg1 didProgressToTime:(double)arg2;	// IMP=0x000000000002b342
- (void)inputButtonTapped;	// IMP=0x000000000002af13
- (void)finishRecording;	// IMP=0x000000000002aed6
- (void)startRecording;	// IMP=0x000000000002adef
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x000000000002ad9a
- (void)handleTap;	// IMP=0x000000000002acf9
- (void)viewDidLoad;	// IMP=0x000000000002a99f
- (id)initWithOutputFormat:(long long)arg1 destinationURL:(id)arg2;	// IMP=0x000000000002a8e0
