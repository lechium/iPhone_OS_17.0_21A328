...
- (void).cxx_destruct;	// IMP=0x00000000009434b4
...
- (void)_pickerDidSelectColor:(id)arg1 colorSpace:(id)arg2 isVolatile:(_Bool)arg3;	// IMP=0x0000000000943384
- (void)_forwardToDelegate:(id)arg1;	// IMP=0x00000000009432ba
- (void)_displayLinkFired;	// IMP=0x000000000094326a
- (id)init;	// IMP=0x0000000000943127
