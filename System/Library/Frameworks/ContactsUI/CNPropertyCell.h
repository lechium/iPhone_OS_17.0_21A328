...
+ (id)labelStringFromAppName:(id)arg1 andPropertyLabel:(id)arg2;	// IMP=0x00600000001df81e
- (void).cxx_destruct;	// IMP=0x00000000001df7e2
...
- (void)updateValueWithPropertyItem:(id)arg1;	// IMP=0x00000000001df58f
- (void)updateWithPropertyItem:(id)arg1;	// IMP=0x00000000001df400
- (void)tintColorDidChange;	// IMP=0x00000000001df28d
...
- (void)copy:(id)arg1;	// IMP=0x00000000001df1e1
- (id)valueString;	// IMP=0x00000000001df191
- (id)appNameForSuggestion:(id)arg1;	// IMP=0x00000000001df03d
- (_Bool)shouldShowSuggestionOrigin;	// IMP=0x00000000001def4f
- (id)labelString;	// IMP=0x00000000001dec7d
@property(readonly, nonatomic, getter=isSuggested) _Bool suggested;
- (void)setPropertyItem:(id)arg1;	// IMP=0x00000000001deb86
@property(readonly, nonatomic) CNPropertyGroupItem *propertyItem;
- (void)setCardGroupItem:(id)arg1;	// IMP=0x00000000001deab2
- (void)performAccessoryAction;	// IMP=0x00000000001de8af
- (void)performDefaultAction;	// IMP=0x00000000001de83b
- (id)initWithStyle:(long long)arg1 reuseIdentifier:(id)arg2;	// IMP=0x00000000001de7f2
