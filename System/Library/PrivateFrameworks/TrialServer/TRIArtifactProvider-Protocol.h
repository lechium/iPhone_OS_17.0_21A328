...
@class CKRecordID, NSDate, NSDictionary, NSIndexSet, NSSet, NSString, TRIBMLTDeployment, TRIExperimentDeployment, TRIFetchOptions, TRILimitedCarryProfileManager, TRIRolloutDeployment;
...
- (void)fetchBMLTNotificationWithDeployment:(TRIBMLTDeployment *)arg1 options:(TRIFetchOptions *)arg2 completion:(void (^)(unsigned long long, TRIClientBMLTArtifact *, NSDate *, NSError *))arg3;
- (void)fetchBMLTNotificationsWithOptions:(TRIFetchOptions *)arg1 completion:(void (^)(unsigned long long, TRIClientBMLTArtifact *, NSDate *, NSError *))arg2;
- (void)fetchBMLTCatalogNotificationWithOptions:(TRIFetchOptions *)arg1 completion:(void (^)(unsigned long long, TRIClientBMLTCatalogArtifact *, NSDate *, NSError *))arg2;
...
- (void)fetchRolloutNotificationsDateDescendingWithOptions:(TRIFetchOptions *)arg1 completion:(void (^)(unsigned long long, TRIClientRolloutArtifact *, NSDate *, NSError *, _Bool *))arg2;
- (void)fetchRolloutNotificationsDateAscendingWithOptions:(TRIFetchOptions *)arg1 lastFetchDateOverride:(NSDate *)arg2 namespaceNames:(NSSet *)arg3 completion:(void (^)(unsigned long long, TRIClientRolloutArtifact *, NSDate *, NSError *))arg4;
