...
@interface _UIPointerEffectSettings : PTSettings
{
    ...
    double _progressiveScaleUpAnimationResponse;	// 80 = 0x50
    double _dampedAnimationResponse;	// 88 = 0x58
    double _dampedAnimationDampingRatio;	// 96 = 0x60
}

+ (id)settingsControllerModule;	// IMP=0x0040000000e1a096
+ (_Bool)pointerSlipMatchesContentSlip;	// IMP=0x0040000000e1a08e
...
- (void)setDefaultValues;	// IMP=0x0000000000e19f6b
