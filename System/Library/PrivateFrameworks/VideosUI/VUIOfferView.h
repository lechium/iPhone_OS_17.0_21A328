...
- (void).cxx_destruct;	// IMP=0x000000000007cdcf
...
- (void)setSelected:(_Bool)arg1 animated:(_Bool)arg2 withAnimationCoordinator:(id)arg3;	// IMP=0x000000000007cb80
- (struct CGSize)computeSizeThatFits:(struct CGSize)arg1;	// IMP=0x000000000007cac8
- (void)layoutOfferSubviewsWithSize:(struct CGSize)arg1;	// IMP=0x000000000007bd8f
- (struct CGSize)vui_layoutSubviews:(struct CGSize)arg1 computationOnly:(_Bool)arg2;	// IMP=0x000000000007bd59
- (double)_chinHeightForSize:(struct CGSize)arg1;	// IMP=0x000000000007b779
- (_Bool)_shouldDisplaySeparator;	// IMP=0x000000000007b735
- (void)setSemanticContentAttribute:(long long)arg1;	// IMP=0x000000000007b687
- (void)prepareForCellReuse;	// IMP=0x000000000007b1a6
