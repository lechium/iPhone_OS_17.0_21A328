...
- (double)defaultHeight;	// IMP=0x0010000000c1c829
- (double)minimumInterItemSpacingForSectionAtIndex:(long long)arg1;	// IMP=0x0010000000c1c808
- (double)minimumLineSpacingForSectionAtIndex:(long long)arg1;	// IMP=0x0010000000c1c7dd
- (struct UIEdgeInsets)insetForFilterAtIndex:(long long)arg1;	// IMP=0x0010000000c1c7be
- (struct CGSize)sizeForFilter:(id)arg1;	// IMP=0x0010000000c1c609
- (id)initWithCollectionsFilterDisplayStyle:(long long)arg1 inContext:(long long)arg2;	// IMP=0x0010000000c1c42c
