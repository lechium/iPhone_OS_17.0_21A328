...
- (void)invalidateAttachmentMeasurements;	// IMP=0x000000000011c30c
- (void)_invalidateLocations;	// IMP=0x000000000011c2ea
...
- (id)textLayoutFragment;	// IMP=0x000000000011c0cf
@property(readonly) id <NSTextLocation> location; // @dynamic location;
- (void)_queryLayoutWithHorizontalOffset:(double)arg1;	// IMP=0x000000000011bf0e
- (void)_queryLayout;	// IMP=0x000000000011bc5d
- (void)dealloc;	// IMP=0x000000000011bbfe
- (id)initWithContext:(id)arg1 location:(id)arg2 attributes:(id)arg3;	// IMP=0x000000000011bab3
