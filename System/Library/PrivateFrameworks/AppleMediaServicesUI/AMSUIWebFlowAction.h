...
- (void)_runWithType:(long long)arg1 options:(id)arg2;	// IMP=0x00000000000a33da
- (id)runAction;	// IMP=0x00000000000a2faf
- (id)initWithJSObject:(id)arg1 context:(id)arg2;	// IMP=0x00000000000a29ab
- (id)initWithContext:(id)arg1;	// IMP=0x00000000000a2968
