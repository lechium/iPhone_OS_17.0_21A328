...
- (id)tv_associatedViewElement;	// IMP=0x00300000000a7640
- (id)tv_urlWithLayout:(id)arg1;	// IMP=0x00300000000d295d
- (id)tv_urlWithSize:(struct CGSize)arg1 focusSizeIncrease:(double)arg2;	// IMP=0x00300000000d28a7
- (id)tv_urlWithSize:(struct CGSize)arg1 focusSizeIncrease:(double)arg2 centerGrowth:(_Bool)arg3 cropCode:(id)arg4;	// IMP=0x00300000000d2672
...
- (id)tv_imageProxyWithLayout:(id)arg1;	// IMP=0x00300000000d21cd
