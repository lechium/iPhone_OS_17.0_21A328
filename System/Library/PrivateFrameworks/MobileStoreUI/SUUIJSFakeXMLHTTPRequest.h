...
@interface SUUIJSFakeXMLHTTPRequest : IKJSObject
{
    NSData *_data;	// 8 = 0x8
...
- (void).cxx_destruct;	// IMP=0x0000000000230803
...
- (id)getResponseHeader:(id)arg1;	// IMP=0x0000000000230581
- (id)getAllResponseHeaders;	// IMP=0x0000000000230492
- (id)initWithAppContext:(id)arg1 data:(id)arg2 URLResponse:(id)arg3 performanceMetrics:(id)arg4;	// IMP=0x00000000002303bb
