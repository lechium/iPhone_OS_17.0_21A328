...
+ (id)styleWithVariant:(unsigned long long)arg1 destination:(unsigned long long)arg2 layoutType:(unsigned long long)arg3;	// IMP=0x0020000000b8ffef
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000b90629
@property(readonly, nonatomic) unsigned int desiredFraming;
@property(readonly, nonatomic) struct CGSize arrowReferenceSize;
@property(readonly, nonatomic) CDStruct_a1deb1f2 junctionArrowMetrics;
@property(readonly, nonatomic) CDStruct_a1deb1f2 arrowMetrics;
...
- (_Bool)_isDisplayedInWidget;	// IMP=0x0010000000b90048
@property(readonly, nonatomic) _Bool displaysShield;
- (id)initWithVariant:(unsigned long long)arg1 destination:(unsigned long long)arg2 layoutType:(unsigned long long)arg3;	// IMP=0x0010000000b8ff95
