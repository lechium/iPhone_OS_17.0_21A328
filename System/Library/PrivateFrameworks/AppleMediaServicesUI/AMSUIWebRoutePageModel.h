...
- (id)_webPageViewController;	// IMP=0x00000000000c5663
- (id)loadPage;	// IMP=0x00000000000c564a
@property(readonly, nonatomic) _Bool disableReappearPlaceholder;
- (id)createViewControllerForContainer:(id)arg1;	// IMP=0x00000000000c5630
@property(readonly, copy) NSString *description;
- (id)initWithJSObject:(id)arg1 context:(id)arg2;	// IMP=0x00000000000c50af
