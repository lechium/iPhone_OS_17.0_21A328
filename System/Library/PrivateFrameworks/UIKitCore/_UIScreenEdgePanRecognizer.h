...
- (void).cxx_destruct;	// IMP=0x000000000098b837
...
- (unsigned long long)_targetEdges;	// IMP=0x000000000098b6bb
- (void)_idleTimerElapsed:(id)arg1;	// IMP=0x000000000098b572
- (void)_longPressTimerElapsed:(id)arg1;	// IMP=0x000000000098b478
- (void)_incorporateIncrementalSampleAtLocation:(struct CGPoint)arg1 timestamp:(double)arg2 modifier:(long long)arg3 region:(unsigned long long)arg4 interfaceOrientation:(long long)arg5 forceState:(long long)arg6;	// IMP=0x000000000098a6fd
- (void)_incorporateInitialTouchAtLocation:(struct CGPoint)arg1 timestamp:(double)arg2 modifier:(long long)arg3 region:(unsigned long long)arg4 interfaceOrientation:(long long)arg5 forceState:(long long)arg6;	// IMP=0x0000000000989f0d
- (void)incorporateTouchSampleAtLocation:(struct CGPoint)arg1 timestamp:(double)arg2 modifier:(long long)arg3 region:(unsigned long long)arg4 interfaceOrientation:(long long)arg5 forceState:(long long)arg6;	// IMP=0x0000000000989e7d
- (unsigned long long)touchedEdgesForInterfaceOrientation:(long long)arg1;	// IMP=0x0000000000989ded
- (long long)_type;	// IMP=0x0000000000989de0
- (void)_setState:(long long)arg1;	// IMP=0x0000000000989bec
@property(readonly, nonatomic) _Bool useGrapeFlags;
- (void)reset;	// IMP=0x0000000000989b57
- (void)dealloc;	// IMP=0x0000000000989b1b
- (id)initWithType:(long long)arg1;	// IMP=0x0000000000989abc
- (id)initWithType:(long long)arg1 settings:(id)arg2;	// IMP=0x00000000009898cd
