...
- (void).cxx_destruct;	// IMP=0x000000000008d8a7
- (unsigned long long)hash;	// IMP=0x000000000008d737
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000008d4c1
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000008d288
- (void)writeTo:(id)arg1;	// IMP=0x000000000008d126
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000008d119
- (id)dictionaryRepresentation;	// IMP=0x000000000008cd3c
- (id)description;	// IMP=0x000000000008cc8d
