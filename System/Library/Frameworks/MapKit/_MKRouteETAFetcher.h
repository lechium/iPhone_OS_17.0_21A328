...
- (void).cxx_destruct;	// IMP=0x0000000000156629
...
- (void)_didUpdateETAResult;	// IMP=0x00000000001565aa
- (void)invalidateETAForTransportType:(unsigned long long)arg1;	// IMP=0x0000000000156556
- (_Bool)isValidETA:(id)arg1;	// IMP=0x00000000001564a9
- (void)expireETAsIfNoLongerValid;	// IMP=0x0000000000156218
- (_Bool)shouldUpdateEstimatedTravelTimeForNewOrigin:(struct CLLocationCoordinate2D)arg1;	// IMP=0x0000000000156115
...
- (_Bool)isUsingCurrentLocationForOrigin;	// IMP=0x0000000000155ecf
- (void)requestNewETAForTransportType:(unsigned long long)arg1 additionalTransportTypes:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x000000000015580e
- (id)routeETAForTransportType:(unsigned long long)arg1;	// IMP=0x00000000001557a7
- (void)_resetState;	// IMP=0x000000000015573a
- (void)dealloc;	// IMP=0x0000000000155437
- (id)init;	// IMP=0x0000000000155372
