...
- (void).cxx_destruct;	// IMP=0x00000000001ebd47
...
- (id)applyUpdatesWithElement:(id)arg1;	// IMP=0x00000000001ebb3f
- (id)initWithDOMElement:(id)arg1 parent:(id)arg2 elementFactory:(id)arg3;	// IMP=0x00000000001eba24
