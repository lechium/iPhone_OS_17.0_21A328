...
- (void)_cancelFireRequests;	// IMP=0x000000000001d61f
- (void)cancelPreviousFireRequests;	// IMP=0x000000000001d598
@property(readonly, nonatomic) _Bool isScheduledToFire;
- (void)callTargetSelector;	// IMP=0x000000000001d34e
- (void)fireImmediately;	// IMP=0x000000000001d253
- (void)requestFire;	// IMP=0x000000000001cf38
- (void)dealloc;	// IMP=0x000000000001ce93
- (id)initWithTarget:(id)arg1 selector:(SEL)arg2 delay:(double)arg3 waitToFireUntilRequestsStop:(_Bool)arg4 callOnMainThread:(_Bool)arg5;	// IMP=0x000000000001cd7e
