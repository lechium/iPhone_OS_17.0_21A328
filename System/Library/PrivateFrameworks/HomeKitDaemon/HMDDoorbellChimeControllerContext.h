...
- (void).cxx_destruct;	// IMP=0x00000000007705bf
...
- (_Bool)accessorySupportsCoordinationDoorbellChime:(id)arg1;	// IMP=0x0000000000770545
@property(readonly, copy) NSUUID *currentAccessoryUUID;
- (id)fetchDoorbellDelay;	// IMP=0x0000000000770461
- (id)clearCoordinationStateForKeyPaths:(id)arg1;	// IMP=0x0000000000770448
- (id)keyPathFromComponents:(id)arg1;	// IMP=0x0000000000770440
- (id)postCoordinationState:(id)arg1;	// IMP=0x0000000000770427
...
- (id)postCULiveAction:(id)arg1;	// IMP=0x00000000007701dd
...
- (id)initWithWorkQueue:(id)arg1 accessory:(id)arg2;	// IMP=0x000000000076ff6e
