...
- (void).cxx_destruct;	// IMP=0x00000000000d76af
...
- (void)dealloc;	// IMP=0x00000000000d763e
- (void)removeManagedReferences;	// IMP=0x00000000000d7508
- (id)description;	// IMP=0x00000000000d7486
- (id)initWithCallback:(id)arg1 callbackArgs:(id)arg2 repeating:(_Bool)arg3 ownerObject:(id)arg4 timer:(id)arg5;	// IMP=0x00000000000d72dd
