...
- (void).cxx_destruct;	// IMP=0x000000000002f6e4
...
- (void)tick;	// IMP=0x000000000002f1c5
- (void)stop;	// IMP=0x000000000002f173
- (void)start;	// IMP=0x000000000002efee
- (void)releaseNode:(id)arg1;	// IMP=0x000000000002ef8e
- (void)fixNode:(id)arg1 atPosition:(struct CGPoint)arg2;	// IMP=0x000000000002eee3
- (void)unlinkNode:(id)arg1 fromNode:(id)arg2;	// IMP=0x000000000002ee8a
- (void)linkNode:(id)arg1 toNode:(id)arg2;	// IMP=0x000000000002ed0b
- (void)removeAllNodes;	// IMP=0x000000000002ecd0
- (void)removeNode:(id)arg1;	// IMP=0x000000000002ebf8
- (void)addNode:(id)arg1;	// IMP=0x000000000002ea98
@property(nonatomic) double lineWidth;
@property(copy, nonatomic) UIColor *lineColor;
- (id)initWithReferenceView:(id)arg1;	// IMP=0x000000000002e6de
- (id)init;	// IMP=0x000000000002e6ca
