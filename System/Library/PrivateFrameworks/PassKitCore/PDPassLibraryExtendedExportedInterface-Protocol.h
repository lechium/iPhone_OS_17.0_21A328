...
@class CLLocation, NSArray, NSData, NSMapTable, NSNumber, NSSet, NSString, PKACAccountChange, PKAddShareablePassConfiguration, PKAppleAccountChange, PKContact, PKDisplayProfile, PKDisplayTraitCollection, PKFieldProperties, PKFileDescriptorXPCContainer, PKGroupsControllerSnapshotFetchOptions, PKPassesXPCContainer, PKPaymentSetupRequest;
...
- (void)usingSynchronousProxy:(_Bool)arg1 addPassIngestionPayloads:(NSArray *)arg2 withCompletionHandler:(void (^)(long long))arg3;
