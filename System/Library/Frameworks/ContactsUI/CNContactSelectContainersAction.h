...
- (void).cxx_destruct;	// IMP=0x00000000002a5b9f
...
- (_Bool)containerPicker:(id)arg1 shouldAllowDeselectionOfContainerWithIdentifier:(id)arg2;	// IMP=0x00000000002a5a58
- (void)containerPicker:(id)arg1 didFinishWithPickedContainers:(id)arg2;	// IMP=0x00000000002a563f
- (void)cleanupForDismissal;	// IMP=0x00000000002a562b
- (void)performActionWithContainerContext:(id)arg1;	// IMP=0x00000000002a540d
