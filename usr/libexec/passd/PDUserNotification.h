...
+ (id)applicationMessageIconForFeature:(unsigned long long)arg1;	// IMP=0x0020000000274d4f
+ (_Bool)supportsCoalescing;	// IMP=0x0010000000274513
+ (_Bool)allowReinsertionAfterDismissal;	// IMP=0x001000000027450b
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000273e8b
- (void).cxx_destruct;	// IMP=0x00100000002752fa
...
- (id)notificationContentWithDataSource:(id)arg1;	// IMP=0x0010000000274f40
- (id)actionURL;	// IMP=0x0010000000274533
- (unsigned long long)coalesceWithExistingUserNotification:(id)arg1;	// IMP=0x001000000027452b
@property(readonly, nonatomic) unsigned long long notificationType;
@property(readonly, nonatomic, getter=isValid) _Bool valid;
- (_Bool)isCashFamilyNotification;	// IMP=0x00100000002744e9
- (id)description;	// IMP=0x0010000000274376
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00100000002741c2
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000273e93
- (id)initWithNotificationIdentifier:(id)arg1 forAccountIdentifier:(id)arg2;	// IMP=0x0010000000273daf
- (id)initWithNotificationIdentifier:(id)arg1 forPassUniqueIdentifier:(id)arg2;	// IMP=0x0010000000273cd3
- (id)_payLaterApplicationMessageContentWithTitleText:(id)arg1 messageText:(id)arg2;	// IMP=0x0010000000319bf2
- (id)_payLaterApplicationMessageGroupDescriptor;	// IMP=0x0010000000319b9b
- (void)updatePassNameForNotificationContent:(id)arg1 dataSource:(id)arg2;	// IMP=0x0010000000319a94
