...
- (void).cxx_destruct;	// IMP=0x00000000002764b9
...
- (_Bool)isSubmitted;	// IMP=0x00000000002761f0
...
- (id)initWithHomeConfigurations:(id)arg1 isFMFDevice:(_Bool)arg2;	// IMP=0x000000000027577d
- (id)initWithHomeManager:(id)arg1 metadataVersion:(unsigned int)arg2;	// IMP=0x00000000002754ea
