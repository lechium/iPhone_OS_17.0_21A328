...
+ (id)changesetWithDownloadID:(id)arg1 state:(long long)arg2;	// IMP=0x0020000000012e3e
- (void).cxx_destruct;	// IMP=0x0020000000013372
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000131a6
- (id)copyXPCEncoding;	// IMP=0x00100000000130e9
- (id)initWithXPCEncoding:(id)arg1;	// IMP=0x0010000000012edc
