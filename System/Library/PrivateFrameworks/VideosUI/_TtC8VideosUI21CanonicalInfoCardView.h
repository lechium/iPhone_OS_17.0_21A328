...
- (void).cxx_destruct;	// IMP=0x000000000057e0f6
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000057e0a6
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000057dfe5
...
- (void)vui_prepareForReuse;	// IMP=0x000000000057dd89
- (struct CGSize)vui_layoutSubviews:(struct CGSize)arg1 computationOnly:(_Bool)arg2;	// IMP=0x000000000057dc37
