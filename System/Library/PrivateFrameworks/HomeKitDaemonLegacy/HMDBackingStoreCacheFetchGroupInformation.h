...
- (void).cxx_destruct;	// IMP=0x00000000001fe8a7
...
- (id)mainReturningError;	// IMP=0x00000000001fe649
- (id)initWithGroup:(id)arg1 fetchResult:(CDUnknownBlockType)arg2;	// IMP=0x00000000001fe58d
