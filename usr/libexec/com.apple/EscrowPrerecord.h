...
+ (id)createPrerecordFromCandidate:(id)arg1 storedCertificate:(id)arg2 request:(id)arg3 error:(id *)arg4;	// IMP=0x0010000000058bc9
- (void).cxx_destruct;	// IMP=0x001000000004cd62
...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000004ca28
- (unsigned long long)hash;	// IMP=0x001000000004c8c7
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000004c658
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000004c424
- (void)copyTo:(id)arg1;	// IMP=0x001000000004c281
- (void)writeTo:(id)arg1;	// IMP=0x001000000004c0f9
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000004c0ec
- (id)dictionaryRepresentation;	// IMP=0x001000000004bb4f
- (id)description;	// IMP=0x001000000004baa0
@property(readonly, nonatomic) _Bool hasDuplicateEscrowBlob;
- (int)StringAsPassphraseType:(id)arg1;	// IMP=0x001000000004b9d7
- (id)passphraseTypeAsString:(int)arg1;	// IMP=0x001000000004b98e
...
- (id)initWithCandidate:(id)arg1 certificate:(id)arg2 escrowBlob:(id)arg3 passphraseType:(int)arg4;	// IMP=0x001000000005896e
