...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000001605
...
- (id)description;	// IMP=0x00000000000014c8
- (id)initWithSyntheticCommand:(id)arg1;	// IMP=0x00000000000012da
- (void)evaluateDeviceNoteParams:(id)arg1;	// IMP=0x0000000000001245
- (pair_218a80e9)valueForNoteParam:(unsigned int)arg1 inParameters:(id)arg2;	// IMP=0x000000000000105c
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000001743
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000000160d
