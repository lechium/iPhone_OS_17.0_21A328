...
+ (id)customAttributes;	// IMP=0x00600000001b9e9d
- (id)outputImage;	// IMP=0x00000000001ba266
- (_Bool)_isIdentity;	// IMP=0x00000000001ba20c
- (id)kernel;	// IMP=0x00000000001b9e7d
