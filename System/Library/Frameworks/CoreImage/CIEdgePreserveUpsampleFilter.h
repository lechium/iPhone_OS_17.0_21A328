...
+ (id)customAttributes;	// IMP=0x006000000008acb8
...
- (id)outputImage;	// IMP=0x000000000008affa
- (id)_kernelGuideMono;	// IMP=0x000000000008afda
- (id)_kernelGuideCombine4;	// IMP=0x000000000008afba
- (id)_kernelGuideCombine;	// IMP=0x000000000008af9a
- (id)_kernelJointUpsampRG;	// IMP=0x000000000008af7a
- (id)_kernelJointUpsamp;	// IMP=0x000000000008af5a
