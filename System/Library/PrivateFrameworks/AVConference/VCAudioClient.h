...
- (void)serverDidDie;	// IMP=0x00000000001b303d
- (void)didResumeAudioIO:(id)arg1;	// IMP=0x00000000001b3037
- (void)didSuspendAudioIO:(id)arg1;	// IMP=0x00000000001b3031
@property(retain, nonatomic) AVAudioDevice *outputDevice;
@property(retain, nonatomic) AVAudioDevice *inputDevice;
- (_Bool)setCurrentAudioDevice:(id)arg1 type:(_Bool)arg2;	// IMP=0x00000000001b300d
- (id)getCurrentAudioDeviceWithType:(_Bool)arg1;	// IMP=0x00000000001b3005
- (void)stopAudioIOWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000000001b2fff
- (void)startAudioIOWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000000001b2ff9
- (_Bool)stopAudioSessionWithError:(id *)arg1;	// IMP=0x00000000001b2ff1
- (_Bool)startAudioSessionWithError:(id *)arg1;	// IMP=0x00000000001b2fe9
- (_Bool)stopWithError:(id *)arg1;	// IMP=0x00000000001b2ad3
- (_Bool)startWithError:(id *)arg1;	// IMP=0x00000000001b25c4
- (void)setAudioSessionProperties:(id)arg1;	// IMP=0x00000000001b254c
- (_Bool)resetAudioSessionOutputPortOverride:(id *)arg1;	// IMP=0x00000000001b2544
- (_Bool)unmuteWithError:(id *)arg1;	// IMP=0x00000000001b24eb
- (_Bool)muteWithError:(id *)arg1;	// IMP=0x00000000001b24c6
- (void)unlock;	// IMP=0x00000000001b24b8
- (void)lock;	// IMP=0x00000000001b24aa
- (void)dealloc;	// IMP=0x00000000001b2443
- (id)initWithProcessId:(int)arg1;	// IMP=0x00000000001b23a9
