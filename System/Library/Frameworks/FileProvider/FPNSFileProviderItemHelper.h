...
- (void).cxx_destruct;	// IMP=0x000000000012391b
...
- (id)fp_sharingCurrentUserPermissions;	// IMP=0x0000000000123875
- (id)fp_sharingCurrentUserRole;	// IMP=0x000000000012373a
- (_Bool)fp_isWritable;	// IMP=0x0000000000123703
- (_Bool)fp_isReadable;	// IMP=0x00000000001236cf
- (id)fp_downloadingStatus;	// IMP=0x000000000012364a
