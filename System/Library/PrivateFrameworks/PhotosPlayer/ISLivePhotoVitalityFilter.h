...
- (void)updateOutput;	// IMP=0x0000000000013768
- (void)invalidateOutput;	// IMP=0x0000000000013751
- (void)performInputChanges:(CDUnknownBlockType)arg1;	// IMP=0x00000000000136be
- (void)setState:(long long)arg1;	// IMP=0x0000000000013640
- (id)initWithSettings:(id)arg1;	// IMP=0x00000000000135d5
- (id)init;	// IMP=0x00000000000135c1
