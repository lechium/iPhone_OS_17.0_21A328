...
- (id)description;	// IMP=0x000000000000c730
- (unsigned long long)hash;	// IMP=0x000000000000c6e0
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000000c610
- (id)initWithPlugIns:(id)arg1 extensionPointName:(id)arg2 forClient:(id)arg3;	// IMP=0x000000000000c490
