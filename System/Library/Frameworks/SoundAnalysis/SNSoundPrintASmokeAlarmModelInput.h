...
- (void).cxx_destruct;	// IMP=0x000000000012960d
...
- (id)featureValueForName:(id)arg1;	// IMP=0x0000000000129425
@property(readonly, nonatomic) NSSet *featureNames;
- (id)initWithInput1:(id)arg1 stateIn:(id)arg2 thresholdedHistoryIn:(id)arg3 detectedHistoryIn:(id)arg4;	// IMP=0x000000000012931d
- (id)initWithInput1:(id)arg1;	// IMP=0x0000000000129303
