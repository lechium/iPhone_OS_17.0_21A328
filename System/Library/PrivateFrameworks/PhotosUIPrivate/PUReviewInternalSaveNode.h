...
@interface PUReviewInternalSaveNode : PXRunNode
{
    ...
    struct CGSize _renderedVideoSize;	// 120 = 0x78
    struct CGSize _baseImageSize;	// 136 = 0x88
    struct CGSize _renderedImageSize;	// 152 = 0x98
}

- (void).cxx_destruct;	// IMP=0x00000000004c74d4
...
- (void)run;	// IMP=0x00000000004c6429
- (id)_exportProperties;	// IMP=0x00000000004c6364
- (long long)_adjustmentBaseVersion;	// IMP=0x00000000004c62c9
- (double)_baseDuration;	// IMP=0x00000000004c61e6
- (long long)_baseExifOrientation;	// IMP=0x00000000004c6156
- (id)initWithDirectory:(id)arg1 imageDataNode:(id)arg2 imageRenderNode:(id)arg3 videoURLNode:(id)arg4 videoRenderNode:(id)arg5;	// IMP=0x00000000004c5fb1
