...
- (void).cxx_destruct;	// IMP=0x00000000000b2645
@property(nonatomic) double lineSpacing; // @synthesize lineSpacing=_lineSpacing;
@property(copy, nonatomic) NSArray *labelViews; // @synthesize labelViews=_labelViews;
- (void)layoutSubviews;	// IMP=0x00000000000b2389
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000000b2186
