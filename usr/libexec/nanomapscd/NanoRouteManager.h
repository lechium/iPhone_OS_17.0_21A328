...
+ (id)defaultRouteAttributesForNavigationOfType:(int)arg1;	// IMP=0x004000000001e9b7
- (void).cxx_destruct;	// IMP=0x002000000001fe3f
...
- (void)_handleDirectionsResponse:(id)arg1 forRequest:(id)arg2 waypoints:(id)arg3 error:(id)arg4 directionsError:(id)arg5;	// IMP=0x001000000001f734
- (void)cancel;	// IMP=0x001000000001f6a8
- (void)loadNewRouteSet;	// IMP=0x001000000001f369
- (void)_addTimepointIfNeededToRouteAttributes:(id)arg1;	// IMP=0x001000000001f1f0
- (id)_directionsRequestParameters;	// IMP=0x001000000001eb9b
- (void)_setupFeedbackIfNeeded;	// IMP=0x001000000001eaac
- (id)initWithWaypoints:(id)arg1 type:(int)arg2 currentLocation:(id)arg3 fromCurrentLocation:(_Bool)arg4 withFeedback:(id)arg5;	// IMP=0x001000000001e8e6
- (id)init;	// IMP=0x001000000001e8a7
- (void)dealloc;	// IMP=0x001000000001e854
