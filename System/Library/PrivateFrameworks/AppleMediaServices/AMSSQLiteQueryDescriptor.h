...
- (void).cxx_destruct;	// IMP=0x0000000000397f1e
...
- (id)_newSelectSQLWithProperties:(id)arg1 columns:(id)arg2;	// IMP=0x00000000003977d8
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000003976e6
