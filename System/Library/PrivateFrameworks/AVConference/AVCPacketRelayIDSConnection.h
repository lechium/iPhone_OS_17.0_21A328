...
- (void)dealloc;	// IMP=0x000000000038bcb7
- (_Bool)sendData:(const void *)arg1 size:(unsigned int)arg2 error:(id *)arg3;	// IMP=0x000000000038b8f9
- (void)readyToRead;	// IMP=0x000000000038b8c1
- (int)stop;	// IMP=0x000000000038b7a2
- (int)start;	// IMP=0x000000000038afe8
- (id)initWithIDSDestination:(id)arg1;	// IMP=0x000000000038addf
- (id)initWithIDSSocketDescriptor:(unsigned short)arg1;	// IMP=0x000000000038abd5
