...
- (void).cxx_destruct;	// IMP=0x00000000000b5090
@property(copy, nonatomic) NSCharacterSet *characterSet; // @synthesize characterSet=_characterSet;
- (unsigned long long)_minimumLength;	// IMP=0x00000000000b505f
- (id)_label;	// IMP=0x00000000000b5052
- (_Bool)_scanValue:(id *)arg1 withScanner:(id)arg2;	// IMP=0x000000000001b3a9
