...
- (void).cxx_destruct;	// IMP=0x00000000000121ac
...
- (id)initWithIdentifier:(id)arg1 title:(id)arg2 placeholder:(id)arg3 contentType:(unsigned long long)arg4;	// IMP=0x00000000000120e8
