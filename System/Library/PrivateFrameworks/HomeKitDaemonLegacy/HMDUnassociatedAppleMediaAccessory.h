...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000303fc2
+ (id)logCategory;	// IMP=0x0010000000303f92
+ (id)namespace;	// IMP=0x0010000000303f62
- (void).cxx_destruct;	// IMP=0x0000000000303eba
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000303a84
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000030376a
- (id)logIdentifier;	// IMP=0x0000000000303758
- (id)dumpDescription;	// IMP=0x000000000030353e
- (_Bool)canPairGivenCapabilities:(unsigned long long)arg1;	// IMP=0x00000000003033c5
- (id)addTransactionForHome:(id)arg1 configurationAppIdentifier:(id)arg2;	// IMP=0x0000000000302fcb
...
- (id)descriptionWithPointer:(_Bool)arg1 additionalDescription:(id)arg2;	// IMP=0x0000000000302ad2
- (id)initWithIdentifier:(id)arg1 name:(id)arg2 category:(id)arg3 requiredPairingCapabilities:(unsigned long long)arg4 minimumPairingSoftware:(id)arg5 productColor:(long long)arg6 idsIdentifierString:(id)arg7 rawAccessoryCapabilities:(id)arg8 rawResidentCapabilities:(id)arg9 messageDispatcher:(id)arg10;	// IMP=0x00000000003028e7
- (id)initWithIdentifier:(id)arg1 name:(id)arg2 category:(id)arg3 productColor:(long long)arg4 idsIdentifierString:(id)arg5 rawAccessoryCapabilities:(id)arg6 rawResidentCapabilities:(id)arg7 messageDispatcher:(id)arg8;	// IMP=0x00000000003028a7
- (id)modelForChangeType:(unsigned long long)arg1 uuid:(id)arg2 parentUUID:(id)arg3;	// IMP=0x000000000030288e
