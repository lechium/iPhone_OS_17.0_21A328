...
- (_Bool)hasAdditionalSnappingAngle;	// IMP=0x000000000020ec01
- (void)updateSnappedToNorth;	// IMP=0x000000000020ea0a
- (void)snapToNorthAnimated:(_Bool)arg1 forceTrueNorth:(_Bool)arg2;	// IMP=0x000000000020e830
- (void)stopRotatingWithFocusPoint:(struct CGPoint)arg1;	// IMP=0x000000000020e7e8
- (void)updateRotationWithFocusPoint:(struct CGPoint)arg1 newValue:(double)arg2;	// IMP=0x000000000020e53b
- (void)startRotatingWithFocusPoint:(struct CGPoint)arg1 withSnapping:(_Bool)arg2;	// IMP=0x000000000020e426
- (id)initWithMapLayer:(id)arg1;	// IMP=0x000000000020e3c2
- (id)init;	// IMP=0x000000000020e398
