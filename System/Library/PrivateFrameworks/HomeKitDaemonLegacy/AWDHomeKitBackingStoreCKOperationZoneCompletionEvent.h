...
- (void).cxx_destruct;	// IMP=0x00000000007c6a27
@property(retain, nonatomic) NSString *errorDomain; // @synthesize errorDomain=_errorDomain;
@property(nonatomic) long long errorCode; // @synthesize errorCode=_errorCode;
@property(nonatomic) _Bool didSucceed; // @synthesize didSucceed=_didSucceed;
@property(nonatomic) unsigned long long timestamp; // @synthesize timestamp=_timestamp;
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000007c68fd
- (unsigned long long)hash;	// IMP=0x00000000007c6841
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000007c66de
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000007c65d4
- (void)copyTo:(id)arg1;	// IMP=0x00000000007c6501
- (void)writeTo:(id)arg1;	// IMP=0x00000000007c6410
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000007c5fd3
- (id)dictionaryRepresentation;	// IMP=0x00000000007c5d7a
- (id)description;	// IMP=0x00000000007c5ccb
@property(readonly, nonatomic) _Bool hasErrorDomain;
- (int)StringAsZoneType:(id)arg1;	// IMP=0x00000000007c5bc4
- (id)zoneTypeAsString:(int)arg1;	// IMP=0x00000000007c5b7c
@property(nonatomic) _Bool hasZoneType;
@property(nonatomic) int zoneType; // @synthesize zoneType=_zoneType;
- (int)StringAsContainerType:(id)arg1;	// IMP=0x00000000007c5a5e
- (id)containerTypeAsString:(int)arg1;	// IMP=0x00000000007c5a16
