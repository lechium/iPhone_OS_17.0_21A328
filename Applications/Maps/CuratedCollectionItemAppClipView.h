...
- (void).cxx_destruct;	// IMP=0x002000000080754f
@property(retain, nonatomic) id <CuratedCollectionItemAppClipViewModel> viewModel; // @synthesize viewModel=_viewModel;
- (void)_updateFromModel;	// IMP=0x00100000008072a6
- (void)_updateFonts;	// IMP=0x001000000080713a
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x0010000000806f82
- (void)updateUI;	// IMP=0x0010000000806ee4
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0010000000806678
