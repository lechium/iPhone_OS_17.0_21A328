...
- (void).cxx_destruct;	// IMP=0x0000000000228bf5
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000228b19
- (id)initWithURL:(id)arg1 likeStatusDictionary:(id)arg2;	// IMP=0x00000000002287bc
