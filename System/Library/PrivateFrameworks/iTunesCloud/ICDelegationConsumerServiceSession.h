...
- (void).cxx_destruct;	// IMP=0x000000000018d6b3
...
- (void)_stop;	// IMP=0x000000000018d4de
- (void)_handleTimeout;	// IMP=0x000000000018d3ee
- (void)stop;	// IMP=0x000000000018d3a3
- (void)start;	// IMP=0x000000000018d358
- (_Bool)delegationServiceConnection:(id)arg1 didReceiveRequest:(id)arg2;	// IMP=0x000000000018d03d
- (void)delegationServiceConnection:(id)arg1 didEncouterError:(id)arg2;	// IMP=0x000000000018cfb0
- (void)delegationServiceConnectionDidClose:(id)arg1;	// IMP=0x000000000018cf23
- (void)delegationConsumerNetService:(id)arg1 didAcceptConnectionWithInputStream:(id)arg2 outputStream:(id)arg3;	// IMP=0x000000000018ce59
- (void)dealloc;	// IMP=0x000000000018ce1b
- (id)initWithRequest:(id)arg1 responseHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000000018ccaf
