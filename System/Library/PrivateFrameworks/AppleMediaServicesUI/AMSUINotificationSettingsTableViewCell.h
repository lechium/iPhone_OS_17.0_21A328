...
- (void).cxx_destruct;	// IMP=0x0000000000055ff8
...
- (void)switchToggled:(id)arg1;	// IMP=0x0000000000055e66
- (id)initWithStyle:(long long)arg1 reuseIdentifier:(id)arg2;	// IMP=0x0000000000055bf7
