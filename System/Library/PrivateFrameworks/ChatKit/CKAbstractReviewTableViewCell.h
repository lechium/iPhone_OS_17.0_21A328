...
- (void).cxx_destruct;	// IMP=0x000000000000b686
...
- (void)layoutSubviews;	// IMP=0x000000000000abac
@property(retain, nonatomic) NSString *subheadingText;
@property(retain, nonatomic) NSString *mainText;
- (void)prepareForReuse;	// IMP=0x000000000000a93a
- (id)initWithStyle:(long long)arg1 reuseIdentifier:(id)arg2;	// IMP=0x000000000000a58f
