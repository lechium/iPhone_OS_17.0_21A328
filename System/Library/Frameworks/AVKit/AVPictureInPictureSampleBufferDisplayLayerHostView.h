...
+ (Class)layerClass;	// IMP=0x006000000003c35a
- (void).cxx_destruct;	// IMP=0x000000000003c331
...
- (void)_updateGeometryIfNeeded;	// IMP=0x000000000003bc01
- (void)layoutSubviews;	// IMP=0x000000000003ba59
- (void)setFrame:(struct CGRect)arg1 contentDimensions:(struct CGSize)arg2 imageQueueSize:(struct CGSize)arg3;	// IMP=0x000000000003b8c7
@property(nonatomic) double beginTime;
@property(nonatomic) unsigned int contextId;
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000003b614
