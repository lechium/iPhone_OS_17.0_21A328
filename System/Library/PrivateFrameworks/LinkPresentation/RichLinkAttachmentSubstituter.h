...
- (void).cxx_destruct;	// IMP=0x00000000000a09a2
...
- (id)unarchiver:(id)arg1 didDecodeObject:(id)arg2;	// IMP=0x00000000000a0900
- (id)applyAttachmentSubstitutionForObject:(id)arg1;	// IMP=0x00000000000a01ce
- (id)archiver:(id)arg1 willEncodeObject:(id)arg2;	// IMP=0x000000000009fde2
- (id)init;	// IMP=0x000000000009fd56
