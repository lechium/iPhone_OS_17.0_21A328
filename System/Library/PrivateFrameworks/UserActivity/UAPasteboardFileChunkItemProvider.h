...
- (void).cxx_destruct;	// IMP=0x000000000001e046
...
- (void)getDataWithCompletionBlock:(CDUnknownBlockType)arg1;	// IMP=0x000000000001d929
- (id)initWithType:(id)arg1 fileHandle:(id)arg2 offsetInFile:(id)arg3 size:(long long)arg4;	// IMP=0x000000000001d826
