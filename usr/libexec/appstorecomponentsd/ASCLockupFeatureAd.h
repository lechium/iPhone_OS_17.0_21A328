...
+ (_Bool)supportsSecureCoding;	// IMP=0x002000000000e3b2
- (void).cxx_destruct;	// IMP=0x002000000000eee5
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000000e8d8
@property(readonly) unsigned long long hash;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000000e756
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000000e5c5
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000000e3ba
- (id)initWithEditorsChoice:(_Bool)arg1 productRating:(float)arg2 productRatingBadge:(id)arg3 productDescription:(id)arg4 screenshots:(id)arg5 trailers:(id)arg6 developerName:(id)arg7;	// IMP=0x001000000000e25f
