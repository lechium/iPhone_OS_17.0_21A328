...
- (void).cxx_destruct;	// IMP=0x0000000000088328
...
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000088003
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000087ff8
- (id)description;	// IMP=0x0000000000087dec
@property(readonly) NSDate *expirationDate;
@property(readonly) NSDate *creationDate; // @synthesize creationDate;
- (id)initWithName:(id)arg1 value:(id)arg2 domain:(id)arg3;	// IMP=0x0000000000087baf
