...
@interface _TtC7NewsUI243TodayFeedWithSmallCarouselAdsScrollTestCase : NSObject
{
...
- (void).cxx_destruct;	// IMP=0x00000000000e1c90
- (id)init;	// IMP=0x00000000000e1c40
- (id)scrollViewWithContext:(id)arg1;	// IMP=0x00000000000e1de0
