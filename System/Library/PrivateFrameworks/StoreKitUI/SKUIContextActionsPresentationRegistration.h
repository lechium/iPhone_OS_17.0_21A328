...
- (void).cxx_destruct;	// IMP=0x00000000000e7817
...
- (void)_presentFromGestureRecognizer:(id)arg1;	// IMP=0x00000000000e754f
- (void)longPressGestureRecognizerTriggered:(id)arg1;	// IMP=0x00000000000e7414
- (void)cleanupPreviewInteraction:(id)arg1;	// IMP=0x00000000000e72e8
- (void)previewInteractionDidCancel:(id)arg1;	// IMP=0x00000000000e7246
- (void)previewInteraction:(id)arg1 didUpdatePreviewTransition:(double)arg2 ended:(_Bool)arg3;	// IMP=0x00000000000e6fc7
- (_Bool)previewInteractionShouldBegin:(id)arg1;	// IMP=0x00000000000e5a2e
- (void)dealloc;	// IMP=0x00000000000e59a5
- (id)initWithViewController:(id)arg1 handler:(CDUnknownBlockType)arg2;	// IMP=0x00000000000e58b7
