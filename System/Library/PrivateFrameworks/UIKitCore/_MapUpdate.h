...
+ (id)itemMoveFromIndexIndexPath:(id)arg1 toIndexPath:(id)arg2 fromIndex:(long long)arg3 toIndex:(long long)arg4;	// IMP=0x00600000004b0c3b
+ (id)itemMoveSection:(long long)arg1 toSection:(long long)arg2 fromRange:(struct _NSRange)arg3 toRange:(struct _NSRange)arg4;	// IMP=0x00600000004b0b87
+ (id)itemDeleteItemAtIndexPath:(id)arg1 index:(long long)arg2;	// IMP=0x00600000004b0acb
+ (id)itemDeleteSection:(long long)arg1 deleteRange:(struct _NSRange)arg2;	// IMP=0x00600000004b0a41
+ (id)itemInsertItemAtIndexPath:(id)arg1 index:(long long)arg2;	// IMP=0x00600000004b0985
+ (id)itemInsertSection:(long long)arg1 insertRange:(struct _NSRange)arg2;	// IMP=0x00600000004b08fb
- (void).cxx_destruct;	// IMP=0x00000000004b1300
...
- (id)reverseUpdateItem;	// IMP=0x00000000004b0eb7
- (id)description;	// IMP=0x00000000004b0d4c
