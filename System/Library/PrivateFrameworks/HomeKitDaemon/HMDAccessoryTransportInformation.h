...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000004db511
- (void).cxx_destruct;	// IMP=0x00000000004db4ad
...
- (id)attributeDescriptions;	// IMP=0x00000000004db29a
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000004db1c8
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000004dafb7
- (id)report;	// IMP=0x00000000004dadc8
...
- (id)initWithServerIdentifier:(id)arg1 instanceID:(id)arg2 linkType:(long long)arg3;	// IMP=0x00000000004da930
