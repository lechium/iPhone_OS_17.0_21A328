...
+ (id)descriptionWithVelocity:(id)arg1 targetVelocity:(id)arg2;	// IMP=0x00600000015b20c0
- (void).cxx_destruct;	// IMP=0x00000000015b2164
...
- (id)initWithVelocity:(id)arg1 targetVelocity:(id)arg2;	// IMP=0x00000000015b2027
