...
+ (void)forceSandboxForBundleIdentifier:(id)arg1 untilDate:(id)arg2;	// IMP=0x00200000001aa5ac
+ (void)initialize;	// IMP=0x00100000001aa57e
...
- (id)description;	// IMP=0x00100000001aad4b
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000001aac4b
- (void)setValuesWithSoftwareApplicationProxy:(id)arg1;	// IMP=0x00100000001aa9be
- (void)setValuesWithPaymentQueueClient:(id)arg1;	// IMP=0x00100000001aa7fe
- (void)dealloc;	// IMP=0x00100000001aa791
