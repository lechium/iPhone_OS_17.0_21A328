...
- (void).cxx_destruct;	// IMP=0x000000000025d8a9
...
- (void)adoptNewLayout;	// IMP=0x000000000025d744
- (void)adoptLayout:(id)arg1;	// IMP=0x000000000025d659
- (void)clearTransitionContext;	// IMP=0x000000000025d5f0
- (void)finalizeStateFromTransition:(id)arg1;	// IMP=0x000000000025d5ea
- (void)ensureBackButtonTruncationOccursWithContext:(id)arg1;	// IMP=0x000000000025d5e4
- (void)recordToStateForTransition:(id)arg1;	// IMP=0x000000000025d549
- (void)prepareToRecordToState:(id)arg1;	// IMP=0x000000000025d4c7
- (void)recordFromStateForTransition:(id)arg1;	// IMP=0x000000000025d426
- (void)pointerInteraction:(id)arg1 willExitRegion:(id)arg2 animator:(id)arg3;	// IMP=0x000000000025d3a7
- (void)pointerInteraction:(id)arg1 willEnterRegion:(id)arg2 animator:(id)arg3;	// IMP=0x000000000025d328
- (id)pointerInteraction:(id)arg1 styleForRegion:(id)arg2;	// IMP=0x000000000025d278
- (id)pointerInteraction:(id)arg1 regionForRequest:(id)arg2 defaultRegion:(id)arg3;	// IMP=0x000000000025d086
- (void)_clearAssistants;	// IMP=0x000000000025cfcf
- (void)_setAssistants;	// IMP=0x000000000025cf4e
- (void)_contentSizeCategoryDidChange;	// IMP=0x000000000025cf11
- (void)updateContent;	// IMP=0x000000000025cefa
- (void)_updateContentAndInvalidate:(_Bool)arg1;	// IMP=0x000000000025cb13
- (void)safeAreaInsetsDidChange;	// IMP=0x000000000025c9e4
- (id)_effectiveTitle;	// IMP=0x000000000025c976
- (id)_titleForCurrentWidth;	// IMP=0x000000000025c2fe
- (void)layoutSubviews;	// IMP=0x000000000025c20e
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x000000000025c1f1
- (struct CGSize)sizeThatFits:(struct CGSize)arg1 titleType:(long long)arg2;	// IMP=0x000000000025c179
- (struct CGSize)intrinsicContentSize;	// IMP=0x000000000025c128
@property(readonly, nonatomic) double restingHeightOfTitleView;
- (id)_layoutForMeasurement;	// IMP=0x000000000025c058
...
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000025bb97
- (id)_newLayout;	// IMP=0x000000000025bb69
