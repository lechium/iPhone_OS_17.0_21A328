...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000051d84
- (void).cxx_destruct;	// IMP=0x0000000000052eae
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000052620
@property(readonly) unsigned long long hash;
- (id)offerWithMetrics:(id)arg1;	// IMP=0x00000000000522a6
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000005229b
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000005208f
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000051d8c
- (id)initWithID:(id)arg1 titles:(id)arg2 subtitles:(id)arg3 flags:(long long)arg4 ageRating:(id)arg5 metrics:(id)arg6 defaultOffer:(id)arg7 buyOffer:(id)arg8 openOffer:(id)arg9;	// IMP=0x0000000000051bd2
