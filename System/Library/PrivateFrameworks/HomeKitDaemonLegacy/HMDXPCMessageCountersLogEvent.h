...
+ (id)XPCMessageCountersLogEventWithType:(id)arg1 peerInformation:(id)arg2 messageName:(id)arg3 count:(id)arg4;	// IMP=0x00600000003092c2
- (void).cxx_destruct;	// IMP=0x000000000030926f
...
- (_Bool)shouldSubmit;	// IMP=0x00000000003091dc
- (id)__initWithType:(id)arg1 peerInformation:(id)arg2 messageName:(id)arg3 count:(id)arg4;	// IMP=0x00000000003090ac
