...
- (_Bool)_sf_isPresentationControllerDismissalTransitionDidEndNotification:(id)arg1;	// IMP=0x00300000000a8390
...
- (void)_sf_animateAlongsideTransitionOrPerform:(CDUnknownBlockType)arg1;	// IMP=0x00300000000a8136
- (void)_sf_presentViewControllerOnTopOfPresentedViewController:(id)arg1 animated:(_Bool)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x00300000000a800d
...
- (void)safari_dismissPresentedAlert;	// IMP=0x00300000000a7e3f
- (_Bool)safari_isEventuallyPresentedByViewControllerClass:(Class)arg1;	// IMP=0x00300000000a7d81
...
- (void)safari_updateApplicationBackgroundStyle;	// IMP=0x00300000000a7b75
