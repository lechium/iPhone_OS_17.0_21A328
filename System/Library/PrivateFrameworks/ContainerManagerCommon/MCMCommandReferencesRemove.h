...
+ (Class)incomingMessageClass;	// IMP=0x0010000000030044
+ (unsigned long long)command;	// IMP=0x001000000003000e
- (void).cxx_destruct;	// IMP=0x000000000002ff65
...
- (void)execute;	// IMP=0x000000000002f43c
- (_Bool)preflightClientAllowed;	// IMP=0x000000000002f3a8
- (id)initWithMessage:(id)arg1 context:(id)arg2 reply:(id)arg3;	// IMP=0x000000000002f271
