...
- (void).cxx_destruct;	// IMP=0x00000000002212c9
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000002210ff
- (id)initWithRequestClass:(Class)arg1;	// IMP=0x0000000000221039
