...
- (void).cxx_destruct;	// IMP=0x0000000000037eb9
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000037d80
- (id)initWithRequestClass:(Class)arg1;	// IMP=0x0000000000037d00
