...
- (void).cxx_destruct;	// IMP=0x00000000001c9886
...
- (id)_sourceInfo;	// IMP=0x00000000001c94bd
- (id)initWithBrowserController:(id)arg1 barItem:(long long)arg2;	// IMP=0x00000000001c9420
