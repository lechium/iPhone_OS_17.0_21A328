...
- (void).cxx_destruct;	// IMP=0x0020000000060a62
...
- (id)resource;	// IMP=0x001000000006088b
- (id)initWithResource:(id)arg1;	// IMP=0x00100000000606a4
- (id)initFromPQLResultSet:(id)arg1 error:(id *)arg2;	// IMP=0x0010000000060526
