...
- (void).cxx_destruct;	// IMP=0x0000000000bc020f
...
- (id)attributeDescriptions;	// IMP=0x0000000000bc00dd
- (id)initWithSession:(id)arg1 payload:(id)arg2;	// IMP=0x0000000000bc0044
