...
- (void).cxx_destruct;	// IMP=0x00200000000beddd
...
- (_Bool)areEquivalent:(struct SecDbItem *)arg1 ckksItem:(id)arg2 keyCache:(id)arg3;	// IMP=0x00100000000be721
- (void)main;	// IMP=0x00100000000bd535
- (void)retriggerMissingMirrorEntries:(id)arg1 databaseProvider:(id)arg2;	// IMP=0x00100000000bd41f
- (void)fixUUIDlessItemsInZone:(id)arg1 primaryKeys:(id)arg2 databaseProvider:(id)arg3;	// IMP=0x00100000000bd24b
- (void)onboardItemsInView:(id)arg1 uuids:(id)arg2 itemClass:(id)arg3 databaseProvider:(id)arg4;	// IMP=0x00100000000bcf30
- (_Bool)onboardItemToCKKS:(struct SecDbItem *)arg1 viewState:(id)arg2 keyCache:(id)arg3 error:(id *)arg4;	// IMP=0x00100000000bcb47
- (_Bool)executeQuery:(id)arg1 readWrite:(_Bool)arg2 error:(id *)arg3 block:(CDUnknownBlockType)arg4;	// IMP=0x00100000000bc833
- (id)queryPredicatesForViewMapping:(id)arg1;	// IMP=0x00100000000bbbef
- (id)initWithDependencies:(id)arg1 intending:(id)arg2 errorState:(id)arg3 ckoperationGroup:(id)arg4;	// IMP=0x00100000000bbaae
- (id)init;	// IMP=0x00100000000bbaa0
