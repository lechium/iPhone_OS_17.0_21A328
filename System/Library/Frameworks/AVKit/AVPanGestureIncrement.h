...
+ (id)gestureIncrementWithTranslation:(struct CGPoint)arg1 velocity:(struct CGPoint)arg2 timestamp:(double)arg3 hasMultipleTouches:(_Bool)arg4;	// IMP=0x00600000000736bd
...
- (id)debugDescription;	// IMP=0x0000000000073640
