...
+ (_Bool)_shouldDefaultToTouches;	// IMP=0x0060000001361e5a
- (void).cxx_destruct;	// IMP=0x0000000001361fd0
...
- (void)touchesCancelled:(id)arg1 withEvent:(id)arg2;	// IMP=0x0000000001361e27
- (void)touchesEnded:(id)arg1 withEvent:(id)arg2;	// IMP=0x0000000001361d62
- (void)touchesMoved:(id)arg1 withEvent:(id)arg2;	// IMP=0x00000000013619e7
- (void)touchesBegan:(id)arg1 withEvent:(id)arg2;	// IMP=0x000000000136178f
- (void)clearIgnoreTouch;	// IMP=0x0000000001361735
- (void)tooSlow:(id)arg1;	// IMP=0x0000000001361702
- (void)clearTimer;	// IMP=0x00000000013616ca
- (void)_resetGestureRecognizer;	// IMP=0x0000000001361675
- (void)dealloc;	// IMP=0x0000000001361613
- (id)initWithTarget:(id)arg1 action:(SEL)arg2;	// IMP=0x0000000001361573
