...
+ (long long)content_typeForImmutableObject:(id)arg1;	// IMP=0x00100000001781ab
+ (Class)content_immutableClassForType:(long long)arg1;	// IMP=0x0010000000178171
- (void).cxx_destruct;	// IMP=0x0000000000178a91
- (id)flatbuffData;	// IMP=0x000000000017890a
- (Offset_3f5da55c)addObjectToBuffer:(void *)arg1;	// IMP=0x00000000001783aa
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001776cd
- (id)initWithFlatbuffData:(id)arg1 root:(const struct RecognitionStreamingRequest *)arg2 verify:(_Bool)arg3;	// IMP=0x00000000001774ea
- (id)initWithFlatbuffData:(id)arg1 root:(const struct RecognitionStreamingRequest *)arg2;	// IMP=0x00000000001774d5
- (id)initAndVerifyWithFlatbuffData:(id)arg1;	// IMP=0x00000000001774bb
- (id)initWithFlatbuffData:(id)arg1;	// IMP=0x00000000001774a4
