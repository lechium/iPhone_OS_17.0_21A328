...
+ (id)entityName;	// IMP=0x004000000013de34
- (id)internalRepresentation;	// IMP=0x002000000013e25f
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x001000000013de41
