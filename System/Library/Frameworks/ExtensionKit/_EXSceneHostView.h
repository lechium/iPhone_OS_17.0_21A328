...
- (void).cxx_destruct;	// IMP=0x0000000000002cd4
...
- (void)layoutSubviews;	// IMP=0x0000000000002b58
- (void)creatScene;	// IMP=0x00000000000022c3
- (id)initWithExtensionProcess:(id)arg1 sessionUUID:(id)arg2 role:(id)arg3;	// IMP=0x00000000000021c0
