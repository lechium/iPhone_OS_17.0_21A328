...
- (void).cxx_destruct;	// IMP=0x0020000000044d53
...
- (id)_fullBuyParametersWithAppProxy:(id)arg1;	// IMP=0x0010000000044352
- (id)_appProxy;	// IMP=0x0010000000043f13
- (void)run;	// IMP=0x0010000000043271
- (_Bool)purchaseOperation:(id)arg1 shouldContinueWithNewStorefront:(id)arg2;	// IMP=0x0010000000043189
...
- (void)setClientAuditTokenData:(id)arg1;	// IMP=0x0010000000042e56
...
- (id)clientAuditTokenData;	// IMP=0x0010000000042a99
