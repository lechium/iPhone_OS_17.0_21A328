...
@class NSPredicate, NSSet, _TtC9appstored6LogKey;
@protocol LibraryCatalogObserver;

@protocol LibraryCatalog <NSObject>
@property __weak id <LibraryCatalogObserver> observer;
- (void)executeQueryForUpdatesReloadingFromServer:(_Bool)arg1 logKey:(_TtC9appstored6LogKey *)arg2 usingBlock:(void (^)(NSArray *, NSError *))arg3;
