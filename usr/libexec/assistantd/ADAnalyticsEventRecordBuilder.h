...
- (void).cxx_destruct;	// IMP=0x00200000001289ff
- (id)build;	// IMP=0x00100000001287c1
- (void)setValue:(id)arg1 forColumnName:(id)arg2;	// IMP=0x001000000012864d
- (void)reset;	// IMP=0x00100000001285c7
