...
- (void).cxx_destruct;	// IMP=0x00000000004aab14
...
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x00000000004aaa30
- (id)hitTest:(struct CGPoint)arg1 withEvent:(id)arg2;	// IMP=0x00000000004aa800
