...
- (void).cxx_destruct;	// IMP=0x000000000001e6f5
...
- (void)reset;	// IMP=0x000000000001e631
- (double)nextSleepTimeInterval;	// IMP=0x000000000001e54f
- (id)initWithBaseSleepTimeInterval:(double)arg1 maxSleepTimeInterval:(double)arg2;	// IMP=0x000000000001e4d3
