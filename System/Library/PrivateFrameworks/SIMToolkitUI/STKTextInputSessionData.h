...
- (id)initWithXPCDictionary:(id)arg1;	// IMP=0x00000000000100a4
- (void)encodeWithXPCDictionary:(id)arg1;	// IMP=0x000000000000ffc7
- (id)initWithText:(id)arg1 simLabel:(id)arg2;	// IMP=0x000000000000ff75
