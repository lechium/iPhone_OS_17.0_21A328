...
- (void).cxx_destruct;	// IMP=0x00000000000436b2
...
- (_Bool)shouldEnableRestriction:(id)arg1;	// IMP=0x000000000004343c
- (id)defaultValueForRestriction:(id)arg1;	// IMP=0x0000000000043326
- (id)visibleRestrictionWithConfiguration:(id)arg1 key:(id)arg2;	// IMP=0x0000000000043178
- (id)init;	// IMP=0x00000000000430fd
