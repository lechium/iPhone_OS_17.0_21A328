...
+ (id)decodedNamedLayerStackWithImage:(id)arg1 size:(struct CGSize)arg2 cornerRadius:(double)arg3;	// IMP=0x001000000000da98
+ (id)namedLayerStackWithImage:(id)arg1;	// IMP=0x001000000000d6ef
...
- (id)_init;	// IMP=0x000000000000d6c0
- (id)init;	// IMP=0x000000000000d6b2
