...
- (void).cxx_destruct;	// IMP=0x002000000006f689
...
- (id)description;	// IMP=0x001000000006f605
- (void)_processDictionary:(id)arg1 addedPrivateEmails:(id *)arg2 removedPrivateEmails:(id *)arg3;	// IMP=0x001000000006f3f9
- (id)initWithResponseBody:(id)arg1;	// IMP=0x001000000006ef7b
