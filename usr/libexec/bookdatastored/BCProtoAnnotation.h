...
- (void).cxx_destruct;	// IMP=0x0020000000080271
...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000007fb3d
- (unsigned long long)hash;	// IMP=0x001000000007f1e6
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000007ebfd
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000007e769
- (void)copyTo:(id)arg1;	// IMP=0x001000000007e3b5
- (void)writeTo:(id)arg1;	// IMP=0x001000000007dfc5
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000007dfb8
- (id)dictionaryRepresentation;	// IMP=0x001000000007ce64
- (id)description;	// IMP=0x001000000007cdb5
@property(nonatomic) _Bool hasLocationModificationDate;
@property(readonly, nonatomic) _Bool hasPlUserData;
- (_Bool);	// IMP=0x001000000007cd43
