...
- (void).cxx_destruct;	// IMP=0x0000000000097198
@property(readonly, nonatomic) SKUIDownloadsCellView *cellView; // @synthesize cellView=_cellView;
- (void)layoutSubviews;	// IMP=0x00000000000970dd
- (id)initWithStyle:(long long)arg1 reuseIdentifier:(id)arg2;	// IMP=0x0000000000096fcf
