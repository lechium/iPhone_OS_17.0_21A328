...
- (void).cxx_destruct;	// IMP=0x00100000001d5773
...
- (_Bool)shows;	// IMP=0x00100000001d5667
...
- (id)initWithSearchResult:(id)arg1;	// IMP=0x00100000001d53d0
- (id)initWithMapItem:(id)arg1 title:(id)arg2;	// IMP=0x00100000001d521d
- (id)leafPersonalizedAutocompleteItems;	// IMP=0x00100000001d59aa
