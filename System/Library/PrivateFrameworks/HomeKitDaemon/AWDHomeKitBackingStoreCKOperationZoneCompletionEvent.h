...
- (void).cxx_destruct;	// IMP=0x00000000008d21ff
@property(retain, nonatomic) NSString *errorDomain; // @synthesize errorDomain=_errorDomain;
@property(nonatomic) long long errorCode; // @synthesize errorCode=_errorCode;
@property(nonatomic) _Bool didSucceed; // @synthesize didSucceed=_didSucceed;
@property(nonatomic) unsigned long long timestamp; // @synthesize timestamp=_timestamp;
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000008d20d5
- (unsigned long long)hash;	// IMP=0x00000000008d2019
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000008d1eb6
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000008d1dac
- (void)copyTo:(id)arg1;	// IMP=0x00000000008d1cd9
- (void)writeTo:(id)arg1;	// IMP=0x00000000008d1be8
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000008d17aa
- (id)dictionaryRepresentation;	// IMP=0x00000000008d1551
- (id)description;	// IMP=0x00000000008d14a2
@property(readonly, nonatomic) _Bool hasErrorDomain;
- (int)StringAsZoneType:(id)arg1;	// IMP=0x00000000008d139b
- (id)zoneTypeAsString:(int)arg1;	// IMP=0x00000000008d1353
@property(nonatomic) _Bool hasZoneType;
@property(nonatomic) int zoneType; // @synthesize zoneType=_zoneType;
- (int)StringAsContainerType:(id)arg1;	// IMP=0x00000000008d1235
- (id)containerTypeAsString:(int)arg1;	// IMP=0x00000000008d11ed
