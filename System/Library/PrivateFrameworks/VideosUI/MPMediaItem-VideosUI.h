...
+ (_Bool)_vui_isNetworkPlayableWithPropertyValues:(id)arg1;	// IMP=0x002000000015d170
+ (_Bool)_vui_isLocalWithPropertyValues:(id)arg1;	// IMP=0x002000000015d0a8
+ (id)vui_mediaItemForStoreIdentifier:(id)arg1;	// IMP=0x002000000015cea0
+ (id)vui_mediaItemForStoreIdentifierString:(id)arg1;	// IMP=0x002000000015cdf0
+ (id)vui_mediaItemForPersistentIdentifier:(id)arg1;	// IMP=0x002000000015ccd8
+ (unsigned long long)vui_VUIMediaEntityAudioCapabilityFromMPMediaItemAudioCapability:(long long)arg1;	// IMP=0x002000000015cccc
+ (long long)vui_MPMediaItemAudioCapabilityFromVUIMediaEntityAudioCapability:(unsigned long long)arg1;	// IMP=0x002000000015ccc0
+ (unsigned long long)vui_VUIMediaEntityColorCapabilityFromMPMediaItemColorCapability:(long long)arg1;	// IMP=0x002000000015ccb4
+ (long long)vui_MPMediaItemColorCapabilityFromVUIMediaEntityColorCapability:(unsigned long long)arg1;	// IMP=0x002000000015cca8
+ (unsigned long long)vui_VUIMediaEntityResolutionFromMPMediaItemVideoQuality:(long long)arg1;	// IMP=0x002000000015cc94
+ (long long)vui_MPMediaItemVideoQualityFromVUIMediaEntityResolution:(unsigned long long)arg1;	// IMP=0x002000000015cc80
- (id)_vui_imageIdentifierWithImageType:(unsigned long long)arg1;	// IMP=0x001000000015d260
- (id)vui_imageLoadParamsWithImageType:(unsigned long long)arg1;	// IMP=0x001000000015d01e
- (id)vui_artworkCatalogWithImageType:(unsigned long long)arg1;	// IMP=0x001000000015cfeb
- (id)vui_imageIdentifierWithImageType:(unsigned long long)arg1;	// IMP=0x001000000015cfb8
...
- (id)vui_assetTypeIgnoringLocalAsset:(_Bool)arg1;	// IMP=0x001000000015c914
...
- (id)vui_isLocalCheckingSidebandLibrary:(_Bool)arg1;	// IMP=0x001000000015bfa9
