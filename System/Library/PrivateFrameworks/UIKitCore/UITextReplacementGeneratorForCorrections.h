...
- (void).cxx_destruct;	// IMP=0x00000000013c76c7
...
- (id)replacements;	// IMP=0x00000000013c6cc6
- (void)addSpellingGuessesForString:(id)arg1 ToReplacements:(id)arg2;	// IMP=0x00000000013c66c1
- (void)addAutocorrectionGuessesToReplacements:(id)arg1;	// IMP=0x00000000013c6308
- (void)addPreviouslySuggestedAutocorrectionToReplacements:(id)arg1;	// IMP=0x00000000013c6129
- (id)addReplacementRevertingAutocorrectionToReplacements:(id)arg1;	// IMP=0x00000000013c5f3b
- (_Bool)isStringToReplaceMisspelled;	// IMP=0x00000000013c5eea
- (_Bool)isStringMisspelled:(id)arg1;	// IMP=0x00000000013c5ddd
- (id)init;	// IMP=0x00000000013c5d94
