...
- (void).cxx_destruct;	// IMP=0x0000000000214bc4
...
- (void)itemStateCenter:(id)arg1 itemStateChanged:(id)arg2;	// IMP=0x00000000002147d6
- (id)_toggledLayout;	// IMP=0x0000000000214758
- (id)_titleAttributes;	// IMP=0x00000000002144de
- (void)_showToggleState:(_Bool)arg1;	// IMP=0x0000000000214272
- (void)_sendWillAnimate;	// IMP=0x00000000002141e8
- (void)_sendDidAnimate;	// IMP=0x000000000021415e
- (id)_nonToggledLayout;	// IMP=0x00000000002140e0
- (id)_layoutForString:(id)arg1;	// IMP=0x0000000000213fc8
- (void)setButtonTitleText:(id)arg1;	// IMP=0x0000000000213f1e
- (void)touchesEnded:(id)arg1 withEvent:(id)arg2;	// IMP=0x0000000000213c68
- (void)setToggled:(_Bool)arg1 animated:(_Bool)arg2;	// IMP=0x0000000000213c4a
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x0000000000213aad
- (void)dealloc;	// IMP=0x0000000000213a38
- (id)init;	// IMP=0x0000000000213967
