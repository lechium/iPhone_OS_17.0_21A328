...
- (void).cxx_destruct;	// IMP=0x002000000013551e
...
- (id)_copyWithZone:(struct _NSZone *)arg1 usingConcreteClass:(Class)arg2;	// IMP=0x0010000000135416
- (id)_optionsDictionary;	// IMP=0x001000000013538c
- (void)_setCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x001000000013535f
- (CDUnknownBlockType)_completionHandler;	// IMP=0x0010000000135349
- (id)optionValueForKey:(struct __CFString *)arg1;	// IMP=0x00100000001352ea
...
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000134cec
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000134cc0
- (id)debugDescription;	// IMP=0x0010000000134b74
- (id)description;	// IMP=0x0010000000134a61
- (id)initWithCommandType:(unsigned int)arg1 playerPath:(id)arg2 unresolvedPlayerPath:(id)arg3 senderAppDisplayID:(id)arg4 optionsData:(id)arg5;	// IMP=0x00100000001348e3
