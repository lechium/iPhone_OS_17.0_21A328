...
- (void).cxx_destruct;	// IMP=0x000000000010e728
...
- (void)computeOnCPUWithInputTensors:(id)arg1 outputTensors:(id)arg2;	// IMP=0x000000000010de01
- (_Bool)hasGPUSupport;	// IMP=0x000000000010ddf9
- (id)initWithParameters:(id)arg1;	// IMP=0x000000000010db84
- (id)setupForInputShapes:(id)arg1 withParameters:(id)arg2;	// IMP=0x000000000010d879
