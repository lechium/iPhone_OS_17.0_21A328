...
+ (id)dmc_createManagementAccountWithStore:(id)arg1;	// IMP=0x0020000000001d19
- (_Bool)dmc_isAccountSchemeSharediPad;	// IMP=0x0010000000002b4e
- (id)dmc_accountQuotaString;	// IMP=0x00100000000025c3
- (_Bool)dmc_isPrimaryAccount;	// IMP=0x0010000000002578
- (_Bool)dmc_isVisibleRemoteManagementAccount;	// IMP=0x00100000000024ec
