...
- (void).cxx_destruct;	// IMP=0x0000000000f25416
...
- (void)_updateCircleBackgroundImage;	// IMP=0x0000000000f251f6
- (void)updateFromQuickAction;	// IMP=0x0000000000f24ea4
- (id)centerYAnchor;	// IMP=0x0000000000f24dda
- (void)layoutSubviews;	// IMP=0x0000000000f24d99
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000f24d44
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000f24605
