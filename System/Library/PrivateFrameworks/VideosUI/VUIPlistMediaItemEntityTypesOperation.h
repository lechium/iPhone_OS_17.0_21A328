...
- (void).cxx_destruct;	// IMP=0x00000000002671f2
...
- (void)executionDidBegin;	// IMP=0x0000000000266e1c
- (id)initWithDatabase:(id)arg1;	// IMP=0x0000000000266d7b
- (id)init;	// IMP=0x0000000000266d0c
