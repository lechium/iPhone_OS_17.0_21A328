...
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x0000000000010238
- (void)endObservingTerminal;	// IMP=0x00000000000101de
- (void)beginObservingTerminal;	// IMP=0x000000000001017e
- (void)invalidateWithError:(id)arg1;	// IMP=0x000000000001000a
- (void)broadcastTerminalNeedsToDismissPin:(id)arg1;	// IMP=0x000000000000ff1e
- (void)broadcastTerminal:(id)arg1 needsToDisplayPin:(id)arg2;	// IMP=0x000000000000fda5
- (void)broadcastTerminal:(id)arg1 hasPairedDeviceConnection:(id)arg2;	// IMP=0x000000000000fbd0
- (void)broadcastTerminal:(id)arg1 stoppedWithError:(id)arg2;	// IMP=0x000000000000fb07
- (void)broadcastTerminal:(id)arg1 hasError:(id)arg2;	// IMP=0x000000000000f9a5
- (void)broadcastTerminal:(id)arg1 didActivateWithError:(id)arg2;	// IMP=0x000000000000f8e0
- (void)invalidate;	// IMP=0x000000000000f873
- (void)startBroadcasting;	// IMP=0x000000000000f7d9
- (id)initWithPrimitives:(id)arg1;	// IMP=0x000000000000f731
- (void)dealloc;	// IMP=0x000000000000f6f3
