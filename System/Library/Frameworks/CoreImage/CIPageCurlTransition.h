...
+ (id)customAttributes;	// IMP=0x0060000000134b67
...
- (id)outputImage;	// IMP=0x0000000000132ddc
- (id)_CIPageCurlTransNoEmap;	// IMP=0x0000000000132dbc
- (id)_CIPageCurlTransition;	// IMP=0x0000000000132d9c
