...
- (void).cxx_destruct;	// IMP=0x00000000001357c7
...
- (void)didToggleEnabledSwitch:(id)arg1;	// IMP=0x00000000001356fd
- (void)didSelectItemAtIndex:(unsigned long long)arg1;	// IMP=0x00000000001356f7
- (id)itemForIndex:(unsigned long long)arg1;	// IMP=0x00000000001356e1
- (unsigned long long)numberOfItems;	// IMP=0x00000000001356cb
- (id)sectionFooterLabel;	// IMP=0x00000000001356c3
- (id)sectionHeaderLabel;	// IMP=0x00000000001356bb
- (void)buildItems;	// IMP=0x00000000001355c2
- (_Bool)supportsSelection;	// IMP=0x00000000001355ba
- (id)initWithSharingEnabled:(_Bool)arg1;	// IMP=0x00000000001354a8
