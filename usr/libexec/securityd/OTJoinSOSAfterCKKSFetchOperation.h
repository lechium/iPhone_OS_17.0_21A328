...
- (void).cxx_destruct;	// IMP=0x0020000000080755
...
- (void)proceedAfterFetch;	// IMP=0x00100000000801fb
- (void)groupStart;	// IMP=0x001000000007ff00
- (id)initWithDependencies:(id)arg1 intendedState:(id)arg2 errorState:(id)arg3;	// IMP=0x001000000007fe36
