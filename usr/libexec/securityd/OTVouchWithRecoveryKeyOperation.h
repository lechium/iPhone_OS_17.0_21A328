...
- (void).cxx_destruct;	// IMP=0x00200000000db7b3
...
- (void)proceedWithFilteredTLKShares:(id)arg1;	// IMP=0x00100000000db4a2
- (void)proceedWithRecoveryKeyID:(id)arg1;	// IMP=0x00100000000db335
- (void)groupStart;	// IMP=0x00100000000daf1d
- (id)initWithDependencies:(id)arg1 intendedState:(id)arg2 errorState:(id)arg3 recoveryKey:(id)arg4 saveVoucher:(_Bool)arg5;	// IMP=0x00100000000dae0d
