...
- (void).cxx_destruct;	// IMP=0x000000000003e41f
...
- (_Bool)isEqualToConfiguration:(id)arg1;	// IMP=0x000000000003e3a3
- (void)_parseConfiguration:(id)arg1;	// IMP=0x000000000003e118
- (id)_currentRegionCode;	// IMP=0x000000000003e0c1
- (void)_configureToBeOff;	// IMP=0x000000000003e0b1
- (void)_configureToUseDefaultValues;	// IMP=0x000000000003e0a1
- (id)initWithConfiguration:(id)arg1;	// IMP=0x000000000003dfde
- (id)init;	// IMP=0x000000000003dfd0
