...
- (void).cxx_destruct;	// IMP=0x000000000004619e
...
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x0000000000046080
- (double)preferredHeightForWidth:(double)arg1;	// IMP=0x0000000000046052
- (void)dealloc;	// IMP=0x000000000004601c
- (id)initWithSpecifier:(id)arg1;	// IMP=0x00000000000455d1
