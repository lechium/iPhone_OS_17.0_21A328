...
- (void).cxx_destruct;	// IMP=0x0020000000176827
...
- (unsigned long long)hash;	// IMP=0x0010000000176635
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000017656b
- (id)description;	// IMP=0x0010000000176473
- (void)dealloc;	// IMP=0x00100000001763bc
- (id)initWithDictRepresentation:(id)arg1;	// IMP=0x00100000001761dd
