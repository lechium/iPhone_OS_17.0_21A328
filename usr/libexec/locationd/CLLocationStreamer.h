...
+ (_Bool)isSupported;	// IMP=0x00200000004e3de2
+ (id)getSilo;	// IMP=0x00100000004e3d86
+ (void)performSyncOnSilo:(id)arg1 invoker:(CDUnknownBlockType)arg2;	// IMP=0x00100000004e3d6d
+ (void)becameFatallyBlocked:(id)arg1 index:(unsigned long long)arg2;	// IMP=0x00100000004e3d10
- (id).cxx_construct;	// IMP=0x00200000004e6abd
- (void).cxx_destruct;	// IMP=0x00100000004e6a2c
...
- (void)pairedDeviceIsNearby:(_Bool)arg1;	// IMP=0x00100000004e67b5
- (void)successfullySentMessage:(id)arg1;	// IMP=0x00100000004e66cf
- (void)failedToSendMessage:(id)arg1 withError:(id)arg2 isFatal:(_Bool)arg3;	// IMP=0x00100000004e65c3
- (void)receivedMessageOfType:(id)arg1 withPayload:(id)arg2;	// IMP=0x00100000004e61bb
- (void)onMotionStateNotification:(const int *)arg1 withData:(const union NotificationData *)arg2;	// IMP=0x00100000004e5eb8
- (void)sendMotionState;	// IMP=0x00100000004e5d08
- (void)stopMotionAlarm;	// IMP=0x00100000004e5bdb
- (void)startMotionAlarm;	// IMP=0x00100000004e5ab6
- (void)reevaluateMotionSubscription;	// IMP=0x00100000004e58d4
- (void)onLocationNotification:(const int *)arg1 withData:(const void *)arg2;	// IMP=0x00100000004e53a3
- (void)startUpdatingLocationWithGranularity:(int)arg1 includeMotion:(_Bool)arg2 inFitnessSession:(_Bool)arg3 inAirborneSession:(_Bool)arg4 emergencyEnablementAssertionActive:(_Bool)arg5 hasMapMatching:(_Bool)arg6;	// IMP=0x00100000004e5054
- (void)stopLocation;	// IMP=0x00100000004e4a65
- (void)unregisterAllLocationNotifications;	// IMP=0x00100000004e49df
- (void)sendAliveAgainMessage;	// IMP=0x00100000004e4848
- (void)endService;	// IMP=0x00100000004e4723
- (void)beginService;	// IMP=0x00100000004e3e87
- (id)init;	// IMP=0x00100000004e3e4a
