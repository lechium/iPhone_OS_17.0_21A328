...
- (void)computeOnCPUWithInputTensors:(id)arg1 outputTensors:(id)arg2;	// IMP=0x00000000000cc007
- (_Bool)hasGPUSupport;	// IMP=0x00000000000cbfff
- (id)initWithParameters:(id)arg1;	// IMP=0x00000000000cbdb6
- (id)setupForInputShapes:(id)arg1 withParameters:(id)arg2;	// IMP=0x00000000000cbab3
