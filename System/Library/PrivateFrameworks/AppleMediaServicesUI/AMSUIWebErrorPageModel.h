...
+ (id)_messageFromError:(id)arg1;	// IMP=0x001000000009aea9
- (void).cxx_destruct;	// IMP=0x000000000009b1a8
...
- (id)loadPage;	// IMP=0x000000000009ae90
@property(readonly, nonatomic) _Bool disableReappearPlaceholder;
- (id)createViewControllerForContainer:(id)arg1;	// IMP=0x000000000009ae1f
@property(readonly, copy) NSString *description;
@property(readonly, nonatomic) NSString *errorMessage; // @synthesize errorMessage=_errorMessage;
- (id)initWithJSObject:(id)arg1 context:(id)arg2;	// IMP=0x000000000009a5f5
- (id)initWithError:(id)arg1 context:(id)arg2 actionBlock:(CDUnknownBlockType)arg3;	// IMP=0x000000000009a292
