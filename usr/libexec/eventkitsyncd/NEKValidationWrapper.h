...
+ (_Bool)validationEnabled;	// IMP=0x002000000001360e
+ (id)validationWrapperForPb:(id)arg1;	// IMP=0x00100000000134d6
+ (id)validationWrapperForSameSpan:(id)arg1;	// IMP=0x0010000000013417
+ (id)validationWrapperForRightNow;	// IMP=0x0010000000013343
- (void).cxx_destruct;	// IMP=0x00200000000141b1
...
- (void)validate;	// IMP=0x0010000000013f75
@property(readonly, copy) NSString *description;
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000013bef
@property(readonly, nonatomic) NSString *sequencer;
@property(readonly, nonatomic) NSString *objectIdentifier;
@property(readonly, nonatomic) long long changeType;
- (void)_countEvents;	// IMP=0x0010000000013616
