...
+ (unsigned long long)maxOperationDurationSeconds;	// IMP=0x001000000000f5aa
+ (unsigned long long)maxRetryCount;	// IMP=0x001000000000f58c
+ (unsigned long long)__integerForPreferenceKey:(id)arg1 defaultValue:(unsigned long long)arg2;	// IMP=0x001000000000f4a8
+ (id)logCategory;	// IMP=0x001000000000f478
- (void).cxx_destruct;	// IMP=0x000000000000f414
...
- (void)finishWithResult:(id)arg1 error:(id)arg2;	// IMP=0x000000000000eff5
- (void)finishWithError:(id)arg1;	// IMP=0x000000000000efde
- (void)finishWithResult:(id)arg1;	// IMP=0x000000000000efca
@property(nonatomic) _Bool shouldRetry;
- (void)dealloc;	// IMP=0x000000000000eac6
- (id)initWithActivity:(id)arg1 options:(id)arg2 container:(id)arg3 useAnonymousRequests:(_Bool)arg4 promise:(id)arg5;	// IMP=0x000000000000e8df
