...
- (void)endEncoding;	// IMP=0x000000000003e96b
- (void)setLabel:(id)arg1;	// IMP=0x000000000003e945
- (void)popDebugGroup;	// IMP=0x000000000003e8d6
- (void)pushDebugGroup:(id)arg1;	// IMP=0x000000000003e8b0
- (void)insertDebugSignpost:(id)arg1;	// IMP=0x000000000003e6ae
- (id)init:(struct BinaryBuffer *)arg1 flags:(unsigned long long)arg2;	// IMP=0x000000000003e650
