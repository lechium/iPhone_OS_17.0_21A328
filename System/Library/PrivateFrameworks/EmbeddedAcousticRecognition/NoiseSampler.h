...
- (id).cxx_construct;	// IMP=0x0000000000067e48
- (void).cxx_destruct;	// IMP=0x0000000000067e0e
- (unsigned long long)drawNoise;	// IMP=0x0000000000067d16
- (id)initWithUnigram:(float *)arg1 ofSize:(unsigned long long)arg2;	// IMP=0x000000000006761f
- (id)initWithZipfOfSize:(unsigned long long)arg1;	// IMP=0x00000000000674a8
- (id)init;	// IMP=0x000000000006749a
