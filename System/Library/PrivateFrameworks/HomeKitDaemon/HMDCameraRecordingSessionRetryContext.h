...
- (void).cxx_destruct;	// IMP=0x0000000000673ad3
...
- (void)computeNextRetryInterval;	// IMP=0x00000000006739fc
@property double retryInterval; // @synthesize retryInterval=_retryInterval;
- (id)initWithWorkQueue:(id)arg1 homePresenceByPairingIdentity:(id)arg2 preferences:(id)arg3;	// IMP=0x0000000000673729
- (id)initWithWorkQueue:(id)arg1 homePresenceByPairingIdentity:(id)arg2;	// IMP=0x0000000000673692
