...
+ (id)urlRequestRewriteRuleWithMatchPattern:(id)arg1 block:(CDUnknownBlockType)arg2;	// IMP=0x006000000001c010
...
- (void)rewriteURLRequest:(id)arg1;	// IMP=0x000000000001c140
- (id)initWithMatchExpression:(id)arg1 block:(CDUnknownBlockType)arg2;	// IMP=0x000000000001bf10
