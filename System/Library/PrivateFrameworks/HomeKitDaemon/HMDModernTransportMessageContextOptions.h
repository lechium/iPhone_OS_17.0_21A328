...
+ (id)newWithBuilder:(CDUnknownBlockType)arg1;	// IMP=0x0060000000c10d00
- (void).cxx_destruct;	// IMP=0x0000000000c10ccd
...
- (id)initWithBuilder:(id)arg1;	// IMP=0x0000000000c10b4e
