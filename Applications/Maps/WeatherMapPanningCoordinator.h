...
- (void).cxx_destruct;	// IMP=0x0020000000815cd5
...
- (void)_updateWeatherConditions;	// IMP=0x0010000000815bb7
- (void)handleMapViewRegionDidChange:(id)arg1 forceUpdate:(_Bool)arg2;	// IMP=0x00100000008159e6
- (void)handleMapViewRegionDidChange:(id)arg1;	// IMP=0x00100000008159d2
- (id)initWithWeatherLocationDataProvider:(id)arg1;	// IMP=0x001000000081595b
