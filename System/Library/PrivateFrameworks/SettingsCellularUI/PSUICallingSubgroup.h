...
- (void).cxx_destruct;	// IMP=0x00000000000110c7
...
- (id)getLogger;	// IMP=0x000000000001104f
- (id)specifiers;	// IMP=0x0000000000010aa4
- (void)viewWillAppear;	// IMP=0x000000000001093a
- (id)initWithListController:(id)arg1 groupSpecifier:(id)arg2;	// IMP=0x00000000000108e4
- (id)initWithListController:(id)arg1 groupSpecifier:(id)arg2 parentSpecifier:(id)arg3;	// IMP=0x00000000000107ef
