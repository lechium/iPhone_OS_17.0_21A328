...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000002212a
- (void).cxx_destruct;	// IMP=0x0000000000022c5d
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000022650
@property(readonly) unsigned long long hash;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000224ce
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000002233d
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000022132
- (id)initWithEditorsChoice:(_Bool)arg1 productRating:(float)arg2 productRatingBadge:(id)arg3 productDescription:(id)arg4 screenshots:(id)arg5 trailers:(id)arg6 developerName:(id)arg7;	// IMP=0x0000000000021fd7
