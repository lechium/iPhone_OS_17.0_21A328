...
- (void).cxx_destruct;	// IMP=0x00000000002f96e5
...
- (id)description;	// IMP=0x00000000002f95e5
- (void)_addChildViewElement:(id)arg1;	// IMP=0x00000000002f95cf
- (id)initWithColumnIdentifier:(long long)arg1;	// IMP=0x00000000002f952b
