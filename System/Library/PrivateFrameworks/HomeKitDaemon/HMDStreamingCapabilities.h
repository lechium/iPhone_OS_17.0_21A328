...
+ (unsigned long long)aspectRatioOfResolution:(id)arg1;	// IMP=0x0010000000588cb0
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000588ca8
+ (void)translateCapabilities:(id)arg1;	// IMP=0x001000000058858f
- (void).cxx_destruct;	// IMP=0x0000000000588323
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000058812e
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000587e24
- (void)updateWithRemoteSettings:(id)arg1;	// IMP=0x0000000000587b10
- (void)_updateWithStreamPreference:(id)arg1;	// IMP=0x00000000005873ca
- (id)_supportedResolutionsWithOverrides;	// IMP=0x0000000000586efd
- (id)initWithStreamPreference:(id)arg1;	// IMP=0x0000000000586c31
- (id)description;	// IMP=0x0000000000586b03
