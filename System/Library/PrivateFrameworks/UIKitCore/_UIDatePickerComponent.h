...
+ (id)componentsFromDateFormatString:(id)arg1 locale:(id)arg2 followsSystemHourCycle:(_Bool)arg3 desiredUnits:(long long)arg4;	// IMP=0x0060000000f7b19d
+ (id)componentsFromDateFormatString:(id)arg1 locale:(id)arg2 followsSystemHourCycle:(_Bool)arg3;	// IMP=0x0060000000f7b181
- (void).cxx_destruct;	// IMP=0x0000000000f7bb77
...
- (id)description;	// IMP=0x0000000000f7b904
- (id)_initWithFormatString:(id)arg1 calendarUnit:(unsigned long long)arg2;	// IMP=0x0000000000f7b867
