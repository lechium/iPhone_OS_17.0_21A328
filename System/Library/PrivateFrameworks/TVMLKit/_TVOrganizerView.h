...
- (void).cxx_destruct;	// IMP=0x00000000000c4847
...
- (id)impressionableElementsContainedInDocument:(id)arg1;	// IMP=0x00000000000c44f9
- (long long)_positionFromView:(id)arg1;	// IMP=0x00000000000c44d7
- (struct CGSize)_contentSizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000000c3fdb
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x00000000000c3eef
- (id)preferredFocusEnvironments;	// IMP=0x00000000000c3c93
- (_Bool)canBecomeFocused;	// IMP=0x00000000000c3c8b
- (void)setHighlighted:(_Bool)arg1;	// IMP=0x00000000000c3b08
- (void)setSelected:(_Bool)arg1 animated:(_Bool)arg2;	// IMP=0x00000000000c3af3
- (void)setSelected:(_Bool)arg1 animated:(_Bool)arg2 withAnimationCoordinator:(id)arg3;	// IMP=0x00000000000c3631
- (void)layoutSubviews;	// IMP=0x00000000000c2129
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000000c1f5f
- (struct UIEdgeInsets)tv_alignmentInsetsForExpectedWidth:(double)arg1;	// IMP=0x00000000000c0998
@property(nonatomic) double cornerRadius;
- (void)setComponentsNeedUpdate;	// IMP=0x00000000000bf506
@property(nonatomic) __weak UIView *preferredFocusedComponent;
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000000bf3f5
