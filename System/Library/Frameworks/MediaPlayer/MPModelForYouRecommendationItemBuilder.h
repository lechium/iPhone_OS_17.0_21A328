...
+ (id)allSupportedProperties;	// IMP=0x0060000000277955
- (void).cxx_destruct;	// IMP=0x00000000002774bd
...
- (id)modelObjectForRecommendationChildDictionary:(id)arg1 parentGroup:(id)arg2 subgroupsAccumulator:(id)arg3 userIdentity:(id)arg4;	// IMP=0x00000000002767b4
- (id)initWithRequestedPropertySet:(id)arg1 storeItemMetadataResults:(id)arg2 flatSectionedItems:(id)arg3;	// IMP=0x00000000002766d4
