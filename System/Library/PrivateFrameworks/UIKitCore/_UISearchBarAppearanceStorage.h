...
- (void).cxx_destruct;	// IMP=0x00000000002a4542
...
- (id)imageForIcon:(long long)arg1 state:(unsigned long long)arg2;	// IMP=0x00000000002a4418
- (void)setImage:(id)arg1 forIcon:(long long)arg2 state:(unsigned long long)arg3;	// IMP=0x00000000002a435b
- (id)searchFieldBackgroundImageForState:(unsigned long long)arg1;	// IMP=0x00000000002a42f4
- (void)setSearchFieldBackgroundImage:(id)arg1 forState:(unsigned long long)arg2;	// IMP=0x00000000002a4217
