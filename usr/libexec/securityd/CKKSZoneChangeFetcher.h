...
- (void).cxx_destruct;	// IMP=0x002000000020bdc7
...
- (void)halt;	// IMP=0x001000000020b9be
- (void)cancel;	// IMP=0x001000000020b981
- (void)holdFetchesUntil:(id)arg1;	// IMP=0x001000000020b96f
- (id)createSuccesfulFetchDependency;	// IMP=0x001000000020b904
- (void)_onqueueCreateNewFetch;	// IMP=0x001000000020b172
- (void)maybeCreateNewFetch;	// IMP=0x001000000020b101
- (void)maybeCreateNewFetchOnQueue;	// IMP=0x001000000020af0a
- (id)inflightFetch;	// IMP=0x001000000020ae0f
- (id)requestSuccessfulFetchForManyReasons:(id)arg1;	// IMP=0x001000000020acd0
- (id)requestFetchDueToAPNS:(id)arg1;	// IMP=0x001000000020a927
- (void)notifyZoneChange:(id)arg1;	// IMP=0x001000000020a84c
- (id)requestSuccessfulFetch:(id)arg1;	// IMP=0x001000000020a7e6
- (id)strongClientMap;	// IMP=0x001000000020a561
- (void)registerClient:(id)arg1 zoneID:(id)arg2;	// IMP=0x001000000020a495
@property(readonly, copy) NSString *description;
- (id)initWithContainer:(id)arg1 fetchClass:(Class)arg2 reachabilityTracker:(id)arg3;	// IMP=0x001000000020a00d
