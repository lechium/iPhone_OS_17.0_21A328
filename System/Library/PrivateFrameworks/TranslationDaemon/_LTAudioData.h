...
- (void)writeToURL:(id)arg1;	// IMP=0x000000000000475f
- (_Bool)_populateWithOpusData:(id)arg1;	// IMP=0x000000000000451c
- (id)initWithASBD:(struct AudioStreamBasicDescription)arg1 rawData:(id)arg2 wordTimingInfo:(id)arg3;	// IMP=0x00000000000043fe
