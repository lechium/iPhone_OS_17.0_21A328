...
- (_Bool)executeRequestCore:(id *)arg1;	// IMP=0x00000000002f49ec
- (void)executeEpilogue;	// IMP=0x00000000002f3994
- (void)executePrologue;	// IMP=0x00000000002f392c
- (_Bool)isWritingRequest;	// IMP=0x00000000002f3924
- (id)rowCache;	// IMP=0x00000000002f3912
- (void)dealloc;	// IMP=0x00000000002f37ae
- (id)initWithRequest:(id)arg1 context:(id)arg2 sqlCore:(id)arg3;	// IMP=0x00000000002f35f4
