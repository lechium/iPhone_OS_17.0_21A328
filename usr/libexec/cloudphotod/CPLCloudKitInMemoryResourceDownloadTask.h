...
- (void).cxx_destruct;	// IMP=0x0020000000135f2d
...
- (void)_startDownload;	// IMP=0x00100000001355ce
- (void)_fetchPlaceholderRecordAndStartDownload;	// IMP=0x00100000001353b5
- (void)runOperations;	// IMP=0x001000000013525b
- (id)_inMemoryDownloadOperationForRecordID:(id)arg1 resource:(id)arg2 record:(id)arg3 keys:(id)arg4 operationType:(long long)arg5 completionBlock:(CDUnknownBlockType)arg6;	// IMP=0x001000000013499a
- (id)initWithController:(id)arg1 resource:(id)arg2 record:(id)arg3 target:(id)arg4 transportScopeMapping:(id)arg5 completionHandler:(CDUnknownBlockType)arg6;	// IMP=0x00100000001347f2
