...
- (void).cxx_destruct;	// IMP=0x002000000001fc91
...
- (void)syncCoordinator:(id)arg1 beginSyncSession:(id)arg2;	// IMP=0x001000000001fa4d
- (_Bool)handlePotentialPairedSyncForComplicationsFailedWithIdentifier:(id)arg1 error:(id)arg2;	// IMP=0x001000000001f917
- (void)handlePairedSyncForComplicationsAckWithIdentifier:(id)arg1 success:(_Bool)arg2;	// IMP=0x001000000001f73b
@property(readonly) NSString *state;
- (id)init;	// IMP=0x001000000001f54a
