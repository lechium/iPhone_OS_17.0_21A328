...
- (void).cxx_destruct;	// IMP=0x000000000001020a
...
- (id)sevenDayDoseForMostRecentNotificationWithError:(id *)arg1;	// IMP=0x000000000000ff52
- (id)notificationCountForRollingDays:(long long)arg1 error:(id *)arg2;	// IMP=0x000000000000fd82
- (id)audioExposureResultWithError:(id *)arg1;	// IMP=0x000000000000fae9
- (id)initWithTargetDate:(id)arg1 exposureType:(long long)arg2 profile:(id)arg3;	// IMP=0x000000000000fa25
