...
+ (_Bool)supportsSecureCoding;	// IMP=0x00600000000b689f
- (void).cxx_destruct;	// IMP=0x00000000000b6b11
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000b6a59
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000b69b8
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000b68a7
