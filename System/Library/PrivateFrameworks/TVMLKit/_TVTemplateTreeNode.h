...
- (void).cxx_destruct;	// IMP=0x000000000006d030
...
- (void)addDerivedTemplateNode:(id)arg1;	// IMP=0x000000000006cf90
@property(readonly, copy, nonatomic) NSArray *derivedTemplateNodes;
- (id)initWithTemplateName:(id)arg1 styleSheetURLs:(id)arg2 abstract:(_Bool)arg3;	// IMP=0x000000000006ceb0
- (id)initWithTemplateName:(id)arg1 styleSheetURLs:(id)arg2;	// IMP=0x000000000006ce9b
