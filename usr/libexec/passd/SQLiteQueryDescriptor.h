...
- (id)_newSelectSQLWithProperties:(id)arg1 columns:(id)arg2;	// IMP=0x001000000009f313
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000009f25f
- (void)dealloc;	// IMP=0x001000000009f207
