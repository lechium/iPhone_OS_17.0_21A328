...
- (void).cxx_destruct;	// IMP=0x00200000000de1d6
...
- (_Bool)_operationAllowsCellular:(id)arg1;	// IMP=0x00100000000dd503
- (id)_priorityDescriptionForOperation:(id)arg1;	// IMP=0x00100000000dd3d7
...
- (void)cancelAllOperations;	// IMP=0x00100000000dd293
- (id)contextForOperation:(id)arg1;	// IMP=0x00100000000dd27d
- (_Bool)hasBlockedOperationsIncludingBackground:(_Bool)arg1;	// IMP=0x00100000000dd053
- (void)operationDidFinish:(id)arg1;	// IMP=0x00100000000dcfc6
- (void)operationWillStart:(id)arg1 context:(id)arg2;	// IMP=0x00100000000dcf26
- (id)initWithTask:(id)arg1;	// IMP=0x00100000000dce5f
