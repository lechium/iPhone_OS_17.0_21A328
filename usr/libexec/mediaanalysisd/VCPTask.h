...
- (void).cxx_destruct;	// IMP=0x00200000000f2d3d
...
- (void)main;	// IMP=0x00100000000f2ca0
- (int)mainInternal;	// IMP=0x00100000000f2c95
- (_Bool)isCancelled;	// IMP=0x00100000000f2c45
- (id)initWithPhotoLibrary:(id)arg1;	// IMP=0x00100000000f2b90
- (id)init;	// IMP=0x00100000000f2b82
