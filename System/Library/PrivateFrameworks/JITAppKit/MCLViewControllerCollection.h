...
- (void).cxx_destruct;	// IMP=0x0000000000018fe0
...
- (void)scrollViewDidScroll:(id)arg1;	// IMP=0x0000000000018b50
- (void)layoutSubviews;	// IMP=0x0000000000018a10
@property(nonatomic) double spacing;
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000017730
