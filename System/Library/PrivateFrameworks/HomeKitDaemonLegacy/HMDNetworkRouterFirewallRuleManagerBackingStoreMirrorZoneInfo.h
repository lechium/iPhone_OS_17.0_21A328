...
- (void).cxx_destruct;	// IMP=0x0000000000823d3e
...
- (void)forceRefresh;	// IMP=0x0000000000823c7a
- (void)markDeleted;	// IMP=0x0000000000823c69
- (void)markChanged;	// IMP=0x0000000000823c58
- (id)initWithZoneID:(id)arg1;	// IMP=0x0000000000823ba1
