...
- (void).cxx_destruct;	// IMP=0x00200000001ebf21
...
- (void)isPseudonymHandleForProvider:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00100000001ebe09
- (void)revokePseudonymHandle:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00100000001ebd60
- (void)renewPseudonymHandle:(id)arg1 expirationDate:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00100000001ebc4d
- (void)generatePseudonymHandleForConversationWithExpiryDuration:(double)arg1 URI:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00100000001eb997
- (id)callerIDAccount;	// IMP=0x00100000001eb947
- (void)registerWithIDSWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x00100000001eb8b3
- (id)tuConversationProvider;	// IMP=0x00100000001eb785
- (id)initWithProvider:(id)arg1;	// IMP=0x00100000001eb625
