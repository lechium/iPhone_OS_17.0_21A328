...
- (void).cxx_destruct;	// IMP=0x00000000004a375d
...
- (void)_updateTargetLayoutInfoIfNeeded;	// IMP=0x00000000004a352f
- (id)tileControllerToTrack;	// IMP=0x00000000004a32af
- (void)configureTileReattachmentContext:(id)arg1;	// IMP=0x00000000004a320d
- (void)completeTracking;	// IMP=0x00000000004a3174
- (void)updateTileControllerTracking;	// IMP=0x00000000004a2e01
- (void)startTileControllerTracking;	// IMP=0x00000000004a2980
- (void)updateGestureRecognizerTracking;	// IMP=0x00000000004a280d
- (void)setDelegate:(id)arg1;	// IMP=0x00000000004a2761
- (id)initWithPinchGestureRecognizer:(id)arg1 tilingView:(id)arg2 direction:(long long)arg3;	// IMP=0x00000000004a25d0
- (id)initWithTilingView:(id)arg1;	// IMP=0x00000000004a25b6
