...
- (void).cxx_destruct;	// IMP=0x00000000008e4f87
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000008e4d78
- (unsigned long long)hash;	// IMP=0x00000000008e4c05
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000008e49da
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000008e4853
- (void)copyTo:(id)arg1;	// IMP=0x00000000008e4704
- (void)writeTo:(id)arg1;	// IMP=0x00000000008e4598
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000008e3f9c
- (id)dictionaryRepresentation;	// IMP=0x00000000008e3c33
- (id)description;	// IMP=0x00000000008e3b84
@property(nonatomic) _Bool hasOperationStartTime;
@property(readonly, nonatomic) _Bool hasErrorDomain;
- (int)StringAsOperationType:(id)arg1;	// IMP=0x00000000008e3a4d
- (id)operationTypeAsString:(int)arg1;	// IMP=0x00000000008e3a02
