...
- (void).cxx_destruct;	// IMP=0x0000000000025617
...
- (void)inputDidChange;	// IMP=0x0000000000025441
- (void)_invalidateOutput;	// IMP=0x000000000002542a
- (void)performOutputChanges:(CDUnknownBlockType)arg1;	// IMP=0x0000000000025354
- (void)performInputChanges:(CDUnknownBlockType)arg1;	// IMP=0x00000000000252c1
- (id)initWithSettings:(id)arg1;	// IMP=0x0000000000025256
- (id)init;	// IMP=0x0000000000025242
