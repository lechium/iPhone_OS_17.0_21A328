...
- (void).cxx_destruct;	// IMP=0x00200000000654da
...
- (void)moveOutroToInsignia;	// IMP=0x00100000000651b6
- (void)playerItemDidReachEnd:(id)arg1;	// IMP=0x0010000000064f84
- (void)_maybePresentInsignia;	// IMP=0x0010000000064e15
- (void)addItemWithURL:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0010000000064be1
- (void)layoutSubviews;	// IMP=0x0010000000064b53
- (void)loadInsigniaAsset;	// IMP=0x0010000000064274
- (void)setupInsigniaLayer;	// IMP=0x0010000000063dc6
- (id)init;	// IMP=0x0010000000063d75
