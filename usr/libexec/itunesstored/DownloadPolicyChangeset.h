...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000001885a7
- (void)dealloc;	// IMP=0x001000000018855d
- (id)initWithPolicyIdentifiers:(id)arg1;	// IMP=0x0010000000188506
