...
- (void).cxx_destruct;	// IMP=0x002000000004b71c
...
- (void)textDidChange:(id)arg1;	// IMP=0x001000000004b5aa
- (void)didCompleteTextEntry:(id)arg1;	// IMP=0x001000000004b526
- (void)setNumberOfDigits:(long long)arg1;	// IMP=0x001000000004b46f
- (void)configureNextViewController:(id)arg1;	// IMP=0x001000000004b3ed
- (id)onCameraButton;	// IMP=0x001000000004b3cd
- (id)commitConfiguration;	// IMP=0x001000000004b2fc
- (id)initWithCoordinator:(id)arg1 config:(id)arg2;	// IMP=0x001000000004b153
