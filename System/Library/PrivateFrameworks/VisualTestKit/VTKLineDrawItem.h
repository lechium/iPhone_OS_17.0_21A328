...
- (void).cxx_destruct;	// IMP=0x0000000000005faa
...
- (void)drawAtContext:(id)arg1;	// IMP=0x0000000000005dff
- (id)initWitColor:(id)arg1 origin:(struct CGPoint)arg2 orientation:(long long)arg3;	// IMP=0x0000000000005cf5
