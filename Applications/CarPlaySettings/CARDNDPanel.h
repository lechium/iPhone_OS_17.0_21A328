...
- (void).cxx_destruct;	// IMP=0x002000000001579c
...
- (void)_drivingToggleChanged:(_Bool)arg1;	// IMP=0x00100000000153ae
- (_Bool)_isDrivingToggleOn;	// IMP=0x0010000000015231
- (void)modeConfigurationService:(id)arg1 didReceiveAvailableModesUpdate:(id)arg2;	// IMP=0x0010000000015144
- (id)specifierSections;	// IMP=0x001000000001502c
- (id)cellSpecifier;	// IMP=0x0010000000014e81
- (void)invalidate;	// IMP=0x0010000000014e25
- (id)initWithPanelController:(id)arg1;	// IMP=0x0010000000014aca
