...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000998280
- (unsigned long long)hash;	// IMP=0x00000000009981e2
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000009980b1
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000997fdf
- (void)copyTo:(id)arg1;	// IMP=0x0000000000997f30
- (void)writeTo:(id)arg1;	// IMP=0x0000000000997e5c
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000997a5b
- (id)dictionaryRepresentation;	// IMP=0x000000000099785f
- (id)description;	// IMP=0x00000000009977b0
