...
- (void).cxx_destruct;	// IMP=0x00000000001b7dc4
...
- (id)_itemAtIndexPath:(id)arg1 isPlaceholder:(_Bool *)arg2;	// IMP=0x00000000001b774e
- (unsigned long long)_indexForCustomItemAtIndexPath:(id)arg1;	// IMP=0x00000000001b763b
- (void)picker:(id)arg1 didDeleteItem:(id)arg2;	// IMP=0x00000000001b7591
- (void)picker:(id)arg1 didPickItem:(id)arg2;	// IMP=0x00000000001b7526
- (void)pickerDidCancel:(id)arg1;	// IMP=0x00000000001b74dc
- (void)tableView:(id)arg1 didEndEditingRowAtIndexPath:(id)arg2;	// IMP=0x00000000001b74ca
- (void)tableView:(id)arg1 willBeginEditingRowAtIndexPath:(id)arg2;	// IMP=0x00000000001b7447
- (void)textFieldDidEndEditing:(id)arg1;	// IMP=0x00000000001b7167
- (_Bool)textFieldShouldEndEditing:(id)arg1;	// IMP=0x00000000001b7082
- (_Bool)textFieldShouldReturn:(id)arg1;	// IMP=0x00000000001b6f85
- (void)textFieldDidBeginEditing:(id)arg1;	// IMP=0x00000000001b6e9d
- (_Bool)isSearching;	// IMP=0x00000000001b6e3b
- (void)didDismissSearchController:(id)arg1;	// IMP=0x00000000001b6893
- (void)willPresentSearchController:(id)arg1;	// IMP=0x00000000001b66be
- (void)updateSearchResultsForSearchController:(id)arg1;	// IMP=0x00000000001b65a8
- (void)tableView:(id)arg1 commitEditingStyle:(long long)arg2 forRowAtIndexPath:(id)arg3;	// IMP=0x00000000001b630e
- (_Bool)tableView:(id)arg1 shouldIndentWhileEditingRowAtIndexPath:(id)arg2;	// IMP=0x00000000001b6306
- (long long)tableView:(id)arg1 editingStyleForRowAtIndexPath:(id)arg2;	// IMP=0x00000000001b62db
- (void)tableView:(id)arg1 willDisplayHeaderView:(id)arg2 forSection:(long long)arg3;	// IMP=0x00000000001b62c6
- (void)tableView:(id)arg1 willDisplayCell:(id)arg2 forRowAtIndexPath:(id)arg3;	// IMP=0x00000000001b60c3
- (void)tableView:(id)arg1 didSelectRowAtIndexPath:(id)arg2;	// IMP=0x00000000001b5e0d
- (id)tableView:(id)arg1 cellForRowAtIndexPath:(id)arg2;	// IMP=0x00000000001b5b93
- (long long)tableView:(id)arg1 numberOfRowsInSection:(long long)arg2;	// IMP=0x00000000001b5a1a
- (long long)numberOfSectionsInTableView:(id)arg1;	// IMP=0x00000000001b58ca
- (void)setEditing:(_Bool)arg1 animated:(_Bool)arg2;	// IMP=0x00000000001b574b
- (void)_updateRightButtonItem;	// IMP=0x00000000001b5661
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x00000000001b4f61
- (_Bool)isSupplementalDisclosureItemIndexPath:(id)arg1;	// IMP=0x00000000001b4eb6
- (_Bool)isAddCustomItemIndexPath:(id)arg1;	// IMP=0x00000000001b4e19
- (void)pickedItem:(id)arg1;	// IMP=0x00000000001b4e13
- (void)removeCustomItem:(id)arg1;	// IMP=0x00000000001b4e0d
- (void)customLabelUpdated:(id)arg1;	// IMP=0x00000000001b4d64
- (void)presentExtendedPicker;	// IMP=0x00000000001b4c33
- (void)donePicker:(id)arg1;	// IMP=0x00000000001b4b16
- (void)doneInlineEditing:(id)arg1;	// IMP=0x00000000001b4abc
- (void)cancelPicker:(id)arg1;	// IMP=0x00000000001b4a70
- (id)titleForSupplementalItems;	// IMP=0x00000000001b4a14
- (id)titleForAddCustomItem;	// IMP=0x00000000001b49b8
- (id)titleForPickerItem:(id)arg1;	// IMP=0x00000000001b48b0
- (id)_titleForPickerItem:(id)arg1;	// IMP=0x00000000001b46ea
- (id)initWithStyle:(long long)arg1;	// IMP=0x00000000001b43e1
