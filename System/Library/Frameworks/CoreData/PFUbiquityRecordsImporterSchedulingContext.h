...
- (id)description;	// IMP=0x000000000034ee77
- (void)dealloc;	// IMP=0x000000000034edfd
- (id)initWithPendingLogLocations:(id)arg1;	// IMP=0x000000000034edc2
- (id)init;	// IMP=0x000000000034ed36
