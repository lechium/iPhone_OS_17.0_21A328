...
- (void).cxx_destruct;	// IMP=0x000000000001e190
...
- (void)selectItemAtIndex:(long long)arg1;	// IMP=0x000000000001dec0
- (void)selectVariant:(id)arg1;	// IMP=0x000000000001dd20
- (id)createVariantButton:(Class)arg1 type:(long long)arg2;	// IMP=0x000000000001dc20
- (void)clearVariants;	// IMP=0x000000000001db20
- (void)reloadData;	// IMP=0x000000000001cea0
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000001cd50
