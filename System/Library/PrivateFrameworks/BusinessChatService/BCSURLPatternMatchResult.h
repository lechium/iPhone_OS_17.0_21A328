...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000000b24b
- (void).cxx_destruct;	// IMP=0x000000000000b2bc
...
- (id)descriptionBuilderWithMultilinePrefix:(id)arg1;	// IMP=0x000000000000b0d2
- (id)descriptionWithMultilinePrefix:(id)arg1;	// IMP=0x000000000000b082
- (id)succinctDescriptionBuilder;	// IMP=0x000000000000aea3
- (id)succinctDescription;	// IMP=0x000000000000ae53
@property(readonly, copy) NSString *debugDescription;
@property(readonly, copy) NSString *description;
@property(readonly, nonatomic) _Bool matchFound;
@property(readonly, nonatomic, getter=isExpired) _Bool expired;
- (id)initWithOriginalURL:(id)arg1 extractedURL:(id)arg2 totalConsecutivePrefixMatches:(unsigned long long)arg3 totalExactMatches:(unsigned long long)arg4 totalAnyMatches:(unsigned long long)arg5 bundleID:(id)arg6 pattern:(id)arg7 expirationDate:(id)arg8 dateHelper:(id)arg9;	// IMP=0x000000000000abf8
