...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000000ff7d
- (void).cxx_destruct;	// IMP=0x000000000000ff34
...
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000000fe1c
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000000fc5f
@property(readonly, copy) NSString *name;
@property(readonly, copy) id value;
- (id)initWithIdentifier:(id)arg1 parentIdentifier:(id)arg2 type:(id)arg3 numberValue:(id)arg4 dataValue:(id)arg5;	// IMP=0x000000000000f98b
