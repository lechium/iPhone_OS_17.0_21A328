...
- (void).cxx_destruct;	// IMP=0x00000000004c33b0
...
- (void)run;	// IMP=0x00000000004c2a0f
- (id)initWithInputAsset:(id)arg1 imageInfoNode:(id)arg2 renderImageInfoNode:(id)arg3 renderImageDataNode:(id)arg4 videoURLNode:(id)arg5 videoAssetNode:(id)arg6 renderVideoURLNode:(id)arg7 renderVideoAssetNode:(id)arg8 adjustmentURLNode:(id)arg9;	// IMP=0x00000000004c2687
