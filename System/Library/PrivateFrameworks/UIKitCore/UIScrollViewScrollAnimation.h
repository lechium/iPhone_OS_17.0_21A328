...
- (void).cxx_destruct;	// IMP=0x00000000015f5eb5
- (void)dealloc;	// IMP=0x00000000015f5e47
- (float)progressForFraction:(float)arg1;	// IMP=0x00000000015f5d44
- (void)setProgress:(float)arg1;	// IMP=0x00000000015f5b51
- (void)adjustForContentOffsetDelta:(struct CGPoint)arg1;	// IMP=0x00000000015f5b10
