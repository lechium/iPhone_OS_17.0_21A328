...
+ (id)specWithSizeClass:(long long)arg1 interfaceOrientation:(long long)arg2;	// IMP=0x006000000001999d
...
- (id)initWithSize:(long long)arg1 interfaceOrientation:(long long)arg2;	// IMP=0x0000000000019a71
