...
- (id)formattedDescription:(unsigned long long)arg1;	// IMP=0x0000000000008f4f
- (id)newArgumentEncoderWithBufferIndex:(unsigned long long)arg1 reflection:(id *)arg2;	// IMP=0x0000000000008f47
- (id)newArgumentEncoderWithBufferIndex:(unsigned long long)arg1;	// IMP=0x0000000000008f3f
@property(readonly) unsigned int functionRef;
- (void)dealloc;	// IMP=0x0000000000008e61
- (id)initWithDevice:(id)arg1 functionType:(unsigned long long)arg2 functionRef:(unsigned int)arg3;	// IMP=0x0000000000008df8
