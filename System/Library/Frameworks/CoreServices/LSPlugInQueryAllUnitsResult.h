...
+ (_Bool)supportsSecureCoding;	// IMP=0x0060000000085268
- (void).cxx_destruct;	// IMP=0x00000000000854a7
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000008540a
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000008531e
- (id)initWithPlugInUnits:(id)arg1 forDatabaseWithUUID:(id)arg2;	// IMP=0x0000000000085270
