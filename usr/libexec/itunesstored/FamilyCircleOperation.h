...
- (void)_writeCacheWithFamilyCircle:(id)arg1 accountIdentifier:(id)arg2;	// IMP=0x0010000000010c75
- (id)_familyCircleForDictionary:(id)arg1;	// IMP=0x001000000001030f
- (id)_cachePath;	// IMP=0x0010000000010283
- (id)_cachedFamilyCircleWithAccountIdentifier:(id)arg1;	// IMP=0x001000000001008f
- (void)run;	// IMP=0x001000000000fae6
- (void)dealloc;	// IMP=0x001000000000fa80
