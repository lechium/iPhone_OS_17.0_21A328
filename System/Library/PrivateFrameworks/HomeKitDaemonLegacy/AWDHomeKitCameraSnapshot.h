...
- (void).cxx_destruct;	// IMP=0x00000000004c8ac5
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000004c8642
- (unsigned long long)hash;	// IMP=0x00000000004c83e6
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000004c8072
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000004c7db0
- (void)copyTo:(id)arg1;	// IMP=0x00000000004c7b85
- (void)writeTo:(id)arg1;	// IMP=0x00000000004c794c
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000004c715c
- (id)dictionaryRepresentation;	// IMP=0x00000000004c6be1
- (id)description;	// IMP=0x00000000004c6b32
...
- (int)StringAsCertified:(id)arg1;	// IMP=0x00000000004c67ed
- (id)certifiedAsString:(int)arg1;	// IMP=0x00000000004c67a5
