...
+ (id)taskWithPhotoLibrary:(id)arg1 options:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00400000000d29f6
- (void).cxx_destruct;	// IMP=0x00200000000d44d7
- (_Bool)run:(id *)arg1;	// IMP=0x00100000000d313d
- (void)publishResults:(id)arg1;	// IMP=0x00100000000d2aae
- (id)initWithPhotoLibrary:(id)arg1 options:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00100000000d26e4
