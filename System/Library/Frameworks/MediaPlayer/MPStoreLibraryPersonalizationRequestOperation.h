...
+ (id)personalizedResponseForContentDescriptor:(id)arg1 requestedProperties:(id)arg2;	// IMP=0x00600000001b1939
- (void).cxx_destruct;	// IMP=0x00000000001af9fa
@property(copy, nonatomic) CDUnknownBlockType responseHandler; // @synthesize responseHandler=_responseHandler;
@property(copy, nonatomic) MPStoreLibraryPersonalizationRequest *request; // @synthesize request=_request;
- (void)execute;	// IMP=0x00000000001ae67f
- (void)cancel;	// IMP=0x00000000001ae636
