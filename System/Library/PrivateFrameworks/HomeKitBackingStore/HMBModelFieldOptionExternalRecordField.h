...
- (void).cxx_destruct;	// IMP=0x000000000009d850
...
- (void)applyTo:(id)arg1;	// IMP=0x000000000009d7a0
- (id)initWithExternalRecordField:(id)arg1 encrypted:(_Bool)arg2;	// IMP=0x000000000009d721
