...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000033cdfe
- (void)addNegotiatedHDRMode:(id)arg1;	// IMP=0x000000000033cde8
- (void)addPixelFormatSet:(id)arg1;	// IMP=0x000000000033cdd2
- (void)addParameterSet:(id)arg1 payload:(int)arg2;	// IMP=0x000000000033cd88
- (void)addFeatureString:(id)arg1 payload:(int)arg2;	// IMP=0x000000000033cd3e
- (void)addVideoRules:(id)arg1 transportType:(unsigned char)arg2 payload:(int)arg3 encodingType:(unsigned char)arg4;	// IMP=0x000000000033cd28
- (void)dealloc;	// IMP=0x000000000033cca6
- (id)init;	// IMP=0x000000000033cbf7
