...
- (void).cxx_destruct;	// IMP=0x002000000020e0fa
...
- (void)handleResponseDictionary:(id)arg1;	// IMP=0x001000000020de1b
- (double)anisetteHeadersTimeout;	// IMP=0x001000000020de0d
- (id)nonStandardMessageHeadersForOutgoingPush;	// IMP=0x001000000020de05
- (id)messageBody;	// IMP=0x001000000020da5e
- (id)requiredKeys;	// IMP=0x001000000020d9d5
- (_Bool)isMultipleAuthCertCapable;	// IMP=0x001000000020d9cd
- (id)bagKey;	// IMP=0x001000000020d9c0
- (_Bool)requiresPushTokenKeys;	// IMP=0x001000000020d9b8
- (_Bool)hasRequiredKeys:(id *)arg1;	// IMP=0x001000000020d904
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000020d687
