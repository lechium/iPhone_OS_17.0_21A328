...
- (void).cxx_destruct;	// IMP=0x0000000000210a91
...
- (id)attributeDescriptions;	// IMP=0x0000000000210867
- (id)asPayload;	// IMP=0x0000000000210680
- (id)init;	// IMP=0x0000000000210590
- (id)initWithPayload:(id)arg1;	// IMP=0x000000000021047a
- (id)initWithDeviceID:(id)arg1 mediaRouteID:(id)arg2 deviceCapabilities:(id)arg3;	// IMP=0x0000000000210391
