...
- (void).cxx_destruct;	// IMP=0x00000000001ccd8c
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001ccd0f
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001ccbf7
- (unsigned long long)hash;	// IMP=0x00000000001ccba7
- (id)initWithSize:(struct CGSize)arg1 headingString:(id)arg2 compassViewStyle:(long long)arg3;	// IMP=0x00000000001ccafd
