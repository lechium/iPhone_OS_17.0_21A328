...
+ (id)descriptorFromGraphicIconConfiguration:(id)arg1;	// IMP=0x00600000000266fe
+ (id)descriptorFromGraphicSymbolRecipe:(id)arg1;	// IMP=0x006000000002629c
- (void).cxx_destruct;	// IMP=0x0000000000026bf8
...
- (id)description;	// IMP=0x0000000000026ad6
