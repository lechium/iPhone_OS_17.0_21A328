...
- (void).cxx_destruct;	// IMP=0x002000000005bdd7
...
- (void)_handleFoundDevice:(id)arg1;	// IMP=0x001000000005bc2f
- (void)authorizationEndorserRapportClientDidFinish:(id)arg1;	// IMP=0x001000000005bc1d
- (void)deactivate;	// IMP=0x001000000005bb8f
- (_Bool)activateWithError:(id *)arg1;	// IMP=0x001000000005bb17
- (id)initWithClient:(id)arg1;	// IMP=0x001000000005baac
