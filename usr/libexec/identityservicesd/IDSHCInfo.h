...
- (void *)remoteContext;	// IMP=0x00100000001b7701
- (void *)localContext;	// IMP=0x00100000001b76f7
- (void)setRemoteContext:(void *)arg1;	// IMP=0x00100000001b75de
- (void)setLocalContext:(void *)arg1;	// IMP=0x00100000001b74c5
- (void)invalidate;	// IMP=0x00100000001b7374
