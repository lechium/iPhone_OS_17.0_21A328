...
- (void).cxx_destruct;	// IMP=0x00000000000a5213
...
- (void)didFailWithError:(id)arg1;	// IMP=0x00000000000a512c
- (void)didFinishWithDocumentInfoCollection:(id)arg1;	// IMP=0x00000000000a5004
- (void)didCancel;	// IMP=0x00000000000a4f67
- (void)dismiss;	// IMP=0x00000000000a4ee7
- (void)viewServicePreferredSizeDidChange:(struct CGSize)arg1;	// IMP=0x00000000000a4ed5
...
- (id)castedChildViewController;	// IMP=0x00000000000a4dd1
- (void)viewDidLoad;	// IMP=0x00000000000a486d
- (void)accelerometer:(id)arg1 didChangeDeviceOrientation:(long long)arg2;	// IMP=0x00000000000a481c
- (void)accelerometer:(id)arg1 didAccelerateWithTimeStamp:(double)arg2 x:(float)arg3 y:(float)arg4 z:(float)arg5 eventType:(int)arg6;	// IMP=0x00000000000a4816
- (void)dealloc;	// IMP=0x00000000000a4745
- (id)initWithDelegate:(id)arg1;	// IMP=0x00000000000a46f5
