...
- (void).cxx_destruct;	// IMP=0x000000000037cd51
...
- (id)applyUpdatesWithElement:(id)arg1;	// IMP=0x000000000037cb1f
- (id)initWithDOMElement:(id)arg1 parent:(id)arg2 elementFactory:(id)arg3;	// IMP=0x000000000037c72c
