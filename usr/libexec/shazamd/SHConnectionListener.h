...
- (void).cxx_destruct;	// IMP=0x002000000000445a
@property(nonatomic) struct os_unfair_lock_s lock; // @synthesize lock=_lock;
- (struct os_unfair_lock_s);	// IMP=0x0010000000004448
...
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x0010000000003ccb
- (void)listen;	// IMP=0x0010000000003c8e
- (id)initWithServiceProvider:(id)arg1 listener:(id)arg2;	// IMP=0x0010000000003bae
