...
- (void).cxx_destruct;	// IMP=0x00000000000a8c93
...
- (struct UIEdgeInsets)playbackControlsViewLayoutMarginsForView:(id)arg1 keyboardHeight:(double)arg2 isFullScreen:(_Bool)arg3;	// IMP=0x00000000000a8266
...
- (id)initWithTraitCollection:(id)arg1;	// IMP=0x00000000000a816b
