...
+ (id)brc_pendingPlaceholderForPackage:(_Bool)arg1;	// IMP=0x002000000005e4eb
...
- (id)brc_SHA256WithSalt:(id)arg1;	// IMP=0x0010000000173f28
- (id)brc_hexadecimalString;	// IMP=0x0010000000173ecd
