...
- (void).cxx_destruct;	// IMP=0x0020000000022922
...
- (void)URLSession:(id)arg1 task:(id)arg2 didCompleteWithError:(id)arg3;	// IMP=0x0010000000022624
- (void)URLSession:(id)arg1 dataTask:(id)arg2 didReceiveData:(id)arg3;	// IMP=0x00100000000223ea
- (void)URLSession:(id)arg1 dataTask:(id)arg2 didReceiveResponse:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x0010000000021e7a
- (long long)versionFromTask:(id)arg1;	// IMP=0x0010000000021e1e
- (void)updateDb:(long long)arg1;	// IMP=0x0010000000021bcd
- (void)reschedule;	// IMP=0x0010000000021acf
