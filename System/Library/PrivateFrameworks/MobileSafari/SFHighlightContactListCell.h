...
- (void).cxx_destruct;	// IMP=0x00000000000444fc
...
- (void)_didReceiveTap:(id)arg1;	// IMP=0x0000000000044440
- (void)_updateMaskedCorners;	// IMP=0x00000000000443d2
- (void)setHighlighted:(_Bool)arg1;	// IMP=0x00000000000442ce
- (id)initWithContact:(id)arg1;	// IMP=0x000000000004320c
