...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000014a1f
...
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000014b19
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000014a27
@property(retain, nonatomic) NSString *deviceIdentifier;
@property(retain, nonatomic) NSString *bundleIdentifier;
@property(retain, nonatomic) NSString *sensor;
- (void)dealloc;	// IMP=0x0000000000014958
- (id)init;	// IMP=0x000000000001490c
