...
@class IDSPseudonym, IDSURI, MISSING_TYPE, NSArray, NSData, NSDictionary, NSError, NSNumber, NSObject, NSSet, NSString, NSUUID;
...
- (void)didSwitchActivePairedDevice:(NSString *)arg1 forService:(NSString *)arg2 wasHandled:(_Bool *)arg3;
...
- (MISSING_TYPE *)session:shouldInvalidateKeyMaterialByKeyIndexes: /* Error: Ran out of types for this method. */;
- (void)session:(NSString *)arg1 didReceiveURIsForParticipantIDs:(NSDictionary *)arg2 withRequestID:(NSUUID *)arg3;
- (void)session:(NSString *)arg1 rejectedKeyRecoveryRequestFromURI:(IDSURI *)arg2 reason:(unsigned int)arg3;
...
- (void)didFlushCacheFromKTPeerUpdateForService:(NSString *)arg1 peerURI:(NSString *)arg2;
