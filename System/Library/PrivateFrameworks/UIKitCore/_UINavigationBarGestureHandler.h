...
- (void).cxx_destruct;	// IMP=0x0000000000223e0a
...
- (void)_handlePopSwipe:(id)arg1;	// IMP=0x0000000000223c99
- (_Bool)_gestureRecognizerShouldBegin:(id)arg1;	// IMP=0x0000000000223beb
- (id)initWithNavigationBar:(id)arg1;	// IMP=0x0000000000223b29
