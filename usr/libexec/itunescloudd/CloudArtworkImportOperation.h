...
- (void).cxx_destruct;	// IMP=0x00200000000c817b
...
- (id)_resizedImageDataFromLocation:(id)arg1;	// IMP=0x00100000000c7d4c
- (void)cancel;	// IMP=0x00100000000c7cf3
- (void)start;	// IMP=0x00100000000c729f
- (id)description;	// IMP=0x00100000000c7211
- (void)callCompletionHandlers;	// IMP=0x00100000000c7082
- (void)addCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x00100000000c6fe4
- (id)initWithURLSession:(id)arg1 configuration:(id)arg2 cloudID:(unsigned long long)arg3 artworkToken:(id)arg4 artworkType:(long long)arg5 sourceType:(long long)arg6 clientIdentity:(id)arg7;	// IMP=0x00100000000c6ebb
