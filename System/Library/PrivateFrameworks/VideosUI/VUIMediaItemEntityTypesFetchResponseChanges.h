...
- (void).cxx_destruct;	// IMP=0x00000000002d4d5a
...
- (id)description;	// IMP=0x00000000002d4b8a
- (id)initWithMediaItemEntityTypesChangeSet:(id)arg1 localMediaItemsAvailableDidChange:(_Bool)arg2;	// IMP=0x00000000002d4b14
- (id)init;	// IMP=0x00000000002d4aa5
