...
- (void).cxx_destruct;	// IMP=0x00000000002e5425
...
- (id)MMCSOptions;	// IMP=0x00000000002e4510
- (_Bool)usesBackgroundSession;	// IMP=0x00000000002e44bf
- (id)description;	// IMP=0x00000000002e44ad
- (id)CKPropertiesDescription;	// IMP=0x00000000002e3fdd
- (id)initWithOperation:(id)arg1;	// IMP=0x00000000002e3bfd
