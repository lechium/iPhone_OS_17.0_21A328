...
+ (void)setHasShownCompatibilityAlert:(_Bool)arg1 forDSID:(id)arg2;	// IMP=0x0010000000042d77
+ (_Bool)hasShownCompatibilityAlertForDSID:(id)arg1;	// IMP=0x0010000000042cc4
...
- (unsigned long long)hash;	// IMP=0x0000000000043049
- (_Bool)isEqualToCommunicationLimits:(id)arg1;	// IMP=0x0000000000042f65
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000042efe
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000042eac
