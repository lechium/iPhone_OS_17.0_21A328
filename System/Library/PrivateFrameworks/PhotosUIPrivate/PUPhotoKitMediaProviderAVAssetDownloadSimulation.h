...
- (void).cxx_destruct;	// IMP=0x000000000042961c
...
- (void)endSimulationWithError:(id)arg1;	// IMP=0x00000000004293a5
- (void)updateSimulationWithProgress:(double)arg1;	// IMP=0x0000000000429301
- (void)_handleResultAVAsset:(id)arg1 audioMix:(id)arg2 info:(id)arg3;	// IMP=0x000000000042921f
- (id)init;	// IMP=0x0000000000429140
