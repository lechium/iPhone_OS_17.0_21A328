...
- (void).cxx_destruct;	// IMP=0x00200000002bfbb9
...
- (_Bool)isPrefightEnabledByServerBag;	// IMP=0x00100000002bf686
...
- (id);	// IMP=0x00100000002bf3d3
- (id)init;	// IMP=0x00100000002bf377
