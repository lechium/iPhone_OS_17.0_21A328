...
- (void).cxx_destruct;	// IMP=0x000000000003c9d5
...
- (void)updateWithTuples:(id)arg1 valueColumnIsTrailing:(_Bool)arg2 truncateKey:(_Bool)arg3;	// IMP=0x000000000003c23d
- (id)init;	// IMP=0x000000000003c16a
