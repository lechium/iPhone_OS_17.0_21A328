...
- (void).cxx_destruct;	// IMP=0x00000000001e4ac5
...
- (void)setCancellationHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000000001e4981
- (CDUnknownBlockType)cancellationHandler;	// IMP=0x00000000001e48c2
- (id)_handlePlaybackResponse:(id)arg1 withPlaybackCacheRequest:(id)arg2 error:(id *)arg3;	// IMP=0x00000000001e435a
- (id)_loadResultsFromServerObjectDatabaseAssets:(id)arg1 hlsAsset:(id)arg2 playbackAuthorizationToken:(id)arg3;	// IMP=0x00000000001e3bbe
- (id)_loadResultsFromServerObjectDatabaseAssetsWithMiniSinf:(id)arg1 playbackAuthorizationToken:(id)arg2;	// IMP=0x00000000001e3594
- (_Bool)_canRetrieveLoadResultsFromServerObjectDatabaseWithAssets:(id *)arg1 hlsAsset:(id *)arg2;	// IMP=0x00000000001e2fab
- (_Bool)_canRetrieveLoadResultsFromMiniSinfWithAssets:(id *)arg1;	// IMP=0x00000000001e2bd8
- (void)execute;	// IMP=0x00000000001e192a
- (void)cancel;	// IMP=0x00000000001e18ca
- (id)description;	// IMP=0x00000000001e1810
- (id)init;	// IMP=0x00000000001e17ac
