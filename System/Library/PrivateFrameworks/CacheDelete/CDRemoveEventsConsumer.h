...
- (void).cxx_destruct;	// IMP=0x000000000002bb64
...
- (void)consumeStream:(struct __FSEventStream *)arg1 forVolume:(id)arg2;	// IMP=0x000000000002b5bf
- (void)callback:(id)arg1;	// IMP=0x000000000002a8d3
- (void)dealloc;	// IMP=0x000000000002a85c
- (id)initWithConsumer:(CDUnknownBlockType)arg1 identifier:(id)arg2;	// IMP=0x000000000002a76f
