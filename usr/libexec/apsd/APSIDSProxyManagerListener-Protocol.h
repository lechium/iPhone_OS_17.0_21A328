...
@optional
- (void)proxyManager:(APSIDSProxyManager *)arg1 handlePubSubUpdateMessage:(NSDictionary *)arg2 connectionType:(long long)arg3 environmentName:(NSString *)arg4 guid:(NSString *)arg5;
...
- (void)proxyManager:(APSIDSProxyManager *)arg1 sendPubSubChannelList:(NSData *)arg2 messageID:(unsigned int)arg3 token:(NSData *)arg4 connectionType:(long long)arg5 environmentName:(NSString *)arg6 guid:(NSString *)arg7;
...
- (void)proxyManager:(APSIDSProxyManager *)arg1 expiredNonceWithServerTime:(NSNumber *)arg2 shouldRollToken:(_Bool)arg3 guid:(NSString *)arg4 environmentName:(NSString *)arg5;
...
- (void)proxyManager:(APSIDSProxyManager *)arg1 receivedPushAckResponse:(NSNumber *)arg2 messageId:(NSData *)arg3 token:(NSData *)arg4 connectionType:(NSNumber *)arg5 generation:(NSNumber *)arg6 guid:(NSString *)arg7 environmentName:(NSString *)arg8;
- (void)proxyManager:(APSIDSProxyManager *)arg1 receivedPush:(NSDictionary *)arg2 connectionType:(NSNumber *)arg3 generation:(NSNumber *)arg4 guid:(NSString *)arg5 environmentName:(NSString *)arg6;
