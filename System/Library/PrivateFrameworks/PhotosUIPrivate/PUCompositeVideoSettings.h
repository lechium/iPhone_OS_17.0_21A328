...
+ (id)settingsControllerModule;	// IMP=0x006000000053c4d8
+ (id)sharedInstance;	// IMP=0x006000000053c4a8
...
- (void)setDefaultValues;	// IMP=0x000000000053c8fe
- (id)parentSettings;	// IMP=0x000000000053c8e5
