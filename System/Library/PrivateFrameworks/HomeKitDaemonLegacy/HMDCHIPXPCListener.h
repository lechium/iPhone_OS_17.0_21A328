...
+ (id)logCategory;	// IMP=0x0010000000038f9b
- (void).cxx_destruct;	// IMP=0x0000000000038e48
...
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x0000000000038960
- (id)createClientConnectionWithRemoteObjectProxy:(id)arg1 homeManager:(id)arg2 pid:(int)arg3;	// IMP=0x00000000000388ad
- (void)stop;	// IMP=0x0000000000038870
- (void)start;	// IMP=0x0000000000038777
- (id)initWithHomeManager:(id)arg1;	// IMP=0x00000000000385bf
