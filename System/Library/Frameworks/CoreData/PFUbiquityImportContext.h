...
- (void)dealloc;	// IMP=0x00000000002e0bd7
- (id)initWithStack:(id)arg1 andStoreMetadata:(id)arg2;	// IMP=0x00000000002e0b8a
- (id)initWithStoreName:(id)arg1 andUbiquityRootLocation:(id)arg2 withLocalPeerID:(id)arg3;	// IMP=0x00000000002e0af9
- (id)init;	// IMP=0x00000000002e0a90
