...
+ (id)_changeSetFromMediaItemEntityTypes:(id)arg1 toMediaItemEntityTypes:(id)arg2;	// IMP=0x006000000015d94a
- (void).cxx_destruct;	// IMP=0x000000000015da62
...
- (void)executionDidBegin;	// IMP=0x000000000015d55f
- (id)initWithMediaLibrary:(id)arg1 fetchReason:(long long)arg2;	// IMP=0x000000000015d51b
- (id)initWithMediaLibrary:(id)arg1;	// IMP=0x000000000015d4ac
