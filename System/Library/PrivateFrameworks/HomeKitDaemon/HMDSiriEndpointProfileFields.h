...
- (void).cxx_destruct;	// IMP=0x0000000000816348
...
- (id)attributeDescriptions;	// IMP=0x0000000000815faf
- (id)serializeFields;	// IMP=0x0000000000815db6
- (id)initWithNeedsOnboardingField:(id)arg1 supportsOnboardingField:(id)arg2 siriEnableField:(id)arg3 siriListeningField:(id)arg4 siriTouchToUseField:(id)arg5 siriLightOnUseField:(id)arg6 siriSoundOnUseField:(id)arg7;	// IMP=0x0000000000815ba3
