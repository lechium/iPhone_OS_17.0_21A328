...
- (void).cxx_destruct;	// IMP=0x00200000001ed91e
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000001ed071
- (unsigned long long)hash;	// IMP=0x00100000001eca48
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000001ec20d
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000001ebc3e
- (void)copyTo:(id)arg1;	// IMP=0x00100000001eb730
- (void)writeTo:(id)arg1;	// IMP=0x00100000001eb1e7
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000001eb1da
- (id)dictionaryRepresentation;	// IMP=0x00100000001ea563
- (id)description;	// IMP=0x00100000001ea4b4
...
// Error: Property attributes should begin with the type ('T') attribute, property name: hasNetworkHostname
