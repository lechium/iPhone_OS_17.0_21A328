...
+ (Class)placesType;	// IMP=0x0020000000015f46
- (void).cxx_destruct;	// IMP=0x0020000000018458
...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000001802f
- (unsigned long long)hash;	// IMP=0x001000000001792a
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000001763a
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000017297
- (void)copyTo:(id)arg1;	// IMP=0x0010000000017041
- (void)writeTo:(id)arg1;	// IMP=0x0010000000016d61
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000016d54
- (id)dictionaryRepresentation;	// IMP=0x0010000000016006
- (id)description;	// IMP=0x0010000000015f57
- (id)placesAtIndex:(unsigned long long)arg1;	// IMP=0x0010000000015f29
- (unsigned long long)placesCount;	// IMP=0x0010000000015f0c
- (void)addPlaces:(id)arg1;	// IMP=0x0010000000015ea2
- (void)clearPlaces;	// IMP=0x0010000000015e85
- (int)StringAsDirectionsMode:(id)arg1;	// IMP=0x0010000000015db3
- (id)directionsModeAsString:(int)arg1;	// IMP=0x0010000000015d6a
...
- (int)StringAsType:(id)arg1;	// IMP=0x001000000001596d
- (id)typeAsString:(int)arg1;	// IMP=0x0010000000015924
