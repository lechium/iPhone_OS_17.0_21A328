...
- (void).cxx_destruct;	// IMP=0x00200000001aa190
...
- (void)updateProductID:(unsigned int)arg1;	// IMP=0x00100000001a9d84
- (void)handleCancelButton:(id)arg1;	// IMP=0x00100000001a9cc3
- (void)handleJoinButton:(id)arg1;	// IMP=0x00100000001a9c02
- (void)viewDidDisappear:(_Bool)arg1;	// IMP=0x00100000001a9b80
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x00100000001a98ca
- (id)presentationControllerForPresentedViewController:(id)arg1 presentingViewController:(id)arg2 sourceViewController:(id)arg3;	// IMP=0x00100000001a9839
