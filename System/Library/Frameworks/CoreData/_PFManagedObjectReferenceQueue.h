...
- (void)dealloc;	// IMP=0x00000000000f1e2b
- (_Bool)_isDeallocating;	// IMP=0x00000000000f1e02
- (_Bool)_tryRetain;	// IMP=0x00000000000f1dfa
- (unsigned long long)retainCount;	// IMP=0x00000000000f1ded
- (oneway void)release;	// IMP=0x00000000000f1dbf
- (id)retain;	// IMP=0x00000000000f1db2
