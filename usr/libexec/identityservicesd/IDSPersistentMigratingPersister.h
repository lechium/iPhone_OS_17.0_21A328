...
- (void).cxx_destruct;	// IMP=0x0020000000353d49
...
- (void)purgeData;	// IMP=0x0010000000353b88
- (void)saveData:(id)arg1 allowBackup:(_Bool)arg2;	// IMP=0x0010000000353ad8
- (id)data;	// IMP=0x0010000000353a8e
@property(readonly, nonatomic) _Bool isAvailable;
@property(readonly, nonatomic) NSString *identifier;
@property(readonly, copy) NSString *description;
- (id)initWithOriginPersister:(id)arg1 destinationPersister:(id)arg2 userDefaults:(id)arg3;	// IMP=0x001000000035386b
- (id)initWithOriginPersister:(id)arg1 destinationPersister:(id)arg2;	// IMP=0x00100000003537d4
