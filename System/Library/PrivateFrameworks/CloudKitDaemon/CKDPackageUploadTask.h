...
- (void).cxx_destruct;	// IMP=0x000000000032219f
...
- (void)cancel;	// IMP=0x00000000003220b5
...
- (id)activityCreate;	// IMP=0x0000000000321e49
- (id)initWithPackage:(id)arg1 trackProgress:(_Bool)arg2;	// IMP=0x0000000000321ca3
