...
- (void).cxx_destruct;	// IMP=0x000000000001a722
- (void)forwardInvocation:(id)arg1;	// IMP=0x000000000001a64a
- (id)methodSignatureForSelector:(SEL)arg1;	// IMP=0x000000000001a631
- (void)updateWithInfo:(id)arg1;	// IMP=0x0000000000019741
- (void)finalUpdate;	// IMP=0x000000000001961d
- (void)endChatWithReason:(unsigned int)arg1;	// IMP=0x000000000001946e
- (void)endChat;	// IMP=0x00000000000193ce
- (void)declineInvitation;	// IMP=0x000000000001929d
- (void)cancelInvitation;	// IMP=0x000000000001916c
- (void)acceptInvitation;	// IMP=0x000000000001903b
- (void)invite:(id)arg1 additionalPeers:(id)arg2 excludingPushTokens:(id)arg3;	// IMP=0x0000000000018e07
- (void)invite:(id)arg1 additionalPeers:(id)arg2;	// IMP=0x0000000000018df2
- (void)inviteAll;	// IMP=0x0000000000018cc1
- (_Bool)_isCallUpgradeTo:(id)arg1;	// IMP=0x0000000000018c14
...
- (_Bool)_isProxy;	// IMP=0x0000000000018235
...
- (void)setLocalAspectRatio:(struct CGSize)arg1 cameraOrientation:(unsigned int)arg2 cameraType:(unsigned int)arg3;	// IMP=0x0000000000017b38
...
- (id)account;	// IMP=0x00000000000175fe
- (id)description;	// IMP=0x0000000000017428
