...
- (void).cxx_destruct;	// IMP=0x002000000004699a
...
- (id)description;	// IMP=0x00100000000468b1
- (void)reset;	// IMP=0x001000000004688f
- (void)close;	// IMP=0x0010000000046865
- (void)dealloc;	// IMP=0x0010000000046827
