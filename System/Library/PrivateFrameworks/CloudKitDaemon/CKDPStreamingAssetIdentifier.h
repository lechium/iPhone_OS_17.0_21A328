...
- (void).cxx_destruct;	// IMP=0x00000000000c7da6
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000000c7cb4
- (unsigned long long)hash;	// IMP=0x00000000000c7c47
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000c7b67
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000c7aa3
- (void)copyTo:(id)arg1;	// IMP=0x00000000000c7a20
- (void)writeTo:(id)arg1;	// IMP=0x00000000000c79a6
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000000c7999
- (id)dictionaryRepresentation;	// IMP=0x00000000000c7763
- (id)description;	// IMP=0x00000000000c76b4
