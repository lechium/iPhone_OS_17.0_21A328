...
- (void).cxx_destruct;	// IMP=0x000000000008d412
...
- (id)rightAccessory;	// IMP=0x000000000008d266
- (id)leftAccessory;	// IMP=0x000000000008d222
- (id)rightIcon;	// IMP=0x000000000008d1de
- (id)leftIcon;	// IMP=0x000000000008d19a
- (id)initWithPlatform:(long long)arg1 sizeClass:(unsigned long long)arg2 fontScalingFactor:(double)arg3;	// IMP=0x000000000008c4dd
