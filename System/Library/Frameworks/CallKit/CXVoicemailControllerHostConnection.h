...
- (oneway void)requestTransaction:(id)arg1 reply:(CDUnknownBlockType)arg2;	// IMP=0x00000000000565d5
- (oneway void)requestVoicemails:(CDUnknownBlockType)arg1;	// IMP=0x00000000000564c8
- (oneway void)removeVoicemails:(id)arg1;	// IMP=0x000000000005645f
- (oneway void)addOrUpdateVoicemails:(id)arg1;	// IMP=0x00000000000563f6
...
- (void)dealloc;	// IMP=0x000000000005623f
- (id)initWithConnection:(id)arg1 serialQueue:(id)arg2;	// IMP=0x0000000000055b3d
- (id)init;	// IMP=0x0000000000055b2f
