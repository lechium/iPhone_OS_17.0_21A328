...
- (void).cxx_destruct;	// IMP=0x0000000000058fab
...
- (_Bool)_isWindowSceneAvailable;	// IMP=0x0000000000058e99
- (void)_updatePreferredDisplayCriteria;	// IMP=0x0000000000058dd0
@property(readonly, nonatomic) struct CGRect sceneBounds;
- (_Bool)isAvailable;	// IMP=0x0000000000058d2d
- (void)setState:(long long)arg1;	// IMP=0x0000000000058aed
- (void)connectWithSecondScreenConnection:(id)arg1;	// IMP=0x00000000000585f6
- (void)dealloc;	// IMP=0x00000000000584ef
- (id)initWithScene:(id)arg1;	// IMP=0x00000000000581ab
