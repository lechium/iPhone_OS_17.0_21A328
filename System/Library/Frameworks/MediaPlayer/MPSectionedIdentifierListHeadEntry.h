...
+ (id)headEntryWithSectionIdentifier:(id)arg1;	// IMP=0x0010000000079e7c
- (void).cxx_destruct;	// IMP=0x0000000000079e29
...
- (void)setBranchDepth:(long long)arg1;	// IMP=0x0000000000079d33
- (id)nextEntries;	// IMP=0x0000000000079c8c
@property(readonly, nonatomic) long long entryType;
@property(readonly, copy) NSString *description;
- (id)initWithPositionKey:(id)arg1 sectionIdentifier:(id)arg2;	// IMP=0x0000000000079b21
