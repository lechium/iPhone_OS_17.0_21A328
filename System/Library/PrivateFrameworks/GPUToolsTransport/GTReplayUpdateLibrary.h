...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000005556
- (void).cxx_destruct;	// IMP=0x0000000000005878
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000056d2
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000000555e
