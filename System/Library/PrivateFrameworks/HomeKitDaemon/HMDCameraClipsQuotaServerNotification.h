...
- (void).cxx_destruct;	// IMP=0x00000000007892c9
...
- (id)initWithDictionaryRepresentation:(id)arg1;	// IMP=0x0000000000788f55
- (id)initWithContainerIdentifier:(id)arg1 reason:(long long)arg2 requestID:(id)arg3 userDSID:(id)arg4;	// IMP=0x0000000000788e14
