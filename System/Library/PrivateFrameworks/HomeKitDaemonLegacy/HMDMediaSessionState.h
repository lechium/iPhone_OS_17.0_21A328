...
- (void).cxx_destruct;	// IMP=0x0000000000696d27
@property(readonly, copy, nonatomic) NSString *sessionIdentifier; // @synthesize sessionIdentifier=_sessionIdentifier;
- (id)dumpState;	// IMP=0x0000000000696b7d
@property(readonly, copy) NSString *description;
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000006967cb
...
- (id)initWithSessionIdentifier:(id)arg1;	// IMP=0x00000000006962bc
