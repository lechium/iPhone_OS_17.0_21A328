...
- (void).cxx_destruct;	// IMP=0x000000000039e905
...
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x000000000039e7ec
- (void)setBackgroundColor:(id)arg1;	// IMP=0x000000000039e75e
- (void)layoutSubviews;	// IMP=0x000000000039e50c
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000039e389
