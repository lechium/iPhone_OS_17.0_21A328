...
+ (id)traceIntervalWithName:(id)arg1 item:(id)arg2 beginEvent:(unsigned int)arg3 endEvent:(unsigned int)arg4;	// IMP=0x00600000002cfa49
+ (void)traceWithName:(id)arg1 item:(id)arg2 event:(unsigned int)arg3;	// IMP=0x00600000002cf965
- (void).cxx_destruct;	// IMP=0x00000000002cf93f
...
- (void)cancel;	// IMP=0x00000000002cf72d
- (void)endInterval;	// IMP=0x00000000002cf59b
- (void)dealloc;	// IMP=0x00000000002cf55d
