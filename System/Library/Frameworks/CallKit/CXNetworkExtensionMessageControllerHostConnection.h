...
- (void).cxx_destruct;	// IMP=0x000000000005a63f
...
- (void)sendNetworkExtensionPushToTalkMessage:(id)arg1 forBundleIdentifier:(id)arg2 reply:(CDUnknownBlockType)arg3;	// IMP=0x000000000005a3f5
- (void)sendNetworkExtensionMessage:(id)arg1 forBundleIdentifier:(id)arg2 reply:(CDUnknownBlockType)arg3;	// IMP=0x000000000005a288
- (void)invalidate;	// IMP=0x000000000005a228
...
- (void)dealloc;	// IMP=0x000000000005a146
- (id)initWithConnection:(id)arg1;	// IMP=0x0000000000059d05
