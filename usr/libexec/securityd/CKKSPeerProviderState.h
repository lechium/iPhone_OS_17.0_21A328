...
+ (id)createFromProvider:(id)arg1;	// IMP=0x004000000014e937
+ (id)noPeersState:(id)arg1;	// IMP=0x001000000014e821
- (void).cxx_destruct;	// IMP=0x002000000014e7cd
...
- (_Bool);	// IMP=0x001000000014e787
@property(retain) NSString *peerProviderID; // @synthesize peerProviderID=_peerProviderID;
- (_Bool)unwrapKey:(id)arg1 fromShares:(id)arg2 error:(id *)arg3;	// IMP=0x001000000014d7e8
- (id)description;	// IMP=0x001000000014d6bb
- (id)initWithPeerProviderID:(id)arg1 essential:(_Bool)arg2 selfPeers:(id)arg3 selfPeersError:(id)arg4 trustedPeers:(id)arg5 trustedPeersError:(id)arg6;	// IMP=0x001000000014d3cb
