...
- (void).cxx_destruct;	// IMP=0x0000000000865b3b
...
- (id)initWithTrustActivityType:(long long)arg1 privilege:(unsigned long long)arg2 isPrimaryResident:(_Bool)arg3;	// IMP=0x00000000008658e7
