...
- (void).cxx_destruct;	// IMP=0x002000000000e34b
...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000000e19d
- (unsigned long long)hash;	// IMP=0x001000000000e0ef
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000000dfb5
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000000de8f
- (void)copyTo:(id)arg1;	// IMP=0x001000000000ddcc
- (void)writeTo:(id)arg1;	// IMP=0x001000000000dcf4
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000000d9c1
- (id)dictionaryRepresentation;	// IMP=0x001000000000d7b2
- (id)description;	// IMP=0x001000000000d703
...
- (int)StringAsChangeType:(id)arg1;	// IMP=0x001000000000d627
- (id)changeTypeAsString:(int)arg1;	// IMP=0x001000000000d5dc
