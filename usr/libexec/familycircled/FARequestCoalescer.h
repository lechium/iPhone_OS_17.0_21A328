...
+ (id)sharedInstance;	// IMP=0x00400000000172d0
- (void).cxx_destruct;	// IMP=0x0020000000017903
...
- (id)performBlockForKey:(id)arg1 force:(_Bool)arg2 block:(CDUnknownBlockType)arg3;	// IMP=0x00100000000173be
- (id)init;	// IMP=0x0010000000017325
