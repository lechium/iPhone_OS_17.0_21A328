...
- (void).cxx_destruct;	// IMP=0x0020000000046f1e
...
- (void)begin:(id)arg1;	// IMP=0x00000000000461c7
- (void)cancel;	// IMP=0x00100000000461bd
- (id)initWithStore:(id)arg1;	// IMP=0x001000000004614a
