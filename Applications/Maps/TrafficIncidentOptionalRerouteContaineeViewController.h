...
- (void).cxx_destruct;	// IMP=0x002000000030e40d
...
- (void)userDecisionConfirmationViewDidConfirm:(id)arg1;	// IMP=0x001000000030e1c8
- (void)userDecisionConfirmationViewDidCancel:(id)arg1;	// IMP=0x001000000030dfaf
- (double)heightForLayout:(unsigned long long)arg1;	// IMP=0x001000000030defe
@property(nonatomic) _Bool progressBarHidden;
@property(nonatomic) double rerouteTimerProgress;
- (void)_setupConstraints;	// IMP=0x001000000030daad
- (void)viewDidLoad;	// IMP=0x001000000030d9d5
- (id)initWithNibName:(id)arg1 bundle:(id)arg2;	// IMP=0x001000000030d9a6
- (_Bool)_canShowWhileLocked;	// IMP=0x001000000030d99e
