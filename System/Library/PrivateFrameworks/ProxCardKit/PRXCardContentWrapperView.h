...
- (void).cxx_destruct;	// IMP=0x00000000000096fd
...
- (void)didChangeContentsOfBottomTray:(id)arg1;	// IMP=0x00000000000094ec
@property(copy, nonatomic) NSArray *actionButtons;
@property(readonly, copy, nonatomic) NSArray *auxiliaryViews;
- (void)scrollViewDidScroll:(id)arg1;	// IMP=0x000000000000902c
- (void)removeBottomTray;	// IMP=0x0000000000008fef
- (void)scrollToBottom;	// IMP=0x0000000000008b99
- (void)setContentOffset:(struct CGPoint)arg1 animated:(_Bool)arg2;	// IMP=0x0000000000008b38
- (struct CGSize)intrinsicContentSize;	// IMP=0x0000000000008a1a
- (struct CGSize)systemLayoutSizeFittingSize:(struct CGSize)arg1 withHorizontalFittingPriority:(float)arg2 verticalFittingPriority:(float)arg3;	// IMP=0x0000000000008997
- (void)layoutSubviews;	// IMP=0x0000000000008577
- (id)initWithContentView:(id)arg1;	// IMP=0x0000000000006a8c
