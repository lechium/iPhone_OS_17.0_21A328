...
- (void).cxx_destruct;	// IMP=0x00000000009c884f
...
- (id)mainReturningError;	// IMP=0x00000000009c869a
- (id)initWithHomeManager:(id)arg1 reason:(id)arg2 incrementGeneration:(_Bool)arg3;	// IMP=0x00000000009c85d6
