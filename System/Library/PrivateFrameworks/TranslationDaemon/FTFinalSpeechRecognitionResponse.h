...
- (void).cxx_destruct;	// IMP=0x00000000000b8b3f
- (id)flatbuffData;	// IMP=0x00000000000b89b8
- (Offset_53990046)addObjectToBuffer:(void *)arg1;	// IMP=0x00000000000b8577
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000b7fb6
- (id)initWithFlatbuffData:(id)arg1 root:(const struct FinalSpeechRecognitionResponse *)arg2 verify:(_Bool)arg3;	// IMP=0x00000000000b7e0b
- (id)initWithFlatbuffData:(id)arg1 root:(const struct FinalSpeechRecognitionResponse *)arg2;	// IMP=0x00000000000b7df6
- (id)initAndVerifyWithFlatbuffData:(id)arg1;	// IMP=0x00000000000b7ddc
- (id)initWithFlatbuffData:(id)arg1;	// IMP=0x00000000000b7dc5
