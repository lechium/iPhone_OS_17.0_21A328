...
@interface PDFDocumentPrivate : NSObject
{
    ...
    _Bool respondsToShouldReadAKInkAnnotations;	// 99 = 0x63
    _Bool respondsToHandleTabFrom;	// 100 = 0x64
    _Bool respondsToDidReceiveAnalysis;	// 101 = 0x65
    ...
    _Bool documentHasPageWithApplicationData;	// 336 = 0x150
    struct {
        _Bool pagesAdded;
        _Bool blankPagesAdded;
        _Bool pagesRemoved;
        _Bool pagesExchanged;
    } pagesChanged;	// 337 = 0x151
