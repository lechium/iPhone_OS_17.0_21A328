...
- (void).cxx_destruct;	// IMP=0x000000000003ef98
...
- (void)close;	// IMP=0x000000000003eea7
- (void)updateIconBorderColor;	// IMP=0x000000000003ecfe
- (void)updateIconBorderWidth;	// IMP=0x000000000003ebeb
- (void)layoutSubviews;	// IMP=0x000000000003eaef
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x000000000003e8ec
- (id)initWithIcon:(id)arg1 closeButton:(id)arg2 title:(id)arg3 subtitle:(id)arg4;	// IMP=0x000000000003d3b9
- (id)initWithRequest:(id)arg1;	// IMP=0x000000000003cf5b
