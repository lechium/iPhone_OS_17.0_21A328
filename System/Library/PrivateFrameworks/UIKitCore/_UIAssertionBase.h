...
- (void).cxx_destruct;	// IMP=0x0000000000ab4dc9
...
- (void)dealloc;	// IMP=0x0000000000ab4ca6
@property(readonly, copy) NSString *description;
- (void)_invalidate;	// IMP=0x0000000000ab4b7d
- (id)_initWithType:(unsigned long long)arg1 initialState:(_Bool)arg2 reason:(id)arg3 requiresExplicitInvalidation:(_Bool)arg4;	// IMP=0x0000000000ab4ae4
