...
- (void).cxx_destruct;	// IMP=0x000000000004e3e4
...
- (_Bool)gestureRecognizer:(id)arg1 shouldRecognizeSimultaneouslyWithGestureRecognizer:(id)arg2;	// IMP=0x000000000004e380
- (void)reset;	// IMP=0x000000000004e344
- (void)setOverlayImageOpacity:(double)arg1;	// IMP=0x000000000004e30b
@property(nonatomic, getter=isRotationEnabled) _Bool rotationEnabled;
- (void)handlePinchGesture:(id)arg1;	// IMP=0x000000000004e14a
- (void)handlePanGesture:(id)arg1;	// IMP=0x000000000004defd
- (void)handleRotateGesture:(id)arg1;	// IMP=0x000000000004de68
- (void)layoutSubviews;	// IMP=0x000000000004d995
- (id)initWithBackgroundImage:(id)arg1 overlayImage:(id)arg2 transform:(id)arg3;	// IMP=0x000000000004d6c8
