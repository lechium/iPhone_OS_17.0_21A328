...
+ (id)responseWithResponse:(id)arg1 transaction:(id)arg2;	// IMP=0x006000000001ba62
- (void).cxx_destruct;	// IMP=0x000000000001bc9e
...
- (void)deserializeResponseBodyWithTransaction:(id)arg1;	// IMP=0x000000000001bad6
