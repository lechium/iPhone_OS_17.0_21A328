...
- (void).cxx_destruct;	// IMP=0x00200000000ec879
...
- (id)_localizedStringForKey:(id)arg1;	// IMP=0x00100000000ec7be
- (void)previousSegment;	// IMP=0x00100000000ec732
- (void)nextSegment;	// IMP=0x00100000000ec6bf
...
- (id)initWithSegments:(id)arg1;	// IMP=0x00100000000ec464
