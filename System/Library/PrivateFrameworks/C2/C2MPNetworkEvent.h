...
+ (Class)networkPathInfoType;	// IMP=0x001000000000877a
- (void).cxx_destruct;	// IMP=0x000000000000e751
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000000db0f
- (unsigned long long)hash;	// IMP=0x000000000000d3ba
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000000ca39
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000000c201
- (void)copyTo:(id)arg1;	// IMP=0x000000000000bbb7
- (void)writeTo:(id)arg1;	// IMP=0x000000000000b4b5
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000000b4a8
- (id)dictionaryRepresentation;	// IMP=0x0000000000008f11
- (id)description;	// IMP=0x0000000000008e62
...
- (id)networkPathInfoAtIndex:(unsigned long long)arg1;	// IMP=0x000000000000875d
- (unsigned long long)networkPathInfosCount;	// IMP=0x0000000000008740
- (void)addNetworkPathInfo:(id)arg1;	// IMP=0x00000000000086d6
- (void)clearNetworkPathInfos;	// IMP=0x00000000000086b9
