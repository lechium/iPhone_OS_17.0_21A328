...
@interface SUUIAttributedStringLayoutRequest : NSObject
{
...
- (void).cxx_destruct;	// IMP=0x00000000000e4d97
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000e4cde
- (id)initWithAttributedString:(id)arg1;	// IMP=0x00000000000e4c6b
