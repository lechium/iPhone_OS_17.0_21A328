...
+ (id)sharedCryptographer;	// IMP=0x0060000000110b45
- (void).cxx_destruct;	// IMP=0x00000000001112c3
...
- (id)stringDigestForName:(id)arg1;	// IMP=0x0000000000110f4a
@property(readonly, nonatomic) NSData *deviceSalt;
- (void)prewarmDeviceSalt;	// IMP=0x0000000000110bf2
- (id)init;	// IMP=0x0000000000110b9a
