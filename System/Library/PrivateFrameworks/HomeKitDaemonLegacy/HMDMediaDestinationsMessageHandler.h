...
- (void).cxx_destruct;	// IMP=0x00000000008fb16b
...
- (void)handleUpdatedDestination:(id)arg1;	// IMP=0x00000000008fb07a
- (void)handleMediaDestinationUpdatedNotification:(id)arg1;	// IMP=0x00000000008fac7b
- (id)initWithDestination:(id)arg1 messageDispatcher:(id)arg2 notificationCenter:(id)arg3 dataSource:(id)arg4 delegate:(id)arg5;	// IMP=0x00000000008fab07
