...
- (void).cxx_destruct;	// IMP=0x00000000000e3a27
...
- (void)tearDownObservations;	// IMP=0x00000000000e38c6
- (void)setupObservations;	// IMP=0x00000000000e36ad
- (void)restoreSessionSettingsFromSnapshot;	// IMP=0x00000000000e363f
- (void)snapshotSessionSettings;	// IMP=0x00000000000e3550
- (void)updateAudioSession:(id)arg1 options:(unsigned long long)arg2 routeSharingPolicy:(unsigned long long)arg3;	// IMP=0x00000000000e34c4
- (void)dealloc;	// IMP=0x00000000000e3486
- (id)init;	// IMP=0x00000000000e33f9
