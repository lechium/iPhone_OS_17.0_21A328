...
+ (id)faceTimeAppUUID;	// IMP=0x002000000007e870
- (void).cxx_destruct;	// IMP=0x00200000000832bf
...
- (void)conference:(id)arg1 didReceiveData:(id)arg2 forCallID:(long long)arg3;	// IMP=0x0010000000083010
- (void)conference:(id)arg1 changedBytesOfDataUsed:(long long)arg2;	// IMP=0x0010000000082fae
- (void)conference:(id)arg1 outputLevelChangedTo:(float)arg2;	// IMP=0x0010000000082f47
- (void)conference:(id)arg1 inputLevelChangedTo:(float)arg2;	// IMP=0x0010000000082ee0
- (void)conference:(id)arg1 outputFrequencyLevelChangedTo:(id)arg2;	// IMP=0x0010000000082e66
- (void)conference:(id)arg1 inputFrequencyLevelChangedTo:(id)arg2;	// IMP=0x0010000000082dec
- (void)conference:(id)arg1 remoteMediaStalled:(_Bool)arg2;	// IMP=0x0010000000082d1c
- (void)remoteVideoPausedForConference:(id)arg1;	// IMP=0x0010000000082cc0
- (void)receivedFirstRemoteFrameForConference:(id)arg1;	// IMP=0x0010000000082ba9
- (void)sendingAudioChangedForConference:(id)arg1;	// IMP=0x0010000000082b4d
- (void)mutedChangedForConference:(id)arg1;	// IMP=0x0010000000082af1
- (void)conference:(id)arg1 endedWithReason:(long long)arg2 error:(id)arg3;	// IMP=0x00100000000829d5
- (void)conferenceStarted:(id)arg1;	// IMP=0x0010000000082751
- (void)conferenceFinishedPreparing:(id)arg1;	// IMP=0x0010000000082329
- (void)session:(id)arg1 receivedData:(id)arg2;	// IMP=0x0010000000082261
- (void)session:(id)arg1 receivedInvitationCancelWithData:(id)arg2;	// IMP=0x0010000000082197
- (void)session:(id)arg1 receivedInvitationDeclineWithData:(id)arg2;	// IMP=0x00100000000820cd
- (void)session:(id)arg1 receivedInvitationAcceptWithData:(id)arg2;	// IMP=0x00100000000817af
- (void)session:(id)arg1 endedWithReason:(int)arg2;	// IMP=0x0010000000081696
- (void)session:(id)arg1 invitationSentToPushTokens:(id)arg2 shouldBreakBeforeMake:(_Bool)arg3;	// IMP=0x0010000000081576
- (void)sessionStarted:(id)arg1;	// IMP=0x001000000008131b
- (void)_handlePushTokensInvited:(id)arg1 didSendInvitation:(_Bool)arg2 didCancelInvitation:(_Bool)arg3;	// IMP=0x00100000000811f2
- (void)setRemoteVideoPresentationState:(int)arg1;	// IMP=0x001000000008119a
- (void)setRemoteVideoPresentationSize:(struct CGSize)arg1;	// IMP=0x0010000000081141
- (void)prepareConference;	// IMP=0x0010000000080ea8
- (void)startConnectionWithTransport:(id)arg1;	// IMP=0x0010000000080d07
...
- (void)sendDataUnreliably:(id)arg1;	// IMP=0x001000000008068a
- (void)cancelInvitationWithLocalHangup;	// IMP=0x0010000000080591
- (void)cancelInvitationWithDeclinedElsewhere;	// IMP=0x0010000000080495
- (void)cancelInvitationWithAnsweredElsewhere;	// IMP=0x0010000000080399
- (void)end;	// IMP=0x001000000008009e
- (void)cancelOrDeclineInvitation;	// IMP=0x001000000007ff6b
- (void)answerWithVideoAspectRatioDescriptor:(id)arg1;	// IMP=0x001000000007fe65
- (void)startWithVideoAspectRatioDescriptor:(id)arg1 inviteCompletion:(CDUnknownBlockType)arg2;	// IMP=0x001000000007fd96
- (int)deviceRole;	// IMP=0x001000000007fd7d
- (id)capabilities;	// IMP=0x001000000007fb7c
- (void)_setLocalAspectRatiosForVideoAspectRatioDescriptor:(id)arg1;	// IMP=0x001000000007fa18
- (void)_setDateEndedIfNecessary;	// IMP=0x001000000007f7a2
...
- (id)initOutgoingWithSession:(id)arg1 UUID:(id)arg2 remoteHandle:(id)arg3 wantsVideo:(_Bool)arg4 isRelaying:(_Bool)arg5;	// IMP=0x001000000007ec6d
- (id)initIncomingWithSession:(id)arg1 remoteHandle:(id)arg2 wantsVideo:(_Bool)arg3 remoteInviteDictionary:(id)arg4;	// IMP=0x001000000007eb0e
- (id)initWithSession:(id)arg1 remoteHandle:(id)arg2 wantsVideo:(_Bool)arg3;	// IMP=0x001000000007e976
