...
- (void).cxx_destruct;	// IMP=0x000000000000e100
...
- (void)notify:(id)arg1;	// IMP=0x000000000000d7c7
- (id)description;	// IMP=0x000000000000d756
- (id)initWithDispatchQueue:(id)arg1 predicate:(id)arg2 block:(CDUnknownBlockType)arg3;	// IMP=0x000000000000d66b
