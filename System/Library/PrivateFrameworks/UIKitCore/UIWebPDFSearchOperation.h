...
- (void)cancel;	// IMP=0x000000000173d626
- (void)main;	// IMP=0x000000000173d4e7
- (void)_search;	// IMP=0x000000000173cd92
- (id)sanitizedAttributedStringForAttributedString:(id)arg1;	// IMP=0x000000000173ca59
- (struct __CTFont *)_fontWithPDFFont:(struct CGPDFFont *)arg1 size:(double)arg2;	// IMP=0x000000000173c713
- (void)_notifyDelegateOfStatus;	// IMP=0x000000000173c59c
- (_Bool)_hitSearchLimit;	// IMP=0x000000000173c571
- (void)dealloc;	// IMP=0x000000000173c509
- (id)init;	// IMP=0x000000000173c484
