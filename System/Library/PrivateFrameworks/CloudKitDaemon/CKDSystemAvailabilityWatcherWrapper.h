...
- (void).cxx_destruct;	// IMP=0x0000000000121497
...
- (id)description;	// IMP=0x0000000000121359
- (unsigned long long)hash;	// IMP=0x000000000012134f
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001212ca
- (void)postSystemAvailabilityChanged:(unsigned long long)arg1;	// IMP=0x0000000000121240
- (id)initWithDelegate:(id)arg1;	// IMP=0x00000000001211bd
