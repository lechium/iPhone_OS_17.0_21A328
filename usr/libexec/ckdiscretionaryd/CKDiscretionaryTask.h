...
- (void).cxx_destruct;	// IMP=0x002000000000475e
...
- (void)complete;	// IMP=0x001000000000441e
- (void)applicationNoLongerInForeground:(id)arg1;	// IMP=0x0010000000004169
- (void)applicationEnteredForeground:(id)arg1;	// IMP=0x0010000000003eb4
- (id)_schedulerTaskIdentifier;	// IMP=0x0010000000003db2
- (void)dealloc;	// IMP=0x0010000000003a9e
- (id)initWithConnection:(id)arg1 operationID:(id)arg2 group:(id)arg3 bundleID:(id)arg4 isSpringBoardApp:(_Bool)arg5 requiresPastBuddy:(_Bool)arg6 options:(id)arg7 schedulerClass:(Class)arg8 startHandler:(CDUnknownBlockType)arg9 suspendHandler:(CDUnknownBlockType)arg10;	// IMP=0x0010000000002a50
