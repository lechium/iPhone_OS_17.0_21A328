...
+ (id)controlLableTextByType:(long long)arg1 style:(id)arg2 available:(_Bool)arg3;	// IMP=0x0000000000ea12ac
- (void).cxx_destruct;	// IMP=0x0000000000ea2541
...
- (id)viewForLastBaselineLayout;	// IMP=0x0000000000ea23b5
- (id)viewForFirstBaselineLayout;	// IMP=0x0000000000ea23a0
- (_Bool)pointInside:(struct CGPoint)arg1 withEvent:(id)arg2;	// IMP=0x0000000000ea232d
- (unsigned int)_secureName;	// IMP=0x0000000000ea2313
- (void)configureSecurePasteButtonInRootView:(id)arg1;	// IMP=0x0000000000ea1eac
- (void)layoutControlForType:(long long)arg1 andStyling:(id)arg2;	// IMP=0x0000000000ea13ec
- (id)controlImageByType:(long long)arg1;	// IMP=0x0000000000ea1238
- (id)controlLabelImageNameByType:(long long)arg1 isRTL:(_Bool)arg2;	// IMP=0x0000000000ea11af
- (void)updateCoverWithTavelProcess:(double)arg1 isRTL:(_Bool)arg2;	// IMP=0x0000000000ea0e15
- (void)updateUndoControlStyle;	// IMP=0x0000000000ea0a6d
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x0000000000ea096b
- (id)initWithType:(long long)arg1 andStyling:(id)arg2;	// IMP=0x0000000000ea0559
