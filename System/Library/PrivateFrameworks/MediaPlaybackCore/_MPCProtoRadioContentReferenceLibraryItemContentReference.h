...
- (void).cxx_destruct;	// IMP=0x000000000025950a
- (unsigned long long)hash;	// IMP=0x00000000002590dc
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000258cfe
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000258a12
- (void)writeTo:(id)arg1;	// IMP=0x0000000000258784
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000258777
- (id)dictionaryRepresentation;	// IMP=0x000000000025822d
- (id)description;	// IMP=0x000000000025817e
