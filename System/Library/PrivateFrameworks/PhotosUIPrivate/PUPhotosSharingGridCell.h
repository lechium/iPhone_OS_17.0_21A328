...
- (void).cxx_destruct;	// IMP=0x0000000000480c28
...
- (void)setHighlighted:(_Bool)arg1;	// IMP=0x0000000000480b79
- (void)layoutSubviews;	// IMP=0x0000000000480a73
- (void)prepareForReuse;	// IMP=0x000000000048099d
- (void)_updateSubviewOrdering;	// IMP=0x0000000000480980
- (void)_updateHighlight;	// IMP=0x00000000004807e2
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000004806af
