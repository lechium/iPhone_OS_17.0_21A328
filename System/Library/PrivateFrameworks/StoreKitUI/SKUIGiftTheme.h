...
- (void).cxx_destruct;	// IMP=0x00000000000b0713
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000b057c
- (id)description;	// IMP=0x00000000000b04ea
- (id)initWithThemeDictionary:(id)arg1;	// IMP=0x00000000000b01c2
