...
+ (id)fromProto:(id)arg1;	// IMP=0x0060000000032df2
+ (id)toProto:(id)arg1;	// IMP=0x0060000000032bde
- (void).cxx_destruct;	// IMP=0x00000000000330ad
...
- (id)initWithDictionary:(id)arg1;	// IMP=0x00000000000328d6
- (id)init;	// IMP=0x00000000000328a7
