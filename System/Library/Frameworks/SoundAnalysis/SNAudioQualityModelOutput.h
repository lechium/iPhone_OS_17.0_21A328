...
- (void).cxx_destruct;	// IMP=0x000000000013669a
...
- (id)featureValueForName:(id)arg1;	// IMP=0x000000000013656b
@property(readonly, nonatomic) NSSet *featureNames;
- (id)initWithFinal_output:(id)arg1 classLabel:(id)arg2;	// IMP=0x00000000001364b2
