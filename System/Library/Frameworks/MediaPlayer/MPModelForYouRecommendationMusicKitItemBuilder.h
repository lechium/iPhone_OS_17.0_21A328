...
+ (id)allSupportedProperties;	// IMP=0x006000000024e973
- (void).cxx_destruct;	// IMP=0x000000000024e6c3
...
- (id)convertToStoreItemMetadataDictionary:(id)arg1;	// IMP=0x000000000024e4aa
- (id)storeItemMetadataWithMusicAPIMetadataDictionary:(id)arg1;	// IMP=0x000000000024e41d
- (id)modelObjectForRecommendationChildDictionary:(id)arg1 parentGroup:(id)arg2 subgroupsAccumulator:(id)arg3 userIdentity:(id)arg4;	// IMP=0x000000000024d89c
- (id)initWithRequestedPropertySet:(id)arg1 storeItemMetadataResults:(id)arg2 flatSectionedItems:(id)arg3 storeURLBag:(id)arg4 isListenNow:(_Bool)arg5;	// IMP=0x000000000024d797
