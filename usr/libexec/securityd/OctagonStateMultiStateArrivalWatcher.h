...
- (void).cxx_destruct;	// IMP=0x00200000000cb253
...
- (void)completeWithErrorIfPending:(id)arg1;	// IMP=0x00100000000cb0b9
- (void)onqueueStartFinishOperation:(id)arg1;	// IMP=0x00100000000cafaf
- (id)timeout:(unsigned long long)arg1;	// IMP=0x00100000000caec8
- (void)_onqueuePerformTimeoutWithUnderlyingError;	// IMP=0x00100000000cad89
- (void)onqueueEnterState:(id)arg1;	// IMP=0x00100000000caca8
- (void)onqueueHandleTransition:(id)arg1;	// IMP=0x00100000000cac10
- (id)description;	// IMP=0x00100000000cab53
- (id)initNamed:(id)arg1 serialQueue:(id)arg2 states:(id)arg3 failStates:(id)arg4;	// IMP=0x00100000000ca9a4
- (id)initNamed:(id)arg1 serialQueue:(id)arg2 states:(id)arg3;	// IMP=0x00100000000ca98b
