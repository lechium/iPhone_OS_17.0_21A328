...
- (void).cxx_destruct;	// IMP=0x0000000000103111
...
- (void)_onPan:(id)arg1;	// IMP=0x0000000000102d52
- (_Bool)gestureRecognizer:(id)arg1 shouldRecognizeSimultaneouslyWithGestureRecognizer:(id)arg2;	// IMP=0x0000000000102cc1
- (id)initWithTarget:(id)arg1 action:(SEL)arg2;	// IMP=0x0000000000102bf4
