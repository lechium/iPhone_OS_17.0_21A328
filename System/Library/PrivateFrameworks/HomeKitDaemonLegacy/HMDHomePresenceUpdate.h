...
- (void).cxx_destruct;	// IMP=0x000000000037416d
...
- (id)description;	// IMP=0x000000000037403a
- (id)initWithHomePresence:(id)arg1 userPresence:(id)arg2 update:(_Bool)arg3 causingDevice:(id)arg4;	// IMP=0x0000000000373f5f
