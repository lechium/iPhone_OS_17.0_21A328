...
+ (id)entityFromContext:(id)arg1;	// IMP=0x0040000000068f5b
- (void)_assignToContact:(id)arg1 inContactStore:(id)arg2 withSoundIdentifier:(id)arg3;	// IMP=0x0020000000069354
- (void)_assignToPersonWithID:(int)arg1 withIdentifier:(id)arg2;	// IMP=0x00100000000692e0
- (void)_assignToContactWithID:(id)arg1 withIdentifier:(id)arg2;	// IMP=0x00100000000691ee
- (void)loadFromPurchase:(id)arg1;	// IMP=0x00100000000690de
- (void)applyUserActionWithToneIdentifier:(id)arg1;	// IMP=0x0010000000068fa8
