...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000157e7d
- (void)dealloc;	// IMP=0x0000000000157e33
- (id)initWithObjectID:(id)arg1 recordName:(id)arg2;	// IMP=0x0000000000157dca
