...
- (void).cxx_destruct;	// IMP=0x00200000006b13b9
...
- (void)autocompleteMatchInfoDidUpdate:(id)arg1;	// IMP=0x00100000006b130a
- (void)setMatchInfo:(id)arg1 forObject:(id)arg2;	// IMP=0x00100000006b11a6
- (id)matchInfoForObject:(id)arg1;	// IMP=0x00100000006b1033
- (id)initWithQueryString:(id)arg1;	// IMP=0x00100000006b0ebf
- (id)init;	// IMP=0x00100000006b0e94
