...
+ (_Bool)supportsSecureCoding;	// IMP=0x0020000000028717
+ (_Bool)dateIsBusyFolderDate:(double)arg1;	// IMP=0x0010000000028679
- (void).cxx_destruct;	// IMP=0x0020000000028ada
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000289f4
- (unsigned long long)hash;	// IMP=0x00100000000289de
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000028825
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000002871f
- (id)init;	// IMP=0x00100000000286a3
