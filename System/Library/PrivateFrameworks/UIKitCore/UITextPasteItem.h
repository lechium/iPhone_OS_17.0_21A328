...
- (void).cxx_destruct;	// IMP=0x00000000013f846a
...
- (void)setDefaultResult;	// IMP=0x00000000013f7fd8
- (void)setNoResult;	// IMP=0x00000000013f7fbd
- (void)setAttachmentResult:(id)arg1;	// IMP=0x00000000013f7f64
- (void)setAttributedStringResult:(id)arg1;	// IMP=0x00000000013f7f4b
- (void)setStringResult:(id)arg1;	// IMP=0x00000000013f7e9f
- (id)initWithTextPasteCoordinator:(id)arg1;	// IMP=0x00000000013f7e34
