...
+ (id)logCategory;	// IMP=0x0010000000904c2e
+ (id)sharedHandler;	// IMP=0x0010000000904bcb
- (void).cxx_destruct;	// IMP=0x000000000090464a
...
- (void)_setJetsamPriorityElevated:(_Bool)arg1;	// IMP=0x00000000009043fc
- (void)_updateOrRemoveRelaunchPlist;	// IMP=0x0000000000903e7b
- (void)deregisterRelaunchClientWithUUID:(id)arg1;	// IMP=0x0000000000903dc3
- (void)registerRelaunchClientWithUUID:(id)arg1;	// IMP=0x0000000000903d0a
- (void)removePersistentRelaunchRegistrationsIfNecessary;	// IMP=0x0000000000903c99
- (id)initWithRelaunchPlistFileURL:(id)arg1 fileManager:(id)arg2 jetsamPriorityHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000000903b42
- (id)init;	// IMP=0x0000000000903aa1
