...
- (void).cxx_destruct;	// IMP=0x0000000000004624
...
- (void)callCompletionHandlerWithImage:(id)arg1 actualCMTime:(CDStruct_1b6d18a9)arg2 actualDate:(id)arg3;	// IMP=0x00000000000043ed
- (id)description;	// IMP=0x0000000000004336
