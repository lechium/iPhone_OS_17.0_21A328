...
- (void).cxx_destruct;	// IMP=0x00000000001183df
...
- (_Bool)activeDocumentIsValidForBrowserControllerWithUUID:(id)arg1;	// IMP=0x0000000000118393
- (id)savedTabsStateForBrowserControllerWithUUID:(id)arg1 initialURLString:(id)arg2;	// IMP=0x0000000000118038
- (id)savedTabsStateForBrowserControllerWithUUID:(id)arg1;	// IMP=0x000000000011800b
