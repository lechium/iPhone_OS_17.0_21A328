...
+ (id)entryWithTaskID:(unsigned long long)arg1 qos:(unsigned int)arg2 background:(_Bool)arg3 task:(id)arg4 completionHandler:(CDUnknownBlockType)arg5;	// IMP=0x0040000000010eff
- (void).cxx_destruct;	// IMP=0x0020000000010ff0
...
- (id)initWithTaskID:(unsigned long long)arg1 qos:(unsigned int)arg2 background:(_Bool)arg3 task:(id)arg4 completionHandler:(CDUnknownBlockType)arg5;	// IMP=0x0010000000010e10
