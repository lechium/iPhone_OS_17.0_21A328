...
- (void).cxx_destruct;	// IMP=0x0020000000009067
...
- (void)load;	// IMP=0x0010000000009039
- (id)initWithCommand:(id)arg1 completionBlock:(CDUnknownBlockType)arg2;	// IMP=0x0010000000008e9a
