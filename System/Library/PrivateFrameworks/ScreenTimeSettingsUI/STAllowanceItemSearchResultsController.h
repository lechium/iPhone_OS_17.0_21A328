...
- (void).cxx_destruct;	// IMP=0x0000000000009d87
...
- (void)updateSearchResultsForSearchController:(id)arg1;	// IMP=0x00000000000095e3
- (void)tableView:(id)arg1 didDeselectRowAtIndexPath:(id)arg2;	// IMP=0x00000000000093eb
- (void)tableView:(id)arg1 didSelectRowAtIndexPath:(id)arg2;	// IMP=0x00000000000091f3
- (void)tableView:(id)arg1 willDisplayCell:(id)arg2 forRowAtIndexPath:(id)arg3;	// IMP=0x000000000000900b
- (id)tableView:(id)arg1 cellForRowAtIndexPath:(id)arg2;	// IMP=0x0000000000008851
- (long long)tableView:(id)arg1 numberOfRowsInSection:(long long)arg2;	// IMP=0x000000000000880d
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x0000000000008719
- (void)viewDidLoad;	// IMP=0x0000000000008605
