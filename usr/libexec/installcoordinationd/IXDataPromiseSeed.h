...
+ (_Bool)supportsSecureCoding;	// IMP=0x002000000003eb30
- (void).cxx_destruct;	// IMP=0x002000000003ec83
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000003eb38
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000003e9ea
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000003e887
