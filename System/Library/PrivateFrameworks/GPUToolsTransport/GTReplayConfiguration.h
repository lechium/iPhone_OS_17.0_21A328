...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000003bab
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000003d6e
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000003c10
- (id)init;	// IMP=0x0000000000003bb3
