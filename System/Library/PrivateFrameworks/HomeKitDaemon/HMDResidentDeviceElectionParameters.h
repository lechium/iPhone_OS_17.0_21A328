...
- (void).cxx_destruct;	// IMP=0x0000000000c0bfa5
...
- (id)attributeDescriptions;	// IMP=0x0000000000c0bca2
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000c0bc1d
- (unsigned long long)hash;	// IMP=0x0000000000c0bbd9
- (long long)compare:(id)arg1 outCriteria:(unsigned long long *)arg2;	// IMP=0x0000000000c0b56c
- (long long)compare:(id)arg1;	// IMP=0x0000000000c0b558
@property(readonly, copy) NSDictionary *dictionaryRepresentation;
- (id)initWithResident:(id)arg1 enabled:(id)arg2 location:(long long)arg3 accessories:(id)arg4;	// IMP=0x0000000000c0b0b2
- (id)initWithResident:(id)arg1 dictionaryRepresentation:(id)arg2;	// IMP=0x0000000000c0aebc
