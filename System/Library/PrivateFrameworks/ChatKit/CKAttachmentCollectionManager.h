...
- (void).cxx_destruct;	// IMP=0x00000000004bc7d1
...
- (void)deleteAttachmentItems:(id)arg1;	// IMP=0x00000000004bc0d3
- (void)updateCollections;	// IMP=0x00000000004bb6dd
- (id)guidFromChatItem:(id)arg1;	// IMP=0x00000000004bb67a
- (void)chatItemsChanged:(id)arg1;	// IMP=0x00000000004bad5c
- (void)dealloc;	// IMP=0x00000000004bace7
- (id)initWithChat:(id)arg1;	// IMP=0x00000000004bacd3
- (id)initWithChat:(id)arg1 photoTransferGUIDs:(id)arg2;	// IMP=0x00000000004bab85
