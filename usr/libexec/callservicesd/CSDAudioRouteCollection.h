...
- (void).cxx_destruct;	// IMP=0x00200000001523cf
...
- (void)_setRoutesFromRouteDictionaries:(id)arg1;	// IMP=0x00100000001520ff
- (void)updatePickableRoutes;	// IMP=0x00100000001520f9
- (_Bool)_anyRoutePassesTest:(CDUnknownBlockType)arg1;	// IMP=0x0010000000152021
- (id)_routePassingTest:(CDUnknownBlockType)arg1;	// IMP=0x0010000000151ee2
- (void)enumerateRoutesInvokingBlock:(CDUnknownBlockType)arg1 forRoutesPassingTest:(CDUnknownBlockType)arg2;	// IMP=0x0010000000151d6e
...
- (_Bool)isAnyRouteAvailableWithUniqueIdentifier:(id)arg1;	// IMP=0x0010000000151bfb
- (_Bool)isAnyRouteAvailableWithBluetoothEndpointType:(long long)arg1;	// IMP=0x0010000000151b82
...
- (id)description;	// IMP=0x0010000000151939
- (id)initWithCategory:(id)arg1 mode:(id)arg2;	// IMP=0x001000000015189b
