...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000042777
- (unsigned long long)hash;	// IMP=0x00000000000426d5
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000425aa
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000424de
- (void)copyTo:(id)arg1;	// IMP=0x0000000000042435
- (void)writeTo:(id)arg1;	// IMP=0x0000000000042361
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000042354
- (id)dictionaryRepresentation;	// IMP=0x0000000000041d03
- (id)description;	// IMP=0x0000000000041c54
- (int)StringAsTotalOTAAchievementViewedCount:(id)arg1;	// IMP=0x0000000000041ba0
- (id)totalOTAAchievementViewedCountAsString:(int)arg1;	// IMP=0x0000000000041b57
...
- (int)StringAsTotalOTAAchievementCount:(id)arg1;	// IMP=0x0000000000041a39
- (id)totalOTAAchievementCountAsString:(int)arg1;	// IMP=0x00000000000419f0
...
- (int)StringAsTotalAchievementCount:(id)arg1;	// IMP=0x0000000000041887
- (id)totalAchievementCountAsString:(int)arg1;	// IMP=0x000000000004183e
