...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000009d00ea
- (unsigned long long)hash;	// IMP=0x00100000009d0035
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000009cff40
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000009cfe41
- (void)copyTo:(id)arg1;	// IMP=0x00100000009cfd93
- (void)writeTo:(id)arg1;	// IMP=0x00100000009cfccd
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000009cfcc0
- (id)dictionaryRepresentation;	// IMP=0x00100000009cf7b5
- (id)description;	// IMP=0x00100000009cf73e
...
- (void)dealloc;	// IMP=0x00100000009cf5e4
