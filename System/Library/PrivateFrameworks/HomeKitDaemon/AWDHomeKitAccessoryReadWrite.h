...
+ (Class)characteristicsType;	// IMP=0x001000000023c14c
- (void).cxx_destruct;	// IMP=0x000000000023c0b5
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000023b9b5
- (unsigned long long)hash;	// IMP=0x000000000023b637
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000023b0a5
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000023ab3e
- (void)copyTo:(id)arg1;	// IMP=0x000000000023a78b
- (void)writeTo:(id)arg1;	// IMP=0x000000000023a318
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000239601
- (id)dictionaryRepresentation;	// IMP=0x0000000000238bd1
- (id)description;	// IMP=0x0000000000238b22
...
- (int)StringAsCertified:(id)arg1;	// IMP=0x0000000000238780
- (id)certifiedAsString:(int)arg1;	// IMP=0x0000000000238738
@property(nonatomic) _Bool hasCertified;
@property(nonatomic) int certified; // @synthesize certified=_certified;
- (int)StringAsSource:(id)arg1;	// IMP=0x000000000023857b
- (id)sourceAsString:(int)arg1;	// IMP=0x0000000000238533
...
- (int)StringAsTransportType:(id)arg1;	// IMP=0x0000000000238303
- (id)transportTypeAsString:(int)arg1;	// IMP=0x00000000002382bb
@property(nonatomic) _Bool hasTransportType;
@property(nonatomic) int transportType; // @synthesize transportType=_transportType;
- (id)characteristicsAtIndex:(unsigned long long)arg1;	// IMP=0x0000000000238234
- (unsigned long long)characteristicsCount;	// IMP=0x0000000000238217
- (void)addCharacteristics:(id)arg1;	// IMP=0x00000000002381ad
- (void)clearCharacteristics;	// IMP=0x0000000000238190
