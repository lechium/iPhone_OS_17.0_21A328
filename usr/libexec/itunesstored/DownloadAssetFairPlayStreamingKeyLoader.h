...
- (void).cxx_destruct;	// IMP=0x00200000000a4553
...
- (id)_track;	// IMP=0x00100000000a41cb
- (void)_persistURI:(id)arg1 persistentContentKey:(id)arg2;	// IMP=0x00100000000a41c5
- (void)_persistKeys;	// IMP=0x00100000000a41bf
- (id)_pastisKeyServerURL;	// IMP=0x00100000000a40f4
- (id)_pastisCertificateURL;	// IMP=0x00100000000a4029
- (_Bool)resourceLoader:(id)arg1 shouldWaitForLoadingOfRequestedResource:(id)arg2;	// IMP=0x00100000000a4021
- (void)persistKeys;	// IMP=0x00100000000a401b
- (void)applyResourceLoaderDelegate:(id)arg1;	// IMP=0x00100000000a3ffc
- (id)initWithDownloadEntity:(id)arg1;	// IMP=0x00100000000a3e81
