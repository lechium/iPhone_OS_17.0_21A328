...
+ (id)sharedMetricsWithPhotoLibrary:(id)arg1;	// IMP=0x004000000007559b
- (void).cxx_destruct;	// IMP=0x00200000000761ca
- (int)persist;	// IMP=0x0010000000075a73
- (int)reportAnalyzedAsset:(id)arg1 withAnalysis:(id)arg2 andProcessingTime:(double)arg3;	// IMP=0x00100000000757a4
- (void)dealloc;	// IMP=0x0010000000075518
- (id)initWithPhotoLibrary:(id)arg1;	// IMP=0x0010000000074b70
