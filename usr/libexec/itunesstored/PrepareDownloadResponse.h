...
@class DownloadDataConsumer, DownloadHandle, MISSING_TYPE, NSArray, NSDictionary, NSError, NSNumber, NSString, NSURLRequest;
...
- (void).cxx_destruct;	// IMP=0x002000000017e367
...
- (id)_reuseExistingTaskInSession:(id)arg1;	// IMP=0x001000000017d749
- (id)_getExistingTaskInSession:(id)arg1;	// IMP=0x001000000017d0bc
@property(readonly, nonatomic) NSString *URLSessionIdentifier;
- (id)sessionTaskWithSession:(id)arg1 error:(id *)arg2;	// IMP=0x001000000017cd5f
- (id)sessionConfiguration;	// IMP=0x001000000017cb8a
