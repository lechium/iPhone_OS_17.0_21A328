...
+ (_Bool)_canDisplayForContext:(id)arg1 transportMode:(unsigned long long)arg2;	// IMP=0x00200000006b3557
+ (id)localizedTransitTitle;	// IMP=0x00100000006b334c
- (void).cxx_destruct;	// IMP=0x00200000006b41ca
...
- (_Bool)_followupQuestionsAreDirectionsRelated;	// IMP=0x00100000006b4136
- (void)_fillSubmissionParameters:(id)arg1;	// IMP=0x00100000006b3c5e
- (id)_alternateAuxiliaryControlsRecording;	// IMP=0x00100000006b3c0e
@property(readonly, nonatomic) RAPDirectionsCategoryQuestion *followUpQuestion; // @synthesize followUpQuestion=_followUpQuestion;
- (_Bool)_isRecursivelyComplete;	// IMP=0x00100000006b3b1e
- (_Bool)isComplete;	// IMP=0x00100000006b3b09
...
- (int)analyticTarget;	// IMP=0x00100000006b354c
@property(readonly, nonatomic) long long questionCategory;
- (id)initWithReport:(id)arg1 parentQuestion:(id)arg2 selectableDirectionRequests:(id)arg3;	// IMP=0x00100000006b3526
- (id)initWithReport:(id)arg1 parentQuestion:(id)arg2 transportType:(unsigned long long)arg3 selectableRequests:(id)arg4;	// IMP=0x00100000006b346c
- (id)initWithReport:(id)arg1 parentQuestion:(id)arg2 transportType:(unsigned long long)arg3;	// IMP=0x00100000006b3457
- (id)initWithReport:(id)arg1 parentQuestion:(id)arg2;	// IMP=0x00100000006b343c
