...
- (void).cxx_destruct;	// IMP=0x000000000003ffbb
...
- (void)configureWithRequest:(id)arg1;	// IMP=0x000000000003fe38
- (void)didSelectManualSignInButton;	// IMP=0x000000000003fdec
- (id)init;	// IMP=0x000000000003fd28
