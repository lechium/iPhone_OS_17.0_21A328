...
+ (id)dataFetcherForSourceURL:(id)arg1;	// IMP=0x006000000000db57
- (void).cxx_destruct;	// IMP=0x000000000000df56
...
- (id)initWithDataURL:(id)arg1;	// IMP=0x000000000000dcc2
- (id)initWithDataURL:(id)arg1 suggestedFileName:(id)arg2;	// IMP=0x000000000000dc29
- (id)initWithData:(id)arg1 suggestedFileName:(id)arg2;	// IMP=0x000000000000db90
