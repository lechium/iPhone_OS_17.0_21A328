...
- (void).cxx_destruct;	// IMP=0x00000000000115d5
@property(retain, nonatomic) NSString *textStyleForScaling; // @synthesize textStyleForScaling=_textStyleForScaling;
- (struct CGSize)intrinsicContentSize;	// IMP=0x000000000001143d
- (void)invalidateIntrinsicContentSize;	// IMP=0x0000000000011401
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x0000000000011310
