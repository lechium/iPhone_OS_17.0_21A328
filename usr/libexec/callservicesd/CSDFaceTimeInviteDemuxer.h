...
- (void).cxx_destruct;	// IMP=0x00400000002fa11c
- (_Bool)destinationIDsCanUseV2Blobs:(id)arg1;	// IMP=0x00100000002f91d3
- (void)idsPeersForHandle:(id)arg1 video:(_Bool)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00100000002f90ee
- (id)init;	// IMP=0x00100000002f79c5
