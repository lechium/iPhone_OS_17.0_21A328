...
- (void).cxx_destruct;	// IMP=0x000000000001dfb4
@property(retain, nonatomic) InterceptConfig *interceptConfig; // @synthesize interceptConfig=_interceptConfig;
- (void)forwardInvocation:(id)arg1;	// IMP=0x000000000001df08
- (_Bool)respondsToSelector:(SEL)arg1;	// IMP=0x000000000001deb8
- (id)forwardingTargetForSelector:(SEL)arg1;	// IMP=0x000000000001de83
- (id)newCommandQueueWithDescriptor:(id)arg1;	// IMP=0x000000000001de2b
- (id)newCommandQueueWithMaxCommandBufferCount:(unsigned long long)arg1;	// IMP=0x000000000001ddf8
- (id)newCommandQueue;	// IMP=0x000000000001ddca
@property(retain, nonatomic) FigMetalExecutionStatus *executionStatus;
- (id)initWithLevel:(int)arg1;	// IMP=0x000000000001db7a
