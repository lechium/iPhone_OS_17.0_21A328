...
+ (id)rangeWithDOMRange:(id)arg1;	// IMP=0x00600000000290c0
...
- (id)description;	// IMP=0x0000000000029138
- (void)dealloc;	// IMP=0x0000000000029109
- (id)initWithDOMRange:(id)arg1;	// IMP=0x0000000000029017
