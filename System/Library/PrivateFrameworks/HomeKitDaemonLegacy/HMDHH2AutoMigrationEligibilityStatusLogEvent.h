...
+ (_Bool)submitEventWithHistogrammedAggregateHomeDataCommonDimensions;	// IMP=0x0010000000af483b
- (void).cxx_destruct;	// IMP=0x0000000000af47f9
...
- (id)initWithAutoMigrationEligibilityResult:(id)arg1 migrationByOwnerManualEligibilityResult:(id)arg2 migrationByOwnerAutoEligibilityResult:(id)arg3 didRunMigrationTaskOnCurrentBuild:(_Bool)arg4 currentBuildStartedOnHH1:(_Bool)arg5;	// IMP=0x0000000000af3f71
