...
- (id).cxx_construct;	// IMP=0x0000000000007a81
- (void).cxx_destruct;	// IMP=0x0000000000007a70
...
- (id)newIntersectionFunctionTableWithDescriptor:(id)arg1;	// IMP=0x0000000000007996
- (id)newVisibleFunctionTableWithDescriptor:(id)arg1;	// IMP=0x000000000000798e
- (CDStruct_da2e99ad)sparseTileSizeWithTextureType:(unsigned long long)arg1 pixelFormat:(unsigned long long)arg2 sampleCount:(unsigned long long)arg3 sparsePageSize:(long long)arg4;	// IMP=0x0000000000007977
...
- (id)newSharedEventWithMachPort:(unsigned int)arg1;	// IMP=0x00000000000076a7
- (id)newSharedEventWithHandle:(id)arg1;	// IMP=0x000000000000738e
- (id)newSharedEventWithOptions:(long long)arg1;	// IMP=0x0000000000007170
- (id)newEventWithOptions:(long long)arg1;	// IMP=0x000000000000715e
- (id)newSharedEvent;	// IMP=0x0000000000006f47
- (id)newEvent;	// IMP=0x0000000000006f35
...
- (id)newRasterizationRateMapWithDescriptor:(id)arg1;	// IMP=0x0000000000006f11
- (_Bool)supportsRasterizationRateMapWithLayerCount:(unsigned long long)arg1;	// IMP=0x0000000000006f09
- (void)newRenderPipelineStateWithMeshDescriptor:(id)arg1 options:(unsigned long long)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000000006ee8
- (void)newRenderPipelineStateWithMeshDescriptor:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000006ec7
- (id)newRenderPipelineStateWithMeshDescriptor:(id)arg1 options:(unsigned long long)arg2 reflection:(id *)arg3 error:(id *)arg4;	// IMP=0x0000000000006ea3
- (id)newRenderPipelineStateWithMeshDescriptor:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000006e7f
- (id)newRenderPipelineStateWithTileDescriptor:(id)arg1 options:(unsigned long long)arg2 reflection:(id *)arg3 error:(id *)arg4;	// IMP=0x0000000000006e5b
- (void)newRenderPipelineStateWithTileDescriptor:(id)arg1 options:(unsigned long long)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000000006e3a
- (unsigned long long)minimumTextureBufferAlignmentForPixelFormat:(unsigned long long)arg1;	// IMP=0x0000000000006cb8
- (unsigned long long)minimumLinearTextureAlignmentForPixelFormat:(unsigned long long)arg1;	// IMP=0x0000000000006adb
- (id)newBufferWithIOSurface:(struct __IOSurface *)arg1;	// IMP=0x0000000000006aae
- (_Bool)setResourcesPurgeableState:(id *)arg1 newState:(unsigned long long)arg2 oldState:(unsigned long long *)arg3 count:(int)arg4;	// IMP=0x0000000000006aa6
- (id)newCommandQueueWithDescriptor:(id)arg1;	// IMP=0x0000000000006920
- (id)vendorName;	// IMP=0x0000000000006913
- (_Bool)supportsSampleCount:(unsigned long long)arg1;	// IMP=0x00000000000068fd
- (int)llvmVersion;	// IMP=0x00000000000068f2
- (id)productName;	// IMP=0x00000000000068e5
- (id)newTiledTextureWithBytesNoCopy:(void *)arg1 length:(unsigned long long)arg2 descriptor:(id)arg3 offset:(unsigned long long)arg4 bytesPerRow:(unsigned long long)arg5;	// IMP=0x00000000000068c1
- (id)newTiledTextureWithBytesNoCopy:(void *)arg1 length:(unsigned long long)arg2 deallocator:(CDUnknownBlockType)arg3 descriptor:(id)arg4 offset:(unsigned long long)arg5 bytesPerRow:(unsigned long long)arg6;	// IMP=0x000000000000689d
- (id)newIndirectRenderCommandEncoderWithBuffer:(id)arg1;	// IMP=0x0000000000006879
- (id)newIndirectComputeCommandEncoderWithBuffer:(id)arg1;	// IMP=0x0000000000006855
- (id)newIndirectCommandBufferWithDescriptor:(id)arg1 maxCount:(unsigned long long)arg2 options:(unsigned long long)arg3;	// IMP=0x0000000000006831
- (id)newArgumentEncoderWithLayout:(id)arg1;	// IMP=0x00000000000065b3
- (id)newIndirectArgumentBufferLayoutWithStructType:(id)arg1;	// IMP=0x0000000000006360
- (id)familyName;	// IMP=0x0000000000006353
- (id)newComputePipelineWithDescriptor:(id)arg1 variant:(id)arg2 errorMessage:(id *)arg3;	// IMP=0x0000000000006078
- (id)newComputeVariantWithCompilerOutput:(id)arg1 pipelineStatisticsOutput:(id)arg2;	// IMP=0x0000000000006061
- (id)wrapComputeState:(id)arg1 descriptor:(id)arg2;	// IMP=0x000000000000603d
- (id)pipelinePerformanceStatisticsWithComputeVariant:(id)arg1 compileTimeOutput:(id)arg2;	// IMP=0x0000000000005fce
- (id)pipelinePerformanceStatisticsWithVertexVariant:(id)arg1 fragmentVariant:(id)arg2 vertexCompileTimeOutput:(id)arg3 fragmentCompileTimeOutput:(id)arg4;	// IMP=0x0000000000005eb5
- (CDStruct_9028b892)pipelineFlagsWithVertexVariant:(id)arg1 fragmentVariant:(id)arg2;	// IMP=0x0000000000005ead
- (id)newRenderPipelineWithDescriptor:(id)arg1 vertexVariant:(id)arg2 fragmentVariant:(id)arg3 errorMessage:(id *)arg4;	// IMP=0x0000000000005c2d
- (id)newVertexVariantWithCompilerOutput:(id)arg1 pipelineStatisticsOutput:(id)arg2;	// IMP=0x0000000000005c16
- (id)newFragmentVariantWithCompilerOutput:(id)arg1 pipelineStatisticsOutput:(id)arg2;	// IMP=0x0000000000005bff
- (id)newFunctionVariantWithCompilerOutput:(id)arg1 functionType:(unsigned long long)arg2;	// IMP=0x0000000000005924
- (id)reportLeaks;	// IMP=0x0000000000005844
- (void)freeVertexFunctionKey:(void *)arg1 vertexKeySize:(unsigned long long)arg2;	// IMP=0x000000000000583e
- (void)freeFragmentFunctionKey:(void *)arg1 fragmentKeySize:(unsigned long long)arg2;	// IMP=0x0000000000005838
- (void *)vertexFunctionKeyWithRenderPipelineDescriptor:(id)arg1 options:(unsigned long long)arg2 nextStageVariant:(id)arg3 vertexKeySize:(unsigned long long *)arg4;	// IMP=0x0000000000005829
- (void *)fragmentFunctionKeyWithRenderPipelineDescriptor:(id)arg1 options:(unsigned long long)arg2 previousStateVariant:(id)arg3 fragmentKeySize:(unsigned long long *)arg4;	// IMP=0x000000000000581a
- (id)wrapRenderState:(id)arg1 descriptor:(id)arg2;	// IMP=0x00000000000057f6
- (void)registerViewTexture:(id)arg1 baseTextureView:(id)arg2;	// IMP=0x00000000000057f0
@property(readonly) _Bool deserializerSupportsSharedTextures;
- (id)newTextureWithDescriptor:(id)arg1 iosurface:(struct __IOSurface *)arg2 plane:(unsigned long long)arg3;	// IMP=0x00000000000053b7
- (id)newTextureWithDescriptor:(id)arg1;	// IMP=0x0000000000005087
- (id)_fixUpSwizzleForTexture:(id)arg1 key:(unsigned int)arg2;	// IMP=0x0000000000004f48
- (id)newSamplerStateWithDescriptor:(id)arg1;	// IMP=0x0000000000004dfa
- (void)dispatchNotificationWithReference:(unsigned int)arg1;	// IMP=0x0000000000004cd9
- (void)registerEventNotification:(unsigned int)arg1 listener:(id)arg2 event:(id)arg3 value:(unsigned long long)arg4 block:(CDUnknownBlockType)arg5;	// IMP=0x0000000000004bf2
- (id)newIndirectCommandBufferWithDescriptor:(id)arg1 maxCommandCount:(unsigned long long)arg2 options:(unsigned long long)arg3;	// IMP=0x0000000000004bce
- (id)newHeapWithDescriptor:(id)arg1;	// IMP=0x00000000000048b5
- (id)newFence;	// IMP=0x000000000000461b
- (id)newDepthStencilStateWithDescriptor:(id)arg1;	// IMP=0x00000000000044cd
- (id)newBufferWithLength:(unsigned long long)arg1 options:(unsigned long long)arg2;	// IMP=0x00000000000044a4
- (id)newBufferWithBytesNoCopy:(void *)arg1 length:(unsigned long long)arg2 options:(unsigned long long)arg3 deallocator:(CDUnknownBlockType)arg4;	// IMP=0x0000000000004476
- (id)newBufferWithBytes:(const void *)arg1 length:(unsigned long long)arg2 options:(unsigned long long)arg3;	// IMP=0x0000000000004441
- (id)newBufferWithLength:(unsigned long long)arg1 options:(unsigned long long)arg2 pointer:(void *)arg3 copyBytes:(_Bool)arg4 deallocator:(CDUnknownBlockType)arg5;	// IMP=0x0000000000004183
- (void)releaseCommandBufferRef:(unsigned int)arg1;	// IMP=0x00000000000040cf
- (unsigned int)registerCommandBuffer:(id)arg1;	// IMP=0x0000000000003f3c
- (id)commandBufferForReference:(unsigned int)arg1;	// IMP=0x0000000000003dcf
- (CDStruct_4bcfbbae)heapTextureSizeAndAlignWithDescriptor:(id)arg1;	// IMP=0x0000000000003b41
- (CDStruct_da2e99ad)sparseTileSizeWithTextureType:(unsigned long long)arg1 pixelFormat:(unsigned long long)arg2 sampleCount:(unsigned long long)arg3;	// IMP=0x0000000000003b04
- (CDStruct_4bcfbbae)heapBufferSizeAndAlignWithLength:(unsigned long long)arg1 options:(unsigned long long)arg2;	// IMP=0x000000000000396d
- (unsigned int)getNewResourceID;	// IMP=0x000000000000395a
- (id)compiler;	// IMP=0x0000000000003831
- (id)_deviceWrapper;	// IMP=0x0000000000003807
- (void)_setDeviceWrapper:(id)arg1;	// IMP=0x00000000000037f6
- (void)dealloc;	// IMP=0x00000000000036fe
...
- (_Bool)supportsVertexAmplificationCount:(unsigned long long)arg1;	// IMP=0x0000000000002a0c
