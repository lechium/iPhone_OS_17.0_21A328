...
- (void).cxx_destruct;	// IMP=0x000000000055b28d
...
- (id)initWithRequestID:(long long)arg1 transferGUID:(id)arg2 resultHandler:(CDUnknownBlockType)arg3;	// IMP=0x000000000055b1c4
