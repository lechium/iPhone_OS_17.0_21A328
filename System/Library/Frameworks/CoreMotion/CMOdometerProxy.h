...
- (void)_stopCyclingWorkoutDistanceUpdates;	// IMP=0x0000000000170953
- (void)_startCyclingWorkoutDistanceUpdatesWithHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000000001700b4
- (void)_stopOdometerUpdates;	// IMP=0x000000000016ff2b
- (void)_stopOdometerGpsAvailability;	// IMP=0x000000000016fdb6
- (void)_startOdometerUpdatesWithHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000000016f625
- (void)_startDaemonConnection;	// IMP=0x000000000016eee5
- (void)_teardown;	// IMP=0x000000000016ee8a
- (void)dealloc;	// IMP=0x000000000016ee40
- (id)initWithOdometer:(id)arg1;	// IMP=0x000000000016ed50
