...
+ (long long)maximumNumberOfItems;	// IMP=0x00600000001b8d9d
- (void).cxx_destruct;	// IMP=0x00000000001b8c85
...
- (void)_updateRoundedCornerOverlayView;	// IMP=0x00000000001b8a23
- (void)_updateImageViews;	// IMP=0x00000000001b86ba
- (void)setHasRoundedCorners:(_Bool)arg1 withCornersBackgroundColor:(id)arg2;	// IMP=0x00000000001b863f
- (void)setImage:(id)arg1 forItemAtIndex:(long long)arg2;	// IMP=0x00000000001b8528
- (void)setImageSize:(struct CGSize)arg1 forItemAtIndex:(long long)arg2;	// IMP=0x00000000001b847b
- (struct CGSize)imageSizeForItemAtIndex:(long long)arg1;	// IMP=0x00000000001b83c7
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000001b8323
- (void)layoutSubviews;	// IMP=0x00000000001b7d0b
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000001b7b1b
