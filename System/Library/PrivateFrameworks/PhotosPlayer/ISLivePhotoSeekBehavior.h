...
- (void).cxx_destruct;	// IMP=0x0000000000010b22
...
- (long long)behaviorType;	// IMP=0x0000000000010ad5
- (void)_handleDidSeekToSeekTime:(_Bool)arg1;	// IMP=0x00000000000109f1
- (void)_callSeekCompletionHandler:(_Bool)arg1;	// IMP=0x0000000000010967
- (void)_seekIfNeeded;	// IMP=0x00000000000108ba
- (void)activeDidChange;	// IMP=0x00000000000107b6
- (id)initWithInitialLayoutInfo:(id)arg1 seekTime:(CDStruct_1b6d18a9)arg2;	// IMP=0x0000000000010709
