...
- (void).cxx_destruct;	// IMP=0x00000000000daf09
...
- (void)dealloc;	// IMP=0x00000000000dae43
- (id)initWithDocument:(id)arg1 stageID:(id)arg2 transferSize:(unsigned long long)arg3;	// IMP=0x00000000000dacb4
- (id)description;	// IMP=0x00000000000dac87
