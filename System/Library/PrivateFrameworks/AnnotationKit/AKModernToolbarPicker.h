...
- (void).cxx_destruct;	// IMP=0x0000000000078a51
...
- (void)revalidateItems:(id)arg1;	// IMP=0x00000000000789e8
- (id)initWithFrame:(struct CGRect)arg1 controller:(id)arg2;	// IMP=0x0000000000078593
