...
- (void).cxx_destruct;	// IMP=0x0020000000024b0f
@property(readonly, nonatomic) BSAuditToken *auditToken; // @synthesize auditToken=_auditToken;
@property(readonly, copy, nonatomic) NSUUID *uniqueIdentifier; // @synthesize uniqueIdentifier=_uniqueIdentifier;
@property(readonly, nonatomic) int pid;
- (id)description;	// IMP=0x0010000000024a61
- (id)initWithUniqueIdentifier:(id)arg1 auditToken:(id)arg2;	// IMP=0x00100000000249bb
