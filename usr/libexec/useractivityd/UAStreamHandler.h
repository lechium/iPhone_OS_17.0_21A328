...
- (void).cxx_destruct;	// IMP=0x002000000003caa5
...
- (id)trimFirstBytes:(unsigned long long)arg1 ofData:(id)arg2;	// IMP=0x001000000003c797
- (long long)tryWriteMessage;	// IMP=0x001000000003c100
- (long long)tryWriteRawData;	// IMP=0x001000000003bdf1
- (long long)handleSpaceAvailable;	// IMP=0x001000000003bd98
- (void)handleMessageRead;	// IMP=0x001000000003bc5d
- (_Bool)dataHasMessage:(id)arg1;	// IMP=0x001000000003bbea
- (void)processHeader;	// IMP=0x001000000003bada
- (void)handleBytesAvailable;	// IMP=0x001000000003b6e1
- (void)handleOpenCompleted;	// IMP=0x001000000003b5e4
- (void)stream:(id)arg1 handleEvent:(unsigned long long)arg2;	// IMP=0x001000000003b399
- (_Bool)writeMessage:(id)arg1 tag:(long long)arg2;	// IMP=0x001000000003b07b
- (_Bool)writeRawData:(id)arg1;	// IMP=0x001000000003ae7a
- (void)_stop;	// IMP=0x001000000003ac4a
- (void)tryStop;	// IMP=0x001000000003aaf7
- (void)stop;	// IMP=0x000000000003a9df
- (void)start;	// IMP=0x001000000003a5bb
- (long long)queueCount;	// IMP=0x001000000003a539
- (id)initWithInputStream:(id)arg1 outputStream:(id)arg2 delegate:(id)arg3;	// IMP=0x001000000003a354
