...
@class NSArray, NSString, PREditingLook, PREditingPosterContentStyleCoordinator, PREditor, PREditorColorPickerConfiguration, PRPosterTransition, PRTimeFontConfiguration, UIAction, UIMenu;
@protocol PREditingLookViewProviding, PRPosterContentStyle, PRPosterEditingEnvironment;
...
- (PREditingPosterContentStyleCoordinator *)coordinatorForContentStyle:(id <PRPosterContentStyle>)arg1 forEditor:(PREditor *)arg2;
