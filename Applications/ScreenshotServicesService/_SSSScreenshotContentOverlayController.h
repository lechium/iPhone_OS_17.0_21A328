...
- (void).cxx_destruct;	// IMP=0x0020000000034f34
...
- (_Bool)rulerHostWantsSharedRuler;	// IMP=0x0010000000034e65
- (id)rulerHostingView;	// IMP=0x0010000000034e53
...
- (void)logDidEndEditingWithOverlay;	// IMP=0x0010000000034caf
- (void)logDidEnterEditingWithOverlay;	// IMP=0x0010000000034ca9
- (void)updateUndoState;	// IMP=0x0010000000034ca3
