...
- (void).cxx_destruct;	// IMP=0x002000000020d26a
...
- (id)leafPersonalizedAutocompleteItems;	// IMP=0x001000000020d179
...
- (id)suggestion;	// IMP=0x001000000020cb2e
...
- (id)initWithSuggestion:(id)arg1 order:(unsigned short)arg2 sourceType:(long long)arg3 sourceSubtype:(long long)arg4 hasPriorityOverride:(_Bool)arg5 priorityOverride:(long long)arg6;	// IMP=0x001000000020c589
