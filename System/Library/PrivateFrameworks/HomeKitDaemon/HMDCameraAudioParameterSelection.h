...
+ (id)logCategory;	// IMP=0x00600000000adeed
- (void).cxx_destruct;	// IMP=0x00000000000addf0
...
- (void)_generateAllCombinations:(id)arg1;	// IMP=0x00000000000ad727
- (id)createSelectedAudioParameters;	// IMP=0x00000000000ad345
- (id)createSRTPParamters;	// IMP=0x00000000000ad2ba
- (_Bool)_selectParametersFromCodec:(id)arg1 bitRateSettings:(id)arg2 sampleRates:(id)arg3 audioChannelCount:(id)arg4;	// IMP=0x00000000000acd0b
- (_Bool)selectAudioParameters;	// IMP=0x00000000000ac4fb
- (id)logIdentifier;	// IMP=0x00000000000ac4ab
- (id)initWithSessionID:(id)arg1 supportedAudioConfiguration:(id)arg2 supportedRTPConfiguration:(id)arg3 streamingCapabilities:(id)arg4;	// IMP=0x00000000000ac31e
