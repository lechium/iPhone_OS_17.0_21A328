...
- (void).cxx_destruct;	// IMP=0x00000000005c67ae
...
- (void)pu_cancel;	// IMP=0x00000000005c6723
- (void)main;	// IMP=0x00000000005c66b2
- (id)initWithDelegate:(id)arg1 activityType:(id)arg2;	// IMP=0x00000000005c65e7
