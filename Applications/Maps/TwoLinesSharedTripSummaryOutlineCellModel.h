...
- (void).cxx_destruct;	// IMP=0x0020000000ce6cbd
@property(readonly, nonatomic) SharedTripSummary *sharedTripSummary; // @synthesize sharedTripSummary=_sharedTripSummary;
- (id)accessoryModels;	// IMP=0x0010000000ce6c97
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000ce6b6c
@property(readonly) unsigned long long hash;
- (id)initWithSharedTripSummary:(id)arg1 accessoryModels:(id)arg2 backgroundModel:(id)arg3;	// IMP=0x0010000000ce6995
