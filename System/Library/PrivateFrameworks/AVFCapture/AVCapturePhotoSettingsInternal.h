...
@interface AVCapturePhotoSettingsInternal : NSObject
{
    ...
    CDStruct_79c71658 maxPhotoDimensions;	// 396 = 0x18c
    NSString *livePhotoContentIdentifier;	// 408 = 0x198
    NSString *livePhotoContentIdentifierForOriginalPhoto;	// 416 = 0x1a0
}
