...
- (void).cxx_destruct;	// IMP=0x00000000000511c3
...
- (id)description;	// IMP=0x0000000000050fb5
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000050ef5
- (id)initWithRequestClass:(Class)arg1;	// IMP=0x0000000000050ea6
