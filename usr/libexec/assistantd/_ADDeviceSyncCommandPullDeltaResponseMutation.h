...
- (void).cxx_destruct;	// IMP=0x00200000000ba6da
- (void)setIncrementalChanges:(id)arg1;	// IMP=0x00100000000ba6ba
- (id)getIncrementalChanges;	// IMP=0x00100000000ba682
- (_Bool)isDirty;	// IMP=0x00100000000ba677
- (id)initWithBase:(id)arg1;	// IMP=0x00100000000ba60c
