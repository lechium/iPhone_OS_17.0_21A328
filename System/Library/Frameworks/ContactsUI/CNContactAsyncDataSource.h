...
- (void).cxx_destruct;	// IMP=0x0000000000306c9c
...
- (void)invalidate;	// IMP=0x0000000000306b98
- (void)invalidateSearch;	// IMP=0x0000000000306b3e
- (void)invalidateResults;	// IMP=0x0000000000306ab8
- (void)reloadWithRequest:(id)arg1;	// IMP=0x00000000003067d3
- (void)reload;	// IMP=0x000000000030663c
- (void)setNetworkActivityIndicatorVisible:(_Bool)arg1;	// IMP=0x0000000000306636
@property(readonly, nonatomic) CNContactFilter *effectiveFilter;
- (id)indexPathForContact:(id)arg1;	// IMP=0x00000000003064bf
- (id)completeContactFromContact:(id)arg1 fromMainStoreOnly:(_Bool)arg2 keysToFetch:(id)arg3;	// IMP=0x0000000000306328
...
- (id)preferredForNameMeContactIdentifier;	// IMP=0x00000000003062a4
...
- (void)dealloc;	// IMP=0x0000000000306162
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000030601f
- (id)initWithStore:(id)arg1;	// IMP=0x0000000000305e34
