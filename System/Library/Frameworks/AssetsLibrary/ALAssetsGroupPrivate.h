...
- (void).cxx_destruct;	// IMP=0x000000000000c509
...
- (void)_performBlockAndWait:(CDUnknownBlockType)arg1;	// IMP=0x000000000000c288
- (void)libraryDidChange;	// IMP=0x000000000000c276
@property(nonatomic) ALAssetsLibrary *library;
- (void)setValue:(id)arg1 forProperty:(id)arg2;	// IMP=0x000000000000c1fc
- (id)valueForProperty:(id)arg1;	// IMP=0x000000000000c18f
- (void)populateAssets;	// IMP=0x000000000000c171
- (void)updateAlbumFiltering;	// IMP=0x000000000000c125
- (void)resetAssets;	// IMP=0x000000000000c0df
- (int)albumFilter;	// IMP=0x000000000000c05b
- (void)dealloc;	// IMP=0x000000000000bfa7
- (id)initWithAlbum:(id)arg1 library:(id)arg2;	// IMP=0x000000000000becb
