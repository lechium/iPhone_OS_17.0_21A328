...
- (void).cxx_destruct;	// IMP=0x0000000000012607
...
- (id)initWithXPCDictionary:(id)arg1;	// IMP=0x000000000001251e
- (void)encodeWithXPCDictionary:(id)arg1;	// IMP=0x000000000001248f
- (id)initWithText:(id)arg1 simLabel:(id)arg2 phoneNumber:(id)arg3;	// IMP=0x000000000001240d
