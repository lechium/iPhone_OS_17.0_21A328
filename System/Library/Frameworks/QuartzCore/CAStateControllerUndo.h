...
- (void)dealloc;	// IMP=0x000000000002a300
- (void)addTransition:(id)arg1;	// IMP=0x000000000002a2c3
- (void)willAddLayer:(id)arg1;	// IMP=0x000000000002a2bd
- (void)addElement:(id)arg1;	// IMP=0x000000000002a280
