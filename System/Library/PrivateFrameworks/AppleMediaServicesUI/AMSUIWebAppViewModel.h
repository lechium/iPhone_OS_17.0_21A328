...
+ (_Bool)validateJSObject:(id)arg1;	// IMP=0x0010000000080afa
- (void).cxx_destruct;	// IMP=0x0000000000080ba3
...
- (id)iconWithSize:(struct CGSize)arg1 scale:(double)arg2;	// IMP=0x00000000000806a9
- (id)createBarButtonItem;	// IMP=0x00000000000800fd
- (id)initWithJSObject:(id)arg1 context:(id)arg2;	// IMP=0x000000000007fd04
