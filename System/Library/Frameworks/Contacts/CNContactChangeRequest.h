...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000021edc
+ (id)contactChangeRequestWithKind:(long long)arg1 contacts:(id)arg2 linkIdentifier:(id)arg3;	// IMP=0x0010000000021d9b
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000002205e
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000021ee4
- (id)initWithKind:(long long)arg1 contacts:(id)arg2 linkIdentifier:(id)arg3;	// IMP=0x0000000000021e18
