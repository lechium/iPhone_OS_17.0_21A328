...
+ (long long)isPredominatelyDownload;	// IMP=0x00600000000f81e8
+ (id)nameForState:(unsigned long long)arg1;	// IMP=0x00600000000f52b4
- (void).cxx_destruct;	// IMP=0x00000000000f8918
...
- (void)_finishOnCallbackQueueWithError:(id)arg1;	// IMP=0x00000000000f8438
- (void)main;	// IMP=0x00000000000f81f0
- (void)_fetchRecords;	// IMP=0x00000000000f79db
- (void)_handleRecordFetched:(id)arg1 recordID:(id)arg2 error:(id)arg3;	// IMP=0x00000000000f6859
- (struct _PCSIdentityData *)_copyShareProtectionFromRecord:(id)arg1 error:(id *)arg2;	// IMP=0x00000000000f63e4
- (void)_saveRecords;	// IMP=0x00000000000f5978
- (void)_handleRecordSaved:(id)arg1 error:(id)arg2;	// IMP=0x00000000000f5316
- (_Bool)makeStateTransition;	// IMP=0x00000000000f5120
- (id)activityCreate;	// IMP=0x00000000000f50f7
- (id)initWithOperationInfo:(id)arg1 container:(id)arg2;	// IMP=0x00000000000f4ff5
