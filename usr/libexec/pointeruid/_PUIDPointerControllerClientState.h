...
// Error: Property attributes should begin with the type ('T') attribute, property name: assertingPointerVisible
// Property attributes: (null)

- (_Bool)isAssertingPointerVisible;	// IMP=0x0010000000011d72
...
- (void)startAutomaticRegionExitTimerWithDelayInterval:(double)arg1 fireHandler:(CDUnknownBlockType)arg2;	// IMP=0x0010000000011afe
- (void)invalidateAutomaticRegionExitTimer;	// IMP=0x0010000000011acc
- (id)init;	// IMP=0x0010000000011a49
