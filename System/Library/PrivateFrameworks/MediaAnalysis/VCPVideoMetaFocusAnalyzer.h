...
- (void).cxx_destruct;	// IMP=0x00000000002be798
@property(readonly, retain, nonatomic) NSArray *results;
- (int)finalizeAnalysis;	// IMP=0x00000000002be6f3
- (void)addSegmentToResults;	// IMP=0x00000000002be4c5
- (int)processFrameMetadata:(id)arg1;	// IMP=0x00000000002be2b6
- (id)init;	// IMP=0x00000000002be1d0
