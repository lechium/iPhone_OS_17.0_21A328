...
- (void).cxx_destruct;	// IMP=0x00200000000e5db8
...
- (void)_setAudioFileIOTransactionState:(long long)arg1;	// IMP=0x00100000000e5a77
- (void)_setSpeechRecognitionTransactionState:(long long)arg1;	// IMP=0x00100000000e577c
- (void)dealloc;	// IMP=0x00100000000e54ae
- (id)initWithUUID:(id)arg1 timestamp:(unsigned long long)arg2 languageCode:(id)arg3 options:(id)arg4 speechRequestOptions:(id)arg5;	// IMP=0x00100000000e53a3
- (id)init;	// IMP=0x00100000000e5395
