...
- (void).cxx_destruct;	// IMP=0x000000000005d6fe
...
- (id)associatedAppTelemetryEvent;	// IMP=0x000000000005d5d9
- (id)subDescription;	// IMP=0x000000000005d520
- (id)additionalPayload;	// IMP=0x000000000005d3dd
