...
- (void).cxx_destruct;	// IMP=0x0000000000a4310e
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000a42e82
- (unsigned long long)hash;	// IMP=0x0000000000a42cf2
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000a42a8a
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000a428bf
- (void)copyTo:(id)arg1;	// IMP=0x0000000000a42726
- (void)writeTo:(id)arg1;	// IMP=0x0000000000a4256c
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000a41e54
- (id)dictionaryRepresentation;	// IMP=0x0000000000a41a50
- (id)description;	// IMP=0x0000000000a419a1
