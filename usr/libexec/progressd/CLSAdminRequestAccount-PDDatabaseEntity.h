...
+ (_Bool)migrateFromVersion:(unsigned long long)arg1 finalVersion:(out unsigned long long *)arg2 inDatabase:(id)arg3;	// IMP=0x00200000000f4dc3
+ (id)entityName;	// IMP=0x00100000000f473f
- (void)bindTo:(id)arg1;	// IMP=0x00200000000f4a7b
- (id)initWithDatabaseRow:(id)arg1;	// IMP=0x00100000000f474c
