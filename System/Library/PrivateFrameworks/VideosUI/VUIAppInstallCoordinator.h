...
- (void).cxx_destruct;	// IMP=0x00000000001618d9
...
- (void)_installAppWithChannel:(id)arg1 punchoutURL:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x000000000016103a
- (void)installAppWithPunchoutURL:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000000160f5d
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000160e96
- (unsigned long long)hash;	// IMP=0x0000000000160e28
- (id)initWithChannelDetails:(id)arg1 contentTitle:(id)arg2;	// IMP=0x0000000000160d6b
