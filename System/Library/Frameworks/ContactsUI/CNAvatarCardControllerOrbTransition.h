...
- (void).cxx_destruct;	// IMP=0x000000000017415a
...
- (struct CGRect)_sourceRectInContainerView:(id)arg1;	// IMP=0x0000000000173a7a
- (void)transitionDidEnd:(_Bool)arg1;	// IMP=0x00000000001739d2
- (void)performTransitionFromView:(id)arg1 toView:(id)arg2 containerView:(id)arg3;	// IMP=0x0000000000173682
- (void)setupTransitionFromView:(id)arg1 toView:(id)arg2 withContainerView:(id)arg3;	// IMP=0x00000000001731cc
- (void)prepareTransitionFromView:(id)arg1 toView:(id)arg2 containerView:(id)arg3;	// IMP=0x0000000000172c71
- (id)initWithCardViewController:(id)arg1 headerView:(id)arg2 sourceView:(id)arg3 highlightedView:(id)arg4 sourceRect:(struct CGRect)arg5 backgroundVisualEffectView:(id)arg6 isDismissing:(_Bool)arg7;	// IMP=0x0000000000172b4d
