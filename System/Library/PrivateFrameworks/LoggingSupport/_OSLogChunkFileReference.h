...
- (void).cxx_destruct;	// IMP=0x000000000001706a
...
- (id)copyMappedChunkFile:(id *)arg1;	// IMP=0x0000000000016f3a
- (_Bool)readXattrForTimespan:(id *)arg1;	// IMP=0x0000000000016cd8
- (void)dealloc;	// IMP=0x0000000000016c9e
- (id)initWithCollection:(id)arg1 subpath:(const char *)arg2;	// IMP=0x0000000000016c1f
