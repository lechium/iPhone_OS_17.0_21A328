...
- (void).cxx_destruct;	// IMP=0x000000000005d39f
...
- (void)associateWithCompletedOperation:(id)arg1;	// IMP=0x000000000005d1ee
- (id)associatedAppTelemetryEvent;	// IMP=0x000000000005d1e6
- (id)additionalPayload;	// IMP=0x000000000005d1d9
- (id)subDescription;	// IMP=0x000000000005d1cc
- (double)duration;	// IMP=0x000000000005d149
- (id)description;	// IMP=0x000000000005d0b5
- (id)initWithEventName:(id)arg1;	// IMP=0x000000000005d045
