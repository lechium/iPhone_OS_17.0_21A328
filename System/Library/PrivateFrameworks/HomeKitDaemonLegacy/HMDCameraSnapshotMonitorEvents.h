...
+ (id)logCategory;	// IMP=0x00100000006ae156
+ (_Bool)hasMessageReceiverChildren;	// IMP=0x00100000006ae14e
- (void).cxx_destruct;	// IMP=0x00000000006aa2c3
...
- (void)timerDidFire:(id)arg1;	// IMP=0x00000000006a9e1d
- (void)handleCameraSettingsDidUpdateNotification:(id)arg1;	// IMP=0x00000000006a9d66
- (void)handleCharacteristicsChangedNotification:(id)arg1;	// IMP=0x00000000006a9caf
- (void)handleBulletinBoardNotificationDidUpdateNotification:(id)arg1;	// IMP=0x00000000006a9bf8
- (void)listener:(id)arg1 didUpdateAvailableCharacteristics:(id)arg2;	// IMP=0x00000000006a9aa8
- (void)dealloc;	// IMP=0x00000000006a98e8
- (void)registerForMessages;	// IMP=0x00000000006a96e8
- (id)initWithSnapshotManager:(id)arg1 accessory:(id)arg2 workQueue:(id)arg3 msgDispatcher:(id)arg4;	// IMP=0x00000000006a919f
