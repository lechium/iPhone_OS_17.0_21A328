...
- (void).cxx_destruct;	// IMP=0x000000000004ae5f
...
- (void)_updateTopHairlineColor;	// IMP=0x000000000004ad89
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x000000000004a8c2
- (void)layoutSubviews;	// IMP=0x000000000004a64c
