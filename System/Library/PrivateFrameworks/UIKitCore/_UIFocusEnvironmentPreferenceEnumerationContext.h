...
- (void).cxx_destruct;	// IMP=0x00000000007e7248
...
- (void)_reportInferredPreferredFocusEnvironment:(id)arg1;	// IMP=0x00000000007e706f
- (void)_stopLogging;	// IMP=0x00000000007e7055
- (id)_startLogging;	// IMP=0x00000000007e6d63
- (void)popEnvironment;	// IMP=0x00000000007e6c48
- (void)pushEnvironment:(id)arg1;	// IMP=0x00000000007e69fb
- (_Bool)_isAllowedToPreferEnvironment:(id)arg1;	// IMP=0x00000000007e69cd
- (id)_inferPreferencesForEnvironment:(id)arg1;	// IMP=0x00000000007e682b
- (void)_resolvePreferredFocusEnvironments;	// IMP=0x00000000007e6233
- (void)_invalidatePreferredEnvironments;	// IMP=0x00000000007e6209
...
- (id)initWithFocusEnvironment:(id)arg1 enumerationMode:(long long)arg2;	// IMP=0x00000000007e5bad
- (id)init;	// IMP=0x00000000007e5b26
