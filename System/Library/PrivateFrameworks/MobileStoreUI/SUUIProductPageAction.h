...
@class NSString, NSURL, SUUIItem, UIViewController;

__attribute__((visibility("hidden")))
@interface SUUIProductPageAction : NSObject
{
    long long _actionType;	// 8 = 0x8
    SUUIItem *_item;	// 16 = 0x10
    NSString *_urlTitle;	// 24 = 0x18
    CDUnknownBlockType _viewControllerBlock;	// 32 = 0x20
    NSURL *_url;	// 40 = 0x28
}

+ (id)actionWithType:(long long)arg1;	// IMP=0x0060000000380075
- (void).cxx_destruct;	// IMP=0x0000000000380131
...
@property(retain, nonatomic) SUUIItem *item; // @synthesize item=_item;
