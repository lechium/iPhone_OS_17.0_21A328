...
- (void).cxx_destruct;	// IMP=0x000000000008e0b2
...
- (void)finishWithError:(id)arg1;	// IMP=0x000000000008df3a
- (void)start;	// IMP=0x000000000008dd8b
- (id)initWithConnectionInterface:(id)arg1 actionMetadata:(id)arg2 suggestionContext:(id)arg3 queue:(id)arg4 completionHandler:(CDUnknownBlockType)arg5;	// IMP=0x000000000008db40
