...
- (void).cxx_destruct;	// IMP=0x00000000002a9567
...
- (id)attributeDescriptions;	// IMP=0x00000000002a933d
- (id)initWithInputLanguage:(id)arg1 outputVoiceLanguageCode:(id)arg2 outputVoiceGenderCode:(id)arg3 voiceName:(id)arg4;	// IMP=0x00000000002a9240
