...
- (void).cxx_destruct;	// IMP=0x00200000008d08c3
...
- (void)mapsForegrounded;	// IMP=0x00100000008d07cc
- (void)mapsBackgrounded;	// IMP=0x00100000008d07ba
- (void)endSession;	// IMP=0x00100000008d048e
- (void)captureIntent:(int)arg1 withFailure:(int)arg2;	// IMP=0x00100000008d03de
- (void)captureStatusIssue:(long long)arg1;	// IMP=0x00100000008d03d4
...
- (id)init;	// IMP=0x00100000008d02aa
