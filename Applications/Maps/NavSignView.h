...
- (void).cxx_destruct;	// IMP=0x0010000000a89139
...
- (double)_calculateInterLabelConstraintConstant;	// IMP=0x0010000000a889c5
- (void)_configureLabels;	// IMP=0x0010000000a8841b
...
- (void)_updateConstraints;	// IMP=0x0010000000a87bea
- (void)_setupConstraints;	// IMP=0x0010000000a871e3
- (void)_updateLabelText;	// IMP=0x0010000000a871dd
- (void)_setupSubviews;	// IMP=0x0010000000a86ed1
@property(readonly, nonatomic) id <NavSignLayoutDelegate> _defaultSignLayoutDelegate;
- (void)navSignLabel:(id)arg1 didSelectAlternate:(unsigned long long)arg2;	// IMP=0x0010000000a86ec3
- (void)layoutSubviews;	// IMP=0x0010000000a86ae3
- (void)updateTheme;	// IMP=0x0010000000a869b9
@property(nonatomic) double maxHeight;
- (void)setSignLayoutDelegate:(id)arg1 withAnimation:(id)arg2;	// IMP=0x0010000000a867b6
...
- (void)refreshSign;	// IMP=0x0010000000a86510
- (void)clearContent;	// IMP=0x0010000000a8647c
- (id)accessibilityIdentifier;	// IMP=0x0010000000a8646a
- (void)_maps_commonInit;	// IMP=0x0010000000a863bf
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000a86373
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0010000000a86316
