...
+ (id)transformerWithAxisTransitionZonePosition:(struct CGPoint)arg1 axisTransitionZoneSize:(struct CGSize)arg2;	// IMP=0x0060000000f11563
- (void).cxx_destruct;	// IMP=0x0000000000f124a7
...
- (void)didEndPanningWithTouchPosition:(struct CGPoint)arg1 currentTransformedPosition:(struct CGPoint)arg2;	// IMP=0x0000000000f12196
- (void)didPanWithTouchPosition:(struct CGPoint)arg1 currentTransformedPosition:(struct CGPoint)arg2;	// IMP=0x0000000000f1199a
- (void)didBeginPanningWithTouchPosition:(struct CGPoint)arg1 currentTransformedPosition:(struct CGPoint)arg2;	// IMP=0x0000000000f117d9
@property(readonly, nonatomic) struct CGVector velocity;
@property(readonly, nonatomic) struct CGVector offset;
- (void)_enterYLockedState;	// IMP=0x0000000000f1167d
- (void)lockIntoYAxis;	// IMP=0x0000000000f11666
- (double)timeIntervalSinceLastDirectionChange;	// IMP=0x0000000000f115b5
- (id)initWithAxisTransitionZonePosition:(struct CGPoint)arg1 axisTransitionZoneSize:(struct CGSize)arg2;	// IMP=0x0000000000f1146a
