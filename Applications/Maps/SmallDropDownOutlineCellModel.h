...
- (void).cxx_destruct;	// IMP=0x0020000000c3e40d
...
- (_Bool)needsReloadFromPreviousViewModel:(id)arg1;	// IMP=0x0010000000c3e3ba
@property(readonly, nonatomic) UICollectionViewCellRegistration *cellRegistration;
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000c3e1f9
@property(readonly) unsigned long long hash;
- (id)initWithButtonTitle:(id)arg1 dropDownTitles:(id)arg2 selectedIndex:(long long)arg3 delegate:(id)arg4 backgroundModel:(id)arg5;	// IMP=0x0010000000c3e0b7
