...
@interface MLRXPCActivityTaskWithClassAOnBattery : NSObject
{
...
- (void).cxx_destruct;	// IMP=0x002000000001f9fd
...
- (void)stop;	// IMP=0x001000000001f993
- (void)startTaskWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x001000000001f745
- (id)createTaskScheduler;	// IMP=0x001000000001f715
- (id)criteria;	// IMP=0x001000000001f620
