...
+ (id)logCategory;	// IMP=0x0010000000b64026
- (void).cxx_destruct;	// IMP=0x0000000000b63d4f
...
- (void)_pumpReadDataIfPossible;	// IMP=0x0000000000b63b1b
- (void)_closeSession;	// IMP=0x0000000000b63a41
- (void)asyncHandleRemoteCloseWithError:(id)arg1;	// IMP=0x0000000000b63989
- (void)asyncHandleIncomingPackets:(id)arg1 isEof:(_Bool)arg2;	// IMP=0x0000000000b638d2
- (void)read:(CDUnknownBlockType)arg1;	// IMP=0x0000000000b63792
- (void)cancelWithReason:(unsigned short)arg1;	// IMP=0x0000000000b63701
@property(readonly, getter=isActive) _Bool active;
- (void)dealloc;	// IMP=0x0000000000b635bb
- (id)initWithProtocol:(id)arg1 sessionIdentifier:(id)arg2 queue:(id)arg3 logIdentifier:(id)arg4;	// IMP=0x0000000000b6347c
