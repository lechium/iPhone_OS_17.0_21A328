...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000001095ca
- (void).cxx_destruct;	// IMP=0x0000000000109c5b
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000109947
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001095d2
- (id)init;	// IMP=0x0000000000109533
