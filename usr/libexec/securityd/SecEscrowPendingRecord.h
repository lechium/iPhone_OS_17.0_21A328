...
+ (id)loadAllFromKeychain:(id *)arg1;	// IMP=0x002000000017b019
+ (id)loadFromKeychain:(id)arg1 error:(id *)arg2;	// IMP=0x001000000017ad04
- (void).cxx_destruct;	// IMP=0x00200000002140b5
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000213e66
- (unsigned long long)hash;	// IMP=0x0010000000213d0a
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000213aca
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000021392a
- (void)copyTo:(id)arg1;	// IMP=0x00100000002137d3
- (void)writeTo:(id)arg1;	// IMP=0x001000000021366c
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000021314c
- (id)dictionaryRepresentation;	// IMP=0x0010000000212e5f
- (id)description;	// IMP=0x0010000000212db0
...
- (_Bool)deleteFromKeychain:(id *)arg1;	// IMP=0x001000000017aa46
- (_Bool)saveToKeychain:(id *)arg1;	// IMP=0x001000000017a447
- (_Bool)escrowAttemptedWithinLastSeconds:(double)arg1;	// IMP=0x001000000017ac48
