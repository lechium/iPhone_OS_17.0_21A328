...
- (void).cxx_destruct;	// IMP=0x0000000000005be1
...
- (void)invalidate;	// IMP=0x0000000000005b69
- (id)initWithIdleHandler:(CDUnknownBlockType)arg1 onResume:(CDUnknownBlockType)arg2;	// IMP=0x0000000000005acb
