...
@class MISSING_TYPE, UIContextMenuConfiguration, UIContextMenuInteraction, UITargetedPreview;
...
- (MISSING_TYPE *)contextMenuInteraction:configuration:dismissalPreviewForItemWithIdentifier: /* Error: Ran out of types for this method. */;
