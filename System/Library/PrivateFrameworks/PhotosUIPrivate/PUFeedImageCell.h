...
+ (Class)_contentViewClass;	// IMP=0x006000000020d08e
+ (long long)_videoOverlayButtonStyle;	// IMP=0x006000000020d083
+ (void)preloadResources;	// IMP=0x006000000020d02b
- (void).cxx_destruct;	// IMP=0x000000000020ccdc
...
- (void)_handleCommentButton:(id)arg1;	// IMP=0x000000000020c93f
- (void)_handlePlayButton:(id)arg1;	// IMP=0x000000000020c8e2
- (id)_imageCellDelegate;	// IMP=0x000000000020c8d0
- (void)_updateRoundedCornersOverlayView;	// IMP=0x000000000020c7a4
- (void)_invalidateOverlayPlayButtonBackground;	// IMP=0x000000000020c736
- (void)_updateCommentButton;	// IMP=0x000000000020c5f1
- (void)_updateOverlays;	// IMP=0x000000000020bfff
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x000000000020bfa5
- (void)layoutSubviews;	// IMP=0x000000000020b5b8
- (void)_layoutImageView;	// IMP=0x000000000020b528
- (void)_updateVideoViewContentMode;	// IMP=0x000000000020b3c9
- (void)_updateVideoPlayerContents;	// IMP=0x000000000020b1ef
- (void)setAudioSession:(id)arg1;	// IMP=0x000000000020b15c
- (void)setImage:(id)arg1 withTag:(long long)arg2;	// IMP=0x000000000020ada1
- (void)setParallaxOffset:(struct CGPoint)arg1;	// IMP=0x000000000020ad44
- (id)focusEffect;	// IMP=0x000000000020acc9
- (void)prepareForReuse;	// IMP=0x000000000020ac41
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000020aad4
