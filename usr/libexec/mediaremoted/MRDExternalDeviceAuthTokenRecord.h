...
- (void).cxx_destruct;	// IMP=0x002000000013f922
...
- (id)_copyWithZone:(struct _NSZone *)arg1 usingConcreteClass:(Class)arg2;	// IMP=0x001000000013f873
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000013f840
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000013f814
