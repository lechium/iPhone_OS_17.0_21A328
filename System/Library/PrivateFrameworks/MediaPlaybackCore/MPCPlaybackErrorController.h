...
- (void).cxx_destruct;	// IMP=0x00000000001e0d07
...
- (_Bool)isLeaseTakenError:(id)arg1;	// IMP=0x00000000001e0c43
- (_Bool)shouldHandleFirstItemFailure:(id)arg1 item:(id)arg2;	// IMP=0x00000000001e0b96
- (_Bool)isAssetUnavailableFailure:(id)arg1;	// IMP=0x00000000001e0b81
- (_Bool)isUnrecoverableAssetLoadingError:(id)arg1;	// IMP=0x00000000001e0b08
- (_Bool)isQueueLoadingFailure:(id)arg1;	// IMP=0x00000000001e0af3
- (_Bool)isFirstItemFailure:(id)arg1 item:(id)arg2;	// IMP=0x00000000001e0a0a
- (_Bool)canHandleFirstItemFailure;	// IMP=0x00000000001e0996
- (void)_notifyObserversForError:(id)arg1 item:(id)arg2;	// IMP=0x00000000001e0304
- (long long)_resolutionForPlaybackError:(id)arg1 item:(id)arg2;	// IMP=0x00000000001dfdf0
- (void)_playbackFailedWithError:(id)arg1 item:(id)arg2 canResolve:(_Bool)arg3 proposedResolution:(long long)arg4 completion:(CDUnknownBlockType)arg5;	// IMP=0x00000000001df8e5
- (void)reportCriticalError:(id)arg1 forItem:(id)arg2;	// IMP=0x00000000001df64f
- (void)resolveError:(id)arg1 forItem:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x00000000001de449
- (void)resetWithReason:(id)arg1;	// IMP=0x00000000001de3c2
@property(nonatomic) _Bool itemsHavePlayed;
- (id)initWithPlaybackEngine:(id)arg1 translator:(id)arg2 externalPlaybackRouter:(id)arg3;	// IMP=0x00000000001de2cc
