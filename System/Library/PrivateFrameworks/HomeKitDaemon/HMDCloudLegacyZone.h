...
+ (void)createLegacyZoneWithName:(id)arg1 owner:(id)arg2 cacheZone:(id)arg3 cloudCache:(id)arg4 completion:(CDUnknownBlockType)arg5;	// IMP=0x006000000038e420
+ (id)zoneSubscriptionName:(id)arg1;	// IMP=0x006000000038e413
+ (id)zoneRootRecordName;	// IMP=0x006000000038e3f4
- (void).cxx_destruct;	// IMP=0x000000000038e37f
- (void)setServerChangeToken:(id)arg1;	// IMP=0x000000000038e33e
- (id)createCloudZoneChangeTemporaryCache:(_Bool)arg1;	// IMP=0x000000000038e305
- (void)dropCachedRecords;	// IMP=0x000000000038e26d
- (id)createCloudRecordWithObjectID:(id)arg1 recordName:(id)arg2;	// IMP=0x000000000038dd40
- (id)homeDataV3ModelWithPushDataPush:(id)arg1;	// IMP=0x000000000038dd27
- (id)homeDataModelWithPushDataPush:(id)arg1;	// IMP=0x000000000038dd0b
- (id)metadataModelWithPushDataPush:(id)arg1;	// IMP=0x000000000038dcf2
...
- (_Bool)doesProcessChangeEvenIfDecryptionFails;	// IMP=0x000000000038d87c
