...
+ (id)sharedState;	// IMP=0x00600000007dca45
- (void).cxx_destruct;	// IMP=0x00000000007dca32
- (void)_callDidUpdateReachabilityChangeForCompanion:(_Bool)arg1 forDelegate:(id)arg2;	// IMP=0x00000000007dc9c5
- (void)registerDelegate:(id)arg1;	// IMP=0x00000000007dc94f
...
- (id)init;	// IMP=0x00000000007dc4ed
