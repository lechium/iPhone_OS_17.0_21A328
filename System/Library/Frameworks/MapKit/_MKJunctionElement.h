...
- (id)description;	// IMP=0x0000000000242f78
- (struct CGPoint)rightEdgePointAtDistanceFromBase:(double)arg1;	// IMP=0x0000000000242f0c
- (struct CGPoint)leftEdgePointAtDistanceFromBase:(double)arg1;	// IMP=0x0000000000242ea0
