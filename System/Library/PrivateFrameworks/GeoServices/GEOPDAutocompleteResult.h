...
- (void).cxx_destruct;	// IMP=0x00000000005461de
- (unsigned long long)hash;	// IMP=0x0000000000545f83
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000545ba7
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000005454c0
- (void)writeTo:(id)arg1;	// IMP=0x000000000054475e
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000054474f
- (id)jsonRepresentation;	// IMP=0x0000000000540da6
- (id)dictionaryRepresentation;	// IMP=0x000000000053fed3
- (id)description;	// IMP=0x000000000053fe24
- (id)initWithData:(id)arg1;	// IMP=0x000000000053de94
- (id)init;	// IMP=0x000000000053de38
