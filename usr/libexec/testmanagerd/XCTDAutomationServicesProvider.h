...
- (void).cxx_destruct;	// IMP=0x0020000000030a4f
...
- (void)orientationManagerDidUpdateInterfaceOrientation:(long long)arg1;	// IMP=0x001000000003092a
- (void)orientationManagerDidUpdateDeviceOrientation:(long long)arg1;	// IMP=0x00100000000308de
- (id)initWithAccessibilitySystem:(id)arg1 timeout:(double)arg2 error:(id *)arg3;	// IMP=0x001000000003076c
- (id)initWithApplicationLauncher:(id)arg1 orientationManager:(id)arg2 siriInterface:(id)arg3 systemConfiguration:(id)arg4 axManager:(id)arg5 touchGesturePerformer:(id)arg6;	// IMP=0x00100000000305f1
- (_Bool)loadAccessibilityWithTimeout:(double)arg1 error:(id *)arg2;	// IMP=0x00100000000303c3
- (void)unloadAccessibility;	// IMP=0x001000000003026c
- (void)invalidate;	// IMP=0x00100000000300ac
- (void)dealloc;	// IMP=0x001000000002ff80
