...
- (void).cxx_destruct;	// IMP=0x0000000000005d84
@property(readonly, nonatomic) NSSet *allowedSourceIdentifiers; // @synthesize allowedSourceIdentifiers=_allowedSourceIdentifiers;
- (_Bool)isActionAllowed:(unsigned long long)arg1 forStore:(void *)arg2 inDatabase:(struct CalDatabase *)arg3;	// IMP=0x0000000000005cc9
- (id)initWithAllowedSourceIdentifiers:(id)arg1 databaseDataProvider:(id)arg2;	// IMP=0x0000000000005c36
