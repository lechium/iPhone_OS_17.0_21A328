...
- (void)paymentWebService:(PKPaymentWebService *)arg1 addSecureElementPass:(PKSecureElementPass *)arg2 properties:(PKPassIngestionProperties *)arg3 completion:(void (^)(PKPaymentPass *))arg4;
