...
- (void).cxx_destruct;	// IMP=0x0000000000429bf4
...
- (void)endSimulationWithError:(id)arg1;	// IMP=0x00000000004299e3
- (void)updateSimulationWithProgress:(double)arg1;	// IMP=0x000000000042993f
- (void)_handleResultLivePhoto:(id)arg1 info:(id)arg2;	// IMP=0x00000000004297cd
- (id)init;	// IMP=0x000000000042971c
