...
- (void).cxx_destruct;	// IMP=0x00200000000026f0
...
- (void)_main_dismissAndExit;	// IMP=0x0010000000002225
- (void)_didCompleteWithError:(id)arg1;	// IMP=0x0010000000001fb2
- (void)_callCompletionWithAuthorization:(id)arg1 error:(id)arg2;	// IMP=0x0010000000001f24
- (void)authorizationViewController:(id)arg1 didRequestIconForRequestContext:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x0010000000001f04
- (void)authorizationViewController:(id)arg1 didRequestAuthorizationWithUserProvidedInformation:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x0010000000001e20
- (void)authorizationViewController:(id)arg1 didCompleteWithAuthorization:(id)arg2 error:(id)arg3;	// IMP=0x0010000000001d0c
- (void)handleCancellation:(id)arg1;	// IMP=0x0010000000001cb0
- (void)configureWithContext:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0010000000001a7d
- (id)remoteObjectInterface;	// IMP=0x0010000000001a64
- (void)setUpHostProxy;	// IMP=0x0010000000001899
