...
- (void).cxx_destruct;	// IMP=0x00200000000bd25a
...
- (MISSING_TYPE *)initWithBroadcastBlock:needsClientAck:messageUUID:priority:senderID:sequenceNumber: /* Error: Ran out of types for this method. */;	// IMP=0x00100000000bd07d
- (id)init;	// IMP=0x00100000000bd022
