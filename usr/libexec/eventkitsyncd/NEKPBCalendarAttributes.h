...
- (void).cxx_destruct;	// IMP=0x00200000000102b7
...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000000f75a
- (unsigned long long)hash;	// IMP=0x001000000000f0cd
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000000e6c7
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000000df6c
- (void)copyTo:(id)arg1;	// IMP=0x001000000000d95a
- (void)writeTo:(id)arg1;	// IMP=0x001000000000d33d
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000000d330
- (id)dictionaryRepresentation;	// IMP=0x001000000000b609
- (id)description;	// IMP=0x001000000000b55a
