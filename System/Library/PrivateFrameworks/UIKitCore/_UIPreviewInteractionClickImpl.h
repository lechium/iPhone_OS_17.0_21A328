...
- (void).cxx_destruct;	// IMP=0x00000000008b0c57
...
- (_Bool)gestureRecognizer:(id)arg1 shouldRecognizeSimultaneouslyWithGestureRecognizer:(id)arg2;	// IMP=0x00000000008b0acd
- (id)_gestureRecognizerForExclusionRelationship;	// IMP=0x00000000008b0abb
- (void)_endInteractionEffectIfNeeded;	// IMP=0x00000000008b09ec
- (void)_prepareInteractionEffect;	// IMP=0x00000000008b0723
- (void)clickInteractionDidClickUp:(id)arg1;	// IMP=0x00000000008af62f
- (void)clickInteractionDidClickDown:(id)arg1;	// IMP=0x00000000008af5ae
- (id)highlightEffectForClickInteraction:(id)arg1;	// IMP=0x00000000008af1d0
- (void)clickInteractionDidEnd:(id)arg1;	// IMP=0x00000000008af153
- (_Bool)clickInteractionShouldBegin:(id)arg1;	// IMP=0x00000000008af0cb
...
- (_Bool)_performPresentationIfPossible;	// IMP=0x00000000008aeb10
- (_Bool)_canPerformPresentation;	// IMP=0x00000000008aead3
- (void)_startPreviewAtLocation:(struct CGPoint)arg1 inCoordinateSpace:(id)arg2;	// IMP=0x00000000008aea8c
- (void)didMoveToView:(id)arg1;	// IMP=0x00000000008ae885
- (void)willMoveToView:(id)arg1;	// IMP=0x00000000008ae6fb
- (void)cancelInteraction;	// IMP=0x00000000008ae559
- (struct CGPoint)locationInCoordinateSpace:(id)arg1;	// IMP=0x00000000008ae472
- (void)dealloc;	// IMP=0x00000000008ae404
- (id)initWithView:(id)arg1 previewInteraction:(id)arg2;	// IMP=0x00000000008ae381
