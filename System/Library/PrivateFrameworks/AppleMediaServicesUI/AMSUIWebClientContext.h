...
+ (id)_createClientInfoFromAccount:(id)arg1 clientInfo:(id)arg2;	// IMP=0x00600000000907b8
+ (_Bool)_boolForKey:(id)arg1 defaultValue:(_Bool)arg2 domain:(struct __CFString *)arg3;	// IMP=0x0060000000090750
- (void).cxx_destruct;	// IMP=0x0000000000090e49
...
- (void)updateBackingBag:(id)arg1;	// IMP=0x000000000009073e
- (void)replaceCurrentAccount:(id)arg1 clientInfo:(id)arg2;	// IMP=0x000000000009016b
- (id)loadSnapshot;	// IMP=0x000000000008fe75
- (id)JSAccountFromAccount:(id)arg1 store:(id)arg2;	// IMP=0x000000000008f8ab
- (id)iTunesAccountFromJSDSID:(id)arg1;	// IMP=0x000000000008f790
- (id)iTunesAccountFromJSAccount:(id)arg1;	// IMP=0x000000000008f2fb
...
- (id)initWithAccount:(id)arg1 clientInfo:(id)arg2 backingBag:(id)arg3;	// IMP=0x000000000008f0a2
