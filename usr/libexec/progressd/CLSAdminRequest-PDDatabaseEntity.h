...
+ (_Bool)migrateFromVersion:(unsigned long long)arg1 finalVersion:(out unsigned long long *)arg2 inDatabase:(id)arg3;	// IMP=0x00200000000b6308
+ (id)entityName;	// IMP=0x00100000000b5ea8
- (void)bindTo:(id)arg1;	// IMP=0x00200000000b60d2
- (id)initWithDatabaseRow:(id)arg1;	// IMP=0x00100000000b5eb5
