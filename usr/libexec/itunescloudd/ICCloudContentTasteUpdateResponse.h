...
+ (id)eTagValueFromContentTasteResponse:(id)arg1;	// IMP=0x0040000000049c45
- (void).cxx_destruct;	// IMP=0x0020000000049c1d
...
- (id)initWithContentTasteResponse:(id)arg1;	// IMP=0x0010000000049b28
