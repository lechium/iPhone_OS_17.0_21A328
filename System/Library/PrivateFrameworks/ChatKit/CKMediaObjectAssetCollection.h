...
@interface CKMediaObjectAssetCollection : PXBaseDisplayCollection
{
}
...
- (id)localizedDateDescriptionWithOptions:(unsigned long long)arg1;	// IMP=0x000000000052c8a0
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000052c83f
