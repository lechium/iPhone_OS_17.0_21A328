...
- (void).cxx_destruct;	// IMP=0x0000000000245e00
...
- (id)networkOutputs;	// IMP=0x0000000000245af0
- (id)networkInputs;	// IMP=0x0000000000245850
- (void)removeOutput:(id)arg1;	// IMP=0x0000000000245700
- (void)addOutputs:(id)arg1;	// IMP=0x0000000000245410
- (void)removeInput:(id)arg1;	// IMP=0x00000000002452c0
- (void)addInputs:(id)arg1;	// IMP=0x0000000000244fd0
- (id)modelContainerPath;	// IMP=0x0000000000244cb0
- (void *)generateModelContainer;	// IMP=0x0000000000244af0
- (void)merge:(id)arg1;	// IMP=0x00000000002448b0
@property struct MontrealNeuralNetwork *nnObject; // @synthesize nnObject=_nnObject;
- (void)dealloc;	// IMP=0x00000000002447f0
- (id)initWithWeightFormat:(unsigned long long)arg1;	// IMP=0x0000000000244700
