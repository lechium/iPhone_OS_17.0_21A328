...
+ (float)getMemoryUsage:(id)arg1 logType:(id)arg2 timeDelta:(double)arg3;	// IMP=0x00600000000e7430
- (void).cxx_destruct;	// IMP=0x00000000000e79a0
...
- (double)getTime;	// IMP=0x00000000000e73c0
- (id)initWithSwitch:(_Bool)arg1 atLevel:(BOOL)arg2;	// IMP=0x00000000000e7230
