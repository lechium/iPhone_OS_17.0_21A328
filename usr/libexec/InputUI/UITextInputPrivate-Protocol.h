...
@class MISSING_TYPE, NSArray, NSAttributedString, NSDictionary, NSString, NSTextAlternatives, RTIInputSystemSourceSession, UIColor, UIDictationSerializableResults, UIFont, UITextInputTraits, UITextInteractionAssistant, UITextPosition, UITextRange, UITextSuggestion, UIView, WebEvent, _UISupplementalItem;
...
- (MISSING_TYPE *)correctedTypedText:rangeOfReplacement: /* Error: Ran out of types for this method. */;
