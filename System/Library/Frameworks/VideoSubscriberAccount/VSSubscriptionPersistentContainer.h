...
- (void).cxx_destruct;	// IMP=0x00000000000601c7
...
- (void)performBlockAndWait:(CDUnknownBlockType)arg1;	// IMP=0x000000000006010e
- (void)performBlock:(CDUnknownBlockType)arg1;	// IMP=0x00000000000600fa
- (void)_performBlock:(CDUnknownBlockType)arg1 andWait:(_Bool)arg2;	// IMP=0x000000000005fd79
- (_Bool)_setupPersistenceIfNeeded:(id *)arg1;	// IMP=0x000000000005f2d4
- (void)_removePersistentStore;	// IMP=0x000000000005f1bb
- (id)init;	// IMP=0x000000000005ee65
