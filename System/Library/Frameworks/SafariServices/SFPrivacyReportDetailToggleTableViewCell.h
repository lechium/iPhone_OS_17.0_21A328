...
- (void).cxx_destruct;	// IMP=0x0000000000054c08
...
- (void)_updateTitle;	// IMP=0x0000000000054a52
- (void)_selectDetailType:(long long)arg1;	// IMP=0x00000000000549e3
- (void)_addSegmentForDetailType:(long long)arg1;	// IMP=0x0000000000054820
- (id)initWithStyle:(long long)arg1 reuseIdentifier:(id)arg2;	// IMP=0x00000000000541b5
