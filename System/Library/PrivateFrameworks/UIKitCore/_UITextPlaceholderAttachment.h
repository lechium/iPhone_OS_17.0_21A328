...
- (void).cxx_destruct;	// IMP=0x000000000142ad7f
...
- (id)imageForBounds:(struct CGRect)arg1 textContainer:(id)arg2 characterIndex:(unsigned long long)arg3;	// IMP=0x000000000142ad29
