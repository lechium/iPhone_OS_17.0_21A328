...
+ (id)properties;	// IMP=0x0010000000666105
+ (id)defaultModelForHomeUUID:(id)arg1;	// IMP=0x0010000000666079
+ (id)modelIDForHomeUUID:(id)arg1;	// IMP=0x0010000000665f95
+ (id)modelNamespace;	// IMP=0x0010000000665f65
+ (Class)cd_entityClass;	// IMP=0x00100000007f724f
- (id)dependentUUIDs;	// IMP=0x0000000000665e1f
- (id)cd_generateValueForProperty:(id)arg1 managedObjectField:(id)arg2 context:(id)arg3;	// IMP=0x00000000007f7056
- (id)cd_generateValueForModelObjectFromManagedObject:(id)arg1 modelObjectField:(id)arg2 modelFieldInfo:(id)arg3;	// IMP=0x00000000007f6ef9
