...
- (id).cxx_construct;	// IMP=0x00000000028760c0
- (void).cxx_destruct;	// IMP=0x0000000002875fa0
...
- (void)resourceFinished:(void *)arg1 metrics:(const void *)arg2;	// IMP=0x0000000002875ea0
- (void)resource:(void *)arg1 loadFailedWithError:(const void *)arg2;	// IMP=0x0000000002875da0
- (void)resource:(void *)arg1 accessControlCheckFailedWithError:(const void *)arg2;	// IMP=0x0000000002875ca0
- (void)_resource:(void *)arg1 loadFinishedWithError:(id)arg2 metrics:(const void *)arg3;	// IMP=0x0000000002875890
- (void)resource:(void *)arg1 receivedRedirect:(const void *)arg2 request:(void *)arg3 completionHandler:(void *)arg4;	// IMP=0x0000000002875370
- (void)resource:(void *)arg1 receivedData:(void *)arg2;	// IMP=0x0000000002875220
- (_Bool)resource:(void *)arg1 shouldCacheResponse:(const void *)arg2;	// IMP=0x00000000028751d0
- (void)resource:(void *)arg1 receivedResponse:(const void *)arg2 completionHandler:(void *)arg3;	// IMP=0x0000000002874cb0
- (void)resource:(void *)arg1 sentBytes:(unsigned long long)arg2 totalBytesToBeSent:(unsigned long long)arg3;	// IMP=0x0000000002874ca0
- (id)_timingData;	// IMP=0x0000000002874c90
- (void)dealloc;	// IMP=0x0000000002874a90
- (void)resume;	// IMP=0x00000000028749f0
- (void)suspend;	// IMP=0x0000000002874950
- (void)cancel;	// IMP=0x0000000002874880
...
- (void)_cancel;	// IMP=0x00000000028745f0
- (void)_restart;	// IMP=0x00000000028740f0
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000028740e0
- (id)initWithSession:(id)arg1 identifier:(unsigned long long)arg2 request:(id)arg3;	// IMP=0x0000000002873fb0
