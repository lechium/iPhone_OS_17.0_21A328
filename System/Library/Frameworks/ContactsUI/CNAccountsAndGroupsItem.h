...
- (void).cxx_destruct;	// IMP=0x00000000001f7ee8
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001f7c0a
@property(readonly, nonatomic) UIImage *groupSymbol;
@property(readonly, nonatomic) NSString *contactCountString;
- (long long)localizedCompare:(id)arg1;	// IMP=0x00000000001f7a3b
- (id)arrayForDisplay:(_Bool)arg1;	// IMP=0x00000000001f7724
- (void)setSelected:(_Bool)arg1 affectingChildren:(_Bool)arg2;	// IMP=0x00000000001f73ca
...
- (id)initWithType:(long long)arg1 nameProvider:(CDUnknownBlockType)arg2;	// IMP=0x00000000001f700c
