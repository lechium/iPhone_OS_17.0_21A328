...
- (void).cxx_destruct;	// IMP=0x00000000004b9628
...
- (void)run;	// IMP=0x00000000004b9458
- (id)initWithReviewAsset:(id)arg1 directory:(id)arg2 contentEditingOutput:(id)arg3;	// IMP=0x00000000004b9301
