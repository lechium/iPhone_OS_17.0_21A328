...
- (void).cxx_destruct;	// IMP=0x0020000000286591
...
- (unsigned int)_numberOfOutagesSinceInterval:(double)arg1;	// IMP=0x001000000028610f
- (void)_addRemotePacketOutage;	// IMP=0x0010000000286081
- (id)description;	// IMP=0x0010000000285f93
@property(readonly, nonatomic) _Bool isFinished;
- (id)init;	// IMP=0x0010000000285c58
