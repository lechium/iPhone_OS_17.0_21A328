...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000005ac16
- (void).cxx_destruct;	// IMP=0x000000000005ad49
...
- (Class)clientPromiseClass;	// IMP=0x000000000005acd3
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000005ac1e
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000005ab30
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000005aa48
