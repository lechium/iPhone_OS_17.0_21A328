...
+ (id)frameWorkFetchResultsWithOperationResults:(id)arg1;	// IMP=0x00600000002a9f8b
- (void).cxx_destruct;	// IMP=0x00000000002a9f38
...
- (id)attributeDescriptions;	// IMP=0x00000000002a9d0e
- (id)initWithKeyPath:(id)arg1 setting:(id)arg2 metadata:(id)arg3 error:(id)arg4;	// IMP=0x00000000002a9c20
