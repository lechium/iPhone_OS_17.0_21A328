...
- (void).cxx_destruct;	// IMP=0x002000000005cbc0
...
- (_Bool)containsIdentifier:(id)arg1;	// IMP=0x001000000005c9f5
- (_Bool)removeIdentifier:(id)arg1;	// IMP=0x001000000005c79e
- (void)updateTimeOnIdentifier:(id)arg1;	// IMP=0x001000000005c606
- (_Bool)addIdentifierIfNotPresent:(id)arg1;	// IMP=0x001000000005bed4
- (id)initWithTimeout:(double)arg1;	// IMP=0x001000000005be19
