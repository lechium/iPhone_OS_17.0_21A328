...
- (void)fetchFPItem:(CDUnknownBlockType)arg1;	// IMP=0x002000000000beee
- (void)fetchURL:(CDUnknownBlockType)arg1;	// IMP=0x002000000000be1b
- (void)fetchParents:(CDUnknownBlockType)arg1;	// IMP=0x002000000000bd2d
- (void)fetchParent:(CDUnknownBlockType)arg1;	// IMP=0x002000000000bbe9
- (void)encodeNodeWithCoder:(id)arg1;	// IMP=0x002000000000bb87
- (long long)localizedStandardTagsCompareNode:(id)arg1;	// IMP=0x002000000000bb31
- (long long)_doc_fileTypeCompare:(id)arg1;	// IMP=0x002000000000baa0
