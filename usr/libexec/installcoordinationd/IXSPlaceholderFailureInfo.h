...
+ (_Bool)supportsSecureCoding;	// IMP=0x002000000003f144
- (void).cxx_destruct;	// IMP=0x002000000003f47a
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000003f2c6
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000003f14c
