...
- (void).cxx_destruct;	// IMP=0x00000000015af730
...
- (_Bool)isStable;	// IMP=0x00000000015af549
@property(retain, nonatomic) id <UIVectorOperatable> velocity;
- (id)stepWithDelta:(double)arg1;	// IMP=0x00000000015af2be
- (id)initWithCurrent:(id)arg1 targetValue:(id)arg2;	// IMP=0x00000000015af217
- (void)updateWithDescription:(id)arg1 initial:(_Bool)arg2;	// IMP=0x00000000015aec6c
- (void)updateWithDescription:(id)arg1;	// IMP=0x00000000015aec58
- (id)initWithDescription:(id)arg1 current:(id)arg2 targetValue:(id)arg3;	// IMP=0x00000000015aea18
