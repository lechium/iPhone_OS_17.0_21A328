...
- (void).cxx_destruct;	// IMP=0x000000000003a1a9
- (void)dealloc;	// IMP=0x000000000003a0ad
...
- (_Bool)conformsToProtocol:(id)arg1;	// IMP=0x0000000000039fda
- (_Bool)respondsToSelector:(SEL)arg1;	// IMP=0x0000000000039fc9
@property(readonly, copy) NSString *description;
- (id)forwardingTargetForSelector:(SEL)arg1;	// IMP=0x0000000000039f08
@property(readonly) unsigned long long streamReference;
@property(readonly) struct GTTraceStream *traceStream;
@property(readonly) struct GTTraceContext *traceContext;
- (void)touch;	// IMP=0x0000000000039ea8
- (id)originalObject;	// IMP=0x0000000000039e9a
@property(readonly) id <MTLDepthStencilState> baseObject;
- (id)initWithBaseObject:(id)arg1 captureDevice:(id)arg2;	// IMP=0x0000000000039dae
