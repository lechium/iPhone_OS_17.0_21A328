...
- (void).cxx_destruct;	// IMP=0x0000000000038322
...
- (void)eventDismiss:(id)arg1;	// IMP=0x0000000000038203
- (void)viewWillDisappear:(_Bool)arg1;	// IMP=0x0000000000038181
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x0000000000037fd3
