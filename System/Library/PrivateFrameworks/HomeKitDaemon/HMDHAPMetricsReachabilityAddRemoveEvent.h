...
- (void).cxx_destruct;	// IMP=0x0000000000aa4463
...
- (id)coreAnalyticsEventDictionary;	// IMP=0x0000000000aa435a
- (id)coreAnalyticsEventName;	// IMP=0x0000000000aa434d
- (id)initWithAccessory:(id)arg1 hmdAddRemoveEvent:(unsigned long long)arg2 forLinkType:(id)arg3;	// IMP=0x0000000000aa42c3
