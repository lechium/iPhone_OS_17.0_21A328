...
+ (id)defaultRouteAttributesForNavigationOfType:(int)arg1;	// IMP=0x0040000000294aa3
- (void).cxx_destruct;	// IMP=0x0020000000295f2b
...
- (void)_handleDirectionsResponse:(id)arg1 forRequest:(id)arg2 waypoints:(id)arg3 error:(id)arg4 directionsError:(id)arg5;	// IMP=0x0010000000295820
- (void)cancel;	// IMP=0x0010000000295794
- (void)loadNewRouteSet;	// IMP=0x0010000000295455
- (void)_addTimepointIfNeededToRouteAttributes:(id)arg1;	// IMP=0x00100000002952dc
- (id)_directionsRequestParameters;	// IMP=0x0010000000294c87
- (void)_setupFeedbackIfNeeded;	// IMP=0x0010000000294b98
- (id)initWithWaypoints:(id)arg1 type:(int)arg2 currentLocation:(id)arg3 fromCurrentLocation:(_Bool)arg4 withFeedback:(id)arg5;	// IMP=0x00100000002949d2
- (id)init;	// IMP=0x0010000000294993
- (void)dealloc;	// IMP=0x0010000000294940
