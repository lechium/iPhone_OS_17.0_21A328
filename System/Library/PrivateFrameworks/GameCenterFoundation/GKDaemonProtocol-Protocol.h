...
- (oneway void)getServicesForPID:(int)arg1 localPlayer:(GKPlayerInternal *)arg2 reply:(void (^)(id <GKAccountService>, id <GKProfileService>, id <GKFriendService>, id <GKGameService>, id <GKGameStatService>, id <GKChallengeService>, id <GKMultiplayerService>, id <GKTurnBasedService>, id <GKUtilityService>, id <GKBulletinService>, id <GKGameSessionService>))arg3;
- (oneway void)messagesDidReceiveGameCenterURL:(NSURL *)arg1 senderHandle:(NSString *)arg2 contactID:(NSString *)arg3;
- (oneway void)setTestGame:(GKGameInternal *)arg1 protocolVersion:(NSString *)arg2 reply:(void (^)(void))arg3;
