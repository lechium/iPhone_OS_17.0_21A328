...
- (unsigned long long)hash;	// IMP=0x000000000003c1e2
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000003be5e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000003bb3e
- (void)writeTo:(id)arg1;	// IMP=0x000000000003b919
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000003b90c
- (id)dictionaryRepresentation;	// IMP=0x000000000003b370
- (id)description;	// IMP=0x000000000003b2c1
