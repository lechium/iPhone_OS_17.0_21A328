...
- (void).cxx_destruct;	// IMP=0x00000000001c8fb5
@property(nonatomic) unsigned long long rank; // @synthesize rank=_rank;
- (void)listItems:(CDUnknownBlockType)arg1;	// IMP=0x00000000001c8f12
- (id)description;	// IMP=0x00000000001c8e93
- (unsigned long long)batchCount;	// IMP=0x00000000001c8dc6
- (void)addDeletionOfFileObjectID:(id)arg1 rank:(unsigned long long)arg2;	// IMP=0x00000000001c8d85
- (void)addIndexOfItem:(id)arg1;	// IMP=0x00000000001c8c18
- (id)init;	// IMP=0x00000000001c8b7b
