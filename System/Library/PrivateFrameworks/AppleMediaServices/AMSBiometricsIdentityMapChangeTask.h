...
- (void).cxx_destruct;	// IMP=0x0000000000204bf1
...
- (id)perform;	// IMP=0x00000000002040ef
- (id)initWithAccount:(id)arg1 session:(id)arg2 task:(id)arg3;	// IMP=0x0000000000204025
