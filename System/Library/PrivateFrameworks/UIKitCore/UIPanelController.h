...
@interface UIPanelController : NSObject
{
    ...
    _UIMTCaptureView *__captureView;	// 192 = 0xc0
    UIDimmingView *__primaryParallaxDimmingView;	// 200 = 0xc8
    UIView *__sourceTransitionView;	// 208 = 0xd0
    UIView *__destTransitionView;	// 216 = 0xd8
    struct CGSize __lastViewSize;	// 224 = 0xe0
}

+ (id)_withDisabledAppearanceTransitions:(_Bool)arg1 forVisibleDescendantsOf:(id)arg2 perform:(CDUnknownBlockType)arg3;	// IMP=0x001000000059d4a0
- (void).cxx_destruct;	// IMP=0x00000000005ad2fc
...
- (void)_adjustNonOverlayLeadingScrollViewsForKeyboardInfo:(id)arg1;	// IMP=0x00000000005acd78
- (void)_adjustForKeyboardInfo:(id)arg1;	// IMP=0x00000000005ac74c
- (void)_stopObservingKeyboardNotifications;	// IMP=0x00000000005ac6a5
- (void)_observeKeyboardNotificationsOnScreen:(id)arg1;	// IMP=0x00000000005ac5bd
- (id)uncachedPossibleStatesForSize:(struct CGSize)arg1;	// IMP=0x00000000005ac521
...
- (void)animateToRequest:(id)arg1 forceOverlay:(_Bool)arg2 withVelocity:(double)arg3;	// IMP=0x00000000005ac106
- (void)animateToRequest:(id)arg1 forceOverlay:(_Bool)arg2;	// IMP=0x00000000005ac0f1
- (void)animateToRequest:(id)arg1;	// IMP=0x00000000005ac0dd
- (_Bool)isSupplementaryViewControllerVisibleAfterAnimation;	// IMP=0x00000000005ac03f
- (_Bool)isTrailingViewControllerVisibleAfterAnimation;	// IMP=0x00000000005abfa1
- (_Bool)isLeadingViewControllerVisibleAfterAnimation;	// IMP=0x00000000005abf03
@property(readonly, nonatomic) id <UIViewControllerTransitionCoordinator> transitionCoordinator;
- (_Bool)_animateCustomTransitionIfNeededWithAnimationState:(id)arg1 possiblePublicStates:(id)arg2 newPublicState:(id)arg3 estimatedDuration:(double)arg4 needsInitialLayout:(_Bool)arg5;	// IMP=0x00000000005ab150
- (void)_animateFromRequest:(id)arg1 toRequest:(id)arg2 withAffectedSides:(long long)arg3 forceOverlay:(_Bool)arg4 velocity:(double)arg5;	// IMP=0x00000000005aa013
- (struct CGSize)_expectedSecondaryColumnSizeAfterAnimatingToState:(id)arg1 getLeadingColumnSize:(struct CGSize *)arg2 trailingColumnSize:(struct CGSize *)arg3 supplementaryColumnSize:(struct CGSize *)arg4;	// IMP=0x00000000005a9932
- (void)stopAnimations;	// IMP=0x00000000005a991b
- (void)_stopAnimationsBeginningInteraction:(_Bool)arg1;	// IMP=0x00000000005a92e5
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x00000000005a9266
- (void)_updateBorderViewsBackgroundColor:(id)arg1;	// IMP=0x00000000005a911b
- (void)_setBorderViewsObserveViewBackgroundColor:(_Bool)arg1;	// IMP=0x00000000005a90ab
- (id)_createOverlayEdgeShadowViewForEdge:(unsigned long long)arg1;	// IMP=0x00000000005a906d
- (id)_createBorderView;	// IMP=0x00000000005a9025
- (double)interpolatedMarginForPrimaryNavigationBar:(id)arg1 supplementaryOrSecondaryNavbar:(id)arg2 getInterpolatedAlpha:(double *)arg3;	// IMP=0x00000000005a8cf9
- (void)_updateToNewPublicState:(id)arg1 withSize:(struct CGSize)arg2;	// IMP=0x00000000005a14b1
- (void)_unspecifiedUpdateToNewPublicState:(id)arg1 withSize:(struct CGSize)arg2;	// IMP=0x000000000059f3d3
- (void)_performWrappedUpdate:(CDUnknownBlockType)arg1;	// IMP=0x000000000059f144
- (void)_performSingleDeferredUpdatePass;	// IMP=0x000000000059e1cb
- (void)_performDeferredUpdate;	// IMP=0x000000000059e175
- (void)_setNeedsDeferredUpdate;	// IMP=0x000000000059dfdc
- (void)_setNeedsLayoutAndPerformImmediately:(_Bool)arg1;	// IMP=0x000000000059df9b
- (void)__viewWillLayoutSubviews;	// IMP=0x000000000059ddab
- (void)_layoutContainerViewDidMoveToWindow:(id)arg1;	// IMP=0x000000000059dca8
- (void)_layoutContainerViewWillMoveToWindow:(id)arg1;	// IMP=0x000000000059db26
- (void)_withDisabledAppearanceTransitionsPerform:(CDUnknownBlockType)arg1;	// IMP=0x000000000059cd9b
- (void)viewWillTransitionToSize:(struct CGSize)arg1 withTransitionCoordinator:(id)arg2 superBlock:(CDUnknownBlockType)arg3;	// IMP=0x000000000059ae2c
- (void)_clearSuspendedConfiguration;	// IMP=0x000000000059ae18
- (void)_storeSuspendedConfiguration;	// IMP=0x000000000059adaa
- (void)traitCollectionDidChange:(id)arg1 toNewTraits:(id)arg2;	// IMP=0x000000000059acec
- (void)willTransitionToTraitCollection:(id)arg1 withTransitionCoordinator:(id)arg2 superBlock:(CDUnknownBlockType)arg3;	// IMP=0x000000000059aac9
- (void)_expandWithTransitionCoordinator:(id)arg1;	// IMP=0x0000000000599f96
- (void)_collapseWithTransitionCoordinator:(id)arg1;	// IMP=0x0000000000598eb1
- (void)_updateForTraitCollection:(id)arg1 oldTraitCollection:(id)arg2 withTransitionCoordinator:(id)arg3;	// IMP=0x0000000000598b4a
- (_Bool)_willExpandWithNewTraitCollection:(id)arg1 oldTraitCollection:(id)arg2;	// IMP=0x0000000000598a6b
- (_Bool)_willCollapseWithNewTraitCollection:(id)arg1 oldTraitCollection:(id)arg2;	// IMP=0x0000000000598981
- (id)gatherMultitaskingDragExclusionRectsFromVisibleColumns;	// IMP=0x0000000000598381
- (void)addWrapperBlockForNextUpdate:(CDUnknownBlockType)arg1;	// IMP=0x00000000005982f4
@property(readonly, nonatomic, getter=isCollapsed) _Bool collapsed;
@property(readonly, nonatomic) long long collapsedState;
- (_Bool)isAnimating;	// IMP=0x00000000005980e8
- (void)setNeedsUpdate;	// IMP=0x00000000005980d6
- (id)allViewControllers;	// IMP=0x0000000000597f11
- (void)navigationControllerDidChangeNavigationBarHidden:(id)arg1;	// IMP=0x0000000000597f0b
- (void)preferredContentSizeDidChangeForChildContentContainer:(id)arg1;	// IMP=0x0000000000597ef9
- (void)removeChildViewController:(id)arg1;	// IMP=0x0000000000597c12
- (void)_removeIdentifiedChildViewController:(id)arg1;	// IMP=0x0000000000597b00
- (void)_addIdentifiedChildViewController:(id)arg1;	// IMP=0x00000000005977c9
- (void)loadView;	// IMP=0x00000000005974da
...
- (void)setSupplementaryViewController:(id)arg1 changingParentage:(_Bool)arg2;	// IMP=0x0000000000596e3a
@property(retain, nonatomic) UIViewController *supplementaryViewController;
- (void)setTrailingViewController:(id)arg1 changingParentage:(_Bool)arg2;	// IMP=0x0000000000596cdb
@property(retain, nonatomic) UIViewController *trailingViewController;
- (void)setLeadingViewController:(id)arg1 changingParentage:(_Bool)arg2;	// IMP=0x0000000000596b7c
@property(retain, nonatomic) UIViewController *leadingViewController;
- (void)setMainViewController:(id)arg1 changingParentage:(_Bool)arg2;	// IMP=0x0000000000596a1d
...
- (void)dealloc;	// IMP=0x000000000059693d
@property(readonly, nonatomic) _Bool supportsColumnStyle;
- (id)initWithOwningViewController:(id)arg1;	// IMP=0x000000000059682f
