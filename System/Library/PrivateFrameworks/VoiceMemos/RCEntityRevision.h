...
- (void)setRecordingID:(long long)arg1;	// IMP=0x0000000000043fa7
@property(readonly, nonatomic) long long recordingID;
- (void)setRevisionID:(long long)arg1;	// IMP=0x0000000000043ea4
@property(readonly, nonatomic) long long revisionID;
- (void)setRevisionType:(long long)arg1;	// IMP=0x0000000000043da1
