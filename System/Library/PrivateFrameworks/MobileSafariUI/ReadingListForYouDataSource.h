...
- (void).cxx_destruct;	// IMP=0x00000000000b719e
- (void)_readingListContentsDidChange:(id)arg1;	// IMP=0x00000000000b7187
- (void)retrieveRecommendationsMatchingTopic:(id)arg1 withCompletionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000000000b694b
- (void)dealloc;	// IMP=0x00000000000b68d6
- (id)initWithBookmarkProvider:(id)arg1 accessQueue:(id)arg2 imageCache:(id)arg3;	// IMP=0x00000000000b674b
