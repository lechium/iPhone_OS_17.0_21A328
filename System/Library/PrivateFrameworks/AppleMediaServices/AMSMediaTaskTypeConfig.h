...
+ (id)configForType:(long long)arg1;	// IMP=0x00600000002ef357
- (void).cxx_destruct;	// IMP=0x00000000002efa35
...
- (id)initWithType:(long long)arg1 typeString:(id)arg2 hostBagKey:(id)arg3 realm:(id)arg4 includePlatform:(_Bool)arg5;	// IMP=0x00000000002ef28c
