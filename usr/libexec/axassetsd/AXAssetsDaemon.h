...
+ (id)sharedInstance;	// IMP=0x002000000000e3a3
- (void).cxx_destruct;	// IMP=0x002000000000eea9
...
- (void)willBecomeIdle:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x001000000000ec2e
- (void)_updateAssetForAssetType:(id)arg1;	// IMP=0x001000000000ebbd
- (void)_refreshAssetCatalogForAssetType:(id)arg1 withOverrideTimeout:(id)arg2 forceCatalogRefresh:(_Bool)arg3;	// IMP=0x001000000000eb20
- (id)_managedAssetForAssetType:(id)arg1;	// IMP=0x001000000000e90c
- (void)run;	// IMP=0x001000000000e7a1
- (void)registerManagedAssets:(id)arg1;	// IMP=0x001000000000e738
- (void)registerManagedAsset:(id)arg1;	// IMP=0x001000000000e6cf
- (id)_init;	// IMP=0x001000000000e408
