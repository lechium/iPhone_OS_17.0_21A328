...
- (id)allObjects;	// IMP=0x0000000000003ffa
- (id)nextObject;	// IMP=0x0000000000003f27
- (id)initWithEnumerator:(id)arg1 filter:(CDUnknownBlockType)arg2;	// IMP=0x0000000000003e72
