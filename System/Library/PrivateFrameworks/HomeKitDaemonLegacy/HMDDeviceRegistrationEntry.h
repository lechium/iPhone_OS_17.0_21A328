...
- (void).cxx_destruct;	// IMP=0x00000000000af78c
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000af692
- (id)initWithDevice:(id)arg1 accessoryList:(id)arg2;	// IMP=0x00000000000af5f0
