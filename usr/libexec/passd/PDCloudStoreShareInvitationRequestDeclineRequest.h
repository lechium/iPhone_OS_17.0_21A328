...
- (void).cxx_destruct;	// IMP=0x00200000001b481c
...
- (id)description;	// IMP=0x00100000001b4697
- (_Bool)canCoalesceRequest:(id)arg1;	// IMP=0x00100000001b4399
- (id)initWithHandle:(id)arg1 zoneName:(id)arg2 containerName:(id)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x00100000001b42bb
