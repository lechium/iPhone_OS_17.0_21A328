...
- (void).cxx_destruct;	// IMP=0x00000000000dae26
...
- (void)_updateDocumentSizeLabel;	// IMP=0x00000000000dabad
- (void)_updatePropertiesDefinedByContentSizeCategory;	// IMP=0x00000000000daace
- (void)_configureOrientationBasedConstraints:(long long)arg1;	// IMP=0x00000000000daa39
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x00000000000da976
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000000da22e
