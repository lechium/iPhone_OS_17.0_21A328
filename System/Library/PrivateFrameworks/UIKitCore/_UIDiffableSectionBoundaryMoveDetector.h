...
- (void).cxx_destruct;	// IMP=0x0000000000a86f8f
...
- (id)_computeMovePairsFoundation;	// IMP=0x0000000000a8664a
- (id)initWithItemDiffer:(id)arg1 beforeDataSourceState:(id)arg2 afterDataSourceState:(id)arg3;	// IMP=0x0000000000a86533
