...
- (void).cxx_destruct;	// IMP=0x000000000008d866
...
- (id)initWithPlatform:(long long)arg1 sizeClass:(unsigned long long)arg2 fontScalingFactor:(double)arg3;	// IMP=0x000000000008d4b3
