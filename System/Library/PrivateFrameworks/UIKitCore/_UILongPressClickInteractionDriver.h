...
+ (_Bool)prefersCancelsTouchesInView;	// IMP=0x0010000000502b60
+ (_Bool)requiresForceCapability;	// IMP=0x0010000000502b58
- (void).cxx_destruct;	// IMP=0x0000000000503ae4
...
- (void)_gestureRecognizerFailed:(id)arg1;	// IMP=0x0000000000503a37
- (_Bool)gestureRecognizer:(id)arg1 shouldRecognizeSimultaneouslyWithGestureRecognizer:(id)arg2;	// IMP=0x0000000000503a2f
- (_Bool)gestureRecognizer:(id)arg1 shouldRequireFailureOfGestureRecognizer:(id)arg2;	// IMP=0x0000000000503932
- (_Bool)gestureRecognizer:(id)arg1 shouldBeRequiredToFailByGestureRecognizer:(id)arg2;	// IMP=0x0000000000503796
- (_Bool)gestureRecognizer:(id)arg1 shouldReceiveTouch:(id)arg2;	// IMP=0x000000000050370e
- (void)_notifyDelegateOfUpdatedClickDownProgress:(double)arg1 forceAdjustedClickDownDuration:(double)arg2;	// IMP=0x00000000005035c0
- (void)_updateForActiveGestureRecognizer;	// IMP=0x0000000000503327
- (void)_asyncGestureBegan;	// IMP=0x00000000005032c9
- (void)_handleGestureRecognizer:(id)arg1;	// IMP=0x00000000005030e2
...
- (struct CGPoint)locationInCoordinateSpace:(id)arg1;	// IMP=0x0000000000502df8
- (void)cancelInteraction;	// IMP=0x0000000000502d70
...
- (id)init;	// IMP=0x000000000050260b
