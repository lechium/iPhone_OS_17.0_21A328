...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000000138fe
- (unsigned long long)hash;	// IMP=0x001000000001385d
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000013718
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000001364a
- (void)copyTo:(id)arg1;	// IMP=0x001000000001359f
- (void)writeTo:(id)arg1;	// IMP=0x00100000000134c9
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000000134bc
- (id)dictionaryRepresentation;	// IMP=0x0010000000012eb6
- (id)description;	// IMP=0x0010000000012e07
