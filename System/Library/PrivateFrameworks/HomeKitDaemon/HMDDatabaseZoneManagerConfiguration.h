...
- (void).cxx_destruct;	// IMP=0x0000000000521911
...
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000005216ed
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000005216e2
- (unsigned long long)hash;	// IMP=0x00000000005215bf
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000052133e
- (id)attributeDescriptions;	// IMP=0x000000000052101c
- (id)init;	// IMP=0x0000000000520f12
