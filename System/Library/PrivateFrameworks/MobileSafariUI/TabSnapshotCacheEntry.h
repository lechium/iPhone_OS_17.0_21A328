...
@interface TabSnapshotCacheEntry : NSObject
{
    ...
    id <TabSnapshotCacheEntryStateObserving> _stateObserver;	// 48 = 0x30
}

- (void).cxx_destruct;	// IMP=0x000000000021cd1a
...
- (id)debugDescription;	// IMP=0x000000000021cab0
- (id)initWithIdentifier:(id)arg1 isGroup:(_Bool)arg2;	// IMP=0x000000000021c9f0
