...
- (void).cxx_destruct;	// IMP=0x00200000005ac431
...
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x00100000005ac133
- (void)pressedCell:(id)arg1;	// IMP=0x00100000005abf5c
- (id)initWithColors:(id)arg1 colorsPerRow:(unsigned long long)arg2 colorEdgeInsets:(struct UIEdgeInsets)arg3 selectedIndex:(id)arg4 contrastColor:(id)arg5 delegate:(id)arg6;	// IMP=0x00100000005ab24c
