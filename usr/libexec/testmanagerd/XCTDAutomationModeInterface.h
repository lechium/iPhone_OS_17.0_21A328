...
+ (id)sharedInterface;	// IMP=0x0020000000042168
+ (void)provideCapabilitiesToBuilder:(id)arg1;	// IMP=0x0010000000041f1f
- (void).cxx_destruct;	// IMP=0x0020000000042c70
...
- (void)unregisterAutomationModeChangeHandlerWithToken:(id)arg1;	// IMP=0x0010000000042b98
- (id)registerAutomationModeChangeHandlerOnQueue:(id)arg1 withBlock:(CDUnknownBlockType)arg2;	// IMP=0x0010000000042b0f
- (void)disableAutomationModeForClient:(id)arg1;	// IMP=0x0010000000042804
- (_Bool)enableAutomationModeForClient:(id)arg1 error:(id *)arg2;	// IMP=0x00100000000425c1
@property(readonly) _Bool isAutomationModeEnabled;
- (void)dealloc;	// IMP=0x0010000000042517
- (id)initForUnsupportedSystems;	// IMP=0x00100000000424ce
- (id)initWithAutomationModeFunctions:(CDStruct_6bdebbfa)arg1;	// IMP=0x001000000004225d
