...
- (void).cxx_destruct;	// IMP=0x00000000000d1d4a
...
- (void)_dismissRecognized:(id)arg1;	// IMP=0x00000000000d1cbc
- (void)setTransparent:(_Bool)arg1;	// IMP=0x00000000000d1c90
- (void)setDimmedContentFrame:(struct CGRect)arg1;	// IMP=0x00000000000d1c73
- (_Bool)pointInside:(struct CGPoint)arg1 withEvent:(id)arg2;	// IMP=0x00000000000d1b68
- (id)initWithFrame:(struct CGRect)arg1 dimmedContentFrame:(struct CGRect)arg2;	// IMP=0x00000000000d19f2
