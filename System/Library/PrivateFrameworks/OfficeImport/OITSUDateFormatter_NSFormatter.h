...
- (void).cxx_destruct;	// IMP=0x00000000002504f4
...
- (id)stringForObjectValue:(id)arg1;	// IMP=0x0000000000250218
- (_Bool)getObjectValue:(out id *)arg1 forString:(id)arg2 errorDescription:(out id *)arg3;	// IMP=0x00000000002500cb
- (id)init;	// IMP=0x000000000024ff96
