...
- (void).cxx_destruct;	// IMP=0x00200000002465e6
...
- (void)setReceivedAWDLInfo:(_Bool)arg1;	// IMP=0x0010000000245fd1
- (_Bool)receivedAWDLInfo;	// IMP=0x0010000000245fc1
...
- (void)sendUnlockConfirmation:(_Bool)arg1 withError:(id)arg2 suppressNotification:(_Bool)arg3;	// IMP=0x0010000000245532
- (void)sendUnlockConfirmation:(_Bool)arg1 withError:(id)arg2;	// IMP=0x001000000024551d
- (void)completeAttemptPostNotification:(_Bool)arg1;	// IMP=0x001000000024547b
- (void)sendKeyExchangeResponseWithData:(id)arg1;	// IMP=0x00100000002451d2
- (void)sendAuthPromptImageDataIfReady:(id)arg1;	// IMP=0x001000000024495b
- (void)sendAuthPromptRequestWithImageHash:(id)arg1 appName:(id)arg2;	// IMP=0x001000000024451e
- (void)sendAWDLInfoData:(id)arg1 type:(unsigned short)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0010000000244188
- (void)consumeAuthTokenIfReady;	// IMP=0x0010000000243a62
- (void)startAWDL;	// IMP=0x0010000000243048
- (void)handleConfirmationACK;	// IMP=0x0010000000242dca
- (void)handleSessionAuthToken:(id)arg1;	// IMP=0x00100000002428f4
- (void)handleSessionKeyExchangeRequest:(id)arg1;	// IMP=0x0010000000241f9a
- (void)handleAuthPromptResponse:(id)arg1;	// IMP=0x0010000000241c55
- (void)handleAWDLInfo:(id)arg1;	// IMP=0x0010000000241558
- (void)handleMessageWithWrapper:(id)arg1;	// IMP=0x001000000024110d
- (void)notifyDelegateWithError:(id)arg1;	// IMP=0x0010000000240ec6
- (void)handleWiFiRequestInvalidated;	// IMP=0x0010000000240e6a
- (void)handleRangingStarted;	// IMP=0x0010000000240d66
- (void)handlePeerFound:(_Bool)arg1;	// IMP=0x0010000000240ca7
- (void)handleAWDLUp;	// IMP=0x0010000000240af2
- (void)handlePeerOutOfRange;	// IMP=0x0010000000240805
- (void)handlePeerInRange;	// IMP=0x001000000024051d
- (_Bool)peerInRange:(id)arg1;	// IMP=0x0010000000240379
- (void)handleRangingResults:(id)arg1 errorCode:(long long)arg2;	// IMP=0x001000000023fe46
- (void)invalidateConfirmationTimer;	// IMP=0x001000000023fd70
- (void)restartConfirmationTimer:(unsigned long long)arg1 error:(id)arg2;	// IMP=0x001000000023fae9
- (void)handleTimerFired;	// IMP=0x001000000023f60c
- (void)invalidateTimerIfReady;	// IMP=0x001000000023f5c1
- (id)aksPeerAvailable;	// IMP=0x001000000023f3dc
- (void)deviceConnected:(id)arg1;	// IMP=0x001000000023f007
- (_Bool)handleFoundBLEDevice:(id)arg1 available:(_Bool)arg2 lockedOnWrist:(_Bool)arg3;	// IMP=0x001000000023ed31
- (_Bool)handleFoundBLEDevice:(id)arg1;	// IMP=0x001000000023ecd2
- (void)connectionActivated;	// IMP=0x001000000023eb24
- (void)updateImageData:(id)arg1 imageHash:(id)arg2;	// IMP=0x001000000023e41a
- (id)getAppName;	// IMP=0x001000000023e412
@property(readonly, nonatomic) _Bool usingProxy;
- (id)hintToken;	// IMP=0x001000000023e2e1
- (_Bool)isAcceptor;	// IMP=0x001000000023e2d9
- (id)attemptResults;	// IMP=0x001000000023d684
- (void)logResults;	// IMP=0x001000000023c822
- (void)displayConfigChanged:(id)arg1;	// IMP=0x001000000023c786
- (void)clamshellStateChanged:(id)arg1;	// IMP=0x001000000023c6ea
- (void)removeObservers;	// IMP=0x001000000023c697
- (void)addObservers;	// IMP=0x001000000023c599
- (void)handleDecryptionFailure:(long long)arg1;	// IMP=0x001000000023c448
- (void)_handleCanceledAfterSuccess;	// IMP=0x001000000023c341
- (void)handleCanceledAfterSuccess;	// IMP=0x001000000023c2ba
- (void)lockKeyBagIfNeeded;	// IMP=0x001000000023c1dd
- (void)cancelWiFiRequest;	// IMP=0x001000000023bff6
- (void)_cancel;	// IMP=0x001000000023bcab
- (void)cancel;	// IMP=0x001000000023bc24
- (void)tearDownAWDLIfNecessary;	// IMP=0x001000000023ba50
- (void)completeAttemptIfNecessary;	// IMP=0x001000000023b88e
- (void)invalidateNoDisconnect;	// IMP=0x001000000023b85f
- (void)invalidate;	// IMP=0x001000000023b644
- (id)initWithAutoUnlockDevice:(id)arg1 sessionID:(id)arg2 bleDevice:(id)arg3;	// IMP=0x001000000023b248
