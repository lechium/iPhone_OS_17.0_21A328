...
- (void).cxx_destruct;	// IMP=0x0020000000003368
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000003349
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000000325e
- (unsigned long long)hash;	// IMP=0x0010000000003218
- (id)initWithAccessor:(id)arg1 clientProvidedIdentity:(id)arg2;	// IMP=0x001000000000317f
