...
+ (id)extensionInfoForCurrentProcess;	// IMP=0x001000000001a276
+ (void)notifyExtensionMainCalled;	// IMP=0x001000000001a245
- (void).cxx_destruct;	// IMP=0x000000000001a581
...
- (id)initForCurrentProcess;	// IMP=0x000000000001a2f1
