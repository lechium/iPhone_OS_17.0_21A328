...
- (void).cxx_destruct;	// IMP=0x00000000000179b0
- (id)nextThumbnailData;	// IMP=0x00000000000173f8
- (void)_createNewCacheIndexDatabaseEnumeratorWithFileIdentifier:(id)arg1;	// IMP=0x0000000000017312
- (id)initWithDiskCache:(id)arg1 fileIdentifier:(id)arg2;	// IMP=0x000000000001726d
