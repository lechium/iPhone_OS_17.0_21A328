...
- (void).cxx_destruct;	// IMP=0x00200000003362b2
...
- (id)description;	// IMP=0x001000000033619d
- (id)dictionaryValue;	// IMP=0x0010000000335ffd
- (id)initWithDictionary:(id)arg1;	// IMP=0x0010000000335e78
