...
- (void).cxx_destruct;	// IMP=0x0020000000085fd2
...
- (void)setNotificationRef:(struct __CFUserNotification *)arg1;	// IMP=0x0010000000085ee9
- (struct __CFUserNotification *)notificationRef;	// IMP=0x0010000000085edf
- (void)dealloc;	// IMP=0x0010000000085ea0
- (id)init;	// IMP=0x0010000000085e3e
