...
- (void).cxx_destruct;	// IMP=0x002000000003147e
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000000311ee
- (unsigned long long)hash;	// IMP=0x00100000000310e5
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000030efd
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000030d40
- (void)copyTo:(id)arg1;	// IMP=0x0010000000030bfd
- (void)writeTo:(id)arg1;	// IMP=0x0010000000030ad5
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000030ac8
- (MISSING_TYPE *)dictionaryRepresentation;	// IMP=0x00100000000306d4
- (id)description;	// IMP=0x0010000000030625
