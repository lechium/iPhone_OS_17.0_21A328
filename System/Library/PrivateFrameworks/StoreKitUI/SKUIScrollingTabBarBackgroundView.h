...
- (void).cxx_destruct;	// IMP=0x00000000001bae2d
...
- (void)_updateTopHairlineColor;	// IMP=0x00000000001bad57
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x00000000001ba890
- (void)layoutSubviews;	// IMP=0x00000000001ba5d0
