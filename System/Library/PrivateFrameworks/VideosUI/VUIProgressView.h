...
- (void).cxx_destruct;	// IMP=0x00000000002b51ee
...
- (void)_updateForStyleChange;	// IMP=0x00000000002b4f61
- (id)_maskImageForProgressBar;	// IMP=0x00000000002b4d8e
- (void)_layoutMaterialView;	// IMP=0x00000000002b4c7d
- (void)setSelected:(_Bool)arg1 animated:(_Bool)arg2;	// IMP=0x00000000002b47d2
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000002b4486
- (void)layoutSubviews;	// IMP=0x00000000002b4153
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000002b3e7e
