...
+ (id)dateFormatter;	// IMP=0x006000000020cbf4
- (void).cxx_destruct;	// IMP=0x000000000020cc4c
...
- (id)initWithReleaseNoteDictionary:(id)arg1 dateFormatter:(id)arg2;	// IMP=0x000000000020c9f1
