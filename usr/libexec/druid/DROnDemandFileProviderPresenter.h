...
+ (id)presenterPresentingURLWrapper:(id)arg1 type:(id)arg2 outURLWrapper:(id *)arg3;	// IMP=0x002000000000c773
+ (double)presenterValiditySeconds;	// IMP=0x001000000000bed5
+ (void)setPresenterValiditySeconds:(double)arg1;	// IMP=0x001000000000bec7
- (void).cxx_destruct;	// IMP=0x002000000000d1d7
...
- (void)relinquishPresentedItemToReader:(CDUnknownBlockType)arg1;	// IMP=0x001000000000c87e
@property(readonly, retain) NSOperationQueue *presentedItemOperationQueue;
@property(readonly, copy) NSURL *presentedItemURL;
- (void)_operationQueue_invalidate;	// IMP=0x001000000000c5fc
- (void)beginPresenting;	// IMP=0x001000000000c294
- (id)initWithURLWrapper:(id)arg1 type:(id)arg2;	// IMP=0x001000000000bee3
