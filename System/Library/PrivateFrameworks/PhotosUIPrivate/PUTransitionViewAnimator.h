...
- (void).cxx_destruct;	// IMP=0x00000000005845d4
...
- (void)_endWithTranslationVelocity:(struct CGPoint)arg1 rotationVelocity:(double)arg2 scaleVelocity:(double)arg3 shouldBounce:(_Bool)arg4 finish:(_Bool)arg5 animated:(_Bool)arg6;	// IMP=0x0000000000583979
- (void)_autoUpdate:(id)arg1;	// IMP=0x0000000000583967
- (void)_updateAutoUpdateDisplayLink;	// IMP=0x0000000000583846
- (void)_update;	// IMP=0x00000000005832a2
- (void)cancelWithoutAnimation;	// IMP=0x0000000000583270
- (void)cancelWithTranslationVelocity:(struct CGPoint)arg1 rotationVelocity:(double)arg2 scaleVelocity:(double)arg3 shouldBounce:(_Bool)arg4;	// IMP=0x0000000000583253
- (void)finishWithTranslationVelocity:(struct CGPoint)arg1 rotationVelocity:(double)arg2 scaleVelocity:(double)arg3 shouldBounce:(_Bool)arg4;	// IMP=0x0000000000583233
- (void)updateWithTranslation:(struct CGPoint)arg1 rotation:(double)arg2 scale:(double)arg3;	// IMP=0x000000000058318c
- (id)initWithView:(id)arg1 sourceFrame:(struct CGRect)arg2 targetFrame:(struct CGRect)arg3 anchorPoint:(struct CGPoint)arg4 shouldUseTargetAspectRatio:(_Bool)arg5 rampUpDuration:(double)arg6 direction:(unsigned long long)arg7;	// IMP=0x0000000000582ac8
