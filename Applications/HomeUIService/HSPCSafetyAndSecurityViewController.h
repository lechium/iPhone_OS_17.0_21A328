...
- (void).cxx_destruct;	// IMP=0x00200000000531a1
...
- (id)commitConfiguration;	// IMP=0x0010000000052d28
- (id)_enableSafetyAndSecuritySettings;	// IMP=0x0010000000052598
- (id)initWithCoordinator:(id)arg1 config:(id)arg2;	// IMP=0x0010000000052369
