...
+ (id)sharedInstance;	// IMP=0x0040000000009668
- (void).cxx_destruct;	// IMP=0x002000000000c259
...
- (id)_getBootTime;	// IMP=0x001000000000c105
- (id)_taskQueueForTask:(Class)arg1;	// IMP=0x001000000000bf3d
- (void)_handleXPCActivity:(id)arg1 taskClass:(Class)arg2;	// IMP=0x001000000000be0a
- (void)_dispatchTask:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x001000000000b3f4
- (id)_tasksForTriggerType:(unsigned long long)arg1;	// IMP=0x001000000000b05d
- (id)_anonymousTaskForId:(id)arg1 withArguments:(id)arg2;	// IMP=0x001000000000ada5
- (id)_tasksForNotification:(id)arg1;	// IMP=0x001000000000a7ed
- (void)_handleNotification:(id)arg1;	// IMP=0x001000000000a6a2
- (void)invokeTaskById:(id)arg1 arguments:(id)arg2;	// IMP=0x001000000000a64e
- (void)handleFirstUnlock;	// IMP=0x001000000000a3ae
- (void)handleFirstBoot:(_Bool)arg1;	// IMP=0x0010000000009fc9
- (void)registerTask:(Class)arg1;	// IMP=0x00100000000099f8
- (void)start;	// IMP=0x001000000000982c
- (id)init;	// IMP=0x00100000000096bd
