...
- (void).cxx_destruct;	// IMP=0x0000000000106963
- (id)flatbuffData;	// IMP=0x00000000001067dc
- (Offset_91732649)addObjectToBuffer:(void *)arg1;	// IMP=0x0000000000105d37
...
- (void)context_info_enumerateObjectsUsingBlock:(CDUnknownBlockType)arg1;	// IMP=0x00000000001053ed
- (unsigned long long)context_info_count;	// IMP=0x0000000000105351
- (id)context_info_objectAtIndex:(unsigned long long)arg1;	// IMP=0x0000000000105258
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000104e3c
- (id)initWithFlatbuffData:(id)arg1 root:(const struct TextToSpeechRequest *)arg2 verify:(_Bool)arg3;	// IMP=0x0000000000104c91
- (id)initWithFlatbuffData:(id)arg1 root:(const struct TextToSpeechRequest *)arg2;	// IMP=0x0000000000104c7c
- (id)initAndVerifyWithFlatbuffData:(id)arg1;	// IMP=0x0000000000104c62
- (id)initWithFlatbuffData:(id)arg1;	// IMP=0x0000000000104c4b
