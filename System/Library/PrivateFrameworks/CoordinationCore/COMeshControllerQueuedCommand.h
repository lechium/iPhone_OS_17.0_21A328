...
- (void)invokeCallbackWithError:(id)arg1;	// IMP=0x0000000000094873
- (id)initWithCommand:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000000000947c8
