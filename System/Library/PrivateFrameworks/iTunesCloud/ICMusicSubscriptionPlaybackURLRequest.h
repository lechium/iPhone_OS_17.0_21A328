...
- (void).cxx_destruct;	// IMP=0x00000000001601a8
...
- (id)_analyticSignature;	// IMP=0x000000000015ff2f
- (id)description;	// IMP=0x000000000015fe45
- (void)_populateItemIdentifiers:(id)arg1;	// IMP=0x000000000015fc66
- (id)_actionType;	// IMP=0x000000000015fc30
- (void)buildStoreURLRequestWithURLRequest:(id)arg1 builderProperties:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x000000000015fb60
