...
+ (unsigned int)mediaTypeForStoreDownload:(id)arg1;	// IMP=0x002000000010791b
- (id)_copyChapterVideoTracksForAsset:(id)arg1;	// IMP=0x0020000000108f37
@property long long updateType;
- (void)setValue:(id)arg1 forAdditionalEntityProperty:(id)arg2;	// IMP=0x0010000000108dd0
...
- (void)loadPropertiesFromMediaPath:(id)arg1 includeTracks:(_Bool)arg2;	// IMP=0x00100000001084d7
@property(readonly) _Bool hasItemArtwork;
@property(readonly, getter=isDownloading) _Bool downloading;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000107764
- (void)dealloc;	// IMP=0x00100000001076f5
- (id)init;	// IMP=0x00100000001076a7
