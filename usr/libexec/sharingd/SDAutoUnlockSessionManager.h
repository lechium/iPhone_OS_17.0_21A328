...
+ (id)sharedManager;	// IMP=0x0020000000077575
- (void).cxx_destruct;	// IMP=0x002000000008efa0
...
- (void)loadPreviousSessionIDs;	// IMP=0x001000000008e449
- (_Bool)previousSessionExists:(id)arg1;	// IMP=0x001000000008e3a7
- (void)storePreviousSessionID:(id)arg1;	// IMP=0x001000000008e1ed
- (struct os_state_data_s *)dumpState;	// IMP=0x001000000008d881
- (void)initializeCaptureBlock;	// IMP=0x001000000008d7e2
- (void)generateStateDump;	// IMP=0x001000000008d7a1
- (void)savePresentedWiFiError;	// IMP=0x001000000008d72d
- (void)savePresentedBluetoothError;	// IMP=0x001000000008d6b9
- (void)loadPresentedWiFiError;	// IMP=0x001000000008d652
- (void)loadPresentedBluetoothError;	// IMP=0x001000000008d5eb
- (_Bool)shouldShowErrorForWiFiEnabled:(_Bool)arg1;	// IMP=0x001000000008d476
- (_Bool)shouldShowErrorForBluetoothEnabled:(_Bool)arg1;	// IMP=0x001000000008d301
- (long long)errorCodeForBluetoothEnabled:(_Bool)arg1 wifiEnabled:(_Bool)arg2 faceIDEnabled:(_Bool)arg3;	// IMP=0x001000000008d2d0
- (id)errorStringForBluetoothEnabled:(_Bool)arg1 wifiEnabled:(_Bool)arg2 faceIDEnabled:(_Bool)arg3;	// IMP=0x001000000008d25d
- (void)handleWiFiPowerChanged:(id)arg1;	// IMP=0x001000000008d15e
- (void)handleBluetoothPowerChanged:(id)arg1;	// IMP=0x001000000008d047
- (id)baseResultsDictionaryForError:(id)arg1;	// IMP=0x001000000008ce04
- (void)createRadarForError:(id)arg1 devices:(id)arg2 rangingResults:(id)arg3;	// IMP=0x001000000008cdfe
- (void)cancelMagnetLinkTimer;	// IMP=0x001000000008cbb0
- (void)btPipeConnectionChanged:(id)arg1;	// IMP=0x001000000008c7f4
- (void)setUpMagnetLinkTimer;	// IMP=0x000000000008c405
- (_Bool)deviceCurrentlyUnlockedByWatch;	// IMP=0x001000000008c395
- (void)releaseLanguageAssertionForAutoRelock;	// IMP=0x001000000008c2f0
- (void)grabLanguageAssertionForAutoRelock;	// IMP=0x001000000008c188
- (void)handleAuthenticationSessionStarted;	// IMP=0x001000000008bfbc
- (void)handlePairedDeviceLockStateChanged;	// IMP=0x001000000008bfb6
- (void)handleBioLockout;	// IMP=0x001000000008bd6a
- (void)beginKeyRegistrationIfNecessary;	// IMP=0x001000000008ba93
- (void)handleDisplayStateChanged:(unsigned long long)arg1;	// IMP=0x001000000008b9d7
- (void)handleNearbyStateChanged;	// IMP=0x001000000008b9c5
- (void)pipeConnectionChanged:(id)arg1;	// IMP=0x001000000008b8fd
- (id)unlockedOnWristDate;	// IMP=0x001000000008b8f5
- (void)wristStateChanged:(id)arg1;	// IMP=0x001000000008b8ef
- (void)handleLockStateChanged;	// IMP=0x001000000008b545
- (void)handleUnexpectedDisablement:(id)arg1;	// IMP=0x001000000008b414
- (_Bool)shouldNotify;	// IMP=0x001000000008b171
- (void)upsellPhoneAutoUnlock;	// IMP=0x001000000008a7ac
- (id)getUpsellNotificationBodyTextForEvent:(id)arg1;	// IMP=0x001000000008a5c5
- (void)upsellBehaviorChangedAfterUpgradeIfNecessary;	// IMP=0x001000000008a276
- (_Bool)behaviorChangedAfterUpgrade;	// IMP=0x001000000008a0e3
- (void)clearPhoneAutoUnlockNotification:(_Bool)arg1;	// IMP=0x0010000000089fec
- (void)screenLockUnlocked:(id)arg1;	// IMP=0x0010000000089fe6
- (void)onqueue_keyBagLockStateChange:(id)arg1;	// IMP=0x0010000000089e5d
- (void)keyBagLockStateChange:(id)arg1;	// IMP=0x0010000000089d88
- (void)handleRelockMessage;	// IMP=0x0010000000089cb9
- (void)handleBLEDataReceivedNotification:(id)arg1;	// IMP=0x00100000000891e8
- (void)removeServiceClientForIdentifier:(id)arg1;	// IMP=0x0010000000089169
- (void)addServiceClientForIdentifier:(id)arg1;	// IMP=0x00100000000890ea
- (long long)idsMacCount;	// IMP=0x001000000008903f
- (_Bool)watchLockedAndOnWrist;	// IMP=0x0010000000089037
- (_Bool)advertisingEnabled;	// IMP=0x001000000008902f
- (void)updateAdvertising;	// IMP=0x0010000000089029
- (_Bool)watchLockedOnWristForPeer:(id)arg1;	// IMP=0x0010000000088ffc
- (_Bool)proxyAdvertisementForPeer:(id)arg1;	// IMP=0x0010000000088fcf
- (_Bool)unlockEnabledForPeer:(id)arg1;	// IMP=0x0010000000088fa2
- (void)handleScanTimerFired;	// IMP=0x001000000008896e
- (void)handleBLEScanTimerFired;	// IMP=0x0010000000088917
- (void)invalidateScanTimer;	// IMP=0x0010000000088841
- (void)restartScanTimer:(unsigned long long)arg1;	// IMP=0x0010000000088608
- (void)handleFoundPeer:(id)arg1;	// IMP=0x00100000000880fc
- (void)invalidateScanner;	// IMP=0x0010000000087f87
- (void)startScannerWithWatchBluetoothIDs:(id)arg1 phoneBluetoothIDs:(id)arg2;	// IMP=0x0010000000087520
- (void)idsController:(id)arg1 didReceiveProtoData:(id)arg2 forType:(unsigned short)arg3 deviceID:(id)arg4;	// IMP=0x0010000000086fdf
- (void)transport:(id)arg1 didReceiveKeyOriginatingRegistrationRequestWithSessionID:(id)arg2 deviceID:(id)arg3 requestData:(id)arg4;	// IMP=0x0010000000086e53
- (void)transport:(id)arg1 didReceiveRegistrationRequestWithSessionID:(id)arg2 deviceID:(id)arg3 requestData:(id)arg4;	// IMP=0x0010000000086cfc
- (void)transport:(id)arg1 didReceivePairingRequestWithSessionID:(id)arg2 deviceID:(id)arg3 requestData:(id)arg4;	// IMP=0x0010000000086bcc
- (void)transportDidChangeNearbyState:(id)arg1;	// IMP=0x0010000000086a7c
- (void)transportDidChangeDevices:(id)arg1;	// IMP=0x001000000008696a
- (void)performRegistrationIfNecessaryForLockSession:(id)arg1 error:(id)arg2;	// IMP=0x0010000000086779
- (_Bool)isDisplayOff;	// IMP=0x001000000008672a
- (void)sessionDidSendInitialData:(id)arg1;	// IMP=0x0010000000086724
- (void)sessionDidReceiveKeyDeviceLocked:(id)arg1;	// IMP=0x001000000008666d
- (void)handleProxyConnectionStartedForSession:(id)arg1;	// IMP=0x001000000008625b
- (void)handleLockConnectionStartedForSession:(id)arg1;	// IMP=0x00100000000858bf
- (void)sessionDidStartConnection:(id)arg1;	// IMP=0x0010000000085847
- (void)handleProxySessionCompleted:(id)arg1 error:(id)arg2;	// IMP=0x00100000000855b4
- (void)handleLockSessionCompleted:(id)arg1 error:(id)arg2;	// IMP=0x00100000000849bf
- (void)session:(id)arg1 didCompleteWithError:(id)arg2;	// IMP=0x00100000000839be
- (void)cancelParallelRegistrationSessionsForDeviceID:(id)arg1 newSessionID:(id)arg2;	// IMP=0x00100000000837be
- (void)registerRemotePeerIfNecessary;	// IMP=0x0010000000083391
- (void)initializeRemotePeer;	// IMP=0x0010000000083184
- (void)armDevicesWaitingForUnlock;	// IMP=0x00100000000830c0
- (void)createRegistrationLockSessionWithDeviceID:(id)arg1 sessionID:(id)arg2 requestData:(id)arg3;	// IMP=0x0010000000082e01
- (void)createRegistrationKeySessionWithIdentifier:(id)arg1 deviceID:(id)arg2 requestData:(id)arg3 locallyGenerated:(_Bool)arg4;	// IMP=0x0010000000082b6e
- (void)invalidateExistingSessionsForBLEDevice:(id)arg1 incomingSessionID:(id)arg2;	// IMP=0x00100000000826f6
- (void)cancelAllLockSessionsForScanTimeout;	// IMP=0x0010000000082564
- (void)clearAllKeysWithTokens;	// IMP=0x00100000000824c7
- (void)cleanUpProxySessions;	// IMP=0x00100000000822c4
- (void)updateStringForProxySession;	// IMP=0x0010000000082044
- (void)createProxySessionWithDeviceID:(id)arg1;	// IMP=0x0010000000081d8a
- (void)createKeySessionWithBLEDevice:(id)arg1 sessionID:(id)arg2 wrapper:(id)arg3 useEncryption:(_Bool)arg4;	// IMP=0x0010000000081977
- (void)createLockSessionWithWatchDevice:(id)arg1;	// IMP=0x0010000000081286
- (void)createPairingKeySessionWithIdentifier:(id)arg1 deviceID:(id)arg2 requestData:(id)arg3;	// IMP=0x001000000008100c
- (void)createPairingLockSessionWithDevice:(id)arg1 passcode:(id)arg2;	// IMP=0x0010000000080bbb
- (void)disableKeyPairingForDeviceID:(id)arg1;	// IMP=0x0010000000080a1c
- (void)handleDisableMessageForLock:(id)arg1 fromDeviceID:(id)arg2;	// IMP=0x0010000000080858
- (void)handleDisableMessageForKey:(id)arg1 fromDeviceID:(id)arg2;	// IMP=0x0010000000080445
- (void)transport:(id)arg1 didReceiveDisableMessage:(id)arg2 fromDeviceID:(id)arg3;	// IMP=0x00100000000801a0
- (void)sendDisableMessageToDeviceID:(id)arg1 pairingID:(id)arg2;	// IMP=0x001000000007ff18
- (_Bool)disablePairingForDeviceID:(id)arg1 pairingID:(id)arg2;	// IMP=0x001000000007fdf0
- (void)authPromptInfoWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x001000000007fd60
- (id)stringForState:(long long)arg1;	// IMP=0x001000000007fd41
- (void)autoUnlockStateWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x001000000007fb86
- (void)requestRelock;	// IMP=0x001000000007fa1b
- (void)generateAppIconImageWithOptions:(unsigned int)arg1;	// IMP=0x001000000007fa15
- (void)decrementAttemptCount;	// IMP=0x001000000007f978
- (void)incrementAttemptCount;	// IMP=0x001000000007f7da
- (void)logUnintentionalAutoUnlockAttempt:(unsigned long long)arg1;	// IMP=0x001000000007f594
- (void)cancelAttemptsForDeviceUnlocked;	// IMP=0x001000000007f3a5
- (void)cancelAutoUnlockWithCancelReason:(long long)arg1 usingTool:(_Bool)arg2;	// IMP=0x001000000007e922
- (void)cancelAutoUnlock;	// IMP=0x001000000007e907
- (void)completeSuccessfulAttempt;	// IMP=0x001000000007e8d4
- (void)invalidateAttempt;	// IMP=0x001000000007e5d5
- (void)donateDeviceUnlockedWithMask:(_Bool)arg1;	// IMP=0x001000000007e517
- (void)completeAutoUnlockWithNotification:(_Bool)arg1;	// IMP=0x001000000007dd7a
- (void)attemptAutoUnlockWithoutNotifyingWatch;	// IMP=0x001000000007dce9
- (void)attemptAutoUnlockForSiri;	// IMP=0x001000000007dc58
- (void)prewarmAutoUnlock;	// IMP=0x001000000007db41
- (void)attemptAutoUnlock;	// IMP=0x001000000007c334
- (void)failedAttemptBeforeStarting:(id)arg1 metricErrorString:(id)arg2;	// IMP=0x001000000007c007
- (void)dropEscrowRecordsIfNecessary;	// IMP=0x001000000007c001
- (void)generateAttemptForType:(long long)arg1;	// IMP=0x001000000007b82d
- (void)attemptAutoUnlockForType:(long long)arg1 externalACMContext:(id)arg2 preventRadarNotification:(_Bool)arg3 bundlePath:(id)arg4 appName:(id)arg5 navBarTitle:(id)arg6 reply:(CDUnknownBlockType)arg7;	// IMP=0x001000000007b586
- (void)attemptAutoUnlockForType:(long long)arg1 preventRadarNotification:(_Bool)arg2;	// IMP=0x001000000007b553
- (void)attemptAutoUnlockForType:(long long)arg1;	// IMP=0x001000000007b53c
- (void)disableAutoUnlockForDevice:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x001000000007b2bb
- (void)disableAutoUnlockForAllWatches;	// IMP=0x001000000007b0e6
- (void)cancelEnablingAutoUnlockForDeviceID:(id)arg1;	// IMP=0x001000000007af1b
- (void)cancelEnablingAutoUnlockForDevice:(id)arg1;	// IMP=0x001000000007ae12
- (void)cancelEnablingAllDevices;	// IMP=0x001000000007abe7
- (void)enableAutoUnlockWithDevice:(id)arg1 passcode:(id)arg2;	// IMP=0x001000000007a851
- (void)eligibleDevicesRequestFromBundleID:(id)arg1 withCompletionHandler:(CDUnknownBlockType)arg2;	// IMP=0x001000000007a35b
- (_Bool)phoneAutoUnlockSupportedByDevice:(id)arg1;	// IMP=0x001000000007a26c
- (void)eligibleDevicesFilterCompatibleDevices:(id)arg1;	// IMP=0x0010000000079fff
- (void)repairCloudPairing;	// IMP=0x0010000000079f23
- (void)notifyObserversOfUnlockFailureWithResults:(id)arg1 error:(id)arg2;	// IMP=0x0010000000079bd2
- (void)notifyObserversOfUnlockCompletionWithDevice:(id)arg1;	// IMP=0x00100000000798fa
- (void)notifyObserverOfAttemptBeganWithDevice:(id)arg1;	// IMP=0x0010000000079641
- (void)notifyObserverOfFailedToEnableDevice:(id)arg1 error:(id)arg2;	// IMP=0x001000000007935e
- (void)notifyObserverOfEnabledDevice:(id)arg1;	// IMP=0x00100000000790a5
- (void)notifyObserverOfKeyDeviceLockWithDevice:(id)arg1;	// IMP=0x0010000000078dec
- (void)unregisterObserver:(id)arg1;	// IMP=0x0010000000078c5f
- (void)registerObserver:(id)arg1;	// IMP=0x0010000000078ad2
- (void)addNotificationsObservers;	// IMP=0x001000000007863f
- (void)initializeAttemptState;	// IMP=0x001000000007823c
- (void)onqueue_start;	// IMP=0x0010000000077d49
- (void)start;	// IMP=0x0010000000077cc2
- (id)initWithTransport:(id)arg1 magnetTransport:(id)arg2 keyManager:(id)arg3;	// IMP=0x001000000007767a
- (id)init;	// IMP=0x00100000000775ca
