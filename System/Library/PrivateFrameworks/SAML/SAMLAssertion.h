...
+ (id)createElement:(id *)arg1;	// IMP=0x006000000000b7c8
- (id)authorizationForResource:(id)arg1;	// IMP=0x000000000000c10f
- (_Bool)isValidForRequestor:(id)arg1;	// IMP=0x000000000000bf69
- (_Bool)meetsConditions:(id *)arg1;	// IMP=0x000000000000bf18
- (_Bool)isValid:(id *)arg1;	// IMP=0x000000000000be04
