...
+ (id)textReplacementCandidateForTextReplacement:(id)arg1;	// IMP=0x00000000004c5f46
- (void).cxx_destruct;	// IMP=0x00000000004c602f
@property(readonly, nonatomic) UITextReplacement *replacement; // @synthesize replacement=_replacement;
- (id)label;	// IMP=0x00000000004c6001
- (id)_initWithTextReplacement:(id)arg1;	// IMP=0x00000000004c5f93
