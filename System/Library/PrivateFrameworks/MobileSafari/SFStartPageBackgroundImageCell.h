...
- (void).cxx_destruct;	// IMP=0x00000000000a7b0b
...
- (void)didSelectClearButton:(id)arg1;	// IMP=0x00000000000a7958
- (void)updateSelectionIndicatorColor;	// IMP=0x00000000000a7885
- (void)setHighlighted:(_Bool)arg1;	// IMP=0x00000000000a7823
- (void)tintColorDidChange;	// IMP=0x00000000000a77e2
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000000a7104
