...
- (void).cxx_destruct;	// IMP=0x000000000000e6ef
...
- (_Bool)_isStereoPeerActive;	// IMP=0x000000000000e422
- (_Bool)_isStereoPeer:(id)arg1;	// IMP=0x000000000000e329
- (_Bool)_isStereoPairMember;	// IMP=0x000000000000e2a9
- (void)_notifyDelegate:(id)arg1;	// IMP=0x000000000000e174
- (void)_withLock:(CDUnknownBlockType)arg1;	// IMP=0x000000000000e136
...
- (id)_messageDecodeCapabilities:(id)arg1;	// IMP=0x000000000000d862
- (id)_messageEncodeCapabilities;	// IMP=0x000000000000d746
- (_Bool)_messageValidateResponse:(id)arg1;	// IMP=0x000000000000d671
- (_Bool)_messageValidateRequest:(id)arg1;	// IMP=0x000000000000d59c
- (id)_messageCreateResponse;	// IMP=0x000000000000d4de
- (id)_messageCreateRequest;	// IMP=0x000000000000d468
- (void)_rapportProcessResponse:(id)arg1 error:(id)arg2;	// IMP=0x000000000000cdc6
- (void)_rapportProcessRequest:(id)arg1 emittingResponse:(CDUnknownBlockType)arg2;	// IMP=0x000000000000cbc9
- (_Bool)_rapportEventShouldUpdateState:(id)arg1;	// IMP=0x000000000000cb11
- (void)_rapportDeregister;	// IMP=0x000000000000cacd
- (void)_rapportRegister;	// IMP=0x000000000000c8c5
- (void)_rapportStop;	// IMP=0x000000000000c831
- (void)_rapportStart;	// IMP=0x000000000000c16b
- (void)_stateQuery;	// IMP=0x000000000000be30
- (void)_stateUpdate;	// IMP=0x000000000000bcd5
- (void)dealloc;	// IMP=0x000000000000bc97
- (id)initWithDelegate:(id)arg1;	// IMP=0x000000000000ba05
