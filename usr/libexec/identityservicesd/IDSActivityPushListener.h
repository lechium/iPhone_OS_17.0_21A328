...
- (void).cxx_destruct;	// IMP=0x002000000012cb5d
@property(nonatomic) _Bool listening; // @synthesize listening=_listening;
- (void)setQueue:(id)arg1;	// IMP=0x001000000012cb3a
- (id)queue;	// IMP=0x001000000012cb30
...
- (void)handler:(id)arg1 didReceiveMessage:(id)arg2 forTopic:(id)arg3 fromID:(id)arg4 messageContext:(id)arg5;	// IMP=0x001000000012c7d2
- (void)_configurePushHandler;	// IMP=0x001000000012c699
- (id)initWithQueue:(id)arg1;	// IMP=0x001000000012c546
