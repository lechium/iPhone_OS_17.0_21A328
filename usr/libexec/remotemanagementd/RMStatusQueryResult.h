...
- (void).cxx_destruct;	// IMP=0x001000000007d0a7
...
- (id)initWithStatusKeyPaths:(id)arg1 statusByKeyPath:(id)arg2 errorByKeyPath:(id)arg3;	// IMP=0x001000000007c3b5
- (id)init;	// IMP=0x001000000007c351
- (id)protocolStatusReportWithFullReport:(_Bool)arg1;	// IMP=0x001000000007d47f
