...
+ (id)sharedManager;	// IMP=0x006000000042401a
...
- (void)registerBlocksForService;	// IMP=0x0000000000424393
- (void)reportSessionMediaDaemonStats:(id)arg1;	// IMP=0x0000000000424069
- (void)dealloc;	// IMP=0x0000000000423faa
- (id)init;	// IMP=0x0000000000423f08
