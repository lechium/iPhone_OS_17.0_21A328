...
- (void).cxx_destruct;	// IMP=0x00000000003fc5d0
- (id)init;	// IMP=0x00000000003fc4d0
- (void)runTestWithContext:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000000003fc310
