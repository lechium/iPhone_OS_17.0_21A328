...
- (void).cxx_destruct;	// IMP=0x00000000000b2c6b
...
- (id)loadPage;	// IMP=0x00000000000b2bca
@property(readonly, nonatomic) _Bool disableReappearPlaceholder;
- (id)createViewControllerForContainer:(id)arg1;	// IMP=0x00000000000b2b3d
@property(readonly, copy) NSString *description;
- (id)initWithJSObject:(id)arg1 context:(id)arg2;	// IMP=0x00000000000b2559
- (id)initWithContext:(id)arg1;	// IMP=0x00000000000b24ee
