...
+ (id)resultFromLegacyDictionary:(id)arg1;	// IMP=0x001000000014417e
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000107ede
- (unsigned long long)hash;	// IMP=0x0000000000107e69
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000107d87
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000107ce4
- (void)copyTo:(id)arg1;	// IMP=0x0000000000107c64
- (void)writeTo:(id)arg1;	// IMP=0x0000000000107bb9
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000107bac
- (id)dictionaryRepresentation;	// IMP=0x00000000001076c0
- (id)description;	// IMP=0x0000000000107611
@property(nonatomic) _Bool hasLoopStart;
@property(nonatomic) _Bool hasLoopPeriod;
@property(nonatomic) _Bool hasLoopFadeLen;
- (id)exportToLegacyDictionary;	// IMP=0x000000000014438b
