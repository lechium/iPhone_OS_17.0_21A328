...
- (void).cxx_destruct;	// IMP=0x00000000002fe7ff
...
- (id)attributeDescriptions;	// IMP=0x00000000002fe2c0
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000002fe0fb
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000002fe0f0
- (unsigned long long)hash;	// IMP=0x00000000002fdee0
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000002fdaba
- (id)xpcWalletKeyWithExpressEnabled:(_Bool)arg1;	// IMP=0x00000000002fd9e6
@property(readonly, copy) NSUUID *uuid;
@property(readonly, copy) NSString *labelColorValue;
@property(readonly, copy) NSString *passColorValue;
- (id)initWithPKPass:(id)arg1;	// IMP=0x00000000002fd516
- (id)initWithTypeIdentifier:(id)arg1 serialNumber:(id)arg2 state:(long long)arg3 walletKeyDescription:(id)arg4 homeName:(id)arg5 color:(long long)arg6 nfcInfo:(id)arg7;	// IMP=0x00000000002fd38c
