...
@class MISSING_TYPE, NSArray, UIDragInteraction, UIDragItem, UITargetedDragPreview;
...
- (MISSING_TYPE *)dragInteraction:willAnimateLiftWithAnimator:session: /* Error: Ran out of types for this method. */;
