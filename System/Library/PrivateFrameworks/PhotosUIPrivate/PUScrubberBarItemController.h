...
- (void).cxx_destruct;	// IMP=0x00000000004f367b
@property(retain, nonatomic) PUBrowsingSession *browsingSession; // @synthesize browsingSession=_browsingSession;
- (void)_updateScrubberBarButtonItemIfNeeded;	// IMP=0x00000000004f3550
- (void)_invalidateScrubberBarButtonItem;	// IMP=0x00000000004f3517
