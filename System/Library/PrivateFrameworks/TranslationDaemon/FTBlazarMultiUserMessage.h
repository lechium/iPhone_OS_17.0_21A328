...
+ (long long)session_message_typeForImmutableObject:(id)arg1;	// IMP=0x001000000007683e
+ (Class)session_message_immutableClassForType:(long long)arg1;	// IMP=0x0010000000076804
- (void).cxx_destruct;	// IMP=0x00000000000775fa
- (id)flatbuffData;	// IMP=0x0000000000077473
- (Offset_86cece31)addObjectToBuffer:(void *)arg1;	// IMP=0x0000000000076b85
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000075608
- (id)initWithFlatbuffData:(id)arg1 root:(const struct BlazarMultiUserMessage *)arg2 verify:(_Bool)arg3;	// IMP=0x0000000000075425
- (id)initWithFlatbuffData:(id)arg1 root:(const struct BlazarMultiUserMessage *)arg2;	// IMP=0x0000000000075410
- (id)initAndVerifyWithFlatbuffData:(id)arg1;	// IMP=0x00000000000753f6
- (id)initWithFlatbuffData:(id)arg1;	// IMP=0x00000000000753df
