...
+ (void)loadEnableMediaAccessories;	// IMP=0x001000000029bcca
- (void).cxx_destruct;	// IMP=0x000000000029bcb7
@property(readonly) HMFSystemPreference *homeKitPreference; // @synthesize homeKitPreference=_homeKitPreference;
- (id)stringValue;	// IMP=0x000000000029bc51
- (id)numberValue;	// IMP=0x000000000029bb29
- (_Bool)boolValue;	// IMP=0x000000000029bae5
...
- (id)initWithKey:(id)arg1 options:(unsigned long long)arg2 defaultValue:(id)arg3;	// IMP=0x000000000029b851
