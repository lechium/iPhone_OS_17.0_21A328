...
- (void).cxx_destruct;	// IMP=0x00000000002cb1bd
...
- (void)photoPickerVariantListControllerDidCancel:(id)arg1;	// IMP=0x00000000002cb0dd
- (void)photoPickerVariantListController:(id)arg1 didSelectProviderItem:(id)arg2;	// IMP=0x00000000002cb020
- (id)posePickerViewController;	// IMP=0x00000000002cae4e
- (id)initWithAnimojiProviderItem:(id)arg1 variantsManager:(id)arg2;	// IMP=0x00000000002cad0c
- (id)initWithAvatarRecord:(id)arg1 variantsManager:(id)arg2;	// IMP=0x00000000002cac88
