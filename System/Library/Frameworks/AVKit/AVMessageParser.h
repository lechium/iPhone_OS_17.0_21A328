...
+ (id)airMessageParser;	// IMP=0x004000000011654d
- (void).cxx_destruct;	// IMP=0x0000000000115083
...
- (id)partsWithData:(id)arg1;	// IMP=0x0000000000114ded
- (id)init;	// IMP=0x0000000000114c2e
- (id)initWithLineSeparator:(id)arg1 headerBodySeparator:(id)arg2 bodyLengthKey:(id)arg3 compressionMethodKey:(id)arg4;	// IMP=0x0000000000114b4d
