...
+ (id)modernTransparentDarkAppearanceController;	// IMP=0x006000000000b255
+ (id)modernTransparentLightAppearanceController;	// IMP=0x006000000000b218
+ (id)modernAppearanceController;	// IMP=0x006000000000b1db
+ (id)gradientAppearanceController;	// IMP=0x006000000000b19e
+ (id)stripedAppearanceController;	// IMP=0x006000000000b161
+ (id)defaultAppearanceController;	// IMP=0x006000000000b14f
+ (id)appearanceControllerForStyle:(long long)arg1;	// IMP=0x006000000000b112
+ (id)globalAppearanceController;	// IMP=0x006000000000b0eb
