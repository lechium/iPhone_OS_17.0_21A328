...
+ (void)setMainWindow:(id)arg1;	// IMP=0x0010000000038994
- (void).cxx_destruct;	// IMP=0x0000000000039b02
...
- (void)willDismissProgressViewController:(id)arg1;	// IMP=0x000000000003994d
- (void)closeProgressDialog;	// IMP=0x0000000000039832
- (void)openProgressDialog;	// IMP=0x0000000000039294
- (void)updateProgress;	// IMP=0x0000000000038f1e
- (void)completeTaskIfNecessary;	// IMP=0x0000000000038d2b
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x0000000000038c9e
- (void)startTask:(CDUnknownBlockType)arg1 completionBlock:(CDUnknownBlockType)arg2;	// IMP=0x00000000000389a8
- (id)initWithWindow:(id)arg1 intervalBeforeOpeningProgressDialog:(double)arg2;	// IMP=0x000000000003890d
- (id)init;	// IMP=0x00000000000388ec
