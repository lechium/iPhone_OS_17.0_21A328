...
+ (id)configuration;	// IMP=0x0020000000040e43
- (void).cxx_destruct;	// IMP=0x00200000000410e2
...
- (_Bool)shouldPerformDatabaseSubscriptionForServiceMode:(_Bool)arg1;	// IMP=0x0010000000040fd3
- (_Bool)shouldArchiveData:(id)arg1;	// IMP=0x0010000000040fcb
