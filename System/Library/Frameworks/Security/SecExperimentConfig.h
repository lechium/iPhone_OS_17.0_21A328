...
- (void).cxx_destruct;	// IMP=0x0000000000016cb2
...
- (_Bool)shouldRunWithSamplingRate:(id)arg1;	// IMP=0x0000000000016aff
- (unsigned int)hostHash;	// IMP=0x0000000000016ad4
- (id)initWithConfiguration:(id)arg1;	// IMP=0x000000000001692c
