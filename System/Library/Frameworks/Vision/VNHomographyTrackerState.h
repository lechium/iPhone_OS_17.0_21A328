...
- (id).cxx_construct;	// IMP=0x0000000000036f8f
- (void).cxx_destruct;	// IMP=0x0000000000036f60
- (void)ICReportFrameAnalysis:(id)arg1 forPresentationTime:(CDStruct_1b6d18a9)arg2 withStats:(id)arg3;	// IMP=0x0000000000036a58
- (_Bool)ICShouldBeCanceled;	// IMP=0x0000000000036a50
- (void)dealloc;	// IMP=0x00000000000369d4
- (id)init;	// IMP=0x0000000000036897
