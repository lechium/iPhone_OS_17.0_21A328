...
- (void).cxx_destruct;	// IMP=0x00000000009db3bd
...
- (id)description;	// IMP=0x00000000009db2e2
- (unsigned long long)hash;	// IMP=0x00000000009db29e
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000009db1c2
- (id)initWithIdentifier:(id)arg1 transports:(unsigned long long)arg2 setupHash:(id)arg3 delegate:(id)arg4;	// IMP=0x00000000009db0d8
- (id)init;	// IMP=0x00000000009db030
