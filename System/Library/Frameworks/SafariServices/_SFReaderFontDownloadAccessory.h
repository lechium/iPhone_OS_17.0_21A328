...
- (void).cxx_destruct;	// IMP=0x00000000000c6778
...
- (id)viewForLastBaselineLayout;	// IMP=0x00000000000c6707
- (void)_tappedDownloadButton:(id)arg1;	// IMP=0x00000000000c66e7
- (id)initWithTappedDownloadBlock:(CDUnknownBlockType)arg1;	// IMP=0x00000000000c6056
