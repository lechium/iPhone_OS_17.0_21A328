...
- (void).cxx_destruct;	// IMP=0x002000000000df13
...
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x001000000000db53
- (void)handleConversionProgress:(id)arg1;	// IMP=0x001000000000da7b
- (void)startProgress;	// IMP=0x001000000000d7d4
- (void)postNotificationForTransferStatus:(long long)arg1 progress:(double)arg2;	// IMP=0x001000000000d594
- (void)airDropClient:(id)arg1 event:(long long)arg2 withResults:(id)arg3;	// IMP=0x001000000000cd8c
- (void)removeClientAlerts;	// IMP=0x001000000000cc57
- (void)dealloc;	// IMP=0x001000000000cbd6
- (void)stop;	// IMP=0x001000000000c9cb
- (void)addClientForNode:(struct __SFNode *)arg1 shouldPublishProgress:(_Bool)arg2;	// IMP=0x001000000000c65b
- (void)serversChanged:(id)arg1;	// IMP=0x001000000000c2e3
- (_Bool)send;	// IMP=0x001000000000c19a
- (void)start;	// IMP=0x001000000000be94
- (void)releaseSandboxExtensions;	// IMP=0x001000000000bd5d
- (void)consumeSandboxExtensions;	// IMP=0x001000000000ba85
- (void)setProperty:(id)arg1 forKey:(id)arg2;	// IMP=0x001000000000ba59
- (id)initWithPerson:(struct __SFNode *)arg1 items:(id)arg2 sandboxExtensions:(id)arg3;	// IMP=0x001000000000b82c
