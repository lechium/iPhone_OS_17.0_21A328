...
@interface period_lstmInput : NSObject
{
...
- (void).cxx_destruct;	// IMP=0x0000000000053d04
...
- (id)featureValueForName:(id)arg1;	// IMP=0x0000000000053b5e
@property(readonly, nonatomic) NSSet *featureNames;
- (id)initWithIn:(id)arg1 lstm_1_h_in:(id)arg2 lstm_1_c_in:(id)arg3;	// IMP=0x0000000000053a86
- (id)initWithIn:(id)arg1;	// IMP=0x0000000000053a6f
