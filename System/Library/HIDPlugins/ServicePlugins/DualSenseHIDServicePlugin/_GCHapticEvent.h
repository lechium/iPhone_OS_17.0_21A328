...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000001a05
...
- (id)description;	// IMP=0x00000000000018c8
- (id)initWithSyntheticCommand:(id)arg1;	// IMP=0x00000000000016da
- (void)evaluateDeviceNoteParams:(id)arg1;	// IMP=0x0000000000001645
- (pair_218a80e9)valueForNoteParam:(unsigned int)arg1 inParameters:(id)arg2;	// IMP=0x000000000000145c
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000001b43
