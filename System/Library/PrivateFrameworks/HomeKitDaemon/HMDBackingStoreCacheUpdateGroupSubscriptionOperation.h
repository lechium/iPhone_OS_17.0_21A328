...
- (void).cxx_destruct;	// IMP=0x0000000000229e87
...
- (id)mainReturningError;	// IMP=0x0000000000229aee
- (id)initWithGroup:(id)arg1 subscription:(id)arg2 resultBlock:(CDUnknownBlockType)arg3;	// IMP=0x0000000000229a38
