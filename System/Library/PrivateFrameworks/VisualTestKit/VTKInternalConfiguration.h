...
+ (id)_comparatorForStrategy:(unsigned long long)arg1 comparisonOptions:(unsigned long long)arg2;	// IMP=0x0010000000003b1d
+ (id)_referenceItemsSourceForType:(unsigned long long)arg1;	// IMP=0x0010000000003a11
- (void).cxx_destruct;	// IMP=0x0000000000004036
...
- (void)addExclusionAreaAt:(struct CGRect)arg1;	// IMP=0x0000000000003f05
- (void)addSquareGuideAt:(struct CGRect)arg1 withColor:(id)arg2;	// IMP=0x0000000000003e77
- (void)addHorozontalGuideAt:(double)arg1 withColor:(id)arg2;	// IMP=0x0000000000003deb
- (void)addVerticalGuideAt:(double)arg1 withColor:(id)arg2;	// IMP=0x0000000000003d62
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000003852
- (id)initWithReferenceItemsSource:(id)arg1 storeManager:(id)arg2 imageComparator:(id)arg3;	// IMP=0x0000000000003760
- (id)init;	// IMP=0x0000000000003747
