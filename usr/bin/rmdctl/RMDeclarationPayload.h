...
+ (id)keyPathsForValuesAffectingManagementSourceIdentifier;	// IMP=0x002000000000ddfb
- (id)reportDetails;	// IMP=0x002000000000ea65
- (void)_validateLoadStateWithErrors:(id)arg1;	// IMP=0x001000000000e915
- (short)_currentLoadState;	// IMP=0x001000000000e7d3
- (void)_validateSetOncePropertiesWithErrors:(id)arg1;	// IMP=0x001000000000e35a
- (void)_validateManagementSourceWithErrors:(id)arg1;	// IMP=0x001000000000e2bd
- (_Bool)validateForUpdate:(id *)arg1;	// IMP=0x001000000000e094
- (_Bool)validateForInsert:(id *)arg1;	// IMP=0x001000000000de6b
