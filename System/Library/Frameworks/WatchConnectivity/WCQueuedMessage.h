...
- (void).cxx_destruct;	// IMP=0x00000000000259ef
...
- (long long)compare:(id)arg1;	// IMP=0x00000000000258f0
- (id)description;	// IMP=0x000000000002580c
- (id)initWithMessage:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000000002573e
