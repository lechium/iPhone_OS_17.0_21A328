...
- (void).cxx_destruct;	// IMP=0x00200000000a7f17
...
- (id)results;	// IMP=0x00100000000a7e89
- (_Bool)isRequestCompleted;	// IMP=0x00100000000a7e6c
- (void)addResult:(id)arg1 isProtectedMessage:(_Bool)arg2;	// IMP=0x00100000000a7d4b
- (void)addResults:(id)arg1 isProtectedMessage:(_Bool)arg2;	// IMP=0x00100000000a7bca
- (void)cancelRequestForMessageIds:(id)arg1;	// IMP=0x00100000000a7a64
- (void)cancelRequestForMessageId:(id)arg1;	// IMP=0x00100000000a79e9
- (_Bool)enqueueMessageId:(id)arg1;	// IMP=0x00100000000a7976
- (_Bool)enqueueMessageIds:(id)arg1;	// IMP=0x00100000000a77f1
- (id)dequeueMessageId;	// IMP=0x00100000000a7792
- (id)dequeueAllMessageIds;	// IMP=0x00100000000a76fa
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000a76ef
- (id)initWithMessageIds:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00100000000a7575
