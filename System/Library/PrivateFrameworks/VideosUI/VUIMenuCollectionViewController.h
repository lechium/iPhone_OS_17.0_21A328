...
- (void).cxx_destruct;	// IMP=0x00000000000bb0c1
...
- (void)_updateNavigationBarPadding;	// IMP=0x00000000000bac4f
- (void)_selectFirstMenuItemIfNecessary;	// IMP=0x00000000000bab24
- (id)_leftBarButton;	// IMP=0x00000000000ba89a
- (id)_backButton;	// IMP=0x00000000000ba5b9
- (_Bool)_menuHasContent;	// IMP=0x00000000000ba56b
- (void)_applySnapshotsToSectionController:(_Bool)arg1;	// IMP=0x00000000000ba2cc
- (id)_createDiffableDataSourceSnapshot;	// IMP=0x00000000000ba151
- (id)_createDiffableDataSource;	// IMP=0x00000000000b9e78
- (void)_setGenreMenuItemsForCategories:(id)arg1;	// IMP=0x00000000000b9e15
- (void)_leftBarButtonSelected:(id)arg1;	// IMP=0x00000000000b9c6e
- (void)_backSelected:(id)arg1;	// IMP=0x00000000000b9c24
- (void)collectionView:(id)arg1 didSelectItemAtIndexPath:(id)arg2;	// IMP=0x00000000000b9bbb
- (_Bool)collectionView:(id)arg1 shouldSelectItemAtIndexPath:(id)arg2;	// IMP=0x00000000000b9aa6
- (struct CGSize)collectionView:(id)arg1 layout:(id)arg2 referenceSizeForHeaderInSection:(long long)arg3;	// IMP=0x00000000000b98df
- (struct UIEdgeInsets)collectionView:(id)arg1 layout:(id)arg2 insetForSectionAtIndex:(long long)arg3;	// IMP=0x00000000000b983a
- (double)collectionView:(id)arg1 layout:(id)arg2 minimumLineSpacingForSectionAtIndex:(long long)arg3;	// IMP=0x00000000000b97ea
- (struct CGSize)collectionView:(id)arg1 layout:(id)arg2 sizeForItemAtIndexPath:(id)arg3;	// IMP=0x00000000000b967c
- (void)viewWillTransitionToSize:(struct CGSize)arg1 withTransitionCoordinator:(id)arg2;	// IMP=0x00000000000b94da
- (void)setTitle:(id)arg1;	// IMP=0x00000000000b944d
- (void)updateWithCategories:(id)arg1;	// IMP=0x00000000000b90c9
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x00000000000b9005
- (void)viewWillLayoutSubviews;	// IMP=0x00000000000b8ef1
- (void)viewDidAppear:(_Bool)arg1;	// IMP=0x00000000000b8e9b
- (void)viewDidLoad;	// IMP=0x00000000000b8e20
- (void)loadView;	// IMP=0x00000000000b8bd7
- (id)initWithCategories:(id)arg1 gridConfiguration:(id)arg2;	// IMP=0x00000000000b8a61
