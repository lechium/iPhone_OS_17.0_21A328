...
- (id).cxx_construct;	// IMP=0x000000000013e86c
- (void).cxx_destruct;	// IMP=0x000000000013e7ee
...
- (void)computeTransform;	// IMP=0x000000000013d6f3
- (void)computeGuides;	// IMP=0x000000000013cc07
- (void)clusterLineSegments;	// IMP=0x000000000013b067
- (void)extractLineSegments;	// IMP=0x000000000013a9d1
- (void)rangeLimitGradientMap;	// IMP=0x000000000013a72c
- (void)thresholdGradientMap;	// IMP=0x000000000013a553
- (void)normalizeGradientMap;	// IMP=0x000000000013a1fc
- (void)createGradientMap;	// IMP=0x0000000000139ec8
- (void)standardizeImage;	// IMP=0x0000000000139c79
- (double)confidence;	// IMP=0x0000000000139bf4
- (_Bool)compute;	// IMP=0x000000000013938a
- (void)dealloc;	// IMP=0x0000000000139349
- (id)initWithContext:(id)arg1 image:(id)arg2 config:(const CDStruct_58ac58eb *)arg3;	// IMP=0x0000000000139196
