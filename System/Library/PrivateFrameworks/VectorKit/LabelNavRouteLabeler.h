...
- (id).cxx_construct;	// IMP=0x0000000000657c3f
- (void).cxx_destruct;	// IMP=0x0000000000657abd
...
- (unsigned char)computeRoutePositionForPOIAtPixel:(const void *)arg1 currentPosition:(unsigned char)arg2 context:(struct NavContext *)arg3;	// IMP=0x00000000006579c1
- (_Bool)_updateActiveRouteRange;	// IMP=0x0000000000656b60
- (_Bool)_findRouteOverlappingJunctionFrom:(long long)arg1 routeJunctions:(void *)arg2 lookBackward:(_Bool)arg3 firstOverlap:(long long *)arg4 secondOverlap:(long long *)arg5;	// IMP=0x00000000006569bf
- (void)_updateCurrentRoadInfo;	// IMP=0x000000000065668f
- (void)_initalizeCurrentRoadInfo;	// IMP=0x0000000000656672
- (void)_dedupOffRouteRoads;	// IMP=0x0000000000655deb
- (void)_updatePreferredLabelPlacements;	// IMP=0x0000000000655acf
- (void)_updateRoadsInGuidance;	// IMP=0x000000000065556d
- (void)_updateRoadStarts;	// IMP=0x00000000006550cb
- (void)_updateUniqueOffRouteRoads;	// IMP=0x0000000000654b41
- (_Bool)_addJunctionsForTile:(const void *)arg1;	// IMP=0x0000000000653ac2
- (void)_addLabelsForJunctions:(id)arg1 withContext:(struct NavContext *)arg2 maxLabelsToAdd:(unsigned long long)arg3 useAllJunctions:(_Bool)arg4 placeShieldsFrontToBack:(_Bool)arg5;	// IMP=0x0000000000652cb2
- (void)_addLabelsAtJunctions:(id)arg1 withContext:(struct NavContext *)arg2 maxLabelsToAdd:(unsigned long long)arg3;	// IMP=0x00000000006526bc
- (void)_addVisibleSigns;	// IMP=0x00000000006525f8
- (void)layoutWithNavContext:(struct NavContext *)arg1 avoidanceRects:(const void *)arg2;	// IMP=0x000000000064fa12
- (unsigned char)orientationForRoadSign:(id)arg1 roadLabel:(id)arg2 navContext:(struct NavContext *)arg3;	// IMP=0x000000000064f898
- (unsigned char)resolveOrientation:(struct NavContext *)arg1 road:(id)arg2 currentOrientation:(unsigned char)arg3;	// IMP=0x000000000064f74c
- (struct RoadSignOrientationResolver)createRoadSignOrientationResolver:(id)arg1 navContext:(struct NavContext *)arg2;	// IMP=0x000000000064f6b4
- (void)_generateCurrentRoadSignWithContext:(struct NavContext *)arg1;	// IMP=0x000000000064ebb4
- (void)styleManagerDidFinishAnimating;	// IMP=0x000000000064eba7
- (void)styleManagerDidStartAnimating;	// IMP=0x000000000064eb98
- (void)styleManagerDidChange:(_Bool)arg1;	// IMP=0x000000000064eb81
- (_Bool)_collideLabel:(id)arg1 activeLabel:(id)arg2 labelsToRemove:(id)arg3;	// IMP=0x000000000064e345
- (void)_tryAddLabel:(id)arg1 navContext:(struct NavContext *)arg2 labelCollisionEnabled:(_Bool)arg3;	// IMP=0x000000000064d071
- (void)_tryAddRoadSignForRoad:(id)arg1 isShield:(_Bool)arg2 navContext:(struct NavContext *)arg3 labelCollisionEnabled:(_Bool)arg4;	// IMP=0x000000000064cbe1
- (void)_createOrUpdateLabelForRoad:(id)arg1 isShield:(_Bool)arg2 navContext:(struct NavContext *)arg3 hopOffsetDistance:(float)arg4;	// IMP=0x000000000064ca6c
- (void)_tryAddRoadSignForJunction:(id)arg1 navContext:(struct NavContext *)arg2 labelCollisionEnabled:(_Bool)arg3;	// IMP=0x000000000064c8f2
- (void)grabTilesFromScene:(const void *)arg1;	// IMP=0x000000000064c5f1
- (void)_refreshGuidanceRoadNames;	// IMP=0x000000000064c366
- (void)_reloadRouteJunctions;	// IMP=0x000000000064c094
- (void)clearSceneIsMemoryWarning:(_Bool)arg1;	// IMP=0x000000000064bf9e
- (_Bool)isNavMode;	// IMP=0x000000000064bf86
- (void)setMaxVisibleRoadsigns:(unsigned int)arg1;	// IMP=0x000000000064be03
- (void)setStyleManager:(shared_ptr_3e3c7f86)arg1;	// IMP=0x000000000064bc37
- (id)init;	// IMP=0x000000000064b6dc
@property(readonly, nonatomic) float currentRoadSignPixelHeight;
@property(readonly, nonatomic) void *currentRoadSign;
- (void)drawNavOverlayDebugView:(void *)arg1 navContext:(struct NavContext *)arg2;	// IMP=0x0000000000522a47
- (void)drawRoadSignOrientationDebugView:(void *)arg1 navContext:(struct NavContext *)arg2;	// IMP=0x0000000000521c2d
- (void)debugDraw:(id)arg1 overlayConsole:(void *)arg2 navContext:(struct NavContext *)arg3;	// IMP=0x0000000000521abd
- (_Bool)needsDebugDraw;	// IMP=0x00000000005219b8
