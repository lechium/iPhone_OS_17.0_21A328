...
- (void).cxx_destruct;	// IMP=0x000000000034fdc1
...
- (void)didSelectItemAtIndex:(unsigned long long)arg1;	// IMP=0x000000000034fc68
- (id)itemForIndex:(unsigned long long)arg1;	// IMP=0x000000000034fc19
- (unsigned long long)numberOfItems;	// IMP=0x000000000034fc03
- (id)sectionFooterLabel;	// IMP=0x000000000034fb72
- (id)sectionHeaderLabel;	// IMP=0x000000000034fb16
- (void)reloadItems;	// IMP=0x000000000034f8a2
- (unsigned long long)sharingAudienceForIndex:(unsigned long long)arg1;	// IMP=0x000000000034f85a
- (unsigned long long)indexForSharingAudience:(unsigned long long)arg1;	// IMP=0x000000000034f7ff
@property(readonly, nonatomic) unsigned long long selectedIndex;
- (_Bool)supportsSelection;	// IMP=0x000000000034f7e1
- (id)initWithSelectedSharingAudience:(unsigned long long)arg1;	// IMP=0x000000000034f738
