...
- (void).cxx_destruct;	// IMP=0x002000000001b46c
...
- (void)assetDownloadSession:(id)arg1 willDownloadVariants:(id)arg2;	// IMP=0x001000000001b2fc
- (void)assetDownloadSession:(id)arg1 didUpdateProgressWithExpectedBytes:(unsigned long long)arg2 bytesDownloaded:(unsigned long long)arg3;	// IMP=0x001000000001b2a9
- (void)assetDownloadSession:(id)arg1 didResolveMediaSelection:(id)arg2;	// IMP=0x001000000001b21c
- (void)assetDownloadSession:(id)arg1 didFinishDownloadForMediaSelection:(id)arg2;	// IMP=0x001000000001b149
- (void)assetDownloadSession:(id)arg1 didLoadTimeRange:(CDStruct_3c1748cc)arg2 totalTimeRangesLoaded:(id)arg3 timeRangeExpectedToLoad:(CDStruct_3c1748cc)arg4 forMediaSelection:(id)arg5;	// IMP=0x001000000001b055
- (void)assetDownloadSession:(id)arg1 didFailWithError:(id)arg2;	// IMP=0x001000000001af82
- (void)assetDownloadSessionDidFinishDownload:(id)arg1;	// IMP=0x001000000001aef4
- (void)startLoadingMetadata;	// IMP=0x001000000001aea3
- (void)cancelAndDeliverError:(id)arg1;	// IMP=0x001000000001ae17
- (void)cancel;	// IMP=0x001000000001adaa
- (void)suspend;	// IMP=0x001000000001ad3d
- (void)resume;	// IMP=0x001000000001ac93
- (void)releasePowerAssertion;	// IMP=0x001000000001aba9
- (void)takePowerAssertion;	// IMP=0x001000000001a90f
- (void)disavowSession;	// IMP=0x001000000001a862
- (id)initWithURLAsset:(id)arg1 destinationURL:(id)arg2 options:(id)arg3 delegate:(id)arg4 queue:(id)arg5;	// IMP=0x0010000000019e26
- (id)initWithURL:(id)arg1 destinationURL:(id)arg2 options:(id)arg3 delegate:(id)arg4 queue:(id)arg5;	// IMP=0x0010000000019c1e
- (_Bool)doesAVAssetDownloadSessionSupportMultipleDownloads;	// IMP=0x0010000000019c03
