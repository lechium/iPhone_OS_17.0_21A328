...
+ (id)logCategory;	// IMP=0x0010000000088d70
- (void).cxx_destruct;	// IMP=0x0000000000088cfb
...
- (id)logIdentifier;	// IMP=0x0000000000088c05
- (_Bool)canStartWithError:(id *)arg1;	// IMP=0x0000000000088a36
- (id)initWithSessionID:(id)arg1 destinationID:(id)arg2 streamClientConnection:(id)arg3 streamControlManager:(id)arg4 streamSetupTimer:(id)arg5;	// IMP=0x00000000000888b3
- (id)initWithSessionID:(id)arg1 destinationID:(id)arg2 streamClientConnection:(id)arg3 streamControlManager:(id)arg4 setupWaitPeriod:(double)arg5;	// IMP=0x0000000000088780
