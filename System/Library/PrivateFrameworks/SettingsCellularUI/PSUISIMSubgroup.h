...
- (void).cxx_destruct;	// IMP=0x0000000000021de9
...
- (id)specifiers;	// IMP=0x00000000000219ca
- (id)initWithListController:(id)arg1 groupSpecifier:(id)arg2;	// IMP=0x0000000000021974
- (id)initWithListController:(id)arg1 groupSpecifier:(id)arg2 parentSpecifier:(id)arg3;	// IMP=0x00000000000218e2
