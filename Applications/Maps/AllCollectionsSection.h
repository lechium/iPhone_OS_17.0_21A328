...
- (void).cxx_destruct;	// IMP=0x00200000007cb53b
...
- (id)layoutSectionForLoadingUsingTraitEnvironment:(id)arg1;	// IMP=0x00100000007cb2bc
- (id)layoutSectionForCollectionsUsingTraitsEnvironment:(id)arg1 usingWidth:(double)arg2;	// IMP=0x00100000007cacfb
- (id)layoutForSectionUsingTraitsEnvironment:(id)arg1 usingWidth:(double)arg2;	// IMP=0x00100000007cac67
- (void)setupConfiguration;	// IMP=0x00100000007cabfd
- (id)initWithSectionIndex:(long long)arg1 usingMaxWidth:(double)arg2 usingTraitEnvironment:(id)arg3;	// IMP=0x00100000007caafe
