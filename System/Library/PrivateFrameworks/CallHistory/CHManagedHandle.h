...
+ (id)managedHandlesForHandles:(id)arg1 inManagedObjectContext:(id)arg2;	// IMP=0x008000000000ce97
+ (id)managedHandleForHandle:(id)arg1 inManagedObjectContext:(id)arg2;	// IMP=0x008000000000cc2d
+ (id)fetchRequest;	// IMP=0x008000000000e5c9
- (id)copyWithContext:(id)arg1;	// IMP=0x000000000000d166
