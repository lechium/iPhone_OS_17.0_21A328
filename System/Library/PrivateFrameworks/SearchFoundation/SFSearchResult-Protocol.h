...
@class NSArray, NSData, NSDictionary, NSNumber, NSString, NSURL, SFActionItem, SFCard, SFCoreSpotlightRankingSignals, SFCustom, SFImage, SFMailRankingSignals, SFMailResultDetails, SFMoreResults, SFPunchout, SFResultEntity, SFText, SFTopic;
