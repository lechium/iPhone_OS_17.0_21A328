...
- (void).cxx_destruct;	// IMP=0x0000000000a1ed23
...
- (void)setConfigVersion:(id)arg1 forHome:(id)arg2;	// IMP=0x0000000000a1ebc7
- (void)setHomeConfiguration:(id)arg1;	// IMP=0x0000000000a1e938
- (id)description;	// IMP=0x0000000000a1e878
- (id)initWithUniqueID:(id)arg1;	// IMP=0x0000000000a1e7c3
