...
- (id)reportDetails;	// IMP=0x001000000000ae74
@property(retain, nonatomic) RMPredicateDescription *predicateDescription;
- (void)failedLoadingWithError:(id)arg1;	// IMP=0x001000000000be51
- (_Bool)_updatePropertiesForActivation:(id)arg1 error:(id *)arg2;	// IMP=0x001000000000b7b6
- (_Bool)_loadAnyDeclaration:(id)arg1 error:(id *)arg2;	// IMP=0x001000000000b618
- (_Bool)reloadReturningError:(id *)arg1;	// IMP=0x001000000000b448
- (_Bool)loadPayload:(id)arg1 error:(id *)arg2;	// IMP=0x001000000000b149
