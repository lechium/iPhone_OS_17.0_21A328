...
- (void).cxx_destruct;	// IMP=0x0020000000c81e1f
...
- (void)scrollViewDidScroll:(id)arg1;	// IMP=0x0010000000c81cb7
- (void)scrollViewWillEndDragging:(id)arg1 withVelocity:(struct CGPoint)arg2 targetContentOffset:(inout struct CGPoint *)arg3;	// IMP=0x0010000000c81c29
- (void)scrollViewWillBeginDragging:(id)arg1;	// IMP=0x0010000000c81bc0
- (double)getMaxWidth;	// IMP=0x0010000000c81993
- (id)layoutSectionForSectionIndex:(long long)arg1 layoutEnvironment:(id)arg2;	// IMP=0x0010000000c80b97
- (void)displayRefinements;	// IMP=0x0010000000c80830
- (void)setupDataSource;	// IMP=0x0010000000c7fa2e
- (id)initWithCollectionView:(id)arg1 viewModel:(id)arg2 scrollViewDelegate:(id)arg3 selectionSequenceNumber:(id)arg4 analyticsDelegate:(id)arg5;	// IMP=0x0010000000c7f8b3
