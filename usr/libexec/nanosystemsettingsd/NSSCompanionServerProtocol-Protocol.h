...
- (void)getFullProfileInfoWithIdentifier:(NSString *)arg1 includeManagedPayloads:(_Bool)arg2 completionHandler:(void (^)(NSDictionary *, NSError *))arg3;
...
- (void)getDiagnosticLogsInfo:(void (^)(NSArray *, NSDictionary *, NSError *))arg1;
