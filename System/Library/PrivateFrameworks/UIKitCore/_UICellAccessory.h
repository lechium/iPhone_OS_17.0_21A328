...
+ (id)accessoryWithIdentifier:(id)arg1;	// IMP=0x0060000001246fce
- (void).cxx_destruct;	// IMP=0x000000000124720c
...
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000012471b4
- (id)description;	// IMP=0x00000000012470e9
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000001247017
- (id)init;	// IMP=0x0000000001246f92
