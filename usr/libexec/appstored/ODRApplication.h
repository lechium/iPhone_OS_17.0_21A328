...
- (void).cxx_destruct;	// IMP=0x002000000021c00c
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000021b8c3
- (unsigned long long)hash;	// IMP=0x001000000021b7a3
- (id)description;	// IMP=0x001000000021b63d
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000021b55b
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000021b349
