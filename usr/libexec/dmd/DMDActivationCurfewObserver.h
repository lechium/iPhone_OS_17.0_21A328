...
- (void).cxx_destruct;	// IMP=0x002000000000d553
...
- (id)_nextDateAfter:(id)arg1 matchingWeekday:(long long)arg2 hour:(long long)arg3 minute:(long long)arg4 second:(long long)arg5 inCalendar:(id)arg6;	// IMP=0x001000000000d2c2
- (id)_datesForNextCurfewBoundary;	// IMP=0x001000000000cdcf
- (void)_registerPredicateObserver;	// IMP=0x001000000000c906
- (_Bool)_extractComponentsFromPredicate:(id)arg1;	// IMP=0x001000000000bfba
- (id)metadata;	// IMP=0x001000000000be89
- (void)updateObserverRegistration;	// IMP=0x001000000000be77
- (void)invalidate;	// IMP=0x001000000000bcba
- (id)evaluatePredicateWithError:(id *)arg1;	// IMP=0x001000000000b726
- (id)initWithDelegate:(id)arg1 uniqueIdentifier:(id)arg2 curfewPredicate:(id)arg3;	// IMP=0x001000000000b635
