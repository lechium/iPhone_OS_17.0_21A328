...
+ (_Bool)shouldAdjustTimeoutIntervalForBeginDate;	// IMP=0x006000000006cbd1
- (void).cxx_destruct;	// IMP=0x000000000006cfdc
...
- (void)invalidate;	// IMP=0x000000000006cedd
- (void)triggerTimeout;	// IMP=0x000000000006ce40
- (void)timerCallback;	// IMP=0x000000000006cdab
- (id)initWithHandle:(id)arg1 beginDate:(id)arg2 timeoutInterval:(double)arg3 delegate:(id)arg4;	// IMP=0x000000000006cbd9
