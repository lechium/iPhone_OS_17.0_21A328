...
- (void).cxx_destruct;	// IMP=0x0020000000c9e16b
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000c9e030
- (id)debugDictionary;	// IMP=0x0010000000c9deb2
...
- (id)feature;	// IMP=0x0010000000c9dd80
- (id)initWithItem:(id)arg1 defaultLocale:(id)arg2;	// IMP=0x0010000000c9c987
