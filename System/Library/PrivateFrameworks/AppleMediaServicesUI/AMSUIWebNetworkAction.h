...
- (void).cxx_destruct;	// IMP=0x00000000000b9e9f
...
- (id)_createSession;	// IMP=0x00000000000b9bb5
- (id)runAction;	// IMP=0x00000000000b880a
- (id)initWithJSObject:(id)arg1 context:(id)arg2;	// IMP=0x00000000000b81b0
