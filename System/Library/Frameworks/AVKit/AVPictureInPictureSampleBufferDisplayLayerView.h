...
- (void).cxx_destruct;	// IMP=0x000000000012780d
...
- (id)_makePictureInPicturePlatformAdapterContentPlaceholderLayer;	// IMP=0x00000000001274bf
- (void)_updateGeometry;	// IMP=0x0000000000127161
- (void)layoutSubviews;	// IMP=0x0000000000127120
- (void)_updateSourceLayerHost;	// IMP=0x000000000012633d
- (void)dealloc;	// IMP=0x00000000001262d2
- (id)initWithSourceLayer:(id)arg1 playerController:(id)arg2;	// IMP=0x0000000000126219
