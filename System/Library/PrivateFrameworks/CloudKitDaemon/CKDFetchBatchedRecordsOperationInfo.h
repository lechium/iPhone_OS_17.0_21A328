...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000002aa1f6
- (void).cxx_destruct;	// IMP=0x00000000002aa6ec
...
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000002aa35a
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000002aa1fe
