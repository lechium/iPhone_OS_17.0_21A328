...
+ (id)_actionForKey:(id)arg1 eventDict:(id)arg2 appContext:(id)arg3;	// IMP=0x006000000031c5b0
+ (id)_documentDataSourceWithDict:(id)arg1;	// IMP=0x006000000031c597
+ (id)attachPrefetchedDict:(id)arg1 eventDict:(id)arg2;	// IMP=0x006000000031c49e
+ (id)eventDataSourceWithEventDict:(id)arg1 appContext:(id)arg2;	// IMP=0x006000000031c1f2
+ (id)selectEventDataSourceWithLibraryMediaEntity:(id)arg1;	// IMP=0x006000000031c7c7
- (void).cxx_destruct;	// IMP=0x000000000031c6fd
...
- (id)_initWithLibraryMediaEntity:(id)arg1;	// IMP=0x000000000031c75c
