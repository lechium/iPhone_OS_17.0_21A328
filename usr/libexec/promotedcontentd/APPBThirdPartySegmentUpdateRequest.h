...
+ (Class)segmentIdentifiersType;	// IMP=0x00200000000a34ff
+ (id)options;	// IMP=0x00100000000a3220
- (void).cxx_destruct;	// IMP=0x00200000000a4a28
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000000a46d3
- (unsigned long long)hash;	// IMP=0x00100000000a4594
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000a4382
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000a408a
- (MISSING_TYPE *)copyTo: /* Error: Ran out of types for this method. */;	// IMP=0x00100000000a3ecb
- (void)writeTo:(id)arg1;	// IMP=0x00100000000a3c89
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000000a3c7c
- (id)dictionaryRepresentation;	// IMP=0x00100000000a3632
- (id)description;	// IMP=0x00100000000a3583
...
- (id)segmentIdentifiersAtIndex:(unsigned long long)arg1;	// IMP=0x00100000000a34e2
- (unsigned long long)segmentIdentifiersCount;	// IMP=0x00100000000a34c5
- (void)addSegmentIdentifiers:(id)arg1;	// IMP=0x00100000000a345b
- (void)clearSegmentIdentifiers;	// IMP=0x00100000000a343e
@property(nonatomic) _Bool hasResetSegmentMembership;
- (int)StringAsRunState:(id)arg1;	// IMP=0x00100000000a335c
- (id)runStateAsString:(int)arg1;	// IMP=0x00100000000a3313
