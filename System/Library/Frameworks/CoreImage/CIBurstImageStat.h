...
- (float *)colorHistogram;	// IMP=0x000000000003a77e
- (long long)compareImageOrder:(id)arg1;	// IMP=0x000000000003a71d
- (long long)compareImageStats:(id)arg1;	// IMP=0x000000000003a715
- (float)computeScore:(float)arg1;	// IMP=0x000000000003a5e1
- (unsigned short *)aeMatrix;	// IMP=0x000000000003a5d4
- (void)computeAEMatrix:(id)arg1;	// IMP=0x000000000003a3f8
- (int)setAEMatrix:(id)arg1;	// IMP=0x000000000003a386
- (float)computeAEMatrixDifference:(id)arg1;	// IMP=0x000000000003a34c
- (float)computeImageDistance:(id)arg1;	// IMP=0x000000000003a2fd
- (float)computeSmilePercentage;	// IMP=0x000000000003a1f1
- (float)computeRuleOfThreeDistance;	// IMP=0x0000000000039f5b
- (float)computeFacialFocusScoreSum;	// IMP=0x00000000000399ed
- (void)collapseSharpnessGrid;	// IMP=0x000000000003970c
- (void)computeImageData:(id)arg1 faceIDCounts:(id)arg2;	// IMP=0x00000000000394be
- (void)writeGridROI:(id)arg1;	// IMP=0x00000000000393e9
- (int)canRegister;	// IMP=0x00000000000393c8
- (void)computeImageProjections:(id)arg1;	// IMP=0x000000000003931f
- (void)performRegistration:(id)arg1 deltaCol:(float *)arg2 deltaRow:(float *)arg3;	// IMP=0x0000000000038615
- (void)flagAsGarbage;	// IMP=0x00000000000385f4
- (void)updateROI:(struct GridROI_t)arg1;	// IMP=0x00000000000384e7
- (float)computeSmoothedGridROI:(id)arg1 nextStat:(id)arg2;	// IMP=0x0000000000038243
- (void)computeBlurStatsOnGrid:(id)arg1;	// IMP=0x0000000000037f4f
- (void)computeImageSharpnessOnGrid:(id)arg1;	// IMP=0x0000000000037dd2
- (struct GridROI_t)getSharpnessAndBlurLimits;	// IMP=0x0000000000037dc3
- (void)computeImageColorHistogram:(id)arg1;	// IMP=0x0000000000037c3c
- (void)dealloc;	// IMP=0x0000000000037baf
- (id)initWithIdentifier:(id)arg1;	// IMP=0x0000000000037ae9
- (void)assignMeanStdBuffers:(float *)arg1;	// IMP=0x0000000000037a3e
- (void)allocateMeanStdPingPongBuffers:(float **)arg1:(float **)arg2:(float **)arg3:(float **)arg4;	// IMP=0x0000000000037989
