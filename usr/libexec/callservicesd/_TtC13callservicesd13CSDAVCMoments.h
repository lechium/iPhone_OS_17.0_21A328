...
- (void).cxx_destruct;	// IMP=0x00400000003176c3
- (id)init;	// IMP=0x001000000031768d
- (id)newRequestWithMediaType:(unsigned char)arg1 mode:(unsigned char)arg2 requesteeID:(id)arg3;	// IMP=0x00100000003175f4
...
- (id)initWithStreamToken:(long long)arg1 requesterID:(id)arg2 delegate:(id)arg3 dispatchQueue:(id)arg4;	// IMP=0x00100000003173b7
