...
+ (_Bool)validateRequest:(id)arg1 error:(id *)arg2;	// IMP=0x0060000000006baf
- (void).cxx_destruct;	// IMP=0x0000000000006e6d
...
- (void)runWithRequest:(id)arg1;	// IMP=0x0000000000006c57
- (id)initWithRequest:(id)arg1 deviceInformationPrimitives:(id)arg2;	// IMP=0x0000000000006b37
