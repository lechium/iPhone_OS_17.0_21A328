...
+ (_Bool)shouldEnableOnAsset:(id)arg1 inAssetCollection:(id)arg2;	// IMP=0x006000000016fc10
+ (_Bool)canPerformOnAsset:(id)arg1 inAssetCollection:(id)arg2;	// IMP=0x006000000016fba2
- (void).cxx_destruct;	// IMP=0x000000000017007b
...
- (void)_presentEditViewControllerForReviewAsset:(id)arg1;	// IMP=0x000000000016fdb7
- (void)performUserInteractionTask;	// IMP=0x000000000016fc6d
