...
@class CSDConversationParticipant, NSData, NSError, NSNumber, NSString;
...
- (CSDConversationParticipant *)pendingRemovedRemoteParticipantByIdentififer:(unsigned long long)arg1;
- (void)setIsTUActivityActive:(_Bool)arg1;
