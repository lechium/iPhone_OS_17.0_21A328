...
- (void).cxx_destruct;	// IMP=0x000000000018389a
...
- (void)verifyFutureProgressIsNotFinished;	// IMP=0x0000000000183782
- (void)copyProgressInfoToProgress:(id)arg1 options:(BOOL)arg2;	// IMP=0x00000000001836a2
- (void)updateLocalizedDescriptionWithOptions:(BOOL)arg1;	// IMP=0x0000000000397a4b
- (void)updateUnitCount;	// IMP=0x00000000001830ae
- (id)description;	// IMP=0x0000000000182d57
- (id)init;	// IMP=0x0000000000182c3c
