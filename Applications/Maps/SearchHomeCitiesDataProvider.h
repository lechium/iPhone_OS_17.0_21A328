...
- (void).cxx_destruct;	// IMP=0x0020000000638e14
...
- (id)headerAccessibilityIdentifier;	// IMP=0x0010000000638db3
- (id)initWithObjects:(id)arg1 type:(long long)arg2 identifier:(id)arg3 title:(id)arg4;	// IMP=0x0010000000638c5e
