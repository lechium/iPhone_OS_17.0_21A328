...
- (void).cxx_destruct;	// IMP=0x00000000008384a2
...
- (void)_rotateToHeadingAnimated:(_Bool)arg1 duration:(double)arg2;	// IMP=0x0000000000837c60
- (void)_goToAnnotationAnimated:(_Bool)arg1 duration:(double)arg2 timingFunction:(CDUnknownBlockType)arg3 isInitial:(_Bool)arg4;	// IMP=0x00000000008365cc
- (Matrix_443f5d51)_centerCursor;	// IMP=0x0000000000836417
- (void)setEdgeInsets:(struct VKEdgeInsets)arg1;	// IMP=0x00000000008363cc
- (struct VKEdgeInsets)_effectiveEdgeInsets;	// IMP=0x00000000008362e7
- (Matrix_443f5d51)_nonOffsetCenterCursor;	// IMP=0x0000000000836191
- (void)dealloc;	// IMP=0x0000000000836125
- (id)init;	// IMP=0x00000000008360de
