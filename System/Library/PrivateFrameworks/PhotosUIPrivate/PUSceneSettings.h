...
+ (id)settingsControllerModule;	// IMP=0x00600000004f284c
+ (id)sharedInstance;	// IMP=0x00600000004f281c
...
- (void)setDefaultValues;	// IMP=0x00000000004f277d
- (id)parentSettings;	// IMP=0x00000000004f2764
