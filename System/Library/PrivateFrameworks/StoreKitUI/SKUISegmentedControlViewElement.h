...
- (void).cxx_destruct;	// IMP=0x0000000000182b4e
...
- (void)_enumerateItemElementsUsingBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000000182993
- (long long)pageComponentType;	// IMP=0x0000000000182988
- (id)applyUpdatesWithElement:(id)arg1;	// IMP=0x00000000001828be
@property(readonly, nonatomic) NSArray *segmentItemTitles;
@property(readonly, nonatomic) long long initialSelectedItemIndex;
- (void)dispatchEventOfType:(unsigned long long)arg1 forItemAtIndex:(long long)arg2;	// IMP=0x0000000000182620
@property(readonly, nonatomic) SKUIDividerViewElement *bottomDivider;
- (id)initWithDOMElement:(id)arg1 parent:(id)arg2 elementFactory:(id)arg3;	// IMP=0x0000000000182474
