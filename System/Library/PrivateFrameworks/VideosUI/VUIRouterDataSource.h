...
- (void).cxx_destruct;	// IMP=0x000000000009a064
...
- (id)initWithRouterData:(id)arg1 prefetchedData:(id)arg2;	// IMP=0x0000000000099ef1
- (id)initWithRouterData:(id)arg1 appContext:(id)arg2;	// IMP=0x0000000000099d2c
- (id)initWithLibraryMediaEntity:(id)arg1;	// IMP=0x000000000009a097
