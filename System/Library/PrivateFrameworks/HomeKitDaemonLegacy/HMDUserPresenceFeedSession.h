...
+ (id)logCategory;	// IMP=0x00100000003b5001
- (void).cxx_destruct;	// IMP=0x00000000003b4bba
...
- (void)timerDidFire:(id)arg1;	// IMP=0x00000000003b4930
- (id)logIdentifier;	// IMP=0x00000000003b491e
- (void)_callDelegate;	// IMP=0x00000000003b485d
- (void)_handleStatusUpdateMessageError:(id)arg1 responseTime:(double)arg2;	// IMP=0x00000000003b4745
- (void)_send;	// IMP=0x00000000003b39a5
- (void)send;	// IMP=0x00000000003b3934
- (id)attributeDescriptions;	// IMP=0x00000000003b3704
- (void)dealloc;	// IMP=0x00000000003b35bc
- (id)initWithDelegate:(id)arg1 workQueue:(id)arg2 targetUUID:(id)arg3 messageDispatcher:(id)arg4 user:(id)arg5 presenceAuthStatus:(id)arg6 presenceComputeStatus:(id)arg7 presenceRegionStatus:(id)arg8 reason:(id)arg9;	// IMP=0x00000000003b328e
