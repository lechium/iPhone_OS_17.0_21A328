...
- (void).cxx_destruct;	// IMP=0x0020000000015028
...
- (void)acknowledgeiCloudIdentity;	// IMP=0x0010000000014bfc
- (_Bool)didUnacknowledgediCloudLogoutOccur;	// IMP=0x00100000000148ab
- (void)forceUpdateTokenWithString:(id)arg1;	// IMP=0x0010000000014828
- (void)fetchCurrentToken;	// IMP=0x00100000000147b7
- (id)initWithContainerURL:(id)arg1 trackingLiverpool:(_Bool)arg2;	// IMP=0x0010000000014656
