...
- (id)_accessibilityAXAttributedName;	// IMP=0x003000000000b8a6
- (_Bool)_accessibilityMatchesCustomActionIdentifier:(id)arg1;	// IMP=0x003000000000b838
- (id)_accessibilityCustomActionIdentifier;	// IMP=0x003000000000b726
