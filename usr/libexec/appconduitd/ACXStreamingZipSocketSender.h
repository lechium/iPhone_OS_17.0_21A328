...
+ (id)senderForURL:(id)arg1 queue:(id)arg2 writingUsingBlock:(CDUnknownBlockType)arg3;	// IMP=0x0040000000067015
- (void).cxx_destruct;	// IMP=0x0020000000067967
...
- (void)cancelSending;	// IMP=0x00100000000678ae
- (void)beginSendingWithCompletionBlock:(CDUnknownBlockType)arg1;	// IMP=0x00100000000670a9
- (id)initWithURL:(id)arg1 queue:(id)arg2 writerBlock:(CDUnknownBlockType)arg3;	// IMP=0x0010000000066f53
