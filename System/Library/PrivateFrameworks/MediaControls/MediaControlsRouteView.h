...
- (void).cxx_destruct;	// IMP=0x00000000000b68a0
...
- (void)_contentSizeCategoryDidChange;	// IMP=0x00000000000b66f2
- (void)_updateLabelVisualStyling;	// IMP=0x00000000000b65d0
- (void)providedStylesDidChangeForProvider:(id)arg1;	// IMP=0x00000000000b65be
- (void)showMessage:(id)arg1;	// IMP=0x00000000000b640b
- (void)setGlyphState:(id)arg1;	// IMP=0x00000000000b632f
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000000b6193
- (void)layoutSubviews;	// IMP=0x00000000000b5b54
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000000b58cf
