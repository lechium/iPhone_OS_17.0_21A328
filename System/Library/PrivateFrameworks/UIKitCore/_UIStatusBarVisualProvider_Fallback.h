...
+ (_Bool)requiresIterativeOverflowLayout;	// IMP=0x001000000115d67a
+ (_Bool)scalesWithScreenNativeScale;	// IMP=0x001000000115d672
+ (struct CGSize)intrinsicContentSizeForOrientation:(long long)arg1;	// IMP=0x001000000115d65c
- (void).cxx_destruct;	// IMP=0x000000000115dddc
...
- (id)styleAttributesForStyle:(long long)arg1;	// IMP=0x000000000115dcb9
- (id)orderedDisplayItemPlacementsInRegionWithIdentifier:(id)arg1;	// IMP=0x000000000115db97
- (id)setupInContainerView:(id)arg1;	// IMP=0x000000000115d68a
