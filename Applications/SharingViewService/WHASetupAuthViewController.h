...
- (void).cxx_destruct;	// IMP=0x00200000001be8e1
- (void)showWithFlags:(unsigned int)arg1 throttleSeconds:(int)arg2;	// IMP=0x00100000001be701
- (void)_handlePINEntered:(id)arg1;	// IMP=0x00100000001be5b3
- (void)_handleKeyboardWillShow:(id)arg1;	// IMP=0x00100000001be22d
- (void)handleDismissButton:(id)arg1;	// IMP=0x00100000001be17e
- (void)viewDidDisappear:(_Bool)arg1;	// IMP=0x00100000001be0ad
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x00100000001bddcc
