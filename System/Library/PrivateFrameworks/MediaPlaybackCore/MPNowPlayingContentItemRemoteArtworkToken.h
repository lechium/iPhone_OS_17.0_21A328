...
- (void).cxx_destruct;	// IMP=0x00000000001ad63a
...
- (id)stringRepresentation;	// IMP=0x00000000001ad5d4
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001ad521
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001ad465
- (id)initWithIdentifier:(id)arg1 artworkProperties:(id)arg2 artworkIdentifier:(id)arg3;	// IMP=0x00000000001ad379
