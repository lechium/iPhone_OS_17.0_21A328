...
- (void).cxx_destruct;	// IMP=0x0020000000042146
...
- (void)addDeletedRecordID:(id)arg1;	// IMP=0x00100000000420c5
- (void)addRecord:(id)arg1;	// IMP=0x0010000000041f30
...
- (id)init;	// IMP=0x0010000000041b31
