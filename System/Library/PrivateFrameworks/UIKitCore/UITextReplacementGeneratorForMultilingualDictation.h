...
- (void).cxx_destruct;	// IMP=0x00000000013c7f99
...
- (id)replacements;	// IMP=0x00000000013c7cb0
- (id)initWithMultilingualAlternatives:(id)arg1 stringToReplace:(id)arg2 replacementRange:(id)arg3;	// IMP=0x00000000013c7bed
