...
+ (id)csvHeader;	// IMP=0x00600000002661a1
...
- (id)csvString;	// IMP=0x00000000002661ae
- (void)report;	// IMP=0x0000000000265f06
- (void)run;	// IMP=0x0000000000265aa8
- (void)dealloc;	// IMP=0x0000000000265a5e
- (id)initWithName:(id)arg1 selector:(SEL)arg2 target:(id)arg3 goalTime:(double)arg4;	// IMP=0x00000000002659a9
