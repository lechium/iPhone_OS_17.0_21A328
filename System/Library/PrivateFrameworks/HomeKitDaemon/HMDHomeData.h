...
+ (void)configureKeyedArchiverClassMappings;	// IMP=0x00100000005694e7
- (void).cxx_destruct;	// IMP=0x00000000005693c8
...
- (id)homeWithUUID:(id)arg1;	// IMP=0x0000000000568f2a
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000568ed6
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000568ecb
