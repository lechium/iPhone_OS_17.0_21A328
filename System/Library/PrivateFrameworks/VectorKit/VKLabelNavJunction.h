...
- (id).cxx_construct;	// IMP=0x0000000000762b6c
- (void).cxx_destruct;	// IMP=0x0000000000762b12
...
- (void)createLabelWithNavContext:(struct NavContext *)arg1 isDrivingSideRight:(_Bool)arg2 artworkCache:(void *)arg3;	// IMP=0x0000000000762417
- (void)prepareStyleVarsWithContext:(struct NavContext *)arg1;	// IMP=0x00000000007621aa
@property(readonly, nonatomic) _Bool isVisible; // @synthesize isVisible=_isVisible;
- (void)layoutWithNavContext:(struct NavContext *)arg1;	// IMP=0x0000000000762143
- (void)_updateWithNavContext:(struct NavContext *)arg1;	// IMP=0x000000000076212e
- (void)_updateWithNavContext:(struct NavContext *)arg1 threshold:(double)arg2;	// IMP=0x00000000007620a4
- (Mercator3_d8bb135c)_anchorCoordinateForSignOrientation:(unsigned char)arg1;	// IMP=0x0000000000761ee9
- (unsigned char)_signOrientationWithDrivingSide:(_Bool)arg1;	// IMP=0x0000000000761b70
...
- (void)evaluateCrossStreetsUsingRouteJunction:(id)arg1;	// IMP=0x0000000000760e87
- (void)evaluateCrossStreets;	// IMP=0x0000000000760e72
- (void)addRouteEdge:(const struct VKLabelNavRouteRoadEdge *)arg1 atA:(_Bool)arg2;	// IMP=0x0000000000760c1c
- (void)findRoads;	// IMP=0x0000000000760684
...
- (_Bool)matchesLocationForJunction:(id)arg1;	// IMP=0x000000000075ffc4
- (id)description;	// IMP=0x000000000075ff1c
- (void)dealloc;	// IMP=0x000000000075fea3
- (id)initWithRoadEdge:(const struct GeoCodecsRoadEdge *)arg1 atA:(_Bool)arg2 routeOffset:(struct PolylineCoordinate)arg3 tile:(const void *)arg4;	// IMP=0x000000000075fc5d
- (id)initWithGEOJunction:(struct GeoCodecsConnectivityJunction *)arg1 routeOffset:(struct PolylineCoordinate)arg2 tile:(const void *)arg3;	// IMP=0x000000000075fa14
