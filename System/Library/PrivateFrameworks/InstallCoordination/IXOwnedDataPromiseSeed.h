...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000002b1b9
...
- (Class)clientPromiseClass;	// IMP=0x000000000002b272
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000002b1c1
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000002b0e5
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000002aff6
