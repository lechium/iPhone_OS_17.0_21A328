...
+ (id)identifier;	// IMP=0x001000000011e29f
...
- (id)_playbackBarWithElapsedTime:(double)arg1 duration:(double)arg2;	// IMP=0x000000000012114c
- (_Bool)_logAccountEvent:(id)arg1 subscription:(id)arg2 cursor:(id)arg3;	// IMP=0x0000000000120822
- (void)unsubscribeFromEventStream:(id)arg1;	// IMP=0x00000000001207e9
- (void)subscribeToEventStream:(id)arg1;	// IMP=0x000000000011e2ac
