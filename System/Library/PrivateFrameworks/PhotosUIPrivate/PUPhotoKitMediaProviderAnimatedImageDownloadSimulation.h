...
- (void).cxx_destruct;	// IMP=0x000000000042a0a5
...
- (void)endSimulationWithError:(id)arg1;	// IMP=0x0000000000429e94
- (void)updateSimulationWithProgress:(double)arg1;	// IMP=0x0000000000429df0
- (void)_handleResultAnimatedImage:(id)arg1 info:(id)arg2;	// IMP=0x0000000000429d36
- (id)init;	// IMP=0x0000000000429c85
