...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000008472d5
- (void).cxx_destruct;	// IMP=0x0000000000846ea9
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000846d82
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000846c5d
- (void)description:(id)arg1 indent:(id)arg2;	// IMP=0x0000000000846b0f
@property(readonly, copy) NSData *tlvData;
- (_Bool)_parseFromTLVData;	// IMP=0x000000000084681c
- (id)initWithImageWidth:(id)arg1 imageHeight:(id)arg2 frameRate:(id)arg3;	// IMP=0x0000000000846728
- (id)initWithResolution:(long long)arg1 frameRate:(id)arg2;	// IMP=0x0000000000846654
