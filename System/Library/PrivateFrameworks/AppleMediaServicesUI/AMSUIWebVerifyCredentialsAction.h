...
+ (id)_authenticationTypeFromStringedType:(id)arg1;	// IMP=0x00100000000cfd7a
+ (long long)_serviceTypeFromType:(long long)arg1;	// IMP=0x00100000000cfc1f
- (void).cxx_destruct;	// IMP=0x00000000000cfeef
...
- (id)runAction;	// IMP=0x00000000000cf71d
- (id)initWithJSObject:(id)arg1 context:(id)arg2;	// IMP=0x00000000000ceef4
