...
- (void).cxx_destruct;	// IMP=0x00000000008f78ea
...
- (id)description;	// IMP=0x00000000008f777e
- (id)initWithResolution:(long long)arg1 bitRateByFrameRate:(id)arg2 keyFrameInterval:(id)arg3 h264Level:(long long)arg4;	// IMP=0x00000000008f76d0
