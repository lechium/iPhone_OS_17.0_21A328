...
- (void).cxx_destruct;	// IMP=0x0000000001272cb2
...
- (void)_translateSourceIndexPath:(CDUnknownBlockType)arg1;	// IMP=0x0000000001272c39
@property(readonly, nonatomic) struct CGSize previewSize;
- (id)initWithDragItem:(id)arg1 sourceIndexPath:(id)arg2;	// IMP=0x0000000001272b2c
