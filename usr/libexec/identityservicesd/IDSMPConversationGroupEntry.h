...
+ (id)entryFromPublicDataRepresentation:(id)arg1 error:(id *)arg2;	// IMP=0x00400000001050ec
- (void).cxx_destruct;	// IMP=0x002000000010570b
...
- (id)description;	// IMP=0x001000000010550a
- (id)publicDataRepresentationWithError:(id *)arg1;	// IMP=0x0010000000105301
- (id)initWithStableGroupID:(id)arg1 groupServerEntry:(id)arg2;	// IMP=0x0010000000104f5c
