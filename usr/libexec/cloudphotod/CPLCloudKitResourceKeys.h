...
+ (unsigned long long)resourceTypeForFieldName:(id)arg1;	// IMP=0x0040000000114d6d
+ (id)resourceKeysForResourceType:(unsigned long long)arg1;	// IMP=0x0010000000114d18
- (void).cxx_destruct;	// IMP=0x0020000000115221
...
- (id)redactedDescription;	// IMP=0x0010000000115079
- (id)description;	// IMP=0x0010000000114ffc
- (id)initWithPrefix:(id)arg1 resourceType:(unsigned long long)arg2;	// IMP=0x0010000000114e01
