...
- (void).cxx_destruct;	// IMP=0x00000000000f9d90
@property(retain, nonatomic) SUUIColorScheme *colorScheme; // @synthesize colorScheme=_colorScheme;
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000000f9d47
- (void)layoutSubviews;	// IMP=0x00000000000f9c54
