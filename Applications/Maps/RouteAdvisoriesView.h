...
- (void).cxx_destruct;	// IMP=0x0020000000b51509
...
- (void)refreshContent;	// IMP=0x0010000000b50be2
- (void)_logAnalyticsIfNeeded;	// IMP=0x0010000000b50980
- (void)setAdvisories:(id)arg1 coordinator:(id)arg2;	// IMP=0x0010000000b50896
@property(readonly, nonatomic) _Bool isVisible;
- (void)setOverrideTextColor:(id)arg1 isSelected:(_Bool)arg2;	// IMP=0x0010000000b505fb
- (void)setupSubViews;	// IMP=0x0010000000b501c6
- (void)didMoveToWindow;	// IMP=0x0010000000b50158
- (id)init;	// IMP=0x0010000000b500f5
