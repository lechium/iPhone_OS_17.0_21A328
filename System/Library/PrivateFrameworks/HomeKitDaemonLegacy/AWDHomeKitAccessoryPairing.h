...
- (void).cxx_destruct;	// IMP=0x00000000007e1f93
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000007e1a88
- (unsigned long long)hash;	// IMP=0x00000000007e1711
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000007e1170
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000007e0ddd
- (void)copyTo:(id)arg1;	// IMP=0x00000000007e0aad
- (void)writeTo:(id)arg1;	// IMP=0x00000000007e0730
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000007df870
- (id)dictionaryRepresentation;	// IMP=0x00000000007def82
- (id)description;	// IMP=0x00000000007deed3
...
- (int)StringAsCredentialType:(id)arg1;	// IMP=0x00000000007dea5e
- (id)credentialTypeAsString:(int)arg1;	// IMP=0x00000000007dea16
...
- (int)StringAsCertified:(id)arg1;	// IMP=0x00000000007de87a
- (id)certifiedAsString:(int)arg1;	// IMP=0x00000000007de832
...
- (int)StringAsTransportType:(id)arg1;	// IMP=0x00000000007de67b
- (id)transportTypeAsString:(int)arg1;	// IMP=0x00000000007de633
