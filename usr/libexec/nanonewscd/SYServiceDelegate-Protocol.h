...
@class MISSING_TYPE, NSData, NSDictionary, NSError, NSInputStream, NSUUID, SYService, SYSession;
...
- (MISSING_TYPE *)service:didSwitchFromPairingID:toPairingID: /* Error: Ran out of types for this method. */;
