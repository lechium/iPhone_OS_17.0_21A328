...
- (void).cxx_destruct;	// IMP=0x00000000014ccd51
...
- (void)drawRect:(struct CGRect)arg1;	// IMP=0x00000000014ccb63
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000014cc9ce
- (void)updateLabelFrame;	// IMP=0x00000000014cc68d
