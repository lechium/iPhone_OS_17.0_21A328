...
- (void).cxx_destruct;	// IMP=0x00200000000c49c1
...
- (void)runOperations;	// IMP=0x00100000000c499f
- (void)fetchUserRecord;	// IMP=0x00100000000c48e0
- (void)fetchDerivativesFilter;	// IMP=0x00100000000c4600
- (void)fetchDisabledFeatures;	// IMP=0x00100000000c4198
- (id)initWithController:(id)arg1 updateDisabledFeatures:(_Bool)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00100000000c4103
