...
- (void).cxx_destruct;	// IMP=0x00000000000b461a
...
- (id)_logNameForContentViewType:(unsigned long long)arg1;	// IMP=0x00000000000b4516
- (id)_createAlertViewWithTitle:(id)arg1 description:(id)arg2;	// IMP=0x00000000000b4389
- (void)refreshNoContentViewIfNeeded;	// IMP=0x00000000000b4139
- (void)configureCurrentViewFrameForBounds:(struct CGRect)arg1;	// IMP=0x00000000000b3bf3
- (void)setRootViewForViewController:(id)arg1;	// IMP=0x00000000000b3b4e
