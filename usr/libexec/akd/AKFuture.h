...
- (void).cxx_destruct;	// IMP=0x0020000000064a8c
...
- (id)value;	// IMP=0x00100000000648c5
- (void)setValue:(id)arg1;	// IMP=0x0010000000064841
- (id)initWithMaxWait:(double)arg1 description:(id)arg2;	// IMP=0x0010000000064752
- (id)init;	// IMP=0x001000000006473b
