...
- (void).cxx_destruct;	// IMP=0x0000000000ea819c
...
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x0000000000ea7f9a
- (void)updateUndoStateHUDControlType:(long long)arg1 available:(_Bool)arg2;	// IMP=0x0000000000ea7df5
- (id)initWithKeyboardAppearance:(long long)arg1;	// IMP=0x0000000000ea690b
