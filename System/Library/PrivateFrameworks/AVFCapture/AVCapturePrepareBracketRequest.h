...
+ (id)prepareBracketRequestWithCompletionBlock:(CDUnknownBlockType)arg1 settings:(id)arg2;	// IMP=0x0060000000058427
...
- (void)dealloc;	// IMP=0x00000000000584ce
- (id)_initWithCompletionBlock:(CDUnknownBlockType)arg1 settings:(id)arg2;	// IMP=0x0000000000058463
