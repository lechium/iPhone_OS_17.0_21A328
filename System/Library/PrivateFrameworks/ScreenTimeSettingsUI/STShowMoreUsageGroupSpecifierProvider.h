...
- (void).cxx_destruct;	// IMP=0x000000000009d543
...
- (void)showMoreItems:(id)arg1;	// IMP=0x000000000009d47e
- (void)updateSpecifier:(id)arg1 usageItem:(id)arg2;	// IMP=0x000000000009d404
- (id)newSpecifierWithUsageItem:(id)arg1;	// IMP=0x000000000009d37e
- (void)refreshUsageSpecifiersWithUpdates:(_Bool)arg1;	// IMP=0x000000000009cf7b
- (id)init;	// IMP=0x000000000009cc8c
