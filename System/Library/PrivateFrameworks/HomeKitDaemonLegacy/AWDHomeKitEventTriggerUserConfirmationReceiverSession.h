...
- (void).cxx_destruct;	// IMP=0x0000000000ac835a
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000ac825e
- (unsigned long long)hash;	// IMP=0x0000000000ac81cc
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000ac80bc
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000ac7fe8
- (void)copyTo:(id)arg1;	// IMP=0x0000000000ac7f43
- (void)writeTo:(id)arg1;	// IMP=0x0000000000ac7e94
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000ac7b7b
- (id)dictionaryRepresentation;	// IMP=0x0000000000ac7a06
- (id)description;	// IMP=0x0000000000ac7957
