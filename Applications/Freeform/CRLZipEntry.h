...
@interface CRLZipEntry : NSObject
{
    ...
    NSString *_collapsedName;	// 32 = 0x20
    NSDate *_lastModificationDate;	// 40 = 0x28
    unsigned long long _size;	// 48 = 0x30
    unsigned long long _offset;	// 56 = 0x38
    unsigned long long _compressedSize;	// 64 = 0x40
    unsigned long long _fileHeaderLength;	// 72 = 0x48
}

- (void).cxx_destruct;	// IMP=0x00200000005b9976
...
- (id)description;	// IMP=0x00100000005b975f
