...
- (void).cxx_destruct;	// IMP=0x0000000000113317
...
- (void)handleUnknownDeclaration:(id)arg1;	// IMP=0x0000000000113183
- (void)handleProcessingInstruction:(id)arg1;	// IMP=0x00000000001130d9
- (void)handleDoctypeDeclaration:(id)arg1;	// IMP=0x000000000011302f
- (void)handleComment:(id)arg1;	// IMP=0x0000000000112f85
- (void)handleCharacterRef:(id)arg1;	// IMP=0x0000000000112edb
- (void)handleEntityRef:(id)arg1;	// IMP=0x0000000000112e31
- (void)handleEndTag:(id)arg1;	// IMP=0x0000000000112d87
- (void)handleData:(id)arg1;	// IMP=0x0000000000112cdd
- (void)handleStartTag:(id)arg1 attributes:(id)arg2;	// IMP=0x0000000000112c13
- (void)handleStartEndTag:(id)arg1 attributes:(id)arg2;	// IMP=0x0000000000112baf
- (long long)updatePosition:(long long)arg1 j:(long long)arg2;	// IMP=0x0000000000112a71
- (long long)parseEndTag:(long long)arg1;	// IMP=0x000000000011251e
- (long long)checkForWholeStartTag:(long long)arg1;	// IMP=0x0000000000112267
- (long long)parseStartTag:(long long)arg1;	// IMP=0x0000000000111b8d
- (long long)parseProcessingInstruction:(long long)arg1;	// IMP=0x0000000000111a1e
- (long long)parseBogusComment:(long long)arg1;	// IMP=0x0000000000111895
- (long long)parseHTMLDeclaration:(long long)arg1;	// IMP=0x0000000000111714
- (long long)parseComment:(long long)arg1;	// IMP=0x0000000000111537
- (long long)parseMarkedSection:(long long)arg1;	// IMP=0x00000000001111f2
- (id)scanName:(long long)arg1 declarationStartPosition:(long long)arg2 location:(long long *)arg3;	// IMP=0x0000000000110f46
- (void)parseDataAndEnd:(_Bool)arg1;	// IMP=0x00000000001102e9
- (void)close;	// IMP=0x00000000001101e5
- (void)feed:(id)arg1;	// IMP=0x0000000000110137
- (void)reset;	// IMP=0x00000000001100db
- (id)init;	// IMP=0x000000000010fe4c
