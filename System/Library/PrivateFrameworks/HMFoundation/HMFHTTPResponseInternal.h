...
- (void).cxx_destruct;	// IMP=0x000000000001ff8f
...
- (void)setHeaderValue:(id)arg1 forHeaderKey:(id)arg2;	// IMP=0x000000000001fe30
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000001fd29
- (id)initWithStatusCode:(long long)arg1 headerFields:(id)arg2 body:(id)arg3;	// IMP=0x000000000001fc54
- (id)init;	// IMP=0x000000000001fbac
